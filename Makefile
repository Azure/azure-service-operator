...
test-existing-controllers: generate fmt vet manifests
	TEST_USE_EXISTING_CLUSTER=true TEST_CONTROLLER_WITH_MOCKS=false REQUEUE_AFTER=20 go test -tags all -v -coverprofile=coverage-existing.txt -covermode count ./controllers/... -timeout 30m
