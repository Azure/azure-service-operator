...
func (*AzureCosmosDBManager) CreateOrUpdateCosmosDB(
	...
	accountOfferType := to.StringPtr(string(dbType))
	...
	kind := documentdb.DatabaseAccountKind(dbKind)
	if kind == documentdb.MongoDB && dbVersion == "3.6" {
