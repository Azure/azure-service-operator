...
type APIProperties struct {
	...
	Format api.ContentFormat `json:"format,omitempty"`
	...
	Protocols *[]api.Protocol `json:"protocols,omitempty"`
...
// TODO: as more implementations of APIMgmtImplemetation are created, it may be neccessary to create additional translation functions
