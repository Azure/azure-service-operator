...
func (g *AzureLoadBalancerClient) Ensure(ctx context.Context, obj runtime.Object, opts ...resourcemanager.ConfigOption) (bool, error) {
	...
	backendAddressPoolName := instance.Spec.BackendAddressPoolName
	inboundNatPoolName := instance.Spec.InboundNatPoolName
	frontendPortRangeStart := instance.Spec.FrontendPortRangeStart
	frontendPortRangeEnd := instance.Spec.FrontendPortRangeEnd
	backendPort := instance.Spec.BackendPort
...
func (g *AzureLoadBalancerClient) Delete(ctx context.Context, obj runtime.Object, opts ...resourcemanager.ConfigOption) (bool, error) {
	...
	status, err := g.DeleteLoadBalancer(
		ctx,
		resourceName,
		resourceGroup,
	)
...
func (g *AzureLoadBalancerClient) convert(obj runtime.Object) (*azurev1alpha1.AzureLoadBalancer, error) {
	local, ok := obj.(*azurev1alpha1.AzureLoadBalancer)
	if !ok {
