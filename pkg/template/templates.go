...
func rediscacheJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "rediscache.json", size: 1773, mode: os.FileMode(420), modTime: time.Unix(1563943619, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func storageJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "storage.json", size: 2459, mode: os.FileMode(420), modTime: time.Unix(1563943619, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
