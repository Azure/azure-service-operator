...
type StorageAccountsBlobServicesContainers_SpecARM struct {
	...
	//on the template
	APIVersion StorageAccountsBlobServicesContainersSpecAPIVersion `json:"apiVersion"`
...
// +kubebuilder:validation:Enum={"Microsoft.Storage/storageAccounts/blobServices/containers"}
type StorageAccountsBlobServicesContainersSpecType string

const StorageAccountsBlobServicesContainersSpecTypeMicrosoftStorageStorageAccountsBlobServicesContainers = StorageAccountsBlobServicesContainersSpecType("Microsoft.Storage/storageAccounts/blobServices/containers")
