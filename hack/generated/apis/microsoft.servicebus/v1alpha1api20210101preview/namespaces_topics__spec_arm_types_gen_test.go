...
func AddIndependentPropertyGeneratorsForNamespacesTopicsSpecARM(gens map[string]gopter.Gen) {
	gens["APIVersion"] = gen.OneConstOf(NamespacesTopicsSpecAPIVersion20210101Preview)
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.AlphaString()
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
	gens["Type"] = gen.OneConstOf(NamespacesTopicsSpecTypeMicrosoftServiceBusNamespacesTopics)
}
