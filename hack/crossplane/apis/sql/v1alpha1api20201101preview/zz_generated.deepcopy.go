...
func (in *ResourceIdentity) DeepCopyInto(out *ResourceIdentity) {
	*out = *in
	...
	if in.UserAssignedIdentities != nil {
		...
		*out = make(map[string]UserIdentity, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServersDatabaseParameters) DeepCopyInto(out *ServersDatabaseParameters) {
	*out = *in
	if in.AutoPauseDelay != nil {
		in, out := &in.AutoPauseDelay, &out.AutoPauseDelay
		*out = new(int)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServersDatabaseParameters.
func (in *ServersDatabaseParameters) DeepCopy() *ServersDatabaseParameters {
	if in == nil {
		return nil
	}
	out := new(ServersDatabaseParameters)
	in.DeepCopyInto(out)
	return out
}
