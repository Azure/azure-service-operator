...
func assignFromOptionalType(
	...
	// Require a conversion between the unwrapped type and our source
	// We supply a nested context as we will wrap the code generated by the conversion (if any)
	// within a scope, making it independent of other code generated
...
func assignArrayFromArray(
	...
	// We supply a nested context as we will wrap the code generated by the conversion (if any)
	// within a loop, making it independent of other code generated
