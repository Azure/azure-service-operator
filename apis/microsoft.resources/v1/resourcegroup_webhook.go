...
// +kubebuilder:webhook:path=/mutate-microsoft-resources-infra-azure-com-v1-resourcegroup,mutating=true,failurePolicy=fail,groups=microsoft.resources.infra.azure.com,resources=resourcegroups,verbs=create;update,versions=v1,name=mresourcegroup.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-microsoft-resources-infra-azure-com-v1-resourcegroup,mutating=false,failurePolicy=fail,groups=microsoft.resources.infra.azure.com,resources=resourcegroups,versions=v1,name=vresourcegroup.kb.io
