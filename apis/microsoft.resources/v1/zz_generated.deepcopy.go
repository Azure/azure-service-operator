...
func (in *AzRGSpec) DeepCopyInto(out *AzRGSpec) {
	*out = *in
	if in.Tags != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AzRGSpec.
func (in *AzRGSpec) DeepCopy() *AzRGSpec {
	if in == nil {
		return nil
	}
	out := new(AzRGSpec)
