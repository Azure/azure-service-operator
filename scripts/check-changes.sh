...
IGNORE_FILTERS=("docs/" "README.md" "hack/" "v2/" "Taskfile.yml" "scripts/check-changes.sh" "scripts/gen-api-docs.sh" ".github/" ".devcontainer/" "workspace.code-workspace" ".golangci.yml")
