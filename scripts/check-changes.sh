...
IGNORE_FILTERS=("docs/" "README.md" "hack/" "v2/" "Taskfile.yml" "scripts/check_samples.py" "scripts/check-changes.sh" "scripts/gen-api-docs.sh" "scripts/generate-helm-manifest.sh" ".github/" ".devcontainer/" "workspace.code-workspace" ".golangci.yml" "scripts/wait-for-ca-bundles.sh" "scripts/wrap-resource-urls.py" "dev.sh")
