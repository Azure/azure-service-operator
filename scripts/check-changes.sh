...
IGNORE_FILTERS=("docs/" "README.md" "ROADMAP.md" "SECURITY.md" "SUPPORT.md" "hack/" "v2/" "scripts/v2" "Taskfile.yml" "scripts/check-changes.sh" ".github/" ".devcontainer/" "workspace.code-workspace" ".golangci.yml" "dev.sh" ".agents/")
