...
**Note: Using this method you can only try the latest version of a CRD, as there are no conversion webhooks running to convert other versions. Use this method only to try out the operator to get familiar.**
