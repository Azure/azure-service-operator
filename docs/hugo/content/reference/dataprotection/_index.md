...
|---------------------------------------------------------------------------------------------------------------|-------------|-------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| [BackupVault]({{< relref "/reference/dataprotection/v20231101#BackupVault" >}})                               | 2023-11-01  | v20231101   | v2.7.0         | [View](https://github.com/Azure/azure-service-operator/tree/main/v2/samples/dataprotection/v20231101/v20231101_backupvault.yaml)                |
| [BackupVaultsBackupInstance]({{< relref "/reference/dataprotection/v20231101#BackupVaultsBackupInstance" >}}) | 2023-11-01  | v20231101   | v2.7.0         | [View](https://github.com/Azure/azure-service-operator/tree/main/v2/samples/dataprotection/v20231101/v20231101_backupvaultsbackupinstance.yaml) |
| [BackupVaultsBackupPolicy]({{< relref "/reference/dataprotection/v20231101#BackupVaultsBackupPolicy" >}})     | 2023-11-01  | v20231101   | v2.7.0         | [View](https://github.com/Azure/azure-service-operator/tree/main/v2/samples/dataprotection/v20231101/v20231101_backupvaultsbackuppolicy.yaml)   |
...
| Resource                                                                                                  | ARM Version | CRD Version | Supported From | Sample                                                                                                                                        |
|-----------------------------------------------------------------------------------------------------------|-------------|-------------|----------------|-----------------------------------------------------------------------------------------------------------------------------------------------|
| [BackupVault]({{< relref "/reference/dataprotection/v20230101#BackupVault" >}})                           | 2023-01-01  | v20230101   | v2.2.0         | [View](https://github.com/Azure/azure-service-operator/tree/main/v2/samples/dataprotection/v20230101/v20230101_backupvault.yaml)              |
| [BackupVaultsBackupPolicy]({{< relref "/reference/dataprotection/v20230101#BackupVaultsBackupPolicy" >}}) | 2023-01-01  | v20230101   | v2.2.0         | [View](https://github.com/Azure/azure-service-operator/tree/main/v2/samples/dataprotection/v20230101/v20230101_backupvaultsbackuppolicy.yaml) |
