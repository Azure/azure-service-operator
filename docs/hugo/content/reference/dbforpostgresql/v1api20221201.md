...
| Version              | v1api20221201                                                                |
| Module               | github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v1api20221201 |
...
| pointInTimeUTC                | Restore point creation time (ISO8601 format), specifying the time to restore from. It's required when 'createMode' is 'PointInTimeRestore' or 'GeoRestore'.                                                                                                                                  | string<br/><small>Optional</small>                                                                                                                                   |
...
| sourceServerResourceId   | The source server resource ID to restore from. It's required when 'createMode' is 'PointInTimeRestore' or 'GeoRestore' or 'Replica'. This property is returned only for Replica server                                                                                                                                    | string<br/><small>Optional</small>                                                                                                                      |
...
| Property                             | Description                                                                                   | Type                                                                                                                                                         |
|--------------------------------------|-----------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|
| primaryKeyURI                        | URI for the key for data encryption for primary server.                                       | string<br/><small>Optional</small>                                                                                                                           |
| primaryKeyURIFromConfig              | URI for the key for data encryption for primary server.                                       | [genruntime.ConfigMapReference](https://pkg.go.dev/github.com/Azure/azure-service-operator/v2/pkg/genruntime#ConfigMapReference)<br/><small>Optional</small> |
