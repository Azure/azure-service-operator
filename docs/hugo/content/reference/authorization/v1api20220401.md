...
| roleDefinitionReference                   | The role definition ID.                                                                                                                                                                                                                                                                                      | [genruntime.WellKnownResourceReference](https://pkg.go.dev/github.com/Azure/azure-service-operator/v2/pkg/genruntime#WellKnownResourceReference)<br/><small>Required</small> |
