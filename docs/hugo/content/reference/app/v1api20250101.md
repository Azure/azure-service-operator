...
Generator information: - Generated from: /app/resource-manager/Microsoft.App/stable/2025-01-01/ContainerApps.json - ARM URI: /&ZeroWidthSpace;subscriptions/&ZeroWidthSpace;{subscriptionId}/&ZeroWidthSpace;resourceGroups/&ZeroWidthSpace;{resourceGroupName}/&ZeroWidthSpace;providers/&ZeroWidthSpace;Microsoft.App/&ZeroWidthSpace;containerApps/&ZeroWidthSpace;{containerAppName}
...
Generator information: - Generated from: /app/resource-manager/Microsoft.App/stable/2025-01-01/Jobs.json - ARM URI: /&ZeroWidthSpace;subscriptions/&ZeroWidthSpace;{subscriptionId}/&ZeroWidthSpace;resourceGroups/&ZeroWidthSpace;{resourceGroupName}/&ZeroWidthSpace;providers/&ZeroWidthSpace;Microsoft.App/&ZeroWidthSpace;jobs/&ZeroWidthSpace;{jobName}
...
Generator information: - Generated from: /app/resource-manager/Microsoft.App/stable/2025-01-01/ManagedEnvironments.json - ARM URI: /&ZeroWidthSpace;subscriptions/&ZeroWidthSpace;{subscriptionId}/&ZeroWidthSpace;resourceGroups/&ZeroWidthSpace;{resourceGroupName}/&ZeroWidthSpace;providers/&ZeroWidthSpace;Microsoft.App/&ZeroWidthSpace;managedEnvironments/&ZeroWidthSpace;{environmentName}
...
Used by: [ContainerApp_Spec](#ContainerApp_Spec), [Job_Spec](#Job_Spec), and [ManagedEnvironment_Spec](#ManagedEnvironment_Spec).
...
Used by: [ContainerApp_STATUS](#ContainerApp_STATUS), [Job_STATUS](#Job_STATUS), and [ManagedEnvironment_STATUS](#ManagedEnvironment_STATUS).
...
Used by: [CustomDomainConfiguration](#CustomDomainConfiguration).
...
| keyVaultUrl       | URL pointing to the Azure Key Vault secret that holds the certificate.                                               | string<br/><small>Optional</small>                                                                                                                         |
...
Used by: [CustomDomainConfiguration_STATUS](#CustomDomainConfiguration_STATUS).
...
| Property          | Description                                                                                                                          | Type                                                                                                                                                       |
|-------------------|--------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| identityReference | The resource ID of a user-assigned managed identity that is assigned to the Container App, or `system` for system-assigned identity. | [genruntime.ResourceReference](https://pkg.go.dev/github.com/Azure/azure-service-operator/v2/pkg/genruntime#ResourceReference)<br/><small>Required</small> |
| lifecycle         | Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.                         | [IdentitySettings_Lifecycle](#IdentitySettings_Lifecycle)<br/><small>Optional</small>                                                                      |

IdentitySettings_STATUS{#IdentitySettings_STATUS}
-------------------------------------------------
...
| Property  | Description                                                                                                                          | Type                                                                                                |
|-----------|--------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------|
| identity  | The resource ID of a user-assigned managed identity that is assigned to the Container App, or `system` for system-assigned identity. | string<br/><small>Optional</small>                                                                  |
| lifecycle | Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.                         | [IdentitySettings_Lifecycle_STATUS](#IdentitySettings_Lifecycle_STATUS)<br/><small>Optional</small> |
...
| Property | Description            | Type                                                      |
|----------|------------------------|-----------------------------------------------------------|
| java     | Java app configuration | [Runtime_Java](#Runtime_Java)<br/><small>Optional</small> |
...
| Property | Description            | Type                                                                    |
|----------|------------------------|-------------------------------------------------------------------------|
| java     | Java app configuration | [Runtime_Java_STATUS](#Runtime_Java_STATUS)<br/><small>Optional</small> |
...
| Property        | Description                                                                    | Type                                                  |
|-----------------|--------------------------------------------------------------------------------|-------------------------------------------------------|
| cooldownPeriod  | Optional. KEDA Cooldown Period in seconds. Defaults to 300 seconds if not set. | int<br/><small>Optional</small>                       |
...
| pollingInterval | Optional. KEDA Polling Interval in seconds. Defaults to 30 seconds if not set. | int<br/><small>Optional</small>                       |
...
| Property     | Description                                                                                                           | Type                                                                  |
|--------------|-----------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| mountOptions | Mount options used while mounting the Azure file share or NFS Azure file share. Must be a comma-separated string.     | string<br/><small>Optional</small>                                    |
...
IdentitySettings_Lifecycle{#IdentitySettings_Lifecycle}
-------------------------------------------------------

Used by: [IdentitySettings](#IdentitySettings).
...
IdentitySettings_Lifecycle_STATUS{#IdentitySettings_Lifecycle_STATUS}
---------------------------------------------------------------------

Used by: [IdentitySettings_STATUS](#IdentitySettings_STATUS).
...
Used by: [Runtime](#Runtime).

| Property      | Description                              | Type                             |
|---------------|------------------------------------------|----------------------------------|
| enableMetrics | Enable jmx core metrics for the java app | bool<br/><small>Optional</small> |

Runtime_Java_STATUS{#Runtime_Java_STATUS}
-----------------------------------------

Used by: [Runtime_STATUS](#Runtime_STATUS).
...
| identityReference | The resource ID of a user-assigned managed identity that is assigned to the Container App, or `system` for system-assigned identity. | [genruntime.ResourceReference](https://pkg.go.dev/github.com/Azure/azure-service-operator/v2/pkg/genruntime#ResourceReference)<br/><small>Optional</small> |
...
| Property          | Description                                                                                                                          | Type                                                                                                                                                       |
|-------------------|--------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| accountName       | Storage account name. required if using managed identity to authenticate                                                             | string<br/><small>Optional</small>                                                                                                                         |
