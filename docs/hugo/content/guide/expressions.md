...
| ------------------- | -------------------------------------------------------------------------------------------------------------------- | ----------------- | -------------------------- |
| \_\_underscores\_\_ | \_\_                                                                                                                 | my\_\_field       | my\_\_underscores\_\_field |
| \_\_dot\_\_         | .                                                                                                                    | my.field          | my\_\_dot\_\_field         |
| \_\_dash\_\_        | -                                                                                                                    | my-field          | my\_\_dash\_\_field        |
| \_\_slash\_\_       | /                                                                                                                    | my/field          | my\_\_slash\_\_field       |
| \_\_{keyword}\_\_   | [CEL RESERVED keyword (false, true, in, null)](https://github.com/google/cel-spec/blob/master/doc/langdef.md#syntax) | false             | \_\_false\_\_              |
...
| ---------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| Hardcoded string (single quotes inside double-quots so CEL sees the ') | `"'helloworld'"`                                                   | `helloworld`                                                                   |
| Hardcoded string (escaped so CEL sees the quotes)                      | `"\"helloworld\""`                                                 | `helloworld`                                                                   |
