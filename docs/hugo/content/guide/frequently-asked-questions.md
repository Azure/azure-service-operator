...
1. You can set [serviceoperator.azure.com/reconcile-policy: detach-on-delete](https://azure.github.io/azure-service-operator/guide/annotations/#serviceoperatorazurecomreconcile-policy). This will allow the resource to be deleted in k8s but not delete the underlying resource in Azure.
...
1. Annotate the resources in cluster A with [serviceoperator.azure.com/reconcile-policy: skip](https://azure.github.io/azure-service-operator/guide/annotations/#serviceoperatorazurecomreconcile-policy). This prevents ASO in that cluster from updating or deleting those resources.
...
This can be accomplished with the [serviceoperator.azure.com/reconcile-policy: skip](https://azure.github.io/azure-service-operator/guide/annotations/#serviceoperatorazurecomreconcile-policy) 
