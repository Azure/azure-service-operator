...
the goal state. Another reconciliation will be performed after [AZURE_SYNC_PERIOD](http://localhost:1313/azure-service-operator/guide/aso-controller-settings-options/#azure_sync_period) or when a change is made to the cluster resource.
