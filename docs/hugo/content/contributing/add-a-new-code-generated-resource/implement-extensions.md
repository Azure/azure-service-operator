...
| PostReconciliationChecker | Implemented when a resource needs to perform additional checks after reconciliation against Azure              | Used by DatabaseWatcher [Target](https://github.com/Azure/azure-service-operator/blob/main/v2/api/databasewatcher/customizations/target_extensions.go) to start the watcher that owns a target, which ARM creates stopped.                                                                                                |
