...
func (r *SqlDatabaseReconciler) reconcileExternal(ctx context.Context, instance *azurev1.SqlDatabase) error {
...
func (r *SqlDatabaseReconciler) deleteExternal(ctx context.Context, instance *azurev1.SqlDatabase) error {
	location := instance.Spec.Location
	groupName := instance.Spec.ResourceGroup
	server := instance.Spec.Server
	dbName := instance.ObjectMeta.Name
...
func (r *SqlDatabaseReconciler) addFinalizer(ctx context.Context, instance *azurev1.SqlDatabase) error {
