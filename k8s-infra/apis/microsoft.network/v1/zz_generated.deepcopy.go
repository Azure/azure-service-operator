...
func (in *BackendAddressPoolSpecProperties) DeepCopyInto(out *BackendAddressPoolSpecProperties) {
	*out = *in
	if in.BackendIPConfigurationRefs != nil {
		...
		*out = make([]corev1.KnownTypeReference, len(*in))
		copy(*out, *in)
	}
...
func (in *InterfaceDNSSettings) DeepCopy() *InterfaceDNSSettings {
	if in == nil {
		return nil
	}
	out := new(InterfaceDNSSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NetworkInterfaceSpec) DeepCopyInto(out *NetworkInterfaceSpec) {
	*out = *in
	...
	if in.Properties != nil {
		in, out := &in.Properties, &out.Properties
		*out = new(NetworkInterfaceSpecProperties)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkInterfaceSpecProperties) DeepCopyInto(out *NetworkInterfaceSpecProperties) {
	*out = *in
...
func (in *NetworkInterfaceSpecProperties) DeepCopy() *NetworkInterfaceSpecProperties {
	if in == nil {
		return nil
	}
	out := new(NetworkInterfaceSpecProperties)
