...
type ControllerFactory struct {
	ClientCreator            func(eventhubs.EventHubNamespaceManager, logr.Logger) ResourceManager
...
const FinalizerName = "eventhubnamespace.finalizers.com"
	...
	return &reconciler.DependencyDefinitions{
		...
		Owner: shared.GetOwnerIfManaged(ehnInstance.ObjectMeta, func() *reconciler.Dependency {
			return &reconciler.Dependency{
				...
				SucceededAccessor: resourcegroupaccessors.GetSuccess,
			}
		}),
	}, nil
}
