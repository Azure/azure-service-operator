...
// +kubebuilder:webhook:verbs=create;update,path=/validate-azure-microsoft-com-v1alpha2-mysqluser,mutating=false,failurePolicy=fail,groups=azure.microsoft.com,resources=mysqlusers,versions=v1alpha2,name=vmysqluser.kb.io,sideEffects=none,webhookVersions=v1beta1
