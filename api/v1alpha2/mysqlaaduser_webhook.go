...
// +kubebuilder:webhook:verbs=create;update,path=/validate-azure-microsoft-com-v1alpha2-mysqlaaduser,mutating=false,failurePolicy=fail,groups=azure.microsoft.com,resources=mysqlaadusers,versions=v1alpha2,name=vmysqlaaduser.kb.io,sideEffects=none,webhookVersions=v1beta1
