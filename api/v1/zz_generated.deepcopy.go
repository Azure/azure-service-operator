...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventhubResource) DeepCopyInto(out *EventhubResource) {
	*out = *in
	out.Properties = in.Properties
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventhubResource.
func (in *EventhubResource) DeepCopy() *EventhubResource {
	if in == nil {
		return nil
	}
	out := new(EventhubResource)
	in.DeepCopyInto(out)
	return out
}
...
func (in *EventhubSpec) DeepCopyInto(out *EventhubSpec) {
	*out = *in
	...
	if in.EventHubs != nil {
		...
		*out = make([]EventhubResource, len(*in))
		copy(*out, *in)
	}
}
