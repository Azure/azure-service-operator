...
func TestGolden_InjectPropertyAssignmentFunctions(t *testing.T) {
	t.Parallel()
	g := NewGomegaWithT(t)
	...
	types.AddAll(resourceV1, specV1, statusV1, resourceV2, specV2, statusV2, test.Address2021, apiVersionV1, apiVersionV2)
