...
// Shared test values:
var (
	package2019         = makeTestLocalPackageReference("group", "2019-01-01")
	person2019TypeName  = astmodel.MakeTypeName(package2019, "person")
	post2019TypeName    = astmodel.MakeTypeName(package2019, "post")
	student2019TypeName = astmodel.MakeTypeName(package2019, "student")
)

var (
	package2020           = makeTestLocalPackageReference("group", "2020-01-01")
	address2020TypeName   = astmodel.MakeTypeName(package2020, "address")
	person2020TypeName    = astmodel.MakeTypeName(package2020, "person")
	professor2020TypeName = astmodel.MakeTypeName(package2020, "professor")
	student2020TypeName   = astmodel.MakeTypeName(package2020, "student")
	tutor2020TypeName     = astmodel.MakeTypeName(package2020, "tutor")
)
