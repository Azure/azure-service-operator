...
func (omc *ObjectModelConfiguration) FindHandCraftedTypeNames(
	localPath string,
) (astmodel.TypeNameSet[astmodel.InternalTypeName], error) {
	result := make(astmodel.TypeNameSet[astmodel.InternalTypeName])
