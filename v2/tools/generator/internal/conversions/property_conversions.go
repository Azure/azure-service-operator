...
//
// 1. For a fatal error, one that guarantees no conversion can be generated, return (nil, error)
// This will abort the conversion process and return an error for logging.
//
// 2. For a valid conversion, return (conversion, nil)
//
// 3. When no conversion could be generated by this factory, return (nil, nil) to delegate to another factory
//
