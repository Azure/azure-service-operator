...
func Test_ImportableResource_SelectLatestVersion(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			kind:            "ResourceGroup",
			knownVersions:   createKnownVersions("resources.azure.com", "v1api20200601"),
		...
		},
		{
			...
			kind:            "StorageAccount",
			knownVersions:   createKnownVersions("storage.azure.com", "v1api20200601", "v1api20220101"),
			expectedVersion: "v1api20220101",
		},
		{
			name:            "Latest version is preview, get latest stable",
			group:           "containerservice.azure.com",
			kind:            "ManagedCluster",
			knownVersions:   createKnownVersions("containerservice.azure.com", "v1api20200601", "v1api20220101preview"),
			expectedVersion: "v1api20200601",
		},
		{
			...
			kind:            "FlexibleServer",
			knownVersions:   createKnownVersions("dbforpostgresql.azure.com", "v1api20200601preview", "v1api20220101preview"),
			expectedVersion: "v1api20220101preview",
		},
	}
	...
	for _, c := range cases {
		...
		t.Run(c.name, func(t *testing.T) {
			...
			gvk := importer.selectImportableVersion(gk, c.knownVersions)
