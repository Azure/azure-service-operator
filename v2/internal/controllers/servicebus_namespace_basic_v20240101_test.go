...
func Test_ServiceBus_Namespace_Basic_v20240101_CRUD(t *testing.T) {
	t.Parallel()
...
func ServiceBus_NamespacesQueue_v20240101_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Namespace_Secrets_v20240101(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
	...
	secretName := "namespace-secrets-20240101"
