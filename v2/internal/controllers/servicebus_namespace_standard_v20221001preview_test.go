...
func Test_ServiceBus_Namespace_Standard_v20221001preview_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunParallelSubtests(
		...
		testcommon.Subtest{
			Name: "Topic CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Topic_v20221001preview_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
			Name: "AuthorizationRule CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_AuthorizationRule_v20221001preview_CRUD(tc, namespace)
			},
		},
	)
...
func NewServiceBusNamespace_v20221001preview(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, sku servicebus.SBSku_Name) *servicebus.Namespace {
	zoneRedundant := false
...
func ServiceBus_AuthorizationRule_v20221001preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Topic_v20221001preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) { ServiceBus_Subscription_v20221001preview_CRUD(tc, topic) },
		},
	)
}

func ServiceBus_Subscription_v20221001preview_CRUD(tc *testcommon.KubePerTestContext, sbTopic client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Subscriptions_Rule_v20221001preview_CRUD(tc, subscription)
			},
		},
	)
...
func ServiceBus_Subscriptions_Rule_v20221001preview_CRUD(tc *testcommon.KubePerTestContext, sbSubscription client.Object) {
