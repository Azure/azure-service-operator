...
//func SQL_Server_Administrator_v20250101_CRUD(tc *testcommon.KubePerTestContext, server *sql.Server, rg *resources.ResourceGroup) {
...
//
//	adminType := sql.AdministratorType_ActiveDirectory
//	firewall := &sql.ServersAdministrator{
//		ObjectMeta: tc.MakeObjectMeta("atp"),
//		Spec: sql.ServersAdministrator_Spec{
//			Owner:          testcommon.AsOwner(server),
//			SidFromConfig: &genruntime.ConfigMapReference{
//				Name: "mimap",
//				Key:  "oid",
...
func SQL_Databases_v20250101_CRUD(tc *testcommon.KubePerTestContext, server *sql.Server, storageDetails vulnStorageAccountDetails) {
	...
	tc.RunParallelSubtests(
		...
		//	Test: func(tc *testcommon.KubePerTestContext) {
		//		SQL_Database_GeoBackupPolicy_v20250101_CRUD(tc, db)
		//	},
		//}
	)
...
//func SQL_Database_GeoBackupPolicy_v20250101_CRUD(tc *testcommon.KubePerTestContext, db *sql.ServersDatabase) {
//	enabled := sql.GeoBackupPolicyState_Enabled
//	geoBackupPolicy := &sql.ServersDatabasesGeoBackupPolicy{
//		ObjectMeta: tc.MakeObjectMeta("atp"),
//		Spec: sql.ServersDatabasesGeoBackupPolicy_Spec{
//			Owner: testcommon.AsOwner(db),
//			State: &enabled,
//		},
//	}
