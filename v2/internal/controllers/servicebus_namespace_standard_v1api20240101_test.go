...
func Test_ServiceBus_Namespace_Standard_v1api20240101_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesQueue_v1api20240101_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
			Name: "Topic CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Topic_v1api20240101_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
			Name: "AuthorizationRule CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_AuthorizationRule_v1api20240101_CRUD(tc, namespace)
			},
		},
	)
...
func NewServiceBusNamespace_v1api20240101(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, sku servicebus.SBSku_Name) *servicebus.Namespace {
	zoneRedundant := false
...
func ServiceBus_AuthorizationRule_v1api20240101_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Topic_v1api20240101_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Subscription_v1api20240101_CRUD(tc *testcommon.KubePerTestContext, sbTopic client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Subscriptions_Rule_v1api20240101_CRUD(tc, subscription)
			},
		},
	)
...
func ServiceBus_Subscriptions_Rule_v1api20240101_CRUD(tc *testcommon.KubePerTestContext, sbSubscription client.Object) {
