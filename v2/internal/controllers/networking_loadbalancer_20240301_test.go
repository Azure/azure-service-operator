...
func Test_Networking_LoadBalancer_20240301_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				LoadBalancer_InboundNatRule_20240301_CRUD(tc, loadBalancer, frontendIPConfigurationARMID)
			},
		},
	)
...
func LoadBalancer_InboundNatRule_20240301_CRUD(tc *testcommon.KubePerTestContext, lb *network.LoadBalancer, frontendIPConfigurationARMID string) {
