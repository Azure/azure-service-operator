...
func Test_Networking_PrivateEndpoint_20250301_CRUD(t *testing.T) {
	...
	endpoint := newPrivateEndpoint20250301(tc, rg, sa, subnet)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				PrivateEndpoint_DNSZoneGroup_20250301_CRUD(tc, vnet, endpoint, rg)
			},
		},
	)
...
func PrivateEndpoint_DNSZoneGroup_20250301_CRUD(tc *testcommon.KubePerTestContext, vnet *network20201101.VirtualNetwork, endpoint *network.PrivateEndpoint, rg *resources.ResourceGroup) {
...
func newPrivateEndpoint20250301(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, sa *storage.StorageAccount, subnet *network20201101.VirtualNetworksSubnet) *network.PrivateEndpoint {
