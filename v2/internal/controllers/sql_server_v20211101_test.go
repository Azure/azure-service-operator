...
func Test_SQL_Server_v20211101_CRUD(t *testing.T) {
	t.Parallel()
...
// TODO: We must create the administrator as part of the server (SQL_Server_CRUD) due to AAD-only restriction on servers in our test subscriptions, so we can't create another one here.
