...
func Test_DBForMySQL_FlexibleServer_20210501_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_AADAdmin_20220101_CRUD(tc, rg, flexibleServer)
			},
		},
	)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Configuration_20220101_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers database CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Database_20210501_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers firewall CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_FirewallRule_20210501_CRUD(tc, flexibleServer)
			},
		},
	)
...
func MySQLFlexibleServer_Database_20210501_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_AADAdmin_20220101_CRUD(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, server *mysql.FlexibleServer) {
