...
import (
	...
	storage "github.com/Azure/azure-service-operator/v2/api/storage/v20250601"
	"github.com/Azure/azure-service-operator/v2/internal/testcommon"
	"github.com/Azure/azure-service-operator/v2/internal/util/to"
	"github.com/Azure/azure-service-operator/v2/pkg/genruntime"
)

func Test_Storage_StorageAccount_20250601_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_BlobServices_20250601_CRUD(tc, acct)
			},
		},
		testcommon.Subtest{
			Name: "Queue Services CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_QueueServices_20250601_CRUD(tc, acct)
			},
		},
		testcommon.Subtest{
			Name: "Table Services CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_TableServices_20250601_CRUD(tc, acct)
			},
		},
		testcommon.Subtest{
			Name: "File Services CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_FileServices_20250601_CRUD(tc, acct)
			},
		},
		testcommon.Subtest{
			Name: "Management Policies CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_ManagementPolicy_20250601_CRUD(tc, acct)
			},
		},
	)
...
func StorageAccount_BlobServices_20250601_CRUD(tc *testcommon.KubePerTestContext, storageAccount client.Object) {
...
func StorageAccount_QueueServices_20250601_CRUD(tc *testcommon.KubePerTestContext, storageAccount client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			Name: "Queue CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				StorageAccount_QueueServices_Queue_20250601_CRUD(tc, queueService)
			},
		},
	)
}

func StorageAccount_QueueServices_Queue_20250601_CRUD(tc *testcommon.KubePerTestContext, queueService *storage.StorageAccountsQueueService) {
...
func StorageAccount_TableServices_20250601_CRUD(tc *testcommon.KubePerTestContext, storageAccount client.Object) {
...
func StorageAccount_FileServices_20250601_CRUD(tc *testcommon.KubePerTestContext, storageAccount client.Object) {
...
func Test_Storage_StorageAccount_20250601_SecretsFromAzure(t *testing.T) {
	t.Parallel()
	tc := globalTestContext.ForTest(t)
...
func StorageAccount_SecretsWrittenToSameKubeSecret20250601(tc *testcommon.KubePerTestContext, acct *storage.StorageAccount) {
	old := acct.DeepCopy()
...
func StorageAccount_SecretsWrittenToDifferentKubeSecrets20250601(tc *testcommon.KubePerTestContext, acct *storage.StorageAccount) {
	old := acct.DeepCopy()
	key1Secret := "secret1"
	key2Secret := "secret2"
	blobSecret := "secret3"
...
func StorageAccount_ConfigMapsWritten20250601(tc *testcommon.KubePerTestContext, acct *storage.StorageAccount) {
	old := acct.DeepCopy()
...
func newStorageAccount20250601(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup) *storage.StorageAccount {
