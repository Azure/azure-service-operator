...
func Test_Networking_RouteTable_20240301_CRUD(t *testing.T) {
	t.Parallel()
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				Routes_20240301_CRUD(tc, routeTable)
			},
		},
	)
...
func Routes_20240301_CRUD(tc *testcommon.KubePerTestContext, routeTable *network.RouteTable) {
...
func Test_Networking_Route_CreatedThenRouteTableUpdated_20240301_RouteStillExists(t *testing.T) {
	t.Parallel()
	tc := globalTestContext.ForTest(t)
	rg := tc.CreateTestResourceGroupAndWait()
