...
import (
	...
	servicebus "github.com/Azure/azure-service-operator/v2/api/servicebus/v20221001preview"
	"github.com/Azure/azure-service-operator/v2/internal/testcommon"
	"github.com/Azure/azure-service-operator/v2/pkg/genruntime"
)

func Test_ServiceBus_Namespace_Basic_v20221001preview_CRUD(t *testing.T) {
	t.Parallel()
	...
	namespace := NewServiceBusNamespace_v20221001preview(tc, rg, sku)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesQueue_v20221001preview_CRUD(tc, namespace)
			},
		},
	)
	...
	tc.RunSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Namespace_Secrets_v20221001preview(tc, namespace)
			},
		},
	)
...
func ServiceBus_NamespacesQueue_v20221001preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Namespace_Secrets_v20221001preview(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
