...
func Test_Networking_PublicIP_20250301_CRUD(t *testing.T) {
	t.Parallel()
	...
	publicIPAddress := newPublicIP20250301(tc, testcommon.AsOwner(rg))
...
func newPublicIP20250301(tc *testcommon.KubePerTestContext, owner *genruntime.KnownResourceReference) *network.PublicIPAddress {
	// Public IP Address
