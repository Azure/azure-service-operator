...
func Test_DBForMySQL_FlexibleServer_20250601preview_CRUD(t *testing.T) {
	t.Parallel()
	...
	flexibleServer, fqdnSecret := newFlexibleServer20250601preview(tc, rg, adminPasswordSecretRef)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Configuration_20250601preview_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers database CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Database_20250601preview_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers firewall CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_FirewallRule_20250601preview_CRUD(tc, flexibleServer)
			},
		},
	)
...
func MySQLFlexibleServer_Database_20250601preview_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_FirewallRule_20250601preview_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
