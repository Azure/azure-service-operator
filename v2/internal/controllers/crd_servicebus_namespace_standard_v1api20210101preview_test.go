...
func Test_ServiceBus_Namespace_Standard_v1api20210101preview_CRUD(t *testing.T) {
	...
	tc.RunParallelSubtests(
		...
		testcommon.Subtest{
			Name: "Topic CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopic_v1api20210101preview_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
...
func ServiceBus_NamespacesAuthorizationRule_v1api20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_NamespacesTopic_v1api20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopicsSubscription_v1api20210101preview_CRUD(tc, topic)
			},
		},
	)
}

func ServiceBus_NamespacesTopicsSubscription_v1api20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbTopic client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopicsSubscriptionsRule_v1api20210101preview_CRUD(tc, subscription)
			},
		},
	)
...
func ServiceBus_NamespacesTopicsSubscriptionsRule_v1api20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbSubscription client.Object) {
