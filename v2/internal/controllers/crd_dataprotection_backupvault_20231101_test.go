...
func newBackupVault20231101(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, name string) *dataprotection.BackupVault {
...
func Test_Dataprotection_Backupvault_20231101_CRUD(t *testing.T) {
