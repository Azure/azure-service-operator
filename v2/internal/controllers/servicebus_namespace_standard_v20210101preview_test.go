...
import (
	...
	servicebus "github.com/Azure/azure-service-operator/v2/api/servicebus/v20210101preview"
	"github.com/Azure/azure-service-operator/v2/internal/testcommon"
	"github.com/Azure/azure-service-operator/v2/pkg/genruntime"
)

func Test_ServiceBus_Namespace_Standard_v20210101preview_CRUD(t *testing.T) {
	t.Parallel()
	...
	namespace := NewServiceBusNamespace_v20210101preview(tc, rg, sku)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Queue_v20210101preview_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
			Name: "Topic CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopic_v20210101preview_CRUD(tc, namespace)
			},
		},
		testcommon.Subtest{
			Name: "AuthorizationRule CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesAuthorizationRule_v20210101preview_CRUD(tc, namespace)
			},
		},
	)
	...
	tc.RunSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_Namespace_Secrets_v20210101preview(tc, namespace)
			},
		},
	)
...
func NewServiceBusNamespace_v20210101preview(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, sku servicebus.SBSku_Name) *servicebus.Namespace {
	zoneRedundant := false
...
func ServiceBus_NamespacesAuthorizationRule_v20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_NamespacesTopic_v20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopicsSubscription_v20210101preview_CRUD(tc, topic)
			},
		},
	)
}

func ServiceBus_NamespacesTopicsSubscription_v20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbTopic client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				ServiceBus_NamespacesTopicsSubscriptionsRule_v20210101preview_CRUD(tc, subscription)
			},
		},
	)
...
func ServiceBus_NamespacesTopicsSubscriptionsRule_v20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbSubscription client.Object) {
