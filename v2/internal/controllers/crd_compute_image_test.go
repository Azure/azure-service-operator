...
import (
	...
	compute2020 "github.com/Azure/azure-service-operator/v2/api/compute/v1alpha1api20200930"
	compute2021 "github.com/Azure/azure-service-operator/v2/api/compute/v1alpha1api20210701"
...
func Test_Compute_Image_CRUD(t *testing.T) {
	...
	exists, retryAfter, err := tc.AzureClient.HeadByID(tc.Ctx, imageARMId, string(compute2021.ImagesSpecAPIVersion20210701))
