...
import (
	...
	mysql "github.com/Azure/azure-service-operator/v2/api/dbformysql/v20241230"
...
func Test_DBForMySQL_FlexibleServer_20241230_CRUD(t *testing.T) {
	t.Parallel()
	...
	flexibleServer, fqdnSecret := newFlexibleServer20241230(tc, rg, adminPasswordSecretRef)
	...
	tc.RunSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_AADAdmin_20241230_CRUD(tc, rg, flexibleServer)
			},
		},
	)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Configuration_20241230_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers database CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Database_20241230_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers firewall CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_FirewallRule_20241230_CRUD(tc, flexibleServer)
			},
		},
	)
...
func newFlexibleServer20241230(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, adminPasswordSecretRef genruntime.SecretReference) (*mysql.FlexibleServer, string) {
...
func MySQLFlexibleServer_Database_20241230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_FirewallRule_20241230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_AADAdmin_20241230_CRUD(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, server *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_Configuration_20241230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
	configuration := &mysql.FlexibleServersConfiguration{
		...
		Spec: mysql.FlexibleServersConfiguration_Spec{
			...
			Owner:     testcommon.AsOwner(flexibleServer),
			Source:    to.Ptr(mysql.ConfigurationSource_UserOverride),
			Value:     to.Ptr("20"),
		},
	}
