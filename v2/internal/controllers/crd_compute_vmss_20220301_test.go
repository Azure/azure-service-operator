...
func newVMSS20220301(
	...
	return &compute2022.VirtualMachineScaleSet{
		...
		Spec: compute2022.VirtualMachineScaleSet_Spec{
			...
			VirtualMachineProfile: &compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile{
				...
				OsProfile: &compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_OsProfile{
				...
				NetworkProfile: &compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_NetworkProfile{
					NetworkInterfaceConfigurations: []compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_NetworkProfile_NetworkInterfaceConfigurations{
						{
							Name:    to.StringPtr("mynicconfig"),
							Primary: to.BoolPtr(true),
							IpConfigurations: []compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_NetworkProfile_NetworkInterfaceConfigurations_Properties_IpConfigurations{
								{
...
func Test_Compute_VMSS_20220301_CRUD(t *testing.T) {
	...
	vmss.Spec.VirtualMachineProfile.ExtensionProfile = &compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_ExtensionProfile{
		Extensions: []compute2022.VirtualMachineScaleSet_Spec_Properties_VirtualMachineProfile_ExtensionProfile_Extensions{
			{
				Name:               &extensionName,
