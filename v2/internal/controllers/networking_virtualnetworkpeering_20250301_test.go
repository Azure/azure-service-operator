...
func Test_Networking_VirtualNetworkPeering_20250301_CRUD(t *testing.T) {
	t.Parallel()
	...
	vnet1 := newVNet20250301(tc, testcommon.AsOwner(rg), []string{"10.0.0.0/16"})
	vnet2 := newVNet20250301(tc, testcommon.AsOwner(rg), []string{"10.1.0.0/16"})
...
func Test_Networking_VirtualNetworkPeering_CreatedThenVNETUpdated_20250301_PeeringStillExists(t *testing.T) {
	t.Parallel()
