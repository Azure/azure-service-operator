...
func Test_DBForMySQL_FlexibleServer_20231230_CRUD(t *testing.T) {
	...
	tc.AzureRegion = to.Ptr("canadacentral")
	...
	flexibleServer, fqdnSecret := newFlexibleServer20231230(tc, rg, adminPasswordSecretRef)
	...
	tc.RunSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_AADAdmin_20231230_CRUD(tc, rg, flexibleServer)
			},
		},
	)
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Configuration_20231230_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers database CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_Database_20231230_CRUD(tc, flexibleServer)
			},
		},
		testcommon.Subtest{
			Name: "MySQL Flexible servers firewall CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				MySQLFlexibleServer_FirewallRule_20231230_CRUD(tc, flexibleServer)
			},
		},
	)
...
func MySQLFlexibleServer_Database_20231230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_FirewallRule_20231230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_AADAdmin_20231230_CRUD(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, server *mysql.FlexibleServer) {
...
func MySQLFlexibleServer_Configuration_20231230_CRUD(tc *testcommon.KubePerTestContext, flexibleServer *mysql.FlexibleServer) {
