...
func Test_ServiceBus_Namespace_Basic_v1api20240101_CRUD(t *testing.T) {
	t.Parallel()
...
func ServiceBus_NamespacesQueue_v1api20240101_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Namespace_Secrets_v1api20240101(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
