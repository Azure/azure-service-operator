...
func Test_ServiceBus_Namespace_Basic_v20211101_CRUD(t *testing.T) {
	t.Parallel()
...
func ServiceBus_Queue_v20211101_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Namespace_Secrets_v20211101(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
