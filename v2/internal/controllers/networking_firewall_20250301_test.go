...
func Test_Networking_Firewall_20250301_CRUD(t *testing.T) {
	t.Parallel()
	...
	publicIP := newPublicIP20250301(tc, testcommon.AsOwner(rg))
	subnet := newSubnet20250301(tc, vnet, "10.0.0.0/24")
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				FirewallPolicy_RuleCollectionGroup_20250301_CRUD(tc, firewallPolicy)
			},
		},
	)
...
func FirewallPolicy_RuleCollectionGroup_20250301_CRUD(tc *testcommon.KubePerTestContext, firewallPolicy *network.FirewallPolicy) {
