...
import (
	...
	containerservice_v20230701 "github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230701"
	containerservice_v20230701s "github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230701/storage"
...
func getKnownStorageTypes() []*registration.StorageType {
	...
	result = append(result, &registration.StorageType{
		Obj: new(containerservice_v20230701s.ManagedCluster),
		Indexes: []registration.Index{
			{
		...
		Watches: []registration.Watch{
			{
				Type:             &v1.Secret{},
				MakeEventHandler: watchSecretsFactory([]string{".spec.servicePrincipalProfile.secret"}, &containerservice_v20230701s.ManagedClusterList{}),
			},
		},
	})
	result = append(result, &registration.StorageType{Obj: new(containerservice_v20230701s.ManagedClustersAgentPool)})
...
func getKnownTypes() []client.Object {
	...
	result = append(result, new(containerservice_v20230701.ManagedCluster), new(containerservice_v20230701.ManagedClustersAgentPool))
	result = append(result, new(containerservice_v20230701s.ManagedCluster), new(containerservice_v20230701s.ManagedClustersAgentPool))
...
func createScheme() *runtime.Scheme {
	...
	_ = containerservice_v20230701.AddToScheme(scheme)
	_ = containerservice_v20230701s.AddToScheme(scheme)
...
// indexContainerserviceManagedClusterSecret an index function for containerservice_v20230701s.ManagedCluster .spec.servicePrincipalProfile.secret
func indexContainerserviceManagedClusterSecret(rawObj client.Object) []string {
	obj, ok := rawObj.(*containerservice_v20230701s.ManagedCluster)
	if !ok {
		return nil
	}
