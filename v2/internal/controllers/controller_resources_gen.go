...
import (
	authorizationextensions "github.com/Azure/azure-service-operator/v2/api/authorization/extensions"
	...
	batchextensions "github.com/Azure/azure-service-operator/v2/api/batch/extensions"
	...
	cacheextensions "github.com/Azure/azure-service-operator/v2/api/cache/extensions"
	...
	computeextensions "github.com/Azure/azure-service-operator/v2/api/compute/extensions"
	...
	containerserviceextensions "github.com/Azure/azure-service-operator/v2/api/containerservice/extensions"
	...
	dbformysqlextensions "github.com/Azure/azure-service-operator/v2/api/dbformysql/extensions"
	...
	dbforpostgresqlextensions "github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/extensions"
	...
	documentdbextensions "github.com/Azure/azure-service-operator/v2/api/documentdb/extensions"
	...
	eventgridextensions "github.com/Azure/azure-service-operator/v2/api/eventgrid/extensions"
	...
	eventhubextensions "github.com/Azure/azure-service-operator/v2/api/eventhub/extensions"
	...
	insightsextensions "github.com/Azure/azure-service-operator/v2/api/insights/extensions"
	...
	managedidentityextensions "github.com/Azure/azure-service-operator/v2/api/managedidentity/extensions"
	...
	networkextensions "github.com/Azure/azure-service-operator/v2/api/network/extensions"
	...
	operationalinsightsextensions "github.com/Azure/azure-service-operator/v2/api/operationalinsights/extensions"
	...
	servicebusextensions "github.com/Azure/azure-service-operator/v2/api/servicebus/extensions"
	...
	signalrserviceextensions "github.com/Azure/azure-service-operator/v2/api/signalrservice/extensions"
	...
	storageextensions "github.com/Azure/azure-service-operator/v2/api/storage/extensions"
...
// getResourceExtensions returns a list of Resource Extension types
func getResourceExtensions() []genruntime.ResourceExtension {
	...
	result = append(result, &cacheextensions.RedisEnterpriseDatabaseExtension{})
	result = append(result, &cacheextensions.RedisEnterpriseExtension{})
	result = append(result, &cacheextensions.RedisExtension{})
	result = append(result, &cacheextensions.RedisFirewallRuleExtension{})
	result = append(result, &cacheextensions.RedisLinkedServerExtension{})
	result = append(result, &cacheextensions.RedisPatchScheduleExtension{})
	result = append(result, &computeextensions.DiskExtension{})
	result = append(result, &computeextensions.VirtualMachineExtension{})
	result = append(result, &computeextensions.VirtualMachineScaleSetExtension{})
	result = append(result, &containerserviceextensions.ManagedClusterExtension{})
	result = append(result, &containerserviceextensions.ManagedClustersAgentPoolExtension{})
	result = append(result, &dbformysqlextensions.FlexibleServerExtension{})
	result = append(result, &dbformysqlextensions.FlexibleServersDatabaseExtension{})
	result = append(result, &dbformysqlextensions.FlexibleServersFirewallRuleExtension{})
	result = append(result, &dbforpostgresqlextensions.FlexibleServerExtension{})
	result = append(result, &dbforpostgresqlextensions.FlexibleServersConfigurationExtension{})
	result = append(result, &dbforpostgresqlextensions.FlexibleServersDatabaseExtension{})
	result = append(result, &dbforpostgresqlextensions.FlexibleServersFirewallRuleExtension{})
	result = append(result, &documentdbextensions.DatabaseAccountExtension{})
	result = append(result, &documentdbextensions.MongodbDatabaseCollectionExtension{})
	result = append(result, &documentdbextensions.MongodbDatabaseCollectionThroughputSettingExtension{})
	result = append(result, &documentdbextensions.MongodbDatabaseExtension{})
	result = append(result, &documentdbextensions.MongodbDatabaseThroughputSettingExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseContainerExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseContainerStoredProcedureExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseContainerThroughputSettingExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseContainerTriggerExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseContainerUserDefinedFunctionExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseExtension{})
	result = append(result, &documentdbextensions.SqlDatabaseThroughputSettingExtension{})
	result = append(result, &eventgridextensions.DomainExtension{})
	result = append(result, &eventgridextensions.DomainsTopicExtension{})
	result = append(result, &eventgridextensions.EventSubscriptionExtension{})
	result = append(result, &eventgridextensions.TopicExtension{})
	result = append(result, &eventhubextensions.NamespaceExtension{})
	result = append(result, &eventhubextensions.NamespacesAuthorizationRuleExtension{})
	result = append(result, &eventhubextensions.NamespacesEventhubExtension{})
	result = append(result, &eventhubextensions.NamespacesEventhubsAuthorizationRuleExtension{})
	result = append(result, &eventhubextensions.NamespacesEventhubsConsumerGroupExtension{})
	result = append(result, &insightsextensions.ComponentExtension{})
	result = append(result, &insightsextensions.WebtestExtension{})
	result = append(result, &managedidentityextensions.UserAssignedIdentityExtension{})
	result = append(result, &networkextensions.LoadBalancerExtension{})
	result = append(result, &networkextensions.NetworkInterfaceExtension{})
	result = append(result, &networkextensions.NetworkSecurityGroupExtension{})
	result = append(result, &networkextensions.NetworkSecurityGroupsSecurityRuleExtension{})
	result = append(result, &networkextensions.PublicIPAddressExtension{})
	result = append(result, &networkextensions.VirtualNetworkExtension{})
	result = append(result, &networkextensions.VirtualNetworkGatewayExtension{})
	result = append(result, &networkextensions.VirtualNetworksSubnetExtension{})
	result = append(result, &networkextensions.VirtualNetworksVirtualNetworkPeeringExtension{})
	result = append(result, &operationalinsightsextensions.WorkspaceExtension{})
	result = append(result, &servicebusextensions.NamespaceExtension{})
	result = append(result, &servicebusextensions.NamespacesQueueExtension{})
	result = append(result, &servicebusextensions.NamespacesTopicExtension{})
	result = append(result, &signalrserviceextensions.SignalRExtension{})
	result = append(result, &storageextensions.StorageAccountExtension{})
	result = append(result, &storageextensions.StorageAccountsBlobServiceExtension{})
	result = append(result, &storageextensions.StorageAccountsBlobServicesContainerExtension{})
	result = append(result, &storageextensions.StorageAccountsQueueServiceExtension{})
	result = append(result, &storageextensions.StorageAccountsQueueServicesQueueExtension{})
	return result
}
