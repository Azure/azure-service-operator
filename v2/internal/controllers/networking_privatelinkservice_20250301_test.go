...
import (
	...
	network20250301 "github.com/Azure/azure-service-operator/v2/api/network/v20250301"
...
func Test_Networking_PrivateLinkService_20250301_CRUD(t *testing.T) {
	t.Parallel()
	...
	subnet := newVMSubnet20250301(tc, testcommon.AsOwner(vnet))
	subnet.Spec.PrivateLinkServiceNetworkPolicies = &privateLinkServiceNetworkPolicies

	lb, frontendIPConfigurationARMID := newLoadBalancerForPLS20250301(tc, rg, subnet)
...
func newLoadBalancerForPLS20250301(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, subnet *network.VirtualNetworksSubnet) (*network.LoadBalancer, string) {
	ipAllocationMethod := network.IPAllocationMethod_Dynamic
	// LoadBalancer
...
func newVMSubnet20250301(tc *testcommon.KubePerTestContext, owner *genruntime.KnownResourceReference) *network20250301.VirtualNetworksSubnet {
