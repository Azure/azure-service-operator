...
func Test_DocumentDB_SQLDatabase_v20240815_CRUD(t *testing.T) {
	t.Parallel()
...
func CosmosDB_SQL_Container_v20240815_CRUD(tc *testcommon.KubePerTestContext, db client.Object) {
	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				CosmosDB_SQL_Trigger_v20240815_CRUD(tc, &container)
			},
		},
		testcommon.Subtest{
			Name: "CosmosDB SQL Stored Procedure CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				CosmosDB_SQL_StoredProcedure_v20240815_CRUD(tc, &container)
			},
		},
		testcommon.Subtest{
			Name: "CosmosDB SQL User-defined Function CRUD",
			Test: func(tc *testcommon.KubePerTestContext) {
				CosmosDB_SQL_UserDefinedFunction_v20240815_CRUD(tc, &container)
			},
		},
		testcommon.Subtest{
...
func CosmosDB_SQL_Trigger_v20240815_CRUD(tc *testcommon.KubePerTestContext, container client.Object) {
	...
	trigger := documentdb.SqlDatabaseContainerTrigger{
		...
		Spec: documentdb.SqlDatabaseContainerTrigger_Spec{
			...
			Resource: &documentdb.SqlTriggerResource{
				...
				Body:             to.Ptr(triggerBody_v20240815),
			},
		},
	}
...
func CosmosDB_SQL_StoredProcedure_v20240815_CRUD(tc *testcommon.KubePerTestContext, container client.Object) {
	...
	storedProcedure := documentdb.SqlDatabaseContainerStoredProcedure{
		...
		Spec: documentdb.SqlDatabaseContainerStoredProcedure_Spec{
			...
			Resource: &documentdb.SqlStoredProcedureResource{
				Id:   &name,
				Body: to.Ptr(storedProcedureBody_v20240815),
			},
		},
	}
...
const storedProcedureBody_v20240815 = `
function () {
    var context = getContext();
...
func CosmosDB_SQL_UserDefinedFunction_v20240815_CRUD(tc *testcommon.KubePerTestContext, container client.Object) {
	...
	userDefinedFunction := documentdb.SqlDatabaseContainerUserDefinedFunction{
		...
		Spec: documentdb.SqlDatabaseContainerUserDefinedFunction_Spec{
			...
			Resource: &documentdb.SqlUserDefinedFunctionResource{
				Id:   &name,
				Body: to.Ptr(userDefinedFunctionBody_v20240815),
			},
		},
	}
...
const userDefinedFunctionBody_v20240815 = `
function tax(income) {
    if (income == undefined)
        throw 'no input';
    if (income < 1000)
...
func CosmosDB_SQL_Database_ThroughputSettings_v20240815_CRUD(tc *testcommon.KubePerTestContext, db client.Object) {
...
func CosmosDB_SQL_Database_Container_ThroughputSettings_v20240815_CRUD(tc *testcommon.KubePerTestContext, container client.Object) {
...
func CosmosDB_SQL_RoleAssignment_v20240815_CRUD(tc *testcommon.KubePerTestContext, rg *resources.ResourceGroup, acct *documentdb.DatabaseAccount) {
