...
func Test_ServiceBus_Namespace_Basic_v20210101preview_CRUD(t *testing.T) {
	t.Parallel()
...
func ServiceBus_Queue_v20210101preview_CRUD(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
...
func ServiceBus_Namespace_Secrets_v20210101preview(tc *testcommon.KubePerTestContext, sbNamespace client.Object) {
