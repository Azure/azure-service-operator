	...
	tc.RunParallelSubtests(
		testcommon.Subtest{
			...
			Test: func(tc *testcommon.KubePerTestContext) {
				AKS_ManagedCluster_AgentPool_20260501_CRUD(tc, cluster)
			},
		},
	)
...
func AKS_ManagedCluster_AgentPool_20260501_CRUD(tc *testcommon.KubePerTestContext, cluster *aks.ManagedCluster) {
