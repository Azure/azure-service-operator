...
func (r *AzureSQLUserReconciler) CreateOrUpdate(ctx context.Context, log logr.Logger, eventRecorder record.EventRecorder, obj genruntime.MetaObject, _ annotations.ReconcilePolicies) (ctrl.Result, error) {
...
func (r *AzureSQLUserReconciler) UpdateStatus(ctx context.Context, log logr.Logger, eventRecorder record.EventRecorder, obj genruntime.MetaObject, _ annotations.ReconcilePolicies) error {
	user, err := r.asUser(obj)
	if err != nil {
		return err
	}
