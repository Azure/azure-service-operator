...
func TestGoldenInjectOriginalVersionProperty_InjectsIntoSpec(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestGoldenInjectOriginalVersionProperty_WhenOriginalVersionFunctionFound_DoesNotInjectIntoSpec(t *testing.T) {
	g := NewGomegaWithT(t)
