...
func TestGoldenInjectHubFunction_WhenResourceIsStorageVersion_GeneratesExpectedFile(t *testing.T) {
	g := NewGomegaWithT(t)
...
func TestGoldenInjectHubFunction_WhenResourceIsNotStorageVersion_GeneratesExpectedFile(t *testing.T) {
	g := NewGomegaWithT(t)
