...
// +kubebuilder:validation:Enum={"Creating","Deleting","Disabled","Failed","Linking","Provisioning","RecoveringScaleFailure","Scaling","Succeeded","Unlinking","Unprovisioning","Updating"}
...
//Generated from:
// +kubebuilder:validation:Enum={"Creating","Deleting","Failed","Succeeded"}
