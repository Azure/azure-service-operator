...
require (
	...
	github.com/google/cel-go v0.21.1-0.20241015195842-2a010f9960b1 // This is pinned to the commit for https://github.com/google/cel-go/pull/1009, we should update to an official release when we can
