...
// +kubebuilder:webhook:path=/mutate-dataprotection-azure-com-v20231101-backupvaultsbackupinstance,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaultsbackupinstances,verbs=create;update,versions=v20231101,name=default.v20231101.backupvaultsbackupinstances.dataprotection.azure.com,admissionReviewVersions=v1
...
func (instance *BackupVaultsBackupInstance) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dataprotection/v20231101/BackupVaultsBackupInstance, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-dataprotection-azure-com-v20231101-backupvaultsbackupinstance,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaultsbackupinstances,verbs=create;update,versions=v20231101,name=validate.v20231101.backupvaultsbackupinstances.dataprotection.azure.com,admissionReviewVersions=v1
...
func (instance *BackupVaultsBackupInstance) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dataprotection/v20231101/BackupVaultsBackupInstance, but got %T", resource)
	}
...
func (instance *BackupVaultsBackupInstance) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dataprotection/v20231101/BackupVaultsBackupInstance, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20231101.BackupVaultsBackupInstance)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dataprotection/v20231101/BackupVaultsBackupInstance, but got %T", oldResource)
	}
