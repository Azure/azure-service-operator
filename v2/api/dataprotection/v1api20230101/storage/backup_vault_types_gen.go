...
func (vault *BackupVault) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20231201s.BackupVault)
	if !ok {
		return fmt.Errorf("expected dataprotection/v1api20231201/storage/BackupVault but received %T instead", hub)
	}
...
func (vault *BackupVault) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20231201s.BackupVault)
	if !ok {
		return fmt.Errorf("expected dataprotection/v1api20231201/storage/BackupVault but received %T instead", hub)
	}
...
func (vault *BackupVault) AssignProperties_From_BackupVault(source *v20231201s.BackupVault) error {
...
func (vault *BackupVault) AssignProperties_To_BackupVault(destination *v20231201s.BackupVault) error {

	// ObjectMeta
	destination.ObjectMeta = *vault.ObjectMeta.DeepCopy()

	// Spec
	var spec v20231201s.BackupVault_Spec
	...
	// Status
	var status v20231201s.BackupVaultResource_STATUS
...
type augmentConversionForBackupVault interface {
	AssignPropertiesFrom(src *v20231201s.BackupVault) error
	AssignPropertiesTo(dst *v20231201s.BackupVault) error
}
...
func (vault *BackupVault_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20231201s.BackupVault_Spec)
	if ok {
	...
	src = &v20231201s.BackupVault_Spec{}
...
func (vault *BackupVault_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20231201s.BackupVault_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20231201s.BackupVault_Spec{}
...
func (vault *BackupVault_Spec) AssignProperties_From_BackupVault_Spec(source *v20231201s.BackupVault_Spec) error {
...
func (vault *BackupVault_Spec) AssignProperties_To_BackupVault_Spec(destination *v20231201s.BackupVault_Spec) error {
	// Clone the existing property bag
	...
	if vault.Identity != nil {
		var identity v20231201s.DppIdentityDetails
	...
	if vault.OperatorSpec != nil {
		var operatorSpec v20231201s.BackupVaultOperatorSpec
	...
	if vault.Properties != nil {
		var property v20231201s.BackupVaultSpec
...
func (resource *BackupVaultResource_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20231201s.BackupVaultResource_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20231201s.BackupVaultResource_STATUS{}
...
func (resource *BackupVaultResource_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20231201s.BackupVaultResource_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20231201s.BackupVaultResource_STATUS{}
...
func (resource *BackupVaultResource_STATUS) AssignProperties_From_BackupVaultResource_STATUS(source *v20231201s.BackupVaultResource_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (resource *BackupVaultResource_STATUS) AssignProperties_To_BackupVaultResource_STATUS(destination *v20231201s.BackupVaultResource_STATUS) error {
	// Clone the existing property bag
	...
	if resource.Identity != nil {
		var identity v20231201s.DppIdentityDetails_STATUS
	...
	if resource.Properties != nil {
		var property v20231201s.BackupVault_STATUS
...
type augmentConversionForBackupVault_Spec interface {
	AssignPropertiesFrom(src *v20231201s.BackupVault_Spec) error
	AssignPropertiesTo(dst *v20231201s.BackupVault_Spec) error
}

type augmentConversionForBackupVaultResource_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.BackupVaultResource_STATUS) error
	AssignPropertiesTo(dst *v20231201s.BackupVaultResource_STATUS) error
}
...
func (vault *BackupVault_STATUS) AssignProperties_From_BackupVault_STATUS(source *v20231201s.BackupVault_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (vault *BackupVault_STATUS) AssignProperties_To_BackupVault_STATUS(destination *v20231201s.BackupVault_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(vault.PropertyBag)

	// FeatureSettings
	if vault.FeatureSettings != nil {
		var featureSetting v20231201s.FeatureSettings_STATUS
	...
	if vault.MonitoringSettings != nil {
		var monitoringSetting v20231201s.MonitoringSettings_STATUS
	...
	if vault.ResourceMoveDetails != nil {
		var resourceMoveDetail v20231201s.ResourceMoveDetails_STATUS
	...
	if vault.SecuritySettings != nil {
		var securitySetting v20231201s.SecuritySettings_STATUS
	...
	if vault.StorageSettings != nil {
		storageSettingList := make([]v20231201s.StorageSetting_STATUS, len(vault.StorageSettings))
		for storageSettingIndex, storageSettingItem := range vault.StorageSettings {
			// Shadow the loop variable to avoid aliasing
			storageSettingItem := storageSettingItem
			var storageSetting v20231201s.StorageSetting_STATUS
...
func (operator *BackupVaultOperatorSpec) AssignProperties_From_BackupVaultOperatorSpec(source *v20231201s.BackupVaultOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *BackupVaultOperatorSpec) AssignProperties_To_BackupVaultOperatorSpec(destination *v20231201s.BackupVaultOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(operator.PropertyBag)

	// ConfigMaps
	if operator.ConfigMaps != nil {
		var configMap v20231201s.BackupVaultOperatorConfigMaps
...
func (vault *BackupVaultSpec) AssignProperties_From_BackupVaultSpec(source *v20231201s.BackupVaultSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (vault *BackupVaultSpec) AssignProperties_To_BackupVaultSpec(destination *v20231201s.BackupVaultSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(vault.PropertyBag)

	// FeatureSettings
	if vault.FeatureSettings != nil {
		var featureSetting v20231201s.FeatureSettings
	...
	// MonitoringSettings
	if vault.MonitoringSettings != nil {
		var monitoringSetting v20231201s.MonitoringSettings
	...
	// SecuritySettings
	if vault.SecuritySettings != nil {
		var securitySetting v20231201s.SecuritySettings
	...
	// StorageSettings
	if vault.StorageSettings != nil {
		storageSettingList := make([]v20231201s.StorageSetting, len(vault.StorageSettings))
		for storageSettingIndex, storageSettingItem := range vault.StorageSettings {
			// Shadow the loop variable to avoid aliasing
			storageSettingItem := storageSettingItem
			var storageSetting v20231201s.StorageSetting
...
func (details *DppIdentityDetails) AssignProperties_From_DppIdentityDetails(source *v20231201s.DppIdentityDetails) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *DppIdentityDetails) AssignProperties_To_DppIdentityDetails(destination *v20231201s.DppIdentityDetails) error {
	// Clone the existing property bag
	...
	if propertyBag.Contains("UserAssignedIdentities") {
		var userAssignedIdentity []v20231201s.UserAssignedIdentityDetails
...
func (details *DppIdentityDetails_STATUS) AssignProperties_From_DppIdentityDetails_STATUS(source *v20231201s.DppIdentityDetails_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *DppIdentityDetails_STATUS) AssignProperties_To_DppIdentityDetails_STATUS(destination *v20231201s.DppIdentityDetails_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(details.PropertyBag)
	...
	// UserAssignedIdentities
	if propertyBag.Contains("UserAssignedIdentities") {
		var userAssignedIdentity map[string]v20231201s.UserAssignedIdentity_STATUS
		err := propertyBag.Pull("UserAssignedIdentities", &userAssignedIdentity)
		if err != nil {
			return errors.Wrap(err, "pulling 'UserAssignedIdentities' from propertyBag")
		}
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20231201s.SystemData_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20231201s.SystemData_STATUS) error {
	// Clone the existing property bag
...
type augmentConversionForBackupVault_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.BackupVault_STATUS) error
	AssignPropertiesTo(dst *v20231201s.BackupVault_STATUS) error
}

type augmentConversionForBackupVaultOperatorSpec interface {
	AssignPropertiesFrom(src *v20231201s.BackupVaultOperatorSpec) error
	AssignPropertiesTo(dst *v20231201s.BackupVaultOperatorSpec) error
}

type augmentConversionForBackupVaultSpec interface {
	AssignPropertiesFrom(src *v20231201s.BackupVaultSpec) error
	AssignPropertiesTo(dst *v20231201s.BackupVaultSpec) error
}

type augmentConversionForDppIdentityDetails interface {
	AssignPropertiesFrom(src *v20231201s.DppIdentityDetails) error
	AssignPropertiesTo(dst *v20231201s.DppIdentityDetails) error
}

type augmentConversionForDppIdentityDetails_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.DppIdentityDetails_STATUS) error
	AssignPropertiesTo(dst *v20231201s.DppIdentityDetails_STATUS) error
}

type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20231201s.SystemData_STATUS) error
}
...
func (maps *BackupVaultOperatorConfigMaps) AssignProperties_From_BackupVaultOperatorConfigMaps(source *v20231201s.BackupVaultOperatorConfigMaps) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (maps *BackupVaultOperatorConfigMaps) AssignProperties_To_BackupVaultOperatorConfigMaps(destination *v20231201s.BackupVaultOperatorConfigMaps) error {
	// Clone the existing property bag
...
func (settings *FeatureSettings) AssignProperties_From_FeatureSettings(source *v20231201s.FeatureSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *FeatureSettings) AssignProperties_To_FeatureSettings(destination *v20231201s.FeatureSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// CrossRegionRestoreSettings
	if propertyBag.Contains("CrossRegionRestoreSettings") {
		var crossRegionRestoreSetting v20231201s.CrossRegionRestoreSettings
	...
	if settings.CrossSubscriptionRestoreSettings != nil {
		var crossSubscriptionRestoreSetting v20231201s.CrossSubscriptionRestoreSettings
...
func (settings *FeatureSettings_STATUS) AssignProperties_From_FeatureSettings_STATUS(source *v20231201s.FeatureSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *FeatureSettings_STATUS) AssignProperties_To_FeatureSettings_STATUS(destination *v20231201s.FeatureSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// CrossRegionRestoreSettings
	if propertyBag.Contains("CrossRegionRestoreSettings") {
		var crossRegionRestoreSetting v20231201s.CrossRegionRestoreSettings_STATUS
		err := propertyBag.Pull("CrossRegionRestoreSettings", &crossRegionRestoreSetting)
		if err != nil {
			return errors.Wrap(err, "pulling 'CrossRegionRestoreSettings' from propertyBag")
		}
	...
	// CrossSubscriptionRestoreSettings
	if settings.CrossSubscriptionRestoreSettings != nil {
		var crossSubscriptionRestoreSetting v20231201s.CrossSubscriptionRestoreSettings_STATUS
...
func (settings *MonitoringSettings) AssignProperties_From_MonitoringSettings(source *v20231201s.MonitoringSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *MonitoringSettings) AssignProperties_To_MonitoringSettings(destination *v20231201s.MonitoringSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// AzureMonitorAlertSettings
	if settings.AzureMonitorAlertSettings != nil {
		var azureMonitorAlertSetting v20231201s.AzureMonitorAlertSettings
...
func (settings *MonitoringSettings_STATUS) AssignProperties_From_MonitoringSettings_STATUS(source *v20231201s.MonitoringSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *MonitoringSettings_STATUS) AssignProperties_To_MonitoringSettings_STATUS(destination *v20231201s.MonitoringSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// AzureMonitorAlertSettings
	if settings.AzureMonitorAlertSettings != nil {
		var azureMonitorAlertSetting v20231201s.AzureMonitorAlertSettings_STATUS
...
func (details *ResourceMoveDetails_STATUS) AssignProperties_From_ResourceMoveDetails_STATUS(source *v20231201s.ResourceMoveDetails_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *ResourceMoveDetails_STATUS) AssignProperties_To_ResourceMoveDetails_STATUS(destination *v20231201s.ResourceMoveDetails_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(details.PropertyBag)
...
func (settings *SecuritySettings) AssignProperties_From_SecuritySettings(source *v20231201s.SecuritySettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *SecuritySettings) AssignProperties_To_SecuritySettings(destination *v20231201s.SecuritySettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// ImmutabilitySettings
	if settings.ImmutabilitySettings != nil {
		var immutabilitySetting v20231201s.ImmutabilitySettings
	...
	if settings.SoftDeleteSettings != nil {
		var softDeleteSetting v20231201s.SoftDeleteSettings
...
func (settings *SecuritySettings_STATUS) AssignProperties_From_SecuritySettings_STATUS(source *v20231201s.SecuritySettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *SecuritySettings_STATUS) AssignProperties_To_SecuritySettings_STATUS(destination *v20231201s.SecuritySettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)

	// ImmutabilitySettings
	if settings.ImmutabilitySettings != nil {
		var immutabilitySetting v20231201s.ImmutabilitySettings_STATUS
	...
	// SoftDeleteSettings
	if settings.SoftDeleteSettings != nil {
		var softDeleteSetting v20231201s.SoftDeleteSettings_STATUS
...
func (setting *StorageSetting) AssignProperties_From_StorageSetting(source *v20231201s.StorageSetting) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (setting *StorageSetting) AssignProperties_To_StorageSetting(destination *v20231201s.StorageSetting) error {
	// Clone the existing property bag
...
func (setting *StorageSetting_STATUS) AssignProperties_From_StorageSetting_STATUS(source *v20231201s.StorageSetting_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (setting *StorageSetting_STATUS) AssignProperties_To_StorageSetting_STATUS(destination *v20231201s.StorageSetting_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(setting.PropertyBag)
...
type augmentConversionForBackupVaultOperatorConfigMaps interface {
	AssignPropertiesFrom(src *v20231201s.BackupVaultOperatorConfigMaps) error
	AssignPropertiesTo(dst *v20231201s.BackupVaultOperatorConfigMaps) error
}

type augmentConversionForFeatureSettings interface {
	AssignPropertiesFrom(src *v20231201s.FeatureSettings) error
	AssignPropertiesTo(dst *v20231201s.FeatureSettings) error
}

type augmentConversionForFeatureSettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.FeatureSettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.FeatureSettings_STATUS) error
}

type augmentConversionForMonitoringSettings interface {
	AssignPropertiesFrom(src *v20231201s.MonitoringSettings) error
	AssignPropertiesTo(dst *v20231201s.MonitoringSettings) error
}

type augmentConversionForMonitoringSettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.MonitoringSettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.MonitoringSettings_STATUS) error
}

type augmentConversionForResourceMoveDetails_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.ResourceMoveDetails_STATUS) error
	AssignPropertiesTo(dst *v20231201s.ResourceMoveDetails_STATUS) error
}

type augmentConversionForSecuritySettings interface {
	AssignPropertiesFrom(src *v20231201s.SecuritySettings) error
	AssignPropertiesTo(dst *v20231201s.SecuritySettings) error
}

type augmentConversionForSecuritySettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.SecuritySettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.SecuritySettings_STATUS) error
}

type augmentConversionForStorageSetting interface {
	AssignPropertiesFrom(src *v20231201s.StorageSetting) error
	AssignPropertiesTo(dst *v20231201s.StorageSetting) error
}

type augmentConversionForStorageSetting_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.StorageSetting_STATUS) error
	AssignPropertiesTo(dst *v20231201s.StorageSetting_STATUS) error
}
...
func (settings *AzureMonitorAlertSettings) AssignProperties_From_AzureMonitorAlertSettings(source *v20231201s.AzureMonitorAlertSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *AzureMonitorAlertSettings) AssignProperties_To_AzureMonitorAlertSettings(destination *v20231201s.AzureMonitorAlertSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *AzureMonitorAlertSettings_STATUS) AssignProperties_From_AzureMonitorAlertSettings_STATUS(source *v20231201s.AzureMonitorAlertSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *AzureMonitorAlertSettings_STATUS) AssignProperties_To_AzureMonitorAlertSettings_STATUS(destination *v20231201s.AzureMonitorAlertSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *CrossSubscriptionRestoreSettings) AssignProperties_From_CrossSubscriptionRestoreSettings(source *v20231201s.CrossSubscriptionRestoreSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *CrossSubscriptionRestoreSettings) AssignProperties_To_CrossSubscriptionRestoreSettings(destination *v20231201s.CrossSubscriptionRestoreSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *CrossSubscriptionRestoreSettings_STATUS) AssignProperties_From_CrossSubscriptionRestoreSettings_STATUS(source *v20231201s.CrossSubscriptionRestoreSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *CrossSubscriptionRestoreSettings_STATUS) AssignProperties_To_CrossSubscriptionRestoreSettings_STATUS(destination *v20231201s.CrossSubscriptionRestoreSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *ImmutabilitySettings) AssignProperties_From_ImmutabilitySettings(source *v20231201s.ImmutabilitySettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *ImmutabilitySettings) AssignProperties_To_ImmutabilitySettings(destination *v20231201s.ImmutabilitySettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *ImmutabilitySettings_STATUS) AssignProperties_From_ImmutabilitySettings_STATUS(source *v20231201s.ImmutabilitySettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *ImmutabilitySettings_STATUS) AssignProperties_To_ImmutabilitySettings_STATUS(destination *v20231201s.ImmutabilitySettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *SoftDeleteSettings) AssignProperties_From_SoftDeleteSettings(source *v20231201s.SoftDeleteSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *SoftDeleteSettings) AssignProperties_To_SoftDeleteSettings(destination *v20231201s.SoftDeleteSettings) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
func (settings *SoftDeleteSettings_STATUS) AssignProperties_From_SoftDeleteSettings_STATUS(source *v20231201s.SoftDeleteSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (settings *SoftDeleteSettings_STATUS) AssignProperties_To_SoftDeleteSettings_STATUS(destination *v20231201s.SoftDeleteSettings_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(settings.PropertyBag)
...
type augmentConversionForAzureMonitorAlertSettings interface {
	AssignPropertiesFrom(src *v20231201s.AzureMonitorAlertSettings) error
	AssignPropertiesTo(dst *v20231201s.AzureMonitorAlertSettings) error
}

type augmentConversionForAzureMonitorAlertSettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.AzureMonitorAlertSettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.AzureMonitorAlertSettings_STATUS) error
}

type augmentConversionForCrossSubscriptionRestoreSettings interface {
	AssignPropertiesFrom(src *v20231201s.CrossSubscriptionRestoreSettings) error
	AssignPropertiesTo(dst *v20231201s.CrossSubscriptionRestoreSettings) error
}

type augmentConversionForCrossSubscriptionRestoreSettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.CrossSubscriptionRestoreSettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.CrossSubscriptionRestoreSettings_STATUS) error
}

type augmentConversionForImmutabilitySettings interface {
	AssignPropertiesFrom(src *v20231201s.ImmutabilitySettings) error
	AssignPropertiesTo(dst *v20231201s.ImmutabilitySettings) error
}

type augmentConversionForImmutabilitySettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.ImmutabilitySettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.ImmutabilitySettings_STATUS) error
}

type augmentConversionForSoftDeleteSettings interface {
	AssignPropertiesFrom(src *v20231201s.SoftDeleteSettings) error
	AssignPropertiesTo(dst *v20231201s.SoftDeleteSettings) error
}

type augmentConversionForSoftDeleteSettings_STATUS interface {
	AssignPropertiesFrom(src *v20231201s.SoftDeleteSettings_STATUS) error
	AssignPropertiesTo(dst *v20231201s.SoftDeleteSettings_STATUS) error
}
