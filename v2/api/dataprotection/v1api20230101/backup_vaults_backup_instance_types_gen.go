...
func (instance *BackupVaultsBackupInstance) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20230101s.BackupVaultsBackupInstance)
	if !ok {
		return fmt.Errorf("expected dataprotection/v1api20230101/storage/BackupVaultsBackupInstance but received %T instead", hub)
	}
...
func (instance *BackupVaultsBackupInstance) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20230101s.BackupVaultsBackupInstance)
	if !ok {
		return fmt.Errorf("expected dataprotection/v1api20230101/storage/BackupVaultsBackupInstance but received %T instead", hub)
	}
...
func (instance *BackupVaultsBackupInstance) AssignProperties_From_BackupVaultsBackupInstance(source *v20230101s.BackupVaultsBackupInstance) error {
...
func (instance *BackupVaultsBackupInstance) AssignProperties_To_BackupVaultsBackupInstance(destination *v20230101s.BackupVaultsBackupInstance) error {

	// ObjectMeta
	destination.ObjectMeta = *instance.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230101s.BackupVaults_BackupInstance_Spec
	...
	// Status
	var status v20230101s.BackupVaults_BackupInstance_STATUS
...
func (instance *BackupVaults_BackupInstance_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230101s.BackupVaults_BackupInstance_Spec)
	if ok {
	...
	src = &v20230101s.BackupVaults_BackupInstance_Spec{}
...
func (instance *BackupVaults_BackupInstance_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230101s.BackupVaults_BackupInstance_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230101s.BackupVaults_BackupInstance_Spec{}
...
func (instance *BackupVaults_BackupInstance_Spec) AssignProperties_From_BackupVaults_BackupInstance_Spec(source *v20230101s.BackupVaults_BackupInstance_Spec) error {
...
func (instance *BackupVaults_BackupInstance_Spec) AssignProperties_To_BackupVaults_BackupInstance_Spec(destination *v20230101s.BackupVaults_BackupInstance_Spec) error {
	...
	// Properties
	if instance.Properties != nil {
		var property v20230101s.BackupInstance
...
func (instance *BackupVaults_BackupInstance_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230101s.BackupVaults_BackupInstance_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230101s.BackupVaults_BackupInstance_STATUS{}
...
func (instance *BackupVaults_BackupInstance_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230101s.BackupVaults_BackupInstance_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230101s.BackupVaults_BackupInstance_STATUS{}
...
func (instance *BackupVaults_BackupInstance_STATUS) AssignProperties_From_BackupVaults_BackupInstance_STATUS(source *v20230101s.BackupVaults_BackupInstance_STATUS) error {
...
func (instance *BackupVaults_BackupInstance_STATUS) AssignProperties_To_BackupVaults_BackupInstance_STATUS(destination *v20230101s.BackupVaults_BackupInstance_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Properties
	if instance.Properties != nil {
		var property v20230101s.BackupInstance_STATUS
...
func (instance *BackupInstance) AssignProperties_From_BackupInstance(source *v20230101s.BackupInstance) error {
...
func (instance *BackupInstance) AssignProperties_To_BackupInstance(destination *v20230101s.BackupInstance) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DataSourceInfo
	if instance.DataSourceInfo != nil {
		var dataSourceInfo v20230101s.Datasource
	...
	// DataSourceSetInfo
	if instance.DataSourceSetInfo != nil {
		var dataSourceSetInfo v20230101s.DatasourceSet
	...
	// DatasourceAuthCredentials
	if instance.DatasourceAuthCredentials != nil {
		var datasourceAuthCredential v20230101s.AuthCredentials
	...
	// PolicyInfo
	if instance.PolicyInfo != nil {
		var policyInfo v20230101s.PolicyInfo
...
func (instance *BackupInstance_STATUS) AssignProperties_From_BackupInstance_STATUS(source *v20230101s.BackupInstance_STATUS) error {
...
func (instance *BackupInstance_STATUS) AssignProperties_To_BackupInstance_STATUS(destination *v20230101s.BackupInstance_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// DataSourceInfo
	if instance.DataSourceInfo != nil {
		var dataSourceInfo v20230101s.Datasource_STATUS
	...
	// DataSourceSetInfo
	if instance.DataSourceSetInfo != nil {
		var dataSourceSetInfo v20230101s.DatasourceSet_STATUS
	...
	// DatasourceAuthCredentials
	if instance.DatasourceAuthCredentials != nil {
		var datasourceAuthCredential v20230101s.AuthCredentials_STATUS
	...
	// PolicyInfo
	if instance.PolicyInfo != nil {
		var policyInfo v20230101s.PolicyInfo_STATUS
	...
	if instance.ProtectionErrorDetails != nil {
		var protectionErrorDetail v20230101s.UserFacingError_STATUS
	...
	if instance.ProtectionStatus != nil {
		var protectionStatus v20230101s.ProtectionStatusDetails_STATUS
...
func (credentials *AuthCredentials) AssignProperties_From_AuthCredentials(source *v20230101s.AuthCredentials) error {
...
func (credentials *AuthCredentials) AssignProperties_To_AuthCredentials(destination *v20230101s.AuthCredentials) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// SecretStoreBasedAuthCredentials
	if credentials.SecretStoreBasedAuthCredentials != nil {
		var secretStoreBasedAuthCredential v20230101s.SecretStoreBasedAuthCredentials
...
func (credentials *AuthCredentials_STATUS) AssignProperties_From_AuthCredentials_STATUS(source *v20230101s.AuthCredentials_STATUS) error {
...
func (credentials *AuthCredentials_STATUS) AssignProperties_To_AuthCredentials_STATUS(destination *v20230101s.AuthCredentials_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// SecretStoreBasedAuthCredentials
	if credentials.SecretStoreBasedAuthCredentials != nil {
		var secretStoreBasedAuthCredential v20230101s.SecretStoreBasedAuthCredentials_STATUS
...
func (datasource *Datasource) AssignProperties_From_Datasource(source *v20230101s.Datasource) error {
...
func (datasource *Datasource) AssignProperties_To_Datasource(destination *v20230101s.Datasource) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (datasource *Datasource_STATUS) AssignProperties_From_Datasource_STATUS(source *v20230101s.Datasource_STATUS) error {
...
func (datasource *Datasource_STATUS) AssignProperties_To_Datasource_STATUS(destination *v20230101s.Datasource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (datasourceSet *DatasourceSet) AssignProperties_From_DatasourceSet(source *v20230101s.DatasourceSet) error {
...
func (datasourceSet *DatasourceSet) AssignProperties_To_DatasourceSet(destination *v20230101s.DatasourceSet) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (datasourceSet *DatasourceSet_STATUS) AssignProperties_From_DatasourceSet_STATUS(source *v20230101s.DatasourceSet_STATUS) error {
...
func (datasourceSet *DatasourceSet_STATUS) AssignProperties_To_DatasourceSet_STATUS(destination *v20230101s.DatasourceSet_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (info *PolicyInfo) AssignProperties_To_PolicyInfo(destination *v20230101s.PolicyInfo) error {
	...
	// PolicyParameters
	if info.PolicyParameters != nil {
		var policyParameter v20230101s.PolicyParameters
...
func (info *PolicyInfo_STATUS) AssignProperties_From_PolicyInfo_STATUS(source *v20230101s.PolicyInfo_STATUS) error {
...
func (info *PolicyInfo_STATUS) AssignProperties_To_PolicyInfo_STATUS(destination *v20230101s.PolicyInfo_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// PolicyParameters
	if info.PolicyParameters != nil {
		var policyParameter v20230101s.PolicyParameters_STATUS
...
func (details *ProtectionStatusDetails_STATUS) AssignProperties_From_ProtectionStatusDetails_STATUS(source *v20230101s.ProtectionStatusDetails_STATUS) error {
...
func (details *ProtectionStatusDetails_STATUS) AssignProperties_To_ProtectionStatusDetails_STATUS(destination *v20230101s.ProtectionStatusDetails_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ErrorDetails
	if details.ErrorDetails != nil {
		var errorDetail v20230101s.UserFacingError_STATUS
...
func (error *UserFacingError_STATUS) AssignProperties_From_UserFacingError_STATUS(source *v20230101s.UserFacingError_STATUS) error {
...
func (error *UserFacingError_STATUS) AssignProperties_To_UserFacingError_STATUS(destination *v20230101s.UserFacingError_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if error.Details != nil {
		detailList := make([]v20230101s.UserFacingError_STATUS_Unrolled, len(error.Details))
		for detailIndex, detailItem := range error.Details {
			// Shadow the loop variable to avoid aliasing
			detailItem := detailItem
			var detail v20230101s.UserFacingError_STATUS_Unrolled
	...
	if error.InnerError != nil {
		var innerError v20230101s.InnerError_STATUS
...
func (error *InnerError_STATUS) AssignProperties_From_InnerError_STATUS(source *v20230101s.InnerError_STATUS) error {
...
func (error *InnerError_STATUS) AssignProperties_To_InnerError_STATUS(destination *v20230101s.InnerError_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if error.EmbeddedInnerError != nil {
		var embeddedInnerError v20230101s.InnerError_STATUS_Unrolled
...
func (parameters *PolicyParameters) AssignProperties_From_PolicyParameters(source *v20230101s.PolicyParameters) error {
...
func (parameters *PolicyParameters) AssignProperties_To_PolicyParameters(destination *v20230101s.PolicyParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackupDatasourceParametersList
	if parameters.BackupDatasourceParametersList != nil {
		backupDatasourceParametersList := make([]v20230101s.BackupDatasourceParameters, len(parameters.BackupDatasourceParametersList))
		for backupDatasourceParametersListIndex, backupDatasourceParametersListItem := range parameters.BackupDatasourceParametersList {
			// Shadow the loop variable to avoid aliasing
			backupDatasourceParametersListItem := backupDatasourceParametersListItem
			var backupDatasourceParametersListLocal v20230101s.BackupDatasourceParameters
	...
	if parameters.DataStoreParametersList != nil {
		dataStoreParametersList := make([]v20230101s.DataStoreParameters, len(parameters.DataStoreParametersList))
		for dataStoreParametersListIndex, dataStoreParametersListItem := range parameters.DataStoreParametersList {
			// Shadow the loop variable to avoid aliasing
			dataStoreParametersListItem := dataStoreParametersListItem
			var dataStoreParametersListLocal v20230101s.DataStoreParameters
...
func (parameters *PolicyParameters_STATUS) AssignProperties_From_PolicyParameters_STATUS(source *v20230101s.PolicyParameters_STATUS) error {
...
func (parameters *PolicyParameters_STATUS) AssignProperties_To_PolicyParameters_STATUS(destination *v20230101s.PolicyParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackupDatasourceParametersList
	if parameters.BackupDatasourceParametersList != nil {
		backupDatasourceParametersList := make([]v20230101s.BackupDatasourceParameters_STATUS, len(parameters.BackupDatasourceParametersList))
		for backupDatasourceParametersListIndex, backupDatasourceParametersListItem := range parameters.BackupDatasourceParametersList {
			// Shadow the loop variable to avoid aliasing
			backupDatasourceParametersListItem := backupDatasourceParametersListItem
			var backupDatasourceParametersListLocal v20230101s.BackupDatasourceParameters_STATUS
	...
	// DataStoreParametersList
	if parameters.DataStoreParametersList != nil {
		dataStoreParametersList := make([]v20230101s.DataStoreParameters_STATUS, len(parameters.DataStoreParametersList))
		for dataStoreParametersListIndex, dataStoreParametersListItem := range parameters.DataStoreParametersList {
			// Shadow the loop variable to avoid aliasing
			dataStoreParametersListItem := dataStoreParametersListItem
			var dataStoreParametersListLocal v20230101s.DataStoreParameters_STATUS
...
func (credentials *SecretStoreBasedAuthCredentials) AssignProperties_From_SecretStoreBasedAuthCredentials(source *v20230101s.SecretStoreBasedAuthCredentials) error {
...
func (credentials *SecretStoreBasedAuthCredentials) AssignProperties_To_SecretStoreBasedAuthCredentials(destination *v20230101s.SecretStoreBasedAuthCredentials) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// SecretStoreResource
	if credentials.SecretStoreResource != nil {
		var secretStoreResource v20230101s.SecretStoreResource
...
func (credentials *SecretStoreBasedAuthCredentials_STATUS) AssignProperties_From_SecretStoreBasedAuthCredentials_STATUS(source *v20230101s.SecretStoreBasedAuthCredentials_STATUS) error {
...
func (credentials *SecretStoreBasedAuthCredentials_STATUS) AssignProperties_To_SecretStoreBasedAuthCredentials_STATUS(destination *v20230101s.SecretStoreBasedAuthCredentials_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// SecretStoreResource
	if credentials.SecretStoreResource != nil {
		var secretStoreResource v20230101s.SecretStoreResource_STATUS
...
func (unrolled *UserFacingError_STATUS_Unrolled) AssignProperties_From_UserFacingError_STATUS_Unrolled(source *v20230101s.UserFacingError_STATUS_Unrolled) error {
...
func (unrolled *UserFacingError_STATUS_Unrolled) AssignProperties_To_UserFacingError_STATUS_Unrolled(destination *v20230101s.UserFacingError_STATUS_Unrolled) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *BackupDatasourceParameters) AssignProperties_From_BackupDatasourceParameters(source *v20230101s.BackupDatasourceParameters) error {
...
func (parameters *BackupDatasourceParameters) AssignProperties_To_BackupDatasourceParameters(destination *v20230101s.BackupDatasourceParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Blob
	if parameters.Blob != nil {
		var blob v20230101s.BlobBackupDatasourceParameters
	...
	// KubernetesCluster
	if parameters.KubernetesCluster != nil {
		var kubernetesCluster v20230101s.KubernetesClusterBackupDatasourceParameters
...
func (parameters *BackupDatasourceParameters_STATUS) AssignProperties_From_BackupDatasourceParameters_STATUS(source *v20230101s.BackupDatasourceParameters_STATUS) error {
...
func (parameters *BackupDatasourceParameters_STATUS) AssignProperties_To_BackupDatasourceParameters_STATUS(destination *v20230101s.BackupDatasourceParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Blob
	if parameters.Blob != nil {
		var blob v20230101s.BlobBackupDatasourceParameters_STATUS
	...
	// KubernetesCluster
	if parameters.KubernetesCluster != nil {
		var kubernetesCluster v20230101s.KubernetesClusterBackupDatasourceParameters_STATUS
...
func (parameters *DataStoreParameters) AssignProperties_From_DataStoreParameters(source *v20230101s.DataStoreParameters) error {
...
func (parameters *DataStoreParameters) AssignProperties_To_DataStoreParameters(destination *v20230101s.DataStoreParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AzureOperationalStoreParameters
	if parameters.AzureOperationalStoreParameters != nil {
		var azureOperationalStoreParameter v20230101s.AzureOperationalStoreParameters
...
func (parameters *DataStoreParameters_STATUS) AssignProperties_From_DataStoreParameters_STATUS(source *v20230101s.DataStoreParameters_STATUS) error {
...
func (parameters *DataStoreParameters_STATUS) AssignProperties_To_DataStoreParameters_STATUS(destination *v20230101s.DataStoreParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AzureOperationalStoreParameters
	if parameters.AzureOperationalStoreParameters != nil {
		var azureOperationalStoreParameter v20230101s.AzureOperationalStoreParameters_STATUS
...
func (unrolled *InnerError_STATUS_Unrolled) AssignProperties_From_InnerError_STATUS_Unrolled(source *v20230101s.InnerError_STATUS_Unrolled) error {
...
func (unrolled *InnerError_STATUS_Unrolled) AssignProperties_To_InnerError_STATUS_Unrolled(destination *v20230101s.InnerError_STATUS_Unrolled) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (resource *SecretStoreResource) AssignProperties_From_SecretStoreResource(source *v20230101s.SecretStoreResource) error {
...
func (resource *SecretStoreResource) AssignProperties_To_SecretStoreResource(destination *v20230101s.SecretStoreResource) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (resource *SecretStoreResource_STATUS) AssignProperties_From_SecretStoreResource_STATUS(source *v20230101s.SecretStoreResource_STATUS) error {
...
func (resource *SecretStoreResource_STATUS) AssignProperties_To_SecretStoreResource_STATUS(destination *v20230101s.SecretStoreResource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *AzureOperationalStoreParameters) AssignProperties_From_AzureOperationalStoreParameters(source *v20230101s.AzureOperationalStoreParameters) error {
...
func (parameters *AzureOperationalStoreParameters) AssignProperties_To_AzureOperationalStoreParameters(destination *v20230101s.AzureOperationalStoreParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *AzureOperationalStoreParameters_STATUS) AssignProperties_From_AzureOperationalStoreParameters_STATUS(source *v20230101s.AzureOperationalStoreParameters_STATUS) error {
...
func (parameters *BlobBackupDatasourceParameters) AssignProperties_From_BlobBackupDatasourceParameters(source *v20230101s.BlobBackupDatasourceParameters) error {
...
func (parameters *BlobBackupDatasourceParameters) AssignProperties_To_BlobBackupDatasourceParameters(destination *v20230101s.BlobBackupDatasourceParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *BlobBackupDatasourceParameters_STATUS) AssignProperties_From_BlobBackupDatasourceParameters_STATUS(source *v20230101s.BlobBackupDatasourceParameters_STATUS) error {
...
func (parameters *BlobBackupDatasourceParameters_STATUS) AssignProperties_To_BlobBackupDatasourceParameters_STATUS(destination *v20230101s.BlobBackupDatasourceParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *KubernetesClusterBackupDatasourceParameters) AssignProperties_From_KubernetesClusterBackupDatasourceParameters(source *v20230101s.KubernetesClusterBackupDatasourceParameters) error {
...
func (parameters *KubernetesClusterBackupDatasourceParameters) AssignProperties_To_KubernetesClusterBackupDatasourceParameters(destination *v20230101s.KubernetesClusterBackupDatasourceParameters) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *KubernetesClusterBackupDatasourceParameters_STATUS) AssignProperties_From_KubernetesClusterBackupDatasourceParameters_STATUS(source *v20230101s.KubernetesClusterBackupDatasourceParameters_STATUS) error {
...
func (parameters *KubernetesClusterBackupDatasourceParameters_STATUS) AssignProperties_To_KubernetesClusterBackupDatasourceParameters_STATUS(destination *v20230101s.KubernetesClusterBackupDatasourceParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
