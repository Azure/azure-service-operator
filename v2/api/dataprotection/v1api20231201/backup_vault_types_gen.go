...
// +kubebuilder:webhook:path=/mutate-dataprotection-azure-com-v1api20231201-backupvault,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaults,verbs=create;update,versions=v1api20231201,name=default.v1api20231201.backupvaults.dataprotection.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dataprotection-azure-com-v1api20231201-backupvault,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaults,verbs=create;update,versions=v1api20231201,name=validate.v1api20231201.backupvaults.dataprotection.azure.com,admissionReviewVersions=v1
...
func (details *DppIdentityDetails) AssignProperties_To_DppIdentityDetails(destination *v20231201s.DppIdentityDetails) error {
	...
	if details.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20231201s.UserAssignedIdentityDetails, len(details.UserAssignedIdentities))
...
func (details *DppIdentityDetails_STATUS) AssignProperties_To_DppIdentityDetails_STATUS(destination *v20231201s.DppIdentityDetails_STATUS) error {
	...
	// UserAssignedIdentities
	if details.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20231201s.UserAssignedIdentity_STATUS, len(details.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range details.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20231201s.UserAssignedIdentity_STATUS
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_From_UserAssignedIdentity_STATUS(source *v20231201s.UserAssignedIdentity_STATUS) error {
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_To_UserAssignedIdentity_STATUS(destination *v20231201s.UserAssignedIdentity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20231201s.UserAssignedIdentityDetails) error {
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20231201s.UserAssignedIdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (settings *CrossRegionRestoreSettings) AssignProperties_From_CrossRegionRestoreSettings(source *v20231201s.CrossRegionRestoreSettings) error {
...
func (settings *CrossRegionRestoreSettings) AssignProperties_To_CrossRegionRestoreSettings(destination *v20231201s.CrossRegionRestoreSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (settings *CrossRegionRestoreSettings_STATUS) AssignProperties_From_CrossRegionRestoreSettings_STATUS(source *v20231201s.CrossRegionRestoreSettings_STATUS) error {
...
func (settings *CrossRegionRestoreSettings_STATUS) AssignProperties_To_CrossRegionRestoreSettings_STATUS(destination *v20231201s.CrossRegionRestoreSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
