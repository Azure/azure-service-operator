...
// - Generated from: /dataprotection/resource-manager/Microsoft.DataProtection/stable/2023-12-01/dataprotection.json
...
// +kubebuilder:webhook:path=/validate-dataprotection-azure-com-v1api20231201-backupvaultsbackupinstance,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaultsbackupinstances,verbs=create;update,versions=v1api20231201,name=validate.v1api20231201.backupvaultsbackupinstances.dataprotection.azure.com,admissionReviewVersions=v1
...
func (details *IdentityDetails) AssignProperties_From_IdentityDetails(source *v20231201s.IdentityDetails) error {
...
func (details *IdentityDetails) AssignProperties_To_IdentityDetails(destination *v20231201s.IdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (details *IdentityDetails_STATUS) AssignProperties_From_IdentityDetails_STATUS(source *v20231201s.IdentityDetails_STATUS) error {
...
func (details *IdentityDetails_STATUS) AssignProperties_To_IdentityDetails_STATUS(destination *v20231201s.IdentityDetails_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *BaseResourceProperties) AssignProperties_From_BaseResourceProperties(source *v20231201s.BaseResourceProperties) error {
...
func (properties *BaseResourceProperties) AssignProperties_To_BaseResourceProperties(destination *v20231201s.BaseResourceProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DefaultResourceProperties
	if properties.DefaultResourceProperties != nil {
		var defaultResourceProperty v20231201s.DefaultResourceProperties
...
func (properties *BaseResourceProperties_STATUS) AssignProperties_From_BaseResourceProperties_STATUS(source *v20231201s.BaseResourceProperties_STATUS) error {
...
func (properties *BaseResourceProperties_STATUS) AssignProperties_To_BaseResourceProperties_STATUS(destination *v20231201s.BaseResourceProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DefaultResourceProperties
	if properties.DefaultResourceProperties != nil {
		var defaultResourceProperty v20231201s.DefaultResourceProperties_STATUS
...
func (properties *DefaultResourceProperties) AssignProperties_From_DefaultResourceProperties(source *v20231201s.DefaultResourceProperties) error {
...
func (properties *DefaultResourceProperties) AssignProperties_To_DefaultResourceProperties(destination *v20231201s.DefaultResourceProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *DefaultResourceProperties_STATUS) AssignProperties_From_DefaultResourceProperties_STATUS(source *v20231201s.DefaultResourceProperties_STATUS) error {
...
func (properties *DefaultResourceProperties_STATUS) AssignProperties_To_DefaultResourceProperties_STATUS(destination *v20231201s.DefaultResourceProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (parameters *KubernetesClusterBackupDatasourceParameters) AssignProperties_To_KubernetesClusterBackupDatasourceParameters(destination *v20231201s.KubernetesClusterBackupDatasourceParameters) error {
	...
	if parameters.BackupHookReferences != nil {
		backupHookReferenceList := make([]v20231201s.NamespacedNameResource, len(parameters.BackupHookReferences))
...
func (parameters *KubernetesClusterBackupDatasourceParameters_STATUS) AssignProperties_To_KubernetesClusterBackupDatasourceParameters_STATUS(destination *v20231201s.KubernetesClusterBackupDatasourceParameters_STATUS) error {
	...
	// BackupHookReferences
	if parameters.BackupHookReferences != nil {
		backupHookReferenceList := make([]v20231201s.NamespacedNameResource_STATUS, len(parameters.BackupHookReferences))
		for backupHookReferenceIndex, backupHookReferenceItem := range parameters.BackupHookReferences {
			// Shadow the loop variable to avoid aliasing
			backupHookReferenceItem := backupHookReferenceItem
...
func (resource *NamespacedNameResource) AssignProperties_From_NamespacedNameResource(source *v20231201s.NamespacedNameResource) error {
...
func (resource *NamespacedNameResource) AssignProperties_To_NamespacedNameResource(destination *v20231201s.NamespacedNameResource) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (resource *NamespacedNameResource_STATUS) AssignProperties_From_NamespacedNameResource_STATUS(source *v20231201s.NamespacedNameResource_STATUS) error {
...
func (resource *NamespacedNameResource_STATUS) AssignProperties_To_NamespacedNameResource_STATUS(destination *v20231201s.NamespacedNameResource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
