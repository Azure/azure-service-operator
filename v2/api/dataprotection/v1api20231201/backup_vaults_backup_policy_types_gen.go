...
// +kubebuilder:webhook:path=/mutate-dataprotection-azure-com-v1api20231201-backupvaultsbackuppolicy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaultsbackuppolicies,verbs=create;update,versions=v1api20231201,name=default.v1api20231201.backupvaultsbackuppolicies.dataprotection.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dataprotection-azure-com-v1api20231201-backupvaultsbackuppolicy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dataprotection.azure.com,resources=backupvaultsbackuppolicies,verbs=create;update,versions=v1api20231201,name=validate.v1api20231201.backupvaultsbackuppolicies.dataprotection.azure.com,admissionReviewVersions=v1
