...
type CrossRegionRestoreSettings_ARM struct {
	...
	State *CrossRegionRestoreSettings_State_ARM `json:"state,omitempty"`
}
...
// +kubebuilder:validation:Enum={"Disabled","Enabled"}
type CrossRegionRestoreSettings_State_ARM string

const (
	CrossRegionRestoreSettings_State_ARM_Disabled = CrossRegionRestoreSettings_State_ARM("Disabled")
	CrossRegionRestoreSettings_State_ARM_Enabled  = CrossRegionRestoreSettings_State_ARM("Enabled")
)

// Mapping from string to CrossRegionRestoreSettings_State_ARM
var crossRegionRestoreSettings_State_ARM_Values = map[string]CrossRegionRestoreSettings_State_ARM{
	"disabled": CrossRegionRestoreSettings_State_ARM_Disabled,
	"enabled":  CrossRegionRestoreSettings_State_ARM_Enabled,
}
