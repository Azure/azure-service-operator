...
func Test_CrossRegionRestoreSettings_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of CrossRegionRestoreSettings_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCrossRegionRestoreSettings_STATUS_ARM, CrossRegionRestoreSettings_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCrossRegionRestoreSettings_STATUS_ARM runs a test to see if a specific instance of CrossRegionRestoreSettings_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForCrossRegionRestoreSettings_STATUS_ARM(subject CrossRegionRestoreSettings_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual CrossRegionRestoreSettings_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of CrossRegionRestoreSettings_STATUS_ARM instances for property testing - lazily instantiated by
// CrossRegionRestoreSettings_STATUS_ARMGenerator()
var crossRegionRestoreSettings_STATUS_ARMGenerator gopter.Gen

// CrossRegionRestoreSettings_STATUS_ARMGenerator returns a generator of CrossRegionRestoreSettings_STATUS_ARM instances for property testing.
func CrossRegionRestoreSettings_STATUS_ARMGenerator() gopter.Gen {
	if crossRegionRestoreSettings_STATUS_ARMGenerator != nil {
		return crossRegionRestoreSettings_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCrossRegionRestoreSettings_STATUS_ARM(generators)
	crossRegionRestoreSettings_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(CrossRegionRestoreSettings_STATUS_ARM{}), generators)
...
// We first initialize dppIdentityDetails_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DppIdentityDetails_STATUS_ARMGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDppIdentityDetails_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForDppIdentityDetails_STATUS_ARM(generators)
	dppIdentityDetails_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(DppIdentityDetails_STATUS_ARM{}), generators)
...
func AddRelatedPropertyGeneratorsForFeatureSettings_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["CrossRegionRestoreSettings"] = gen.PtrOf(CrossRegionRestoreSettings_STATUS_ARMGenerator())
