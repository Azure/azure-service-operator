...
func (vault *BackupVault_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "ReplicatedRegions":
	for _, item := range typedInput.ReplicatedRegions {
		vault.ReplicatedRegions = append(vault.ReplicatedRegions, item)
	}
...
func (vault *BackupVault_STATUS) AssignProperties_To_BackupVault_STATUS(destination *storage.BackupVault_STATUS) error {
	...
	// SecureScore
	if vault.SecureScore != nil {
		secureScore := string(*vault.SecureScore)
...
func (vault *BackupVaultSpec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "ReplicatedRegions":
	for _, item := range vault.ReplicatedRegions {
		result.ReplicatedRegions = append(result.ReplicatedRegions, item)
	}
...
func (details *DppIdentityDetails_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.UserAssignedIdentities != nil {
		details.UserAssignedIdentities = make(map[string]UserAssignedIdentity_STATUS, len(typedInput.UserAssignedIdentities))
		for key, value := range typedInput.UserAssignedIdentities {
			...
			details.UserAssignedIdentities[key] = value1
		}
	}
...
func (settings *FeatureSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CrossRegionRestoreSettings":
	if typedInput.CrossRegionRestoreSettings != nil {
		var crossRegionRestoreSettings1 CrossRegionRestoreSettings
		err := crossRegionRestoreSettings1.PopulateFromARM(owner, *typedInput.CrossRegionRestoreSettings)
		if err != nil {
			return err
		}
		crossRegionRestoreSettings := crossRegionRestoreSettings1
		settings.CrossRegionRestoreSettings = &crossRegionRestoreSettings
	}
...
func (settings *FeatureSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CrossRegionRestoreSettings":
	if typedInput.CrossRegionRestoreSettings != nil {
		var crossRegionRestoreSettings1 CrossRegionRestoreSettings_STATUS
		err := crossRegionRestoreSettings1.PopulateFromARM(owner, *typedInput.CrossRegionRestoreSettings)
		if err != nil {
			return err
		}
...
var _ genruntime.ARMTransformer = &CrossRegionRestoreSettings{}
...
func (settings *CrossRegionRestoreSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if settings.State != nil {
		...
		state := CrossRegionRestoreSettings_State_ARM(temp)
		result.State = &state
	}
	return result, nil
}
...
var _ genruntime.FromARMConverter = &CrossRegionRestoreSettings_STATUS{}
