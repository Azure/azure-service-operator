...
func (details *DppIdentityDetails) AssignProperties_To_DppIdentityDetails(destination *v20231101s.DppIdentityDetails) error {
	...
	if details.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20231101s.UserAssignedIdentityDetails, len(details.UserAssignedIdentities))
...
func (details *DppIdentityDetails_STATUS) AssignProperties_To_DppIdentityDetails_STATUS(destination *v20231101s.DppIdentityDetails_STATUS) error {
	...
	// UserAssignedIdentities
	if details.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20231101s.UserAssignedIdentity_STATUS, len(details.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range details.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20231101s.UserAssignedIdentity_STATUS
