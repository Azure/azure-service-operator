...
func Test_Profiles_Endpoints_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of Profiles_Endpoints_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForProfiles_Endpoints_SpecARM, Profiles_Endpoints_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForProfiles_Endpoints_SpecARM runs a test to see if a specific instance of Profiles_Endpoints_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForProfiles_Endpoints_SpecARM(subject Profiles_Endpoints_SpecARM) string {
	// Serialize to JSON
	...
	var actual Profiles_Endpoints_SpecARM
...
// Generator of Profiles_Endpoints_SpecARM instances for property testing - lazily instantiated by
// Profiles_Endpoints_SpecARMGenerator()
var profiles_Endpoints_SpecARMGenerator gopter.Gen

// Profiles_Endpoints_SpecARMGenerator returns a generator of Profiles_Endpoints_SpecARM instances for property testing.
// We first initialize profiles_Endpoints_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Profiles_Endpoints_SpecARMGenerator() gopter.Gen {
	if profiles_Endpoints_SpecARMGenerator != nil {
		return profiles_Endpoints_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_SpecARM(generators)
	profiles_Endpoints_SpecARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_SpecARM(generators)
	AddRelatedPropertyGeneratorsForProfiles_Endpoints_SpecARM(generators)
	profiles_Endpoints_SpecARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_SpecARM{}), generators)

	return profiles_Endpoints_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForProfiles_Endpoints_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForProfiles_Endpoints_SpecARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.AlphaString()
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForProfiles_Endpoints_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForProfiles_Endpoints_SpecARM(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(Profiles_Endpoints_Spec_PropertiesARMGenerator())
}

func Test_Profiles_Endpoints_Spec_PropertiesARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Profiles_Endpoints_Spec_PropertiesARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForProfiles_Endpoints_Spec_PropertiesARM, Profiles_Endpoints_Spec_PropertiesARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForProfiles_Endpoints_Spec_PropertiesARM runs a test to see if a specific instance of Profiles_Endpoints_Spec_PropertiesARM round trips to JSON and back losslessly
func RunJSONSerializationTestForProfiles_Endpoints_Spec_PropertiesARM(subject Profiles_Endpoints_Spec_PropertiesARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual Profiles_Endpoints_Spec_PropertiesARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of Profiles_Endpoints_Spec_PropertiesARM instances for property testing - lazily instantiated by
// Profiles_Endpoints_Spec_PropertiesARMGenerator()
var profiles_Endpoints_Spec_PropertiesARMGenerator gopter.Gen

// Profiles_Endpoints_Spec_PropertiesARMGenerator returns a generator of Profiles_Endpoints_Spec_PropertiesARM instances for property testing.
// We first initialize profiles_Endpoints_Spec_PropertiesARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Profiles_Endpoints_Spec_PropertiesARMGenerator() gopter.Gen {
	if profiles_Endpoints_Spec_PropertiesARMGenerator != nil {
		return profiles_Endpoints_Spec_PropertiesARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM(generators)
	profiles_Endpoints_Spec_PropertiesARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_PropertiesARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM(generators)
	AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM(generators)
	profiles_Endpoints_Spec_PropertiesARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_PropertiesARM{}), generators)

	return profiles_Endpoints_Spec_PropertiesARMGenerator
}

// AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM(gens map[string]gopter.Gen) {
	...
	gens["OptimizationType"] = gen.PtrOf(gen.OneConstOf(
		Profiles_Endpoints_Spec_Properties_OptimizationType_DynamicSiteAcceleration,
		Profiles_Endpoints_Spec_Properties_OptimizationType_GeneralMediaStreaming,
		Profiles_Endpoints_Spec_Properties_OptimizationType_GeneralWebDelivery,
		Profiles_Endpoints_Spec_Properties_OptimizationType_LargeFileDownload,
		Profiles_Endpoints_Spec_Properties_OptimizationType_VideoOnDemandMediaStreaming))
	...
	gens["QueryStringCachingBehavior"] = gen.PtrOf(gen.OneConstOf(
		Profiles_Endpoints_Spec_Properties_QueryStringCachingBehavior_BypassCaching,
		Profiles_Endpoints_Spec_Properties_QueryStringCachingBehavior_IgnoreQueryString,
		Profiles_Endpoints_Spec_Properties_QueryStringCachingBehavior_NotSet,
		Profiles_Endpoints_Spec_Properties_QueryStringCachingBehavior_UseQueryString))
}

// AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_PropertiesARM(gens map[string]gopter.Gen) {
	...
	gens["OriginGroups"] = gen.SliceOf(Profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator())
	gens["Origins"] = gen.SliceOf(Profiles_Endpoints_Spec_Properties_OriginsARMGenerator())
...
func Test_Profiles_Endpoints_Spec_Properties_OriginGroupsARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Profiles_Endpoints_Spec_Properties_OriginGroupsARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginGroupsARM, Profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginGroupsARM runs a test to see if a specific instance of Profiles_Endpoints_Spec_Properties_OriginGroupsARM round trips to JSON and back losslessly
func RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(subject Profiles_Endpoints_Spec_Properties_OriginGroupsARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual Profiles_Endpoints_Spec_Properties_OriginGroupsARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of Profiles_Endpoints_Spec_Properties_OriginGroupsARM instances for property testing - lazily instantiated
// by Profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator()
var profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator gopter.Gen

// Profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator returns a generator of Profiles_Endpoints_Spec_Properties_OriginGroupsARM instances for property testing.
// We first initialize profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator() gopter.Gen {
	if profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator != nil {
		return profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(generators)
	profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_Properties_OriginGroupsARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(generators)
	AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(generators)
	profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_Properties_OriginGroupsARM{}), generators)

	return profiles_Endpoints_Spec_Properties_OriginGroupsARMGenerator
}

// AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginGroupsARM(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(DeepCreatedOriginGroupPropertiesARMGenerator())
}

func Test_Profiles_Endpoints_Spec_Properties_OriginsARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Profiles_Endpoints_Spec_Properties_OriginsARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginsARM, Profiles_Endpoints_Spec_Properties_OriginsARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginsARM runs a test to see if a specific instance of Profiles_Endpoints_Spec_Properties_OriginsARM round trips to JSON and back losslessly
func RunJSONSerializationTestForProfiles_Endpoints_Spec_Properties_OriginsARM(subject Profiles_Endpoints_Spec_Properties_OriginsARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual Profiles_Endpoints_Spec_Properties_OriginsARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of Profiles_Endpoints_Spec_Properties_OriginsARM instances for property testing - lazily instantiated by
// Profiles_Endpoints_Spec_Properties_OriginsARMGenerator()
var profiles_Endpoints_Spec_Properties_OriginsARMGenerator gopter.Gen

// Profiles_Endpoints_Spec_Properties_OriginsARMGenerator returns a generator of Profiles_Endpoints_Spec_Properties_OriginsARM instances for property testing.
// We first initialize profiles_Endpoints_Spec_Properties_OriginsARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Profiles_Endpoints_Spec_Properties_OriginsARMGenerator() gopter.Gen {
	if profiles_Endpoints_Spec_Properties_OriginsARMGenerator != nil {
		return profiles_Endpoints_Spec_Properties_OriginsARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM(generators)
	profiles_Endpoints_Spec_Properties_OriginsARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_Properties_OriginsARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM(generators)
	AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM(generators)
	profiles_Endpoints_Spec_Properties_OriginsARMGenerator = gen.Struct(reflect.TypeOf(Profiles_Endpoints_Spec_Properties_OriginsARM{}), generators)

	return profiles_Endpoints_Spec_Properties_OriginsARMGenerator
}

// AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForProfiles_Endpoints_Spec_Properties_OriginsARM(gens map[string]gopter.Gen) {
