...
type Profiles_Endpoints_SpecARM struct {
	...
	Properties *Profiles_Endpoints_Spec_PropertiesARM `json:"properties,omitempty"`

	// Tags: Name-value pairs to add to the resource
	Tags map[string]string `json:"tags,omitempty"`
}

var _ genruntime.ARMResourceSpec = &Profiles_Endpoints_SpecARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-06-01"
func (endpoints Profiles_Endpoints_SpecARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (endpoints *Profiles_Endpoints_SpecARM) GetName() string {
	return endpoints.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Cdn/profiles/endpoints"
func (endpoints *Profiles_Endpoints_SpecARM) GetType() string {
	return "Microsoft.Cdn/profiles/endpoints"
}

type Profiles_Endpoints_Spec_PropertiesARM struct {
	...
	OriginGroups []Profiles_Endpoints_Spec_Properties_OriginGroupsARM `json:"originGroups,omitempty"`
	...
	Origins []Profiles_Endpoints_Spec_Properties_OriginsARM `json:"origins,omitempty"`
...
type Profiles_Endpoints_Spec_Properties_OriginGroupsARM struct {
...
type Profiles_Endpoints_Spec_Properties_OriginsARM struct {
