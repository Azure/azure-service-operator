...
// +kubebuilder:webhook:path=/mutate-cdn-azure-com-v20230501-afdcustomdomain,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=afdcustomdomains,verbs=create;update,versions=v20230501,name=default.v20230501.afdcustomdomains.cdn.azure.com,admissionReviewVersions=v1
...
func (domain *AfdCustomDomain) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/AfdCustomDomain, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-cdn-azure-com-v20230501-afdcustomdomain,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=afdcustomdomains,verbs=create;update,versions=v20230501,name=validate.v20230501.afdcustomdomains.cdn.azure.com,admissionReviewVersions=v1
...
func (domain *AfdCustomDomain) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/AfdCustomDomain, but got %T", resource)
	}
...
func (domain *AfdCustomDomain) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/AfdCustomDomain, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230501.AfdCustomDomain)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/AfdCustomDomain, but got %T", oldResource)
	}
