...
// +kubebuilder:webhook:path=/mutate-cdn-azure-com-v20230501-securitypolicy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=securitypolicies,verbs=create;update,versions=v20230501,name=default.v20230501.securitypolicies.cdn.azure.com,admissionReviewVersions=v1
...
func (policy *SecurityPolicy) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/SecurityPolicy, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-cdn-azure-com-v20230501-securitypolicy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=securitypolicies,verbs=create;update,versions=v20230501,name=validate.v20230501.securitypolicies.cdn.azure.com,admissionReviewVersions=v1
...
func (policy *SecurityPolicy) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/SecurityPolicy, but got %T", resource)
	}
...
func (policy *SecurityPolicy) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/SecurityPolicy, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230501.SecurityPolicy)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20230501/SecurityPolicy, but got %T", oldResource)
	}
...
func (policy *SecurityPolicy) createValidations() []func(ctx context.Context, obj *v20230501.SecurityPolicy) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20230501.SecurityPolicy) (admission.Warnings, error){
