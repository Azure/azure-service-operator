...
func Test_DeepCreatedCustomDomainProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeepCreatedCustomDomainProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeepCreatedCustomDomainProperties_STATUS, DeepCreatedCustomDomainProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeepCreatedCustomDomainProperties_STATUS runs a test to see if a specific instance of DeepCreatedCustomDomainProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForDeepCreatedCustomDomainProperties_STATUS(subject DeepCreatedCustomDomainProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeepCreatedCustomDomainProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeepCreatedCustomDomainProperties_STATUS instances for property testing - lazily instantiated by
// DeepCreatedCustomDomainProperties_STATUSGenerator()
var deepCreatedCustomDomainProperties_STATUSGenerator gopter.Gen

// DeepCreatedCustomDomainProperties_STATUSGenerator returns a generator of DeepCreatedCustomDomainProperties_STATUS instances for property testing.
func DeepCreatedCustomDomainProperties_STATUSGenerator() gopter.Gen {
	if deepCreatedCustomDomainProperties_STATUSGenerator != nil {
		return deepCreatedCustomDomainProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedCustomDomainProperties_STATUS(generators)
	deepCreatedCustomDomainProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedCustomDomainProperties_STATUS{}), generators)

	return deepCreatedCustomDomainProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForDeepCreatedCustomDomainProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDeepCreatedCustomDomainProperties_STATUS(gens map[string]gopter.Gen) {
...
// We first initialize deepCreatedCustomDomain_STATUSGenerator with a simplified generator based on the
...
func DeepCreatedCustomDomain_STATUSGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedCustomDomain_STATUS(generators)
	AddRelatedPropertyGeneratorsForDeepCreatedCustomDomain_STATUS(generators)
	deepCreatedCustomDomain_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedCustomDomain_STATUS{}), generators)
...
// AddRelatedPropertyGeneratorsForDeepCreatedCustomDomain_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeepCreatedCustomDomain_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(DeepCreatedCustomDomainProperties_STATUSGenerator())
}

func Test_DeepCreatedOriginGroupProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeepCreatedOriginGroupProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeepCreatedOriginGroupProperties_STATUS, DeepCreatedOriginGroupProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeepCreatedOriginGroupProperties_STATUS runs a test to see if a specific instance of DeepCreatedOriginGroupProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForDeepCreatedOriginGroupProperties_STATUS(subject DeepCreatedOriginGroupProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeepCreatedOriginGroupProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeepCreatedOriginGroupProperties_STATUS instances for property testing - lazily instantiated by
// DeepCreatedOriginGroupProperties_STATUSGenerator()
var deepCreatedOriginGroupProperties_STATUSGenerator gopter.Gen

// DeepCreatedOriginGroupProperties_STATUSGenerator returns a generator of DeepCreatedOriginGroupProperties_STATUS instances for property testing.
// We first initialize deepCreatedOriginGroupProperties_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DeepCreatedOriginGroupProperties_STATUSGenerator() gopter.Gen {
	if deepCreatedOriginGroupProperties_STATUSGenerator != nil {
		return deepCreatedOriginGroupProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS(generators)
	deepCreatedOriginGroupProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedOriginGroupProperties_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS(generators)
	AddRelatedPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS(generators)
	deepCreatedOriginGroupProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedOriginGroupProperties_STATUS{}), generators)

	return deepCreatedOriginGroupProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS(gens map[string]gopter.Gen) {
	gens["TrafficRestorationTimeToHealedOrNewEndpointsInMinutes"] = gen.PtrOf(gen.Int())
}

// AddRelatedPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeepCreatedOriginGroupProperties_STATUS(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForDeepCreatedOriginGroup_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(DeepCreatedOriginGroupProperties_STATUSGenerator())
}

func Test_DeepCreatedOriginProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeepCreatedOriginProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeepCreatedOriginProperties_STATUS, DeepCreatedOriginProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeepCreatedOriginProperties_STATUS runs a test to see if a specific instance of DeepCreatedOriginProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForDeepCreatedOriginProperties_STATUS(subject DeepCreatedOriginProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeepCreatedOriginProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeepCreatedOriginProperties_STATUS instances for property testing - lazily instantiated by
// DeepCreatedOriginProperties_STATUSGenerator()
var deepCreatedOriginProperties_STATUSGenerator gopter.Gen

// DeepCreatedOriginProperties_STATUSGenerator returns a generator of DeepCreatedOriginProperties_STATUS instances for property testing.
func DeepCreatedOriginProperties_STATUSGenerator() gopter.Gen {
	if deepCreatedOriginProperties_STATUSGenerator != nil {
		return deepCreatedOriginProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedOriginProperties_STATUS(generators)
	deepCreatedOriginProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedOriginProperties_STATUS{}), generators)

	return deepCreatedOriginProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForDeepCreatedOriginProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDeepCreatedOriginProperties_STATUS(gens map[string]gopter.Gen) {
...
// We first initialize deepCreatedOrigin_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DeepCreatedOrigin_STATUSGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDeepCreatedOrigin_STATUS(generators)
	AddRelatedPropertyGeneratorsForDeepCreatedOrigin_STATUS(generators)
	deepCreatedOrigin_STATUSGenerator = gen.Struct(reflect.TypeOf(DeepCreatedOrigin_STATUS{}), generators)
...
// AddRelatedPropertyGeneratorsForDeepCreatedOrigin_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeepCreatedOrigin_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(DeepCreatedOriginProperties_STATUSGenerator())
}
