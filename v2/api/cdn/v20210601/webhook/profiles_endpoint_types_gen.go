...
// +kubebuilder:webhook:path=/mutate-cdn-azure-com-v20210601-profilesendpoint,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesendpoints,verbs=create;update,versions=v20210601,name=default.v20210601.profilesendpoints.cdn.azure.com,admissionReviewVersions=v1
...
func (endpoint *ProfilesEndpoint) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20210601/ProfilesEndpoint, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-cdn-azure-com-v20210601-profilesendpoint,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cdn.azure.com,resources=profilesendpoints,verbs=create;update,versions=v20210601,name=validate.v20210601.profilesendpoints.cdn.azure.com,admissionReviewVersions=v1
...
func (endpoint *ProfilesEndpoint) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20210601/ProfilesEndpoint, but got %T", resource)
	}
...
func (endpoint *ProfilesEndpoint) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20210601/ProfilesEndpoint, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210601.ProfilesEndpoint)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cdn/v20210601/ProfilesEndpoint, but got %T", oldResource)
	}
