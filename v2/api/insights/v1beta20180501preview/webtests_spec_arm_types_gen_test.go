...
func Test_Webtest_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/insights/v1beta20180501preview/webtest__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/insights/v1beta20180501preview/webtests_spec_arm_types_gen_test.go
	// Serialize to JSON
