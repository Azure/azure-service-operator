...
func Test_ApplicationInsights_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ApplicationInsights to ApplicationInsights via AssignProperties_To_ApplicationInsights & AssignProperties_From_ApplicationInsights returns original",
		prop.ForAll(RunPropertyAssignmentTestForApplicationInsights, ApplicationInsightsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForApplicationInsights tests if a specific instance of ApplicationInsights can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForApplicationInsights(subject ApplicationInsights) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ApplicationInsights
	err := copied.AssignProperties_To_ApplicationInsights(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_ApplicationInsights(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_ApplicationInsights_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ApplicationInsights_STATUS to ApplicationInsights_STATUS via AssignProperties_To_ApplicationInsights_STATUS & AssignProperties_From_ApplicationInsights_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForApplicationInsights_STATUS, ApplicationInsights_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForApplicationInsights_STATUS tests if a specific instance of ApplicationInsights_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForApplicationInsights_STATUS(subject ApplicationInsights_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ApplicationInsights_STATUS
	err := copied.AssignProperties_To_ApplicationInsights_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_ApplicationInsights_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DirectDataSourcesSpec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DirectDataSourcesSpec to DirectDataSourcesSpec via AssignProperties_To_DirectDataSourcesSpec & AssignProperties_From_DirectDataSourcesSpec returns original",
		prop.ForAll(RunPropertyAssignmentTestForDirectDataSourcesSpec, DirectDataSourcesSpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDirectDataSourcesSpec tests if a specific instance of DirectDataSourcesSpec can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDirectDataSourcesSpec(subject DirectDataSourcesSpec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DirectDataSourcesSpec
	err := copied.AssignProperties_To_DirectDataSourcesSpec(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DirectDataSourcesSpec(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DirectDataSourcesSpec_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DirectDataSourcesSpec_STATUS to DirectDataSourcesSpec_STATUS via AssignProperties_To_DirectDataSourcesSpec_STATUS & AssignProperties_From_DirectDataSourcesSpec_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDirectDataSourcesSpec_STATUS, DirectDataSourcesSpec_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDirectDataSourcesSpec_STATUS tests if a specific instance of DirectDataSourcesSpec_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDirectDataSourcesSpec_STATUS(subject DirectDataSourcesSpec_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DirectDataSourcesSpec_STATUS
	err := copied.AssignProperties_To_DirectDataSourcesSpec_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DirectDataSourcesSpec_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_EtwProviderDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from EtwProviderDataSource to EtwProviderDataSource via AssignProperties_To_EtwProviderDataSource & AssignProperties_From_EtwProviderDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForEtwProviderDataSource, EtwProviderDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForEtwProviderDataSource tests if a specific instance of EtwProviderDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForEtwProviderDataSource(subject EtwProviderDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.EtwProviderDataSource
	err := copied.AssignProperties_To_EtwProviderDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_EtwProviderDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_EtwProviderDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from EtwProviderDataSource_STATUS to EtwProviderDataSource_STATUS via AssignProperties_To_EtwProviderDataSource_STATUS & AssignProperties_From_EtwProviderDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForEtwProviderDataSource_STATUS, EtwProviderDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForEtwProviderDataSource_STATUS tests if a specific instance of EtwProviderDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForEtwProviderDataSource_STATUS(subject EtwProviderDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.EtwProviderDataSource_STATUS
	err := copied.AssignProperties_To_EtwProviderDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_EtwProviderDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IngestionQuotas_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IngestionQuotas_STATUS to IngestionQuotas_STATUS via AssignProperties_To_IngestionQuotas_STATUS & AssignProperties_From_IngestionQuotas_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForIngestionQuotas_STATUS, IngestionQuotas_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIngestionQuotas_STATUS tests if a specific instance of IngestionQuotas_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIngestionQuotas_STATUS(subject IngestionQuotas_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IngestionQuotas_STATUS
	err := copied.AssignProperties_To_IngestionQuotas_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_IngestionQuotas_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_LogsQuotaSpec_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from LogsQuotaSpec_STATUS to LogsQuotaSpec_STATUS via AssignProperties_To_LogsQuotaSpec_STATUS & AssignProperties_From_LogsQuotaSpec_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForLogsQuotaSpec_STATUS, LogsQuotaSpec_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForLogsQuotaSpec_STATUS tests if a specific instance of LogsQuotaSpec_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForLogsQuotaSpec_STATUS(subject LogsQuotaSpec_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.LogsQuotaSpec_STATUS
	err := copied.AssignProperties_To_LogsQuotaSpec_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_LogsQuotaSpec_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelDataSourceResourceAttributeRouting_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelDataSourceResourceAttributeRouting to OtelDataSourceResourceAttributeRouting via AssignProperties_To_OtelDataSourceResourceAttributeRouting & AssignProperties_From_OtelDataSourceResourceAttributeRouting returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting, OtelDataSourceResourceAttributeRoutingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting tests if a specific instance of OtelDataSourceResourceAttributeRouting can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting(subject OtelDataSourceResourceAttributeRouting) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelDataSourceResourceAttributeRouting
	err := copied.AssignProperties_To_OtelDataSourceResourceAttributeRouting(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelDataSourceResourceAttributeRouting(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelDataSourceResourceAttributeRouting_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelDataSourceResourceAttributeRouting_STATUS to OtelDataSourceResourceAttributeRouting_STATUS via AssignProperties_To_OtelDataSourceResourceAttributeRouting_STATUS & AssignProperties_From_OtelDataSourceResourceAttributeRouting_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting_STATUS, OtelDataSourceResourceAttributeRouting_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting_STATUS tests if a specific instance of OtelDataSourceResourceAttributeRouting_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelDataSourceResourceAttributeRouting_STATUS(subject OtelDataSourceResourceAttributeRouting_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelDataSourceResourceAttributeRouting_STATUS
	err := copied.AssignProperties_To_OtelDataSourceResourceAttributeRouting_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelDataSourceResourceAttributeRouting_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelLogsDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelLogsDataSource to OtelLogsDataSource via AssignProperties_To_OtelLogsDataSource & AssignProperties_From_OtelLogsDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelLogsDataSource, OtelLogsDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelLogsDataSource tests if a specific instance of OtelLogsDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelLogsDataSource(subject OtelLogsDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelLogsDataSource
	err := copied.AssignProperties_To_OtelLogsDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelLogsDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelLogsDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelLogsDataSource_STATUS to OtelLogsDataSource_STATUS via AssignProperties_To_OtelLogsDataSource_STATUS & AssignProperties_From_OtelLogsDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelLogsDataSource_STATUS, OtelLogsDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelLogsDataSource_STATUS tests if a specific instance of OtelLogsDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelLogsDataSource_STATUS(subject OtelLogsDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelLogsDataSource_STATUS
	err := copied.AssignProperties_To_OtelLogsDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelLogsDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelLogsDirectDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelLogsDirectDataSource to OtelLogsDirectDataSource via AssignProperties_To_OtelLogsDirectDataSource & AssignProperties_From_OtelLogsDirectDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelLogsDirectDataSource, OtelLogsDirectDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelLogsDirectDataSource tests if a specific instance of OtelLogsDirectDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelLogsDirectDataSource(subject OtelLogsDirectDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelLogsDirectDataSource
	err := copied.AssignProperties_To_OtelLogsDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelLogsDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelLogsDirectDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelLogsDirectDataSource_STATUS to OtelLogsDirectDataSource_STATUS via AssignProperties_To_OtelLogsDirectDataSource_STATUS & AssignProperties_From_OtelLogsDirectDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelLogsDirectDataSource_STATUS, OtelLogsDirectDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelLogsDirectDataSource_STATUS tests if a specific instance of OtelLogsDirectDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelLogsDirectDataSource_STATUS(subject OtelLogsDirectDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelLogsDirectDataSource_STATUS
	err := copied.AssignProperties_To_OtelLogsDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelLogsDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelMetricsDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelMetricsDataSource to OtelMetricsDataSource via AssignProperties_To_OtelMetricsDataSource & AssignProperties_From_OtelMetricsDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelMetricsDataSource, OtelMetricsDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelMetricsDataSource tests if a specific instance of OtelMetricsDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelMetricsDataSource(subject OtelMetricsDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelMetricsDataSource
	err := copied.AssignProperties_To_OtelMetricsDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelMetricsDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelMetricsDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelMetricsDataSource_STATUS to OtelMetricsDataSource_STATUS via AssignProperties_To_OtelMetricsDataSource_STATUS & AssignProperties_From_OtelMetricsDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelMetricsDataSource_STATUS, OtelMetricsDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelMetricsDataSource_STATUS tests if a specific instance of OtelMetricsDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelMetricsDataSource_STATUS(subject OtelMetricsDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelMetricsDataSource_STATUS
	err := copied.AssignProperties_To_OtelMetricsDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelMetricsDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelMetricsDirectDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelMetricsDirectDataSource to OtelMetricsDirectDataSource via AssignProperties_To_OtelMetricsDirectDataSource & AssignProperties_From_OtelMetricsDirectDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelMetricsDirectDataSource, OtelMetricsDirectDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelMetricsDirectDataSource tests if a specific instance of OtelMetricsDirectDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelMetricsDirectDataSource(subject OtelMetricsDirectDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelMetricsDirectDataSource
	err := copied.AssignProperties_To_OtelMetricsDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelMetricsDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelMetricsDirectDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelMetricsDirectDataSource_STATUS to OtelMetricsDirectDataSource_STATUS via AssignProperties_To_OtelMetricsDirectDataSource_STATUS & AssignProperties_From_OtelMetricsDirectDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelMetricsDirectDataSource_STATUS, OtelMetricsDirectDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelMetricsDirectDataSource_STATUS tests if a specific instance of OtelMetricsDirectDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelMetricsDirectDataSource_STATUS(subject OtelMetricsDirectDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelMetricsDirectDataSource_STATUS
	err := copied.AssignProperties_To_OtelMetricsDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelMetricsDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelTracesDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelTracesDataSource to OtelTracesDataSource via AssignProperties_To_OtelTracesDataSource & AssignProperties_From_OtelTracesDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelTracesDataSource, OtelTracesDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelTracesDataSource tests if a specific instance of OtelTracesDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelTracesDataSource(subject OtelTracesDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelTracesDataSource
	err := copied.AssignProperties_To_OtelTracesDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelTracesDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelTracesDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelTracesDataSource_STATUS to OtelTracesDataSource_STATUS via AssignProperties_To_OtelTracesDataSource_STATUS & AssignProperties_From_OtelTracesDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelTracesDataSource_STATUS, OtelTracesDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelTracesDataSource_STATUS tests if a specific instance of OtelTracesDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelTracesDataSource_STATUS(subject OtelTracesDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelTracesDataSource_STATUS
	err := copied.AssignProperties_To_OtelTracesDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelTracesDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelTracesDirectDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelTracesDirectDataSource to OtelTracesDirectDataSource via AssignProperties_To_OtelTracesDirectDataSource & AssignProperties_From_OtelTracesDirectDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelTracesDirectDataSource, OtelTracesDirectDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelTracesDirectDataSource tests if a specific instance of OtelTracesDirectDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelTracesDirectDataSource(subject OtelTracesDirectDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelTracesDirectDataSource
	err := copied.AssignProperties_To_OtelTracesDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelTracesDirectDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_OtelTracesDirectDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from OtelTracesDirectDataSource_STATUS to OtelTracesDirectDataSource_STATUS via AssignProperties_To_OtelTracesDirectDataSource_STATUS & AssignProperties_From_OtelTracesDirectDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForOtelTracesDirectDataSource_STATUS, OtelTracesDirectDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForOtelTracesDirectDataSource_STATUS tests if a specific instance of OtelTracesDirectDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForOtelTracesDirectDataSource_STATUS(subject OtelTracesDirectDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.OtelTracesDirectDataSource_STATUS
	err := copied.AssignProperties_To_OtelTracesDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_OtelTracesDirectDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_PerformanceCountersOTelDataSource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PerformanceCountersOTelDataSource to PerformanceCountersOTelDataSource via AssignProperties_To_PerformanceCountersOTelDataSource & AssignProperties_From_PerformanceCountersOTelDataSource returns original",
		prop.ForAll(RunPropertyAssignmentTestForPerformanceCountersOTelDataSource, PerformanceCountersOTelDataSourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPerformanceCountersOTelDataSource tests if a specific instance of PerformanceCountersOTelDataSource can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPerformanceCountersOTelDataSource(subject PerformanceCountersOTelDataSource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.PerformanceCountersOTelDataSource
	err := copied.AssignProperties_To_PerformanceCountersOTelDataSource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_PerformanceCountersOTelDataSource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_PerformanceCountersOTelDataSource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PerformanceCountersOTelDataSource_STATUS to PerformanceCountersOTelDataSource_STATUS via AssignProperties_To_PerformanceCountersOTelDataSource_STATUS & AssignProperties_From_PerformanceCountersOTelDataSource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForPerformanceCountersOTelDataSource_STATUS, PerformanceCountersOTelDataSource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPerformanceCountersOTelDataSource_STATUS tests if a specific instance of PerformanceCountersOTelDataSource_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPerformanceCountersOTelDataSource_STATUS(subject PerformanceCountersOTelDataSource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.PerformanceCountersOTelDataSource_STATUS
	err := copied.AssignProperties_To_PerformanceCountersOTelDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_PerformanceCountersOTelDataSource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
