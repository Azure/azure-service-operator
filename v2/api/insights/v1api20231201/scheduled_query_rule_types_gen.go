...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/insights/v1api20231201/arm"
...
// +kubebuilder:webhook:path=/mutate-insights-azure-com-v1api20231201-scheduledqueryrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=insights.azure.com,resources=scheduledqueryrules,verbs=create;update,versions=v1api20231201,name=default.v1api20231201.scheduledqueryrules.insights.azure.com,admissionReviewVersions=v1
...
func (rule *ScheduledQueryRule_Spec) Initialize_From_ScheduledQueryRule_STATUS(source *ScheduledQueryRule_STATUS) error {
	...
	if source.ResolveConfiguration != nil {
		var resolveConfiguration RuleResolveConfiguration
		err := resolveConfiguration.Initialize_From_RuleResolveConfiguration_STATUS(source.ResolveConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_RuleResolveConfiguration_STATUS() to populate field ResolveConfiguration")
		}
		rule.ResolveConfiguration = &resolveConfiguration
	} else {
		rule.ResolveConfiguration = nil
