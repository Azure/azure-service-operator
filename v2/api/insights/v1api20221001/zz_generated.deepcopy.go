...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoscaleSettingProperties_ARM) DeepCopyInto(out *AutoscaleSettingProperties_ARM) {
	*out = *in
	if in.Enabled != nil {
...
func (in *AutoscaleSettingProperties_ARM) DeepCopy() *AutoscaleSettingProperties_ARM {
	if in == nil {
		return nil
	}
	out := new(AutoscaleSettingProperties_ARM)
	in.DeepCopyInto(out)
	return out
}
