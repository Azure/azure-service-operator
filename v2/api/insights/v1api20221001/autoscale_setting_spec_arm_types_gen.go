...
func (setting AutoscaleSetting_Spec_ARM) GetAPIVersion() string {
	return "2022-10-01"
}

// GetName returns the Name of the resource
func (setting *AutoscaleSetting_Spec_ARM) GetName() string {
	return setting.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Insights/autoscalesettings"
func (setting *AutoscaleSetting_Spec_ARM) GetType() string {
