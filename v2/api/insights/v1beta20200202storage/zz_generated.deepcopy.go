...
func (in *Component_Spec) DeepCopyInto(out *Component_Spec) {
	*out = *in
	...
	if in.PrivateLinkScopedResources != nil {
		in, out := &in.PrivateLinkScopedResources, &out.PrivateLinkScopedResources
		*out = make([]PrivateLinkScopedResource, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivateLinkScopedResource) DeepCopyInto(out *PrivateLinkScopedResource) {
	*out = *in
	if in.PropertyBag != nil {
		in, out := &in.PropertyBag, &out.PropertyBag
		*out = make(genruntime.PropertyBag, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateLinkScopedResource.
func (in *PrivateLinkScopedResource) DeepCopy() *PrivateLinkScopedResource {
	if in == nil {
		return nil
	}
	out := new(PrivateLinkScopedResource)
	in.DeepCopyInto(out)
	return out
}
