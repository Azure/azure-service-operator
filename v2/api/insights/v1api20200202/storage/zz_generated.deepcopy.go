...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentOperatorSecrets) DeepCopyInto(out *ComponentOperatorSecrets) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentOperatorSecrets.
func (in *ComponentOperatorSecrets) DeepCopy() *ComponentOperatorSecrets {
	if in == nil {
		return nil
	}
	out := new(ComponentOperatorSecrets)
	in.DeepCopyInto(out)
	return out
}
