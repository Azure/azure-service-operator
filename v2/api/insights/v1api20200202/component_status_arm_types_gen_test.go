...
func AddIndependentPropertyGeneratorsForApplicationInsightsComponentProperties_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Application_Type"] = gen.PtrOf(gen.OneConstOf(ApplicationInsightsComponentProperties_Application_Type_STATUS_ARM_Other, ApplicationInsightsComponentProperties_Application_Type_STATUS_ARM_Web))
	...
	gens["Flow_Type"] = gen.PtrOf(gen.OneConstOf(ApplicationInsightsComponentProperties_Flow_Type_STATUS_ARM_Bluefield))
	...
	gens["IngestionMode"] = gen.PtrOf(gen.OneConstOf(ApplicationInsightsComponentProperties_IngestionMode_STATUS_ARM_ApplicationInsights, ApplicationInsightsComponentProperties_IngestionMode_STATUS_ARM_ApplicationInsightsWithDiagnosticSettings, ApplicationInsightsComponentProperties_IngestionMode_STATUS_ARM_LogAnalytics))
	...
	gens["Request_Source"] = gen.PtrOf(gen.OneConstOf(ApplicationInsightsComponentProperties_Request_Source_STATUS_ARM_Rest))
