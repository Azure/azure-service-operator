...
type augmentConversionForWebtest interface {
	AssignPropertiesFrom(src *v20220615s.Webtest) error
	AssignPropertiesTo(dst *v20220615s.Webtest) error
}
...
type augmentConversionForWebtest_Spec interface {
	AssignPropertiesFrom(src *v20220615s.Webtest_Spec) error
	AssignPropertiesTo(dst *v20220615s.Webtest_Spec) error
}

type augmentConversionForWebtest_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.Webtest_STATUS) error
	AssignPropertiesTo(dst *v20220615s.Webtest_STATUS) error
}
...
type augmentConversionForWebTestGeolocation interface {
	AssignPropertiesFrom(src *v20220615s.WebTestGeolocation) error
	AssignPropertiesTo(dst *v20220615s.WebTestGeolocation) error
}

type augmentConversionForWebTestGeolocation_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.WebTestGeolocation_STATUS) error
	AssignPropertiesTo(dst *v20220615s.WebTestGeolocation_STATUS) error
}

type augmentConversionForWebTestProperties_Configuration interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_Configuration) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_Configuration) error
}

type augmentConversionForWebTestProperties_Configuration_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_Configuration_STATUS) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_Configuration_STATUS) error
}

type augmentConversionForWebTestProperties_Request interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_Request) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_Request) error
}

type augmentConversionForWebTestProperties_Request_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_Request_STATUS) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_Request_STATUS) error
}

type augmentConversionForWebTestProperties_ValidationRules interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_ValidationRules) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_ValidationRules) error
}

type augmentConversionForWebTestProperties_ValidationRules_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_ValidationRules_STATUS) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_ValidationRules_STATUS) error
}
...
type augmentConversionForHeaderField interface {
	AssignPropertiesFrom(src *v20220615s.HeaderField) error
	AssignPropertiesTo(dst *v20220615s.HeaderField) error
}

type augmentConversionForHeaderField_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.HeaderField_STATUS) error
	AssignPropertiesTo(dst *v20220615s.HeaderField_STATUS) error
}

type augmentConversionForWebTestProperties_ValidationRules_ContentValidation interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_ValidationRules_ContentValidation) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_ValidationRules_ContentValidation) error
}

type augmentConversionForWebTestProperties_ValidationRules_ContentValidation_STATUS interface {
	AssignPropertiesFrom(src *v20220615s.WebTestProperties_ValidationRules_ContentValidation_STATUS) error
	AssignPropertiesTo(dst *v20220615s.WebTestProperties_ValidationRules_ContentValidation_STATUS) error
}
