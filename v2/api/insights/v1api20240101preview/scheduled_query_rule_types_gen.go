...
// +kubebuilder:webhook:path=/mutate-insights-azure-com-v1api20240101preview-scheduledqueryrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=insights.azure.com,resources=scheduledqueryrules,verbs=create;update,versions=v1api20240101preview,name=default.v1api20240101preview.scheduledqueryrules.insights.azure.com,admissionReviewVersions=v1
