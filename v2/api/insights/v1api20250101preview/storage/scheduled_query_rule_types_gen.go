...
func (rule *ScheduledQueryRule) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20240101ps.ScheduledQueryRule
...
func (rule *ScheduledQueryRule) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20240101ps.ScheduledQueryRule
...
func (rule *ScheduledQueryRule) AssignProperties_From_ScheduledQueryRule(source *v20240101ps.ScheduledQueryRule) error {
...
func (rule *ScheduledQueryRule) AssignProperties_To_ScheduledQueryRule(destination *v20240101ps.ScheduledQueryRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v20240101ps.ScheduledQueryRule_Spec
	...
	// Status
	var status v20240101ps.ScheduledQueryRule_STATUS
...
// Storage version of v1api20250101preview.APIVersion
// +kubebuilder:validation:Enum={"2025-01-01-preview"}
type APIVersion string

const APIVersion_Value = APIVersion("2025-01-01-preview")

type augmentConversionForScheduledQueryRule interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRule) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRule) error
}

// Storage version of v1api20250101preview.ScheduledQueryRule_Spec
...
func (rule *ScheduledQueryRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20240101ps.ScheduledQueryRule_Spec)
	if ok {
	...
	src = &v20240101ps.ScheduledQueryRule_Spec{}
...
func (rule *ScheduledQueryRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20240101ps.ScheduledQueryRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20240101ps.ScheduledQueryRule_Spec{}
...
func (rule *ScheduledQueryRule_Spec) AssignProperties_From_ScheduledQueryRule_Spec(source *v20240101ps.ScheduledQueryRule_Spec) error {
...
func (rule *ScheduledQueryRule_Spec) AssignProperties_To_ScheduledQueryRule_Spec(destination *v20240101ps.ScheduledQueryRule_Spec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(rule.PropertyBag)

	// Actions
	if rule.Actions != nil {
		var action v20240101ps.Actions
	...
	if rule.Criteria != nil {
		var criterion v20240101ps.ScheduledQueryRuleCriteria
	...
	if rule.Identity != nil {
		var identity v20240101ps.Identity
	...
	if rule.OperatorSpec != nil {
		var operatorSpec v20240101ps.ScheduledQueryRuleOperatorSpec
	...
	if rule.ResolveConfiguration != nil {
		var resolveConfiguration v20240101ps.RuleResolveConfiguration
...
// Storage version of v1api20250101preview.ScheduledQueryRule_STATUS
...
func (rule *ScheduledQueryRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20240101ps.ScheduledQueryRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20240101ps.ScheduledQueryRule_STATUS{}
...
func (rule *ScheduledQueryRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20240101ps.ScheduledQueryRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20240101ps.ScheduledQueryRule_STATUS{}
...
func (rule *ScheduledQueryRule_STATUS) AssignProperties_From_ScheduledQueryRule_STATUS(source *v20240101ps.ScheduledQueryRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	if source.SystemData != nil {
		...
		var systemDataSTATUSPivot v20240311s.SystemData_STATUS
...
func (rule *ScheduledQueryRule_STATUS) AssignProperties_To_ScheduledQueryRule_STATUS(destination *v20240101ps.ScheduledQueryRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(rule.PropertyBag)

	// Actions
	if rule.Actions != nil {
		var action v20240101ps.Actions_STATUS
	...
	// Criteria
	if rule.Criteria != nil {
		var criterion v20240101ps.ScheduledQueryRuleCriteria_STATUS
	...
	// Identity
	if rule.Identity != nil {
		var identity v20240101ps.Identity_STATUS
	...
	// ResolveConfiguration
	if rule.ResolveConfiguration != nil {
		var resolveConfiguration v20240101ps.RuleResolveConfiguration_STATUS
	...
	if rule.SystemData != nil {
		...
		var systemDatum v20240101ps.SystemData_STATUS
...
func (actions *Actions) AssignProperties_From_Actions(source *v20240101ps.Actions) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (actions *Actions) AssignProperties_To_Actions(destination *v20240101ps.Actions) error {
	// Clone the existing property bag
...
func (actions *Actions_STATUS) AssignProperties_From_Actions_STATUS(source *v20240101ps.Actions_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (actions *Actions_STATUS) AssignProperties_To_Actions_STATUS(destination *v20240101ps.Actions_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(actions.PropertyBag)
...
type augmentConversionForScheduledQueryRule_Spec interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRule_Spec) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRule_Spec) error
}

type augmentConversionForScheduledQueryRule_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRule_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRule_STATUS) error
}
...
func (identity *Identity) AssignProperties_From_Identity(source *v20240101ps.Identity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	if source.UserAssignedIdentities != nil {
		...
		for userAssignedIdentityIndex, userAssignedIdentityItem := range source.UserAssignedIdentities {
			var userAssignedIdentityDetailsStash v20230601s.UserAssignedIdentityDetails
			...
			var userAssignedIdentityDetailsPivot v20240311s.UserAssignedIdentityDetails
...
func (identity *Identity) AssignProperties_To_Identity(destination *v20240101ps.Identity) error {
	// Clone the existing property bag
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20240101ps.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			...
			var userAssignedIdentity v20240101ps.UserAssignedIdentityDetails
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v20240101ps.Identity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v20240101ps.Identity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20240101ps.UserIdentityProperties_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			var userAssignedIdentity v20240101ps.UserIdentityProperties_STATUS
...
func (configuration *RuleResolveConfiguration) AssignProperties_From_RuleResolveConfiguration(source *v20240101ps.RuleResolveConfiguration) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// Invoke the augmentConversionForRuleResolveConfiguration interface (if implemented) to customize the conversion
	var configurationAsAny any = configuration
	if augmentedConfiguration, ok := configurationAsAny.(augmentConversionForRuleResolveConfiguration); ok {
...
func (configuration *RuleResolveConfiguration) AssignProperties_To_RuleResolveConfiguration(destination *v20240101ps.RuleResolveConfiguration) error {
	// Clone the existing property bag
...
func (configuration *RuleResolveConfiguration_STATUS) AssignProperties_From_RuleResolveConfiguration_STATUS(source *v20240101ps.RuleResolveConfiguration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// Invoke the augmentConversionForRuleResolveConfiguration_STATUS interface (if implemented) to customize the conversion
	var configurationAsAny any = configuration
	if augmentedConfiguration, ok := configurationAsAny.(augmentConversionForRuleResolveConfiguration_STATUS); ok {
		err := augmentedConfiguration.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
func (configuration *RuleResolveConfiguration_STATUS) AssignProperties_To_RuleResolveConfiguration_STATUS(destination *v20240101ps.RuleResolveConfiguration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(configuration.PropertyBag)
...
func (criteria *ScheduledQueryRuleCriteria) AssignProperties_From_ScheduledQueryRuleCriteria(source *v20240101ps.ScheduledQueryRuleCriteria) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (criteria *ScheduledQueryRuleCriteria) AssignProperties_To_ScheduledQueryRuleCriteria(destination *v20240101ps.ScheduledQueryRuleCriteria) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(criteria.PropertyBag)

	// AllOf
	if criteria.AllOf != nil {
		allOfList := make([]v20240101ps.Condition, len(criteria.AllOf))
		for allOfIndex, allOfItem := range criteria.AllOf {
			var allOf v20240101ps.Condition
...
func (criteria *ScheduledQueryRuleCriteria_STATUS) AssignProperties_From_ScheduledQueryRuleCriteria_STATUS(source *v20240101ps.ScheduledQueryRuleCriteria_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (criteria *ScheduledQueryRuleCriteria_STATUS) AssignProperties_To_ScheduledQueryRuleCriteria_STATUS(destination *v20240101ps.ScheduledQueryRuleCriteria_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(criteria.PropertyBag)

	// AllOf
	if criteria.AllOf != nil {
		allOfList := make([]v20240101ps.Condition_STATUS, len(criteria.AllOf))
		for allOfIndex, allOfItem := range criteria.AllOf {
			var allOf v20240101ps.Condition_STATUS
...
func (operator *ScheduledQueryRuleOperatorSpec) AssignProperties_From_ScheduledQueryRuleOperatorSpec(source *v20240101ps.ScheduledQueryRuleOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *ScheduledQueryRuleOperatorSpec) AssignProperties_To_ScheduledQueryRuleOperatorSpec(destination *v20240101ps.ScheduledQueryRuleOperatorSpec) error {
	// Clone the existing property bag
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20240311s.SystemData_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20240311s.SystemData_STATUS) error {
	// Clone the existing property bag
...
type augmentConversionForActions interface {
	AssignPropertiesFrom(src *v20240101ps.Actions) error
	AssignPropertiesTo(dst *v20240101ps.Actions) error
}

type augmentConversionForActions_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.Actions_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.Actions_STATUS) error
}

type augmentConversionForIdentity interface {
	AssignPropertiesFrom(src *v20240101ps.Identity) error
	AssignPropertiesTo(dst *v20240101ps.Identity) error
}

type augmentConversionForIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.Identity_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.Identity_STATUS) error
}

type augmentConversionForRuleResolveConfiguration interface {
	AssignPropertiesFrom(src *v20240101ps.RuleResolveConfiguration) error
	AssignPropertiesTo(dst *v20240101ps.RuleResolveConfiguration) error
}

type augmentConversionForRuleResolveConfiguration_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.RuleResolveConfiguration_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.RuleResolveConfiguration_STATUS) error
}

type augmentConversionForScheduledQueryRuleCriteria interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRuleCriteria) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRuleCriteria) error
}

type augmentConversionForScheduledQueryRuleCriteria_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRuleCriteria_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRuleCriteria_STATUS) error
}

type augmentConversionForScheduledQueryRuleOperatorSpec interface {
	AssignPropertiesFrom(src *v20240101ps.ScheduledQueryRuleOperatorSpec) error
	AssignPropertiesTo(dst *v20240101ps.ScheduledQueryRuleOperatorSpec) error
}

type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20240311s.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20240311s.SystemData_STATUS) error
}
...
func (condition *Condition) AssignProperties_From_Condition(source *v20240101ps.Condition) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// CriterionType
	condition.CriterionType = genruntime.ClonePointerToString(source.CriterionType)
	...
	// MinRecurrenceCount
	if propertyBag.Contains("MinRecurrenceCount") {
		var minRecurrenceCount int
		err := propertyBag.Pull("MinRecurrenceCount", &minRecurrenceCount)
		if err != nil {
			return eris.Wrap(err, "pulling 'MinRecurrenceCount' from propertyBag")
		}

		condition.MinRecurrenceCount = &minRecurrenceCount
	} else {
		condition.MinRecurrenceCount = nil
	}
...
func (condition *Condition) AssignProperties_To_Condition(destination *v20240101ps.Condition) error {
	// Clone the existing property bag
	...
	// CriterionType
	destination.CriterionType = genruntime.ClonePointerToString(condition.CriterionType)

	// Dimensions
	if condition.Dimensions != nil {
		dimensionList := make([]v20240101ps.Dimension, len(condition.Dimensions))
		for dimensionIndex, dimensionItem := range condition.Dimensions {
			var dimension v20240101ps.Dimension
	...
	if condition.FailingPeriods != nil {
		var failingPeriod v20240101ps.Condition_FailingPeriods
	...
	// MinRecurrenceCount
	if condition.MinRecurrenceCount != nil {
		propertyBag.Add("MinRecurrenceCount", *condition.MinRecurrenceCount)
	} else {
		propertyBag.Remove("MinRecurrenceCount")
	}
...
func (condition *Condition_STATUS) AssignProperties_From_Condition_STATUS(source *v20240101ps.Condition_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (condition *Condition_STATUS) AssignProperties_To_Condition_STATUS(destination *v20240101ps.Condition_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(condition.PropertyBag)
	...
	// Dimensions
	if condition.Dimensions != nil {
		dimensionList := make([]v20240101ps.Dimension_STATUS, len(condition.Dimensions))
		for dimensionIndex, dimensionItem := range condition.Dimensions {
			var dimension v20240101ps.Dimension_STATUS
	...
	// FailingPeriods
	if condition.FailingPeriods != nil {
		var failingPeriod v20240101ps.Condition_FailingPeriods_STATUS
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20240311s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20240311s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_From_UserIdentityProperties_STATUS(source *v20240101ps.UserIdentityProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_To_UserIdentityProperties_STATUS(destination *v20240101ps.UserIdentityProperties_STATUS) error {
	// Clone the existing property bag
...
type augmentConversionForCondition interface {
	AssignPropertiesFrom(src *v20240101ps.Condition) error
	AssignPropertiesTo(dst *v20240101ps.Condition) error
}

type augmentConversionForCondition_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.Condition_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.Condition_STATUS) error
}

type augmentConversionForUserAssignedIdentityDetails interface {
	AssignPropertiesFrom(src *v20240311s.UserAssignedIdentityDetails) error
...
type augmentConversionForUserIdentityProperties_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.UserIdentityProperties_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.UserIdentityProperties_STATUS) error
}
...
func (periods *Condition_FailingPeriods) AssignProperties_From_Condition_FailingPeriods(source *v20240101ps.Condition_FailingPeriods) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (periods *Condition_FailingPeriods) AssignProperties_To_Condition_FailingPeriods(destination *v20240101ps.Condition_FailingPeriods) error {
	// Clone the existing property bag
...
func (periods *Condition_FailingPeriods_STATUS) AssignProperties_From_Condition_FailingPeriods_STATUS(source *v20240101ps.Condition_FailingPeriods_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (periods *Condition_FailingPeriods_STATUS) AssignProperties_To_Condition_FailingPeriods_STATUS(destination *v20240101ps.Condition_FailingPeriods_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(periods.PropertyBag)
...
func (dimension *Dimension) AssignProperties_From_Dimension(source *v20240101ps.Dimension) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (dimension *Dimension) AssignProperties_To_Dimension(destination *v20240101ps.Dimension) error {
	// Clone the existing property bag
...
func (dimension *Dimension_STATUS) AssignProperties_From_Dimension_STATUS(source *v20240101ps.Dimension_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (dimension *Dimension_STATUS) AssignProperties_To_Dimension_STATUS(destination *v20240101ps.Dimension_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(dimension.PropertyBag)
...
type augmentConversionForCondition_FailingPeriods interface {
	AssignPropertiesFrom(src *v20240101ps.Condition_FailingPeriods) error
	AssignPropertiesTo(dst *v20240101ps.Condition_FailingPeriods) error
}

type augmentConversionForCondition_FailingPeriods_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.Condition_FailingPeriods_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.Condition_FailingPeriods_STATUS) error
}

type augmentConversionForDimension interface {
	AssignPropertiesFrom(src *v20240101ps.Dimension) error
	AssignPropertiesTo(dst *v20240101ps.Dimension) error
}

type augmentConversionForDimension_STATUS interface {
	AssignPropertiesFrom(src *v20240101ps.Dimension_STATUS) error
	AssignPropertiesTo(dst *v20240101ps.Dimension_STATUS) error
}
