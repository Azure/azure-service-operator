...
func (in *Condition) DeepCopyInto(out *Condition) {
	*out = *in
	...
	if in.CriterionType != nil {
		...
		*out = new(MicrosoftCommonCriterionType)
		**out = **in
	}
...
func (in *Condition_STATUS) DeepCopyInto(out *Condition_STATUS) {
	*out = *in
	...
	if in.CriterionType != nil {
		in, out := &in.CriterionType, &out.CriterionType
		*out = new(MicrosoftCommonCriterionType_STATUS)
		**out = **in
	}
	if in.Dimensions != nil {
		in, out := &in.Dimensions, &out.Dimensions
	...
	if in.Operator != nil {
		in, out := &in.Operator, &out.Operator
		*out = new(ConditionOperator_STATUS)
		**out = **in
	}
	if in.Query != nil {
		in, out := &in.Query, &out.Query
	...
	if in.TimeAggregation != nil {
		in, out := &in.TimeAggregation, &out.TimeAggregation
		*out = new(TimeAggregation_STATUS)
		**out = **in
	}
}
...
func (in *Dimension_STATUS) DeepCopyInto(out *Dimension_STATUS) {
	*out = *in
	...
	if in.Operator != nil {
		in, out := &in.Operator, &out.Operator
		*out = new(DimensionOperator_STATUS)
		**out = **in
	}
	if in.Values != nil {
		in, out := &in.Values, &out.Values
...
func (in *MicrosoftCommonIdentity) DeepCopyInto(out *MicrosoftCommonIdentity) {
	*out = *in
	if in.Type != nil {
		...
		*out = new(MicrosoftCommonIdentityType)
		**out = **in
	}
...
func (in *MicrosoftCommonIdentity_STATUS) DeepCopyInto(out *MicrosoftCommonIdentity_STATUS) {
	*out = *in
	...
	if in.Type != nil {
		in, out := &in.Type, &out.Type
		*out = new(MicrosoftCommonIdentityType_STATUS)
		**out = **in
	}
	if in.UserAssignedIdentities != nil {
		in, out := &in.UserAssignedIdentities, &out.UserAssignedIdentities
