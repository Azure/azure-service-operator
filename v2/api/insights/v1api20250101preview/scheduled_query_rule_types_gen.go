...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/insights/v1api20250101preview/arm"
	storage "github.com/Azure/azure-service-operator/v2/api/insights/v1api20250101preview/storage"
...
func (condition *Condition) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "MinRecurrenceCount":
	if condition.MinRecurrenceCount != nil {
		minRecurrenceCount := *condition.MinRecurrenceCount
		result.MinRecurrenceCount = &minRecurrenceCount
	}
...
func (condition *Condition) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "MinRecurrenceCount":
	if typedInput.MinRecurrenceCount != nil {
		minRecurrenceCount := *typedInput.MinRecurrenceCount
...
func (condition *Condition) AssignProperties_From_Condition(source *storage.Condition) error {
	...
	// MinRecurrenceCount
	condition.MinRecurrenceCount = genruntime.ClonePointerToInt(source.MinRecurrenceCount)
...
func (condition *Condition) AssignProperties_To_Condition(destination *storage.Condition) error {
	...
	// MinRecurrenceCount
	destination.MinRecurrenceCount = genruntime.ClonePointerToInt(condition.MinRecurrenceCount)
