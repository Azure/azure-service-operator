...
// - Generated from: /monitor/resource-manager/Microsoft.Insights/preview/2023-03-15-preview/scheduledQueryRule_API.json
...
func (rule *ScheduledQueryRule) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20230315ps.ScheduledQueryRule)
	if !ok {
		return fmt.Errorf("expected insights/v1api20230315previewstorage/ScheduledQueryRule but received %T instead", hub)
	}
...
func (rule *ScheduledQueryRule) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20230315ps.ScheduledQueryRule)
	if !ok {
		return fmt.Errorf("expected insights/v1api20230315previewstorage/ScheduledQueryRule but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-insights-azure-com-v1api20230315preview-scheduledqueryrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=insights.azure.com,resources=scheduledqueryrules,verbs=create;update,versions=v1api20230315preview,name=default.v1api20230315preview.scheduledqueryrules.insights.azure.com,admissionReviewVersions=v1
...
func (rule *ScheduledQueryRule) AssignProperties_From_ScheduledQueryRule(source *v20230315ps.ScheduledQueryRule) error {
...
func (rule *ScheduledQueryRule) AssignProperties_To_ScheduledQueryRule(destination *v20230315ps.ScheduledQueryRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230315ps.ScheduledQueryRule_Spec
	...
	// Status
	var status v20230315ps.ScheduledQueryRule_STATUS
...
type ScheduledQueryRule_Spec struct {
	...
	// RuleResolveConfiguration: Defines the configuration for resolving fired alerts. Relevant only for rules of the kind
	// LogAlert.
...
func (rule *ScheduledQueryRule_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if rule.Actions != nil ||
		...
		rule.RuleResolveConfiguration != nil ||
	...
	if rule.RuleResolveConfiguration != nil {
		ruleResolveConfiguration_ARM, err := (*rule.RuleResolveConfiguration).ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		ruleResolveConfiguration := *ruleResolveConfiguration_ARM.(*RuleResolveConfiguration_ARM)
		result.Properties.RuleResolveConfiguration = &ruleResolveConfiguration
	}
...
func (rule *ScheduledQueryRule_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "RuleResolveConfiguration":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.RuleResolveConfiguration != nil {
			var ruleResolveConfiguration1 RuleResolveConfiguration
			err := ruleResolveConfiguration1.PopulateFromARM(owner, *typedInput.Properties.RuleResolveConfiguration)
			if err != nil {
				return err
			}
			ruleResolveConfiguration := ruleResolveConfiguration1
			rule.RuleResolveConfiguration = &ruleResolveConfiguration
		}
	}
...
func (rule *ScheduledQueryRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230315ps.ScheduledQueryRule_Spec)
	if ok {
	...
	src = &v20230315ps.ScheduledQueryRule_Spec{}
...
func (rule *ScheduledQueryRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230315ps.ScheduledQueryRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230315ps.ScheduledQueryRule_Spec{}
...
func (rule *ScheduledQueryRule_Spec) AssignProperties_From_ScheduledQueryRule_Spec(source *v20230315ps.ScheduledQueryRule_Spec) error {
	...
	if source.RuleResolveConfiguration != nil {
		var ruleResolveConfiguration RuleResolveConfiguration
		err := ruleResolveConfiguration.AssignProperties_From_RuleResolveConfiguration(source.RuleResolveConfiguration)
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_From_RuleResolveConfiguration() to populate field RuleResolveConfiguration")
		}
		rule.RuleResolveConfiguration = &ruleResolveConfiguration
	} else {
		rule.RuleResolveConfiguration = nil
...
func (rule *ScheduledQueryRule_Spec) AssignProperties_To_ScheduledQueryRule_Spec(destination *v20230315ps.ScheduledQueryRule_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Actions
	if rule.Actions != nil {
		var action v20230315ps.Actions
	...
	// Criteria
	if rule.Criteria != nil {
		var criterion v20230315ps.ScheduledQueryRuleCriteria
	...
	// Identity
	if rule.Identity != nil {
		var identity v20230315ps.Identity
	...
	// RuleResolveConfiguration
	if rule.RuleResolveConfiguration != nil {
		var ruleResolveConfiguration v20230315ps.RuleResolveConfiguration
		err := rule.RuleResolveConfiguration.AssignProperties_To_RuleResolveConfiguration(&ruleResolveConfiguration)
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_To_RuleResolveConfiguration() to populate field RuleResolveConfiguration")
		}
		destination.RuleResolveConfiguration = &ruleResolveConfiguration
	} else {
		destination.RuleResolveConfiguration = nil
	}
...
func (rule *ScheduledQueryRule_Spec) Initialize_From_ScheduledQueryRule_STATUS(source *ScheduledQueryRule_STATUS) error {
	...
	if source.RuleResolveConfiguration != nil {
		var ruleResolveConfiguration RuleResolveConfiguration
		err := ruleResolveConfiguration.Initialize_From_RuleResolveConfiguration_STATUS(source.RuleResolveConfiguration)
		if err != nil {
			return errors.Wrap(err, "calling Initialize_From_RuleResolveConfiguration_STATUS() to populate field RuleResolveConfiguration")
		}
		rule.RuleResolveConfiguration = &ruleResolveConfiguration
	} else {
		rule.RuleResolveConfiguration = nil
...
type ScheduledQueryRule_STATUS struct {
	...
	// RuleResolveConfiguration: Defines the configuration for resolving fired alerts. Relevant only for rules of the kind
	// LogAlert.
	RuleResolveConfiguration *RuleResolveConfiguration_STATUS `json:"ruleResolveConfiguration,omitempty"`
...
func (rule *ScheduledQueryRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230315ps.ScheduledQueryRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230315ps.ScheduledQueryRule_STATUS{}
...
func (rule *ScheduledQueryRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230315ps.ScheduledQueryRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230315ps.ScheduledQueryRule_STATUS{}
...
func (rule *ScheduledQueryRule_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.RuleResolveConfiguration != nil {
			var ruleResolveConfiguration1 RuleResolveConfiguration_STATUS
			err := ruleResolveConfiguration1.PopulateFromARM(owner, *typedInput.Properties.RuleResolveConfiguration)
			if err != nil {
				return err
			}
...
func (rule *ScheduledQueryRule_STATUS) AssignProperties_From_ScheduledQueryRule_STATUS(source *v20230315ps.ScheduledQueryRule_STATUS) error {
	...
	// RuleResolveConfiguration
	if source.RuleResolveConfiguration != nil {
		var ruleResolveConfiguration RuleResolveConfiguration_STATUS
		err := ruleResolveConfiguration.AssignProperties_From_RuleResolveConfiguration_STATUS(source.RuleResolveConfiguration)
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_From_RuleResolveConfiguration_STATUS() to populate field RuleResolveConfiguration")
		}
		rule.RuleResolveConfiguration = &ruleResolveConfiguration
	} else {
		rule.RuleResolveConfiguration = nil
...
func (rule *ScheduledQueryRule_STATUS) AssignProperties_To_ScheduledQueryRule_STATUS(destination *v20230315ps.ScheduledQueryRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Actions
	if rule.Actions != nil {
		var action v20230315ps.Actions_STATUS
	...
	// Criteria
	if rule.Criteria != nil {
		var criterion v20230315ps.ScheduledQueryRuleCriteria_STATUS
	...
	// Identity
	if rule.Identity != nil {
		var identity v20230315ps.Identity_STATUS
	...
	// RuleResolveConfiguration
	if rule.RuleResolveConfiguration != nil {
		var ruleResolveConfiguration v20230315ps.RuleResolveConfiguration_STATUS
		err := rule.RuleResolveConfiguration.AssignProperties_To_RuleResolveConfiguration_STATUS(&ruleResolveConfiguration)
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_To_RuleResolveConfiguration_STATUS() to populate field RuleResolveConfiguration")
		}
		destination.RuleResolveConfiguration = &ruleResolveConfiguration
	} else {
		destination.RuleResolveConfiguration = nil
...
func (actions *Actions) AssignProperties_From_Actions(source *v20230315ps.Actions) error {
...
func (actions *Actions) AssignProperties_To_Actions(destination *v20230315ps.Actions) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (actions *Actions_STATUS) AssignProperties_From_Actions_STATUS(source *v20230315ps.Actions_STATUS) error {
...
func (actions *Actions_STATUS) AssignProperties_To_Actions_STATUS(destination *v20230315ps.Actions_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *Identity) AssignProperties_From_Identity(source *v20230315ps.Identity) error {
...
func (identity *Identity) AssignProperties_To_Identity(destination *v20230315ps.Identity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20230315ps.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20230315ps.UserAssignedIdentityDetails
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v20230315ps.Identity_STATUS) error {
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v20230315ps.Identity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20230315ps.UserIdentityProperties_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20230315ps.UserIdentityProperties_STATUS
...
func (configuration *RuleResolveConfiguration) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &RuleResolveConfiguration_ARM{}
...
func (configuration *RuleResolveConfiguration) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &RuleResolveConfiguration_ARM{}
}
...
func (configuration *RuleResolveConfiguration) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(RuleResolveConfiguration_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected RuleResolveConfiguration_ARM, got %T", armInput)
	}
...
func (configuration *RuleResolveConfiguration) AssignProperties_From_RuleResolveConfiguration(source *v20230315ps.RuleResolveConfiguration) error {
...
func (configuration *RuleResolveConfiguration) AssignProperties_To_RuleResolveConfiguration(destination *v20230315ps.RuleResolveConfiguration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *RuleResolveConfiguration_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &RuleResolveConfiguration_STATUS_ARM{}
}
...
func (configuration *RuleResolveConfiguration_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(RuleResolveConfiguration_STATUS_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected RuleResolveConfiguration_STATUS_ARM, got %T", armInput)
	}
...
func (configuration *RuleResolveConfiguration_STATUS) AssignProperties_From_RuleResolveConfiguration_STATUS(source *v20230315ps.RuleResolveConfiguration_STATUS) error {
...
func (configuration *RuleResolveConfiguration_STATUS) AssignProperties_To_RuleResolveConfiguration_STATUS(destination *v20230315ps.RuleResolveConfiguration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (criteria *ScheduledQueryRuleCriteria) AssignProperties_From_ScheduledQueryRuleCriteria(source *v20230315ps.ScheduledQueryRuleCriteria) error {
...
func (criteria *ScheduledQueryRuleCriteria) AssignProperties_To_ScheduledQueryRuleCriteria(destination *v20230315ps.ScheduledQueryRuleCriteria) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AllOf
	if criteria.AllOf != nil {
		allOfList := make([]v20230315ps.Condition, len(criteria.AllOf))
		for allOfIndex, allOfItem := range criteria.AllOf {
			// Shadow the loop variable to avoid aliasing
			allOfItem := allOfItem
			var allOf v20230315ps.Condition
...
func (criteria *ScheduledQueryRuleCriteria_STATUS) AssignProperties_From_ScheduledQueryRuleCriteria_STATUS(source *v20230315ps.ScheduledQueryRuleCriteria_STATUS) error {
...
func (criteria *ScheduledQueryRuleCriteria_STATUS) AssignProperties_To_ScheduledQueryRuleCriteria_STATUS(destination *v20230315ps.ScheduledQueryRuleCriteria_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AllOf
	if criteria.AllOf != nil {
		allOfList := make([]v20230315ps.Condition_STATUS, len(criteria.AllOf))
		for allOfIndex, allOfItem := range criteria.AllOf {
			// Shadow the loop variable to avoid aliasing
			allOfItem := allOfItem
			var allOf v20230315ps.Condition_STATUS
...
func (condition *Condition) AssignProperties_From_Condition(source *v20230315ps.Condition) error {
...
func (condition *Condition) AssignProperties_To_Condition(destination *v20230315ps.Condition) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Dimensions
	if condition.Dimensions != nil {
		dimensionList := make([]v20230315ps.Dimension, len(condition.Dimensions))
		for dimensionIndex, dimensionItem := range condition.Dimensions {
			// Shadow the loop variable to avoid aliasing
			dimensionItem := dimensionItem
			var dimension v20230315ps.Dimension
	...
	// FailingPeriods
	if condition.FailingPeriods != nil {
		var failingPeriod v20230315ps.Condition_FailingPeriods
...
func (condition *Condition_STATUS) AssignProperties_From_Condition_STATUS(source *v20230315ps.Condition_STATUS) error {
...
func (condition *Condition_STATUS) AssignProperties_To_Condition_STATUS(destination *v20230315ps.Condition_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Dimensions
	if condition.Dimensions != nil {
		dimensionList := make([]v20230315ps.Dimension_STATUS, len(condition.Dimensions))
		for dimensionIndex, dimensionItem := range condition.Dimensions {
			// Shadow the loop variable to avoid aliasing
			dimensionItem := dimensionItem
			var dimension v20230315ps.Dimension_STATUS
	...
	// FailingPeriods
	if condition.FailingPeriods != nil {
		var failingPeriod v20230315ps.Condition_FailingPeriods_STATUS
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20230315ps.UserAssignedIdentityDetails) error {
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20230315ps.UserAssignedIdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_From_UserIdentityProperties_STATUS(source *v20230315ps.UserIdentityProperties_STATUS) error {
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_To_UserIdentityProperties_STATUS(destination *v20230315ps.UserIdentityProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (periods *Condition_FailingPeriods) AssignProperties_From_Condition_FailingPeriods(source *v20230315ps.Condition_FailingPeriods) error {
...
func (periods *Condition_FailingPeriods) AssignProperties_To_Condition_FailingPeriods(destination *v20230315ps.Condition_FailingPeriods) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (periods *Condition_FailingPeriods_STATUS) AssignProperties_From_Condition_FailingPeriods_STATUS(source *v20230315ps.Condition_FailingPeriods_STATUS) error {
...
func (periods *Condition_FailingPeriods_STATUS) AssignProperties_To_Condition_FailingPeriods_STATUS(destination *v20230315ps.Condition_FailingPeriods_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (dimension *Dimension) AssignProperties_From_Dimension(source *v20230315ps.Dimension) error {
...
func (dimension *Dimension) AssignProperties_To_Dimension(destination *v20230315ps.Dimension) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (dimension *Dimension_STATUS) AssignProperties_From_Dimension_STATUS(source *v20230315ps.Dimension_STATUS) error {
...
func (dimension *Dimension_STATUS) AssignProperties_To_Dimension_STATUS(destination *v20230315ps.Dimension_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
