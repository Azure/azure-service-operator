...
func RunResourceConversionTestForScheduledQueryRule(subject ScheduledQueryRule) string {
	...
	var hub v20230315ps.ScheduledQueryRule
...
// RunPropertyAssignmentTestForScheduledQueryRule tests if a specific instance of ScheduledQueryRule can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForScheduledQueryRule(subject ScheduledQueryRule) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.ScheduledQueryRule
...
// RunPropertyAssignmentTestForScheduledQueryRule_Spec tests if a specific instance of ScheduledQueryRule_Spec can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForScheduledQueryRule_Spec(subject ScheduledQueryRule_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.ScheduledQueryRule_Spec
...
func AddRelatedPropertyGeneratorsForScheduledQueryRule_Spec(gens map[string]gopter.Gen) {
	...
	gens["RuleResolveConfiguration"] = gen.PtrOf(RuleResolveConfigurationGenerator())
}
...
// RunPropertyAssignmentTestForScheduledQueryRule_STATUS tests if a specific instance of ScheduledQueryRule_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForScheduledQueryRule_STATUS(subject ScheduledQueryRule_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.ScheduledQueryRule_STATUS
...
func AddRelatedPropertyGeneratorsForScheduledQueryRule_STATUS(gens map[string]gopter.Gen) {
	...
	gens["RuleResolveConfiguration"] = gen.PtrOf(RuleResolveConfiguration_STATUSGenerator())
...
// RunPropertyAssignmentTestForActions tests if a specific instance of Actions can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForActions(subject Actions) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Actions
...
// RunPropertyAssignmentTestForActions_STATUS tests if a specific instance of Actions_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForActions_STATUS(subject Actions_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Actions_STATUS
...
// RunPropertyAssignmentTestForIdentity tests if a specific instance of Identity can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForIdentity(subject Identity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Identity
...
// RunPropertyAssignmentTestForIdentity_STATUS tests if a specific instance of Identity_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForIdentity_STATUS(subject Identity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Identity_STATUS
...
// RunPropertyAssignmentTestForRuleResolveConfiguration tests if a specific instance of RuleResolveConfiguration can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForRuleResolveConfiguration(subject RuleResolveConfiguration) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.RuleResolveConfiguration
...
// RunPropertyAssignmentTestForRuleResolveConfiguration_STATUS tests if a specific instance of RuleResolveConfiguration_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForRuleResolveConfiguration_STATUS(subject RuleResolveConfiguration_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.RuleResolveConfiguration_STATUS
...
// RunPropertyAssignmentTestForScheduledQueryRuleCriteria tests if a specific instance of ScheduledQueryRuleCriteria can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForScheduledQueryRuleCriteria(subject ScheduledQueryRuleCriteria) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.ScheduledQueryRuleCriteria
...
// RunPropertyAssignmentTestForScheduledQueryRuleCriteria_STATUS tests if a specific instance of ScheduledQueryRuleCriteria_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForScheduledQueryRuleCriteria_STATUS(subject ScheduledQueryRuleCriteria_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.ScheduledQueryRuleCriteria_STATUS
...
// RunPropertyAssignmentTestForCondition tests if a specific instance of Condition can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForCondition(subject Condition) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Condition
...
// RunPropertyAssignmentTestForCondition_STATUS tests if a specific instance of Condition_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForCondition_STATUS(subject Condition_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Condition_STATUS
...
// RunPropertyAssignmentTestForUserAssignedIdentityDetails tests if a specific instance of UserAssignedIdentityDetails can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForUserAssignedIdentityDetails(subject UserAssignedIdentityDetails) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.UserAssignedIdentityDetails
...
// RunPropertyAssignmentTestForUserIdentityProperties_STATUS tests if a specific instance of UserIdentityProperties_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForUserIdentityProperties_STATUS(subject UserIdentityProperties_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.UserIdentityProperties_STATUS
...
// RunPropertyAssignmentTestForCondition_FailingPeriods tests if a specific instance of Condition_FailingPeriods can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForCondition_FailingPeriods(subject Condition_FailingPeriods) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Condition_FailingPeriods
...
// RunPropertyAssignmentTestForCondition_FailingPeriods_STATUS tests if a specific instance of Condition_FailingPeriods_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForCondition_FailingPeriods_STATUS(subject Condition_FailingPeriods_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Condition_FailingPeriods_STATUS
...
// RunPropertyAssignmentTestForDimension tests if a specific instance of Dimension can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForDimension(subject Dimension) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Dimension
...
// RunPropertyAssignmentTestForDimension_STATUS tests if a specific instance of Dimension_STATUS can be assigned to v1api20230315previewstorage and back losslessly
func RunPropertyAssignmentTestForDimension_STATUS(subject Dimension_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230315ps.Dimension_STATUS
