...
type DiagnosticSetting_STATUS_ARM struct {
	...
	Properties *DiagnosticSettings_STATUS_ARM `json:"properties,omitempty"`
...
type DiagnosticSettings_STATUS_ARM struct {
	...
	Logs []LogSettings_STATUS_ARM `json:"logs,omitempty"`
	...
	Metrics []MetricSettings_STATUS_ARM `json:"metrics,omitempty"`
...
type LogSettings_STATUS_ARM struct {
...
type MetricSettings_STATUS_ARM struct {
