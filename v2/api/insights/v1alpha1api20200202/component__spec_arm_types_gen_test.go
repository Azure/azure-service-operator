...
func AddIndependentPropertyGeneratorsForApplicationInsightsComponentPropertiesARM(gens map[string]gopter.Gen) {
	gens["Application_Type"] = gen.OneConstOf(ApplicationInsightsComponentPropertiesApplication_TypeOther, ApplicationInsightsComponentPropertiesApplication_TypeWeb)
