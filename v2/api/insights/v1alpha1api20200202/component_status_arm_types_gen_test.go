...
func Test_Component_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<< HEAD:v2/api/insights/v1alpha1api20200202/component_status_arm_types_gen_test.go
...
>>>>>>> main:v2/api/insights/v1alpha1api20200202/application_insights_component_status_arm_types_gen_test.go
	// Serialize to JSON
