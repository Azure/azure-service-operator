...
func (webtest *Webtest) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220615s.Webtest)
	if !ok {
...
func (webtest *Webtest) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220615s.Webtest)
	if !ok {
		return fmt.Errorf("expected insights/v1api20220615/storage/Webtest but received %T instead", hub)
	}
...
func (webtest *Webtest) AssignProperties_To_Webtest(destination *v20220615s.Webtest) error {
	...
	// Spec
	var spec v20220615s.Webtest_Spec
	...
	// Status
	var status v20220615s.Webtest_STATUS
...
func (webtest *Webtest_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20220615s.Webtest_Spec)
	if ok {
...
func (webtest *Webtest_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20220615s.Webtest_Spec)
	if ok {
...
func (webtest *Webtest_Spec) AssignProperties_To_Webtest_Spec(destination *v20220615s.Webtest_Spec) error {
	...
	// Configuration
	if webtest.Configuration != nil {
		var configuration v20220615s.WebTestProperties_Configuration
	...
	if webtest.Locations != nil {
		locationList := make([]v20220615s.WebTestGeolocation, len(webtest.Locations))
		for locationIndex, locationItem := range webtest.Locations {
			// Shadow the loop variable to avoid aliasing
			locationItem := locationItem
			var location v20220615s.WebTestGeolocation
	...
	// Request
	if webtest.Request != nil {
		var request v20220615s.WebTestProperties_Request
	...
	// ValidationRules
	if webtest.ValidationRules != nil {
		var validationRule v20220615s.WebTestProperties_ValidationRules
...
func (webtest *Webtest_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20220615s.Webtest_STATUS)
	if ok {
		// Populate our instance from source
...
func (webtest *Webtest_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20220615s.Webtest_STATUS)
	if ok {
		// Populate destination from our instance
...
func (webtest *Webtest_STATUS) AssignProperties_To_Webtest_STATUS(destination *v20220615s.Webtest_STATUS) error {
	...
	// Configuration
	if webtest.Configuration != nil {
		var configuration v20220615s.WebTestProperties_Configuration_STATUS
	...
	// Locations
	if webtest.Locations != nil {
		locationList := make([]v20220615s.WebTestGeolocation_STATUS, len(webtest.Locations))
		for locationIndex, locationItem := range webtest.Locations {
			// Shadow the loop variable to avoid aliasing
			locationItem := locationItem
			var location v20220615s.WebTestGeolocation_STATUS
	...
	// Request
	if webtest.Request != nil {
		var request v20220615s.WebTestProperties_Request_STATUS
	...
	// ValidationRules
	if webtest.ValidationRules != nil {
		var validationRule v20220615s.WebTestProperties_ValidationRules_STATUS
...
func (request *WebTestProperties_Request) AssignProperties_To_WebTestProperties_Request(destination *v20220615s.WebTestProperties_Request) error {
	...
	if request.Headers != nil {
		headerList := make([]v20220615s.HeaderField, len(request.Headers))
		for headerIndex, headerItem := range request.Headers {
			// Shadow the loop variable to avoid aliasing
			headerItem := headerItem
			var header v20220615s.HeaderField
...
func (request *WebTestProperties_Request_STATUS) AssignProperties_To_WebTestProperties_Request_STATUS(destination *v20220615s.WebTestProperties_Request_STATUS) error {
	...
	// Headers
	if request.Headers != nil {
		headerList := make([]v20220615s.HeaderField_STATUS, len(request.Headers))
		for headerIndex, headerItem := range request.Headers {
			// Shadow the loop variable to avoid aliasing
			headerItem := headerItem
			var header v20220615s.HeaderField_STATUS
...
func (rules *WebTestProperties_ValidationRules) AssignProperties_To_WebTestProperties_ValidationRules(destination *v20220615s.WebTestProperties_ValidationRules) error {
	...
	// ContentValidation
	if rules.ContentValidation != nil {
		var contentValidation v20220615s.WebTestProperties_ValidationRules_ContentValidation
...
func (rules *WebTestProperties_ValidationRules_STATUS) AssignProperties_To_WebTestProperties_ValidationRules_STATUS(destination *v20220615s.WebTestProperties_ValidationRules_STATUS) error {
	...
	// ContentValidation
	if rules.ContentValidation != nil {
		var contentValidation v20220615s.WebTestProperties_ValidationRules_ContentValidation_STATUS
