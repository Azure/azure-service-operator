...
type Webtests_SPECARM struct {
	...
	Properties *WebTestProperties_SpecARM `json:"properties,omitempty"`
...
func (specarm Webtests_SPECARM) GetName() string {
	return specarm.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Insights/webtests"
func (specarm Webtests_SPECARM) GetType() string {
...
type WebTestProperties_SpecARM struct {
	...
	Locations []WebTestGeolocation_SpecARM `json:"Locations"`
...
type WebTestProperties_Request_SpecARM struct {
	...
	Headers []HeaderField_SpecARM `json:"Headers,omitempty"`
...
type HeaderField_SpecARM struct {
