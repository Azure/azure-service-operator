...
func Test_RoleAssignment_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/authorization/v1alpha1api20200801preview/role_assignment__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/authorization/v1alpha1api20200801preview/role_assignments_spec_arm_types_gen_test.go
	// Serialize to JSON
