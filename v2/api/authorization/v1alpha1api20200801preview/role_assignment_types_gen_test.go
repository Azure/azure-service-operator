...
// RunPropertyAssignmentTestForRoleAssignmentCreateParameters_STATUS tests if a specific instance of RoleAssignmentCreateParameters_STATUS can be assigned to v1alpha1api20200801previewstorage and back losslessly
func RunPropertyAssignmentTestForRoleAssignmentCreateParameters_STATUS(subject RoleAssignmentCreateParameters_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200801ps.RoleAssignmentCreateParameters_STATUS
