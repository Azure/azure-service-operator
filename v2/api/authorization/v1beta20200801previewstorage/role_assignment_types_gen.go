...
type augmentConversionForRoleAssignment interface {
	AssignPropertiesFrom(src *v1api20200801ps.RoleAssignment) error
	AssignPropertiesTo(dst *v1api20200801ps.RoleAssignment) error
}
...
type augmentConversionForRoleAssignment_Spec interface {
	AssignPropertiesFrom(src *v1api20200801ps.RoleAssignment_Spec) error
	AssignPropertiesTo(dst *v1api20200801ps.RoleAssignment_Spec) error
}

type augmentConversionForRoleAssignment_STATUS interface {
	AssignPropertiesFrom(src *v1api20200801ps.RoleAssignment_STATUS) error
	AssignPropertiesTo(dst *v1api20200801ps.RoleAssignment_STATUS) error
}
