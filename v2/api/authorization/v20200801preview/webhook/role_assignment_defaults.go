...
import (
	...
	v20200801p "github.com/Azure/azure-service-operator/v2/api/authorization/v20200801preview"
...
func (webhook *RoleAssignment) CustomDefault(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/authorization/v20200801preview/RoleAssignment, but got %T", obj)
	}
