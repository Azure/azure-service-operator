...
// Role definition.
type RoleDefinition_STATUS_ARM struct {
	...
	Properties *RoleDefinitionProperties_STATUS_ARM `json:"properties,omitempty"`
...
type RoleDefinitionProperties_STATUS_ARM struct {
	...
	Permissions []Permission_STATUS_ARM `json:"permissions,omitempty"`
...
type Permission_STATUS_ARM struct {
