...
func AddIndependentPropertyGeneratorsForRoleAssignmentProperties_ARM(gens map[string]gopter.Gen) {
	...
	gens["PrincipalType"] = gen.PtrOf(gen.OneConstOf(
		RoleAssignmentProperties_PrincipalType_ARM_ForeignGroup,
		RoleAssignmentProperties_PrincipalType_ARM_Group,
		RoleAssignmentProperties_PrincipalType_ARM_ServicePrincipal,
		RoleAssignmentProperties_PrincipalType_ARM_User))
