...
type RoleAssignmentOperatorSpec struct {
	// NamingConvention: The naming convention to use for the AzureName of any RoleAssignment where AzureName is not given. One
	// of 'deterministic' (the default) or 'random' (for a new GUID every time).
