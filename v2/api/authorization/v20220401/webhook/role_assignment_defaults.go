...
func (webhook *RoleAssignment) CustomDefault(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20220401.RoleAssignment)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/authorization/v20220401/RoleAssignment, but got %T", obj)
	}
...
func (webhook *RoleAssignment) defaultAzureName(_ context.Context, assignment *v20220401.RoleAssignment) {
