...
<<<<<<<< HEAD:v2/api/dbformysql/v1beta20210501/flexible_servers_database__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/dbformysql/v1beta20210501/flexible_servers_databases_spec_arm_types_gen_test.go
	t.Parallel()
