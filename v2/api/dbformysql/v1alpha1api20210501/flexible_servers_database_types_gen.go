...
func (database *FlexibleServersDatabase) AssignPropertiesToFlexibleServersDatabase(destination *v1alpha1api20210501storage.FlexibleServersDatabase) error {
	...
	// Spec
	var spec v1alpha1api20210501storage.FlexibleServersDatabase_Spec
...
func (database *FlexibleServersDatabase_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	var result FlexibleServersDatabase_SpecARM
...
func (database *FlexibleServersDatabase_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1alpha1api20210501storage.FlexibleServersDatabase_Spec)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1alpha1api20210501storage.FlexibleServersDatabase_Spec{}
...
func (database *FlexibleServersDatabase_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1alpha1api20210501storage.FlexibleServersDatabase_Spec)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210501storage.FlexibleServersDatabase_Spec{}
...
func (database *FlexibleServersDatabase_Spec) AssignPropertiesFromFlexibleServersDatabase_Spec(source *v1alpha1api20210501storage.FlexibleServersDatabase_Spec) error {
...
func (database *FlexibleServersDatabase_Spec) AssignPropertiesToFlexibleServersDatabase_Spec(destination *v1alpha1api20210501storage.FlexibleServersDatabase_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
