...
func (rule *FlexibleServersFirewallRule) AssignPropertiesFromFlexibleServersFirewallRule(source *v1alpha1api20210501storage.FlexibleServersFirewallRule) error {
...
func (rule *FlexibleServersFirewallRule) AssignPropertiesToFlexibleServersFirewallRule(destination *v1alpha1api20210501storage.FlexibleServersFirewallRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec
...
func (rule *FlexibleServersFirewallRule_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	var result FlexibleServersFirewallRule_SpecARM
	...
	result.Properties.EndIpAddress = rule.EndIpAddress
	result.Properties.StartIpAddress = rule.StartIpAddress
	return result, nil
}
...
func (rule *FlexibleServersFirewallRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec{}
...
func (rule *FlexibleServersFirewallRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec{}
...
func (rule *FlexibleServersFirewallRule_Spec) AssignPropertiesFromFlexibleServersFirewallRule_Spec(source *v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec) error {
	...
	if source.EndIpAddress != nil {
		rule.EndIpAddress = *source.EndIpAddress
	} else {
		rule.EndIpAddress = ""
	}
	...
	if source.StartIpAddress != nil {
		rule.StartIpAddress = *source.StartIpAddress
	} else {
		rule.StartIpAddress = ""
	}
...
func (rule *FlexibleServersFirewallRule_Spec) AssignPropertiesToFlexibleServersFirewallRule_Spec(destination *v1alpha1api20210501storage.FlexibleServersFirewallRule_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
