...
<<<<<<<< HEAD:v2/api/dbformysql/v1alpha1api20210501/flexible_servers_database__spec_arm_types_gen.go
...
========
// Deprecated version of FlexibleServers_Databases_Spec. Use v1beta20210501.FlexibleServers_Databases_Spec instead
type FlexibleServers_Databases_SpecARM struct {
	Location   *string                `json:"location,omitempty"`
>>>>>>>> main:v2/api/dbformysql/v1alpha1api20210501/flexible_servers_databases_spec_arm_types_gen.go
