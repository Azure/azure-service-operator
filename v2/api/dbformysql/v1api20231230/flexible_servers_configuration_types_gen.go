...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/dbformysql/v1api20231230/arm"
...
// +kubebuilder:webhook:path=/mutate-dbformysql-azure-com-v1api20231230-flexibleserversconfiguration,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversconfigurations,verbs=create;update,versions=v1api20231230,name=default.v1api20231230.flexibleserversconfigurations.dbformysql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbformysql-azure-com-v1api20231230-flexibleserversconfiguration,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversconfigurations,verbs=create;update,versions=v1api20231230,name=validate.v1api20231230.flexibleserversconfigurations.dbformysql.azure.com,admissionReviewVersions=v1
