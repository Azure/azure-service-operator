...
func (configuration *FlexibleServersConfiguration) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected dbformysql/v20241230/storage/FlexibleServersConfiguration but received %T instead", hub)
	}
...
// Storage version of v1api20231230.FlexibleServersConfiguration_Spec
...
// Storage version of v1api20231230.FlexibleServersConfiguration_STATUS
...
// Storage version of v1api20231230.FlexibleServersConfigurationOperatorSpec
