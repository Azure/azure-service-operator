...
// +kubebuilder:webhook:path=/mutate-dbformysql-azure-com-v1api20231230-flexibleserversdatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v1api20231230,name=default.v1api20231230.flexibleserversdatabases.dbformysql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbformysql-azure-com-v1api20231230-flexibleserversdatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v1api20231230,name=validate.v1api20231230.flexibleserversdatabases.dbformysql.azure.com,admissionReviewVersions=v1
