...
// +kubebuilder:webhook:path=/mutate-dbformysql-azure-com-v1api20231230-flexibleserver,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleservers,verbs=create;update,versions=v1api20231230,name=default.v1api20231230.flexibleservers.dbformysql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbformysql-azure-com-v1api20231230-flexibleserver,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleservers,verbs=create;update,versions=v1api20231230,name=validate.v1api20231230.flexibleservers.dbformysql.azure.com,admissionReviewVersions=v1
...
func (server *FlexibleServer_Spec) Initialize_From_FlexibleServer_STATUS(source *FlexibleServer_STATUS) error {
	...
	if source.Identity != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_MySQLServerIdentity_STATUS() to populate field Identity")
		}
		server.Identity = &identity
	} else {
		server.Identity = nil
	...
	if source.ImportSourceProperties != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ImportSourceProperties_STATUS() to populate field ImportSourceProperties")
		}
		server.ImportSourceProperties = &importSourceProperty
	} else {
		server.ImportSourceProperties = nil
	...
	if source.Sku != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_MySQLServerSku_STATUS() to populate field Sku")
		}
		server.Sku = &sku
	} else {
		server.Sku = nil
