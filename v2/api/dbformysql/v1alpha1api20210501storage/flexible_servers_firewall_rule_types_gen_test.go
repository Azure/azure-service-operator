...
func RunResourceConversionTestForFlexibleServersFirewallRule(subject FlexibleServersFirewallRule) string {
	...
	var hub v1beta20210501storage.FlexibleServersFirewallRule
...
func RunPropertyAssignmentTestForFlexibleServersFirewallRule(subject FlexibleServersFirewallRule) string {
	...
	var other v1beta20210501storage.FlexibleServersFirewallRule
...
func RunPropertyAssignmentTestForFirewallRuleStatus(subject FirewallRule_Status) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1beta20210501storage.FirewallRule_Status
...
// RunPropertyAssignmentTestForFlexibleServersFirewallRulesSpec tests if a specific instance of FlexibleServersFirewallRules_Spec can be assigned to v1beta20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServersFirewallRulesSpec(subject FlexibleServersFirewallRules_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1beta20210501storage.FlexibleServersFirewallRules_Spec
