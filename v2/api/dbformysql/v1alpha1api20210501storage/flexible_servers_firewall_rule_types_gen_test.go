...
// RunPropertyAssignmentTestForFirewallRuleSTATUS tests if a specific instance of FirewallRule_STATUS can be assigned to v1beta20210501storage and back losslessly
