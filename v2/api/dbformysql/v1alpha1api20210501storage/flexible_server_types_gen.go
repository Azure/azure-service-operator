...
type augmentConversionForFlexibleServer interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServer) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServer) error
}

// Storage version of v1alpha1api20210501.FlexibleServer_Spec
...
// Storage version of v1alpha1api20210501.FlexibleServer_STATUS
...
type augmentConversionForFlexibleServer_Spec interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServer_Spec) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServer_Spec) error
}

type augmentConversionForFlexibleServer_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServer_STATUS) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServer_STATUS) error
}
...
type augmentConversionForBackup interface {
	AssignPropertiesFrom(src *v20210501s.Backup) error
	AssignPropertiesTo(dst *v20210501s.Backup) error
}

type augmentConversionForBackup_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.Backup_STATUS) error
	AssignPropertiesTo(dst *v20210501s.Backup_STATUS) error
}

type augmentConversionForDataEncryption interface {
	AssignPropertiesFrom(src *v20210501s.DataEncryption) error
	AssignPropertiesTo(dst *v20210501s.DataEncryption) error
}

type augmentConversionForDataEncryption_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.DataEncryption_STATUS) error
	AssignPropertiesTo(dst *v20210501s.DataEncryption_STATUS) error
}

type augmentConversionForFlexibleServerOperatorSpec interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServerOperatorSpec) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServerOperatorSpec) error
}

type augmentConversionForHighAvailability interface {
	AssignPropertiesFrom(src *v20210501s.HighAvailability) error
	AssignPropertiesTo(dst *v20210501s.HighAvailability) error
}

type augmentConversionForHighAvailability_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.HighAvailability_STATUS) error
	AssignPropertiesTo(dst *v20210501s.HighAvailability_STATUS) error
}

type augmentConversionForIdentity interface {
	AssignPropertiesFrom(src *v20210501s.Identity) error
	AssignPropertiesTo(dst *v20210501s.Identity) error
}

type augmentConversionForIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.Identity_STATUS) error
	AssignPropertiesTo(dst *v20210501s.Identity_STATUS) error
}

type augmentConversionForMaintenanceWindow interface {
	AssignPropertiesFrom(src *v20210501s.MaintenanceWindow) error
	AssignPropertiesTo(dst *v20210501s.MaintenanceWindow) error
}

type augmentConversionForMaintenanceWindow_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.MaintenanceWindow_STATUS) error
	AssignPropertiesTo(dst *v20210501s.MaintenanceWindow_STATUS) error
}

type augmentConversionForNetwork interface {
	AssignPropertiesFrom(src *v20210501s.Network) error
	AssignPropertiesTo(dst *v20210501s.Network) error
}

type augmentConversionForNetwork_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.Network_STATUS) error
	AssignPropertiesTo(dst *v20210501s.Network_STATUS) error
}

type augmentConversionForSku interface {
	AssignPropertiesFrom(src *v20210501s.Sku) error
	AssignPropertiesTo(dst *v20210501s.Sku) error
}

type augmentConversionForSku_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.Sku_STATUS) error
	AssignPropertiesTo(dst *v20210501s.Sku_STATUS) error
}

type augmentConversionForStorage interface {
	AssignPropertiesFrom(src *v20210501s.Storage) error
	AssignPropertiesTo(dst *v20210501s.Storage) error
}

type augmentConversionForStorage_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.Storage_STATUS) error
	AssignPropertiesTo(dst *v20210501s.Storage_STATUS) error
}

type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20210501s.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20210501s.SystemData_STATUS) error
}
...
type augmentConversionForFlexibleServerOperatorSecrets interface {
	AssignPropertiesFrom(src *v20210501s.FlexibleServerOperatorSecrets) error
	AssignPropertiesTo(dst *v20210501s.FlexibleServerOperatorSecrets) error
}
