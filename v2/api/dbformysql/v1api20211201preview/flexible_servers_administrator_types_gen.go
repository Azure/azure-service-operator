...
func (administrator *FlexibleServersAdministrator) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20211201ps.FlexibleServersAdministrator)
	if !ok {
		return fmt.Errorf("expected dbformysql/v1api20211201previewstorage/FlexibleServersAdministrator but received %T instead", hub)
	}
...
func (administrator *FlexibleServersAdministrator) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20211201ps.FlexibleServersAdministrator)
	if !ok {
		return fmt.Errorf("expected dbformysql/v1api20211201previewstorage/FlexibleServersAdministrator but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-dbformysql-azure-com-v1api20211201preview-flexibleserversadministrator,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversadministrators,verbs=create;update,versions=v1api20211201preview,name=default.v1api20211201preview.flexibleserversadministrators.dbformysql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbformysql-azure-com-v1api20211201preview-flexibleserversadministrator,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbformysql.azure.com,resources=flexibleserversadministrators,verbs=create;update,versions=v1api20211201preview,name=validate.v1api20211201preview.flexibleserversadministrators.dbformysql.azure.com,admissionReviewVersions=v1
...
func (administrator *FlexibleServersAdministrator) AssignProperties_From_FlexibleServersAdministrator(source *v1api20211201ps.FlexibleServersAdministrator) error {
...
func (administrator *FlexibleServersAdministrator) AssignProperties_To_FlexibleServersAdministrator(destination *v1api20211201ps.FlexibleServersAdministrator) error {

	// ObjectMeta
	destination.ObjectMeta = *administrator.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20211201ps.FlexibleServers_Administrator_Spec
	...
	// Status
	var status v1api20211201ps.FlexibleServers_Administrator_STATUS
...
func (administrator *FlexibleServers_Administrator_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20211201ps.FlexibleServers_Administrator_Spec)
	if ok {
	...
	src = &v1api20211201ps.FlexibleServers_Administrator_Spec{}
...
func (administrator *FlexibleServers_Administrator_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20211201ps.FlexibleServers_Administrator_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20211201ps.FlexibleServers_Administrator_Spec{}
...
func (administrator *FlexibleServers_Administrator_Spec) AssignProperties_From_FlexibleServers_Administrator_Spec(source *v1api20211201ps.FlexibleServers_Administrator_Spec) error {
...
func (administrator *FlexibleServers_Administrator_Spec) AssignProperties_To_FlexibleServers_Administrator_Spec(destination *v1api20211201ps.FlexibleServers_Administrator_Spec) error {
...
func (administrator *FlexibleServers_Administrator_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20211201ps.FlexibleServers_Administrator_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20211201ps.FlexibleServers_Administrator_STATUS{}
...
func (administrator *FlexibleServers_Administrator_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20211201ps.FlexibleServers_Administrator_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20211201ps.FlexibleServers_Administrator_STATUS{}
...
func (administrator *FlexibleServers_Administrator_STATUS) AssignProperties_From_FlexibleServers_Administrator_STATUS(source *v1api20211201ps.FlexibleServers_Administrator_STATUS) error {
...
func (administrator *FlexibleServers_Administrator_STATUS) AssignProperties_To_FlexibleServers_Administrator_STATUS(destination *v1api20211201ps.FlexibleServers_Administrator_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if administrator.SystemData != nil {
		var systemDatum v1api20211201ps.SystemData_STATUS
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v1api20211201ps.SystemData_STATUS) error {
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v1api20211201ps.SystemData_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
