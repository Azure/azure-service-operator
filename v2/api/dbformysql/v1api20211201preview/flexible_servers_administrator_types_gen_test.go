...
func RunResourceConversionTestForFlexibleServersAdministrator(subject FlexibleServersAdministrator) string {
	...
	var hub v1api20211201ps.FlexibleServersAdministrator
...
// RunPropertyAssignmentTestForFlexibleServersAdministrator tests if a specific instance of FlexibleServersAdministrator can be assigned to v1api20211201previewstorage and back losslessly
func RunPropertyAssignmentTestForFlexibleServersAdministrator(subject FlexibleServersAdministrator) string {
	...
	var other v1api20211201ps.FlexibleServersAdministrator
...
// RunPropertyAssignmentTestForFlexibleServers_Administrator_Spec tests if a specific instance of FlexibleServers_Administrator_Spec can be assigned to v1api20211201previewstorage and back losslessly
func RunPropertyAssignmentTestForFlexibleServers_Administrator_Spec(subject FlexibleServers_Administrator_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20211201ps.FlexibleServers_Administrator_Spec
...
// RunPropertyAssignmentTestForFlexibleServers_Administrator_STATUS tests if a specific instance of FlexibleServers_Administrator_STATUS can be assigned to v1api20211201previewstorage and back losslessly
func RunPropertyAssignmentTestForFlexibleServers_Administrator_STATUS(subject FlexibleServers_Administrator_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20211201ps.FlexibleServers_Administrator_STATUS
...
// RunPropertyAssignmentTestForSystemData_STATUS tests if a specific instance of SystemData_STATUS can be assigned to v1api20211201previewstorage and back losslessly
func RunPropertyAssignmentTestForSystemData_STATUS(subject SystemData_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20211201ps.SystemData_STATUS
