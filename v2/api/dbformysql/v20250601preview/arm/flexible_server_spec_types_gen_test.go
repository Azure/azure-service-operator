...
func AddIndependentPropertyGeneratorsForHighAvailability(gens map[string]gopter.Gen) {
	...
	gens["ReplicationMode"] = gen.PtrOf(gen.OneConstOf(ReplicationMode_BinaryLog, ReplicationMode_RedoLog))
...
func AddIndependentPropertyGeneratorsForImportSourceProperties(gens map[string]gopter.Gen) {
	...
	gens["StorageType"] = gen.PtrOf(gen.OneConstOf(ImportSourceStorageType_AzureBlob))
	gens["StorageUrl"] = gen.PtrOf(gen.AlphaString())
}

func Test_MaintenancePolicy_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of MaintenancePolicy via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMaintenancePolicy, MaintenancePolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMaintenancePolicy runs a test to see if a specific instance of MaintenancePolicy round trips to JSON and back losslessly
func RunJSONSerializationTestForMaintenancePolicy(subject MaintenancePolicy) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of MaintenancePolicy instances for property testing - lazily instantiated by MaintenancePolicyGenerator()
var maintenancePolicyGenerator gopter.Gen

// MaintenancePolicyGenerator returns a generator of MaintenancePolicy instances for property testing.
func MaintenancePolicyGenerator() gopter.Gen {
	if maintenancePolicyGenerator != nil {
		return maintenancePolicyGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMaintenancePolicy(generators)
	maintenancePolicyGenerator = gen.Struct(reflect.TypeOf(MaintenancePolicy{}), generators)

	return maintenancePolicyGenerator
}

// AddIndependentPropertyGeneratorsForMaintenancePolicy is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMaintenancePolicy(gens map[string]gopter.Gen) {
	gens["PatchStrategy"] = gen.PtrOf(gen.OneConstOf(PatchStrategy_Regular, PatchStrategy_VirtualCanary))
}
...
func AddIndependentPropertyGeneratorsForMaintenanceWindow(gens map[string]gopter.Gen) {
	gens["BatchOfMaintenance"] = gen.PtrOf(gen.OneConstOf(BatchOfMaintenance_Batch1, BatchOfMaintenance_Batch2, BatchOfMaintenance_Default))
...
func AddIndependentPropertyGeneratorsForMySQLServerIdentity(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(ManagedServiceIdentityType_UserAssigned))
}
...
func AddIndependentPropertyGeneratorsForMySQLServerSku(gens map[string]gopter.Gen) {
	...
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(ServerSkuTier_Burstable, ServerSkuTier_GeneralPurpose, ServerSkuTier_MemoryOptimized))
}
...
func AddIndependentPropertyGeneratorsForServerProperties(gens map[string]gopter.Gen) {
	...
	gens["CreateMode"] = gen.PtrOf(gen.OneConstOf(
		CreateMode_Default,
		CreateMode_GeoRestore,
		CreateMode_PointInTimeRestore,
		CreateMode_Replica))
	gens["DatabasePort"] = gen.PtrOf(gen.Int())
	gens["LowerCaseTableNames"] = gen.PtrOf(gen.Int())
	...
	gens["Version"] = gen.PtrOf(gen.OneConstOf(ServerVersion_57, ServerVersion_8021, ServerVersion_84))
}
...
func AddRelatedPropertyGeneratorsForServerProperties(gens map[string]gopter.Gen) {
	...
	gens["MaintenancePolicy"] = gen.PtrOf(MaintenancePolicyGenerator())
...
func AddIndependentPropertyGeneratorsForStorage(gens map[string]gopter.Gen) {
	...
	gens["AutoIoScaling"] = gen.PtrOf(gen.OneConstOf(Storage_AutoIoScaling_Disabled, Storage_AutoIoScaling_Enabled))
	gens["Iops"] = gen.PtrOf(gen.Int())
	gens["LogOnDisk"] = gen.PtrOf(gen.OneConstOf(Storage_LogOnDisk_Disabled, Storage_LogOnDisk_Enabled))
	gens["StorageRedundancy"] = gen.PtrOf(gen.OneConstOf(Storage_StorageRedundancy_LocalRedundancy, Storage_StorageRedundancy_ZoneRedundancy))
