...
// Storage version of v20250601preview.APIVersion
...
// Storage version of v20250601preview.FlexibleServer_Spec
...
func (server *FlexibleServer_Spec) AssignProperties_From_FlexibleServer_Spec(source *storage.FlexibleServer_Spec) error {
	...
	// LowerCaseTableNames
	if propertyBag.Contains("LowerCaseTableNames") {
		var lowerCaseTableName int
		err := propertyBag.Pull("LowerCaseTableNames", &lowerCaseTableName)
		if err != nil {
			return eris.Wrap(err, "pulling 'LowerCaseTableNames' from propertyBag")
		}

		server.LowerCaseTableNames = &lowerCaseTableName
	} else {
...
func (server *FlexibleServer_Spec) AssignProperties_To_FlexibleServer_Spec(destination *storage.FlexibleServer_Spec) error {
	...
	if server.LowerCaseTableNames != nil {
		propertyBag.Add("LowerCaseTableNames", *server.LowerCaseTableNames)
	} else {
		propertyBag.Remove("LowerCaseTableNames")
	}
...
// Storage version of v20250601preview.FlexibleServer_STATUS
...
func (availability *HighAvailability) AssignProperties_From_HighAvailability(source *storage.HighAvailability) error {
	...
	// ReplicationMode
	if propertyBag.Contains("ReplicationMode") {
		var replicationMode string
		err := propertyBag.Pull("ReplicationMode", &replicationMode)
		if err != nil {
			return eris.Wrap(err, "pulling 'ReplicationMode' from propertyBag")
		}
...
func (availability *HighAvailability) AssignProperties_To_HighAvailability(destination *storage.HighAvailability) error {
	...
	if availability.ReplicationMode != nil {
		propertyBag.Add("ReplicationMode", *availability.ReplicationMode)
	} else {
		propertyBag.Remove("ReplicationMode")
	}
...
func (policy *MaintenancePolicy) AssignProperties_From_MaintenancePolicy(source *storage.MaintenancePolicy) error {
	...
	// PatchStrategy
	policy.PatchStrategy = genruntime.ClonePointerToString(source.PatchStrategy)
	...
	// Invoke the augmentConversionForMaintenancePolicy interface (if implemented) to customize the conversion
	var policyAsAny any = policy
	if augmentedPolicy, ok := policyAsAny.(augmentConversionForMaintenancePolicy); ok {
...
func (policy *MaintenancePolicy) AssignProperties_To_MaintenancePolicy(destination *storage.MaintenancePolicy) error {
	...
	// PatchStrategy
	destination.PatchStrategy = genruntime.ClonePointerToString(policy.PatchStrategy)
...
func (policy *MaintenancePolicy_STATUS) AssignProperties_From_MaintenancePolicy_STATUS(source *storage.MaintenancePolicy_STATUS) error {
	...
	// Invoke the augmentConversionForMaintenancePolicy_STATUS interface (if implemented) to customize the conversion
	var policyAsAny any = policy
	if augmentedPolicy, ok := policyAsAny.(augmentConversionForMaintenancePolicy_STATUS); ok {
		err := augmentedPolicy.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type MaintenanceWindow struct {
	BatchOfMaintenance *string                `json:"batchOfMaintenance,omitempty"`
...
func (window *MaintenanceWindow) AssignProperties_From_MaintenanceWindow(source *storage.MaintenanceWindow) error {
	...
	// BatchOfMaintenance
	window.BatchOfMaintenance = genruntime.ClonePointerToString(source.BatchOfMaintenance)
...
func (window *MaintenanceWindow) AssignProperties_To_MaintenanceWindow(destination *storage.MaintenanceWindow) error {
	...
	// BatchOfMaintenance
	destination.BatchOfMaintenance = genruntime.ClonePointerToString(window.BatchOfMaintenance)
...
type Storage struct {
	...
	PropertyBag       genruntime.PropertyBag `json:"$propertyBag,omitempty"`
	StorageRedundancy *string                `json:"storageRedundancy,omitempty"`
...
func (storage *Storage) AssignProperties_From_Storage(source *storage.Storage) error {
	...
	// StorageRedundancy
	storage.StorageRedundancy = genruntime.ClonePointerToString(source.StorageRedundancy)
...
func (storage *Storage) AssignProperties_To_Storage(destination *storage.Storage) error {
	...
	// StorageRedundancy
	destination.StorageRedundancy = genruntime.ClonePointerToString(storage.StorageRedundancy)
...
type augmentConversionForMaintenancePolicy interface {
	AssignPropertiesFrom(src *storage.MaintenancePolicy) error
	AssignPropertiesTo(dst *storage.MaintenancePolicy) error
}

type augmentConversionForMaintenancePolicy_STATUS interface {
	AssignPropertiesFrom(src *storage.MaintenancePolicy_STATUS) error
	AssignPropertiesTo(dst *storage.MaintenancePolicy_STATUS) error
}
...
// Storage version of v20250601preview.FlexibleServerOperatorConfigMaps
...
// Storage version of v20250601preview.FlexibleServerOperatorSecrets
