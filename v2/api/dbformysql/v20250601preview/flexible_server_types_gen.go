...
import (
	"context"
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/dbformysql/v20250601preview/arm"
	storage "github.com/Azure/azure-service-operator/v2/api/dbformysql/v20250601preview/storage"
...
// +kubebuilder:validation:Enum={"2025-06-01-preview"}
type APIVersion string

const APIVersion_Value = APIVersion("2025-06-01-preview")
...
func (server *FlexibleServer_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if server.AdministratorLogin != nil ||
		...
		server.DatabasePort != nil ||
		server.HighAvailability != nil ||
		server.ImportSourceProperties != nil ||
		server.LowerCaseTableNames != nil ||
		server.MaintenancePolicy != nil ||
	...
	if server.DatabasePort != nil {
		databasePort := *server.DatabasePort
		result.Properties.DatabasePort = &databasePort
	}
	...
	if server.LowerCaseTableNames != nil {
		lowerCaseTableNames := *server.LowerCaseTableNames
		result.Properties.LowerCaseTableNames = &lowerCaseTableNames
	}
	if server.MaintenancePolicy != nil {
		maintenancePolicy_ARM, err := server.MaintenancePolicy.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		maintenancePolicy := *maintenancePolicy_ARM.(*arm.MaintenancePolicy)
		result.Properties.MaintenancePolicy = &maintenancePolicy
	}
...
func (server *FlexibleServer_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DatabasePort":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DatabasePort != nil {
			databasePort := *typedInput.Properties.DatabasePort
			server.DatabasePort = &databasePort
		}
	}
	...
	// Set property "LowerCaseTableNames":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.LowerCaseTableNames != nil {
			lowerCaseTableNames := *typedInput.Properties.LowerCaseTableNames
			server.LowerCaseTableNames = &lowerCaseTableNames
		}
	}

	// Set property "MaintenancePolicy":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.MaintenancePolicy != nil {
			var maintenancePolicy1 MaintenancePolicy
			err := maintenancePolicy1.PopulateFromARM(owner, *typedInput.Properties.MaintenancePolicy)
			if err != nil {
				return err
			}
			maintenancePolicy := maintenancePolicy1
			server.MaintenancePolicy = &maintenancePolicy
		}
	}
...
func (server *FlexibleServer_Spec) AssignProperties_From_FlexibleServer_Spec(source *storage.FlexibleServer_Spec) error {
	...
	// DatabasePort
	server.DatabasePort = genruntime.ClonePointerToInt(source.DatabasePort)
	...
	// LowerCaseTableNames
	server.LowerCaseTableNames = genruntime.ClonePointerToInt(source.LowerCaseTableNames)

	// MaintenancePolicy
	if source.MaintenancePolicy != nil {
		var maintenancePolicy MaintenancePolicy
		err := maintenancePolicy.AssignProperties_From_MaintenancePolicy(source.MaintenancePolicy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_MaintenancePolicy() to populate field MaintenancePolicy")
		}
		server.MaintenancePolicy = &maintenancePolicy
	} else {
		server.MaintenancePolicy = nil
...
func (server *FlexibleServer_Spec) AssignProperties_To_FlexibleServer_Spec(destination *storage.FlexibleServer_Spec) error {
	...
	// DatabasePort
	destination.DatabasePort = genruntime.ClonePointerToInt(server.DatabasePort)
	...
	// LowerCaseTableNames
	destination.LowerCaseTableNames = genruntime.ClonePointerToInt(server.LowerCaseTableNames)

	// MaintenancePolicy
	if server.MaintenancePolicy != nil {
		var maintenancePolicy storage.MaintenancePolicy
		err := server.MaintenancePolicy.AssignProperties_To_MaintenancePolicy(&maintenancePolicy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_MaintenancePolicy() to populate field MaintenancePolicy")
		}
...
func (server *FlexibleServer_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "FullVersion":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.FullVersion != nil {
			fullVersion := *typedInput.Properties.FullVersion
			server.FullVersion = &fullVersion
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MaintenancePolicy != nil {
			var maintenancePolicy1 MaintenancePolicy_STATUS
			err := maintenancePolicy1.PopulateFromARM(owner, *typedInput.Properties.MaintenancePolicy)
			if err != nil {
				return err
			}
...
func (server *FlexibleServer_STATUS) AssignProperties_From_FlexibleServer_STATUS(source *storage.FlexibleServer_STATUS) error {
	...
	// FullVersion
	server.FullVersion = genruntime.ClonePointerToString(source.FullVersion)
	...
	// MaintenancePolicy
	if source.MaintenancePolicy != nil {
		var maintenancePolicy MaintenancePolicy_STATUS
		err := maintenancePolicy.AssignProperties_From_MaintenancePolicy_STATUS(source.MaintenancePolicy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_MaintenancePolicy_STATUS() to populate field MaintenancePolicy")
		}
		server.MaintenancePolicy = &maintenancePolicy
	} else {
		server.MaintenancePolicy = nil
...
func (server *FlexibleServer_STATUS) AssignProperties_To_FlexibleServer_STATUS(destination *storage.FlexibleServer_STATUS) error {
	...
	// FullVersion
	destination.FullVersion = genruntime.ClonePointerToString(server.FullVersion)
	...
	if server.MaintenancePolicy != nil {
		...
		err := server.MaintenancePolicy.AssignProperties_To_MaintenancePolicy_STATUS(&maintenancePolicy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_MaintenancePolicy_STATUS() to populate field MaintenancePolicy")
		}
		destination.MaintenancePolicy = &maintenancePolicy
	} else {
		destination.MaintenancePolicy = nil
...
func (backup *Backup) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "BackupIntervalHours":
	if backup.BackupIntervalHours != nil {
		backupIntervalHours := *backup.BackupIntervalHours
		result.BackupIntervalHours = &backupIntervalHours
	}
...
func (backup *Backup) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "BackupIntervalHours":
	if typedInput.BackupIntervalHours != nil {
		backupIntervalHours := *typedInput.BackupIntervalHours
		backup.BackupIntervalHours = &backupIntervalHours
	}
...
func (backup *Backup) AssignProperties_From_Backup(source *storage.Backup) error {
	...
	// BackupIntervalHours
	backup.BackupIntervalHours = genruntime.ClonePointerToInt(source.BackupIntervalHours)
...
func (backup *Backup) AssignProperties_To_Backup(destination *storage.Backup) error {
	...
	// BackupIntervalHours
	destination.BackupIntervalHours = genruntime.ClonePointerToInt(backup.BackupIntervalHours)
...
func (availability *HighAvailability) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if availability.Mode != nil {
		...
		mode := arm.HighAvailabilityMode(temp)
		result.Mode = &mode
	}

	// Set property "ReplicationMode":
	if availability.ReplicationMode != nil {
		var temp string
		temp = string(*availability.ReplicationMode)
		replicationMode := arm.ReplicationMode(temp)
		result.ReplicationMode = &replicationMode
	}
...
func (availability *HighAvailability) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Mode != nil {
		...
		mode := HighAvailabilityMode(temp)
		availability.Mode = &mode
	}

	// Set property "ReplicationMode":
	if typedInput.ReplicationMode != nil {
		var temp string
		temp = string(*typedInput.ReplicationMode)
		replicationMode := ReplicationMode(temp)
		availability.ReplicationMode = &replicationMode
	}
...
func (availability *HighAvailability) AssignProperties_From_HighAvailability(source *storage.HighAvailability) error {
	...
	if source.Mode != nil {
		mode := *source.Mode
		modeTemp := genruntime.ToEnum(mode, highAvailabilityMode_Values)
	...
	if source.ReplicationMode != nil {
		replicationMode := *source.ReplicationMode
		replicationModeTemp := genruntime.ToEnum(replicationMode, replicationMode_Values)
		availability.ReplicationMode = &replicationModeTemp
	} else {
		availability.ReplicationMode = nil
	}
...
func (availability *HighAvailability) AssignProperties_To_HighAvailability(destination *storage.HighAvailability) error {
	...
	// ReplicationMode
	if availability.ReplicationMode != nil {
		replicationMode := string(*availability.ReplicationMode)
...
func (availability *HighAvailability_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Mode != nil {
		var temp string
		temp = string(*typedInput.Mode)
		mode := HighAvailabilityMode_STATUS(temp)
		availability.Mode = &mode
	}
	...
	if typedInput.ReplicationMode != nil {
		var temp string
		temp = string(*typedInput.ReplicationMode)
		replicationMode := ReplicationMode_STATUS(temp)
		availability.ReplicationMode = &replicationMode
	}
...
func (availability *HighAvailability_STATUS) AssignProperties_From_HighAvailability_STATUS(source *storage.HighAvailability_STATUS) error {
	...
	if source.Mode != nil {
		mode := *source.Mode
		modeTemp := genruntime.ToEnum(mode, highAvailabilityMode_STATUS_Values)
		availability.Mode = &modeTemp
	} else {
		availability.Mode = nil
	}
	...
	if source.ReplicationMode != nil {
		replicationMode := *source.ReplicationMode
		replicationModeTemp := genruntime.ToEnum(replicationMode, replicationMode_STATUS_Values)
		availability.ReplicationMode = &replicationModeTemp
	} else {
		availability.ReplicationMode = nil
	}
...
func (properties *ImportSourceProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if properties.StorageType != nil {
		...
		storageType := arm.ImportSourceStorageType(temp)
...
func (properties *ImportSourceProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.StorageType != nil {
		...
		storageType := ImportSourceStorageType(temp)
...
func (properties *ImportSourceProperties) AssignProperties_From_ImportSourceProperties(source *storage.ImportSourceProperties) error {
	...
	if source.StorageType != nil {
		...
		storageTypeTemp := genruntime.ToEnum(storageType, importSourceStorageType_Values)
...
func (properties *ImportSourceProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.StorageType != nil {
		var temp string
		temp = string(*typedInput.StorageType)
		storageType := ImportSourceStorageType_STATUS(temp)
		properties.StorageType = &storageType
	}
...
func (properties *ImportSourceProperties_STATUS) AssignProperties_From_ImportSourceProperties_STATUS(source *storage.ImportSourceProperties_STATUS) error {
	...
	if source.StorageType != nil {
		storageType := *source.StorageType
		storageTypeTemp := genruntime.ToEnum(storageType, importSourceStorageType_STATUS_Values)
		properties.StorageType = &storageTypeTemp
	} else {
		properties.StorageType = nil
	}
...
var _ genruntime.ARMTransformer = &MaintenancePolicy{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (policy *MaintenancePolicy) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if policy == nil {
		return nil, nil
	}
	result := &arm.MaintenancePolicy{}

	// Set property "PatchStrategy":
	if policy.PatchStrategy != nil {
		var temp string
		temp = string(*policy.PatchStrategy)
		patchStrategy := arm.PatchStrategy(temp)
		result.PatchStrategy = &patchStrategy
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (policy *MaintenancePolicy) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.MaintenancePolicy{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (policy *MaintenancePolicy) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.MaintenancePolicy)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.MaintenancePolicy, got %T", armInput)
	}

	// Set property "PatchStrategy":
	if typedInput.PatchStrategy != nil {
		var temp string
		temp = string(*typedInput.PatchStrategy)
		patchStrategy := PatchStrategy(temp)
		policy.PatchStrategy = &patchStrategy
	}
...
// AssignProperties_From_MaintenancePolicy populates our MaintenancePolicy from the provided source MaintenancePolicy
func (policy *MaintenancePolicy) AssignProperties_From_MaintenancePolicy(source *storage.MaintenancePolicy) error {

	// PatchStrategy
	if source.PatchStrategy != nil {
		patchStrategy := *source.PatchStrategy
		patchStrategyTemp := genruntime.ToEnum(patchStrategy, patchStrategy_Values)
		policy.PatchStrategy = &patchStrategyTemp
	} else {
		policy.PatchStrategy = nil
	}
...
// AssignProperties_To_MaintenancePolicy populates the provided destination MaintenancePolicy from our MaintenancePolicy
func (policy *MaintenancePolicy) AssignProperties_To_MaintenancePolicy(destination *storage.MaintenancePolicy) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// PatchStrategy
	if policy.PatchStrategy != nil {
		patchStrategy := string(*policy.PatchStrategy)
		destination.PatchStrategy = &patchStrategy
	} else {
		destination.PatchStrategy = nil
	}
...
var _ genruntime.FromARMConverter = &MaintenancePolicy_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (policy *MaintenancePolicy_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.MaintenancePolicy_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (policy *MaintenancePolicy_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.MaintenancePolicy_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.MaintenancePolicy_STATUS, got %T", armInput)
	}
	...
	if typedInput.PatchStrategy != nil {
		var temp string
		temp = string(*typedInput.PatchStrategy)
		patchStrategy := PatchStrategy_STATUS(temp)
		policy.PatchStrategy = &patchStrategy
	}
...
// AssignProperties_From_MaintenancePolicy_STATUS populates our MaintenancePolicy_STATUS from the provided source MaintenancePolicy_STATUS
func (policy *MaintenancePolicy_STATUS) AssignProperties_From_MaintenancePolicy_STATUS(source *storage.MaintenancePolicy_STATUS) error {

	// PatchStrategy
	if source.PatchStrategy != nil {
		patchStrategy := *source.PatchStrategy
		patchStrategyTemp := genruntime.ToEnum(patchStrategy, patchStrategy_STATUS_Values)
		policy.PatchStrategy = &patchStrategyTemp
	} else {
		policy.PatchStrategy = nil
	}
...
// AssignProperties_To_MaintenancePolicy_STATUS populates the provided destination MaintenancePolicy_STATUS from our MaintenancePolicy_STATUS
func (policy *MaintenancePolicy_STATUS) AssignProperties_To_MaintenancePolicy_STATUS(destination *storage.MaintenancePolicy_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (window *MaintenanceWindow) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "BatchOfMaintenance":
	if window.BatchOfMaintenance != nil {
		var temp string
		temp = string(*window.BatchOfMaintenance)
		batchOfMaintenance := arm.BatchOfMaintenance(temp)
		result.BatchOfMaintenance = &batchOfMaintenance
	}
...
func (window *MaintenanceWindow) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "BatchOfMaintenance":
	if typedInput.BatchOfMaintenance != nil {
		var temp string
		temp = string(*typedInput.BatchOfMaintenance)
		batchOfMaintenance := BatchOfMaintenance(temp)
		window.BatchOfMaintenance = &batchOfMaintenance
	}
...
func (window *MaintenanceWindow) AssignProperties_From_MaintenanceWindow(source *storage.MaintenanceWindow) error {
	...
	if source.BatchOfMaintenance != nil {
		batchOfMaintenance := *source.BatchOfMaintenance
		batchOfMaintenanceTemp := genruntime.ToEnum(batchOfMaintenance, batchOfMaintenance_Values)
		window.BatchOfMaintenance = &batchOfMaintenanceTemp
	} else {
		window.BatchOfMaintenance = nil
	}
...
func (window *MaintenanceWindow) AssignProperties_To_MaintenanceWindow(destination *storage.MaintenanceWindow) error {
	...
	// BatchOfMaintenance
	if window.BatchOfMaintenance != nil {
		batchOfMaintenance := string(*window.BatchOfMaintenance)
...
func (window *MaintenanceWindow_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.BatchOfMaintenance != nil {
		var temp string
		temp = string(*typedInput.BatchOfMaintenance)
		batchOfMaintenance := BatchOfMaintenance_STATUS(temp)
		window.BatchOfMaintenance = &batchOfMaintenance
	}
...
func (window *MaintenanceWindow_STATUS) AssignProperties_From_MaintenanceWindow_STATUS(source *storage.MaintenanceWindow_STATUS) error {
	...
	if source.BatchOfMaintenance != nil {
		batchOfMaintenance := *source.BatchOfMaintenance
		batchOfMaintenanceTemp := genruntime.ToEnum(batchOfMaintenance, batchOfMaintenance_STATUS_Values)
		window.BatchOfMaintenance = &batchOfMaintenanceTemp
	} else {
		window.BatchOfMaintenance = nil
	}
...
func (serverSku *MySQLServerSku) AssignProperties_From_MySQLServerSku(source *storage.MySQLServerSku) error {
	...
	if source.Tier != nil {
		tier := *source.Tier
		tierTemp := genruntime.ToEnum(tier, serverSkuTier_Values)
...
func (serverSku *MySQLServerSku_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Tier != nil {
		var temp string
		temp = string(*typedInput.Tier)
		tier := ServerSkuTier_STATUS(temp)
		serverSku.Tier = &tier
	}
...
func (serverSku *MySQLServerSku_STATUS) AssignProperties_From_MySQLServerSku_STATUS(source *storage.MySQLServerSku_STATUS) error {
	...
	if source.Tier != nil {
		tier := *source.Tier
		tierTemp := genruntime.ToEnum(tier, serverSkuTier_STATUS_Values)
		serverSku.Tier = &tierTemp
	} else {
		serverSku.Tier = nil
	}
...
const (
	...
	ServerVersion_STATUS_84   = ServerVersion_STATUS("8.4")
)
...
func (storage *Storage) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if storage.AutoIoScaling != nil {
		...
		autoIoScaling := arm.Storage_AutoIoScaling(temp)
	...
	if storage.LogOnDisk != nil {
		...
		logOnDisk := arm.Storage_LogOnDisk(temp)
		result.LogOnDisk = &logOnDisk
	}

	// Set property "StorageRedundancy":
	if storage.StorageRedundancy != nil {
		var temp string
		temp = string(*storage.StorageRedundancy)
		storageRedundancy := arm.Storage_StorageRedundancy(temp)
		result.StorageRedundancy = &storageRedundancy
	}
...
func (storage *Storage) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.AutoIoScaling != nil {
		...
		autoIoScaling := Storage_AutoIoScaling(temp)
	...
	if typedInput.LogOnDisk != nil {
		...
		logOnDisk := Storage_LogOnDisk(temp)
		storage.LogOnDisk = &logOnDisk
	}

	// Set property "StorageRedundancy":
	if typedInput.StorageRedundancy != nil {
		var temp string
		temp = string(*typedInput.StorageRedundancy)
		storageRedundancy := Storage_StorageRedundancy(temp)
		storage.StorageRedundancy = &storageRedundancy
	}
...
func (storage *Storage) AssignProperties_From_Storage(source *storage.Storage) error {
	...
	if source.AutoIoScaling != nil {
		...
		autoIoScalingTemp := genruntime.ToEnum(autoIoScaling, storage_AutoIoScaling_Values)
	...
	if source.LogOnDisk != nil {
		...
		logOnDiskTemp := genruntime.ToEnum(logOnDisk, storage_LogOnDisk_Values)
	...
	if source.StorageRedundancy != nil {
		storageRedundancy := *source.StorageRedundancy
		storageRedundancyTemp := genruntime.ToEnum(storageRedundancy, storage_StorageRedundancy_Values)
		storage.StorageRedundancy = &storageRedundancyTemp
	} else {
		storage.StorageRedundancy = nil
	}
...
func (storage *Storage) AssignProperties_To_Storage(destination *storage.Storage) error {
	...
	// StorageRedundancy
	if storage.StorageRedundancy != nil {
		storageRedundancy := string(*storage.StorageRedundancy)
...
func (storage *Storage_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.AutoIoScaling != nil {
		var temp string
		temp = string(*typedInput.AutoIoScaling)
		autoIoScaling := Storage_AutoIoScaling_STATUS(temp)
		storage.AutoIoScaling = &autoIoScaling
	}
	...
	if typedInput.LogOnDisk != nil {
		var temp string
		temp = string(*typedInput.LogOnDisk)
		logOnDisk := Storage_LogOnDisk_STATUS(temp)
		storage.LogOnDisk = &logOnDisk
	}
	...
	if typedInput.StorageRedundancy != nil {
		var temp string
		temp = string(*typedInput.StorageRedundancy)
		storageRedundancy := Storage_StorageRedundancy_STATUS(temp)
		storage.StorageRedundancy = &storageRedundancy
	}
...
func (storage *Storage_STATUS) AssignProperties_From_Storage_STATUS(source *storage.Storage_STATUS) error {
	...
	if source.AutoIoScaling != nil {
		autoIoScaling := *source.AutoIoScaling
		autoIoScalingTemp := genruntime.ToEnum(autoIoScaling, storage_AutoIoScaling_STATUS_Values)
		storage.AutoIoScaling = &autoIoScalingTemp
	} else {
		storage.AutoIoScaling = nil
	}
	...
	if source.LogOnDisk != nil {
		logOnDisk := *source.LogOnDisk
		logOnDiskTemp := genruntime.ToEnum(logOnDisk, storage_LogOnDisk_STATUS_Values)
		storage.LogOnDisk = &logOnDiskTemp
	} else {
		storage.LogOnDisk = nil
	}
	...
	if source.StorageRedundancy != nil {
		storageRedundancy := *source.StorageRedundancy
		storageRedundancyTemp := genruntime.ToEnum(storageRedundancy, storage_StorageRedundancy_STATUS_Values)
		storage.StorageRedundancy = &storageRedundancyTemp
	} else {
		storage.StorageRedundancy = nil
	}
...
// +kubebuilder:validation:Enum={"BinaryLog","RedoLog"}
type ReplicationMode string

const (
	ReplicationMode_BinaryLog = ReplicationMode("BinaryLog")
	ReplicationMode_RedoLog   = ReplicationMode("RedoLog")
)

// Mapping from string to ReplicationMode
var replicationMode_Values = map[string]ReplicationMode{
	"binarylog": ReplicationMode_BinaryLog,
	"redolog":   ReplicationMode_RedoLog,
}
