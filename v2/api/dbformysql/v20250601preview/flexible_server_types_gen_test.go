...
func RunPropertyAssignmentTestForBackup_STATUS(subject Backup_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.Backup_STATUS
...
func RunPropertyAssignmentTestForDataEncryption(subject DataEncryption) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.DataEncryption
...
func RunPropertyAssignmentTestForDataEncryption_STATUS(subject DataEncryption_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.DataEncryption_STATUS
...
func RunPropertyAssignmentTestForFlexibleServer(subject FlexibleServer) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServer
...
func RunPropertyAssignmentTestForFlexibleServerOperatorConfigMaps(subject FlexibleServerOperatorConfigMaps) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServerOperatorConfigMaps
...
func RunPropertyAssignmentTestForFlexibleServerOperatorSecrets(subject FlexibleServerOperatorSecrets) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServerOperatorSecrets
...
func RunPropertyAssignmentTestForFlexibleServerOperatorSpec(subject FlexibleServerOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServerOperatorSpec
...
func RunPropertyAssignmentTestForFlexibleServer_STATUS(subject FlexibleServer_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServer_STATUS
...
func AddIndependentPropertyGeneratorsForFlexibleServer_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Version"] = gen.PtrOf(gen.OneConstOf(ServerVersion_STATUS_57, ServerVersion_STATUS_8021, ServerVersion_STATUS_84))
}
...
func RunPropertyAssignmentTestForFlexibleServer_Spec(subject FlexibleServer_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.FlexibleServer_Spec
...
func RunPropertyAssignmentTestForHighAvailability(subject HighAvailability) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.HighAvailability
...
func RunPropertyAssignmentTestForHighAvailability_STATUS(subject HighAvailability_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.HighAvailability_STATUS
...
func AddIndependentPropertyGeneratorsForHighAvailability_STATUS(gens map[string]gopter.Gen) {
	gens["Mode"] = gen.PtrOf(gen.OneConstOf(HighAvailabilityMode_STATUS_Disabled, HighAvailabilityMode_STATUS_SameZone, HighAvailabilityMode_STATUS_ZoneRedundant))
	gens["ReplicationMode"] = gen.PtrOf(gen.OneConstOf(ReplicationMode_STATUS_BinaryLog, ReplicationMode_STATUS_RedoLog))
	gens["StandbyAvailabilityZone"] = gen.PtrOf(gen.AlphaString())
	gens["State"] = gen.PtrOf(gen.OneConstOf(
...
func RunPropertyAssignmentTestForImportSourceProperties(subject ImportSourceProperties) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.ImportSourceProperties
...
func RunPropertyAssignmentTestForImportSourceProperties_STATUS(subject ImportSourceProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.ImportSourceProperties_STATUS
...
func AddIndependentPropertyGeneratorsForImportSourceProperties_STATUS(gens map[string]gopter.Gen) {
	gens["DataDirPath"] = gen.PtrOf(gen.AlphaString())
	gens["StorageType"] = gen.PtrOf(gen.OneConstOf(ImportSourceStorageType_STATUS_AzureBlob))
	gens["StorageUrl"] = gen.PtrOf(gen.AlphaString())
}

func Test_MaintenancePolicy_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from MaintenancePolicy to MaintenancePolicy via AssignProperties_To_MaintenancePolicy & AssignProperties_From_MaintenancePolicy returns original",
		prop.ForAll(RunPropertyAssignmentTestForMaintenancePolicy, MaintenancePolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMaintenancePolicy tests if a specific instance of MaintenancePolicy can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMaintenancePolicy(subject MaintenancePolicy) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MaintenancePolicy
	err := copied.AssignProperties_To_MaintenancePolicy(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_MaintenancePolicy(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_MaintenancePolicy_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from MaintenancePolicy_STATUS to MaintenancePolicy_STATUS via AssignProperties_To_MaintenancePolicy_STATUS & AssignProperties_From_MaintenancePolicy_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForMaintenancePolicy_STATUS, MaintenancePolicy_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMaintenancePolicy_STATUS tests if a specific instance of MaintenancePolicy_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMaintenancePolicy_STATUS(subject MaintenancePolicy_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MaintenancePolicy_STATUS
	err := copied.AssignProperties_To_MaintenancePolicy_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_MaintenancePolicy_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForMaintenancePolicy_STATUS(gens map[string]gopter.Gen) {
	gens["PatchStrategy"] = gen.PtrOf(gen.OneConstOf(PatchStrategy_STATUS_Regular, PatchStrategy_STATUS_VirtualCanary))
}
...
func RunPropertyAssignmentTestForMaintenanceWindow(subject MaintenanceWindow) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MaintenanceWindow
...
func RunPropertyAssignmentTestForMaintenanceWindow_STATUS(subject MaintenanceWindow_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MaintenanceWindow_STATUS
...
func AddIndependentPropertyGeneratorsForMaintenanceWindow_STATUS(gens map[string]gopter.Gen) {
	gens["BatchOfMaintenance"] = gen.PtrOf(gen.OneConstOf(BatchOfMaintenance_STATUS_Batch1, BatchOfMaintenance_STATUS_Batch2, BatchOfMaintenance_STATUS_Default))
	gens["CustomWindow"] = gen.PtrOf(gen.AlphaString())
	gens["DayOfWeek"] = gen.PtrOf(gen.Int())
	gens["StartHour"] = gen.PtrOf(gen.Int())
	gens["StartMinute"] = gen.PtrOf(gen.Int())
...
func RunPropertyAssignmentTestForMySQLServerIdentity(subject MySQLServerIdentity) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MySQLServerIdentity
...
func RunPropertyAssignmentTestForMySQLServerIdentity_STATUS(subject MySQLServerIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MySQLServerIdentity_STATUS
...
func AddIndependentPropertyGeneratorsForMySQLServerIdentity_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(ManagedServiceIdentityType_STATUS_UserAssigned))
}
...
func RunPropertyAssignmentTestForMySQLServerSku(subject MySQLServerSku) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MySQLServerSku
...
func RunPropertyAssignmentTestForMySQLServerSku_STATUS(subject MySQLServerSku_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.MySQLServerSku_STATUS
...
func AddIndependentPropertyGeneratorsForMySQLServerSku_STATUS(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(ServerSkuTier_STATUS_Burstable, ServerSkuTier_STATUS_GeneralPurpose, ServerSkuTier_STATUS_MemoryOptimized))
}
...
func RunPropertyAssignmentTestForNetwork_STATUS(subject Network_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.Network_STATUS
...
func RunPropertyAssignmentTestForPrivateEndpointConnection_STATUS(subject PrivateEndpointConnection_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.PrivateEndpointConnection_STATUS
...
func RunPropertyAssignmentTestForStorage_STATUS(subject Storage_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.Storage_STATUS
...
func AddIndependentPropertyGeneratorsForStorage_STATUS(gens map[string]gopter.Gen) {
	...
	gens["AutoIoScaling"] = gen.PtrOf(gen.OneConstOf(Storage_AutoIoScaling_STATUS_Disabled, Storage_AutoIoScaling_STATUS_Enabled))
	gens["Iops"] = gen.PtrOf(gen.Int())
	gens["LogOnDisk"] = gen.PtrOf(gen.OneConstOf(Storage_LogOnDisk_STATUS_Disabled, Storage_LogOnDisk_STATUS_Enabled))
	gens["StorageRedundancy"] = gen.PtrOf(gen.OneConstOf(Storage_StorageRedundancy_STATUS_LocalRedundancy, Storage_StorageRedundancy_STATUS_ZoneRedundancy))
	gens["StorageSizeGB"] = gen.PtrOf(gen.Int())
...
func RunPropertyAssignmentTestForSystemData_STATUS(subject SystemData_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.SystemData_STATUS
...
func RunPropertyAssignmentTestForUserAssignedIdentityDetails(subject UserAssignedIdentityDetails) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.UserAssignedIdentityDetails
...
func RunPropertyAssignmentTestForUserAssignedIdentity_STATUS(subject UserAssignedIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250601ps.UserAssignedIdentity_STATUS
