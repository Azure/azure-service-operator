...
func RunResourceConversionTestForFlexibleServer(subject FlexibleServer) string {
	...
	var hub v1api20210501s.FlexibleServer
...
// RunPropertyAssignmentTestForFlexibleServer tests if a specific instance of FlexibleServer can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServer(subject FlexibleServer) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.FlexibleServer
...
// RunPropertyAssignmentTestForFlexibleServer_Spec tests if a specific instance of FlexibleServer_Spec can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServer_Spec(subject FlexibleServer_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.FlexibleServer_Spec
...
// RunPropertyAssignmentTestForFlexibleServer_STATUS tests if a specific instance of FlexibleServer_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServer_STATUS(subject FlexibleServer_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.FlexibleServer_STATUS
...
// RunPropertyAssignmentTestForBackup tests if a specific instance of Backup can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForBackup(subject Backup) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Backup
...
// RunPropertyAssignmentTestForBackup_STATUS tests if a specific instance of Backup_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForBackup_STATUS(subject Backup_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Backup_STATUS
...
// RunPropertyAssignmentTestForDataEncryption tests if a specific instance of DataEncryption can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForDataEncryption(subject DataEncryption) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.DataEncryption
...
// RunPropertyAssignmentTestForDataEncryption_STATUS tests if a specific instance of DataEncryption_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForDataEncryption_STATUS(subject DataEncryption_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.DataEncryption_STATUS
...
// RunPropertyAssignmentTestForFlexibleServerOperatorSpec tests if a specific instance of FlexibleServerOperatorSpec can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServerOperatorSpec(subject FlexibleServerOperatorSpec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.FlexibleServerOperatorSpec
...
// RunPropertyAssignmentTestForHighAvailability tests if a specific instance of HighAvailability can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForHighAvailability(subject HighAvailability) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.HighAvailability
...
// RunPropertyAssignmentTestForHighAvailability_STATUS tests if a specific instance of HighAvailability_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForHighAvailability_STATUS(subject HighAvailability_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.HighAvailability_STATUS
...
// RunPropertyAssignmentTestForIdentity tests if a specific instance of Identity can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForIdentity(subject Identity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Identity
...
// RunPropertyAssignmentTestForIdentity_STATUS tests if a specific instance of Identity_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForIdentity_STATUS(subject Identity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Identity_STATUS
...
// RunPropertyAssignmentTestForMaintenanceWindow tests if a specific instance of MaintenanceWindow can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForMaintenanceWindow(subject MaintenanceWindow) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.MaintenanceWindow
...
// RunPropertyAssignmentTestForMaintenanceWindow_STATUS tests if a specific instance of MaintenanceWindow_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForMaintenanceWindow_STATUS(subject MaintenanceWindow_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.MaintenanceWindow_STATUS
...
// RunPropertyAssignmentTestForNetwork tests if a specific instance of Network can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForNetwork(subject Network) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Network
...
// RunPropertyAssignmentTestForNetwork_STATUS tests if a specific instance of Network_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForNetwork_STATUS(subject Network_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Network_STATUS
...
// RunPropertyAssignmentTestForSku tests if a specific instance of Sku can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForSku(subject Sku) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Sku
...
// RunPropertyAssignmentTestForSku_STATUS tests if a specific instance of Sku_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForSku_STATUS(subject Sku_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Sku_STATUS
...
// RunPropertyAssignmentTestForStorage tests if a specific instance of Storage can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForStorage(subject Storage) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Storage
...
// RunPropertyAssignmentTestForStorage_STATUS tests if a specific instance of Storage_STATUS can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForStorage_STATUS(subject Storage_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.Storage_STATUS
...
// RunPropertyAssignmentTestForFlexibleServerOperatorSecrets tests if a specific instance of FlexibleServerOperatorSecrets can be assigned to v1api20210501storage and back losslessly
func RunPropertyAssignmentTestForFlexibleServerOperatorSecrets(subject FlexibleServerOperatorSecrets) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20210501s.FlexibleServerOperatorSecrets
