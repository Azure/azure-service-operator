...
type FlexibleServersFirewallRule_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &FlexibleServersFirewallRule_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-01"
func (rule FlexibleServersFirewallRule_Spec_ARM) GetAPIVersion() string {
	return "2021-05-01"
}

// GetName returns the Name of the resource
func (rule *FlexibleServersFirewallRule_Spec_ARM) GetName() string {
	return rule.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.DBforMySQL/flexibleServers/firewallRules"
func (rule *FlexibleServersFirewallRule_Spec_ARM) GetType() string {
