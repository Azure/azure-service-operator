...
func (rule *FlexibleServersFirewallRule) AssignProperties_To_FlexibleServersFirewallRule(destination *v20230630s.FlexibleServersFirewallRule) error {
	...
	// Spec
	var spec v20230630s.FlexibleServers_FirewallRule_Spec
	...
	// Status
	var status v20230630s.FlexibleServers_FirewallRule_STATUS
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230630s.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	src = &v20230630s.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230630s.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230630s.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_Spec) AssignProperties_From_FlexibleServers_FirewallRule_Spec(source *v20230630s.FlexibleServers_FirewallRule_Spec) error {
...
func (rule *FlexibleServers_FirewallRule_Spec) AssignProperties_To_FlexibleServers_FirewallRule_Spec(destination *v20230630s.FlexibleServers_FirewallRule_Spec) error {
	// Clone the existing property bag
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230630s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230630s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230630s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230630s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_From_FlexibleServers_FirewallRule_STATUS(source *v20230630s.FlexibleServers_FirewallRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_To_FlexibleServers_FirewallRule_STATUS(destination *v20230630s.FlexibleServers_FirewallRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(rule.PropertyBag)
...
type augmentConversionForFlexibleServers_FirewallRule_Spec interface {
	AssignPropertiesFrom(src *v20230630s.FlexibleServers_FirewallRule_Spec) error
	AssignPropertiesTo(dst *v20230630s.FlexibleServers_FirewallRule_Spec) error
}

type augmentConversionForFlexibleServers_FirewallRule_STATUS interface {
	AssignPropertiesFrom(src *v20230630s.FlexibleServers_FirewallRule_STATUS) error
	AssignPropertiesTo(dst *v20230630s.FlexibleServers_FirewallRule_STATUS) error
}
