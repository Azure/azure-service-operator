...
func (webhook *User_Webhook) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbformysql/v1/User, but got %T", obj)
	}
...
func (webhook *User_Webhook) ValidateCreate(ctx context.Context, obj runtime.Object) (admission.Warnings, error) {
	resource, ok := obj.(*v1.User)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbformysql/v1/User, but got %T", obj)
	}
...
func (webhook *User_Webhook) ValidateUpdate(ctx context.Context, oldObj runtime.Object, newObj runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbformysql/v1/User, but got %T", newObj)
	}
	oldResource, ok := oldObj.(*v1.User)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbformysql/v1/User, but got %T", oldObj)
	}
...
func (webhook *User_Webhook) createValidations() []func(ctx context.Context, obj *v1.User) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v1.User) (admission.Warnings, error){webhook.validateIsLocalOrAAD}
}
