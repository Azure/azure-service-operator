...
// Storage version of v20200601.EventSubscription_Spec
...
func (subscription *EventSubscription_Spec) AssignProperties_From_EventSubscription_Spec(source *storage.EventSubscription_Spec) error {
	...
	if source.DeadLetterWithResourceIdentity != nil {
		propertyBag.Add("DeadLetterWithResourceIdentity", *source.DeadLetterWithResourceIdentity)
	} else {
		propertyBag.Remove("DeadLetterWithResourceIdentity")
	}

	// DeliveryWithResourceIdentity
	if source.DeliveryWithResourceIdentity != nil {
		propertyBag.Add("DeliveryWithResourceIdentity", *source.DeliveryWithResourceIdentity)
	} else {
		propertyBag.Remove("DeliveryWithResourceIdentity")
	}
...
func (subscription *EventSubscription_Spec) AssignProperties_To_EventSubscription_Spec(destination *storage.EventSubscription_Spec) error {
	...
	// DeadLetterWithResourceIdentity
	if propertyBag.Contains("DeadLetterWithResourceIdentity") {
		var deadLetterWithResourceIdentity storage.DeadLetterWithResourceIdentity
		err := propertyBag.Pull("DeadLetterWithResourceIdentity", &deadLetterWithResourceIdentity)
		if err != nil {
			return eris.Wrap(err, "pulling 'DeadLetterWithResourceIdentity' from propertyBag")
		}
	...
	// DeliveryWithResourceIdentity
	if propertyBag.Contains("DeliveryWithResourceIdentity") {
		var deliveryWithResourceIdentity storage.DeliveryWithResourceIdentity
		err := propertyBag.Pull("DeliveryWithResourceIdentity", &deliveryWithResourceIdentity)
		if err != nil {
			return eris.Wrap(err, "pulling 'DeliveryWithResourceIdentity' from propertyBag")
		}
...
// Storage version of v20200601.DeadLetterDestination
...
// Storage version of v20200601.DeadLetterDestination_STATUS
...
// Storage version of v20200601.EventSubscriptionDestination
...
func (destination *EventSubscriptionDestination) AssignProperties_From_EventSubscriptionDestination(source *storage.EventSubscriptionDestination) error {
	...
	if source.MonitorAlert != nil {
		propertyBag.Add("MonitorAlert", *source.MonitorAlert)
	} else {
		propertyBag.Remove("MonitorAlert")
	}

	// NamespaceTopic
	if source.NamespaceTopic != nil {
		propertyBag.Add("NamespaceTopic", *source.NamespaceTopic)
	} else {
		propertyBag.Remove("NamespaceTopic")
	}
...
func (destination *EventSubscriptionDestination) AssignProperties_To_EventSubscriptionDestination(target *storage.EventSubscriptionDestination) error {
	...
	// MonitorAlert
	if propertyBag.Contains("MonitorAlert") {
		var monitorAlert storage.MonitorAlertEventSubscriptionDestination
		err := propertyBag.Pull("MonitorAlert", &monitorAlert)
		if err != nil {
			return eris.Wrap(err, "pulling 'MonitorAlert' from propertyBag")
		}
	...
	// NamespaceTopic
	if propertyBag.Contains("NamespaceTopic") {
		var namespaceTopic storage.NamespaceTopicEventSubscriptionDestination
		err := propertyBag.Pull("NamespaceTopic", &namespaceTopic)
		if err != nil {
			return eris.Wrap(err, "pulling 'NamespaceTopic' from propertyBag")
		}
...
// Storage version of v20200601.EventSubscriptionDestination_STATUS
...
func (filter *EventSubscriptionFilter) AssignProperties_From_EventSubscriptionFilter(source *storage.EventSubscriptionFilter) error {
	...
	if source.EnableAdvancedFilteringOnArrays != nil {
		propertyBag.Add("EnableAdvancedFilteringOnArrays", *source.EnableAdvancedFilteringOnArrays)
	} else {
		propertyBag.Remove("EnableAdvancedFilteringOnArrays")
	}
...
func (filter *EventSubscriptionFilter) AssignProperties_To_EventSubscriptionFilter(destination *storage.EventSubscriptionFilter) error {
	...
	// EnableAdvancedFilteringOnArrays
	if propertyBag.Contains("EnableAdvancedFilteringOnArrays") {
		var enableAdvancedFilteringOnArray bool
		err := propertyBag.Pull("EnableAdvancedFilteringOnArrays", &enableAdvancedFilteringOnArray)
		if err != nil {
			return eris.Wrap(err, "pulling 'EnableAdvancedFilteringOnArrays' from propertyBag")
		}
...
// Storage version of v20200601.AdvancedFilter
...
func (filter *AdvancedFilter) AssignProperties_From_AdvancedFilter(source *storage.AdvancedFilter) error {
	...
	if source.IsNotNull != nil {
		propertyBag.Add("IsNotNull", *source.IsNotNull)
	} else {
		propertyBag.Remove("IsNotNull")
	}

	// IsNullOrUndefined
	if source.IsNullOrUndefined != nil {
		propertyBag.Add("IsNullOrUndefined", *source.IsNullOrUndefined)
	} else {
		propertyBag.Remove("IsNullOrUndefined")
	}
	...
	if source.NumberInRange != nil {
		propertyBag.Add("NumberInRange", *source.NumberInRange)
	} else {
		propertyBag.Remove("NumberInRange")
	}
	...
	if source.NumberNotInRange != nil {
		propertyBag.Add("NumberNotInRange", *source.NumberNotInRange)
	} else {
		propertyBag.Remove("NumberNotInRange")
	}
	...
	if source.StringNotBeginsWith != nil {
		propertyBag.Add("StringNotBeginsWith", *source.StringNotBeginsWith)
	} else {
		propertyBag.Remove("StringNotBeginsWith")
	}

	// StringNotContains
	if source.StringNotContains != nil {
		propertyBag.Add("StringNotContains", *source.StringNotContains)
	} else {
		propertyBag.Remove("StringNotContains")
	}

	// StringNotEndsWith
	if source.StringNotEndsWith != nil {
		propertyBag.Add("StringNotEndsWith", *source.StringNotEndsWith)
	} else {
		propertyBag.Remove("StringNotEndsWith")
	}
...
func (filter *AdvancedFilter) AssignProperties_To_AdvancedFilter(destination *storage.AdvancedFilter) error {
	...
	// IsNotNull
	if propertyBag.Contains("IsNotNull") {
		var isNotNull storage.IsNotNullAdvancedFilter
		err := propertyBag.Pull("IsNotNull", &isNotNull)
		if err != nil {
			return eris.Wrap(err, "pulling 'IsNotNull' from propertyBag")
		}
	...
	// IsNullOrUndefined
	if propertyBag.Contains("IsNullOrUndefined") {
		var isNullOrUndefined storage.IsNullOrUndefinedAdvancedFilter
		err := propertyBag.Pull("IsNullOrUndefined", &isNullOrUndefined)
		if err != nil {
			return eris.Wrap(err, "pulling 'IsNullOrUndefined' from propertyBag")
		}
	...
	// NumberInRange
	if propertyBag.Contains("NumberInRange") {
		var numberInRange storage.NumberInRangeAdvancedFilter
		err := propertyBag.Pull("NumberInRange", &numberInRange)
		if err != nil {
			return eris.Wrap(err, "pulling 'NumberInRange' from propertyBag")
		}
	...
	// NumberNotInRange
	if propertyBag.Contains("NumberNotInRange") {
		var numberNotInRange storage.NumberNotInRangeAdvancedFilter
		err := propertyBag.Pull("NumberNotInRange", &numberNotInRange)
		if err != nil {
			return eris.Wrap(err, "pulling 'NumberNotInRange' from propertyBag")
		}
	...
	// StringNotBeginsWith
	if propertyBag.Contains("StringNotBeginsWith") {
		var stringNotBeginsWith storage.StringNotBeginsWithAdvancedFilter
		err := propertyBag.Pull("StringNotBeginsWith", &stringNotBeginsWith)
		if err != nil {
			return eris.Wrap(err, "pulling 'StringNotBeginsWith' from propertyBag")
		}
	...
	// StringNotContains
	if propertyBag.Contains("StringNotContains") {
		var stringNotContain storage.StringNotContainsAdvancedFilter
		err := propertyBag.Pull("StringNotContains", &stringNotContain)
		if err != nil {
			return eris.Wrap(err, "pulling 'StringNotContains' from propertyBag")
		}
	...
	// StringNotEndsWith
	if propertyBag.Contains("StringNotEndsWith") {
		var stringNotEndsWith storage.StringNotEndsWithAdvancedFilter
		err := propertyBag.Pull("StringNotEndsWith", &stringNotEndsWith)
		if err != nil {
			return eris.Wrap(err, "pulling 'StringNotEndsWith' from propertyBag")
		}
...
// Storage version of v20200601.AdvancedFilter_STATUS
...
// Storage version of v20200601.AzureFunctionEventSubscriptionDestination
...
func (destination *AzureFunctionEventSubscriptionDestination) AssignProperties_From_AzureFunctionEventSubscriptionDestination(source *storage.AzureFunctionEventSubscriptionDestination) error {
	...
	if len(source.DeliveryAttributeMappings) > 0 {
		propertyBag.Add("DeliveryAttributeMappings", source.DeliveryAttributeMappings)
	} else {
		propertyBag.Remove("DeliveryAttributeMappings")
	}
...
func (destination *AzureFunctionEventSubscriptionDestination) AssignProperties_To_AzureFunctionEventSubscriptionDestination(target *storage.AzureFunctionEventSubscriptionDestination) error {
	...
	// DeliveryAttributeMappings
	if propertyBag.Contains("DeliveryAttributeMappings") {
		var deliveryAttributeMapping []storage.DeliveryAttributeMapping
		err := propertyBag.Pull("DeliveryAttributeMappings", &deliveryAttributeMapping)
		if err != nil {
			return eris.Wrap(err, "pulling 'DeliveryAttributeMappings' from propertyBag")
		}

		target.DeliveryAttributeMappings = deliveryAttributeMapping
	} else {
...
// Storage version of v20200601.AzureFunctionEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.EventHubEventSubscriptionDestination
...
// Storage version of v20200601.EventHubEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.HybridConnectionEventSubscriptionDestination
...
// Storage version of v20200601.HybridConnectionEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.ServiceBusQueueEventSubscriptionDestination
...
// Storage version of v20200601.ServiceBusQueueEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.ServiceBusTopicEventSubscriptionDestination
...
// Storage version of v20200601.ServiceBusTopicEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.StorageBlobDeadLetterDestination
...
// Storage version of v20200601.StorageBlobDeadLetterDestination_STATUS
...
func (destination *StorageQueueEventSubscriptionDestination) AssignProperties_From_StorageQueueEventSubscriptionDestination(source *storage.StorageQueueEventSubscriptionDestination) error {
	...
	if source.QueueMessageTimeToLiveInSeconds != nil {
		propertyBag.Add("QueueMessageTimeToLiveInSeconds", *source.QueueMessageTimeToLiveInSeconds)
	} else {
		propertyBag.Remove("QueueMessageTimeToLiveInSeconds")
	}
...
func (destination *StorageQueueEventSubscriptionDestination) AssignProperties_To_StorageQueueEventSubscriptionDestination(target *storage.StorageQueueEventSubscriptionDestination) error {
	...
	// QueueMessageTimeToLiveInSeconds
	if propertyBag.Contains("QueueMessageTimeToLiveInSeconds") {
		var queueMessageTimeToLiveInSecond int
		err := propertyBag.Pull("QueueMessageTimeToLiveInSeconds", &queueMessageTimeToLiveInSecond)
		if err != nil {
			return eris.Wrap(err, "pulling 'QueueMessageTimeToLiveInSeconds' from propertyBag")
		}

		target.QueueMessageTimeToLiveInSeconds = &queueMessageTimeToLiveInSecond
	} else {
		target.QueueMessageTimeToLiveInSeconds = nil
	}
...
// Storage version of v20200601.StorageQueueEventSubscriptionDestination_STATUS
...
func (destination *WebHookEventSubscriptionDestination) AssignProperties_From_WebHookEventSubscriptionDestination(source *storage.WebHookEventSubscriptionDestination) error {
	...
	if source.MinimumTlsVersionAllowed != nil {
		propertyBag.Add("MinimumTlsVersionAllowed", *source.MinimumTlsVersionAllowed)
	} else {
		propertyBag.Remove("MinimumTlsVersionAllowed")
	}
...
func (destination *WebHookEventSubscriptionDestination) AssignProperties_To_WebHookEventSubscriptionDestination(target *storage.WebHookEventSubscriptionDestination) error {
	...
	// MinimumTlsVersionAllowed
	if propertyBag.Contains("MinimumTlsVersionAllowed") {
		var minimumTlsVersionAllowed string
		err := propertyBag.Pull("MinimumTlsVersionAllowed", &minimumTlsVersionAllowed)
		if err != nil {
			return eris.Wrap(err, "pulling 'MinimumTlsVersionAllowed' from propertyBag")
		}
...
// Storage version of v20200601.WebHookEventSubscriptionDestination_STATUS
...
// Storage version of v20200601.BoolEqualsAdvancedFilter
...
// Storage version of v20200601.BoolEqualsAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberGreaterThanAdvancedFilter
...
// Storage version of v20200601.NumberGreaterThanAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberGreaterThanOrEqualsAdvancedFilter
...
// Storage version of v20200601.NumberGreaterThanOrEqualsAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberInAdvancedFilter
...
// Storage version of v20200601.NumberInAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberLessThanAdvancedFilter
...
// Storage version of v20200601.NumberLessThanAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberLessThanOrEqualsAdvancedFilter
...
// Storage version of v20200601.NumberLessThanOrEqualsAdvancedFilter_STATUS
...
// Storage version of v20200601.NumberNotInAdvancedFilter
...
// Storage version of v20200601.NumberNotInAdvancedFilter_STATUS
...
// Storage version of v20200601.StringBeginsWithAdvancedFilter
...
// Storage version of v20200601.StringBeginsWithAdvancedFilter_STATUS
...
// Storage version of v20200601.StringContainsAdvancedFilter
...
// Storage version of v20200601.StringContainsAdvancedFilter_STATUS
...
// Storage version of v20200601.StringEndsWithAdvancedFilter
...
// Storage version of v20200601.StringEndsWithAdvancedFilter_STATUS
...
// Storage version of v20200601.StringInAdvancedFilter
...
// Storage version of v20200601.StringInAdvancedFilter_STATUS
...
// Storage version of v20200601.StringNotInAdvancedFilter
...
// Storage version of v20200601.StringNotInAdvancedFilter_STATUS
