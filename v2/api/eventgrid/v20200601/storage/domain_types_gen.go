...
// Storage version of v20200601.APIVersion
...
// Storage version of v20200601.Domain_Spec
...
func (domain *Domain_Spec) AssignProperties_From_Domain_Spec(source *storage.Domain_Spec) error {
	...
	if source.AutoCreateTopicWithFirstSubscription != nil {
		propertyBag.Add("AutoCreateTopicWithFirstSubscription", *source.AutoCreateTopicWithFirstSubscription)
	} else {
		propertyBag.Remove("AutoCreateTopicWithFirstSubscription")
	}

	// AutoDeleteTopicWithLastSubscription
	if source.AutoDeleteTopicWithLastSubscription != nil {
		propertyBag.Add("AutoDeleteTopicWithLastSubscription", *source.AutoDeleteTopicWithLastSubscription)
	} else {
		propertyBag.Remove("AutoDeleteTopicWithLastSubscription")
	}
	...
	if source.DataResidencyBoundary != nil {
		propertyBag.Add("DataResidencyBoundary", *source.DataResidencyBoundary)
	} else {
		propertyBag.Remove("DataResidencyBoundary")
	}
	...
	if source.EventTypeInfo != nil {
		propertyBag.Add("EventTypeInfo", *source.EventTypeInfo)
	} else {
		propertyBag.Remove("EventTypeInfo")
	}
...
func (domain *Domain_Spec) AssignProperties_To_Domain_Spec(destination *storage.Domain_Spec) error {
	...
	// AutoCreateTopicWithFirstSubscription
	if propertyBag.Contains("AutoCreateTopicWithFirstSubscription") {
		var autoCreateTopicWithFirstSubscription bool
		err := propertyBag.Pull("AutoCreateTopicWithFirstSubscription", &autoCreateTopicWithFirstSubscription)
		if err != nil {
			return eris.Wrap(err, "pulling 'AutoCreateTopicWithFirstSubscription' from propertyBag")
		}
	...
	// AutoDeleteTopicWithLastSubscription
	if propertyBag.Contains("AutoDeleteTopicWithLastSubscription") {
		var autoDeleteTopicWithLastSubscription bool
		err := propertyBag.Pull("AutoDeleteTopicWithLastSubscription", &autoDeleteTopicWithLastSubscription)
		if err != nil {
			return eris.Wrap(err, "pulling 'AutoDeleteTopicWithLastSubscription' from propertyBag")
		}
	...
	// DataResidencyBoundary
	if propertyBag.Contains("DataResidencyBoundary") {
		var dataResidencyBoundary string
		err := propertyBag.Pull("DataResidencyBoundary", &dataResidencyBoundary)
		if err != nil {
			return eris.Wrap(err, "pulling 'DataResidencyBoundary' from propertyBag")
		}
	...
	// EventTypeInfo
	if propertyBag.Contains("EventTypeInfo") {
		var eventTypeInfo storage.EventTypeInfo
		err := propertyBag.Pull("EventTypeInfo", &eventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "pulling 'EventTypeInfo' from propertyBag")
		}
...
// Storage version of v20200601.InboundIpRule
...
// Storage version of v20200601.InboundIpRule_STATUS
...
// Storage version of v20200601.InputSchemaMapping
...
// Storage version of v20200601.InputSchemaMapping_STATUS
...
// Storage version of v20200601.PrivateEndpointConnection_STATUS_Domain_SubResourceEmbedded
...
// Storage version of v20200601.JsonInputSchemaMapping
...
// Storage version of v20200601.JsonInputSchemaMapping_STATUS
