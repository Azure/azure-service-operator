...
// +kubebuilder:webhook:path=/mutate-eventgrid-azure-com-v20200601-topic,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=eventgrid.azure.com,resources=topics,verbs=create;update,versions=v20200601,name=default.v20200601.topics.eventgrid.azure.com,admissionReviewVersions=v1
...
func (topic *Topic) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/eventgrid/v20200601/Topic, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-eventgrid-azure-com-v20200601-topic,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=eventgrid.azure.com,resources=topics,verbs=create;update,versions=v20200601,name=validate.v20200601.topics.eventgrid.azure.com,admissionReviewVersions=v1
...
func (topic *Topic) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/eventgrid/v20200601/Topic, but got %T", resource)
	}
...
func (topic *Topic) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/eventgrid/v20200601/Topic, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20200601.Topic)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/eventgrid/v20200601/Topic, but got %T", oldResource)
	}
