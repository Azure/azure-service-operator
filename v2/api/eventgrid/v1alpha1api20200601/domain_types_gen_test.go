...
// RunPropertyAssignmentTestForPrivateEndpointConnection_Domain_SubResourceEmbedded tests if a specific instance of PrivateEndpointConnection_Domain_SubResourceEmbedded can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateEndpointConnection_Domain_SubResourceEmbedded(subject PrivateEndpointConnection_Domain_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.PrivateEndpointConnection_Domain_SubResourceEmbedded
...
// RunPropertyAssignmentTestForSystemData tests if a specific instance of SystemData can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForSystemData(subject SystemData) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.SystemData
