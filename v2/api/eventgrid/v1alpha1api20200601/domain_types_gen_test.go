...
func RunPropertyAssignmentTestForDomain_Spec(subject Domain_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.Domain_Spec
...
func RunPropertyAssignmentTestForInputSchemaMapping(subject InputSchemaMapping) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.InputSchemaMapping
...
// RunPropertyAssignmentTestForJsonInputSchemaMapping_STATUS tests if a specific instance of JsonInputSchemaMapping_STATUS can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForJsonInputSchemaMapping_STATUS(subject JsonInputSchemaMapping_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.JsonInputSchemaMapping_STATUS
...
// RunPropertyAssignmentTestForJsonField_STATUS tests if a specific instance of JsonField_STATUS can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForJsonField_STATUS(subject JsonField_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.JsonField_STATUS
...
// RunPropertyAssignmentTestForJsonFieldWithDefault_STATUS tests if a specific instance of JsonFieldWithDefault_STATUS can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForJsonFieldWithDefault_STATUS(subject JsonFieldWithDefault_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.JsonFieldWithDefault_STATUS
