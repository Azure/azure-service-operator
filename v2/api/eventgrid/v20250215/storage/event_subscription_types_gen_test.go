...
func AddRelatedPropertyGeneratorsForAdvancedFilter(gens map[string]gopter.Gen) {
	...
	gens["IsNotNull"] = IsNotNullAdvancedFilterGenerator().Map(func(it IsNotNullAdvancedFilter) *IsNotNullAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	gens["IsNullOrUndefined"] = IsNullOrUndefinedAdvancedFilterGenerator().Map(func(it IsNullOrUndefinedAdvancedFilter) *IsNullOrUndefinedAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	...
	gens["NumberInRange"] = NumberInRangeAdvancedFilterGenerator().Map(func(it NumberInRangeAdvancedFilter) *NumberInRangeAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	...
	gens["NumberNotInRange"] = NumberNotInRangeAdvancedFilterGenerator().Map(func(it NumberNotInRangeAdvancedFilter) *NumberNotInRangeAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	...
	gens["StringNotBeginsWith"] = StringNotBeginsWithAdvancedFilterGenerator().Map(func(it StringNotBeginsWithAdvancedFilter) *StringNotBeginsWithAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	gens["StringNotContains"] = StringNotContainsAdvancedFilterGenerator().Map(func(it StringNotContainsAdvancedFilter) *StringNotContainsAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
	gens["StringNotEndsWith"] = StringNotEndsWithAdvancedFilterGenerator().Map(func(it StringNotEndsWithAdvancedFilter) *StringNotEndsWithAdvancedFilter {
		return &it
	}) // generate one case for OneOf type
...
func AddRelatedPropertyGeneratorsForAzureFunctionEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
...
func Test_DeadLetterWithResourceIdentity_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeadLetterWithResourceIdentity via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeadLetterWithResourceIdentity, DeadLetterWithResourceIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeadLetterWithResourceIdentity runs a test to see if a specific instance of DeadLetterWithResourceIdentity round trips to JSON and back losslessly
func RunJSONSerializationTestForDeadLetterWithResourceIdentity(subject DeadLetterWithResourceIdentity) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeadLetterWithResourceIdentity
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeadLetterWithResourceIdentity instances for property testing - lazily instantiated by
// DeadLetterWithResourceIdentityGenerator()
var deadLetterWithResourceIdentityGenerator gopter.Gen

// DeadLetterWithResourceIdentityGenerator returns a generator of DeadLetterWithResourceIdentity instances for property testing.
func DeadLetterWithResourceIdentityGenerator() gopter.Gen {
	if deadLetterWithResourceIdentityGenerator != nil {
		return deadLetterWithResourceIdentityGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForDeadLetterWithResourceIdentity(generators)
	deadLetterWithResourceIdentityGenerator = gen.Struct(reflect.TypeOf(DeadLetterWithResourceIdentity{}), generators)

	return deadLetterWithResourceIdentityGenerator
}

// AddRelatedPropertyGeneratorsForDeadLetterWithResourceIdentity is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeadLetterWithResourceIdentity(gens map[string]gopter.Gen) {
	gens["DeadLetterDestination"] = gen.PtrOf(DeadLetterDestinationGenerator())
	gens["Identity"] = gen.PtrOf(EventSubscriptionIdentityGenerator())
}
...
func Test_DeliveryAttributeMapping_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeliveryAttributeMapping via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeliveryAttributeMapping, DeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeliveryAttributeMapping runs a test to see if a specific instance of DeliveryAttributeMapping round trips to JSON and back losslessly
func RunJSONSerializationTestForDeliveryAttributeMapping(subject DeliveryAttributeMapping) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeliveryAttributeMapping
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeliveryAttributeMapping instances for property testing - lazily instantiated by
// DeliveryAttributeMappingGenerator()
var deliveryAttributeMappingGenerator gopter.Gen

// DeliveryAttributeMappingGenerator returns a generator of DeliveryAttributeMapping instances for property testing.
func DeliveryAttributeMappingGenerator() gopter.Gen {
	if deliveryAttributeMappingGenerator != nil {
		return deliveryAttributeMappingGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForDeliveryAttributeMapping(generators)

	// handle OneOf by choosing only one field to instantiate
	var gens []gopter.Gen
	for propName, propGen := range generators {
		props := map[string]gopter.Gen{propName: propGen}
		gens = append(gens, gen.Struct(reflect.TypeOf(DeliveryAttributeMapping{}), props))
	}
	deliveryAttributeMappingGenerator = gen.OneGenOf(gens...)

	return deliveryAttributeMappingGenerator
}

// AddRelatedPropertyGeneratorsForDeliveryAttributeMapping is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	gens["Dynamic"] = DynamicDeliveryAttributeMappingGenerator().Map(func(it DynamicDeliveryAttributeMapping) *DynamicDeliveryAttributeMapping {
		return &it
	}) // generate one case for OneOf type
	gens["Static"] = StaticDeliveryAttributeMappingGenerator().Map(func(it StaticDeliveryAttributeMapping) *StaticDeliveryAttributeMapping {
		return &it
	}) // generate one case for OneOf type
}
...
func Test_DeliveryWithResourceIdentity_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DeliveryWithResourceIdentity via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDeliveryWithResourceIdentity, DeliveryWithResourceIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDeliveryWithResourceIdentity runs a test to see if a specific instance of DeliveryWithResourceIdentity round trips to JSON and back losslessly
func RunJSONSerializationTestForDeliveryWithResourceIdentity(subject DeliveryWithResourceIdentity) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DeliveryWithResourceIdentity
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DeliveryWithResourceIdentity instances for property testing - lazily instantiated by
// DeliveryWithResourceIdentityGenerator()
var deliveryWithResourceIdentityGenerator gopter.Gen

// DeliveryWithResourceIdentityGenerator returns a generator of DeliveryWithResourceIdentity instances for property testing.
func DeliveryWithResourceIdentityGenerator() gopter.Gen {
	if deliveryWithResourceIdentityGenerator != nil {
		return deliveryWithResourceIdentityGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForDeliveryWithResourceIdentity(generators)
	deliveryWithResourceIdentityGenerator = gen.Struct(reflect.TypeOf(DeliveryWithResourceIdentity{}), generators)

	return deliveryWithResourceIdentityGenerator
}

// AddRelatedPropertyGeneratorsForDeliveryWithResourceIdentity is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDeliveryWithResourceIdentity(gens map[string]gopter.Gen) {
...
func Test_DynamicDeliveryAttributeMapping_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DynamicDeliveryAttributeMapping via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDynamicDeliveryAttributeMapping, DynamicDeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDynamicDeliveryAttributeMapping runs a test to see if a specific instance of DynamicDeliveryAttributeMapping round trips to JSON and back losslessly
func RunJSONSerializationTestForDynamicDeliveryAttributeMapping(subject DynamicDeliveryAttributeMapping) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DynamicDeliveryAttributeMapping
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DynamicDeliveryAttributeMapping instances for property testing - lazily instantiated by
// DynamicDeliveryAttributeMappingGenerator()
var dynamicDeliveryAttributeMappingGenerator gopter.Gen

// DynamicDeliveryAttributeMappingGenerator returns a generator of DynamicDeliveryAttributeMapping instances for property testing.
func DynamicDeliveryAttributeMappingGenerator() gopter.Gen {
	if dynamicDeliveryAttributeMappingGenerator != nil {
		return dynamicDeliveryAttributeMappingGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping(generators)
	dynamicDeliveryAttributeMappingGenerator = gen.Struct(reflect.TypeOf(DynamicDeliveryAttributeMapping{}), generators)

	return dynamicDeliveryAttributeMappingGenerator
}

// AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForEventSubscriptionDestination(gens map[string]gopter.Gen) {
	...
	gens["MonitorAlert"] = MonitorAlertEventSubscriptionDestinationGenerator().Map(func(it MonitorAlertEventSubscriptionDestination) *MonitorAlertEventSubscriptionDestination {
		return &it
	}) // generate one case for OneOf type
	gens["NamespaceTopic"] = NamespaceTopicEventSubscriptionDestinationGenerator().Map(func(it NamespaceTopicEventSubscriptionDestination) *NamespaceTopicEventSubscriptionDestination {
		return &it
	}) // generate one case for OneOf type
...
func Test_EventSubscriptionIdentity_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of EventSubscriptionIdentity via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForEventSubscriptionIdentity, EventSubscriptionIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForEventSubscriptionIdentity runs a test to see if a specific instance of EventSubscriptionIdentity round trips to JSON and back losslessly
func RunJSONSerializationTestForEventSubscriptionIdentity(subject EventSubscriptionIdentity) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual EventSubscriptionIdentity
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of EventSubscriptionIdentity instances for property testing - lazily instantiated by
// EventSubscriptionIdentityGenerator()
var eventSubscriptionIdentityGenerator gopter.Gen

// EventSubscriptionIdentityGenerator returns a generator of EventSubscriptionIdentity instances for property testing.
func EventSubscriptionIdentityGenerator() gopter.Gen {
	if eventSubscriptionIdentityGenerator != nil {
		return eventSubscriptionIdentityGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForEventSubscriptionIdentity(generators)
	eventSubscriptionIdentityGenerator = gen.Struct(reflect.TypeOf(EventSubscriptionIdentity{}), generators)

	return eventSubscriptionIdentityGenerator
}

// AddIndependentPropertyGeneratorsForEventSubscriptionIdentity is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForEventSubscriptionIdentity(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.AlphaString())
...
func AddRelatedPropertyGeneratorsForEventSubscription_Spec(gens map[string]gopter.Gen) {
	gens["DeadLetterDestination"] = gen.PtrOf(DeadLetterDestinationGenerator())
	gens["DeadLetterWithResourceIdentity"] = gen.PtrOf(DeadLetterWithResourceIdentityGenerator())
	gens["DeliveryWithResourceIdentity"] = gen.PtrOf(DeliveryWithResourceIdentityGenerator())
	gens["Destination"] = gen.PtrOf(EventSubscriptionDestinationGenerator())
...
func Test_IsNotNullAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IsNotNullAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIsNotNullAdvancedFilter, IsNotNullAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIsNotNullAdvancedFilter runs a test to see if a specific instance of IsNotNullAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForIsNotNullAdvancedFilter(subject IsNotNullAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual IsNotNullAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of IsNotNullAdvancedFilter instances for property testing - lazily instantiated by
// IsNotNullAdvancedFilterGenerator()
var isNotNullAdvancedFilterGenerator gopter.Gen

// IsNotNullAdvancedFilterGenerator returns a generator of IsNotNullAdvancedFilter instances for property testing.
func IsNotNullAdvancedFilterGenerator() gopter.Gen {
	if isNotNullAdvancedFilterGenerator != nil {
		return isNotNullAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter(generators)
	isNotNullAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(IsNotNullAdvancedFilter{}), generators)

	return isNotNullAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_IsNullOrUndefinedAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IsNullOrUndefinedAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIsNullOrUndefinedAdvancedFilter, IsNullOrUndefinedAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIsNullOrUndefinedAdvancedFilter runs a test to see if a specific instance of IsNullOrUndefinedAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForIsNullOrUndefinedAdvancedFilter(subject IsNullOrUndefinedAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual IsNullOrUndefinedAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of IsNullOrUndefinedAdvancedFilter instances for property testing - lazily instantiated by
// IsNullOrUndefinedAdvancedFilterGenerator()
var isNullOrUndefinedAdvancedFilterGenerator gopter.Gen

// IsNullOrUndefinedAdvancedFilterGenerator returns a generator of IsNullOrUndefinedAdvancedFilter instances for property testing.
func IsNullOrUndefinedAdvancedFilterGenerator() gopter.Gen {
	if isNullOrUndefinedAdvancedFilterGenerator != nil {
		return isNullOrUndefinedAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter(generators)
	isNullOrUndefinedAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(IsNullOrUndefinedAdvancedFilter{}), generators)

	return isNullOrUndefinedAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_MonitorAlertEventSubscriptionDestination_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of MonitorAlertEventSubscriptionDestination via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMonitorAlertEventSubscriptionDestination, MonitorAlertEventSubscriptionDestinationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMonitorAlertEventSubscriptionDestination runs a test to see if a specific instance of MonitorAlertEventSubscriptionDestination round trips to JSON and back losslessly
func RunJSONSerializationTestForMonitorAlertEventSubscriptionDestination(subject MonitorAlertEventSubscriptionDestination) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual MonitorAlertEventSubscriptionDestination
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of MonitorAlertEventSubscriptionDestination instances for property testing - lazily instantiated by
// MonitorAlertEventSubscriptionDestinationGenerator()
var monitorAlertEventSubscriptionDestinationGenerator gopter.Gen

// MonitorAlertEventSubscriptionDestinationGenerator returns a generator of MonitorAlertEventSubscriptionDestination instances for property testing.
func MonitorAlertEventSubscriptionDestinationGenerator() gopter.Gen {
	if monitorAlertEventSubscriptionDestinationGenerator != nil {
		return monitorAlertEventSubscriptionDestinationGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(generators)
	monitorAlertEventSubscriptionDestinationGenerator = gen.Struct(reflect.TypeOf(MonitorAlertEventSubscriptionDestination{}), generators)

	return monitorAlertEventSubscriptionDestinationGenerator
}

// AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(gens map[string]gopter.Gen) {
...
func Test_NamespaceTopicEventSubscriptionDestination_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NamespaceTopicEventSubscriptionDestination via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestination, NamespaceTopicEventSubscriptionDestinationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestination runs a test to see if a specific instance of NamespaceTopicEventSubscriptionDestination round trips to JSON and back losslessly
func RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestination(subject NamespaceTopicEventSubscriptionDestination) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NamespaceTopicEventSubscriptionDestination
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NamespaceTopicEventSubscriptionDestination instances for property testing - lazily instantiated by
// NamespaceTopicEventSubscriptionDestinationGenerator()
var namespaceTopicEventSubscriptionDestinationGenerator gopter.Gen

// NamespaceTopicEventSubscriptionDestinationGenerator returns a generator of NamespaceTopicEventSubscriptionDestination instances for property testing.
func NamespaceTopicEventSubscriptionDestinationGenerator() gopter.Gen {
	if namespaceTopicEventSubscriptionDestinationGenerator != nil {
		return namespaceTopicEventSubscriptionDestinationGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(generators)
	namespaceTopicEventSubscriptionDestinationGenerator = gen.Struct(reflect.TypeOf(NamespaceTopicEventSubscriptionDestination{}), generators)

	return namespaceTopicEventSubscriptionDestinationGenerator
}

// AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["EndpointType"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_NumberInRangeAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NumberInRangeAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNumberInRangeAdvancedFilter, NumberInRangeAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNumberInRangeAdvancedFilter runs a test to see if a specific instance of NumberInRangeAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForNumberInRangeAdvancedFilter(subject NumberInRangeAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NumberInRangeAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NumberInRangeAdvancedFilter instances for property testing - lazily instantiated by
// NumberInRangeAdvancedFilterGenerator()
var numberInRangeAdvancedFilterGenerator gopter.Gen

// NumberInRangeAdvancedFilterGenerator returns a generator of NumberInRangeAdvancedFilter instances for property testing.
func NumberInRangeAdvancedFilterGenerator() gopter.Gen {
	if numberInRangeAdvancedFilterGenerator != nil {
		return numberInRangeAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter(generators)
	numberInRangeAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(NumberInRangeAdvancedFilter{}), generators)

	return numberInRangeAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
...
func Test_NumberNotInRangeAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NumberNotInRangeAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNumberNotInRangeAdvancedFilter, NumberNotInRangeAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNumberNotInRangeAdvancedFilter runs a test to see if a specific instance of NumberNotInRangeAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForNumberNotInRangeAdvancedFilter(subject NumberNotInRangeAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NumberNotInRangeAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NumberNotInRangeAdvancedFilter instances for property testing - lazily instantiated by
// NumberNotInRangeAdvancedFilterGenerator()
var numberNotInRangeAdvancedFilterGenerator gopter.Gen

// NumberNotInRangeAdvancedFilterGenerator returns a generator of NumberNotInRangeAdvancedFilter instances for property testing.
func NumberNotInRangeAdvancedFilterGenerator() gopter.Gen {
	if numberNotInRangeAdvancedFilterGenerator != nil {
		return numberNotInRangeAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter(generators)
	numberNotInRangeAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(NumberNotInRangeAdvancedFilter{}), generators)

	return numberNotInRangeAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}
...
func Test_StaticDeliveryAttributeMapping_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StaticDeliveryAttributeMapping via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStaticDeliveryAttributeMapping, StaticDeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStaticDeliveryAttributeMapping runs a test to see if a specific instance of StaticDeliveryAttributeMapping round trips to JSON and back losslessly
func RunJSONSerializationTestForStaticDeliveryAttributeMapping(subject StaticDeliveryAttributeMapping) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StaticDeliveryAttributeMapping
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StaticDeliveryAttributeMapping instances for property testing - lazily instantiated by
// StaticDeliveryAttributeMappingGenerator()
var staticDeliveryAttributeMappingGenerator gopter.Gen

// StaticDeliveryAttributeMappingGenerator returns a generator of StaticDeliveryAttributeMapping instances for property testing.
func StaticDeliveryAttributeMappingGenerator() gopter.Gen {
	if staticDeliveryAttributeMappingGenerator != nil {
		return staticDeliveryAttributeMappingGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping(generators)
	staticDeliveryAttributeMappingGenerator = gen.Struct(reflect.TypeOf(StaticDeliveryAttributeMapping{}), generators)

	return staticDeliveryAttributeMappingGenerator
}

// AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping(gens map[string]gopter.Gen) {
...
func Test_StringNotBeginsWithAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StringNotBeginsWithAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStringNotBeginsWithAdvancedFilter, StringNotBeginsWithAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStringNotBeginsWithAdvancedFilter runs a test to see if a specific instance of StringNotBeginsWithAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForStringNotBeginsWithAdvancedFilter(subject StringNotBeginsWithAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StringNotBeginsWithAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StringNotBeginsWithAdvancedFilter instances for property testing - lazily instantiated by
// StringNotBeginsWithAdvancedFilterGenerator()
var stringNotBeginsWithAdvancedFilterGenerator gopter.Gen

// StringNotBeginsWithAdvancedFilterGenerator returns a generator of StringNotBeginsWithAdvancedFilter instances for property testing.
func StringNotBeginsWithAdvancedFilterGenerator() gopter.Gen {
	if stringNotBeginsWithAdvancedFilterGenerator != nil {
		return stringNotBeginsWithAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter(generators)
	stringNotBeginsWithAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(StringNotBeginsWithAdvancedFilter{}), generators)

	return stringNotBeginsWithAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
func Test_StringNotContainsAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StringNotContainsAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStringNotContainsAdvancedFilter, StringNotContainsAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStringNotContainsAdvancedFilter runs a test to see if a specific instance of StringNotContainsAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForStringNotContainsAdvancedFilter(subject StringNotContainsAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StringNotContainsAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StringNotContainsAdvancedFilter instances for property testing - lazily instantiated by
// StringNotContainsAdvancedFilterGenerator()
var stringNotContainsAdvancedFilterGenerator gopter.Gen

// StringNotContainsAdvancedFilterGenerator returns a generator of StringNotContainsAdvancedFilter instances for property testing.
func StringNotContainsAdvancedFilterGenerator() gopter.Gen {
	if stringNotContainsAdvancedFilterGenerator != nil {
		return stringNotContainsAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter(generators)
	stringNotContainsAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(StringNotContainsAdvancedFilter{}), generators)

	return stringNotContainsAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
func Test_StringNotEndsWithAdvancedFilter_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StringNotEndsWithAdvancedFilter via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStringNotEndsWithAdvancedFilter, StringNotEndsWithAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStringNotEndsWithAdvancedFilter runs a test to see if a specific instance of StringNotEndsWithAdvancedFilter round trips to JSON and back losslessly
func RunJSONSerializationTestForStringNotEndsWithAdvancedFilter(subject StringNotEndsWithAdvancedFilter) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StringNotEndsWithAdvancedFilter
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StringNotEndsWithAdvancedFilter instances for property testing - lazily instantiated by
// StringNotEndsWithAdvancedFilterGenerator()
var stringNotEndsWithAdvancedFilterGenerator gopter.Gen

// StringNotEndsWithAdvancedFilterGenerator returns a generator of StringNotEndsWithAdvancedFilter instances for property testing.
func StringNotEndsWithAdvancedFilterGenerator() gopter.Gen {
	if stringNotEndsWithAdvancedFilterGenerator != nil {
		return stringNotEndsWithAdvancedFilterGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter(generators)
	stringNotEndsWithAdvancedFilterGenerator = gen.Struct(reflect.TypeOf(StringNotEndsWithAdvancedFilter{}), generators)

	return stringNotEndsWithAdvancedFilterGenerator
}

// AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.AlphaString())
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
