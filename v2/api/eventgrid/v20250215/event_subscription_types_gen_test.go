...
func Test_DeadLetterWithResourceIdentity_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeadLetterWithResourceIdentity to DeadLetterWithResourceIdentity via AssignProperties_To_DeadLetterWithResourceIdentity & AssignProperties_From_DeadLetterWithResourceIdentity returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeadLetterWithResourceIdentity, DeadLetterWithResourceIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeadLetterWithResourceIdentity tests if a specific instance of DeadLetterWithResourceIdentity can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeadLetterWithResourceIdentity(subject DeadLetterWithResourceIdentity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeadLetterWithResourceIdentity
	err := copied.AssignProperties_To_DeadLetterWithResourceIdentity(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeadLetterWithResourceIdentity(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DeadLetterWithResourceIdentity_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeadLetterWithResourceIdentity_STATUS to DeadLetterWithResourceIdentity_STATUS via AssignProperties_To_DeadLetterWithResourceIdentity_STATUS & AssignProperties_From_DeadLetterWithResourceIdentity_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeadLetterWithResourceIdentity_STATUS, DeadLetterWithResourceIdentity_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeadLetterWithResourceIdentity_STATUS tests if a specific instance of DeadLetterWithResourceIdentity_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeadLetterWithResourceIdentity_STATUS(subject DeadLetterWithResourceIdentity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeadLetterWithResourceIdentity_STATUS
	err := copied.AssignProperties_To_DeadLetterWithResourceIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeadLetterWithResourceIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DeliveryAttributeMapping_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeliveryAttributeMapping to DeliveryAttributeMapping via AssignProperties_To_DeliveryAttributeMapping & AssignProperties_From_DeliveryAttributeMapping returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeliveryAttributeMapping, DeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeliveryAttributeMapping tests if a specific instance of DeliveryAttributeMapping can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeliveryAttributeMapping(subject DeliveryAttributeMapping) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeliveryAttributeMapping
	err := copied.AssignProperties_To_DeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DeliveryAttributeMapping_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeliveryAttributeMapping_STATUS to DeliveryAttributeMapping_STATUS via AssignProperties_To_DeliveryAttributeMapping_STATUS & AssignProperties_From_DeliveryAttributeMapping_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeliveryAttributeMapping_STATUS, DeliveryAttributeMapping_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeliveryAttributeMapping_STATUS tests if a specific instance of DeliveryAttributeMapping_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeliveryAttributeMapping_STATUS(subject DeliveryAttributeMapping_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeliveryAttributeMapping_STATUS
	err := copied.AssignProperties_To_DeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DeliveryWithResourceIdentity_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeliveryWithResourceIdentity to DeliveryWithResourceIdentity via AssignProperties_To_DeliveryWithResourceIdentity & AssignProperties_From_DeliveryWithResourceIdentity returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeliveryWithResourceIdentity, DeliveryWithResourceIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeliveryWithResourceIdentity tests if a specific instance of DeliveryWithResourceIdentity can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeliveryWithResourceIdentity(subject DeliveryWithResourceIdentity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeliveryWithResourceIdentity
	err := copied.AssignProperties_To_DeliveryWithResourceIdentity(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeliveryWithResourceIdentity(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DeliveryWithResourceIdentity_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DeliveryWithResourceIdentity_STATUS to DeliveryWithResourceIdentity_STATUS via AssignProperties_To_DeliveryWithResourceIdentity_STATUS & AssignProperties_From_DeliveryWithResourceIdentity_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDeliveryWithResourceIdentity_STATUS, DeliveryWithResourceIdentity_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDeliveryWithResourceIdentity_STATUS tests if a specific instance of DeliveryWithResourceIdentity_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDeliveryWithResourceIdentity_STATUS(subject DeliveryWithResourceIdentity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DeliveryWithResourceIdentity_STATUS
	err := copied.AssignProperties_To_DeliveryWithResourceIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DeliveryWithResourceIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DynamicDeliveryAttributeMapping_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DynamicDeliveryAttributeMapping to DynamicDeliveryAttributeMapping via AssignProperties_To_DynamicDeliveryAttributeMapping & AssignProperties_From_DynamicDeliveryAttributeMapping returns original",
		prop.ForAll(RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping, DynamicDeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping tests if a specific instance of DynamicDeliveryAttributeMapping can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping(subject DynamicDeliveryAttributeMapping) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DynamicDeliveryAttributeMapping
	err := copied.AssignProperties_To_DynamicDeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DynamicDeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(DynamicDeliveryAttributeMapping_Type_Dynamic))
}

func Test_DynamicDeliveryAttributeMapping_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DynamicDeliveryAttributeMapping_STATUS to DynamicDeliveryAttributeMapping_STATUS via AssignProperties_To_DynamicDeliveryAttributeMapping_STATUS & AssignProperties_From_DynamicDeliveryAttributeMapping_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping_STATUS, DynamicDeliveryAttributeMapping_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping_STATUS tests if a specific instance of DynamicDeliveryAttributeMapping_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDynamicDeliveryAttributeMapping_STATUS(subject DynamicDeliveryAttributeMapping_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DynamicDeliveryAttributeMapping_STATUS
	err := copied.AssignProperties_To_DynamicDeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DynamicDeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping_STATUS(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["SourceField"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(DynamicDeliveryAttributeMapping_Type_STATUS_Dynamic))
}
...
func Test_EventSubscriptionIdentity_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from EventSubscriptionIdentity to EventSubscriptionIdentity via AssignProperties_To_EventSubscriptionIdentity & AssignProperties_From_EventSubscriptionIdentity returns original",
		prop.ForAll(RunPropertyAssignmentTestForEventSubscriptionIdentity, EventSubscriptionIdentityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForEventSubscriptionIdentity tests if a specific instance of EventSubscriptionIdentity can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForEventSubscriptionIdentity(subject EventSubscriptionIdentity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.EventSubscriptionIdentity
	err := copied.AssignProperties_To_EventSubscriptionIdentity(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_EventSubscriptionIdentity(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForEventSubscriptionIdentity(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(EventSubscriptionIdentity_Type_SystemAssigned, EventSubscriptionIdentity_Type_UserAssigned))
	gens["UserAssignedIdentity"] = gen.PtrOf(gen.AlphaString())
}

func Test_EventSubscriptionIdentity_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from EventSubscriptionIdentity_STATUS to EventSubscriptionIdentity_STATUS via AssignProperties_To_EventSubscriptionIdentity_STATUS & AssignProperties_From_EventSubscriptionIdentity_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForEventSubscriptionIdentity_STATUS, EventSubscriptionIdentity_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForEventSubscriptionIdentity_STATUS tests if a specific instance of EventSubscriptionIdentity_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForEventSubscriptionIdentity_STATUS(subject EventSubscriptionIdentity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.EventSubscriptionIdentity_STATUS
	err := copied.AssignProperties_To_EventSubscriptionIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_EventSubscriptionIdentity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IsNotNullAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IsNotNullAdvancedFilter to IsNotNullAdvancedFilter via AssignProperties_To_IsNotNullAdvancedFilter & AssignProperties_From_IsNotNullAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForIsNotNullAdvancedFilter, IsNotNullAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIsNotNullAdvancedFilter tests if a specific instance of IsNotNullAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIsNotNullAdvancedFilter(subject IsNotNullAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IsNotNullAdvancedFilter
	err := copied.AssignProperties_To_IsNotNullAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_IsNotNullAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(IsNotNullAdvancedFilter_OperatorType_IsNotNull))
}

func Test_IsNotNullAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IsNotNullAdvancedFilter_STATUS to IsNotNullAdvancedFilter_STATUS via AssignProperties_To_IsNotNullAdvancedFilter_STATUS & AssignProperties_From_IsNotNullAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForIsNotNullAdvancedFilter_STATUS, IsNotNullAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIsNotNullAdvancedFilter_STATUS tests if a specific instance of IsNotNullAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIsNotNullAdvancedFilter_STATUS(subject IsNotNullAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IsNotNullAdvancedFilter_STATUS
	err := copied.AssignProperties_To_IsNotNullAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_IsNotNullAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(IsNotNullAdvancedFilter_OperatorType_STATUS_IsNotNull))
}

func Test_IsNullOrUndefinedAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IsNullOrUndefinedAdvancedFilter to IsNullOrUndefinedAdvancedFilter via AssignProperties_To_IsNullOrUndefinedAdvancedFilter & AssignProperties_From_IsNullOrUndefinedAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter, IsNullOrUndefinedAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter tests if a specific instance of IsNullOrUndefinedAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter(subject IsNullOrUndefinedAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IsNullOrUndefinedAdvancedFilter
	err := copied.AssignProperties_To_IsNullOrUndefinedAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_IsNullOrUndefinedAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(IsNullOrUndefinedAdvancedFilter_OperatorType_IsNullOrUndefined))
}

func Test_IsNullOrUndefinedAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IsNullOrUndefinedAdvancedFilter_STATUS to IsNullOrUndefinedAdvancedFilter_STATUS via AssignProperties_To_IsNullOrUndefinedAdvancedFilter_STATUS & AssignProperties_From_IsNullOrUndefinedAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter_STATUS, IsNullOrUndefinedAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter_STATUS tests if a specific instance of IsNullOrUndefinedAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIsNullOrUndefinedAdvancedFilter_STATUS(subject IsNullOrUndefinedAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IsNullOrUndefinedAdvancedFilter_STATUS
	err := copied.AssignProperties_To_IsNullOrUndefinedAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_IsNullOrUndefinedAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(IsNullOrUndefinedAdvancedFilter_OperatorType_STATUS_IsNullOrUndefined))
}

func Test_MonitorAlertEventSubscriptionDestination_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from MonitorAlertEventSubscriptionDestination to MonitorAlertEventSubscriptionDestination via AssignProperties_To_MonitorAlertEventSubscriptionDestination & AssignProperties_From_MonitorAlertEventSubscriptionDestination returns original",
		prop.ForAll(RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination, MonitorAlertEventSubscriptionDestinationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination tests if a specific instance of MonitorAlertEventSubscriptionDestination can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination(subject MonitorAlertEventSubscriptionDestination) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.MonitorAlertEventSubscriptionDestination
	err := copied.AssignProperties_To_MonitorAlertEventSubscriptionDestination(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_MonitorAlertEventSubscriptionDestination(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(gens map[string]gopter.Gen) {
	...
	gens["EndpointType"] = gen.PtrOf(gen.OneConstOf(MonitorAlertEventSubscriptionDestination_EndpointType_MonitorAlert))
	gens["Severity"] = gen.PtrOf(gen.OneConstOf(
		MonitorAlertEventSubscriptionDestinationProperties_Severity_Sev0,
		MonitorAlertEventSubscriptionDestinationProperties_Severity_Sev1,
		MonitorAlertEventSubscriptionDestinationProperties_Severity_Sev2,
		MonitorAlertEventSubscriptionDestinationProperties_Severity_Sev3,
		MonitorAlertEventSubscriptionDestinationProperties_Severity_Sev4))
}

func Test_MonitorAlertEventSubscriptionDestination_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from MonitorAlertEventSubscriptionDestination_STATUS to MonitorAlertEventSubscriptionDestination_STATUS via AssignProperties_To_MonitorAlertEventSubscriptionDestination_STATUS & AssignProperties_From_MonitorAlertEventSubscriptionDestination_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination_STATUS, MonitorAlertEventSubscriptionDestination_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination_STATUS tests if a specific instance of MonitorAlertEventSubscriptionDestination_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMonitorAlertEventSubscriptionDestination_STATUS(subject MonitorAlertEventSubscriptionDestination_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.MonitorAlertEventSubscriptionDestination_STATUS
	err := copied.AssignProperties_To_MonitorAlertEventSubscriptionDestination_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_MonitorAlertEventSubscriptionDestination_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Description"] = gen.PtrOf(gen.AlphaString())
	gens["EndpointType"] = gen.PtrOf(gen.OneConstOf(MonitorAlertEventSubscriptionDestination_EndpointType_STATUS_MonitorAlert))
	gens["Severity"] = gen.PtrOf(gen.OneConstOf(
...
func Test_NamespaceTopicEventSubscriptionDestination_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NamespaceTopicEventSubscriptionDestination to NamespaceTopicEventSubscriptionDestination via AssignProperties_To_NamespaceTopicEventSubscriptionDestination & AssignProperties_From_NamespaceTopicEventSubscriptionDestination returns original",
		prop.ForAll(RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination, NamespaceTopicEventSubscriptionDestinationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination tests if a specific instance of NamespaceTopicEventSubscriptionDestination can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination(subject NamespaceTopicEventSubscriptionDestination) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NamespaceTopicEventSubscriptionDestination
	err := copied.AssignProperties_To_NamespaceTopicEventSubscriptionDestination(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NamespaceTopicEventSubscriptionDestination(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["EndpointType"] = gen.PtrOf(gen.OneConstOf(NamespaceTopicEventSubscriptionDestination_EndpointType_NamespaceTopic))
}

func Test_NamespaceTopicEventSubscriptionDestination_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NamespaceTopicEventSubscriptionDestination_STATUS to NamespaceTopicEventSubscriptionDestination_STATUS via AssignProperties_To_NamespaceTopicEventSubscriptionDestination_STATUS & AssignProperties_From_NamespaceTopicEventSubscriptionDestination_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination_STATUS, NamespaceTopicEventSubscriptionDestination_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination_STATUS tests if a specific instance of NamespaceTopicEventSubscriptionDestination_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNamespaceTopicEventSubscriptionDestination_STATUS(subject NamespaceTopicEventSubscriptionDestination_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NamespaceTopicEventSubscriptionDestination_STATUS
	err := copied.AssignProperties_To_NamespaceTopicEventSubscriptionDestination_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NamespaceTopicEventSubscriptionDestination_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination_STATUS(gens map[string]gopter.Gen) {
	gens["EndpointType"] = gen.PtrOf(gen.OneConstOf(NamespaceTopicEventSubscriptionDestination_EndpointType_STATUS_NamespaceTopic))
	gens["ResourceId"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_NumberInRangeAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NumberInRangeAdvancedFilter to NumberInRangeAdvancedFilter via AssignProperties_To_NumberInRangeAdvancedFilter & AssignProperties_From_NumberInRangeAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForNumberInRangeAdvancedFilter, NumberInRangeAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNumberInRangeAdvancedFilter tests if a specific instance of NumberInRangeAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNumberInRangeAdvancedFilter(subject NumberInRangeAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NumberInRangeAdvancedFilter
	err := copied.AssignProperties_To_NumberInRangeAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NumberInRangeAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(NumberInRangeAdvancedFilter_OperatorType_NumberInRange))
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}

func Test_NumberInRangeAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NumberInRangeAdvancedFilter_STATUS to NumberInRangeAdvancedFilter_STATUS via AssignProperties_To_NumberInRangeAdvancedFilter_STATUS & AssignProperties_From_NumberInRangeAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForNumberInRangeAdvancedFilter_STATUS, NumberInRangeAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNumberInRangeAdvancedFilter_STATUS tests if a specific instance of NumberInRangeAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNumberInRangeAdvancedFilter_STATUS(subject NumberInRangeAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NumberInRangeAdvancedFilter_STATUS
	err := copied.AssignProperties_To_NumberInRangeAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NumberInRangeAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(NumberInRangeAdvancedFilter_OperatorType_STATUS_NumberInRange))
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}
...
func Test_NumberNotInRangeAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NumberNotInRangeAdvancedFilter to NumberNotInRangeAdvancedFilter via AssignProperties_To_NumberNotInRangeAdvancedFilter & AssignProperties_From_NumberNotInRangeAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter, NumberNotInRangeAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter tests if a specific instance of NumberNotInRangeAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter(subject NumberNotInRangeAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NumberNotInRangeAdvancedFilter
	err := copied.AssignProperties_To_NumberNotInRangeAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NumberNotInRangeAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(NumberNotInRangeAdvancedFilter_OperatorType_NumberNotInRange))
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}

func Test_NumberNotInRangeAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NumberNotInRangeAdvancedFilter_STATUS to NumberNotInRangeAdvancedFilter_STATUS via AssignProperties_To_NumberNotInRangeAdvancedFilter_STATUS & AssignProperties_From_NumberNotInRangeAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter_STATUS, NumberNotInRangeAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter_STATUS tests if a specific instance of NumberNotInRangeAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNumberNotInRangeAdvancedFilter_STATUS(subject NumberNotInRangeAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NumberNotInRangeAdvancedFilter_STATUS
	err := copied.AssignProperties_To_NumberNotInRangeAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NumberNotInRangeAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(NumberNotInRangeAdvancedFilter_OperatorType_STATUS_NumberNotInRange))
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}
...
func Test_StaticDeliveryAttributeMapping_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StaticDeliveryAttributeMapping to StaticDeliveryAttributeMapping via AssignProperties_To_StaticDeliveryAttributeMapping & AssignProperties_From_StaticDeliveryAttributeMapping returns original",
		prop.ForAll(RunPropertyAssignmentTestForStaticDeliveryAttributeMapping, StaticDeliveryAttributeMappingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStaticDeliveryAttributeMapping tests if a specific instance of StaticDeliveryAttributeMapping can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStaticDeliveryAttributeMapping(subject StaticDeliveryAttributeMapping) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StaticDeliveryAttributeMapping
	err := copied.AssignProperties_To_StaticDeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StaticDeliveryAttributeMapping(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(StaticDeliveryAttributeMapping_Type_Static))
	gens["Value"] = gen.PtrOf(gen.AlphaString())
}

func Test_StaticDeliveryAttributeMapping_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StaticDeliveryAttributeMapping_STATUS to StaticDeliveryAttributeMapping_STATUS via AssignProperties_To_StaticDeliveryAttributeMapping_STATUS & AssignProperties_From_StaticDeliveryAttributeMapping_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForStaticDeliveryAttributeMapping_STATUS, StaticDeliveryAttributeMapping_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStaticDeliveryAttributeMapping_STATUS tests if a specific instance of StaticDeliveryAttributeMapping_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStaticDeliveryAttributeMapping_STATUS(subject StaticDeliveryAttributeMapping_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StaticDeliveryAttributeMapping_STATUS
	err := copied.AssignProperties_To_StaticDeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StaticDeliveryAttributeMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping_STATUS(gens map[string]gopter.Gen) {
	gens["IsSecret"] = gen.PtrOf(gen.Bool())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(StaticDeliveryAttributeMapping_Type_STATUS_Static))
	gens["Value"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_StringNotBeginsWithAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotBeginsWithAdvancedFilter to StringNotBeginsWithAdvancedFilter via AssignProperties_To_StringNotBeginsWithAdvancedFilter & AssignProperties_From_StringNotBeginsWithAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter, StringNotBeginsWithAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter tests if a specific instance of StringNotBeginsWithAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter(subject StringNotBeginsWithAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotBeginsWithAdvancedFilter
	err := copied.AssignProperties_To_StringNotBeginsWithAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotBeginsWithAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotBeginsWithAdvancedFilter_OperatorType_StringNotBeginsWith))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}

func Test_StringNotBeginsWithAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotBeginsWithAdvancedFilter_STATUS to StringNotBeginsWithAdvancedFilter_STATUS via AssignProperties_To_StringNotBeginsWithAdvancedFilter_STATUS & AssignProperties_From_StringNotBeginsWithAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter_STATUS, StringNotBeginsWithAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter_STATUS tests if a specific instance of StringNotBeginsWithAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotBeginsWithAdvancedFilter_STATUS(subject StringNotBeginsWithAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotBeginsWithAdvancedFilter_STATUS
	err := copied.AssignProperties_To_StringNotBeginsWithAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotBeginsWithAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotBeginsWithAdvancedFilter_OperatorType_STATUS_StringNotBeginsWith))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}

func Test_StringNotContainsAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotContainsAdvancedFilter to StringNotContainsAdvancedFilter via AssignProperties_To_StringNotContainsAdvancedFilter & AssignProperties_From_StringNotContainsAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotContainsAdvancedFilter, StringNotContainsAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotContainsAdvancedFilter tests if a specific instance of StringNotContainsAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotContainsAdvancedFilter(subject StringNotContainsAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotContainsAdvancedFilter
	err := copied.AssignProperties_To_StringNotContainsAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotContainsAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotContainsAdvancedFilter_OperatorType_StringNotContains))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}

func Test_StringNotContainsAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotContainsAdvancedFilter_STATUS to StringNotContainsAdvancedFilter_STATUS via AssignProperties_To_StringNotContainsAdvancedFilter_STATUS & AssignProperties_From_StringNotContainsAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotContainsAdvancedFilter_STATUS, StringNotContainsAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotContainsAdvancedFilter_STATUS tests if a specific instance of StringNotContainsAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotContainsAdvancedFilter_STATUS(subject StringNotContainsAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotContainsAdvancedFilter_STATUS
	err := copied.AssignProperties_To_StringNotContainsAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotContainsAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotContainsAdvancedFilter_OperatorType_STATUS_StringNotContains))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}

func Test_StringNotEndsWithAdvancedFilter_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotEndsWithAdvancedFilter to StringNotEndsWithAdvancedFilter via AssignProperties_To_StringNotEndsWithAdvancedFilter & AssignProperties_From_StringNotEndsWithAdvancedFilter returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter, StringNotEndsWithAdvancedFilterGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter tests if a specific instance of StringNotEndsWithAdvancedFilter can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter(subject StringNotEndsWithAdvancedFilter) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotEndsWithAdvancedFilter
	err := copied.AssignProperties_To_StringNotEndsWithAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotEndsWithAdvancedFilter(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotEndsWithAdvancedFilter_OperatorType_StringNotEndsWith))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}

func Test_StringNotEndsWithAdvancedFilter_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from StringNotEndsWithAdvancedFilter_STATUS to StringNotEndsWithAdvancedFilter_STATUS via AssignProperties_To_StringNotEndsWithAdvancedFilter_STATUS & AssignProperties_From_StringNotEndsWithAdvancedFilter_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter_STATUS, StringNotEndsWithAdvancedFilter_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter_STATUS tests if a specific instance of StringNotEndsWithAdvancedFilter_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForStringNotEndsWithAdvancedFilter_STATUS(subject StringNotEndsWithAdvancedFilter_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.StringNotEndsWithAdvancedFilter_STATUS
	err := copied.AssignProperties_To_StringNotEndsWithAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_StringNotEndsWithAdvancedFilter_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter_STATUS(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.PtrOf(gen.OneConstOf(StringNotEndsWithAdvancedFilter_OperatorType_STATUS_StringNotEndsWith))
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForWebHookEventSubscriptionDestination(gens map[string]gopter.Gen) {
	...
	gens["MaxEventsPerBatch"] = gen.PtrOf(gen.Int())
	gens["MinimumTlsVersionAllowed"] = gen.PtrOf(gen.OneConstOf(WebHookEventSubscriptionDestinationProperties_MinimumTlsVersionAllowed_10, WebHookEventSubscriptionDestinationProperties_MinimumTlsVersionAllowed_11, WebHookEventSubscriptionDestinationProperties_MinimumTlsVersionAllowed_12))
	gens["PreferredBatchSizeInKilobytes"] = gen.PtrOf(gen.Int())
}
