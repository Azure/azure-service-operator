...
func (domain *Domain) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected eventgrid/v20250215/storage/Domain but received %T instead", hub)
	}
...
func (domain *Domain_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if domain.Identity != nil {
		identity_ARM, err := domain.Identity.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
	...
	if domain.AutoCreateTopicWithFirstSubscription != nil ||
		domain.AutoDeleteTopicWithLastSubscription != nil ||
		domain.DataResidencyBoundary != nil ||
		domain.DisableLocalAuth != nil ||
		domain.EventTypeInfo != nil ||
		domain.InboundIpRules != nil ||
		domain.InputSchema != nil ||
		domain.InputSchemaMapping != nil ||
		domain.MinimumTlsVersionAllowed != nil ||
	...
	if domain.AutoCreateTopicWithFirstSubscription != nil {
		...
		result.Properties.AutoCreateTopicWithFirstSubscription = &autoCreateTopicWithFirstSubscription
	}
	if domain.AutoDeleteTopicWithLastSubscription != nil {
		autoDeleteTopicWithLastSubscription := *domain.AutoDeleteTopicWithLastSubscription
		result.Properties.AutoDeleteTopicWithLastSubscription = &autoDeleteTopicWithLastSubscription
	}
	if domain.DataResidencyBoundary != nil {
		var temp string
		temp = string(*domain.DataResidencyBoundary)
		dataResidencyBoundary := arm.DomainProperties_DataResidencyBoundary(temp)
		result.Properties.DataResidencyBoundary = &dataResidencyBoundary
	}
	if domain.DisableLocalAuth != nil {
		disableLocalAuth := *domain.DisableLocalAuth
		result.Properties.DisableLocalAuth = &disableLocalAuth
	}
	if domain.EventTypeInfo != nil {
		eventTypeInfo_ARM, err := domain.EventTypeInfo.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
	...
	if domain.MinimumTlsVersionAllowed != nil {
		var temp string
		temp = string(*domain.MinimumTlsVersionAllowed)
		minimumTlsVersionAllowed := arm.DomainProperties_MinimumTlsVersionAllowed(temp)
...
func (domain *Domain_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "AutoCreateTopicWithFirstSubscription":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.AutoCreateTopicWithFirstSubscription != nil {
			autoCreateTopicWithFirstSubscription := *typedInput.Properties.AutoCreateTopicWithFirstSubscription
			domain.AutoCreateTopicWithFirstSubscription = &autoCreateTopicWithFirstSubscription
		}
	}

	// Set property "AutoDeleteTopicWithLastSubscription":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.AutoDeleteTopicWithLastSubscription != nil {
			autoDeleteTopicWithLastSubscription := *typedInput.Properties.AutoDeleteTopicWithLastSubscription
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DataResidencyBoundary != nil {
			...
			dataResidencyBoundary := DomainProperties_DataResidencyBoundary(temp)
			domain.DataResidencyBoundary = &dataResidencyBoundary
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.EventTypeInfo != nil {
			...
			domain.EventTypeInfo = &eventTypeInfo
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersionAllowed != nil {
			...
			minimumTlsVersionAllowed := DomainProperties_MinimumTlsVersionAllowed(temp)
			domain.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
		}
	}
...
func (domain *Domain_Spec) AssignProperties_From_Domain_Spec(source *storage.Domain_Spec) error {
	...
	if source.AutoCreateTopicWithFirstSubscription != nil {
		autoCreateTopicWithFirstSubscription := *source.AutoCreateTopicWithFirstSubscription
		domain.AutoCreateTopicWithFirstSubscription = &autoCreateTopicWithFirstSubscription
	} else {
		domain.AutoCreateTopicWithFirstSubscription = nil
	}

	// AutoDeleteTopicWithLastSubscription
	if source.AutoDeleteTopicWithLastSubscription != nil {
		autoDeleteTopicWithLastSubscription := *source.AutoDeleteTopicWithLastSubscription
		domain.AutoDeleteTopicWithLastSubscription = &autoDeleteTopicWithLastSubscription
	} else {
		domain.AutoDeleteTopicWithLastSubscription = nil
	}
	...
	if source.DataResidencyBoundary != nil {
		...
		dataResidencyBoundaryTemp := genruntime.ToEnum(dataResidencyBoundary, domainProperties_DataResidencyBoundary_Values)
		domain.DataResidencyBoundary = &dataResidencyBoundaryTemp
	} else {
		domain.DataResidencyBoundary = nil
	}
	...
	if source.MinimumTlsVersionAllowed != nil {
		...
		minimumTlsVersionAllowedTemp := genruntime.ToEnum(minimumTlsVersionAllowed, domainProperties_MinimumTlsVersionAllowed_Values)
		domain.MinimumTlsVersionAllowed = &minimumTlsVersionAllowedTemp
	} else {
		domain.MinimumTlsVersionAllowed = nil
	}
...
func (domain *Domain_Spec) AssignProperties_To_Domain_Spec(destination *storage.Domain_Spec) error {
	...
	if domain.AutoCreateTopicWithFirstSubscription != nil {
		autoCreateTopicWithFirstSubscription := *domain.AutoCreateTopicWithFirstSubscription
		destination.AutoCreateTopicWithFirstSubscription = &autoCreateTopicWithFirstSubscription
	} else {
		destination.AutoCreateTopicWithFirstSubscription = nil
	}

	// AutoDeleteTopicWithLastSubscription
	if domain.AutoDeleteTopicWithLastSubscription != nil {
		autoDeleteTopicWithLastSubscription := *domain.AutoDeleteTopicWithLastSubscription
		destination.AutoDeleteTopicWithLastSubscription = &autoDeleteTopicWithLastSubscription
	} else {
		destination.AutoDeleteTopicWithLastSubscription = nil
	}
	...
	// DataResidencyBoundary
	if domain.DataResidencyBoundary != nil {
		dataResidencyBoundary := string(*domain.DataResidencyBoundary)
	...
	if domain.EventTypeInfo != nil {
		...
		err := domain.EventTypeInfo.AssignProperties_To_EventTypeInfo(&eventTypeInfo)
		if err != nil {
	...
	if domain.Identity != nil {
		...
		err := domain.Identity.AssignProperties_To_IdentityInfo(&identity)
		if err != nil {
	...
	// MinimumTlsVersionAllowed
	if domain.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := string(*domain.MinimumTlsVersionAllowed)
...
func (domain *Domain_Spec) Initialize_From_Domain_STATUS(source *Domain_STATUS) error {
	...
	// DataResidencyBoundary
	if source.DataResidencyBoundary != nil {
		dataResidencyBoundary := genruntime.ToEnum(string(*source.DataResidencyBoundary), domainProperties_DataResidencyBoundary_Values)
		domain.DataResidencyBoundary = &dataResidencyBoundary
	} else {
		domain.DataResidencyBoundary = nil
	}
	...
	// MinimumTlsVersionAllowed
	if source.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := genruntime.ToEnum(string(*source.MinimumTlsVersionAllowed), domainProperties_MinimumTlsVersionAllowed_Values)
		domain.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
	} else {
		domain.MinimumTlsVersionAllowed = nil
	}
...
func (domain *Domain_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DataResidencyBoundary != nil {
			var temp string
			temp = string(*typedInput.Properties.DataResidencyBoundary)
			dataResidencyBoundary := DomainProperties_DataResidencyBoundary_STATUS(temp)
			domain.DataResidencyBoundary = &dataResidencyBoundary
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersionAllowed != nil {
			var temp string
			temp = string(*typedInput.Properties.MinimumTlsVersionAllowed)
			minimumTlsVersionAllowed := DomainProperties_MinimumTlsVersionAllowed_STATUS(temp)
			domain.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
		}
	}
...
func (domain *Domain_STATUS) AssignProperties_From_Domain_STATUS(source *storage.Domain_STATUS) error {
	...
	if source.DataResidencyBoundary != nil {
		dataResidencyBoundary := *source.DataResidencyBoundary
		dataResidencyBoundaryTemp := genruntime.ToEnum(dataResidencyBoundary, domainProperties_DataResidencyBoundary_STATUS_Values)
		domain.DataResidencyBoundary = &dataResidencyBoundaryTemp
	} else {
		domain.DataResidencyBoundary = nil
	}
	...
	if source.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := *source.MinimumTlsVersionAllowed
		minimumTlsVersionAllowedTemp := genruntime.ToEnum(minimumTlsVersionAllowed, domainProperties_MinimumTlsVersionAllowed_STATUS_Values)
		domain.MinimumTlsVersionAllowed = &minimumTlsVersionAllowedTemp
	} else {
		domain.MinimumTlsVersionAllowed = nil
	}
...
func (domain *Domain_STATUS) AssignProperties_To_Domain_STATUS(destination *storage.Domain_STATUS) error {
	...
	if domain.EventTypeInfo != nil {
		...
		err := domain.EventTypeInfo.AssignProperties_To_EventTypeInfo_STATUS(&eventTypeInfo)
		if err != nil {
	...
	if domain.Identity != nil {
		...
		err := domain.Identity.AssignProperties_To_IdentityInfo_STATUS(&identity)
		if err != nil {
...
var _ genruntime.ARMTransformer = &EventTypeInfo{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (info *EventTypeInfo) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if info == nil {
		return nil, nil
	}
	result := &arm.EventTypeInfo{}

	// Set property "InlineEventTypes":
	if info.InlineEventTypes != nil {
		result.InlineEventTypes = make(map[string]arm.InlineEventProperties, len(info.InlineEventTypes))
		for key, value := range info.InlineEventTypes {
			value_ARM, err := value.ConvertToARM(resolved)
			if err != nil {
				return nil, err
			}
			result.InlineEventTypes[key] = *value_ARM.(*arm.InlineEventProperties)
		}
	}
	...
	if info.Kind != nil {
		var temp string
		temp = string(*info.Kind)
		kind := arm.EventTypeInfo_Kind(temp)
		result.Kind = &kind
	}
	return result, nil
}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *EventTypeInfo) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.EventTypeInfo{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *EventTypeInfo) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.EventTypeInfo)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.EventTypeInfo, got %T", armInput)
	}

	// Set property "InlineEventTypes":
	if typedInput.InlineEventTypes != nil {
		info.InlineEventTypes = make(map[string]InlineEventProperties, len(typedInput.InlineEventTypes))
		for key, value := range typedInput.InlineEventTypes {
			var value1 InlineEventProperties
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
				return err
			}
			info.InlineEventTypes[key] = value1
		}
	}
...
// AssignProperties_From_EventTypeInfo populates our EventTypeInfo from the provided source EventTypeInfo
func (info *EventTypeInfo) AssignProperties_From_EventTypeInfo(source *storage.EventTypeInfo) error {

	// InlineEventTypes
	if source.InlineEventTypes != nil {
		inlineEventTypeMap := make(map[string]InlineEventProperties, len(source.InlineEventTypes))
		for inlineEventTypeKey, inlineEventTypeValue := range source.InlineEventTypes {
			var inlineEventType InlineEventProperties
			err := inlineEventType.AssignProperties_From_InlineEventProperties(&inlineEventTypeValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_InlineEventProperties() to populate field InlineEventTypes")
			}
			inlineEventTypeMap[inlineEventTypeKey] = inlineEventType
		}
		info.InlineEventTypes = inlineEventTypeMap
	} else {
		info.InlineEventTypes = nil
	}

	// Kind
	if source.Kind != nil {
		kind := *source.Kind
		kindTemp := genruntime.ToEnum(kind, eventTypeInfo_Kind_Values)
		info.Kind = &kindTemp
	} else {
		info.Kind = nil
	}
...
// AssignProperties_To_EventTypeInfo populates the provided destination EventTypeInfo from our EventTypeInfo
func (info *EventTypeInfo) AssignProperties_To_EventTypeInfo(destination *storage.EventTypeInfo) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// InlineEventTypes
	if info.InlineEventTypes != nil {
		inlineEventTypeMap := make(map[string]storage.InlineEventProperties, len(info.InlineEventTypes))
		for inlineEventTypeKey, inlineEventTypeValue := range info.InlineEventTypes {
			var inlineEventType storage.InlineEventProperties
			err := inlineEventTypeValue.AssignProperties_To_InlineEventProperties(&inlineEventType)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_InlineEventProperties() to populate field InlineEventTypes")
			}
			inlineEventTypeMap[inlineEventTypeKey] = inlineEventType
		}
		destination.InlineEventTypes = inlineEventTypeMap
	} else {
		destination.InlineEventTypes = nil
	}
...
// Initialize_From_EventTypeInfo_STATUS populates our EventTypeInfo from the provided source EventTypeInfo_STATUS
func (info *EventTypeInfo) Initialize_From_EventTypeInfo_STATUS(source *EventTypeInfo_STATUS) error {
	...
	if source.InlineEventTypes != nil {
		...
		for inlineEventTypeKey, inlineEventTypeValue := range source.InlineEventTypes {
			var inlineEventType InlineEventProperties
			err := inlineEventType.Initialize_From_InlineEventProperties_STATUS(&inlineEventTypeValue)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_InlineEventProperties_STATUS() to populate field InlineEventTypes")
			}
			inlineEventTypeMap[inlineEventTypeKey] = inlineEventType
		}
		info.InlineEventTypes = inlineEventTypeMap
	...
	// Kind
	if source.Kind != nil {
		kind := genruntime.ToEnum(string(*source.Kind), eventTypeInfo_Kind_Values)
		info.Kind = &kind
	} else {
		info.Kind = nil
	}
...
var _ genruntime.FromARMConverter = &EventTypeInfo_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *EventTypeInfo_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.EventTypeInfo_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *EventTypeInfo_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.EventTypeInfo_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.EventTypeInfo_STATUS, got %T", armInput)
	}

	// Set property "InlineEventTypes":
	if typedInput.InlineEventTypes != nil {
		info.InlineEventTypes = make(map[string]InlineEventProperties_STATUS, len(typedInput.InlineEventTypes))
		for key, value := range typedInput.InlineEventTypes {
			var value1 InlineEventProperties_STATUS
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
				return err
			}
	...
	if typedInput.Kind != nil {
		var temp string
		temp = string(*typedInput.Kind)
		kind := EventTypeInfo_Kind_STATUS(temp)
		info.Kind = &kind
	}
...
// AssignProperties_From_EventTypeInfo_STATUS populates our EventTypeInfo_STATUS from the provided source EventTypeInfo_STATUS
func (info *EventTypeInfo_STATUS) AssignProperties_From_EventTypeInfo_STATUS(source *storage.EventTypeInfo_STATUS) error {

	// InlineEventTypes
	if source.InlineEventTypes != nil {
		inlineEventTypeMap := make(map[string]InlineEventProperties_STATUS, len(source.InlineEventTypes))
		for inlineEventTypeKey, inlineEventTypeValue := range source.InlineEventTypes {
			var inlineEventType InlineEventProperties_STATUS
			err := inlineEventType.AssignProperties_From_InlineEventProperties_STATUS(&inlineEventTypeValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_InlineEventProperties_STATUS() to populate field InlineEventTypes")
			}
			inlineEventTypeMap[inlineEventTypeKey] = inlineEventType
		}
		info.InlineEventTypes = inlineEventTypeMap
	...
	if source.Kind != nil {
		kind := *source.Kind
		kindTemp := genruntime.ToEnum(kind, eventTypeInfo_Kind_STATUS_Values)
		info.Kind = &kindTemp
	} else {
		info.Kind = nil
	}
...
// AssignProperties_To_EventTypeInfo_STATUS populates the provided destination EventTypeInfo_STATUS from our EventTypeInfo_STATUS
func (info *EventTypeInfo_STATUS) AssignProperties_To_EventTypeInfo_STATUS(destination *storage.EventTypeInfo_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// InlineEventTypes
	if info.InlineEventTypes != nil {
		inlineEventTypeMap := make(map[string]storage.InlineEventProperties_STATUS, len(info.InlineEventTypes))
		for inlineEventTypeKey, inlineEventTypeValue := range info.InlineEventTypes {
			var inlineEventType storage.InlineEventProperties_STATUS
			err := inlineEventTypeValue.AssignProperties_To_InlineEventProperties_STATUS(&inlineEventType)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_InlineEventProperties_STATUS() to populate field InlineEventTypes")
			}
			inlineEventTypeMap[inlineEventTypeKey] = inlineEventType
		}
		destination.InlineEventTypes = inlineEventTypeMap
...
var _ genruntime.ARMTransformer = &IdentityInfo{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (info *IdentityInfo) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if info == nil {
		return nil, nil
	}
	result := &arm.IdentityInfo{}

	// Set property "Type":
	if info.Type != nil {
		var temp string
		temp = string(*info.Type)
		typeVar := arm.IdentityInfo_Type(temp)
		result.Type = &typeVar
	}

	// Set property "UserAssignedIdentities":
	result.UserAssignedIdentities = make(map[string]arm.UserAssignedIdentityDetails, len(info.UserAssignedIdentities))
	for _, ident := range info.UserAssignedIdentities {
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *IdentityInfo) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IdentityInfo{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *IdentityInfo) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IdentityInfo)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IdentityInfo, got %T", armInput)
	}
	...
	if typedInput.Type != nil {
		...
		typeVar := IdentityInfo_Type(temp)
		info.Type = &typeVar
	}
...
// AssignProperties_From_IdentityInfo populates our IdentityInfo from the provided source IdentityInfo
func (info *IdentityInfo) AssignProperties_From_IdentityInfo(source *storage.IdentityInfo) error {

	// Type
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, identityInfo_Type_Values)
		info.Type = &typeTemp
	} else {
		info.Type = nil
	}
	...
	if source.UserAssignedIdentities != nil {
		...
		info.UserAssignedIdentities = userAssignedIdentityList
	} else {
		info.UserAssignedIdentities = nil
	}
...
// AssignProperties_To_IdentityInfo populates the provided destination IdentityInfo from our IdentityInfo
func (info *IdentityInfo) AssignProperties_To_IdentityInfo(destination *storage.IdentityInfo) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// UserAssignedIdentities
	if info.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]storage.UserAssignedIdentityDetails, len(info.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range info.UserAssignedIdentities {
...
// Initialize_From_IdentityInfo_STATUS populates our IdentityInfo from the provided source IdentityInfo_STATUS
func (info *IdentityInfo) Initialize_From_IdentityInfo_STATUS(source *IdentityInfo_STATUS) error {

	// Type
	if source.Type != nil {
		typeVar := genruntime.ToEnum(string(*source.Type), identityInfo_Type_Values)
		info.Type = &typeVar
	} else {
		info.Type = nil
	}
...
var _ genruntime.FromARMConverter = &IdentityInfo_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *IdentityInfo_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IdentityInfo_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *IdentityInfo_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IdentityInfo_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IdentityInfo_STATUS, got %T", armInput)
	}
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := IdentityInfo_Type_STATUS(temp)
		info.Type = &typeVar
	}

	// Set property "UserAssignedIdentities":
	if typedInput.UserAssignedIdentities != nil {
		info.UserAssignedIdentities = make(map[string]UserIdentityProperties_STATUS, len(typedInput.UserAssignedIdentities))
		for key, value := range typedInput.UserAssignedIdentities {
			...
			info.UserAssignedIdentities[key] = value1
		}
	}
...
// AssignProperties_From_IdentityInfo_STATUS populates our IdentityInfo_STATUS from the provided source IdentityInfo_STATUS
func (info *IdentityInfo_STATUS) AssignProperties_From_IdentityInfo_STATUS(source *storage.IdentityInfo_STATUS) error {

	// PrincipalId
	info.PrincipalId = genruntime.ClonePointerToString(source.PrincipalId)

	// TenantId
	info.TenantId = genruntime.ClonePointerToString(source.TenantId)

	// Type
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, identityInfo_Type_STATUS_Values)
		info.Type = &typeTemp
	} else {
		info.Type = nil
	}
	...
	if source.UserAssignedIdentities != nil {
		...
		info.UserAssignedIdentities = userAssignedIdentityMap
	} else {
		info.UserAssignedIdentities = nil
	}
...
// AssignProperties_To_IdentityInfo_STATUS populates the provided destination IdentityInfo_STATUS from our IdentityInfo_STATUS
func (info *IdentityInfo_STATUS) AssignProperties_To_IdentityInfo_STATUS(destination *storage.IdentityInfo_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// TenantId
	destination.TenantId = genruntime.ClonePointerToString(info.TenantId)
	...
	// UserAssignedIdentities
	if info.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]storage.UserIdentityProperties_STATUS, len(info.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range info.UserAssignedIdentities {
...
var _ genruntime.ARMTransformer = &InlineEventProperties{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (properties *InlineEventProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if properties == nil {
		return nil, nil
	}
	result := &arm.InlineEventProperties{}

	// Set property "DataSchemaUrl":
	if properties.DataSchemaUrl != nil {
		dataSchemaUrl := *properties.DataSchemaUrl
		result.DataSchemaUrl = &dataSchemaUrl
	}
	...
	// Set property "DocumentationUrl":
	if properties.DocumentationUrl != nil {
		documentationUrl := *properties.DocumentationUrl
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *InlineEventProperties) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.InlineEventProperties{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *InlineEventProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.InlineEventProperties)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.InlineEventProperties, got %T", armInput)
	}

	// Set property "DataSchemaUrl":
	if typedInput.DataSchemaUrl != nil {
		dataSchemaUrl := *typedInput.DataSchemaUrl
		properties.DataSchemaUrl = &dataSchemaUrl
	}
	...
	// Set property "DocumentationUrl":
	if typedInput.DocumentationUrl != nil {
		documentationUrl := *typedInput.DocumentationUrl
...
// AssignProperties_From_InlineEventProperties populates our InlineEventProperties from the provided source InlineEventProperties
func (properties *InlineEventProperties) AssignProperties_From_InlineEventProperties(source *storage.InlineEventProperties) error {

	// DataSchemaUrl
	properties.DataSchemaUrl = genruntime.ClonePointerToString(source.DataSchemaUrl)
	...
	// DocumentationUrl
	properties.DocumentationUrl = genruntime.ClonePointerToString(source.DocumentationUrl)

	// No error
	return nil
}

// AssignProperties_To_InlineEventProperties populates the provided destination InlineEventProperties from our InlineEventProperties
func (properties *InlineEventProperties) AssignProperties_To_InlineEventProperties(destination *storage.InlineEventProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DataSchemaUrl
	destination.DataSchemaUrl = genruntime.ClonePointerToString(properties.DataSchemaUrl)
	...
	// DocumentationUrl
	destination.DocumentationUrl = genruntime.ClonePointerToString(properties.DocumentationUrl)
...
// Initialize_From_InlineEventProperties_STATUS populates our InlineEventProperties from the provided source InlineEventProperties_STATUS
func (properties *InlineEventProperties) Initialize_From_InlineEventProperties_STATUS(source *InlineEventProperties_STATUS) error {
...
var _ genruntime.FromARMConverter = &InlineEventProperties_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *InlineEventProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.InlineEventProperties_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *InlineEventProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.InlineEventProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.InlineEventProperties_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_InlineEventProperties_STATUS populates our InlineEventProperties_STATUS from the provided source InlineEventProperties_STATUS
func (properties *InlineEventProperties_STATUS) AssignProperties_From_InlineEventProperties_STATUS(source *storage.InlineEventProperties_STATUS) error {
...
// AssignProperties_To_InlineEventProperties_STATUS populates the provided destination InlineEventProperties_STATUS from our InlineEventProperties_STATUS
func (properties *InlineEventProperties_STATUS) AssignProperties_To_InlineEventProperties_STATUS(destination *storage.InlineEventProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
