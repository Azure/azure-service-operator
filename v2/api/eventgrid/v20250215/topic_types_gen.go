...
func (topic *Topic) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected eventgrid/v20250215/storage/Topic but received %T instead", hub)
	}
...
func (topic *Topic_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if topic.Identity != nil {
		identity_ARM, err := topic.Identity.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
	...
	if topic.DataResidencyBoundary != nil ||
		topic.DisableLocalAuth != nil ||
		topic.EventTypeInfo != nil ||
		topic.InboundIpRules != nil ||
		topic.InputSchema != nil ||
		topic.InputSchemaMapping != nil ||
		topic.MinimumTlsVersionAllowed != nil ||
		topic.PublicNetworkAccess != nil {
		result.Properties = &arm.TopicProperties{}
	}
	if topic.DataResidencyBoundary != nil {
		var temp string
		temp = string(*topic.DataResidencyBoundary)
		dataResidencyBoundary := arm.TopicProperties_DataResidencyBoundary(temp)
		result.Properties.DataResidencyBoundary = &dataResidencyBoundary
	}
	if topic.DisableLocalAuth != nil {
		disableLocalAuth := *topic.DisableLocalAuth
		result.Properties.DisableLocalAuth = &disableLocalAuth
	}
	if topic.EventTypeInfo != nil {
		eventTypeInfo_ARM, err := topic.EventTypeInfo.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		eventTypeInfo := *eventTypeInfo_ARM.(*arm.EventTypeInfo)
		result.Properties.EventTypeInfo = &eventTypeInfo
	}
	...
	if topic.MinimumTlsVersionAllowed != nil {
		var temp string
		temp = string(*topic.MinimumTlsVersionAllowed)
		minimumTlsVersionAllowed := arm.TopicProperties_MinimumTlsVersionAllowed(temp)
...
func (topic *Topic_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DataResidencyBoundary":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DataResidencyBoundary != nil {
			var temp string
			temp = string(*typedInput.Properties.DataResidencyBoundary)
			dataResidencyBoundary := TopicProperties_DataResidencyBoundary(temp)
			topic.DataResidencyBoundary = &dataResidencyBoundary
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DisableLocalAuth != nil {
			...
			topic.DisableLocalAuth = &disableLocalAuth
		}
	}

	// Set property "EventTypeInfo":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.EventTypeInfo != nil {
			var eventTypeInfo1 EventTypeInfo
			err := eventTypeInfo1.PopulateFromARM(owner, *typedInput.Properties.EventTypeInfo)
			if err != nil {
				return err
			}
			eventTypeInfo := eventTypeInfo1
			topic.EventTypeInfo = &eventTypeInfo
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersionAllowed != nil {
			...
			minimumTlsVersionAllowed := TopicProperties_MinimumTlsVersionAllowed(temp)
			topic.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
		}
	}
...
func (topic *Topic_Spec) AssignProperties_From_Topic_Spec(source *storage.Topic_Spec) error {
	...
	if source.DataResidencyBoundary != nil {
		dataResidencyBoundary := *source.DataResidencyBoundary
		dataResidencyBoundaryTemp := genruntime.ToEnum(dataResidencyBoundary, topicProperties_DataResidencyBoundary_Values)
		topic.DataResidencyBoundary = &dataResidencyBoundaryTemp
	} else {
		topic.DataResidencyBoundary = nil
	}
	...
	// EventTypeInfo
	if source.EventTypeInfo != nil {
		var eventTypeInfo EventTypeInfo
		err := eventTypeInfo.AssignProperties_From_EventTypeInfo(source.EventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_EventTypeInfo() to populate field EventTypeInfo")
		}
		topic.EventTypeInfo = &eventTypeInfo
	} else {
		topic.EventTypeInfo = nil
	...
	if source.MinimumTlsVersionAllowed != nil {
		...
		minimumTlsVersionAllowedTemp := genruntime.ToEnum(minimumTlsVersionAllowed, topicProperties_MinimumTlsVersionAllowed_Values)
		topic.MinimumTlsVersionAllowed = &minimumTlsVersionAllowedTemp
	} else {
		topic.MinimumTlsVersionAllowed = nil
	}
...
func (topic *Topic_Spec) AssignProperties_To_Topic_Spec(destination *storage.Topic_Spec) error {
	...
	// DataResidencyBoundary
	if topic.DataResidencyBoundary != nil {
		dataResidencyBoundary := string(*topic.DataResidencyBoundary)
		destination.DataResidencyBoundary = &dataResidencyBoundary
	} else {
		destination.DataResidencyBoundary = nil
	}
	...
	// EventTypeInfo
	if topic.EventTypeInfo != nil {
		var eventTypeInfo storage.EventTypeInfo
		err := topic.EventTypeInfo.AssignProperties_To_EventTypeInfo(&eventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_EventTypeInfo() to populate field EventTypeInfo")
		}
		destination.EventTypeInfo = &eventTypeInfo
	} else {
		destination.EventTypeInfo = nil
	}

	// Identity
	if topic.Identity != nil {
		var identity storage.IdentityInfo
		err := topic.Identity.AssignProperties_To_IdentityInfo(&identity)
		if err != nil {
	...
	// MinimumTlsVersionAllowed
	if topic.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := string(*topic.MinimumTlsVersionAllowed)
...
func (topic *Topic_Spec) Initialize_From_Topic_STATUS(source *Topic_STATUS) error {
	...
	// DataResidencyBoundary
	if source.DataResidencyBoundary != nil {
		dataResidencyBoundary := genruntime.ToEnum(string(*source.DataResidencyBoundary), topicProperties_DataResidencyBoundary_Values)
		topic.DataResidencyBoundary = &dataResidencyBoundary
	} else {
		topic.DataResidencyBoundary = nil
	}
	...
	if source.EventTypeInfo != nil {
		var eventTypeInfo EventTypeInfo
		err := eventTypeInfo.Initialize_From_EventTypeInfo_STATUS(source.EventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_EventTypeInfo_STATUS() to populate field EventTypeInfo")
		}
		topic.EventTypeInfo = &eventTypeInfo
	} else {
		topic.EventTypeInfo = nil
	...
	// MinimumTlsVersionAllowed
	if source.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := genruntime.ToEnum(string(*source.MinimumTlsVersionAllowed), topicProperties_MinimumTlsVersionAllowed_Values)
		topic.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
	} else {
		topic.MinimumTlsVersionAllowed = nil
	}
...
func (topic *Topic_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DataResidencyBoundary != nil {
			var temp string
			temp = string(*typedInput.Properties.DataResidencyBoundary)
			dataResidencyBoundary := TopicProperties_DataResidencyBoundary_STATUS(temp)
			topic.DataResidencyBoundary = &dataResidencyBoundary
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.EventTypeInfo != nil {
			var eventTypeInfo1 EventTypeInfo_STATUS
			err := eventTypeInfo1.PopulateFromARM(owner, *typedInput.Properties.EventTypeInfo)
			if err != nil {
				return err
			}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersionAllowed != nil {
			var temp string
			temp = string(*typedInput.Properties.MinimumTlsVersionAllowed)
			minimumTlsVersionAllowed := TopicProperties_MinimumTlsVersionAllowed_STATUS(temp)
			topic.MinimumTlsVersionAllowed = &minimumTlsVersionAllowed
		}
	}
...
func (topic *Topic_STATUS) AssignProperties_From_Topic_STATUS(source *storage.Topic_STATUS) error {
	...
	if source.DataResidencyBoundary != nil {
		dataResidencyBoundary := *source.DataResidencyBoundary
		dataResidencyBoundaryTemp := genruntime.ToEnum(dataResidencyBoundary, topicProperties_DataResidencyBoundary_STATUS_Values)
		topic.DataResidencyBoundary = &dataResidencyBoundaryTemp
	} else {
		topic.DataResidencyBoundary = nil
	}
	...
	// EventTypeInfo
	if source.EventTypeInfo != nil {
		var eventTypeInfo EventTypeInfo_STATUS
		err := eventTypeInfo.AssignProperties_From_EventTypeInfo_STATUS(source.EventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_EventTypeInfo_STATUS() to populate field EventTypeInfo")
		}
		topic.EventTypeInfo = &eventTypeInfo
	} else {
		topic.EventTypeInfo = nil
	...
	if source.MinimumTlsVersionAllowed != nil {
		minimumTlsVersionAllowed := *source.MinimumTlsVersionAllowed
		minimumTlsVersionAllowedTemp := genruntime.ToEnum(minimumTlsVersionAllowed, topicProperties_MinimumTlsVersionAllowed_STATUS_Values)
		topic.MinimumTlsVersionAllowed = &minimumTlsVersionAllowedTemp
	} else {
		topic.MinimumTlsVersionAllowed = nil
	}
...
func (topic *Topic_STATUS) AssignProperties_To_Topic_STATUS(destination *storage.Topic_STATUS) error {
	...
	// EventTypeInfo
	if topic.EventTypeInfo != nil {
		var eventTypeInfo storage.EventTypeInfo_STATUS
		err := topic.EventTypeInfo.AssignProperties_To_EventTypeInfo_STATUS(&eventTypeInfo)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_EventTypeInfo_STATUS() to populate field EventTypeInfo")
		}
		destination.EventTypeInfo = &eventTypeInfo
	} else {
		destination.EventTypeInfo = nil
	...
	if topic.Identity != nil {
		...
		err := topic.Identity.AssignProperties_To_IdentityInfo_STATUS(&identity)
		if err != nil {
