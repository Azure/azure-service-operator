...
// We first initialize azureFunctionEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AzureFunctionEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAzureFunctionEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForAzureFunctionEventSubscriptionDestinationProperties(generators)
	azureFunctionEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(AzureFunctionEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForAzureFunctionEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAzureFunctionEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
...
// We first initialize dynamicDeliveryAttributeMappingGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DynamicDeliveryAttributeMappingGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping(generators)
	AddRelatedPropertyGeneratorsForDynamicDeliveryAttributeMapping(generators)
	dynamicDeliveryAttributeMappingGenerator = gen.Struct(reflect.TypeOf(DynamicDeliveryAttributeMapping{}), generators)
...
func AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.OneConstOf(DynamicDeliveryAttributeMapping_Type_Dynamic)
}

// AddRelatedPropertyGeneratorsForDynamicDeliveryAttributeMapping is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDynamicDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(DynamicDeliveryAttributeMappingPropertiesGenerator())
}

func Test_DynamicDeliveryAttributeMappingProperties_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DynamicDeliveryAttributeMappingProperties via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDynamicDeliveryAttributeMappingProperties, DynamicDeliveryAttributeMappingPropertiesGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDynamicDeliveryAttributeMappingProperties runs a test to see if a specific instance of DynamicDeliveryAttributeMappingProperties round trips to JSON and back losslessly
func RunJSONSerializationTestForDynamicDeliveryAttributeMappingProperties(subject DynamicDeliveryAttributeMappingProperties) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DynamicDeliveryAttributeMappingProperties
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DynamicDeliveryAttributeMappingProperties instances for property testing - lazily instantiated by
// DynamicDeliveryAttributeMappingPropertiesGenerator()
var dynamicDeliveryAttributeMappingPropertiesGenerator gopter.Gen

// DynamicDeliveryAttributeMappingPropertiesGenerator returns a generator of DynamicDeliveryAttributeMappingProperties instances for property testing.
func DynamicDeliveryAttributeMappingPropertiesGenerator() gopter.Gen {
	if dynamicDeliveryAttributeMappingPropertiesGenerator != nil {
		return dynamicDeliveryAttributeMappingPropertiesGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMappingProperties(generators)
	dynamicDeliveryAttributeMappingPropertiesGenerator = gen.Struct(reflect.TypeOf(DynamicDeliveryAttributeMappingProperties{}), generators)

	return dynamicDeliveryAttributeMappingPropertiesGenerator
}

// AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMappingProperties is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDynamicDeliveryAttributeMappingProperties(gens map[string]gopter.Gen) {
...
// We first initialize eventHubEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func EventHubEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForEventHubEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForEventHubEventSubscriptionDestinationProperties(generators)
	eventHubEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(EventHubEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForEventHubEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForEventHubEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
...
// We first initialize hybridConnectionEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func HybridConnectionEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForHybridConnectionEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForHybridConnectionEventSubscriptionDestinationProperties(generators)
	hybridConnectionEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(HybridConnectionEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForHybridConnectionEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForHybridConnectionEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
...
func AddIndependentPropertyGeneratorsForIsNotNullAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(IsNotNullAdvancedFilter_OperatorType_IsNotNull)
}
...
func AddIndependentPropertyGeneratorsForIsNullOrUndefinedAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(IsNullOrUndefinedAdvancedFilter_OperatorType_IsNullOrUndefined)
}
...
// We first initialize monitorAlertEventSubscriptionDestinationGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func MonitorAlertEventSubscriptionDestinationGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(generators)
	AddRelatedPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(generators)
	monitorAlertEventSubscriptionDestinationGenerator = gen.Struct(reflect.TypeOf(MonitorAlertEventSubscriptionDestination{}), generators)
...
func AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["EndpointType"] = gen.OneConstOf(MonitorAlertEventSubscriptionDestination_EndpointType_MonitorAlert)
}

// AddRelatedPropertyGeneratorsForMonitorAlertEventSubscriptionDestination is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForMonitorAlertEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(MonitorAlertEventSubscriptionDestinationPropertiesGenerator())
}

func Test_MonitorAlertEventSubscriptionDestinationProperties_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of MonitorAlertEventSubscriptionDestinationProperties via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMonitorAlertEventSubscriptionDestinationProperties, MonitorAlertEventSubscriptionDestinationPropertiesGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMonitorAlertEventSubscriptionDestinationProperties runs a test to see if a specific instance of MonitorAlertEventSubscriptionDestinationProperties round trips to JSON and back losslessly
func RunJSONSerializationTestForMonitorAlertEventSubscriptionDestinationProperties(subject MonitorAlertEventSubscriptionDestinationProperties) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual MonitorAlertEventSubscriptionDestinationProperties
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of MonitorAlertEventSubscriptionDestinationProperties instances for property testing - lazily instantiated
// by MonitorAlertEventSubscriptionDestinationPropertiesGenerator()
var monitorAlertEventSubscriptionDestinationPropertiesGenerator gopter.Gen

// MonitorAlertEventSubscriptionDestinationPropertiesGenerator returns a generator of MonitorAlertEventSubscriptionDestinationProperties instances for property testing.
func MonitorAlertEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	if monitorAlertEventSubscriptionDestinationPropertiesGenerator != nil {
		return monitorAlertEventSubscriptionDestinationPropertiesGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestinationProperties(generators)
	monitorAlertEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(MonitorAlertEventSubscriptionDestinationProperties{}), generators)

	return monitorAlertEventSubscriptionDestinationPropertiesGenerator
}

// AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMonitorAlertEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
...
// We first initialize namespaceTopicEventSubscriptionDestinationGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func NamespaceTopicEventSubscriptionDestinationGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(generators)
	AddRelatedPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(generators)
	namespaceTopicEventSubscriptionDestinationGenerator = gen.Struct(reflect.TypeOf(NamespaceTopicEventSubscriptionDestination{}), generators)
...
func AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["EndpointType"] = gen.OneConstOf(NamespaceTopicEventSubscriptionDestination_EndpointType_NamespaceTopic)
}

// AddRelatedPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForNamespaceTopicEventSubscriptionDestination(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(NamespaceTopicEventSubscriptionDestinationPropertiesGenerator())
}

func Test_NamespaceTopicEventSubscriptionDestinationProperties_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NamespaceTopicEventSubscriptionDestinationProperties via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestinationProperties, NamespaceTopicEventSubscriptionDestinationPropertiesGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestinationProperties runs a test to see if a specific instance of NamespaceTopicEventSubscriptionDestinationProperties round trips to JSON and back losslessly
func RunJSONSerializationTestForNamespaceTopicEventSubscriptionDestinationProperties(subject NamespaceTopicEventSubscriptionDestinationProperties) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NamespaceTopicEventSubscriptionDestinationProperties
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NamespaceTopicEventSubscriptionDestinationProperties instances for property testing - lazily
// instantiated by NamespaceTopicEventSubscriptionDestinationPropertiesGenerator()
var namespaceTopicEventSubscriptionDestinationPropertiesGenerator gopter.Gen

// NamespaceTopicEventSubscriptionDestinationPropertiesGenerator returns a generator of NamespaceTopicEventSubscriptionDestinationProperties instances for property testing.
func NamespaceTopicEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	if namespaceTopicEventSubscriptionDestinationPropertiesGenerator != nil {
		return namespaceTopicEventSubscriptionDestinationPropertiesGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestinationProperties(generators)
	namespaceTopicEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(NamespaceTopicEventSubscriptionDestinationProperties{}), generators)

	return namespaceTopicEventSubscriptionDestinationPropertiesGenerator
}

// AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNamespaceTopicEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["ResourceId"] = gen.PtrOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForNumberInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(NumberInRangeAdvancedFilter_OperatorType_NumberInRange)
...
func AddIndependentPropertyGeneratorsForNumberNotInRangeAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(NumberNotInRangeAdvancedFilter_OperatorType_NumberNotInRange)
	gens["Values"] = gen.SliceOf(gen.SliceOf(gen.Float64()))
}
...
// We first initialize serviceBusQueueEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServiceBusQueueEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServiceBusQueueEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForServiceBusQueueEventSubscriptionDestinationProperties(generators)
	serviceBusQueueEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(ServiceBusQueueEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForServiceBusQueueEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServiceBusQueueEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
...
// We first initialize serviceBusTopicEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServiceBusTopicEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServiceBusTopicEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForServiceBusTopicEventSubscriptionDestinationProperties(generators)
	serviceBusTopicEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(ServiceBusTopicEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForServiceBusTopicEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServiceBusTopicEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
...
// We first initialize staticDeliveryAttributeMappingGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StaticDeliveryAttributeMappingGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping(generators)
	AddRelatedPropertyGeneratorsForStaticDeliveryAttributeMapping(generators)
	staticDeliveryAttributeMappingGenerator = gen.Struct(reflect.TypeOf(StaticDeliveryAttributeMapping{}), generators)
...
func AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.OneConstOf(StaticDeliveryAttributeMapping_Type_Static)
}

// AddRelatedPropertyGeneratorsForStaticDeliveryAttributeMapping is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStaticDeliveryAttributeMapping(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(StaticDeliveryAttributeMappingPropertiesGenerator())
}

func Test_StaticDeliveryAttributeMappingProperties_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StaticDeliveryAttributeMappingProperties via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStaticDeliveryAttributeMappingProperties, StaticDeliveryAttributeMappingPropertiesGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStaticDeliveryAttributeMappingProperties runs a test to see if a specific instance of StaticDeliveryAttributeMappingProperties round trips to JSON and back losslessly
func RunJSONSerializationTestForStaticDeliveryAttributeMappingProperties(subject StaticDeliveryAttributeMappingProperties) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StaticDeliveryAttributeMappingProperties
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StaticDeliveryAttributeMappingProperties instances for property testing - lazily instantiated by
// StaticDeliveryAttributeMappingPropertiesGenerator()
var staticDeliveryAttributeMappingPropertiesGenerator gopter.Gen

// StaticDeliveryAttributeMappingPropertiesGenerator returns a generator of StaticDeliveryAttributeMappingProperties instances for property testing.
func StaticDeliveryAttributeMappingPropertiesGenerator() gopter.Gen {
	if staticDeliveryAttributeMappingPropertiesGenerator != nil {
		return staticDeliveryAttributeMappingPropertiesGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMappingProperties(generators)
	staticDeliveryAttributeMappingPropertiesGenerator = gen.Struct(reflect.TypeOf(StaticDeliveryAttributeMappingProperties{}), generators)

	return staticDeliveryAttributeMappingPropertiesGenerator
}

// AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMappingProperties is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStaticDeliveryAttributeMappingProperties(gens map[string]gopter.Gen) {
...
func AddIndependentPropertyGeneratorsForStringNotBeginsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(StringNotBeginsWithAdvancedFilter_OperatorType_StringNotBeginsWith)
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForStringNotContainsAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(StringNotContainsAdvancedFilter_OperatorType_StringNotContains)
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForStringNotEndsWithAdvancedFilter(gens map[string]gopter.Gen) {
	gens["Key"] = gen.PtrOf(gen.AlphaString())
	gens["OperatorType"] = gen.OneConstOf(StringNotEndsWithAdvancedFilter_OperatorType_StringNotEndsWith)
	gens["Values"] = gen.SliceOf(gen.AlphaString())
}
...
// We first initialize webHookEventSubscriptionDestinationPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func WebHookEventSubscriptionDestinationPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForWebHookEventSubscriptionDestinationProperties(generators)
	AddRelatedPropertyGeneratorsForWebHookEventSubscriptionDestinationProperties(generators)
	webHookEventSubscriptionDestinationPropertiesGenerator = gen.Struct(reflect.TypeOf(WebHookEventSubscriptionDestinationProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForWebHookEventSubscriptionDestinationProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForWebHookEventSubscriptionDestinationProperties(gens map[string]gopter.Gen) {
	gens["DeliveryAttributeMappings"] = gen.SliceOf(DeliveryAttributeMappingGenerator())
}
