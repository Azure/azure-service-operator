...
func AddIndependentPropertyGeneratorsForTopic_STATUS(gens map[string]gopter.Gen) {
	gens["DataResidencyBoundary"] = gen.PtrOf(gen.OneConstOf(TopicProperties_DataResidencyBoundary_STATUS_WithinGeopair, TopicProperties_DataResidencyBoundary_STATUS_WithinRegion))
	...
	gens["MinimumTlsVersionAllowed"] = gen.PtrOf(gen.OneConstOf(TopicProperties_MinimumTlsVersionAllowed_STATUS_10, TopicProperties_MinimumTlsVersionAllowed_STATUS_11, TopicProperties_MinimumTlsVersionAllowed_STATUS_12))
...
func AddIndependentPropertyGeneratorsForTopic_Spec(gens map[string]gopter.Gen) {
	...
	gens["DataResidencyBoundary"] = gen.PtrOf(gen.OneConstOf(TopicProperties_DataResidencyBoundary_WithinGeopair, TopicProperties_DataResidencyBoundary_WithinRegion))
	gens["DisableLocalAuth"] = gen.PtrOf(gen.Bool())
	...
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["MinimumTlsVersionAllowed"] = gen.PtrOf(gen.OneConstOf(TopicProperties_MinimumTlsVersionAllowed_10, TopicProperties_MinimumTlsVersionAllowed_11, TopicProperties_MinimumTlsVersionAllowed_12))
