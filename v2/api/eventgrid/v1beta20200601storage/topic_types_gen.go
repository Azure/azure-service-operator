...
func (topic *Topic) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20200601s.Topic)
	if !ok {
...
func (topic *Topic) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20200601s.Topic)
	if !ok {
		return fmt.Errorf("expected eventgrid/v1api20200601storage/Topic but received %T instead", hub)
	}
...
func (topic *Topic) AssignProperties_From_Topic(source *v1api20200601s.Topic) error {
...
func (topic *Topic) AssignProperties_To_Topic(destination *v1api20200601s.Topic) error {

	// ObjectMeta
	destination.ObjectMeta = *topic.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20200601s.Topic_Spec
	...
	// Status
	var status v1api20200601s.Topic_STATUS
...
type augmentConversionForTopic interface {
	AssignPropertiesFrom(src *v1api20200601s.Topic) error
	AssignPropertiesTo(dst *v1api20200601s.Topic) error
}
...
func (topic *Topic_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20200601s.Topic_Spec)
	if ok {
...
func (topic *Topic_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20200601s.Topic_Spec)
	if ok {
...
func (topic *Topic_Spec) AssignProperties_From_Topic_Spec(source *v1api20200601s.Topic_Spec) error {
...
func (topic *Topic_Spec) AssignProperties_To_Topic_Spec(destination *v1api20200601s.Topic_Spec) error {
	// Clone the existing property bag
	...
	if topic.InboundIpRules != nil {
		inboundIpRuleList := make([]v1api20200601s.InboundIpRule, len(topic.InboundIpRules))
...
func (topic *Topic_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20200601s.Topic_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20200601s.Topic_STATUS{}
...
func (topic *Topic_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20200601s.Topic_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20200601s.Topic_STATUS{}
...
func (topic *Topic_STATUS) AssignProperties_From_Topic_STATUS(source *v1api20200601s.Topic_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (topic *Topic_STATUS) AssignProperties_To_Topic_STATUS(destination *v1api20200601s.Topic_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(topic.PropertyBag)
	...
	// InboundIpRules
	if topic.InboundIpRules != nil {
		inboundIpRuleList := make([]v1api20200601s.InboundIpRule_STATUS, len(topic.InboundIpRules))
		for inboundIpRuleIndex, inboundIpRuleItem := range topic.InboundIpRules {
			// Shadow the loop variable to avoid aliasing
			inboundIpRuleItem := inboundIpRuleItem
	...
	if topic.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded, len(topic.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range topic.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded
...
type augmentConversionForTopic_Spec interface {
	AssignPropertiesFrom(src *v1api20200601s.Topic_Spec) error
	AssignPropertiesTo(dst *v1api20200601s.Topic_Spec) error
}

type augmentConversionForTopic_STATUS interface {
	AssignPropertiesFrom(src *v1api20200601s.Topic_STATUS) error
	AssignPropertiesTo(dst *v1api20200601s.Topic_STATUS) error
}
...
func (embedded *PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) AssignProperties_From_PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded(source *v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (embedded *PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) AssignProperties_To_PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded(destination *v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) error {
	// Clone the existing property bag
...
type augmentConversionForPrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20200601s.PrivateEndpointConnection_STATUS_Topic_SubResourceEmbedded) error
}
