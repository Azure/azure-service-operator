...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Domains_Topic_STATUSARM) DeepCopyInto(out *Domains_Topic_STATUSARM) {
	*out = *in
	if in.Id != nil {
		in, out := &in.Id, &out.Id
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Domains_Topic_STATUSARM.
func (in *Domains_Topic_STATUSARM) DeepCopy() *Domains_Topic_STATUSARM {
	if in == nil {
		return nil
	}
	out := new(Domains_Topic_STATUSARM)
	in.DeepCopyInto(out)
	return out
}
