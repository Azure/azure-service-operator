...
const (
	ConfigurationStoreProperties_CreateMode_Default_STATUS = ConfigurationStoreProperties_CreateMode_STATUS("Default")
	ConfigurationStoreProperties_CreateMode_Recover_STATUS = ConfigurationStoreProperties_CreateMode_STATUS("Recover")
)

type ConfigurationStoreProperties_ProvisioningState_STATUS string

const (
	ConfigurationStoreProperties_ProvisioningState_Canceled_STATUS  = ConfigurationStoreProperties_ProvisioningState_STATUS("Canceled")
	ConfigurationStoreProperties_ProvisioningState_Creating_STATUS  = ConfigurationStoreProperties_ProvisioningState_STATUS("Creating")
	ConfigurationStoreProperties_ProvisioningState_Deleting_STATUS  = ConfigurationStoreProperties_ProvisioningState_STATUS("Deleting")
	ConfigurationStoreProperties_ProvisioningState_Failed_STATUS    = ConfigurationStoreProperties_ProvisioningState_STATUS("Failed")
	ConfigurationStoreProperties_ProvisioningState_Succeeded_STATUS = ConfigurationStoreProperties_ProvisioningState_STATUS("Succeeded")
	ConfigurationStoreProperties_ProvisioningState_Updating_STATUS  = ConfigurationStoreProperties_ProvisioningState_STATUS("Updating")
)
...
const (
	ConfigurationStoreProperties_PublicNetworkAccess_Disabled_STATUS = ConfigurationStoreProperties_PublicNetworkAccess_STATUS("Disabled")
	ConfigurationStoreProperties_PublicNetworkAccess_Enabled_STATUS  = ConfigurationStoreProperties_PublicNetworkAccess_STATUS("Enabled")
)
