...
func (store *ConfigurationStore_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if store.CreateMode != nil ||
		store.DataPlaneProxy != nil ||
		store.DefaultKeyValueRevisionRetentionPeriodInSeconds != nil ||
	...
	if store.DataPlaneProxy != nil {
		dataPlaneProxy_ARM, err := store.DataPlaneProxy.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		dataPlaneProxy := *dataPlaneProxy_ARM.(*arm.DataPlaneProxyProperties)
		result.Properties.DataPlaneProxy = &dataPlaneProxy
	}
	if store.DefaultKeyValueRevisionRetentionPeriodInSeconds != nil {
		defaultKeyValueRevisionRetentionPeriodInSeconds := *store.DefaultKeyValueRevisionRetentionPeriodInSeconds
		result.Properties.DefaultKeyValueRevisionRetentionPeriodInSeconds = &defaultKeyValueRevisionRetentionPeriodInSeconds
	}
...
func (store *ConfigurationStore_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DataPlaneProxy":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DataPlaneProxy != nil {
			var dataPlaneProxy1 DataPlaneProxyProperties
			err := dataPlaneProxy1.PopulateFromARM(owner, *typedInput.Properties.DataPlaneProxy)
			if err != nil {
				return err
			}
			dataPlaneProxy := dataPlaneProxy1
			store.DataPlaneProxy = &dataPlaneProxy
		}
	}

	// Set property "DefaultKeyValueRevisionRetentionPeriodInSeconds":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DefaultKeyValueRevisionRetentionPeriodInSeconds != nil {
			defaultKeyValueRevisionRetentionPeriodInSeconds := *typedInput.Properties.DefaultKeyValueRevisionRetentionPeriodInSeconds
			store.DefaultKeyValueRevisionRetentionPeriodInSeconds = &defaultKeyValueRevisionRetentionPeriodInSeconds
		}
	}
...
func (store *ConfigurationStore_Spec) AssignProperties_From_ConfigurationStore_Spec(source *storage.ConfigurationStore_Spec) error {
	...
	if source.DataPlaneProxy != nil {
		var dataPlaneProxy DataPlaneProxyProperties
		err := dataPlaneProxy.AssignProperties_From_DataPlaneProxyProperties(source.DataPlaneProxy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DataPlaneProxyProperties() to populate field DataPlaneProxy")
		}
		store.DataPlaneProxy = &dataPlaneProxy
	} else {
		store.DataPlaneProxy = nil
	...
	store.DefaultKeyValueRevisionRetentionPeriodInSeconds = genruntime.ClonePointerToInt(source.DefaultKeyValueRevisionRetentionPeriodInSeconds)
...
func (store *ConfigurationStore_Spec) AssignProperties_To_ConfigurationStore_Spec(destination *storage.ConfigurationStore_Spec) error {
	...
	if store.DataPlaneProxy != nil {
		...
		err := store.DataPlaneProxy.AssignProperties_To_DataPlaneProxyProperties(&dataPlaneProxy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DataPlaneProxyProperties() to populate field DataPlaneProxy")
		}
	...
	// DefaultKeyValueRevisionRetentionPeriodInSeconds
	destination.DefaultKeyValueRevisionRetentionPeriodInSeconds = genruntime.ClonePointerToInt(store.DefaultKeyValueRevisionRetentionPeriodInSeconds)
...
func (store *ConfigurationStore_Spec) Initialize_From_ConfigurationStore_STATUS(source *ConfigurationStore_STATUS) error {
	...
	if source.DataPlaneProxy != nil {
		var dataPlaneProxy DataPlaneProxyProperties
		err := dataPlaneProxy.Initialize_From_DataPlaneProxyProperties_STATUS(source.DataPlaneProxy)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_DataPlaneProxyProperties_STATUS() to populate field DataPlaneProxy")
		}
		store.DataPlaneProxy = &dataPlaneProxy
	} else {
		store.DataPlaneProxy = nil
...
func (store *ConfigurationStore_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DataPlaneProxy != nil {
			var dataPlaneProxy1 DataPlaneProxyProperties_STATUS
			err := dataPlaneProxy1.PopulateFromARM(owner, *typedInput.Properties.DataPlaneProxy)
			if err != nil {
				return err
			}
...
func (store *ConfigurationStore_STATUS) AssignProperties_From_ConfigurationStore_STATUS(source *storage.ConfigurationStore_STATUS) error {
	...
	// DataPlaneProxy
	if source.DataPlaneProxy != nil {
		var dataPlaneProxy DataPlaneProxyProperties_STATUS
		err := dataPlaneProxy.AssignProperties_From_DataPlaneProxyProperties_STATUS(source.DataPlaneProxy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DataPlaneProxyProperties_STATUS() to populate field DataPlaneProxy")
		}
		store.DataPlaneProxy = &dataPlaneProxy
	} else {
		store.DataPlaneProxy = nil
...
func (store *ConfigurationStore_STATUS) AssignProperties_To_ConfigurationStore_STATUS(destination *storage.ConfigurationStore_STATUS) error {
	...
	if store.DataPlaneProxy != nil {
		...
		err := store.DataPlaneProxy.AssignProperties_To_DataPlaneProxyProperties_STATUS(&dataPlaneProxy)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DataPlaneProxyProperties_STATUS() to populate field DataPlaneProxy")
		}
		destination.DataPlaneProxy = &dataPlaneProxy
	} else {
		destination.DataPlaneProxy = nil
...
var _ genruntime.ARMTransformer = &DataPlaneProxyProperties{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (properties *DataPlaneProxyProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if properties == nil {
		return nil, nil
	}
	result := &arm.DataPlaneProxyProperties{}

	// Set property "AuthenticationMode":
	if properties.AuthenticationMode != nil {
		var temp string
		temp = string(*properties.AuthenticationMode)
		authenticationMode := arm.DataPlaneProxyProperties_AuthenticationMode(temp)
		result.AuthenticationMode = &authenticationMode
	}

	// Set property "PrivateLinkDelegation":
	if properties.PrivateLinkDelegation != nil {
		var temp string
		temp = string(*properties.PrivateLinkDelegation)
		privateLinkDelegation := arm.DataPlaneProxyProperties_PrivateLinkDelegation(temp)
		result.PrivateLinkDelegation = &privateLinkDelegation
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *DataPlaneProxyProperties) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DataPlaneProxyProperties{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *DataPlaneProxyProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DataPlaneProxyProperties)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DataPlaneProxyProperties, got %T", armInput)
	}
	...
	if typedInput.AuthenticationMode != nil {
		...
		authenticationMode := DataPlaneProxyProperties_AuthenticationMode(temp)
		properties.AuthenticationMode = &authenticationMode
	}

	// Set property "PrivateLinkDelegation":
	if typedInput.PrivateLinkDelegation != nil {
		var temp string
		temp = string(*typedInput.PrivateLinkDelegation)
		privateLinkDelegation := DataPlaneProxyProperties_PrivateLinkDelegation(temp)
		properties.PrivateLinkDelegation = &privateLinkDelegation
	}
...
// AssignProperties_From_DataPlaneProxyProperties populates our DataPlaneProxyProperties from the provided source DataPlaneProxyProperties
func (properties *DataPlaneProxyProperties) AssignProperties_From_DataPlaneProxyProperties(source *storage.DataPlaneProxyProperties) error {

	// AuthenticationMode
	if source.AuthenticationMode != nil {
		authenticationMode := *source.AuthenticationMode
		authenticationModeTemp := genruntime.ToEnum(authenticationMode, dataPlaneProxyProperties_AuthenticationMode_Values)
	...
	if source.PrivateLinkDelegation != nil {
		privateLinkDelegation := *source.PrivateLinkDelegation
		privateLinkDelegationTemp := genruntime.ToEnum(privateLinkDelegation, dataPlaneProxyProperties_PrivateLinkDelegation_Values)
		properties.PrivateLinkDelegation = &privateLinkDelegationTemp
	} else {
		properties.PrivateLinkDelegation = nil
	}
...
// AssignProperties_To_DataPlaneProxyProperties populates the provided destination DataPlaneProxyProperties from our DataPlaneProxyProperties
func (properties *DataPlaneProxyProperties) AssignProperties_To_DataPlaneProxyProperties(destination *storage.DataPlaneProxyProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// PrivateLinkDelegation
	if properties.PrivateLinkDelegation != nil {
		privateLinkDelegation := string(*properties.PrivateLinkDelegation)
		destination.PrivateLinkDelegation = &privateLinkDelegation
	} else {
		destination.PrivateLinkDelegation = nil
	}
...
// Initialize_From_DataPlaneProxyProperties_STATUS populates our DataPlaneProxyProperties from the provided source DataPlaneProxyProperties_STATUS
func (properties *DataPlaneProxyProperties) Initialize_From_DataPlaneProxyProperties_STATUS(source *DataPlaneProxyProperties_STATUS) error {

	// AuthenticationMode
	if source.AuthenticationMode != nil {
		authenticationMode := genruntime.ToEnum(string(*source.AuthenticationMode), dataPlaneProxyProperties_AuthenticationMode_Values)
		properties.AuthenticationMode = &authenticationMode
	} else {
		properties.AuthenticationMode = nil
	}
	...
	// PrivateLinkDelegation
	if source.PrivateLinkDelegation != nil {
		privateLinkDelegation := genruntime.ToEnum(string(*source.PrivateLinkDelegation), dataPlaneProxyProperties_PrivateLinkDelegation_Values)
		properties.PrivateLinkDelegation = &privateLinkDelegation
	} else {
		properties.PrivateLinkDelegation = nil
	}
...
var _ genruntime.FromARMConverter = &DataPlaneProxyProperties_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *DataPlaneProxyProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DataPlaneProxyProperties_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *DataPlaneProxyProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DataPlaneProxyProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DataPlaneProxyProperties_STATUS, got %T", armInput)
	}
	...
	if typedInput.AuthenticationMode != nil {
		var temp string
		temp = string(*typedInput.AuthenticationMode)
		authenticationMode := DataPlaneProxyProperties_AuthenticationMode_STATUS(temp)
		properties.AuthenticationMode = &authenticationMode
	}
	...
	if typedInput.PrivateLinkDelegation != nil {
		var temp string
		temp = string(*typedInput.PrivateLinkDelegation)
		privateLinkDelegation := DataPlaneProxyProperties_PrivateLinkDelegation_STATUS(temp)
		properties.PrivateLinkDelegation = &privateLinkDelegation
	}
...
// AssignProperties_From_DataPlaneProxyProperties_STATUS populates our DataPlaneProxyProperties_STATUS from the provided source DataPlaneProxyProperties_STATUS
func (properties *DataPlaneProxyProperties_STATUS) AssignProperties_From_DataPlaneProxyProperties_STATUS(source *storage.DataPlaneProxyProperties_STATUS) error {

	// AuthenticationMode
	if source.AuthenticationMode != nil {
		authenticationMode := *source.AuthenticationMode
		authenticationModeTemp := genruntime.ToEnum(authenticationMode, dataPlaneProxyProperties_AuthenticationMode_STATUS_Values)
		properties.AuthenticationMode = &authenticationModeTemp
	} else {
		properties.AuthenticationMode = nil
	}
	...
	if source.PrivateLinkDelegation != nil {
		privateLinkDelegation := *source.PrivateLinkDelegation
		privateLinkDelegationTemp := genruntime.ToEnum(privateLinkDelegation, dataPlaneProxyProperties_PrivateLinkDelegation_STATUS_Values)
		properties.PrivateLinkDelegation = &privateLinkDelegationTemp
	} else {
		properties.PrivateLinkDelegation = nil
	}
...
// AssignProperties_To_DataPlaneProxyProperties_STATUS populates the provided destination DataPlaneProxyProperties_STATUS from our DataPlaneProxyProperties_STATUS
func (properties *DataPlaneProxyProperties_STATUS) AssignProperties_To_DataPlaneProxyProperties_STATUS(destination *storage.DataPlaneProxyProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (reference *PrivateEndpointConnectionReference_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PrivateEndpoint != nil {
			...
			reference.PrivateEndpoint = &privateEndpoint
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PrivateLinkServiceConnectionState != nil {
			...
			reference.PrivateLinkServiceConnectionState = &privateLinkServiceConnectionState
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ProvisioningState != nil {
			...
			reference.ProvisioningState = &provisioningState
		}
	}
...
func (reference *PrivateEndpointConnectionReference_STATUS) AssignProperties_From_PrivateEndpointConnectionReference_STATUS(source *storage.PrivateEndpointConnectionReference_STATUS) error {
	...
	// Name
	reference.Name = genruntime.ClonePointerToString(source.Name)
	...
	if source.PrivateLinkServiceConnectionState != nil {
		...
		reference.PrivateLinkServiceConnectionState = nil
	}
	...
	if source.ProvisioningState != nil {
		...
		reference.ProvisioningState = &provisioningStateTemp
	} else {
		reference.ProvisioningState = nil
	}

	// Type
	reference.Type = genruntime.ClonePointerToString(source.Type)
...
func (reference *PrivateEndpointConnectionReference_STATUS) AssignProperties_To_PrivateEndpointConnectionReference_STATUS(destination *storage.PrivateEndpointConnectionReference_STATUS) error {
	...
	// Name
	destination.Name = genruntime.ClonePointerToString(reference.Name)

	// PrivateEndpoint
	if reference.PrivateEndpoint != nil {
		var privateEndpoint storage.PrivateEndpoint_STATUS
		err := reference.PrivateEndpoint.AssignProperties_To_PrivateEndpoint_STATUS(&privateEndpoint)
		if err != nil {
	...
	// PrivateLinkServiceConnectionState
	if reference.PrivateLinkServiceConnectionState != nil {
		var privateLinkServiceConnectionState storage.PrivateLinkServiceConnectionState_STATUS
		err := reference.PrivateLinkServiceConnectionState.AssignProperties_To_PrivateLinkServiceConnectionState_STATUS(&privateLinkServiceConnectionState)
		if err != nil {
	...
	// ProvisioningState
	if reference.ProvisioningState != nil {
		provisioningState := string(*reference.ProvisioningState)
		destination.ProvisioningState = &provisioningState
	} else {
		destination.ProvisioningState = nil
	}
	...
	// Type
	destination.Type = genruntime.ClonePointerToString(reference.Type)
