...
func Test_DataPlaneProxyProperties_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DataPlaneProxyProperties to DataPlaneProxyProperties via AssignProperties_To_DataPlaneProxyProperties & AssignProperties_From_DataPlaneProxyProperties returns original",
		prop.ForAll(RunPropertyAssignmentTestForDataPlaneProxyProperties, DataPlaneProxyPropertiesGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDataPlaneProxyProperties tests if a specific instance of DataPlaneProxyProperties can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDataPlaneProxyProperties(subject DataPlaneProxyProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DataPlaneProxyProperties
	err := copied.AssignProperties_To_DataPlaneProxyProperties(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DataPlaneProxyProperties(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForDataPlaneProxyProperties(gens map[string]gopter.Gen) {
	gens["AuthenticationMode"] = gen.PtrOf(gen.OneConstOf(DataPlaneProxyProperties_AuthenticationMode_Local, DataPlaneProxyProperties_AuthenticationMode_PassThrough))
	gens["PrivateLinkDelegation"] = gen.PtrOf(gen.OneConstOf(DataPlaneProxyProperties_PrivateLinkDelegation_Disabled, DataPlaneProxyProperties_PrivateLinkDelegation_Enabled))
}

func Test_DataPlaneProxyProperties_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DataPlaneProxyProperties_STATUS to DataPlaneProxyProperties_STATUS via AssignProperties_To_DataPlaneProxyProperties_STATUS & AssignProperties_From_DataPlaneProxyProperties_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDataPlaneProxyProperties_STATUS, DataPlaneProxyProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDataPlaneProxyProperties_STATUS tests if a specific instance of DataPlaneProxyProperties_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDataPlaneProxyProperties_STATUS(subject DataPlaneProxyProperties_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.DataPlaneProxyProperties_STATUS
	err := copied.AssignProperties_To_DataPlaneProxyProperties_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DataPlaneProxyProperties_STATUS(&other)
	if err != nil {
		return err.Error()
	}
