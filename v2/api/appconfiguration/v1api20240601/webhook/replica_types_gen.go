...
func (replica *Replica) defaultAzureName(ctx context.Context, obj *v20240601.Replica) error {
...
func (replica *Replica) defaultImpl(ctx context.Context, obj *v20240601.Replica) error {
...
func (replica *Replica) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = replica
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20240601.Replica]); ok {
...
func (replica *Replica) createValidations() []func(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error){
...
func (replica *Replica) deleteValidations() []func(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (replica *Replica) updateValidations() []func(ctx context.Context, oldObj *v20240601.Replica, newObj *v20240601.Replica) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20240601.Replica, newObj *v20240601.Replica) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20240601.Replica, newObj *v20240601.Replica) (admission.Warnings, error) {
...
func (replica *Replica) validateConfigMapDestinations(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
...
func (replica *Replica) validateOwnerReference(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (replica *Replica) validateResourceReferences(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
...
func (replica *Replica) validateSecretDestinations(ctx context.Context, obj *v20240601.Replica) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (replica *Replica) validateWriteOnceProperties(ctx context.Context, oldObj *v20240601.Replica, newObj *v20240601.Replica) (admission.Warnings, error) {
