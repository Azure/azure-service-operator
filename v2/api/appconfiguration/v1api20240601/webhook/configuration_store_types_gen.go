...
func (store *ConfigurationStore) defaultAzureName(ctx context.Context, obj *v20240601.ConfigurationStore) error {
...
func (store *ConfigurationStore) defaultImpl(ctx context.Context, obj *v20240601.ConfigurationStore) error {
...
func (store *ConfigurationStore) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = store
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20240601.ConfigurationStore]); ok {
...
func (store *ConfigurationStore) createValidations() []func(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error){
...
func (store *ConfigurationStore) deleteValidations() []func(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (store *ConfigurationStore) updateValidations() []func(ctx context.Context, oldObj *v20240601.ConfigurationStore, newObj *v20240601.ConfigurationStore) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20240601.ConfigurationStore, newObj *v20240601.ConfigurationStore) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20240601.ConfigurationStore, newObj *v20240601.ConfigurationStore) (admission.Warnings, error) {
...
func (store *ConfigurationStore) validateConfigMapDestinations(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
...
func (store *ConfigurationStore) validateOwnerReference(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (store *ConfigurationStore) validateResourceReferences(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
...
func (store *ConfigurationStore) validateSecretDestinations(ctx context.Context, obj *v20240601.ConfigurationStore) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (store *ConfigurationStore) validateWriteOnceProperties(ctx context.Context, oldObj *v20240601.ConfigurationStore, newObj *v20240601.ConfigurationStore) (admission.Warnings, error) {
