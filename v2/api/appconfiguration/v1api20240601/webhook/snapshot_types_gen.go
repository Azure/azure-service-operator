...
func (snapshot *Snapshot) defaultAzureName(ctx context.Context, obj *v20240601.Snapshot) error {
...
func (snapshot *Snapshot) defaultImpl(ctx context.Context, obj *v20240601.Snapshot) error {
...
func (snapshot *Snapshot) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = snapshot
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20240601.Snapshot]); ok {
...
func (snapshot *Snapshot) createValidations() []func(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error){
...
func (snapshot *Snapshot) deleteValidations() []func(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (snapshot *Snapshot) updateValidations() []func(ctx context.Context, oldObj *v20240601.Snapshot, newObj *v20240601.Snapshot) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20240601.Snapshot, newObj *v20240601.Snapshot) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20240601.Snapshot, newObj *v20240601.Snapshot) (admission.Warnings, error) {
...
func (snapshot *Snapshot) validateConfigMapDestinations(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
...
func (snapshot *Snapshot) validateOwnerReference(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (snapshot *Snapshot) validateResourceReferences(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
...
func (snapshot *Snapshot) validateSecretDestinations(ctx context.Context, obj *v20240601.Snapshot) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (snapshot *Snapshot) validateWriteOnceProperties(ctx context.Context, oldObj *v20240601.Snapshot, newObj *v20240601.Snapshot) (admission.Warnings, error) {
