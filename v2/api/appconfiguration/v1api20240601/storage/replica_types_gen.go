...
// +kubebuilder:rbac:groups=appconfiguration.azure.com,resources=replicas,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appconfiguration.azure.com,resources={replicas/status,replicas/finalizers},verbs=get;update;patch
