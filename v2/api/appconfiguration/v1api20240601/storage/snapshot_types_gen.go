...
// +kubebuilder:rbac:groups=appconfiguration.azure.com,resources=snapshots,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=appconfiguration.azure.com,resources={snapshots/status,snapshots/finalizers},verbs=get;update;patch
