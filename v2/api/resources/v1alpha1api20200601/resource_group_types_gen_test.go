...
// RunPropertyAssignmentTestForResourceGroup tests if a specific instance of ResourceGroup can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForResourceGroup(subject ResourceGroup) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.ResourceGroup
...
// RunPropertyAssignmentTestForResourceGroup_Spec tests if a specific instance of ResourceGroup_Spec can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForResourceGroup_Spec(subject ResourceGroup_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.ResourceGroup_Spec
...
// RunPropertyAssignmentTestForResourceGroup_STATUS tests if a specific instance of ResourceGroup_STATUS can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForResourceGroup_STATUS(subject ResourceGroup_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.ResourceGroup_STATUS
...
// RunPropertyAssignmentTestForResourceGroupProperties_STATUS tests if a specific instance of ResourceGroupProperties_STATUS can be assigned to v1alpha1api20200601storage and back losslessly
func RunPropertyAssignmentTestForResourceGroupProperties_STATUS(subject ResourceGroupProperties_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20200601s.ResourceGroupProperties_STATUS
