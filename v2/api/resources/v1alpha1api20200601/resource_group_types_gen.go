...
// Deprecated version of ResourceGroup. Use v1beta20200601.ResourceGroup instead
...
func (group *ResourceGroup) ConvertFrom(hub conversion.Hub) error {
	...
	var source alpha20200601s.ResourceGroup
...
func (group *ResourceGroup) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination alpha20200601s.ResourceGroup
...
// +kubebuilder:webhook:path=/validate-resources-azure-com-v1alpha1api20200601-resourcegroup,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=resources.azure.com,resources=resourcegroups,verbs=create;update,versions=v1alpha1api20200601,name=validate.v1alpha1api20200601.resourcegroups.resources.azure.com,admissionReviewVersions=v1
...
func (group *ResourceGroup) AssignProperties_From_ResourceGroup(source *alpha20200601s.ResourceGroup) error {
...
func (group *ResourceGroup) AssignProperties_To_ResourceGroup(destination *alpha20200601s.ResourceGroup) error {

	// ObjectMeta
	destination.ObjectMeta = *group.ObjectMeta.DeepCopy()

	// Spec
	var spec alpha20200601s.ResourceGroup_Spec
	...
	// Status
	var status alpha20200601s.ResourceGroup_STATUS
...
func (group *ResourceGroup_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20200601s.ResourceGroup_Spec)
	if ok {
	...
	src = &alpha20200601s.ResourceGroup_Spec{}
...
func (group *ResourceGroup_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20200601s.ResourceGroup_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &alpha20200601s.ResourceGroup_Spec{}
...
func (group *ResourceGroup_Spec) AssignProperties_From_ResourceGroup_Spec(source *alpha20200601s.ResourceGroup_Spec) error {
...
func (group *ResourceGroup_Spec) AssignProperties_To_ResourceGroup_Spec(destination *alpha20200601s.ResourceGroup_Spec) error {
...
// Deprecated version of ResourceGroup_STATUS. Use v1beta20200601.ResourceGroup_STATUS instead
...
func (group *ResourceGroup_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20200601s.ResourceGroup_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20200601s.ResourceGroup_STATUS{}
...
func (group *ResourceGroup_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20200601s.ResourceGroup_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20200601s.ResourceGroup_STATUS{}
...
func (group *ResourceGroup_STATUS) AssignProperties_From_ResourceGroup_STATUS(source *alpha20200601s.ResourceGroup_STATUS) error {
...
func (group *ResourceGroup_STATUS) AssignProperties_To_ResourceGroup_STATUS(destination *alpha20200601s.ResourceGroup_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if group.Properties != nil {
		var property alpha20200601s.ResourceGroupProperties_STATUS
...
// Deprecated version of ResourceGroupProperties_STATUS. Use v1beta20200601.ResourceGroupProperties_STATUS instead
...
func (properties *ResourceGroupProperties_STATUS) AssignProperties_From_ResourceGroupProperties_STATUS(source *alpha20200601s.ResourceGroupProperties_STATUS) error {
...
func (properties *ResourceGroupProperties_STATUS) AssignProperties_To_ResourceGroupProperties_STATUS(destination *alpha20200601s.ResourceGroupProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
