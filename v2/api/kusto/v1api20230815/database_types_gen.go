...
func (database *Database_Spec) AssignProperties_From_Database_Spec(source *storage.Database_Spec) error {
	...
	if source.ReadOnlyFollowing != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_ReadOnlyFollowingDatabase() to populate field ReadOnlyFollowing")
		}
		database.ReadOnlyFollowing = &readOnlyFollowing
	} else {
...
func (database *Database_Spec) AssignProperties_To_Database_Spec(destination *storage.Database_Spec) error {
	...
	if database.ReadOnlyFollowing != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_ReadOnlyFollowingDatabase() to populate field ReadOnlyFollowing")
		}
...
func (database *Database_Spec) Initialize_From_Database_STATUS(source *Database_STATUS) error {
	...
	if source.ReadOnlyFollowing != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ReadOnlyFollowingDatabase_STATUS() to populate field ReadOnlyFollowing")
		}
		database.ReadOnlyFollowing = &readOnlyFollowing
	} else {
		database.ReadOnlyFollowing = nil
...
func (database *Database_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.ReadOnlyFollowing != nil {
		...
		readOnlyFollowing := readOnlyFollowing1
		database.ReadOnlyFollowing = &readOnlyFollowing
		database.Name = typedInput.ReadOnlyFollowing.Name
	}
...
func (database *Database_STATUS) AssignProperties_From_Database_STATUS(source *storage.Database_STATUS) error {
	...
	if source.ReadOnlyFollowing != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_ReadOnlyFollowingDatabase_STATUS() to populate field ReadOnlyFollowing")
		}
		database.ReadOnlyFollowing = &readOnlyFollowing
	} else {
		database.ReadOnlyFollowing = nil
...
func (database *Database_STATUS) AssignProperties_To_Database_STATUS(destination *storage.Database_STATUS) error {
	...
	if database.ReadOnlyFollowing != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_ReadOnlyFollowingDatabase_STATUS() to populate field ReadOnlyFollowing")
		}
		destination.ReadOnlyFollowing = &readOnlyFollowing
	} else {
		destination.ReadOnlyFollowing = nil
...
func (database *ReadOnlyFollowingDatabase) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if database.Kind != nil {
		var temp arm.ReadOnlyFollowingDatabase_Kind
		var temp1 string
		temp1 = string(*database.Kind)
		temp = arm.ReadOnlyFollowingDatabase_Kind(temp1)
		result.Kind = temp
	}
	...
	if database.DatabaseShareOrigin != nil || database.HotCachePeriod != nil {
		result.Properties = &arm.ReadOnlyFollowingDatabaseProperties{}
	}
	if database.DatabaseShareOrigin != nil {
		var temp string
		temp = string(*database.DatabaseShareOrigin)
		databaseShareOrigin := arm.DatabaseShareOrigin(temp)
...
func (database *ReadOnlyFollowingDatabase) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Kind":
	var temp ReadOnlyFollowingDatabase_Kind
	var temp1 string
	temp1 = string(typedInput.Kind)
	temp = ReadOnlyFollowingDatabase_Kind(temp1)
	database.Kind = &temp
...
func (database *ReadOnlyFollowingDatabase_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ReadOnlyFollowingDatabase_STATUS{}
}
...
func (database *ReadOnlyFollowingDatabase_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ReadOnlyFollowingDatabase_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ReadOnlyFollowingDatabase_STATUS, got %T", armInput)
	}
...
func (database *ReadOnlyFollowingDatabase_STATUS) AssignProperties_From_ReadOnlyFollowingDatabase_STATUS(source *storage.ReadOnlyFollowingDatabase_STATUS) error {
	...
	if source.TableLevelSharingProperties != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_TableLevelSharingProperties_STATUS() to populate field TableLevelSharingProperties")
		}
...
func (database *ReadOnlyFollowingDatabase_STATUS) AssignProperties_To_ReadOnlyFollowingDatabase_STATUS(destination *storage.ReadOnlyFollowingDatabase_STATUS) error {
	...
	if database.TableLevelSharingProperties != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_TableLevelSharingProperties_STATUS() to populate field TableLevelSharingProperties")
		}
...
func (properties *TableLevelSharingProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.TableLevelSharingProperties_STATUS{}
}
...
func (properties *TableLevelSharingProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.TableLevelSharingProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.TableLevelSharingProperties_STATUS, got %T", armInput)
	}
