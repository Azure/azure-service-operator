...
type CalloutPolicy struct {
	...
	CalloutType *CalloutPolicy_CalloutType `json:"calloutType,omitempty"`
	...
	OutboundAccess *CalloutPolicy_OutboundAccess `json:"outboundAccess,omitempty"`
}
...
type CalloutPolicy_CalloutType string

const (
	CalloutPolicy_CalloutType_Azure_Digital_Twins = CalloutPolicy_CalloutType("azure_digital_twins")
	CalloutPolicy_CalloutType_Azure_Openai        = CalloutPolicy_CalloutType("azure_openai")
	CalloutPolicy_CalloutType_Cosmosdb            = CalloutPolicy_CalloutType("cosmosdb")
	CalloutPolicy_CalloutType_External_Data       = CalloutPolicy_CalloutType("external_data")
	CalloutPolicy_CalloutType_Genevametrics       = CalloutPolicy_CalloutType("genevametrics")
	CalloutPolicy_CalloutType_Kusto               = CalloutPolicy_CalloutType("kusto")
	CalloutPolicy_CalloutType_Mysql               = CalloutPolicy_CalloutType("mysql")
	CalloutPolicy_CalloutType_Postgresql          = CalloutPolicy_CalloutType("postgresql")
	CalloutPolicy_CalloutType_Sandbox_Artifacts   = CalloutPolicy_CalloutType("sandbox_artifacts")
	CalloutPolicy_CalloutType_Sql                 = CalloutPolicy_CalloutType("sql")
	CalloutPolicy_CalloutType_Webapi              = CalloutPolicy_CalloutType("webapi")
)

// Mapping from string to CalloutPolicy_CalloutType
var calloutPolicy_CalloutType_Values = map[string]CalloutPolicy_CalloutType{
	"azure_digital_twins": CalloutPolicy_CalloutType_Azure_Digital_Twins,
	"azure_openai":        CalloutPolicy_CalloutType_Azure_Openai,
	"cosmosdb":            CalloutPolicy_CalloutType_Cosmosdb,
	"external_data":       CalloutPolicy_CalloutType_External_Data,
	"genevametrics":       CalloutPolicy_CalloutType_Genevametrics,
	"kusto":               CalloutPolicy_CalloutType_Kusto,
	"mysql":               CalloutPolicy_CalloutType_Mysql,
	"postgresql":          CalloutPolicy_CalloutType_Postgresql,
	"sandbox_artifacts":   CalloutPolicy_CalloutType_Sandbox_Artifacts,
	"sql":                 CalloutPolicy_CalloutType_Sql,
	"webapi":              CalloutPolicy_CalloutType_Webapi,
}

// +kubebuilder:validation:Enum={"Allow","Deny"}
type CalloutPolicy_OutboundAccess string

const (
	CalloutPolicy_OutboundAccess_Allow = CalloutPolicy_OutboundAccess("Allow")
	CalloutPolicy_OutboundAccess_Deny  = CalloutPolicy_OutboundAccess("Deny")
)

// Mapping from string to CalloutPolicy_OutboundAccess
var calloutPolicy_OutboundAccess_Values = map[string]CalloutPolicy_OutboundAccess{
	"allow": CalloutPolicy_OutboundAccess_Allow,
	"deny":  CalloutPolicy_OutboundAccess_Deny,
}
...
// +kubebuilder:validation:Enum={"Python3_10_8","Python3_10_8_DL","Python3_11_7","Python3_11_7_DL","Python3_6_5","PythonCustomImage","R"}
...
var languageExtensionImageName_Values = map[string]LanguageExtensionImageName{
	...
	"python3_11_7":      LanguageExtensionImageName_Python3_11_7,
	"python3_11_7_dl":   LanguageExtensionImageName_Python3_11_7_DL,
