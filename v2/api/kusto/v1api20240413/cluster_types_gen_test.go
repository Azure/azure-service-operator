...
func Test_CalloutPolicy_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CalloutPolicy to CalloutPolicy via AssignProperties_To_CalloutPolicy & AssignProperties_From_CalloutPolicy returns original",
		prop.ForAll(RunPropertyAssignmentTestForCalloutPolicy, CalloutPolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCalloutPolicy tests if a specific instance of CalloutPolicy can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForCalloutPolicy(subject CalloutPolicy) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()
...
func Test_CalloutPolicy_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of CalloutPolicy via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCalloutPolicy, CalloutPolicyGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}
...
func RunJSONSerializationTestForCalloutPolicy(subject CalloutPolicy) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
var calloutPolicyGenerator gopter.Gen

// CalloutPolicyGenerator returns a generator of CalloutPolicy instances for property testing.
func CalloutPolicyGenerator() gopter.Gen {
	if calloutPolicyGenerator != nil {
		return calloutPolicyGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCalloutPolicy(generators)
	calloutPolicyGenerator = gen.Struct(reflect.TypeOf(CalloutPolicy{}), generators)

	return calloutPolicyGenerator
}

// AddIndependentPropertyGeneratorsForCalloutPolicy is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCalloutPolicy(gens map[string]gopter.Gen) {
	gens["CalloutType"] = gen.PtrOf(gen.OneConstOf(
		CalloutPolicy_CalloutType_Azure_Digital_Twins,
		CalloutPolicy_CalloutType_Azure_Openai,
		CalloutPolicy_CalloutType_Cosmosdb,
		CalloutPolicy_CalloutType_External_Data,
		CalloutPolicy_CalloutType_Genevametrics,
		CalloutPolicy_CalloutType_Kusto,
		CalloutPolicy_CalloutType_Mysql,
		CalloutPolicy_CalloutType_Postgresql,
		CalloutPolicy_CalloutType_Sandbox_Artifacts,
		CalloutPolicy_CalloutType_Sql,
		CalloutPolicy_CalloutType_Webapi))
	gens["CalloutUriRegex"] = gen.PtrOf(gen.AlphaString())
	gens["OutboundAccess"] = gen.PtrOf(gen.OneConstOf(CalloutPolicy_OutboundAccess_Allow, CalloutPolicy_OutboundAccess_Deny))
}
...
func Test_CalloutPolicy_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CalloutPolicy_STATUS to CalloutPolicy_STATUS via AssignProperties_To_CalloutPolicy_STATUS & AssignProperties_From_CalloutPolicy_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForCalloutPolicy_STATUS, CalloutPolicy_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCalloutPolicy_STATUS tests if a specific instance of CalloutPolicy_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForCalloutPolicy_STATUS(subject CalloutPolicy_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()
...
func Test_CalloutPolicy_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of CalloutPolicy_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCalloutPolicy_STATUS, CalloutPolicy_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}
...
func RunJSONSerializationTestForCalloutPolicy_STATUS(subject CalloutPolicy_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
var calloutPolicy_STATUSGenerator gopter.Gen

// CalloutPolicy_STATUSGenerator returns a generator of CalloutPolicy_STATUS instances for property testing.
func CalloutPolicy_STATUSGenerator() gopter.Gen {
	if calloutPolicy_STATUSGenerator != nil {
		return calloutPolicy_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCalloutPolicy_STATUS(generators)
	calloutPolicy_STATUSGenerator = gen.Struct(reflect.TypeOf(CalloutPolicy_STATUS{}), generators)

	return calloutPolicy_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForCalloutPolicy_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCalloutPolicy_STATUS(gens map[string]gopter.Gen) {
	gens["CalloutId"] = gen.PtrOf(gen.AlphaString())
	gens["CalloutType"] = gen.PtrOf(gen.OneConstOf(
		CalloutPolicy_CalloutType_STATUS_Azure_Digital_Twins,
		CalloutPolicy_CalloutType_STATUS_Azure_Openai,
		CalloutPolicy_CalloutType_STATUS_Cosmosdb,
		CalloutPolicy_CalloutType_STATUS_External_Data,
		CalloutPolicy_CalloutType_STATUS_Genevametrics,
		CalloutPolicy_CalloutType_STATUS_Kusto,
		CalloutPolicy_CalloutType_STATUS_Mysql,
		CalloutPolicy_CalloutType_STATUS_Postgresql,
		CalloutPolicy_CalloutType_STATUS_Sandbox_Artifacts,
		CalloutPolicy_CalloutType_STATUS_Sql,
		CalloutPolicy_CalloutType_STATUS_Webapi))
	gens["CalloutUriRegex"] = gen.PtrOf(gen.AlphaString())
	gens["OutboundAccess"] = gen.PtrOf(gen.OneConstOf(CalloutPolicy_OutboundAccess_STATUS_Allow, CalloutPolicy_OutboundAccess_STATUS_Deny))
}
...
func AddIndependentPropertyGeneratorsForCluster_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ZoneStatus"] = gen.PtrOf(gen.OneConstOf(ClusterProperties_ZoneStatus_STATUS_NonZonal, ClusterProperties_ZoneStatus_STATUS_Zonal, ClusterProperties_ZoneStatus_STATUS_ZonalInconsistency))
...
func AddRelatedPropertyGeneratorsForCluster_STATUS(gens map[string]gopter.Gen) {
	...
	gens["CalloutPolicies"] = gen.SliceOf(CalloutPolicy_STATUSGenerator())
...
func AddRelatedPropertyGeneratorsForCluster_Spec(gens map[string]gopter.Gen) {
	...
	gens["CalloutPolicies"] = gen.SliceOf(CalloutPolicyGenerator())
...
func AddIndependentPropertyGeneratorsForLanguageExtension_STATUS(gens map[string]gopter.Gen) {
	...
	gens["LanguageExtensionImageName"] = gen.PtrOf(gen.OneConstOf(
		...
		LanguageExtensionImageName_STATUS_Python3_11_7,
		LanguageExtensionImageName_STATUS_Python3_11_7_DL,
