...
func (cluster *Cluster_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	for _, item := range cluster.CalloutPolicies {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.Properties.CalloutPolicies = append(result.Properties.CalloutPolicies, *item_ARM.(*arm.CalloutPolicy))
	}
...
func (cluster *Cluster_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CalloutPolicies":
	// copying flattened property:
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.CalloutPolicies {
			var item1 CalloutPolicy
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
			cluster.CalloutPolicies = append(cluster.CalloutPolicies, item1)
		}
	}
...
func (cluster *Cluster_Spec) AssignProperties_From_Cluster_Spec(source *storage.Cluster_Spec) error {
	...
	if source.CalloutPolicies != nil {
		...
		for calloutPolicyIndex, calloutPolicyItem := range source.CalloutPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_CalloutPolicy() to populate field CalloutPolicies")
			}
			calloutPolicyList[calloutPolicyIndex] = calloutPolicy
		}
		cluster.CalloutPolicies = calloutPolicyList
	} else {
		cluster.CalloutPolicies = nil
	}
...
func (cluster *Cluster_Spec) AssignProperties_To_Cluster_Spec(destination *storage.Cluster_Spec) error {
	...
	if cluster.CalloutPolicies != nil {
		...
		for calloutPolicyIndex, calloutPolicyItem := range cluster.CalloutPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_CalloutPolicy() to populate field CalloutPolicies")
			}
			calloutPolicyList[calloutPolicyIndex] = calloutPolicy
		}
		destination.CalloutPolicies = calloutPolicyList
	} else {
...
func (cluster *Cluster_Spec) Initialize_From_Cluster_STATUS(source *Cluster_STATUS) error {
	...
	if source.CalloutPolicies != nil {
		...
		for calloutPolicyIndex, calloutPolicyItem := range source.CalloutPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_CalloutPolicy_STATUS() to populate field CalloutPolicies")
			}
			calloutPolicyList[calloutPolicyIndex] = calloutPolicy
		}
		cluster.CalloutPolicies = calloutPolicyList
...
type Cluster_STATUS struct {
	...
	ZoneStatus *ClusterProperties_ZoneStatus_STATUS `json:"zoneStatus,omitempty"`
...
func (cluster *Cluster_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.CalloutPolicies {
			var item1 CalloutPolicy_STATUS
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
	...
	// Set property "ZoneStatus":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.ZoneStatus != nil {
			var temp string
			temp = string(*typedInput.Properties.ZoneStatus)
			zoneStatus := ClusterProperties_ZoneStatus_STATUS(temp)
			cluster.ZoneStatus = &zoneStatus
		}
	}
...
func (cluster *Cluster_STATUS) AssignProperties_From_Cluster_STATUS(source *storage.Cluster_STATUS) error {
	...
	if source.CalloutPolicies != nil {
		...
		for calloutPolicyIndex, calloutPolicyItem := range source.CalloutPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_CalloutPolicy_STATUS() to populate field CalloutPolicies")
			}
			calloutPolicyList[calloutPolicyIndex] = calloutPolicy
		}
		cluster.CalloutPolicies = calloutPolicyList
	...
	if source.ZoneStatus != nil {
		...
		zoneStatusTemp := genruntime.ToEnum(zoneStatus, clusterProperties_ZoneStatus_STATUS_Values)
		cluster.ZoneStatus = &zoneStatusTemp
	} else {
		cluster.ZoneStatus = nil
	}
...
func (cluster *Cluster_STATUS) AssignProperties_To_Cluster_STATUS(destination *storage.Cluster_STATUS) error {
	...
	if cluster.CalloutPolicies != nil {
		...
		for calloutPolicyIndex, calloutPolicyItem := range cluster.CalloutPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_CalloutPolicy_STATUS() to populate field CalloutPolicies")
			}
			calloutPolicyList[calloutPolicyIndex] = calloutPolicy
		}
		destination.CalloutPolicies = calloutPolicyList
	...
	// ZoneStatus
	if cluster.ZoneStatus != nil {
		zoneStatus := string(*cluster.ZoneStatus)
...
var _ genruntime.ARMTransformer = &CalloutPolicy{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (policy *CalloutPolicy) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if policy == nil {
		return nil, nil
	}
	result := &arm.CalloutPolicy{}

	// Set property "CalloutType":
	if policy.CalloutType != nil {
		var temp string
		temp = string(*policy.CalloutType)
		calloutType := arm.CalloutPolicy_CalloutType(temp)
		result.CalloutType = &calloutType
	}

	// Set property "CalloutUriRegex":
	if policy.CalloutUriRegex != nil {
		calloutUriRegex := *policy.CalloutUriRegex
		result.CalloutUriRegex = &calloutUriRegex
	}

	// Set property "OutboundAccess":
	if policy.OutboundAccess != nil {
		var temp string
		temp = string(*policy.OutboundAccess)
		outboundAccess := arm.CalloutPolicy_OutboundAccess(temp)
		result.OutboundAccess = &outboundAccess
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (policy *CalloutPolicy) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.CalloutPolicy{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (policy *CalloutPolicy) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.CalloutPolicy)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.CalloutPolicy, got %T", armInput)
	}

	// Set property "CalloutType":
	if typedInput.CalloutType != nil {
		var temp string
		temp = string(*typedInput.CalloutType)
		calloutType := CalloutPolicy_CalloutType(temp)
		policy.CalloutType = &calloutType
	}

	// Set property "CalloutUriRegex":
	if typedInput.CalloutUriRegex != nil {
		calloutUriRegex := *typedInput.CalloutUriRegex
		policy.CalloutUriRegex = &calloutUriRegex
	}

	// Set property "OutboundAccess":
	if typedInput.OutboundAccess != nil {
		var temp string
		temp = string(*typedInput.OutboundAccess)
		outboundAccess := CalloutPolicy_OutboundAccess(temp)
		policy.OutboundAccess = &outboundAccess
	}
...
// AssignProperties_From_CalloutPolicy populates our CalloutPolicy from the provided source CalloutPolicy
func (policy *CalloutPolicy) AssignProperties_From_CalloutPolicy(source *storage.CalloutPolicy) error {

	// CalloutType
	if source.CalloutType != nil {
		calloutType := *source.CalloutType
		calloutTypeTemp := genruntime.ToEnum(calloutType, calloutPolicy_CalloutType_Values)
		policy.CalloutType = &calloutTypeTemp
	} else {
		policy.CalloutType = nil
	}

	// CalloutUriRegex
	policy.CalloutUriRegex = genruntime.ClonePointerToString(source.CalloutUriRegex)

	// OutboundAccess
	if source.OutboundAccess != nil {
		outboundAccess := *source.OutboundAccess
		outboundAccessTemp := genruntime.ToEnum(outboundAccess, calloutPolicy_OutboundAccess_Values)
		policy.OutboundAccess = &outboundAccessTemp
	} else {
		policy.OutboundAccess = nil
	}
...
// AssignProperties_To_CalloutPolicy populates the provided destination CalloutPolicy from our CalloutPolicy
func (policy *CalloutPolicy) AssignProperties_To_CalloutPolicy(destination *storage.CalloutPolicy) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// CalloutType
	if policy.CalloutType != nil {
		calloutType := string(*policy.CalloutType)
		destination.CalloutType = &calloutType
	} else {
		destination.CalloutType = nil
	}

	// CalloutUriRegex
	destination.CalloutUriRegex = genruntime.ClonePointerToString(policy.CalloutUriRegex)

	// OutboundAccess
	if policy.OutboundAccess != nil {
		outboundAccess := string(*policy.OutboundAccess)
		destination.OutboundAccess = &outboundAccess
	} else {
		destination.OutboundAccess = nil
	}
...
// Initialize_From_CalloutPolicy_STATUS populates our CalloutPolicy from the provided source CalloutPolicy_STATUS
func (policy *CalloutPolicy) Initialize_From_CalloutPolicy_STATUS(source *CalloutPolicy_STATUS) error {

	// CalloutType
	if source.CalloutType != nil {
		calloutType := genruntime.ToEnum(string(*source.CalloutType), calloutPolicy_CalloutType_Values)
		policy.CalloutType = &calloutType
	} else {
		policy.CalloutType = nil
	}
	...
	// OutboundAccess
	if source.OutboundAccess != nil {
		outboundAccess := genruntime.ToEnum(string(*source.OutboundAccess), calloutPolicy_OutboundAccess_Values)
		policy.OutboundAccess = &outboundAccess
	} else {
		policy.OutboundAccess = nil
	}
...
type CalloutPolicy_STATUS struct {
	...
	// CalloutType: Type of the callout service, specifying the kind of external resource or service being accessed.
	CalloutType *CalloutPolicy_CalloutType_STATUS `json:"calloutType,omitempty"`

	// CalloutUriRegex: Regular expression or FQDN pattern for the callout URI.
	CalloutUriRegex *string `json:"calloutUriRegex,omitempty"`

	// OutboundAccess: Indicates whether outbound access is permitted for the specified URI pattern.
	OutboundAccess *CalloutPolicy_OutboundAccess_STATUS `json:"outboundAccess,omitempty"`
}

var _ genruntime.FromARMConverter = &CalloutPolicy_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (policy *CalloutPolicy_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.CalloutPolicy_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (policy *CalloutPolicy_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.CalloutPolicy_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.CalloutPolicy_STATUS, got %T", armInput)
	}

	// Set property "CalloutId":
	if typedInput.CalloutId != nil {
		calloutId := *typedInput.CalloutId
		policy.CalloutId = &calloutId
	}
	...
	if typedInput.CalloutType != nil {
		var temp string
		temp = string(*typedInput.CalloutType)
		calloutType := CalloutPolicy_CalloutType_STATUS(temp)
		policy.CalloutType = &calloutType
	}
	...
	if typedInput.OutboundAccess != nil {
		var temp string
		temp = string(*typedInput.OutboundAccess)
		outboundAccess := CalloutPolicy_OutboundAccess_STATUS(temp)
		policy.OutboundAccess = &outboundAccess
	}
...
// AssignProperties_From_CalloutPolicy_STATUS populates our CalloutPolicy_STATUS from the provided source CalloutPolicy_STATUS
func (policy *CalloutPolicy_STATUS) AssignProperties_From_CalloutPolicy_STATUS(source *storage.CalloutPolicy_STATUS) error {

	// CalloutId
	policy.CalloutId = genruntime.ClonePointerToString(source.CalloutId)

	// CalloutType
	if source.CalloutType != nil {
		calloutType := *source.CalloutType
		calloutTypeTemp := genruntime.ToEnum(calloutType, calloutPolicy_CalloutType_STATUS_Values)
		policy.CalloutType = &calloutTypeTemp
	} else {
		policy.CalloutType = nil
	}
	...
	if source.OutboundAccess != nil {
		outboundAccess := *source.OutboundAccess
		outboundAccessTemp := genruntime.ToEnum(outboundAccess, calloutPolicy_OutboundAccess_STATUS_Values)
		policy.OutboundAccess = &outboundAccessTemp
	} else {
		policy.OutboundAccess = nil
	}
...
// AssignProperties_To_CalloutPolicy_STATUS populates the provided destination CalloutPolicy_STATUS from our CalloutPolicy_STATUS
func (policy *CalloutPolicy_STATUS) AssignProperties_To_CalloutPolicy_STATUS(destination *storage.CalloutPolicy_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// CalloutId
	destination.CalloutId = genruntime.ClonePointerToString(policy.CalloutId)
...
type ClusterProperties_ZoneStatus_STATUS string

const (
	ClusterProperties_ZoneStatus_STATUS_NonZonal           = ClusterProperties_ZoneStatus_STATUS("NonZonal")
	ClusterProperties_ZoneStatus_STATUS_Zonal              = ClusterProperties_ZoneStatus_STATUS("Zonal")
	ClusterProperties_ZoneStatus_STATUS_ZonalInconsistency = ClusterProperties_ZoneStatus_STATUS("ZonalInconsistency")
)

// Mapping from string to ClusterProperties_ZoneStatus_STATUS
var clusterProperties_ZoneStatus_STATUS_Values = map[string]ClusterProperties_ZoneStatus_STATUS{
	"nonzonal":           ClusterProperties_ZoneStatus_STATUS_NonZonal,
	"zonal":              ClusterProperties_ZoneStatus_STATUS_Zonal,
	"zonalinconsistency": ClusterProperties_ZoneStatus_STATUS_ZonalInconsistency,
}
...
type CalloutPolicy_CalloutType_STATUS string

const (
	CalloutPolicy_CalloutType_STATUS_Azure_Digital_Twins = CalloutPolicy_CalloutType_STATUS("azure_digital_twins")
	CalloutPolicy_CalloutType_STATUS_Azure_Openai        = CalloutPolicy_CalloutType_STATUS("azure_openai")
	CalloutPolicy_CalloutType_STATUS_Cosmosdb            = CalloutPolicy_CalloutType_STATUS("cosmosdb")
	CalloutPolicy_CalloutType_STATUS_External_Data       = CalloutPolicy_CalloutType_STATUS("external_data")
	CalloutPolicy_CalloutType_STATUS_Genevametrics       = CalloutPolicy_CalloutType_STATUS("genevametrics")
	CalloutPolicy_CalloutType_STATUS_Kusto               = CalloutPolicy_CalloutType_STATUS("kusto")
	CalloutPolicy_CalloutType_STATUS_Mysql               = CalloutPolicy_CalloutType_STATUS("mysql")
	CalloutPolicy_CalloutType_STATUS_Postgresql          = CalloutPolicy_CalloutType_STATUS("postgresql")
	CalloutPolicy_CalloutType_STATUS_Sandbox_Artifacts   = CalloutPolicy_CalloutType_STATUS("sandbox_artifacts")
	CalloutPolicy_CalloutType_STATUS_Sql                 = CalloutPolicy_CalloutType_STATUS("sql")
	CalloutPolicy_CalloutType_STATUS_Webapi              = CalloutPolicy_CalloutType_STATUS("webapi")
)

// Mapping from string to CalloutPolicy_CalloutType_STATUS
var calloutPolicy_CalloutType_STATUS_Values = map[string]CalloutPolicy_CalloutType_STATUS{
	"azure_digital_twins": CalloutPolicy_CalloutType_STATUS_Azure_Digital_Twins,
	"azure_openai":        CalloutPolicy_CalloutType_STATUS_Azure_Openai,
	"cosmosdb":            CalloutPolicy_CalloutType_STATUS_Cosmosdb,
	"external_data":       CalloutPolicy_CalloutType_STATUS_External_Data,
	"genevametrics":       CalloutPolicy_CalloutType_STATUS_Genevametrics,
	"kusto":               CalloutPolicy_CalloutType_STATUS_Kusto,
	"mysql":               CalloutPolicy_CalloutType_STATUS_Mysql,
	"postgresql":          CalloutPolicy_CalloutType_STATUS_Postgresql,
	"sandbox_artifacts":   CalloutPolicy_CalloutType_STATUS_Sandbox_Artifacts,
	"sql":                 CalloutPolicy_CalloutType_STATUS_Sql,
	"webapi":              CalloutPolicy_CalloutType_STATUS_Webapi,
}
...
type CalloutPolicy_OutboundAccess_STATUS string

const (
	CalloutPolicy_OutboundAccess_STATUS_Allow = CalloutPolicy_OutboundAccess_STATUS("Allow")
	CalloutPolicy_OutboundAccess_STATUS_Deny  = CalloutPolicy_OutboundAccess_STATUS("Deny")
)

// Mapping from string to CalloutPolicy_OutboundAccess_STATUS
...
const (
	...
	LanguageExtensionImageName_STATUS_Python3_11_7      = LanguageExtensionImageName_STATUS("Python3_11_7")
	LanguageExtensionImageName_STATUS_Python3_11_7_DL   = LanguageExtensionImageName_STATUS("Python3_11_7_DL")
...
var languageExtensionImageName_STATUS_Values = map[string]LanguageExtensionImageName_STATUS{
	...
	"python3_11_7":      LanguageExtensionImageName_STATUS_Python3_11_7,
	"python3_11_7_dl":   LanguageExtensionImageName_STATUS_Python3_11_7_DL,
