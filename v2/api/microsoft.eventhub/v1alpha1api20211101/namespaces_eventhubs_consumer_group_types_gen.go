...
// +kubebuilder:rbac:groups=microsoft.eventhub.azure.com,resources=namespaceseventhubsconsumergroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.eventhub.azure.com,resources={namespaceseventhubsconsumergroups/status,namespaceseventhubsconsumergroups/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-eventhub-azure-com-v1alpha1api20211101-namespaceseventhubsconsumergroup,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventhub.azure.com,resources=namespaceseventhubsconsumergroups,verbs=create;update,versions=v1alpha1api20211101,name=default.v1alpha1api20211101.namespaceseventhubsconsumergroups.microsoft.eventhub.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-eventhub-azure-com-v1alpha1api20211101-namespaceseventhubsconsumergroup,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventhub.azure.com,resources=namespaceseventhubsconsumergroups,verbs=create;update,versions=v1alpha1api20211101,name=validate.v1alpha1api20211101.namespaceseventhubsconsumergroups.microsoft.eventhub.azure.com,admissionReviewVersions=v1beta1
