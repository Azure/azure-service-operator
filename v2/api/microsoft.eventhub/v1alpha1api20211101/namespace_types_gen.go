...
// +kubebuilder:rbac:groups=microsoft.eventhub.azure.com,resources=namespaces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.eventhub.azure.com,resources={namespaces/status,namespaces/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-eventhub-azure-com-v1alpha1api20211101-namespace,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.eventhub.azure.com,resources=namespaces,verbs=create;update,versions=v1alpha1api20211101,name=default.v1alpha1api20211101.namespaces.microsoft.eventhub.azure.com,admissionReviewVersions=v1beta1
