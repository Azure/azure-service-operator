...
// +kubebuilder:rbac:groups=microsoft.dbformysql.azure.com,resources=flexibleservers,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.dbformysql.azure.com,resources={flexibleservers/status,flexibleservers/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-dbformysql-azure-com-v1alpha1api20210501-flexibleserver,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.dbformysql.azure.com,resources=flexibleservers,verbs=create;update,versions=v1alpha1api20210501,name=default.v1alpha1api20210501.flexibleservers.microsoft.dbformysql.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-dbformysql-azure-com-v1alpha1api20210501-flexibleserver,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.dbformysql.azure.com,resources=flexibleservers,verbs=create;update,versions=v1alpha1api20210501,name=validate.v1alpha1api20210501.flexibleservers.microsoft.dbformysql.azure.com,admissionReviewVersions=v1beta1
