...
import (
	"fmt"
	"github.com/Azure/azure-service-operator/v2/api/microsoft.dbformysql/v1alpha1api20210501storage"
...
// +kubebuilder:rbac:groups=microsoft.dbformysql.azure.com,resources=flexibleserversfirewallrules,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.dbformysql.azure.com,resources={flexibleserversfirewallrules/status,flexibleserversfirewallrules/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-dbformysql-azure-com-v1alpha1api20210501-flexibleserversfirewallrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.dbformysql.azure.com,resources=flexibleserversfirewallrules,verbs=create;update,versions=v1alpha1api20210501,name=default.v1alpha1api20210501.flexibleserversfirewallrules.microsoft.dbformysql.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-dbformysql-azure-com-v1alpha1api20210501-flexibleserversfirewallrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.dbformysql.azure.com,resources=flexibleserversfirewallrules,verbs=create;update,versions=v1alpha1api20210501,name=validate.v1alpha1api20210501.flexibleserversfirewallrules.microsoft.dbformysql.azure.com,admissionReviewVersions=v1beta1
...
type FlexibleServersFirewallRules_Spec struct {
	...
	// +kubebuilder:validation:Required
	Owner genruntime.KnownResourceReference `group:"microsoft.dbformysql.azure.com" json:"owner" kind:"FlexibleServer"`
