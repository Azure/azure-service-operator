...
func ApiPropertiesGenerator() *rapid.Generator[ApiProperties] {
	...
	ptrString := rapid.Ptr(rapid.String(), true)
	ptrString1 := rapid.Ptr(rapid.String(), true)
	...
	apiPropertiesGenerator = rapid.Custom(func(t *rapid.T) ApiProperties {
		...
		result.QnaAzureSearchEndpointId = ptrString1.Draw(t, "QnaAzureSearchEndpointId")
		result.QnaRuntimeEndpoint = ptrString1.Draw(t, "QnaRuntimeEndpoint")
