...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/cognitiveservices/v1api20241001/arm"
...
// - Generated from: /cognitiveservices/resource-manager/Microsoft.CognitiveServices/stable/2024-10-01/cognitiveservices.json
...
func (account *Account) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected cognitiveservices/v1api20241001/storage/Account but received %T instead", hub)
	}
...
type UserOwnedAmlWorkspace struct {
	...
	// ResourceReference: Full resource id of a AML workspace resource.
