...
// +kubebuilder:webhook:path=/mutate-cognitiveservices-azure-com-v20250601-account,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cognitiveservices.azure.com,resources=accounts,verbs=create;update,versions=v20250601,name=default.v20250601.accounts.cognitiveservices.azure.com,admissionReviewVersions=v1
...
func (account *Account) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cognitiveservices/v20250601/Account, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-cognitiveservices-azure-com-v20250601-account,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cognitiveservices.azure.com,resources=accounts,verbs=create;update,versions=v20250601,name=validate.v20250601.accounts.cognitiveservices.azure.com,admissionReviewVersions=v1
...
func (account *Account) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cognitiveservices/v20250601/Account, but got %T", resource)
	}
...
func (account *Account) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cognitiveservices/v20250601/Account, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20250601.Account)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cognitiveservices/v20250601/Account, but got %T", oldResource)
	}
