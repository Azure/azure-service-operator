...
func Test_VaultCreateOrUpdateParameters_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of VaultCreateOrUpdateParameters_STATUSARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForVaultCreateOrUpdateParameters_STATUSARM, VaultCreateOrUpdateParameters_STATUSARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVaultCreateOrUpdateParameters_STATUSARM runs a test to see if a specific instance of VaultCreateOrUpdateParameters_STATUSARM round trips to JSON and back losslessly
func RunJSONSerializationTestForVaultCreateOrUpdateParameters_STATUSARM(subject VaultCreateOrUpdateParameters_STATUSARM) string {
	// Serialize to JSON
	...
	var actual VaultCreateOrUpdateParameters_STATUSARM
...
// Generator of VaultCreateOrUpdateParameters_STATUSARM instances for property testing - lazily instantiated by
// VaultCreateOrUpdateParameters_STATUSARMGenerator()
var vaultCreateOrUpdateParameters_STATUSARMGenerator gopter.Gen

// VaultCreateOrUpdateParameters_STATUSARMGenerator returns a generator of VaultCreateOrUpdateParameters_STATUSARM instances for property testing.
// We first initialize vaultCreateOrUpdateParameters_STATUSARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func VaultCreateOrUpdateParameters_STATUSARMGenerator() gopter.Gen {
	if vaultCreateOrUpdateParameters_STATUSARMGenerator != nil {
		return vaultCreateOrUpdateParameters_STATUSARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM(generators)
	vaultCreateOrUpdateParameters_STATUSARMGenerator = gen.Struct(reflect.TypeOf(VaultCreateOrUpdateParameters_STATUSARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM(generators)
	AddRelatedPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM(generators)
	vaultCreateOrUpdateParameters_STATUSARMGenerator = gen.Struct(reflect.TypeOf(VaultCreateOrUpdateParameters_STATUSARM{}), generators)

	return vaultCreateOrUpdateParameters_STATUSARMGenerator
}

// AddIndependentPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForVaultCreateOrUpdateParameters_STATUSARM(gens map[string]gopter.Gen) {
