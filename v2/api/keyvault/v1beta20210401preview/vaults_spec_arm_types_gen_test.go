...
func Test_Vault_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/keyvault/v1beta20210401preview/vault__spec_arm_types_gen_test.go
...
========
		...
		prop.ForAll(RunJSONSerializationTestForVaults_SpecARM, Vaults_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVaults_SpecARM runs a test to see if a specific instance of Vaults_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForVaults_SpecARM(subject Vaults_SpecARM) string {
>>>>>>>> main:v2/api/keyvault/v1beta20210401preview/vaults_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
// Generator of Vaults_SpecARM instances for property testing - lazily instantiated by Vaults_SpecARMGenerator()
var vaults_SpecARMGenerator gopter.Gen

// Vaults_SpecARMGenerator returns a generator of Vaults_SpecARM instances for property testing.
// We first initialize vaults_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Vaults_SpecARMGenerator() gopter.Gen {
	if vaults_SpecARMGenerator != nil {
		return vaults_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVaults_SpecARM(generators)
	vaults_SpecARMGenerator = gen.Struct(reflect.TypeOf(Vaults_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVaults_SpecARM(generators)
	AddRelatedPropertyGeneratorsForVaults_SpecARM(generators)
	vaults_SpecARMGenerator = gen.Struct(reflect.TypeOf(Vaults_SpecARM{}), generators)

	return vaults_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForVaults_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVaults_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/keyvault/v1beta20210401preview/vaults_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForVaults_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForVaults_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/keyvault/v1beta20210401preview/vaults_spec_arm_types_gen_test.go
