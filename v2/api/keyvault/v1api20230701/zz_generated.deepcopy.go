...
func (in *AccessPolicyEntry_STATUS_ARM) DeepCopyInto(out *AccessPolicyEntry_STATUS_ARM) {
	*out = *in
	...
	if in.Permissions != nil {
		in, out := &in.Permissions, &out.Permissions
		*out = new(Permissions_STATUS_ARM)
		(*in).DeepCopyInto(*out)
	}
	if in.TenantId != nil {
		in, out := &in.TenantId, &out.TenantId
...
func (in *AccessPolicyEntry_STATUS_ARM) DeepCopy() *AccessPolicyEntry_STATUS_ARM {
	...
	out := new(AccessPolicyEntry_STATUS_ARM)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Permissions_ARM) DeepCopyInto(out *Permissions_ARM) {
	*out = *in
	if in.Certificates != nil {
		in, out := &in.Certificates, &out.Certificates
		*out = make([]Permissions_Certificates_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Keys != nil {
		in, out := &in.Keys, &out.Keys
		*out = make([]Permissions_Keys_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Secrets != nil {
		in, out := &in.Secrets, &out.Secrets
		*out = make([]Permissions_Secrets_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Storage != nil {
		in, out := &in.Storage, &out.Storage
		*out = make([]Permissions_Storage_ARM, len(*in))
		copy(*out, *in)
	}
}
...
func (in *Permissions_STATUS_ARM) DeepCopyInto(out *Permissions_STATUS_ARM) {
	*out = *in
	if in.Certificates != nil {
		in, out := &in.Certificates, &out.Certificates
		*out = make([]Permissions_Certificates_STATUS_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Keys != nil {
		in, out := &in.Keys, &out.Keys
		*out = make([]Permissions_Keys_STATUS_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Secrets != nil {
		in, out := &in.Secrets, &out.Secrets
		*out = make([]Permissions_Secrets_STATUS_ARM, len(*in))
		copy(*out, *in)
	}
	if in.Storage != nil {
		in, out := &in.Storage, &out.Storage
		*out = make([]Permissions_Storage_STATUS_ARM, len(*in))
		copy(*out, *in)
	}
}
...
func (in *PrivateEndpointConnectionItem_STATUS_ARM) DeepCopy() *PrivateEndpointConnectionItem_STATUS_ARM {
	...
	out := new(PrivateEndpointConnectionItem_STATUS_ARM)
	in.DeepCopyInto(out)
	return out
}
...
func (in *PrivateEndpointConnectionProperties_STATUS_ARM) DeepCopyInto(out *PrivateEndpointConnectionProperties_STATUS_ARM) {
	*out = *in
	...
	if in.ProvisioningState != nil {
		in, out := &in.ProvisioningState, &out.ProvisioningState
		*out = new(PrivateEndpointConnectionProvisioningState_STATUS_ARM)
		**out = **in
	}
}
...
func (in *PrivateLinkServiceConnectionState_STATUS_ARM) DeepCopyInto(out *PrivateLinkServiceConnectionState_STATUS_ARM) {
	*out = *in
	if in.ActionsRequired != nil {
		in, out := &in.ActionsRequired, &out.ActionsRequired
		*out = new(PrivateLinkServiceConnectionState_ActionsRequired_STATUS_ARM)
		**out = **in
	}
	if in.Description != nil {
		in, out := &in.Description, &out.Description
...
func (in *VaultProperties_ARM) DeepCopyInto(out *VaultProperties_ARM) {
	*out = *in
	if in.AccessPolicies != nil {
		in, out := &in.AccessPolicies, &out.AccessPolicies
		*out = make([]AccessPolicyEntry_ARM, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CreateMode != nil {
		in, out := &in.CreateMode, &out.CreateMode
		*out = new(VaultProperties_CreateMode_ARM)
		**out = **in
	}
	if in.EnablePurgeProtection != nil {
		in, out := &in.EnablePurgeProtection, &out.EnablePurgeProtection
	...
	if in.ProvisioningState != nil {
		in, out := &in.ProvisioningState, &out.ProvisioningState
		*out = new(VaultProperties_ProvisioningState_ARM)
		**out = **in
	}
	if in.PublicNetworkAccess != nil {
		in, out := &in.PublicNetworkAccess, &out.PublicNetworkAccess
...
func (in *VaultProperties_STATUS_ARM) DeepCopyInto(out *VaultProperties_STATUS_ARM) {
	*out = *in
	if in.AccessPolicies != nil {
		in, out := &in.AccessPolicies, &out.AccessPolicies
		*out = make([]AccessPolicyEntry_STATUS_ARM, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.CreateMode != nil {
		in, out := &in.CreateMode, &out.CreateMode
		*out = new(VaultProperties_CreateMode_STATUS_ARM)
		**out = **in
	}
	if in.EnablePurgeProtection != nil {
		in, out := &in.EnablePurgeProtection, &out.EnablePurgeProtection
	...
	if in.PrivateEndpointConnections != nil {
		in, out := &in.PrivateEndpointConnections, &out.PrivateEndpointConnections
		*out = make([]PrivateEndpointConnectionItem_STATUS_ARM, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.ProvisioningState != nil {
		in, out := &in.ProvisioningState, &out.ProvisioningState
		*out = new(VaultProperties_ProvisioningState_STATUS_ARM)
		**out = **in
	}
	if in.PublicNetworkAccess != nil {
		in, out := &in.PublicNetworkAccess, &out.PublicNetworkAccess
...
func (in *VaultProperties_STATUS_ARM) DeepCopy() *VaultProperties_STATUS_ARM {
	...
	out := new(VaultProperties_STATUS_ARM)
	in.DeepCopyInto(out)
	return out
}
