...
const (
	Permissions_Certificates_ARM_All            = Permissions_Certificates_ARM("all")
...
var permissions_Certificates_ARM_Values = map[string]Permissions_Certificates_ARM{
	"all":            Permissions_Certificates_ARM_All,
...
const (
	Permissions_Keys_ARM_All               = Permissions_Keys_ARM("all")
	...
	Permissions_Keys_ARM_Getrotationpolicy = Permissions_Keys_ARM("getrotationpolicy")
	...
	Permissions_Keys_ARM_Rotate            = Permissions_Keys_ARM("rotate")
	Permissions_Keys_ARM_Setrotationpolicy = Permissions_Keys_ARM("setrotationpolicy")
...
var permissions_Keys_ARM_Values = map[string]Permissions_Keys_ARM{
	...
	"getrotationpolicy": Permissions_Keys_ARM_Getrotationpolicy,
	...
	"rotate":            Permissions_Keys_ARM_Rotate,
	"setrotationpolicy": Permissions_Keys_ARM_Setrotationpolicy,
...
const (
	Permissions_Secrets_ARM_All     = Permissions_Secrets_ARM("all")
...
var permissions_Secrets_ARM_Values = map[string]Permissions_Secrets_ARM{
	"all":     Permissions_Secrets_ARM_All,
...
const (
	Permissions_Storage_ARM_All           = Permissions_Storage_ARM("all")
