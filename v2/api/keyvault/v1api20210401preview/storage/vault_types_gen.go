...
type augmentConversionForVault interface {
	AssignPropertiesFrom(src *v20220701s.Vault) error
	AssignPropertiesTo(dst *v20220701s.Vault) error
}
...
type augmentConversionForVault_Spec interface {
	AssignPropertiesFrom(src *v20220701s.Vault_Spec) error
	AssignPropertiesTo(dst *v20220701s.Vault_Spec) error
}

type augmentConversionForVault_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.Vault_STATUS) error
	AssignPropertiesTo(dst *v20220701s.Vault_STATUS) error
}
...
type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20220701s.SystemData_STATUS) error
}

type augmentConversionForVaultProperties interface {
	AssignPropertiesFrom(src *v20220701s.VaultProperties) error
	AssignPropertiesTo(dst *v20220701s.VaultProperties) error
}

type augmentConversionForVaultProperties_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.VaultProperties_STATUS) error
	AssignPropertiesTo(dst *v20220701s.VaultProperties_STATUS) error
}
...
type augmentConversionForAccessPolicyEntry interface {
	AssignPropertiesFrom(src *v20220701s.AccessPolicyEntry) error
	AssignPropertiesTo(dst *v20220701s.AccessPolicyEntry) error
}

type augmentConversionForAccessPolicyEntry_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.AccessPolicyEntry_STATUS) error
	AssignPropertiesTo(dst *v20220701s.AccessPolicyEntry_STATUS) error
}

type augmentConversionForNetworkRuleSet interface {
	AssignPropertiesFrom(src *v20220701s.NetworkRuleSet) error
	AssignPropertiesTo(dst *v20220701s.NetworkRuleSet) error
}

type augmentConversionForNetworkRuleSet_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.NetworkRuleSet_STATUS) error
	AssignPropertiesTo(dst *v20220701s.NetworkRuleSet_STATUS) error
}

type augmentConversionForPrivateEndpointConnectionItem_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.PrivateEndpointConnectionItem_STATUS) error
	AssignPropertiesTo(dst *v20220701s.PrivateEndpointConnectionItem_STATUS) error
}

type augmentConversionForSku interface {
	AssignPropertiesFrom(src *v20220701s.Sku) error
	AssignPropertiesTo(dst *v20220701s.Sku) error
}

type augmentConversionForSku_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.Sku_STATUS) error
	AssignPropertiesTo(dst *v20220701s.Sku_STATUS) error
}
...
type augmentConversionForIPRule interface {
	AssignPropertiesFrom(src *v20220701s.IPRule) error
	AssignPropertiesTo(dst *v20220701s.IPRule) error
}

type augmentConversionForIPRule_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.IPRule_STATUS) error
	AssignPropertiesTo(dst *v20220701s.IPRule_STATUS) error
}

type augmentConversionForPermissions interface {
	AssignPropertiesFrom(src *v20220701s.Permissions) error
	AssignPropertiesTo(dst *v20220701s.Permissions) error
}

type augmentConversionForPermissions_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.Permissions_STATUS) error
	AssignPropertiesTo(dst *v20220701s.Permissions_STATUS) error
}

type augmentConversionForPrivateEndpoint_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.PrivateEndpoint_STATUS) error
	AssignPropertiesTo(dst *v20220701s.PrivateEndpoint_STATUS) error
}

type augmentConversionForPrivateLinkServiceConnectionState_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.PrivateLinkServiceConnectionState_STATUS) error
	AssignPropertiesTo(dst *v20220701s.PrivateLinkServiceConnectionState_STATUS) error
}

type augmentConversionForVirtualNetworkRule interface {
	AssignPropertiesFrom(src *v20220701s.VirtualNetworkRule) error
	AssignPropertiesTo(dst *v20220701s.VirtualNetworkRule) error
}

type augmentConversionForVirtualNetworkRule_STATUS interface {
	AssignPropertiesFrom(src *v20220701s.VirtualNetworkRule_STATUS) error
	AssignPropertiesTo(dst *v20220701s.VirtualNetworkRule_STATUS) error
}
