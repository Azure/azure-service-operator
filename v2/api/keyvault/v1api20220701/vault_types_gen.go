...
func (vault *Vault) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220701s.Vault)
	if !ok {
		return fmt.Errorf("expected keyvault/v1api20220701/storage/Vault but received %T instead", hub)
	}
...
func (vault *Vault) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220701s.Vault)
	if !ok {
		return fmt.Errorf("expected keyvault/v1api20220701/storage/Vault but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-keyvault-azure-com-v1api20220701-vault,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=keyvault.azure.com,resources=vaults,verbs=create;update,versions=v1api20220701,name=default.v1api20220701.vaults.keyvault.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-keyvault-azure-com-v1api20220701-vault,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=keyvault.azure.com,resources=vaults,verbs=create;update,versions=v1api20220701,name=validate.v1api20220701.vaults.keyvault.azure.com,admissionReviewVersions=v1
...
func (vault *Vault) AssignProperties_From_Vault(source *v20220701s.Vault) error {
...
func (vault *Vault) AssignProperties_To_Vault(destination *v20220701s.Vault) error {

	// ObjectMeta
	destination.ObjectMeta = *vault.ObjectMeta.DeepCopy()

	// Spec
	var spec v20220701s.Vault_Spec
	...
	// Status
	var status v20220701s.Vault_STATUS
...
func (vault *Vault_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20220701s.Vault_Spec)
	if ok {
...
func (vault *Vault_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20220701s.Vault_Spec)
	if ok {
...
func (vault *Vault_Spec) AssignProperties_From_Vault_Spec(source *v20220701s.Vault_Spec) error {
...
func (vault *Vault_Spec) AssignProperties_To_Vault_Spec(destination *v20220701s.Vault_Spec) error {
	...
	// Properties
	if vault.Properties != nil {
		var property v20220701s.VaultProperties
...
func (vault *Vault_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20220701s.Vault_STATUS)
	if ok {
		// Populate our instance from source
...
func (vault *Vault_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20220701s.Vault_STATUS)
	if ok {
		// Populate destination from our instance
...
func (vault *Vault_STATUS) AssignProperties_From_Vault_STATUS(source *v20220701s.Vault_STATUS) error {
...
func (vault *Vault_STATUS) AssignProperties_To_Vault_STATUS(destination *v20220701s.Vault_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Properties
	if vault.Properties != nil {
		var property v20220701s.VaultProperties_STATUS
...
func (properties *VaultProperties) AssignProperties_From_VaultProperties(source *v20220701s.VaultProperties) error {
...
func (properties *VaultProperties) AssignProperties_To_VaultProperties(destination *v20220701s.VaultProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AccessPolicies
	if properties.AccessPolicies != nil {
		accessPolicyList := make([]v20220701s.AccessPolicyEntry, len(properties.AccessPolicies))
		for accessPolicyIndex, accessPolicyItem := range properties.AccessPolicies {
			// Shadow the loop variable to avoid aliasing
			accessPolicyItem := accessPolicyItem
			var accessPolicy v20220701s.AccessPolicyEntry
	...
	// NetworkAcls
	if properties.NetworkAcls != nil {
		var networkAcl v20220701s.NetworkRuleSet
...
func (properties *VaultProperties_STATUS) AssignProperties_From_VaultProperties_STATUS(source *v20220701s.VaultProperties_STATUS) error {
...
func (properties *VaultProperties_STATUS) AssignProperties_To_VaultProperties_STATUS(destination *v20220701s.VaultProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AccessPolicies
	if properties.AccessPolicies != nil {
		accessPolicyList := make([]v20220701s.AccessPolicyEntry_STATUS, len(properties.AccessPolicies))
		for accessPolicyIndex, accessPolicyItem := range properties.AccessPolicies {
			// Shadow the loop variable to avoid aliasing
			accessPolicyItem := accessPolicyItem
			var accessPolicy v20220701s.AccessPolicyEntry_STATUS
	...
	// NetworkAcls
	if properties.NetworkAcls != nil {
		var networkAcl v20220701s.NetworkRuleSet_STATUS
	...
	if properties.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v20220701s.PrivateEndpointConnectionItem_STATUS, len(properties.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range properties.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v20220701s.PrivateEndpointConnectionItem_STATUS
...
func (entry *AccessPolicyEntry) AssignProperties_From_AccessPolicyEntry(source *v20220701s.AccessPolicyEntry) error {
...
func (entry *AccessPolicyEntry) AssignProperties_To_AccessPolicyEntry(destination *v20220701s.AccessPolicyEntry) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Permissions
	if entry.Permissions != nil {
		var permission v20220701s.Permissions
...
func (entry *AccessPolicyEntry_STATUS) AssignProperties_From_AccessPolicyEntry_STATUS(source *v20220701s.AccessPolicyEntry_STATUS) error {
...
func (entry *AccessPolicyEntry_STATUS) AssignProperties_To_AccessPolicyEntry_STATUS(destination *v20220701s.AccessPolicyEntry_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Permissions
	if entry.Permissions != nil {
		var permission v20220701s.Permissions_STATUS
...
func (ruleSet *NetworkRuleSet) AssignProperties_From_NetworkRuleSet(source *v20220701s.NetworkRuleSet) error {
...
func (ruleSet *NetworkRuleSet) AssignProperties_To_NetworkRuleSet(destination *v20220701s.NetworkRuleSet) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if ruleSet.IpRules != nil {
		ipRuleList := make([]v20220701s.IPRule, len(ruleSet.IpRules))
		for ipRuleIndex, ipRuleItem := range ruleSet.IpRules {
			// Shadow the loop variable to avoid aliasing
			ipRuleItem := ipRuleItem
			var ipRule v20220701s.IPRule
	...
	if ruleSet.VirtualNetworkRules != nil {
		virtualNetworkRuleList := make([]v20220701s.VirtualNetworkRule, len(ruleSet.VirtualNetworkRules))
		for virtualNetworkRuleIndex, virtualNetworkRuleItem := range ruleSet.VirtualNetworkRules {
			// Shadow the loop variable to avoid aliasing
			virtualNetworkRuleItem := virtualNetworkRuleItem
			var virtualNetworkRule v20220701s.VirtualNetworkRule
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_From_NetworkRuleSet_STATUS(source *v20220701s.NetworkRuleSet_STATUS) error {
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_To_NetworkRuleSet_STATUS(destination *v20220701s.NetworkRuleSet_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// IpRules
	if ruleSet.IpRules != nil {
		ipRuleList := make([]v20220701s.IPRule_STATUS, len(ruleSet.IpRules))
		for ipRuleIndex, ipRuleItem := range ruleSet.IpRules {
			// Shadow the loop variable to avoid aliasing
			ipRuleItem := ipRuleItem
			var ipRule v20220701s.IPRule_STATUS
	...
	// VirtualNetworkRules
	if ruleSet.VirtualNetworkRules != nil {
		virtualNetworkRuleList := make([]v20220701s.VirtualNetworkRule_STATUS, len(ruleSet.VirtualNetworkRules))
		for virtualNetworkRuleIndex, virtualNetworkRuleItem := range ruleSet.VirtualNetworkRules {
			// Shadow the loop variable to avoid aliasing
			virtualNetworkRuleItem := virtualNetworkRuleItem
			var virtualNetworkRule v20220701s.VirtualNetworkRule_STATUS
...
func (item *PrivateEndpointConnectionItem_STATUS) AssignProperties_From_PrivateEndpointConnectionItem_STATUS(source *v20220701s.PrivateEndpointConnectionItem_STATUS) error {
...
func (item *PrivateEndpointConnectionItem_STATUS) AssignProperties_To_PrivateEndpointConnectionItem_STATUS(destination *v20220701s.PrivateEndpointConnectionItem_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if item.PrivateEndpoint != nil {
		var privateEndpoint v20220701s.PrivateEndpoint_STATUS
...
func (rule *IPRule) AssignProperties_From_IPRule(source *v20220701s.IPRule) error {
...
func (rule *IPRule) AssignProperties_To_IPRule(destination *v20220701s.IPRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *IPRule_STATUS) AssignProperties_From_IPRule_STATUS(source *v20220701s.IPRule_STATUS) error {
...
func (rule *IPRule_STATUS) AssignProperties_To_IPRule_STATUS(destination *v20220701s.IPRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (permissions *Permissions) AssignProperties_From_Permissions(source *v20220701s.Permissions) error {
...
func (permissions *Permissions) AssignProperties_To_Permissions(destination *v20220701s.Permissions) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (permissions *Permissions_STATUS) AssignProperties_From_Permissions_STATUS(source *v20220701s.Permissions_STATUS) error {
...
func (permissions *Permissions_STATUS) AssignProperties_To_Permissions_STATUS(destination *v20220701s.Permissions_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (endpoint *PrivateEndpoint_STATUS) AssignProperties_From_PrivateEndpoint_STATUS(source *v20220701s.PrivateEndpoint_STATUS) error {
...
func (endpoint *PrivateEndpoint_STATUS) AssignProperties_To_PrivateEndpoint_STATUS(destination *v20220701s.PrivateEndpoint_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *VirtualNetworkRule) AssignProperties_From_VirtualNetworkRule(source *v20220701s.VirtualNetworkRule) error {
...
func (rule *VirtualNetworkRule) AssignProperties_To_VirtualNetworkRule(destination *v20220701s.VirtualNetworkRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *VirtualNetworkRule_STATUS) AssignProperties_From_VirtualNetworkRule_STATUS(source *v20220701s.VirtualNetworkRule_STATUS) error {
...
func (rule *VirtualNetworkRule_STATUS) AssignProperties_To_VirtualNetworkRule_STATUS(destination *v20220701s.VirtualNetworkRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
