...
func (in *SearchServiceProperties_ARM) DeepCopyInto(out *SearchServiceProperties_ARM) {
	*out = *in
	...
	if in.DisabledDataExfiltrationOptions != nil {
		in, out := &in.DisabledDataExfiltrationOptions, &out.DisabledDataExfiltrationOptions
		*out = make([]DisabledDataExfiltrationOption, len(*in))
		copy(*out, *in)
	}
...
func (in *SearchServiceProperties_STATUS_ARM) DeepCopyInto(out *SearchServiceProperties_STATUS_ARM) {
	*out = *in
	...
	if in.DisabledDataExfiltrationOptions != nil {
		in, out := &in.DisabledDataExfiltrationOptions, &out.DisabledDataExfiltrationOptions
		*out = make([]DisabledDataExfiltrationOption_STATUS, len(*in))
		copy(*out, *in)
	}
	if in.ETag != nil {
