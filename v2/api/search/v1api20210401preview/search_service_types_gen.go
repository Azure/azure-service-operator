...
// - Generated from: /search/resource-manager/Microsoft.Search/preview/2021-04-01-preview/search.json
...
func (service *SearchService) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20210401ps.SearchService)
	if !ok {
		return fmt.Errorf("expected search/v1api20210401previewstorage/SearchService but received %T instead", hub)
	}
...
func (service *SearchService) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20210401ps.SearchService)
	if !ok {
		return fmt.Errorf("expected search/v1api20210401previewstorage/SearchService but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-search-azure-com-v1api20210401preview-searchservice,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=search.azure.com,resources=searchservices,verbs=create;update,versions=v1api20210401preview,name=default.v1api20210401preview.searchservices.search.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-search-azure-com-v1api20210401preview-searchservice,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=search.azure.com,resources=searchservices,verbs=create;update,versions=v1api20210401preview,name=validate.v1api20210401preview.searchservices.search.azure.com,admissionReviewVersions=v1
...
func (service *SearchService) AssignProperties_From_SearchService(source *v1api20210401ps.SearchService) error {
...
func (service *SearchService) AssignProperties_To_SearchService(destination *v1api20210401ps.SearchService) error {

	// ObjectMeta
	destination.ObjectMeta = *service.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20210401ps.SearchService_Spec
	...
	// Status
	var status v1api20210401ps.SearchService_STATUS
...
type SearchService_Spec struct {
	...
	// DisabledDataExfiltrationOptions: A list of data exfiltration scenarios that are explicitly disallowed for the search
	// service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine
	// grained controls planned for the future.
	DisabledDataExfiltrationOptions []DisabledDataExfiltrationOption `json:"disabledDataExfiltrationOptions,omitempty"`
	...
	// certain Azure Cognitive Search SKUs in certain locations.
...
func (service *SearchService_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if service.AuthOptions != nil ||
		...
		service.DisabledDataExfiltrationOptions != nil ||
	...
	for _, item := range service.DisabledDataExfiltrationOptions {
		result.Properties.DisabledDataExfiltrationOptions = append(result.Properties.DisabledDataExfiltrationOptions, item)
	}
	...
	if service.SemanticSearch != nil {
		semanticSearch := *service.SemanticSearch
		result.Properties.SemanticSearch = &semanticSearch
	}
...
func (service *SearchService_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property ‘DisabledDataExfiltrationOptions’:
	// copying flattened property:
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.DisabledDataExfiltrationOptions {
			service.DisabledDataExfiltrationOptions = append(service.DisabledDataExfiltrationOptions, item)
		}
	}
	...
	// Set property ‘SemanticSearch’:
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.SemanticSearch != nil {
			semanticSearch := *typedInput.Properties.SemanticSearch
			service.SemanticSearch = &semanticSearch
		}
	}
...
func (service *SearchService_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20210401ps.SearchService_Spec)
	if ok {
	...
	src = &v1api20210401ps.SearchService_Spec{}
...
func (service *SearchService_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20210401ps.SearchService_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20210401ps.SearchService_Spec{}
...
func (service *SearchService_Spec) AssignProperties_From_SearchService_Spec(source *v1api20210401ps.SearchService_Spec) error {
	...
	if source.DisabledDataExfiltrationOptions != nil {
		disabledDataExfiltrationOptionList := make([]DisabledDataExfiltrationOption, len(source.DisabledDataExfiltrationOptions))
		for disabledDataExfiltrationOptionIndex, disabledDataExfiltrationOptionItem := range source.DisabledDataExfiltrationOptions {
			// Shadow the loop variable to avoid aliasing
			disabledDataExfiltrationOptionItem := disabledDataExfiltrationOptionItem
			disabledDataExfiltrationOptionList[disabledDataExfiltrationOptionIndex] = DisabledDataExfiltrationOption(disabledDataExfiltrationOptionItem)
		}
		service.DisabledDataExfiltrationOptions = disabledDataExfiltrationOptionList
	} else {
		service.DisabledDataExfiltrationOptions = nil
	}
	...
	if source.SemanticSearch != nil {
		semanticSearch := SemanticSearch(*source.SemanticSearch)
		service.SemanticSearch = &semanticSearch
	} else {
		service.SemanticSearch = nil
	}
...
func (service *SearchService_Spec) AssignProperties_To_SearchService_Spec(destination *v1api20210401ps.SearchService_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AuthOptions
	if service.AuthOptions != nil {
		var authOption v1api20210401ps.DataPlaneAuthOptions
	...
	// DisabledDataExfiltrationOptions
	if service.DisabledDataExfiltrationOptions != nil {
		disabledDataExfiltrationOptionList := make([]string, len(service.DisabledDataExfiltrationOptions))
		for disabledDataExfiltrationOptionIndex, disabledDataExfiltrationOptionItem := range service.DisabledDataExfiltrationOptions {
			// Shadow the loop variable to avoid aliasing
			disabledDataExfiltrationOptionItem := disabledDataExfiltrationOptionItem
			disabledDataExfiltrationOptionList[disabledDataExfiltrationOptionIndex] = string(disabledDataExfiltrationOptionItem)
		}
		destination.DisabledDataExfiltrationOptions = disabledDataExfiltrationOptionList
	} else {
		destination.DisabledDataExfiltrationOptions = nil
	}

	// EncryptionWithCmk
	if service.EncryptionWithCmk != nil {
		var encryptionWithCmk v1api20210401ps.EncryptionWithCmk
	...
	// Identity
	if service.Identity != nil {
		var identity v1api20210401ps.Identity
	...
	// NetworkRuleSet
	if service.NetworkRuleSet != nil {
		var networkRuleSet v1api20210401ps.NetworkRuleSet
	...
	// SemanticSearch
	if service.SemanticSearch != nil {
		semanticSearch := string(*service.SemanticSearch)
...
func (service *SearchService_Spec) Initialize_From_SearchService_STATUS(source *SearchService_STATUS) error {
	...
	if source.DisabledDataExfiltrationOptions != nil {
		...
		for disabledDataExfiltrationOptionIndex, disabledDataExfiltrationOptionItem := range source.DisabledDataExfiltrationOptions {
			// Shadow the loop variable to avoid aliasing
			disabledDataExfiltrationOptionItem := disabledDataExfiltrationOptionItem
			disabledDataExfiltrationOption := DisabledDataExfiltrationOption(disabledDataExfiltrationOptionItem)
			disabledDataExfiltrationOptionList[disabledDataExfiltrationOptionIndex] = disabledDataExfiltrationOption
		}
		service.DisabledDataExfiltrationOptions = disabledDataExfiltrationOptionList
	} else {
		service.DisabledDataExfiltrationOptions = nil
...
type SearchService_STATUS struct {
	...
	// service. Currently, the only supported value is 'All' to disable all possible data export scenarios with more fine
	// grained controls planned for the future.
	DisabledDataExfiltrationOptions []DisabledDataExfiltrationOption_STATUS `json:"disabledDataExfiltrationOptions,omitempty"`

	// ETag: A system generated property representing the service's etag that can be for optimistic concurrency control during
	// updates.
	...
	// SemanticSearch: Sets options that control the availability of semantic search. This configuration is only possible for
	// certain Azure Cognitive Search SKUs in certain locations.
	SemanticSearch *SemanticSearch_STATUS `json:"semanticSearch,omitempty"`
	...
	// all API requests. 'error': The search service is in an error state. 'stopped': The search service is in a subscription
	// that's disabled. If your service is in the degraded, disabled, or error states, it means the Azure Cognitive Search team
	// is actively investigating the underlying issue. Dedicated services in these states are still chargeable based on the
...
func (service *SearchService_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20210401ps.SearchService_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20210401ps.SearchService_STATUS{}
...
func (service *SearchService_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20210401ps.SearchService_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20210401ps.SearchService_STATUS{}
...
func (service *SearchService_STATUS) AssignProperties_From_SearchService_STATUS(source *v1api20210401ps.SearchService_STATUS) error {
	...
	// DisabledDataExfiltrationOptions
	if source.DisabledDataExfiltrationOptions != nil {
		disabledDataExfiltrationOptionList := make([]DisabledDataExfiltrationOption_STATUS, len(source.DisabledDataExfiltrationOptions))
		for disabledDataExfiltrationOptionIndex, disabledDataExfiltrationOptionItem := range source.DisabledDataExfiltrationOptions {
			// Shadow the loop variable to avoid aliasing
			disabledDataExfiltrationOptionItem := disabledDataExfiltrationOptionItem
			disabledDataExfiltrationOptionList[disabledDataExfiltrationOptionIndex] = DisabledDataExfiltrationOption_STATUS(disabledDataExfiltrationOptionItem)
		}
		service.DisabledDataExfiltrationOptions = disabledDataExfiltrationOptionList
	} else {
		service.DisabledDataExfiltrationOptions = nil
	...
	// SemanticSearch
	if source.SemanticSearch != nil {
		semanticSearch := SemanticSearch_STATUS(*source.SemanticSearch)
		service.SemanticSearch = &semanticSearch
	} else {
		service.SemanticSearch = nil
	}
...
func (service *SearchService_STATUS) AssignProperties_To_SearchService_STATUS(destination *v1api20210401ps.SearchService_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AuthOptions
	if service.AuthOptions != nil {
		var authOption v1api20210401ps.DataPlaneAuthOptions_STATUS
	...
	// EncryptionWithCmk
	if service.EncryptionWithCmk != nil {
		var encryptionWithCmk v1api20210401ps.EncryptionWithCmk_STATUS
	...
	// Identity
	if service.Identity != nil {
		var identity v1api20210401ps.Identity_STATUS
	...
	// NetworkRuleSet
	if service.NetworkRuleSet != nil {
		var networkRuleSet v1api20210401ps.NetworkRuleSet_STATUS
	...
	if service.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v1api20210401ps.PrivateEndpointConnection_STATUS, len(service.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range service.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v1api20210401ps.PrivateEndpointConnection_STATUS
	...
	if service.SharedPrivateLinkResources != nil {
		sharedPrivateLinkResourceList := make([]v1api20210401ps.SharedPrivateLinkResource_STATUS, len(service.SharedPrivateLinkResources))
		for sharedPrivateLinkResourceIndex, sharedPrivateLinkResourceItem := range service.SharedPrivateLinkResources {
			// Shadow the loop variable to avoid aliasing
			sharedPrivateLinkResourceItem := sharedPrivateLinkResourceItem
			var sharedPrivateLinkResource v1api20210401ps.SharedPrivateLinkResource_STATUS
	...
	// Sku
	if service.Sku != nil {
		var sku v1api20210401ps.Sku_STATUS
...
func (options *DataPlaneAuthOptions) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if options.ApiKeyOnly != nil {
		result.ApiKeyOnly = make(map[string]v1.JSON, len(options.ApiKeyOnly))
		for key, value := range options.ApiKeyOnly {
			result.ApiKeyOnly[key] = *value.DeepCopy()
		}
	}
	return result, nil
}
...
func (options *DataPlaneAuthOptions) AssignProperties_From_DataPlaneAuthOptions(source *v1api20210401ps.DataPlaneAuthOptions) error {
...
func (options *DataPlaneAuthOptions) AssignProperties_To_DataPlaneAuthOptions(destination *v1api20210401ps.DataPlaneAuthOptions) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AadOrApiKey
	if options.AadOrApiKey != nil {
		var aadOrApiKey v1api20210401ps.DataPlaneAadOrApiKeyAuthOption
...
func (options *DataPlaneAuthOptions_STATUS) AssignProperties_From_DataPlaneAuthOptions_STATUS(source *v1api20210401ps.DataPlaneAuthOptions_STATUS) error {
...
func (options *DataPlaneAuthOptions_STATUS) AssignProperties_To_DataPlaneAuthOptions_STATUS(destination *v1api20210401ps.DataPlaneAuthOptions_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AadOrApiKey
	if options.AadOrApiKey != nil {
		var aadOrApiKey v1api20210401ps.DataPlaneAadOrApiKeyAuthOption_STATUS
...
type DisabledDataExfiltrationOption string

const DisabledDataExfiltrationOption_All = DisabledDataExfiltrationOption("All")

// A specific data exfiltration scenario that is disabled for the service.
type DisabledDataExfiltrationOption_STATUS string

const DisabledDataExfiltrationOption_STATUS_All = DisabledDataExfiltrationOption_STATUS("All")
...
func (withCmk *EncryptionWithCmk) AssignProperties_From_EncryptionWithCmk(source *v1api20210401ps.EncryptionWithCmk) error {
...
func (withCmk *EncryptionWithCmk) AssignProperties_To_EncryptionWithCmk(destination *v1api20210401ps.EncryptionWithCmk) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (withCmk *EncryptionWithCmk_STATUS) AssignProperties_From_EncryptionWithCmk_STATUS(source *v1api20210401ps.EncryptionWithCmk_STATUS) error {
...
func (withCmk *EncryptionWithCmk_STATUS) AssignProperties_To_EncryptionWithCmk_STATUS(destination *v1api20210401ps.EncryptionWithCmk_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
type Identity struct {
	// +kubebuilder:validation:Required
	// Type: The type of identity used for the resource. The type 'SystemAssigned, UserAssigned' includes both an identity
...
func (identity *Identity) AssignProperties_From_Identity(source *v1api20210401ps.Identity) error {
...
func (identity *Identity) AssignProperties_To_Identity(destination *v1api20210401ps.Identity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v1api20210401ps.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v1api20210401ps.UserAssignedIdentityDetails
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v1api20210401ps.Identity_STATUS) error {
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v1api20210401ps.Identity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v1api20210401ps.UserAssignedManagedIdentity_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v1api20210401ps.UserAssignedManagedIdentity_STATUS
...
func (ruleSet *NetworkRuleSet) AssignProperties_From_NetworkRuleSet(source *v1api20210401ps.NetworkRuleSet) error {
...
func (ruleSet *NetworkRuleSet) AssignProperties_To_NetworkRuleSet(destination *v1api20210401ps.NetworkRuleSet) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if ruleSet.IpRules != nil {
		ipRuleList := make([]v1api20210401ps.IpRule, len(ruleSet.IpRules))
		for ipRuleIndex, ipRuleItem := range ruleSet.IpRules {
			// Shadow the loop variable to avoid aliasing
			ipRuleItem := ipRuleItem
			var ipRule v1api20210401ps.IpRule
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_From_NetworkRuleSet_STATUS(source *v1api20210401ps.NetworkRuleSet_STATUS) error {
...
func (ruleSet *NetworkRuleSet_STATUS) AssignProperties_To_NetworkRuleSet_STATUS(destination *v1api20210401ps.NetworkRuleSet_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// IpRules
	if ruleSet.IpRules != nil {
		ipRuleList := make([]v1api20210401ps.IpRule_STATUS, len(ruleSet.IpRules))
		for ipRuleIndex, ipRuleItem := range ruleSet.IpRules {
			// Shadow the loop variable to avoid aliasing
			ipRuleItem := ipRuleItem
			var ipRule v1api20210401ps.IpRule_STATUS
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_From_PrivateEndpointConnection_STATUS(source *v1api20210401ps.PrivateEndpointConnection_STATUS) error {
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_To_PrivateEndpointConnection_STATUS(destination *v1api20210401ps.PrivateEndpointConnection_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// +kubebuilder:validation:Enum={"disabled","free","standard"}
type SemanticSearch string

const (
	SemanticSearch_Disabled = SemanticSearch("disabled")
	SemanticSearch_Free     = SemanticSearch("free")
	SemanticSearch_Standard = SemanticSearch("standard")
)

// Sets options that control the availability of semantic search. This configuration is only possible for certain Azure
// Cognitive Search SKUs in certain locations.
type SemanticSearch_STATUS string

const (
	SemanticSearch_STATUS_Disabled = SemanticSearch_STATUS("disabled")
	SemanticSearch_STATUS_Free     = SemanticSearch_STATUS("free")
	SemanticSearch_STATUS_Standard = SemanticSearch_STATUS("standard")
)
...
func (resource *SharedPrivateLinkResource_STATUS) AssignProperties_From_SharedPrivateLinkResource_STATUS(source *v1api20210401ps.SharedPrivateLinkResource_STATUS) error {
...
func (resource *SharedPrivateLinkResource_STATUS) AssignProperties_To_SharedPrivateLinkResource_STATUS(destination *v1api20210401ps.SharedPrivateLinkResource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sku *Sku) AssignProperties_From_Sku(source *v1api20210401ps.Sku) error {
...
func (sku *Sku) AssignProperties_To_Sku(destination *v1api20210401ps.Sku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sku *Sku_STATUS) AssignProperties_From_Sku_STATUS(source *v1api20210401ps.Sku_STATUS) error {
...
func (sku *Sku_STATUS) AssignProperties_To_Sku_STATUS(destination *v1api20210401ps.Sku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (option *DataPlaneAadOrApiKeyAuthOption) AssignProperties_From_DataPlaneAadOrApiKeyAuthOption(source *v1api20210401ps.DataPlaneAadOrApiKeyAuthOption) error {
...
func (option *DataPlaneAadOrApiKeyAuthOption) AssignProperties_To_DataPlaneAadOrApiKeyAuthOption(destination *v1api20210401ps.DataPlaneAadOrApiKeyAuthOption) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (option *DataPlaneAadOrApiKeyAuthOption_STATUS) AssignProperties_From_DataPlaneAadOrApiKeyAuthOption_STATUS(source *v1api20210401ps.DataPlaneAadOrApiKeyAuthOption_STATUS) error {
...
func (option *DataPlaneAadOrApiKeyAuthOption_STATUS) AssignProperties_To_DataPlaneAadOrApiKeyAuthOption_STATUS(destination *v1api20210401ps.DataPlaneAadOrApiKeyAuthOption_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *IpRule) AssignProperties_From_IpRule(source *v1api20210401ps.IpRule) error {
...
func (rule *IpRule) AssignProperties_To_IpRule(destination *v1api20210401ps.IpRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *IpRule_STATUS) AssignProperties_From_IpRule_STATUS(source *v1api20210401ps.IpRule_STATUS) error {
...
func (rule *IpRule_STATUS) AssignProperties_To_IpRule_STATUS(destination *v1api20210401ps.IpRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// +kubebuilder:validation:Enum={"AzurePortal","None"}
type NetworkRuleSet_Bypass string

const (
	NetworkRuleSet_Bypass_AzurePortal = NetworkRuleSet_Bypass("AzurePortal")
...
const (
	NetworkRuleSet_Bypass_STATUS_AzurePortal = NetworkRuleSet_Bypass_STATUS("AzurePortal")
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v1api20210401ps.UserAssignedIdentityDetails) error {
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v1api20210401ps.UserAssignedIdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *UserAssignedManagedIdentity_STATUS) AssignProperties_From_UserAssignedManagedIdentity_STATUS(source *v1api20210401ps.UserAssignedManagedIdentity_STATUS) error {
...
func (identity *UserAssignedManagedIdentity_STATUS) AssignProperties_To_UserAssignedManagedIdentity_STATUS(destination *v1api20210401ps.UserAssignedManagedIdentity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
