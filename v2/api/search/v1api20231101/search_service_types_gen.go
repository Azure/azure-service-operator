...
import (
	"context"
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/search/v1api20231101/arm"
...
// - Generated from: /search/resource-manager/Microsoft.Search/stable/2023-11-01/search.json
...
type SearchService_Spec struct {
	...
	// NetworkRuleSet: Network-specific rules that determine how the search service may be reached.
...
func (service *SearchService_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if service.SemanticSearch != nil {
		var temp string
		temp = string(*service.SemanticSearch)
		semanticSearch := arm.SemanticSearch(temp)
...
func (service *SearchService_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.SemanticSearch != nil {
			var temp string
			temp = string(*typedInput.Properties.SemanticSearch)
			semanticSearch := SemanticSearch(temp)
...
func (service *SearchService_Spec) AssignProperties_From_SearchService_Spec(source *storage.SearchService_Spec) error {
	...
	if source.SemanticSearch != nil {
		semanticSearch := *source.SemanticSearch
		semanticSearchTemp := genruntime.ToEnum(semanticSearch, semanticSearch_Values)
		service.SemanticSearch = &semanticSearchTemp
	} else {
		service.SemanticSearch = nil
	}
...
func (service *SearchService_Spec) Initialize_From_SearchService_STATUS(source *SearchService_STATUS) error {
	...
	// SemanticSearch
	if source.SemanticSearch != nil {
		semanticSearch := genruntime.ToEnum(string(*source.SemanticSearch), semanticSearch_Values)
		service.SemanticSearch = &semanticSearch
	} else {
		service.SemanticSearch = nil
	}
...
type SearchService_STATUS struct {
	...
	// PrivateEndpointConnections: The list of private endpoint connections to the search service.
	...
	// SharedPrivateLinkResources: The list of shared private link resources managed by the search service.
...
func (service *SearchService_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.SemanticSearch != nil {
			var temp string
			temp = string(*typedInput.Properties.SemanticSearch)
			semanticSearch := SemanticSearch_STATUS(temp)
			service.SemanticSearch = &semanticSearch
		}
	}
...
func (service *SearchService_STATUS) AssignProperties_From_SearchService_STATUS(source *storage.SearchService_STATUS) error {
	...
	if source.SemanticSearch != nil {
		semanticSearch := *source.SemanticSearch
		semanticSearchTemp := genruntime.ToEnum(semanticSearch, semanticSearch_STATUS_Values)
		service.SemanticSearch = &semanticSearchTemp
	} else {
		service.SemanticSearch = nil
	}
...
// Mapping from string to SemanticSearch
var semanticSearch_Values = map[string]SemanticSearch{
	"disabled": SemanticSearch_Disabled,
	"free":     SemanticSearch_Free,
	"standard": SemanticSearch_Standard,
}
...
// Mapping from string to SemanticSearch_STATUS
var semanticSearch_STATUS_Values = map[string]SemanticSearch_STATUS{
	"disabled": SemanticSearch_STATUS_Disabled,
	"free":     SemanticSearch_STATUS_Free,
	"standard": SemanticSearch_STATUS_Standard,
}
