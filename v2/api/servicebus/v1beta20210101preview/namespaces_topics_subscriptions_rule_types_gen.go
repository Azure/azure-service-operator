...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v1beta20210101preview-namespacestopicssubscriptionsrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacestopicssubscriptionsrules,verbs=create;update,versions=v1beta20210101preview,name=validate.v1beta20210101preview.namespacestopicssubscriptionsrules.servicebus.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &NamespacesTopicsSubscriptionsRule{}

// ValidateCreate validates the creation of the resource
func (rule *NamespacesTopicsSubscriptionsRule) ValidateCreate() error {
...
func (rule *NamespacesTopicsSubscriptionsRule) ValidateDelete() error {
...
func (rule *NamespacesTopicsSubscriptionsRule) ValidateUpdate(old runtime.Object) error {
...
func (rule *NamespacesTopicsSubscriptionsRule) createValidations() []func() error {
	return []func() error{rule.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (rule *NamespacesTopicsSubscriptionsRule) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (rule *NamespacesTopicsSubscriptionsRule) updateValidations() []func(old runtime.Object) error {
...
func (rule *NamespacesTopicsSubscriptionsRule) validateResourceReferences() error {
...
func (rule *NamespacesTopicsSubscriptionsRule) validateWriteOnceProperties(old runtime.Object) error {
