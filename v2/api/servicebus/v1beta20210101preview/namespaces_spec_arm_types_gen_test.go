...
func Test_Namespace_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/servicebus/v1beta20210101preview/namespace__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/servicebus/v1beta20210101preview/namespaces_spec_arm_types_gen_test.go
	// Serialize to JSON
