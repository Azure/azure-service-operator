...
<<<<<<<< HEAD:v2/api/servicebus/v1beta20210101preview/namespaces_queue_statusarm_types_gen.go
type NamespacesQueue_STATUSARM struct {
========
type SBQueue_STATUSARM struct {
>>>>>>>> main:v2/api/servicebus/v1beta20210101preview/sb_queue_status_arm_types_gen.go
	// Id: Resource Id
