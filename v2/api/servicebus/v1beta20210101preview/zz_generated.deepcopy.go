...
func (in *Namespaces_Topics_Subscriptions_Rule_Spec) DeepCopyInto(out *Namespaces_Topics_Subscriptions_Rule_Spec) {
	*out = *in
	...
	if in.FilterType != nil {
		...
		*out = new(Ruleproperties_FilterType)
		**out = **in
	}
	if in.Location != nil {
		in, out := &in.Location, &out.Location
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SBSubscription_STATUS_ARM) DeepCopyInto(out *SBSubscription_STATUS_ARM) {
	*out = *in
	if in.Id != nil {
		in, out := &in.Id, &out.Id
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SBSubscription_STATUS_ARM.
func (in *SBSubscription_STATUS_ARM) DeepCopy() *SBSubscription_STATUS_ARM {
	if in == nil {
		return nil
	}
	out := new(SBSubscription_STATUS_ARM)
	in.DeepCopyInto(out)
	return out
}
