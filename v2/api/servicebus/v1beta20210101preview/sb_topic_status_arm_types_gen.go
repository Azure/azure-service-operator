...
<<<<<<<< HEAD:v2/api/servicebus/v1beta20210101preview/namespaces_topic_statusarm_types_gen.go
type NamespacesTopic_STATUSARM struct {
========
type SBTopic_STATUSARM struct {
>>>>>>>> main:v2/api/servicebus/v1beta20210101preview/sb_topic_status_arm_types_gen.go
	// Id: Resource Id
