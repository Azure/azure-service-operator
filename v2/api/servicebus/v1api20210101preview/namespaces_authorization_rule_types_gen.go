...
func (rule *NamespacesAuthorizationRule) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20210101ps.NamespacesAuthorizationRule)
	if !ok {
...
func (rule *NamespacesAuthorizationRule) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20210101ps.NamespacesAuthorizationRule)
	if !ok {
		return fmt.Errorf("expected servicebus/v1api20210101previewstorage/NamespacesAuthorizationRule but received %T instead", hub)
	}
...
func (rule *NamespacesAuthorizationRule) AssignProperties_From_NamespacesAuthorizationRule(source *v1api20210101ps.NamespacesAuthorizationRule) error {
...
func (rule *NamespacesAuthorizationRule) AssignProperties_To_NamespacesAuthorizationRule(destination *v1api20210101ps.NamespacesAuthorizationRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20210101ps.Namespaces_AuthorizationRule_Spec
	...
	// Status
	var status v1api20210101ps.Namespaces_AuthorizationRule_STATUS
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20210101ps.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	src = &v1api20210101ps.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20210101ps.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20210101ps.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_Spec) AssignProperties_From_Namespaces_AuthorizationRule_Spec(source *v1api20210101ps.Namespaces_AuthorizationRule_Spec) error {
...
func (rule *Namespaces_AuthorizationRule_Spec) AssignProperties_To_Namespaces_AuthorizationRule_Spec(destination *v1api20210101ps.Namespaces_AuthorizationRule_Spec) error {
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20210101ps.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20210101ps.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20210101ps.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20210101ps.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_From_Namespaces_AuthorizationRule_STATUS(source *v1api20210101ps.Namespaces_AuthorizationRule_STATUS) error {
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_To_Namespaces_AuthorizationRule_STATUS(destination *v1api20210101ps.Namespaces_AuthorizationRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
