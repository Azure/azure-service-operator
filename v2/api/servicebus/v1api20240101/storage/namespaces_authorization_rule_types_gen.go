...
func (rule *NamespacesAuthorizationRule) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected servicebus/v20240101/storage/NamespacesAuthorizationRule but received %T instead", hub)
	}
...
// Storage version of v1api20240101.NamespacesAuthorizationRule_Spec
...
// Storage version of v1api20240101.NamespacesAuthorizationRule_STATUS
...
// Storage version of v1api20240101.NamespacesAuthorizationRuleOperatorSecrets
