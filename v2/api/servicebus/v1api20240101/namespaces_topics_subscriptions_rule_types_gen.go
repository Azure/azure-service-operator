...
// +kubebuilder:webhook:path=/mutate-servicebus-azure-com-v1api20240101-namespacestopicssubscriptionsrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacestopicssubscriptionsrules,verbs=create;update,versions=v1api20240101,name=default.v1api20240101.namespacestopicssubscriptionsrules.servicebus.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v1api20240101-namespacestopicssubscriptionsrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacestopicssubscriptionsrules,verbs=create;update,versions=v1api20240101,name=validate.v1api20240101.namespacestopicssubscriptionsrules.servicebus.azure.com,admissionReviewVersions=v1
