...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v1api20240101-namespacesauthorizationrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacesauthorizationrules,verbs=create;update,versions=v1api20240101,name=validate.v1api20240101.namespacesauthorizationrules.servicebus.azure.com,admissionReviewVersions=v1
