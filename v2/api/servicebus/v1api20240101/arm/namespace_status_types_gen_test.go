...
func AddRelatedPropertyGeneratorsForNamespace_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Properties"] = gen.PtrOf(SBNamespaceProperties_STATUSGenerator())
...
func Test_SBNamespaceProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SBNamespaceProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSBNamespaceProperties_STATUS, SBNamespaceProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSBNamespaceProperties_STATUS runs a test to see if a specific instance of SBNamespaceProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForSBNamespaceProperties_STATUS(subject SBNamespaceProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual SBNamespaceProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of SBNamespaceProperties_STATUS instances for property testing - lazily instantiated by
// SBNamespaceProperties_STATUSGenerator()
var sbNamespaceProperties_STATUSGenerator gopter.Gen

// SBNamespaceProperties_STATUSGenerator returns a generator of SBNamespaceProperties_STATUS instances for property testing.
// We first initialize sbNamespaceProperties_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func SBNamespaceProperties_STATUSGenerator() gopter.Gen {
	if sbNamespaceProperties_STATUSGenerator != nil {
		return sbNamespaceProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSBNamespaceProperties_STATUS(generators)
	sbNamespaceProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(SBNamespaceProperties_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSBNamespaceProperties_STATUS(generators)
	AddRelatedPropertyGeneratorsForSBNamespaceProperties_STATUS(generators)
	sbNamespaceProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(SBNamespaceProperties_STATUS{}), generators)

	return sbNamespaceProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForSBNamespaceProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSBNamespaceProperties_STATUS(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForSBNamespaceProperties_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForSBNamespaceProperties_STATUS(gens map[string]gopter.Gen) {
