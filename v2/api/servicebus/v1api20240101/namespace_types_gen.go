...
// +kubebuilder:webhook:path=/mutate-servicebus-azure-com-v1api20240101-namespace,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespaces,verbs=create;update,versions=v1api20240101,name=default.v1api20240101.namespaces.servicebus.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v1api20240101-namespace,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespaces,verbs=create;update,versions=v1api20240101,name=validate.v1api20240101.namespaces.servicebus.azure.com,admissionReviewVersions=v1
...
func (namespace *Namespace_Spec) Initialize_From_Namespace_STATUS(source *Namespace_STATUS) error {
	...
	// MinimumTlsVersion
	if source.MinimumTlsVersion != nil {
		minimumTlsVersion := genruntime.ToEnum(string(*source.MinimumTlsVersion), sBNamespaceProperties_MinimumTlsVersion_Values)
		namespace.MinimumTlsVersion = &minimumTlsVersion
	} else {
		namespace.MinimumTlsVersion = nil
	}
	...
	// PublicNetworkAccess
	if source.PublicNetworkAccess != nil {
		publicNetworkAccess := genruntime.ToEnum(string(*source.PublicNetworkAccess), sBNamespaceProperties_PublicNetworkAccess_Values)
		namespace.PublicNetworkAccess = &publicNetworkAccess
	} else {
		namespace.PublicNetworkAccess = nil
	}
