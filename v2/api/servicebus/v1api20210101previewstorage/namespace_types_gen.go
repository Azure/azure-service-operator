...
// Storage version of v1api20210101preview.Namespace
...
func (namespace *Namespace) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected servicebus/v1api20211101storage/Namespace but received %T instead", hub)
	}
...
// Storage version of v1api20210101preview.APIVersion
...
// Storage version of v1api20210101preview.Namespace_Spec
...
func (namespace *Namespace_Spec) AssignProperties_To_Namespace_Spec(destination *v20211101s.Namespace_Spec) error {
	...
	if propertyBag.Contains("AlternateName") {
		...
		if err != nil {
			return errors.Wrap(err, "pulling 'AlternateName' from propertyBag")
		}
...
// Storage version of v1api20210101preview.Namespace_STATUS
...
// Storage version of v1api20210101preview.Encryption
...
// Storage version of v1api20210101preview.Encryption_STATUS
// Properties to configure Encryption
...
// Storage version of v1api20210101preview.NamespaceOperatorSpec
...
// Storage version of v1api20210101preview.PrivateEndpointConnection_STATUS
...
// Storage version of v1api20210101preview.SBSku
...
// Storage version of v1api20210101preview.SBSku_STATUS
// SKU of the namespace.
...
// Storage version of v1api20210101preview.DictionaryValue_STATUS
...
func (value *DictionaryValue_STATUS) AssignProperties_From_UserAssignedIdentity_STATUS(source *v20211101s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// Invoke the augmentConversionForDictionaryValue_STATUS interface (if implemented) to customize the conversion
	var valueAsAny any = value
	if augmentedValue, ok := valueAsAny.(augmentConversionForDictionaryValue_STATUS); ok {
...
func (value *DictionaryValue_STATUS) AssignProperties_To_UserAssignedIdentity_STATUS(destination *v20211101s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
...
// Storage version of v1api20210101preview.KeyVaultProperties
...
// Storage version of v1api20210101preview.KeyVaultProperties_STATUS
// Properties to configure keyVault Properties
...
// Storage version of v1api20210101preview.UserAssignedIdentityProperties_STATUS
