...
// RunPropertyAssignmentTestForDictionaryValue_STATUS tests if a specific instance of DictionaryValue_STATUS can be assigned to v1api20211101storage and back losslessly
