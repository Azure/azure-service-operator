...
// RunPropertyAssignmentTestForNamespacesTopicsSubscriptionsRule tests if a specific instance of NamespacesTopicsSubscriptionsRule can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForNamespaces_Topics_Subscriptions_Rule_Spec tests if a specific instance of Namespaces_Topics_Subscriptions_Rule_Spec can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForNamespaces_Topics_Subscriptions_Rule_STATUS tests if a specific instance of Namespaces_Topics_Subscriptions_Rule_STATUS can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForAction tests if a specific instance of Action can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForAction_STATUS tests if a specific instance of Action_STATUS can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForCorrelationFilter tests if a specific instance of CorrelationFilter can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForCorrelationFilter_STATUS tests if a specific instance of CorrelationFilter_STATUS can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForSqlFilter tests if a specific instance of SqlFilter can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForSqlFilter_STATUS tests if a specific instance of SqlFilter_STATUS can be assigned to v1api20211101storage and back losslessly
