...
// +kubebuilder:webhook:path=/mutate-servicebus-azure-com-v20221001preview-namespacestopicssubscriptionsrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacestopicssubscriptionsrules,verbs=create;update,versions=v20221001preview,name=default.v20221001preview.namespacestopicssubscriptionsrules.servicebus.azure.com,admissionReviewVersions=v1
...
func (rule *NamespacesTopicsSubscriptionsRule) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20221001preview/NamespacesTopicsSubscriptionsRule, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v20221001preview-namespacestopicssubscriptionsrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacestopicssubscriptionsrules,verbs=create;update,versions=v20221001preview,name=validate.v20221001preview.namespacestopicssubscriptionsrules.servicebus.azure.com,admissionReviewVersions=v1
...
func (rule *NamespacesTopicsSubscriptionsRule) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20221001preview/NamespacesTopicsSubscriptionsRule, but got %T", resource)
	}
...
func (rule *NamespacesTopicsSubscriptionsRule) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20221001preview/NamespacesTopicsSubscriptionsRule, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20221001p.NamespacesTopicsSubscriptionsRule)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20221001preview/NamespacesTopicsSubscriptionsRule, but got %T", oldResource)
	}
...
func (rule *NamespacesTopicsSubscriptionsRule) createValidations() []func(ctx context.Context, obj *v20221001p.NamespacesTopicsSubscriptionsRule) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20221001p.NamespacesTopicsSubscriptionsRule) (admission.Warnings, error){
