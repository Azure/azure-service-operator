...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SBSubscription_STATUS) DeepCopyInto(out *SBSubscription_STATUS) {
	*out = *in
	if in.AccessedAt != nil {
		in, out := &in.AccessedAt, &out.AccessedAt
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SBSubscription_STATUS.
func (in *SBSubscription_STATUS) DeepCopy() *SBSubscription_STATUS {
	if in == nil {
		return nil
	}
	out := new(SBSubscription_STATUS)
	in.DeepCopyInto(out)
	return out
}
