...
type augmentConversionForNamespacesTopicsSubscription interface {
	AssignPropertiesFrom(src *v1api20210101ps.NamespacesTopicsSubscription) error
	AssignPropertiesTo(dst *v1api20210101ps.NamespacesTopicsSubscription) error
}
...
type augmentConversionForNamespaces_Topics_Subscription_Spec interface {
	AssignPropertiesFrom(src *v1api20210101ps.Namespaces_Topics_Subscription_Spec) error
	AssignPropertiesTo(dst *v1api20210101ps.Namespaces_Topics_Subscription_Spec) error
}

type augmentConversionForNamespaces_Topics_Subscription_STATUS interface {
	AssignPropertiesFrom(src *v1api20210101ps.Namespaces_Topics_Subscription_STATUS) error
	AssignPropertiesTo(dst *v1api20210101ps.Namespaces_Topics_Subscription_STATUS) error
}
