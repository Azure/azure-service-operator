...
import (
	"context"
	"fmt"
	v20211101 "github.com/Azure/azure-service-operator/v2/api/servicebus/v20211101"
...
// +kubebuilder:webhook:path=/mutate-servicebus-azure-com-v20211101-namespacesqueue,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacesqueues,verbs=create;update,versions=v20211101,name=default.v20211101.namespacesqueues.servicebus.azure.com,admissionReviewVersions=v1
...
func (queue *NamespacesQueue) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20211101/NamespacesQueue, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-servicebus-azure-com-v20211101-namespacesqueue,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=servicebus.azure.com,resources=namespacesqueues,verbs=create;update,versions=v20211101,name=validate.v20211101.namespacesqueues.servicebus.azure.com,admissionReviewVersions=v1
...
func (queue *NamespacesQueue) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20211101/NamespacesQueue, but got %T", resource)
	}
...
func (queue *NamespacesQueue) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20211101/NamespacesQueue, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.NamespacesQueue)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/servicebus/v20211101/NamespacesQueue, but got %T", oldResource)
	}
