...
func AddIndependentPropertyGeneratorsForEncryption_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["KeySource"] = gen.PtrOf(gen.OneConstOf(Encryption_KeySource_STATUS_ARM_MicrosoftKeyVault))
...
func AddIndependentPropertyGeneratorsForSBNamespaceProperties_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["MinimumTlsVersion"] = gen.PtrOf(gen.OneConstOf(SBNamespaceProperties_MinimumTlsVersion_STATUS_ARM_10, SBNamespaceProperties_MinimumTlsVersion_STATUS_ARM_11, SBNamespaceProperties_MinimumTlsVersion_STATUS_ARM_12))
	gens["PremiumMessagingPartitions"] = gen.PtrOf(gen.Int())
	gens["ProvisioningState"] = gen.PtrOf(gen.AlphaString())
	gens["PublicNetworkAccess"] = gen.PtrOf(gen.OneConstOf(SBNamespaceProperties_PublicNetworkAccess_STATUS_ARM_Disabled, SBNamespaceProperties_PublicNetworkAccess_STATUS_ARM_Enabled, SBNamespaceProperties_PublicNetworkAccess_STATUS_ARM_SecuredByPerimeter))
...
func AddIndependentPropertyGeneratorsForSBSku_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.OneConstOf(SBSku_Name_STATUS_ARM_Basic, SBSku_Name_STATUS_ARM_Premium, SBSku_Name_STATUS_ARM_Standard))
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(SBSku_Tier_STATUS_ARM_Basic, SBSku_Tier_STATUS_ARM_Premium, SBSku_Tier_STATUS_ARM_Standard))
}
