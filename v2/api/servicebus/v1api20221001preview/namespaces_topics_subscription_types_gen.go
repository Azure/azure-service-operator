...
func (subscription *NamespacesTopicsSubscription) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20221001ps.NamespacesTopicsSubscription
...
func (subscription *NamespacesTopicsSubscription) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20221001ps.NamespacesTopicsSubscription
...
func (subscription *NamespacesTopicsSubscription) AssignProperties_From_NamespacesTopicsSubscription(source *v20221001ps.NamespacesTopicsSubscription) error {
...
func (subscription *NamespacesTopicsSubscription) AssignProperties_To_NamespacesTopicsSubscription(destination *v20221001ps.NamespacesTopicsSubscription) error {

	// ObjectMeta
	destination.ObjectMeta = *subscription.ObjectMeta.DeepCopy()

	// Spec
	var spec v20221001ps.Namespaces_Topics_Subscription_Spec
	...
	// Status
	var status v20221001ps.Namespaces_Topics_Subscription_STATUS
...
func (subscription *Namespaces_Topics_Subscription_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20221001ps.Namespaces_Topics_Subscription_Spec)
	if ok {
	...
	src = &v20221001ps.Namespaces_Topics_Subscription_Spec{}
...
func (subscription *Namespaces_Topics_Subscription_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20221001ps.Namespaces_Topics_Subscription_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespaces_Topics_Subscription_Spec{}
...
func (subscription *Namespaces_Topics_Subscription_Spec) AssignProperties_From_Namespaces_Topics_Subscription_Spec(source *v20221001ps.Namespaces_Topics_Subscription_Spec) error {
...
func (subscription *Namespaces_Topics_Subscription_Spec) AssignProperties_To_Namespaces_Topics_Subscription_Spec(destination *v20221001ps.Namespaces_Topics_Subscription_Spec) error {
	...
	// ClientAffineProperties
	if subscription.ClientAffineProperties != nil {
		var clientAffineProperty v20221001ps.SBClientAffineProperties
...
func (subscription *Namespaces_Topics_Subscription_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20221001ps.Namespaces_Topics_Subscription_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20221001ps.Namespaces_Topics_Subscription_STATUS{}
...
func (subscription *Namespaces_Topics_Subscription_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20221001ps.Namespaces_Topics_Subscription_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20221001ps.Namespaces_Topics_Subscription_STATUS{}
...
func (subscription *Namespaces_Topics_Subscription_STATUS) AssignProperties_From_Namespaces_Topics_Subscription_STATUS(source *v20221001ps.Namespaces_Topics_Subscription_STATUS) error {
...
func (subscription *Namespaces_Topics_Subscription_STATUS) AssignProperties_To_Namespaces_Topics_Subscription_STATUS(destination *v20221001ps.Namespaces_Topics_Subscription_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// ClientAffineProperties
	if subscription.ClientAffineProperties != nil {
		var clientAffineProperty v20221001ps.SBClientAffineProperties_STATUS
...
func (properties *SBClientAffineProperties) AssignProperties_From_SBClientAffineProperties(source *v20221001ps.SBClientAffineProperties) error {
...
func (properties *SBClientAffineProperties) AssignProperties_To_SBClientAffineProperties(destination *v20221001ps.SBClientAffineProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *SBClientAffineProperties_STATUS) AssignProperties_From_SBClientAffineProperties_STATUS(source *v20221001ps.SBClientAffineProperties_STATUS) error {
...
func (properties *SBClientAffineProperties_STATUS) AssignProperties_To_SBClientAffineProperties_STATUS(destination *v20221001ps.SBClientAffineProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
