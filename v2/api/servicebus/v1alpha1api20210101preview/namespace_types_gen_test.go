...
// RunPropertyAssignmentTestForNamespaces_SPEC tests if a specific instance of Namespaces_SPEC can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForEncryption_Spec tests if a specific instance of Encryption_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForIdentity_Spec tests if a specific instance of Identity_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForPrivateEndpointConnection_Spec tests if a specific instance of PrivateEndpointConnection_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
func Test_SBSku_Spec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from SBSku_Spec to SBSku_Spec via AssignPropertiesToSBSku_Spec & AssignPropertiesFromSBSku_Spec returns original",
		prop.ForAll(RunPropertyAssignmentTestForSBSku_Spec, SBSku_SpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForSBSku_Spec tests if a specific instance of SBSku_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
func RunPropertyAssignmentTestForSBSku_Spec(subject SBSku_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210101previewstorage.SBSku_Spec
	err := copied.AssignPropertiesToSBSku_Spec(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignPropertiesFromSBSku_Spec(&other)
	if err != nil {
		return err.Error()
	}
...
// RunPropertyAssignmentTestForConnectionState_Spec tests if a specific instance of ConnectionState_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForKeyVaultProperties_Spec tests if a specific instance of KeyVaultProperties_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForPrivateEndpoint_Spec tests if a specific instance of PrivateEndpoint_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
...
// RunPropertyAssignmentTestForUserAssignedIdentityProperties_Spec tests if a specific instance of UserAssignedIdentityProperties_Spec can be assigned to v1alpha1api20210101previewstorage and back losslessly
