...
func (topic *NamespacesTopic) AssignProperties_To_NamespacesTopic(destination *alpha20210101ps.NamespacesTopic) error {
	...
	// Spec
	var spec alpha20210101ps.Namespaces_Topic_Spec
	...
	// Status
	var status alpha20210101ps.Namespaces_Topic_STATUS
...
func (topic *Namespaces_Topic_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20210101ps.Namespaces_Topic_Spec)
	if ok {
	...
	src = &alpha20210101ps.Namespaces_Topic_Spec{}
...
func (topic *Namespaces_Topic_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20210101ps.Namespaces_Topic_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &alpha20210101ps.Namespaces_Topic_Spec{}
...
func (topic *Namespaces_Topic_Spec) AssignProperties_To_Namespaces_Topic_Spec(destination *alpha20210101ps.Namespaces_Topic_Spec) error {
...
func (topic *Namespaces_Topic_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20210101ps.Namespaces_Topic_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210101ps.Namespaces_Topic_STATUS{}
...
func (topic *Namespaces_Topic_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20210101ps.Namespaces_Topic_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210101ps.Namespaces_Topic_STATUS{}
...
func (topic *Namespaces_Topic_STATUS) AssignProperties_From_Namespaces_Topic_STATUS(source *alpha20210101ps.Namespaces_Topic_STATUS) error {
...
func (topic *Namespaces_Topic_STATUS) AssignProperties_To_Namespaces_Topic_STATUS(destination *alpha20210101ps.Namespaces_Topic_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
