...
type NamespacesQueues_SPECARM struct {
	...
	Properties *SBQueueProperties_SpecARM `json:"properties,omitempty"`
}

var _ genruntime.ARMResourceSpec = &NamespacesQueues_SPECARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-01-01-preview"
func (specarm NamespacesQueues_SPECARM) GetAPIVersion() string {
	return string(APIVersionValue)
}

// GetName returns the Name of the resource
func (specarm NamespacesQueues_SPECARM) GetName() string {
	return specarm.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ServiceBus/namespaces/queues"
func (specarm NamespacesQueues_SPECARM) GetType() string {
	return "Microsoft.ServiceBus/namespaces/queues"
}

type SBQueueProperties_SpecARM struct {
