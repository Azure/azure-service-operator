...
func FactoryGitHubConfigurationGenerator() *rapid.Generator[FactoryGitHubConfiguration] {
	...
	typeVar := rapid.Ptr(rapid.SampledFrom([]FactoryGitHubConfiguration_Type{FactoryGitHubConfiguration_Type_FactoryGitHubConfiguration}), true)
...
func FactoryGitHubConfiguration_STATUSGenerator() *rapid.Generator[FactoryGitHubConfiguration_STATUS] {
	...
	disablePublish := rapid.Ptr(rapid.Bool(), true)
	typeVar := rapid.Ptr(rapid.SampledFrom([]FactoryGitHubConfiguration_Type_STATUS{FactoryGitHubConfiguration_Type_STATUS_FactoryGitHubConfiguration}), true)
...
func FactoryVSTSConfigurationGenerator() *rapid.Generator[FactoryVSTSConfiguration] {
	...
	ptrString := rapid.Ptr(rapid.String(), true)
	disablePublish := rapid.Ptr(rapid.Bool(), true)
	typeVar := rapid.Ptr(rapid.SampledFrom([]FactoryVSTSConfiguration_Type{FactoryVSTSConfiguration_Type_FactoryVSTSConfiguration}), true)
...
func FactoryVSTSConfiguration_STATUSGenerator() *rapid.Generator[FactoryVSTSConfiguration_STATUS] {
	...
	ptrString := rapid.Ptr(rapid.String(), true)
	disablePublish := rapid.Ptr(rapid.Bool(), true)
	typeVar := rapid.Ptr(rapid.SampledFrom([]FactoryVSTSConfiguration_Type_STATUS{FactoryVSTSConfiguration_Type_STATUS_FactoryVSTSConfiguration}), true)
...
func Test_UserAssignedIdentityDetails_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	rapid.Check(t, func(t *rapid.T) {
		...
		// Use AssignPropertiesTo() for the first stage of conversion
		var other datafactory_v1api20180601s.UserAssignedIdentityDetails
