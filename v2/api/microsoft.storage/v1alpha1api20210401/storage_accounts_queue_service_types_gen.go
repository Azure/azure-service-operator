...
// +kubebuilder:rbac:groups=microsoft.storage.azure.com,resources=storageaccountsqueueservices,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.storage.azure.com,resources={storageaccountsqueueservices/status,storageaccountsqueueservices/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-storage-azure-com-v1alpha1api20210401-storageaccountsqueueservice,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.storage.azure.com,resources=storageaccountsqueueservices,verbs=create;update,versions=v1alpha1api20210401,name=default.v1alpha1api20210401.storageaccountsqueueservices.microsoft.storage.azure.com,admissionReviewVersions=v1beta1
...
func (storageAccountsQueueService *StorageAccountsQueueService) Owner() *genruntime.ResourceReference {
	...
	return &genruntime.ResourceReference{
		Group:     group,
		Kind:      kind,
		Namespace: storageAccountsQueueService.Namespace,
...
// +kubebuilder:webhook:path=/validate-microsoft-storage-azure-com-v1alpha1api20210401-storageaccountsqueueservice,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.storage.azure.com,resources=storageaccountsqueueservices,verbs=create;update,versions=v1alpha1api20210401,name=validate.v1alpha1api20210401.storageaccountsqueueservices.microsoft.storage.azure.com,admissionReviewVersions=v1beta1
