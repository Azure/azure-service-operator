...
func RunResourceConversionTestForPrivateDnsZonesVirtualNetworkLink(subject PrivateDnsZonesVirtualNetworkLink) string {
	...
	var hub v20180901s.PrivateDnsZonesVirtualNetworkLink
...
// RunPropertyAssignmentTestForPrivateDnsZonesVirtualNetworkLink tests if a specific instance of PrivateDnsZonesVirtualNetworkLink can be assigned to v1beta20180901storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZonesVirtualNetworkLink(subject PrivateDnsZonesVirtualNetworkLink) string {
	...
	var other v20180901s.PrivateDnsZonesVirtualNetworkLink
...
// RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_Spec tests if a specific instance of PrivateDnsZones_VirtualNetworkLink_Spec can be assigned to v1beta20180901storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_Spec(subject PrivateDnsZones_VirtualNetworkLink_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec
...
// RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_STATUS tests if a specific instance of PrivateDnsZones_VirtualNetworkLink_STATUS can be assigned to v1beta20180901storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_STATUS(subject PrivateDnsZones_VirtualNetworkLink_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS
