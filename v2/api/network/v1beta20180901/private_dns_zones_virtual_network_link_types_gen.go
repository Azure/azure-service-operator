...
func (link *PrivateDnsZonesVirtualNetworkLink) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20180901s.PrivateDnsZonesVirtualNetworkLink)
	if !ok {
		return fmt.Errorf("expected network/v1beta20180901storage/PrivateDnsZonesVirtualNetworkLink but received %T instead", hub)
	}
...
func (link *PrivateDnsZonesVirtualNetworkLink) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20180901s.PrivateDnsZonesVirtualNetworkLink)
	if !ok {
		return fmt.Errorf("expected network/v1beta20180901storage/PrivateDnsZonesVirtualNetworkLink but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20180901-privatednszonesvirtualnetworklink,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesvirtualnetworklinks,verbs=create;update,versions=v1beta20180901,name=default.v1beta20180901.privatednszonesvirtualnetworklinks.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20180901-privatednszonesvirtualnetworklink,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesvirtualnetworklinks,verbs=create;update,versions=v1beta20180901,name=validate.v1beta20180901.privatednszonesvirtualnetworklinks.network.azure.com,admissionReviewVersions=v1
...
func (link *PrivateDnsZonesVirtualNetworkLink) AssignProperties_From_PrivateDnsZonesVirtualNetworkLink(source *v20180901s.PrivateDnsZonesVirtualNetworkLink) error {
...
func (link *PrivateDnsZonesVirtualNetworkLink) AssignProperties_To_PrivateDnsZonesVirtualNetworkLink(destination *v20180901s.PrivateDnsZonesVirtualNetworkLink) error {

	// ObjectMeta
	destination.ObjectMeta = *link.ObjectMeta.DeepCopy()

	// Spec
	var spec v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec
	...
	// Status
	var status v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS
...
func (link *PrivateDnsZones_VirtualNetworkLink_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec)
	if ok {
	...
	src = &v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec{}
...
func (link *PrivateDnsZones_VirtualNetworkLink_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec{}
...
func (link *PrivateDnsZones_VirtualNetworkLink_Spec) AssignProperties_From_PrivateDnsZones_VirtualNetworkLink_Spec(source *v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec) error {
...
func (link *PrivateDnsZones_VirtualNetworkLink_Spec) AssignProperties_To_PrivateDnsZones_VirtualNetworkLink_Spec(destination *v20180901s.PrivateDnsZones_VirtualNetworkLink_Spec) error {
	...
	// VirtualNetwork
	if link.VirtualNetwork != nil {
		var virtualNetwork v20180901s.SubResource
...
func (link *PrivateDnsZones_VirtualNetworkLink_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS{}
...
func (link *PrivateDnsZones_VirtualNetworkLink_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS{}
...
func (link *PrivateDnsZones_VirtualNetworkLink_STATUS) AssignProperties_From_PrivateDnsZones_VirtualNetworkLink_STATUS(source *v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS) error {
...
func (link *PrivateDnsZones_VirtualNetworkLink_STATUS) AssignProperties_To_PrivateDnsZones_VirtualNetworkLink_STATUS(destination *v20180901s.PrivateDnsZones_VirtualNetworkLink_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// VirtualNetwork
	if link.VirtualNetwork != nil {
		var virtualNetwork v20180901s.SubResource_STATUS
...
func (resource *SubResource_STATUS) AssignProperties_From_SubResource_STATUS(source *v20180901s.SubResource_STATUS) error {
...
func (resource *SubResource_STATUS) AssignProperties_To_SubResource_STATUS(destination *v20180901s.SubResource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
