...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivateZone_STATUS_ARM) DeepCopyInto(out *PrivateZone_STATUS_ARM) {
	*out = *in
	if in.Etag != nil {
		in, out := &in.Etag, &out.Etag
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateZone_STATUS_ARM.
func (in *PrivateZone_STATUS_ARM) DeepCopy() *PrivateZone_STATUS_ARM {
	if in == nil {
		return nil
	}
	out := new(PrivateZone_STATUS_ARM)
	in.DeepCopyInto(out)
	return out
}
