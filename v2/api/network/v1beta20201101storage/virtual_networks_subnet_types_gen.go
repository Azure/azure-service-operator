...
type augmentConversionForVirtualNetworksSubnet interface {
	AssignPropertiesFrom(src *v1api20201101s.VirtualNetworksSubnet) error
	AssignPropertiesTo(dst *v1api20201101s.VirtualNetworksSubnet) error
}
...
type augmentConversionForVirtualNetworks_Subnet_Spec interface {
	AssignPropertiesFrom(src *v1api20201101s.VirtualNetworks_Subnet_Spec) error
	AssignPropertiesTo(dst *v1api20201101s.VirtualNetworks_Subnet_Spec) error
}

type augmentConversionForVirtualNetworks_Subnet_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.VirtualNetworks_Subnet_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.VirtualNetworks_Subnet_STATUS) error
}
...
type augmentConversionForApplicationGatewayIPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.ApplicationGatewayIPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.ApplicationGatewayIPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForApplicationGatewayIPConfiguration_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.ApplicationGatewayIPConfiguration_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.ApplicationGatewayIPConfiguration_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForDelegation interface {
	AssignPropertiesFrom(src *v1api20201101s.Delegation) error
	AssignPropertiesTo(dst *v1api20201101s.Delegation) error
}

type augmentConversionForDelegation_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.Delegation_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.Delegation_STATUS) error
}

type augmentConversionForIPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.IPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.IPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForIPConfigurationProfile_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.IPConfigurationProfile_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.IPConfigurationProfile_STATUS) error
}

type augmentConversionForNetworkSecurityGroup_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.NetworkSecurityGroup_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.NetworkSecurityGroup_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForNetworkSecurityGroupSpec_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.NetworkSecurityGroupSpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.NetworkSecurityGroupSpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForPrivateEndpoint_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.PrivateEndpoint_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.PrivateEndpoint_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForResourceNavigationLink_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.ResourceNavigationLink_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.ResourceNavigationLink_STATUS) error
}

type augmentConversionForRouteTable_STATUS_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.RouteTable_STATUS_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.RouteTable_STATUS_SubResourceEmbedded) error
}

type augmentConversionForRouteTableSpec_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.RouteTableSpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.RouteTableSpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForServiceAssociationLink_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.ServiceAssociationLink_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.ServiceAssociationLink_STATUS) error
}

type augmentConversionForServiceEndpointPolicy_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.ServiceEndpointPolicy_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.ServiceEndpointPolicy_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForServiceEndpointPolicySpec_VirtualNetworks_Subnet_SubResourceEmbedded interface {
	AssignPropertiesFrom(src *v1api20201101s.ServiceEndpointPolicySpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
	AssignPropertiesTo(dst *v1api20201101s.ServiceEndpointPolicySpec_VirtualNetworks_Subnet_SubResourceEmbedded) error
}

type augmentConversionForServiceEndpointPropertiesFormat interface {
	AssignPropertiesFrom(src *v1api20201101s.ServiceEndpointPropertiesFormat) error
	AssignPropertiesTo(dst *v1api20201101s.ServiceEndpointPropertiesFormat) error
}

type augmentConversionForServiceEndpointPropertiesFormat_STATUS interface {
	AssignPropertiesFrom(src *v1api20201101s.ServiceEndpointPropertiesFormat_STATUS) error
	AssignPropertiesTo(dst *v1api20201101s.ServiceEndpointPropertiesFormat_STATUS) error
}
