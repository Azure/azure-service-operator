...
func Test_PrivateDnsZonesRecordsetTypePTR_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of PrivateDnsZonesRecordsetTypePTR via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPrivateDnsZonesRecordsetTypePTR, PrivateDnsZonesRecordsetTypePTRGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPrivateDnsZonesRecordsetTypePTR runs a test to see if a specific instance of PrivateDnsZonesRecordsetTypePTR round trips to JSON and back losslessly
func RunJSONSerializationTestForPrivateDnsZonesRecordsetTypePTR(subject PrivateDnsZonesRecordsetTypePTR) string {
	// Serialize to JSON
	...
	var actual PrivateDnsZonesRecordsetTypePTR
...
// Generator of PrivateDnsZonesRecordsetTypePTR instances for property testing - lazily instantiated by
// PrivateDnsZonesRecordsetTypePTRGenerator()
var privateDnsZonesRecordsetTypePTRGenerator gopter.Gen

// PrivateDnsZonesRecordsetTypePTRGenerator returns a generator of PrivateDnsZonesRecordsetTypePTR instances for property testing.
func PrivateDnsZonesRecordsetTypePTRGenerator() gopter.Gen {
	if privateDnsZonesRecordsetTypePTRGenerator != nil {
		return privateDnsZonesRecordsetTypePTRGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypePTR(generators)
	privateDnsZonesRecordsetTypePTRGenerator = gen.Struct(reflect.TypeOf(PrivateDnsZonesRecordsetTypePTR{}), generators)

	return privateDnsZonesRecordsetTypePTRGenerator
}

// AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypePTR is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypePTR(gens map[string]gopter.Gen) {
