...
// +kubebuilder:rbac:groups=network.azure.com,resources=privatednszonesrecordsettypemxes,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources={privatednszonesrecordsettypemxes/status,privatednszonesrecordsettypemxes/finalizers},verbs=get;update;patch
...
// Storage version of v1beta20200601.PrivateDnsZonesRecordsetTypeMX
...
// Hub marks that this PrivateDnsZonesRecordsetTypeMX is the hub type for conversion
func (typeMX *PrivateDnsZonesRecordsetTypeMX) Hub() {}
