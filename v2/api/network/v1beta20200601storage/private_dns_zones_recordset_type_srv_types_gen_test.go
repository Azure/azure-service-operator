...
func Test_PrivateDnsZonesRecordsetTypeSRV_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of PrivateDnsZonesRecordsetTypeSRV via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeSRV, PrivateDnsZonesRecordsetTypeSRVGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeSRV runs a test to see if a specific instance of PrivateDnsZonesRecordsetTypeSRV round trips to JSON and back losslessly
func RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeSRV(subject PrivateDnsZonesRecordsetTypeSRV) string {
	// Serialize to JSON
	...
	var actual PrivateDnsZonesRecordsetTypeSRV
...
// Generator of PrivateDnsZonesRecordsetTypeSRV instances for property testing - lazily instantiated by
// PrivateDnsZonesRecordsetTypeSRVGenerator()
var privateDnsZonesRecordsetTypeSRVGenerator gopter.Gen

// PrivateDnsZonesRecordsetTypeSRVGenerator returns a generator of PrivateDnsZonesRecordsetTypeSRV instances for property testing.
func PrivateDnsZonesRecordsetTypeSRVGenerator() gopter.Gen {
	if privateDnsZonesRecordsetTypeSRVGenerator != nil {
		return privateDnsZonesRecordsetTypeSRVGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeSRV(generators)
	privateDnsZonesRecordsetTypeSRVGenerator = gen.Struct(reflect.TypeOf(PrivateDnsZonesRecordsetTypeSRV{}), generators)

	return privateDnsZonesRecordsetTypeSRVGenerator
}

// AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeSRV is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeSRV(gens map[string]gopter.Gen) {
