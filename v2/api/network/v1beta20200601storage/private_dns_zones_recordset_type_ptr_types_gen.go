...
// +kubebuilder:rbac:groups=network.azure.com,resources=privatednszonesrecordsettypeptrs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources={privatednszonesrecordsettypeptrs/status,privatednszonesrecordsettypeptrs/finalizers},verbs=get;update;patch
...
// Storage version of v1beta20200601.PrivateDnsZonesRecordsetTypePTR
...
type PrivateDnsZonesRecordsetTypePTR struct {
...
var _ conditions.Conditioner = &PrivateDnsZonesRecordsetTypePTR{}

// GetConditions returns the conditions of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) GetConditions() conditions.Conditions {
	return typePTR.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (typePTR *PrivateDnsZonesRecordsetTypePTR) SetConditions(conditions conditions.Conditions) {
	typePTR.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &PrivateDnsZonesRecordsetTypePTR{}

// AzureName returns the Azure name of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) AzureName() string {
	return typePTR.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-06-01"
func (typePTR PrivateDnsZonesRecordsetTypePTR) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) GetSpec() genruntime.ConvertibleSpec {
	return &typePTR.Spec
}

// GetStatus returns the status of this resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) GetStatus() genruntime.ConvertibleStatus {
	return &typePTR.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/privateDnsZones/PTR"
func (typePTR *PrivateDnsZonesRecordsetTypePTR) GetType() string {
	return "Microsoft.Network/privateDnsZones/PTR"
}

// NewEmptyStatus returns a new empty (blank) status
func (typePTR *PrivateDnsZonesRecordsetTypePTR) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &PrivateDnsZones_PTR_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (typePTR *PrivateDnsZonesRecordsetTypePTR) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(typePTR.Spec)
	return &genruntime.ResourceReference{
		Group: group,
		Kind:  kind,
		Name:  typePTR.Spec.Owner.Name,
	}
}

// SetStatus sets the status of this resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) SetStatus(status genruntime.ConvertibleStatus) error {
...
// Hub marks that this PrivateDnsZonesRecordsetTypePTR is the hub type for conversion
func (typePTR *PrivateDnsZonesRecordsetTypePTR) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: typePTR.Spec.OriginalVersion,
		Kind:    "PrivateDnsZonesRecordsetTypePTR",
	}
}
...
// - Generated from: /privatedns/resource-manager/Microsoft.Network/stable/2020-06-01/privatedns.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/PTR/{relativeRecordSetName}
type PrivateDnsZonesRecordsetTypePTRList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrivateDnsZonesRecordsetTypePTR `json:"items"`
}

// Storage version of v1beta20200601.PrivateDnsZones_PTR_Spec
...
// Storage version of v1beta20200601.PrivateDnsZones_PTR_STATUS
...
func init() {
	SchemeBuilder.Register(&PrivateDnsZonesRecordsetTypePTR{}, &PrivateDnsZonesRecordsetTypePTRList{})
}
