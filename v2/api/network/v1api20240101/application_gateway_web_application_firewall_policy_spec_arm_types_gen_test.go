...
func Test_ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM, ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM runs a test to see if a specific instance of ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(subject ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM) string {
	// Serialize to JSON
	...
	var actual ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM
...
// Generator of ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM instances for property testing - lazily
// instantiated by ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator()
var applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator gopter.Gen

// ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator returns a generator of ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM instances for property testing.
// We first initialize applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator() gopter.Gen {
	if applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator != nil {
		return applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(generators)
	applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(generators)
	applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(ApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM{}), generators)

	return applicationGatewayWebApplicationFirewallPolicy_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForApplicationGatewayWebApplicationFirewallPolicy_Spec_ARM(gens map[string]gopter.Gen) {
