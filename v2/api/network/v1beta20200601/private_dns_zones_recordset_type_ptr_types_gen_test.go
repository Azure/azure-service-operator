...
func Test_PrivateDnsZonesRecordsetTypePTR_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypePTR to hub returns original",
		prop.ForAll(RunResourceConversionTestForPrivateDnsZonesRecordsetTypePTR, PrivateDnsZonesRecordsetTypePTRGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForPrivateDnsZonesRecordsetTypePTR tests if a specific instance of PrivateDnsZonesRecordsetTypePTR round trips to the hub storage version and back losslessly
func RunResourceConversionTestForPrivateDnsZonesRecordsetTypePTR(subject PrivateDnsZonesRecordsetTypePTR) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20200601s.PrivateDnsZonesRecordsetTypePTR
...
func Test_PrivateDnsZonesRecordsetTypePTR_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypePTR to PrivateDnsZonesRecordsetTypePTR via AssignProperties_To_PrivateDnsZonesRecordsetTypePTR & AssignProperties_From_PrivateDnsZonesRecordsetTypePTR returns original",
		prop.ForAll(RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypePTR, PrivateDnsZonesRecordsetTypePTRGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypePTR tests if a specific instance of PrivateDnsZonesRecordsetTypePTR can be assigned to v1beta20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypePTR(subject PrivateDnsZonesRecordsetTypePTR) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20200601s.PrivateDnsZonesRecordsetTypePTR
	err := copied.AssignProperties_To_PrivateDnsZonesRecordsetTypePTR(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual PrivateDnsZonesRecordsetTypePTR
	err = actual.AssignProperties_From_PrivateDnsZonesRecordsetTypePTR(&other)
	if err != nil {
		return err.Error()
	}
