...
func Test_PrivateDnsZonesRecordsetTypeA_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypeA to hub returns original",
		prop.ForAll(RunResourceConversionTestForPrivateDnsZonesRecordsetTypeA, PrivateDnsZonesRecordsetTypeAGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForPrivateDnsZonesRecordsetTypeA tests if a specific instance of PrivateDnsZonesRecordsetTypeA round trips to the hub storage version and back losslessly
func RunResourceConversionTestForPrivateDnsZonesRecordsetTypeA(subject PrivateDnsZonesRecordsetTypeA) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20200601s.PrivateDnsZonesRecordsetTypeA
	...
	var actual PrivateDnsZonesRecordsetTypeA
...
func Test_PrivateDnsZonesRecordsetTypeA_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypeA to PrivateDnsZonesRecordsetTypeA via AssignProperties_To_PrivateDnsZonesRecordsetTypeA & AssignProperties_From_PrivateDnsZonesRecordsetTypeA returns original",
		prop.ForAll(RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeA, PrivateDnsZonesRecordsetTypeAGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeA tests if a specific instance of PrivateDnsZonesRecordsetTypeA can be assigned to v1beta20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeA(subject PrivateDnsZonesRecordsetTypeA) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20200601s.PrivateDnsZonesRecordsetTypeA
	err := copied.AssignProperties_To_PrivateDnsZonesRecordsetTypeA(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual PrivateDnsZonesRecordsetTypeA
	err = actual.AssignProperties_From_PrivateDnsZonesRecordsetTypeA(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_PrivateDnsZonesRecordsetTypeA_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of PrivateDnsZonesRecordsetTypeA via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeA, PrivateDnsZonesRecordsetTypeAGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeA runs a test to see if a specific instance of PrivateDnsZonesRecordsetTypeA round trips to JSON and back losslessly
func RunJSONSerializationTestForPrivateDnsZonesRecordsetTypeA(subject PrivateDnsZonesRecordsetTypeA) string {
	// Serialize to JSON
...
// Generator of PrivateDnsZonesRecordsetTypeA instances for property testing - lazily instantiated by
// PrivateDnsZonesRecordsetTypeAGenerator()
var privateDnsZonesRecordsetTypeAGenerator gopter.Gen

// PrivateDnsZonesRecordsetTypeAGenerator returns a generator of PrivateDnsZonesRecordsetTypeA instances for property testing.
func PrivateDnsZonesRecordsetTypeAGenerator() gopter.Gen {
	if privateDnsZonesRecordsetTypeAGenerator != nil {
		return privateDnsZonesRecordsetTypeAGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeA(generators)
	privateDnsZonesRecordsetTypeAGenerator = gen.Struct(reflect.TypeOf(PrivateDnsZonesRecordsetTypeA{}), generators)

	return privateDnsZonesRecordsetTypeAGenerator
}

// AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeA is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForPrivateDnsZonesRecordsetTypeA(gens map[string]gopter.Gen) {
...
// RunPropertyAssignmentTestForPrivateDnsZones_A_Spec tests if a specific instance of PrivateDnsZones_A_Spec can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateDnsZones_A_STATUS tests if a specific instance of PrivateDnsZones_A_STATUS can be assigned to v1beta20200601storage and back losslessly
