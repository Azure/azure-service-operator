...
// RunPropertyAssignmentTestForPrivateDnsZonesTXTRecord tests if a specific instance of PrivateDnsZonesTXTRecord can be assigned to v1beta20200601storage and back losslessly
