...
// RunPropertyAssignmentTestForPrivateDnsZonesVirtualNetworkLink tests if a specific instance of PrivateDnsZonesVirtualNetworkLink can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_Spec tests if a specific instance of PrivateDnsZones_VirtualNetworkLink_Spec can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateDnsZones_VirtualNetworkLink_STATUS tests if a specific instance of PrivateDnsZones_VirtualNetworkLink_STATUS can be assigned to v1beta20200601storage and back losslessly
