...
var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypePTR{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypePTR from the provided hub PrivateDnsZonesRecordsetTypePTR
func (typePTR *PrivateDnsZonesRecordsetTypePTR) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypePTR)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypePTR but received %T instead", hub)
	}

	return typePTR.AssignProperties_From_PrivateDnsZonesRecordsetTypePTR(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypePTR from our PrivateDnsZonesRecordsetTypePTR
func (typePTR *PrivateDnsZonesRecordsetTypePTR) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypePTR)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypePTR but received %T instead", hub)
	}

	return typePTR.AssignProperties_To_PrivateDnsZonesRecordsetTypePTR(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypeptr,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypeptrs,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypeptrs.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypePTR{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypePTR resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) Default() {
	typePTR.defaultImpl()
	var temp any = typePTR
...
func (typePTR *PrivateDnsZonesRecordsetTypePTR) defaultAzureName() {
	if typePTR.Spec.AzureName == "" {
		typePTR.Spec.AzureName = typePTR.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypePTR resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) defaultImpl() { typePTR.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypePTR{}

// InitializeSpec initializes the spec for this resource from the given status
func (typePTR *PrivateDnsZonesRecordsetTypePTR) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_PTR_STATUS); ok {
		return typePTR.Spec.Initialize_From_PrivateDnsZones_PTR_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypeptr,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypeptrs,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypeptrs.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypePTR{}

// ValidateCreate validates the creation of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) ValidateCreate() error {
	validations := typePTR.createValidations()
	var temp any = typePTR
...
func (typePTR *PrivateDnsZonesRecordsetTypePTR) ValidateDelete() error {
	validations := typePTR.deleteValidations()
	var temp any = typePTR
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typePTR *PrivateDnsZonesRecordsetTypePTR) ValidateUpdate(old runtime.Object) error {
	validations := typePTR.updateValidations()
	var temp any = typePTR
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typePTR *PrivateDnsZonesRecordsetTypePTR) createValidations() []func() error {
	return []func() error{typePTR.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (typePTR *PrivateDnsZonesRecordsetTypePTR) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return typePTR.validateResourceReferences()
		},
		typePTR.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (typePTR *PrivateDnsZonesRecordsetTypePTR) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&typePTR.Spec)
	if err != nil {
		return err
	}
...
func (typePTR *PrivateDnsZonesRecordsetTypePTR) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypePTR)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, typePTR)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypePTR populates our PrivateDnsZonesRecordsetTypePTR from the provided source PrivateDnsZonesRecordsetTypePTR
func (typePTR *PrivateDnsZonesRecordsetTypePTR) AssignProperties_From_PrivateDnsZonesRecordsetTypePTR(source *v20200601s.PrivateDnsZonesRecordsetTypePTR) error {

	// ObjectMeta
	typePTR.ObjectMeta = *source.ObjectMeta.DeepCopy()
...
// AssignProperties_To_PrivateDnsZonesRecordsetTypePTR populates the provided destination PrivateDnsZonesRecordsetTypePTR from our PrivateDnsZonesRecordsetTypePTR
func (typePTR *PrivateDnsZonesRecordsetTypePTR) AssignProperties_To_PrivateDnsZonesRecordsetTypePTR(destination *v20200601s.PrivateDnsZonesRecordsetTypePTR) error {

	// ObjectMeta
	destination.ObjectMeta = *typePTR.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_PTR_Spec
	err := typePTR.Spec.AssignProperties_To_PrivateDnsZones_PTR_Spec(&spec)
	if err != nil {
	...
	err = typePTR.Status.AssignProperties_To_PrivateDnsZones_PTR_STATUS(&status)
	if err != nil {
