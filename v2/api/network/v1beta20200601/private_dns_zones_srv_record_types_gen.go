...
func (record *PrivateDnsZonesSRVRecord) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesSRVRecord but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonessrvrecord,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonessrvrecords,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonessrvrecords.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonessrvrecord,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonessrvrecords,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonessrvrecords.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesSRVRecord{}

// ValidateCreate validates the creation of the resource
func (record *PrivateDnsZonesSRVRecord) ValidateCreate() error {
...
func (record *PrivateDnsZonesSRVRecord) ValidateDelete() error {
...
func (record *PrivateDnsZonesSRVRecord) ValidateUpdate(old runtime.Object) error {
...
func (record *PrivateDnsZonesSRVRecord) createValidations() []func() error {
	return []func() error{record.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (record *PrivateDnsZonesSRVRecord) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (record *PrivateDnsZonesSRVRecord) updateValidations() []func(old runtime.Object) error {
...
func (record *PrivateDnsZonesSRVRecord) validateResourceReferences() error {
...
func (record *PrivateDnsZonesSRVRecord) validateWriteOnceProperties(old runtime.Object) error {
