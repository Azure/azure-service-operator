...
// RunPropertyAssignmentTestForPrivateDnsZonesAAAARecord tests if a specific instance of PrivateDnsZonesAAAARecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateDnsZones_AAAA_Spec tests if a specific instance of PrivateDnsZones_AAAA_Spec can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateDnsZones_AAAA_STATUS tests if a specific instance of PrivateDnsZones_AAAA_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForAaaaRecord tests if a specific instance of AaaaRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForAaaaRecord_STATUS tests if a specific instance of AaaaRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForARecord tests if a specific instance of ARecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForARecord_STATUS tests if a specific instance of ARecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForCnameRecord tests if a specific instance of CnameRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForCnameRecord_STATUS tests if a specific instance of CnameRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForMxRecord tests if a specific instance of MxRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForMxRecord_STATUS tests if a specific instance of MxRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPtrRecord tests if a specific instance of PtrRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForPtrRecord_STATUS tests if a specific instance of PtrRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForSoaRecord tests if a specific instance of SoaRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForSoaRecord_STATUS tests if a specific instance of SoaRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForSrvRecord tests if a specific instance of SrvRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForSrvRecord_STATUS tests if a specific instance of SrvRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForTxtRecord tests if a specific instance of TxtRecord can be assigned to v1beta20200601storage and back losslessly
...
// RunPropertyAssignmentTestForTxtRecord_STATUS tests if a specific instance of TxtRecord_STATUS can be assigned to v1beta20200601storage and back losslessly
