...
func (record *PrivateDnsZonesAAAARecord) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesAAAARecord but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesaaaarecord,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesaaaarecords,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesaaaarecords.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesaaaarecord,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesaaaarecords,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesaaaarecords.network.azure.com,admissionReviewVersions=v1
