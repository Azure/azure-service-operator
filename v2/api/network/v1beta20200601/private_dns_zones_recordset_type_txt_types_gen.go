...
var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypeTXT{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypeTXT from the provided hub PrivateDnsZonesRecordsetTypeTXT
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeTXT)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeTXT but received %T instead", hub)
	}

	return typeTXT.AssignProperties_From_PrivateDnsZonesRecordsetTypeTXT(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypeTXT from our PrivateDnsZonesRecordsetTypeTXT
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeTXT)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeTXT but received %T instead", hub)
	}

	return typeTXT.AssignProperties_To_PrivateDnsZonesRecordsetTypeTXT(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypetxt,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypetxts,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypetxts.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypeTXT{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypeTXT resource
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) Default() {
	typeTXT.defaultImpl()
	var temp any = typeTXT
...
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) defaultAzureName() {
	if typeTXT.Spec.AzureName == "" {
		typeTXT.Spec.AzureName = typeTXT.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypeTXT resource
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) defaultImpl() { typeTXT.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypeTXT{}

// InitializeSpec initializes the spec for this resource from the given status
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_TXT_STATUS); ok {
		return typeTXT.Spec.Initialize_From_PrivateDnsZones_TXT_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypetxt,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypetxts,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypetxts.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypeTXT{}

// ValidateCreate validates the creation of the resource
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) ValidateCreate() error {
	validations := typeTXT.createValidations()
	var temp any = typeTXT
...
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) ValidateDelete() error {
	validations := typeTXT.deleteValidations()
	var temp any = typeTXT
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) ValidateUpdate(old runtime.Object) error {
	validations := typeTXT.updateValidations()
	var temp any = typeTXT
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) createValidations() []func() error {
	return []func() error{typeTXT.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return typeTXT.validateResourceReferences()
		},
		typeTXT.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&typeTXT.Spec)
	if err != nil {
		return err
	}
...
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypeTXT)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, typeTXT)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypeTXT populates our PrivateDnsZonesRecordsetTypeTXT from the provided source PrivateDnsZonesRecordsetTypeTXT
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) AssignProperties_From_PrivateDnsZonesRecordsetTypeTXT(source *v20200601s.PrivateDnsZonesRecordsetTypeTXT) error {

	// ObjectMeta
	typeTXT.ObjectMeta = *source.ObjectMeta.DeepCopy()
	...
	typeTXT.Status = status

	// No error
	return nil
}

// AssignProperties_To_PrivateDnsZonesRecordsetTypeTXT populates the provided destination PrivateDnsZonesRecordsetTypeTXT from our PrivateDnsZonesRecordsetTypeTXT
func (typeTXT *PrivateDnsZonesRecordsetTypeTXT) AssignProperties_To_PrivateDnsZonesRecordsetTypeTXT(destination *v20200601s.PrivateDnsZonesRecordsetTypeTXT) error {

	// ObjectMeta
	destination.ObjectMeta = *typeTXT.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_TXT_Spec
	err := typeTXT.Spec.AssignProperties_To_PrivateDnsZones_TXT_Spec(&spec)
	if err != nil {
	...
	err = typeTXT.Status.AssignProperties_To_PrivateDnsZones_TXT_STATUS(&status)
	if err != nil {
