...
var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypeCNAME{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypeCNAME from the provided hub PrivateDnsZonesRecordsetTypeCNAME
func (cname *PrivateDnsZonesRecordsetTypeCNAME) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeCNAME)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeCNAME but received %T instead", hub)
	}

	return cname.AssignProperties_From_PrivateDnsZonesRecordsetTypeCNAME(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypeCNAME from our PrivateDnsZonesRecordsetTypeCNAME
func (cname *PrivateDnsZonesRecordsetTypeCNAME) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeCNAME)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeCNAME but received %T instead", hub)
	}

	return cname.AssignProperties_To_PrivateDnsZonesRecordsetTypeCNAME(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypecname,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypecnames,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypecnames.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypeCNAME{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypeCNAME resource
func (cname *PrivateDnsZonesRecordsetTypeCNAME) Default() {
	cname.defaultImpl()
	var temp any = cname
...
func (cname *PrivateDnsZonesRecordsetTypeCNAME) defaultAzureName() {
	if cname.Spec.AzureName == "" {
		cname.Spec.AzureName = cname.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypeCNAME resource
func (cname *PrivateDnsZonesRecordsetTypeCNAME) defaultImpl() { cname.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypeCNAME{}

// InitializeSpec initializes the spec for this resource from the given status
func (cname *PrivateDnsZonesRecordsetTypeCNAME) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_CNAME_STATUS); ok {
		return cname.Spec.Initialize_From_PrivateDnsZones_CNAME_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypecname,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypecnames,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypecnames.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypeCNAME{}

// ValidateCreate validates the creation of the resource
func (cname *PrivateDnsZonesRecordsetTypeCNAME) ValidateCreate() error {
	validations := cname.createValidations()
	var temp any = cname
...
func (cname *PrivateDnsZonesRecordsetTypeCNAME) ValidateDelete() error {
	validations := cname.deleteValidations()
	var temp any = cname
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (cname *PrivateDnsZonesRecordsetTypeCNAME) ValidateUpdate(old runtime.Object) error {
	validations := cname.updateValidations()
	var temp any = cname
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (cname *PrivateDnsZonesRecordsetTypeCNAME) createValidations() []func() error {
	return []func() error{cname.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (cname *PrivateDnsZonesRecordsetTypeCNAME) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (cname *PrivateDnsZonesRecordsetTypeCNAME) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return cname.validateResourceReferences()
		},
		cname.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (cname *PrivateDnsZonesRecordsetTypeCNAME) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&cname.Spec)
	if err != nil {
		return err
	}
...
func (cname *PrivateDnsZonesRecordsetTypeCNAME) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypeCNAME)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, cname)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypeCNAME populates our PrivateDnsZonesRecordsetTypeCNAME from the provided source PrivateDnsZonesRecordsetTypeCNAME
func (cname *PrivateDnsZonesRecordsetTypeCNAME) AssignProperties_From_PrivateDnsZonesRecordsetTypeCNAME(source *v20200601s.PrivateDnsZonesRecordsetTypeCNAME) error {

	// ObjectMeta
	cname.ObjectMeta = *source.ObjectMeta.DeepCopy()
...
// AssignProperties_To_PrivateDnsZonesRecordsetTypeCNAME populates the provided destination PrivateDnsZonesRecordsetTypeCNAME from our PrivateDnsZonesRecordsetTypeCNAME
func (cname *PrivateDnsZonesRecordsetTypeCNAME) AssignProperties_To_PrivateDnsZonesRecordsetTypeCNAME(destination *v20200601s.PrivateDnsZonesRecordsetTypeCNAME) error {

	// ObjectMeta
	destination.ObjectMeta = *cname.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_CNAME_Spec
	err := cname.Spec.AssignProperties_To_PrivateDnsZones_CNAME_Spec(&spec)
	if err != nil {
	...
	err = cname.Status.AssignProperties_To_PrivateDnsZones_CNAME_STATUS(&status)
	if err != nil {
