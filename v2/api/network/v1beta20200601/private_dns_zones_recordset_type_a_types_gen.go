...
var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypeA{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypeA from the provided hub PrivateDnsZonesRecordsetTypeA
func (typeA *PrivateDnsZonesRecordsetTypeA) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeA)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeA but received %T instead", hub)
	}

	return typeA.AssignProperties_From_PrivateDnsZonesRecordsetTypeA(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypeA from our PrivateDnsZonesRecordsetTypeA
func (typeA *PrivateDnsZonesRecordsetTypeA) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeA)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeA but received %T instead", hub)
	}

	return typeA.AssignProperties_To_PrivateDnsZonesRecordsetTypeA(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypea,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypeas,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypeas.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypeA{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypeA resource
func (typeA *PrivateDnsZonesRecordsetTypeA) Default() {
	typeA.defaultImpl()
	var temp any = typeA
...
func (typeA *PrivateDnsZonesRecordsetTypeA) defaultAzureName() {
	if typeA.Spec.AzureName == "" {
		typeA.Spec.AzureName = typeA.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypeA resource
func (typeA *PrivateDnsZonesRecordsetTypeA) defaultImpl() { typeA.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypeA{}

// InitializeSpec initializes the spec for this resource from the given status
func (typeA *PrivateDnsZonesRecordsetTypeA) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_A_STATUS); ok {
		return typeA.Spec.Initialize_From_PrivateDnsZones_A_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypea,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypeas,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypeas.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypeA{}

// ValidateCreate validates the creation of the resource
func (typeA *PrivateDnsZonesRecordsetTypeA) ValidateCreate() error {
	validations := typeA.createValidations()
	var temp any = typeA
...
func (typeA *PrivateDnsZonesRecordsetTypeA) ValidateDelete() error {
	validations := typeA.deleteValidations()
	var temp any = typeA
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeA *PrivateDnsZonesRecordsetTypeA) ValidateUpdate(old runtime.Object) error {
	validations := typeA.updateValidations()
	var temp any = typeA
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeA *PrivateDnsZonesRecordsetTypeA) createValidations() []func() error {
	return []func() error{typeA.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (typeA *PrivateDnsZonesRecordsetTypeA) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (typeA *PrivateDnsZonesRecordsetTypeA) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return typeA.validateResourceReferences()
		},
		typeA.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (typeA *PrivateDnsZonesRecordsetTypeA) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&typeA.Spec)
	if err != nil {
		return err
	}
...
func (typeA *PrivateDnsZonesRecordsetTypeA) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypeA)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, typeA)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypeA populates our PrivateDnsZonesRecordsetTypeA from the provided source PrivateDnsZonesRecordsetTypeA
func (typeA *PrivateDnsZonesRecordsetTypeA) AssignProperties_From_PrivateDnsZonesRecordsetTypeA(source *v20200601s.PrivateDnsZonesRecordsetTypeA) error {

	// ObjectMeta
	typeA.ObjectMeta = *source.ObjectMeta.DeepCopy()
...
// AssignProperties_To_PrivateDnsZonesRecordsetTypeA populates the provided destination PrivateDnsZonesRecordsetTypeA from our PrivateDnsZonesRecordsetTypeA
func (typeA *PrivateDnsZonesRecordsetTypeA) AssignProperties_To_PrivateDnsZonesRecordsetTypeA(destination *v20200601s.PrivateDnsZonesRecordsetTypeA) error {

	// ObjectMeta
	destination.ObjectMeta = *typeA.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_A_Spec
	err := typeA.Spec.AssignProperties_To_PrivateDnsZones_A_Spec(&spec)
	if err != nil {
	...
	err = typeA.Status.AssignProperties_To_PrivateDnsZones_A_STATUS(&status)
	if err != nil {
