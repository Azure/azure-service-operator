...
type PrivateDnsZonesRecordsetTypeMX struct {
...
var _ conditions.Conditioner = &PrivateDnsZonesRecordsetTypeMX{}

// GetConditions returns the conditions of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) GetConditions() conditions.Conditions {
	return typeMX.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (typeMX *PrivateDnsZonesRecordsetTypeMX) SetConditions(conditions conditions.Conditions) {
	typeMX.Status.Conditions = conditions
}

var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypeMX{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypeMX from the provided hub PrivateDnsZonesRecordsetTypeMX
func (typeMX *PrivateDnsZonesRecordsetTypeMX) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeMX)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeMX but received %T instead", hub)
	}

	return typeMX.AssignProperties_From_PrivateDnsZonesRecordsetTypeMX(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypeMX from our PrivateDnsZonesRecordsetTypeMX
func (typeMX *PrivateDnsZonesRecordsetTypeMX) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeMX)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeMX but received %T instead", hub)
	}

	return typeMX.AssignProperties_To_PrivateDnsZonesRecordsetTypeMX(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypemx,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypemxes,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypemxes.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypeMX{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypeMX resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) Default() {
	typeMX.defaultImpl()
	var temp any = typeMX
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) defaultAzureName() {
	if typeMX.Spec.AzureName == "" {
		typeMX.Spec.AzureName = typeMX.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypeMX resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) defaultImpl() { typeMX.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypeMX{}

// InitializeSpec initializes the spec for this resource from the given status
func (typeMX *PrivateDnsZonesRecordsetTypeMX) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_MX_STATUS); ok {
		return typeMX.Spec.Initialize_From_PrivateDnsZones_MX_STATUS(s)
	}

	return fmt.Errorf("expected Status of type PrivateDnsZones_MX_STATUS but received %T instead", status)
}

var _ genruntime.KubernetesResource = &PrivateDnsZonesRecordsetTypeMX{}

// AzureName returns the Azure name of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) AzureName() string {
	return typeMX.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-06-01"
func (typeMX PrivateDnsZonesRecordsetTypeMX) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) GetSpec() genruntime.ConvertibleSpec {
	return &typeMX.Spec
}

// GetStatus returns the status of this resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) GetStatus() genruntime.ConvertibleStatus {
	return &typeMX.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/privateDnsZones/MX"
func (typeMX *PrivateDnsZonesRecordsetTypeMX) GetType() string {
	return "Microsoft.Network/privateDnsZones/MX"
}

// NewEmptyStatus returns a new empty (blank) status
func (typeMX *PrivateDnsZonesRecordsetTypeMX) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &PrivateDnsZones_MX_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (typeMX *PrivateDnsZonesRecordsetTypeMX) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(typeMX.Spec)
	return &genruntime.ResourceReference{
		Group: group,
		Kind:  kind,
		Name:  typeMX.Spec.Owner.Name,
	}
}

// SetStatus sets the status of this resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypemx,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypemxes,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypemxes.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypeMX{}

// ValidateCreate validates the creation of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) ValidateCreate() error {
	validations := typeMX.createValidations()
	var temp any = typeMX
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) ValidateDelete() error {
	validations := typeMX.deleteValidations()
	var temp any = typeMX
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) ValidateUpdate(old runtime.Object) error {
	validations := typeMX.updateValidations()
	var temp any = typeMX
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) createValidations() []func() error {
	return []func() error{typeMX.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (typeMX *PrivateDnsZonesRecordsetTypeMX) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return typeMX.validateResourceReferences()
		},
		typeMX.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (typeMX *PrivateDnsZonesRecordsetTypeMX) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&typeMX.Spec)
	if err != nil {
		return err
	}
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypeMX)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, typeMX)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypeMX populates our PrivateDnsZonesRecordsetTypeMX from the provided source PrivateDnsZonesRecordsetTypeMX
func (typeMX *PrivateDnsZonesRecordsetTypeMX) AssignProperties_From_PrivateDnsZonesRecordsetTypeMX(source *v20200601s.PrivateDnsZonesRecordsetTypeMX) error {

	// ObjectMeta
	typeMX.ObjectMeta = *source.ObjectMeta.DeepCopy()
	...
	typeMX.Status = status

	// No error
	return nil
}

// AssignProperties_To_PrivateDnsZonesRecordsetTypeMX populates the provided destination PrivateDnsZonesRecordsetTypeMX from our PrivateDnsZonesRecordsetTypeMX
func (typeMX *PrivateDnsZonesRecordsetTypeMX) AssignProperties_To_PrivateDnsZonesRecordsetTypeMX(destination *v20200601s.PrivateDnsZonesRecordsetTypeMX) error {

	// ObjectMeta
	destination.ObjectMeta = *typeMX.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_MX_Spec
	err := typeMX.Spec.AssignProperties_To_PrivateDnsZones_MX_Spec(&spec)
	if err != nil {
	...
	err = typeMX.Status.AssignProperties_To_PrivateDnsZones_MX_STATUS(&status)
	if err != nil {
...
func (typeMX *PrivateDnsZonesRecordsetTypeMX) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: typeMX.Spec.OriginalVersion(),
		Kind:    "PrivateDnsZonesRecordsetTypeMX",
	}
}
...
// - Generated from: /privatedns/resource-manager/Microsoft.Network/stable/2020-06-01/privatedns.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/privateDnsZones/{privateZoneName}/MX/{relativeRecordSetName}
type PrivateDnsZonesRecordsetTypeMXList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []PrivateDnsZonesRecordsetTypeMX `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&PrivateDnsZonesRecordsetTypeMX{}, &PrivateDnsZonesRecordsetTypeMXList{})
}
