...
func Test_PrivateDnsZonesRecordsetTypeSRV_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypeSRV to hub returns original",
		prop.ForAll(RunResourceConversionTestForPrivateDnsZonesRecordsetTypeSRV, PrivateDnsZonesRecordsetTypeSRVGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForPrivateDnsZonesRecordsetTypeSRV tests if a specific instance of PrivateDnsZonesRecordsetTypeSRV round trips to the hub storage version and back losslessly
func RunResourceConversionTestForPrivateDnsZonesRecordsetTypeSRV(subject PrivateDnsZonesRecordsetTypeSRV) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20200601s.PrivateDnsZonesRecordsetTypeSRV
...
func Test_PrivateDnsZonesRecordsetTypeSRV_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PrivateDnsZonesRecordsetTypeSRV to PrivateDnsZonesRecordsetTypeSRV via AssignProperties_To_PrivateDnsZonesRecordsetTypeSRV & AssignProperties_From_PrivateDnsZonesRecordsetTypeSRV returns original",
		prop.ForAll(RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeSRV, PrivateDnsZonesRecordsetTypeSRVGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeSRV tests if a specific instance of PrivateDnsZonesRecordsetTypeSRV can be assigned to v1beta20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZonesRecordsetTypeSRV(subject PrivateDnsZonesRecordsetTypeSRV) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20200601s.PrivateDnsZonesRecordsetTypeSRV
	err := copied.AssignProperties_To_PrivateDnsZonesRecordsetTypeSRV(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual PrivateDnsZonesRecordsetTypeSRV
	err = actual.AssignProperties_From_PrivateDnsZonesRecordsetTypeSRV(&other)
	if err != nil {
		return err.Error()
	}
