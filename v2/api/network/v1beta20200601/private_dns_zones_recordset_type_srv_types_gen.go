...
var _ conversion.Convertible = &PrivateDnsZonesRecordsetTypeSRV{}

// ConvertFrom populates our PrivateDnsZonesRecordsetTypeSRV from the provided hub PrivateDnsZonesRecordsetTypeSRV
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeSRV)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeSRV but received %T instead", hub)
	}

	return typeSRV.AssignProperties_From_PrivateDnsZonesRecordsetTypeSRV(source)
}

// ConvertTo populates the provided hub PrivateDnsZonesRecordsetTypeSRV from our PrivateDnsZonesRecordsetTypeSRV
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20200601s.PrivateDnsZonesRecordsetTypeSRV)
	if !ok {
		return fmt.Errorf("expected network/v1beta20200601storage/PrivateDnsZonesRecordsetTypeSRV but received %T instead", hub)
	}

	return typeSRV.AssignProperties_To_PrivateDnsZonesRecordsetTypeSRV(destination)
}

// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20200601-privatednszonesrecordsettypesrv,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypesrvs,verbs=create;update,versions=v1beta20200601,name=default.v1beta20200601.privatednszonesrecordsettypesrvs.network.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &PrivateDnsZonesRecordsetTypeSRV{}

// Default applies defaults to the PrivateDnsZonesRecordsetTypeSRV resource
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) Default() {
	typeSRV.defaultImpl()
	var temp any = typeSRV
...
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) defaultAzureName() {
	if typeSRV.Spec.AzureName == "" {
		typeSRV.Spec.AzureName = typeSRV.Name
	}
}

// defaultImpl applies the code generated defaults to the PrivateDnsZonesRecordsetTypeSRV resource
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) defaultImpl() { typeSRV.defaultAzureName() }

var _ genruntime.ImportableResource = &PrivateDnsZonesRecordsetTypeSRV{}

// InitializeSpec initializes the spec for this resource from the given status
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateDnsZones_SRV_STATUS); ok {
		return typeSRV.Spec.Initialize_From_PrivateDnsZones_SRV_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20200601-privatednszonesrecordsettypesrv,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatednszonesrecordsettypesrvs,verbs=create;update,versions=v1beta20200601,name=validate.v1beta20200601.privatednszonesrecordsettypesrvs.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateDnsZonesRecordsetTypeSRV{}

// ValidateCreate validates the creation of the resource
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) ValidateCreate() error {
	validations := typeSRV.createValidations()
	var temp any = typeSRV
...
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) ValidateDelete() error {
	validations := typeSRV.deleteValidations()
	var temp any = typeSRV
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) ValidateUpdate(old runtime.Object) error {
	validations := typeSRV.updateValidations()
	var temp any = typeSRV
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) createValidations() []func() error {
	return []func() error{typeSRV.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) updateValidations() []func(old runtime.Object) error {
	return []func(old runtime.Object) error{
		func(old runtime.Object) error {
			return typeSRV.validateResourceReferences()
		},
		typeSRV.validateWriteOnceProperties}
}

// validateResourceReferences validates all resource references
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) validateResourceReferences() error {
	refs, err := reflecthelpers.FindResourceReferences(&typeSRV.Spec)
	if err != nil {
		return err
	}
...
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) validateWriteOnceProperties(old runtime.Object) error {
	oldObj, ok := old.(*PrivateDnsZonesRecordsetTypeSRV)
	if !ok {
		return nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, typeSRV)
}

// AssignProperties_From_PrivateDnsZonesRecordsetTypeSRV populates our PrivateDnsZonesRecordsetTypeSRV from the provided source PrivateDnsZonesRecordsetTypeSRV
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) AssignProperties_From_PrivateDnsZonesRecordsetTypeSRV(source *v20200601s.PrivateDnsZonesRecordsetTypeSRV) error {

	// ObjectMeta
	typeSRV.ObjectMeta = *source.ObjectMeta.DeepCopy()
	...
	typeSRV.Status = status

	// No error
	return nil
}

// AssignProperties_To_PrivateDnsZonesRecordsetTypeSRV populates the provided destination PrivateDnsZonesRecordsetTypeSRV from our PrivateDnsZonesRecordsetTypeSRV
func (typeSRV *PrivateDnsZonesRecordsetTypeSRV) AssignProperties_To_PrivateDnsZonesRecordsetTypeSRV(destination *v20200601s.PrivateDnsZonesRecordsetTypeSRV) error {

	// ObjectMeta
	destination.ObjectMeta = *typeSRV.ObjectMeta.DeepCopy()

	// Spec
	var spec v20200601s.PrivateDnsZones_SRV_Spec
	err := typeSRV.Spec.AssignProperties_To_PrivateDnsZones_SRV_Spec(&spec)
	if err != nil {
	...
	err = typeSRV.Status.AssignProperties_To_PrivateDnsZones_SRV_STATUS(&status)
	if err != nil {
