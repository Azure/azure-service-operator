...
func Test_CustomIpPrefix_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from CustomIpPrefix to hub returns original",
		prop.ForAll(RunResourceConversionTestForCustomIpPrefix, CustomIpPrefixGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForCustomIpPrefix tests if a specific instance of CustomIpPrefix round trips to the hub storage version and back losslessly
func RunResourceConversionTestForCustomIpPrefix(subject CustomIpPrefix) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v1api20220701s.CustomIpPrefix
...
func Test_CustomIpPrefix_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CustomIpPrefix to CustomIpPrefix via AssignProperties_To_CustomIpPrefix & AssignProperties_From_CustomIpPrefix returns original",
		prop.ForAll(RunPropertyAssignmentTestForCustomIpPrefix, CustomIpPrefixGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCustomIpPrefix tests if a specific instance of CustomIpPrefix can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForCustomIpPrefix(subject CustomIpPrefix) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.CustomIpPrefix
	err := copied.AssignProperties_To_CustomIpPrefix(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual CustomIpPrefix
	err = actual.AssignProperties_From_CustomIpPrefix(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_CustomIpPrefix_Spec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CustomIpPrefix_Spec to CustomIpPrefix_Spec via AssignProperties_To_CustomIpPrefix_Spec & AssignProperties_From_CustomIpPrefix_Spec returns original",
		prop.ForAll(RunPropertyAssignmentTestForCustomIpPrefix_Spec, CustomIpPrefix_SpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCustomIpPrefix_Spec tests if a specific instance of CustomIpPrefix_Spec can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForCustomIpPrefix_Spec(subject CustomIpPrefix_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.CustomIpPrefix_Spec
	err := copied.AssignProperties_To_CustomIpPrefix_Spec(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CustomIpPrefix_Spec(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_CustomIpPrefix_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CustomIpPrefix_STATUS to CustomIpPrefix_STATUS via AssignProperties_To_CustomIpPrefix_STATUS & AssignProperties_From_CustomIpPrefix_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForCustomIpPrefix_STATUS, CustomIpPrefix_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCustomIpPrefix_STATUS tests if a specific instance of CustomIpPrefix_STATUS can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForCustomIpPrefix_STATUS(subject CustomIpPrefix_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.CustomIpPrefix_STATUS
	err := copied.AssignProperties_To_CustomIpPrefix_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CustomIpPrefix_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_CustomIpPrefixSubResource_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CustomIpPrefixSubResource to CustomIpPrefixSubResource via AssignProperties_To_CustomIpPrefixSubResource & AssignProperties_From_CustomIpPrefixSubResource returns original",
		prop.ForAll(RunPropertyAssignmentTestForCustomIpPrefixSubResource, CustomIpPrefixSubResourceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCustomIpPrefixSubResource tests if a specific instance of CustomIpPrefixSubResource can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForCustomIpPrefixSubResource(subject CustomIpPrefixSubResource) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.CustomIpPrefixSubResource
	err := copied.AssignProperties_To_CustomIpPrefixSubResource(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CustomIpPrefixSubResource(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_CustomIpPrefixSubResource_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CustomIpPrefixSubResource_STATUS to CustomIpPrefixSubResource_STATUS via AssignProperties_To_CustomIpPrefixSubResource_STATUS & AssignProperties_From_CustomIpPrefixSubResource_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForCustomIpPrefixSubResource_STATUS, CustomIpPrefixSubResource_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCustomIpPrefixSubResource_STATUS tests if a specific instance of CustomIpPrefixSubResource_STATUS can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForCustomIpPrefixSubResource_STATUS(subject CustomIpPrefixSubResource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.CustomIpPrefixSubResource_STATUS
	err := copied.AssignProperties_To_CustomIpPrefixSubResource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CustomIpPrefixSubResource_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
// RunPropertyAssignmentTestForExtendedLocation tests if a specific instance of ExtendedLocation can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForExtendedLocation(subject ExtendedLocation) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.ExtendedLocation
...
// RunPropertyAssignmentTestForExtendedLocation_STATUS tests if a specific instance of ExtendedLocation_STATUS can be assigned to v1api20220701storage and back losslessly
func RunPropertyAssignmentTestForExtendedLocation_STATUS(subject ExtendedLocation_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20220701s.ExtendedLocation_STATUS
