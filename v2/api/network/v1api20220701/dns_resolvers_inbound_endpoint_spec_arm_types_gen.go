...
type DnsResolversInboundEndpoint_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &DnsResolversInboundEndpoint_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-07-01"
func (endpoint DnsResolversInboundEndpoint_Spec_ARM) GetAPIVersion() string {
	return "2022-07-01"
}

// GetName returns the Name of the resource
func (endpoint *DnsResolversInboundEndpoint_Spec_ARM) GetName() string {
	return endpoint.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/dnsResolvers/inboundEndpoints"
func (endpoint *DnsResolversInboundEndpoint_Spec_ARM) GetType() string {
