...
func Test_DnsForwardingRuleSetsForwardingRule_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of DnsForwardingRuleSetsForwardingRule_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDnsForwardingRuleSetsForwardingRule_Spec_ARM, DnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDnsForwardingRuleSetsForwardingRule_Spec_ARM runs a test to see if a specific instance of DnsForwardingRuleSetsForwardingRule_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDnsForwardingRuleSetsForwardingRule_Spec_ARM(subject DnsForwardingRuleSetsForwardingRule_Spec_ARM) string {
	// Serialize to JSON
	...
	var actual DnsForwardingRuleSetsForwardingRule_Spec_ARM
...
// Generator of DnsForwardingRuleSetsForwardingRule_Spec_ARM instances for property testing - lazily instantiated by
// DnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator()
var dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator gopter.Gen

// DnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator returns a generator of DnsForwardingRuleSetsForwardingRule_Spec_ARM instances for property testing.
// We first initialize dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator() gopter.Gen {
	if dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator != nil {
		return dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM(generators)
	dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(DnsForwardingRuleSetsForwardingRule_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM(generators)
	dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(DnsForwardingRuleSetsForwardingRule_Spec_ARM{}), generators)

	return dnsForwardingRuleSetsForwardingRule_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDnsForwardingRuleSetsForwardingRule_Spec_ARM(gens map[string]gopter.Gen) {
