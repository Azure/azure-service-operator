...
type DnsForwardingRuleSetsForwardingRule_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &DnsForwardingRuleSetsForwardingRule_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-07-01"
func (rule DnsForwardingRuleSetsForwardingRule_Spec_ARM) GetAPIVersion() string {
	return "2022-07-01"
}

// GetName returns the Name of the resource
func (rule *DnsForwardingRuleSetsForwardingRule_Spec_ARM) GetName() string {
	return rule.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/dnsForwardingRulesets/forwardingRules"
func (rule *DnsForwardingRuleSetsForwardingRule_Spec_ARM) GetType() string {
