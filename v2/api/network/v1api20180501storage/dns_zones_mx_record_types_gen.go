...
// +kubebuilder:rbac:groups=network.azure.com,resources=dnszonesmxrecords,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=network.azure.com,resources={dnszonesmxrecords/status,dnszonesmxrecords/finalizers},verbs=get;update;patch
...
// Storage version of v1api20180501.DnsZonesMXRecord
