...
func (group *PrivateEndpointsPrivateDnsZoneGroup) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1beta20220701storage/PrivateEndpointsPrivateDnsZoneGroup but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20220701-privateendpointsprivatednszonegroup,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpointsprivatednszonegroups,verbs=create;update,versions=v1beta20220701,name=default.v1beta20220701.privateendpointsprivatednszonegroups.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20220701-privateendpointsprivatednszonegroup,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpointsprivatednszonegroups,verbs=create;update,versions=v1beta20220701,name=validate.v1beta20220701.privateendpointsprivatednszonegroups.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateEndpointsPrivateDnsZoneGroup{}

// ValidateCreate validates the creation of the resource
func (group *PrivateEndpointsPrivateDnsZoneGroup) ValidateCreate() error {
...
func (group *PrivateEndpointsPrivateDnsZoneGroup) ValidateDelete() error {
...
func (group *PrivateEndpointsPrivateDnsZoneGroup) ValidateUpdate(old runtime.Object) error {
...
func (group *PrivateEndpointsPrivateDnsZoneGroup) createValidations() []func() error {
	return []func() error{group.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (group *PrivateEndpointsPrivateDnsZoneGroup) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (group *PrivateEndpointsPrivateDnsZoneGroup) updateValidations() []func(old runtime.Object) error {
...
func (group *PrivateEndpointsPrivateDnsZoneGroup) validateResourceReferences() error {
...
func (group *PrivateEndpointsPrivateDnsZoneGroup) validateWriteOnceProperties(old runtime.Object) error {
