...
func (endpoint *PrivateEndpoint) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1beta20220701storage/PrivateEndpoint but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20220701-privateendpoint,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpoints,verbs=create;update,versions=v1beta20220701,name=default.v1beta20220701.privateendpoints.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20220701-privateendpoint,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpoints,verbs=create;update,versions=v1beta20220701,name=validate.v1beta20220701.privateendpoints.network.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &PrivateEndpoint{}

// ValidateCreate validates the creation of the resource
func (endpoint *PrivateEndpoint) ValidateCreate() error {
...
func (endpoint *PrivateEndpoint) ValidateDelete() error {
...
func (endpoint *PrivateEndpoint) ValidateUpdate(old runtime.Object) error {
...
func (endpoint *PrivateEndpoint) createValidations() []func() error {
	return []func() error{endpoint.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (endpoint *PrivateEndpoint) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (endpoint *PrivateEndpoint) updateValidations() []func(old runtime.Object) error {
...
func (endpoint *PrivateEndpoint) validateResourceReferences() error {
...
func (endpoint *PrivateEndpoint) validateWriteOnceProperties(old runtime.Object) error {
