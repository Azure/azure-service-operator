...
func (service *PrivateLinkService) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1beta20220701storage/PrivateLinkService but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1beta20220701-privatelinkservice,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatelinkservices,verbs=create;update,versions=v1beta20220701,name=default.v1beta20220701.privatelinkservices.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20220701-privatelinkservice,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privatelinkservices,verbs=create;update,versions=v1beta20220701,name=validate.v1beta20220701.privatelinkservices.network.azure.com,admissionReviewVersions=v1
