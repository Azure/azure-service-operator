...
func AddIndependentPropertyGeneratorsForSecurityRulePropertiesFormatARM(gens map[string]gopter.Gen) {
	gens["Access"] = gen.OneConstOf(SecurityRuleAccessAllow, SecurityRuleAccessDeny)
	...
	gens["Direction"] = gen.OneConstOf(SecurityRuleDirectionInbound, SecurityRuleDirectionOutbound)
