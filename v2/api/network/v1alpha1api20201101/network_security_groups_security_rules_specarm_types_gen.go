...
type NetworkSecurityGroupsSecurityRules_SPECARM struct {
	...
	Properties *SecurityRulePropertiesFormat_SpecARM `json:"properties,omitempty"`
...
func (specarm NetworkSecurityGroupsSecurityRules_SPECARM) GetAPIVersion() string {
	return "2020-11-01"
}

// GetName returns the Name of the resource
func (specarm NetworkSecurityGroupsSecurityRules_SPECARM) GetName() string {
	return specarm.Name
}

// GetType returns the ARM Type of the resource. This is always ""
func (specarm NetworkSecurityGroupsSecurityRules_SPECARM) GetType() string {
	return ""
}

type SecurityRulePropertiesFormat_SpecARM struct {
	//Access: The network traffic is allowed or denied.
	Access SecurityRuleAccess_Spec `json:"access"`
	...
	//as destination.
	DestinationApplicationSecurityGroups []ApplicationSecurityGroup_SpecARM `json:"destinationApplicationSecurityGroups,omitempty"`
	...
	Direction SecurityRuleDirection_Spec `json:"direction"`
	...
	//source.
	SourceApplicationSecurityGroups []ApplicationSecurityGroup_SpecARM `json:"sourceApplicationSecurityGroups,omitempty"`
...
type ApplicationSecurityGroup_SpecARM struct {
	Id *string `json:"id,omitempty"`
