...
// RunPropertyAssignmentTestForNetworkSecurityGroups_SecurityRules_Spec tests if a specific instance of NetworkSecurityGroups_SecurityRules_Spec can be assigned to v1alpha1api20201101storage and back losslessly
...
=======
	var other alpha20201101s.NetworkSecurityGroups_SecurityRules_Spec
...
// RunPropertyAssignmentTestForSecurityRule_STATUS_NetworkSecurityGroups_SecurityRule_SubResourceEmbedded tests if a specific instance of SecurityRule_STATUS_NetworkSecurityGroups_SecurityRule_SubResourceEmbedded can be assigned to v1alpha1api20201101storage and back losslessly
func RunPropertyAssignmentTestForSecurityRule_STATUS_NetworkSecurityGroups_SecurityRule_SubResourceEmbedded(subject SecurityRule_STATUS_NetworkSecurityGroups_SecurityRule_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20201101s.SecurityRule_STATUS_NetworkSecurityGroups_SecurityRule_SubResourceEmbedded
