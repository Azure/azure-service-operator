...
func (balancer *LoadBalancer) AssignProperties_From_LoadBalancer(source *alpha20201101s.LoadBalancer) error {
...
func (balancer *LoadBalancer) AssignProperties_To_LoadBalancer(destination *alpha20201101s.LoadBalancer) error {
...
func (balancer *LoadBalancer_Spec) AssignProperties_From_LoadBalancer_Spec(source *alpha20201101s.LoadBalancer_Spec) error {
...
func (balancer *LoadBalancer_Spec) AssignProperties_To_LoadBalancer_Spec(destination *alpha20201101s.LoadBalancer_Spec) error {
	...
	if balancer.BackendAddressPools != nil {
<<<<<<< HEAD
		backendAddressPoolList := make([]alpha20201101s.BackendAddressPool, len(balancer.BackendAddressPools))
		for backendAddressPoolIndex, backendAddressPoolItem := range balancer.BackendAddressPools {
			// Shadow the loop variable to avoid aliasing
			backendAddressPoolItem := backendAddressPoolItem
			var backendAddressPool alpha20201101s.BackendAddressPool
...
=======
		backendAddressPoolList := make([]alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools, len(balancer.BackendAddressPools))
		for backendAddressPoolIndex, backendAddressPoolItem := range balancer.BackendAddressPools {
			// Shadow the loop variable to avoid aliasing
			backendAddressPoolItem := backendAddressPoolItem
			var backendAddressPool alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools
...
<<<<<<< HEAD
		frontendIPConfigurationList := make([]alpha20201101s.FrontendIPConfiguration, len(balancer.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range balancer.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration alpha20201101s.FrontendIPConfiguration
...
=======
		frontendIPConfigurationList := make([]alpha20201101s.LoadBalancer_Spec_Properties_FrontendIPConfigurations, len(balancer.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range balancer.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration alpha20201101s.LoadBalancer_Spec_Properties_FrontendIPConfigurations
...
=======
		inboundNatPoolList := make([]alpha20201101s.LoadBalancer_Spec_Properties_InboundNatPools, len(balancer.InboundNatPools))
		for inboundNatPoolIndex, inboundNatPoolItem := range balancer.InboundNatPools {
			// Shadow the loop variable to avoid aliasing
			inboundNatPoolItem := inboundNatPoolItem
			var inboundNatPool alpha20201101s.LoadBalancer_Spec_Properties_InboundNatPools
...
<<<<<<< HEAD
	...
	if balancer.InboundNatRules != nil {
		inboundNatRuleList := make([]alpha20201101s.InboundNatRule, len(balancer.InboundNatRules))
		for inboundNatRuleIndex, inboundNatRuleItem := range balancer.InboundNatRules {
			// Shadow the loop variable to avoid aliasing
			inboundNatRuleItem := inboundNatRuleItem
			var inboundNatRule alpha20201101s.InboundNatRule
...
=======
	// LoadBalancingRules
	if balancer.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]alpha20201101s.LoadBalancer_Spec_Properties_LoadBalancingRules, len(balancer.LoadBalancingRules))
		for loadBalancingRuleIndex, loadBalancingRuleItem := range balancer.LoadBalancingRules {
			// Shadow the loop variable to avoid aliasing
			loadBalancingRuleItem := loadBalancingRuleItem
			var loadBalancingRule alpha20201101s.LoadBalancer_Spec_Properties_LoadBalancingRules
...
=======
		outboundRuleList := make([]alpha20201101s.LoadBalancer_Spec_Properties_OutboundRules, len(balancer.OutboundRules))
		for outboundRuleIndex, outboundRuleItem := range balancer.OutboundRules {
			// Shadow the loop variable to avoid aliasing
			outboundRuleItem := outboundRuleItem
			var outboundRule alpha20201101s.LoadBalancer_Spec_Properties_OutboundRules
...
=======
		probeList := make([]alpha20201101s.LoadBalancer_Spec_Properties_Probes, len(balancer.Probes))
		for probeIndex, probeItem := range balancer.Probes {
			// Shadow the loop variable to avoid aliasing
			probeItem := probeItem
			var probe alpha20201101s.LoadBalancer_Spec_Properties_Probes
...
func (balancer *LoadBalancer_STATUS) AssignProperties_From_LoadBalancer_STATUS(source *alpha20201101s.LoadBalancer_STATUS) error {
...
func (balancer *LoadBalancer_STATUS) AssignProperties_To_LoadBalancer_STATUS(destination *alpha20201101s.LoadBalancer_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackendAddressPools
	if balancer.BackendAddressPools != nil {
		backendAddressPoolList := make([]alpha20201101s.BackendAddressPool_STATUS, len(balancer.BackendAddressPools))
		for backendAddressPoolIndex, backendAddressPoolItem := range balancer.BackendAddressPools {
			// Shadow the loop variable to avoid aliasing
			backendAddressPoolItem := backendAddressPoolItem
			var backendAddressPool alpha20201101s.BackendAddressPool_STATUS
	...
	// FrontendIPConfigurations
	if balancer.FrontendIPConfigurations != nil {
		frontendIPConfigurationList := make([]alpha20201101s.FrontendIPConfiguration_STATUS, len(balancer.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range balancer.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration alpha20201101s.FrontendIPConfiguration_STATUS
	...
	// InboundNatRules
	if balancer.InboundNatRules != nil {
		inboundNatRuleList := make([]alpha20201101s.InboundNatRule_STATUS, len(balancer.InboundNatRules))
		for inboundNatRuleIndex, inboundNatRuleItem := range balancer.InboundNatRules {
			// Shadow the loop variable to avoid aliasing
			inboundNatRuleItem := inboundNatRuleItem
			var inboundNatRule alpha20201101s.InboundNatRule_STATUS
...
func (pool *BackendAddressPool) AssignProperties_From_BackendAddressPool(source *alpha20201101s.BackendAddressPool) error {
...
func (pool *BackendAddressPool) AssignProperties_To_BackendAddressPool(destination *alpha20201101s.BackendAddressPool) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// LoadBalancerBackendAddresses
	if pool.LoadBalancerBackendAddresses != nil {
		loadBalancerBackendAddressList := make([]alpha20201101s.LoadBalancerBackendAddress, len(pool.LoadBalancerBackendAddresses))
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range pool.LoadBalancerBackendAddresses {
			// Shadow the loop variable to avoid aliasing
			loadBalancerBackendAddressItem := loadBalancerBackendAddressItem
			var loadBalancerBackendAddress alpha20201101s.LoadBalancerBackendAddress
...
func (pool *BackendAddressPool_STATUS) AssignProperties_From_BackendAddressPool_STATUS(source *alpha20201101s.BackendAddressPool_STATUS) error {
...
func (pool *BackendAddressPool_STATUS) AssignProperties_To_BackendAddressPool_STATUS(destination *alpha20201101s.BackendAddressPool_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// LoadBalancerBackendAddresses
	if pool.LoadBalancerBackendAddresses != nil {
		loadBalancerBackendAddressList := make([]alpha20201101s.LoadBalancerBackendAddress_STATUS, len(pool.LoadBalancerBackendAddresses))
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range pool.LoadBalancerBackendAddresses {
			// Shadow the loop variable to avoid aliasing
			loadBalancerBackendAddressItem := loadBalancerBackendAddressItem
			var loadBalancerBackendAddress alpha20201101s.LoadBalancerBackendAddress_STATUS
	...
	if pool.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]alpha20201101s.SubResource_STATUS, len(pool.LoadBalancingRules))
	...
	if pool.OutboundRules != nil {
		outboundRuleList := make([]alpha20201101s.SubResource_STATUS, len(pool.OutboundRules))
...
func (location *ExtendedLocation) AssignProperties_From_ExtendedLocation(source *alpha20201101s.ExtendedLocation) error {
...
func (location *ExtendedLocation) AssignProperties_To_ExtendedLocation(destination *alpha20201101s.ExtendedLocation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (location *ExtendedLocation_STATUS) AssignProperties_From_ExtendedLocation_STATUS(source *alpha20201101s.ExtendedLocation_STATUS) error {
...
func (location *ExtendedLocation_STATUS) AssignProperties_To_ExtendedLocation_STATUS(destination *alpha20201101s.ExtendedLocation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *FrontendIPConfiguration) AssignProperties_From_FrontendIPConfiguration(source *alpha20201101s.FrontendIPConfiguration) error {
...
func (configuration *FrontendIPConfiguration) AssignProperties_To_FrontendIPConfiguration(destination *alpha20201101s.FrontendIPConfiguration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *FrontendIPConfiguration_STATUS) AssignProperties_From_FrontendIPConfiguration_STATUS(source *alpha20201101s.FrontendIPConfiguration_STATUS) error {
...
func (configuration *FrontendIPConfiguration_STATUS) AssignProperties_To_FrontendIPConfiguration_STATUS(destination *alpha20201101s.FrontendIPConfiguration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if configuration.InboundNatPools != nil {
		inboundNatPoolList := make([]alpha20201101s.SubResource_STATUS, len(configuration.InboundNatPools))
	...
	if configuration.InboundNatRules != nil {
		inboundNatRuleList := make([]alpha20201101s.SubResource_STATUS, len(configuration.InboundNatRules))
	...
	if configuration.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]alpha20201101s.SubResource_STATUS, len(configuration.LoadBalancingRules))
	...
	if configuration.OutboundRules != nil {
		outboundRuleList := make([]alpha20201101s.SubResource_STATUS, len(configuration.OutboundRules))
...
func (pool *InboundNatPool) AssignProperties_From_InboundNatPool(source *alpha20201101s.InboundNatPool) error {
...
func (pool *InboundNatPool) AssignProperties_To_InboundNatPool(destination *alpha20201101s.InboundNatPool) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (pool *InboundNatPool_STATUS) AssignProperties_From_InboundNatPool_STATUS(source *alpha20201101s.InboundNatPool_STATUS) error {
...
func (pool *InboundNatPool_STATUS) AssignProperties_To_InboundNatPool_STATUS(destination *alpha20201101s.InboundNatPool_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded(source *alpha20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded(destination *alpha20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (pools *LoadBalancer_Spec_Properties_BackendAddressPools) AssignProperties_From_LoadBalancer_Spec_Properties_BackendAddressPools(source *alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools) error {
...
func (pools *LoadBalancer_Spec_Properties_BackendAddressPools) AssignProperties_To_LoadBalancer_Spec_Properties_BackendAddressPools(destination *alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// LoadBalancerBackendAddresses
	if pools.LoadBalancerBackendAddresses != nil {
		loadBalancerBackendAddressList := make([]alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools_Properties_LoadBalancerBackendAddresses, len(pools.LoadBalancerBackendAddresses))
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range pools.LoadBalancerBackendAddresses {
			// Shadow the loop variable to avoid aliasing
			loadBalancerBackendAddressItem := loadBalancerBackendAddressItem
			var loadBalancerBackendAddress alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools_Properties_LoadBalancerBackendAddresses
...
func (configurations *LoadBalancer_Spec_Properties_FrontendIPConfigurations) AssignProperties_From_LoadBalancer_Spec_Properties_FrontendIPConfigurations(source *alpha20201101s.LoadBalancer_Spec_Properties_FrontendIPConfigurations) error {
...
func (configurations *LoadBalancer_Spec_Properties_FrontendIPConfigurations) AssignProperties_To_LoadBalancer_Spec_Properties_FrontendIPConfigurations(destination *alpha20201101s.LoadBalancer_Spec_Properties_FrontendIPConfigurations) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (pools *LoadBalancer_Spec_Properties_InboundNatPools) AssignProperties_From_LoadBalancer_Spec_Properties_InboundNatPools(source *alpha20201101s.LoadBalancer_Spec_Properties_InboundNatPools) error {
...
func (pools *LoadBalancer_Spec_Properties_InboundNatPools) AssignProperties_To_LoadBalancer_Spec_Properties_InboundNatPools(destination *alpha20201101s.LoadBalancer_Spec_Properties_InboundNatPools) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *InboundNatRule) AssignProperties_From_InboundNatRule(source *alpha20201101s.InboundNatRule) error {
=======
...
func (rules *LoadBalancer_Spec_Properties_LoadBalancingRules) AssignProperties_From_LoadBalancer_Spec_Properties_LoadBalancingRules(source *alpha20201101s.LoadBalancer_Spec_Properties_LoadBalancingRules) error {
...
func (rule *InboundNatRule) AssignProperties_To_InboundNatRule(destination *alpha20201101s.InboundNatRule) error {
=======
...
func (rules *LoadBalancer_Spec_Properties_LoadBalancingRules) AssignProperties_To_LoadBalancer_Spec_Properties_LoadBalancingRules(destination *alpha20201101s.LoadBalancer_Spec_Properties_LoadBalancingRules) error {
>>>>>>> main
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *InboundNatRule_STATUS) AssignProperties_From_InboundNatRule_STATUS(source *alpha20201101s.InboundNatRule_STATUS) error {
=======
...
func (rules *LoadBalancer_Spec_Properties_OutboundRules) AssignProperties_From_LoadBalancer_Spec_Properties_OutboundRules(source *alpha20201101s.LoadBalancer_Spec_Properties_OutboundRules) error {
>>>>>>> main
...
func (rule *InboundNatRule_STATUS) AssignProperties_To_InboundNatRule_STATUS(destination *alpha20201101s.InboundNatRule_STATUS) error {
=======
...
func (rules *LoadBalancer_Spec_Properties_OutboundRules) AssignProperties_To_LoadBalancer_Spec_Properties_OutboundRules(destination *alpha20201101s.LoadBalancer_Spec_Properties_OutboundRules) error {
>>>>>>> main
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (probes *LoadBalancer_Spec_Properties_Probes) AssignProperties_From_LoadBalancer_Spec_Properties_Probes(source *alpha20201101s.LoadBalancer_Spec_Properties_Probes) error {
...
func (probes *LoadBalancer_Spec_Properties_Probes) AssignProperties_To_LoadBalancer_Spec_Properties_Probes(destination *alpha20201101s.LoadBalancer_Spec_Properties_Probes) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (balancerSku *LoadBalancerSku) AssignProperties_From_LoadBalancerSku(source *alpha20201101s.LoadBalancerSku) error {
...
func (balancerSku *LoadBalancerSku) AssignProperties_To_LoadBalancerSku(destination *alpha20201101s.LoadBalancerSku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (balancerSku *LoadBalancerSku_STATUS) AssignProperties_From_LoadBalancerSku_STATUS(source *alpha20201101s.LoadBalancerSku_STATUS) error {
...
func (balancerSku *LoadBalancerSku_STATUS) AssignProperties_To_LoadBalancerSku_STATUS(destination *alpha20201101s.LoadBalancerSku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *LoadBalancingRule) AssignProperties_From_LoadBalancingRule(source *alpha20201101s.LoadBalancingRule) error {
...
func (rule *LoadBalancingRule) AssignProperties_To_LoadBalancingRule(destination *alpha20201101s.LoadBalancingRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_From_LoadBalancingRule_STATUS(source *alpha20201101s.LoadBalancingRule_STATUS) error {
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_To_LoadBalancingRule_STATUS(destination *alpha20201101s.LoadBalancingRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *OutboundRule) AssignProperties_From_OutboundRule(source *alpha20201101s.OutboundRule) error {
...
func (rule *OutboundRule) AssignProperties_To_OutboundRule(destination *alpha20201101s.OutboundRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *OutboundRule_STATUS) AssignProperties_From_OutboundRule_STATUS(source *alpha20201101s.OutboundRule_STATUS) error {
...
func (rule *OutboundRule_STATUS) AssignProperties_To_OutboundRule_STATUS(destination *alpha20201101s.OutboundRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (probe *Probe) AssignProperties_From_Probe(source *alpha20201101s.Probe) error {
...
func (probe *Probe) AssignProperties_To_Probe(destination *alpha20201101s.Probe) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (probe *Probe_STATUS) AssignProperties_From_Probe_STATUS(source *alpha20201101s.Probe_STATUS) error {
...
func (probe *Probe_STATUS) AssignProperties_To_Probe_STATUS(destination *alpha20201101s.Probe_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
=======
// Deprecated version of FrontendIPConfigurationPropertiesFormat_PrivateIPAddressVersion. Use
// v1beta20201101.FrontendIPConfigurationPropertiesFormat_PrivateIPAddressVersion instead
...
// Deprecated version of FrontendIPConfigurationPropertiesFormat_PrivateIPAllocationMethod. Use
// v1beta20201101.FrontendIPConfigurationPropertiesFormat_PrivateIPAllocationMethod instead
...
// Deprecated version of InboundNatPoolPropertiesFormat_Protocol. Use
// v1beta20201101.InboundNatPoolPropertiesFormat_Protocol instead
...
func (address *LoadBalancerBackendAddress) AssignProperties_From_LoadBalancerBackendAddress(source *alpha20201101s.LoadBalancerBackendAddress) error {
=======
...
func (addresses *LoadBalancer_Spec_Properties_BackendAddressPools_Properties_LoadBalancerBackendAddresses) AssignProperties_From_LoadBalancer_Spec_Properties_BackendAddressPools_Properties_LoadBalancerBackendAddresses(source *alpha20201101s.LoadBalancer_Spec_Properties_BackendAddressPools_Properties_LoadBalancerBackendAddresses) error {
>>>>>>> main
...
func (address *LoadBalancerBackendAddress) AssignProperties_To_LoadBalancerBackendAddress(destination *alpha20201101s.LoadBalancerBackendAddress) error {
=======
...
func (address *LoadBalancerBackendAddress_STATUS) AssignProperties_From_LoadBalancerBackendAddress_STATUS(source *alpha20201101s.LoadBalancerBackendAddress_STATUS) error {
...
func (address *LoadBalancerBackendAddress_STATUS) AssignProperties_To_LoadBalancerBackendAddress_STATUS(destination *alpha20201101s.LoadBalancerBackendAddress_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// LoadBalancerFrontendIPConfiguration
	if address.LoadBalancerFrontendIPConfiguration != nil {
		var loadBalancerFrontendIPConfiguration alpha20201101s.SubResource_STATUS
	...
	if address.NetworkInterfaceIPConfiguration != nil {
		var networkInterfaceIPConfiguration alpha20201101s.SubResource_STATUS
	...
	// VirtualNetwork
	if address.VirtualNetwork != nil {
		var virtualNetwork alpha20201101s.SubResource_STATUS
...
func (address *PublicIPAddress_STATUS) AssignProperties_From_PublicIPAddress_STATUS(source *alpha20201101s.PublicIPAddress_STATUS) error {
...
func (address *PublicIPAddress_STATUS) AssignProperties_To_PublicIPAddress_STATUS(destination *alpha20201101s.PublicIPAddress_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if address.IpTags != nil {
		ipTagList := make([]alpha20201101s.IpTag_STATUS, len(address.IpTags))
	...
	if address.LinkedPublicIPAddress != nil {
		var linkedPublicIPAddress alpha20201101s.PublicIPAddress_STATUS
	...
	if address.NatGateway != nil {
		var natGateway alpha20201101s.NatGateway_STATUS
	...
	if address.ServicePublicIPAddress != nil {
		var servicePublicIPAddress alpha20201101s.PublicIPAddress_STATUS
...
func (address *PublicIPAddressSpec) AssignProperties_From_PublicIPAddressSpec(source *alpha20201101s.PublicIPAddressSpec) error {
...
func (address *PublicIPAddressSpec) AssignProperties_To_PublicIPAddressSpec(destination *alpha20201101s.PublicIPAddressSpec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (subnet *Subnet) AssignProperties_From_Subnet(source *alpha20201101s.Subnet) error {
...
func (subnet *Subnet) AssignProperties_To_Subnet(destination *alpha20201101s.Subnet) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (subnet *Subnet_STATUS) AssignProperties_From_Subnet_STATUS(source *alpha20201101s.Subnet_STATUS) error {
...
func (subnet *Subnet_STATUS) AssignProperties_To_Subnet_STATUS(destination *alpha20201101s.Subnet_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (gateway *NatGateway_STATUS) AssignProperties_From_NatGateway_STATUS(source *alpha20201101s.NatGateway_STATUS) error {
...
func (gateway *NatGateway_STATUS) AssignProperties_To_NatGateway_STATUS(destination *alpha20201101s.NatGateway_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if gateway.PublicIpAddresses != nil {
		publicIpAddressList := make([]alpha20201101s.SubResource_STATUS, len(gateway.PublicIpAddresses))
	...
	if gateway.PublicIpPrefixes != nil {
		publicIpPrefixList := make([]alpha20201101s.SubResource_STATUS, len(gateway.PublicIpPrefixes))
	...
	if gateway.Subnets != nil {
		subnetList := make([]alpha20201101s.SubResource_STATUS, len(gateway.Subnets))
