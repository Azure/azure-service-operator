...
func (peering *VirtualNetworksVirtualNetworkPeering) AssignProperties_To_VirtualNetworksVirtualNetworkPeering(destination *alpha20201101s.VirtualNetworksVirtualNetworkPeering) error {
	...
	// Status
	var status alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS{}
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS{}
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &VirtualNetworks_VirtualNetworkPeering_STATUSARM{}
}
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(VirtualNetworks_VirtualNetworkPeering_STATUSARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected VirtualNetworks_VirtualNetworkPeering_STATUSARM, got %T", armInput)
	}
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) AssignProperties_From_VirtualNetworks_VirtualNetworkPeering_STATUS(source *alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS) error {
...
func (peering *VirtualNetworks_VirtualNetworkPeering_STATUS) AssignProperties_To_VirtualNetworks_VirtualNetworkPeering_STATUS(destination *alpha20201101s.VirtualNetworks_VirtualNetworkPeering_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
