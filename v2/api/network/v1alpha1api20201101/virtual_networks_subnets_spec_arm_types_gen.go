...
// Deprecated version of VirtualNetworks_Subnets_Spec. Use v1beta20201101.VirtualNetworks_Subnets_Spec instead
type VirtualNetworks_Subnets_SpecARM struct {
	Name       string                                      `json:"name,omitempty"`
	Properties *VirtualNetworks_Subnets_Spec_PropertiesARM `json:"properties,omitempty"`
}

var _ genruntime.ARMResourceSpec = &VirtualNetworks_Subnets_SpecARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-11-01"
func (subnets VirtualNetworks_Subnets_SpecARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (subnets *VirtualNetworks_Subnets_SpecARM) GetName() string {
	return subnets.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/virtualNetworks/subnets"
func (subnets *VirtualNetworks_Subnets_SpecARM) GetType() string {
	return "Microsoft.Network/virtualNetworks/subnets"
}

// Deprecated version of VirtualNetworks_Subnets_Spec_Properties. Use v1beta20201101.VirtualNetworks_Subnets_Spec_Properties instead
type VirtualNetworks_Subnets_Spec_PropertiesARM struct {
	AddressPrefix                     *string                                                  `json:"addressPrefix,omitempty"`
	AddressPrefixes                   []string                                                 `json:"addressPrefixes,omitempty"`
	Delegations                       []VirtualNetworks_Subnets_Spec_Properties_DelegationsARM `json:"delegations,omitempty"`
...
type VirtualNetworks_Subnets_Spec_Properties_DelegationsARM struct {
	Name       *string                               `json:"name,omitempty"`
