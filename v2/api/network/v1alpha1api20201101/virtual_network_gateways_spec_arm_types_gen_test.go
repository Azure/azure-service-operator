...
func Test_VirtualNetworkGateway_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/network/v1alpha1api20201101/virtual_network_gateway__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/network/v1alpha1api20201101/virtual_network_gateways_spec_arm_types_gen_test.go
	// Serialize to JSON
