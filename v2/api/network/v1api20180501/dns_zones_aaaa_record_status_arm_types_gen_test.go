...
func Test_DnsZonesAAAARecord_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DnsZonesAAAARecord_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDnsZonesAAAARecord_STATUS_ARM, DnsZonesAAAARecord_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDnsZonesAAAARecord_STATUS_ARM runs a test to see if a specific instance of DnsZonesAAAARecord_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDnsZonesAAAARecord_STATUS_ARM(subject DnsZonesAAAARecord_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DnsZonesAAAARecord_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DnsZonesAAAARecord_STATUS_ARM instances for property testing - lazily instantiated by
// DnsZonesAAAARecord_STATUS_ARMGenerator()
var dnsZonesAAAARecord_STATUS_ARMGenerator gopter.Gen

// DnsZonesAAAARecord_STATUS_ARMGenerator returns a generator of DnsZonesAAAARecord_STATUS_ARM instances for property testing.
// We first initialize dnsZonesAAAARecord_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DnsZonesAAAARecord_STATUS_ARMGenerator() gopter.Gen {
	if dnsZonesAAAARecord_STATUS_ARMGenerator != nil {
		return dnsZonesAAAARecord_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM(generators)
	dnsZonesAAAARecord_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(DnsZonesAAAARecord_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM(generators)
	dnsZonesAAAARecord_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(DnsZonesAAAARecord_STATUS_ARM{}), generators)

	return dnsZonesAAAARecord_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_STATUS_ARM(gens map[string]gopter.Gen) {
