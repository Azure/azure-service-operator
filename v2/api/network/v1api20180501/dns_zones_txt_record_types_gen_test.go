...
func RunResourceConversionTestForDnsZonesTXTRecord(subject DnsZonesTXTRecord) string {
	...
	var hub v1api20180501s.DnsZonesTXTRecord
...
// RunPropertyAssignmentTestForDnsZonesTXTRecord tests if a specific instance of DnsZonesTXTRecord can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZonesTXTRecord(subject DnsZonesTXTRecord) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZonesTXTRecord
...
// RunPropertyAssignmentTestForDnsZones_TXT_Spec tests if a specific instance of DnsZones_TXT_Spec can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZones_TXT_Spec(subject DnsZones_TXT_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZones_TXT_Spec
...
// RunPropertyAssignmentTestForDnsZones_TXT_STATUS tests if a specific instance of DnsZones_TXT_STATUS can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZones_TXT_STATUS(subject DnsZones_TXT_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZones_TXT_STATUS
