...
func RunResourceConversionTestForDnsZonesCAARecord(subject DnsZonesCAARecord) string {
	...
	var hub v1api20180501s.DnsZonesCAARecord
...
// RunPropertyAssignmentTestForDnsZonesCAARecord tests if a specific instance of DnsZonesCAARecord can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZonesCAARecord(subject DnsZonesCAARecord) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZonesCAARecord
...
func Test_DnsZones_CAA_Spec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DnsZones_CAA_Spec to DnsZones_CAA_Spec via AssignProperties_To_DnsZones_CAA_Spec & AssignProperties_From_DnsZones_CAA_Spec returns original",
		prop.ForAll(RunPropertyAssignmentTestForDnsZones_CAA_Spec, DnsZones_CAA_SpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDnsZones_CAA_Spec tests if a specific instance of DnsZones_CAA_Spec can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZones_CAA_Spec(subject DnsZones_CAA_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZones_CAA_Spec
	err := copied.AssignProperties_To_DnsZones_CAA_Spec(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DnsZones_CAA_Spec(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DnsZones_CAA_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DnsZones_CAA_STATUS to DnsZones_CAA_STATUS via AssignProperties_To_DnsZones_CAA_STATUS & AssignProperties_From_DnsZones_CAA_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDnsZones_CAA_STATUS, DnsZones_CAA_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDnsZones_CAA_STATUS tests if a specific instance of DnsZones_CAA_STATUS can be assigned to v1api20180501storage and back losslessly
func RunPropertyAssignmentTestForDnsZones_CAA_STATUS(subject DnsZones_CAA_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20180501s.DnsZones_CAA_STATUS
	err := copied.AssignProperties_To_DnsZones_CAA_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_DnsZones_CAA_STATUS(&other)
	if err != nil {
		return err.Error()
	}
