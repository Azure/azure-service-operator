...
func (record *DnsZonesARecord) validateConfigMapDestinations() (admission.Warnings, error) {
	if record.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (record *DnsZonesARecord) validateSecretDestinations() (admission.Warnings, error) {
	if record.Spec.OperatorSpec == nil {
		return nil, nil
	}
