...
func Test_DnsZonesAAAARecord_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DnsZonesAAAARecord_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDnsZonesAAAARecord_Spec_ARM, DnsZonesAAAARecord_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDnsZonesAAAARecord_Spec_ARM runs a test to see if a specific instance of DnsZonesAAAARecord_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDnsZonesAAAARecord_Spec_ARM(subject DnsZonesAAAARecord_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual DnsZonesAAAARecord_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of DnsZonesAAAARecord_Spec_ARM instances for property testing - lazily instantiated by
// DnsZonesAAAARecord_Spec_ARMGenerator()
var dnsZonesAAAARecord_Spec_ARMGenerator gopter.Gen

// DnsZonesAAAARecord_Spec_ARMGenerator returns a generator of DnsZonesAAAARecord_Spec_ARM instances for property testing.
// We first initialize dnsZonesAAAARecord_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DnsZonesAAAARecord_Spec_ARMGenerator() gopter.Gen {
	if dnsZonesAAAARecord_Spec_ARMGenerator != nil {
		return dnsZonesAAAARecord_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM(generators)
	dnsZonesAAAARecord_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(DnsZonesAAAARecord_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM(generators)
	dnsZonesAAAARecord_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(DnsZonesAAAARecord_Spec_ARM{}), generators)

	return dnsZonesAAAARecord_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDnsZonesAAAARecord_Spec_ARM(gens map[string]gopter.Gen) {
