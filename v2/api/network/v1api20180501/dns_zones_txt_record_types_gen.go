...
func (record *DnsZonesTXTRecord) AssignProperties_To_DnsZonesTXTRecord(destination *storage.DnsZonesTXTRecord) error {
	...
	// Spec
	var spec storage.DnsZones_TXT_Spec
	...
	// Status
	var status storage.DnsZones_TXT_STATUS
...
func (zonesTXT *DnsZones_TXT_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*storage.DnsZones_TXT_Spec)
	if ok {
...
func (zonesTXT *DnsZones_TXT_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*storage.DnsZones_TXT_Spec)
	if ok {
...
func (zonesTXT *DnsZones_TXT_Spec) AssignProperties_From_DnsZones_TXT_Spec(source *storage.DnsZones_TXT_Spec) error {
...
func (zonesTXT *DnsZones_TXT_Spec) AssignProperties_To_DnsZones_TXT_Spec(destination *storage.DnsZones_TXT_Spec) error {
	...
	if zonesTXT.CaaRecords != nil {
		caaRecordList := make([]storage.CaaRecord, len(zonesTXT.CaaRecords))
	...
	if zonesTXT.NSRecords != nil {
		nsRecordList := make([]storage.NsRecord, len(zonesTXT.NSRecords))
...
func (zonesTXT *DnsZones_TXT_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*storage.DnsZones_TXT_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &storage.DnsZones_TXT_STATUS{}
...
func (zonesTXT *DnsZones_TXT_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*storage.DnsZones_TXT_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &storage.DnsZones_TXT_STATUS{}
...
func (zonesTXT *DnsZones_TXT_STATUS) AssignProperties_From_DnsZones_TXT_STATUS(source *storage.DnsZones_TXT_STATUS) error {
...
func (zonesTXT *DnsZones_TXT_STATUS) AssignProperties_To_DnsZones_TXT_STATUS(destination *storage.DnsZones_TXT_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// CaaRecords
	if zonesTXT.CaaRecords != nil {
		caaRecordList := make([]storage.CaaRecord_STATUS, len(zonesTXT.CaaRecords))
		for caaRecordIndex, caaRecordItem := range zonesTXT.CaaRecords {
			// Shadow the loop variable to avoid aliasing
			caaRecordItem := caaRecordItem
	...
	// NSRecords
	if zonesTXT.NSRecords != nil {
		nsRecordList := make([]storage.NsRecord_STATUS, len(zonesTXT.NSRecords))
		for nsRecordIndex, nsRecordItem := range zonesTXT.NSRecords {
			// Shadow the loop variable to avoid aliasing
			nsRecordItem := nsRecordItem
