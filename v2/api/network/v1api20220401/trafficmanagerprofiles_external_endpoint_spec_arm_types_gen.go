...
var _ genruntime.ARMResourceSpec = &Trafficmanagerprofiles_ExternalEndpoint_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-04-01"
func (endpoint Trafficmanagerprofiles_ExternalEndpoint_Spec_ARM) GetAPIVersion() string {
	return "2022-04-01"
}

// GetName returns the Name of the resource
func (endpoint *Trafficmanagerprofiles_ExternalEndpoint_Spec_ARM) GetName() string {
...
func (endpoint *Trafficmanagerprofiles_ExternalEndpoint_Spec_ARM) GetType() string {
