...
type TrafficManagerProfilesAzureEndpoint_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &TrafficManagerProfilesAzureEndpoint_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-04-01"
func (endpoint TrafficManagerProfilesAzureEndpoint_Spec_ARM) GetAPIVersion() string {
	return "2022-04-01"
}

// GetName returns the Name of the resource
func (endpoint *TrafficManagerProfilesAzureEndpoint_Spec_ARM) GetName() string {
	return endpoint.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/trafficmanagerprofiles/AzureEndpoints"
func (endpoint *TrafficManagerProfilesAzureEndpoint_Spec_ARM) GetType() string {
