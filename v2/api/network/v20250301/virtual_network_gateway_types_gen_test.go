...
func Test_VirtualNetworkGatewayMigrationStatus_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from VirtualNetworkGatewayMigrationStatus to VirtualNetworkGatewayMigrationStatus via AssignProperties_To_VirtualNetworkGatewayMigrationStatus & AssignProperties_From_VirtualNetworkGatewayMigrationStatus returns original",
		prop.ForAll(RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus, VirtualNetworkGatewayMigrationStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus tests if a specific instance of VirtualNetworkGatewayMigrationStatus can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus(subject VirtualNetworkGatewayMigrationStatus) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.VirtualNetworkGatewayMigrationStatus
	err := copied.AssignProperties_To_VirtualNetworkGatewayMigrationStatus(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_VirtualNetworkGatewayMigrationStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus(gens map[string]gopter.Gen) {
	...
	gens["Phase"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkGatewayMigrationStatus_Phase_Abort,
		VirtualNetworkGatewayMigrationStatus_Phase_AbortSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_Commit,
		VirtualNetworkGatewayMigrationStatus_Phase_CommitSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_Execute,
		VirtualNetworkGatewayMigrationStatus_Phase_ExecuteSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_None,
		VirtualNetworkGatewayMigrationStatus_Phase_Prepare,
		VirtualNetworkGatewayMigrationStatus_Phase_PrepareSucceeded))
	gens["State"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkGatewayMigrationStatus_State_Failed,
		VirtualNetworkGatewayMigrationStatus_State_InProgress,
		VirtualNetworkGatewayMigrationStatus_State_None,
		VirtualNetworkGatewayMigrationStatus_State_Succeeded))
}

func Test_VirtualNetworkGatewayMigrationStatus_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from VirtualNetworkGatewayMigrationStatus_STATUS to VirtualNetworkGatewayMigrationStatus_STATUS via AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS & AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus_STATUS, VirtualNetworkGatewayMigrationStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus_STATUS tests if a specific instance of VirtualNetworkGatewayMigrationStatus_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForVirtualNetworkGatewayMigrationStatus_STATUS(subject VirtualNetworkGatewayMigrationStatus_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.VirtualNetworkGatewayMigrationStatus_STATUS
	err := copied.AssignProperties_To_VirtualNetworkGatewayMigrationStatus_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_VirtualNetworkGatewayMigrationStatus_STATUS(&other)
	if err != nil {
		return err.Error()
	}
