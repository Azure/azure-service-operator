...
func (endpoint *PrivateEndpoint) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v20250301/storage/PrivateEndpoint but received %T instead", hub)
	}
...
func (endpoint *PrivateEndpoint) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateEndpoint_STATUS); ok {
		return endpoint.Spec.Initialize_From_PrivateEndpoint_STATUS(s)
	}

	return fmt.Errorf("expected Status of type PrivateEndpoint_STATUS but received %T instead", status)
}
...
type PrivateEndpoint_Spec struct {
	...
	// to IPv4.
	IpVersionType *PrivateEndpointProperties_IpVersionType `json:"ipVersionType,omitempty"`
...
func (endpoint *PrivateEndpoint_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if endpoint.IpVersionType != nil {
		var temp string
		temp = string(*endpoint.IpVersionType)
		ipVersionType := arm.PrivateEndpointProperties_IpVersionType(temp)
		result.Properties.IpVersionType = &ipVersionType
	}
...
func (endpoint *PrivateEndpoint_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "IpVersionType":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.IpVersionType != nil {
			var temp string
			temp = string(*typedInput.Properties.IpVersionType)
			ipVersionType := PrivateEndpointProperties_IpVersionType(temp)
			endpoint.IpVersionType = &ipVersionType
		}
	}
...
func (endpoint *PrivateEndpoint_Spec) AssignProperties_From_PrivateEndpoint_Spec(source *storage.PrivateEndpoint_Spec) error {
	...
	// IpVersionType
	if source.IpVersionType != nil {
		ipVersionType := *source.IpVersionType
		ipVersionTypeTemp := genruntime.ToEnum(ipVersionType, privateEndpointProperties_IpVersionType_Values)
		endpoint.IpVersionType = &ipVersionTypeTemp
	} else {
		endpoint.IpVersionType = nil
	}
...
func (endpoint *PrivateEndpoint_Spec) AssignProperties_To_PrivateEndpoint_Spec(destination *storage.PrivateEndpoint_Spec) error {
	...
	// IpVersionType
	if endpoint.IpVersionType != nil {
		ipVersionType := string(*endpoint.IpVersionType)
		destination.IpVersionType = &ipVersionType
	} else {
		destination.IpVersionType = nil
	}
...
// Initialize_From_PrivateEndpoint_STATUS populates our PrivateEndpoint_Spec from the provided source PrivateEndpoint_STATUS
func (endpoint *PrivateEndpoint_Spec) Initialize_From_PrivateEndpoint_STATUS(source *PrivateEndpoint_STATUS) error {
	...
	if source.ApplicationSecurityGroups != nil {
		...
		for applicationSecurityGroupIndex, applicationSecurityGroupItem := range source.ApplicationSecurityGroups {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ApplicationSecurityGroup_STATUS_PrivateEndpoint_SubResourceEmbedded() to populate field ApplicationSecurityGroups")
			}
			applicationSecurityGroupList[applicationSecurityGroupIndex] = applicationSecurityGroup
		}
		endpoint.ApplicationSecurityGroups = applicationSecurityGroupList
	...
	if source.IpConfigurations != nil {
		...
		for ipConfigurationIndex, ipConfigurationItem := range source.IpConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_PrivateEndpointIPConfiguration_STATUS() to populate field IpConfigurations")
			}
			ipConfigurationList[ipConfigurationIndex] = ipConfiguration
		}
		endpoint.IpConfigurations = ipConfigurationList
	...
	// IpVersionType
	if source.IpVersionType != nil {
		ipVersionType := genruntime.ToEnum(string(*source.IpVersionType), privateEndpointProperties_IpVersionType_Values)
		endpoint.IpVersionType = &ipVersionType
	} else {
		endpoint.IpVersionType = nil
	}
	...
	if source.ManualPrivateLinkServiceConnections != nil {
		...
		for manualPrivateLinkServiceConnectionIndex, manualPrivateLinkServiceConnectionItem := range source.ManualPrivateLinkServiceConnections {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_PrivateLinkServiceConnection_STATUS() to populate field ManualPrivateLinkServiceConnections")
			}
			manualPrivateLinkServiceConnectionList[manualPrivateLinkServiceConnectionIndex] = manualPrivateLinkServiceConnection
		}
		endpoint.ManualPrivateLinkServiceConnections = manualPrivateLinkServiceConnectionList
	...
	if source.PrivateLinkServiceConnections != nil {
		...
		for privateLinkServiceConnectionIndex, privateLinkServiceConnectionItem := range source.PrivateLinkServiceConnections {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_PrivateLinkServiceConnection_STATUS() to populate field PrivateLinkServiceConnections")
			}
			privateLinkServiceConnectionList[privateLinkServiceConnectionIndex] = privateLinkServiceConnection
		}
		endpoint.PrivateLinkServiceConnections = privateLinkServiceConnectionList
	...
	if source.Subnet != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Subnet_STATUS_PrivateEndpoint_SubResourceEmbedded() to populate field Subnet")
		}
		endpoint.Subnet = &subnet
	} else {
		endpoint.Subnet = nil
...
type PrivateEndpoint_STATUS struct {
	...
	// IpVersionType: Specifies the IP version type for the private IPs of the private endpoint. If not defined, this defaults
	// to IPv4.
	IpVersionType *PrivateEndpointProperties_IpVersionType_STATUS `json:"ipVersionType,omitempty"`
...
func (endpoint *PrivateEndpoint_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.IpVersionType != nil {
			var temp string
			temp = string(*typedInput.Properties.IpVersionType)
			ipVersionType := PrivateEndpointProperties_IpVersionType_STATUS(temp)
			endpoint.IpVersionType = &ipVersionType
		}
	}
...
func (endpoint *PrivateEndpoint_STATUS) AssignProperties_From_PrivateEndpoint_STATUS(source *storage.PrivateEndpoint_STATUS) error {
	...
	if source.IpVersionType != nil {
		ipVersionType := *source.IpVersionType
		ipVersionTypeTemp := genruntime.ToEnum(ipVersionType, privateEndpointProperties_IpVersionType_STATUS_Values)
		endpoint.IpVersionType = &ipVersionTypeTemp
	} else {
		endpoint.IpVersionType = nil
	}
...
type PrivateEndpointProperties_IpVersionType string

const (
	PrivateEndpointProperties_IpVersionType_DualStack = PrivateEndpointProperties_IpVersionType("DualStack")
	PrivateEndpointProperties_IpVersionType_IPv4      = PrivateEndpointProperties_IpVersionType("IPv4")
	PrivateEndpointProperties_IpVersionType_IPv6      = PrivateEndpointProperties_IpVersionType("IPv6")
)

// Mapping from string to PrivateEndpointProperties_IpVersionType
var privateEndpointProperties_IpVersionType_Values = map[string]PrivateEndpointProperties_IpVersionType{
	"dualstack": PrivateEndpointProperties_IpVersionType_DualStack,
	"ipv4":      PrivateEndpointProperties_IpVersionType_IPv4,
	"ipv6":      PrivateEndpointProperties_IpVersionType_IPv6,
}

type PrivateEndpointProperties_IpVersionType_STATUS string

const (
	PrivateEndpointProperties_IpVersionType_STATUS_DualStack = PrivateEndpointProperties_IpVersionType_STATUS("DualStack")
	PrivateEndpointProperties_IpVersionType_STATUS_IPv4      = PrivateEndpointProperties_IpVersionType_STATUS("IPv4")
	PrivateEndpointProperties_IpVersionType_STATUS_IPv6      = PrivateEndpointProperties_IpVersionType_STATUS("IPv6")
)

// Mapping from string to PrivateEndpointProperties_IpVersionType_STATUS
var privateEndpointProperties_IpVersionType_STATUS_Values = map[string]PrivateEndpointProperties_IpVersionType_STATUS{
	"dualstack": PrivateEndpointProperties_IpVersionType_STATUS_DualStack,
	"ipv4":      PrivateEndpointProperties_IpVersionType_STATUS_IPv4,
	"ipv6":      PrivateEndpointProperties_IpVersionType_STATUS_IPv6,
}
