...
func AddIndependentPropertyGeneratorsForFirewallPolicy_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		FirewallPolicyProvisioningState_STATUS_Deleting,
		FirewallPolicyProvisioningState_STATUS_Failed,
		FirewallPolicyProvisioningState_STATUS_Succeeded,
		FirewallPolicyProvisioningState_STATUS_Updating))
