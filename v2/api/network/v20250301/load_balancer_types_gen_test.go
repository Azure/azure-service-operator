...
func Test_BackendAddressPool_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties.Property(
		"Round trip from BackendAddressPool_LoadBalancer_SubResourceEmbedded to BackendAddressPool_LoadBalancer_SubResourceEmbedded via AssignProperties_To_BackendAddressPool_LoadBalancer_SubResourceEmbedded & AssignProperties_From_BackendAddressPool_LoadBalancer_SubResourceEmbedded returns original",
...
func RunPropertyAssignmentTestForBackendAddressPool_LoadBalancer_SubResourceEmbedded(subject BackendAddressPool_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_BackendAddressPool_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForBackendAddressPool_LoadBalancer_SubResourceEmbedded(gens map[string]gopter.Gen) {
	...
	gens["SyncMode"] = gen.PtrOf(gen.OneConstOf(BackendAddressPoolPropertiesFormat_SyncMode_Automatic, BackendAddressPoolPropertiesFormat_SyncMode_Manual))
}
...
func AddRelatedPropertyGeneratorsForBackendAddressPool_LoadBalancer_SubResourceEmbedded(gens map[string]gopter.Gen) {
	...
	gens["TunnelInterfaces"] = gen.SliceOf(GatewayLoadBalancerTunnelInterfaceGenerator())
...
func Test_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded to FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded via AssignProperties_To_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded & AssignProperties_From_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded returns original",
...
func RunPropertyAssignmentTestForFrontendIPConfiguration_LoadBalancer_SubResourceEmbedded(subject FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_GatewayLoadBalancerTunnelInterface_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from GatewayLoadBalancerTunnelInterface to GatewayLoadBalancerTunnelInterface via AssignProperties_To_GatewayLoadBalancerTunnelInterface & AssignProperties_From_GatewayLoadBalancerTunnelInterface returns original",
		prop.ForAll(RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface, GatewayLoadBalancerTunnelInterfaceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface tests if a specific instance of GatewayLoadBalancerTunnelInterface can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface(subject GatewayLoadBalancerTunnelInterface) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.GatewayLoadBalancerTunnelInterface
	err := copied.AssignProperties_To_GatewayLoadBalancerTunnelInterface(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual GatewayLoadBalancerTunnelInterface
	err = actual.AssignProperties_From_GatewayLoadBalancerTunnelInterface(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_GatewayLoadBalancerTunnelInterface_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of GatewayLoadBalancerTunnelInterface via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForGatewayLoadBalancerTunnelInterface, GatewayLoadBalancerTunnelInterfaceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForGatewayLoadBalancerTunnelInterface runs a test to see if a specific instance of GatewayLoadBalancerTunnelInterface round trips to JSON and back losslessly
func RunJSONSerializationTestForGatewayLoadBalancerTunnelInterface(subject GatewayLoadBalancerTunnelInterface) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of GatewayLoadBalancerTunnelInterface instances for property testing - lazily instantiated by
// GatewayLoadBalancerTunnelInterfaceGenerator()
var gatewayLoadBalancerTunnelInterfaceGenerator gopter.Gen

// GatewayLoadBalancerTunnelInterfaceGenerator returns a generator of GatewayLoadBalancerTunnelInterface instances for property testing.
func GatewayLoadBalancerTunnelInterfaceGenerator() gopter.Gen {
	if gatewayLoadBalancerTunnelInterfaceGenerator != nil {
		return gatewayLoadBalancerTunnelInterfaceGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForGatewayLoadBalancerTunnelInterface(generators)
	gatewayLoadBalancerTunnelInterfaceGenerator = gen.Struct(reflect.TypeOf(GatewayLoadBalancerTunnelInterface{}), generators)

	return gatewayLoadBalancerTunnelInterfaceGenerator
}

// AddIndependentPropertyGeneratorsForGatewayLoadBalancerTunnelInterface is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForGatewayLoadBalancerTunnelInterface(gens map[string]gopter.Gen) {
	gens["Identifier"] = gen.PtrOf(gen.Int())
	gens["Port"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(GatewayLoadBalancerTunnelInterface_Protocol_Native, GatewayLoadBalancerTunnelInterface_Protocol_None, GatewayLoadBalancerTunnelInterface_Protocol_VXLAN))
	gens["Type"] = gen.PtrOf(gen.OneConstOf(GatewayLoadBalancerTunnelInterface_Type_External, GatewayLoadBalancerTunnelInterface_Type_Internal, GatewayLoadBalancerTunnelInterface_Type_None))
}

func Test_GatewayLoadBalancerTunnelInterface_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from GatewayLoadBalancerTunnelInterface_STATUS to GatewayLoadBalancerTunnelInterface_STATUS via AssignProperties_To_GatewayLoadBalancerTunnelInterface_STATUS & AssignProperties_From_GatewayLoadBalancerTunnelInterface_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface_STATUS, GatewayLoadBalancerTunnelInterface_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface_STATUS tests if a specific instance of GatewayLoadBalancerTunnelInterface_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface_STATUS(subject GatewayLoadBalancerTunnelInterface_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.GatewayLoadBalancerTunnelInterface_STATUS
	err := copied.AssignProperties_To_GatewayLoadBalancerTunnelInterface_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_GatewayLoadBalancerTunnelInterface_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForInboundNatPool_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(
		TransportProtocol_STATUS_All,
		TransportProtocol_STATUS_Quic,
		TransportProtocol_STATUS_Tcp,
		TransportProtocol_STATUS_Udp))
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		LoadBalancerProvisioningState_STATUS_Deleting,
		LoadBalancerProvisioningState_STATUS_Failed,
		LoadBalancerProvisioningState_STATUS_Succeeded,
		LoadBalancerProvisioningState_STATUS_Updating))
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}
...
func Test_InboundNatRule_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from InboundNatRule_LoadBalancer_SubResourceEmbedded to InboundNatRule_LoadBalancer_SubResourceEmbedded via AssignProperties_To_InboundNatRule_LoadBalancer_SubResourceEmbedded & AssignProperties_From_InboundNatRule_LoadBalancer_SubResourceEmbedded returns original",
...
func RunPropertyAssignmentTestForInboundNatRule_LoadBalancer_SubResourceEmbedded(subject InboundNatRule_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_InboundNatRule_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForLoadBalancerBackendAddress(gens map[string]gopter.Gen) {
	gens["AdminState"] = gen.PtrOf(gen.OneConstOf(LoadBalancerBackendAddressPropertiesFormat_AdminState_Down, LoadBalancerBackendAddressPropertiesFormat_AdminState_None, LoadBalancerBackendAddressPropertiesFormat_AdminState_Up))
...
func AddIndependentPropertyGeneratorsForLoadBalancerSku(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.OneConstOf(LoadBalancerSku_Name_Basic, LoadBalancerSku_Name_Gateway, LoadBalancerSku_Name_Standard))
...
func AddIndependentPropertyGeneratorsForLoadBalancer_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Scope"] = gen.PtrOf(gen.OneConstOf(LoadBalancerPropertiesFormat_Scope_STATUS_Private, LoadBalancerPropertiesFormat_Scope_STATUS_Public))
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
...
func AddIndependentPropertyGeneratorsForLoadBalancer_Spec(gens map[string]gopter.Gen) {
	...
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Scope"] = gen.PtrOf(gen.OneConstOf(LoadBalancerPropertiesFormat_Scope_Private, LoadBalancerPropertiesFormat_Scope_Public))
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForLoadBalancingRule(gens map[string]gopter.Gen) {
	...
	gens["EnableConnectionTracking"] = gen.PtrOf(gen.Bool())
	gens["EnableFloatingIP"] = gen.PtrOf(gen.Bool())
	gens["EnableTcpReset"] = gen.PtrOf(gen.Bool())
	gens["FrontendPort"] = gen.PtrOf(gen.Int())
	gens["IdleTimeoutInMinutes"] = gen.PtrOf(gen.Int())
...
func AddRelatedPropertyGeneratorsForLoadBalancingRule(gens map[string]gopter.Gen) {
	gens["BackendAddressPool"] = gen.PtrOf(SubResourceGenerator())
	gens["BackendAddressPools"] = gen.SliceOf(SubResourceGenerator())
	gens["FrontendIPConfiguration"] = gen.PtrOf(SubResourceGenerator())
...
func Test_NatRulePortMapping_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NatRulePortMapping_STATUS to NatRulePortMapping_STATUS via AssignProperties_To_NatRulePortMapping_STATUS & AssignProperties_From_NatRulePortMapping_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForNatRulePortMapping_STATUS, NatRulePortMapping_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForNatRulePortMapping_STATUS tests if a specific instance of NatRulePortMapping_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNatRulePortMapping_STATUS(subject NatRulePortMapping_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.NatRulePortMapping_STATUS
	err := copied.AssignProperties_To_NatRulePortMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_NatRulePortMapping_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded to NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded via AssignProperties_To_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded & AssignProperties_From_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded returns original",
		prop.ForAll(RunPropertyAssignmentTestForNetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded, NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbeddedGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}
...
func RunPropertyAssignmentTestForNetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(subject NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForProbe(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["NoHealthyBackendsBehavior"] = gen.PtrOf(gen.OneConstOf(ProbePropertiesFormat_NoHealthyBackendsBehavior_AllProbedDown, ProbePropertiesFormat_NoHealthyBackendsBehavior_AllProbedUp))
...
func Test_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded to PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded via AssignProperties_To_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded & AssignProperties_From_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded returns original",
...
func RunPropertyAssignmentTestForPublicIPAddressSpec_LoadBalancer_SubResourceEmbedded(subject PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Subnet_LoadBalancer_SubResourceEmbedded_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Subnet_LoadBalancer_SubResourceEmbedded to Subnet_LoadBalancer_SubResourceEmbedded via AssignProperties_To_Subnet_LoadBalancer_SubResourceEmbedded & AssignProperties_From_Subnet_LoadBalancer_SubResourceEmbedded returns original",
...
func RunPropertyAssignmentTestForSubnet_LoadBalancer_SubResourceEmbedded(subject Subnet_LoadBalancer_SubResourceEmbedded) string {
	...
	err = actual.AssignProperties_From_Subnet_LoadBalancer_SubResourceEmbedded(&other)
	if err != nil {
		return err.Error()
	}
