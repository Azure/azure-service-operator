...
func Test_VirtualNetworkGatewayMigrationStatus_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of VirtualNetworkGatewayMigrationStatus via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus, VirtualNetworkGatewayMigrationStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus runs a test to see if a specific instance of VirtualNetworkGatewayMigrationStatus round trips to JSON and back losslessly
func RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus(subject VirtualNetworkGatewayMigrationStatus) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual VirtualNetworkGatewayMigrationStatus
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of VirtualNetworkGatewayMigrationStatus instances for property testing - lazily instantiated by
// VirtualNetworkGatewayMigrationStatusGenerator()
var virtualNetworkGatewayMigrationStatusGenerator gopter.Gen

// VirtualNetworkGatewayMigrationStatusGenerator returns a generator of VirtualNetworkGatewayMigrationStatus instances for property testing.
func VirtualNetworkGatewayMigrationStatusGenerator() gopter.Gen {
	if virtualNetworkGatewayMigrationStatusGenerator != nil {
		return virtualNetworkGatewayMigrationStatusGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus(generators)
	virtualNetworkGatewayMigrationStatusGenerator = gen.Struct(reflect.TypeOf(VirtualNetworkGatewayMigrationStatus{}), generators)

	return virtualNetworkGatewayMigrationStatusGenerator
}

// AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus(gens map[string]gopter.Gen) {
	gens["ErrorMessage"] = gen.PtrOf(gen.AlphaString())
	gens["Phase"] = gen.PtrOf(gen.AlphaString())
	gens["State"] = gen.PtrOf(gen.AlphaString())
}

func Test_VirtualNetworkGatewayMigrationStatus_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of VirtualNetworkGatewayMigrationStatus_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus_STATUS, VirtualNetworkGatewayMigrationStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus_STATUS runs a test to see if a specific instance of VirtualNetworkGatewayMigrationStatus_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForVirtualNetworkGatewayMigrationStatus_STATUS(subject VirtualNetworkGatewayMigrationStatus_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual VirtualNetworkGatewayMigrationStatus_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of VirtualNetworkGatewayMigrationStatus_STATUS instances for property testing - lazily instantiated by
// VirtualNetworkGatewayMigrationStatus_STATUSGenerator()
var virtualNetworkGatewayMigrationStatus_STATUSGenerator gopter.Gen

// VirtualNetworkGatewayMigrationStatus_STATUSGenerator returns a generator of VirtualNetworkGatewayMigrationStatus_STATUS instances for property testing.
func VirtualNetworkGatewayMigrationStatus_STATUSGenerator() gopter.Gen {
	if virtualNetworkGatewayMigrationStatus_STATUSGenerator != nil {
		return virtualNetworkGatewayMigrationStatus_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus_STATUS(generators)
	virtualNetworkGatewayMigrationStatus_STATUSGenerator = gen.Struct(reflect.TypeOf(VirtualNetworkGatewayMigrationStatus_STATUS{}), generators)

	return virtualNetworkGatewayMigrationStatus_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus_STATUS(gens map[string]gopter.Gen) {
	gens["ErrorMessage"] = gen.PtrOf(gen.AlphaString())
	gens["Phase"] = gen.PtrOf(gen.AlphaString())
	gens["State"] = gen.PtrOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForVirtualNetworkGateway_STATUS(gens map[string]gopter.Gen) {
	...
	gens["EnableHighBandwidthVpnGateway"] = gen.PtrOf(gen.Bool())
...
func AddRelatedPropertyGeneratorsForVirtualNetworkGateway_STATUS(gens map[string]gopter.Gen) {
	...
	gens["VirtualNetworkGatewayMigrationStatus"] = gen.PtrOf(VirtualNetworkGatewayMigrationStatus_STATUSGenerator())
...
func AddRelatedPropertyGeneratorsForVirtualNetworkGateway_Spec(gens map[string]gopter.Gen) {
	...
	gens["VirtualNetworkGatewayMigrationStatus"] = gen.PtrOf(VirtualNetworkGatewayMigrationStatusGenerator())
