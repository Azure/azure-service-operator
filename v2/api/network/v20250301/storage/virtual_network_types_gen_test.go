...
// We first initialize addressSpaceGenerator with a simplified generator based on the
...
func AddressSpaceGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAddressSpace(generators)
	AddRelatedPropertyGeneratorsForAddressSpace(generators)
	addressSpaceGenerator = gen.Struct(reflect.TypeOf(AddressSpace{}), generators)
...
// AddRelatedPropertyGeneratorsForAddressSpace is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAddressSpace(gens map[string]gopter.Gen) {
	gens["IpamPoolPrefixAllocations"] = gen.SliceOf(IpamPoolPrefixAllocationGenerator())
}
...
func AddIndependentPropertyGeneratorsForVirtualNetwork_STATUS(gens map[string]gopter.Gen) {
	...
	gens["PrivateEndpointVNetPolicies"] = gen.PtrOf(gen.AlphaString())
...
func AddRelatedPropertyGeneratorsForVirtualNetwork_STATUS(gens map[string]gopter.Gen) {
	...
	gens["DefaultPublicNatGateway"] = gen.PtrOf(SubResource_STATUSGenerator())
