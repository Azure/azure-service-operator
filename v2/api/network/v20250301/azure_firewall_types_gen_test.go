...
func AddIndependentPropertyGeneratorsForAzureFirewall_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		AzureFirewallProvisioningState_STATUS_Deleting,
		AzureFirewallProvisioningState_STATUS_Failed,
		AzureFirewallProvisioningState_STATUS_Succeeded,
		AzureFirewallProvisioningState_STATUS_Updating))
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
