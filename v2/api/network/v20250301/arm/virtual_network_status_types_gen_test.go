...
func AddIndependentPropertyGeneratorsForVirtualNetworkPropertiesFormat_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkProvisioningState_STATUS_Deleting,
		VirtualNetworkProvisioningState_STATUS_Failed,
		VirtualNetworkProvisioningState_STATUS_Succeeded,
		VirtualNetworkProvisioningState_STATUS_Updating))
