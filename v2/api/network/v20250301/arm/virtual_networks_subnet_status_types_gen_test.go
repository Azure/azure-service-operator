...
func Test_IpamPoolPrefixAllocation_Pool_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IpamPoolPrefixAllocation_Pool_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool_STATUS, IpamPoolPrefixAllocation_Pool_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool_STATUS runs a test to see if a specific instance of IpamPoolPrefixAllocation_Pool_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool_STATUS(subject IpamPoolPrefixAllocation_Pool_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual IpamPoolPrefixAllocation_Pool_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of IpamPoolPrefixAllocation_Pool_STATUS instances for property testing - lazily instantiated by
// IpamPoolPrefixAllocation_Pool_STATUSGenerator()
var ipamPoolPrefixAllocation_Pool_STATUSGenerator gopter.Gen

// IpamPoolPrefixAllocation_Pool_STATUSGenerator returns a generator of IpamPoolPrefixAllocation_Pool_STATUS instances for property testing.
func IpamPoolPrefixAllocation_Pool_STATUSGenerator() gopter.Gen {
	if ipamPoolPrefixAllocation_Pool_STATUSGenerator != nil {
		return ipamPoolPrefixAllocation_Pool_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool_STATUS(generators)
	ipamPoolPrefixAllocation_Pool_STATUSGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation_Pool_STATUS{}), generators)

	return ipamPoolPrefixAllocation_Pool_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool_STATUS(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
}
...
// We first initialize ipamPoolPrefixAllocation_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func IpamPoolPrefixAllocation_STATUSGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS(generators)
	AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS(generators)
	ipamPoolPrefixAllocation_STATUSGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation_STATUS{}), generators)
...
// AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS(gens map[string]gopter.Gen) {
	gens["Pool"] = gen.PtrOf(IpamPoolPrefixAllocation_Pool_STATUSGenerator())
}
