...
// We first initialize ipamPoolPrefixAllocationGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func IpamPoolPrefixAllocationGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation(generators)
	AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation(generators)
	ipamPoolPrefixAllocationGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation{}), generators)
...
// AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForIpamPoolPrefixAllocation(gens map[string]gopter.Gen) {
	gens["Pool"] = gen.PtrOf(IpamPoolPrefixAllocation_PoolGenerator())
}

func Test_IpamPoolPrefixAllocation_Pool_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IpamPoolPrefixAllocation_Pool via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool, IpamPoolPrefixAllocation_PoolGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool runs a test to see if a specific instance of IpamPoolPrefixAllocation_Pool round trips to JSON and back losslessly
func RunJSONSerializationTestForIpamPoolPrefixAllocation_Pool(subject IpamPoolPrefixAllocation_Pool) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual IpamPoolPrefixAllocation_Pool
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of IpamPoolPrefixAllocation_Pool instances for property testing - lazily instantiated by
// IpamPoolPrefixAllocation_PoolGenerator()
var ipamPoolPrefixAllocation_PoolGenerator gopter.Gen

// IpamPoolPrefixAllocation_PoolGenerator returns a generator of IpamPoolPrefixAllocation_Pool instances for property testing.
func IpamPoolPrefixAllocation_PoolGenerator() gopter.Gen {
	if ipamPoolPrefixAllocation_PoolGenerator != nil {
		return ipamPoolPrefixAllocation_PoolGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool(generators)
	ipamPoolPrefixAllocation_PoolGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation_Pool{}), generators)

	return ipamPoolPrefixAllocation_PoolGenerator
}

// AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_Pool(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
}
