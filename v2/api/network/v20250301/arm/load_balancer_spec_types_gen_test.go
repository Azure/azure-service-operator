...
// We first initialize backendAddressPoolPropertiesFormatGenerator with a simplified generator based on the
...
func BackendAddressPoolPropertiesFormatGenerator() gopter.Gen {
	...
	AddIndependentPropertyGeneratorsForBackendAddressPoolPropertiesFormat(generators)
...
// AddIndependentPropertyGeneratorsForBackendAddressPoolPropertiesFormat is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBackendAddressPoolPropertiesFormat(gens map[string]gopter.Gen) {
...
// We first initialize loadBalancerPropertiesFormatGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func LoadBalancerPropertiesFormatGenerator() gopter.Gen {
	...
	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLoadBalancerPropertiesFormat(generators)
...
// AddIndependentPropertyGeneratorsForLoadBalancerPropertiesFormat is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForLoadBalancerPropertiesFormat(gens map[string]gopter.Gen) {
