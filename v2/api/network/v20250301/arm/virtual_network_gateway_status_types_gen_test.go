...
// We first initialize addressSpace_STATUSGenerator with a simplified generator based on the
...
func AddressSpace_STATUSGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAddressSpace_STATUS(generators)
	AddRelatedPropertyGeneratorsForAddressSpace_STATUS(generators)
	addressSpace_STATUSGenerator = gen.Struct(reflect.TypeOf(AddressSpace_STATUS{}), generators)
...
// AddRelatedPropertyGeneratorsForAddressSpace_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAddressSpace_STATUS(gens map[string]gopter.Gen) {
	gens["IpamPoolPrefixAllocations"] = gen.SliceOf(IpamPoolPrefixAllocation_STATUSGenerator())
}
...
func AddIndependentPropertyGeneratorsForVirtualNetworkGatewayIPConfigurationPropertiesFormat_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkGatewayProvisioningState_STATUS_Deleting,
		VirtualNetworkGatewayProvisioningState_STATUS_Failed,
		VirtualNetworkGatewayProvisioningState_STATUS_Succeeded,
		VirtualNetworkGatewayProvisioningState_STATUS_Updating))
}
...
func AddIndependentPropertyGeneratorsForVirtualNetworkGatewayMigrationStatus_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Phase"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Abort,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_AbortSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Commit,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_CommitSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Execute,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_ExecuteSucceeded,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_None,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_Prepare,
		VirtualNetworkGatewayMigrationStatus_Phase_STATUS_PrepareSucceeded))
	gens["State"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkGatewayMigrationStatus_State_STATUS_Failed,
		VirtualNetworkGatewayMigrationStatus_State_STATUS_InProgress,
		VirtualNetworkGatewayMigrationStatus_State_STATUS_None,
		VirtualNetworkGatewayMigrationStatus_State_STATUS_Succeeded))
}
