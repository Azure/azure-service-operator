...
func RunPropertyAssignmentTestForPrivateLinkService_STATUS(subject PrivateLinkService_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.PrivateLinkService_STATUS
...
func AddIndependentPropertyGeneratorsForPrivateLinkService_STATUS(gens map[string]gopter.Gen) {
	gens["AccessMode"] = gen.PtrOf(gen.OneConstOf(PrivateLinkServiceProperties_AccessMode_STATUS_Default, PrivateLinkServiceProperties_AccessMode_STATUS_Restricted))
...
func AddIndependentPropertyGeneratorsForPrivateLinkService_Spec(gens map[string]gopter.Gen) {
	gens["AccessMode"] = gen.PtrOf(gen.OneConstOf(PrivateLinkServiceProperties_AccessMode_Default, PrivateLinkServiceProperties_AccessMode_Restricted))
