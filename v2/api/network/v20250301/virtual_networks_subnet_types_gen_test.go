...
func Test_IpamPoolPrefixAllocation_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IpamPoolPrefixAllocation to IpamPoolPrefixAllocation via AssignProperties_To_IpamPoolPrefixAllocation & AssignProperties_From_IpamPoolPrefixAllocation returns original",
		prop.ForAll(RunPropertyAssignmentTestForIpamPoolPrefixAllocation, IpamPoolPrefixAllocationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIpamPoolPrefixAllocation tests if a specific instance of IpamPoolPrefixAllocation can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIpamPoolPrefixAllocation(subject IpamPoolPrefixAllocation) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IpamPoolPrefixAllocation
	err := copied.AssignProperties_To_IpamPoolPrefixAllocation(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual IpamPoolPrefixAllocation
	err = actual.AssignProperties_From_IpamPoolPrefixAllocation(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IpamPoolPrefixAllocation_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IpamPoolPrefixAllocation via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIpamPoolPrefixAllocation, IpamPoolPrefixAllocationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIpamPoolPrefixAllocation runs a test to see if a specific instance of IpamPoolPrefixAllocation round trips to JSON and back losslessly
func RunJSONSerializationTestForIpamPoolPrefixAllocation(subject IpamPoolPrefixAllocation) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of IpamPoolPrefixAllocation instances for property testing - lazily instantiated by
// IpamPoolPrefixAllocationGenerator()
var ipamPoolPrefixAllocationGenerator gopter.Gen

// IpamPoolPrefixAllocationGenerator returns a generator of IpamPoolPrefixAllocation instances for property testing.
func IpamPoolPrefixAllocationGenerator() gopter.Gen {
	if ipamPoolPrefixAllocationGenerator != nil {
		return ipamPoolPrefixAllocationGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation(generators)
	ipamPoolPrefixAllocationGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation{}), generators)

	return ipamPoolPrefixAllocationGenerator
}

// AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation(gens map[string]gopter.Gen) {
	gens["NumberOfIpAddresses"] = gen.PtrOf(gen.AlphaString())
}

func Test_IpamPoolPrefixAllocation_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IpamPoolPrefixAllocation_STATUS to IpamPoolPrefixAllocation_STATUS via AssignProperties_To_IpamPoolPrefixAllocation_STATUS & AssignProperties_From_IpamPoolPrefixAllocation_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForIpamPoolPrefixAllocation_STATUS, IpamPoolPrefixAllocation_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIpamPoolPrefixAllocation_STATUS tests if a specific instance of IpamPoolPrefixAllocation_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIpamPoolPrefixAllocation_STATUS(subject IpamPoolPrefixAllocation_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IpamPoolPrefixAllocation_STATUS
	err := copied.AssignProperties_To_IpamPoolPrefixAllocation_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual IpamPoolPrefixAllocation_STATUS
	err = actual.AssignProperties_From_IpamPoolPrefixAllocation_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IpamPoolPrefixAllocation_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IpamPoolPrefixAllocation_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIpamPoolPrefixAllocation_STATUS, IpamPoolPrefixAllocation_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIpamPoolPrefixAllocation_STATUS runs a test to see if a specific instance of IpamPoolPrefixAllocation_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForIpamPoolPrefixAllocation_STATUS(subject IpamPoolPrefixAllocation_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of IpamPoolPrefixAllocation_STATUS instances for property testing - lazily instantiated by
// IpamPoolPrefixAllocation_STATUSGenerator()
var ipamPoolPrefixAllocation_STATUSGenerator gopter.Gen

// IpamPoolPrefixAllocation_STATUSGenerator returns a generator of IpamPoolPrefixAllocation_STATUS instances for property testing.
func IpamPoolPrefixAllocation_STATUSGenerator() gopter.Gen {
	if ipamPoolPrefixAllocation_STATUSGenerator != nil {
		return ipamPoolPrefixAllocation_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS(generators)
	ipamPoolPrefixAllocation_STATUSGenerator = gen.Struct(reflect.TypeOf(IpamPoolPrefixAllocation_STATUS{}), generators)

	return ipamPoolPrefixAllocation_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIpamPoolPrefixAllocation_STATUS(gens map[string]gopter.Gen) {
	gens["AllocatedAddressPrefixes"] = gen.SliceOf(gen.AlphaString())
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["NumberOfIpAddresses"] = gen.PtrOf(gen.AlphaString())
}
