...
func AddIndependentPropertyGeneratorsForPrivateEndpoint_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Etag"] = gen.PtrOf(gen.AlphaString())
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["IpVersionType"] = gen.PtrOf(gen.OneConstOf(PrivateEndpointProperties_IpVersionType_STATUS_DualStack, PrivateEndpointProperties_IpVersionType_STATUS_IPv4, PrivateEndpointProperties_IpVersionType_STATUS_IPv6))
...
func AddIndependentPropertyGeneratorsForPrivateEndpoint_Spec(gens map[string]gopter.Gen) {
	...
	gens["CustomNetworkInterfaceName"] = gen.PtrOf(gen.AlphaString())
	gens["IpVersionType"] = gen.PtrOf(gen.OneConstOf(PrivateEndpointProperties_IpVersionType_DualStack, PrivateEndpointProperties_IpVersionType_IPv4, PrivateEndpointProperties_IpVersionType_IPv6))
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
