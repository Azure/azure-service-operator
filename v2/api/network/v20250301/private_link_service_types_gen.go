...
func (service *PrivateLinkService) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v20250301/storage/PrivateLinkService but received %T instead", hub)
	}
...
func (service *PrivateLinkService) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PrivateLinkService_STATUS); ok {
		return service.Spec.Initialize_From_PrivateLinkService_STATUS(s)
	}

	return fmt.Errorf("expected Status of type PrivateLinkService_STATUS but received %T instead", status)
}
...
type PrivateLinkService_Spec struct {
	...
	AccessMode *PrivateLinkServiceProperties_AccessMode `json:"accessMode,omitempty"`
...
func (service *PrivateLinkService_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if service.AccessMode != nil {
		var temp string
		temp = string(*service.AccessMode)
		accessMode := arm.PrivateLinkServiceProperties_AccessMode(temp)
...
func (service *PrivateLinkService_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessMode != nil {
			...
			accessMode := PrivateLinkServiceProperties_AccessMode(temp)
			service.AccessMode = &accessMode
		}
	}
...
func (service *PrivateLinkService_Spec) AssignProperties_From_PrivateLinkService_Spec(source *storage.PrivateLinkService_Spec) error {
	...
	if source.AccessMode != nil {
		...
		accessModeTemp := genruntime.ToEnum(accessMode, privateLinkServiceProperties_AccessMode_Values)
		service.AccessMode = &accessModeTemp
	} else {
		service.AccessMode = nil
	}
...
func (service *PrivateLinkService_Spec) AssignProperties_To_PrivateLinkService_Spec(destination *storage.PrivateLinkService_Spec) error {
	...
	// AccessMode
	if service.AccessMode != nil {
		accessMode := string(*service.AccessMode)
...
// Initialize_From_PrivateLinkService_STATUS populates our PrivateLinkService_Spec from the provided source PrivateLinkService_STATUS
func (service *PrivateLinkService_Spec) Initialize_From_PrivateLinkService_STATUS(source *PrivateLinkService_STATUS) error {

	// AccessMode
	if source.AccessMode != nil {
		accessMode := genruntime.ToEnum(string(*source.AccessMode), privateLinkServiceProperties_AccessMode_Values)
		service.AccessMode = &accessMode
	} else {
		service.AccessMode = nil
	}
	...
	if source.AutoApproval != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ResourceSet_STATUS() to populate field AutoApproval")
		}
		service.AutoApproval = &autoApproval
	} else {
		service.AutoApproval = nil
	...
	if source.IpConfigurations != nil {
		...
		for ipConfigurationIndex, ipConfigurationItem := range source.IpConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_PrivateLinkServiceIpConfiguration_STATUS() to populate field IpConfigurations")
			}
			ipConfigurationList[ipConfigurationIndex] = ipConfiguration
		}
		service.IpConfigurations = ipConfigurationList
	...
	if source.LoadBalancerFrontendIpConfigurations != nil {
		...
		for loadBalancerFrontendIpConfigurationIndex, loadBalancerFrontendIpConfigurationItem := range source.LoadBalancerFrontendIpConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_FrontendIPConfiguration_STATUS_PrivateLinkService_SubResourceEmbedded() to populate field LoadBalancerFrontendIpConfigurations")
			}
			loadBalancerFrontendIpConfigurationList[loadBalancerFrontendIpConfigurationIndex] = loadBalancerFrontendIpConfiguration
		}
		service.LoadBalancerFrontendIpConfigurations = loadBalancerFrontendIpConfigurationList
	...
	if source.Visibility != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ResourceSet_STATUS() to populate field Visibility")
		}
		service.Visibility = &visibility
	} else {
		service.Visibility = nil
...
type PrivateLinkService_STATUS struct {
	// AccessMode: The access mode of the private link service.
	AccessMode *PrivateLinkServiceProperties_AccessMode_STATUS `json:"accessMode,omitempty"`
...
func (service *PrivateLinkService_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessMode != nil {
			var temp string
			temp = string(*typedInput.Properties.AccessMode)
			accessMode := PrivateLinkServiceProperties_AccessMode_STATUS(temp)
			service.AccessMode = &accessMode
		}
	}
...
func (service *PrivateLinkService_STATUS) AssignProperties_From_PrivateLinkService_STATUS(source *storage.PrivateLinkService_STATUS) error {
	...
	if source.AccessMode != nil {
		accessMode := *source.AccessMode
		accessModeTemp := genruntime.ToEnum(accessMode, privateLinkServiceProperties_AccessMode_STATUS_Values)
		service.AccessMode = &accessModeTemp
	} else {
		service.AccessMode = nil
	}
...
func (configuration *PrivateLinkServiceIpConfiguration) Initialize_From_PrivateLinkServiceIpConfiguration_STATUS(source *PrivateLinkServiceIpConfiguration_STATUS) error {
	...
	if source.Subnet != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Subnet_STATUS_PrivateLinkService_SubResourceEmbedded() to populate field Subnet")
		}
		configuration.Subnet = &subnet
	} else {
		configuration.Subnet = nil
...
// +kubebuilder:validation:Enum={"Default","Restricted"}
type PrivateLinkServiceProperties_AccessMode string

const (
	PrivateLinkServiceProperties_AccessMode_Default    = PrivateLinkServiceProperties_AccessMode("Default")
	PrivateLinkServiceProperties_AccessMode_Restricted = PrivateLinkServiceProperties_AccessMode("Restricted")
)

// Mapping from string to PrivateLinkServiceProperties_AccessMode
var privateLinkServiceProperties_AccessMode_Values = map[string]PrivateLinkServiceProperties_AccessMode{
	"default":    PrivateLinkServiceProperties_AccessMode_Default,
	"restricted": PrivateLinkServiceProperties_AccessMode_Restricted,
}

type PrivateLinkServiceProperties_AccessMode_STATUS string

const (
	PrivateLinkServiceProperties_AccessMode_STATUS_Default    = PrivateLinkServiceProperties_AccessMode_STATUS("Default")
	PrivateLinkServiceProperties_AccessMode_STATUS_Restricted = PrivateLinkServiceProperties_AccessMode_STATUS("Restricted")
)

// Mapping from string to PrivateLinkServiceProperties_AccessMode_STATUS
var privateLinkServiceProperties_AccessMode_STATUS_Values = map[string]PrivateLinkServiceProperties_AccessMode_STATUS{
	"default":    PrivateLinkServiceProperties_AccessMode_STATUS_Default,
	"restricted": PrivateLinkServiceProperties_AccessMode_STATUS_Restricted,
}
