...
func (endpoint *PrivateEndpoint_Spec) AssignProperties_From_PrivateEndpoint_Spec(source *storage.PrivateEndpoint_Spec) error {
	...
	if source.IpVersionType != nil {
		propertyBag.Add("IpVersionType", *source.IpVersionType)
	} else {
		propertyBag.Remove("IpVersionType")
	}
...
func (endpoint *PrivateEndpoint_Spec) AssignProperties_To_PrivateEndpoint_Spec(destination *storage.PrivateEndpoint_Spec) error {
	...
	// IpVersionType
	if propertyBag.Contains("IpVersionType") {
		var ipVersionType string
		err := propertyBag.Pull("IpVersionType", &ipVersionType)
		if err != nil {
			return eris.Wrap(err, "pulling 'IpVersionType' from propertyBag")
		}
