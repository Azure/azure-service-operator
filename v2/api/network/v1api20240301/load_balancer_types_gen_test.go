...
func RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface(subject GatewayLoadBalancerTunnelInterface) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.GatewayLoadBalancerTunnelInterface
...
func RunPropertyAssignmentTestForGatewayLoadBalancerTunnelInterface_STATUS(subject GatewayLoadBalancerTunnelInterface_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.GatewayLoadBalancerTunnelInterface_STATUS
...
func RunPropertyAssignmentTestForNatRulePortMapping_STATUS(subject NatRulePortMapping_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.NatRulePortMapping_STATUS
