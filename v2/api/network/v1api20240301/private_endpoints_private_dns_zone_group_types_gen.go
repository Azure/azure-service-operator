...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1api20240301-privateendpointsprivatednszonegroup,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpointsprivatednszonegroups,verbs=create;update,versions=v1api20240301,name=default.v1api20240301.privateendpointsprivatednszonegroups.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1api20240301-privateendpointsprivatednszonegroup,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=privateendpointsprivatednszonegroups,verbs=create;update,versions=v1api20240301,name=validate.v1api20240301.privateendpointsprivatednszonegroups.network.azure.com,admissionReviewVersions=v1
...
func (group *PrivateEndpointsPrivateDnsZoneGroup_Spec) Initialize_From_PrivateEndpointsPrivateDnsZoneGroup_STATUS(source *PrivateEndpointsPrivateDnsZoneGroup_STATUS) error {
	...
	if source.PrivateDnsZoneConfigs != nil {
		...
		for privateDnsZoneConfigIndex, privateDnsZoneConfigItem := range source.PrivateDnsZoneConfigs {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_PrivateDnsZoneConfig_STATUS() to populate field PrivateDnsZoneConfigs")
			}
			privateDnsZoneConfigList[privateDnsZoneConfigIndex] = privateDnsZoneConfig
		}
		group.PrivateDnsZoneConfigs = privateDnsZoneConfigList
