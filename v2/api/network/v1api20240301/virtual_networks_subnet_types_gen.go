...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1api20240301-virtualnetworkssubnet,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=virtualnetworkssubnets,verbs=create;update,versions=v1api20240301,name=default.v1api20240301.virtualnetworkssubnets.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1api20240301-virtualnetworkssubnet,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=virtualnetworkssubnets,verbs=create;update,versions=v1api20240301,name=validate.v1api20240301.virtualnetworkssubnets.network.azure.com,admissionReviewVersions=v1
...
func (subnet *VirtualNetworksSubnet_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if subnet.DefaultOutboundAccess != nil {
		...
		result.Properties.DefaultOutboundAccess = &defaultOutboundAccess
	}
	...
	if subnet.SharingScope != nil {
		var temp string
		temp = string(*subnet.SharingScope)
		sharingScope := arm.SubnetPropertiesFormat_SharingScope(temp)
		result.Properties.SharingScope = &sharingScope
	}
	return result, nil
}
...
func (subnet *VirtualNetworksSubnet_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DefaultOutboundAccess":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DefaultOutboundAccess != nil {
			defaultOutboundAccess := *typedInput.Properties.DefaultOutboundAccess
	...
	// Set property "SharingScope":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.SharingScope != nil {
			var temp string
			temp = string(*typedInput.Properties.SharingScope)
			sharingScope := SubnetPropertiesFormat_SharingScope(temp)
			subnet.SharingScope = &sharingScope
		}
	}
...
func (subnet *VirtualNetworksSubnet_Spec) AssignProperties_From_VirtualNetworksSubnet_Spec(source *storage.VirtualNetworksSubnet_Spec) error {
	...
	if source.SharingScope != nil {
		...
		sharingScopeTemp := genruntime.ToEnum(sharingScope, subnetPropertiesFormat_SharingScope_Values)
		subnet.SharingScope = &sharingScopeTemp
	} else {
		subnet.SharingScope = nil
	}
...
func (subnet *VirtualNetworksSubnet_Spec) AssignProperties_To_VirtualNetworksSubnet_Spec(destination *storage.VirtualNetworksSubnet_Spec) error {
	...
	// SharingScope
	if subnet.SharingScope != nil {
		sharingScope := string(*subnet.SharingScope)
...
func (subnet *VirtualNetworksSubnet_Spec) Initialize_From_VirtualNetworksSubnet_STATUS(source *VirtualNetworksSubnet_STATUS) error {
	...
	if source.ApplicationGatewayIPConfigurations != nil {
		...
		for applicationGatewayIPConfigurationIndex, applicationGatewayIPConfigurationItem := range source.ApplicationGatewayIPConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ApplicationGatewayIPConfiguration_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded() to populate field ApplicationGatewayIPConfigurations")
			}
			applicationGatewayIPConfigurationList[applicationGatewayIPConfigurationIndex] = applicationGatewayIPConfiguration
		}
		subnet.ApplicationGatewayIPConfigurations = applicationGatewayIPConfigurationList
	...
	if source.Delegations != nil {
		...
		for delegationIndex, delegationItem := range source.Delegations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_Delegation_STATUS() to populate field Delegations")
			}
			delegationList[delegationIndex] = delegation
		}
		subnet.Delegations = delegationList
	...
	if source.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field NatGateway")
		}
		subnet.NatGateway = &natGateway
	} else {
		subnet.NatGateway = nil
	...
	if source.NetworkSecurityGroup != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NetworkSecurityGroup_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded() to populate field NetworkSecurityGroup")
		}
		subnet.NetworkSecurityGroup = &networkSecurityGroup
	} else {
		subnet.NetworkSecurityGroup = nil
	...
	if source.RouteTable != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_RouteTable_STATUS_SubResourceEmbedded() to populate field RouteTable")
		}
		subnet.RouteTable = &routeTable
	} else {
		subnet.RouteTable = nil
	...
	if source.ServiceEndpointPolicies != nil {
		...
		for serviceEndpointPolicyIndex, serviceEndpointPolicyItem := range source.ServiceEndpointPolicies {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ServiceEndpointPolicy_STATUS_VirtualNetworks_Subnet_SubResourceEmbedded() to populate field ServiceEndpointPolicies")
			}
			serviceEndpointPolicyList[serviceEndpointPolicyIndex] = serviceEndpointPolicy
		}
		subnet.ServiceEndpointPolicies = serviceEndpointPolicyList
	...
	if source.ServiceEndpoints != nil {
		...
		for serviceEndpointIndex, serviceEndpointItem := range source.ServiceEndpoints {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ServiceEndpointPropertiesFormat_STATUS() to populate field ServiceEndpoints")
			}
			serviceEndpointList[serviceEndpointIndex] = serviceEndpoint
		}
		subnet.ServiceEndpoints = serviceEndpointList
	...
	// SharingScope
	if source.SharingScope != nil {
		sharingScope := genruntime.ToEnum(string(*source.SharingScope), subnetPropertiesFormat_SharingScope_Values)
		subnet.SharingScope = &sharingScope
	} else {
		subnet.SharingScope = nil
	}
...
func (subnet *VirtualNetworksSubnet_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.SharingScope != nil {
			var temp string
			temp = string(*typedInput.Properties.SharingScope)
			sharingScope := SubnetPropertiesFormat_SharingScope_STATUS(temp)
			subnet.SharingScope = &sharingScope
		}
	}
...
func (subnet *VirtualNetworksSubnet_STATUS) AssignProperties_From_VirtualNetworksSubnet_STATUS(source *storage.VirtualNetworksSubnet_STATUS) error {
	...
	if source.SharingScope != nil {
		sharingScope := *source.SharingScope
		sharingScopeTemp := genruntime.ToEnum(sharingScope, subnetPropertiesFormat_SharingScope_STATUS_Values)
		subnet.SharingScope = &sharingScopeTemp
	} else {
		subnet.SharingScope = nil
	}
...
func (format *ServiceEndpointPropertiesFormat) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if format.NetworkIdentifier != nil {
		...
		networkIdentifier := *networkIdentifier_ARM.(*arm.SubResource)
...
func (format *ServiceEndpointPropertiesFormat) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NetworkIdentifier":
	if typedInput.NetworkIdentifier != nil {
		var networkIdentifier1 SubResource
		err := networkIdentifier1.PopulateFromARM(owner, *typedInput.NetworkIdentifier)
		if err != nil {
			return err
		}
...
func (format *ServiceEndpointPropertiesFormat) AssignProperties_From_ServiceEndpointPropertiesFormat(source *storage.ServiceEndpointPropertiesFormat) error {
	...
	if source.NetworkIdentifier != nil {
		...
		err := networkIdentifier.AssignProperties_From_SubResource(source.NetworkIdentifier)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource() to populate field NetworkIdentifier")
		}
		format.NetworkIdentifier = &networkIdentifier
	} else {
...
func (format *ServiceEndpointPropertiesFormat) AssignProperties_To_ServiceEndpointPropertiesFormat(destination *storage.ServiceEndpointPropertiesFormat) error {
	...
	// NetworkIdentifier
	if format.NetworkIdentifier != nil {
		var networkIdentifier storage.SubResource
		err := format.NetworkIdentifier.AssignProperties_To_SubResource(&networkIdentifier)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource() to populate field NetworkIdentifier")
		}
...
func (format *ServiceEndpointPropertiesFormat) Initialize_From_ServiceEndpointPropertiesFormat_STATUS(source *ServiceEndpointPropertiesFormat_STATUS) error {
	...
	if source.NetworkIdentifier != nil {
		var networkIdentifier SubResource
		err := networkIdentifier.Initialize_From_SubResource_STATUS(source.NetworkIdentifier)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field NetworkIdentifier")
		}
		format.NetworkIdentifier = &networkIdentifier
	} else {
		format.NetworkIdentifier = nil
...
func (format *ServiceEndpointPropertiesFormat_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NetworkIdentifier":
	if typedInput.NetworkIdentifier != nil {
		var networkIdentifier1 SubResource_STATUS
		err := networkIdentifier1.PopulateFromARM(owner, *typedInput.NetworkIdentifier)
		if err != nil {
			return err
		}
...
func (format *ServiceEndpointPropertiesFormat_STATUS) AssignProperties_From_ServiceEndpointPropertiesFormat_STATUS(source *storage.ServiceEndpointPropertiesFormat_STATUS) error {
	...
	if source.NetworkIdentifier != nil {
		...
		err := networkIdentifier.AssignProperties_From_SubResource_STATUS(source.NetworkIdentifier)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field NetworkIdentifier")
		}
		format.NetworkIdentifier = &networkIdentifier
	} else {
		format.NetworkIdentifier = nil
...
func (format *ServiceEndpointPropertiesFormat_STATUS) AssignProperties_To_ServiceEndpointPropertiesFormat_STATUS(destination *storage.ServiceEndpointPropertiesFormat_STATUS) error {
	...
	// NetworkIdentifier
	if format.NetworkIdentifier != nil {
		var networkIdentifier storage.SubResource_STATUS
		err := format.NetworkIdentifier.AssignProperties_To_SubResource_STATUS(&networkIdentifier)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field NetworkIdentifier")
		}
		destination.NetworkIdentifier = &networkIdentifier
	} else {
		destination.NetworkIdentifier = nil
