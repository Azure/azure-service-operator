...
func (address *PublicIPAddress) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*PublicIPAddress_STATUS); ok {
		return address.Spec.Initialize_From_PublicIPAddress_STATUS(s)
	}

	return fmt.Errorf("expected Status of type PublicIPAddress_STATUS but received %T instead", status)
}
...
func (address *PublicIPAddress) AssignProperties_From_PublicIPAddress(source *storage.PublicIPAddress) error {
	...
	if err != nil {
		return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddress_Spec() to populate field Spec")
	}
	address.Spec = spec
	...
	if err != nil {
		return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddress_STATUS() to populate field Status")
	}
...
func (address *PublicIPAddress) AssignProperties_To_PublicIPAddress(destination *storage.PublicIPAddress) error {
	...
	if err != nil {
		return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddress_Spec() to populate field Spec")
	}
	...
	if err != nil {
		return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddress_STATUS() to populate field Status")
	}
...
func (address *PublicIPAddress_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if address.DeleteOption != nil {
		var temp string
		temp = string(*address.DeleteOption)
		deleteOption := arm.PublicIPAddressPropertiesFormat_DeleteOption(temp)
...
func (address *PublicIPAddress_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DeleteOption != nil {
			...
			deleteOption := PublicIPAddressPropertiesFormat_DeleteOption(temp)
			address.DeleteOption = &deleteOption
		}
	}
...
func (address *PublicIPAddress_Spec) AssignProperties_From_PublicIPAddress_Spec(source *storage.PublicIPAddress_Spec) error {
	...
	if source.DdosSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DdosSettings() to populate field DdosSettings")
		}
	...
	if source.DeleteOption != nil {
		...
		deleteOptionTemp := genruntime.ToEnum(deleteOption, publicIPAddressPropertiesFormat_DeleteOption_Values)
		address.DeleteOption = &deleteOptionTemp
	} else {
		address.DeleteOption = nil
	}
	...
	if source.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddressDnsSettings() to populate field DnsSettings")
		}
	...
	if source.LinkedPublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded() to populate field LinkedPublicIPAddress")
		}
		address.LinkedPublicIPAddress = &linkedPublicIPAddress
	} else {
		address.LinkedPublicIPAddress = nil
	...
	if source.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_NatGatewaySpec_PublicIPAddress_SubResourceEmbedded() to populate field NatGateway")
		}
		address.NatGateway = &natGateway
	} else {
		address.NatGateway = nil
	...
	if source.OperatorSpec != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddressOperatorSpec() to populate field OperatorSpec")
		}
	...
	if source.ServicePublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded() to populate field ServicePublicIPAddress")
		}
		address.ServicePublicIPAddress = &servicePublicIPAddress
	} else {
		address.ServicePublicIPAddress = nil
...
func (address *PublicIPAddress_Spec) AssignProperties_To_PublicIPAddress_Spec(destination *storage.PublicIPAddress_Spec) error {
	...
	if address.DdosSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DdosSettings() to populate field DdosSettings")
		}
	...
	// DeleteOption
	if address.DeleteOption != nil {
		deleteOption := string(*address.DeleteOption)
	...
	if address.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddressDnsSettings() to populate field DnsSettings")
		}
	...
	if address.LinkedPublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded() to populate field LinkedPublicIPAddress")
		}
	...
	if address.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_NatGatewaySpec_PublicIPAddress_SubResourceEmbedded() to populate field NatGateway")
		}
	...
	if address.OperatorSpec != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddressOperatorSpec() to populate field OperatorSpec")
		}
	...
	if address.ServicePublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded() to populate field ServicePublicIPAddress")
		}
...
func (address *PublicIPAddress_Spec) Initialize_From_PublicIPAddress_STATUS(source *PublicIPAddress_STATUS) error {
	...
	if source.DdosSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_DdosSettings_STATUS() to populate field DdosSettings")
		}
		address.DdosSettings = &ddosSetting
	} else {
		address.DdosSettings = nil
	...
	// DeleteOption
	if source.DeleteOption != nil {
		deleteOption := genruntime.ToEnum(string(*source.DeleteOption), publicIPAddressPropertiesFormat_DeleteOption_Values)
		address.DeleteOption = &deleteOption
	} else {
		address.DeleteOption = nil
	}
	...
	if source.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_PublicIPAddressDnsSettings_STATUS() to populate field DnsSettings")
		}
		address.DnsSettings = &dnsSetting
	} else {
		address.DnsSettings = nil
	...
	if source.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded() to populate field NatGateway")
		}
		address.NatGateway = &natGateway
	} else {
		address.NatGateway = nil
...
func (address *PublicIPAddress_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DeleteOption != nil {
			var temp string
			temp = string(*typedInput.Properties.DeleteOption)
			deleteOption := PublicIPAddressPropertiesFormat_DeleteOption_STATUS(temp)
			address.DeleteOption = &deleteOption
		}
	}
...
func (address *PublicIPAddress_STATUS) AssignProperties_From_PublicIPAddress_STATUS(source *storage.PublicIPAddress_STATUS) error {
	...
	if source.DdosSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_DdosSettings_STATUS() to populate field DdosSettings")
		}
		address.DdosSettings = &ddosSetting
	} else {
		address.DdosSettings = nil
	...
	if source.DeleteOption != nil {
		deleteOption := *source.DeleteOption
		deleteOptionTemp := genruntime.ToEnum(deleteOption, publicIPAddressPropertiesFormat_DeleteOption_STATUS_Values)
		address.DeleteOption = &deleteOptionTemp
	} else {
		address.DeleteOption = nil
	}
	...
	if source.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_PublicIPAddressDnsSettings_STATUS() to populate field DnsSettings")
		}
		address.DnsSettings = &dnsSetting
	} else {
		address.DnsSettings = nil
	...
	if source.IpConfiguration != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded() to populate field IpConfiguration")
		}
		address.IpConfiguration = &ipConfiguration
	} else {
	...
	if source.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded() to populate field NatGateway")
		}
		address.NatGateway = &natGateway
	} else {
		address.NatGateway = nil
...
func (address *PublicIPAddress_STATUS) AssignProperties_To_PublicIPAddress_STATUS(destination *storage.PublicIPAddress_STATUS) error {
	...
	if address.DdosSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_DdosSettings_STATUS() to populate field DdosSettings")
		}
		destination.DdosSettings = &ddosSetting
	} else {
		destination.DdosSettings = nil
	...
	if address.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_PublicIPAddressDnsSettings_STATUS() to populate field DnsSettings")
		}
		destination.DnsSettings = &dnsSetting
	} else {
		destination.DnsSettings = nil
	...
	if address.IpConfiguration != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded() to populate field IpConfiguration")
		}
	...
	if address.NatGateway != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded() to populate field NatGateway")
		}
		destination.NatGateway = &natGateway
	} else {
		destination.NatGateway = nil
...
func (settings *DdosSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if settings.DdosProtectionPlan != nil {
		...
		result.DdosProtectionPlan = &ddosProtectionPlan
	}

	// Set property "ProtectionMode":
	if settings.ProtectionMode != nil {
		var temp string
		temp = string(*settings.ProtectionMode)
		protectionMode := arm.DdosSettings_ProtectionMode(temp)
		result.ProtectionMode = &protectionMode
	}
	return result, nil
}
...
func (settings *DdosSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DdosProtectionPlan":
	if typedInput.DdosProtectionPlan != nil {
		var ddosProtectionPlan1 SubResource
		err := ddosProtectionPlan1.PopulateFromARM(owner, *typedInput.DdosProtectionPlan)
		if err != nil {
			return err
		}
		ddosProtectionPlan := ddosProtectionPlan1
		settings.DdosProtectionPlan = &ddosProtectionPlan
	}

	// Set property "ProtectionMode":
	if typedInput.ProtectionMode != nil {
		var temp string
		temp = string(*typedInput.ProtectionMode)
		protectionMode := DdosSettings_ProtectionMode(temp)
...
func (settings *DdosSettings) AssignProperties_From_DdosSettings(source *storage.DdosSettings) error {
	...
	if source.DdosProtectionPlan != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource() to populate field DdosProtectionPlan")
		}
		settings.DdosProtectionPlan = &ddosProtectionPlan
	} else {
		settings.DdosProtectionPlan = nil
	}

	// ProtectionMode
	if source.ProtectionMode != nil {
		protectionMode := *source.ProtectionMode
		protectionModeTemp := genruntime.ToEnum(protectionMode, ddosSettings_ProtectionMode_Values)
		settings.ProtectionMode = &protectionModeTemp
	} else {
		settings.ProtectionMode = nil
	}
...
func (settings *DdosSettings) AssignProperties_To_DdosSettings(destination *storage.DdosSettings) error {
	...
	if settings.DdosProtectionPlan != nil {
		...
		err := settings.DdosProtectionPlan.AssignProperties_To_SubResource(&ddosProtectionPlan)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource() to populate field DdosProtectionPlan")
		}
	...
	// ProtectionMode
	if settings.ProtectionMode != nil {
		protectionMode := string(*settings.ProtectionMode)
...
func (settings *DdosSettings) Initialize_From_DdosSettings_STATUS(source *DdosSettings_STATUS) error {
	...
	// ProtectionMode
	if source.ProtectionMode != nil {
		protectionMode := genruntime.ToEnum(string(*source.ProtectionMode), ddosSettings_ProtectionMode_Values)
		settings.ProtectionMode = &protectionMode
	} else {
		settings.ProtectionMode = nil
	}
...
func (settings *DdosSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.ProtectionMode != nil {
		var temp string
		temp = string(*typedInput.ProtectionMode)
		protectionMode := DdosSettings_ProtectionMode_STATUS(temp)
		settings.ProtectionMode = &protectionMode
	}
...
func (settings *DdosSettings_STATUS) AssignProperties_From_DdosSettings_STATUS(source *storage.DdosSettings_STATUS) error {
	...
	if source.DdosProtectionPlan != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field DdosProtectionPlan")
		}
		settings.DdosProtectionPlan = &ddosProtectionPlan
	} else {
		settings.DdosProtectionPlan = nil
	...
	if source.ProtectionMode != nil {
		protectionMode := *source.ProtectionMode
		protectionModeTemp := genruntime.ToEnum(protectionMode, ddosSettings_ProtectionMode_STATUS_Values)
		settings.ProtectionMode = &protectionModeTemp
	} else {
		settings.ProtectionMode = nil
	}
...
func (settings *DdosSettings_STATUS) AssignProperties_To_DdosSettings_STATUS(destination *storage.DdosSettings_STATUS) error {
	...
	if settings.DdosProtectionPlan != nil {
		...
		err := settings.DdosProtectionPlan.AssignProperties_To_SubResource_STATUS(&ddosProtectionPlan)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field DdosProtectionPlan")
		}
		destination.DdosProtectionPlan = &ddosProtectionPlan
	} else {
		destination.DdosProtectionPlan = nil
...
func (settings *PublicIPAddressDnsSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "DomainNameLabelScope":
	if settings.DomainNameLabelScope != nil {
		var temp string
		temp = string(*settings.DomainNameLabelScope)
		domainNameLabelScope := arm.PublicIPAddressDnsSettings_DomainNameLabelScope(temp)
		result.DomainNameLabelScope = &domainNameLabelScope
	}
...
func (settings *PublicIPAddressDnsSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DomainNameLabelScope":
	if typedInput.DomainNameLabelScope != nil {
		var temp string
		temp = string(*typedInput.DomainNameLabelScope)
		domainNameLabelScope := PublicIPAddressDnsSettings_DomainNameLabelScope(temp)
		settings.DomainNameLabelScope = &domainNameLabelScope
	}
...
func (settings *PublicIPAddressDnsSettings) AssignProperties_From_PublicIPAddressDnsSettings(source *storage.PublicIPAddressDnsSettings) error {
	...
	if source.DomainNameLabelScope != nil {
		domainNameLabelScope := *source.DomainNameLabelScope
		domainNameLabelScopeTemp := genruntime.ToEnum(domainNameLabelScope, publicIPAddressDnsSettings_DomainNameLabelScope_Values)
		settings.DomainNameLabelScope = &domainNameLabelScopeTemp
	} else {
		settings.DomainNameLabelScope = nil
	}
...
func (settings *PublicIPAddressDnsSettings) AssignProperties_To_PublicIPAddressDnsSettings(destination *storage.PublicIPAddressDnsSettings) error {
	...
	// DomainNameLabelScope
	if settings.DomainNameLabelScope != nil {
		domainNameLabelScope := string(*settings.DomainNameLabelScope)
...
func (settings *PublicIPAddressDnsSettings) Initialize_From_PublicIPAddressDnsSettings_STATUS(source *PublicIPAddressDnsSettings_STATUS) error {
	...
	// DomainNameLabelScope
	if source.DomainNameLabelScope != nil {
		domainNameLabelScope := genruntime.ToEnum(string(*source.DomainNameLabelScope), publicIPAddressDnsSettings_DomainNameLabelScope_Values)
		settings.DomainNameLabelScope = &domainNameLabelScope
	} else {
		settings.DomainNameLabelScope = nil
	}
...
func (settings *PublicIPAddressDnsSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DomainNameLabelScope != nil {
		var temp string
		temp = string(*typedInput.DomainNameLabelScope)
		domainNameLabelScope := PublicIPAddressDnsSettings_DomainNameLabelScope_STATUS(temp)
		settings.DomainNameLabelScope = &domainNameLabelScope
	}
...
func (settings *PublicIPAddressDnsSettings_STATUS) AssignProperties_From_PublicIPAddressDnsSettings_STATUS(source *storage.PublicIPAddressDnsSettings_STATUS) error {
	...
	if source.DomainNameLabelScope != nil {
		domainNameLabelScope := *source.DomainNameLabelScope
		domainNameLabelScopeTemp := genruntime.ToEnum(domainNameLabelScope, publicIPAddressDnsSettings_DomainNameLabelScope_STATUS_Values)
		settings.DomainNameLabelScope = &domainNameLabelScopeTemp
	} else {
		settings.DomainNameLabelScope = nil
	}
...
// Mapping from string to PublicIPAddressPropertiesFormat_DeleteOption
var publicIPAddressPropertiesFormat_DeleteOption_Values = map[string]PublicIPAddressPropertiesFormat_DeleteOption{
	"delete": PublicIPAddressPropertiesFormat_DeleteOption_Delete,
	"detach": PublicIPAddressPropertiesFormat_DeleteOption_Detach,
}
...
// Mapping from string to DdosSettings_ProtectionMode
var ddosSettings_ProtectionMode_Values = map[string]DdosSettings_ProtectionMode{
	"disabled":                DdosSettings_ProtectionMode_Disabled,
	"enabled":                 DdosSettings_ProtectionMode_Enabled,
	"virtualnetworkinherited": DdosSettings_ProtectionMode_VirtualNetworkInherited,
}
...
// Mapping from string to PublicIPAddressDnsSettings_DomainNameLabelScope
var publicIPAddressDnsSettings_DomainNameLabelScope_Values = map[string]PublicIPAddressDnsSettings_DomainNameLabelScope{
	"noreuse":            PublicIPAddressDnsSettings_DomainNameLabelScope_NoReuse,
	"resourcegroupreuse": PublicIPAddressDnsSettings_DomainNameLabelScope_ResourceGroupReuse,
	"subscriptionreuse":  PublicIPAddressDnsSettings_DomainNameLabelScope_SubscriptionReuse,
	"tenantreuse":        PublicIPAddressDnsSettings_DomainNameLabelScope_TenantReuse,
}
