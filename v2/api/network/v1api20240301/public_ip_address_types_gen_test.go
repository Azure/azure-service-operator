...
// RunPropertyAssignmentTestForDdosSettings tests if a specific instance of DdosSettings can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDdosSettings(subject DdosSettings) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.DdosSettings
...
func AddIndependentPropertyGeneratorsForDdosSettings(gens map[string]gopter.Gen) {
	gens["ProtectionMode"] = gen.PtrOf(gen.OneConstOf(DdosSettings_ProtectionMode_Disabled, DdosSettings_ProtectionMode_Enabled, DdosSettings_ProtectionMode_VirtualNetworkInherited))
}
...
// RunPropertyAssignmentTestForDdosSettings_STATUS tests if a specific instance of DdosSettings_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDdosSettings_STATUS(subject DdosSettings_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.DdosSettings_STATUS
...
func AddIndependentPropertyGeneratorsForDdosSettings_STATUS(gens map[string]gopter.Gen) {
	gens["ProtectionMode"] = gen.PtrOf(gen.OneConstOf(DdosSettings_ProtectionMode_STATUS_Disabled, DdosSettings_ProtectionMode_STATUS_Enabled, DdosSettings_ProtectionMode_STATUS_VirtualNetworkInherited))
}
...
// RunPropertyAssignmentTestForIPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded tests if a specific instance of IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded(subject IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded
...
func RunPropertyAssignmentTestForIpTag_STATUS(subject IpTag_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.IpTag_STATUS
...
// RunPropertyAssignmentTestForNatGatewaySpec_PublicIPAddress_SubResourceEmbedded tests if a specific instance of NatGatewaySpec_PublicIPAddress_SubResourceEmbedded can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNatGatewaySpec_PublicIPAddress_SubResourceEmbedded(subject NatGatewaySpec_PublicIPAddress_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.NatGatewaySpec_PublicIPAddress_SubResourceEmbedded
...
// RunPropertyAssignmentTestForNatGateway_STATUS_PublicIPAddress_SubResourceEmbedded tests if a specific instance of NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForNatGateway_STATUS_PublicIPAddress_SubResourceEmbedded(subject NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded
...
// RunPropertyAssignmentTestForPublicIPAddress tests if a specific instance of PublicIPAddress can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddress(subject PublicIPAddress) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddress
...
func AddRelatedPropertyGeneratorsForPublicIPAddress(gens map[string]gopter.Gen) {
	...
	gens["Status"] = PublicIPAddress_STATUSGenerator()
}
...
// RunPropertyAssignmentTestForPublicIPAddressDnsSettings tests if a specific instance of PublicIPAddressDnsSettings can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddressDnsSettings(subject PublicIPAddressDnsSettings) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressDnsSettings
...
func AddIndependentPropertyGeneratorsForPublicIPAddressDnsSettings(gens map[string]gopter.Gen) {
	...
	gens["DomainNameLabelScope"] = gen.PtrOf(gen.OneConstOf(
		PublicIPAddressDnsSettings_DomainNameLabelScope_NoReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_ResourceGroupReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_SubscriptionReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_TenantReuse))
...
// RunPropertyAssignmentTestForPublicIPAddressDnsSettings_STATUS tests if a specific instance of PublicIPAddressDnsSettings_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddressDnsSettings_STATUS(subject PublicIPAddressDnsSettings_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressDnsSettings_STATUS
...
func AddIndependentPropertyGeneratorsForPublicIPAddressDnsSettings_STATUS(gens map[string]gopter.Gen) {
	gens["DomainNameLabel"] = gen.PtrOf(gen.AlphaString())
	gens["DomainNameLabelScope"] = gen.PtrOf(gen.OneConstOf(
		PublicIPAddressDnsSettings_DomainNameLabelScope_STATUS_NoReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_STATUS_ResourceGroupReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_STATUS_SubscriptionReuse,
		PublicIPAddressDnsSettings_DomainNameLabelScope_STATUS_TenantReuse))
	gens["Fqdn"] = gen.PtrOf(gen.AlphaString())
	gens["ReverseFqdn"] = gen.PtrOf(gen.AlphaString())
}

func Test_PublicIPAddressOperatorSpec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from PublicIPAddressOperatorSpec to PublicIPAddressOperatorSpec via AssignProperties_To_PublicIPAddressOperatorSpec & AssignProperties_From_PublicIPAddressOperatorSpec returns original",
		prop.ForAll(RunPropertyAssignmentTestForPublicIPAddressOperatorSpec, PublicIPAddressOperatorSpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForPublicIPAddressOperatorSpec tests if a specific instance of PublicIPAddressOperatorSpec can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddressOperatorSpec(subject PublicIPAddressOperatorSpec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressOperatorSpec
	...
	err = actual.AssignProperties_From_PublicIPAddressOperatorSpec(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForPublicIPAddressSku(subject PublicIPAddressSku) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressSku
...
func RunPropertyAssignmentTestForPublicIPAddressSku_STATUS(subject PublicIPAddressSku_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressSku_STATUS
...
// RunPropertyAssignmentTestForPublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded tests if a specific instance of PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded(subject PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded
...
// RunPropertyAssignmentTestForPublicIPAddress_STATUS tests if a specific instance of PublicIPAddress_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddress_STATUS(subject PublicIPAddress_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddress_STATUS
...
func AddIndependentPropertyGeneratorsForPublicIPAddress_STATUS(gens map[string]gopter.Gen) {
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(PublicIPAddressPropertiesFormat_DeleteOption_STATUS_Delete, PublicIPAddressPropertiesFormat_DeleteOption_STATUS_Detach))
...
// RunPropertyAssignmentTestForPublicIPAddress_Spec tests if a specific instance of PublicIPAddress_Spec can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPublicIPAddress_Spec(subject PublicIPAddress_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20240301s.PublicIPAddress_Spec
...
func AddIndependentPropertyGeneratorsForPublicIPAddress_Spec(gens map[string]gopter.Gen) {
	...
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(PublicIPAddressPropertiesFormat_DeleteOption_Delete, PublicIPAddressPropertiesFormat_DeleteOption_Detach))
	gens["IdleTimeoutInMinutes"] = gen.PtrOf(gen.Int())
	gens["IpAddress"] = gen.PtrOf(gen.AlphaString())
	gens["Location"] = gen.PtrOf(gen.AlphaString())
