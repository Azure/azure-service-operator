...
// +kubebuilder:webhook:path=/mutate-network-azure-com-v1api20240301-loadbalancer,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=loadbalancers,verbs=create;update,versions=v1api20240301,name=default.v1api20240301.loadbalancers.network.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1api20240301-loadbalancer,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=loadbalancers,verbs=create;update,versions=v1api20240301,name=validate.v1api20240301.loadbalancers.network.azure.com,admissionReviewVersions=v1
...
func (balancer *LoadBalancer_Spec) Initialize_From_LoadBalancer_STATUS(source *LoadBalancer_STATUS) error {
	...
	if source.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range source.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
		balancer.BackendAddressPools = backendAddressPoolList
	...
	if source.FrontendIPConfigurations != nil {
		...
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range source.FrontendIPConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded() to populate field FrontendIPConfigurations")
			}
			frontendIPConfigurationList[frontendIPConfigurationIndex] = frontendIPConfiguration
		}
		balancer.FrontendIPConfigurations = frontendIPConfigurationList
	...
	if source.InboundNatPools != nil {
		...
		for inboundNatPoolIndex, inboundNatPoolItem := range source.InboundNatPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_InboundNatPool_STATUS() to populate field InboundNatPools")
			}
			inboundNatPoolList[inboundNatPoolIndex] = inboundNatPool
		}
		balancer.InboundNatPools = inboundNatPoolList
	...
	if source.InboundNatRules != nil {
		...
		for inboundNatRuleIndex, inboundNatRuleItem := range source.InboundNatRules {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded() to populate field InboundNatRules")
			}
			inboundNatRuleList[inboundNatRuleIndex] = inboundNatRule
		}
		balancer.InboundNatRules = inboundNatRuleList
	...
	if source.LoadBalancingRules != nil {
		...
		for loadBalancingRuleIndex, loadBalancingRuleItem := range source.LoadBalancingRules {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_LoadBalancingRule_STATUS() to populate field LoadBalancingRules")
			}
			loadBalancingRuleList[loadBalancingRuleIndex] = loadBalancingRule
		}
		balancer.LoadBalancingRules = loadBalancingRuleList
	...
	if source.OutboundRules != nil {
		...
		for outboundRuleIndex, outboundRuleItem := range source.OutboundRules {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_OutboundRule_STATUS() to populate field OutboundRules")
			}
			outboundRuleList[outboundRuleIndex] = outboundRule
		}
		balancer.OutboundRules = outboundRuleList
	...
	if source.Probes != nil {
		...
		for probeIndex, probeItem := range source.Probes {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_Probe_STATUS() to populate field Probes")
			}
			probeList[probeIndex] = probe
		}
		balancer.Probes = probeList
	...
	if source.Sku != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_LoadBalancerSku_STATUS() to populate field Sku")
		}
		balancer.Sku = &sku
	} else {
		balancer.Sku = nil
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "Properties":
	if embedded.DrainPeriodInSeconds != nil ||
		embedded.LoadBalancerBackendAddresses != nil ||
		embedded.Location != nil ||
		embedded.SyncMode != nil ||
		embedded.TunnelInterfaces != nil ||
		embedded.VirtualNetwork != nil {
		result.Properties = &arm.BackendAddressPoolPropertiesFormat{}
	}
	if embedded.DrainPeriodInSeconds != nil {
		drainPeriodInSeconds := *embedded.DrainPeriodInSeconds
		result.Properties.DrainPeriodInSeconds = &drainPeriodInSeconds
	}
	...
	if embedded.SyncMode != nil {
		var temp string
		temp = string(*embedded.SyncMode)
		syncMode := arm.BackendAddressPoolPropertiesFormat_SyncMode(temp)
		result.Properties.SyncMode = &syncMode
	}
	for _, item := range embedded.TunnelInterfaces {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DrainPeriodInSeconds":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DrainPeriodInSeconds != nil {
			drainPeriodInSeconds := *typedInput.Properties.DrainPeriodInSeconds
			embedded.DrainPeriodInSeconds = &drainPeriodInSeconds
		}
	}
	...
	// Set property "SyncMode":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.SyncMode != nil {
			var temp string
			temp = string(*typedInput.Properties.SyncMode)
			syncMode := BackendAddressPoolPropertiesFormat_SyncMode(temp)
			embedded.SyncMode = &syncMode
		}
	}

	// Set property "TunnelInterfaces":
	// copying flattened property:
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.TunnelInterfaces {
			var item1 GatewayLoadBalancerTunnelInterface
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
			embedded.TunnelInterfaces = append(embedded.TunnelInterfaces, item1)
		}
	}
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) AssignProperties_From_BackendAddressPool_LoadBalancer_SubResourceEmbedded(source *storage.BackendAddressPool_LoadBalancer_SubResourceEmbedded) error {
	...
	if source.SyncMode != nil {
		...
		syncModeTemp := genruntime.ToEnum(syncMode, backendAddressPoolPropertiesFormat_SyncMode_Values)
		embedded.SyncMode = &syncModeTemp
	} else {
		embedded.SyncMode = nil
	}
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) AssignProperties_To_BackendAddressPool_LoadBalancer_SubResourceEmbedded(destination *storage.BackendAddressPool_LoadBalancer_SubResourceEmbedded) error {
	...
	// SyncMode
	if embedded.SyncMode != nil {
		syncMode := string(*embedded.SyncMode)
	...
	if embedded.VirtualNetwork != nil {
		...
		err := embedded.VirtualNetwork.AssignProperties_To_SubResource(&virtualNetwork)
		if err != nil {
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) Initialize_From_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded(source *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) error {
	...
	if source.LoadBalancerBackendAddresses != nil {
		...
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range source.LoadBalancerBackendAddresses {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_LoadBalancerBackendAddress_STATUS() to populate field LoadBalancerBackendAddresses")
			}
			loadBalancerBackendAddressList[loadBalancerBackendAddressIndex] = loadBalancerBackendAddress
		}
		embedded.LoadBalancerBackendAddresses = loadBalancerBackendAddressList
	...
	// SyncMode
	if source.SyncMode != nil {
		syncMode := genruntime.ToEnum(string(*source.SyncMode), backendAddressPoolPropertiesFormat_SyncMode_Values)
		embedded.SyncMode = &syncMode
	} else {
		embedded.SyncMode = nil
	}
	...
	if source.TunnelInterfaces != nil {
		...
		for tunnelInterfaceIndex, tunnelInterfaceItem := range source.TunnelInterfaces {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_GatewayLoadBalancerTunnelInterface_STATUS() to populate field TunnelInterfaces")
			}
			tunnelInterfaceList[tunnelInterfaceIndex] = tunnelInterface
		}
		embedded.TunnelInterfaces = tunnelInterfaceList
...
func (embedded *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.SyncMode != nil {
			var temp string
			temp = string(*typedInput.Properties.SyncMode)
			syncMode := BackendAddressPoolPropertiesFormat_SyncMode_STATUS(temp)
			embedded.SyncMode = &syncMode
		}
	}
	...
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.TunnelInterfaces {
			var item1 GatewayLoadBalancerTunnelInterface_STATUS
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
...
func (embedded *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded(source *storage.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) error {
	...
	if source.SyncMode != nil {
		syncMode := *source.SyncMode
		syncModeTemp := genruntime.ToEnum(syncMode, backendAddressPoolPropertiesFormat_SyncMode_STATUS_Values)
		embedded.SyncMode = &syncModeTemp
	} else {
		embedded.SyncMode = nil
	}
...
func (embedded *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded(destination *storage.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) error {
	...
	if embedded.VirtualNetwork != nil {
		...
		err := embedded.VirtualNetwork.AssignProperties_To_SubResource_STATUS(&virtualNetwork)
		if err != nil {
...
func (embedded *FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) Initialize_From_FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(source *FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) error {
	...
	if source.PublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded() to populate field PublicIPAddress")
		}
		embedded.PublicIPAddress = &publicIPAddress
	} else {
		embedded.PublicIPAddress = nil
	...
	if source.Subnet != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Subnet_STATUS_LoadBalancer_SubResourceEmbedded() to populate field Subnet")
		}
		embedded.Subnet = &subnet
	} else {
		embedded.Subnet = nil
...
func (embedded *InboundNatRule_LoadBalancer_SubResourceEmbedded) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if embedded.FrontendPortRangeEnd != nil {
		frontendPortRangeEnd := *embedded.FrontendPortRangeEnd
		result.Properties.FrontendPortRangeEnd = &frontendPortRangeEnd
	}
	if embedded.FrontendPortRangeStart != nil {
		frontendPortRangeStart := *embedded.FrontendPortRangeStart
		result.Properties.FrontendPortRangeStart = &frontendPortRangeStart
	}
...
func (embedded *InboundNatRule_LoadBalancer_SubResourceEmbedded) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.FrontendPortRangeEnd != nil {
			frontendPortRangeEnd := *typedInput.Properties.FrontendPortRangeEnd
			embedded.FrontendPortRangeEnd = &frontendPortRangeEnd
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.FrontendPortRangeStart != nil {
			frontendPortRangeStart := *typedInput.Properties.FrontendPortRangeStart
			embedded.FrontendPortRangeStart = &frontendPortRangeStart
		}
	}
...
func (embedded *InboundNatRule_LoadBalancer_SubResourceEmbedded) AssignProperties_To_InboundNatRule_LoadBalancer_SubResourceEmbedded(destination *storage.InboundNatRule_LoadBalancer_SubResourceEmbedded) error {
	...
	if embedded.BackendAddressPool != nil {
		...
		err := embedded.BackendAddressPool.AssignProperties_To_SubResource(&backendAddressPool)
		if err != nil {
...
func (embedded *InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded(destination *storage.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) error {
	...
	if embedded.BackendAddressPool != nil {
		...
		err := embedded.BackendAddressPool.AssignProperties_To_SubResource_STATUS(&backendAddressPool)
		if err != nil {
...
func (rule *LoadBalancingRule) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	for _, item := range rule.BackendAddressPools {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.Properties.BackendAddressPools = append(result.Properties.BackendAddressPools, *item_ARM.(*arm.SubResource))
	}
...
func (rule *LoadBalancingRule) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.BackendAddressPools {
			...
			rule.BackendAddressPools = append(rule.BackendAddressPools, item1)
		}
	}
...
func (rule *LoadBalancingRule) AssignProperties_From_LoadBalancingRule(source *storage.LoadBalancingRule) error {
	...
	if source.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range source.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_SubResource() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
...
func (rule *LoadBalancingRule) AssignProperties_To_LoadBalancingRule(destination *storage.LoadBalancingRule) error {
	...
	if rule.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range rule.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_SubResource() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
		destination.BackendAddressPools = backendAddressPoolList
...
func (rule *LoadBalancingRule) Initialize_From_LoadBalancingRule_STATUS(source *LoadBalancingRule_STATUS) error {
	...
	if source.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range source.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
		rule.BackendAddressPools = backendAddressPoolList
	...
	if source.Probe != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field Probe")
		}
		rule.Probe = &probe
	} else {
		rule.Probe = nil
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_From_LoadBalancingRule_STATUS(source *storage.LoadBalancingRule_STATUS) error {
	...
	if source.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range source.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
		rule.BackendAddressPools = backendAddressPoolList
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_To_LoadBalancingRule_STATUS(destination *storage.LoadBalancingRule_STATUS) error {
	...
	if rule.BackendAddressPools != nil {
		...
		for backendAddressPoolIndex, backendAddressPoolItem := range rule.BackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field BackendAddressPools")
			}
			backendAddressPoolList[backendAddressPoolIndex] = backendAddressPool
		}
		destination.BackendAddressPools = backendAddressPoolList
...
func (rule *OutboundRule) Initialize_From_OutboundRule_STATUS(source *OutboundRule_STATUS) error {
	...
	if source.FrontendIPConfigurations != nil {
		...
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range source.FrontendIPConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field FrontendIPConfigurations")
			}
			frontendIPConfigurationList[frontendIPConfigurationIndex] = frontendIPConfiguration
		}
		rule.FrontendIPConfigurations = frontendIPConfigurationList
...
func (probe *Probe) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if probe.IntervalInSeconds != nil ||
		probe.NoHealthyBackendsBehavior != nil ||
		probe.NumberOfProbes != nil ||
		probe.Port != nil ||
		probe.ProbeThreshold != nil ||
		probe.Protocol != nil ||
	...
	if probe.NoHealthyBackendsBehavior != nil {
		var temp string
		temp = string(*probe.NoHealthyBackendsBehavior)
		noHealthyBackendsBehavior := arm.ProbePropertiesFormat_NoHealthyBackendsBehavior(temp)
		result.Properties.NoHealthyBackendsBehavior = &noHealthyBackendsBehavior
	}
	...
	if probe.ProbeThreshold != nil {
		...
		result.Properties.ProbeThreshold = &probeThreshold
	}
...
func (probe *Probe) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NoHealthyBackendsBehavior":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.NoHealthyBackendsBehavior != nil {
			var temp string
			temp = string(*typedInput.Properties.NoHealthyBackendsBehavior)
			noHealthyBackendsBehavior := ProbePropertiesFormat_NoHealthyBackendsBehavior(temp)
			probe.NoHealthyBackendsBehavior = &noHealthyBackendsBehavior
		}
	}
	...
	// Set property "ProbeThreshold":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.ProbeThreshold != nil {
			probeThreshold := *typedInput.Properties.ProbeThreshold
			probe.ProbeThreshold = &probeThreshold
		}
	}
...
func (probe *Probe) AssignProperties_From_Probe(source *storage.Probe) error {
	...
	if source.NoHealthyBackendsBehavior != nil {
		noHealthyBackendsBehavior := *source.NoHealthyBackendsBehavior
		noHealthyBackendsBehaviorTemp := genruntime.ToEnum(noHealthyBackendsBehavior, probePropertiesFormat_NoHealthyBackendsBehavior_Values)
		probe.NoHealthyBackendsBehavior = &noHealthyBackendsBehaviorTemp
	} else {
		probe.NoHealthyBackendsBehavior = nil
	}
...
func (probe *Probe) AssignProperties_To_Probe(destination *storage.Probe) error {
	...
	// NoHealthyBackendsBehavior
	if probe.NoHealthyBackendsBehavior != nil {
		noHealthyBackendsBehavior := string(*probe.NoHealthyBackendsBehavior)
...
func (probe *Probe) Initialize_From_Probe_STATUS(source *Probe_STATUS) error {
	...
	// NoHealthyBackendsBehavior
	if source.NoHealthyBackendsBehavior != nil {
		noHealthyBackendsBehavior := genruntime.ToEnum(string(*source.NoHealthyBackendsBehavior), probePropertiesFormat_NoHealthyBackendsBehavior_Values)
		probe.NoHealthyBackendsBehavior = &noHealthyBackendsBehavior
	} else {
		probe.NoHealthyBackendsBehavior = nil
	}
...
func (probe *Probe_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.NoHealthyBackendsBehavior != nil {
			var temp string
			temp = string(*typedInput.Properties.NoHealthyBackendsBehavior)
			noHealthyBackendsBehavior := ProbePropertiesFormat_NoHealthyBackendsBehavior_STATUS(temp)
			probe.NoHealthyBackendsBehavior = &noHealthyBackendsBehavior
		}
	}
...
func (probe *Probe_STATUS) AssignProperties_From_Probe_STATUS(source *storage.Probe_STATUS) error {
	...
	if source.NoHealthyBackendsBehavior != nil {
		noHealthyBackendsBehavior := *source.NoHealthyBackendsBehavior
		noHealthyBackendsBehaviorTemp := genruntime.ToEnum(noHealthyBackendsBehavior, probePropertiesFormat_NoHealthyBackendsBehavior_STATUS_Values)
		probe.NoHealthyBackendsBehavior = &noHealthyBackendsBehaviorTemp
	} else {
		probe.NoHealthyBackendsBehavior = nil
	}
...
// Mapping from string to BackendAddressPoolPropertiesFormat_SyncMode
var backendAddressPoolPropertiesFormat_SyncMode_Values = map[string]BackendAddressPoolPropertiesFormat_SyncMode{
	"automatic": BackendAddressPoolPropertiesFormat_SyncMode_Automatic,
	"manual":    BackendAddressPoolPropertiesFormat_SyncMode_Manual,
}
...
// Mapping from string to BackendAddressPoolPropertiesFormat_SyncMode_STATUS
var backendAddressPoolPropertiesFormat_SyncMode_STATUS_Values = map[string]BackendAddressPoolPropertiesFormat_SyncMode_STATUS{
	"automatic": BackendAddressPoolPropertiesFormat_SyncMode_STATUS_Automatic,
	"manual":    BackendAddressPoolPropertiesFormat_SyncMode_STATUS_Manual,
}
...
var _ genruntime.ARMTransformer = &GatewayLoadBalancerTunnelInterface{}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &arm.GatewayLoadBalancerTunnelInterface{}

	// Set property "Identifier":
	if tunnelInterface.Identifier != nil {
		identifier := *tunnelInterface.Identifier
		result.Identifier = &identifier
	}

	// Set property "Port":
	if tunnelInterface.Port != nil {
		port := *tunnelInterface.Port
		result.Port = &port
	}

	// Set property "Protocol":
	if tunnelInterface.Protocol != nil {
		var temp string
		temp = string(*tunnelInterface.Protocol)
		protocol := arm.GatewayLoadBalancerTunnelInterface_Protocol(temp)
		result.Protocol = &protocol
	}

	// Set property "Type":
	if tunnelInterface.Type != nil {
		var temp string
		temp = string(*tunnelInterface.Type)
		typeVar := arm.GatewayLoadBalancerTunnelInterface_Type(temp)
		result.Type = &typeVar
	}
	return result, nil
}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GatewayLoadBalancerTunnelInterface{}
}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GatewayLoadBalancerTunnelInterface)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GatewayLoadBalancerTunnelInterface, got %T", armInput)
	}

	// Set property "Identifier":
	if typedInput.Identifier != nil {
		identifier := *typedInput.Identifier
		tunnelInterface.Identifier = &identifier
	}

	// Set property "Port":
	if typedInput.Port != nil {
		port := *typedInput.Port
		tunnelInterface.Port = &port
	}
	...
	if typedInput.Protocol != nil {
		...
		protocol := GatewayLoadBalancerTunnelInterface_Protocol(temp)
		tunnelInterface.Protocol = &protocol
	}
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := GatewayLoadBalancerTunnelInterface_Type(temp)
		tunnelInterface.Type = &typeVar
	}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) AssignProperties_From_GatewayLoadBalancerTunnelInterface(source *storage.GatewayLoadBalancerTunnelInterface) error {
	...
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, gatewayLoadBalancerTunnelInterface_Protocol_Values)
		tunnelInterface.Protocol = &protocolTemp
	} else {
		tunnelInterface.Protocol = nil
	}

	// Type
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, gatewayLoadBalancerTunnelInterface_Type_Values)
		tunnelInterface.Type = &typeTemp
	} else {
		tunnelInterface.Type = nil
	}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) AssignProperties_To_GatewayLoadBalancerTunnelInterface(destination *storage.GatewayLoadBalancerTunnelInterface) error {
	...
	// Type
	if tunnelInterface.Type != nil {
		typeVar := string(*tunnelInterface.Type)
		destination.Type = &typeVar
	} else {
		destination.Type = nil
	}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface) Initialize_From_GatewayLoadBalancerTunnelInterface_STATUS(source *GatewayLoadBalancerTunnelInterface_STATUS) error {
	...
	// Protocol
	if source.Protocol != nil {
		protocol := genruntime.ToEnum(string(*source.Protocol), gatewayLoadBalancerTunnelInterface_Protocol_Values)
		tunnelInterface.Protocol = &protocol
	} else {
		tunnelInterface.Protocol = nil
	}
	...
	// Type
	if source.Type != nil {
		typeVar := genruntime.ToEnum(string(*source.Type), gatewayLoadBalancerTunnelInterface_Type_Values)
		tunnelInterface.Type = &typeVar
	} else {
		tunnelInterface.Type = nil
	}
...
var _ genruntime.FromARMConverter = &GatewayLoadBalancerTunnelInterface_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (tunnelInterface *GatewayLoadBalancerTunnelInterface_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GatewayLoadBalancerTunnelInterface_STATUS{}
}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GatewayLoadBalancerTunnelInterface_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GatewayLoadBalancerTunnelInterface_STATUS, got %T", armInput)
	}
	...
	if typedInput.Protocol != nil {
		var temp string
		temp = string(*typedInput.Protocol)
		protocol := GatewayLoadBalancerTunnelInterface_Protocol_STATUS(temp)
		tunnelInterface.Protocol = &protocol
	}
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := GatewayLoadBalancerTunnelInterface_Type_STATUS(temp)
		tunnelInterface.Type = &typeVar
	}
...
func (tunnelInterface *GatewayLoadBalancerTunnelInterface_STATUS) AssignProperties_From_GatewayLoadBalancerTunnelInterface_STATUS(source *storage.GatewayLoadBalancerTunnelInterface_STATUS) error {
	...
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, gatewayLoadBalancerTunnelInterface_Protocol_STATUS_Values)
		tunnelInterface.Protocol = &protocolTemp
	} else {
		tunnelInterface.Protocol = nil
	}
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, gatewayLoadBalancerTunnelInterface_Type_STATUS_Values)
		tunnelInterface.Type = &typeTemp
	} else {
		tunnelInterface.Type = nil
	}
...
func (address *LoadBalancerBackendAddress) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if address.AdminState != nil {
		var temp string
		temp = string(*address.AdminState)
		adminState := arm.LoadBalancerBackendAddressPropertiesFormat_AdminState(temp)
...
func (address *LoadBalancerBackendAddress) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AdminState != nil {
			...
			adminState := LoadBalancerBackendAddressPropertiesFormat_AdminState(temp)
...
func (address *LoadBalancerBackendAddress) AssignProperties_From_LoadBalancerBackendAddress(source *storage.LoadBalancerBackendAddress) error {
	...
	if source.AdminState != nil {
		...
		adminStateTemp := genruntime.ToEnum(adminState, loadBalancerBackendAddressPropertiesFormat_AdminState_Values)
		address.AdminState = &adminStateTemp
	} else {
		address.AdminState = nil
	}
...
func (address *LoadBalancerBackendAddress) AssignProperties_To_LoadBalancerBackendAddress(destination *storage.LoadBalancerBackendAddress) error {
	...
	// AdminState
	if address.AdminState != nil {
		adminState := string(*address.AdminState)
...
func (address *LoadBalancerBackendAddress) Initialize_From_LoadBalancerBackendAddress_STATUS(source *LoadBalancerBackendAddress_STATUS) error {
	...
	// AdminState
	if source.AdminState != nil {
		adminState := genruntime.ToEnum(string(*source.AdminState), loadBalancerBackendAddressPropertiesFormat_AdminState_Values)
		address.AdminState = &adminState
	} else {
		address.AdminState = nil
	}
	...
	if source.LoadBalancerFrontendIPConfiguration != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field LoadBalancerFrontendIPConfiguration")
		}
		address.LoadBalancerFrontendIPConfiguration = &loadBalancerFrontendIPConfiguration
	} else {
		address.LoadBalancerFrontendIPConfiguration = nil
...
func (address *LoadBalancerBackendAddress_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AdminState != nil {
			var temp string
			temp = string(*typedInput.Properties.AdminState)
			adminState := LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS(temp)
			address.AdminState = &adminState
		}
	}

	// Set property "InboundNatRulesPortMapping":
	// copying flattened property:
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.InboundNatRulesPortMapping {
			var item1 NatRulePortMapping_STATUS
			err := item1.PopulateFromARM(owner, item)
			if err != nil {
				return err
			}
			address.InboundNatRulesPortMapping = append(address.InboundNatRulesPortMapping, item1)
		}
	}
...
func (address *LoadBalancerBackendAddress_STATUS) AssignProperties_From_LoadBalancerBackendAddress_STATUS(source *storage.LoadBalancerBackendAddress_STATUS) error {
	...
	if source.AdminState != nil {
		adminState := *source.AdminState
		adminStateTemp := genruntime.ToEnum(adminState, loadBalancerBackendAddressPropertiesFormat_AdminState_STATUS_Values)
		address.AdminState = &adminStateTemp
	} else {
		address.AdminState = nil
	}
...
var loadBalancerSku_Name_Values = map[string]LoadBalancerSku_Name{
	...
	"gateway":  LoadBalancerSku_Name_Gateway,
...
var loadBalancerSku_Name_STATUS_Values = map[string]LoadBalancerSku_Name_STATUS{
	...
	"gateway":  LoadBalancerSku_Name_STATUS_Gateway,
...
// Mapping from string to ProbePropertiesFormat_NoHealthyBackendsBehavior
var probePropertiesFormat_NoHealthyBackendsBehavior_Values = map[string]ProbePropertiesFormat_NoHealthyBackendsBehavior{
	"allprobeddown": ProbePropertiesFormat_NoHealthyBackendsBehavior_AllProbedDown,
	"allprobedup":   ProbePropertiesFormat_NoHealthyBackendsBehavior_AllProbedUp,
}
...
// Mapping from string to ProbePropertiesFormat_NoHealthyBackendsBehavior_STATUS
var probePropertiesFormat_NoHealthyBackendsBehavior_STATUS_Values = map[string]ProbePropertiesFormat_NoHealthyBackendsBehavior_STATUS{
	"allprobeddown": ProbePropertiesFormat_NoHealthyBackendsBehavior_STATUS_AllProbedDown,
	"allprobedup":   ProbePropertiesFormat_NoHealthyBackendsBehavior_STATUS_AllProbedUp,
}
...
// Mapping from string to GatewayLoadBalancerTunnelInterface_Protocol
var gatewayLoadBalancerTunnelInterface_Protocol_Values = map[string]GatewayLoadBalancerTunnelInterface_Protocol{
	"native": GatewayLoadBalancerTunnelInterface_Protocol_Native,
	"none":   GatewayLoadBalancerTunnelInterface_Protocol_None,
	"vxlan":  GatewayLoadBalancerTunnelInterface_Protocol_VXLAN,
}
...
// Mapping from string to GatewayLoadBalancerTunnelInterface_Protocol_STATUS
var gatewayLoadBalancerTunnelInterface_Protocol_STATUS_Values = map[string]GatewayLoadBalancerTunnelInterface_Protocol_STATUS{
	"native": GatewayLoadBalancerTunnelInterface_Protocol_STATUS_Native,
	"none":   GatewayLoadBalancerTunnelInterface_Protocol_STATUS_None,
	"vxlan":  GatewayLoadBalancerTunnelInterface_Protocol_STATUS_VXLAN,
}
...
// Mapping from string to GatewayLoadBalancerTunnelInterface_Type
var gatewayLoadBalancerTunnelInterface_Type_Values = map[string]GatewayLoadBalancerTunnelInterface_Type{
	"external": GatewayLoadBalancerTunnelInterface_Type_External,
	"internal": GatewayLoadBalancerTunnelInterface_Type_Internal,
	"none":     GatewayLoadBalancerTunnelInterface_Type_None,
}
...
// Mapping from string to GatewayLoadBalancerTunnelInterface_Type_STATUS
var gatewayLoadBalancerTunnelInterface_Type_STATUS_Values = map[string]GatewayLoadBalancerTunnelInterface_Type_STATUS{
	"external": GatewayLoadBalancerTunnelInterface_Type_STATUS_External,
	"internal": GatewayLoadBalancerTunnelInterface_Type_STATUS_Internal,
	"none":     GatewayLoadBalancerTunnelInterface_Type_STATUS_None,
}
...
// Mapping from string to LoadBalancerBackendAddressPropertiesFormat_AdminState
var loadBalancerBackendAddressPropertiesFormat_AdminState_Values = map[string]LoadBalancerBackendAddressPropertiesFormat_AdminState{
	"down": LoadBalancerBackendAddressPropertiesFormat_AdminState_Down,
	"none": LoadBalancerBackendAddressPropertiesFormat_AdminState_None,
	"up":   LoadBalancerBackendAddressPropertiesFormat_AdminState_Up,
}
...
// Mapping from string to LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS
var loadBalancerBackendAddressPropertiesFormat_AdminState_STATUS_Values = map[string]LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS{
	"down": LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS_Down,
	"none": LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS_None,
	"up":   LoadBalancerBackendAddressPropertiesFormat_AdminState_STATUS_Up,
}
...
var _ genruntime.FromARMConverter = &NatRulePortMapping_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (mapping *NatRulePortMapping_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NatRulePortMapping_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (mapping *NatRulePortMapping_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NatRulePortMapping_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NatRulePortMapping_STATUS, got %T", armInput)
	}

	// Set property "BackendPort":
	if typedInput.BackendPort != nil {
		backendPort := *typedInput.BackendPort
		mapping.BackendPort = &backendPort
	}

	// Set property "FrontendPort":
	if typedInput.FrontendPort != nil {
		frontendPort := *typedInput.FrontendPort
		mapping.FrontendPort = &frontendPort
	}

	// Set property "InboundNatRuleName":
	if typedInput.InboundNatRuleName != nil {
		inboundNatRuleName := *typedInput.InboundNatRuleName
		mapping.InboundNatRuleName = &inboundNatRuleName
	}
