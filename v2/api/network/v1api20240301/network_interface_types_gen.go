...
func (networkInterface *NetworkInterface) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*NetworkInterface_STATUS); ok {
		return networkInterface.Spec.Initialize_From_NetworkInterface_STATUS(s)
	}

	return fmt.Errorf("expected Status of type NetworkInterface_STATUS but received %T instead", status)
}
...
func (networkInterface *NetworkInterface) AssignProperties_To_NetworkInterface(destination *storage.NetworkInterface) error {
	...
	// Status
	var status storage.NetworkInterface_STATUS
...
func (networkInterface *NetworkInterface_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if networkInterface.AuxiliaryMode != nil ||
		networkInterface.AuxiliarySku != nil ||
		...
		networkInterface.WorkloadType != nil {
		result.Properties = &arm.NetworkInterfacePropertiesFormat{}
	}
	if networkInterface.AuxiliaryMode != nil {
		var temp string
		temp = string(*networkInterface.AuxiliaryMode)
		auxiliaryMode := arm.NetworkInterfacePropertiesFormat_AuxiliaryMode(temp)
		result.Properties.AuxiliaryMode = &auxiliaryMode
	}
	if networkInterface.AuxiliarySku != nil {
		var temp string
		temp = string(*networkInterface.AuxiliarySku)
		auxiliarySku := arm.NetworkInterfacePropertiesFormat_AuxiliarySku(temp)
		result.Properties.AuxiliarySku = &auxiliarySku
	}
	...
	if networkInterface.WorkloadType != nil {
		workloadType := *networkInterface.WorkloadType
		result.Properties.WorkloadType = &workloadType
	}
...
func (networkInterface *NetworkInterface_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AuxiliaryMode != nil {
			...
			auxiliaryMode := NetworkInterfacePropertiesFormat_AuxiliaryMode(temp)
			networkInterface.AuxiliaryMode = &auxiliaryMode
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AuxiliarySku != nil {
			...
			auxiliarySku := NetworkInterfacePropertiesFormat_AuxiliarySku(temp)
			networkInterface.AuxiliarySku = &auxiliarySku
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.WorkloadType != nil {
			...
			networkInterface.WorkloadType = &workloadType
		}
	}
...
func (networkInterface *NetworkInterface_Spec) AssignProperties_From_NetworkInterface_Spec(source *storage.NetworkInterface_Spec) error {
	...
	if source.AuxiliaryMode != nil {
		auxiliaryMode := *source.AuxiliaryMode
		auxiliaryModeTemp := genruntime.ToEnum(auxiliaryMode, networkInterfacePropertiesFormat_AuxiliaryMode_Values)
		networkInterface.AuxiliaryMode = &auxiliaryModeTemp
	} else {
		networkInterface.AuxiliaryMode = nil
	}

	// AuxiliarySku
	if source.AuxiliarySku != nil {
		auxiliarySku := *source.AuxiliarySku
		auxiliarySkuTemp := genruntime.ToEnum(auxiliarySku, networkInterfacePropertiesFormat_AuxiliarySku_Values)
		networkInterface.AuxiliarySku = &auxiliarySkuTemp
	} else {
		networkInterface.AuxiliarySku = nil
	}
...
func (networkInterface *NetworkInterface_Spec) AssignProperties_To_NetworkInterface_Spec(destination *storage.NetworkInterface_Spec) error {
	...
	// AuxiliaryMode
	if networkInterface.AuxiliaryMode != nil {
		auxiliaryMode := string(*networkInterface.AuxiliaryMode)
	...
	// AuxiliarySku
	if networkInterface.AuxiliarySku != nil {
		auxiliarySku := string(*networkInterface.AuxiliarySku)
...
// Initialize_From_NetworkInterface_STATUS populates our NetworkInterface_Spec from the provided source NetworkInterface_STATUS
func (networkInterface *NetworkInterface_Spec) Initialize_From_NetworkInterface_STATUS(source *NetworkInterface_STATUS) error {

	// AuxiliaryMode
	if source.AuxiliaryMode != nil {
		auxiliaryMode := genruntime.ToEnum(string(*source.AuxiliaryMode), networkInterfacePropertiesFormat_AuxiliaryMode_Values)
		networkInterface.AuxiliaryMode = &auxiliaryMode
	} else {
		networkInterface.AuxiliaryMode = nil
	}
	...
	// AuxiliarySku
	if source.AuxiliarySku != nil {
		auxiliarySku := genruntime.ToEnum(string(*source.AuxiliarySku), networkInterfacePropertiesFormat_AuxiliarySku_Values)
		networkInterface.AuxiliarySku = &auxiliarySku
	} else {
		networkInterface.AuxiliarySku = nil
	}
	...
	if source.DnsSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NetworkInterfaceDnsSettings_STATUS() to populate field DnsSettings")
		}
		networkInterface.DnsSettings = &dnsSetting
	} else {
		networkInterface.DnsSettings = nil
	...
	if source.IpConfigurations != nil {
		...
		for ipConfigurationIndex, ipConfigurationItem := range source.IpConfigurations {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded() to populate field IpConfigurations")
			}
			ipConfigurationList[ipConfigurationIndex] = ipConfiguration
		}
		networkInterface.IpConfigurations = ipConfigurationList
	...
	if source.NetworkSecurityGroup != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NetworkSecurityGroup_STATUS_NetworkInterface_SubResourceEmbedded() to populate field NetworkSecurityGroup")
		}
		networkInterface.NetworkSecurityGroup = &networkSecurityGroup
	} else {
		networkInterface.NetworkSecurityGroup = nil
	...
	if source.PrivateLinkService != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_PrivateLinkService_STATUS_NetworkInterface_SubResourceEmbedded() to populate field PrivateLinkService")
		}
		networkInterface.PrivateLinkService = &privateLinkService
	} else {
		networkInterface.PrivateLinkService = nil
...
func (networkInterface *NetworkInterface_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*storage.NetworkInterface_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &storage.NetworkInterface_STATUS{}
...
func (networkInterface *NetworkInterface_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*storage.NetworkInterface_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &storage.NetworkInterface_STATUS{}
...
func (networkInterface *NetworkInterface_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NetworkInterface_STATUS{}
}
...
func (networkInterface *NetworkInterface_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NetworkInterface_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NetworkInterface_STATUS, got %T", armInput)
	}
...
func (networkInterface *NetworkInterface_STATUS) AssignProperties_From_NetworkInterface_STATUS(source *storage.NetworkInterface_STATUS) error {

	// AuxiliaryMode
	if source.AuxiliaryMode != nil {
		auxiliaryMode := *source.AuxiliaryMode
		auxiliaryModeTemp := genruntime.ToEnum(auxiliaryMode, networkInterfacePropertiesFormat_AuxiliaryMode_STATUS_Values)
		networkInterface.AuxiliaryMode = &auxiliaryModeTemp
	} else {
		networkInterface.AuxiliaryMode = nil
	}
	...
	if source.AuxiliarySku != nil {
		auxiliarySku := *source.AuxiliarySku
		auxiliarySkuTemp := genruntime.ToEnum(auxiliarySku, networkInterfacePropertiesFormat_AuxiliarySku_STATUS_Values)
		networkInterface.AuxiliarySku = &auxiliarySkuTemp
	} else {
		networkInterface.AuxiliarySku = nil
	}
	...
	if source.MigrationPhase != nil {
		...
		networkInterface.MigrationPhase = &migrationPhaseTemp
	} else {
	...
	if source.ProvisioningState != nil {
		...
		networkInterface.ProvisioningState = &provisioningStateTemp
	} else {
	...
	if source.VirtualMachine != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field VirtualMachine")
		}
		networkInterface.VirtualMachine = &virtualMachine
	} else {
...
func (networkInterface *NetworkInterface_STATUS) AssignProperties_To_NetworkInterface_STATUS(destination *storage.NetworkInterface_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// IpConfigurations
	if networkInterface.IpConfigurations != nil {
		ipConfigurationList := make([]storage.NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded, len(networkInterface.IpConfigurations))
		for ipConfigurationIndex, ipConfigurationItem := range networkInterface.IpConfigurations {
			// Shadow the loop variable to avoid aliasing
			ipConfigurationItem := ipConfigurationItem
	...
	if networkInterface.TapConfigurations != nil {
		tapConfigurationList := make([]storage.NetworkInterfaceTapConfiguration_STATUS_NetworkInterface_SubResourceEmbedded, len(networkInterface.TapConfigurations))
	...
	if networkInterface.VirtualMachine != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field VirtualMachine")
		}
...
func (embedded *NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if embedded.GatewayLoadBalancer != nil {
		...
		gatewayLoadBalancer := *gatewayLoadBalancer_ARM.(*arm.SubResource)
		result.Properties.GatewayLoadBalancer = &gatewayLoadBalancer
	}
	...
	if embedded.PrivateIPAddressPrefixLength != nil {
		...
		result.Properties.PrivateIPAddressPrefixLength = &privateIPAddressPrefixLength
	}
...
func (embedded *NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "GatewayLoadBalancer":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.GatewayLoadBalancer != nil {
			var gatewayLoadBalancer1 SubResource
			err := gatewayLoadBalancer1.PopulateFromARM(owner, *typedInput.Properties.GatewayLoadBalancer)
			if err != nil {
				return err
			}
			gatewayLoadBalancer := gatewayLoadBalancer1
	...
	// Set property "PrivateIPAddressPrefixLength":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.PrivateIPAddressPrefixLength != nil {
			privateIPAddressPrefixLength := *typedInput.Properties.PrivateIPAddressPrefixLength
...
func (embedded *NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) AssignProperties_From_NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded(source *storage.NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) error {
	...
	if source.GatewayLoadBalancer != nil {
		...
		err := gatewayLoadBalancer.AssignProperties_From_SubResource(source.GatewayLoadBalancer)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource() to populate field GatewayLoadBalancer")
		}
		embedded.GatewayLoadBalancer = &gatewayLoadBalancer
	} else {
		embedded.GatewayLoadBalancer = nil
...
func (embedded *NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) AssignProperties_To_NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded(destination *storage.NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) error {
	...
	// GatewayLoadBalancer
	if embedded.GatewayLoadBalancer != nil {
		var gatewayLoadBalancer storage.SubResource
		err := embedded.GatewayLoadBalancer.AssignProperties_To_SubResource(&gatewayLoadBalancer)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource() to populate field GatewayLoadBalancer")
		}
...
func (embedded *NetworkInterfaceIPConfiguration_NetworkInterface_SubResourceEmbedded) Initialize_From_NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded(source *NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) error {
	...
	if source.ApplicationGatewayBackendAddressPools != nil {
		...
		for applicationGatewayBackendAddressPoolIndex, applicationGatewayBackendAddressPoolItem := range source.ApplicationGatewayBackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ApplicationGatewayBackendAddressPool_STATUS_NetworkInterface_SubResourceEmbedded() to populate field ApplicationGatewayBackendAddressPools")
			}
			applicationGatewayBackendAddressPoolList[applicationGatewayBackendAddressPoolIndex] = applicationGatewayBackendAddressPool
		}
		embedded.ApplicationGatewayBackendAddressPools = applicationGatewayBackendAddressPoolList
	...
	if source.ApplicationSecurityGroups != nil {
		...
		for applicationSecurityGroupIndex, applicationSecurityGroupItem := range source.ApplicationSecurityGroups {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ApplicationSecurityGroup_STATUS_NetworkInterface_SubResourceEmbedded() to populate field ApplicationSecurityGroups")
			}
			applicationSecurityGroupList[applicationSecurityGroupIndex] = applicationSecurityGroup
		}
		embedded.ApplicationSecurityGroups = applicationSecurityGroupList
	...
	if source.GatewayLoadBalancer != nil {
		var gatewayLoadBalancer SubResource
		err := gatewayLoadBalancer.Initialize_From_SubResource_STATUS(source.GatewayLoadBalancer)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SubResource_STATUS() to populate field GatewayLoadBalancer")
		}
		embedded.GatewayLoadBalancer = &gatewayLoadBalancer
	} else {
		embedded.GatewayLoadBalancer = nil
	...
	if source.LoadBalancerBackendAddressPools != nil {
		...
		for loadBalancerBackendAddressPoolIndex, loadBalancerBackendAddressPoolItem := range source.LoadBalancerBackendAddressPools {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_BackendAddressPool_STATUS_NetworkInterface_SubResourceEmbedded() to populate field LoadBalancerBackendAddressPools")
			}
			loadBalancerBackendAddressPoolList[loadBalancerBackendAddressPoolIndex] = loadBalancerBackendAddressPool
		}
		embedded.LoadBalancerBackendAddressPools = loadBalancerBackendAddressPoolList
	...
	if source.LoadBalancerInboundNatRules != nil {
		...
		for loadBalancerInboundNatRuleIndex, loadBalancerInboundNatRuleItem := range source.LoadBalancerInboundNatRules {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_InboundNatRule_STATUS_NetworkInterface_SubResourceEmbedded() to populate field LoadBalancerInboundNatRules")
			}
			loadBalancerInboundNatRuleList[loadBalancerInboundNatRuleIndex] = loadBalancerInboundNatRule
		}
		embedded.LoadBalancerInboundNatRules = loadBalancerInboundNatRuleList
	...
	if source.PublicIPAddress != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_PublicIPAddress_STATUS_NetworkInterface_SubResourceEmbedded() to populate field PublicIPAddress")
		}
		embedded.PublicIPAddress = &publicIPAddress
	} else {
		embedded.PublicIPAddress = nil
	...
	if source.Subnet != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Subnet_STATUS_NetworkInterface_SubResourceEmbedded() to populate field Subnet")
		}
		embedded.Subnet = &subnet
	} else {
		embedded.Subnet = nil
	...
	if source.VirtualNetworkTaps != nil {
		...
		for virtualNetworkTapIndex, virtualNetworkTapItem := range source.VirtualNetworkTaps {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_VirtualNetworkTap_STATUS_NetworkInterface_SubResourceEmbedded() to populate field VirtualNetworkTaps")
			}
			virtualNetworkTapList[virtualNetworkTapIndex] = virtualNetworkTap
		}
		embedded.VirtualNetworkTaps = virtualNetworkTapList
...
func (embedded *NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.GatewayLoadBalancer != nil {
			var gatewayLoadBalancer1 SubResource_STATUS
			err := gatewayLoadBalancer1.PopulateFromARM(owner, *typedInput.Properties.GatewayLoadBalancer)
			if err != nil {
				return err
			}
...
func (embedded *NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) AssignProperties_From_NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded(source *storage.NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) error {
	...
	if source.GatewayLoadBalancer != nil {
		...
		err := gatewayLoadBalancer.AssignProperties_From_SubResource_STATUS(source.GatewayLoadBalancer)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SubResource_STATUS() to populate field GatewayLoadBalancer")
		}
		embedded.GatewayLoadBalancer = &gatewayLoadBalancer
	} else {
		embedded.GatewayLoadBalancer = nil
...
func (embedded *NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) AssignProperties_To_NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded(destination *storage.NetworkInterfaceIPConfiguration_STATUS_NetworkInterface_SubResourceEmbedded) error {
	...
	// GatewayLoadBalancer
	if embedded.GatewayLoadBalancer != nil {
		var gatewayLoadBalancer storage.SubResource_STATUS
		err := embedded.GatewayLoadBalancer.AssignProperties_To_SubResource_STATUS(&gatewayLoadBalancer)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SubResource_STATUS() to populate field GatewayLoadBalancer")
		}
		destination.GatewayLoadBalancer = &gatewayLoadBalancer
	} else {
		destination.GatewayLoadBalancer = nil
...
// Mapping from string to NetworkInterfacePropertiesFormat_AuxiliaryMode
var networkInterfacePropertiesFormat_AuxiliaryMode_Values = map[string]NetworkInterfacePropertiesFormat_AuxiliaryMode{
	"acceleratedconnections": NetworkInterfacePropertiesFormat_AuxiliaryMode_AcceleratedConnections,
	"floating":               NetworkInterfacePropertiesFormat_AuxiliaryMode_Floating,
	"maxconnections":         NetworkInterfacePropertiesFormat_AuxiliaryMode_MaxConnections,
	"none":                   NetworkInterfacePropertiesFormat_AuxiliaryMode_None,
}
...
// Mapping from string to NetworkInterfacePropertiesFormat_AuxiliarySku
var networkInterfacePropertiesFormat_AuxiliarySku_Values = map[string]NetworkInterfacePropertiesFormat_AuxiliarySku{
	"a1":   NetworkInterfacePropertiesFormat_AuxiliarySku_A1,
	"a2":   NetworkInterfacePropertiesFormat_AuxiliarySku_A2,
	"a4":   NetworkInterfacePropertiesFormat_AuxiliarySku_A4,
	"a8":   NetworkInterfacePropertiesFormat_AuxiliarySku_A8,
	"none": NetworkInterfacePropertiesFormat_AuxiliarySku_None,
}
