...
type NetworkSecurityGroupsSecurityRule_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &NetworkSecurityGroupsSecurityRule_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-11-01"
func (rule NetworkSecurityGroupsSecurityRule_Spec_ARM) GetAPIVersion() string {
	return "2020-11-01"
}

// GetName returns the Name of the resource
func (rule *NetworkSecurityGroupsSecurityRule_Spec_ARM) GetName() string {
	return rule.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/networkSecurityGroups/securityRules"
func (rule *NetworkSecurityGroupsSecurityRule_Spec_ARM) GetType() string {
