...
type RouteTablesRoute_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &RouteTablesRoute_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-11-01"
func (route RouteTablesRoute_Spec_ARM) GetAPIVersion() string {
	return "2020-11-01"
}

// GetName returns the Name of the resource
func (route *RouteTablesRoute_Spec_ARM) GetName() string {
	return route.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/routeTables/routes"
func (route *RouteTablesRoute_Spec_ARM) GetType() string {
