...
<<<<<<<< HEAD:v2/api/network/v1beta20201101/virtual_networks_subnet_statusarm_types_gen.go
type VirtualNetworksSubnet_STATUSARM struct {
========
type Subnet_STATUS_VirtualNetworksSubnet_SubResourceEmbeddedARM struct {
>>>>>>>> main:v2/api/network/v1beta20201101/subnet_status__virtual_networks_subnet__sub_resource_embedded_arm_types_gen.go
