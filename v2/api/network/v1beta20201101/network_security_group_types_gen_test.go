...
// RunPropertyAssignmentTestForApplicationSecurityGroupSpec_NetworkSecurityGroup_SubResourceEmbedded tests if a specific instance of ApplicationSecurityGroupSpec_NetworkSecurityGroup_SubResourceEmbedded can be assigned to v1beta20201101storage and back losslessly
func RunPropertyAssignmentTestForApplicationSecurityGroupSpec_NetworkSecurityGroup_SubResourceEmbedded(subject ApplicationSecurityGroupSpec_NetworkSecurityGroup_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20201101s.ApplicationSecurityGroupSpec_NetworkSecurityGroup_SubResourceEmbedded
