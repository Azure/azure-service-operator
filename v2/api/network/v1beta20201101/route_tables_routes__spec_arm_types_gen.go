...
func (routes RouteTablesRoutes_SpecARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (routes *RouteTablesRoutes_SpecARM) GetName() string {
	return routes.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/routeTables/routes"
func (routes *RouteTablesRoutes_SpecARM) GetType() string {
