...
<<<<<<<< HEAD:v2/api/network/v1beta20201101/network_security_groups_security_rule_statusarm_types_gen.go
...
>>>>>>>> main:v2/api/network/v1beta20201101/security_rule_status__network_security_groups_security_rule__sub_resource_embedded_arm_types_gen.go
