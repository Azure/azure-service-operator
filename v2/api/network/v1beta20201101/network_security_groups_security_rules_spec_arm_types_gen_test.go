...
<<<<<<<< HEAD:v2/api/network/v1beta20201101/network_security_groups_security_rule__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/network/v1beta20201101/network_security_groups_security_rules_spec_arm_types_gen_test.go
	t.Parallel()
