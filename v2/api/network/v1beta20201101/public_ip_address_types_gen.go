...
func (address *PublicIPAddress) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20201101s.PublicIPAddress
...
func (address *PublicIPAddress) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20201101s.PublicIPAddress
...
func (address *PublicIPAddress) AssignProperties_From_PublicIPAddress(source *v1beta20201101s.PublicIPAddress) error {
...
func (address *PublicIPAddress) AssignProperties_To_PublicIPAddress(destination *v1beta20201101s.PublicIPAddress) error {

	// ObjectMeta
	destination.ObjectMeta = *address.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20201101s.PublicIPAddress_Spec
	...
	// Status
	var status v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded
...
func (address *PublicIPAddress_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20201101s.PublicIPAddress_Spec)
	if ok {
	...
	src = &v1beta20201101s.PublicIPAddress_Spec{}
...
func (address *PublicIPAddress_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20201101s.PublicIPAddress_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.PublicIPAddress_Spec{}
...
func (address *PublicIPAddress_Spec) AssignProperties_From_PublicIPAddress_Spec(source *v1beta20201101s.PublicIPAddress_Spec) error {
...
func (address *PublicIPAddress_Spec) AssignProperties_To_PublicIPAddress_Spec(destination *v1beta20201101s.PublicIPAddress_Spec) error {
	...
	// DdosSettings
	if address.DdosSettings != nil {
		var ddosSetting v1beta20201101s.DdosSettings
	...
	// DnsSettings
	if address.DnsSettings != nil {
		var dnsSetting v1beta20201101s.PublicIPAddressDnsSettings
	...
	if address.IpTags != nil {
		ipTagList := make([]v1beta20201101s.IpTag, len(address.IpTags))
		for ipTagIndex, ipTagItem := range address.IpTags {
			// Shadow the loop variable to avoid aliasing
			ipTagItem := ipTagItem
			var ipTag v1beta20201101s.IpTag
	...
	// LinkedPublicIPAddress
	if address.LinkedPublicIPAddress != nil {
		var linkedPublicIPAddress v1beta20201101s.PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded
	...
	// NatGateway
	if address.NatGateway != nil {
		var natGateway v1beta20201101s.NatGatewaySpec_PublicIPAddress_SubResourceEmbedded
	...
	// ServicePublicIPAddress
	if address.ServicePublicIPAddress != nil {
		var servicePublicIPAddress v1beta20201101s.PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded
	...
	// Sku
	if address.Sku != nil {
		var sku v1beta20201101s.PublicIPAddressSku
...
func (embedded *PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded{}
...
func (embedded *PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded{}
...
func (embedded *PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_From_PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded(source *v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) error {
...
func (embedded *PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_To_PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded(destination *v1beta20201101s.PublicIPAddress_STATUS_PublicIPAddress_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if embedded.DdosSettings != nil {
		var ddosSetting v1beta20201101s.DdosSettings_STATUS
	...
	if embedded.DnsSettings != nil {
		var dnsSetting v1beta20201101s.PublicIPAddressDnsSettings_STATUS
	...
	if embedded.IpConfiguration != nil {
		var ipConfiguration v1beta20201101s.IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded
	...
	if embedded.IpTags != nil {
		ipTagList := make([]v1beta20201101s.IpTag_STATUS, len(embedded.IpTags))
		for ipTagIndex, ipTagItem := range embedded.IpTags {
			// Shadow the loop variable to avoid aliasing
			ipTagItem := ipTagItem
			var ipTag v1beta20201101s.IpTag_STATUS
	...
	if embedded.NatGateway != nil {
		var natGateway v1beta20201101s.NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded
	...
	// Sku
	if embedded.Sku != nil {
		var sku v1beta20201101s.PublicIPAddressSku_STATUS
...
func (settings *DdosSettings) AssignProperties_From_DdosSettings(source *v1beta20201101s.DdosSettings) error {
...
func (settings *DdosSettings) AssignProperties_To_DdosSettings(destination *v1beta20201101s.DdosSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DdosCustomPolicy
	if settings.DdosCustomPolicy != nil {
		var ddosCustomPolicy v1beta20201101s.SubResource
...
func (settings *DdosSettings_STATUS) AssignProperties_From_DdosSettings_STATUS(source *v1beta20201101s.DdosSettings_STATUS) error {
...
func (settings *DdosSettings_STATUS) AssignProperties_To_DdosSettings_STATUS(destination *v1beta20201101s.DdosSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// DdosCustomPolicy
	if settings.DdosCustomPolicy != nil {
		var ddosCustomPolicy v1beta20201101s.SubResource_STATUS
...
// Deprecated version of IPAllocationMethod. Use v1api20201101.IPAllocationMethod instead
...
func (embedded *IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_From_IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded(source *v1beta20201101s.IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded) error {
...
func (embedded *IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_To_IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded(destination *v1beta20201101s.IPConfiguration_STATUS_PublicIPAddress_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (ipTag *IpTag) AssignProperties_From_IpTag(source *v1beta20201101s.IpTag) error {
...
func (ipTag *IpTag) AssignProperties_To_IpTag(destination *v1beta20201101s.IpTag) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (ipTag *IpTag_STATUS) AssignProperties_From_IpTag_STATUS(source *v1beta20201101s.IpTag_STATUS) error {
...
func (ipTag *IpTag_STATUS) AssignProperties_To_IpTag_STATUS(destination *v1beta20201101s.IpTag_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Deprecated version of IPVersion. Use v1api20201101.IPVersion instead
...
func (embedded *NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_From_NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded(source *v1beta20201101s.NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded) error {
...
func (embedded *NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded) AssignProperties_To_NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded(destination *v1beta20201101s.NatGateway_STATUS_PublicIPAddress_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *NatGatewaySpec_PublicIPAddress_SubResourceEmbedded) AssignProperties_From_NatGatewaySpec_PublicIPAddress_SubResourceEmbedded(source *v1beta20201101s.NatGatewaySpec_PublicIPAddress_SubResourceEmbedded) error {
...
func (embedded *NatGatewaySpec_PublicIPAddress_SubResourceEmbedded) AssignProperties_To_NatGatewaySpec_PublicIPAddress_SubResourceEmbedded(destination *v1beta20201101s.NatGatewaySpec_PublicIPAddress_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (settings *PublicIPAddressDnsSettings) AssignProperties_From_PublicIPAddressDnsSettings(source *v1beta20201101s.PublicIPAddressDnsSettings) error {
...
func (settings *PublicIPAddressDnsSettings) AssignProperties_To_PublicIPAddressDnsSettings(destination *v1beta20201101s.PublicIPAddressDnsSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (settings *PublicIPAddressDnsSettings_STATUS) AssignProperties_From_PublicIPAddressDnsSettings_STATUS(source *v1beta20201101s.PublicIPAddressDnsSettings_STATUS) error {
...
func (settings *PublicIPAddressDnsSettings_STATUS) AssignProperties_To_PublicIPAddressDnsSettings_STATUS(destination *v1beta20201101s.PublicIPAddressDnsSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// v1api20201101.PublicIPAddressPropertiesFormat_MigrationPhase_STATUS instead
...
func (addressSku *PublicIPAddressSku) AssignProperties_From_PublicIPAddressSku(source *v1beta20201101s.PublicIPAddressSku) error {
...
func (addressSku *PublicIPAddressSku) AssignProperties_To_PublicIPAddressSku(destination *v1beta20201101s.PublicIPAddressSku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (addressSku *PublicIPAddressSku_STATUS) AssignProperties_From_PublicIPAddressSku_STATUS(source *v1beta20201101s.PublicIPAddressSku_STATUS) error {
...
func (addressSku *PublicIPAddressSku_STATUS) AssignProperties_To_PublicIPAddressSku_STATUS(destination *v1beta20201101s.PublicIPAddressSku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded) AssignProperties_From_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded(source *v1beta20201101s.PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded) error {
...
func (embedded *PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded) AssignProperties_To_PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded(destination *v1beta20201101s.PublicIPAddressSpec_PublicIPAddress_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (resource *SubResource) AssignProperties_From_SubResource(source *v1beta20201101s.SubResource) error {
...
func (resource *SubResource) AssignProperties_To_SubResource(destination *v1beta20201101s.SubResource) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Deprecated version of DdosSettings_ProtectionCoverage. Use v1api20201101.DdosSettings_ProtectionCoverage instead
...
// Deprecated version of DdosSettings_ProtectionCoverage_STATUS. Use v1api20201101.DdosSettings_ProtectionCoverage_STATUS
// instead
