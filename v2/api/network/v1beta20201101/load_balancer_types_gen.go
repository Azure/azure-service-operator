...
func (balancer *LoadBalancer) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20201101s.LoadBalancer
...
func (balancer *LoadBalancer) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20201101s.LoadBalancer
...
func (balancer *LoadBalancer) AssignProperties_From_LoadBalancer(source *v1beta20201101s.LoadBalancer) error {
...
func (balancer *LoadBalancer) AssignProperties_To_LoadBalancer(destination *v1beta20201101s.LoadBalancer) error {

	// ObjectMeta
	destination.ObjectMeta = *balancer.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20201101s.LoadBalancer_Spec
	...
	// Status
	var status v1beta20201101s.LoadBalancer_STATUS
...
func (balancer *LoadBalancer_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20201101s.LoadBalancer_Spec)
	if ok {
	...
	src = &v1beta20201101s.LoadBalancer_Spec{}
...
func (balancer *LoadBalancer_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20201101s.LoadBalancer_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.LoadBalancer_Spec{}
...
func (balancer *LoadBalancer_Spec) AssignProperties_From_LoadBalancer_Spec(source *v1beta20201101s.LoadBalancer_Spec) error {
...
func (balancer *LoadBalancer_Spec) AssignProperties_To_LoadBalancer_Spec(destination *v1beta20201101s.LoadBalancer_Spec) error {
	...
	// BackendAddressPools
	if balancer.BackendAddressPools != nil {
		backendAddressPoolList := make([]v1beta20201101s.BackendAddressPool_LoadBalancer_SubResourceEmbedded, len(balancer.BackendAddressPools))
		for backendAddressPoolIndex, backendAddressPoolItem := range balancer.BackendAddressPools {
			// Shadow the loop variable to avoid aliasing
			backendAddressPoolItem := backendAddressPoolItem
			var backendAddressPool v1beta20201101s.BackendAddressPool_LoadBalancer_SubResourceEmbedded
	...
	// ExtendedLocation
	if balancer.ExtendedLocation != nil {
		var extendedLocation v1beta20201101s.ExtendedLocation
	...
	if balancer.FrontendIPConfigurations != nil {
		frontendIPConfigurationList := make([]v1beta20201101s.FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded, len(balancer.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range balancer.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration v1beta20201101s.FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded
	...
	if balancer.InboundNatPools != nil {
		inboundNatPoolList := make([]v1beta20201101s.InboundNatPool, len(balancer.InboundNatPools))
		for inboundNatPoolIndex, inboundNatPoolItem := range balancer.InboundNatPools {
			// Shadow the loop variable to avoid aliasing
			inboundNatPoolItem := inboundNatPoolItem
			var inboundNatPool v1beta20201101s.InboundNatPool
	...
	if balancer.InboundNatRules != nil {
		inboundNatRuleList := make([]v1beta20201101s.InboundNatRule_LoadBalancer_SubResourceEmbedded, len(balancer.InboundNatRules))
		for inboundNatRuleIndex, inboundNatRuleItem := range balancer.InboundNatRules {
			// Shadow the loop variable to avoid aliasing
			inboundNatRuleItem := inboundNatRuleItem
			var inboundNatRule v1beta20201101s.InboundNatRule_LoadBalancer_SubResourceEmbedded
	...
	if balancer.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]v1beta20201101s.LoadBalancingRule, len(balancer.LoadBalancingRules))
		for loadBalancingRuleIndex, loadBalancingRuleItem := range balancer.LoadBalancingRules {
			// Shadow the loop variable to avoid aliasing
			loadBalancingRuleItem := loadBalancingRuleItem
			var loadBalancingRule v1beta20201101s.LoadBalancingRule
	...
	if balancer.OutboundRules != nil {
		outboundRuleList := make([]v1beta20201101s.OutboundRule, len(balancer.OutboundRules))
		for outboundRuleIndex, outboundRuleItem := range balancer.OutboundRules {
			// Shadow the loop variable to avoid aliasing
			outboundRuleItem := outboundRuleItem
			var outboundRule v1beta20201101s.OutboundRule
	...
	if balancer.Probes != nil {
		probeList := make([]v1beta20201101s.Probe, len(balancer.Probes))
		for probeIndex, probeItem := range balancer.Probes {
			// Shadow the loop variable to avoid aliasing
			probeItem := probeItem
			var probe v1beta20201101s.Probe
	...
	// Sku
	if balancer.Sku != nil {
		var sku v1beta20201101s.LoadBalancerSku
...
func (balancer *LoadBalancer_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20201101s.LoadBalancer_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20201101s.LoadBalancer_STATUS{}
...
func (balancer *LoadBalancer_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20201101s.LoadBalancer_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.LoadBalancer_STATUS{}
...
func (balancer *LoadBalancer_STATUS) AssignProperties_From_LoadBalancer_STATUS(source *v1beta20201101s.LoadBalancer_STATUS) error {
...
func (balancer *LoadBalancer_STATUS) AssignProperties_To_LoadBalancer_STATUS(destination *v1beta20201101s.LoadBalancer_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackendAddressPools
	if balancer.BackendAddressPools != nil {
		backendAddressPoolList := make([]v1beta20201101s.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded, len(balancer.BackendAddressPools))
		for backendAddressPoolIndex, backendAddressPoolItem := range balancer.BackendAddressPools {
			// Shadow the loop variable to avoid aliasing
			backendAddressPoolItem := backendAddressPoolItem
			var backendAddressPool v1beta20201101s.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded
	...
	// ExtendedLocation
	if balancer.ExtendedLocation != nil {
		var extendedLocation v1beta20201101s.ExtendedLocation_STATUS
	...
	// FrontendIPConfigurations
	if balancer.FrontendIPConfigurations != nil {
		frontendIPConfigurationList := make([]v1beta20201101s.FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded, len(balancer.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range balancer.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration v1beta20201101s.FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded
	...
	// InboundNatPools
	if balancer.InboundNatPools != nil {
		inboundNatPoolList := make([]v1beta20201101s.InboundNatPool_STATUS, len(balancer.InboundNatPools))
		for inboundNatPoolIndex, inboundNatPoolItem := range balancer.InboundNatPools {
			// Shadow the loop variable to avoid aliasing
			inboundNatPoolItem := inboundNatPoolItem
			var inboundNatPool v1beta20201101s.InboundNatPool_STATUS
	...
	// InboundNatRules
	if balancer.InboundNatRules != nil {
		inboundNatRuleList := make([]v1beta20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded, len(balancer.InboundNatRules))
		for inboundNatRuleIndex, inboundNatRuleItem := range balancer.InboundNatRules {
			// Shadow the loop variable to avoid aliasing
			inboundNatRuleItem := inboundNatRuleItem
			var inboundNatRule v1beta20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded
	...
	// LoadBalancingRules
	if balancer.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]v1beta20201101s.LoadBalancingRule_STATUS, len(balancer.LoadBalancingRules))
		for loadBalancingRuleIndex, loadBalancingRuleItem := range balancer.LoadBalancingRules {
			// Shadow the loop variable to avoid aliasing
			loadBalancingRuleItem := loadBalancingRuleItem
			var loadBalancingRule v1beta20201101s.LoadBalancingRule_STATUS
	...
	// OutboundRules
	if balancer.OutboundRules != nil {
		outboundRuleList := make([]v1beta20201101s.OutboundRule_STATUS, len(balancer.OutboundRules))
		for outboundRuleIndex, outboundRuleItem := range balancer.OutboundRules {
			// Shadow the loop variable to avoid aliasing
			outboundRuleItem := outboundRuleItem
			var outboundRule v1beta20201101s.OutboundRule_STATUS
	...
	// Probes
	if balancer.Probes != nil {
		probeList := make([]v1beta20201101s.Probe_STATUS, len(balancer.Probes))
		for probeIndex, probeItem := range balancer.Probes {
			// Shadow the loop variable to avoid aliasing
			probeItem := probeItem
			var probe v1beta20201101s.Probe_STATUS
	...
	// Sku
	if balancer.Sku != nil {
		var sku v1beta20201101s.LoadBalancerSku_STATUS
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) AssignProperties_From_BackendAddressPool_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.BackendAddressPool_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *BackendAddressPool_LoadBalancer_SubResourceEmbedded) AssignProperties_To_BackendAddressPool_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.BackendAddressPool_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// LoadBalancerBackendAddresses
	if embedded.LoadBalancerBackendAddresses != nil {
		loadBalancerBackendAddressList := make([]v1beta20201101s.LoadBalancerBackendAddress, len(embedded.LoadBalancerBackendAddresses))
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range embedded.LoadBalancerBackendAddresses {
			// Shadow the loop variable to avoid aliasing
			loadBalancerBackendAddressItem := loadBalancerBackendAddressItem
			var loadBalancerBackendAddress v1beta20201101s.LoadBalancerBackendAddress
...
func (embedded *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.BackendAddressPool_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackendIPConfigurations
	if embedded.BackendIPConfigurations != nil {
		backendIPConfigurationList := make([]v1beta20201101s.NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded, len(embedded.BackendIPConfigurations))
		for backendIPConfigurationIndex, backendIPConfigurationItem := range embedded.BackendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			backendIPConfigurationItem := backendIPConfigurationItem
			var backendIPConfiguration v1beta20201101s.NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded
	...
	// LoadBalancerBackendAddresses
	if embedded.LoadBalancerBackendAddresses != nil {
		loadBalancerBackendAddressList := make([]v1beta20201101s.LoadBalancerBackendAddress_STATUS, len(embedded.LoadBalancerBackendAddresses))
		for loadBalancerBackendAddressIndex, loadBalancerBackendAddressItem := range embedded.LoadBalancerBackendAddresses {
			// Shadow the loop variable to avoid aliasing
			loadBalancerBackendAddressItem := loadBalancerBackendAddressItem
			var loadBalancerBackendAddress v1beta20201101s.LoadBalancerBackendAddress_STATUS
	...
	if embedded.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]v1beta20201101s.SubResource_STATUS, len(embedded.LoadBalancingRules))
		for loadBalancingRuleIndex, loadBalancingRuleItem := range embedded.LoadBalancingRules {
			// Shadow the loop variable to avoid aliasing
			loadBalancingRuleItem := loadBalancingRuleItem
			var loadBalancingRule v1beta20201101s.SubResource_STATUS
	...
	if embedded.OutboundRule != nil {
		var outboundRule v1beta20201101s.SubResource_STATUS
	...
	if embedded.OutboundRules != nil {
		outboundRuleList := make([]v1beta20201101s.SubResource_STATUS, len(embedded.OutboundRules))
...
func (location *ExtendedLocation) AssignProperties_From_ExtendedLocation(source *v1beta20201101s.ExtendedLocation) error {
...
func (location *ExtendedLocation) AssignProperties_To_ExtendedLocation(destination *v1beta20201101s.ExtendedLocation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (location *ExtendedLocation_STATUS) AssignProperties_From_ExtendedLocation_STATUS(source *v1beta20201101s.ExtendedLocation_STATUS) error {
...
func (location *ExtendedLocation_STATUS) AssignProperties_To_ExtendedLocation_STATUS(destination *v1beta20201101s.ExtendedLocation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) AssignProperties_From_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) AssignProperties_To_FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.FrontendIPConfiguration_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// PublicIPAddress
	if embedded.PublicIPAddress != nil {
		var publicIPAddress v1beta20201101s.PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded
	...
	// PublicIPPrefix
	if embedded.PublicIPPrefix != nil {
		var publicIPPrefix v1beta20201101s.SubResource
	...
	// Subnet
	if embedded.Subnet != nil {
		var subnet v1beta20201101s.Subnet_LoadBalancer_SubResourceEmbedded
...
func (embedded *FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.FrontendIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if embedded.InboundNatPools != nil {
		inboundNatPoolList := make([]v1beta20201101s.SubResource_STATUS, len(embedded.InboundNatPools))
		for inboundNatPoolIndex, inboundNatPoolItem := range embedded.InboundNatPools {
			// Shadow the loop variable to avoid aliasing
			inboundNatPoolItem := inboundNatPoolItem
			var inboundNatPool v1beta20201101s.SubResource_STATUS
	...
	if embedded.InboundNatRules != nil {
		inboundNatRuleList := make([]v1beta20201101s.SubResource_STATUS, len(embedded.InboundNatRules))
		for inboundNatRuleIndex, inboundNatRuleItem := range embedded.InboundNatRules {
			// Shadow the loop variable to avoid aliasing
			inboundNatRuleItem := inboundNatRuleItem
			var inboundNatRule v1beta20201101s.SubResource_STATUS
	...
	// PublicIPAddress
	if embedded.PublicIPAddress != nil {
		var publicIPAddress v1beta20201101s.PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded
	...
	// PublicIPPrefix
	if embedded.PublicIPPrefix != nil {
		var publicIPPrefix v1beta20201101s.SubResource_STATUS
	...
	// Subnet
	if embedded.Subnet != nil {
		var subnet v1beta20201101s.Subnet_STATUS_LoadBalancer_SubResourceEmbedded
...
func (pool *InboundNatPool) AssignProperties_From_InboundNatPool(source *v1beta20201101s.InboundNatPool) error {
...
func (pool *InboundNatPool) AssignProperties_To_InboundNatPool(destination *v1beta20201101s.InboundNatPool) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// FrontendIPConfiguration
	if pool.FrontendIPConfiguration != nil {
		var frontendIPConfiguration v1beta20201101s.SubResource
...
func (pool *InboundNatPool_STATUS) AssignProperties_From_InboundNatPool_STATUS(source *v1beta20201101s.InboundNatPool_STATUS) error {
...
func (pool *InboundNatPool_STATUS) AssignProperties_To_InboundNatPool_STATUS(destination *v1beta20201101s.InboundNatPool_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// FrontendIPConfiguration
	if pool.FrontendIPConfiguration != nil {
		var frontendIPConfiguration v1beta20201101s.SubResource_STATUS
...
func (embedded *InboundNatRule_LoadBalancer_SubResourceEmbedded) AssignProperties_From_InboundNatRule_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.InboundNatRule_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *InboundNatRule_LoadBalancer_SubResourceEmbedded) AssignProperties_To_InboundNatRule_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.InboundNatRule_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.InboundNatRule_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (balancerSku *LoadBalancerSku) AssignProperties_From_LoadBalancerSku(source *v1beta20201101s.LoadBalancerSku) error {
...
func (balancerSku *LoadBalancerSku) AssignProperties_To_LoadBalancerSku(destination *v1beta20201101s.LoadBalancerSku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (balancerSku *LoadBalancerSku_STATUS) AssignProperties_From_LoadBalancerSku_STATUS(source *v1beta20201101s.LoadBalancerSku_STATUS) error {
...
func (balancerSku *LoadBalancerSku_STATUS) AssignProperties_To_LoadBalancerSku_STATUS(destination *v1beta20201101s.LoadBalancerSku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *LoadBalancingRule) AssignProperties_From_LoadBalancingRule(source *v1beta20201101s.LoadBalancingRule) error {
...
func (rule *LoadBalancingRule) AssignProperties_To_LoadBalancingRule(destination *v1beta20201101s.LoadBalancingRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackendAddressPool
	if rule.BackendAddressPool != nil {
		var backendAddressPool v1beta20201101s.SubResource
	...
	// Probe
	if rule.Probe != nil {
		var probe v1beta20201101s.SubResource
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_From_LoadBalancingRule_STATUS(source *v1beta20201101s.LoadBalancingRule_STATUS) error {
...
func (rule *LoadBalancingRule_STATUS) AssignProperties_To_LoadBalancingRule_STATUS(destination *v1beta20201101s.LoadBalancingRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BackendAddressPool
	if rule.BackendAddressPool != nil {
		var backendAddressPool v1beta20201101s.SubResource_STATUS
	...
	// Probe
	if rule.Probe != nil {
		var probe v1beta20201101s.SubResource_STATUS
...
func (rule *OutboundRule) AssignProperties_From_OutboundRule(source *v1beta20201101s.OutboundRule) error {
...
func (rule *OutboundRule) AssignProperties_To_OutboundRule(destination *v1beta20201101s.OutboundRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if rule.FrontendIPConfigurations != nil {
		frontendIPConfigurationList := make([]v1beta20201101s.SubResource, len(rule.FrontendIPConfigurations))
...
func (rule *OutboundRule_STATUS) AssignProperties_From_OutboundRule_STATUS(source *v1beta20201101s.OutboundRule_STATUS) error {
...
func (rule *OutboundRule_STATUS) AssignProperties_To_OutboundRule_STATUS(destination *v1beta20201101s.OutboundRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// FrontendIPConfigurations
	if rule.FrontendIPConfigurations != nil {
		frontendIPConfigurationList := make([]v1beta20201101s.SubResource_STATUS, len(rule.FrontendIPConfigurations))
		for frontendIPConfigurationIndex, frontendIPConfigurationItem := range rule.FrontendIPConfigurations {
			// Shadow the loop variable to avoid aliasing
			frontendIPConfigurationItem := frontendIPConfigurationItem
			var frontendIPConfiguration v1beta20201101s.SubResource_STATUS
...
func (probe *Probe) AssignProperties_From_Probe(source *v1beta20201101s.Probe) error {
...
func (probe *Probe) AssignProperties_To_Probe(destination *v1beta20201101s.Probe) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (probe *Probe_STATUS) AssignProperties_From_Probe_STATUS(source *v1beta20201101s.Probe_STATUS) error {
...
func (probe *Probe_STATUS) AssignProperties_To_Probe_STATUS(destination *v1beta20201101s.Probe_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if probe.LoadBalancingRules != nil {
		loadBalancingRuleList := make([]v1beta20201101s.SubResource_STATUS, len(probe.LoadBalancingRules))
...
func (address *LoadBalancerBackendAddress) AssignProperties_From_LoadBalancerBackendAddress(source *v1beta20201101s.LoadBalancerBackendAddress) error {
...
func (address *LoadBalancerBackendAddress) AssignProperties_To_LoadBalancerBackendAddress(destination *v1beta20201101s.LoadBalancerBackendAddress) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// LoadBalancerFrontendIPConfiguration
	if address.LoadBalancerFrontendIPConfiguration != nil {
		var loadBalancerFrontendIPConfiguration v1beta20201101s.SubResource
	...
	// Subnet
	if address.Subnet != nil {
		var subnet v1beta20201101s.SubResource
	...
	// VirtualNetwork
	if address.VirtualNetwork != nil {
		var virtualNetwork v1beta20201101s.SubResource
...
func (address *LoadBalancerBackendAddress_STATUS) AssignProperties_From_LoadBalancerBackendAddress_STATUS(source *v1beta20201101s.LoadBalancerBackendAddress_STATUS) error {
...
func (address *LoadBalancerBackendAddress_STATUS) AssignProperties_To_LoadBalancerBackendAddress_STATUS(destination *v1beta20201101s.LoadBalancerBackendAddress_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// LoadBalancerFrontendIPConfiguration
	if address.LoadBalancerFrontendIPConfiguration != nil {
		var loadBalancerFrontendIPConfiguration v1beta20201101s.SubResource_STATUS
	...
	if address.NetworkInterfaceIPConfiguration != nil {
		var networkInterfaceIPConfiguration v1beta20201101s.SubResource_STATUS
	...
	// Subnet
	if address.Subnet != nil {
		var subnet v1beta20201101s.SubResource_STATUS
	...
	// VirtualNetwork
	if address.VirtualNetwork != nil {
		var virtualNetwork v1beta20201101s.SubResource_STATUS
...
func (embedded *NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.NetworkInterfaceIPConfiguration_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.PublicIPAddress_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded) AssignProperties_From_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded) AssignProperties_To_PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.PublicIPAddressSpec_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *Subnet_LoadBalancer_SubResourceEmbedded) AssignProperties_From_Subnet_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.Subnet_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *Subnet_LoadBalancer_SubResourceEmbedded) AssignProperties_To_Subnet_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.Subnet_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *Subnet_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_From_Subnet_STATUS_LoadBalancer_SubResourceEmbedded(source *v1beta20201101s.Subnet_STATUS_LoadBalancer_SubResourceEmbedded) error {
...
func (embedded *Subnet_STATUS_LoadBalancer_SubResourceEmbedded) AssignProperties_To_Subnet_STATUS_LoadBalancer_SubResourceEmbedded(destination *v1beta20201101s.Subnet_STATUS_LoadBalancer_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
