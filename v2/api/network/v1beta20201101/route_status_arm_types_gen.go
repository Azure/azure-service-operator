...
<<<<<<<< HEAD:v2/api/network/v1beta20201101/route_tables_route_statusarm_types_gen.go
type RouteTablesRoute_STATUSARM struct {
========
type Route_STATUSARM struct {
>>>>>>>> main:v2/api/network/v1beta20201101/route_status_arm_types_gen.go
