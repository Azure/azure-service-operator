...
func (group *NetworkSecurityGroup) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20201101s.NetworkSecurityGroup
...
func (group *NetworkSecurityGroup) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20201101s.NetworkSecurityGroup
...
// +kubebuilder:webhook:path=/validate-network-azure-com-v1beta20201101-networksecuritygroup,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=network.azure.com,resources=networksecuritygroups,verbs=create;update,versions=v1beta20201101,name=validate.v1beta20201101.networksecuritygroups.network.azure.com,admissionReviewVersions=v1
...
func (group *NetworkSecurityGroup) AssignProperties_From_NetworkSecurityGroup(source *v1beta20201101s.NetworkSecurityGroup) error {
...
func (group *NetworkSecurityGroup) AssignProperties_To_NetworkSecurityGroup(destination *v1beta20201101s.NetworkSecurityGroup) error {

	// ObjectMeta
	destination.ObjectMeta = *group.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20201101s.NetworkSecurityGroup_Spec
	...
	// Status
	var status v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded
...
func (group *NetworkSecurityGroup_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20201101s.NetworkSecurityGroup_Spec)
	if ok {
	...
	src = &v1beta20201101s.NetworkSecurityGroup_Spec{}
...
func (group *NetworkSecurityGroup_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20201101s.NetworkSecurityGroup_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.NetworkSecurityGroup_Spec{}
...
func (group *NetworkSecurityGroup_Spec) AssignProperties_From_NetworkSecurityGroup_Spec(source *v1beta20201101s.NetworkSecurityGroup_Spec) error {
...
func (group *NetworkSecurityGroup_Spec) AssignProperties_To_NetworkSecurityGroup_Spec(destination *v1beta20201101s.NetworkSecurityGroup_Spec) error {
...
func (embedded *NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded{}
...
func (embedded *NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded{}
...
func (embedded *NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_From_NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded(source *v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
...
func (embedded *NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_To_NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded(destination *v1beta20201101s.NetworkSecurityGroup_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if embedded.DefaultSecurityRules != nil {
		defaultSecurityRuleList := make([]v1beta20201101s.SecurityRule_STATUS, len(embedded.DefaultSecurityRules))
		for defaultSecurityRuleIndex, defaultSecurityRuleItem := range embedded.DefaultSecurityRules {
			// Shadow the loop variable to avoid aliasing
			defaultSecurityRuleItem := defaultSecurityRuleItem
			var defaultSecurityRule v1beta20201101s.SecurityRule_STATUS
	...
	if embedded.FlowLogs != nil {
		flowLogList := make([]v1beta20201101s.FlowLog_STATUS, len(embedded.FlowLogs))
		for flowLogIndex, flowLogItem := range embedded.FlowLogs {
			// Shadow the loop variable to avoid aliasing
			flowLogItem := flowLogItem
			var flowLog v1beta20201101s.FlowLog_STATUS
	...
	if embedded.NetworkInterfaces != nil {
		networkInterfaceList := make([]v1beta20201101s.NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded, len(embedded.NetworkInterfaces))
		for networkInterfaceIndex, networkInterfaceItem := range embedded.NetworkInterfaces {
			// Shadow the loop variable to avoid aliasing
			networkInterfaceItem := networkInterfaceItem
			var networkInterface v1beta20201101s.NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded
	...
	if embedded.Subnets != nil {
		subnetList := make([]v1beta20201101s.Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded, len(embedded.Subnets))
		for subnetIndex, subnetItem := range embedded.Subnets {
			// Shadow the loop variable to avoid aliasing
			subnetItem := subnetItem
			var subnet v1beta20201101s.Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded
...
func (flowLog *FlowLog_STATUS) AssignProperties_From_FlowLog_STATUS(source *v1beta20201101s.FlowLog_STATUS) error {
...
func (flowLog *FlowLog_STATUS) AssignProperties_To_FlowLog_STATUS(destination *v1beta20201101s.FlowLog_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_From_NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded(source *v1beta20201101s.NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
...
func (embedded *NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_To_NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded(destination *v1beta20201101s.NetworkInterface_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (rule *SecurityRule_STATUS) AssignProperties_From_SecurityRule_STATUS(source *v1beta20201101s.SecurityRule_STATUS) error {
...
func (rule *SecurityRule_STATUS) AssignProperties_To_SecurityRule_STATUS(destination *v1beta20201101s.SecurityRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (embedded *Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_From_Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded(source *v1beta20201101s.Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
...
func (embedded *Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded) AssignProperties_To_Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded(destination *v1beta20201101s.Subnet_STATUS_NetworkSecurityGroup_SubResourceEmbedded) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
