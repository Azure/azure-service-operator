...
type PrivateDnsZonesVirtualNetworkLink_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &PrivateDnsZonesVirtualNetworkLink_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2020-06-01"
func (link PrivateDnsZonesVirtualNetworkLink_Spec_ARM) GetAPIVersion() string {
	return "2020-06-01"
}

// GetName returns the Name of the resource
func (link *PrivateDnsZonesVirtualNetworkLink_Spec_ARM) GetName() string {
	return link.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/privateDnsZones/virtualNetworkLinks"
func (link *PrivateDnsZonesVirtualNetworkLink_Spec_ARM) GetType() string {
