...
func (record *PrivateDnsZonesTXTRecord) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected network/v1api20240601/storage/PrivateDnsZonesTXTRecord but received %T instead", hub)
	}
...
func (record *PrivateDnsZonesTXTRecord) AssignProperties_From_PrivateDnsZonesTXTRecord(source *storage.PrivateDnsZonesTXTRecord) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesTXTRecord interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesTXTRecord); ok {
...
type augmentConversionForPrivateDnsZonesTXTRecord interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesTXTRecord) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesTXTRecord) error
}
...
func (record *PrivateDnsZonesTXTRecord_Spec) AssignProperties_From_PrivateDnsZonesTXTRecord_Spec(source *storage.PrivateDnsZonesTXTRecord_Spec) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesTXTRecord_Spec interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesTXTRecord_Spec); ok {
		err := augmentedRecord.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
func (record *PrivateDnsZonesTXTRecord_STATUS) AssignProperties_From_PrivateDnsZonesTXTRecord_STATUS(source *storage.PrivateDnsZonesTXTRecord_STATUS) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesTXTRecord_STATUS interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesTXTRecord_STATUS); ok {
		err := augmentedRecord.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForPrivateDnsZonesTXTRecord_Spec interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesTXTRecord_Spec) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesTXTRecord_Spec) error
}

type augmentConversionForPrivateDnsZonesTXTRecord_STATUS interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesTXTRecord_STATUS) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesTXTRecord_STATUS) error
}

// Storage version of v1api20200601.PrivateDnsZonesTXTRecordOperatorSpec
...
func (operator *PrivateDnsZonesTXTRecordOperatorSpec) AssignProperties_From_PrivateDnsZonesTXTRecordOperatorSpec(source *storage.PrivateDnsZonesTXTRecordOperatorSpec) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesTXTRecordOperatorSpec interface (if implemented) to customize the conversion
	var operatorAsAny any = operator
	if augmentedOperator, ok := operatorAsAny.(augmentConversionForPrivateDnsZonesTXTRecordOperatorSpec); ok {
...
type augmentConversionForPrivateDnsZonesTXTRecordOperatorSpec interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesTXTRecordOperatorSpec) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesTXTRecordOperatorSpec) error
}
