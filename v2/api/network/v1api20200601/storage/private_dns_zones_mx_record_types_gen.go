...
func (record *PrivateDnsZonesMXRecord) AssignProperties_From_PrivateDnsZonesMXRecord(source *storage.PrivateDnsZonesMXRecord) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesMXRecord interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesMXRecord); ok {
...
type augmentConversionForPrivateDnsZonesMXRecord interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesMXRecord) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesMXRecord) error
}
...
func (record *PrivateDnsZonesMXRecord_Spec) AssignProperties_From_PrivateDnsZonesMXRecord_Spec(source *storage.PrivateDnsZonesMXRecord_Spec) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesMXRecord_Spec interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesMXRecord_Spec); ok {
		err := augmentedRecord.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
func (record *PrivateDnsZonesMXRecord_STATUS) AssignProperties_From_PrivateDnsZonesMXRecord_STATUS(source *storage.PrivateDnsZonesMXRecord_STATUS) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesMXRecord_STATUS interface (if implemented) to customize the conversion
	var recordAsAny any = record
	if augmentedRecord, ok := recordAsAny.(augmentConversionForPrivateDnsZonesMXRecord_STATUS); ok {
		err := augmentedRecord.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForPrivateDnsZonesMXRecord_Spec interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesMXRecord_Spec) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesMXRecord_Spec) error
}

type augmentConversionForPrivateDnsZonesMXRecord_STATUS interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesMXRecord_STATUS) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesMXRecord_STATUS) error
}
...
func (operator *PrivateDnsZonesMXRecordOperatorSpec) AssignProperties_From_PrivateDnsZonesMXRecordOperatorSpec(source *storage.PrivateDnsZonesMXRecordOperatorSpec) error {
	...
	// Invoke the augmentConversionForPrivateDnsZonesMXRecordOperatorSpec interface (if implemented) to customize the conversion
	var operatorAsAny any = operator
	if augmentedOperator, ok := operatorAsAny.(augmentConversionForPrivateDnsZonesMXRecordOperatorSpec); ok {
...
type augmentConversionForPrivateDnsZonesMXRecordOperatorSpec interface {
	AssignPropertiesFrom(src *storage.PrivateDnsZonesMXRecordOperatorSpec) error
	AssignPropertiesTo(dst *storage.PrivateDnsZonesMXRecordOperatorSpec) error
}
