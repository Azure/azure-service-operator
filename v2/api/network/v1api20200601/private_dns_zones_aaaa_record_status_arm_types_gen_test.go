...
func Test_PrivateDnsZonesAAAARecord_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of PrivateDnsZonesAAAARecord_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPrivateDnsZonesAAAARecord_STATUS_ARM, PrivateDnsZonesAAAARecord_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPrivateDnsZonesAAAARecord_STATUS_ARM runs a test to see if a specific instance of PrivateDnsZonesAAAARecord_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForPrivateDnsZonesAAAARecord_STATUS_ARM(subject PrivateDnsZonesAAAARecord_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual PrivateDnsZonesAAAARecord_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of PrivateDnsZonesAAAARecord_STATUS_ARM instances for property testing - lazily instantiated by
// PrivateDnsZonesAAAARecord_STATUS_ARMGenerator()
var privateDnsZonesAAAARecord_STATUS_ARMGenerator gopter.Gen

// PrivateDnsZonesAAAARecord_STATUS_ARMGenerator returns a generator of PrivateDnsZonesAAAARecord_STATUS_ARM instances for property testing.
// We first initialize privateDnsZonesAAAARecord_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func PrivateDnsZonesAAAARecord_STATUS_ARMGenerator() gopter.Gen {
	if privateDnsZonesAAAARecord_STATUS_ARMGenerator != nil {
		return privateDnsZonesAAAARecord_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM(generators)
	privateDnsZonesAAAARecord_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(PrivateDnsZonesAAAARecord_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM(generators)
	privateDnsZonesAAAARecord_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(PrivateDnsZonesAAAARecord_STATUS_ARM{}), generators)

	return privateDnsZonesAAAARecord_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForPrivateDnsZonesAAAARecord_STATUS_ARM(gens map[string]gopter.Gen) {
