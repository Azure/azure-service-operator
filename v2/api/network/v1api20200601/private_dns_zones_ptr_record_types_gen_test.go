...
func RunResourceConversionTestForPrivateDnsZonesPTRRecord(subject PrivateDnsZonesPTRRecord) string {
	...
	var hub v1api20200601s.PrivateDnsZonesPTRRecord
...
// RunPropertyAssignmentTestForPrivateDnsZonesPTRRecord tests if a specific instance of PrivateDnsZonesPTRRecord can be assigned to v1api20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZonesPTRRecord(subject PrivateDnsZonesPTRRecord) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20200601s.PrivateDnsZonesPTRRecord
...
// RunPropertyAssignmentTestForPrivateDnsZones_PTR_Spec tests if a specific instance of PrivateDnsZones_PTR_Spec can be assigned to v1api20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZones_PTR_Spec(subject PrivateDnsZones_PTR_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20200601s.PrivateDnsZones_PTR_Spec
...
// RunPropertyAssignmentTestForPrivateDnsZones_PTR_STATUS tests if a specific instance of PrivateDnsZones_PTR_STATUS can be assigned to v1api20200601storage and back losslessly
func RunPropertyAssignmentTestForPrivateDnsZones_PTR_STATUS(subject PrivateDnsZones_PTR_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1api20200601s.PrivateDnsZones_PTR_STATUS
