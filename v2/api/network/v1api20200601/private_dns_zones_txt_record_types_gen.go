...
func (record *PrivateDnsZonesTXTRecord) AssignProperties_From_PrivateDnsZonesTXTRecord(source *storage.PrivateDnsZonesTXTRecord) error {
	...
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_From_PrivateDnsZonesTXTRecord_Spec() to populate field Spec")
	}
	record.Spec = spec
	...
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_From_PrivateDnsZonesTXTRecord_STATUS() to populate field Status")
	}
...
func (record *PrivateDnsZonesTXTRecord) AssignProperties_To_PrivateDnsZonesTXTRecord(destination *storage.PrivateDnsZonesTXTRecord) error {
	...
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_To_PrivateDnsZonesTXTRecord_Spec() to populate field Spec")
	}
	...
	if err != nil {
		return errors.Wrap(err, "calling AssignProperties_To_PrivateDnsZonesTXTRecord_STATUS() to populate field Status")
	}
...
func (record *PrivateDnsZonesTXTRecord_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &PrivateDnsZonesTXTRecord_Spec_ARM{}
...
func (record *PrivateDnsZonesTXTRecord_Spec) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &PrivateDnsZonesTXTRecord_Spec_ARM{}
}
...
func (record *PrivateDnsZonesTXTRecord_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(PrivateDnsZonesTXTRecord_Spec_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected PrivateDnsZonesTXTRecord_Spec_ARM, got %T", armInput)
	}
...
func (record *PrivateDnsZonesTXTRecord_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &PrivateDnsZonesTXTRecord_STATUS_ARM{}
}
...
func (record *PrivateDnsZonesTXTRecord_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(PrivateDnsZonesTXTRecord_STATUS_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected PrivateDnsZonesTXTRecord_STATUS_ARM, got %T", armInput)
	}
