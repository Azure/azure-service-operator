...
func Test_SiteSourceControlProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SiteSourceControlProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSiteSourceControlProperties_STATUS, SiteSourceControlProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSiteSourceControlProperties_STATUS runs a test to see if a specific instance of SiteSourceControlProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForSiteSourceControlProperties_STATUS(subject SiteSourceControlProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual SiteSourceControlProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of SiteSourceControlProperties_STATUS instances for property testing - lazily instantiated by
// SiteSourceControlProperties_STATUSGenerator()
var siteSourceControlProperties_STATUSGenerator gopter.Gen

// SiteSourceControlProperties_STATUSGenerator returns a generator of SiteSourceControlProperties_STATUS instances for property testing.
// We first initialize siteSourceControlProperties_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func SiteSourceControlProperties_STATUSGenerator() gopter.Gen {
	if siteSourceControlProperties_STATUSGenerator != nil {
		return siteSourceControlProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSiteSourceControlProperties_STATUS(generators)
	siteSourceControlProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(SiteSourceControlProperties_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSiteSourceControlProperties_STATUS(generators)
	AddRelatedPropertyGeneratorsForSiteSourceControlProperties_STATUS(generators)
	siteSourceControlProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(SiteSourceControlProperties_STATUS{}), generators)

	return siteSourceControlProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForSiteSourceControlProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSiteSourceControlProperties_STATUS(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForSiteSourceControlProperties_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForSiteSourceControlProperties_STATUS(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForSitesSourcecontrol_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(SiteSourceControlProperties_STATUSGenerator())
