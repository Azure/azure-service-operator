...
func Test_AiIntegration_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from AiIntegration to AiIntegration via AssignProperties_To_AiIntegration & AssignProperties_From_AiIntegration returns original",
		prop.ForAll(RunPropertyAssignmentTestForAiIntegration, AiIntegrationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForAiIntegration tests if a specific instance of AiIntegration can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForAiIntegration(subject AiIntegration) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AiIntegration
	err := copied.AssignProperties_To_AiIntegration(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual AiIntegration
	err = actual.AssignProperties_From_AiIntegration(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_AiIntegration_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AiIntegration via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAiIntegration, AiIntegrationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAiIntegration runs a test to see if a specific instance of AiIntegration round trips to JSON and back losslessly
func RunJSONSerializationTestForAiIntegration(subject AiIntegration) string {
	// Serialize to JSON
...
// Generator of AiIntegration instances for property testing - lazily instantiated by AiIntegrationGenerator()
var aiIntegrationGenerator gopter.Gen

// AiIntegrationGenerator returns a generator of AiIntegration instances for property testing.
// We first initialize aiIntegrationGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AiIntegrationGenerator() gopter.Gen {
	if aiIntegrationGenerator != nil {
		return aiIntegrationGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAiIntegration(generators)
	aiIntegrationGenerator = gen.Struct(reflect.TypeOf(AiIntegration{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAiIntegration(generators)
	AddRelatedPropertyGeneratorsForAiIntegration(generators)
	aiIntegrationGenerator = gen.Struct(reflect.TypeOf(AiIntegration{}), generators)

	return aiIntegrationGenerator
}

// AddIndependentPropertyGeneratorsForAiIntegration is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAiIntegration(gens map[string]gopter.Gen) {
	gens["ApiSpecPath"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForAiIntegration is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAiIntegration(gens map[string]gopter.Gen) {
	gens["Mcp"] = gen.PtrOf(McpSettingsGenerator())
	gens["SiteAuth"] = gen.PtrOf(SiteAuthInfoGenerator())
}

func Test_AiIntegration_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from AiIntegration_STATUS to AiIntegration_STATUS via AssignProperties_To_AiIntegration_STATUS & AssignProperties_From_AiIntegration_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForAiIntegration_STATUS, AiIntegration_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForAiIntegration_STATUS tests if a specific instance of AiIntegration_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForAiIntegration_STATUS(subject AiIntegration_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AiIntegration_STATUS
	err := copied.AssignProperties_To_AiIntegration_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual AiIntegration_STATUS
	err = actual.AssignProperties_From_AiIntegration_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_AiIntegration_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AiIntegration_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAiIntegration_STATUS, AiIntegration_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAiIntegration_STATUS runs a test to see if a specific instance of AiIntegration_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForAiIntegration_STATUS(subject AiIntegration_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of AiIntegration_STATUS instances for property testing - lazily instantiated by
// AiIntegration_STATUSGenerator()
var aiIntegration_STATUSGenerator gopter.Gen

// AiIntegration_STATUSGenerator returns a generator of AiIntegration_STATUS instances for property testing.
// We first initialize aiIntegration_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AiIntegration_STATUSGenerator() gopter.Gen {
	if aiIntegration_STATUSGenerator != nil {
		return aiIntegration_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAiIntegration_STATUS(generators)
	aiIntegration_STATUSGenerator = gen.Struct(reflect.TypeOf(AiIntegration_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAiIntegration_STATUS(generators)
	AddRelatedPropertyGeneratorsForAiIntegration_STATUS(generators)
	aiIntegration_STATUSGenerator = gen.Struct(reflect.TypeOf(AiIntegration_STATUS{}), generators)

	return aiIntegration_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForAiIntegration_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAiIntegration_STATUS(gens map[string]gopter.Gen) {
	gens["ApiSpecPath"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForAiIntegration_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAiIntegration_STATUS(gens map[string]gopter.Gen) {
	gens["Mcp"] = gen.PtrOf(McpSettings_STATUSGenerator())
	gens["SiteAuth"] = gen.PtrOf(SiteAuthInfo_STATUSGenerator())
}
...
func Test_McpServerConfig_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from McpServerConfig to McpServerConfig via AssignProperties_To_McpServerConfig & AssignProperties_From_McpServerConfig returns original",
		prop.ForAll(RunPropertyAssignmentTestForMcpServerConfig, McpServerConfigGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMcpServerConfig tests if a specific instance of McpServerConfig can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMcpServerConfig(subject McpServerConfig) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.McpServerConfig
	err := copied.AssignProperties_To_McpServerConfig(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual McpServerConfig
	err = actual.AssignProperties_From_McpServerConfig(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_McpServerConfig_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of McpServerConfig via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMcpServerConfig, McpServerConfigGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMcpServerConfig runs a test to see if a specific instance of McpServerConfig round trips to JSON and back losslessly
func RunJSONSerializationTestForMcpServerConfig(subject McpServerConfig) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of McpServerConfig instances for property testing - lazily instantiated by McpServerConfigGenerator()
var mcpServerConfigGenerator gopter.Gen

// McpServerConfigGenerator returns a generator of McpServerConfig instances for property testing.
func McpServerConfigGenerator() gopter.Gen {
	if mcpServerConfigGenerator != nil {
		return mcpServerConfigGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMcpServerConfig(generators)
	mcpServerConfigGenerator = gen.Struct(reflect.TypeOf(McpServerConfig{}), generators)

	return mcpServerConfigGenerator
}

// AddIndependentPropertyGeneratorsForMcpServerConfig is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMcpServerConfig(gens map[string]gopter.Gen) {
	gens["Description"] = gen.PtrOf(gen.AlphaString())
	gens["Enabled"] = gen.PtrOf(gen.Bool())
	gens["Endpoint"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["ToolList"] = gen.SliceOf(gen.AlphaString())
}

func Test_McpServerConfig_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from McpServerConfig_STATUS to McpServerConfig_STATUS via AssignProperties_To_McpServerConfig_STATUS & AssignProperties_From_McpServerConfig_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForMcpServerConfig_STATUS, McpServerConfig_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMcpServerConfig_STATUS tests if a specific instance of McpServerConfig_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMcpServerConfig_STATUS(subject McpServerConfig_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.McpServerConfig_STATUS
	err := copied.AssignProperties_To_McpServerConfig_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual McpServerConfig_STATUS
	err = actual.AssignProperties_From_McpServerConfig_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_McpServerConfig_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of McpServerConfig_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMcpServerConfig_STATUS, McpServerConfig_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMcpServerConfig_STATUS runs a test to see if a specific instance of McpServerConfig_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForMcpServerConfig_STATUS(subject McpServerConfig_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of McpServerConfig_STATUS instances for property testing - lazily instantiated by
// McpServerConfig_STATUSGenerator()
var mcpServerConfig_STATUSGenerator gopter.Gen

// McpServerConfig_STATUSGenerator returns a generator of McpServerConfig_STATUS instances for property testing.
func McpServerConfig_STATUSGenerator() gopter.Gen {
	if mcpServerConfig_STATUSGenerator != nil {
		return mcpServerConfig_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMcpServerConfig_STATUS(generators)
	mcpServerConfig_STATUSGenerator = gen.Struct(reflect.TypeOf(McpServerConfig_STATUS{}), generators)

	return mcpServerConfig_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForMcpServerConfig_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMcpServerConfig_STATUS(gens map[string]gopter.Gen) {
	gens["Description"] = gen.PtrOf(gen.AlphaString())
	gens["Enabled"] = gen.PtrOf(gen.Bool())
	gens["Endpoint"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
...
func Test_McpSettings_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from McpSettings to McpSettings via AssignProperties_To_McpSettings & AssignProperties_From_McpSettings returns original",
		prop.ForAll(RunPropertyAssignmentTestForMcpSettings, McpSettingsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMcpSettings tests if a specific instance of McpSettings can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMcpSettings(subject McpSettings) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.McpSettings
	err := copied.AssignProperties_To_McpSettings(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual McpSettings
	err = actual.AssignProperties_From_McpSettings(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_McpSettings_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of McpSettings via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMcpSettings, McpSettingsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMcpSettings runs a test to see if a specific instance of McpSettings round trips to JSON and back losslessly
func RunJSONSerializationTestForMcpSettings(subject McpSettings) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of McpSettings instances for property testing - lazily instantiated by McpSettingsGenerator()
var mcpSettingsGenerator gopter.Gen

// McpSettingsGenerator returns a generator of McpSettings instances for property testing.
func McpSettingsGenerator() gopter.Gen {
	if mcpSettingsGenerator != nil {
		return mcpSettingsGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForMcpSettings(generators)
	mcpSettingsGenerator = gen.Struct(reflect.TypeOf(McpSettings{}), generators)

	return mcpSettingsGenerator
}

// AddRelatedPropertyGeneratorsForMcpSettings is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForMcpSettings(gens map[string]gopter.Gen) {
	gens["Servers"] = gen.SliceOf(McpServerConfigGenerator())
}

func Test_McpSettings_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from McpSettings_STATUS to McpSettings_STATUS via AssignProperties_To_McpSettings_STATUS & AssignProperties_From_McpSettings_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForMcpSettings_STATUS, McpSettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForMcpSettings_STATUS tests if a specific instance of McpSettings_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForMcpSettings_STATUS(subject McpSettings_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.McpSettings_STATUS
	err := copied.AssignProperties_To_McpSettings_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual McpSettings_STATUS
	err = actual.AssignProperties_From_McpSettings_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_McpSettings_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of McpSettings_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMcpSettings_STATUS, McpSettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMcpSettings_STATUS runs a test to see if a specific instance of McpSettings_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForMcpSettings_STATUS(subject McpSettings_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of McpSettings_STATUS instances for property testing - lazily instantiated by McpSettings_STATUSGenerator()
var mcpSettings_STATUSGenerator gopter.Gen

// McpSettings_STATUSGenerator returns a generator of McpSettings_STATUS instances for property testing.
func McpSettings_STATUSGenerator() gopter.Gen {
	if mcpSettings_STATUSGenerator != nil {
		return mcpSettings_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForMcpSettings_STATUS(generators)
	mcpSettings_STATUSGenerator = gen.Struct(reflect.TypeOf(McpSettings_STATUS{}), generators)

	return mcpSettings_STATUSGenerator
}

// AddRelatedPropertyGeneratorsForMcpSettings_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForMcpSettings_STATUS(gens map[string]gopter.Gen) {
	gens["Servers"] = gen.SliceOf(McpServerConfig_STATUSGenerator())
}
...
func AddIndependentPropertyGeneratorsForOutboundVnetRouting(gens map[string]gopter.Gen) {
	...
	gens["ManagedIdentityTraffic"] = gen.PtrOf(gen.Bool())
}
...
func Test_SiteAuthInfo_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from SiteAuthInfo to SiteAuthInfo via AssignProperties_To_SiteAuthInfo & AssignProperties_From_SiteAuthInfo returns original",
		prop.ForAll(RunPropertyAssignmentTestForSiteAuthInfo, SiteAuthInfoGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForSiteAuthInfo tests if a specific instance of SiteAuthInfo can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForSiteAuthInfo(subject SiteAuthInfo) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.SiteAuthInfo
	err := copied.AssignProperties_To_SiteAuthInfo(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual SiteAuthInfo
	err = actual.AssignProperties_From_SiteAuthInfo(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_SiteAuthInfo_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SiteAuthInfo via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSiteAuthInfo, SiteAuthInfoGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSiteAuthInfo runs a test to see if a specific instance of SiteAuthInfo round trips to JSON and back losslessly
func RunJSONSerializationTestForSiteAuthInfo(subject SiteAuthInfo) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of SiteAuthInfo instances for property testing - lazily instantiated by SiteAuthInfoGenerator()
var siteAuthInfoGenerator gopter.Gen

// SiteAuthInfoGenerator returns a generator of SiteAuthInfo instances for property testing.
func SiteAuthInfoGenerator() gopter.Gen {
	if siteAuthInfoGenerator != nil {
		return siteAuthInfoGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSiteAuthInfo(generators)
	siteAuthInfoGenerator = gen.Struct(reflect.TypeOf(SiteAuthInfo{}), generators)

	return siteAuthInfoGenerator
}

// AddIndependentPropertyGeneratorsForSiteAuthInfo is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSiteAuthInfo(gens map[string]gopter.Gen) {
	gens["Audience"] = gen.PtrOf(gen.AlphaString())
	gens["Issuer"] = gen.PtrOf(gen.AlphaString())
	gens["JwksUri"] = gen.PtrOf(gen.AlphaString())
	gens["Scopes"] = gen.SliceOf(gen.AlphaString())
	gens["WellKnownOpenIdConfiguration"] = gen.PtrOf(gen.AlphaString())
}

func Test_SiteAuthInfo_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from SiteAuthInfo_STATUS to SiteAuthInfo_STATUS via AssignProperties_To_SiteAuthInfo_STATUS & AssignProperties_From_SiteAuthInfo_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForSiteAuthInfo_STATUS, SiteAuthInfo_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForSiteAuthInfo_STATUS tests if a specific instance of SiteAuthInfo_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForSiteAuthInfo_STATUS(subject SiteAuthInfo_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.SiteAuthInfo_STATUS
	err := copied.AssignProperties_To_SiteAuthInfo_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual SiteAuthInfo_STATUS
	err = actual.AssignProperties_From_SiteAuthInfo_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_SiteAuthInfo_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SiteAuthInfo_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSiteAuthInfo_STATUS, SiteAuthInfo_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSiteAuthInfo_STATUS runs a test to see if a specific instance of SiteAuthInfo_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForSiteAuthInfo_STATUS(subject SiteAuthInfo_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of SiteAuthInfo_STATUS instances for property testing - lazily instantiated by
// SiteAuthInfo_STATUSGenerator()
var siteAuthInfo_STATUSGenerator gopter.Gen

// SiteAuthInfo_STATUSGenerator returns a generator of SiteAuthInfo_STATUS instances for property testing.
func SiteAuthInfo_STATUSGenerator() gopter.Gen {
	if siteAuthInfo_STATUSGenerator != nil {
		return siteAuthInfo_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSiteAuthInfo_STATUS(generators)
	siteAuthInfo_STATUSGenerator = gen.Struct(reflect.TypeOf(SiteAuthInfo_STATUS{}), generators)

	return siteAuthInfo_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForSiteAuthInfo_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSiteAuthInfo_STATUS(gens map[string]gopter.Gen) {
	gens["Audience"] = gen.PtrOf(gen.AlphaString())
	gens["Issuer"] = gen.PtrOf(gen.AlphaString())
	gens["JwksUri"] = gen.PtrOf(gen.AlphaString())
	gens["Scopes"] = gen.SliceOf(gen.AlphaString())
...
func AddRelatedPropertyGeneratorsForSite_STATUS(gens map[string]gopter.Gen) {
	gens["AiIntegration"] = gen.PtrOf(AiIntegration_STATUSGenerator())
...
func AddIndependentPropertyGeneratorsForSite_Spec(gens map[string]gopter.Gen) {
	...
	gens["MaintenanceEnabled"] = gen.PtrOf(gen.Bool())
	gens["PlatformReleaseChannel"] = gen.PtrOf(gen.OneConstOf(PlatformReleaseChannel_Extended, PlatformReleaseChannel_Latest, PlatformReleaseChannel_Standard))
	...
	gens["SiteScopedCertificatesEnabled"] = gen.PtrOf(gen.Bool())
...
func AddRelatedPropertyGeneratorsForSite_Spec(gens map[string]gopter.Gen) {
	gens["AiIntegration"] = gen.PtrOf(AiIntegrationGenerator())
