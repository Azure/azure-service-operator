...
func (site *Site_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if site.AiIntegration != nil ||
		...
		site.SiteConfig != nil ||
		site.SiteScopedCertificatesEnabled != nil ||
		site.SshEnabled != nil ||
	...
	if site.AiIntegration != nil {
		aiIntegration_ARM, err := site.AiIntegration.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		aiIntegration := *aiIntegration_ARM.(*arm.AiIntegration)
		result.Properties.AiIntegration = &aiIntegration
	}
	...
	if site.MaintenanceEnabled != nil {
		maintenanceEnabled := *site.MaintenanceEnabled
		result.Properties.MaintenanceEnabled = &maintenanceEnabled
	}
	...
	if site.PlatformReleaseChannel != nil {
		var temp string
		temp = string(*site.PlatformReleaseChannel)
		platformReleaseChannel := arm.PlatformReleaseChannel(temp)
		result.Properties.PlatformReleaseChannel = &platformReleaseChannel
	}
	...
	if site.SiteScopedCertificatesEnabled != nil {
		siteScopedCertificatesEnabled := *site.SiteScopedCertificatesEnabled
		result.Properties.SiteScopedCertificatesEnabled = &siteScopedCertificatesEnabled
	}
...
func (site *Site_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "AiIntegration":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.AiIntegration != nil {
			var aiIntegration1 AiIntegration
			err := aiIntegration1.PopulateFromARM(owner, *typedInput.Properties.AiIntegration)
			if err != nil {
				return err
			}
			aiIntegration := aiIntegration1
			site.AiIntegration = &aiIntegration
		}
	}
	...
	// Set property "MaintenanceEnabled":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.MaintenanceEnabled != nil {
			maintenanceEnabled := *typedInput.Properties.MaintenanceEnabled
			site.MaintenanceEnabled = &maintenanceEnabled
		}
	}
	...
	// Set property "PlatformReleaseChannel":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.PlatformReleaseChannel != nil {
			var temp string
			temp = string(*typedInput.Properties.PlatformReleaseChannel)
			platformReleaseChannel := PlatformReleaseChannel(temp)
			site.PlatformReleaseChannel = &platformReleaseChannel
		}
	}
	...
	// Set property "SiteScopedCertificatesEnabled":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.SiteScopedCertificatesEnabled != nil {
			siteScopedCertificatesEnabled := *typedInput.Properties.SiteScopedCertificatesEnabled
			site.SiteScopedCertificatesEnabled = &siteScopedCertificatesEnabled
		}
	}
...
func (site *Site_Spec) AssignProperties_From_Site_Spec(source *storage.Site_Spec) error {
	...
	if source.AiIntegration != nil {
		var aiIntegration AiIntegration
		err := aiIntegration.AssignProperties_From_AiIntegration(source.AiIntegration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_AiIntegration() to populate field AiIntegration")
		}
		site.AiIntegration = &aiIntegration
	} else {
		site.AiIntegration = nil
	}
	...
	if source.PlatformReleaseChannel != nil {
		platformReleaseChannel := *source.PlatformReleaseChannel
		platformReleaseChannelTemp := genruntime.ToEnum(platformReleaseChannel, platformReleaseChannel_Values)
		site.PlatformReleaseChannel = &platformReleaseChannelTemp
	} else {
		site.PlatformReleaseChannel = nil
	}
	...
	if source.SiteScopedCertificatesEnabled != nil {
		siteScopedCertificatesEnabled := *source.SiteScopedCertificatesEnabled
		site.SiteScopedCertificatesEnabled = &siteScopedCertificatesEnabled
	} else {
		site.SiteScopedCertificatesEnabled = nil
	}
...
func (site *Site_Spec) AssignProperties_To_Site_Spec(destination *storage.Site_Spec) error {
	...
	if site.AiIntegration != nil {
		...
		err := site.AiIntegration.AssignProperties_To_AiIntegration(&aiIntegration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_AiIntegration() to populate field AiIntegration")
		}
	...
	// PlatformReleaseChannel
	if site.PlatformReleaseChannel != nil {
		platformReleaseChannel := string(*site.PlatformReleaseChannel)
...
func (site *Site_Spec) Initialize_From_Site_STATUS(source *Site_STATUS) error {
	...
	if source.AiIntegration != nil {
		var aiIntegration AiIntegration
		err := aiIntegration.Initialize_From_AiIntegration_STATUS(source.AiIntegration)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_AiIntegration_STATUS() to populate field AiIntegration")
		}
		site.AiIntegration = &aiIntegration
	} else {
		site.AiIntegration = nil
	...
	// PlatformReleaseChannel
	if source.PlatformReleaseChannel != nil {
		platformReleaseChannel := genruntime.ToEnum(string(*source.PlatformReleaseChannel), platformReleaseChannel_Values)
		site.PlatformReleaseChannel = &platformReleaseChannel
	} else {
		site.PlatformReleaseChannel = nil
	}
...
func (site *Site_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AiIntegration != nil {
			var aiIntegration1 AiIntegration_STATUS
			err := aiIntegration1.PopulateFromARM(owner, *typedInput.Properties.AiIntegration)
			if err != nil {
				return err
			}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PlatformReleaseChannel != nil {
			var temp string
			temp = string(*typedInput.Properties.PlatformReleaseChannel)
			platformReleaseChannel := PlatformReleaseChannel_STATUS(temp)
			site.PlatformReleaseChannel = &platformReleaseChannel
		}
	}
...
func (site *Site_STATUS) AssignProperties_From_Site_STATUS(source *storage.Site_STATUS) error {
	...
	// AiIntegration
	if source.AiIntegration != nil {
		var aiIntegration AiIntegration_STATUS
		err := aiIntegration.AssignProperties_From_AiIntegration_STATUS(source.AiIntegration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_AiIntegration_STATUS() to populate field AiIntegration")
		}
		site.AiIntegration = &aiIntegration
	} else {
		site.AiIntegration = nil
	...
	if source.PlatformReleaseChannel != nil {
		platformReleaseChannel := *source.PlatformReleaseChannel
		platformReleaseChannelTemp := genruntime.ToEnum(platformReleaseChannel, platformReleaseChannel_STATUS_Values)
		site.PlatformReleaseChannel = &platformReleaseChannelTemp
	} else {
		site.PlatformReleaseChannel = nil
	}
...
func (site *Site_STATUS) AssignProperties_To_Site_STATUS(destination *storage.Site_STATUS) error {
	...
	if site.AiIntegration != nil {
		...
		err := site.AiIntegration.AssignProperties_To_AiIntegration_STATUS(&aiIntegration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_AiIntegration_STATUS() to populate field AiIntegration")
		}
		destination.AiIntegration = &aiIntegration
	} else {
		destination.AiIntegration = nil
...
var _ genruntime.ARMTransformer = &AiIntegration{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (integration *AiIntegration) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if integration == nil {
		return nil, nil
	}
	result := &arm.AiIntegration{}

	// Set property "ApiSpecPath":
	if integration.ApiSpecPath != nil {
		apiSpecPath := *integration.ApiSpecPath
		result.ApiSpecPath = &apiSpecPath
	}

	// Set property "Mcp":
	if integration.Mcp != nil {
		mcp_ARM, err := integration.Mcp.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		mcp := *mcp_ARM.(*arm.McpSettings)
		result.Mcp = &mcp
	}

	// Set property "SiteAuth":
	if integration.SiteAuth != nil {
		siteAuth_ARM, err := integration.SiteAuth.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		siteAuth := *siteAuth_ARM.(*arm.SiteAuthInfo)
		result.SiteAuth = &siteAuth
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (integration *AiIntegration) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AiIntegration{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (integration *AiIntegration) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AiIntegration)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AiIntegration, got %T", armInput)
	}

	// Set property "ApiSpecPath":
	if typedInput.ApiSpecPath != nil {
		apiSpecPath := *typedInput.ApiSpecPath
		integration.ApiSpecPath = &apiSpecPath
	}

	// Set property "Mcp":
	if typedInput.Mcp != nil {
		var mcp1 McpSettings
		err := mcp1.PopulateFromARM(owner, *typedInput.Mcp)
		if err != nil {
			return err
		}
		mcp := mcp1
	...
	// Set property "SiteAuth":
	if typedInput.SiteAuth != nil {
		var siteAuth1 SiteAuthInfo
		err := siteAuth1.PopulateFromARM(owner, *typedInput.SiteAuth)
		if err != nil {
			return err
		}
		siteAuth := siteAuth1
		integration.SiteAuth = &siteAuth
	}
...
// AssignProperties_From_AiIntegration populates our AiIntegration from the provided source AiIntegration
func (integration *AiIntegration) AssignProperties_From_AiIntegration(source *storage.AiIntegration) error {

	// ApiSpecPath
	integration.ApiSpecPath = genruntime.ClonePointerToString(source.ApiSpecPath)

	// Mcp
	if source.Mcp != nil {
		var mcp McpSettings
		err := mcp.AssignProperties_From_McpSettings(source.Mcp)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_McpSettings() to populate field Mcp")
		}
		integration.Mcp = &mcp
	} else {
		integration.Mcp = nil
	...
	// SiteAuth
	if source.SiteAuth != nil {
		var siteAuth SiteAuthInfo
		err := siteAuth.AssignProperties_From_SiteAuthInfo(source.SiteAuth)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SiteAuthInfo() to populate field SiteAuth")
		}
		integration.SiteAuth = &siteAuth
	} else {
		integration.SiteAuth = nil
	}
...
// AssignProperties_To_AiIntegration populates the provided destination AiIntegration from our AiIntegration
func (integration *AiIntegration) AssignProperties_To_AiIntegration(destination *storage.AiIntegration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ApiSpecPath
	destination.ApiSpecPath = genruntime.ClonePointerToString(integration.ApiSpecPath)

	// Mcp
	if integration.Mcp != nil {
		var mcp storage.McpSettings
		err := integration.Mcp.AssignProperties_To_McpSettings(&mcp)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_McpSettings() to populate field Mcp")
		}
		destination.Mcp = &mcp
	} else {
		destination.Mcp = nil
	...
	// SiteAuth
	if integration.SiteAuth != nil {
		var siteAuth storage.SiteAuthInfo
		err := integration.SiteAuth.AssignProperties_To_SiteAuthInfo(&siteAuth)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SiteAuthInfo() to populate field SiteAuth")
		}
		destination.SiteAuth = &siteAuth
	} else {
		destination.SiteAuth = nil
	}
...
// Initialize_From_AiIntegration_STATUS populates our AiIntegration from the provided source AiIntegration_STATUS
func (integration *AiIntegration) Initialize_From_AiIntegration_STATUS(source *AiIntegration_STATUS) error {
	...
	if source.Mcp != nil {
		var mcp McpSettings
		err := mcp.Initialize_From_McpSettings_STATUS(source.Mcp)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_McpSettings_STATUS() to populate field Mcp")
		}
		integration.Mcp = &mcp
	} else {
		integration.Mcp = nil
	...
	if source.SiteAuth != nil {
		var siteAuth SiteAuthInfo
		err := siteAuth.Initialize_From_SiteAuthInfo_STATUS(source.SiteAuth)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SiteAuthInfo_STATUS() to populate field SiteAuth")
		}
		integration.SiteAuth = &siteAuth
	} else {
		integration.SiteAuth = nil
...
var _ genruntime.FromARMConverter = &AiIntegration_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (integration *AiIntegration_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AiIntegration_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (integration *AiIntegration_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AiIntegration_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AiIntegration_STATUS, got %T", armInput)
	}
	...
	// Set property "SiteAuth":
	if typedInput.SiteAuth != nil {
		var siteAuth1 SiteAuthInfo_STATUS
		err := siteAuth1.PopulateFromARM(owner, *typedInput.SiteAuth)
		if err != nil {
			return err
		}
...
// AssignProperties_From_AiIntegration_STATUS populates our AiIntegration_STATUS from the provided source AiIntegration_STATUS
func (integration *AiIntegration_STATUS) AssignProperties_From_AiIntegration_STATUS(source *storage.AiIntegration_STATUS) error {
	...
	// Mcp
	if source.Mcp != nil {
		var mcp McpSettings_STATUS
		err := mcp.AssignProperties_From_McpSettings_STATUS(source.Mcp)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_McpSettings_STATUS() to populate field Mcp")
		}
		integration.Mcp = &mcp
	} else {
		integration.Mcp = nil
	...
	// SiteAuth
	if source.SiteAuth != nil {
		var siteAuth SiteAuthInfo_STATUS
		err := siteAuth.AssignProperties_From_SiteAuthInfo_STATUS(source.SiteAuth)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_SiteAuthInfo_STATUS() to populate field SiteAuth")
		}
		integration.SiteAuth = &siteAuth
	} else {
		integration.SiteAuth = nil
...
// AssignProperties_To_AiIntegration_STATUS populates the provided destination AiIntegration_STATUS from our AiIntegration_STATUS
func (integration *AiIntegration_STATUS) AssignProperties_To_AiIntegration_STATUS(destination *storage.AiIntegration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Mcp
	if integration.Mcp != nil {
		var mcp storage.McpSettings_STATUS
		err := integration.Mcp.AssignProperties_To_McpSettings_STATUS(&mcp)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_McpSettings_STATUS() to populate field Mcp")
		}
		destination.Mcp = &mcp
	} else {
		destination.Mcp = nil
	...
	// SiteAuth
	if integration.SiteAuth != nil {
		var siteAuth storage.SiteAuthInfo_STATUS
		err := integration.SiteAuth.AssignProperties_To_SiteAuthInfo_STATUS(&siteAuth)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_SiteAuthInfo_STATUS() to populate field SiteAuth")
		}
		destination.SiteAuth = &siteAuth
	} else {
		destination.SiteAuth = nil
...
func (routing *OutboundVnetRouting) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "ManagedIdentityTraffic":
	if routing.ManagedIdentityTraffic != nil {
		managedIdentityTraffic := *routing.ManagedIdentityTraffic
		result.ManagedIdentityTraffic = &managedIdentityTraffic
	}
	return result, nil
}
...
func (routing *OutboundVnetRouting) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "ManagedIdentityTraffic":
	if typedInput.ManagedIdentityTraffic != nil {
		managedIdentityTraffic := *typedInput.ManagedIdentityTraffic
		routing.ManagedIdentityTraffic = &managedIdentityTraffic
	}
...
func (routing *OutboundVnetRouting) AssignProperties_From_OutboundVnetRouting(source *storage.OutboundVnetRouting) error {
	...
	if source.ManagedIdentityTraffic != nil {
		managedIdentityTraffic := *source.ManagedIdentityTraffic
		routing.ManagedIdentityTraffic = &managedIdentityTraffic
	} else {
		routing.ManagedIdentityTraffic = nil
	}
...
var _ genruntime.ARMTransformer = &McpSettings{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (settings *McpSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if settings == nil {
		return nil, nil
	}
	result := &arm.McpSettings{}
	...
	for _, item := range settings.Servers {
		...
		result.Servers = append(result.Servers, *item_ARM.(*arm.McpServerConfig))
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *McpSettings) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.McpSettings{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *McpSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.McpSettings)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.McpSettings, got %T", armInput)
	}

	// Set property "Servers":
	for _, item := range typedInput.Servers {
		var item1 McpServerConfig
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		settings.Servers = append(settings.Servers, item1)
	}
...
// AssignProperties_From_McpSettings populates our McpSettings from the provided source McpSettings
func (settings *McpSettings) AssignProperties_From_McpSettings(source *storage.McpSettings) error {

	// Servers
	if source.Servers != nil {
		serverList := make([]McpServerConfig, len(source.Servers))
		for serverIndex, serverItem := range source.Servers {
			var server McpServerConfig
			err := server.AssignProperties_From_McpServerConfig(&serverItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_McpServerConfig() to populate field Servers")
			}
...
// AssignProperties_To_McpSettings populates the provided destination McpSettings from our McpSettings
func (settings *McpSettings) AssignProperties_To_McpSettings(destination *storage.McpSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Servers
	if settings.Servers != nil {
		serverList := make([]storage.McpServerConfig, len(settings.Servers))
		for serverIndex, serverItem := range settings.Servers {
			var server storage.McpServerConfig
			err := serverItem.AssignProperties_To_McpServerConfig(&server)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_McpServerConfig() to populate field Servers")
			}
			serverList[serverIndex] = server
		}
		destination.Servers = serverList
	} else {
		destination.Servers = nil
	}
...
// Initialize_From_McpSettings_STATUS populates our McpSettings from the provided source McpSettings_STATUS
func (settings *McpSettings) Initialize_From_McpSettings_STATUS(source *McpSettings_STATUS) error {
	...
	if source.Servers != nil {
		...
		for serverIndex, serverItem := range source.Servers {
			var server McpServerConfig
			err := server.Initialize_From_McpServerConfig_STATUS(&serverItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_McpServerConfig_STATUS() to populate field Servers")
			}
			serverList[serverIndex] = server
		}
		settings.Servers = serverList
...
var _ genruntime.FromARMConverter = &McpSettings_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *McpSettings_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.McpSettings_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *McpSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.McpSettings_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.McpSettings_STATUS, got %T", armInput)
	}

	// Set property "Servers":
	for _, item := range typedInput.Servers {
		var item1 McpServerConfig_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
...
// AssignProperties_From_McpSettings_STATUS populates our McpSettings_STATUS from the provided source McpSettings_STATUS
func (settings *McpSettings_STATUS) AssignProperties_From_McpSettings_STATUS(source *storage.McpSettings_STATUS) error {

	// Servers
	if source.Servers != nil {
		serverList := make([]McpServerConfig_STATUS, len(source.Servers))
		for serverIndex, serverItem := range source.Servers {
			var server McpServerConfig_STATUS
			err := server.AssignProperties_From_McpServerConfig_STATUS(&serverItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_McpServerConfig_STATUS() to populate field Servers")
			}
			serverList[serverIndex] = server
		}
		settings.Servers = serverList
...
// AssignProperties_To_McpSettings_STATUS populates the provided destination McpSettings_STATUS from our McpSettings_STATUS
func (settings *McpSettings_STATUS) AssignProperties_To_McpSettings_STATUS(destination *storage.McpSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Servers
	if settings.Servers != nil {
		serverList := make([]storage.McpServerConfig_STATUS, len(settings.Servers))
		for serverIndex, serverItem := range settings.Servers {
			var server storage.McpServerConfig_STATUS
			err := serverItem.AssignProperties_To_McpServerConfig_STATUS(&server)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_McpServerConfig_STATUS() to populate field Servers")
			}
			serverList[serverIndex] = server
		}
		destination.Servers = serverList
...
var _ genruntime.ARMTransformer = &SiteAuthInfo{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (info *SiteAuthInfo) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if info == nil {
		return nil, nil
	}
	result := &arm.SiteAuthInfo{}

	// Set property "Audience":
	if info.Audience != nil {
	...
	if info.WellKnownOpenIdConfiguration != nil {
		wellKnownOpenIdConfiguration := *info.WellKnownOpenIdConfiguration
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *SiteAuthInfo) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SiteAuthInfo{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *SiteAuthInfo) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SiteAuthInfo)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SiteAuthInfo, got %T", armInput)
	}

	// Set property "Audience":
	if typedInput.Audience != nil {
		audience := *typedInput.Audience
...
// AssignProperties_From_SiteAuthInfo populates our SiteAuthInfo from the provided source SiteAuthInfo
func (info *SiteAuthInfo) AssignProperties_From_SiteAuthInfo(source *storage.SiteAuthInfo) error {

	// Audience
	info.Audience = genruntime.ClonePointerToString(source.Audience)

	// Issuer
	info.Issuer = genruntime.ClonePointerToString(source.Issuer)

	// JwksUri
	info.JwksUri = genruntime.ClonePointerToString(source.JwksUri)

	// Scopes
	info.Scopes = genruntime.CloneSliceOfString(source.Scopes)

	// WellKnownOpenIdConfiguration
	info.WellKnownOpenIdConfiguration = genruntime.ClonePointerToString(source.WellKnownOpenIdConfiguration)

	// No error
	return nil
}

// AssignProperties_To_SiteAuthInfo populates the provided destination SiteAuthInfo from our SiteAuthInfo
func (info *SiteAuthInfo) AssignProperties_To_SiteAuthInfo(destination *storage.SiteAuthInfo) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Audience
	destination.Audience = genruntime.ClonePointerToString(info.Audience)

	// Issuer
	destination.Issuer = genruntime.ClonePointerToString(info.Issuer)

	// JwksUri
	destination.JwksUri = genruntime.ClonePointerToString(info.JwksUri)

	// Scopes
	destination.Scopes = genruntime.CloneSliceOfString(info.Scopes)

	// WellKnownOpenIdConfiguration
	destination.WellKnownOpenIdConfiguration = genruntime.ClonePointerToString(info.WellKnownOpenIdConfiguration)
...
// Initialize_From_SiteAuthInfo_STATUS populates our SiteAuthInfo from the provided source SiteAuthInfo_STATUS
func (info *SiteAuthInfo) Initialize_From_SiteAuthInfo_STATUS(source *SiteAuthInfo_STATUS) error {
...
var _ genruntime.FromARMConverter = &SiteAuthInfo_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (info *SiteAuthInfo_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SiteAuthInfo_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (info *SiteAuthInfo_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SiteAuthInfo_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SiteAuthInfo_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_SiteAuthInfo_STATUS populates our SiteAuthInfo_STATUS from the provided source SiteAuthInfo_STATUS
func (info *SiteAuthInfo_STATUS) AssignProperties_From_SiteAuthInfo_STATUS(source *storage.SiteAuthInfo_STATUS) error {
...
// AssignProperties_To_SiteAuthInfo_STATUS populates the provided destination SiteAuthInfo_STATUS from our SiteAuthInfo_STATUS
func (info *SiteAuthInfo_STATUS) AssignProperties_To_SiteAuthInfo_STATUS(destination *storage.SiteAuthInfo_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
var _ genruntime.ARMTransformer = &McpServerConfig{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (config *McpServerConfig) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if config == nil {
		return nil, nil
	}
	result := &arm.McpServerConfig{}
	...
	// Set property "ToolList":
	for _, item := range config.ToolList {
		result.ToolList = append(result.ToolList, item)
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (config *McpServerConfig) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.McpServerConfig{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (config *McpServerConfig) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.McpServerConfig)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.McpServerConfig, got %T", armInput)
	}
	...
	// Set property "ToolList":
	for _, item := range typedInput.ToolList {
		config.ToolList = append(config.ToolList, item)
	}
...
// AssignProperties_From_McpServerConfig populates our McpServerConfig from the provided source McpServerConfig
func (config *McpServerConfig) AssignProperties_From_McpServerConfig(source *storage.McpServerConfig) error {

	// Description
	config.Description = genruntime.ClonePointerToString(source.Description)
	...
	// Endpoint
	config.Endpoint = genruntime.ClonePointerToString(source.Endpoint)

	// Name
	config.Name = genruntime.ClonePointerToString(source.Name)

	// ToolList
	config.ToolList = genruntime.CloneSliceOfString(source.ToolList)

	// No error
	return nil
}

// AssignProperties_To_McpServerConfig populates the provided destination McpServerConfig from our McpServerConfig
func (config *McpServerConfig) AssignProperties_To_McpServerConfig(destination *storage.McpServerConfig) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Description
	destination.Description = genruntime.ClonePointerToString(config.Description)
	...
	// Endpoint
	destination.Endpoint = genruntime.ClonePointerToString(config.Endpoint)

	// Name
	destination.Name = genruntime.ClonePointerToString(config.Name)

	// ToolList
	destination.ToolList = genruntime.CloneSliceOfString(config.ToolList)
...
// Initialize_From_McpServerConfig_STATUS populates our McpServerConfig from the provided source McpServerConfig_STATUS
func (config *McpServerConfig) Initialize_From_McpServerConfig_STATUS(source *McpServerConfig_STATUS) error {
...
var _ genruntime.FromARMConverter = &McpServerConfig_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (config *McpServerConfig_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.McpServerConfig_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (config *McpServerConfig_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.McpServerConfig_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.McpServerConfig_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_McpServerConfig_STATUS populates our McpServerConfig_STATUS from the provided source McpServerConfig_STATUS
func (config *McpServerConfig_STATUS) AssignProperties_From_McpServerConfig_STATUS(source *storage.McpServerConfig_STATUS) error {
...
// AssignProperties_To_McpServerConfig_STATUS populates the provided destination McpServerConfig_STATUS from our McpServerConfig_STATUS
func (config *McpServerConfig_STATUS) AssignProperties_To_McpServerConfig_STATUS(destination *storage.McpServerConfig_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
