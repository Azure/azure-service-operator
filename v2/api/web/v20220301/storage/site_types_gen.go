...
// Storage version of v20220301.Site_Spec
...
func (site *Site_Spec) AssignProperties_From_Site_Spec(source *storage.Site_Spec) error {
	...
	if source.AutoGeneratedDomainNameLabelScope != nil {
		propertyBag.Add("AutoGeneratedDomainNameLabelScope", *source.AutoGeneratedDomainNameLabelScope)
	} else {
		propertyBag.Remove("AutoGeneratedDomainNameLabelScope")
	}
	...
	if source.ClientAffinityPartitioningEnabled != nil {
		propertyBag.Add("ClientAffinityPartitioningEnabled", *source.ClientAffinityPartitioningEnabled)
	} else {
		propertyBag.Remove("ClientAffinityPartitioningEnabled")
	}

	// ClientAffinityProxyEnabled
	if source.ClientAffinityProxyEnabled != nil {
		propertyBag.Add("ClientAffinityProxyEnabled", *source.ClientAffinityProxyEnabled)
	} else {
		propertyBag.Remove("ClientAffinityProxyEnabled")
	}
	...
	if source.DaprConfig != nil {
		propertyBag.Add("DaprConfig", *source.DaprConfig)
	} else {
		propertyBag.Remove("DaprConfig")
	}

	// DnsConfiguration
	if source.DnsConfiguration != nil {
		propertyBag.Add("DnsConfiguration", *source.DnsConfiguration)
	} else {
		propertyBag.Remove("DnsConfiguration")
	}
	...
	if source.EndToEndEncryptionEnabled != nil {
		propertyBag.Add("EndToEndEncryptionEnabled", *source.EndToEndEncryptionEnabled)
	} else {
		propertyBag.Remove("EndToEndEncryptionEnabled")
	}
	...
	if source.FunctionAppConfig != nil {
		propertyBag.Add("FunctionAppConfig", *source.FunctionAppConfig)
	} else {
		propertyBag.Remove("FunctionAppConfig")
	}
	...
	if source.IpMode != nil {
		propertyBag.Add("IpMode", *source.IpMode)
	} else {
		propertyBag.Remove("IpMode")
	}
	...
	if source.ManagedEnvironmentReference != nil {
		propertyBag.Add("ManagedEnvironmentReference", *source.ManagedEnvironmentReference)
	} else {
		propertyBag.Remove("ManagedEnvironmentReference")
	}
	...
	if source.OutboundVnetRouting != nil {
		propertyBag.Add("OutboundVnetRouting", *source.OutboundVnetRouting)
	} else {
		propertyBag.Remove("OutboundVnetRouting")
	}
	...
	if source.ResourceConfig != nil {
		propertyBag.Add("ResourceConfig", *source.ResourceConfig)
	} else {
		propertyBag.Remove("ResourceConfig")
	}
	...
	if source.SshEnabled != nil {
		propertyBag.Add("SshEnabled", *source.SshEnabled)
	} else {
		propertyBag.Remove("SshEnabled")
	}
	...
	if propertyBag.Contains("VnetContentShareEnabled") {
		var vnetContentShareEnabled bool
		err := propertyBag.Pull("VnetContentShareEnabled", &vnetContentShareEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'VnetContentShareEnabled' from propertyBag")
		}
	...
	if propertyBag.Contains("VnetImagePullEnabled") {
		var vnetImagePullEnabled bool
		err := propertyBag.Pull("VnetImagePullEnabled", &vnetImagePullEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'VnetImagePullEnabled' from propertyBag")
		}
	...
	// VnetRouteAllEnabled
	if propertyBag.Contains("VnetRouteAllEnabled") {
		var vnetRouteAllEnabled bool
		err := propertyBag.Pull("VnetRouteAllEnabled", &vnetRouteAllEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'VnetRouteAllEnabled' from propertyBag")
		}
	...
	// WorkloadProfileName
	if source.WorkloadProfileName != nil {
		propertyBag.Add("WorkloadProfileName", *source.WorkloadProfileName)
	} else {
		propertyBag.Remove("WorkloadProfileName")
	}
...
func (site *Site_Spec) AssignProperties_To_Site_Spec(destination *storage.Site_Spec) error {
	...
	// AutoGeneratedDomainNameLabelScope
	if propertyBag.Contains("AutoGeneratedDomainNameLabelScope") {
		var autoGeneratedDomainNameLabelScope string
		err := propertyBag.Pull("AutoGeneratedDomainNameLabelScope", &autoGeneratedDomainNameLabelScope)
		if err != nil {
			return eris.Wrap(err, "pulling 'AutoGeneratedDomainNameLabelScope' from propertyBag")
		}
	...
	// ClientAffinityPartitioningEnabled
	if propertyBag.Contains("ClientAffinityPartitioningEnabled") {
		var clientAffinityPartitioningEnabled bool
		err := propertyBag.Pull("ClientAffinityPartitioningEnabled", &clientAffinityPartitioningEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'ClientAffinityPartitioningEnabled' from propertyBag")
		}
	...
	// ClientAffinityProxyEnabled
	if propertyBag.Contains("ClientAffinityProxyEnabled") {
		var clientAffinityProxyEnabled bool
		err := propertyBag.Pull("ClientAffinityProxyEnabled", &clientAffinityProxyEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'ClientAffinityProxyEnabled' from propertyBag")
		}
	...
	// DaprConfig
	if propertyBag.Contains("DaprConfig") {
		var daprConfig storage.DaprConfig
		err := propertyBag.Pull("DaprConfig", &daprConfig)
		if err != nil {
			return eris.Wrap(err, "pulling 'DaprConfig' from propertyBag")
		}
	...
	// DnsConfiguration
	if propertyBag.Contains("DnsConfiguration") {
		var dnsConfiguration storage.SiteDnsConfig
		err := propertyBag.Pull("DnsConfiguration", &dnsConfiguration)
		if err != nil {
			return eris.Wrap(err, "pulling 'DnsConfiguration' from propertyBag")
		}
	...
	// EndToEndEncryptionEnabled
	if propertyBag.Contains("EndToEndEncryptionEnabled") {
		var endToEndEncryptionEnabled bool
		err := propertyBag.Pull("EndToEndEncryptionEnabled", &endToEndEncryptionEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'EndToEndEncryptionEnabled' from propertyBag")
		}
	...
	// FunctionAppConfig
	if propertyBag.Contains("FunctionAppConfig") {
		var functionAppConfig storage.FunctionAppConfig
		err := propertyBag.Pull("FunctionAppConfig", &functionAppConfig)
		if err != nil {
			return eris.Wrap(err, "pulling 'FunctionAppConfig' from propertyBag")
		}
	...
	// IpMode
	if propertyBag.Contains("IpMode") {
		var ipMode string
		err := propertyBag.Pull("IpMode", &ipMode)
		if err != nil {
			return eris.Wrap(err, "pulling 'IpMode' from propertyBag")
		}
	...
	// ManagedEnvironmentReference
	if propertyBag.Contains("ManagedEnvironmentReference") {
		var managedEnvironmentReference genruntime.ResourceReference
		err := propertyBag.Pull("ManagedEnvironmentReference", &managedEnvironmentReference)
		if err != nil {
			return eris.Wrap(err, "pulling 'ManagedEnvironmentReference' from propertyBag")
		}
	...
	// OutboundVnetRouting
	if propertyBag.Contains("OutboundVnetRouting") {
		var outboundVnetRouting storage.OutboundVnetRouting
		err := propertyBag.Pull("OutboundVnetRouting", &outboundVnetRouting)
		if err != nil {
			return eris.Wrap(err, "pulling 'OutboundVnetRouting' from propertyBag")
		}
	...
	// ResourceConfig
	if propertyBag.Contains("ResourceConfig") {
		var resourceConfig storage.ResourceConfig
		err := propertyBag.Pull("ResourceConfig", &resourceConfig)
		if err != nil {
			return eris.Wrap(err, "pulling 'ResourceConfig' from propertyBag")
		}
	...
	// SshEnabled
	if propertyBag.Contains("SshEnabled") {
		var sshEnabled bool
		err := propertyBag.Pull("SshEnabled", &sshEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'SshEnabled' from propertyBag")
		}
	...
	if site.VnetContentShareEnabled != nil {
		propertyBag.Add("VnetContentShareEnabled", *site.VnetContentShareEnabled)
	} else {
		propertyBag.Remove("VnetContentShareEnabled")
	}

	// VnetImagePullEnabled
	if site.VnetImagePullEnabled != nil {
		propertyBag.Add("VnetImagePullEnabled", *site.VnetImagePullEnabled)
	} else {
		propertyBag.Remove("VnetImagePullEnabled")
	}

	// VnetRouteAllEnabled
	if site.VnetRouteAllEnabled != nil {
		propertyBag.Add("VnetRouteAllEnabled", *site.VnetRouteAllEnabled)
	} else {
		propertyBag.Remove("VnetRouteAllEnabled")
	}

	// WorkloadProfileName
	if propertyBag.Contains("WorkloadProfileName") {
		var workloadProfileName string
		err := propertyBag.Pull("WorkloadProfileName", &workloadProfileName)
		if err != nil {
			return eris.Wrap(err, "pulling 'WorkloadProfileName' from propertyBag")
		}

		destination.WorkloadProfileName = &workloadProfileName
	} else {
		destination.WorkloadProfileName = nil
	}
...
func (site *Site_STATUS) AssignProperties_From_Site_STATUS(source *storage.Site_STATUS) error {
	...
	if source.ManagedEnvironmentId != nil {
		propertyBag.Add("ManagedEnvironmentId", *source.ManagedEnvironmentId)
	} else {
		propertyBag.Remove("ManagedEnvironmentId")
	}
...
func (site *Site_STATUS) AssignProperties_To_Site_STATUS(destination *storage.Site_STATUS) error {
	...
	// ManagedEnvironmentId
	if propertyBag.Contains("ManagedEnvironmentId") {
		var managedEnvironmentId string
		err := propertyBag.Pull("ManagedEnvironmentId", &managedEnvironmentId)
		if err != nil {
			return eris.Wrap(err, "pulling 'ManagedEnvironmentId' from propertyBag")
		}

		destination.ManagedEnvironmentId = &managedEnvironmentId
	} else {
		destination.ManagedEnvironmentId = nil
	}
...
func (config *SiteConfig) AssignProperties_From_SiteConfig(source *storage.SiteConfig) error {
	...
	if source.ElasticWebAppScaleLimit != nil {
		propertyBag.Add("ElasticWebAppScaleLimit", *source.ElasticWebAppScaleLimit)
	} else {
		propertyBag.Remove("ElasticWebAppScaleLimit")
	}
	...
	// Http20ProxyFlag
	if source.Http20ProxyFlag != nil {
		propertyBag.Add("Http20ProxyFlag", *source.Http20ProxyFlag)
	} else {
		propertyBag.Remove("Http20ProxyFlag")
	}
	...
	if source.IpSecurityRestrictionsDefaultAction != nil {
		propertyBag.Add("IpSecurityRestrictionsDefaultAction", *source.IpSecurityRestrictionsDefaultAction)
	} else {
		propertyBag.Remove("IpSecurityRestrictionsDefaultAction")
	}
	...
	if len(source.Metadata) > 0 {
		propertyBag.Add("Metadata", source.Metadata)
	} else {
		propertyBag.Remove("Metadata")
	}

	// MinTlsCipherSuite
	if source.MinTlsCipherSuite != nil {
		propertyBag.Add("MinTlsCipherSuite", *source.MinTlsCipherSuite)
	} else {
		propertyBag.Remove("MinTlsCipherSuite")
	}
	...
	if source.ScmIpSecurityRestrictionsDefaultAction != nil {
		propertyBag.Add("ScmIpSecurityRestrictionsDefaultAction", *source.ScmIpSecurityRestrictionsDefaultAction)
	} else {
		propertyBag.Remove("ScmIpSecurityRestrictionsDefaultAction")
	}
...
func (config *SiteConfig) AssignProperties_To_SiteConfig(destination *storage.SiteConfig) error {
	...
	// ElasticWebAppScaleLimit
	if propertyBag.Contains("ElasticWebAppScaleLimit") {
		var elasticWebAppScaleLimit int
		err := propertyBag.Pull("ElasticWebAppScaleLimit", &elasticWebAppScaleLimit)
		if err != nil {
			return eris.Wrap(err, "pulling 'ElasticWebAppScaleLimit' from propertyBag")
		}

		destination.ElasticWebAppScaleLimit = &elasticWebAppScaleLimit
	} else {
		destination.ElasticWebAppScaleLimit = nil
	}
	...
	// Http20ProxyFlag
	if propertyBag.Contains("Http20ProxyFlag") {
		var http20ProxyFlag int
		err := propertyBag.Pull("Http20ProxyFlag", &http20ProxyFlag)
		if err != nil {
			return eris.Wrap(err, "pulling 'Http20ProxyFlag' from propertyBag")
		}

		destination.Http20ProxyFlag = &http20ProxyFlag
	} else {
		destination.Http20ProxyFlag = nil
	}
	...
	// IpSecurityRestrictionsDefaultAction
	if propertyBag.Contains("IpSecurityRestrictionsDefaultAction") {
		var ipSecurityRestrictionsDefaultAction string
		err := propertyBag.Pull("IpSecurityRestrictionsDefaultAction", &ipSecurityRestrictionsDefaultAction)
		if err != nil {
			return eris.Wrap(err, "pulling 'IpSecurityRestrictionsDefaultAction' from propertyBag")
		}
	...
	// Metadata
	if propertyBag.Contains("Metadata") {
		var metadatum []storage.NameValuePair
		err := propertyBag.Pull("Metadata", &metadatum)
		if err != nil {
			return eris.Wrap(err, "pulling 'Metadata' from propertyBag")
		}
	...
	// MinTlsCipherSuite
	if propertyBag.Contains("MinTlsCipherSuite") {
		var minTlsCipherSuite string
		err := propertyBag.Pull("MinTlsCipherSuite", &minTlsCipherSuite)
		if err != nil {
			return eris.Wrap(err, "pulling 'MinTlsCipherSuite' from propertyBag")
		}
	...
	// ScmIpSecurityRestrictionsDefaultAction
	if propertyBag.Contains("ScmIpSecurityRestrictionsDefaultAction") {
		var scmIpSecurityRestrictionsDefaultAction string
		err := propertyBag.Pull("ScmIpSecurityRestrictionsDefaultAction", &scmIpSecurityRestrictionsDefaultAction)
		if err != nil {
			return eris.Wrap(err, "pulling 'ScmIpSecurityRestrictionsDefaultAction' from propertyBag")
		}
...
func (value *AzureStorageInfoValue) AssignProperties_From_AzureStorageInfoValue(source *storage.AzureStorageInfoValue) error {
	...
	if source.Protocol != nil {
		propertyBag.Add("Protocol", *source.Protocol)
	} else {
		propertyBag.Remove("Protocol")
	}
...
func (value *AzureStorageInfoValue) AssignProperties_To_AzureStorageInfoValue(destination *storage.AzureStorageInfoValue) error {
	...
	// Protocol
	if propertyBag.Contains("Protocol") {
		var protocol string
		err := propertyBag.Pull("Protocol", &protocol)
		if err != nil {
			return eris.Wrap(err, "pulling 'Protocol' from propertyBag")
		}
