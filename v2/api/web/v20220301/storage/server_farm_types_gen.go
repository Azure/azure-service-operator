...
// Storage version of v20220301.ServerFarm_Spec
...
func (farm *ServerFarm_Spec) AssignProperties_From_ServerFarm_Spec(source *storage.ServerFarm_Spec) error {
	...
	if source.AsyncScalingEnabled != nil {
		propertyBag.Add("AsyncScalingEnabled", *source.AsyncScalingEnabled)
	} else {
		propertyBag.Remove("AsyncScalingEnabled")
	}
	...
	// InstallScripts
	if len(source.InstallScripts) > 0 {
		propertyBag.Add("InstallScripts", source.InstallScripts)
	} else {
		propertyBag.Remove("InstallScripts")
	}

	// IsCustomMode
	if source.IsCustomMode != nil {
		propertyBag.Add("IsCustomMode", *source.IsCustomMode)
	} else {
		propertyBag.Remove("IsCustomMode")
	}
	...
	if source.Network != nil {
		propertyBag.Add("Network", *source.Network)
	} else {
		propertyBag.Remove("Network")
	}
	...
	if source.PlanDefaultIdentity != nil {
		propertyBag.Add("PlanDefaultIdentity", *source.PlanDefaultIdentity)
	} else {
		propertyBag.Remove("PlanDefaultIdentity")
	}

	// RdpEnabled
	if source.RdpEnabled != nil {
		propertyBag.Add("RdpEnabled", *source.RdpEnabled)
	} else {
		propertyBag.Remove("RdpEnabled")
	}

	// RegistryAdapters
	if len(source.RegistryAdapters) > 0 {
		propertyBag.Add("RegistryAdapters", source.RegistryAdapters)
	} else {
		propertyBag.Remove("RegistryAdapters")
	}
	...
	// StorageMounts
	if len(source.StorageMounts) > 0 {
		propertyBag.Add("StorageMounts", source.StorageMounts)
	} else {
		propertyBag.Remove("StorageMounts")
	}
...
func (farm *ServerFarm_Spec) AssignProperties_To_ServerFarm_Spec(destination *storage.ServerFarm_Spec) error {
	...
	// AsyncScalingEnabled
	if propertyBag.Contains("AsyncScalingEnabled") {
		var asyncScalingEnabled bool
		err := propertyBag.Pull("AsyncScalingEnabled", &asyncScalingEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'AsyncScalingEnabled' from propertyBag")
		}
	...
	// InstallScripts
	if propertyBag.Contains("InstallScripts") {
		var installScript []storage.InstallScript
		err := propertyBag.Pull("InstallScripts", &installScript)
		if err != nil {
			return eris.Wrap(err, "pulling 'InstallScripts' from propertyBag")
		}

		destination.InstallScripts = installScript
	} else {
		destination.InstallScripts = nil
	}

	// IsCustomMode
	if propertyBag.Contains("IsCustomMode") {
		var isCustomMode bool
		err := propertyBag.Pull("IsCustomMode", &isCustomMode)
		if err != nil {
			return eris.Wrap(err, "pulling 'IsCustomMode' from propertyBag")
		}
	...
	// Network
	if propertyBag.Contains("Network") {
		var network storage.ServerFarmNetworkSettings
		err := propertyBag.Pull("Network", &network)
		if err != nil {
			return eris.Wrap(err, "pulling 'Network' from propertyBag")
		}
	...
	// PlanDefaultIdentity
	if propertyBag.Contains("PlanDefaultIdentity") {
		var planDefaultIdentity storage.DefaultIdentity
		err := propertyBag.Pull("PlanDefaultIdentity", &planDefaultIdentity)
		if err != nil {
			return eris.Wrap(err, "pulling 'PlanDefaultIdentity' from propertyBag")
		}
	...
	// RdpEnabled
	if propertyBag.Contains("RdpEnabled") {
		var rdpEnabled bool
		err := propertyBag.Pull("RdpEnabled", &rdpEnabled)
		if err != nil {
			return eris.Wrap(err, "pulling 'RdpEnabled' from propertyBag")
		}
	...
	// RegistryAdapters
	if propertyBag.Contains("RegistryAdapters") {
		var registryAdapter []storage.RegistryAdapter
		err := propertyBag.Pull("RegistryAdapters", &registryAdapter)
		if err != nil {
			return eris.Wrap(err, "pulling 'RegistryAdapters' from propertyBag")
		}

		destination.RegistryAdapters = registryAdapter
	} else {
	...
	// StorageMounts
	if propertyBag.Contains("StorageMounts") {
		var storageMount []storage.StorageMount
		err := propertyBag.Pull("StorageMounts", &storageMount)
		if err != nil {
			return eris.Wrap(err, "pulling 'StorageMounts' from propertyBag")
		}

		destination.StorageMounts = storageMount
	} else {
...
// Storage version of v20220301.ServerFarm_STATUS
