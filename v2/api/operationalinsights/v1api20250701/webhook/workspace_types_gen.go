...
func (workspace *Workspace) defaultAzureName(ctx context.Context, obj *v20250701.Workspace) error {
...
func (workspace *Workspace) defaultImpl(ctx context.Context, obj *v20250701.Workspace) error {
...
func (workspace *Workspace) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = workspace
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20250701.Workspace]); ok {
...
func (workspace *Workspace) createValidations() []func(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error){
...
func (workspace *Workspace) deleteValidations() []func(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (workspace *Workspace) updateValidations() []func(ctx context.Context, oldObj *v20250701.Workspace, newObj *v20250701.Workspace) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20250701.Workspace, newObj *v20250701.Workspace) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20250701.Workspace, newObj *v20250701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateConfigMapDestinations(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateOwnerReference(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (workspace *Workspace) validateResourceReferences(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
...
func (workspace *Workspace) validateSecretDestinations(ctx context.Context, obj *v20250701.Workspace) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (workspace *Workspace) validateWriteOnceProperties(ctx context.Context, oldObj *v20250701.Workspace, newObj *v20250701.Workspace) (admission.Warnings, error) {
