...
func Test_Workspace_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/operationalinsights/v1alpha1api20210601/workspace__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/operationalinsights/v1alpha1api20210601/workspaces_spec_arm_types_gen_test.go
	// Serialize to JSON
