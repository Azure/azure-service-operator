...
func (workspace *Workspace) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/operationalinsights/v1api20210601/Workspace, but got %T", obj)
	}
...
func (workspace *Workspace) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/operationalinsights/v1api20210601/Workspace, but got %T", resource)
	}
...
func (workspace *Workspace) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/operationalinsights/v1api20210601/Workspace, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210601.Workspace)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/operationalinsights/v1api20210601/Workspace, but got %T", oldResource)
	}
...
func (workspace *Workspace) createValidations() []func(ctx context.Context, obj *v20210601.Workspace) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20210601.Workspace) (admission.Warnings, error){
