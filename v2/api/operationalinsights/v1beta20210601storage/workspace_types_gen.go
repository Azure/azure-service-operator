...
type augmentConversionForWorkspace interface {
	AssignPropertiesFrom(src *v1api20210601s.Workspace) error
	AssignPropertiesTo(dst *v1api20210601s.Workspace) error
}
...
type augmentConversionForWorkspace_Spec interface {
	AssignPropertiesFrom(src *v1api20210601s.Workspace_Spec) error
	AssignPropertiesTo(dst *v1api20210601s.Workspace_Spec) error
}

type augmentConversionForWorkspace_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.Workspace_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.Workspace_STATUS) error
}
...
type augmentConversionForPrivateLinkScopedResource_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.PrivateLinkScopedResource_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.PrivateLinkScopedResource_STATUS) error
}

type augmentConversionForWorkspaceCapping interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceCapping) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceCapping) error
}

type augmentConversionForWorkspaceCapping_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceCapping_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceCapping_STATUS) error
}

type augmentConversionForWorkspaceFeatures interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceFeatures) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceFeatures) error
}

type augmentConversionForWorkspaceFeatures_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceFeatures_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceFeatures_STATUS) error
}

type augmentConversionForWorkspaceSku interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceSku) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceSku) error
}

type augmentConversionForWorkspaceSku_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.WorkspaceSku_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.WorkspaceSku_STATUS) error
}
