...
func (rule *NamespacesAuthorizationRule) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected notificationhubs/v1api20230901/storage/NamespacesAuthorizationRule but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-notificationhubs-azure-com-v1api20230901-namespacesauthorizationrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=notificationhubs.azure.com,resources=namespacesauthorizationrules,verbs=create;update,versions=v1api20230901,name=default.v1api20230901.namespacesauthorizationrules.notificationhubs.azure.com,admissionReviewVersions=v1
...
func (rule *NamespacesAuthorizationRule) validateConfigMapDestinations() (admission.Warnings, error) {
	if rule.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
var _ genruntime.ARMTransformer = &SharedAccessAuthorizationRuleProperties{}
...
func (properties *SharedAccessAuthorizationRuleProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &arm.SharedAccessAuthorizationRuleProperties{}

	// Set property "Rights":
	for _, item := range properties.Rights {
		var temp string
		temp = string(item)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *SharedAccessAuthorizationRuleProperties) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SharedAccessAuthorizationRuleProperties{}
}
...
func (properties *SharedAccessAuthorizationRuleProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SharedAccessAuthorizationRuleProperties)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SharedAccessAuthorizationRuleProperties, got %T", armInput)
	}
	...
	for _, item := range typedInput.Rights {
		var temp string
		temp = string(item)
		properties.Rights = append(properties.Rights, AccessRights(temp))
	}
...
var _ genruntime.FromARMConverter = &SharedAccessAuthorizationRuleProperties_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *SharedAccessAuthorizationRuleProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.SharedAccessAuthorizationRuleProperties_STATUS{}
}
...
func (properties *SharedAccessAuthorizationRuleProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.SharedAccessAuthorizationRuleProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.SharedAccessAuthorizationRuleProperties_STATUS, got %T", armInput)
	}

	// Set property "ClaimType":
	if typedInput.ClaimType != nil {
		claimType := *typedInput.ClaimType
		properties.ClaimType = &claimType
	}

	// Set property "ClaimValue":
	if typedInput.ClaimValue != nil {
		claimValue := *typedInput.ClaimValue
		properties.ClaimValue = &claimValue
	}
	...
	// Set property "ModifiedTime":
	if typedInput.ModifiedTime != nil {
		modifiedTime := *typedInput.ModifiedTime
	...
	for _, item := range typedInput.Rights {
		var temp string
		temp = string(item)
		properties.Rights = append(properties.Rights, AccessRights_STATUS(temp))
	}
...
func (properties *SharedAccessAuthorizationRuleProperties_STATUS) AssignProperties_From_SharedAccessAuthorizationRuleProperties_STATUS(source *storage.SharedAccessAuthorizationRuleProperties_STATUS) error {
	...
	// ClaimType
	properties.ClaimType = genruntime.ClonePointerToString(source.ClaimType)

	// ClaimValue
	properties.ClaimValue = genruntime.ClonePointerToString(source.ClaimValue)
	...
	// ModifiedTime
	properties.ModifiedTime = genruntime.ClonePointerToString(source.ModifiedTime)

	// Revision
	properties.Revision = genruntime.ClonePointerToInt(source.Revision)
...
func (properties *SharedAccessAuthorizationRuleProperties_STATUS) AssignProperties_To_SharedAccessAuthorizationRuleProperties_STATUS(destination *storage.SharedAccessAuthorizationRuleProperties_STATUS) error {
	...
	// ClaimType
	destination.ClaimType = genruntime.ClonePointerToString(properties.ClaimType)

	// ClaimValue
	destination.ClaimValue = genruntime.ClonePointerToString(properties.ClaimValue)
	...
	// ModifiedTime
	destination.ModifiedTime = genruntime.ClonePointerToString(properties.ModifiedTime)

	// Revision
	destination.Revision = genruntime.ClonePointerToInt(properties.Revision)
