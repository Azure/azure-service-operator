...
func (namespace *Namespace) validateConfigMapDestinations() (admission.Warnings, error) {
	...
	if namespace.Spec.OperatorSpec.ConfigMaps != nil {
		toValidate = []*genruntime.ConfigMapDestination{
			namespace.Spec.OperatorSpec.ConfigMaps.ServiceBusEndpoint,
		}
	}
	return configmaps.ValidateDestinations(namespace, toValidate, namespace.Spec.OperatorSpec.ConfigMapExpressions)
}
