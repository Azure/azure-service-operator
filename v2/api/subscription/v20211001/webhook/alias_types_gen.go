...
import (
	"context"
	"fmt"
	v20211001 "github.com/Azure/azure-service-operator/v2/api/subscription/v20211001"
...
// +kubebuilder:webhook:path=/mutate-subscription-azure-com-v20211001-alias,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=subscription.azure.com,resources=aliases,verbs=create;update,versions=v20211001,name=default.v20211001.aliases.subscription.azure.com,admissionReviewVersions=v1
...
func (alias *Alias) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/subscription/v20211001/Alias, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-subscription-azure-com-v20211001-alias,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=subscription.azure.com,resources=aliases,verbs=create;update,versions=v20211001,name=validate.v20211001.aliases.subscription.azure.com,admissionReviewVersions=v1
...
func (alias *Alias) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/subscription/v20211001/Alias, but got %T", resource)
	}
...
func (alias *Alias) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/subscription/v20211001/Alias, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211001.Alias)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/subscription/v20211001/Alias, but got %T", oldResource)
	}
