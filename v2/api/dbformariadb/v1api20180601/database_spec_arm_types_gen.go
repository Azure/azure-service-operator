...
var _ genruntime.ARMResourceSpec = &Database_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2018-06-01"
func (database Database_Spec_ARM) GetAPIVersion() string {
	return "2018-06-01"
}

// GetName returns the Name of the resource
func (database *Database_Spec_ARM) GetName() string {
	return database.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.DBforMariaDB/servers/databases"
func (database *Database_Spec_ARM) GetType() string {
