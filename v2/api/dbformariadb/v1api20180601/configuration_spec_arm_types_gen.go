...
type Configuration_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &Configuration_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2018-06-01"
func (configuration Configuration_Spec_ARM) GetAPIVersion() string {
	return "2018-06-01"
}

// GetName returns the Name of the resource
func (configuration *Configuration_Spec_ARM) GetName() string {
	return configuration.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.DBforMariaDB/servers/configurations"
func (configuration *Configuration_Spec_ARM) GetType() string {
