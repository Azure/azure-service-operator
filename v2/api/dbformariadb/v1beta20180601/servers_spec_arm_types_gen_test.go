...
func Test_Servers_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForServers_SpecARM, Servers_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServers_SpecARM runs a test to see if a specific instance of Servers_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForServers_SpecARM(subject Servers_SpecARM) string {
	// Serialize to JSON
...
// Generator of Servers_SpecARM instances for property testing - lazily instantiated by Servers_SpecARMGenerator()
var servers_SpecARMGenerator gopter.Gen

// Servers_SpecARMGenerator returns a generator of Servers_SpecARM instances for property testing.
// We first initialize servers_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Servers_SpecARMGenerator() gopter.Gen {
	if servers_SpecARMGenerator != nil {
		return servers_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServers_SpecARM(generators)
	servers_SpecARMGenerator = gen.Struct(reflect.TypeOf(Servers_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServers_SpecARM(generators)
	AddRelatedPropertyGeneratorsForServers_SpecARM(generators)
	servers_SpecARMGenerator = gen.Struct(reflect.TypeOf(Servers_SpecARM{}), generators)

	return servers_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForServers_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServers_SpecARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.AlphaString()
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForServers_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServers_SpecARM(gens map[string]gopter.Gen) {
