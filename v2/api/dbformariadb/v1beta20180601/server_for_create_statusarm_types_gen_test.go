...
func Test_ServerForCreate_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ServerForCreate_STATUSARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForServerForCreate_STATUSARM, ServerForCreate_STATUSARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServerForCreate_STATUSARM runs a test to see if a specific instance of ServerForCreate_STATUSARM round trips to JSON and back losslessly
func RunJSONSerializationTestForServerForCreate_STATUSARM(subject ServerForCreate_STATUSARM) string {
	// Serialize to JSON
	...
	var actual ServerForCreate_STATUSARM
...
// Generator of ServerForCreate_STATUSARM instances for property testing - lazily instantiated by
// ServerForCreate_STATUSARMGenerator()
var serverForCreate_STATUSARMGenerator gopter.Gen

// ServerForCreate_STATUSARMGenerator returns a generator of ServerForCreate_STATUSARM instances for property testing.
// We first initialize serverForCreate_STATUSARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServerForCreate_STATUSARMGenerator() gopter.Gen {
	if serverForCreate_STATUSARMGenerator != nil {
		return serverForCreate_STATUSARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServerForCreate_STATUSARM(generators)
	serverForCreate_STATUSARMGenerator = gen.Struct(reflect.TypeOf(ServerForCreate_STATUSARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServerForCreate_STATUSARM(generators)
	AddRelatedPropertyGeneratorsForServerForCreate_STATUSARM(generators)
	serverForCreate_STATUSARMGenerator = gen.Struct(reflect.TypeOf(ServerForCreate_STATUSARM{}), generators)

	return serverForCreate_STATUSARMGenerator
}

// AddIndependentPropertyGeneratorsForServerForCreate_STATUSARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServerForCreate_STATUSARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForServerForCreate_STATUSARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServerForCreate_STATUSARM(gens map[string]gopter.Gen) {
