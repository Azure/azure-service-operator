...
type WebApplicationFirewallPolicy_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &WebApplicationFirewallPolicy_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-05-01"
func (policy WebApplicationFirewallPolicy_Spec_ARM) GetAPIVersion() string {
	return "2022-05-01"
}

// GetName returns the Name of the resource
func (policy *WebApplicationFirewallPolicy_Spec_ARM) GetName() string {
	return policy.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Network/FrontDoorWebApplicationFirewallPolicies"
func (policy *WebApplicationFirewallPolicy_Spec_ARM) GetType() string {
