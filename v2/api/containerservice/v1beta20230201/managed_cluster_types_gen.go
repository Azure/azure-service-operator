...
func (cluster *ManagedCluster) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected containerservice/v1beta20230201storage/ManagedCluster but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v1beta20230201-managedcluster,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v1beta20230201,name=default.v1beta20230201.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v1beta20230201-managedcluster,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v1beta20230201,name=validate.v1beta20230201.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
