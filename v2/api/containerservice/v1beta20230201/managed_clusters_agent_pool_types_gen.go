...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v1beta20230201-managedclustersagentpool,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1beta20230201,name=default.v1beta20230201.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v1beta20230201-managedclustersagentpool,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1beta20230201,name=validate.v1beta20230201.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
