...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v1api20240901-managedclustersagentpool,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1api20240901,name=default.v1api20240901.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v1api20240901-managedclustersagentpool,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1api20240901,name=validate.v1api20240901.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
...
func (pool *ManagedClustersAgentPool_Spec) Initialize_From_ManagedClustersAgentPool_STATUS(source *ManagedClustersAgentPool_STATUS) error {
	...
	if source.SecurityProfile != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling Initialize_From_AgentPoolSecurityProfile_STATUS() to populate field SecurityProfile")
		}
		pool.SecurityProfile = &securityProfile
	} else {
		pool.SecurityProfile = nil
