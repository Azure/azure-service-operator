...
type ManagedClusterAzureMonitorProfileMetrics_STATUS struct {
	...
	ControlPlane *ManagedClusterAzureMonitorProfileMetricsControlPlane_STATUS `json:"controlPlane,omitempty"`
...
// for an overview.
type ManagedClusterAzureMonitorProfileMetricsControlPlane_STATUS struct {
...
type ManagedClusterSecurityProfileDefenderSecurityGating_STATUS struct {
	...
	Identities []ManagedClusterSecurityProfileDefenderSecurityGatingIdentity_STATUS `json:"identities"`
}
...
type ManagedClusterAppRoutingIstio_STATUS struct {
	...
	Mode *GatewayAPIIstioEnabled_STATUS `json:"mode,omitempty"`
}
...
type ManagedClusterSecurityProfileDefenderSecurityGatingIdentity_STATUS struct {
...
type GatewayAPIIstioEnabled_STATUS string

const (
	GatewayAPIIstioEnabled_STATUS_Disabled = GatewayAPIIstioEnabled_STATUS("Disabled")
	GatewayAPIIstioEnabled_STATUS_Enabled  = GatewayAPIIstioEnabled_STATUS("Enabled")
)

// Mapping from string to GatewayAPIIstioEnabled_STATUS
var gatewayAPIIstioEnabled_STATUS_Values = map[string]GatewayAPIIstioEnabled_STATUS{
	"disabled": GatewayAPIIstioEnabled_STATUS_Disabled,
	"enabled":  GatewayAPIIstioEnabled_STATUS_Enabled,
}
