...
// +kubebuilder:validation:Enum={"AzureContainerLinux","AzureLinux","AzureLinux3","CBLMariner","Ubuntu","Ubuntu2204","Ubuntu2404","Windows2019","Windows2022","Windows2025"}
type OSSKU string

const (
	OSSKU_AzureContainerLinux = OSSKU("AzureContainerLinux")
...
var oSSKU_Values = map[string]OSSKU{
	"azurecontainerlinux": OSSKU_AzureContainerLinux,
...
// +kubebuilder:validation:Enum={"KataVmIsolation","OCIContainer","WasmWasi"}
