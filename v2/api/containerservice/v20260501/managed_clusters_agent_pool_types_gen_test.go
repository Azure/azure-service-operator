...
func RunPropertyAssignmentTestForAgentPoolArtifactStreamingProfile(subject AgentPoolArtifactStreamingProfile) string {
	...
	var other storage.AgentPoolArtifactStreamingProfile
...
func RunPropertyAssignmentTestForAgentPoolArtifactStreamingProfile_STATUS(subject AgentPoolArtifactStreamingProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolArtifactStreamingProfile_STATUS
...
func RunPropertyAssignmentTestForAgentPoolGatewayProfile(subject AgentPoolGatewayProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolGatewayProfile
...
func RunPropertyAssignmentTestForAgentPoolGatewayProfile_STATUS(subject AgentPoolGatewayProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolGatewayProfile_STATUS
...
func Test_AgentPoolStatus_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from AgentPoolStatus_STATUS to AgentPoolStatus_STATUS via AssignProperties_To_AgentPoolStatus_STATUS & AssignProperties_From_AgentPoolStatus_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForAgentPoolStatus_STATUS, AgentPoolStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForAgentPoolStatus_STATUS tests if a specific instance of AgentPoolStatus_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForAgentPoolStatus_STATUS(subject AgentPoolStatus_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolStatus_STATUS
	err := copied.AssignProperties_To_AgentPoolStatus_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_AgentPoolStatus_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForAgentPoolUpgradeSettings(gens map[string]gopter.Gen) {
	...
	gens["UndrainableNodeBehavior"] = gen.PtrOf(gen.OneConstOf(UndrainableNodeBehavior_Cordon, UndrainableNodeBehavior_Schedule))
}
...
func AddIndependentPropertyGeneratorsForAgentPoolUpgradeSettings_STATUS(gens map[string]gopter.Gen) {
	...
	gens["MaxUnavailable"] = gen.PtrOf(gen.AlphaString())
	gens["NodeSoakDurationInMinutes"] = gen.PtrOf(gen.Int())
	gens["UndrainableNodeBehavior"] = gen.PtrOf(gen.OneConstOf(UndrainableNodeBehavior_STATUS_Cordon, UndrainableNodeBehavior_STATUS_Schedule))
}
...
func RunPropertyAssignmentTestForAgentPoolWindowsProfile(subject AgentPoolWindowsProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolWindowsProfile
...
func RunPropertyAssignmentTestForAgentPoolWindowsProfile_STATUS(subject AgentPoolWindowsProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.AgentPoolWindowsProfile_STATUS
...
func AddIndependentPropertyGeneratorsForGPUProfile(gens map[string]gopter.Gen) {
	gens["Driver"] = gen.PtrOf(gen.OneConstOf(GPUDriver_Install, GPUDriver_None))
}
...
func AddIndependentPropertyGeneratorsForGPUProfile_STATUS(gens map[string]gopter.Gen) {
	gens["Driver"] = gen.PtrOf(gen.OneConstOf(GPUDriver_STATUS_Install, GPUDriver_STATUS_None))
}
...
func Test_LocalDNSOverride_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from LocalDNSOverride to LocalDNSOverride via AssignProperties_To_LocalDNSOverride & AssignProperties_From_LocalDNSOverride returns original",
		prop.ForAll(RunPropertyAssignmentTestForLocalDNSOverride, LocalDNSOverrideGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForLocalDNSOverride tests if a specific instance of LocalDNSOverride can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForLocalDNSOverride(subject LocalDNSOverride) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.LocalDNSOverride
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual LocalDNSOverride
	err = actual.AssignProperties_From_LocalDNSOverride(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_LocalDNSOverride_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of LocalDNSOverride via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForLocalDNSOverride, LocalDNSOverrideGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForLocalDNSOverride runs a test to see if a specific instance of LocalDNSOverride round trips to JSON and back losslessly
func RunJSONSerializationTestForLocalDNSOverride(subject LocalDNSOverride) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of LocalDNSOverride instances for property testing - lazily instantiated by LocalDNSOverrideGenerator()
var localDNSOverrideGenerator gopter.Gen

// LocalDNSOverrideGenerator returns a generator of LocalDNSOverride instances for property testing.
func LocalDNSOverrideGenerator() gopter.Gen {
	if localDNSOverrideGenerator != nil {
		return localDNSOverrideGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSOverride(generators)
	localDNSOverrideGenerator = gen.Struct(reflect.TypeOf(LocalDNSOverride{}), generators)

	return localDNSOverrideGenerator
}

// AddIndependentPropertyGeneratorsForLocalDNSOverride is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForLocalDNSOverride(gens map[string]gopter.Gen) {
	gens["CacheDurationInSeconds"] = gen.PtrOf(gen.Int())
	gens["ForwardDestination"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ForwardDestination_ClusterCoreDNS, LocalDNSOverride_ForwardDestination_VnetDNS))
	gens["ForwardPolicy"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ForwardPolicy_Random, LocalDNSOverride_ForwardPolicy_RoundRobin, LocalDNSOverride_ForwardPolicy_Sequential))
	gens["MaxConcurrent"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_Protocol_ForceTCP, LocalDNSOverride_Protocol_PreferUDP))
	gens["QueryLogging"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_QueryLogging_Error, LocalDNSOverride_QueryLogging_Log))
	gens["ServeStale"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ServeStale_Disable, LocalDNSOverride_ServeStale_Immediate, LocalDNSOverride_ServeStale_Verify))
	gens["ServeStaleDurationInSeconds"] = gen.PtrOf(gen.Int())
}

func Test_LocalDNSOverride_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from LocalDNSOverride_STATUS to LocalDNSOverride_STATUS via AssignProperties_To_LocalDNSOverride_STATUS & AssignProperties_From_LocalDNSOverride_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForLocalDNSOverride_STATUS, LocalDNSOverride_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForLocalDNSOverride_STATUS tests if a specific instance of LocalDNSOverride_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForLocalDNSOverride_STATUS(subject LocalDNSOverride_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.LocalDNSOverride_STATUS
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual LocalDNSOverride_STATUS
	err = actual.AssignProperties_From_LocalDNSOverride_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_LocalDNSOverride_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of LocalDNSOverride_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForLocalDNSOverride_STATUS, LocalDNSOverride_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForLocalDNSOverride_STATUS runs a test to see if a specific instance of LocalDNSOverride_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForLocalDNSOverride_STATUS(subject LocalDNSOverride_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of LocalDNSOverride_STATUS instances for property testing - lazily instantiated by
// LocalDNSOverride_STATUSGenerator()
var localDNSOverride_STATUSGenerator gopter.Gen

// LocalDNSOverride_STATUSGenerator returns a generator of LocalDNSOverride_STATUS instances for property testing.
func LocalDNSOverride_STATUSGenerator() gopter.Gen {
	if localDNSOverride_STATUSGenerator != nil {
		return localDNSOverride_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSOverride_STATUS(generators)
	localDNSOverride_STATUSGenerator = gen.Struct(reflect.TypeOf(LocalDNSOverride_STATUS{}), generators)

	return localDNSOverride_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForLocalDNSOverride_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForLocalDNSOverride_STATUS(gens map[string]gopter.Gen) {
	gens["CacheDurationInSeconds"] = gen.PtrOf(gen.Int())
	gens["ForwardDestination"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ForwardDestination_STATUS_ClusterCoreDNS, LocalDNSOverride_ForwardDestination_STATUS_VnetDNS))
	gens["ForwardPolicy"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ForwardPolicy_STATUS_Random, LocalDNSOverride_ForwardPolicy_STATUS_RoundRobin, LocalDNSOverride_ForwardPolicy_STATUS_Sequential))
	gens["MaxConcurrent"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_Protocol_STATUS_ForceTCP, LocalDNSOverride_Protocol_STATUS_PreferUDP))
	gens["QueryLogging"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_QueryLogging_STATUS_Error, LocalDNSOverride_QueryLogging_STATUS_Log))
	gens["ServeStale"] = gen.PtrOf(gen.OneConstOf(LocalDNSOverride_ServeStale_STATUS_Disable, LocalDNSOverride_ServeStale_STATUS_Immediate, LocalDNSOverride_ServeStale_STATUS_Verify))
	gens["ServeStaleDurationInSeconds"] = gen.PtrOf(gen.Int())
}

func Test_LocalDNSProfile_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from LocalDNSProfile to LocalDNSProfile via AssignProperties_To_LocalDNSProfile & AssignProperties_From_LocalDNSProfile returns original",
		prop.ForAll(RunPropertyAssignmentTestForLocalDNSProfile, LocalDNSProfileGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForLocalDNSProfile tests if a specific instance of LocalDNSProfile can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForLocalDNSProfile(subject LocalDNSProfile) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.LocalDNSProfile
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual LocalDNSProfile
	err = actual.AssignProperties_From_LocalDNSProfile(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_LocalDNSProfile_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of LocalDNSProfile via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForLocalDNSProfile, LocalDNSProfileGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForLocalDNSProfile runs a test to see if a specific instance of LocalDNSProfile round trips to JSON and back losslessly
func RunJSONSerializationTestForLocalDNSProfile(subject LocalDNSProfile) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of LocalDNSProfile instances for property testing - lazily instantiated by LocalDNSProfileGenerator()
var localDNSProfileGenerator gopter.Gen

// LocalDNSProfileGenerator returns a generator of LocalDNSProfile instances for property testing.
// We first initialize localDNSProfileGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func LocalDNSProfileGenerator() gopter.Gen {
	if localDNSProfileGenerator != nil {
		return localDNSProfileGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSProfile(generators)
	localDNSProfileGenerator = gen.Struct(reflect.TypeOf(LocalDNSProfile{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSProfile(generators)
	AddRelatedPropertyGeneratorsForLocalDNSProfile(generators)
	localDNSProfileGenerator = gen.Struct(reflect.TypeOf(LocalDNSProfile{}), generators)

	return localDNSProfileGenerator
}

// AddIndependentPropertyGeneratorsForLocalDNSProfile is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForLocalDNSProfile(gens map[string]gopter.Gen) {
	gens["Mode"] = gen.PtrOf(gen.OneConstOf(LocalDNSProfile_Mode_Disabled, LocalDNSProfile_Mode_Preferred, LocalDNSProfile_Mode_Required))
}

// AddRelatedPropertyGeneratorsForLocalDNSProfile is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForLocalDNSProfile(gens map[string]gopter.Gen) {
	gens["KubeDNSOverrides"] = gen.MapOf(
		gen.AlphaString(),
		LocalDNSOverrideGenerator())
	gens["VnetDNSOverrides"] = gen.MapOf(
		gen.AlphaString(),
		LocalDNSOverrideGenerator())
}

func Test_LocalDNSProfile_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from LocalDNSProfile_STATUS to LocalDNSProfile_STATUS via AssignProperties_To_LocalDNSProfile_STATUS & AssignProperties_From_LocalDNSProfile_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForLocalDNSProfile_STATUS, LocalDNSProfile_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForLocalDNSProfile_STATUS tests if a specific instance of LocalDNSProfile_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForLocalDNSProfile_STATUS(subject LocalDNSProfile_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.LocalDNSProfile_STATUS
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual LocalDNSProfile_STATUS
	err = actual.AssignProperties_From_LocalDNSProfile_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_LocalDNSProfile_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of LocalDNSProfile_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForLocalDNSProfile_STATUS, LocalDNSProfile_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForLocalDNSProfile_STATUS runs a test to see if a specific instance of LocalDNSProfile_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForLocalDNSProfile_STATUS(subject LocalDNSProfile_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of LocalDNSProfile_STATUS instances for property testing - lazily instantiated by
// LocalDNSProfile_STATUSGenerator()
var localDNSProfile_STATUSGenerator gopter.Gen

// LocalDNSProfile_STATUSGenerator returns a generator of LocalDNSProfile_STATUS instances for property testing.
// We first initialize localDNSProfile_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func LocalDNSProfile_STATUSGenerator() gopter.Gen {
	if localDNSProfile_STATUSGenerator != nil {
		return localDNSProfile_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSProfile_STATUS(generators)
	localDNSProfile_STATUSGenerator = gen.Struct(reflect.TypeOf(LocalDNSProfile_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForLocalDNSProfile_STATUS(generators)
	AddRelatedPropertyGeneratorsForLocalDNSProfile_STATUS(generators)
	localDNSProfile_STATUSGenerator = gen.Struct(reflect.TypeOf(LocalDNSProfile_STATUS{}), generators)

	return localDNSProfile_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForLocalDNSProfile_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForLocalDNSProfile_STATUS(gens map[string]gopter.Gen) {
	gens["Mode"] = gen.PtrOf(gen.OneConstOf(LocalDNSProfile_Mode_STATUS_Disabled, LocalDNSProfile_Mode_STATUS_Preferred, LocalDNSProfile_Mode_STATUS_Required))
	gens["State"] = gen.PtrOf(gen.OneConstOf(LocalDNSState_STATUS_Disabled, LocalDNSState_STATUS_Enabled))
}

// AddRelatedPropertyGeneratorsForLocalDNSProfile_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForLocalDNSProfile_STATUS(gens map[string]gopter.Gen) {
	gens["KubeDNSOverrides"] = gen.MapOf(
		gen.AlphaString(),
		LocalDNSOverride_STATUSGenerator())
	gens["VnetDNSOverrides"] = gen.MapOf(
...
func RunPropertyAssignmentTestForManagedClustersAgentPoolOperatorSpec(subject ManagedClustersAgentPoolOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ManagedClustersAgentPoolOperatorSpec
...
func RunPropertyAssignmentTestForManagedClustersAgentPool_STATUS(subject ManagedClustersAgentPool_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ManagedClustersAgentPool_STATUS
...
func RunPropertyAssignmentTestForManagedClustersAgentPool_Spec(subject ManagedClustersAgentPool_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ManagedClustersAgentPool_Spec
...
func AddIndependentPropertyGeneratorsForPortRange(gens map[string]gopter.Gen) {
	...
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(Protocol_TCP, Protocol_UDP))
}
...
func AddIndependentPropertyGeneratorsForPortRange_STATUS(gens map[string]gopter.Gen) {
	gens["PortEnd"] = gen.PtrOf(gen.Int())
	gens["PortStart"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(Protocol_STATUS_TCP, Protocol_STATUS_UDP))
}
...
func AddIndependentPropertyGeneratorsForPowerState(gens map[string]gopter.Gen) {
	gens["Code"] = gen.PtrOf(gen.OneConstOf(Code_Running, Code_Stopped))
}
...
func RunPropertyAssignmentTestForVirtualMachineNodes(subject VirtualMachineNodes) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.VirtualMachineNodes
...
func RunPropertyAssignmentTestForVirtualMachineNodes_STATUS(subject VirtualMachineNodes_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.VirtualMachineNodes_STATUS
