...
func (pool *ManagedClustersAgentPool_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if pool.LocalDNSProfile != nil {
		localDNSProfile_ARM, err := pool.LocalDNSProfile.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		localDNSProfile := *localDNSProfile_ARM.(*arm.LocalDNSProfile)
		result.Properties.LocalDNSProfile = &localDNSProfile
	}
	...
	if pool.OsType != nil {
		...
		osType := arm.ManagedClusterAgentPoolProfileProperties_OsType(temp)
	...
	if pool.ScaleSetEvictionPolicy != nil {
		...
		scaleSetEvictionPolicy := arm.ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy(temp)
	...
	if pool.ScaleSetPriority != nil {
		...
		scaleSetPriority := arm.ManagedClusterAgentPoolProfileProperties_ScaleSetPriority(temp)
...
func (pool *ManagedClustersAgentPool_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.LocalDNSProfile != nil {
			var localDNSProfile1 LocalDNSProfile
			err := localDNSProfile1.PopulateFromARM(owner, *typedInput.Properties.LocalDNSProfile)
			if err != nil {
				return err
			}
			localDNSProfile := localDNSProfile1
			pool.LocalDNSProfile = &localDNSProfile
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.OsType != nil {
			...
			osType := ManagedClusterAgentPoolProfileProperties_OsType(temp)
			pool.OsType = &osType
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ScaleSetEvictionPolicy != nil {
			...
			scaleSetEvictionPolicy := ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ScaleSetPriority != nil {
			...
			scaleSetPriority := ManagedClusterAgentPoolProfileProperties_ScaleSetPriority(temp)
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_From_ManagedClustersAgentPool_Spec(source *storage.ManagedClustersAgentPool_Spec) error {
	...
	if source.OsType != nil {
		...
		osTypeTemp := genruntime.ToEnum(osType, managedClusterAgentPoolProfileProperties_OsType_Values)
	...
	if source.ScaleSetEvictionPolicy != nil {
		...
		scaleSetEvictionPolicyTemp := genruntime.ToEnum(scaleSetEvictionPolicy, managedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_Values)
	...
	if source.ScaleSetPriority != nil {
		...
		scaleSetPriorityTemp := genruntime.ToEnum(scaleSetPriority, managedClusterAgentPoolProfileProperties_ScaleSetPriority_Values)
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_To_ManagedClustersAgentPool_Spec(destination *storage.ManagedClustersAgentPool_Spec) error {
	...
	if pool.LocalDNSProfile != nil {
		...
		err := pool.LocalDNSProfile.AssignProperties_To_LocalDNSProfile(&localDNSProfile)
		if err != nil {
...
func (pool *ManagedClustersAgentPool_Spec) Initialize_From_ManagedClustersAgentPool_STATUS(source *ManagedClustersAgentPool_STATUS) error {
	...
	if source.ArtifactStreamingProfile != nil {
		var artifactStreamingProfile AgentPoolArtifactStreamingProfile
		err := artifactStreamingProfile.Initialize_From_AgentPoolArtifactStreamingProfile_STATUS(source.ArtifactStreamingProfile)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_AgentPoolArtifactStreamingProfile_STATUS() to populate field ArtifactStreamingProfile")
		}
		pool.ArtifactStreamingProfile = &artifactStreamingProfile
	} else {
		pool.ArtifactStreamingProfile = nil
	...
	if source.GatewayProfile != nil {
		var gatewayProfile AgentPoolGatewayProfile
		err := gatewayProfile.Initialize_From_AgentPoolGatewayProfile_STATUS(source.GatewayProfile)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_AgentPoolGatewayProfile_STATUS() to populate field GatewayProfile")
		}
		pool.GatewayProfile = &gatewayProfile
	} else {
		pool.GatewayProfile = nil
	...
	if source.GpuProfile != nil {
		var gpuProfile GPUProfile
		err := gpuProfile.Initialize_From_GPUProfile_STATUS(source.GpuProfile)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_GPUProfile_STATUS() to populate field GpuProfile")
		}
		pool.GpuProfile = &gpuProfile
	} else {
		pool.GpuProfile = nil
	...
	if source.LocalDNSProfile != nil {
		var localDNSProfile LocalDNSProfile
		err := localDNSProfile.Initialize_From_LocalDNSProfile_STATUS(source.LocalDNSProfile)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_LocalDNSProfile_STATUS() to populate field LocalDNSProfile")
		}
		pool.LocalDNSProfile = &localDNSProfile
	} else {
		pool.LocalDNSProfile = nil
	...
	// OsType
	if source.OsType != nil {
		osType := genruntime.ToEnum(string(*source.OsType), managedClusterAgentPoolProfileProperties_OsType_Values)
		pool.OsType = &osType
	} else {
		pool.OsType = nil
	}
	...
	// PodIPAllocationMode
	if source.PodIPAllocationMode != nil {
		podIPAllocationMode := genruntime.ToEnum(string(*source.PodIPAllocationMode), podIPAllocationMode_Values)
		pool.PodIPAllocationMode = &podIPAllocationMode
	} else {
		pool.PodIPAllocationMode = nil
	}
	...
	// ScaleSetEvictionPolicy
	if source.ScaleSetEvictionPolicy != nil {
		scaleSetEvictionPolicy := genruntime.ToEnum(string(*source.ScaleSetEvictionPolicy), managedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_Values)
		pool.ScaleSetEvictionPolicy = &scaleSetEvictionPolicy
	} else {
		pool.ScaleSetEvictionPolicy = nil
	}
	...
	// ScaleSetPriority
	if source.ScaleSetPriority != nil {
		scaleSetPriority := genruntime.ToEnum(string(*source.ScaleSetPriority), managedClusterAgentPoolProfileProperties_ScaleSetPriority_Values)
		pool.ScaleSetPriority = &scaleSetPriority
	} else {
		pool.ScaleSetPriority = nil
	}
	...
	if source.VirtualMachineNodesStatus != nil {
		...
		for virtualMachineNodesStatusIndex, virtualMachineNodesStatusItem := range source.VirtualMachineNodesStatus {
			var virtualMachineNodesStatus VirtualMachineNodes
			err := virtualMachineNodesStatus.Initialize_From_VirtualMachineNodes_STATUS(&virtualMachineNodesStatusItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_VirtualMachineNodes_STATUS() to populate field VirtualMachineNodesStatus")
			}
			virtualMachineNodesStatusList[virtualMachineNodesStatusIndex] = virtualMachineNodesStatus
		}
		pool.VirtualMachineNodesStatus = virtualMachineNodesStatusList
	...
	if source.VirtualMachinesProfile != nil {
		var virtualMachinesProfile VirtualMachinesProfile
		err := virtualMachinesProfile.Initialize_From_VirtualMachinesProfile_STATUS(source.VirtualMachinesProfile)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_VirtualMachinesProfile_STATUS() to populate field VirtualMachinesProfile")
		}
		pool.VirtualMachinesProfile = &virtualMachinesProfile
	} else {
		pool.VirtualMachinesProfile = nil
...
func (pool *ManagedClustersAgentPool_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.OsType != nil {
			var temp string
			temp = string(*typedInput.Properties.OsType)
			osType := ManagedClusterAgentPoolProfileProperties_OsType_STATUS(temp)
			pool.OsType = &osType
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ScaleSetEvictionPolicy != nil {
			var temp string
			temp = string(*typedInput.Properties.ScaleSetEvictionPolicy)
			scaleSetEvictionPolicy := ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS(temp)
			pool.ScaleSetEvictionPolicy = &scaleSetEvictionPolicy
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ScaleSetPriority != nil {
			var temp string
			temp = string(*typedInput.Properties.ScaleSetPriority)
			scaleSetPriority := ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS(temp)
			pool.ScaleSetPriority = &scaleSetPriority
		}
	}
...
func (pool *ManagedClustersAgentPool_STATUS) AssignProperties_From_ManagedClustersAgentPool_STATUS(source *storage.ManagedClustersAgentPool_STATUS) error {
	...
	if source.OsType != nil {
		osType := *source.OsType
		osTypeTemp := genruntime.ToEnum(osType, managedClusterAgentPoolProfileProperties_OsType_STATUS_Values)
		pool.OsType = &osTypeTemp
	} else {
		pool.OsType = nil
	}
	...
	if source.ScaleSetEvictionPolicy != nil {
		scaleSetEvictionPolicy := *source.ScaleSetEvictionPolicy
		scaleSetEvictionPolicyTemp := genruntime.ToEnum(scaleSetEvictionPolicy, managedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Values)
		pool.ScaleSetEvictionPolicy = &scaleSetEvictionPolicyTemp
	} else {
		pool.ScaleSetEvictionPolicy = nil
	}
	...
	if source.ScaleSetPriority != nil {
		scaleSetPriority := *source.ScaleSetPriority
		scaleSetPriorityTemp := genruntime.ToEnum(scaleSetPriority, managedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Values)
		pool.ScaleSetPriority = &scaleSetPriorityTemp
	} else {
		pool.ScaleSetPriority = nil
	}
...
func (pool *ManagedClustersAgentPool_STATUS) AssignProperties_To_ManagedClustersAgentPool_STATUS(destination *storage.ManagedClustersAgentPool_STATUS) error {
	...
	if pool.LocalDNSProfile != nil {
		...
		err := pool.LocalDNSProfile.AssignProperties_To_LocalDNSProfile_STATUS(&localDNSProfile)
		if err != nil {
...
// Initialize_From_AgentPoolArtifactStreamingProfile_STATUS populates our AgentPoolArtifactStreamingProfile from the provided source AgentPoolArtifactStreamingProfile_STATUS
func (profile *AgentPoolArtifactStreamingProfile) Initialize_From_AgentPoolArtifactStreamingProfile_STATUS(source *AgentPoolArtifactStreamingProfile_STATUS) error {
...
func (profile *AgentPoolGatewayProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &arm.AgentPoolGatewayProfile{}
...
func (profile *AgentPoolGatewayProfile) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AgentPoolGatewayProfile{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *AgentPoolGatewayProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AgentPoolGatewayProfile)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AgentPoolGatewayProfile, got %T", armInput)
	}
...
// Initialize_From_AgentPoolGatewayProfile_STATUS populates our AgentPoolGatewayProfile from the provided source AgentPoolGatewayProfile_STATUS
func (profile *AgentPoolGatewayProfile) Initialize_From_AgentPoolGatewayProfile_STATUS(source *AgentPoolGatewayProfile_STATUS) error {
...
func (profile *AgentPoolGatewayProfile_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AgentPoolGatewayProfile_STATUS{}
}
...
func (profile *AgentPoolGatewayProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AgentPoolGatewayProfile_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AgentPoolGatewayProfile_STATUS, got %T", armInput)
	}
...
func (profile *AgentPoolSecurityProfile) Initialize_From_AgentPoolSecurityProfile_STATUS(source *AgentPoolSecurityProfile_STATUS) error {
	...
	// SshAccess
	if source.SshAccess != nil {
		sshAccess := genruntime.ToEnum(string(*source.SshAccess), agentPoolSSHAccess_Values)
		profile.SshAccess = &sshAccess
	} else {
		profile.SshAccess = nil
	}
...
var _ genruntime.FromARMConverter = &AgentPoolStatus_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *AgentPoolStatus_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AgentPoolStatus_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *AgentPoolStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AgentPoolStatus_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AgentPoolStatus_STATUS, got %T", armInput)
	}
...
func (settings *AgentPoolUpgradeSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "MaxUnavailable":
	if settings.MaxUnavailable != nil {
	...
	if settings.UndrainableNodeBehavior != nil {
		var temp string
		temp = string(*settings.UndrainableNodeBehavior)
		undrainableNodeBehavior := arm.UndrainableNodeBehavior(temp)
...
func (settings *AgentPoolUpgradeSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "MaxUnavailable":
	if typedInput.MaxUnavailable != nil {
		maxUnavailable := *typedInput.MaxUnavailable
		settings.MaxUnavailable = &maxUnavailable
	}
	...
	if typedInput.UndrainableNodeBehavior != nil {
		var temp string
		temp = string(*typedInput.UndrainableNodeBehavior)
		undrainableNodeBehavior := UndrainableNodeBehavior(temp)
...
func (settings *AgentPoolUpgradeSettings) AssignProperties_From_AgentPoolUpgradeSettings(source *storage.AgentPoolUpgradeSettings) error {
	...
	if source.UndrainableNodeBehavior != nil {
		...
		undrainableNodeBehaviorTemp := genruntime.ToEnum(undrainableNodeBehavior, undrainableNodeBehavior_Values)
...
func (settings *AgentPoolUpgradeSettings) Initialize_From_AgentPoolUpgradeSettings_STATUS(source *AgentPoolUpgradeSettings_STATUS) error {
	...
	// UndrainableNodeBehavior
	if source.UndrainableNodeBehavior != nil {
		undrainableNodeBehavior := genruntime.ToEnum(string(*source.UndrainableNodeBehavior), undrainableNodeBehavior_Values)
		settings.UndrainableNodeBehavior = &undrainableNodeBehavior
	} else {
		settings.UndrainableNodeBehavior = nil
	}
...
func (settings *AgentPoolUpgradeSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.UndrainableNodeBehavior != nil {
		var temp string
		temp = string(*typedInput.UndrainableNodeBehavior)
		undrainableNodeBehavior := UndrainableNodeBehavior_STATUS(temp)
		settings.UndrainableNodeBehavior = &undrainableNodeBehavior
	}
...
func (settings *AgentPoolUpgradeSettings_STATUS) AssignProperties_From_AgentPoolUpgradeSettings_STATUS(source *storage.AgentPoolUpgradeSettings_STATUS) error {
	...
	if source.UndrainableNodeBehavior != nil {
		undrainableNodeBehavior := *source.UndrainableNodeBehavior
		undrainableNodeBehaviorTemp := genruntime.ToEnum(undrainableNodeBehavior, undrainableNodeBehavior_STATUS_Values)
		settings.UndrainableNodeBehavior = &undrainableNodeBehaviorTemp
	} else {
		settings.UndrainableNodeBehavior = nil
	}
...
var _ genruntime.ARMTransformer = &GPUProfile{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (profile *GPUProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if profile == nil {
		return nil, nil
	}
	result := &arm.GPUProfile{}

	// Set property "Driver":
	if profile.Driver != nil {
		var temp string
		temp = string(*profile.Driver)
		driver := arm.GPUDriver(temp)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *GPUProfile) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GPUProfile{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *GPUProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GPUProfile)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GPUProfile, got %T", armInput)
	}

	// Set property "Driver":
	if typedInput.Driver != nil {
		var temp string
		temp = string(*typedInput.Driver)
		driver := GPUDriver(temp)
...
func (profile *GPUProfile) AssignProperties_From_GPUProfile(source *storage.GPUProfile) error {
	...
	if source.Driver != nil {
		...
		driverTemp := genruntime.ToEnum(driver, gPUDriver_Values)
		profile.Driver = &driverTemp
	} else {
		profile.Driver = nil
	}
...
// Initialize_From_GPUProfile_STATUS populates our GPUProfile from the provided source GPUProfile_STATUS
func (profile *GPUProfile) Initialize_From_GPUProfile_STATUS(source *GPUProfile_STATUS) error {

	// Driver
	if source.Driver != nil {
		driver := genruntime.ToEnum(string(*source.Driver), gPUDriver_Values)
		profile.Driver = &driver
	} else {
		profile.Driver = nil
	}
...
var _ genruntime.FromARMConverter = &GPUProfile_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *GPUProfile_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.GPUProfile_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *GPUProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.GPUProfile_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.GPUProfile_STATUS, got %T", armInput)
	}
...
func (profile *GPUProfile_STATUS) AssignProperties_From_GPUProfile_STATUS(source *storage.GPUProfile_STATUS) error {
	...
	if source.Driver != nil {
		driver := *source.Driver
		driverTemp := genruntime.ToEnum(driver, gPUDriver_STATUS_Values)
		profile.Driver = &driverTemp
	} else {
		profile.Driver = nil
	}
...
var _ genruntime.ARMTransformer = &LocalDNSProfile{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (profile *LocalDNSProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if profile == nil {
		return nil, nil
	}
	result := &arm.LocalDNSProfile{}

	// Set property "KubeDNSOverrides":
	if profile.KubeDNSOverrides != nil {
		result.KubeDNSOverrides = make(map[string]arm.LocalDNSOverride, len(profile.KubeDNSOverrides))
		for key, value := range profile.KubeDNSOverrides {
			value_ARM, err := value.ConvertToARM(resolved)
			if err != nil {
				return nil, err
			}
			result.KubeDNSOverrides[key] = *value_ARM.(*arm.LocalDNSOverride)
		}
	}
	...
	if profile.Mode != nil {
		...
		mode := arm.LocalDNSProfile_Mode(temp)
		result.Mode = &mode
	}

	// Set property "VnetDNSOverrides":
	if profile.VnetDNSOverrides != nil {
		result.VnetDNSOverrides = make(map[string]arm.LocalDNSOverride, len(profile.VnetDNSOverrides))
		for key, value := range profile.VnetDNSOverrides {
			value_ARM, err := value.ConvertToARM(resolved)
			if err != nil {
				return nil, err
			}
			result.VnetDNSOverrides[key] = *value_ARM.(*arm.LocalDNSOverride)
		}
	}
	return result, nil
}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *LocalDNSProfile) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LocalDNSProfile{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *LocalDNSProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LocalDNSProfile)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LocalDNSProfile, got %T", armInput)
	}

	// Set property "KubeDNSOverrides":
	if typedInput.KubeDNSOverrides != nil {
		profile.KubeDNSOverrides = make(map[string]LocalDNSOverride, len(typedInput.KubeDNSOverrides))
		for key, value := range typedInput.KubeDNSOverrides {
			var value1 LocalDNSOverride
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
				return err
			}
			profile.KubeDNSOverrides[key] = value1
		}
	}
	...
	if typedInput.Mode != nil {
		...
		mode := LocalDNSProfile_Mode(temp)
		profile.Mode = &mode
	}

	// Set property "VnetDNSOverrides":
	if typedInput.VnetDNSOverrides != nil {
		profile.VnetDNSOverrides = make(map[string]LocalDNSOverride, len(typedInput.VnetDNSOverrides))
		for key, value := range typedInput.VnetDNSOverrides {
			var value1 LocalDNSOverride
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
				return err
			}
			profile.VnetDNSOverrides[key] = value1
		}
	}
...
func (profile *LocalDNSProfile) AssignProperties_From_LocalDNSProfile(source *storage.LocalDNSProfile) error {

	// KubeDNSOverrides
	if source.KubeDNSOverrides != nil {
		kubeDNSOverrideMap := make(map[string]LocalDNSOverride, len(source.KubeDNSOverrides))
		for kubeDNSOverrideKey, kubeDNSOverrideValue := range source.KubeDNSOverrides {
			var kubeDNSOverride LocalDNSOverride
			err := kubeDNSOverride.AssignProperties_From_LocalDNSOverride(&kubeDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LocalDNSOverride() to populate field KubeDNSOverrides")
			}
			kubeDNSOverrideMap[kubeDNSOverrideKey] = kubeDNSOverride
		}
		profile.KubeDNSOverrides = kubeDNSOverrideMap
	} else {
		profile.KubeDNSOverrides = nil
	}

	// Mode
	if source.Mode != nil {
		mode := *source.Mode
		modeTemp := genruntime.ToEnum(mode, localDNSProfile_Mode_Values)
	...
	// VnetDNSOverrides
	if source.VnetDNSOverrides != nil {
		vnetDNSOverrideMap := make(map[string]LocalDNSOverride, len(source.VnetDNSOverrides))
		for vnetDNSOverrideKey, vnetDNSOverrideValue := range source.VnetDNSOverrides {
			var vnetDNSOverride LocalDNSOverride
			err := vnetDNSOverride.AssignProperties_From_LocalDNSOverride(&vnetDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LocalDNSOverride() to populate field VnetDNSOverrides")
			}
			vnetDNSOverrideMap[vnetDNSOverrideKey] = vnetDNSOverride
		}
		profile.VnetDNSOverrides = vnetDNSOverrideMap
	} else {
		profile.VnetDNSOverrides = nil
	}
...
func (profile *LocalDNSProfile) AssignProperties_To_LocalDNSProfile(destination *storage.LocalDNSProfile) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// KubeDNSOverrides
	if profile.KubeDNSOverrides != nil {
		kubeDNSOverrideMap := make(map[string]storage.LocalDNSOverride, len(profile.KubeDNSOverrides))
		for kubeDNSOverrideKey, kubeDNSOverrideValue := range profile.KubeDNSOverrides {
			var kubeDNSOverride storage.LocalDNSOverride
		...
		destination.KubeDNSOverrides = kubeDNSOverrideMap
	} else {
		destination.KubeDNSOverrides = nil
	}
	...
	// VnetDNSOverrides
	if profile.VnetDNSOverrides != nil {
		vnetDNSOverrideMap := make(map[string]storage.LocalDNSOverride, len(profile.VnetDNSOverrides))
		for vnetDNSOverrideKey, vnetDNSOverrideValue := range profile.VnetDNSOverrides {
			var vnetDNSOverride storage.LocalDNSOverride
		...
		destination.VnetDNSOverrides = vnetDNSOverrideMap
	} else {
		destination.VnetDNSOverrides = nil
	}
...
// Initialize_From_LocalDNSProfile_STATUS populates our LocalDNSProfile from the provided source LocalDNSProfile_STATUS
func (profile *LocalDNSProfile) Initialize_From_LocalDNSProfile_STATUS(source *LocalDNSProfile_STATUS) error {
	...
	if source.KubeDNSOverrides != nil {
		...
		for kubeDNSOverrideKey, kubeDNSOverrideValue := range source.KubeDNSOverrides {
			var kubeDNSOverride LocalDNSOverride
			err := kubeDNSOverride.Initialize_From_LocalDNSOverride_STATUS(&kubeDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_LocalDNSOverride_STATUS() to populate field KubeDNSOverrides")
			}
			kubeDNSOverrideMap[kubeDNSOverrideKey] = kubeDNSOverride
		}
		profile.KubeDNSOverrides = kubeDNSOverrideMap
	...
	// Mode
	if source.Mode != nil {
		mode := genruntime.ToEnum(string(*source.Mode), localDNSProfile_Mode_Values)
		profile.Mode = &mode
	} else {
		profile.Mode = nil
	}
	...
	if source.VnetDNSOverrides != nil {
		...
		for vnetDNSOverrideKey, vnetDNSOverrideValue := range source.VnetDNSOverrides {
			var vnetDNSOverride LocalDNSOverride
			err := vnetDNSOverride.Initialize_From_LocalDNSOverride_STATUS(&vnetDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_LocalDNSOverride_STATUS() to populate field VnetDNSOverrides")
			}
			vnetDNSOverrideMap[vnetDNSOverrideKey] = vnetDNSOverride
		}
		profile.VnetDNSOverrides = vnetDNSOverrideMap
...
type LocalDNSProfile_STATUS struct {
	// KubeDNSOverrides: KubeDNS overrides apply to DNS traffic from pods with dnsPolicy:ClusterFirst (referred to as KubeDNS
	// traffic).
	KubeDNSOverrides map[string]LocalDNSOverride_STATUS `json:"kubeDNSOverrides,omitempty"`
	...
	// VnetDNSOverrides: VnetDNS overrides apply to DNS traffic from pods with dnsPolicy:default or kubelet (referred to as
	// VnetDNS traffic).
	VnetDNSOverrides map[string]LocalDNSOverride_STATUS `json:"vnetDNSOverrides,omitempty"`
}

var _ genruntime.FromARMConverter = &LocalDNSProfile_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *LocalDNSProfile_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LocalDNSProfile_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *LocalDNSProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LocalDNSProfile_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LocalDNSProfile_STATUS, got %T", armInput)
	}

	// Set property "KubeDNSOverrides":
	if typedInput.KubeDNSOverrides != nil {
		profile.KubeDNSOverrides = make(map[string]LocalDNSOverride_STATUS, len(typedInput.KubeDNSOverrides))
		for key, value := range typedInput.KubeDNSOverrides {
			var value1 LocalDNSOverride_STATUS
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
				return err
			}
	...
	if typedInput.Mode != nil {
		var temp string
		temp = string(*typedInput.Mode)
		mode := LocalDNSProfile_Mode_STATUS(temp)
		profile.Mode = &mode
	}
	...
	if typedInput.State != nil {
		...
		state := LocalDNSState_STATUS(temp)
		profile.State = &state
	}

	// Set property "VnetDNSOverrides":
	if typedInput.VnetDNSOverrides != nil {
		profile.VnetDNSOverrides = make(map[string]LocalDNSOverride_STATUS, len(typedInput.VnetDNSOverrides))
		for key, value := range typedInput.VnetDNSOverrides {
			var value1 LocalDNSOverride_STATUS
			err := value1.PopulateFromARM(owner, value)
			if err != nil {
...
func (profile *LocalDNSProfile_STATUS) AssignProperties_From_LocalDNSProfile_STATUS(source *storage.LocalDNSProfile_STATUS) error {

	// KubeDNSOverrides
	if source.KubeDNSOverrides != nil {
		kubeDNSOverrideMap := make(map[string]LocalDNSOverride_STATUS, len(source.KubeDNSOverrides))
		for kubeDNSOverrideKey, kubeDNSOverrideValue := range source.KubeDNSOverrides {
			var kubeDNSOverride LocalDNSOverride_STATUS
			err := kubeDNSOverride.AssignProperties_From_LocalDNSOverride_STATUS(&kubeDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LocalDNSOverride_STATUS() to populate field KubeDNSOverrides")
			}
			kubeDNSOverrideMap[kubeDNSOverrideKey] = kubeDNSOverride
		}
		profile.KubeDNSOverrides = kubeDNSOverrideMap
	...
	if source.Mode != nil {
		mode := *source.Mode
		modeTemp := genruntime.ToEnum(mode, localDNSProfile_Mode_STATUS_Values)
		profile.Mode = &modeTemp
	} else {
		profile.Mode = nil
	}
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, localDNSState_STATUS_Values)
	...
	// VnetDNSOverrides
	if source.VnetDNSOverrides != nil {
		vnetDNSOverrideMap := make(map[string]LocalDNSOverride_STATUS, len(source.VnetDNSOverrides))
		for vnetDNSOverrideKey, vnetDNSOverrideValue := range source.VnetDNSOverrides {
			var vnetDNSOverride LocalDNSOverride_STATUS
			err := vnetDNSOverride.AssignProperties_From_LocalDNSOverride_STATUS(&vnetDNSOverrideValue)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LocalDNSOverride_STATUS() to populate field VnetDNSOverrides")
			}
			vnetDNSOverrideMap[vnetDNSOverrideKey] = vnetDNSOverride
		}
		profile.VnetDNSOverrides = vnetDNSOverrideMap
...
func (profile *LocalDNSProfile_STATUS) AssignProperties_To_LocalDNSProfile_STATUS(destination *storage.LocalDNSProfile_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// KubeDNSOverrides
	if profile.KubeDNSOverrides != nil {
		kubeDNSOverrideMap := make(map[string]storage.LocalDNSOverride_STATUS, len(profile.KubeDNSOverrides))
		for kubeDNSOverrideKey, kubeDNSOverrideValue := range profile.KubeDNSOverrides {
			var kubeDNSOverride storage.LocalDNSOverride_STATUS
	...
	// VnetDNSOverrides
	if profile.VnetDNSOverrides != nil {
		vnetDNSOverrideMap := make(map[string]storage.LocalDNSOverride_STATUS, len(profile.VnetDNSOverrides))
		for vnetDNSOverrideKey, vnetDNSOverrideValue := range profile.VnetDNSOverrides {
			var vnetDNSOverride storage.LocalDNSOverride_STATUS
...
func (state *PowerState) AssignProperties_From_PowerState(source *storage.PowerState) error {
	...
	if source.Code != nil {
		code := *source.Code
		codeTemp := genruntime.ToEnum(code, code_Values)
		state.Code = &codeTemp
	} else {
		state.Code = nil
	}
...
func (state *PowerState) Initialize_From_PowerState_STATUS(source *PowerState_STATUS) error {
	...
	// Code
	if source.Code != nil {
		code := genruntime.ToEnum(string(*source.Code), code_Values)
		state.Code = &code
	} else {
		state.Code = nil
	}
...
// Initialize_From_VirtualMachineNodes_STATUS populates our VirtualMachineNodes from the provided source VirtualMachineNodes_STATUS
func (nodes *VirtualMachineNodes) Initialize_From_VirtualMachineNodes_STATUS(source *VirtualMachineNodes_STATUS) error {
...
// Initialize_From_VirtualMachinesProfile_STATUS populates our VirtualMachinesProfile from the provided source VirtualMachinesProfile_STATUS
func (profile *VirtualMachinesProfile) Initialize_From_VirtualMachinesProfile_STATUS(source *VirtualMachinesProfile_STATUS) error {

	// Scale
	if source.Scale != nil {
		var scale ScaleProfile
		err := scale.Initialize_From_ScaleProfile_STATUS(source.Scale)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ScaleProfile_STATUS() to populate field Scale")
		}
		profile.Scale = &scale
	} else {
		profile.Scale = nil
...
var _ genruntime.ARMTransformer = &LocalDNSOverride{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (override *LocalDNSOverride) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if override == nil {
		return nil, nil
	}
	result := &arm.LocalDNSOverride{}

	// Set property "CacheDurationInSeconds":
	if override.CacheDurationInSeconds != nil {
		cacheDurationInSeconds := *override.CacheDurationInSeconds
		result.CacheDurationInSeconds = &cacheDurationInSeconds
	}

	// Set property "ForwardDestination":
	if override.ForwardDestination != nil {
		var temp string
		temp = string(*override.ForwardDestination)
		forwardDestination := arm.LocalDNSOverride_ForwardDestination(temp)
		result.ForwardDestination = &forwardDestination
	}

	// Set property "ForwardPolicy":
	if override.ForwardPolicy != nil {
		var temp string
		temp = string(*override.ForwardPolicy)
		forwardPolicy := arm.LocalDNSOverride_ForwardPolicy(temp)
		result.ForwardPolicy = &forwardPolicy
	}

	// Set property "MaxConcurrent":
	...
	if override.Protocol != nil {
		var temp string
		temp = string(*override.Protocol)
		protocol := arm.LocalDNSOverride_Protocol(temp)
		result.Protocol = &protocol
	}

	// Set property "QueryLogging":
	if override.QueryLogging != nil {
		var temp string
		temp = string(*override.QueryLogging)
		queryLogging := arm.LocalDNSOverride_QueryLogging(temp)
		result.QueryLogging = &queryLogging
	}

	// Set property "ServeStale":
	if override.ServeStale != nil {
		var temp string
		temp = string(*override.ServeStale)
		serveStale := arm.LocalDNSOverride_ServeStale(temp)
		result.ServeStale = &serveStale
	}

	// Set property "ServeStaleDurationInSeconds":
	if override.ServeStaleDurationInSeconds != nil {
		serveStaleDurationInSeconds := *override.ServeStaleDurationInSeconds
		result.ServeStaleDurationInSeconds = &serveStaleDurationInSeconds
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (override *LocalDNSOverride) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LocalDNSOverride{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (override *LocalDNSOverride) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LocalDNSOverride)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LocalDNSOverride, got %T", armInput)
	}

	// Set property "CacheDurationInSeconds":
	if typedInput.CacheDurationInSeconds != nil {
		cacheDurationInSeconds := *typedInput.CacheDurationInSeconds
		override.CacheDurationInSeconds = &cacheDurationInSeconds
	}

	// Set property "ForwardDestination":
	if typedInput.ForwardDestination != nil {
		var temp string
		temp = string(*typedInput.ForwardDestination)
		forwardDestination := LocalDNSOverride_ForwardDestination(temp)
		override.ForwardDestination = &forwardDestination
	}

	// Set property "ForwardPolicy":
	if typedInput.ForwardPolicy != nil {
		var temp string
		temp = string(*typedInput.ForwardPolicy)
		forwardPolicy := LocalDNSOverride_ForwardPolicy(temp)
		override.ForwardPolicy = &forwardPolicy
	}

	// Set property "MaxConcurrent":
	if typedInput.MaxConcurrent != nil {
		maxConcurrent := *typedInput.MaxConcurrent
	...
	if typedInput.Protocol != nil {
		...
		protocol := LocalDNSOverride_Protocol(temp)
		override.Protocol = &protocol
	}

	// Set property "QueryLogging":
	if typedInput.QueryLogging != nil {
		var temp string
		temp = string(*typedInput.QueryLogging)
		queryLogging := LocalDNSOverride_QueryLogging(temp)
		override.QueryLogging = &queryLogging
	}

	// Set property "ServeStale":
	if typedInput.ServeStale != nil {
		var temp string
		temp = string(*typedInput.ServeStale)
		serveStale := LocalDNSOverride_ServeStale(temp)
		override.ServeStale = &serveStale
	}

	// Set property "ServeStaleDurationInSeconds":
	if typedInput.ServeStaleDurationInSeconds != nil {
		serveStaleDurationInSeconds := *typedInput.ServeStaleDurationInSeconds
		override.ServeStaleDurationInSeconds = &serveStaleDurationInSeconds
	}
...
func (override *LocalDNSOverride) AssignProperties_From_LocalDNSOverride(source *storage.LocalDNSOverride) error {

	// CacheDurationInSeconds
	override.CacheDurationInSeconds = genruntime.ClonePointerToInt(source.CacheDurationInSeconds)

	// ForwardDestination
	if source.ForwardDestination != nil {
		forwardDestination := *source.ForwardDestination
		forwardDestinationTemp := genruntime.ToEnum(forwardDestination, localDNSOverride_ForwardDestination_Values)
		override.ForwardDestination = &forwardDestinationTemp
	} else {
		override.ForwardDestination = nil
	}

	// ForwardPolicy
	if source.ForwardPolicy != nil {
		forwardPolicy := *source.ForwardPolicy
		forwardPolicyTemp := genruntime.ToEnum(forwardPolicy, localDNSOverride_ForwardPolicy_Values)
		override.ForwardPolicy = &forwardPolicyTemp
	} else {
		override.ForwardPolicy = nil
	}

	// MaxConcurrent
	override.MaxConcurrent = genruntime.ClonePointerToInt(source.MaxConcurrent)

	// Protocol
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, localDNSOverride_Protocol_Values)
		override.Protocol = &protocolTemp
	} else {
		override.Protocol = nil
	}

	// QueryLogging
	if source.QueryLogging != nil {
		queryLogging := *source.QueryLogging
		queryLoggingTemp := genruntime.ToEnum(queryLogging, localDNSOverride_QueryLogging_Values)
		override.QueryLogging = &queryLoggingTemp
	} else {
		override.QueryLogging = nil
	}

	// ServeStale
	if source.ServeStale != nil {
		serveStale := *source.ServeStale
		serveStaleTemp := genruntime.ToEnum(serveStale, localDNSOverride_ServeStale_Values)
		override.ServeStale = &serveStaleTemp
	} else {
		override.ServeStale = nil
	}

	// ServeStaleDurationInSeconds
	override.ServeStaleDurationInSeconds = genruntime.ClonePointerToInt(source.ServeStaleDurationInSeconds)
...
func (override *LocalDNSOverride) AssignProperties_To_LocalDNSOverride(destination *storage.LocalDNSOverride) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// CacheDurationInSeconds
	destination.CacheDurationInSeconds = genruntime.ClonePointerToInt(override.CacheDurationInSeconds)

	// ForwardDestination
	if override.ForwardDestination != nil {
		forwardDestination := string(*override.ForwardDestination)
		destination.ForwardDestination = &forwardDestination
	} else {
		destination.ForwardDestination = nil
	}

	// ForwardPolicy
	if override.ForwardPolicy != nil {
		forwardPolicy := string(*override.ForwardPolicy)
		destination.ForwardPolicy = &forwardPolicy
	} else {
		destination.ForwardPolicy = nil
	}

	// MaxConcurrent
	destination.MaxConcurrent = genruntime.ClonePointerToInt(override.MaxConcurrent)
	...
	if override.QueryLogging != nil {
		...
		destination.QueryLogging = &queryLogging
	} else {
		destination.QueryLogging = nil
	}

	// ServeStale
	if override.ServeStale != nil {
		serveStale := string(*override.ServeStale)
		destination.ServeStale = &serveStale
	} else {
		destination.ServeStale = nil
	}

	// ServeStaleDurationInSeconds
	destination.ServeStaleDurationInSeconds = genruntime.ClonePointerToInt(override.ServeStaleDurationInSeconds)
...
// Initialize_From_LocalDNSOverride_STATUS populates our LocalDNSOverride from the provided source LocalDNSOverride_STATUS
func (override *LocalDNSOverride) Initialize_From_LocalDNSOverride_STATUS(source *LocalDNSOverride_STATUS) error {
	...
	// ForwardDestination
	if source.ForwardDestination != nil {
		forwardDestination := genruntime.ToEnum(string(*source.ForwardDestination), localDNSOverride_ForwardDestination_Values)
		override.ForwardDestination = &forwardDestination
	} else {
		override.ForwardDestination = nil
	}
	...
	// ForwardPolicy
	if source.ForwardPolicy != nil {
		forwardPolicy := genruntime.ToEnum(string(*source.ForwardPolicy), localDNSOverride_ForwardPolicy_Values)
		override.ForwardPolicy = &forwardPolicy
	} else {
		override.ForwardPolicy = nil
	}
	...
	// Protocol
	if source.Protocol != nil {
		protocol := genruntime.ToEnum(string(*source.Protocol), localDNSOverride_Protocol_Values)
		override.Protocol = &protocol
	} else {
		override.Protocol = nil
	}
	...
	// QueryLogging
	if source.QueryLogging != nil {
		queryLogging := genruntime.ToEnum(string(*source.QueryLogging), localDNSOverride_QueryLogging_Values)
		override.QueryLogging = &queryLogging
	} else {
		override.QueryLogging = nil
	}
	...
	// ServeStale
	if source.ServeStale != nil {
		serveStale := genruntime.ToEnum(string(*source.ServeStale), localDNSOverride_ServeStale_Values)
		override.ServeStale = &serveStale
	} else {
		override.ServeStale = nil
	}
...
var _ genruntime.FromARMConverter = &LocalDNSOverride_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (override *LocalDNSOverride_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LocalDNSOverride_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (override *LocalDNSOverride_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LocalDNSOverride_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LocalDNSOverride_STATUS, got %T", armInput)
	}
	...
	if typedInput.ForwardDestination != nil {
		var temp string
		temp = string(*typedInput.ForwardDestination)
		forwardDestination := LocalDNSOverride_ForwardDestination_STATUS(temp)
		override.ForwardDestination = &forwardDestination
	}
	...
	if typedInput.ForwardPolicy != nil {
		var temp string
		temp = string(*typedInput.ForwardPolicy)
		forwardPolicy := LocalDNSOverride_ForwardPolicy_STATUS(temp)
		override.ForwardPolicy = &forwardPolicy
	}
	...
	if typedInput.Protocol != nil {
		var temp string
		temp = string(*typedInput.Protocol)
		protocol := LocalDNSOverride_Protocol_STATUS(temp)
		override.Protocol = &protocol
	}
	...
	if typedInput.QueryLogging != nil {
		var temp string
		temp = string(*typedInput.QueryLogging)
		queryLogging := LocalDNSOverride_QueryLogging_STATUS(temp)
		override.QueryLogging = &queryLogging
	}
	...
	if typedInput.ServeStale != nil {
		var temp string
		temp = string(*typedInput.ServeStale)
		serveStale := LocalDNSOverride_ServeStale_STATUS(temp)
		override.ServeStale = &serveStale
	}
...
func (override *LocalDNSOverride_STATUS) AssignProperties_From_LocalDNSOverride_STATUS(source *storage.LocalDNSOverride_STATUS) error {
	...
	if source.ForwardDestination != nil {
		forwardDestination := *source.ForwardDestination
		forwardDestinationTemp := genruntime.ToEnum(forwardDestination, localDNSOverride_ForwardDestination_STATUS_Values)
		override.ForwardDestination = &forwardDestinationTemp
	} else {
		override.ForwardDestination = nil
	}
	...
	if source.ForwardPolicy != nil {
		forwardPolicy := *source.ForwardPolicy
		forwardPolicyTemp := genruntime.ToEnum(forwardPolicy, localDNSOverride_ForwardPolicy_STATUS_Values)
		override.ForwardPolicy = &forwardPolicyTemp
	} else {
		override.ForwardPolicy = nil
	}
	...
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, localDNSOverride_Protocol_STATUS_Values)
		override.Protocol = &protocolTemp
	} else {
		override.Protocol = nil
	}
	...
	if source.QueryLogging != nil {
		queryLogging := *source.QueryLogging
		queryLoggingTemp := genruntime.ToEnum(queryLogging, localDNSOverride_QueryLogging_STATUS_Values)
		override.QueryLogging = &queryLoggingTemp
	} else {
		override.QueryLogging = nil
	}
	...
	if source.ServeStale != nil {
		serveStale := *source.ServeStale
		serveStaleTemp := genruntime.ToEnum(serveStale, localDNSOverride_ServeStale_STATUS_Values)
		override.ServeStale = &serveStaleTemp
	} else {
		override.ServeStale = nil
	}
...
func (override *LocalDNSOverride_STATUS) AssignProperties_To_LocalDNSOverride_STATUS(destination *storage.LocalDNSOverride_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (portRange *PortRange) AssignProperties_From_PortRange(source *storage.PortRange) error {
	...
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, protocol_Values)
...
func (portRange *PortRange) Initialize_From_PortRange_STATUS(source *PortRange_STATUS) error {
	...
	// Protocol
	if source.Protocol != nil {
		protocol := genruntime.ToEnum(string(*source.Protocol), protocol_Values)
		portRange.Protocol = &protocol
	} else {
		portRange.Protocol = nil
	}
...
func (portRange *PortRange_STATUS) AssignProperties_From_PortRange_STATUS(source *storage.PortRange_STATUS) error {
	...
	if source.Protocol != nil {
		protocol := *source.Protocol
		protocolTemp := genruntime.ToEnum(protocol, protocol_STATUS_Values)
		portRange.Protocol = &protocolTemp
	} else {
		portRange.Protocol = nil
	}
...
func (profile *ScaleProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	for _, item := range profile.Autoscale {
		...
		result.Autoscale = append(result.Autoscale, *item_ARM.(*arm.AutoScaleProfile))
	}
...
// Initialize_From_ScaleProfile_STATUS populates our ScaleProfile from the provided source ScaleProfile_STATUS
func (profile *ScaleProfile) Initialize_From_ScaleProfile_STATUS(source *ScaleProfile_STATUS) error {
	...
	if source.Autoscale != nil {
		...
		for autoscaleIndex, autoscaleItem := range source.Autoscale {
			var autoscale AutoScaleProfile
			err := autoscale.Initialize_From_AutoScaleProfile_STATUS(&autoscaleItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_AutoScaleProfile_STATUS() to populate field Autoscale")
			}
			autoscaleList[autoscaleIndex] = autoscale
		}
		profile.Autoscale = autoscaleList
	...
	if source.Manual != nil {
		...
		for manualIndex, manualItem := range source.Manual {
			var manual ManualScaleProfile
			err := manual.Initialize_From_ManualScaleProfile_STATUS(&manualItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_ManualScaleProfile_STATUS() to populate field Manual")
			}
			manualList[manualIndex] = manual
		}
		profile.Manual = manualList
...
// Initialize_From_ManualScaleProfile_STATUS populates our ManualScaleProfile from the provided source ManualScaleProfile_STATUS
func (profile *ManualScaleProfile) Initialize_From_ManualScaleProfile_STATUS(source *ManualScaleProfile_STATUS) error {
