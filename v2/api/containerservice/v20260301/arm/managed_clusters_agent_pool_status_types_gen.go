...
type ManagedClusterAgentPoolProfileProperties_STATUS struct {
	...
	OsType *ManagedClusterAgentPoolProfileProperties_OsType_STATUS `json:"osType,omitempty"`
	...
	ScaleSetEvictionPolicy *ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS `json:"scaleSetEvictionPolicy,omitempty"`

	// ScaleSetPriority: The Virtual Machine Scale Set priority.
	ScaleSetPriority *ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS `json:"scaleSetPriority,omitempty"`
...
type AgentPoolStatus_STATUS struct {
...
type AgentPoolUpgradeSettings_STATUS struct {
	...
	UndrainableNodeBehavior *UndrainableNodeBehavior_STATUS `json:"undrainableNodeBehavior,omitempty"`
}
...
type GPUProfile_STATUS struct {
	...
	Driver *GPUDriver_STATUS `json:"driver,omitempty"`
}
...
type LocalDNSProfile_STATUS struct {
	// KubeDNSOverrides: KubeDNS overrides apply to DNS traffic from pods with dnsPolicy:ClusterFirst (referred to as KubeDNS
	// traffic).
	KubeDNSOverrides map[string]LocalDNSOverride_STATUS `json:"kubeDNSOverrides"`

	// Mode: Mode of enablement for localDNS.
	Mode *LocalDNSProfile_Mode_STATUS `json:"mode,omitempty"`

	// State: System-generated state of localDNS.
	State *LocalDNSState_STATUS `json:"state,omitempty"`

	// VnetDNSOverrides: VnetDNS overrides apply to DNS traffic from pods with dnsPolicy:default or kubelet (referred to as
	// VnetDNS traffic).
	VnetDNSOverrides map[string]LocalDNSOverride_STATUS `json:"vnetDNSOverrides"`
}

type ManagedClusterAgentPoolProfileProperties_OsType_STATUS string

const (
	ManagedClusterAgentPoolProfileProperties_OsType_STATUS_Linux   = ManagedClusterAgentPoolProfileProperties_OsType_STATUS("Linux")
	ManagedClusterAgentPoolProfileProperties_OsType_STATUS_Windows = ManagedClusterAgentPoolProfileProperties_OsType_STATUS("Windows")
)

// Mapping from string to ManagedClusterAgentPoolProfileProperties_OsType_STATUS
var managedClusterAgentPoolProfileProperties_OsType_STATUS_Values = map[string]ManagedClusterAgentPoolProfileProperties_OsType_STATUS{
	"linux":   ManagedClusterAgentPoolProfileProperties_OsType_STATUS_Linux,
	"windows": ManagedClusterAgentPoolProfileProperties_OsType_STATUS_Windows,
}

type ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS string

const (
	ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Deallocate = ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS("Deallocate")
	ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Delete     = ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS("Delete")
)

// Mapping from string to ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS
var managedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Values = map[string]ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS{
	"deallocate": ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Deallocate,
	"delete":     ManagedClusterAgentPoolProfileProperties_ScaleSetEvictionPolicy_STATUS_Delete,
}

type ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS string

const (
	ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Regular = ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS("Regular")
	ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Spot    = ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS("Spot")
)

// Mapping from string to ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS
var managedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Values = map[string]ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS{
	"regular": ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Regular,
	"spot":    ManagedClusterAgentPoolProfileProperties_ScaleSetPriority_STATUS_Spot,
}
...
const (
	WorkloadRuntime_STATUS_KataVmIsolation = WorkloadRuntime_STATUS("KataVmIsolation")
...
var workloadRuntime_STATUS_Values = map[string]WorkloadRuntime_STATUS{
	"katavmisolation": WorkloadRuntime_STATUS_KataVmIsolation,
...
type GPUDriver_STATUS string

const (
	GPUDriver_STATUS_Install = GPUDriver_STATUS("Install")
	GPUDriver_STATUS_None    = GPUDriver_STATUS("None")
)

// Mapping from string to GPUDriver_STATUS
var gPUDriver_STATUS_Values = map[string]GPUDriver_STATUS{
	"install": GPUDriver_STATUS_Install,
	"none":    GPUDriver_STATUS_None,
}
...
type LocalDNSOverride_STATUS struct {
	...
	ForwardDestination *LocalDNSOverride_ForwardDestination_STATUS `json:"forwardDestination,omitempty"`
	...
	ForwardPolicy *LocalDNSOverride_ForwardPolicy_STATUS `json:"forwardPolicy,omitempty"`
	...
	Protocol *LocalDNSOverride_Protocol_STATUS `json:"protocol,omitempty"`

	// QueryLogging: Log level for DNS queries in localDNS.
	QueryLogging *LocalDNSOverride_QueryLogging_STATUS `json:"queryLogging,omitempty"`

	// ServeStale: Policy for serving stale data. See [cache plugin](https://coredns.io/plugins/cache) for more information.
	ServeStale *LocalDNSOverride_ServeStale_STATUS `json:"serveStale,omitempty"`
...
type LocalDNSProfile_Mode_STATUS string

const (
	LocalDNSProfile_Mode_STATUS_Disabled  = LocalDNSProfile_Mode_STATUS("Disabled")
	LocalDNSProfile_Mode_STATUS_Preferred = LocalDNSProfile_Mode_STATUS("Preferred")
	LocalDNSProfile_Mode_STATUS_Required  = LocalDNSProfile_Mode_STATUS("Required")
)

// Mapping from string to LocalDNSProfile_Mode_STATUS
var localDNSProfile_Mode_STATUS_Values = map[string]LocalDNSProfile_Mode_STATUS{
	"disabled":  LocalDNSProfile_Mode_STATUS_Disabled,
	"preferred": LocalDNSProfile_Mode_STATUS_Preferred,
	"required":  LocalDNSProfile_Mode_STATUS_Required,
}

// System-generated state of localDNS.
type LocalDNSState_STATUS string

const (
	LocalDNSState_STATUS_Disabled = LocalDNSState_STATUS("Disabled")
	LocalDNSState_STATUS_Enabled  = LocalDNSState_STATUS("Enabled")
)

// Mapping from string to LocalDNSState_STATUS
var localDNSState_STATUS_Values = map[string]LocalDNSState_STATUS{
	"disabled": LocalDNSState_STATUS_Disabled,
	"enabled":  LocalDNSState_STATUS_Enabled,
}
...
type PortRange_STATUS struct {
	...
	Protocol *Protocol_STATUS `json:"protocol,omitempty"`
}
...
type UndrainableNodeBehavior_STATUS string

const (
	UndrainableNodeBehavior_STATUS_Cordon   = UndrainableNodeBehavior_STATUS("Cordon")
	UndrainableNodeBehavior_STATUS_Schedule = UndrainableNodeBehavior_STATUS("Schedule")
)

// Mapping from string to UndrainableNodeBehavior_STATUS
var undrainableNodeBehavior_STATUS_Values = map[string]UndrainableNodeBehavior_STATUS{
	"cordon":   UndrainableNodeBehavior_STATUS_Cordon,
	"schedule": UndrainableNodeBehavior_STATUS_Schedule,
}

type LocalDNSOverride_ForwardDestination_STATUS string

const (
	LocalDNSOverride_ForwardDestination_STATUS_ClusterCoreDNS = LocalDNSOverride_ForwardDestination_STATUS("ClusterCoreDNS")
	LocalDNSOverride_ForwardDestination_STATUS_VnetDNS        = LocalDNSOverride_ForwardDestination_STATUS("VnetDNS")
)

// Mapping from string to LocalDNSOverride_ForwardDestination_STATUS
var localDNSOverride_ForwardDestination_STATUS_Values = map[string]LocalDNSOverride_ForwardDestination_STATUS{
	"clustercoredns": LocalDNSOverride_ForwardDestination_STATUS_ClusterCoreDNS,
	"vnetdns":        LocalDNSOverride_ForwardDestination_STATUS_VnetDNS,
}

type LocalDNSOverride_ForwardPolicy_STATUS string

const (
	LocalDNSOverride_ForwardPolicy_STATUS_Random     = LocalDNSOverride_ForwardPolicy_STATUS("Random")
	LocalDNSOverride_ForwardPolicy_STATUS_RoundRobin = LocalDNSOverride_ForwardPolicy_STATUS("RoundRobin")
	LocalDNSOverride_ForwardPolicy_STATUS_Sequential = LocalDNSOverride_ForwardPolicy_STATUS("Sequential")
)

// Mapping from string to LocalDNSOverride_ForwardPolicy_STATUS
var localDNSOverride_ForwardPolicy_STATUS_Values = map[string]LocalDNSOverride_ForwardPolicy_STATUS{
	"random":     LocalDNSOverride_ForwardPolicy_STATUS_Random,
	"roundrobin": LocalDNSOverride_ForwardPolicy_STATUS_RoundRobin,
	"sequential": LocalDNSOverride_ForwardPolicy_STATUS_Sequential,
}

type LocalDNSOverride_Protocol_STATUS string

const (
	LocalDNSOverride_Protocol_STATUS_ForceTCP  = LocalDNSOverride_Protocol_STATUS("ForceTCP")
	LocalDNSOverride_Protocol_STATUS_PreferUDP = LocalDNSOverride_Protocol_STATUS("PreferUDP")
)

// Mapping from string to LocalDNSOverride_Protocol_STATUS
var localDNSOverride_Protocol_STATUS_Values = map[string]LocalDNSOverride_Protocol_STATUS{
	"forcetcp":  LocalDNSOverride_Protocol_STATUS_ForceTCP,
	"preferudp": LocalDNSOverride_Protocol_STATUS_PreferUDP,
}

type LocalDNSOverride_QueryLogging_STATUS string

const (
	LocalDNSOverride_QueryLogging_STATUS_Error = LocalDNSOverride_QueryLogging_STATUS("Error")
	LocalDNSOverride_QueryLogging_STATUS_Log   = LocalDNSOverride_QueryLogging_STATUS("Log")
)

// Mapping from string to LocalDNSOverride_QueryLogging_STATUS
var localDNSOverride_QueryLogging_STATUS_Values = map[string]LocalDNSOverride_QueryLogging_STATUS{
	"error": LocalDNSOverride_QueryLogging_STATUS_Error,
	"log":   LocalDNSOverride_QueryLogging_STATUS_Log,
}

type LocalDNSOverride_ServeStale_STATUS string

const (
	LocalDNSOverride_ServeStale_STATUS_Disable   = LocalDNSOverride_ServeStale_STATUS("Disable")
	LocalDNSOverride_ServeStale_STATUS_Immediate = LocalDNSOverride_ServeStale_STATUS("Immediate")
	LocalDNSOverride_ServeStale_STATUS_Verify    = LocalDNSOverride_ServeStale_STATUS("Verify")
)

// Mapping from string to LocalDNSOverride_ServeStale_STATUS
var localDNSOverride_ServeStale_STATUS_Values = map[string]LocalDNSOverride_ServeStale_STATUS{
	"disable":   LocalDNSOverride_ServeStale_STATUS_Disable,
	"immediate": LocalDNSOverride_ServeStale_STATUS_Immediate,
	"verify":    LocalDNSOverride_ServeStale_STATUS_Verify,
}
...
type Protocol_STATUS string

const (
	Protocol_STATUS_TCP = Protocol_STATUS("TCP")
	Protocol_STATUS_UDP = Protocol_STATUS("UDP")
)

// Mapping from string to Protocol_STATUS
var protocol_STATUS_Values = map[string]Protocol_STATUS{
	"tcp": Protocol_STATUS_TCP,
	"udp": Protocol_STATUS_UDP,
}
