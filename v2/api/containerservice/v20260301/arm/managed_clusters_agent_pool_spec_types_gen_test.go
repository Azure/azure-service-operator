...
func AddIndependentPropertyGeneratorsForManagedClusterAgentPoolProfileProperties(gens map[string]gopter.Gen) {
	...
	gens["WorkloadRuntime"] = gen.PtrOf(gen.OneConstOf(WorkloadRuntime_KataVmIsolation, WorkloadRuntime_OCIContainer, WorkloadRuntime_WasmWasi))
}
