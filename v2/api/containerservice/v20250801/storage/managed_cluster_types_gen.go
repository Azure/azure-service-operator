...
import (
	"context"
	"fmt"
	compat "github.com/Azure/azure-service-operator/v2/api/containerservice/v20250801/storage/compat"
...
// Storage version of v20250801.ManagedCluster
...
// Storage version of v20250801.ManagedCluster_Spec
...
func (cluster *ManagedCluster_Spec) AssignProperties_From_ManagedCluster_Spec(source *storage.ManagedCluster_Spec) error {
	...
	if source.HostedSystemProfile != nil {
		var hostedSystemProfile compat.ManagedClusterHostedSystemProfile
		...
		propertyBag.Add("HostedSystemProfile", hostedSystemProfile)
	} else {
...
func (cluster *ManagedCluster_Spec) AssignProperties_To_ManagedCluster_Spec(destination *storage.ManagedCluster_Spec) error {
	...
	if propertyBag.Contains("HostedSystemProfile") {
		var hostedSystemProfileFromBag compat.ManagedClusterHostedSystemProfile
		err := propertyBag.Pull("HostedSystemProfile", &hostedSystemProfileFromBag)
		if err != nil {
		...
		err = hostedSystemProfileFromBag.AssignProperties_To_ManagedClusterHostedSystemProfile(&hostedSystemProfile)
		if err != nil {
...
// Storage version of v20250801.ManagedCluster_STATUS
// Managed cluster.
...
func (cluster *ManagedCluster_STATUS) AssignProperties_From_ManagedCluster_STATUS(source *storage.ManagedCluster_STATUS) error {
	...
	// HostedSystemProfile
	if source.HostedSystemProfile != nil {
		var hostedSystemProfile compat.ManagedClusterHostedSystemProfile_STATUS
...
func (cluster *ManagedCluster_STATUS) AssignProperties_To_ManagedCluster_STATUS(destination *storage.ManagedCluster_STATUS) error {
	...
	// HostedSystemProfile
	if propertyBag.Contains("HostedSystemProfile") {
		var hostedSystemProfileFromBag compat.ManagedClusterHostedSystemProfile_STATUS
		err := propertyBag.Pull("HostedSystemProfile", &hostedSystemProfileFromBag)
		if err != nil {
			return eris.Wrap(err, "pulling 'HostedSystemProfile' from propertyBag")
		}
		...
		err = hostedSystemProfileFromBag.AssignProperties_To_ManagedClusterHostedSystemProfile_STATUS(&hostedSystemProfile)
		if err != nil {
...
// Storage version of v20250801.ClusterUpgradeSettings
...
// Storage version of v20250801.ClusterUpgradeSettings_STATUS
// Settings for upgrading a cluster.
...
// Storage version of v20250801.ContainerServiceLinuxProfile
...
// Storage version of v20250801.ContainerServiceLinuxProfile_STATUS
// Profile for Linux VMs in the container service cluster.
...
// Storage version of v20250801.ContainerServiceNetworkProfile
...
// Storage version of v20250801.ContainerServiceNetworkProfile_STATUS
// Profile of network configuration.
...
// Storage version of v20250801.ExtendedLocation
...
// Storage version of v20250801.ExtendedLocation_STATUS
// The complex type of the extended location.
...
// Storage version of v20250801.ManagedClusterAADProfile
...
// Storage version of v20250801.ManagedClusterAADProfile_STATUS
// AADProfile specifies attributes for Azure Active Directory integration. For more details see [managed AAD on
// AKS](https://docs.microsoft.com/azure/aks/managed-aad).
...
// Storage version of v20250801.ManagedClusterAddonProfile
...
// Storage version of v20250801.ManagedClusterAddonProfile_STATUS
// A Kubernetes add-on profile for a managed cluster.
...
// Storage version of v20250801.ManagedClusterAgentPoolProfile
...
// Storage version of v20250801.ManagedClusterAgentPoolProfile_STATUS
// Profile for the container service agent pool.
...
// Storage version of v20250801.ManagedClusterAIToolchainOperatorProfile
...
// Storage version of v20250801.ManagedClusterAIToolchainOperatorProfile_STATUS
// When enabling the operator, a set of AKS managed CRDs and controllers will be installed in the cluster. The operator
// automates the deployment of OSS models for inference and/or training purposes. It provides a set of preset models and
// enables distributed inference against them.
...
// Storage version of v20250801.ManagedClusterAPIServerAccessProfile
...
// Storage version of v20250801.ManagedClusterAPIServerAccessProfile_STATUS
// Access profile for managed cluster API server.
...
// Storage version of v20250801.ManagedClusterAutoUpgradeProfile
...
// Storage version of v20250801.ManagedClusterAutoUpgradeProfile_STATUS
// Auto upgrade profile for a managed cluster.
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfile
...
func (profile *ManagedClusterAzureMonitorProfile) AssignProperties_From_ManagedClusterAzureMonitorProfile(source *storage.ManagedClusterAzureMonitorProfile) error {
	...
	if source.AppMonitoring != nil {
		var appMonitoring compat.ManagedClusterAzureMonitorProfileAppMonitoring
		...
		propertyBag.Add("AppMonitoring", appMonitoring)
	} else {
...
func (profile *ManagedClusterAzureMonitorProfile) AssignProperties_To_ManagedClusterAzureMonitorProfile(destination *storage.ManagedClusterAzureMonitorProfile) error {
	...
	if propertyBag.Contains("AppMonitoring") {
		var appMonitoringFromBag compat.ManagedClusterAzureMonitorProfileAppMonitoring
		err := propertyBag.Pull("AppMonitoring", &appMonitoringFromBag)
		if err != nil {
		...
		err = appMonitoringFromBag.AssignProperties_To_ManagedClusterAzureMonitorProfileAppMonitoring(&appMonitoring)
		if err != nil {
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfile_STATUS
// Azure Monitor addon profiles for monitoring the managed cluster.
...
func (profile *ManagedClusterAzureMonitorProfile_STATUS) AssignProperties_From_ManagedClusterAzureMonitorProfile_STATUS(source *storage.ManagedClusterAzureMonitorProfile_STATUS) error {
	...
	// AppMonitoring
	if source.AppMonitoring != nil {
		var appMonitoring compat.ManagedClusterAzureMonitorProfileAppMonitoring_STATUS
...
func (profile *ManagedClusterAzureMonitorProfile_STATUS) AssignProperties_To_ManagedClusterAzureMonitorProfile_STATUS(destination *storage.ManagedClusterAzureMonitorProfile_STATUS) error {
	...
	// AppMonitoring
	if propertyBag.Contains("AppMonitoring") {
		var appMonitoringFromBag compat.ManagedClusterAzureMonitorProfileAppMonitoring_STATUS
		err := propertyBag.Pull("AppMonitoring", &appMonitoringFromBag)
		if err != nil {
			return eris.Wrap(err, "pulling 'AppMonitoring' from propertyBag")
		}
		...
		err = appMonitoringFromBag.AssignProperties_To_ManagedClusterAzureMonitorProfileAppMonitoring_STATUS(&appMonitoring)
		if err != nil {
...
// Storage version of v20250801.ManagedClusterBootstrapProfile
...
// Storage version of v20250801.ManagedClusterBootstrapProfile_STATUS
// The bootstrap profile.
...
// Storage version of v20250801.ManagedClusterHTTPProxyConfig
...
// Storage version of v20250801.ManagedClusterHTTPProxyConfig_STATUS
// Cluster HTTP proxy configuration.
...
// Storage version of v20250801.ManagedClusterIdentity
...
// Storage version of v20250801.ManagedClusterIdentity_STATUS
// Identity for the managed cluster.
...
// Storage version of v20250801.ManagedClusterIngressProfile
...
func (profile *ManagedClusterIngressProfile) AssignProperties_From_ManagedClusterIngressProfile(source *storage.ManagedClusterIngressProfile) error {
	...
	if source.GatewayAPI != nil {
		propertyBag.Add("GatewayAPI", *source.GatewayAPI)
	} else {
...
// Storage version of v20250801.ManagedClusterIngressProfile_STATUS
// Ingress profile for the container service cluster.
...
// Storage version of v20250801.ManagedClusterMetricsProfile
...
// Storage version of v20250801.ManagedClusterMetricsProfile_STATUS
// The metrics profile for the ManagedCluster.
...
// Storage version of v20250801.ManagedClusterNodeProvisioningProfile
...
// Storage version of v20250801.ManagedClusterNodeProvisioningProfile_STATUS
...
// Storage version of v20250801.ManagedClusterNodeResourceGroupProfile
...
// Storage version of v20250801.ManagedClusterNodeResourceGroupProfile_STATUS
// Node resource group lockdown profile for a managed cluster.
...
// Storage version of v20250801.ManagedClusterOIDCIssuerProfile
...
// Storage version of v20250801.ManagedClusterOIDCIssuerProfile_STATUS
// The OIDC issuer profile of the Managed Cluster.
...
// Storage version of v20250801.ManagedClusterOperatorSpec
...
// Storage version of v20250801.ManagedClusterPodIdentityProfile
...
// Storage version of v20250801.ManagedClusterPodIdentityProfile_STATUS
// The pod identity profile of the Managed Cluster. See [use AAD pod
// identity](https://docs.microsoft.com/azure/aks/use-azure-ad-pod-identity) for more details on pod identity integration.
...
// Storage version of v20250801.ManagedClusterProperties_AutoScalerProfile
...
// AssignProperties_From_ManagedClusterPropertiesAutoScalerProfile populates our ManagedClusterProperties_AutoScalerProfile from the provided source ManagedClusterPropertiesAutoScalerProfile
func (profile *ManagedClusterProperties_AutoScalerProfile) AssignProperties_From_ManagedClusterPropertiesAutoScalerProfile(source *storage.ManagedClusterPropertiesAutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterPropertiesAutoScalerProfile populates the provided destination ManagedClusterPropertiesAutoScalerProfile from our ManagedClusterProperties_AutoScalerProfile
func (profile *ManagedClusterProperties_AutoScalerProfile) AssignProperties_To_ManagedClusterPropertiesAutoScalerProfile(destination *storage.ManagedClusterPropertiesAutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
// Storage version of v20250801.ManagedClusterProperties_AutoScalerProfile_STATUS
...
// AssignProperties_From_ManagedClusterPropertiesAutoScalerProfile_STATUS populates our ManagedClusterProperties_AutoScalerProfile_STATUS from the provided source ManagedClusterPropertiesAutoScalerProfile_STATUS
func (profile *ManagedClusterProperties_AutoScalerProfile_STATUS) AssignProperties_From_ManagedClusterPropertiesAutoScalerProfile_STATUS(source *storage.ManagedClusterPropertiesAutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterPropertiesAutoScalerProfile_STATUS populates the provided destination ManagedClusterPropertiesAutoScalerProfile_STATUS from our ManagedClusterProperties_AutoScalerProfile_STATUS
func (profile *ManagedClusterProperties_AutoScalerProfile_STATUS) AssignProperties_To_ManagedClusterPropertiesAutoScalerProfile_STATUS(destination *storage.ManagedClusterPropertiesAutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
// Storage version of v20250801.ManagedClusterSecurityProfile
...
// Storage version of v20250801.ManagedClusterSecurityProfile_STATUS
// Security profile for the container service cluster.
...
// Storage version of v20250801.ManagedClusterServicePrincipalProfile
...
// Storage version of v20250801.ManagedClusterServicePrincipalProfile_STATUS
// Information about a service principal identity for the cluster to use for manipulating Azure APIs.
...
// Storage version of v20250801.ManagedClusterSKU
...
// Storage version of v20250801.ManagedClusterSKU_STATUS
// The SKU of a Managed Cluster.
...
// Storage version of v20250801.ManagedClusterStatus_STATUS
...
// Storage version of v20250801.ManagedClusterStorageProfile
...
// Storage version of v20250801.ManagedClusterStorageProfile_STATUS
// Storage profile for the container service cluster.
...
// Storage version of v20250801.ManagedClusterWindowsProfile
...
// Storage version of v20250801.ManagedClusterWindowsProfile_STATUS
// Profile for Windows VMs in the managed cluster.
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfile
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfile_STATUS
// Workload Auto-scaler profile for the managed cluster.
...
// Storage version of v20250801.PowerState_STATUS
...
// Storage version of v20250801.PrivateLinkResource
...
// Storage version of v20250801.PrivateLinkResource_STATUS
// A private link resource
...
// Storage version of v20250801.ServiceMeshProfile
...
// Storage version of v20250801.ServiceMeshProfile_STATUS
// Service mesh profile for a managed cluster.
...
// Storage version of v20250801.UserAssignedIdentity
...
// Storage version of v20250801.UserAssignedIdentity_STATUS
// Details about a user assigned identity.
...
// Storage version of v20250801.AdvancedNetworking
...
func (networking *AdvancedNetworking) AssignProperties_From_AdvancedNetworking(source *storage.AdvancedNetworking) error {
	...
	if source.Performance != nil {
		propertyBag.Add("Performance", *source.Performance)
	} else {
...
// Storage version of v20250801.AdvancedNetworking_STATUS
// Advanced Networking profile for enabling observability and security feature suite on a cluster. For more information see
// aka.ms/aksadvancednetworking.
...
type augmentConversionForManagedClusterBootstrapProfile interface {
	AssignPropertiesFrom(src *storage.ManagedClusterBootstrapProfile) error
	AssignPropertiesTo(dst *storage.ManagedClusterBootstrapProfile) error
}

type augmentConversionForManagedClusterBootstrapProfile_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterBootstrapProfile_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterBootstrapProfile_STATUS) error
}
...
type augmentConversionForManagedClusterProperties_AutoScalerProfile interface {
	AssignPropertiesFrom(src *storage.ManagedClusterPropertiesAutoScalerProfile) error
	AssignPropertiesTo(dst *storage.ManagedClusterPropertiesAutoScalerProfile) error
}

type augmentConversionForManagedClusterProperties_AutoScalerProfile_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterPropertiesAutoScalerProfile_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterPropertiesAutoScalerProfile_STATUS) error
}
...
type augmentConversionForManagedClusterStatus_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterStatus_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterStatus_STATUS) error
}
...
// Storage version of v20250801.AzureKeyVaultKms
...
// Storage version of v20250801.AzureKeyVaultKms_STATUS
// Azure Key Vault key management service settings for the security profile.
...
// Storage version of v20250801.ContainerServiceSshConfiguration
...
// Storage version of v20250801.ContainerServiceSshConfiguration_STATUS
// SSH configuration for Linux-based VMs running on Azure.
...
// Storage version of v20250801.DelegatedResource
...
// Storage version of v20250801.DelegatedResource_STATUS
// Delegated resource properties - internal use only.
...
// Storage version of v20250801.ErrorDetail_STATUS
// The error detail.
...
// Storage version of v20250801.IstioServiceMesh
...
// Storage version of v20250801.IstioServiceMesh_STATUS
// Istio service mesh configuration.
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfileMetrics
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfileMetrics_STATUS
// Metrics profile for the Azure Monitor managed service for Prometheus addon. Collect out-of-the-box Kubernetes
// infrastructure metrics to send to an Azure Monitor Workspace and configure additional scraping for custom targets. See
// aka.ms/AzureManagedPrometheus for an overview.
...
// Storage version of v20250801.ManagedClusterCostAnalysis
...
// Storage version of v20250801.ManagedClusterCostAnalysis_STATUS
// The cost analysis configuration for the cluster
...
// Storage version of v20250801.ManagedClusterIdentity_UserAssignedIdentities_STATUS
...
// AssignProperties_From_ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS populates our ManagedClusterIdentity_UserAssignedIdentities_STATUS from the provided source ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS
func (identities *ManagedClusterIdentity_UserAssignedIdentities_STATUS) AssignProperties_From_ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS(source *storage.ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS populates the provided destination ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS from our ManagedClusterIdentity_UserAssignedIdentities_STATUS
func (identities *ManagedClusterIdentity_UserAssignedIdentities_STATUS) AssignProperties_To_ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS(destination *storage.ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS) error {
	// Clone the existing property bag
...
// Storage version of v20250801.ManagedClusterIngressProfileWebAppRouting
...
func (routing *ManagedClusterIngressProfileWebAppRouting) AssignProperties_From_ManagedClusterIngressProfileWebAppRouting(source *storage.ManagedClusterIngressProfileWebAppRouting) error {
	...
	if source.GatewayAPIImplementations != nil {
		propertyBag.Add("GatewayAPIImplementations", *source.GatewayAPIImplementations)
	} else {
		propertyBag.Remove("GatewayAPIImplementations")
	}
...
func (routing *ManagedClusterIngressProfileWebAppRouting) AssignProperties_To_ManagedClusterIngressProfileWebAppRouting(destination *storage.ManagedClusterIngressProfileWebAppRouting) error {
	...
	// GatewayAPIImplementations
	if propertyBag.Contains("GatewayAPIImplementations") {
		var gatewayAPIImplementation storage.ManagedClusterWebAppRoutingGatewayAPIImplementations
		err := propertyBag.Pull("GatewayAPIImplementations", &gatewayAPIImplementation)
		if err != nil {
			return eris.Wrap(err, "pulling 'GatewayAPIImplementations' from propertyBag")
		}

		destination.GatewayAPIImplementations = &gatewayAPIImplementation
	} else {
		destination.GatewayAPIImplementations = nil
	}
...
// Storage version of v20250801.ManagedClusterIngressProfileWebAppRouting_STATUS
// Application Routing add-on settings for the ingress profile.
...
func (routing *ManagedClusterIngressProfileWebAppRouting_STATUS) AssignProperties_To_ManagedClusterIngressProfileWebAppRouting_STATUS(destination *storage.ManagedClusterIngressProfileWebAppRouting_STATUS) error {
	...
	// GatewayAPIImplementations
	if propertyBag.Contains("GatewayAPIImplementations") {
		var gatewayAPIImplementation storage.ManagedClusterWebAppRoutingGatewayAPIImplementations_STATUS
		err := propertyBag.Pull("GatewayAPIImplementations", &gatewayAPIImplementation)
		if err != nil {
			return eris.Wrap(err, "pulling 'GatewayAPIImplementations' from propertyBag")
		}
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_STATUS
// Profile of the managed cluster load balancer.
...
// Storage version of v20250801.ManagedClusterNATGatewayProfile
...
// Storage version of v20250801.ManagedClusterNATGatewayProfile_STATUS
// Profile of the managed cluster NAT gateway.
...
// Storage version of v20250801.ManagedClusterOperatorConfigMaps
...
// Storage version of v20250801.ManagedClusterOperatorSecrets
...
// Storage version of v20250801.ManagedClusterPodIdentity
...
// Storage version of v20250801.ManagedClusterPodIdentity_STATUS
// Details about the pod identity assigned to the Managed Cluster.
...
// Storage version of v20250801.ManagedClusterPodIdentityException
...
// Storage version of v20250801.ManagedClusterPodIdentityException_STATUS
// A pod identity exception, which allows pods with certain labels to access the Azure Instance Metadata Service (IMDS)
// endpoint without being intercepted by the node-managed identity (NMI) server. See [disable AAD Pod Identity for a
// specific Pod/Application](https://azure.github.io/aad-pod-identity/docs/configure/application_exception/) for more
// details.
...
// Storage version of v20250801.ManagedClusterSecurityProfileDefender
...
// Storage version of v20250801.ManagedClusterSecurityProfileDefender_STATUS
// Microsoft Defender settings for the security profile.
...
// Storage version of v20250801.ManagedClusterSecurityProfileImageCleaner
...
// Storage version of v20250801.ManagedClusterSecurityProfileImageCleaner_STATUS
// Image Cleaner removes unused images from nodes, freeing up disk space and helping to reduce attack surface area. Here
// are settings for the security profile.
...
// Storage version of v20250801.ManagedClusterSecurityProfileWorkloadIdentity
...
// Storage version of v20250801.ManagedClusterSecurityProfileWorkloadIdentity_STATUS
// Workload identity settings for the security profile.
...
// Storage version of v20250801.ManagedClusterStaticEgressGatewayProfile
...
// Storage version of v20250801.ManagedClusterStaticEgressGatewayProfile_STATUS
// The Static Egress Gateway addon configuration for the cluster.
...
// Storage version of v20250801.ManagedClusterStorageProfileBlobCSIDriver
...
// Storage version of v20250801.ManagedClusterStorageProfileBlobCSIDriver_STATUS
// AzureBlob CSI Driver settings for the storage profile.
...
// Storage version of v20250801.ManagedClusterStorageProfileDiskCSIDriver
...
// Storage version of v20250801.ManagedClusterStorageProfileDiskCSIDriver_STATUS
// AzureDisk CSI Driver settings for the storage profile.
...
// Storage version of v20250801.ManagedClusterStorageProfileFileCSIDriver
...
// Storage version of v20250801.ManagedClusterStorageProfileFileCSIDriver_STATUS
// AzureFile CSI Driver settings for the storage profile.
...
// Storage version of v20250801.ManagedClusterStorageProfileSnapshotController
...
// Storage version of v20250801.ManagedClusterStorageProfileSnapshotController_STATUS
// Snapshot Controller settings for the storage profile.
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfileKeda
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS
// KEDA (Kubernetes Event-driven Autoscaling) settings for the workload auto-scaler profile.
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler
...
// Storage version of v20250801.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_STATUS
// VPA (Vertical Pod Autoscaler) settings for the workload auto-scaler profile.
...
// Storage version of v20250801.UpgradeOverrideSettings
...
// Storage version of v20250801.UpgradeOverrideSettings_STATUS
// Settings for overrides when upgrading a cluster.
...
// Storage version of v20250801.UserAssignedIdentityDetails
...
// Storage version of v20250801.WindowsGmsaProfile
...
// Storage version of v20250801.WindowsGmsaProfile_STATUS
// Windows gMSA Profile in the managed cluster.
...
// Storage version of v20250801.AdvancedNetworkingObservability
...
// Storage version of v20250801.AdvancedNetworkingObservability_STATUS
// Observability profile to enable advanced network metrics and flow logs with historical contexts.
...
// Storage version of v20250801.AdvancedNetworkingSecurity
...
func (security *AdvancedNetworkingSecurity) AssignProperties_From_AdvancedNetworkingSecurity(source *storage.AdvancedNetworkingSecurity) error {
	...
	if source.TransitEncryption != nil {
		propertyBag.Add("TransitEncryption", *source.TransitEncryption)
	} else {
...
// Storage version of v20250801.AdvancedNetworkingSecurity_STATUS
// Security profile to enable security features on cilium based cluster.
...
type augmentConversionForManagedClusterIdentity_UserAssignedIdentities_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedServiceIdentityUserAssignedIdentitiesValue_STATUS) error
}
...
type augmentConversionForManagedClusterStaticEgressGatewayProfile interface {
	AssignPropertiesFrom(src *storage.ManagedClusterStaticEgressGatewayProfile) error
	AssignPropertiesTo(dst *storage.ManagedClusterStaticEgressGatewayProfile) error
}

type augmentConversionForManagedClusterStaticEgressGatewayProfile_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterStaticEgressGatewayProfile_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterStaticEgressGatewayProfile_STATUS) error
}
...
// Storage version of v20250801.ContainerServiceSshPublicKey
...
// Storage version of v20250801.ContainerServiceSshPublicKey_STATUS
// Contains information about SSH certificate public key data.
...
// Storage version of v20250801.ErrorAdditionalInfo_STATUS
...
// Storage version of v20250801.ErrorDetail_STATUS_Unrolled
...
// Storage version of v20250801.IstioCertificateAuthority
...
// Storage version of v20250801.IstioCertificateAuthority_STATUS
// Istio Service Mesh Certificate Authority (CA) configuration. For now, we only support plugin certificates as described
// here https://aka.ms/asm-plugin-ca
...
// Storage version of v20250801.IstioComponents
...
func (components *IstioComponents) AssignProperties_From_IstioComponents(source *storage.IstioComponents) error {
	...
	if source.ProxyRedirectionMechanism != nil {
		propertyBag.Add("ProxyRedirectionMechanism", *source.ProxyRedirectionMechanism)
	} else {
...
// Storage version of v20250801.IstioComponents_STATUS
// Istio components configuration.
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfileKubeStateMetrics
...
// Storage version of v20250801.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS
// Kube State Metrics profile for the Azure Managed Prometheus addon. These optional settings are for the
// kube-state-metrics pod that is deployed with the addon. See aka.ms/AzureManagedPrometheus-optional-parameters for
// details.
...
// Storage version of v20250801.ManagedClusterIngressProfileNginx
...
// Storage version of v20250801.ManagedClusterIngressProfileNginx_STATUS
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs
...
// AssignProperties_From_ManagedClusterLoadBalancerProfileManagedOutboundIPs populates our ManagedClusterLoadBalancerProfile_ManagedOutboundIPs from the provided source ManagedClusterLoadBalancerProfileManagedOutboundIPs
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) AssignProperties_From_ManagedClusterLoadBalancerProfileManagedOutboundIPs(source *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileManagedOutboundIPs populates the provided destination ManagedClusterLoadBalancerProfileManagedOutboundIPs from our ManagedClusterLoadBalancerProfile_ManagedOutboundIPs
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) AssignProperties_To_ManagedClusterLoadBalancerProfileManagedOutboundIPs(destination *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs) error {
	// Clone the existing property bag
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS
...
// AssignProperties_From_ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS populates our ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS from the provided source ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS(source *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS populates the provided destination ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS from our ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS(destination *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes
...
// AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPPrefixes populates our ManagedClusterLoadBalancerProfile_OutboundIPPrefixes from the provided source ManagedClusterLoadBalancerProfileOutboundIPPrefixes
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPPrefixes(source *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPPrefixes populates the provided destination ManagedClusterLoadBalancerProfileOutboundIPPrefixes from our ManagedClusterLoadBalancerProfile_OutboundIPPrefixes
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPPrefixes(destination *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes) error {
	// Clone the existing property bag
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS
...
// AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS populates our ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS from the provided source ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS(source *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS populates the provided destination ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS from our ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS(destination *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(prefixes.PropertyBag)
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_OutboundIPs
type ManagedClusterLoadBalancerProfile_OutboundIPs struct {
	PropertyBag genruntime.PropertyBag `json:"$propertyBag,omitempty"`
	PublicIPs   []ResourceReference    `json:"publicIPs,omitempty"`
}

// AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPs populates our ManagedClusterLoadBalancerProfile_OutboundIPs from the provided source ManagedClusterLoadBalancerProfileOutboundIPs
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs) AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPs(source *storage.ManagedClusterLoadBalancerProfileOutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPs populates the provided destination ManagedClusterLoadBalancerProfileOutboundIPs from our ManagedClusterLoadBalancerProfile_OutboundIPs
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs) AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPs(destination *storage.ManagedClusterLoadBalancerProfileOutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)
...
// Storage version of v20250801.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS
...
// AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPs_STATUS populates our ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS from the provided source ManagedClusterLoadBalancerProfileOutboundIPs_STATUS
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfileOutboundIPs_STATUS(source *storage.ManagedClusterLoadBalancerProfileOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPs_STATUS populates the provided destination ManagedClusterLoadBalancerProfileOutboundIPs_STATUS from our ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfileOutboundIPs_STATUS(destination *storage.ManagedClusterLoadBalancerProfileOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)
...
// Storage version of v20250801.ManagedClusterManagedOutboundIPProfile
...
// Storage version of v20250801.ManagedClusterManagedOutboundIPProfile_STATUS
// Profile of the managed outbound IP resources of the managed cluster.
...
// Storage version of v20250801.ManagedClusterPodIdentity_ProvisioningInfo_STATUS
...
// AssignProperties_From_ManagedClusterPodIdentityProvisioningInfo_STATUS populates our ManagedClusterPodIdentity_ProvisioningInfo_STATUS from the provided source ManagedClusterPodIdentityProvisioningInfo_STATUS
func (info *ManagedClusterPodIdentity_ProvisioningInfo_STATUS) AssignProperties_From_ManagedClusterPodIdentityProvisioningInfo_STATUS(source *storage.ManagedClusterPodIdentityProvisioningInfo_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
// AssignProperties_To_ManagedClusterPodIdentityProvisioningInfo_STATUS populates the provided destination ManagedClusterPodIdentityProvisioningInfo_STATUS from our ManagedClusterPodIdentity_ProvisioningInfo_STATUS
func (info *ManagedClusterPodIdentity_ProvisioningInfo_STATUS) AssignProperties_To_ManagedClusterPodIdentityProvisioningInfo_STATUS(destination *storage.ManagedClusterPodIdentityProvisioningInfo_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(info.PropertyBag)
...
// Storage version of v20250801.ManagedClusterSecurityProfileDefenderSecurityMonitoring
...
// Storage version of v20250801.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS
// Microsoft Defender settings for the security profile threat detection.
...
// Storage version of v20250801.ResourceReference_STATUS
...
type augmentConversionForAdvancedNetworkingSecurity interface {
	AssignPropertiesFrom(src *storage.AdvancedNetworkingSecurity) error
	AssignPropertiesTo(dst *storage.AdvancedNetworkingSecurity) error
}

type augmentConversionForAdvancedNetworkingSecurity_STATUS interface {
	AssignPropertiesFrom(src *storage.AdvancedNetworkingSecurity_STATUS) error
	AssignPropertiesTo(dst *storage.AdvancedNetworkingSecurity_STATUS) error
}
...
type augmentConversionForManagedClusterIngressProfileNginx interface {
	AssignPropertiesFrom(src *storage.ManagedClusterIngressProfileNginx) error
	AssignPropertiesTo(dst *storage.ManagedClusterIngressProfileNginx) error
}

type augmentConversionForManagedClusterIngressProfileNginx_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterIngressProfileNginx_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterIngressProfileNginx_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_ManagedOutboundIPs interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileManagedOutboundIPs_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPPrefixes interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileOutboundIPPrefixes_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPs interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileOutboundIPs) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileOutboundIPs) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPs_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterLoadBalancerProfileOutboundIPs_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterLoadBalancerProfileOutboundIPs_STATUS) error
}
...
type augmentConversionForManagedClusterPodIdentity_ProvisioningInfo_STATUS interface {
	AssignPropertiesFrom(src *storage.ManagedClusterPodIdentityProvisioningInfo_STATUS) error
	AssignPropertiesTo(dst *storage.ManagedClusterPodIdentityProvisioningInfo_STATUS) error
}
...
// Storage version of v20250801.IstioEgressGateway
...
func (gateway *IstioEgressGateway) AssignProperties_From_IstioEgressGateway(source *storage.IstioEgressGateway) error {
	...
	if source.GatewayConfigurationName != nil {
		propertyBag.Add("GatewayConfigurationName", *source.GatewayConfigurationName)
	} else {
	...
	if source.Namespace != nil {
		propertyBag.Add("Namespace", *source.Namespace)
	} else {
...
func (gateway *IstioEgressGateway) AssignProperties_To_IstioEgressGateway(destination *storage.IstioEgressGateway) error {
	...
	if propertyBag.Contains("GatewayConfigurationName") {
		...
		destination.GatewayConfigurationName = &gatewayConfigurationName
	} else {
		destination.GatewayConfigurationName = nil
	}
...
// Storage version of v20250801.IstioEgressGateway_STATUS
// Istio egress gateway configuration.
...
// Storage version of v20250801.IstioIngressGateway
...
// Storage version of v20250801.IstioIngressGateway_STATUS
// Istio ingress gateway configuration. For now, we support up to one external ingress gateway named
// `aks-istio-ingressgateway-external` and one internal ingress gateway named `aks-istio-ingressgateway-internal`.
...
// Storage version of v20250801.IstioPluginCertificateAuthority
...
// Storage version of v20250801.IstioPluginCertificateAuthority_STATUS
// Plugin certificates information for Service Mesh.
...
// Storage version of v20250801.ManagedClusterPodIdentityProvisioningError_STATUS
...
// Storage version of v20250801.ResourceReference
// A reference to an Azure resource.
...
// Storage version of v20250801.ManagedClusterPodIdentityProvisioningErrorBody_STATUS
// An error response from the pod identity provisioning.
...
// Storage version of v20250801.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled
