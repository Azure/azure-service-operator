...
// Storage version of v20250801.ManagedClustersAgentPool
...
// Storage version of v20250801.ManagedClustersAgentPool_Spec
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_From_ManagedClustersAgentPool_Spec(source *storage.ManagedClustersAgentPool_Spec) error {
	...
	// PodIPAllocationMode
	pool.PodIPAllocationMode = genruntime.ClonePointerToString(source.PodIPAllocationMode)
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_To_ManagedClustersAgentPool_Spec(destination *storage.ManagedClustersAgentPool_Spec) error {
	...
	if pool.GpuProfile != nil {
		...
		err := pool.GpuProfile.AssignProperties_To_GPUProfile(&gpuProfile)
		if err != nil {
	...
	// PodIPAllocationMode
	destination.PodIPAllocationMode = genruntime.ClonePointerToString(pool.PodIPAllocationMode)
...
// Storage version of v20250801.ManagedClustersAgentPool_STATUS
...
func (pool *ManagedClustersAgentPool_STATUS) AssignProperties_To_ManagedClustersAgentPool_STATUS(destination *storage.ManagedClustersAgentPool_STATUS) error {
	...
	if pool.GpuProfile != nil {
		...
		err := pool.GpuProfile.AssignProperties_To_GPUProfile_STATUS(&gpuProfile)
		if err != nil {
	...
	if pool.Status != nil {
		...
		err := pool.Status.AssignProperties_To_AgentPoolStatus_STATUS(&status)
		if err != nil {
...
// Storage version of v20250801.AgentPoolGatewayProfile
...
func (profile *AgentPoolGatewayProfile) AssignProperties_From_AgentPoolGatewayProfile(source *storage.AgentPoolGatewayProfile) error {
	...
	// Invoke the augmentConversionForAgentPoolGatewayProfile interface (if implemented) to customize the conversion
	var profileAsAny any = profile
	if augmentedProfile, ok := profileAsAny.(augmentConversionForAgentPoolGatewayProfile); ok {
...
// Storage version of v20250801.AgentPoolGatewayProfile_STATUS
// Profile of the managed cluster gateway agent pool.
...
func (profile *AgentPoolGatewayProfile_STATUS) AssignProperties_From_AgentPoolGatewayProfile_STATUS(source *storage.AgentPoolGatewayProfile_STATUS) error {
	...
	// Invoke the augmentConversionForAgentPoolGatewayProfile_STATUS interface (if implemented) to customize the conversion
	var profileAsAny any = profile
	if augmentedProfile, ok := profileAsAny.(augmentConversionForAgentPoolGatewayProfile_STATUS); ok {
		err := augmentedProfile.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
// Storage version of v20250801.AgentPoolNetworkProfile
...
// Storage version of v20250801.AgentPoolNetworkProfile_STATUS
// Network settings of an agent pool.
...
// Storage version of v20250801.AgentPoolSecurityProfile
...
// Storage version of v20250801.AgentPoolSecurityProfile_STATUS
// The security settings of an agent pool.
...
// Storage version of v20250801.AgentPoolStatus_STATUS
...
// AssignProperties_From_AgentPoolStatus_STATUS populates our AgentPoolStatus_STATUS from the provided source AgentPoolStatus_STATUS
func (status *AgentPoolStatus_STATUS) AssignProperties_From_AgentPoolStatus_STATUS(source *storage.AgentPoolStatus_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// Invoke the augmentConversionForAgentPoolStatus_STATUS interface (if implemented) to customize the conversion
	var statusAsAny any = status
	if augmentedStatus, ok := statusAsAny.(augmentConversionForAgentPoolStatus_STATUS); ok {
...
// AssignProperties_To_AgentPoolStatus_STATUS populates the provided destination AgentPoolStatus_STATUS from our AgentPoolStatus_STATUS
func (status *AgentPoolStatus_STATUS) AssignProperties_To_AgentPoolStatus_STATUS(destination *storage.AgentPoolStatus_STATUS) error {
	// Clone the existing property bag
...
// Storage version of v20250801.AgentPoolUpgradeSettings
...
func (settings *AgentPoolUpgradeSettings) AssignProperties_From_AgentPoolUpgradeSettings(source *storage.AgentPoolUpgradeSettings) error {
	...
	// MaxUnavailable
	settings.MaxUnavailable = genruntime.ClonePointerToString(source.MaxUnavailable)

	// NodeSoakDurationInMinutes
	settings.NodeSoakDurationInMinutes = genruntime.ClonePointerToInt(source.NodeSoakDurationInMinutes)

	// UndrainableNodeBehavior
	settings.UndrainableNodeBehavior = genruntime.ClonePointerToString(source.UndrainableNodeBehavior)
...
func (settings *AgentPoolUpgradeSettings) AssignProperties_To_AgentPoolUpgradeSettings(destination *storage.AgentPoolUpgradeSettings) error {
	...
	// MaxUnavailable
	destination.MaxUnavailable = genruntime.ClonePointerToString(settings.MaxUnavailable)

	// NodeSoakDurationInMinutes
	destination.NodeSoakDurationInMinutes = genruntime.ClonePointerToInt(settings.NodeSoakDurationInMinutes)

	// UndrainableNodeBehavior
	destination.UndrainableNodeBehavior = genruntime.ClonePointerToString(settings.UndrainableNodeBehavior)
...
// Storage version of v20250801.AgentPoolUpgradeSettings_STATUS
// Settings for upgrading an agentpool
...
// Storage version of v20250801.AgentPoolWindowsProfile
...
// Storage version of v20250801.AgentPoolWindowsProfile_STATUS
// The Windows agent pool's specific profile.
...
// Storage version of v20250801.CreationData
...
// Storage version of v20250801.CreationData_STATUS
// Data used when creating a target resource from a source resource.
...
// Storage version of v20250801.GPUProfile
...
func (profile *GPUProfile) AssignProperties_From_GPUProfile(source *storage.GPUProfile) error {
	...
	// Driver
	profile.Driver = genruntime.ClonePointerToString(source.Driver)
...
func (profile *GPUProfile) AssignProperties_To_GPUProfile(destination *storage.GPUProfile) error {
	...
	// Driver
	destination.Driver = genruntime.ClonePointerToString(profile.Driver)
...
// Storage version of v20250801.GPUProfile_STATUS
// GPU settings for the Agent Pool.
...
// Storage version of v20250801.KubeletConfig
...
// Storage version of v20250801.KubeletConfig_STATUS
// Kubelet configurations of agent nodes. See [AKS custom node
// configuration](https://docs.microsoft.com/azure/aks/custom-node-configuration) for more details.
...
// Storage version of v20250801.LinuxOSConfig
...
// Storage version of v20250801.LinuxOSConfig_STATUS
// OS configurations of Linux agent nodes. See [AKS custom node
// configuration](https://docs.microsoft.com/azure/aks/custom-node-configuration) for more details.
...
// Storage version of v20250801.ManagedClustersAgentPoolOperatorSpec
...
// Storage version of v20250801.PowerState
...
// Storage version of v20250801.VirtualMachineNodes
...
// Storage version of v20250801.VirtualMachineNodes_STATUS
// Current status on a group of nodes of the same vm size.
...
// Storage version of v20250801.VirtualMachinesProfile
...
// Storage version of v20250801.VirtualMachinesProfile_STATUS
// Specifications on VirtualMachines agent pool.
...
type augmentConversionForAgentPoolGatewayProfile interface {
	AssignPropertiesFrom(src *storage.AgentPoolGatewayProfile) error
	AssignPropertiesTo(dst *storage.AgentPoolGatewayProfile) error
}

type augmentConversionForAgentPoolGatewayProfile_STATUS interface {
	AssignPropertiesFrom(src *storage.AgentPoolGatewayProfile_STATUS) error
	AssignPropertiesTo(dst *storage.AgentPoolGatewayProfile_STATUS) error
}
...
type augmentConversionForAgentPoolStatus_STATUS interface {
	AssignPropertiesFrom(src *storage.AgentPoolStatus_STATUS) error
	AssignPropertiesTo(dst *storage.AgentPoolStatus_STATUS) error
}
...
// Storage version of v20250801.IPTag
...
// Storage version of v20250801.IPTag_STATUS
// Contains the IPTag associated with the object.
...
// Storage version of v20250801.PortRange
// The port range.
...
// Storage version of v20250801.PortRange_STATUS
// The port range.
...
// Storage version of v20250801.ScaleProfile
...
// Storage version of v20250801.ScaleProfile_STATUS
// Specifications on how to scale a VirtualMachines agent pool.
...
// Storage version of v20250801.SysctlConfig
...
// Storage version of v20250801.SysctlConfig_STATUS
// Sysctl settings for Linux agent nodes.
...
// Storage version of v20250801.ManualScaleProfile
...
// Storage version of v20250801.ManualScaleProfile_STATUS
// Specifications on number of machines.
