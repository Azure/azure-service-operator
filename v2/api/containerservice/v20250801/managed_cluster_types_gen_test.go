...
func AddIndependentPropertyGeneratorsForAdvancedNetworkingSecurity(gens map[string]gopter.Gen) {
	gens["AdvancedNetworkPolicies"] = gen.PtrOf(gen.OneConstOf(AdvancedNetworkingSecurity_AdvancedNetworkPolicies_FQDN, AdvancedNetworkingSecurity_AdvancedNetworkPolicies_L7, AdvancedNetworkingSecurity_AdvancedNetworkPolicies_None))
	gens["Enabled"] = gen.PtrOf(gen.Bool())
}
...
func AddIndependentPropertyGeneratorsForContainerServiceNetworkProfile(gens map[string]gopter.Gen) {
	...
	gens["NetworkPolicy"] = gen.PtrOf(gen.OneConstOf(
		ContainerServiceNetworkProfile_NetworkPolicy_Azure,
		ContainerServiceNetworkProfile_NetworkPolicy_Calico,
		ContainerServiceNetworkProfile_NetworkPolicy_Cilium,
		ContainerServiceNetworkProfile_NetworkPolicy_None))
...
func AddIndependentPropertyGeneratorsForManagedClusterIngressProfileNginx(gens map[string]gopter.Gen) {
	gens["DefaultIngressControllerType"] = gen.PtrOf(gen.OneConstOf(
		ManagedClusterIngressProfileNginx_DefaultIngressControllerType_AnnotationControlled,
		ManagedClusterIngressProfileNginx_DefaultIngressControllerType_External,
		ManagedClusterIngressProfileNginx_DefaultIngressControllerType_Internal,
		ManagedClusterIngressProfileNginx_DefaultIngressControllerType_None))
}
