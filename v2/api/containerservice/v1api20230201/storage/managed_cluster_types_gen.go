...
func (cluster *ManagedCluster) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20230701s.ManagedCluster)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20230701/storage/ManagedCluster but received %T instead", hub)
	}
...
func (cluster *ManagedCluster) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20230701s.ManagedCluster)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20230701/storage/ManagedCluster but received %T instead", hub)
	}
...
func (cluster *ManagedCluster) AssignProperties_From_ManagedCluster(source *v20230701s.ManagedCluster) error {
...
func (cluster *ManagedCluster) AssignProperties_To_ManagedCluster(destination *v20230701s.ManagedCluster) error {

	// ObjectMeta
	destination.ObjectMeta = *cluster.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230701s.ManagedCluster_Spec
	...
	// Status
	var status v20230701s.ManagedCluster_STATUS
...
type augmentConversionForManagedCluster interface {
	AssignPropertiesFrom(src *v20230701s.ManagedCluster) error
	AssignPropertiesTo(dst *v20230701s.ManagedCluster) error
}
...
func (cluster *ManagedCluster_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230701s.ManagedCluster_Spec)
	if ok {
	...
	src = &v20230701s.ManagedCluster_Spec{}
...
func (cluster *ManagedCluster_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230701s.ManagedCluster_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230701s.ManagedCluster_Spec{}
...
func (cluster *ManagedCluster_Spec) AssignProperties_From_ManagedCluster_Spec(source *v20230701s.ManagedCluster_Spec) error {
...
func (cluster *ManagedCluster_Spec) AssignProperties_To_ManagedCluster_Spec(destination *v20230701s.ManagedCluster_Spec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(cluster.PropertyBag)

	// AadProfile
	if cluster.AadProfile != nil {
		var aadProfile v20230701s.ManagedClusterAADProfile
	...
	if cluster.AddonProfiles != nil {
		addonProfileMap := make(map[string]v20230701s.ManagedClusterAddonProfile, len(cluster.AddonProfiles))
		for addonProfileKey, addonProfileValue := range cluster.AddonProfiles {
			// Shadow the loop variable to avoid aliasing
			addonProfileValue := addonProfileValue
			var addonProfile v20230701s.ManagedClusterAddonProfile
	...
	if cluster.AgentPoolProfiles != nil {
		agentPoolProfileList := make([]v20230701s.ManagedClusterAgentPoolProfile, len(cluster.AgentPoolProfiles))
		for agentPoolProfileIndex, agentPoolProfileItem := range cluster.AgentPoolProfiles {
			// Shadow the loop variable to avoid aliasing
			agentPoolProfileItem := agentPoolProfileItem
			var agentPoolProfile v20230701s.ManagedClusterAgentPoolProfile
	...
	if cluster.ApiServerAccessProfile != nil {
		var apiServerAccessProfile v20230701s.ManagedClusterAPIServerAccessProfile
	...
	if cluster.AutoScalerProfile != nil {
		var autoScalerProfile v20230701s.ManagedClusterProperties_AutoScalerProfile
	...
	if cluster.AutoUpgradeProfile != nil {
		var autoUpgradeProfile v20230701s.ManagedClusterAutoUpgradeProfile
	...
	if cluster.AzureMonitorProfile != nil {
		var azureMonitorProfile v20230701s.ManagedClusterAzureMonitorProfile
	...
	if cluster.ExtendedLocation != nil {
		var extendedLocation v20230701s.ExtendedLocation
	...
	if cluster.HttpProxyConfig != nil {
		var httpProxyConfig v20230701s.ManagedClusterHTTPProxyConfig
	...
	if cluster.Identity != nil {
		var identity v20230701s.ManagedClusterIdentity
	...
	if cluster.IdentityProfile != nil {
		identityProfileMap := make(map[string]v20230701s.UserAssignedIdentity, len(cluster.IdentityProfile))
		for identityProfileKey, identityProfileValue := range cluster.IdentityProfile {
			// Shadow the loop variable to avoid aliasing
			identityProfileValue := identityProfileValue
			var identityProfile v20230701s.UserAssignedIdentity
	...
	if cluster.LinuxProfile != nil {
		var linuxProfile v20230701s.ContainerServiceLinuxProfile
	...
	if cluster.NetworkProfile != nil {
		var networkProfile v20230701s.ContainerServiceNetworkProfile
	...
	if cluster.OidcIssuerProfile != nil {
		var oidcIssuerProfile v20230701s.ManagedClusterOIDCIssuerProfile
	...
	if cluster.OperatorSpec != nil {
		var operatorSpec v20230701s.ManagedClusterOperatorSpec
	...
	if cluster.PodIdentityProfile != nil {
		var podIdentityProfile v20230701s.ManagedClusterPodIdentityProfile
	...
	if cluster.PrivateLinkResources != nil {
		privateLinkResourceList := make([]v20230701s.PrivateLinkResource, len(cluster.PrivateLinkResources))
		for privateLinkResourceIndex, privateLinkResourceItem := range cluster.PrivateLinkResources {
			// Shadow the loop variable to avoid aliasing
			privateLinkResourceItem := privateLinkResourceItem
			var privateLinkResource v20230701s.PrivateLinkResource
	...
	if cluster.SecurityProfile != nil {
		var securityProfile v20230701s.ManagedClusterSecurityProfile
	...
	if cluster.ServicePrincipalProfile != nil {
		var servicePrincipalProfile v20230701s.ManagedClusterServicePrincipalProfile
	...
	// Sku
	if cluster.Sku != nil {
		var sku v20230701s.ManagedClusterSKU
	...
	if cluster.StorageProfile != nil {
		var storageProfile v20230701s.ManagedClusterStorageProfile
	...
	if propertyBag.Contains("UpgradeSettings") {
		...
		var upgradeSetting v20230701s.ClusterUpgradeSettings
	...
	if cluster.WindowsProfile != nil {
		var windowsProfile v20230701s.ManagedClusterWindowsProfile
	...
	if cluster.WorkloadAutoScalerProfile != nil {
		var workloadAutoScalerProfile v20230701s.ManagedClusterWorkloadAutoScalerProfile
...
func (cluster *ManagedCluster_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230701s.ManagedCluster_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230701s.ManagedCluster_STATUS{}
...
func (cluster *ManagedCluster_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230701s.ManagedCluster_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230701s.ManagedCluster_STATUS{}
...
func (cluster *ManagedCluster_STATUS) AssignProperties_From_ManagedCluster_STATUS(source *v20230701s.ManagedCluster_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (cluster *ManagedCluster_STATUS) AssignProperties_To_ManagedCluster_STATUS(destination *v20230701s.ManagedCluster_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(cluster.PropertyBag)

	// AadProfile
	if cluster.AadProfile != nil {
		var aadProfile v20230701s.ManagedClusterAADProfile_STATUS
	...
	// AddonProfiles
	if cluster.AddonProfiles != nil {
		addonProfileMap := make(map[string]v20230701s.ManagedClusterAddonProfile_STATUS, len(cluster.AddonProfiles))
		for addonProfileKey, addonProfileValue := range cluster.AddonProfiles {
			// Shadow the loop variable to avoid aliasing
			addonProfileValue := addonProfileValue
			var addonProfile v20230701s.ManagedClusterAddonProfile_STATUS
	...
	// AgentPoolProfiles
	if cluster.AgentPoolProfiles != nil {
		agentPoolProfileList := make([]v20230701s.ManagedClusterAgentPoolProfile_STATUS, len(cluster.AgentPoolProfiles))
		for agentPoolProfileIndex, agentPoolProfileItem := range cluster.AgentPoolProfiles {
			// Shadow the loop variable to avoid aliasing
			agentPoolProfileItem := agentPoolProfileItem
			var agentPoolProfile v20230701s.ManagedClusterAgentPoolProfile_STATUS
	...
	// ApiServerAccessProfile
	if cluster.ApiServerAccessProfile != nil {
		var apiServerAccessProfile v20230701s.ManagedClusterAPIServerAccessProfile_STATUS
	...
	// AutoScalerProfile
	if cluster.AutoScalerProfile != nil {
		var autoScalerProfile v20230701s.ManagedClusterProperties_AutoScalerProfile_STATUS
	...
	// AutoUpgradeProfile
	if cluster.AutoUpgradeProfile != nil {
		var autoUpgradeProfile v20230701s.ManagedClusterAutoUpgradeProfile_STATUS
	...
	// AzureMonitorProfile
	if cluster.AzureMonitorProfile != nil {
		var azureMonitorProfile v20230701s.ManagedClusterAzureMonitorProfile_STATUS
	...
	// ExtendedLocation
	if cluster.ExtendedLocation != nil {
		var extendedLocation v20230701s.ExtendedLocation_STATUS
	...
	// HttpProxyConfig
	if cluster.HttpProxyConfig != nil {
		var httpProxyConfig v20230701s.ManagedClusterHTTPProxyConfig_STATUS
	...
	// Identity
	if cluster.Identity != nil {
		var identity v20230701s.ManagedClusterIdentity_STATUS
	...
	// IdentityProfile
	if cluster.IdentityProfile != nil {
		identityProfileMap := make(map[string]v20230701s.UserAssignedIdentity_STATUS, len(cluster.IdentityProfile))
		for identityProfileKey, identityProfileValue := range cluster.IdentityProfile {
			// Shadow the loop variable to avoid aliasing
			identityProfileValue := identityProfileValue
			var identityProfile v20230701s.UserAssignedIdentity_STATUS
	...
	// LinuxProfile
	if cluster.LinuxProfile != nil {
		var linuxProfile v20230701s.ContainerServiceLinuxProfile_STATUS
	...
	// NetworkProfile
	if cluster.NetworkProfile != nil {
		var networkProfile v20230701s.ContainerServiceNetworkProfile_STATUS
	...
	// OidcIssuerProfile
	if cluster.OidcIssuerProfile != nil {
		var oidcIssuerProfile v20230701s.ManagedClusterOIDCIssuerProfile_STATUS
	...
	// PodIdentityProfile
	if cluster.PodIdentityProfile != nil {
		var podIdentityProfile v20230701s.ManagedClusterPodIdentityProfile_STATUS
	...
	if cluster.PowerState != nil {
		var powerState v20230701s.PowerState_STATUS
	...
	// PrivateLinkResources
	if cluster.PrivateLinkResources != nil {
		privateLinkResourceList := make([]v20230701s.PrivateLinkResource_STATUS, len(cluster.PrivateLinkResources))
		for privateLinkResourceIndex, privateLinkResourceItem := range cluster.PrivateLinkResources {
			// Shadow the loop variable to avoid aliasing
			privateLinkResourceItem := privateLinkResourceItem
			var privateLinkResource v20230701s.PrivateLinkResource_STATUS
	...
	// SecurityProfile
	if cluster.SecurityProfile != nil {
		var securityProfile v20230701s.ManagedClusterSecurityProfile_STATUS
	...
	// ServicePrincipalProfile
	if cluster.ServicePrincipalProfile != nil {
		var servicePrincipalProfile v20230701s.ManagedClusterServicePrincipalProfile_STATUS
	...
	// Sku
	if cluster.Sku != nil {
		var sku v20230701s.ManagedClusterSKU_STATUS
	...
	// StorageProfile
	if cluster.StorageProfile != nil {
		var storageProfile v20230701s.ManagedClusterStorageProfile_STATUS
	...
	if propertyBag.Contains("UpgradeSettings") {
		...
		var upgradeSetting v20230701s.ClusterUpgradeSettings_STATUS
	...
	// WindowsProfile
	if cluster.WindowsProfile != nil {
		var windowsProfile v20230701s.ManagedClusterWindowsProfile_STATUS
	...
	// WorkloadAutoScalerProfile
	if cluster.WorkloadAutoScalerProfile != nil {
		var workloadAutoScalerProfile v20230701s.ManagedClusterWorkloadAutoScalerProfile_STATUS
...
type augmentConversionForManagedCluster_Spec interface {
	AssignPropertiesFrom(src *v20230701s.ManagedCluster_Spec) error
	AssignPropertiesTo(dst *v20230701s.ManagedCluster_Spec) error
}

type augmentConversionForManagedCluster_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedCluster_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedCluster_STATUS) error
}
...
func (profile *ContainerServiceLinuxProfile) AssignProperties_From_ContainerServiceLinuxProfile(source *v20230701s.ContainerServiceLinuxProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ContainerServiceLinuxProfile) AssignProperties_To_ContainerServiceLinuxProfile(destination *v20230701s.ContainerServiceLinuxProfile) error {
	// Clone the existing property bag
	...
	// Ssh
	if profile.Ssh != nil {
		var ssh v20230701s.ContainerServiceSshConfiguration
...
func (profile *ContainerServiceLinuxProfile_STATUS) AssignProperties_From_ContainerServiceLinuxProfile_STATUS(source *v20230701s.ContainerServiceLinuxProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ContainerServiceLinuxProfile_STATUS) AssignProperties_To_ContainerServiceLinuxProfile_STATUS(destination *v20230701s.ContainerServiceLinuxProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// Ssh
	if profile.Ssh != nil {
		var ssh v20230701s.ContainerServiceSshConfiguration_STATUS
...
func (profile *ContainerServiceNetworkProfile) AssignProperties_From_ContainerServiceNetworkProfile(source *v20230701s.ContainerServiceNetworkProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ContainerServiceNetworkProfile) AssignProperties_To_ContainerServiceNetworkProfile(destination *v20230701s.ContainerServiceNetworkProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.LoadBalancerProfile != nil {
		var loadBalancerProfile v20230701s.ManagedClusterLoadBalancerProfile
	...
	if profile.NatGatewayProfile != nil {
		var natGatewayProfile v20230701s.ManagedClusterNATGatewayProfile
...
func (profile *ContainerServiceNetworkProfile_STATUS) AssignProperties_From_ContainerServiceNetworkProfile_STATUS(source *v20230701s.ContainerServiceNetworkProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ContainerServiceNetworkProfile_STATUS) AssignProperties_To_ContainerServiceNetworkProfile_STATUS(destination *v20230701s.ContainerServiceNetworkProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// LoadBalancerProfile
	if profile.LoadBalancerProfile != nil {
		var loadBalancerProfile v20230701s.ManagedClusterLoadBalancerProfile_STATUS
	...
	// NatGatewayProfile
	if profile.NatGatewayProfile != nil {
		var natGatewayProfile v20230701s.ManagedClusterNATGatewayProfile_STATUS
...
func (location *ExtendedLocation) AssignProperties_From_ExtendedLocation(source *v20230701s.ExtendedLocation) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (location *ExtendedLocation) AssignProperties_To_ExtendedLocation(destination *v20230701s.ExtendedLocation) error {
	// Clone the existing property bag
...
func (location *ExtendedLocation_STATUS) AssignProperties_From_ExtendedLocation_STATUS(source *v20230701s.ExtendedLocation_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (location *ExtendedLocation_STATUS) AssignProperties_To_ExtendedLocation_STATUS(destination *v20230701s.ExtendedLocation_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(location.PropertyBag)
...
func (profile *ManagedClusterAADProfile) AssignProperties_From_ManagedClusterAADProfile(source *v20230701s.ManagedClusterAADProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAADProfile) AssignProperties_To_ManagedClusterAADProfile(destination *v20230701s.ManagedClusterAADProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAADProfile_STATUS) AssignProperties_From_ManagedClusterAADProfile_STATUS(source *v20230701s.ManagedClusterAADProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAADProfile_STATUS) AssignProperties_To_ManagedClusterAADProfile_STATUS(destination *v20230701s.ManagedClusterAADProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAddonProfile) AssignProperties_From_ManagedClusterAddonProfile(source *v20230701s.ManagedClusterAddonProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAddonProfile) AssignProperties_To_ManagedClusterAddonProfile(destination *v20230701s.ManagedClusterAddonProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAddonProfile_STATUS) AssignProperties_From_ManagedClusterAddonProfile_STATUS(source *v20230701s.ManagedClusterAddonProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAddonProfile_STATUS) AssignProperties_To_ManagedClusterAddonProfile_STATUS(destination *v20230701s.ManagedClusterAddonProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.Identity != nil {
		var identity v20230701s.UserAssignedIdentity_STATUS
...
func (profile *ManagedClusterAgentPoolProfile) AssignProperties_From_ManagedClusterAgentPoolProfile(source *v20230701s.ManagedClusterAgentPoolProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAgentPoolProfile) AssignProperties_To_ManagedClusterAgentPoolProfile(destination *v20230701s.ManagedClusterAgentPoolProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.CreationData != nil {
		var creationDatum v20230701s.CreationData
	...
	if profile.KubeletConfig != nil {
		var kubeletConfig v20230701s.KubeletConfig
	...
	if profile.LinuxOSConfig != nil {
		var linuxOSConfig v20230701s.LinuxOSConfig
	...
	if profile.PowerState != nil {
		var powerState v20230701s.PowerState
	...
	if profile.UpgradeSettings != nil {
		var upgradeSetting v20230701s.AgentPoolUpgradeSettings
...
func (profile *ManagedClusterAgentPoolProfile_STATUS) AssignProperties_From_ManagedClusterAgentPoolProfile_STATUS(source *v20230701s.ManagedClusterAgentPoolProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAgentPoolProfile_STATUS) AssignProperties_To_ManagedClusterAgentPoolProfile_STATUS(destination *v20230701s.ManagedClusterAgentPoolProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// CreationData
	if profile.CreationData != nil {
		var creationDatum v20230701s.CreationData_STATUS
	...
	// KubeletConfig
	if profile.KubeletConfig != nil {
		var kubeletConfig v20230701s.KubeletConfig_STATUS
	...
	// LinuxOSConfig
	if profile.LinuxOSConfig != nil {
		var linuxOSConfig v20230701s.LinuxOSConfig_STATUS
	...
	// UpgradeSettings
	if profile.UpgradeSettings != nil {
		var upgradeSetting v20230701s.AgentPoolUpgradeSettings_STATUS
...
func (profile *ManagedClusterAPIServerAccessProfile) AssignProperties_From_ManagedClusterAPIServerAccessProfile(source *v20230701s.ManagedClusterAPIServerAccessProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAPIServerAccessProfile) AssignProperties_To_ManagedClusterAPIServerAccessProfile(destination *v20230701s.ManagedClusterAPIServerAccessProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAPIServerAccessProfile_STATUS) AssignProperties_From_ManagedClusterAPIServerAccessProfile_STATUS(source *v20230701s.ManagedClusterAPIServerAccessProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAPIServerAccessProfile_STATUS) AssignProperties_To_ManagedClusterAPIServerAccessProfile_STATUS(destination *v20230701s.ManagedClusterAPIServerAccessProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAutoUpgradeProfile) AssignProperties_From_ManagedClusterAutoUpgradeProfile(source *v20230701s.ManagedClusterAutoUpgradeProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAutoUpgradeProfile) AssignProperties_To_ManagedClusterAutoUpgradeProfile(destination *v20230701s.ManagedClusterAutoUpgradeProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAutoUpgradeProfile_STATUS) AssignProperties_From_ManagedClusterAutoUpgradeProfile_STATUS(source *v20230701s.ManagedClusterAutoUpgradeProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAutoUpgradeProfile_STATUS) AssignProperties_To_ManagedClusterAutoUpgradeProfile_STATUS(destination *v20230701s.ManagedClusterAutoUpgradeProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterAzureMonitorProfile) AssignProperties_From_ManagedClusterAzureMonitorProfile(source *v20230701s.ManagedClusterAzureMonitorProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAzureMonitorProfile) AssignProperties_To_ManagedClusterAzureMonitorProfile(destination *v20230701s.ManagedClusterAzureMonitorProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// Metrics
	if profile.Metrics != nil {
		var metric v20230701s.ManagedClusterAzureMonitorProfileMetrics
...
func (profile *ManagedClusterAzureMonitorProfile_STATUS) AssignProperties_From_ManagedClusterAzureMonitorProfile_STATUS(source *v20230701s.ManagedClusterAzureMonitorProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterAzureMonitorProfile_STATUS) AssignProperties_To_ManagedClusterAzureMonitorProfile_STATUS(destination *v20230701s.ManagedClusterAzureMonitorProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// Metrics
	if profile.Metrics != nil {
		var metric v20230701s.ManagedClusterAzureMonitorProfileMetrics_STATUS
...
func (config *ManagedClusterHTTPProxyConfig) AssignProperties_From_ManagedClusterHTTPProxyConfig(source *v20230701s.ManagedClusterHTTPProxyConfig) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (config *ManagedClusterHTTPProxyConfig) AssignProperties_To_ManagedClusterHTTPProxyConfig(destination *v20230701s.ManagedClusterHTTPProxyConfig) error {
	// Clone the existing property bag
...
func (config *ManagedClusterHTTPProxyConfig_STATUS) AssignProperties_From_ManagedClusterHTTPProxyConfig_STATUS(source *v20230701s.ManagedClusterHTTPProxyConfig_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (config *ManagedClusterHTTPProxyConfig_STATUS) AssignProperties_To_ManagedClusterHTTPProxyConfig_STATUS(destination *v20230701s.ManagedClusterHTTPProxyConfig_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(config.PropertyBag)
...
func (identity *ManagedClusterIdentity) AssignProperties_From_ManagedClusterIdentity(source *v20230701s.ManagedClusterIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterIdentity) AssignProperties_To_ManagedClusterIdentity(destination *v20230701s.ManagedClusterIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)

	// DelegatedResources
	if propertyBag.Contains("DelegatedResources") {
		var delegatedResource map[string]v20230701s.DelegatedResource
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20230701s.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20230701s.UserAssignedIdentityDetails
...
func (identity *ManagedClusterIdentity_STATUS) AssignProperties_From_ManagedClusterIdentity_STATUS(source *v20230701s.ManagedClusterIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterIdentity_STATUS) AssignProperties_To_ManagedClusterIdentity_STATUS(destination *v20230701s.ManagedClusterIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)

	// DelegatedResources
	if propertyBag.Contains("DelegatedResources") {
		var delegatedResource map[string]v20230701s.DelegatedResource_STATUS
		err := propertyBag.Pull("DelegatedResources", &delegatedResource)
		if err != nil {
			return errors.Wrap(err, "pulling 'DelegatedResources' from propertyBag")
		}
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS
...
func (profile *ManagedClusterOIDCIssuerProfile) AssignProperties_From_ManagedClusterOIDCIssuerProfile(source *v20230701s.ManagedClusterOIDCIssuerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterOIDCIssuerProfile) AssignProperties_To_ManagedClusterOIDCIssuerProfile(destination *v20230701s.ManagedClusterOIDCIssuerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterOIDCIssuerProfile_STATUS) AssignProperties_From_ManagedClusterOIDCIssuerProfile_STATUS(source *v20230701s.ManagedClusterOIDCIssuerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterOIDCIssuerProfile_STATUS) AssignProperties_To_ManagedClusterOIDCIssuerProfile_STATUS(destination *v20230701s.ManagedClusterOIDCIssuerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (operator *ManagedClusterOperatorSpec) AssignProperties_From_ManagedClusterOperatorSpec(source *v20230701s.ManagedClusterOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *ManagedClusterOperatorSpec) AssignProperties_To_ManagedClusterOperatorSpec(destination *v20230701s.ManagedClusterOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(operator.PropertyBag)

	// ConfigMaps
	if operator.ConfigMaps != nil {
		var configMap v20230701s.ManagedClusterOperatorConfigMaps
	...
	if operator.Secrets != nil {
		var secret v20230701s.ManagedClusterOperatorSecrets
...
func (profile *ManagedClusterPodIdentityProfile) AssignProperties_From_ManagedClusterPodIdentityProfile(source *v20230701s.ManagedClusterPodIdentityProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterPodIdentityProfile) AssignProperties_To_ManagedClusterPodIdentityProfile(destination *v20230701s.ManagedClusterPodIdentityProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20230701s.ManagedClusterPodIdentity, len(profile.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range profile.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20230701s.ManagedClusterPodIdentity
	...
	if profile.UserAssignedIdentityExceptions != nil {
		userAssignedIdentityExceptionList := make([]v20230701s.ManagedClusterPodIdentityException, len(profile.UserAssignedIdentityExceptions))
		for userAssignedIdentityExceptionIndex, userAssignedIdentityExceptionItem := range profile.UserAssignedIdentityExceptions {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityExceptionItem := userAssignedIdentityExceptionItem
			var userAssignedIdentityException v20230701s.ManagedClusterPodIdentityException
...
func (profile *ManagedClusterPodIdentityProfile_STATUS) AssignProperties_From_ManagedClusterPodIdentityProfile_STATUS(source *v20230701s.ManagedClusterPodIdentityProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterPodIdentityProfile_STATUS) AssignProperties_To_ManagedClusterPodIdentityProfile_STATUS(destination *v20230701s.ManagedClusterPodIdentityProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// UserAssignedIdentities
	if profile.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20230701s.ManagedClusterPodIdentity_STATUS, len(profile.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range profile.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20230701s.ManagedClusterPodIdentity_STATUS
	...
	// UserAssignedIdentityExceptions
	if profile.UserAssignedIdentityExceptions != nil {
		userAssignedIdentityExceptionList := make([]v20230701s.ManagedClusterPodIdentityException_STATUS, len(profile.UserAssignedIdentityExceptions))
		for userAssignedIdentityExceptionIndex, userAssignedIdentityExceptionItem := range profile.UserAssignedIdentityExceptions {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityExceptionItem := userAssignedIdentityExceptionItem
			var userAssignedIdentityException v20230701s.ManagedClusterPodIdentityException_STATUS
...
func (profile *ManagedClusterProperties_AutoScalerProfile) AssignProperties_From_ManagedClusterProperties_AutoScalerProfile(source *v20230701s.ManagedClusterProperties_AutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterProperties_AutoScalerProfile) AssignProperties_To_ManagedClusterProperties_AutoScalerProfile(destination *v20230701s.ManagedClusterProperties_AutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterProperties_AutoScalerProfile_STATUS) AssignProperties_From_ManagedClusterProperties_AutoScalerProfile_STATUS(source *v20230701s.ManagedClusterProperties_AutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterProperties_AutoScalerProfile_STATUS) AssignProperties_To_ManagedClusterProperties_AutoScalerProfile_STATUS(destination *v20230701s.ManagedClusterProperties_AutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterSecurityProfile) AssignProperties_From_ManagedClusterSecurityProfile(source *v20230701s.ManagedClusterSecurityProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterSecurityProfile) AssignProperties_To_ManagedClusterSecurityProfile(destination *v20230701s.ManagedClusterSecurityProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// AzureKeyVaultKms
	if profile.AzureKeyVaultKms != nil {
		var azureKeyVaultKm v20230701s.AzureKeyVaultKms
	...
	if profile.Defender != nil {
		var defender v20230701s.ManagedClusterSecurityProfileDefender
	...
	if profile.ImageCleaner != nil {
		var imageCleaner v20230701s.ManagedClusterSecurityProfileImageCleaner
	...
	if profile.WorkloadIdentity != nil {
		var workloadIdentity v20230701s.ManagedClusterSecurityProfileWorkloadIdentity
...
func (profile *ManagedClusterSecurityProfile_STATUS) AssignProperties_From_ManagedClusterSecurityProfile_STATUS(source *v20230701s.ManagedClusterSecurityProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterSecurityProfile_STATUS) AssignProperties_To_ManagedClusterSecurityProfile_STATUS(destination *v20230701s.ManagedClusterSecurityProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// AzureKeyVaultKms
	if profile.AzureKeyVaultKms != nil {
		var azureKeyVaultKm v20230701s.AzureKeyVaultKms_STATUS
	...
	// Defender
	if profile.Defender != nil {
		var defender v20230701s.ManagedClusterSecurityProfileDefender_STATUS
	...
	// ImageCleaner
	if profile.ImageCleaner != nil {
		var imageCleaner v20230701s.ManagedClusterSecurityProfileImageCleaner_STATUS
	...
	// WorkloadIdentity
	if profile.WorkloadIdentity != nil {
		var workloadIdentity v20230701s.ManagedClusterSecurityProfileWorkloadIdentity_STATUS
...
func (profile *ManagedClusterServicePrincipalProfile) AssignProperties_From_ManagedClusterServicePrincipalProfile(source *v20230701s.ManagedClusterServicePrincipalProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterServicePrincipalProfile) AssignProperties_To_ManagedClusterServicePrincipalProfile(destination *v20230701s.ManagedClusterServicePrincipalProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterServicePrincipalProfile_STATUS) AssignProperties_From_ManagedClusterServicePrincipalProfile_STATUS(source *v20230701s.ManagedClusterServicePrincipalProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterServicePrincipalProfile_STATUS) AssignProperties_To_ManagedClusterServicePrincipalProfile_STATUS(destination *v20230701s.ManagedClusterServicePrincipalProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (clusterSKU *ManagedClusterSKU) AssignProperties_From_ManagedClusterSKU(source *v20230701s.ManagedClusterSKU) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (clusterSKU *ManagedClusterSKU) AssignProperties_To_ManagedClusterSKU(destination *v20230701s.ManagedClusterSKU) error {
	// Clone the existing property bag
...
func (clusterSKU *ManagedClusterSKU_STATUS) AssignProperties_From_ManagedClusterSKU_STATUS(source *v20230701s.ManagedClusterSKU_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (clusterSKU *ManagedClusterSKU_STATUS) AssignProperties_To_ManagedClusterSKU_STATUS(destination *v20230701s.ManagedClusterSKU_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(clusterSKU.PropertyBag)
...
func (profile *ManagedClusterStorageProfile) AssignProperties_From_ManagedClusterStorageProfile(source *v20230701s.ManagedClusterStorageProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterStorageProfile) AssignProperties_To_ManagedClusterStorageProfile(destination *v20230701s.ManagedClusterStorageProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// BlobCSIDriver
	if profile.BlobCSIDriver != nil {
		var blobCSIDriver v20230701s.ManagedClusterStorageProfileBlobCSIDriver
	...
	if profile.DiskCSIDriver != nil {
		var diskCSIDriver v20230701s.ManagedClusterStorageProfileDiskCSIDriver
	...
	if profile.FileCSIDriver != nil {
		var fileCSIDriver v20230701s.ManagedClusterStorageProfileFileCSIDriver
	...
	if profile.SnapshotController != nil {
		var snapshotController v20230701s.ManagedClusterStorageProfileSnapshotController
...
func (profile *ManagedClusterStorageProfile_STATUS) AssignProperties_From_ManagedClusterStorageProfile_STATUS(source *v20230701s.ManagedClusterStorageProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterStorageProfile_STATUS) AssignProperties_To_ManagedClusterStorageProfile_STATUS(destination *v20230701s.ManagedClusterStorageProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// BlobCSIDriver
	if profile.BlobCSIDriver != nil {
		var blobCSIDriver v20230701s.ManagedClusterStorageProfileBlobCSIDriver_STATUS
	...
	// DiskCSIDriver
	if profile.DiskCSIDriver != nil {
		var diskCSIDriver v20230701s.ManagedClusterStorageProfileDiskCSIDriver_STATUS
	...
	// FileCSIDriver
	if profile.FileCSIDriver != nil {
		var fileCSIDriver v20230701s.ManagedClusterStorageProfileFileCSIDriver_STATUS
	...
	// SnapshotController
	if profile.SnapshotController != nil {
		var snapshotController v20230701s.ManagedClusterStorageProfileSnapshotController_STATUS
...
func (profile *ManagedClusterWindowsProfile) AssignProperties_From_ManagedClusterWindowsProfile(source *v20230701s.ManagedClusterWindowsProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterWindowsProfile) AssignProperties_To_ManagedClusterWindowsProfile(destination *v20230701s.ManagedClusterWindowsProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.GmsaProfile != nil {
		var gmsaProfile v20230701s.WindowsGmsaProfile
...
func (profile *ManagedClusterWindowsProfile_STATUS) AssignProperties_From_ManagedClusterWindowsProfile_STATUS(source *v20230701s.ManagedClusterWindowsProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterWindowsProfile_STATUS) AssignProperties_To_ManagedClusterWindowsProfile_STATUS(destination *v20230701s.ManagedClusterWindowsProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// GmsaProfile
	if profile.GmsaProfile != nil {
		var gmsaProfile v20230701s.WindowsGmsaProfile_STATUS
...
func (profile *ManagedClusterWorkloadAutoScalerProfile) AssignProperties_From_ManagedClusterWorkloadAutoScalerProfile(source *v20230701s.ManagedClusterWorkloadAutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterWorkloadAutoScalerProfile) AssignProperties_To_ManagedClusterWorkloadAutoScalerProfile(destination *v20230701s.ManagedClusterWorkloadAutoScalerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// Keda
	if profile.Keda != nil {
		var kedum v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda
	...
	if propertyBag.Contains("VerticalPodAutoscaler") {
		...
		var verticalPodAutoscaler v20230701s.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler
...
func (profile *ManagedClusterWorkloadAutoScalerProfile_STATUS) AssignProperties_From_ManagedClusterWorkloadAutoScalerProfile_STATUS(source *v20230701s.ManagedClusterWorkloadAutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterWorkloadAutoScalerProfile_STATUS) AssignProperties_To_ManagedClusterWorkloadAutoScalerProfile_STATUS(destination *v20230701s.ManagedClusterWorkloadAutoScalerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// Keda
	if profile.Keda != nil {
		var kedum v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS
	...
	if propertyBag.Contains("VerticalPodAutoscaler") {
		...
		var verticalPodAutoscaler v20230701s.ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_STATUS
...
func (state *PowerState_STATUS) AssignProperties_From_PowerState_STATUS(source *v20230701s.PowerState_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (state *PowerState_STATUS) AssignProperties_To_PowerState_STATUS(destination *v20230701s.PowerState_STATUS) error {
	// Clone the existing property bag
...
func (resource *PrivateLinkResource) AssignProperties_From_PrivateLinkResource(source *v20230701s.PrivateLinkResource) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (resource *PrivateLinkResource) AssignProperties_To_PrivateLinkResource(destination *v20230701s.PrivateLinkResource) error {
	// Clone the existing property bag
...
func (resource *PrivateLinkResource_STATUS) AssignProperties_From_PrivateLinkResource_STATUS(source *v20230701s.PrivateLinkResource_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (resource *PrivateLinkResource_STATUS) AssignProperties_To_PrivateLinkResource_STATUS(destination *v20230701s.PrivateLinkResource_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(resource.PropertyBag)
...
func (identity *UserAssignedIdentity) AssignProperties_From_UserAssignedIdentity(source *v20230701s.UserAssignedIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *UserAssignedIdentity) AssignProperties_To_UserAssignedIdentity(destination *v20230701s.UserAssignedIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_From_UserAssignedIdentity_STATUS(source *v20230701s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_To_UserAssignedIdentity_STATUS(destination *v20230701s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
...
type augmentConversionForContainerServiceLinuxProfile interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceLinuxProfile) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceLinuxProfile) error
}

type augmentConversionForContainerServiceLinuxProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceLinuxProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceLinuxProfile_STATUS) error
}

type augmentConversionForContainerServiceNetworkProfile interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceNetworkProfile) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceNetworkProfile) error
}

type augmentConversionForContainerServiceNetworkProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceNetworkProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceNetworkProfile_STATUS) error
}

type augmentConversionForExtendedLocation interface {
	AssignPropertiesFrom(src *v20230701s.ExtendedLocation) error
	AssignPropertiesTo(dst *v20230701s.ExtendedLocation) error
}

type augmentConversionForExtendedLocation_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ExtendedLocation_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ExtendedLocation_STATUS) error
}

type augmentConversionForManagedClusterAADProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAADProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAADProfile) error
}

type augmentConversionForManagedClusterAADProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAADProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAADProfile_STATUS) error
}

type augmentConversionForManagedClusterAddonProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAddonProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAddonProfile) error
}

type augmentConversionForManagedClusterAddonProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAddonProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAddonProfile_STATUS) error
}

type augmentConversionForManagedClusterAgentPoolProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAgentPoolProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAgentPoolProfile) error
}

type augmentConversionForManagedClusterAgentPoolProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAgentPoolProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAgentPoolProfile_STATUS) error
}

type augmentConversionForManagedClusterAPIServerAccessProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAPIServerAccessProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAPIServerAccessProfile) error
}

type augmentConversionForManagedClusterAPIServerAccessProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAPIServerAccessProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAPIServerAccessProfile_STATUS) error
}

type augmentConversionForManagedClusterAutoUpgradeProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAutoUpgradeProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAutoUpgradeProfile) error
}

type augmentConversionForManagedClusterAutoUpgradeProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAutoUpgradeProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAutoUpgradeProfile_STATUS) error
}

type augmentConversionForManagedClusterAzureMonitorProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfile) error
}

type augmentConversionForManagedClusterAzureMonitorProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfile_STATUS) error
}

type augmentConversionForManagedClusterHTTPProxyConfig interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterHTTPProxyConfig) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterHTTPProxyConfig) error
}

type augmentConversionForManagedClusterHTTPProxyConfig_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterHTTPProxyConfig_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterHTTPProxyConfig_STATUS) error
}

type augmentConversionForManagedClusterIdentity interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterIdentity) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterIdentity) error
}

type augmentConversionForManagedClusterIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterIdentity_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterIdentity_STATUS) error
}

type augmentConversionForManagedClusterOIDCIssuerProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterOIDCIssuerProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterOIDCIssuerProfile) error
}

type augmentConversionForManagedClusterOIDCIssuerProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterOIDCIssuerProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterOIDCIssuerProfile_STATUS) error
}

type augmentConversionForManagedClusterOperatorSpec interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterOperatorSpec) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterOperatorSpec) error
}

type augmentConversionForManagedClusterPodIdentityProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityProfile) error
}

type augmentConversionForManagedClusterPodIdentityProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityProfile_STATUS) error
}

type augmentConversionForManagedClusterProperties_AutoScalerProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterProperties_AutoScalerProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterProperties_AutoScalerProfile) error
}

type augmentConversionForManagedClusterProperties_AutoScalerProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterProperties_AutoScalerProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterProperties_AutoScalerProfile_STATUS) error
}

type augmentConversionForManagedClusterSecurityProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfile) error
}

type augmentConversionForManagedClusterSecurityProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfile_STATUS) error
}

type augmentConversionForManagedClusterServicePrincipalProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterServicePrincipalProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterServicePrincipalProfile) error
}

type augmentConversionForManagedClusterServicePrincipalProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterServicePrincipalProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterServicePrincipalProfile_STATUS) error
}

type augmentConversionForManagedClusterSKU interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSKU) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSKU) error
}

type augmentConversionForManagedClusterSKU_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSKU_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSKU_STATUS) error
}

type augmentConversionForManagedClusterStorageProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfile) error
}

type augmentConversionForManagedClusterStorageProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfile_STATUS) error
}

type augmentConversionForManagedClusterWindowsProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWindowsProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWindowsProfile) error
}

type augmentConversionForManagedClusterWindowsProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWindowsProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWindowsProfile_STATUS) error
}

type augmentConversionForManagedClusterWorkloadAutoScalerProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWorkloadAutoScalerProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWorkloadAutoScalerProfile) error
}

type augmentConversionForManagedClusterWorkloadAutoScalerProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWorkloadAutoScalerProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWorkloadAutoScalerProfile_STATUS) error
}

type augmentConversionForPowerState_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.PowerState_STATUS) error
	AssignPropertiesTo(dst *v20230701s.PowerState_STATUS) error
}

type augmentConversionForPrivateLinkResource interface {
	AssignPropertiesFrom(src *v20230701s.PrivateLinkResource) error
	AssignPropertiesTo(dst *v20230701s.PrivateLinkResource) error
}

type augmentConversionForPrivateLinkResource_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.PrivateLinkResource_STATUS) error
	AssignPropertiesTo(dst *v20230701s.PrivateLinkResource_STATUS) error
}
...
type augmentConversionForUserAssignedIdentity interface {
	AssignPropertiesFrom(src *v20230701s.UserAssignedIdentity) error
	AssignPropertiesTo(dst *v20230701s.UserAssignedIdentity) error
}

type augmentConversionForUserAssignedIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.UserAssignedIdentity_STATUS) error
	AssignPropertiesTo(dst *v20230701s.UserAssignedIdentity_STATUS) error
}
...
func (vaultKms *AzureKeyVaultKms) AssignProperties_From_AzureKeyVaultKms(source *v20230701s.AzureKeyVaultKms) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (vaultKms *AzureKeyVaultKms) AssignProperties_To_AzureKeyVaultKms(destination *v20230701s.AzureKeyVaultKms) error {
	// Clone the existing property bag
...
func (vaultKms *AzureKeyVaultKms_STATUS) AssignProperties_From_AzureKeyVaultKms_STATUS(source *v20230701s.AzureKeyVaultKms_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (vaultKms *AzureKeyVaultKms_STATUS) AssignProperties_To_AzureKeyVaultKms_STATUS(destination *v20230701s.AzureKeyVaultKms_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(vaultKms.PropertyBag)
...
func (configuration *ContainerServiceSshConfiguration) AssignProperties_From_ContainerServiceSshConfiguration(source *v20230701s.ContainerServiceSshConfiguration) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (configuration *ContainerServiceSshConfiguration) AssignProperties_To_ContainerServiceSshConfiguration(destination *v20230701s.ContainerServiceSshConfiguration) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(configuration.PropertyBag)

	// PublicKeys
	if configuration.PublicKeys != nil {
		publicKeyList := make([]v20230701s.ContainerServiceSshPublicKey, len(configuration.PublicKeys))
		for publicKeyIndex, publicKeyItem := range configuration.PublicKeys {
			// Shadow the loop variable to avoid aliasing
			publicKeyItem := publicKeyItem
			var publicKey v20230701s.ContainerServiceSshPublicKey
...
func (configuration *ContainerServiceSshConfiguration_STATUS) AssignProperties_From_ContainerServiceSshConfiguration_STATUS(source *v20230701s.ContainerServiceSshConfiguration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (configuration *ContainerServiceSshConfiguration_STATUS) AssignProperties_To_ContainerServiceSshConfiguration_STATUS(destination *v20230701s.ContainerServiceSshConfiguration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(configuration.PropertyBag)

	// PublicKeys
	if configuration.PublicKeys != nil {
		publicKeyList := make([]v20230701s.ContainerServiceSshPublicKey_STATUS, len(configuration.PublicKeys))
		for publicKeyIndex, publicKeyItem := range configuration.PublicKeys {
			// Shadow the loop variable to avoid aliasing
			publicKeyItem := publicKeyItem
			var publicKey v20230701s.ContainerServiceSshPublicKey_STATUS
...
func (metrics *ManagedClusterAzureMonitorProfileMetrics) AssignProperties_From_ManagedClusterAzureMonitorProfileMetrics(source *v20230701s.ManagedClusterAzureMonitorProfileMetrics) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileMetrics) AssignProperties_To_ManagedClusterAzureMonitorProfileMetrics(destination *v20230701s.ManagedClusterAzureMonitorProfileMetrics) error {
	// Clone the existing property bag
	...
	if metrics.KubeStateMetrics != nil {
		var kubeStateMetric v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics
...
func (metrics *ManagedClusterAzureMonitorProfileMetrics_STATUS) AssignProperties_From_ManagedClusterAzureMonitorProfileMetrics_STATUS(source *v20230701s.ManagedClusterAzureMonitorProfileMetrics_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileMetrics_STATUS) AssignProperties_To_ManagedClusterAzureMonitorProfileMetrics_STATUS(destination *v20230701s.ManagedClusterAzureMonitorProfileMetrics_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(metrics.PropertyBag)
	...
	// KubeStateMetrics
	if metrics.KubeStateMetrics != nil {
		var kubeStateMetric v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS
...
func (identities *ManagedClusterIdentity_UserAssignedIdentities_STATUS) AssignProperties_From_ManagedClusterIdentity_UserAssignedIdentities_STATUS(source *v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identities *ManagedClusterIdentity_UserAssignedIdentities_STATUS) AssignProperties_To_ManagedClusterIdentity_UserAssignedIdentities_STATUS(destination *v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS) error {
	// Clone the existing property bag
...
func (profile *ManagedClusterLoadBalancerProfile) AssignProperties_From_ManagedClusterLoadBalancerProfile(source *v20230701s.ManagedClusterLoadBalancerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterLoadBalancerProfile) AssignProperties_To_ManagedClusterLoadBalancerProfile(destination *v20230701s.ManagedClusterLoadBalancerProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.EffectiveOutboundIPs != nil {
		effectiveOutboundIPList := make([]v20230701s.ResourceReference, len(profile.EffectiveOutboundIPs))
		for effectiveOutboundIPIndex, effectiveOutboundIPItem := range profile.EffectiveOutboundIPs {
			// Shadow the loop variable to avoid aliasing
			effectiveOutboundIPItem := effectiveOutboundIPItem
			var effectiveOutboundIP v20230701s.ResourceReference
	...
	if profile.ManagedOutboundIPs != nil {
		var managedOutboundIP v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs
	...
	if profile.OutboundIPPrefixes != nil {
		var outboundIPPrefix v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes
	...
	if profile.OutboundIPs != nil {
		var outboundIP v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs
...
func (profile *ManagedClusterLoadBalancerProfile_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfile_STATUS(source *v20230701s.ManagedClusterLoadBalancerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterLoadBalancerProfile_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfile_STATUS(destination *v20230701s.ManagedClusterLoadBalancerProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// EffectiveOutboundIPs
	if profile.EffectiveOutboundIPs != nil {
		effectiveOutboundIPList := make([]v20230701s.ResourceReference_STATUS, len(profile.EffectiveOutboundIPs))
		for effectiveOutboundIPIndex, effectiveOutboundIPItem := range profile.EffectiveOutboundIPs {
			// Shadow the loop variable to avoid aliasing
			effectiveOutboundIPItem := effectiveOutboundIPItem
			var effectiveOutboundIP v20230701s.ResourceReference_STATUS
	...
	// ManagedOutboundIPs
	if profile.ManagedOutboundIPs != nil {
		var managedOutboundIP v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS
	...
	// OutboundIPPrefixes
	if profile.OutboundIPPrefixes != nil {
		var outboundIPPrefix v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS
	...
	// OutboundIPs
	if profile.OutboundIPs != nil {
		var outboundIP v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS
...
func (profile *ManagedClusterNATGatewayProfile) AssignProperties_From_ManagedClusterNATGatewayProfile(source *v20230701s.ManagedClusterNATGatewayProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterNATGatewayProfile) AssignProperties_To_ManagedClusterNATGatewayProfile(destination *v20230701s.ManagedClusterNATGatewayProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	if profile.ManagedOutboundIPProfile != nil {
		var managedOutboundIPProfile v20230701s.ManagedClusterManagedOutboundIPProfile
...
func (profile *ManagedClusterNATGatewayProfile_STATUS) AssignProperties_From_ManagedClusterNATGatewayProfile_STATUS(source *v20230701s.ManagedClusterNATGatewayProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterNATGatewayProfile_STATUS) AssignProperties_To_ManagedClusterNATGatewayProfile_STATUS(destination *v20230701s.ManagedClusterNATGatewayProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
	...
	// ManagedOutboundIPProfile
	if profile.ManagedOutboundIPProfile != nil {
		var managedOutboundIPProfile v20230701s.ManagedClusterManagedOutboundIPProfile_STATUS
...
func (maps *ManagedClusterOperatorConfigMaps) AssignProperties_From_ManagedClusterOperatorConfigMaps(source *v20230701s.ManagedClusterOperatorConfigMaps) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (maps *ManagedClusterOperatorConfigMaps) AssignProperties_To_ManagedClusterOperatorConfigMaps(destination *v20230701s.ManagedClusterOperatorConfigMaps) error {
	// Clone the existing property bag
...
func (secrets *ManagedClusterOperatorSecrets) AssignProperties_From_ManagedClusterOperatorSecrets(source *v20230701s.ManagedClusterOperatorSecrets) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (secrets *ManagedClusterOperatorSecrets) AssignProperties_To_ManagedClusterOperatorSecrets(destination *v20230701s.ManagedClusterOperatorSecrets) error {
	// Clone the existing property bag
...
func (identity *ManagedClusterPodIdentity) AssignProperties_From_ManagedClusterPodIdentity(source *v20230701s.ManagedClusterPodIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterPodIdentity) AssignProperties_To_ManagedClusterPodIdentity(destination *v20230701s.ManagedClusterPodIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
	...
	if identity.Identity != nil {
		var identityLocal v20230701s.UserAssignedIdentity
...
func (identity *ManagedClusterPodIdentity_STATUS) AssignProperties_From_ManagedClusterPodIdentity_STATUS(source *v20230701s.ManagedClusterPodIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterPodIdentity_STATUS) AssignProperties_To_ManagedClusterPodIdentity_STATUS(destination *v20230701s.ManagedClusterPodIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
	...
	// Identity
	if identity.Identity != nil {
		var identityLocal v20230701s.UserAssignedIdentity_STATUS
	...
	if identity.ProvisioningInfo != nil {
		var provisioningInfo v20230701s.ManagedClusterPodIdentity_ProvisioningInfo_STATUS
...
func (exception *ManagedClusterPodIdentityException) AssignProperties_From_ManagedClusterPodIdentityException(source *v20230701s.ManagedClusterPodIdentityException) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (exception *ManagedClusterPodIdentityException) AssignProperties_To_ManagedClusterPodIdentityException(destination *v20230701s.ManagedClusterPodIdentityException) error {
	// Clone the existing property bag
...
func (exception *ManagedClusterPodIdentityException_STATUS) AssignProperties_From_ManagedClusterPodIdentityException_STATUS(source *v20230701s.ManagedClusterPodIdentityException_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (exception *ManagedClusterPodIdentityException_STATUS) AssignProperties_To_ManagedClusterPodIdentityException_STATUS(destination *v20230701s.ManagedClusterPodIdentityException_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(exception.PropertyBag)
...
func (defender *ManagedClusterSecurityProfileDefender) AssignProperties_From_ManagedClusterSecurityProfileDefender(source *v20230701s.ManagedClusterSecurityProfileDefender) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (defender *ManagedClusterSecurityProfileDefender) AssignProperties_To_ManagedClusterSecurityProfileDefender(destination *v20230701s.ManagedClusterSecurityProfileDefender) error {
	// Clone the existing property bag
	...
	if defender.SecurityMonitoring != nil {
		var securityMonitoring v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring
...
func (defender *ManagedClusterSecurityProfileDefender_STATUS) AssignProperties_From_ManagedClusterSecurityProfileDefender_STATUS(source *v20230701s.ManagedClusterSecurityProfileDefender_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (defender *ManagedClusterSecurityProfileDefender_STATUS) AssignProperties_To_ManagedClusterSecurityProfileDefender_STATUS(destination *v20230701s.ManagedClusterSecurityProfileDefender_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(defender.PropertyBag)
	...
	// SecurityMonitoring
	if defender.SecurityMonitoring != nil {
		var securityMonitoring v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS
...
func (cleaner *ManagedClusterSecurityProfileImageCleaner) AssignProperties_From_ManagedClusterSecurityProfileImageCleaner(source *v20230701s.ManagedClusterSecurityProfileImageCleaner) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (cleaner *ManagedClusterSecurityProfileImageCleaner) AssignProperties_To_ManagedClusterSecurityProfileImageCleaner(destination *v20230701s.ManagedClusterSecurityProfileImageCleaner) error {
	// Clone the existing property bag
...
func (cleaner *ManagedClusterSecurityProfileImageCleaner_STATUS) AssignProperties_From_ManagedClusterSecurityProfileImageCleaner_STATUS(source *v20230701s.ManagedClusterSecurityProfileImageCleaner_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (cleaner *ManagedClusterSecurityProfileImageCleaner_STATUS) AssignProperties_To_ManagedClusterSecurityProfileImageCleaner_STATUS(destination *v20230701s.ManagedClusterSecurityProfileImageCleaner_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(cleaner.PropertyBag)
...
func (identity *ManagedClusterSecurityProfileWorkloadIdentity) AssignProperties_From_ManagedClusterSecurityProfileWorkloadIdentity(source *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterSecurityProfileWorkloadIdentity) AssignProperties_To_ManagedClusterSecurityProfileWorkloadIdentity(destination *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
...
func (identity *ManagedClusterSecurityProfileWorkloadIdentity_STATUS) AssignProperties_From_ManagedClusterSecurityProfileWorkloadIdentity_STATUS(source *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *ManagedClusterSecurityProfileWorkloadIdentity_STATUS) AssignProperties_To_ManagedClusterSecurityProfileWorkloadIdentity_STATUS(destination *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
...
func (driver *ManagedClusterStorageProfileBlobCSIDriver) AssignProperties_From_ManagedClusterStorageProfileBlobCSIDriver(source *v20230701s.ManagedClusterStorageProfileBlobCSIDriver) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileBlobCSIDriver) AssignProperties_To_ManagedClusterStorageProfileBlobCSIDriver(destination *v20230701s.ManagedClusterStorageProfileBlobCSIDriver) error {
	// Clone the existing property bag
...
func (driver *ManagedClusterStorageProfileBlobCSIDriver_STATUS) AssignProperties_From_ManagedClusterStorageProfileBlobCSIDriver_STATUS(source *v20230701s.ManagedClusterStorageProfileBlobCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileBlobCSIDriver_STATUS) AssignProperties_To_ManagedClusterStorageProfileBlobCSIDriver_STATUS(destination *v20230701s.ManagedClusterStorageProfileBlobCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(driver.PropertyBag)
...
func (driver *ManagedClusterStorageProfileDiskCSIDriver) AssignProperties_From_ManagedClusterStorageProfileDiskCSIDriver(source *v20230701s.ManagedClusterStorageProfileDiskCSIDriver) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileDiskCSIDriver) AssignProperties_To_ManagedClusterStorageProfileDiskCSIDriver(destination *v20230701s.ManagedClusterStorageProfileDiskCSIDriver) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(driver.PropertyBag)
...
func (driver *ManagedClusterStorageProfileDiskCSIDriver_STATUS) AssignProperties_From_ManagedClusterStorageProfileDiskCSIDriver_STATUS(source *v20230701s.ManagedClusterStorageProfileDiskCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileDiskCSIDriver_STATUS) AssignProperties_To_ManagedClusterStorageProfileDiskCSIDriver_STATUS(destination *v20230701s.ManagedClusterStorageProfileDiskCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(driver.PropertyBag)
...
func (driver *ManagedClusterStorageProfileFileCSIDriver) AssignProperties_From_ManagedClusterStorageProfileFileCSIDriver(source *v20230701s.ManagedClusterStorageProfileFileCSIDriver) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileFileCSIDriver) AssignProperties_To_ManagedClusterStorageProfileFileCSIDriver(destination *v20230701s.ManagedClusterStorageProfileFileCSIDriver) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(driver.PropertyBag)
...
func (driver *ManagedClusterStorageProfileFileCSIDriver_STATUS) AssignProperties_From_ManagedClusterStorageProfileFileCSIDriver_STATUS(source *v20230701s.ManagedClusterStorageProfileFileCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (driver *ManagedClusterStorageProfileFileCSIDriver_STATUS) AssignProperties_To_ManagedClusterStorageProfileFileCSIDriver_STATUS(destination *v20230701s.ManagedClusterStorageProfileFileCSIDriver_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(driver.PropertyBag)
...
func (controller *ManagedClusterStorageProfileSnapshotController) AssignProperties_From_ManagedClusterStorageProfileSnapshotController(source *v20230701s.ManagedClusterStorageProfileSnapshotController) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (controller *ManagedClusterStorageProfileSnapshotController) AssignProperties_To_ManagedClusterStorageProfileSnapshotController(destination *v20230701s.ManagedClusterStorageProfileSnapshotController) error {
	// Clone the existing property bag
...
func (controller *ManagedClusterStorageProfileSnapshotController_STATUS) AssignProperties_From_ManagedClusterStorageProfileSnapshotController_STATUS(source *v20230701s.ManagedClusterStorageProfileSnapshotController_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (controller *ManagedClusterStorageProfileSnapshotController_STATUS) AssignProperties_To_ManagedClusterStorageProfileSnapshotController_STATUS(destination *v20230701s.ManagedClusterStorageProfileSnapshotController_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(controller.PropertyBag)
...
func (keda *ManagedClusterWorkloadAutoScalerProfileKeda) AssignProperties_From_ManagedClusterWorkloadAutoScalerProfileKeda(source *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (keda *ManagedClusterWorkloadAutoScalerProfileKeda) AssignProperties_To_ManagedClusterWorkloadAutoScalerProfileKeda(destination *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda) error {
	// Clone the existing property bag
...
func (keda *ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) AssignProperties_From_ManagedClusterWorkloadAutoScalerProfileKeda_STATUS(source *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (keda *ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) AssignProperties_To_ManagedClusterWorkloadAutoScalerProfileKeda_STATUS(destination *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(keda.PropertyBag)
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20230701s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20230701s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
...
func (profile *WindowsGmsaProfile) AssignProperties_From_WindowsGmsaProfile(source *v20230701s.WindowsGmsaProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *WindowsGmsaProfile) AssignProperties_To_WindowsGmsaProfile(destination *v20230701s.WindowsGmsaProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *WindowsGmsaProfile_STATUS) AssignProperties_From_WindowsGmsaProfile_STATUS(source *v20230701s.WindowsGmsaProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *WindowsGmsaProfile_STATUS) AssignProperties_To_WindowsGmsaProfile_STATUS(destination *v20230701s.WindowsGmsaProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
type augmentConversionForAzureKeyVaultKms interface {
	AssignPropertiesFrom(src *v20230701s.AzureKeyVaultKms) error
	AssignPropertiesTo(dst *v20230701s.AzureKeyVaultKms) error
}

type augmentConversionForAzureKeyVaultKms_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.AzureKeyVaultKms_STATUS) error
	AssignPropertiesTo(dst *v20230701s.AzureKeyVaultKms_STATUS) error
}

type augmentConversionForContainerServiceSshConfiguration interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceSshConfiguration) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceSshConfiguration) error
}

type augmentConversionForContainerServiceSshConfiguration_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceSshConfiguration_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceSshConfiguration_STATUS) error
}

type augmentConversionForManagedClusterAzureMonitorProfileMetrics interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfileMetrics) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfileMetrics) error
}

type augmentConversionForManagedClusterAzureMonitorProfileMetrics_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfileMetrics_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfileMetrics_STATUS) error
}

type augmentConversionForManagedClusterIdentity_UserAssignedIdentities_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterIdentity_UserAssignedIdentities_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_STATUS) error
}

type augmentConversionForManagedClusterNATGatewayProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterNATGatewayProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterNATGatewayProfile) error
}

type augmentConversionForManagedClusterNATGatewayProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterNATGatewayProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterNATGatewayProfile_STATUS) error
}

type augmentConversionForManagedClusterOperatorConfigMaps interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterOperatorConfigMaps) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterOperatorConfigMaps) error
}

type augmentConversionForManagedClusterOperatorSecrets interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterOperatorSecrets) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterOperatorSecrets) error
}

type augmentConversionForManagedClusterPodIdentity interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentity) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentity) error
}

type augmentConversionForManagedClusterPodIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentity_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentity_STATUS) error
}

type augmentConversionForManagedClusterPodIdentityException interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityException) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityException) error
}

type augmentConversionForManagedClusterPodIdentityException_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityException_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityException_STATUS) error
}

type augmentConversionForManagedClusterSecurityProfileDefender interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileDefender) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileDefender) error
}

type augmentConversionForManagedClusterSecurityProfileDefender_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileDefender_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileDefender_STATUS) error
}

type augmentConversionForManagedClusterSecurityProfileImageCleaner interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileImageCleaner) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileImageCleaner) error
}

type augmentConversionForManagedClusterSecurityProfileImageCleaner_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileImageCleaner_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileImageCleaner_STATUS) error
}

type augmentConversionForManagedClusterSecurityProfileWorkloadIdentity interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity) error
}

type augmentConversionForManagedClusterSecurityProfileWorkloadIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileWorkloadIdentity_STATUS) error
}

type augmentConversionForManagedClusterStorageProfileBlobCSIDriver interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileBlobCSIDriver) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileBlobCSIDriver) error
}

type augmentConversionForManagedClusterStorageProfileBlobCSIDriver_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileBlobCSIDriver_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileBlobCSIDriver_STATUS) error
}

type augmentConversionForManagedClusterStorageProfileDiskCSIDriver interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileDiskCSIDriver) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileDiskCSIDriver) error
}

type augmentConversionForManagedClusterStorageProfileDiskCSIDriver_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileDiskCSIDriver_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileDiskCSIDriver_STATUS) error
}

type augmentConversionForManagedClusterStorageProfileFileCSIDriver interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileFileCSIDriver) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileFileCSIDriver) error
}

type augmentConversionForManagedClusterStorageProfileFileCSIDriver_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileFileCSIDriver_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileFileCSIDriver_STATUS) error
}

type augmentConversionForManagedClusterStorageProfileSnapshotController interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileSnapshotController) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileSnapshotController) error
}

type augmentConversionForManagedClusterStorageProfileSnapshotController_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterStorageProfileSnapshotController_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterStorageProfileSnapshotController_STATUS) error
}

type augmentConversionForManagedClusterWorkloadAutoScalerProfileKeda interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda) error
}

type augmentConversionForManagedClusterWorkloadAutoScalerProfileKeda_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterWorkloadAutoScalerProfileKeda_STATUS) error
}

type augmentConversionForUserAssignedIdentityDetails interface {
	AssignPropertiesFrom(src *v20230701s.UserAssignedIdentityDetails) error
	AssignPropertiesTo(dst *v20230701s.UserAssignedIdentityDetails) error
}

type augmentConversionForWindowsGmsaProfile interface {
	AssignPropertiesFrom(src *v20230701s.WindowsGmsaProfile) error
	AssignPropertiesTo(dst *v20230701s.WindowsGmsaProfile) error
}

type augmentConversionForWindowsGmsaProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.WindowsGmsaProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.WindowsGmsaProfile_STATUS) error
}
...
func (publicKey *ContainerServiceSshPublicKey) AssignProperties_From_ContainerServiceSshPublicKey(source *v20230701s.ContainerServiceSshPublicKey) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (publicKey *ContainerServiceSshPublicKey) AssignProperties_To_ContainerServiceSshPublicKey(destination *v20230701s.ContainerServiceSshPublicKey) error {
	// Clone the existing property bag
...
func (publicKey *ContainerServiceSshPublicKey_STATUS) AssignProperties_From_ContainerServiceSshPublicKey_STATUS(source *v20230701s.ContainerServiceSshPublicKey_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (publicKey *ContainerServiceSshPublicKey_STATUS) AssignProperties_To_ContainerServiceSshPublicKey_STATUS(destination *v20230701s.ContainerServiceSshPublicKey_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(publicKey.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileKubeStateMetrics) AssignProperties_From_ManagedClusterAzureMonitorProfileKubeStateMetrics(source *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileKubeStateMetrics) AssignProperties_To_ManagedClusterAzureMonitorProfileKubeStateMetrics(destination *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(metrics.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) AssignProperties_From_ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS(source *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (metrics *ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) AssignProperties_To_ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS(destination *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(metrics.PropertyBag)
...
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) AssignProperties_From_ManagedClusterLoadBalancerProfile_ManagedOutboundIPs(source *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) AssignProperties_To_ManagedClusterLoadBalancerProfile_ManagedOutboundIPs(destination *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) error {
	// Clone the existing property bag
...
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS(source *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS(destination *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)
...
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) AssignProperties_From_ManagedClusterLoadBalancerProfile_OutboundIPPrefixes(source *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) AssignProperties_To_ManagedClusterLoadBalancerProfile_OutboundIPPrefixes(destination *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(prefixes.PropertyBag)

	// PublicIPPrefixes
	if prefixes.PublicIPPrefixes != nil {
		publicIPPrefixList := make([]v20230701s.ResourceReference, len(prefixes.PublicIPPrefixes))
		for publicIPPrefixIndex, publicIPPrefixItem := range prefixes.PublicIPPrefixes {
			// Shadow the loop variable to avoid aliasing
			publicIPPrefixItem := publicIPPrefixItem
			var publicIPPrefix v20230701s.ResourceReference
...
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS(source *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (prefixes *ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS(destination *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(prefixes.PropertyBag)

	// PublicIPPrefixes
	if prefixes.PublicIPPrefixes != nil {
		publicIPPrefixList := make([]v20230701s.ResourceReference_STATUS, len(prefixes.PublicIPPrefixes))
		for publicIPPrefixIndex, publicIPPrefixItem := range prefixes.PublicIPPrefixes {
			// Shadow the loop variable to avoid aliasing
			publicIPPrefixItem := publicIPPrefixItem
			var publicIPPrefix v20230701s.ResourceReference_STATUS
...
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs) AssignProperties_From_ManagedClusterLoadBalancerProfile_OutboundIPs(source *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs) AssignProperties_To_ManagedClusterLoadBalancerProfile_OutboundIPs(destination *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)

	// PublicIPs
	if iPs.PublicIPs != nil {
		publicIPList := make([]v20230701s.ResourceReference, len(iPs.PublicIPs))
		for publicIPIndex, publicIPItem := range iPs.PublicIPs {
			// Shadow the loop variable to avoid aliasing
			publicIPItem := publicIPItem
			var publicIP v20230701s.ResourceReference
...
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) AssignProperties_From_ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS(source *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (iPs *ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) AssignProperties_To_ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS(destination *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(iPs.PropertyBag)

	// PublicIPs
	if iPs.PublicIPs != nil {
		publicIPList := make([]v20230701s.ResourceReference_STATUS, len(iPs.PublicIPs))
		for publicIPIndex, publicIPItem := range iPs.PublicIPs {
			// Shadow the loop variable to avoid aliasing
			publicIPItem := publicIPItem
			var publicIP v20230701s.ResourceReference_STATUS
...
func (profile *ManagedClusterManagedOutboundIPProfile) AssignProperties_From_ManagedClusterManagedOutboundIPProfile(source *v20230701s.ManagedClusterManagedOutboundIPProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterManagedOutboundIPProfile) AssignProperties_To_ManagedClusterManagedOutboundIPProfile(destination *v20230701s.ManagedClusterManagedOutboundIPProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (profile *ManagedClusterManagedOutboundIPProfile_STATUS) AssignProperties_From_ManagedClusterManagedOutboundIPProfile_STATUS(source *v20230701s.ManagedClusterManagedOutboundIPProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *ManagedClusterManagedOutboundIPProfile_STATUS) AssignProperties_To_ManagedClusterManagedOutboundIPProfile_STATUS(destination *v20230701s.ManagedClusterManagedOutboundIPProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)
...
func (info *ManagedClusterPodIdentity_ProvisioningInfo_STATUS) AssignProperties_From_ManagedClusterPodIdentity_ProvisioningInfo_STATUS(source *v20230701s.ManagedClusterPodIdentity_ProvisioningInfo_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (info *ManagedClusterPodIdentity_ProvisioningInfo_STATUS) AssignProperties_To_ManagedClusterPodIdentity_ProvisioningInfo_STATUS(destination *v20230701s.ManagedClusterPodIdentity_ProvisioningInfo_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(info.PropertyBag)

	// Error
	if info.Error != nil {
		var error v20230701s.ManagedClusterPodIdentityProvisioningError_STATUS
...
func (monitoring *ManagedClusterSecurityProfileDefenderSecurityMonitoring) AssignProperties_From_ManagedClusterSecurityProfileDefenderSecurityMonitoring(source *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (monitoring *ManagedClusterSecurityProfileDefenderSecurityMonitoring) AssignProperties_To_ManagedClusterSecurityProfileDefenderSecurityMonitoring(destination *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring) error {
	// Clone the existing property bag
...
func (monitoring *ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) AssignProperties_From_ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS(source *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (monitoring *ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) AssignProperties_To_ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS(destination *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(monitoring.PropertyBag)
...
func (reference *ResourceReference) AssignProperties_From_ResourceReference(source *v20230701s.ResourceReference) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (reference *ResourceReference) AssignProperties_To_ResourceReference(destination *v20230701s.ResourceReference) error {
	// Clone the existing property bag
...
func (reference *ResourceReference_STATUS) AssignProperties_From_ResourceReference_STATUS(source *v20230701s.ResourceReference_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (reference *ResourceReference_STATUS) AssignProperties_To_ResourceReference_STATUS(destination *v20230701s.ResourceReference_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(reference.PropertyBag)
...
type augmentConversionForContainerServiceSshPublicKey interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceSshPublicKey) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceSshPublicKey) error
}

type augmentConversionForContainerServiceSshPublicKey_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ContainerServiceSshPublicKey_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ContainerServiceSshPublicKey_STATUS) error
}

type augmentConversionForManagedClusterAzureMonitorProfileKubeStateMetrics interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics) error
}

type augmentConversionForManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_ManagedOutboundIPs interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPPrefixes interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPPrefixes_STATUS) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPs interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs) error
}

type augmentConversionForManagedClusterLoadBalancerProfile_OutboundIPs_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterLoadBalancerProfile_OutboundIPs_STATUS) error
}

type augmentConversionForManagedClusterManagedOutboundIPProfile interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterManagedOutboundIPProfile) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterManagedOutboundIPProfile) error
}

type augmentConversionForManagedClusterManagedOutboundIPProfile_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterManagedOutboundIPProfile_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterManagedOutboundIPProfile_STATUS) error
}

type augmentConversionForManagedClusterPodIdentity_ProvisioningInfo_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentity_ProvisioningInfo_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentity_ProvisioningInfo_STATUS) error
}

type augmentConversionForManagedClusterSecurityProfileDefenderSecurityMonitoring interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring) error
}

type augmentConversionForManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterSecurityProfileDefenderSecurityMonitoring_STATUS) error
}

type augmentConversionForResourceReference interface {
	AssignPropertiesFrom(src *v20230701s.ResourceReference) error
	AssignPropertiesTo(dst *v20230701s.ResourceReference) error
}

type augmentConversionForResourceReference_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ResourceReference_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ResourceReference_STATUS) error
}
...
func (error *ManagedClusterPodIdentityProvisioningError_STATUS) AssignProperties_From_ManagedClusterPodIdentityProvisioningError_STATUS(source *v20230701s.ManagedClusterPodIdentityProvisioningError_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (error *ManagedClusterPodIdentityProvisioningError_STATUS) AssignProperties_To_ManagedClusterPodIdentityProvisioningError_STATUS(destination *v20230701s.ManagedClusterPodIdentityProvisioningError_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(error.PropertyBag)

	// Error
	if error.Error != nil {
		var errorLocal v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS
...
type augmentConversionForManagedClusterPodIdentityProvisioningError_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityProvisioningError_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityProvisioningError_STATUS) error
}
...
func (body *ManagedClusterPodIdentityProvisioningErrorBody_STATUS) AssignProperties_From_ManagedClusterPodIdentityProvisioningErrorBody_STATUS(source *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (body *ManagedClusterPodIdentityProvisioningErrorBody_STATUS) AssignProperties_To_ManagedClusterPodIdentityProvisioningErrorBody_STATUS(destination *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS) error {
	// Clone the existing property bag
	...
	// Details
	if body.Details != nil {
		detailList := make([]v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled, len(body.Details))
		for detailIndex, detailItem := range body.Details {
			// Shadow the loop variable to avoid aliasing
			detailItem := detailItem
			var detail v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled
...
type augmentConversionForManagedClusterPodIdentityProvisioningErrorBody_STATUS interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS) error
}
...
func (unrolled *ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) AssignProperties_From_ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled(source *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (unrolled *ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) AssignProperties_To_ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled(destination *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) error {
	// Clone the existing property bag
...
type augmentConversionForManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled interface {
	AssignPropertiesFrom(src *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) error
	AssignPropertiesTo(dst *v20230701s.ManagedClusterPodIdentityProvisioningErrorBody_STATUS_Unrolled) error
}
