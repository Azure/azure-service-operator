...
func (cluster *ManagedCluster) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20230201.ManagedCluster)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230201/ManagedCluster, but got %T", obj)
	}
...
func (cluster *ManagedCluster) defaultAzureName(ctx context.Context, obj *v20230201.ManagedCluster) error {
...
func (cluster *ManagedCluster) defaultImpl(ctx context.Context, obj *v20230201.ManagedCluster) error {
...
func (cluster *ManagedCluster) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20230201.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230201/ManagedCluster, but got %T", resource)
	}
	validations := cluster.createValidations()
	var temp any = cluster
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20230201.ManagedCluster]); ok {
...
func (cluster *ManagedCluster) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20230201.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230201/ManagedCluster, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20230201.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20230201/ManagedCluster, but got %T", oldResource)
	}
...
func (cluster *ManagedCluster) createValidations() []func(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error){
...
func (cluster *ManagedCluster) deleteValidations() []func(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (cluster *ManagedCluster) updateValidations() []func(ctx context.Context, oldObj *v20230201.ManagedCluster, newObj *v20230201.ManagedCluster) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20230201.ManagedCluster, newObj *v20230201.ManagedCluster) (admission.Warnings, error){
...
func (cluster *ManagedCluster) validateConfigMapDestinations(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateOwnerReference(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (cluster *ManagedCluster) validateResourceReferences(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateSecretDestinations(ctx context.Context, obj *v20230201.ManagedCluster) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (cluster *ManagedCluster) validateWriteOnceProperties(ctx context.Context, oldObj *v20230201.ManagedCluster, newObj *v20230201.ManagedCluster) (admission.Warnings, error) {
