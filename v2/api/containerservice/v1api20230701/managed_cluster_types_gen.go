...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v1api20230701-managedcluster,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v1api20230701,name=default.v1api20230701.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v1api20230701-managedcluster,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v1api20230701,name=validate.v1api20230701.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
...
func (settings *ClusterUpgradeSettings) AssignProperties_From_ClusterUpgradeSettings(source *v20230701s.ClusterUpgradeSettings) error {
...
func (settings *ClusterUpgradeSettings) AssignProperties_To_ClusterUpgradeSettings(destination *v20230701s.ClusterUpgradeSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// OverrideSettings
	if settings.OverrideSettings != nil {
		var overrideSetting v20230701s.UpgradeOverrideSettings
...
func (identity *ManagedClusterIdentity) AssignProperties_To_ManagedClusterIdentity(destination *v20230701s.ManagedClusterIdentity) error {
	...
	// DelegatedResources
	if identity.DelegatedResources != nil {
		delegatedResourceMap := make(map[string]v20230701s.DelegatedResource, len(identity.DelegatedResources))
		for delegatedResourceKey, delegatedResourceValue := range identity.DelegatedResources {
			// Shadow the loop variable to avoid aliasing
			delegatedResourceValue := delegatedResourceValue
			var delegatedResource v20230701s.DelegatedResource
...
func (identity *ManagedClusterIdentity_STATUS) AssignProperties_To_ManagedClusterIdentity_STATUS(destination *v20230701s.ManagedClusterIdentity_STATUS) error {
	...
	// DelegatedResources
	if identity.DelegatedResources != nil {
		delegatedResourceMap := make(map[string]v20230701s.DelegatedResource_STATUS, len(identity.DelegatedResources))
		for delegatedResourceKey, delegatedResourceValue := range identity.DelegatedResources {
			// Shadow the loop variable to avoid aliasing
			delegatedResourceValue := delegatedResourceValue
			var delegatedResource v20230701s.DelegatedResource_STATUS
...
func (resource *DelegatedResource) AssignProperties_From_DelegatedResource(source *v20230701s.DelegatedResource) error {
...
func (resource *DelegatedResource) AssignProperties_To_DelegatedResource(destination *v20230701s.DelegatedResource) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (resource *DelegatedResource_STATUS) AssignProperties_From_DelegatedResource_STATUS(source *v20230701s.DelegatedResource_STATUS) error {
...
func (resource *DelegatedResource_STATUS) AssignProperties_To_DelegatedResource_STATUS(destination *v20230701s.DelegatedResource_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
