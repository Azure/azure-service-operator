...
<<<<<<<< HEAD:v2/api/containerservice/v1beta20210501/managed_clusters_agent_pool__spec_arm_types_gen_test.go
func Test_ManagedClustersAgentPool_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_ManagedClusters_AgentPools_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/containerservice/v1beta20210501/managed_clusters_agent_pools_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of ManagedClusters_AgentPools_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForManagedClusters_AgentPools_SpecARM, ManagedClusters_AgentPools_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForManagedClusters_AgentPools_SpecARM runs a test to see if a specific instance of ManagedClusters_AgentPools_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForManagedClusters_AgentPools_SpecARM(subject ManagedClusters_AgentPools_SpecARM) string {
>>>>>>>> main:v2/api/containerservice/v1beta20210501/managed_clusters_agent_pools_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual ManagedClusters_AgentPools_SpecARM
>>>>>>>> main:v2/api/containerservice/v1beta20210501/managed_clusters_agent_pools_spec_arm_types_gen_test.go
...
========
// Generator of ManagedClusters_AgentPools_SpecARM instances for property testing - lazily instantiated by
// ManagedClusters_AgentPools_SpecARMGenerator()
var managedClusters_AgentPools_SpecARMGenerator gopter.Gen

// ManagedClusters_AgentPools_SpecARMGenerator returns a generator of ManagedClusters_AgentPools_SpecARM instances for property testing.
// We first initialize managedClusters_AgentPools_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ManagedClusters_AgentPools_SpecARMGenerator() gopter.Gen {
	if managedClusters_AgentPools_SpecARMGenerator != nil {
		return managedClusters_AgentPools_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForManagedClusters_AgentPools_SpecARM(generators)
	managedClusters_AgentPools_SpecARMGenerator = gen.Struct(reflect.TypeOf(ManagedClusters_AgentPools_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForManagedClusters_AgentPools_SpecARM(generators)
	AddRelatedPropertyGeneratorsForManagedClusters_AgentPools_SpecARM(generators)
	managedClusters_AgentPools_SpecARMGenerator = gen.Struct(reflect.TypeOf(ManagedClusters_AgentPools_SpecARM{}), generators)

	return managedClusters_AgentPools_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForManagedClusters_AgentPools_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForManagedClusters_AgentPools_SpecARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForManagedClusters_AgentPools_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForManagedClusters_AgentPools_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/containerservice/v1beta20210501/managed_clusters_agent_pools_spec_arm_types_gen_test.go
