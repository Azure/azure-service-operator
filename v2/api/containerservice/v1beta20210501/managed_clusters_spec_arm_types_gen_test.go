...
func Test_ManagedCluster_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/containerservice/v1beta20210501/managed_cluster__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/containerservice/v1beta20210501/managed_clusters_spec_arm_types_gen_test.go
	// Serialize to JSON
