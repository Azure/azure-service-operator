...
func Test_CloudErrorBody_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForCloudErrorBody_STATUS, CloudErrorBody_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCloudErrorBody_STATUS runs a test to see if a specific instance of CloudErrorBody_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForCloudErrorBody_STATUS(subject CloudErrorBody_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// CloudErrorBody_STATUSGenerator()
var cloudErrorBody_STATUSGenerator gopter.Gen

// CloudErrorBody_STATUSGenerator returns a generator of CloudErrorBody_STATUS instances for property testing.
// We first initialize cloudErrorBody_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func CloudErrorBody_STATUSGenerator() gopter.Gen {
	if cloudErrorBody_STATUSGenerator != nil {
		return cloudErrorBody_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS(generators)
	cloudErrorBody_STATUSGenerator = gen.Struct(reflect.TypeOf(CloudErrorBody_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS(generators)
	AddRelatedPropertyGeneratorsForCloudErrorBody_STATUS(generators)
	cloudErrorBody_STATUSGenerator = gen.Struct(reflect.TypeOf(CloudErrorBody_STATUS{}), generators)

	return cloudErrorBody_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS(gens map[string]gopter.Gen) {
	gens["Code"] = gen.PtrOf(gen.AlphaString())
	gens["Message"] = gen.PtrOf(gen.AlphaString())
	gens["Target"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForCloudErrorBody_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForCloudErrorBody_STATUS(gens map[string]gopter.Gen) {
	gens["Details"] = gen.SliceOf(CloudErrorBody_STATUS_UnrolledGenerator())
}
...
func Test_CloudErrorBody_STATUS_Unrolled_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForCloudErrorBody_STATUS_Unrolled, CloudErrorBody_STATUS_UnrolledGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCloudErrorBody_STATUS_Unrolled runs a test to see if a specific instance of CloudErrorBody_STATUS_Unrolled round trips to JSON and back losslessly
func RunJSONSerializationTestForCloudErrorBody_STATUS_Unrolled(subject CloudErrorBody_STATUS_Unrolled) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// CloudErrorBody_STATUS_UnrolledGenerator()
var cloudErrorBody_STATUS_UnrolledGenerator gopter.Gen

// CloudErrorBody_STATUS_UnrolledGenerator returns a generator of CloudErrorBody_STATUS_Unrolled instances for property testing.
func CloudErrorBody_STATUS_UnrolledGenerator() gopter.Gen {
	if cloudErrorBody_STATUS_UnrolledGenerator != nil {
		return cloudErrorBody_STATUS_UnrolledGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS_Unrolled(generators)
	cloudErrorBody_STATUS_UnrolledGenerator = gen.Struct(reflect.TypeOf(CloudErrorBody_STATUS_Unrolled{}), generators)

	return cloudErrorBody_STATUS_UnrolledGenerator
}

// AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS_Unrolled is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCloudErrorBody_STATUS_Unrolled(gens map[string]gopter.Gen) {
	gens["Code"] = gen.PtrOf(gen.AlphaString())
	gens["Message"] = gen.PtrOf(gen.AlphaString())
	gens["Target"] = gen.PtrOf(gen.AlphaString())
}
...
func AddRelatedPropertyGeneratorsForManagedClusterStatus_STATUS(gens map[string]gopter.Gen) {
	gens["ProvisioningError"] = gen.PtrOf(CloudErrorBody_STATUSGenerator())
}
