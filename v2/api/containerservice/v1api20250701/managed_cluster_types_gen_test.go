...
func Test_CloudErrorBody_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CloudErrorBody_STATUS to CloudErrorBody_STATUS via AssignProperties_To_CloudErrorBody_STATUS & AssignProperties_From_CloudErrorBody_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForCloudErrorBody_STATUS, CloudErrorBody_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCloudErrorBody_STATUS tests if a specific instance of CloudErrorBody_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForCloudErrorBody_STATUS(subject CloudErrorBody_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.CloudErrorBody_STATUS
	err := copied.AssignProperties_To_CloudErrorBody_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CloudErrorBody_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_CloudErrorBody_STATUS_Unrolled_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from CloudErrorBody_STATUS_Unrolled to CloudErrorBody_STATUS_Unrolled via AssignProperties_To_CloudErrorBody_STATUS_Unrolled & AssignProperties_From_CloudErrorBody_STATUS_Unrolled returns original",
		prop.ForAll(RunPropertyAssignmentTestForCloudErrorBody_STATUS_Unrolled, CloudErrorBody_STATUS_UnrolledGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForCloudErrorBody_STATUS_Unrolled tests if a specific instance of CloudErrorBody_STATUS_Unrolled can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForCloudErrorBody_STATUS_Unrolled(subject CloudErrorBody_STATUS_Unrolled) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.CloudErrorBody_STATUS_Unrolled
	err := copied.AssignProperties_To_CloudErrorBody_STATUS_Unrolled(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_CloudErrorBody_STATUS_Unrolled(&other)
	if err != nil {
		return err.Error()
	}
