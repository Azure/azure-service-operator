...
func (pool *ManagedClustersAgentPool) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20250701/storage/ManagedClustersAgentPool but received %T instead", hub)
	}
...
func (status *AgentPoolStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.ProvisioningError != nil {
		var provisioningError1 CloudErrorBody_STATUS
...
func (status *AgentPoolStatus_STATUS) AssignProperties_From_AgentPoolStatus_STATUS(source *storage.AgentPoolStatus_STATUS) error {
	...
	if source.ProvisioningError != nil {
		var provisioningError CloudErrorBody_STATUS
		err := provisioningError.AssignProperties_From_CloudErrorBody_STATUS(source.ProvisioningError)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_CloudErrorBody_STATUS() to populate field ProvisioningError")
		}
		status.ProvisioningError = &provisioningError
	} else {
...
func (status *AgentPoolStatus_STATUS) AssignProperties_To_AgentPoolStatus_STATUS(destination *storage.AgentPoolStatus_STATUS) error {
	...
	if status.ProvisioningError != nil {
		var provisioningError storage.CloudErrorBody_STATUS
		err := status.ProvisioningError.AssignProperties_To_CloudErrorBody_STATUS(&provisioningError)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_CloudErrorBody_STATUS() to populate field ProvisioningError")
		}
...
func (settings *AgentPoolUpgradeSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if settings.UndrainableNodeBehavior != nil {
		...
		undrainableNodeBehavior := arm.AgentPoolUpgradeSettings_UndrainableNodeBehavior(temp)
...
func (settings *AgentPoolUpgradeSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.UndrainableNodeBehavior != nil {
		...
		undrainableNodeBehavior := AgentPoolUpgradeSettings_UndrainableNodeBehavior(temp)
...
func (settings *AgentPoolUpgradeSettings) Initialize_From_AgentPoolUpgradeSettings_STATUS(source *AgentPoolUpgradeSettings_STATUS) error {
	...
	// UndrainableNodeBehavior
	if source.UndrainableNodeBehavior != nil {
		undrainableNodeBehavior := genruntime.ToEnum(string(*source.UndrainableNodeBehavior), agentPoolUpgradeSettings_UndrainableNodeBehavior_Values)
		settings.UndrainableNodeBehavior = &undrainableNodeBehavior
	} else {
		settings.UndrainableNodeBehavior = nil
	}
...
func (settings *AgentPoolUpgradeSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.UndrainableNodeBehavior != nil {
		var temp string
		temp = string(*typedInput.UndrainableNodeBehavior)
		undrainableNodeBehavior := AgentPoolUpgradeSettings_UndrainableNodeBehavior_STATUS(temp)
		settings.UndrainableNodeBehavior = &undrainableNodeBehavior
	}
...
func (profile *GPUProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if profile.Driver != nil {
		...
		driver := arm.GPUProfile_Driver(temp)
...
func (profile *GPUProfile) AssignProperties_From_GPUProfile(source *storage.GPUProfile) error {
	...
	if source.Driver != nil {
		...
		driverTemp := genruntime.ToEnum(driver, gPUProfile_Driver_Values)
...
func (profile *GPUProfile) Initialize_From_GPUProfile_STATUS(source *GPUProfile_STATUS) error {
	...
	// Driver
	if source.Driver != nil {
		driver := genruntime.ToEnum(string(*source.Driver), gPUProfile_Driver_Values)
		profile.Driver = &driver
	} else {
		profile.Driver = nil
	}
...
func (profile *GPUProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Driver != nil {
		var temp string
		temp = string(*typedInput.Driver)
		driver := GPUProfile_Driver_STATUS(temp)
		profile.Driver = &driver
	}
...
func (profile *GPUProfile_STATUS) AssignProperties_From_GPUProfile_STATUS(source *storage.GPUProfile_STATUS) error {
	...
	if source.Driver != nil {
		driver := *source.Driver
		driverTemp := genruntime.ToEnum(driver, gPUProfile_Driver_STATUS_Values)
		profile.Driver = &driverTemp
	} else {
		profile.Driver = nil
	}
