...
type ManagedClusterIngressProfileNginx struct {
	...
	DefaultIngressControllerType *ManagedClusterIngressProfileNginx_DefaultIngressControllerType `json:"defaultIngressControllerType,omitempty"`
}
...
type ManagedClusterIngressProfileNginx_DefaultIngressControllerType string

const (
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_AnnotationControlled = ManagedClusterIngressProfileNginx_DefaultIngressControllerType("AnnotationControlled")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_External             = ManagedClusterIngressProfileNginx_DefaultIngressControllerType("External")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_Internal             = ManagedClusterIngressProfileNginx_DefaultIngressControllerType("Internal")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_None                 = ManagedClusterIngressProfileNginx_DefaultIngressControllerType("None")
)

// Mapping from string to ManagedClusterIngressProfileNginx_DefaultIngressControllerType
var managedClusterIngressProfileNginx_DefaultIngressControllerType_Values = map[string]ManagedClusterIngressProfileNginx_DefaultIngressControllerType{
	"annotationcontrolled": ManagedClusterIngressProfileNginx_DefaultIngressControllerType_AnnotationControlled,
	"external":             ManagedClusterIngressProfileNginx_DefaultIngressControllerType_External,
	"internal":             ManagedClusterIngressProfileNginx_DefaultIngressControllerType_Internal,
	"none":                 ManagedClusterIngressProfileNginx_DefaultIngressControllerType_None,
}
