...
type ManagedClusterStatus_STATUS struct {
	...
	ProvisioningError *CloudErrorBody_STATUS `json:"provisioningError,omitempty"`
}
...
type CloudErrorBody_STATUS struct {
	...
	Details []CloudErrorBody_STATUS_Unrolled `json:"details"`
...
type ManagedClusterIngressProfileNginx_STATUS struct {
	...
	DefaultIngressControllerType *ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS `json:"defaultIngressControllerType,omitempty"`
}
...
type ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS string

const (
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_AnnotationControlled = ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS("AnnotationControlled")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_External             = ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS("External")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_Internal             = ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS("Internal")
	ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_None                 = ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS("None")
)

// Mapping from string to ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS
var managedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_Values = map[string]ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS{
	"annotationcontrolled": ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_AnnotationControlled,
	"external":             ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_External,
	"internal":             ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_Internal,
	"none":                 ManagedClusterIngressProfileNginx_DefaultIngressControllerType_STATUS_None,
}
