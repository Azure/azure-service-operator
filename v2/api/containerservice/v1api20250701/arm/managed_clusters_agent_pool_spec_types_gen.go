...
type GPUProfile struct {
	...
	Driver *GPUProfile_Driver `json:"driver,omitempty"`
}
...
// +kubebuilder:validation:Enum={"AzureLinux","AzureLinux3","CBLMariner","Ubuntu","Ubuntu2204","Windows2019","Windows2022"}
type OSSKU string
...
type GPUProfile_Driver string

const (
	GPUProfile_Driver_Install = GPUProfile_Driver("Install")
	GPUProfile_Driver_None    = GPUProfile_Driver("None")
)

// Mapping from string to GPUProfile_Driver
var gPUProfile_Driver_Values = map[string]GPUProfile_Driver{
	"install": GPUProfile_Driver_Install,
	"none":    GPUProfile_Driver_None,
}
