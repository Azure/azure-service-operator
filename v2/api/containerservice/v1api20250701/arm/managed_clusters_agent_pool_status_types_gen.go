...
type GPUProfile_STATUS struct {
	...
	Driver *GPUProfile_Driver_STATUS `json:"driver,omitempty"`
}
...
// The Virtual Machine Scale Set eviction policy. The eviction policy specifies what to do with the VM when it is evicted.
...
type GPUProfile_Driver_STATUS string

const (
	GPUProfile_Driver_STATUS_Install = GPUProfile_Driver_STATUS("Install")
	GPUProfile_Driver_STATUS_None    = GPUProfile_Driver_STATUS("None")
)

// Mapping from string to GPUProfile_Driver_STATUS
var gPUProfile_Driver_STATUS_Values = map[string]GPUProfile_Driver_STATUS{
	"install": GPUProfile_Driver_STATUS_Install,
	"none":    GPUProfile_Driver_STATUS_None,
}
