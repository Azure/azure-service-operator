...
func AddIndependentPropertyGeneratorsForManagedClusterAgentPoolProfileProperties(gens map[string]gopter.Gen) {
	...
	gens["Mode"] = gen.PtrOf(gen.OneConstOf(AgentPoolMode_Gateway, AgentPoolMode_System, AgentPoolMode_User))
	...
	gens["PodIPAllocationMode"] = gen.PtrOf(gen.OneConstOf(PodIPAllocationMode_DynamicIndividual, PodIPAllocationMode_StaticBlock))
