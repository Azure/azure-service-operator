...
func (member *FleetsMember) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20240401s.FleetsMember)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20240401/storage/FleetsMember but received %T instead", hub)
	}
...
func (member *FleetsMember) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20240401s.FleetsMember)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20240401/storage/FleetsMember but received %T instead", hub)
	}
...
func (member *FleetsMember) AssignProperties_From_FleetsMember(source *v20240401s.FleetsMember) error {
...
func (member *FleetsMember) AssignProperties_To_FleetsMember(destination *v20240401s.FleetsMember) error {

	// ObjectMeta
	destination.ObjectMeta = *member.ObjectMeta.DeepCopy()

	// Spec
	var spec v20240401s.FleetsMember_Spec
	...
	// Status
	var status v20240401s.FleetsMember_STATUS
...
type augmentConversionForFleetsMember interface {
	AssignPropertiesFrom(src *v20240401s.FleetsMember) error
	AssignPropertiesTo(dst *v20240401s.FleetsMember) error
}
...
func (member *FleetsMember_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20240401s.FleetsMember_Spec)
	if ok {
	...
	src = &v20240401s.FleetsMember_Spec{}
...
func (member *FleetsMember_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20240401s.FleetsMember_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20240401s.FleetsMember_Spec{}
...
func (member *FleetsMember_Spec) AssignProperties_From_FleetsMember_Spec(source *v20240401s.FleetsMember_Spec) error {
...
func (member *FleetsMember_Spec) AssignProperties_To_FleetsMember_Spec(destination *v20240401s.FleetsMember_Spec) error {
	// Clone the existing property bag
	...
	if member.OperatorSpec != nil {
		var operatorSpec v20240401s.FleetsMemberOperatorSpec
...
func (member *FleetsMember_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20240401s.FleetsMember_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20240401s.FleetsMember_STATUS{}
...
func (member *FleetsMember_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20240401s.FleetsMember_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20240401s.FleetsMember_STATUS{}
...
func (member *FleetsMember_STATUS) AssignProperties_From_FleetsMember_STATUS(source *v20240401s.FleetsMember_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (member *FleetsMember_STATUS) AssignProperties_To_FleetsMember_STATUS(destination *v20240401s.FleetsMember_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(member.PropertyBag)
...
type augmentConversionForFleetsMember_Spec interface {
	AssignPropertiesFrom(src *v20240401s.FleetsMember_Spec) error
	AssignPropertiesTo(dst *v20240401s.FleetsMember_Spec) error
}

type augmentConversionForFleetsMember_STATUS interface {
	AssignPropertiesFrom(src *v20240401s.FleetsMember_STATUS) error
	AssignPropertiesTo(dst *v20240401s.FleetsMember_STATUS) error
}
...
func (operator *FleetsMemberOperatorSpec) AssignProperties_From_FleetsMemberOperatorSpec(source *v20240401s.FleetsMemberOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *FleetsMemberOperatorSpec) AssignProperties_To_FleetsMemberOperatorSpec(destination *v20240401s.FleetsMemberOperatorSpec) error {
	// Clone the existing property bag
...
type augmentConversionForFleetsMemberOperatorSpec interface {
	AssignPropertiesFrom(src *v20240401s.FleetsMemberOperatorSpec) error
	AssignPropertiesTo(dst *v20240401s.FleetsMemberOperatorSpec) error
}
