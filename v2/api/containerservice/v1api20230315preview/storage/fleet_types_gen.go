...
func (fleet *Fleet) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20240401s.Fleet)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20240401/storage/Fleet but received %T instead", hub)
	}
...
func (fleet *Fleet) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20240401s.Fleet)
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20240401/storage/Fleet but received %T instead", hub)
	}
...
func (fleet *Fleet) AssignProperties_From_Fleet(source *v20240401s.Fleet) error {
...
func (fleet *Fleet) AssignProperties_To_Fleet(destination *v20240401s.Fleet) error {

	// ObjectMeta
	destination.ObjectMeta = *fleet.ObjectMeta.DeepCopy()

	// Spec
	var spec v20240401s.Fleet_Spec
	...
	// Status
	var status v20240401s.Fleet_STATUS
...
type augmentConversionForFleet interface {
	AssignPropertiesFrom(src *v20240401s.Fleet) error
	AssignPropertiesTo(dst *v20240401s.Fleet) error
}
...
func (fleet *Fleet_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20240401s.Fleet_Spec)
	if ok {
...
func (fleet *Fleet_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20240401s.Fleet_Spec)
	if ok {
...
func (fleet *Fleet_Spec) AssignProperties_From_Fleet_Spec(source *v20240401s.Fleet_Spec) error {
...
func (fleet *Fleet_Spec) AssignProperties_To_Fleet_Spec(destination *v20240401s.Fleet_Spec) error {
	// Clone the existing property bag
	...
	if fleet.HubProfile != nil {
		var hubProfile v20240401s.FleetHubProfile
	...
	if propertyBag.Contains("Identity") {
		var identity v20240401s.ManagedServiceIdentity
	...
	if fleet.OperatorSpec != nil {
		var operatorSpec v20240401s.FleetOperatorSpec
...
func (fleet *Fleet_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20240401s.Fleet_STATUS)
	if ok {
		// Populate our instance from source
...
func (fleet *Fleet_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20240401s.Fleet_STATUS)
	if ok {
		// Populate destination from our instance
...
func (fleet *Fleet_STATUS) AssignProperties_From_Fleet_STATUS(source *v20240401s.Fleet_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (fleet *Fleet_STATUS) AssignProperties_To_Fleet_STATUS(destination *v20240401s.Fleet_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(fleet.PropertyBag)
	...
	// HubProfile
	if fleet.HubProfile != nil {
		var hubProfile v20240401s.FleetHubProfile_STATUS
	...
	// Identity
	if propertyBag.Contains("Identity") {
		var identity v20240401s.ManagedServiceIdentity_STATUS
		err := propertyBag.Pull("Identity", &identity)
		if err != nil {
			return eris.Wrap(err, "pulling 'Identity' from propertyBag")
		}
...
type augmentConversionForFleet_Spec interface {
	AssignPropertiesFrom(src *v20240401s.Fleet_Spec) error
	AssignPropertiesTo(dst *v20240401s.Fleet_Spec) error
}

type augmentConversionForFleet_STATUS interface {
	AssignPropertiesFrom(src *v20240401s.Fleet_STATUS) error
	AssignPropertiesTo(dst *v20240401s.Fleet_STATUS) error
}
...
func (profile *FleetHubProfile) AssignProperties_From_FleetHubProfile(source *v20240401s.FleetHubProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *FleetHubProfile) AssignProperties_To_FleetHubProfile(destination *v20240401s.FleetHubProfile) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// AgentProfile
	if propertyBag.Contains("AgentProfile") {
		var agentProfile v20240401s.AgentProfile
	...
	if propertyBag.Contains("ApiServerAccessProfile") {
		var apiServerAccessProfile v20240401s.APIServerAccessProfile
...
func (profile *FleetHubProfile_STATUS) AssignProperties_From_FleetHubProfile_STATUS(source *v20240401s.FleetHubProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (profile *FleetHubProfile_STATUS) AssignProperties_To_FleetHubProfile_STATUS(destination *v20240401s.FleetHubProfile_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(profile.PropertyBag)

	// AgentProfile
	if propertyBag.Contains("AgentProfile") {
		var agentProfile v20240401s.AgentProfile_STATUS
		err := propertyBag.Pull("AgentProfile", &agentProfile)
		if err != nil {
			return eris.Wrap(err, "pulling 'AgentProfile' from propertyBag")
		}
	...
	// ApiServerAccessProfile
	if propertyBag.Contains("ApiServerAccessProfile") {
		var apiServerAccessProfile v20240401s.APIServerAccessProfile_STATUS
		err := propertyBag.Pull("ApiServerAccessProfile", &apiServerAccessProfile)
		if err != nil {
			return eris.Wrap(err, "pulling 'ApiServerAccessProfile' from propertyBag")
		}
...
func (operator *FleetOperatorSpec) AssignProperties_From_FleetOperatorSpec(source *v20240401s.FleetOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *FleetOperatorSpec) AssignProperties_To_FleetOperatorSpec(destination *v20240401s.FleetOperatorSpec) error {
	// Clone the existing property bag
	...
	if operator.Secrets != nil {
		var secret v20240401s.FleetOperatorSecrets
...
type augmentConversionForFleetHubProfile interface {
	AssignPropertiesFrom(src *v20240401s.FleetHubProfile) error
	AssignPropertiesTo(dst *v20240401s.FleetHubProfile) error
}

type augmentConversionForFleetHubProfile_STATUS interface {
	AssignPropertiesFrom(src *v20240401s.FleetHubProfile_STATUS) error
	AssignPropertiesTo(dst *v20240401s.FleetHubProfile_STATUS) error
}

type augmentConversionForFleetOperatorSpec interface {
	AssignPropertiesFrom(src *v20240401s.FleetOperatorSpec) error
	AssignPropertiesTo(dst *v20240401s.FleetOperatorSpec) error
}
...
func (secrets *FleetOperatorSecrets) AssignProperties_From_FleetOperatorSecrets(source *v20240401s.FleetOperatorSecrets) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (secrets *FleetOperatorSecrets) AssignProperties_To_FleetOperatorSecrets(destination *v20240401s.FleetOperatorSecrets) error {
	// Clone the existing property bag
...
type augmentConversionForFleetOperatorSecrets interface {
	AssignPropertiesFrom(src *v20240401s.FleetOperatorSecrets) error
	AssignPropertiesTo(dst *v20240401s.FleetOperatorSecrets) error
}
