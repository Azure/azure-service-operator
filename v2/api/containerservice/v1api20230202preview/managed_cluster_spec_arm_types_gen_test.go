...
func AddIndependentPropertyGeneratorsForContainerServiceNetworkProfile_ARM(gens map[string]gopter.Gen) {
	...
	gens["NetworkPolicy"] = gen.PtrOf(gen.OneConstOf(NetworkPolicy_ARM_Azure, NetworkPolicy_ARM_Calico, NetworkPolicy_ARM_Cilium))
...
func AddIndependentPropertyGeneratorsForGuardrailsProfile_ARM(gens map[string]gopter.Gen) {
	...
	gens["Level"] = gen.PtrOf(gen.OneConstOf(GuardrailsProfile_Level_ARM_Enforcement, GuardrailsProfile_Level_ARM_Off, GuardrailsProfile_Level_ARM_Warning))
...
func AddIndependentPropertyGeneratorsForManagedClusterSKU_ARM(gens map[string]gopter.Gen) {
	...
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(ManagedClusterSKU_Tier_ARM_Free, ManagedClusterSKU_Tier_ARM_Standard))
}
...
func AddIndependentPropertyGeneratorsForManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_ARM(gens map[string]gopter.Gen) {
	gens["ControlledValues"] = gen.PtrOf(gen.OneConstOf(ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_ControlledValues_ARM_RequestsAndLimits, ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_ControlledValues_ARM_RequestsOnly))
	gens["Enabled"] = gen.PtrOf(gen.Bool())
	gens["UpdateMode"] = gen.PtrOf(gen.OneConstOf(
		ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_UpdateMode_ARM_Auto,
		ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_UpdateMode_ARM_Initial,
		ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_UpdateMode_ARM_Off,
		ManagedClusterWorkloadAutoScalerProfileVerticalPodAutoscaler_UpdateMode_ARM_Recreate))
}
...
func AddIndependentPropertyGeneratorsForUpgradeOverrideSettings_ARM(gens map[string]gopter.Gen) {
	gens["ControlPlaneOverrides"] = gen.SliceOf(gen.OneConstOf(ControlPlaneUpgradeOverride_ARM_IgnoreKubernetesDeprecations))
