...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v1beta20230202preview-managedclustersagentpool,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1beta20230202preview,name=default.v1beta20230202preview.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v1beta20230202preview-managedclustersagentpool,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclustersagentpools,verbs=create;update,versions=v1beta20230202preview,name=validate.v1beta20230202preview.managedclustersagentpools.containerservice.azure.com,admissionReviewVersions=v1
...
func (pool *ManagedClusters_AgentPool_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if pool.CapacityReservationGroupID != nil {
		capacityReservationGroupID := *pool.CapacityReservationGroupID
...
func (pool *ManagedClusters_AgentPool_Spec) Initialize_From_ManagedClusters_AgentPool_STATUS(source *ManagedClusters_AgentPool_STATUS) error {
	...
	if source.WindowsProfile != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling Initialize_From_AgentPoolWindowsProfile_STATUS() to populate field WindowsProfile")
		}
		pool.WindowsProfile = &windowsProfile
	} else {
		pool.WindowsProfile = nil
