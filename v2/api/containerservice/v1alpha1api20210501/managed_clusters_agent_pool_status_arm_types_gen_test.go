...
func Test_ManagedClustersAgentPool_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<< HEAD:v2/api/containerservice/v1alpha1api20210501/managed_clusters_agent_pool_status_arm_types_gen_test.go
...
>>>>>>> main:v2/api/containerservice/v1alpha1api20210501/agent_pool_status_arm_types_gen_test.go
	// Serialize to JSON
