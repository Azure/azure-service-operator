...
type ManagedClustersAgentPools_SPECARM struct {
	...
	Properties *ManagedClusterAgentPoolProfileProperties_SpecARM `json:"properties,omitempty"`
}

var _ genruntime.ARMResourceSpec = &ManagedClustersAgentPools_SPECARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-01"
func (specarm ManagedClustersAgentPools_SPECARM) GetAPIVersion() string {
	return string(APIVersionValue)
}

// GetName returns the Name of the resource
func (specarm ManagedClustersAgentPools_SPECARM) GetName() string {
	return specarm.Name
}
...
type AgentPoolUpgradeSettings_SpecARM struct {
...
type KubeletConfig_SpecARM struct {
...
type LinuxOSConfig_SpecARM struct {
	...
	Sysctls *SysctlConfig_SpecARM `json:"sysctls,omitempty"`
...
type SysctlConfig_SpecARM struct {
