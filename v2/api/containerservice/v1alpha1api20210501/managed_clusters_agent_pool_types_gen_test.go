...
// RunPropertyAssignmentTestForManagedClusters_AgentPools_Spec tests if a specific instance of ManagedClusters_AgentPools_Spec can be assigned to v1alpha1api20210501storage and back losslessly
func RunPropertyAssignmentTestForManagedClusters_AgentPools_Spec(subject ManagedClusters_AgentPools_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210501s.ManagedClusters_AgentPools_Spec
