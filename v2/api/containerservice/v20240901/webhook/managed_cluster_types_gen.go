...
// +kubebuilder:webhook:path=/mutate-containerservice-azure-com-v20240901-managedcluster,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v20240901,name=default.v20240901.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
...
func (cluster *ManagedCluster) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v20240901/ManagedCluster, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-containerservice-azure-com-v20240901-managedcluster,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=containerservice.azure.com,resources=managedclusters,verbs=create;update,versions=v20240901,name=validate.v20240901.managedclusters.containerservice.azure.com,admissionReviewVersions=v1
...
func (cluster *ManagedCluster) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v20240901/ManagedCluster, but got %T", resource)
	}
...
func (cluster *ManagedCluster) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v20240901/ManagedCluster, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20240901.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v20240901/ManagedCluster, but got %T", oldResource)
	}
