...
func (profile *ContainerServiceNetworkProfile) AssignProperties_To_ContainerServiceNetworkProfile(destination *storage.ContainerServiceNetworkProfile) error {
	...
	if propertyBag.Contains("IpFamilies") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'IpFamilies' from propertyBag")
		}
	...
	if propertyBag.Contains("NatGatewayProfile") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'NatGatewayProfile' from propertyBag")
		}
	...
	if propertyBag.Contains("NetworkDataplane") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'NetworkDataplane' from propertyBag")
		}
	...
	if propertyBag.Contains("NetworkPluginMode") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'NetworkPluginMode' from propertyBag")
		}
	...
	if propertyBag.Contains("PodCidrs") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'PodCidrs' from propertyBag")
		}
	...
	if propertyBag.Contains("ServiceCidrs") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'ServiceCidrs' from propertyBag")
		}
...
func (profile *ManagedClusterAPIServerAccessProfile) AssignProperties_To_ManagedClusterAPIServerAccessProfile(destination *storage.ManagedClusterAPIServerAccessProfile) error {
	...
	if propertyBag.Contains("DisableRunCommand") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'DisableRunCommand' from propertyBag")
		}
...
func (profile *ManagedClusterWindowsProfile) AssignProperties_To_ManagedClusterWindowsProfile(destination *storage.ManagedClusterWindowsProfile) error {
	...
	if propertyBag.Contains("GmsaProfile") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'GmsaProfile' from propertyBag")
		}
...
func (profile *ManagedClusterLoadBalancerProfile) AssignProperties_To_ManagedClusterLoadBalancerProfile(destination *storage.ManagedClusterLoadBalancerProfile) error {
	...
	if propertyBag.Contains("EnableMultipleStandardLoadBalancers") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'EnableMultipleStandardLoadBalancers' from propertyBag")
		}
...
func (iPs *ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) AssignProperties_To_ManagedClusterLoadBalancerProfile_ManagedOutboundIPs(destination *storage.ManagedClusterLoadBalancerProfile_ManagedOutboundIPs) error {
	...
	if propertyBag.Contains("CountIPv6") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'CountIPv6' from propertyBag")
		}
