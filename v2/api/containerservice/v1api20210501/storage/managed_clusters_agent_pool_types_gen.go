...
// Storage version of v1api20210501.ManagedClustersAgentPool_Spec
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_From_ManagedClustersAgentPool_Spec(source *storage.ManagedClustersAgentPool_Spec) error {
	...
	if propertyBag.Contains("NodePublicIPPrefixIDReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'NodePublicIPPrefixIDReference' from propertyBag")
		}
	...
	if propertyBag.Contains("PodSubnetIDReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'PodSubnetIDReference' from propertyBag")
		}
	...
	if propertyBag.Contains("ProximityPlacementGroupID") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'ProximityPlacementGroupID' from propertyBag")
		}
	...
	if propertyBag.Contains("VnetSubnetIDReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'VnetSubnetIDReference' from propertyBag")
		}
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_To_ManagedClustersAgentPool_Spec(destination *storage.ManagedClustersAgentPool_Spec) error {
	...
	if propertyBag.Contains("HostGroupReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'HostGroupReference' from propertyBag")
		}
	...
	if propertyBag.Contains("NodePublicIPPrefixReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'NodePublicIPPrefixReference' from propertyBag")
		}
	...
	if propertyBag.Contains("PodSubnetReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'PodSubnetReference' from propertyBag")
		}
	...
	if propertyBag.Contains("PowerState") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'PowerState' from propertyBag")
		}
	...
	if propertyBag.Contains("ProximityPlacementGroupReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'ProximityPlacementGroupReference' from propertyBag")
		}
	...
	if propertyBag.Contains("ScaleDownMode") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'ScaleDownMode' from propertyBag")
		}
	...
	if propertyBag.Contains("VnetSubnetReference") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'VnetSubnetReference' from propertyBag")
		}
	...
	if propertyBag.Contains("WorkloadRuntime") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'WorkloadRuntime' from propertyBag")
		}
...
// Storage version of v1api20210501.ManagedClustersAgentPool_STATUS
...
func (pool *ManagedClustersAgentPool_STATUS) AssignProperties_To_ManagedClustersAgentPool_STATUS(destination *storage.ManagedClustersAgentPool_STATUS) error {
	...
	if propertyBag.Contains("CurrentOrchestratorVersion") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'CurrentOrchestratorVersion' from propertyBag")
		}
	...
	if propertyBag.Contains("HostGroupID") {
		...
		if err != nil {
			return eris.Wrap(err, "pulling 'HostGroupID' from propertyBag")
		}
