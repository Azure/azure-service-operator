...
func AddIndependentPropertyGeneratorsForContainerServiceNetworkProfile_ARM(gens map[string]gopter.Gen) {
	...
	gens["NetworkPlugin"] = gen.PtrOf(gen.OneConstOf(ContainerServiceNetworkProfile_NetworkPlugin_ARM_Azure, ContainerServiceNetworkProfile_NetworkPlugin_ARM_Kubenet))
	gens["NetworkPolicy"] = gen.PtrOf(gen.OneConstOf(ContainerServiceNetworkProfile_NetworkPolicy_ARM_Azure, ContainerServiceNetworkProfile_NetworkPolicy_ARM_Calico))
	gens["OutboundType"] = gen.PtrOf(gen.OneConstOf(ContainerServiceNetworkProfile_OutboundType_ARM_LoadBalancer, ContainerServiceNetworkProfile_OutboundType_ARM_UserDefinedRouting))
...
func AddIndependentPropertyGeneratorsForManagedClusterSKU_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.OneConstOf(ManagedClusterSKU_Name_ARM_Basic))
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(ManagedClusterSKU_Tier_ARM_Free, ManagedClusterSKU_Tier_ARM_Paid))
}
