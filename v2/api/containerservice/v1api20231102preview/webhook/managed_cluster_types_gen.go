...
func (cluster *ManagedCluster) createValidations() []func(ctx context.Context, obj *v20231102p.ManagedCluster) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20231102p.ManagedCluster) (admission.Warnings, error){
...
func (cluster *ManagedCluster) validateOptionalConfigMapReferences(ctx context.Context, obj *v20231102p.ManagedCluster) (admission.Warnings, error) {
