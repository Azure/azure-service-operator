...
func AddRelatedPropertyGeneratorsForContainerServiceNetworkProfile_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Monitoring"] = gen.PtrOf(NetworkMonitoring_STATUS_ARMGenerator())
...
func ManagedClusterAzureMonitorProfileAppMonitoring_STATUS_ARMGenerator() gopter.Gen {
	...
	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileAppMonitoring_STATUS_ARM(generators)
...
// AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileAppMonitoring_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileAppMonitoring_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Enabled"] = gen.PtrOf(gen.Bool())
}
...
// We first initialize managedClusterAzureMonitorProfileContainerInsights_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARMGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARM(generators)
	managedClusterAzureMonitorProfileContainerInsights_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARM{}), generators)
...
// AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileContainerInsights_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["WindowsHostLogs"] = gen.PtrOf(ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator())
}
...
func Test_ManagedClusterAzureMonitorProfileLogs_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ManagedClusterAzureMonitorProfileLogs_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForManagedClusterAzureMonitorProfileLogs_STATUS_ARM, ManagedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForManagedClusterAzureMonitorProfileLogs_STATUS_ARM runs a test to see if a specific instance of ManagedClusterAzureMonitorProfileLogs_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForManagedClusterAzureMonitorProfileLogs_STATUS_ARM(subject ManagedClusterAzureMonitorProfileLogs_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ManagedClusterAzureMonitorProfileLogs_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ManagedClusterAzureMonitorProfileLogs_STATUS_ARM instances for property testing - lazily instantiated by
// ManagedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator()
var managedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator gopter.Gen

// ManagedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator returns a generator of ManagedClusterAzureMonitorProfileLogs_STATUS_ARM instances for property testing.
func ManagedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator() gopter.Gen {
	if managedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator != nil {
		return managedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileLogs_STATUS_ARM(generators)
	managedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ManagedClusterAzureMonitorProfileLogs_STATUS_ARM{}), generators)

	return managedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator
}

// AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileLogs_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileLogs_STATUS_ARM(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfileMetrics_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["AppMonitoringOpenTelemetryMetrics"] = gen.PtrOf(ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics_STATUS_ARMGenerator())
	gens["KubeStateMetrics"] = gen.PtrOf(ManagedClusterAzureMonitorProfileKubeStateMetrics_STATUS_ARMGenerator())
}

func Test_ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM, ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM runs a test to see if a specific instance of ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM(subject ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM instances for property testing - lazily
// instantiated by ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator()
var managedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator gopter.Gen

// ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator returns a generator of ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM instances for property testing.
func ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator() gopter.Gen {
	if managedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator != nil {
		return managedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM(generators)
	managedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM{}), generators)

	return managedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForManagedClusterAzureMonitorProfileWindowsHostLogs_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Enabled"] = gen.PtrOf(gen.Bool())
}
...
func AddRelatedPropertyGeneratorsForManagedClusterAzureMonitorProfile_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Logs"] = gen.PtrOf(ManagedClusterAzureMonitorProfileLogs_STATUS_ARMGenerator())
...
func Test_NetworkMonitoring_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NetworkMonitoring_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNetworkMonitoring_STATUS_ARM, NetworkMonitoring_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNetworkMonitoring_STATUS_ARM runs a test to see if a specific instance of NetworkMonitoring_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForNetworkMonitoring_STATUS_ARM(subject NetworkMonitoring_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NetworkMonitoring_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NetworkMonitoring_STATUS_ARM instances for property testing - lazily instantiated by
// NetworkMonitoring_STATUS_ARMGenerator()
var networkMonitoring_STATUS_ARMGenerator gopter.Gen

// NetworkMonitoring_STATUS_ARMGenerator returns a generator of NetworkMonitoring_STATUS_ARM instances for property testing.
func NetworkMonitoring_STATUS_ARMGenerator() gopter.Gen {
	if networkMonitoring_STATUS_ARMGenerator != nil {
		return networkMonitoring_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNetworkMonitoring_STATUS_ARM(generators)
	networkMonitoring_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(NetworkMonitoring_STATUS_ARM{}), generators)

	return networkMonitoring_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForNetworkMonitoring_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNetworkMonitoring_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Enabled"] = gen.PtrOf(gen.Bool())
}
