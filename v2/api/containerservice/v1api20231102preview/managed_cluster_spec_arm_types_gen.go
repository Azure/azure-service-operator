...
type ContainerServiceNetworkProfile_ARM struct {
	...
	// format
	Monitoring *NetworkMonitoring_ARM `json:"monitoring,omitempty"`
...
type ManagedClusterAzureMonitorProfile_ARM struct {
	...
	Logs *ManagedClusterAzureMonitorProfileLogs_ARM `json:"logs,omitempty"`
...
type ManagedClusterAzureMonitorProfileLogs_ARM struct {
...
type ManagedClusterAzureMonitorProfileMetrics_ARM struct {
	...
	AppMonitoringOpenTelemetryMetrics *ManagedClusterAzureMonitorProfileAppMonitoringOpenTelemetryMetrics_ARM `json:"appMonitoringOpenTelemetryMetrics,omitempty"`
...
type ManagedClusterAzureMonitorProfileContainerInsights_ARM struct {
	...
	WindowsHostLogs *ManagedClusterAzureMonitorProfileWindowsHostLogs_ARM `json:"windowsHostLogs,omitempty"`
}
