...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240401/arm"
...
func (strategy *FleetsUpdateStrategy) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected containerservice/v1api20240401/storage/FleetsUpdateStrategy but received %T instead", hub)
	}
