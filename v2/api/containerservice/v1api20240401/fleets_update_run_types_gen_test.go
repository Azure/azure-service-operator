...
import (
	"encoding/json"
	storage "github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240401/storage"
...
func AddIndependentPropertyGeneratorsForNodeImageSelection(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(NodeImageSelectionType_Consistent, NodeImageSelectionType_Latest))
}
...
func AddIndependentPropertyGeneratorsForNodeImageSelection_STATUS(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(NodeImageSelectionType_STATUS_Consistent, NodeImageSelectionType_STATUS_Latest))
}
