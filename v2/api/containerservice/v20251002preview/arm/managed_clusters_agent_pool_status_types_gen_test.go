...
func Test_AgentPoolBlueGreenUpgradeSettings_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AgentPoolBlueGreenUpgradeSettings_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAgentPoolBlueGreenUpgradeSettings_STATUS, AgentPoolBlueGreenUpgradeSettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAgentPoolBlueGreenUpgradeSettings_STATUS runs a test to see if a specific instance of AgentPoolBlueGreenUpgradeSettings_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForAgentPoolBlueGreenUpgradeSettings_STATUS(subject AgentPoolBlueGreenUpgradeSettings_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual AgentPoolBlueGreenUpgradeSettings_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of AgentPoolBlueGreenUpgradeSettings_STATUS instances for property testing - lazily instantiated by
// AgentPoolBlueGreenUpgradeSettings_STATUSGenerator()
var agentPoolBlueGreenUpgradeSettings_STATUSGenerator gopter.Gen

// AgentPoolBlueGreenUpgradeSettings_STATUSGenerator returns a generator of AgentPoolBlueGreenUpgradeSettings_STATUS instances for property testing.
func AgentPoolBlueGreenUpgradeSettings_STATUSGenerator() gopter.Gen {
	if agentPoolBlueGreenUpgradeSettings_STATUSGenerator != nil {
		return agentPoolBlueGreenUpgradeSettings_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAgentPoolBlueGreenUpgradeSettings_STATUS(generators)
	agentPoolBlueGreenUpgradeSettings_STATUSGenerator = gen.Struct(reflect.TypeOf(AgentPoolBlueGreenUpgradeSettings_STATUS{}), generators)

	return agentPoolBlueGreenUpgradeSettings_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForAgentPoolBlueGreenUpgradeSettings_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAgentPoolBlueGreenUpgradeSettings_STATUS(gens map[string]gopter.Gen) {
	gens["BatchSoakDurationInMinutes"] = gen.PtrOf(gen.Int())
	gens["DrainBatchSize"] = gen.PtrOf(gen.AlphaString())
	gens["DrainTimeoutInMinutes"] = gen.PtrOf(gen.Int())
	gens["FinalSoakDurationInMinutes"] = gen.PtrOf(gen.Int())
}
...
func AddIndependentPropertyGeneratorsForAgentPoolSecurityProfile_STATUS(gens map[string]gopter.Gen) {
	...
	gens["SshAccess"] = gen.PtrOf(gen.OneConstOf(AgentPoolSSHAccess_STATUS_Disabled, AgentPoolSSHAccess_STATUS_EntraId, AgentPoolSSHAccess_STATUS_LocalUser))
}
...
func AddIndependentPropertyGeneratorsForAgentPoolUpgradeSettings_STATUS(gens map[string]gopter.Gen) {
	gens["DrainTimeoutInMinutes"] = gen.PtrOf(gen.Int())
	gens["MaxBlockedNodes"] = gen.PtrOf(gen.AlphaString())
...
func AddIndependentPropertyGeneratorsForGPUProfile_STATUS(gens map[string]gopter.Gen) {
	...
	gens["DriverType"] = gen.PtrOf(gen.OneConstOf(DriverType_STATUS_CUDA, DriverType_STATUS_GRID))
}
...
func AddIndependentPropertyGeneratorsForKubeletConfig_STATUS(gens map[string]gopter.Gen) {
	...
	gens["SeccompDefault"] = gen.PtrOf(gen.OneConstOf(SeccompDefault_STATUS_RuntimeDefault, SeccompDefault_STATUS_Unconfined))
...
func Test_NodeCustomizationProfile_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NodeCustomizationProfile_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNodeCustomizationProfile_STATUS, NodeCustomizationProfile_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNodeCustomizationProfile_STATUS runs a test to see if a specific instance of NodeCustomizationProfile_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForNodeCustomizationProfile_STATUS(subject NodeCustomizationProfile_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NodeCustomizationProfile_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NodeCustomizationProfile_STATUS instances for property testing - lazily instantiated by
// NodeCustomizationProfile_STATUSGenerator()
var nodeCustomizationProfile_STATUSGenerator gopter.Gen

// NodeCustomizationProfile_STATUSGenerator returns a generator of NodeCustomizationProfile_STATUS instances for property testing.
func NodeCustomizationProfile_STATUSGenerator() gopter.Gen {
	if nodeCustomizationProfile_STATUSGenerator != nil {
		return nodeCustomizationProfile_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNodeCustomizationProfile_STATUS(generators)
	nodeCustomizationProfile_STATUSGenerator = gen.Struct(reflect.TypeOf(NodeCustomizationProfile_STATUS{}), generators)

	return nodeCustomizationProfile_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForNodeCustomizationProfile_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNodeCustomizationProfile_STATUS(gens map[string]gopter.Gen) {
	gens["NodeCustomizationId"] = gen.PtrOf(gen.AlphaString())
}
...
func AddRelatedPropertyGeneratorsForScaleProfile_STATUS(gens map[string]gopter.Gen) {
	gens["Autoscale"] = gen.PtrOf(AutoScaleProfile_STATUSGenerator())
