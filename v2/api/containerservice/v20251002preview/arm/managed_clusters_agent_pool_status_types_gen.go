...
const (
	...
	AgentPoolMode_STATUS_Machines      = AgentPoolMode_STATUS("Machines")
	AgentPoolMode_STATUS_ManagedSystem = AgentPoolMode_STATUS("ManagedSystem")
...
var agentPoolMode_STATUS_Values = map[string]AgentPoolMode_STATUS{
	...
	"machines":      AgentPoolMode_STATUS_Machines,
	"managedsystem": AgentPoolMode_STATUS_ManagedSystem,
...
type GPUProfile_STATUS struct {
	...
	DriverType *DriverType_STATUS `json:"driverType,omitempty"`
}
...
type KubeletConfig_STATUS struct {
	...
	// used by default.
	SeccompDefault *SeccompDefault_STATUS `json:"seccompDefault,omitempty"`
...
const (
	...
	OSSKU_STATUS_Flatcar       = OSSKU_STATUS("Flatcar")
...
type UpgradeStrategy_STATUS string

const (
	UpgradeStrategy_STATUS_BlueGreen = UpgradeStrategy_STATUS("BlueGreen")
	UpgradeStrategy_STATUS_Rolling   = UpgradeStrategy_STATUS("Rolling")
)

// Mapping from string to UpgradeStrategy_STATUS
var upgradeStrategy_STATUS_Values = map[string]UpgradeStrategy_STATUS{
	"bluegreen": UpgradeStrategy_STATUS_BlueGreen,
	"rolling":   UpgradeStrategy_STATUS_Rolling,
}
...
const (
	...
	AgentPoolSSHAccess_STATUS_EntraId   = AgentPoolSSHAccess_STATUS("EntraId")
...
var agentPoolSSHAccess_STATUS_Values = map[string]AgentPoolSSHAccess_STATUS{
	...
	"entraid":   AgentPoolSSHAccess_STATUS_EntraId,
...
type DriverType_STATUS string

const (
	DriverType_STATUS_CUDA = DriverType_STATUS("CUDA")
	DriverType_STATUS_GRID = DriverType_STATUS("GRID")
)

// Mapping from string to DriverType_STATUS
var driverType_STATUS_Values = map[string]DriverType_STATUS{
	"cuda": DriverType_STATUS_CUDA,
	"grid": DriverType_STATUS_GRID,
}
...
type SeccompDefault_STATUS string

const (
	SeccompDefault_STATUS_RuntimeDefault = SeccompDefault_STATUS("RuntimeDefault")
	SeccompDefault_STATUS_Unconfined     = SeccompDefault_STATUS("Unconfined")
)

// Mapping from string to SeccompDefault_STATUS
var seccompDefault_STATUS_Values = map[string]SeccompDefault_STATUS{
	"runtimedefault": SeccompDefault_STATUS_RuntimeDefault,
	"unconfined":     SeccompDefault_STATUS_Unconfined,
}
