...
func (pool *ManagedClustersAgentPool_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if pool.NodeCustomizationProfile != nil {
		nodeCustomizationProfile_ARM, err := pool.NodeCustomizationProfile.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
	...
	if pool.UpgradeSettingsBlueGreen != nil {
		upgradeSettingsBlueGreen_ARM, err := pool.UpgradeSettingsBlueGreen.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		upgradeSettingsBlueGreen := *upgradeSettingsBlueGreen_ARM.(*arm.AgentPoolBlueGreenUpgradeSettings)
		result.Properties.UpgradeSettingsBlueGreen = &upgradeSettingsBlueGreen
	}
	if pool.UpgradeStrategy != nil {
		var temp string
		temp = string(*pool.UpgradeStrategy)
		upgradeStrategy := arm.UpgradeStrategy(temp)
		result.Properties.UpgradeStrategy = &upgradeStrategy
	}
...
func (pool *ManagedClustersAgentPool_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.NodeCustomizationProfile != nil {
			var nodeCustomizationProfile1 NodeCustomizationProfile
			err := nodeCustomizationProfile1.PopulateFromARM(owner, *typedInput.Properties.NodeCustomizationProfile)
			if err != nil {
				return err
			}
	...
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.UpgradeSettingsBlueGreen != nil {
			var upgradeSettingsBlueGreen1 AgentPoolBlueGreenUpgradeSettings
			err := upgradeSettingsBlueGreen1.PopulateFromARM(owner, *typedInput.Properties.UpgradeSettingsBlueGreen)
			if err != nil {
				return err
			}
	...
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.UpgradeStrategy != nil {
			var temp string
			temp = string(*typedInput.Properties.UpgradeStrategy)
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_From_ManagedClustersAgentPool_Spec(source *storage.ManagedClustersAgentPool_Spec) error {
	...
	if source.UpgradeStrategy != nil {
		...
		pool.UpgradeStrategy = &upgradeStrategyTemp
	} else {
		pool.UpgradeStrategy = nil
	}
...
func (pool *ManagedClustersAgentPool_Spec) AssignProperties_To_ManagedClustersAgentPool_Spec(destination *storage.ManagedClustersAgentPool_Spec) error {
	...
	if pool.NodeCustomizationProfile != nil {
		...
		err := pool.NodeCustomizationProfile.AssignProperties_To_NodeCustomizationProfile(&nodeCustomizationProfile)
		if err != nil {
	...
	if pool.UpgradeSettingsBlueGreen != nil {
		...
		err := pool.UpgradeSettingsBlueGreen.AssignProperties_To_AgentPoolBlueGreenUpgradeSettings(&upgradeSettingsBlueGreen)
		if err != nil {
	...
	// UpgradeStrategy
	if pool.UpgradeStrategy != nil {
		upgradeStrategy := string(*pool.UpgradeStrategy)
...
func (pool *ManagedClustersAgentPool_STATUS) AssignProperties_To_ManagedClustersAgentPool_STATUS(destination *storage.ManagedClustersAgentPool_STATUS) error {
	...
	if pool.NodeCustomizationProfile != nil {
		...
		err := pool.NodeCustomizationProfile.AssignProperties_To_NodeCustomizationProfile_STATUS(&nodeCustomizationProfile)
		if err != nil {
	...
	if pool.UpgradeSettingsBlueGreen != nil {
		...
		err := pool.UpgradeSettingsBlueGreen.AssignProperties_To_AgentPoolBlueGreenUpgradeSettings_STATUS(&upgradeSettingsBlueGreen)
		if err != nil {
...
var _ genruntime.ARMTransformer = &AgentPoolBlueGreenUpgradeSettings{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (settings *AgentPoolBlueGreenUpgradeSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if settings == nil {
		return nil, nil
	}
	result := &arm.AgentPoolBlueGreenUpgradeSettings{}

	// Set property "BatchSoakDurationInMinutes":
	if settings.BatchSoakDurationInMinutes != nil {
		batchSoakDurationInMinutes := *settings.BatchSoakDurationInMinutes
		result.BatchSoakDurationInMinutes = &batchSoakDurationInMinutes
	}

	// Set property "DrainBatchSize":
	if settings.DrainBatchSize != nil {
		drainBatchSize := *settings.DrainBatchSize
		result.DrainBatchSize = &drainBatchSize
	}
	...
	// Set property "FinalSoakDurationInMinutes":
	if settings.FinalSoakDurationInMinutes != nil {
		finalSoakDurationInMinutes := *settings.FinalSoakDurationInMinutes
		result.FinalSoakDurationInMinutes = &finalSoakDurationInMinutes
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *AgentPoolBlueGreenUpgradeSettings) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AgentPoolBlueGreenUpgradeSettings{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *AgentPoolBlueGreenUpgradeSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AgentPoolBlueGreenUpgradeSettings)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AgentPoolBlueGreenUpgradeSettings, got %T", armInput)
	}

	// Set property "BatchSoakDurationInMinutes":
	if typedInput.BatchSoakDurationInMinutes != nil {
		batchSoakDurationInMinutes := *typedInput.BatchSoakDurationInMinutes
		settings.BatchSoakDurationInMinutes = &batchSoakDurationInMinutes
	}

	// Set property "DrainBatchSize":
	if typedInput.DrainBatchSize != nil {
		drainBatchSize := *typedInput.DrainBatchSize
		settings.DrainBatchSize = &drainBatchSize
	}
	...
	// Set property "FinalSoakDurationInMinutes":
	if typedInput.FinalSoakDurationInMinutes != nil {
		finalSoakDurationInMinutes := *typedInput.FinalSoakDurationInMinutes
		settings.FinalSoakDurationInMinutes = &finalSoakDurationInMinutes
	}
...
// AssignProperties_From_AgentPoolBlueGreenUpgradeSettings populates our AgentPoolBlueGreenUpgradeSettings from the provided source AgentPoolBlueGreenUpgradeSettings
func (settings *AgentPoolBlueGreenUpgradeSettings) AssignProperties_From_AgentPoolBlueGreenUpgradeSettings(source *storage.AgentPoolBlueGreenUpgradeSettings) error {

	// BatchSoakDurationInMinutes
	settings.BatchSoakDurationInMinutes = genruntime.ClonePointerToInt(source.BatchSoakDurationInMinutes)

	// DrainBatchSize
	settings.DrainBatchSize = genruntime.ClonePointerToString(source.DrainBatchSize)

	// DrainTimeoutInMinutes
	settings.DrainTimeoutInMinutes = genruntime.ClonePointerToInt(source.DrainTimeoutInMinutes)

	// FinalSoakDurationInMinutes
	settings.FinalSoakDurationInMinutes = genruntime.ClonePointerToInt(source.FinalSoakDurationInMinutes)

	// No error
	return nil
}

// AssignProperties_To_AgentPoolBlueGreenUpgradeSettings populates the provided destination AgentPoolBlueGreenUpgradeSettings from our AgentPoolBlueGreenUpgradeSettings
func (settings *AgentPoolBlueGreenUpgradeSettings) AssignProperties_To_AgentPoolBlueGreenUpgradeSettings(destination *storage.AgentPoolBlueGreenUpgradeSettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BatchSoakDurationInMinutes
	destination.BatchSoakDurationInMinutes = genruntime.ClonePointerToInt(settings.BatchSoakDurationInMinutes)

	// DrainBatchSize
	destination.DrainBatchSize = genruntime.ClonePointerToString(settings.DrainBatchSize)

	// DrainTimeoutInMinutes
	destination.DrainTimeoutInMinutes = genruntime.ClonePointerToInt(settings.DrainTimeoutInMinutes)

	// FinalSoakDurationInMinutes
	destination.FinalSoakDurationInMinutes = genruntime.ClonePointerToInt(settings.FinalSoakDurationInMinutes)
...
var _ genruntime.FromARMConverter = &AgentPoolBlueGreenUpgradeSettings_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *AgentPoolBlueGreenUpgradeSettings_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.AgentPoolBlueGreenUpgradeSettings_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *AgentPoolBlueGreenUpgradeSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.AgentPoolBlueGreenUpgradeSettings_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.AgentPoolBlueGreenUpgradeSettings_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_AgentPoolBlueGreenUpgradeSettings_STATUS populates our AgentPoolBlueGreenUpgradeSettings_STATUS from the provided source AgentPoolBlueGreenUpgradeSettings_STATUS
func (settings *AgentPoolBlueGreenUpgradeSettings_STATUS) AssignProperties_From_AgentPoolBlueGreenUpgradeSettings_STATUS(source *storage.AgentPoolBlueGreenUpgradeSettings_STATUS) error {
...
// AssignProperties_To_AgentPoolBlueGreenUpgradeSettings_STATUS populates the provided destination AgentPoolBlueGreenUpgradeSettings_STATUS from our AgentPoolBlueGreenUpgradeSettings_STATUS
func (settings *AgentPoolBlueGreenUpgradeSettings_STATUS) AssignProperties_To_AgentPoolBlueGreenUpgradeSettings_STATUS(destination *storage.AgentPoolBlueGreenUpgradeSettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (settings *AgentPoolUpgradeSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "MaxBlockedNodes":
	if settings.MaxBlockedNodes != nil {
		maxBlockedNodes := *settings.MaxBlockedNodes
		result.MaxBlockedNodes = &maxBlockedNodes
	}
...
func (settings *AgentPoolUpgradeSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "MaxBlockedNodes":
	if typedInput.MaxBlockedNodes != nil {
		maxBlockedNodes := *typedInput.MaxBlockedNodes
		settings.MaxBlockedNodes = &maxBlockedNodes
	}
...
func (settings *AgentPoolUpgradeSettings) AssignProperties_From_AgentPoolUpgradeSettings(source *storage.AgentPoolUpgradeSettings) error {
	...
	// MaxBlockedNodes
	settings.MaxBlockedNodes = genruntime.ClonePointerToString(source.MaxBlockedNodes)
...
func (settings *AgentPoolUpgradeSettings) AssignProperties_To_AgentPoolUpgradeSettings(destination *storage.AgentPoolUpgradeSettings) error {
	...
	// MaxBlockedNodes
	destination.MaxBlockedNodes = genruntime.ClonePointerToString(settings.MaxBlockedNodes)
...
func (profile *GPUProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "DriverType":
	if profile.DriverType != nil {
		var temp string
		temp = string(*profile.DriverType)
		driverType := arm.DriverType(temp)
...
func (profile *GPUProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DriverType":
	if typedInput.DriverType != nil {
		var temp string
		temp = string(*typedInput.DriverType)
		driverType := DriverType(temp)
...
func (profile *GPUProfile) AssignProperties_From_GPUProfile(source *storage.GPUProfile) error {
	...
	// DriverType
	if source.DriverType != nil {
		driverType := *source.DriverType
		driverTypeTemp := genruntime.ToEnum(driverType, driverType_Values)
		profile.DriverType = &driverTypeTemp
	} else {
...
func (profile *GPUProfile) AssignProperties_To_GPUProfile(destination *storage.GPUProfile) error {
	...
	// DriverType
	if profile.DriverType != nil {
		driverType := string(*profile.DriverType)
		destination.DriverType = &driverType
	} else {
		destination.DriverType = nil
	}
...
func (profile *GPUProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DriverType != nil {
		var temp string
		temp = string(*typedInput.DriverType)
		driverType := DriverType_STATUS(temp)
		profile.DriverType = &driverType
	}
...
func (profile *GPUProfile_STATUS) AssignProperties_From_GPUProfile_STATUS(source *storage.GPUProfile_STATUS) error {
	...
	if source.DriverType != nil {
		driverType := *source.DriverType
		driverTypeTemp := genruntime.ToEnum(driverType, driverType_STATUS_Values)
		profile.DriverType = &driverTypeTemp
	} else {
		profile.DriverType = nil
	}
...
func (config *KubeletConfig) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "SeccompDefault":
	if config.SeccompDefault != nil {
		var temp string
		temp = string(*config.SeccompDefault)
		seccompDefault := arm.SeccompDefault(temp)
		result.SeccompDefault = &seccompDefault
	}
...
func (config *KubeletConfig) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "SeccompDefault":
	if typedInput.SeccompDefault != nil {
		var temp string
		temp = string(*typedInput.SeccompDefault)
		seccompDefault := SeccompDefault(temp)
...
func (config *KubeletConfig) AssignProperties_From_KubeletConfig(source *storage.KubeletConfig) error {
	...
	// SeccompDefault
	if source.SeccompDefault != nil {
		seccompDefault := *source.SeccompDefault
		seccompDefaultTemp := genruntime.ToEnum(seccompDefault, seccompDefault_Values)
		config.SeccompDefault = &seccompDefaultTemp
	} else {
...
func (config *KubeletConfig) AssignProperties_To_KubeletConfig(destination *storage.KubeletConfig) error {
	...
	// SeccompDefault
	if config.SeccompDefault != nil {
		seccompDefault := string(*config.SeccompDefault)
		destination.SeccompDefault = &seccompDefault
	} else {
		destination.SeccompDefault = nil
	}
...
func (config *KubeletConfig_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.SeccompDefault != nil {
		var temp string
		temp = string(*typedInput.SeccompDefault)
		seccompDefault := SeccompDefault_STATUS(temp)
		config.SeccompDefault = &seccompDefault
	}
...
func (config *KubeletConfig_STATUS) AssignProperties_From_KubeletConfig_STATUS(source *storage.KubeletConfig_STATUS) error {
	...
	if source.SeccompDefault != nil {
		seccompDefault := *source.SeccompDefault
		seccompDefaultTemp := genruntime.ToEnum(seccompDefault, seccompDefault_STATUS_Values)
		config.SeccompDefault = &seccompDefaultTemp
	} else {
		config.SeccompDefault = nil
	}
...
var _ genruntime.ARMTransformer = &NodeCustomizationProfile{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (profile *NodeCustomizationProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if profile == nil {
		return nil, nil
	}
	result := &arm.NodeCustomizationProfile{}

	// Set property "NodeCustomizationId":
	if profile.NodeCustomizationReference != nil {
		nodeCustomizationReferenceARMID, err := resolved.ResolvedReferences.Lookup(*profile.NodeCustomizationReference)
		if err != nil {
			return nil, err
		}
		nodeCustomizationReference := nodeCustomizationReferenceARMID
		result.NodeCustomizationId = &nodeCustomizationReference
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *NodeCustomizationProfile) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeCustomizationProfile{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *NodeCustomizationProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	_, ok := armInput.(arm.NodeCustomizationProfile)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeCustomizationProfile, got %T", armInput)
	}

	// no assignment for property "NodeCustomizationReference"

	// No error
	return nil
}

// AssignProperties_From_NodeCustomizationProfile populates our NodeCustomizationProfile from the provided source NodeCustomizationProfile
func (profile *NodeCustomizationProfile) AssignProperties_From_NodeCustomizationProfile(source *storage.NodeCustomizationProfile) error {

	// NodeCustomizationReference
	if source.NodeCustomizationReference != nil {
		nodeCustomizationReference := source.NodeCustomizationReference.Copy()
		profile.NodeCustomizationReference = &nodeCustomizationReference
	} else {
		profile.NodeCustomizationReference = nil
	}
...
// AssignProperties_To_NodeCustomizationProfile populates the provided destination NodeCustomizationProfile from our NodeCustomizationProfile
func (profile *NodeCustomizationProfile) AssignProperties_To_NodeCustomizationProfile(destination *storage.NodeCustomizationProfile) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// NodeCustomizationReference
	if profile.NodeCustomizationReference != nil {
		nodeCustomizationReference := profile.NodeCustomizationReference.Copy()
		destination.NodeCustomizationReference = &nodeCustomizationReference
	} else {
		destination.NodeCustomizationReference = nil
	}
...
var _ genruntime.FromARMConverter = &NodeCustomizationProfile_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (profile *NodeCustomizationProfile_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeCustomizationProfile_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (profile *NodeCustomizationProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NodeCustomizationProfile_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeCustomizationProfile_STATUS, got %T", armInput)
	}

	// Set property "NodeCustomizationId":
	if typedInput.NodeCustomizationId != nil {
		nodeCustomizationId := *typedInput.NodeCustomizationId
		profile.NodeCustomizationId = &nodeCustomizationId
	}
...
// AssignProperties_From_NodeCustomizationProfile_STATUS populates our NodeCustomizationProfile_STATUS from the provided source NodeCustomizationProfile_STATUS
func (profile *NodeCustomizationProfile_STATUS) AssignProperties_From_NodeCustomizationProfile_STATUS(source *storage.NodeCustomizationProfile_STATUS) error {

	// NodeCustomizationId
	profile.NodeCustomizationId = genruntime.ClonePointerToString(source.NodeCustomizationId)

	// No error
	return nil
}

// AssignProperties_To_NodeCustomizationProfile_STATUS populates the provided destination NodeCustomizationProfile_STATUS from our NodeCustomizationProfile_STATUS
func (profile *NodeCustomizationProfile_STATUS) AssignProperties_To_NodeCustomizationProfile_STATUS(destination *storage.NodeCustomizationProfile_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// NodeCustomizationId
	destination.NodeCustomizationId = genruntime.ClonePointerToString(profile.NodeCustomizationId)
...
func (profile *ScaleProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if profile.Autoscale != nil {
		autoscale_ARM, err := profile.Autoscale.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		autoscale := *autoscale_ARM.(*arm.AutoScaleProfile)
...
func (profile *ScaleProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Autoscale":
	if typedInput.Autoscale != nil {
		var autoscale1 AutoScaleProfile
		err := autoscale1.PopulateFromARM(owner, *typedInput.Autoscale)
		if err != nil {
			return err
		}
...
func (profile *ScaleProfile) AssignProperties_From_ScaleProfile(source *storage.ScaleProfile) error {
	...
	if source.Autoscale != nil {
		...
		err := autoscale.AssignProperties_From_AutoScaleProfile(source.Autoscale)
		if err != nil {
...
func (profile *ScaleProfile) AssignProperties_To_ScaleProfile(destination *storage.ScaleProfile) error {
	...
	if profile.Autoscale != nil {
		...
		err := profile.Autoscale.AssignProperties_To_AutoScaleProfile(&autoscale)
		if err != nil {
...
func (profile *ScaleProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Autoscale":
	if typedInput.Autoscale != nil {
		var autoscale1 AutoScaleProfile_STATUS
		err := autoscale1.PopulateFromARM(owner, *typedInput.Autoscale)
		if err != nil {
			return err
		}
...
func (profile *ScaleProfile_STATUS) AssignProperties_From_ScaleProfile_STATUS(source *storage.ScaleProfile_STATUS) error {
	...
	if source.Autoscale != nil {
		...
		err := autoscale.AssignProperties_From_AutoScaleProfile_STATUS(source.Autoscale)
		if err != nil {
...
func (profile *ScaleProfile_STATUS) AssignProperties_To_ScaleProfile_STATUS(destination *storage.ScaleProfile_STATUS) error {
	...
	if profile.Autoscale != nil {
		...
		err := profile.Autoscale.AssignProperties_To_AutoScaleProfile_STATUS(&autoscale)
		if err != nil {
