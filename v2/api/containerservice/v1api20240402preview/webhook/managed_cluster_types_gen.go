...
func (cluster *ManagedCluster) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20240402p.ManagedCluster)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240402preview/ManagedCluster, but got %T", obj)
	}
...
func (cluster *ManagedCluster) defaultAzureName(ctx context.Context, obj *v20240402p.ManagedCluster) error {
...
func (cluster *ManagedCluster) defaultImpl(ctx context.Context, obj *v20240402p.ManagedCluster) error {
...
func (cluster *ManagedCluster) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20240402p.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240402preview/ManagedCluster, but got %T", resource)
	}
	validations := cluster.createValidations()
	var temp any = cluster
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20240402p.ManagedCluster]); ok {
...
func (cluster *ManagedCluster) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20240402p.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240402preview/ManagedCluster, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20240402p.ManagedCluster)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/containerservice/v1api20240402preview/ManagedCluster, but got %T", oldResource)
	}
...
func (cluster *ManagedCluster) createValidations() []func(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error){
...
func (cluster *ManagedCluster) deleteValidations() []func(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (cluster *ManagedCluster) updateValidations() []func(ctx context.Context, oldObj *v20240402p.ManagedCluster, newObj *v20240402p.ManagedCluster) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20240402p.ManagedCluster, newObj *v20240402p.ManagedCluster) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20240402p.ManagedCluster, newObj *v20240402p.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateConfigMapDestinations(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateOptionalConfigMapReferences(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateOwnerReference(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (cluster *ManagedCluster) validateResourceReferences(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
...
func (cluster *ManagedCluster) validateSecretDestinations(ctx context.Context, obj *v20240402p.ManagedCluster) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (cluster *ManagedCluster) validateWriteOnceProperties(ctx context.Context, oldObj *v20240402p.ManagedCluster, newObj *v20240402p.ManagedCluster) (admission.Warnings, error) {
