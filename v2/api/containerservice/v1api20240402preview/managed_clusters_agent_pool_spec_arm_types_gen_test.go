...
func Test_AgentPoolGatewayProfile_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AgentPoolGatewayProfile_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAgentPoolGatewayProfile_ARM, AgentPoolGatewayProfile_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAgentPoolGatewayProfile_ARM runs a test to see if a specific instance of AgentPoolGatewayProfile_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForAgentPoolGatewayProfile_ARM(subject AgentPoolGatewayProfile_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual AgentPoolGatewayProfile_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of AgentPoolGatewayProfile_ARM instances for property testing - lazily instantiated by
// AgentPoolGatewayProfile_ARMGenerator()
var agentPoolGatewayProfile_ARMGenerator gopter.Gen

// AgentPoolGatewayProfile_ARMGenerator returns a generator of AgentPoolGatewayProfile_ARM instances for property testing.
func AgentPoolGatewayProfile_ARMGenerator() gopter.Gen {
	if agentPoolGatewayProfile_ARMGenerator != nil {
		return agentPoolGatewayProfile_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_ARM(generators)
	agentPoolGatewayProfile_ARMGenerator = gen.Struct(reflect.TypeOf(AgentPoolGatewayProfile_ARM{}), generators)

	return agentPoolGatewayProfile_ARMGenerator
}

// AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_ARM(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForManagedClusterAgentPoolProfileProperties_ARM(gens map[string]gopter.Gen) {
	...
	gens["GatewayProfile"] = gen.PtrOf(AgentPoolGatewayProfile_ARMGenerator())
...
func AddRelatedPropertyGeneratorsForScaleProfile_ARM(gens map[string]gopter.Gen) {
	gens["Autoscale"] = gen.SliceOf(AutoScaleProfile_ARMGenerator())
