...
func Test_AgentPoolGatewayProfile_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AgentPoolGatewayProfile_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAgentPoolGatewayProfile_STATUS_ARM, AgentPoolGatewayProfile_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAgentPoolGatewayProfile_STATUS_ARM runs a test to see if a specific instance of AgentPoolGatewayProfile_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForAgentPoolGatewayProfile_STATUS_ARM(subject AgentPoolGatewayProfile_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual AgentPoolGatewayProfile_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of AgentPoolGatewayProfile_STATUS_ARM instances for property testing - lazily instantiated by
// AgentPoolGatewayProfile_STATUS_ARMGenerator()
var agentPoolGatewayProfile_STATUS_ARMGenerator gopter.Gen

// AgentPoolGatewayProfile_STATUS_ARMGenerator returns a generator of AgentPoolGatewayProfile_STATUS_ARM instances for property testing.
func AgentPoolGatewayProfile_STATUS_ARMGenerator() gopter.Gen {
	if agentPoolGatewayProfile_STATUS_ARMGenerator != nil {
		return agentPoolGatewayProfile_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_STATUS_ARM(generators)
	agentPoolGatewayProfile_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(AgentPoolGatewayProfile_STATUS_ARM{}), generators)

	return agentPoolGatewayProfile_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAgentPoolGatewayProfile_STATUS_ARM(gens map[string]gopter.Gen) {
...
func AddIndependentPropertyGeneratorsForAgentPoolUpgradeSettings_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["UndrainableNodeBehavior"] = gen.PtrOf(gen.OneConstOf(AgentPoolUpgradeSettings_UndrainableNodeBehavior_STATUS_ARM_Cordon, AgentPoolUpgradeSettings_UndrainableNodeBehavior_STATUS_ARM_Schedule))
}
...
func AddRelatedPropertyGeneratorsForScaleProfile_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Autoscale"] = gen.SliceOf(AutoScaleProfile_STATUS_ARMGenerator())
