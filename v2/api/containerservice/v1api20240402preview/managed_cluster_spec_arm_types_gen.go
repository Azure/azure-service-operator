...
type ContainerServiceNetworkProfile_ARM struct {
	...
	PodLinkLocalAccess *PodLinkLocalAccess_ARM `json:"podLinkLocalAccess,omitempty"`
...
type ManagedClusterBootstrapProfile_ARM struct {
	...
	ArtifactSource      *ManagedClusterBootstrapProfile_ArtifactSource_ARM `json:"artifactSource,omitempty"`
...
const (
	ManagedClusterSKU_Name_ARM_Automatic = ManagedClusterSKU_Name_ARM("Automatic")
	ManagedClusterSKU_Name_ARM_Base      = ManagedClusterSKU_Name_ARM("Base")
)
...
var managedClusterSKU_Name_ARM_Values = map[string]ManagedClusterSKU_Name_ARM{
	"automatic": ManagedClusterSKU_Name_ARM_Automatic,
...
const (
	...
	ContainerServiceNetworkProfile_OutboundType_ARM_None                   = ContainerServiceNetworkProfile_OutboundType_ARM("none")
...
var containerServiceNetworkProfile_OutboundType_ARM_Values = map[string]ContainerServiceNetworkProfile_OutboundType_ARM{
	...
	"none":                   ContainerServiceNetworkProfile_OutboundType_ARM_None,
...
type ManagedClusterBootstrapProfile_ArtifactSource_ARM string

const (
	ManagedClusterBootstrapProfile_ArtifactSource_ARM_Cache  = ManagedClusterBootstrapProfile_ArtifactSource_ARM("Cache")
	ManagedClusterBootstrapProfile_ArtifactSource_ARM_Direct = ManagedClusterBootstrapProfile_ArtifactSource_ARM("Direct")
)

// Mapping from string to ManagedClusterBootstrapProfile_ArtifactSource_ARM
var managedClusterBootstrapProfile_ArtifactSource_ARM_Values = map[string]ManagedClusterBootstrapProfile_ArtifactSource_ARM{
	"cache":  ManagedClusterBootstrapProfile_ArtifactSource_ARM_Cache,
	"direct": ManagedClusterBootstrapProfile_ArtifactSource_ARM_Direct,
}
...
type ManagedClusterLoadBalancerProfile_ARM struct {
	...
	ClusterServiceLoadBalancerHealthProbeMode *ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM `json:"clusterServiceLoadBalancerHealthProbeMode,omitempty"`
...
type PodLinkLocalAccess_ARM string

const (
	PodLinkLocalAccess_ARM_IMDS = PodLinkLocalAccess_ARM("IMDS")
	PodLinkLocalAccess_ARM_None = PodLinkLocalAccess_ARM("None")
)

// Mapping from string to PodLinkLocalAccess_ARM
var podLinkLocalAccess_ARM_Values = map[string]PodLinkLocalAccess_ARM{
	"imds": PodLinkLocalAccess_ARM_IMDS,
	"none": PodLinkLocalAccess_ARM_None,
}
...
type ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM string

const (
	ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM_ServiceNodePort = ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM("ServiceNodePort")
	ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM_Shared          = ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM("Shared")
)

// Mapping from string to ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM
var managedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM_Values = map[string]ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM{
	"servicenodeport": ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM_ServiceNodePort,
	"shared":          ManagedClusterLoadBalancerProfile_ClusterServiceLoadBalancerHealthProbeMode_ARM_Shared,
}
