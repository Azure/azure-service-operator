...
type augmentConversionForManagedClustersAgentPool interface {
	AssignPropertiesFrom(src *v1api20230201s.ManagedClustersAgentPool) error
	AssignPropertiesTo(dst *v1api20230201s.ManagedClustersAgentPool) error
}
...
type augmentConversionForManagedClusters_AgentPool_Spec interface {
	AssignPropertiesFrom(src *v1api20230201s.ManagedClusters_AgentPool_Spec) error
	AssignPropertiesTo(dst *v1api20230201s.ManagedClusters_AgentPool_Spec) error
}

type augmentConversionForManagedClusters_AgentPool_STATUS interface {
	AssignPropertiesFrom(src *v1api20230201s.ManagedClusters_AgentPool_STATUS) error
	AssignPropertiesTo(dst *v1api20230201s.ManagedClusters_AgentPool_STATUS) error
}
...
type augmentConversionForAgentPoolUpgradeSettings interface {
	AssignPropertiesFrom(src *v1api20230201s.AgentPoolUpgradeSettings) error
	AssignPropertiesTo(dst *v1api20230201s.AgentPoolUpgradeSettings) error
}

type augmentConversionForAgentPoolUpgradeSettings_STATUS interface {
	AssignPropertiesFrom(src *v1api20230201s.AgentPoolUpgradeSettings_STATUS) error
	AssignPropertiesTo(dst *v1api20230201s.AgentPoolUpgradeSettings_STATUS) error
}

type augmentConversionForKubeletConfig interface {
	AssignPropertiesFrom(src *v1api20230201s.KubeletConfig) error
	AssignPropertiesTo(dst *v1api20230201s.KubeletConfig) error
}

type augmentConversionForKubeletConfig_STATUS interface {
	AssignPropertiesFrom(src *v1api20230201s.KubeletConfig_STATUS) error
	AssignPropertiesTo(dst *v1api20230201s.KubeletConfig_STATUS) error
}

type augmentConversionForLinuxOSConfig interface {
	AssignPropertiesFrom(src *v1api20230201s.LinuxOSConfig) error
	AssignPropertiesTo(dst *v1api20230201s.LinuxOSConfig) error
}

type augmentConversionForLinuxOSConfig_STATUS interface {
	AssignPropertiesFrom(src *v1api20230201s.LinuxOSConfig_STATUS) error
	AssignPropertiesTo(dst *v1api20230201s.LinuxOSConfig_STATUS) error
}

type augmentConversionForPowerState interface {
	AssignPropertiesFrom(src *v1api20230201s.PowerState) error
	AssignPropertiesTo(dst *v1api20230201s.PowerState) error
}
...
type augmentConversionForSysctlConfig interface {
	AssignPropertiesFrom(src *v1api20230201s.SysctlConfig) error
	AssignPropertiesTo(dst *v1api20230201s.SysctlConfig) error
}

type augmentConversionForSysctlConfig_STATUS interface {
	AssignPropertiesFrom(src *v1api20230201s.SysctlConfig_STATUS) error
	AssignPropertiesTo(dst *v1api20230201s.SysctlConfig_STATUS) error
}
