...
// +kubebuilder:rbac:groups=containerservice.azure.com,resources=managedclusterstrustedaccessrolebindings,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=containerservice.azure.com,resources={managedclusterstrustedaccessrolebindings/status,managedclusterstrustedaccessrolebindings/finalizers},verbs=get;update;patch
...
// Storage version of v1api20230202preview.ManagedClustersTrustedAccessRoleBinding
...
// Hub marks that this ManagedClustersTrustedAccessRoleBinding is the hub type for conversion
func (binding *ManagedClustersTrustedAccessRoleBinding) Hub() {}
