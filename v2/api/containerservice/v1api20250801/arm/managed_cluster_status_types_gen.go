...
type AdvancedNetworkingSecurity_STATUS struct {
	...
	AdvancedNetworkPolicies *AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS `json:"advancedNetworkPolicies,omitempty"`
...
type AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS string

const (
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_FQDN = AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS("FQDN")
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_L7   = AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS("L7")
	AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_None = AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS("None")
)

// Mapping from string to AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS
var advancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_Values = map[string]AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS{
	"fqdn": AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_FQDN,
	"l7":   AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_L7,
	"none": AdvancedNetworkingSecurity_AdvancedNetworkPolicies_STATUS_None,
}
