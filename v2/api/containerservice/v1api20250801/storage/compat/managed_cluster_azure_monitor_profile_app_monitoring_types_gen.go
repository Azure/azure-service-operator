...
type augmentConversionForManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentation interface {
	AssignPropertiesFrom(src *storage.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentation) error
	AssignPropertiesTo(dst *storage.ManagedClusterAzureMonitorProfileAppMonitoringAutoInstrumentation) error
}
