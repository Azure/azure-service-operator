...
func AddIndependentPropertyGeneratorsForManagedClusterAutoUpgradeProfile_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["NodeOSUpgradeChannel"] = gen.PtrOf(gen.OneConstOf(ManagedClusterAutoUpgradeProfile_NodeOSUpgradeChannel_STATUS_ARM_NodeImage, ManagedClusterAutoUpgradeProfile_NodeOSUpgradeChannel_STATUS_ARM_None, ManagedClusterAutoUpgradeProfile_NodeOSUpgradeChannel_STATUS_ARM_Unmanaged))
