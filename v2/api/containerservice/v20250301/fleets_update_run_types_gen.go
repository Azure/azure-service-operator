...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/containerservice/v20250301/arm"
...
func (updateRun *FleetsUpdateRun_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if updateRun.UpdateStrategyReference != nil {
		updateStrategyIdARMID, err := resolved.ResolvedReferences.Lookup(*updateRun.UpdateStrategyReference)
		if err != nil {
			return nil, err
		}
...
func (updateRun *FleetsUpdateRun_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "AutoUpgradeProfileId":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.AutoUpgradeProfileId != nil {
			autoUpgradeProfileId := *typedInput.Properties.AutoUpgradeProfileId
			updateRun.AutoUpgradeProfileId = &autoUpgradeProfileId
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.UpdateStrategyId != nil {
			...
			updateRun.UpdateStrategyId = &updateStrategyId
		}
	}
...
func (update *ManagedClusterUpdate) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if update.NodeImageSelection != nil {
		nodeImageSelection_ARM, err := update.NodeImageSelection.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		nodeImageSelection := *nodeImageSelection_ARM.(*arm.NodeImageSelection)
		result.NodeImageSelection = &nodeImageSelection
	}
...
func (update *ManagedClusterUpdate) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NodeImageSelection":
	if typedInput.NodeImageSelection != nil {
		var nodeImageSelection1 NodeImageSelection
		err := nodeImageSelection1.PopulateFromARM(owner, *typedInput.NodeImageSelection)
		if err != nil {
			return err
		}
...
func (update *ManagedClusterUpdate) Initialize_From_ManagedClusterUpdate_STATUS(source *ManagedClusterUpdate_STATUS) error {
	...
	if source.NodeImageSelection != nil {
		var nodeImageSelection NodeImageSelection
		err := nodeImageSelection.Initialize_From_NodeImageSelection_STATUS(source.NodeImageSelection)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NodeImageSelection_STATUS() to populate field NodeImageSelection")
		}
		update.NodeImageSelection = &nodeImageSelection
	} else {
		update.NodeImageSelection = nil
...
func (update *ManagedClusterUpdate_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NodeImageSelection":
	if typedInput.NodeImageSelection != nil {
		var nodeImageSelection1 NodeImageSelection_STATUS
		err := nodeImageSelection1.PopulateFromARM(owner, *typedInput.NodeImageSelection)
		if err != nil {
			return err
		}
...
func (status *UpdateRunStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "NodeImageSelection":
	if typedInput.NodeImageSelection != nil {
		var nodeImageSelection1 NodeImageSelectionStatus_STATUS
		err := nodeImageSelection1.PopulateFromARM(owner, *typedInput.NodeImageSelection)
		if err != nil {
			return err
		}
...
var _ genruntime.ARMTransformer = &NodeImageSelection{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (selection *NodeImageSelection) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if selection == nil {
		return nil, nil
	}
	result := &arm.NodeImageSelection{}

	// Set property "Type":
	if selection.Type != nil {
		var temp string
		temp = string(*selection.Type)
		typeVar := arm.NodeImageSelectionType(temp)
		result.Type = &typeVar
	}
	return result, nil
}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (selection *NodeImageSelection) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeImageSelection{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (selection *NodeImageSelection) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NodeImageSelection)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeImageSelection, got %T", armInput)
	}
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := NodeImageSelectionType(temp)
...
func (selection *NodeImageSelection) AssignProperties_From_NodeImageSelection(source *storage.NodeImageSelection) error {
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, nodeImageSelectionType_Values)
...
// Initialize_From_NodeImageSelection_STATUS populates our NodeImageSelection from the provided source NodeImageSelection_STATUS
func (selection *NodeImageSelection) Initialize_From_NodeImageSelection_STATUS(source *NodeImageSelection_STATUS) error {

	// Type
	if source.Type != nil {
		typeVar := genruntime.ToEnum(string(*source.Type), nodeImageSelectionType_Values)
		selection.Type = &typeVar
	} else {
		selection.Type = nil
	}
...
var _ genruntime.FromARMConverter = &NodeImageSelection_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (selection *NodeImageSelection_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeImageSelection_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (selection *NodeImageSelection_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NodeImageSelection_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeImageSelection_STATUS, got %T", armInput)
	}

	// Set property "CustomNodeImageVersions":
	for _, item := range typedInput.CustomNodeImageVersions {
		var item1 NodeImageVersion_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		selection.CustomNodeImageVersions = append(selection.CustomNodeImageVersions, item1)
	}
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := NodeImageSelectionType_STATUS(temp)
		selection.Type = &typeVar
	}
...
func (selection *NodeImageSelection_STATUS) AssignProperties_From_NodeImageSelection_STATUS(source *storage.NodeImageSelection_STATUS) error {
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, nodeImageSelectionType_STATUS_Values)
		selection.Type = &typeTemp
	} else {
		selection.Type = nil
	}
...
var _ genruntime.FromARMConverter = &NodeImageSelectionStatus_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *NodeImageSelectionStatus_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeImageSelectionStatus_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (status *NodeImageSelectionStatus_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NodeImageSelectionStatus_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeImageSelectionStatus_STATUS, got %T", armInput)
	}

	// Set property "SelectedNodeImageVersions":
	for _, item := range typedInput.SelectedNodeImageVersions {
		var item1 NodeImageVersion_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		status.SelectedNodeImageVersions = append(status.SelectedNodeImageVersions, item1)
	}
...
var _ genruntime.FromARMConverter = &NodeImageVersion_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (version *NodeImageVersion_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NodeImageVersion_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (version *NodeImageVersion_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NodeImageVersion_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NodeImageVersion_STATUS, got %T", armInput)
	}

	// Set property "Version":
	if typedInput.Version != nil {
		version1 := *typedInput.Version
