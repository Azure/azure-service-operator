...
func (in *ContainerGroup_Spec) DeepCopyInto(out *ContainerGroup_Spec) {
	*out = *in
	if in.Containers != nil {
		in, out := &in.Containers, &out.Containers
		*out = make([]ContainerGroup_Spec_Properties_Containers, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	...
	if in.ImageRegistryCredentials != nil {
		in, out := &in.ImageRegistryCredentials, &out.ImageRegistryCredentials
		*out = make([]ContainerGroup_Spec_Properties_ImageRegistryCredentials, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
	if in.InitContainers != nil {
		in, out := &in.InitContainers, &out.InitContainers
		*out = make([]ContainerGroup_Spec_Properties_InitContainers, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerGroup_Spec_Properties_Containers) DeepCopyInto(out *ContainerGroup_Spec_Properties_Containers) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerGroup_Spec_Properties_Containers.
func (in *ContainerGroup_Spec_Properties_Containers) DeepCopy() *ContainerGroup_Spec_Properties_Containers {
	if in == nil {
		return nil
	}
	out := new(ContainerGroup_Spec_Properties_Containers)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerGroup_Spec_Properties_ImageRegistryCredentials) DeepCopyInto(out *ContainerGroup_Spec_Properties_ImageRegistryCredentials) {
	*out = *in
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerGroup_Spec_Properties_ImageRegistryCredentials.
func (in *ContainerGroup_Spec_Properties_ImageRegistryCredentials) DeepCopy() *ContainerGroup_Spec_Properties_ImageRegistryCredentials {
	if in == nil {
		return nil
	}
	out := new(ContainerGroup_Spec_Properties_ImageRegistryCredentials)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerGroup_Spec_Properties_InitContainers) DeepCopyInto(out *ContainerGroup_Spec_Properties_InitContainers) {
	*out = *in
	if in.Command != nil {
		in, out := &in.Command, &out.Command
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerGroup_Spec_Properties_InitContainers.
func (in *ContainerGroup_Spec_Properties_InitContainers) DeepCopy() *ContainerGroup_Spec_Properties_InitContainers {
	if in == nil {
		return nil
	}
	out := new(ContainerGroup_Spec_Properties_InitContainers)
	in.DeepCopyInto(out)
	return out
}
