...
func (in *ContainerGroups_Spec) DeepCopyInto(out *ContainerGroups_Spec) {
	*out = *in
	...
	if in.ImageRegistryCredentials != nil {
		in, out := &in.ImageRegistryCredentials, &out.ImageRegistryCredentials
		*out = make([]ContainerGroups_Spec_Properties_ImageRegistryCredentials, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerGroups_Spec_Properties_ImageRegistryCredentials) DeepCopyInto(out *ContainerGroups_Spec_Properties_ImageRegistryCredentials) {
	*out = *in
	if in.Identity != nil {
		in, out := &in.Identity, &out.Identity
		*out = new(string)
...
func (in *ContainerGroups_Spec_Properties_ImageRegistryCredentials) DeepCopy() *ContainerGroups_Spec_Properties_ImageRegistryCredentials {
	if in == nil {
		return nil
	}
	out := new(ContainerGroups_Spec_Properties_ImageRegistryCredentials)
	in.DeepCopyInto(out)
	return out
}
