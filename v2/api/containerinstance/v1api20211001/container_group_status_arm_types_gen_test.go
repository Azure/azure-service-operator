...
func AddIndependentPropertyGeneratorsForContainerGroupIdentity_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(
		ContainerGroupIdentity_Type_STATUS_ARM_None,
		ContainerGroupIdentity_Type_STATUS_ARM_SystemAssigned,
		ContainerGroupIdentity_Type_STATUS_ARM_SystemAssignedUserAssigned,
		ContainerGroupIdentity_Type_STATUS_ARM_UserAssigned))
}
...
func AddIndependentPropertyGeneratorsForContainerGroup_Properties_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["OsType"] = gen.PtrOf(gen.OneConstOf(ContainerGroup_Properties_OsType_STATUS_ARM_Linux, ContainerGroup_Properties_OsType_STATUS_ARM_Windows))
	gens["ProvisioningState"] = gen.PtrOf(gen.AlphaString())
	gens["RestartPolicy"] = gen.PtrOf(gen.OneConstOf(ContainerGroup_Properties_RestartPolicy_STATUS_ARM_Always, ContainerGroup_Properties_RestartPolicy_STATUS_ARM_Never, ContainerGroup_Properties_RestartPolicy_STATUS_ARM_OnFailure))
	gens["Sku"] = gen.PtrOf(gen.OneConstOf(ContainerGroupSku_STATUS_ARM_Dedicated, ContainerGroupSku_STATUS_ARM_Standard))
}
...
func AddIndependentPropertyGeneratorsForContainerHttpGet_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Scheme"] = gen.PtrOf(gen.OneConstOf(ContainerHttpGet_Scheme_STATUS_ARM_Http, ContainerHttpGet_Scheme_STATUS_ARM_Https))
}
...
func AddIndependentPropertyGeneratorsForContainerPort_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Port"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(ContainerPort_Protocol_STATUS_ARM_TCP, ContainerPort_Protocol_STATUS_ARM_UDP))
}
...
func AddIndependentPropertyGeneratorsForGpuResource_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Count"] = gen.PtrOf(gen.Int())
	gens["Sku"] = gen.PtrOf(gen.OneConstOf(GpuResource_Sku_STATUS_ARM_K80, GpuResource_Sku_STATUS_ARM_P100, GpuResource_Sku_STATUS_ARM_V100))
}
...
func AddIndependentPropertyGeneratorsForIpAddress_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["AutoGeneratedDomainNameLabelScope"] = gen.PtrOf(gen.OneConstOf(
		IpAddress_AutoGeneratedDomainNameLabelScope_STATUS_ARM_Noreuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_STATUS_ARM_ResourceGroupReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_STATUS_ARM_SubscriptionReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_STATUS_ARM_TenantReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_STATUS_ARM_Unsecure))
	gens["DnsNameLabel"] = gen.PtrOf(gen.AlphaString())
	gens["Fqdn"] = gen.PtrOf(gen.AlphaString())
	gens["Ip"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(IpAddress_Type_STATUS_ARM_Private, IpAddress_Type_STATUS_ARM_Public))
}
...
func AddIndependentPropertyGeneratorsForLogAnalytics_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["LogType"] = gen.PtrOf(gen.OneConstOf(LogAnalytics_LogType_STATUS_ARM_ContainerInsights, LogAnalytics_LogType_STATUS_ARM_ContainerInstanceLogs))
...
func AddIndependentPropertyGeneratorsForPort_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Port"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(Port_Protocol_STATUS_ARM_TCP, Port_Protocol_STATUS_ARM_UDP))
}
...
func Test_UserAssignedIdentities_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of UserAssignedIdentities_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForUserAssignedIdentities_STATUS_ARM, UserAssignedIdentities_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForUserAssignedIdentities_STATUS_ARM runs a test to see if a specific instance of UserAssignedIdentities_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForUserAssignedIdentities_STATUS_ARM(subject UserAssignedIdentities_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual UserAssignedIdentities_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of UserAssignedIdentities_STATUS_ARM instances for property testing - lazily instantiated by
// UserAssignedIdentities_STATUS_ARMGenerator()
var userAssignedIdentities_STATUS_ARMGenerator gopter.Gen

// UserAssignedIdentities_STATUS_ARMGenerator returns a generator of UserAssignedIdentities_STATUS_ARM instances for property testing.
func UserAssignedIdentities_STATUS_ARMGenerator() gopter.Gen {
	if userAssignedIdentities_STATUS_ARMGenerator != nil {
		return userAssignedIdentities_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForUserAssignedIdentities_STATUS_ARM(generators)
	userAssignedIdentities_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(UserAssignedIdentities_STATUS_ARM{}), generators)

	return userAssignedIdentities_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForUserAssignedIdentities_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForUserAssignedIdentities_STATUS_ARM(gens map[string]gopter.Gen) {
