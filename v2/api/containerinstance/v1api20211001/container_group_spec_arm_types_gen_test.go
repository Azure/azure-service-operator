...
func AddIndependentPropertyGeneratorsForContainerGroupIdentity_ARM(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(
		ContainerGroupIdentity_Type_ARM_None,
		ContainerGroupIdentity_Type_ARM_SystemAssigned,
		ContainerGroupIdentity_Type_ARM_SystemAssignedUserAssigned,
		ContainerGroupIdentity_Type_ARM_UserAssigned))
}
...
func AddIndependentPropertyGeneratorsForContainerGroup_Properties_Spec_ARM(gens map[string]gopter.Gen) {
	gens["OsType"] = gen.PtrOf(gen.OneConstOf(ContainerGroup_Properties_OsType_Spec_ARM_Linux, ContainerGroup_Properties_OsType_Spec_ARM_Windows))
	gens["RestartPolicy"] = gen.PtrOf(gen.OneConstOf(ContainerGroup_Properties_RestartPolicy_Spec_ARM_Always, ContainerGroup_Properties_RestartPolicy_Spec_ARM_Never, ContainerGroup_Properties_RestartPolicy_Spec_ARM_OnFailure))
	gens["Sku"] = gen.PtrOf(gen.OneConstOf(ContainerGroupSku_ARM_Dedicated, ContainerGroupSku_ARM_Standard))
}
...
func AddIndependentPropertyGeneratorsForContainerHttpGet_ARM(gens map[string]gopter.Gen) {
	...
	gens["Scheme"] = gen.PtrOf(gen.OneConstOf(ContainerHttpGet_Scheme_ARM_Http, ContainerHttpGet_Scheme_ARM_Https))
}
...
func AddIndependentPropertyGeneratorsForContainerPort_ARM(gens map[string]gopter.Gen) {
	gens["Port"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(ContainerPort_Protocol_ARM_TCP, ContainerPort_Protocol_ARM_UDP))
}
...
func AddIndependentPropertyGeneratorsForGpuResource_ARM(gens map[string]gopter.Gen) {
	...
	gens["Sku"] = gen.PtrOf(gen.OneConstOf(GpuResource_Sku_ARM_K80, GpuResource_Sku_ARM_P100, GpuResource_Sku_ARM_V100))
}
...
func AddIndependentPropertyGeneratorsForIpAddress_ARM(gens map[string]gopter.Gen) {
	gens["AutoGeneratedDomainNameLabelScope"] = gen.PtrOf(gen.OneConstOf(
		IpAddress_AutoGeneratedDomainNameLabelScope_ARM_Noreuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_ARM_ResourceGroupReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_ARM_SubscriptionReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_ARM_TenantReuse,
		IpAddress_AutoGeneratedDomainNameLabelScope_ARM_Unsecure))
	gens["DnsNameLabel"] = gen.PtrOf(gen.AlphaString())
	gens["Ip"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(IpAddress_Type_ARM_Private, IpAddress_Type_ARM_Public))
}
...
func AddIndependentPropertyGeneratorsForLogAnalytics_ARM(gens map[string]gopter.Gen) {
	gens["LogType"] = gen.PtrOf(gen.OneConstOf(LogAnalytics_LogType_ARM_ContainerInsights, LogAnalytics_LogType_ARM_ContainerInstanceLogs))
...
func AddIndependentPropertyGeneratorsForPort_ARM(gens map[string]gopter.Gen) {
	gens["Port"] = gen.PtrOf(gen.Int())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(Port_Protocol_ARM_TCP, Port_Protocol_ARM_UDP))
}
