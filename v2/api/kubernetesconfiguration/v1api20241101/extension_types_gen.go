...
// +kubebuilder:webhook:path=/mutate-kubernetesconfiguration-azure-com-v1api20241101-extension,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=kubernetesconfiguration.azure.com,resources=extensions,verbs=create;update,versions=v1api20241101,name=default.v1api20241101.extensions.kubernetesconfiguration.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-kubernetesconfiguration-azure-com-v1api20241101-extension,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=kubernetesconfiguration.azure.com,resources=extensions,verbs=create;update,versions=v1api20241101,name=validate.v1api20241101.extensions.kubernetesconfiguration.azure.com,admissionReviewVersions=v1
