...
func ExtensionPropertiesAksAssignedIdentity_STATUSGenerator() *rapid.Generator[ExtensionPropertiesAksAssignedIdentity_STATUS] {
	...
	ptrString := rapid.Ptr(rapid.String(), true)
	typeVar := rapid.Ptr(rapid.SampledFrom([]AKSIdentityType_STATUS{AKSIdentityType_STATUS_SystemAssigned, AKSIdentityType_STATUS_UserAssigned}), true)
...
func Test_ExtensionProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	rapid.Check(t, RunJSONSerializationTestForExtensionProperties_STATUS)
}
...
func RunJSONSerializationTestForExtensionProperties_STATUS(t *rapid.T) {
	subject := ExtensionProperties_STATUSGenerator().Draw(t, "subject")
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		t.Fatal(err)
...
var extensionProperties_STATUSGenerator *rapid.Generator[ExtensionProperties_STATUS]

// ExtensionProperties_STATUSGenerator returns a generator of ExtensionProperties_STATUS instances for property testing.
func ExtensionProperties_STATUSGenerator() *rapid.Generator[ExtensionProperties_STATUS] {
	...
	extensionProperties_STATUSGenerator = rapid.Custom(func(t *rapid.T) ExtensionProperties_STATUS {
		var result ExtensionProperties_STATUS
...
func Extension_STATUSGenerator() *rapid.Generator[Extension_STATUS] {
	...
	properties := rapid.Ptr(ExtensionProperties_STATUSGenerator(), true)
