...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExtensionStatus_ARM) DeepCopyInto(out *ExtensionStatus_ARM) {
	*out = *in
	if in.Code != nil {
		in, out := &in.Code, &out.Code
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExtensionStatus_ARM.
func (in *ExtensionStatus_ARM) DeepCopy() *ExtensionStatus_ARM {
	if in == nil {
		return nil
	}
	out := new(ExtensionStatus_ARM)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Extension_Properties_Spec_ARM) DeepCopyInto(out *Extension_Properties_Spec_ARM) {
	*out = *in
	...
	if in.Statuses != nil {
		in, out := &in.Statuses, &out.Statuses
		*out = make([]ExtensionStatus_ARM, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
