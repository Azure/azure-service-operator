...
func (extension *Extension) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20221101s.Extension)
	if !ok {
		return fmt.Errorf("expected kubernetesconfiguration/v1api20221101/storage/Extension but received %T instead", hub)
	}
...
func (extension *Extension) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20221101s.Extension)
	if !ok {
		return fmt.Errorf("expected kubernetesconfiguration/v1api20221101/storage/Extension but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-kubernetesconfiguration-azure-com-v1api20221101-extension,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=kubernetesconfiguration.azure.com,resources=extensions,verbs=create;update,versions=v1api20221101,name=default.v1api20221101.extensions.kubernetesconfiguration.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-kubernetesconfiguration-azure-com-v1api20221101-extension,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=kubernetesconfiguration.azure.com,resources=extensions,verbs=create;update,versions=v1api20221101,name=validate.v1api20221101.extensions.kubernetesconfiguration.azure.com,admissionReviewVersions=v1
...
func (extension *Extension) AssignProperties_From_Extension(source *v20221101s.Extension) error {
...
func (extension *Extension) AssignProperties_To_Extension(destination *v20221101s.Extension) error {

	// ObjectMeta
	destination.ObjectMeta = *extension.ObjectMeta.DeepCopy()

	// Spec
	var spec v20221101s.Extension_Spec
	...
	// Status
	var status v20221101s.Extension_STATUS
...
func (extension *Extension_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20221101s.Extension_Spec)
	if ok {
...
func (extension *Extension_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20221101s.Extension_Spec)
	if ok {
...
func (extension *Extension_Spec) AssignProperties_From_Extension_Spec(source *v20221101s.Extension_Spec) error {
...
func (extension *Extension_Spec) AssignProperties_To_Extension_Spec(destination *v20221101s.Extension_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AksAssignedIdentity
	if extension.AksAssignedIdentity != nil {
		var aksAssignedIdentity v20221101s.Extension_Properties_AksAssignedIdentity_Spec
	...
	// Identity
	if extension.Identity != nil {
		var identity v20221101s.Identity
	...
	if extension.Statuses != nil {
		statusList := make([]v20221101s.ExtensionStatus, len(extension.Statuses))
		for statusIndex, statusItem := range extension.Statuses {
			// Shadow the loop variable to avoid aliasing
			statusItem := statusItem
			var status v20221101s.ExtensionStatus
	...
	// SystemData
	if extension.SystemData != nil {
		var systemDatum v20221101s.SystemData
...
func (extension *Extension_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20221101s.Extension_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20221101s.Extension_STATUS{}
...
func (extension *Extension_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20221101s.Extension_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20221101s.Extension_STATUS{}
...
func (extension *Extension_STATUS) AssignProperties_From_Extension_STATUS(source *v20221101s.Extension_STATUS) error {
...
func (extension *Extension_STATUS) AssignProperties_To_Extension_STATUS(destination *v20221101s.Extension_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AksAssignedIdentity
	if extension.AksAssignedIdentity != nil {
		var aksAssignedIdentity v20221101s.Extension_Properties_AksAssignedIdentity_STATUS
	...
	if extension.ErrorInfo != nil {
		var errorInfo v20221101s.ErrorDetail_STATUS
	...
	// Identity
	if extension.Identity != nil {
		var identity v20221101s.Identity_STATUS
	...
	// Plan
	if extension.Plan != nil {
		var plan v20221101s.Plan_STATUS
	...
	// Scope
	if extension.Scope != nil {
		var scope v20221101s.Scope_STATUS
	...
	// Statuses
	if extension.Statuses != nil {
		statusList := make([]v20221101s.ExtensionStatus_STATUS, len(extension.Statuses))
		for statusIndex, statusItem := range extension.Statuses {
			// Shadow the loop variable to avoid aliasing
			statusItem := statusItem
			var status v20221101s.ExtensionStatus_STATUS
	...
	// SystemData
	if extension.SystemData != nil {
		var systemDatum v20221101s.SystemData_STATUS
...
func (detail *ErrorDetail_STATUS) AssignProperties_From_ErrorDetail_STATUS(source *v20221101s.ErrorDetail_STATUS) error {
...
func (detail *ErrorDetail_STATUS) AssignProperties_To_ErrorDetail_STATUS(destination *v20221101s.ErrorDetail_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AdditionalInfo
	if detail.AdditionalInfo != nil {
		additionalInfoList := make([]v20221101s.ErrorAdditionalInfo_STATUS, len(detail.AdditionalInfo))
		for additionalInfoIndex, additionalInfoItem := range detail.AdditionalInfo {
			// Shadow the loop variable to avoid aliasing
			additionalInfoItem := additionalInfoItem
			var additionalInfo v20221101s.ErrorAdditionalInfo_STATUS
	...
	if detail.Details != nil {
		detailList := make([]v20221101s.ErrorDetail_STATUS_Unrolled, len(detail.Details))
		for detailIndex, detailItem := range detail.Details {
			// Shadow the loop variable to avoid aliasing
			detailItem := detailItem
			var detailLocal v20221101s.ErrorDetail_STATUS_Unrolled
...
func (identity *Extension_Properties_AksAssignedIdentity_Spec) AssignProperties_From_Extension_Properties_AksAssignedIdentity_Spec(source *v20221101s.Extension_Properties_AksAssignedIdentity_Spec) error {
...
func (identity *Extension_Properties_AksAssignedIdentity_Spec) AssignProperties_To_Extension_Properties_AksAssignedIdentity_Spec(destination *v20221101s.Extension_Properties_AksAssignedIdentity_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *Extension_Properties_AksAssignedIdentity_STATUS) AssignProperties_From_Extension_Properties_AksAssignedIdentity_STATUS(source *v20221101s.Extension_Properties_AksAssignedIdentity_STATUS) error {
...
func (identity *Extension_Properties_AksAssignedIdentity_STATUS) AssignProperties_To_Extension_Properties_AksAssignedIdentity_STATUS(destination *v20221101s.Extension_Properties_AksAssignedIdentity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (status *ExtensionStatus) AssignProperties_From_ExtensionStatus(source *v20221101s.ExtensionStatus) error {
...
func (status *ExtensionStatus) AssignProperties_To_ExtensionStatus(destination *v20221101s.ExtensionStatus) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (status *ExtensionStatus_STATUS) AssignProperties_From_ExtensionStatus_STATUS(source *v20221101s.ExtensionStatus_STATUS) error {
...
func (status *ExtensionStatus_STATUS) AssignProperties_To_ExtensionStatus_STATUS(destination *v20221101s.ExtensionStatus_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *Identity) AssignProperties_From_Identity(source *v20221101s.Identity) error {
...
func (identity *Identity) AssignProperties_To_Identity(destination *v20221101s.Identity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v20221101s.Identity_STATUS) error {
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v20221101s.Identity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (plan *Plan) AssignProperties_From_Plan(source *v20221101s.Plan) error {
...
func (plan *Plan) AssignProperties_To_Plan(destination *v20221101s.Plan) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (plan *Plan_STATUS) AssignProperties_From_Plan_STATUS(source *v20221101s.Plan_STATUS) error {
...
func (plan *Plan_STATUS) AssignProperties_To_Plan_STATUS(destination *v20221101s.Plan_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (scope *Scope) AssignProperties_From_Scope(source *v20221101s.Scope) error {
...
func (scope *Scope) AssignProperties_To_Scope(destination *v20221101s.Scope) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Cluster
	if scope.Cluster != nil {
		var cluster v20221101s.ScopeCluster
	...
	// Namespace
	if scope.Namespace != nil {
		var namespace v20221101s.ScopeNamespace
...
func (scope *Scope_STATUS) AssignProperties_From_Scope_STATUS(source *v20221101s.Scope_STATUS) error {
...
func (scope *Scope_STATUS) AssignProperties_To_Scope_STATUS(destination *v20221101s.Scope_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Cluster
	if scope.Cluster != nil {
		var cluster v20221101s.ScopeCluster_STATUS
	...
	// Namespace
	if scope.Namespace != nil {
		var namespace v20221101s.ScopeNamespace_STATUS
...
func (data *SystemData) AssignProperties_From_SystemData(source *v20221101s.SystemData) error {
...
func (data *SystemData) AssignProperties_To_SystemData(destination *v20221101s.SystemData) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20221101s.SystemData_STATUS) error {
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20221101s.SystemData_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (info *ErrorAdditionalInfo_STATUS) AssignProperties_From_ErrorAdditionalInfo_STATUS(source *v20221101s.ErrorAdditionalInfo_STATUS) error {
...
func (info *ErrorAdditionalInfo_STATUS) AssignProperties_To_ErrorAdditionalInfo_STATUS(destination *v20221101s.ErrorAdditionalInfo_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (unrolled *ErrorDetail_STATUS_Unrolled) AssignProperties_From_ErrorDetail_STATUS_Unrolled(source *v20221101s.ErrorDetail_STATUS_Unrolled) error {
...
func (unrolled *ErrorDetail_STATUS_Unrolled) AssignProperties_To_ErrorDetail_STATUS_Unrolled(destination *v20221101s.ErrorDetail_STATUS_Unrolled) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AdditionalInfo
	if unrolled.AdditionalInfo != nil {
		additionalInfoList := make([]v20221101s.ErrorAdditionalInfo_STATUS, len(unrolled.AdditionalInfo))
...
func (cluster *ScopeCluster) AssignProperties_From_ScopeCluster(source *v20221101s.ScopeCluster) error {
...
func (cluster *ScopeCluster) AssignProperties_To_ScopeCluster(destination *v20221101s.ScopeCluster) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (cluster *ScopeCluster_STATUS) AssignProperties_From_ScopeCluster_STATUS(source *v20221101s.ScopeCluster_STATUS) error {
...
func (cluster *ScopeCluster_STATUS) AssignProperties_To_ScopeCluster_STATUS(destination *v20221101s.ScopeCluster_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (namespace *ScopeNamespace) AssignProperties_From_ScopeNamespace(source *v20221101s.ScopeNamespace) error {
...
func (namespace *ScopeNamespace) AssignProperties_To_ScopeNamespace(destination *v20221101s.ScopeNamespace) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (namespace *ScopeNamespace_STATUS) AssignProperties_From_ScopeNamespace_STATUS(source *v20221101s.ScopeNamespace_STATUS) error {
...
func (namespace *ScopeNamespace_STATUS) AssignProperties_To_ScopeNamespace_STATUS(destination *v20221101s.ScopeNamespace_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
