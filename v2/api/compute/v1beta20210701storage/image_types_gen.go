...
type augmentConversionForImage interface {
	AssignPropertiesFrom(src *v1beta20220301s.Image) error
	AssignPropertiesTo(dst *v1beta20220301s.Image) error
}
...
type augmentConversionForImage_Spec interface {
	AssignPropertiesFrom(src *v1beta20220301s.Image_Spec) error
	AssignPropertiesTo(dst *v1beta20220301s.Image_Spec) error
}

type augmentConversionForImage_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.Image_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.Image_STATUS) error
}
...
type augmentConversionForExtendedLocation interface {
	AssignPropertiesFrom(src *v1beta20220301s.ExtendedLocation) error
	AssignPropertiesTo(dst *v1beta20220301s.ExtendedLocation) error
}

type augmentConversionForExtendedLocation_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.ExtendedLocation_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.ExtendedLocation_STATUS) error
}

type augmentConversionForImageStorageProfile interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageStorageProfile) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageStorageProfile) error
}

type augmentConversionForImageStorageProfile_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageStorageProfile_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageStorageProfile_STATUS) error
}

type augmentConversionForSubResource interface {
	AssignPropertiesFrom(src *v1beta20220301s.SubResource) error
	AssignPropertiesTo(dst *v1beta20220301s.SubResource) error
}

type augmentConversionForSubResource_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.SubResource_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.SubResource_STATUS) error
}
...
type augmentConversionForImageDataDisk interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageDataDisk) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageDataDisk) error
}

type augmentConversionForImageDataDisk_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageDataDisk_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageDataDisk_STATUS) error
}

type augmentConversionForImageOSDisk interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageOSDisk) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageOSDisk) error
}

type augmentConversionForImageOSDisk_STATUS interface {
	AssignPropertiesFrom(src *v1beta20220301s.ImageOSDisk_STATUS) error
	AssignPropertiesTo(dst *v1beta20220301s.ImageOSDisk_STATUS) error
}
