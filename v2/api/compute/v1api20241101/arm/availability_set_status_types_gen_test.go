...
func Test_AvailabilitySetProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of AvailabilitySetProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAvailabilitySetProperties_STATUS, AvailabilitySetProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAvailabilitySetProperties_STATUS runs a test to see if a specific instance of AvailabilitySetProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForAvailabilitySetProperties_STATUS(subject AvailabilitySetProperties_STATUS) string {
	// Serialize to JSON
	...
	var actual AvailabilitySetProperties_STATUS
...
// Generator of AvailabilitySetProperties_STATUS instances for property testing - lazily instantiated by
// AvailabilitySetProperties_STATUSGenerator()
var availabilitySetProperties_STATUSGenerator gopter.Gen

// AvailabilitySetProperties_STATUSGenerator returns a generator of AvailabilitySetProperties_STATUS instances for property testing.
// We first initialize availabilitySetProperties_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AvailabilitySetProperties_STATUSGenerator() gopter.Gen {
	if availabilitySetProperties_STATUSGenerator != nil {
		return availabilitySetProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAvailabilitySetProperties_STATUS(generators)
	availabilitySetProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(AvailabilitySetProperties_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAvailabilitySetProperties_STATUS(generators)
	AddRelatedPropertyGeneratorsForAvailabilitySetProperties_STATUS(generators)
	availabilitySetProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(AvailabilitySetProperties_STATUS{}), generators)

	return availabilitySetProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForAvailabilitySetProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForAvailabilitySetProperties_STATUS(gens map[string]gopter.Gen) {
	gens["PlatformFaultDomainCount"] = gen.PtrOf(gen.Int())
	gens["PlatformUpdateDomainCount"] = gen.PtrOf(gen.Int())
}

// AddRelatedPropertyGeneratorsForAvailabilitySetProperties_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAvailabilitySetProperties_STATUS(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForAvailabilitySet_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(AvailabilitySetProperties_STATUSGenerator())
