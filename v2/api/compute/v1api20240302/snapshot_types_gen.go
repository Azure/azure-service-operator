...
func (snapshot *Snapshot_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if snapshot.CopyCompletionError != nil {
		...
		copyCompletionError := *copyCompletionError_ARM.(*CopyCompletionError_ARM)
...
func (snapshot *Snapshot_Spec) AssignProperties_From_Snapshot_Spec(source *storage.Snapshot_Spec) error {
	...
	if source.CopyCompletionError != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_From_CopyCompletionError() to populate field CopyCompletionError")
		}
		snapshot.CopyCompletionError = &copyCompletionError
	} else {
		snapshot.CopyCompletionError = nil
...
func (snapshot *Snapshot_Spec) AssignProperties_To_Snapshot_Spec(destination *storage.Snapshot_Spec) error {
	...
	if snapshot.CopyCompletionError != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_To_CopyCompletionError() to populate field CopyCompletionError")
		}
...
func (snapshot *Snapshot_Spec) Initialize_From_Snapshot_STATUS(source *Snapshot_STATUS) error {
	...
	if source.CopyCompletionError != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling Initialize_From_CopyCompletionError_STATUS() to populate field CopyCompletionError")
		}
		snapshot.CopyCompletionError = &copyCompletionError
	} else {
		snapshot.CopyCompletionError = nil
...
func (snapshot *Snapshot_STATUS) AssignProperties_From_Snapshot_STATUS(source *storage.Snapshot_STATUS) error {
	...
	if source.CopyCompletionError != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_From_CopyCompletionError_STATUS() to populate field CopyCompletionError")
		}
		snapshot.CopyCompletionError = &copyCompletionError
	} else {
		snapshot.CopyCompletionError = nil
...
func (snapshot *Snapshot_STATUS) AssignProperties_To_Snapshot_STATUS(destination *storage.Snapshot_STATUS) error {
	...
	if snapshot.CopyCompletionError != nil {
		...
		if err != nil {
			return errors.Wrap(err, "calling AssignProperties_To_CopyCompletionError_STATUS() to populate field CopyCompletionError")
		}
		destination.CopyCompletionError = &copyCompletionError
	} else {
		destination.CopyCompletionError = nil
...
func (error *CopyCompletionError) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &CopyCompletionError_ARM{}
...
func (error *CopyCompletionError) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &CopyCompletionError_ARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (error *CopyCompletionError) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(CopyCompletionError_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected CopyCompletionError_ARM, got %T", armInput)
	}
...
func (error *CopyCompletionError_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &CopyCompletionError_STATUS_ARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (error *CopyCompletionError_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(CopyCompletionError_STATUS_ARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected CopyCompletionError_STATUS_ARM, got %T", armInput)
	}
