...
func Test_VirtualMachine_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/compute/v1beta20220301/virtual_machine__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/compute/v1beta20220301/virtual_machines_spec_arm_types_gen_test.go
	// Serialize to JSON
