...
>>>>>>>> main:v2/api/compute/v1beta20220301/virtual_machine_scale_sets_spec_arm_types_gen_test.go
	// Serialize to JSON
...
// We first initialize virtualMachineScaleSets_Spec_Properties_VirtualMachineProfile_NetworkProfileARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func VirtualMachineScaleSets_Spec_Properties_VirtualMachineProfile_NetworkProfileARMGenerator() gopter.Gen {
	...
	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVirtualMachineScaleSets_Spec_Properties_VirtualMachineProfile_NetworkProfileARM(generators)
...
// AddIndependentPropertyGeneratorsForVirtualMachineScaleSets_Spec_Properties_VirtualMachineProfile_NetworkProfileARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVirtualMachineScaleSets_Spec_Properties_VirtualMachineProfile_NetworkProfileARM(gens map[string]gopter.Gen) {
