...
func Test_Image_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/compute/v1beta20220301/image__spec_arm_types_gen_test.go
...
========
		...
		prop.ForAll(RunJSONSerializationTestForImages_SpecARM, Images_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForImages_SpecARM runs a test to see if a specific instance of Images_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForImages_SpecARM(subject Images_SpecARM) string {
>>>>>>>> main:v2/api/compute/v1beta20220301/images_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
// Generator of Images_SpecARM instances for property testing - lazily instantiated by Images_SpecARMGenerator()
var images_SpecARMGenerator gopter.Gen

// Images_SpecARMGenerator returns a generator of Images_SpecARM instances for property testing.
// We first initialize images_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Images_SpecARMGenerator() gopter.Gen {
	if images_SpecARMGenerator != nil {
		return images_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImages_SpecARM(generators)
	images_SpecARMGenerator = gen.Struct(reflect.TypeOf(Images_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImages_SpecARM(generators)
	AddRelatedPropertyGeneratorsForImages_SpecARM(generators)
	images_SpecARMGenerator = gen.Struct(reflect.TypeOf(Images_SpecARM{}), generators)

	return images_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForImages_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForImages_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/compute/v1beta20220301/images_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForImages_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForImages_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/compute/v1beta20220301/images_spec_arm_types_gen_test.go
