...
// RunPropertyAssignmentTestForSnapshots_Spec tests if a specific instance of Snapshots_Spec can be assigned to v1alpha1api20200930storage and back losslessly
