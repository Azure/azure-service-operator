...
const (
	DiskSkuNamePremium_LRS     = DiskSkuName("Premium_LRS")
	DiskSkuNameStandardSSD_LRS = DiskSkuName("StandardSSD_LRS")
	DiskSkuNameStandard_LRS    = DiskSkuName("Standard_LRS")
	DiskSkuNameUltraSSD_LRS    = DiskSkuName("UltraSSD_LRS")
)
