...
func Test_Snapshot_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/compute/v1alpha1api20200930/snapshot__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/compute/v1alpha1api20200930/snapshots_spec_arm_types_gen_test.go
	// Serialize to JSON
