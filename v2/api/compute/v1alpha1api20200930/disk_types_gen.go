...
func (disk *Disk_Spec) AssignProperties_From_Disk_Spec(source *alpha20200930s.Disk_Spec) error {
...
func (disk *Disk_Spec) AssignProperties_To_Disk_Spec(destination *alpha20200930s.Disk_Spec) error {
