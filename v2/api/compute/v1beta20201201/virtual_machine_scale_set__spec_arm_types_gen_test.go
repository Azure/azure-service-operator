...
<<<<<<< HEAD:v2/api/compute/v1beta20201201/virtual_machine_scale_set__spec_arm_types_gen_test.go
...
>>>>>>> main:v2/api/compute/v1beta20201201/virtual_machine_scale_sets__spec_arm_types_gen_test.go
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
