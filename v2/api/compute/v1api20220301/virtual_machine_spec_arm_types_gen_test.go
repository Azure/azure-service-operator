...
func AddIndependentPropertyGeneratorsForDataDisk_ARM(gens map[string]gopter.Gen) {
	...
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(DeleteOption_ARM_Delete, DeleteOption_ARM_Detach))
...
func AddIndependentPropertyGeneratorsForLinuxPatchSettings_ARM(gens map[string]gopter.Gen) {
	gens["AssessmentMode"] = gen.PtrOf(gen.OneConstOf(LinuxPatchSettings_AssessmentMode_ARM_AutomaticByPlatform, LinuxPatchSettings_AssessmentMode_ARM_ImageDefault))
...
func AddIndependentPropertyGeneratorsForLinuxVMGuestPatchAutomaticByPlatformSettings_ARM(gens map[string]gopter.Gen) {
	gens["RebootSetting"] = gen.PtrOf(gen.OneConstOf(
		LinuxVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Always,
		LinuxVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_IfRequired,
		LinuxVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Never,
		LinuxVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Unknown))
}
...
func AddIndependentPropertyGeneratorsForManagedDiskParameters_ARM(gens map[string]gopter.Gen) {
	...
	gens["StorageAccountType"] = gen.PtrOf(gen.OneConstOf(
		StorageAccountType_ARM_PremiumV2_LRS,
...
func AddIndependentPropertyGeneratorsForNetworkInterfaceReferenceProperties_ARM(gens map[string]gopter.Gen) {
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(NetworkInterfaceReferenceProperties_DeleteOption_ARM_Delete, NetworkInterfaceReferenceProperties_DeleteOption_ARM_Detach))
...
func AddIndependentPropertyGeneratorsForNetworkProfile_ARM(gens map[string]gopter.Gen) {
	gens["NetworkApiVersion"] = gen.PtrOf(gen.OneConstOf(NetworkProfile_NetworkApiVersion_ARM_20201101))
}
...
func AddIndependentPropertyGeneratorsForPatchSettings_ARM(gens map[string]gopter.Gen) {
	gens["AssessmentMode"] = gen.PtrOf(gen.OneConstOf(PatchSettings_AssessmentMode_ARM_AutomaticByPlatform, PatchSettings_AssessmentMode_ARM_ImageDefault))
...
func AddIndependentPropertyGeneratorsForPublicIPAddressSku_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.OneConstOf(PublicIPAddressSku_Name_ARM_Basic, PublicIPAddressSku_Name_ARM_Standard))
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(PublicIPAddressSku_Tier_ARM_Global, PublicIPAddressSku_Tier_ARM_Regional))
}
...
func AddIndependentPropertyGeneratorsForSecurityProfile_ARM(gens map[string]gopter.Gen) {
	...
	gens["SecurityType"] = gen.PtrOf(gen.OneConstOf(SecurityProfile_SecurityType_ARM_ConfidentialVM, SecurityProfile_SecurityType_ARM_TrustedLaunch))
}
...
func AddIndependentPropertyGeneratorsForVMDiskSecurityProfile_ARM(gens map[string]gopter.Gen) {
	gens["SecurityEncryptionType"] = gen.PtrOf(gen.OneConstOf(VMDiskSecurityProfile_SecurityEncryptionType_ARM_DiskWithVMGuestState, VMDiskSecurityProfile_SecurityEncryptionType_ARM_VMGuestStateOnly))
}
...
func AddIndependentPropertyGeneratorsForVirtualMachineNetworkInterfaceConfigurationProperties_ARM(gens map[string]gopter.Gen) {
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(VirtualMachineNetworkInterfaceConfigurationProperties_DeleteOption_ARM_Delete, VirtualMachineNetworkInterfaceConfigurationProperties_DeleteOption_ARM_Detach))
...
func AddIndependentPropertyGeneratorsForVirtualMachineNetworkInterfaceIPConfigurationProperties_ARM(gens map[string]gopter.Gen) {
	gens["Primary"] = gen.PtrOf(gen.Bool())
	gens["PrivateIPAddressVersion"] = gen.PtrOf(gen.OneConstOf(VirtualMachineNetworkInterfaceIPConfigurationProperties_PrivateIPAddressVersion_ARM_IPv4, VirtualMachineNetworkInterfaceIPConfigurationProperties_PrivateIPAddressVersion_ARM_IPv6))
}
...
func AddIndependentPropertyGeneratorsForVirtualMachinePublicIPAddressConfigurationProperties_ARM(gens map[string]gopter.Gen) {
	gens["DeleteOption"] = gen.PtrOf(gen.OneConstOf(VirtualMachinePublicIPAddressConfigurationProperties_DeleteOption_ARM_Delete, VirtualMachinePublicIPAddressConfigurationProperties_DeleteOption_ARM_Detach))
	gens["IdleTimeoutInMinutes"] = gen.PtrOf(gen.Int())
	gens["PublicIPAddressVersion"] = gen.PtrOf(gen.OneConstOf(VirtualMachinePublicIPAddressConfigurationProperties_PublicIPAddressVersion_ARM_IPv4, VirtualMachinePublicIPAddressConfigurationProperties_PublicIPAddressVersion_ARM_IPv6))
	gens["PublicIPAllocationMethod"] = gen.PtrOf(gen.OneConstOf(VirtualMachinePublicIPAddressConfigurationProperties_PublicIPAllocationMethod_ARM_Dynamic, VirtualMachinePublicIPAddressConfigurationProperties_PublicIPAllocationMethod_ARM_Static))
}
...
func AddIndependentPropertyGeneratorsForWindowsVMGuestPatchAutomaticByPlatformSettings_ARM(gens map[string]gopter.Gen) {
	gens["RebootSetting"] = gen.PtrOf(gen.OneConstOf(
		WindowsVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Always,
		WindowsVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_IfRequired,
		WindowsVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Never,
		WindowsVMGuestPatchAutomaticByPlatformSettings_RebootSetting_ARM_Unknown))
}
