...
type VirtualMachineScaleSets_SPECARM struct {
	...
	Identity *VirtualMachineScaleSetIdentity_SpecARM `json:"identity,omitempty"`
	...
	Plan       *Plan_SpecARM                             `json:"plan,omitempty"`
	Properties *VirtualMachineScaleSetProperties_SpecARM `json:"properties,omitempty"`
...
func (specarm VirtualMachineScaleSets_SPECARM) GetAPIVersion() string {
	return "2020-12-01"
}

// GetName returns the Name of the resource
func (specarm VirtualMachineScaleSets_SPECARM) GetName() string {
	return specarm.Name
}
...
type VirtualMachineScaleSetIdentity_SpecARM struct {
...
type VirtualMachineScaleSetProperties_SpecARM struct {
	...
	AdditionalCapabilities *AdditionalCapabilities_SpecARM `json:"additionalCapabilities,omitempty"`

	//AutomaticRepairsPolicy: Policy for automatic repairs.
	AutomaticRepairsPolicy *AutomaticRepairsPolicy_SpecARM `json:"automaticRepairsPolicy,omitempty"`
	...
	HostGroup *SubResource_SpecARM `json:"hostGroup,omitempty"`
	...
	ProximityPlacementGroup *SubResource_SpecARM `json:"proximityPlacementGroup,omitempty"`
	...
	ScaleInPolicy *ScaleInPolicy_SpecARM `json:"scaleInPolicy,omitempty"`
	...
	UpgradePolicy *UpgradePolicy_SpecARM `json:"upgradePolicy,omitempty"`

	//VirtualMachineProfile: The virtual machine profile.
	VirtualMachineProfile *VirtualMachineScaleSetVMProfile_SpecARM `json:"virtualMachineProfile,omitempty"`
...
type AdditionalCapabilities_SpecARM struct {
...
type AutomaticRepairsPolicy_SpecARM struct {
...
type ScaleInPolicy_SpecARM struct {
...
type UpgradePolicy_SpecARM struct {
	//AutomaticOSUpgradePolicy: Configuration parameters used for performing automatic
	//OS Upgrade.
	AutomaticOSUpgradePolicy *AutomaticOSUpgradePolicy_SpecARM `json:"automaticOSUpgradePolicy,omitempty"`
	...
	//rolling upgrade.
	RollingUpgradePolicy *RollingUpgradePolicy_SpecARM `json:"rollingUpgradePolicy,omitempty"`
}
...
type VirtualMachineScaleSetVMProfile_SpecARM struct {
	...
	BillingProfile *BillingProfile_SpecARM `json:"billingProfile,omitempty"`

	//DiagnosticsProfile: Specifies the boot diagnostic settings state.
	//Minimum api-version: 2015-06-15.
	DiagnosticsProfile *DiagnosticsProfile_SpecARM `json:"diagnosticsProfile,omitempty"`
	...
	ExtensionProfile *VirtualMachineScaleSetExtensionProfile_SpecARM `json:"extensionProfile,omitempty"`
	...
	NetworkProfile *VirtualMachineScaleSetNetworkProfile_SpecARM `json:"networkProfile,omitempty"`

	//OsProfile: Specifies the operating system settings for the virtual machines in
	//the scale set.
	OsProfile *VirtualMachineScaleSetOSProfile_SpecARM `json:"osProfile,omitempty"`
	...
	ScheduledEventsProfile *ScheduledEventsProfile_SpecARM `json:"scheduledEventsProfile,omitempty"`

	//SecurityProfile: Specifies the Security related profile settings for the virtual
	//machines in the scale set.
	SecurityProfile *SecurityProfile_SpecARM `json:"securityProfile,omitempty"`

	//StorageProfile: Specifies the storage settings for the virtual machine disks.
	StorageProfile *VirtualMachineScaleSetStorageProfile_SpecARM `json:"storageProfile,omitempty"`
}

type AutomaticOSUpgradePolicy_SpecARM struct {
...
type RollingUpgradePolicy_SpecARM struct {
...
type ScheduledEventsProfile_SpecARM struct {
	//TerminateNotificationProfile: Specifies Terminate Scheduled Event related
	//configurations.
	TerminateNotificationProfile *TerminateNotificationProfile_SpecARM `json:"terminateNotificationProfile,omitempty"`
}

type VirtualMachineScaleSetExtensionProfile_SpecARM struct {
...
type VirtualMachineScaleSetNetworkProfile_SpecARM struct {
	...
	HealthProbe *ApiEntityReference_SpecARM `json:"healthProbe,omitempty"`

	//NetworkInterfaceConfigurations: The list of network configurations.
	NetworkInterfaceConfigurations []VirtualMachineScaleSetNetworkConfiguration_SpecARM `json:"networkInterfaceConfigurations,omitempty"`
}

type VirtualMachineScaleSetOSProfile_SpecARM struct {
	...
	LinuxConfiguration *LinuxConfiguration_SpecARM `json:"linuxConfiguration,omitempty"`

	//Secrets: Specifies set of certificates that should be installed onto the virtual
	//machines in the scale set.
	Secrets []VaultSecretGroup_SpecARM `json:"secrets,omitempty"`

	//WindowsConfiguration: Specifies Windows operating system settings on the virtual
	//machine.
	WindowsConfiguration *WindowsConfiguration_SpecARM `json:"windowsConfiguration,omitempty"`
}

type VirtualMachineScaleSetStorageProfile_SpecARM struct {
	//DataDisks: Specifies the parameters that are used to add data disks to the
	//virtual machines in the scale set.
	//For more information about disks, see [About disks and VHDs for Azure virtual
	//machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
	DataDisks []VirtualMachineScaleSetDataDisk_SpecARM `json:"dataDisks,omitempty"`
	...
	//operations.
	ImageReference *ImageReference_SpecARM `json:"imageReference,omitempty"`

	//OsDisk: Specifies information about the operating system disk used by the
	//virtual machines in the scale set.
	//For more information about disks, see [About disks and VHDs for Azure virtual
	//machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
	OsDisk *VirtualMachineScaleSetOSDisk_SpecARM `json:"osDisk,omitempty"`
}

type ApiEntityReference_SpecARM struct {
	Id *string `json:"id,omitempty"`
}

type TerminateNotificationProfile_SpecARM struct {
...
type VirtualMachineScaleSetDataDisk_SpecARM struct {
	...
	ManagedDisk *VirtualMachineScaleSetManagedDiskParameters_SpecARM `json:"managedDisk,omitempty"`
...
type VirtualMachineScaleSetNetworkConfiguration_SpecARM struct {
	Id *string `json:"id,omitempty"`

	//Name: The network configuration name.
	Name       string                                                        `json:"name"`
	Properties *VirtualMachineScaleSetNetworkConfigurationProperties_SpecARM `json:"properties,omitempty"`
}

type VirtualMachineScaleSetOSDisk_SpecARM struct {
	//Caching: Specifies the caching requirements.
	//Possible values are:
	//None
	//ReadOnly
	...
	DiffDiskSettings *DiffDiskSettings_SpecARM `json:"diffDiskSettings,omitempty"`
	...
	//set on.
	Image *VirtualHardDisk_SpecARM `json:"image,omitempty"`
...
type VirtualMachineScaleSetManagedDiskParameters_SpecARM struct {
	//DiskEncryptionSet: Specifies the customer managed disk encryption set resource
	//id for the managed disk.
	DiskEncryptionSet *SubResource_SpecARM `json:"diskEncryptionSet,omitempty"`
...
type VirtualMachineScaleSetNetworkConfigurationProperties_SpecARM struct {
	//DnsSettings: The dns settings to be applied on the network interfaces.
	DnsSettings *VirtualMachineScaleSetNetworkConfigurationDnsSettings_SpecARM `json:"dnsSettings,omitempty"`
	...
	IpConfigurations []VirtualMachineScaleSetIPConfiguration_SpecARM `json:"ipConfigurations"`

	//NetworkSecurityGroup: The network security group.
	NetworkSecurityGroup *SubResource_SpecARM `json:"networkSecurityGroup,omitempty"`
...
type VirtualMachineScaleSetIPConfiguration_SpecARM struct {
	Id *string `json:"id,omitempty"`

	//Name: The IP configuration name.
	Name       string                                                   `json:"name"`
	Properties *VirtualMachineScaleSetIPConfigurationProperties_SpecARM `json:"properties,omitempty"`
}

type VirtualMachineScaleSetNetworkConfigurationDnsSettings_SpecARM struct {
	//DnsServers: List of DNS servers IP addresses
	DnsServers []string `json:"dnsServers,omitempty"`
}

type VirtualMachineScaleSetIPConfigurationProperties_SpecARM struct {
	...
	ApplicationGatewayBackendAddressPools []SubResource_SpecARM `json:"applicationGatewayBackendAddressPools,omitempty"`

	//ApplicationSecurityGroups: Specifies an array of references to application
	//security group.
	ApplicationSecurityGroups []SubResource_SpecARM `json:"applicationSecurityGroups,omitempty"`
	...
	LoadBalancerBackendAddressPools []SubResource_SpecARM `json:"loadBalancerBackendAddressPools,omitempty"`
	...
	LoadBalancerInboundNatPools []SubResource_SpecARM `json:"loadBalancerInboundNatPools,omitempty"`
	...
	Subnet *ApiEntityReference_SpecARM `json:"subnet,omitempty"`
}

type VirtualMachineScaleSetPublicIPAddressConfiguration_SpecARM struct {
	//Name: The publicIP address configuration name.
	Name       string                                                                `json:"name"`
	Properties *VirtualMachineScaleSetPublicIPAddressConfigurationProperties_SpecARM `json:"properties,omitempty"`
}

type VirtualMachineScaleSetPublicIPAddressConfigurationProperties_SpecARM struct {
	//DnsSettings: The dns settings to be applied on the publicIP addresses .
	DnsSettings *VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings_SpecARM `json:"dnsSettings,omitempty"`

	//IdleTimeoutInMinutes: The idle timeout of the public IP address.
	IdleTimeoutInMinutes *int `json:"idleTimeoutInMinutes,omitempty"`

	//IpTags: The list of IP tags associated with the public IP address.
	IpTags []VirtualMachineScaleSetIpTag_SpecARM `json:"ipTags,omitempty"`
...
type VirtualMachineScaleSetIpTag_SpecARM struct {
...
type VirtualMachineScaleSetPublicIPAddressConfigurationDnsSettings_SpecARM struct {
