...
type VirtualMachines_SPECARM struct {
	...
	Identity *VirtualMachineIdentity_SpecARM `json:"identity,omitempty"`
	...
	Properties *VirtualMachineProperties_SpecARM `json:"properties,omitempty"`
...
func (specarm VirtualMachines_SPECARM) GetAPIVersion() string {
	return "2020-12-01"
}

// GetName returns the Name of the resource
func (specarm VirtualMachines_SPECARM) GetName() string {
	return specarm.Name
}
...
type VirtualMachineProperties_SpecARM struct {
	...
	AvailabilitySet *SubResource_SpecARM `json:"availabilitySet,omitempty"`
	...
	HardwareProfile *HardwareProfile_SpecARM `json:"hardwareProfile,omitempty"`

	//Host: Specifies information about the dedicated host that the virtual machine
	//resides in.
	//Minimum api-version: 2018-10-01.
	Host *SubResource_SpecARM `json:"host,omitempty"`
	...
	NetworkProfile *NetworkProfile_SpecARM `json:"networkProfile,omitempty"`
	...
	OsProfile *OSProfile_SpecARM `json:"osProfile,omitempty"`
	...
	StorageProfile *StorageProfile_SpecARM `json:"storageProfile,omitempty"`
	...
	//reference.
	//Minimum api‐version: 2019‐03‐01
	VirtualMachineScaleSet *SubResource_SpecARM `json:"virtualMachineScaleSet,omitempty"`
}

type BillingProfile_SpecARM struct {
...
type DiagnosticsProfile_SpecARM struct {
	...
	BootDiagnostics *BootDiagnostics_SpecARM `json:"bootDiagnostics,omitempty"`
}

type HardwareProfile_SpecARM struct {
...
type NetworkProfile_SpecARM struct {
	...
	NetworkInterfaces []NetworkInterfaceReference_SpecARM `json:"networkInterfaces,omitempty"`
}

type OSProfile_SpecARM struct {
...
type SecurityProfile_SpecARM struct {
	...
	//Minimum api-version: 2020-12-01
	UefiSettings *UefiSettings_SpecARM `json:"uefiSettings,omitempty"`
}

type StorageProfile_SpecARM struct {
	//DataDisks: Specifies the parameters that are used to add a data disk to a
	//virtual machine.
	//For more information about disks, see [About disks and VHDs for Azure virtual
	//machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
	DataDisks []DataDisk_SpecARM `json:"dataDisks,omitempty"`
	...
	//For more information about disks, see [About disks and VHDs for Azure virtual
	//machines](https://docs.microsoft.com/azure/virtual-machines/virtual-machines-windows-about-disks-vhds?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
	OsDisk *OSDisk_SpecARM `json:"osDisk,omitempty"`
}
...
type DataDisk_SpecARM struct {
	...
	ManagedDisk *ManagedDiskParameters_SpecARM `json:"managedDisk,omitempty"`
...
type ImageReference_SpecARM struct {
...
type LinuxConfiguration_SpecARM struct {
	...
	//on Linux.
	PatchSettings *LinuxPatchSettings_SpecARM `json:"patchSettings,omitempty"`
	...
	Ssh *SshConfiguration_SpecARM `json:"ssh,omitempty"`
}

type NetworkInterfaceReference_SpecARM struct {
	Id         *string                                      `json:"id,omitempty"`
	Properties *NetworkInterfaceReferenceProperties_SpecARM `json:"properties,omitempty"`
}

type OSDisk_SpecARM struct {
	//Caching: Specifies the caching requirements.
	//Possible values are:
	//None
	//ReadOnly
	...
	//Minimum api-version: 2015-06-15
	EncryptionSettings *DiskEncryptionSettings_SpecARM `json:"encryptionSettings,omitempty"`
...
type UefiSettings_SpecARM struct {
...
type VaultSecretGroup_SpecARM struct {
	//SourceVault: The relative URL of the Key Vault containing all of the
	//certificates in VaultCertificates.
	SourceVault *SubResource_SpecARM `json:"sourceVault,omitempty"`

	//VaultCertificates: The list of key vault references in SourceVault which contain
	//certificates.
	VaultCertificates []VaultCertificate_SpecARM `json:"vaultCertificates,omitempty"`
}

type WindowsConfiguration_SpecARM struct {
	...
	//Windows Setup.
	AdditionalUnattendContent []AdditionalUnattendContent_SpecARM `json:"additionalUnattendContent,omitempty"`
	...
	//PatchSettings: [Preview Feature] Specifies settings related to VM Guest Patching
	//on Windows.
	PatchSettings *PatchSettings_SpecARM `json:"patchSettings,omitempty"`
	...
	//Windows PowerShell.
	WinRM *WinRMConfiguration_SpecARM `json:"winRM,omitempty"`
}
...
type DiskEncryptionSettings_SpecARM struct {
	//DiskEncryptionKey: Specifies the location of the disk encryption key, which is a
	//Key Vault Secret.
	DiskEncryptionKey *KeyVaultSecretReference_SpecARM `json:"diskEncryptionKey,omitempty"`
	...
	KeyEncryptionKey *KeyVaultKeyReference_SpecARM `json:"keyEncryptionKey,omitempty"`
}

type LinuxPatchSettings_SpecARM struct {
...
type SshConfiguration_SpecARM struct {
	...
	//VMs.
	PublicKeys []SshPublicKey_SpecARM `json:"publicKeys,omitempty"`
}

type VaultCertificate_SpecARM struct {
...
type VirtualHardDisk_SpecARM struct {
	//Uri: Specifies the virtual hard disk's uri.
	Uri *string `json:"uri,omitempty"`
}

type WinRMConfiguration_SpecARM struct {
	//Listeners: The list of Windows Remote Management listeners
	Listeners []WinRMListener_SpecARM `json:"listeners,omitempty"`
}

type KeyVaultKeyReference_SpecARM struct {
	//KeyUrl: The URL referencing a key encryption key in Key Vault.
	KeyUrl string `json:"keyUrl"`

	//SourceVault: The relative URL of the Key Vault containing the key.
	SourceVault SubResource_SpecARM `json:"sourceVault"`
}

type KeyVaultSecretReference_SpecARM struct {
...
type SshPublicKey_SpecARM struct {
...
type WinRMListener_SpecARM struct {
	//CertificateUrl: This is the URL of a certificate that has been uploaded to Key
	//Vault as a secret. For adding a secret to the Key Vault, see [Add a key or
	//secret to the key
	//vault](https://docs.microsoft.com/azure/key-vault/key-vault-get-started/#add).
