...
func Test_DatabaseAccountsSqlDatabase_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DatabaseAccountsSqlDatabase to DatabaseAccountsSqlDatabase via AssignPropertiesToDatabaseAccountsSqlDatabase & AssignPropertiesFromDatabaseAccountsSqlDatabase returns original",
		prop.ForAll(RunPropertyAssignmentTestForDatabaseAccountsSqlDatabase, DatabaseAccountsSqlDatabaseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDatabaseAccountsSqlDatabase tests if a specific instance of DatabaseAccountsSqlDatabase can be assigned to v1alpha1api20210515storage and back losslessly
func RunPropertyAssignmentTestForDatabaseAccountsSqlDatabase(subject DatabaseAccountsSqlDatabase) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210515storage.DatabaseAccountsSqlDatabase
	err := subject.AssignPropertiesToDatabaseAccountsSqlDatabase(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual DatabaseAccountsSqlDatabase
	err = actual.AssignPropertiesFromDatabaseAccountsSqlDatabase(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DatabaseAccountsSqlDatabase_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DatabaseAccountsSqlDatabase via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseAccountsSqlDatabase, DatabaseAccountsSqlDatabaseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseAccountsSqlDatabase runs a test to see if a specific instance of DatabaseAccountsSqlDatabase round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseAccountsSqlDatabase(subject DatabaseAccountsSqlDatabase) string {
	// Serialize to JSON
...
// Generator of DatabaseAccountsSqlDatabase instances for property testing - lazily instantiated by
//DatabaseAccountsSqlDatabaseGenerator()
var databaseAccountsSqlDatabaseGenerator gopter.Gen

// DatabaseAccountsSqlDatabaseGenerator returns a generator of DatabaseAccountsSqlDatabase instances for property testing.
func DatabaseAccountsSqlDatabaseGenerator() gopter.Gen {
	if databaseAccountsSqlDatabaseGenerator != nil {
		return databaseAccountsSqlDatabaseGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabase(generators)
	databaseAccountsSqlDatabaseGenerator = gen.Struct(reflect.TypeOf(DatabaseAccountsSqlDatabase{}), generators)

	return databaseAccountsSqlDatabaseGenerator
}

// AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabase is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabase(gens map[string]gopter.Gen) {
