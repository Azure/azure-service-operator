...
func Test_DatabaseAccountsSqlDatabasesContainer_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DatabaseAccountsSqlDatabasesContainer to DatabaseAccountsSqlDatabasesContainer via AssignPropertiesToDatabaseAccountsSqlDatabasesContainer & AssignPropertiesFromDatabaseAccountsSqlDatabasesContainer returns original",
		prop.ForAll(RunPropertyAssignmentTestForDatabaseAccountsSqlDatabasesContainer, DatabaseAccountsSqlDatabasesContainerGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDatabaseAccountsSqlDatabasesContainer tests if a specific instance of DatabaseAccountsSqlDatabasesContainer can be assigned to v1alpha1api20210515storage and back losslessly
func RunPropertyAssignmentTestForDatabaseAccountsSqlDatabasesContainer(subject DatabaseAccountsSqlDatabasesContainer) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210515storage.DatabaseAccountsSqlDatabasesContainer
	err := subject.AssignPropertiesToDatabaseAccountsSqlDatabasesContainer(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual DatabaseAccountsSqlDatabasesContainer
	err = actual.AssignPropertiesFromDatabaseAccountsSqlDatabasesContainer(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_DatabaseAccountsSqlDatabasesContainer_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DatabaseAccountsSqlDatabasesContainer via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseAccountsSqlDatabasesContainer, DatabaseAccountsSqlDatabasesContainerGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseAccountsSqlDatabasesContainer runs a test to see if a specific instance of DatabaseAccountsSqlDatabasesContainer round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseAccountsSqlDatabasesContainer(subject DatabaseAccountsSqlDatabasesContainer) string {
	// Serialize to JSON
...
// Generator of DatabaseAccountsSqlDatabasesContainer instances for property testing - lazily instantiated by
//DatabaseAccountsSqlDatabasesContainerGenerator()
var databaseAccountsSqlDatabasesContainerGenerator gopter.Gen

// DatabaseAccountsSqlDatabasesContainerGenerator returns a generator of DatabaseAccountsSqlDatabasesContainer instances for property testing.
func DatabaseAccountsSqlDatabasesContainerGenerator() gopter.Gen {
	if databaseAccountsSqlDatabasesContainerGenerator != nil {
		return databaseAccountsSqlDatabasesContainerGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabasesContainer(generators)
	databaseAccountsSqlDatabasesContainerGenerator = gen.Struct(reflect.TypeOf(DatabaseAccountsSqlDatabasesContainer{}), generators)

	return databaseAccountsSqlDatabasesContainerGenerator
}

// AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabasesContainer is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabasesContainer(gens map[string]gopter.Gen) {
