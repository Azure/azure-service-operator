...
// RunPropertyAssignmentTestForService tests if a specific instance of Service can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForService(subject Service) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.Service
...
// RunPropertyAssignmentTestForService_Spec tests if a specific instance of Service_Spec can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForService_Spec(subject Service_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.Service_Spec
...
// RunPropertyAssignmentTestForService_STATUS tests if a specific instance of Service_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForService_STATUS(subject Service_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.Service_STATUS
...
// RunPropertyAssignmentTestForAdditionalLocation tests if a specific instance of AdditionalLocation can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForAdditionalLocation(subject AdditionalLocation) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.AdditionalLocation
...
// RunPropertyAssignmentTestForAdditionalLocation_STATUS tests if a specific instance of AdditionalLocation_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForAdditionalLocation_STATUS(subject AdditionalLocation_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.AdditionalLocation_STATUS
...
// RunPropertyAssignmentTestForApiManagementServiceIdentity tests if a specific instance of ApiManagementServiceIdentity can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiManagementServiceIdentity(subject ApiManagementServiceIdentity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiManagementServiceIdentity
...
// RunPropertyAssignmentTestForApiManagementServiceIdentity_STATUS tests if a specific instance of ApiManagementServiceIdentity_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiManagementServiceIdentity_STATUS(subject ApiManagementServiceIdentity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiManagementServiceIdentity_STATUS
...
// RunPropertyAssignmentTestForApiManagementServiceSkuProperties tests if a specific instance of ApiManagementServiceSkuProperties can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiManagementServiceSkuProperties(subject ApiManagementServiceSkuProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiManagementServiceSkuProperties
...
// RunPropertyAssignmentTestForApiManagementServiceSkuProperties_STATUS tests if a specific instance of ApiManagementServiceSkuProperties_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiManagementServiceSkuProperties_STATUS(subject ApiManagementServiceSkuProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiManagementServiceSkuProperties_STATUS
...
// RunPropertyAssignmentTestForApiVersionConstraint tests if a specific instance of ApiVersionConstraint can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiVersionConstraint(subject ApiVersionConstraint) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiVersionConstraint
...
// RunPropertyAssignmentTestForApiVersionConstraint_STATUS tests if a specific instance of ApiVersionConstraint_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForApiVersionConstraint_STATUS(subject ApiVersionConstraint_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ApiVersionConstraint_STATUS
...
// RunPropertyAssignmentTestForCertificateConfiguration tests if a specific instance of CertificateConfiguration can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForCertificateConfiguration(subject CertificateConfiguration) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.CertificateConfiguration
...
// RunPropertyAssignmentTestForCertificateConfiguration_STATUS tests if a specific instance of CertificateConfiguration_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForCertificateConfiguration_STATUS(subject CertificateConfiguration_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.CertificateConfiguration_STATUS
...
// RunPropertyAssignmentTestForConfigurationApi tests if a specific instance of ConfigurationApi can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForConfigurationApi(subject ConfigurationApi) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ConfigurationApi
...
// RunPropertyAssignmentTestForConfigurationApi_STATUS tests if a specific instance of ConfigurationApi_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForConfigurationApi_STATUS(subject ConfigurationApi_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ConfigurationApi_STATUS
...
// RunPropertyAssignmentTestForHostnameConfiguration tests if a specific instance of HostnameConfiguration can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForHostnameConfiguration(subject HostnameConfiguration) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.HostnameConfiguration
...
// RunPropertyAssignmentTestForHostnameConfiguration_STATUS tests if a specific instance of HostnameConfiguration_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForHostnameConfiguration_STATUS(subject HostnameConfiguration_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.HostnameConfiguration_STATUS
...
// RunPropertyAssignmentTestForRemotePrivateEndpointConnectionWrapper_STATUS tests if a specific instance of RemotePrivateEndpointConnectionWrapper_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForRemotePrivateEndpointConnectionWrapper_STATUS(subject RemotePrivateEndpointConnectionWrapper_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.RemotePrivateEndpointConnectionWrapper_STATUS
...
// RunPropertyAssignmentTestForSystemData_STATUS tests if a specific instance of SystemData_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForSystemData_STATUS(subject SystemData_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.SystemData_STATUS
...
// RunPropertyAssignmentTestForVirtualNetworkConfiguration tests if a specific instance of VirtualNetworkConfiguration can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForVirtualNetworkConfiguration(subject VirtualNetworkConfiguration) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.VirtualNetworkConfiguration
...
// RunPropertyAssignmentTestForVirtualNetworkConfiguration_STATUS tests if a specific instance of VirtualNetworkConfiguration_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForVirtualNetworkConfiguration_STATUS(subject VirtualNetworkConfiguration_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.VirtualNetworkConfiguration_STATUS
...
// RunPropertyAssignmentTestForArmIdWrapper_STATUS tests if a specific instance of ArmIdWrapper_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForArmIdWrapper_STATUS(subject ArmIdWrapper_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.ArmIdWrapper_STATUS
...
// RunPropertyAssignmentTestForCertificateInformation tests if a specific instance of CertificateInformation can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForCertificateInformation(subject CertificateInformation) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.CertificateInformation
...
// RunPropertyAssignmentTestForCertificateInformation_STATUS tests if a specific instance of CertificateInformation_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForCertificateInformation_STATUS(subject CertificateInformation_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.CertificateInformation_STATUS
...
// RunPropertyAssignmentTestForPrivateLinkServiceConnectionState_STATUS tests if a specific instance of PrivateLinkServiceConnectionState_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForPrivateLinkServiceConnectionState_STATUS(subject PrivateLinkServiceConnectionState_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.PrivateLinkServiceConnectionState_STATUS
...
// RunPropertyAssignmentTestForUserAssignedIdentityDetails tests if a specific instance of UserAssignedIdentityDetails can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForUserAssignedIdentityDetails(subject UserAssignedIdentityDetails) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.UserAssignedIdentityDetails
...
// RunPropertyAssignmentTestForUserIdentityProperties_STATUS tests if a specific instance of UserIdentityProperties_STATUS can be assigned to v1api20230301previewstorage and back losslessly
func RunPropertyAssignmentTestForUserIdentityProperties_STATUS(subject UserIdentityProperties_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20230301ps.UserIdentityProperties_STATUS
