...
func (service *Service) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20230301ps.Service
...
func (service *Service) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20230301ps.Service
...
// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20230301preview-service,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=services,verbs=create;update,versions=v1api20230301preview,name=default.v1api20230301preview.services.apimanagement.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20230301preview-service,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=services,verbs=create;update,versions=v1api20230301preview,name=validate.v1api20230301preview.services.apimanagement.azure.com,admissionReviewVersions=v1
...
func (service *Service) AssignProperties_From_Service(source *v20230301ps.Service) error {
...
func (service *Service) AssignProperties_To_Service(destination *v20230301ps.Service) error {

	// ObjectMeta
	destination.ObjectMeta = *service.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230301ps.Service_Spec
	...
	// Status
	var status v20230301ps.Service_STATUS
...
func (service *Service_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230301ps.Service_Spec)
	if ok {
...
func (service *Service_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230301ps.Service_Spec)
	if ok {
...
func (service *Service_Spec) AssignProperties_From_Service_Spec(source *v20230301ps.Service_Spec) error {
	...
	if source.DeveloperPortalStatus != nil {
		developerPortalStatus := ApiManagementServiceProperties_DeveloperPortalStatus(*source.DeveloperPortalStatus)
		service.DeveloperPortalStatus = &developerPortalStatus
	} else {
		service.DeveloperPortalStatus = nil
	}
	...
	if source.LegacyPortalStatus != nil {
		legacyPortalStatus := ApiManagementServiceProperties_LegacyPortalStatus(*source.LegacyPortalStatus)
		service.LegacyPortalStatus = &legacyPortalStatus
	} else {
		service.LegacyPortalStatus = nil
	}
...
func (service *Service_Spec) AssignProperties_To_Service_Spec(destination *v20230301ps.Service_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AdditionalLocations
	if service.AdditionalLocations != nil {
		additionalLocationList := make([]v20230301ps.AdditionalLocation, len(service.AdditionalLocations))
		for additionalLocationIndex, additionalLocationItem := range service.AdditionalLocations {
			// Shadow the loop variable to avoid aliasing
			additionalLocationItem := additionalLocationItem
			var additionalLocation v20230301ps.AdditionalLocation
	...
	// ApiVersionConstraint
	if service.ApiVersionConstraint != nil {
		var apiVersionConstraint v20230301ps.ApiVersionConstraint
	...
	if service.Certificates != nil {
		certificateList := make([]v20230301ps.CertificateConfiguration, len(service.Certificates))
		for certificateIndex, certificateItem := range service.Certificates {
			// Shadow the loop variable to avoid aliasing
			certificateItem := certificateItem
			var certificate v20230301ps.CertificateConfiguration
	...
	// ConfigurationApi
	if service.ConfigurationApi != nil {
		var configurationApi v20230301ps.ConfigurationApi
	...
	if service.HostnameConfigurations != nil {
		hostnameConfigurationList := make([]v20230301ps.HostnameConfiguration, len(service.HostnameConfigurations))
		for hostnameConfigurationIndex, hostnameConfigurationItem := range service.HostnameConfigurations {
			// Shadow the loop variable to avoid aliasing
			hostnameConfigurationItem := hostnameConfigurationItem
			var hostnameConfiguration v20230301ps.HostnameConfiguration
	...
	// Identity
	if service.Identity != nil {
		var identity v20230301ps.ApiManagementServiceIdentity
	...
	// Sku
	if service.Sku != nil {
		var sku v20230301ps.ApiManagementServiceSkuProperties
	...
	// VirtualNetworkConfiguration
	if service.VirtualNetworkConfiguration != nil {
		var virtualNetworkConfiguration v20230301ps.VirtualNetworkConfiguration
...
func (service *Service_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230301ps.Service_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230301ps.Service_STATUS{}
...
func (service *Service_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230301ps.Service_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230301ps.Service_STATUS{}
...
func (service *Service_STATUS) AssignProperties_From_Service_STATUS(source *v20230301ps.Service_STATUS) error {
	...
	// DeveloperPortalStatus
	if source.DeveloperPortalStatus != nil {
		developerPortalStatus := ApiManagementServiceProperties_DeveloperPortalStatus_STATUS(*source.DeveloperPortalStatus)
		service.DeveloperPortalStatus = &developerPortalStatus
	} else {
		service.DeveloperPortalStatus = nil
	}
	...
	// LegacyPortalStatus
	if source.LegacyPortalStatus != nil {
		legacyPortalStatus := ApiManagementServiceProperties_LegacyPortalStatus_STATUS(*source.LegacyPortalStatus)
		service.LegacyPortalStatus = &legacyPortalStatus
	} else {
		service.LegacyPortalStatus = nil
	}
...
func (service *Service_STATUS) AssignProperties_To_Service_STATUS(destination *v20230301ps.Service_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// AdditionalLocations
	if service.AdditionalLocations != nil {
		additionalLocationList := make([]v20230301ps.AdditionalLocation_STATUS, len(service.AdditionalLocations))
		for additionalLocationIndex, additionalLocationItem := range service.AdditionalLocations {
			// Shadow the loop variable to avoid aliasing
			additionalLocationItem := additionalLocationItem
			var additionalLocation v20230301ps.AdditionalLocation_STATUS
	...
	// ApiVersionConstraint
	if service.ApiVersionConstraint != nil {
		var apiVersionConstraint v20230301ps.ApiVersionConstraint_STATUS
	...
	// Certificates
	if service.Certificates != nil {
		certificateList := make([]v20230301ps.CertificateConfiguration_STATUS, len(service.Certificates))
		for certificateIndex, certificateItem := range service.Certificates {
			// Shadow the loop variable to avoid aliasing
			certificateItem := certificateItem
			var certificate v20230301ps.CertificateConfiguration_STATUS
	...
	// ConfigurationApi
	if service.ConfigurationApi != nil {
		var configurationApi v20230301ps.ConfigurationApi_STATUS
	...
	// HostnameConfigurations
	if service.HostnameConfigurations != nil {
		hostnameConfigurationList := make([]v20230301ps.HostnameConfiguration_STATUS, len(service.HostnameConfigurations))
		for hostnameConfigurationIndex, hostnameConfigurationItem := range service.HostnameConfigurations {
			// Shadow the loop variable to avoid aliasing
			hostnameConfigurationItem := hostnameConfigurationItem
			var hostnameConfiguration v20230301ps.HostnameConfiguration_STATUS
	...
	// Identity
	if service.Identity != nil {
		var identity v20230301ps.ApiManagementServiceIdentity_STATUS
	...
	if service.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v20230301ps.RemotePrivateEndpointConnectionWrapper_STATUS, len(service.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range service.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v20230301ps.RemotePrivateEndpointConnectionWrapper_STATUS
	...
	// Sku
	if service.Sku != nil {
		var sku v20230301ps.ApiManagementServiceSkuProperties_STATUS
	...
	if service.SystemData != nil {
		var systemDatum v20230301ps.SystemData_STATUS
	...
	// VirtualNetworkConfiguration
	if service.VirtualNetworkConfiguration != nil {
		var virtualNetworkConfiguration v20230301ps.VirtualNetworkConfiguration_STATUS
...
func (location *AdditionalLocation) AssignProperties_From_AdditionalLocation(source *v20230301ps.AdditionalLocation) error {
...
func (location *AdditionalLocation) AssignProperties_To_AdditionalLocation(destination *v20230301ps.AdditionalLocation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (location *AdditionalLocation_STATUS) AssignProperties_From_AdditionalLocation_STATUS(source *v20230301ps.AdditionalLocation_STATUS) error {
...
func (location *AdditionalLocation_STATUS) AssignProperties_To_AdditionalLocation_STATUS(destination *v20230301ps.AdditionalLocation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (identity *ApiManagementServiceIdentity) AssignProperties_From_ApiManagementServiceIdentity(source *v20230301ps.ApiManagementServiceIdentity) error {
...
func (identity *ApiManagementServiceIdentity) AssignProperties_To_ApiManagementServiceIdentity(destination *v20230301ps.ApiManagementServiceIdentity) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20230301ps.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20230301ps.UserAssignedIdentityDetails
...
func (identity *ApiManagementServiceIdentity_STATUS) AssignProperties_From_ApiManagementServiceIdentity_STATUS(source *v20230301ps.ApiManagementServiceIdentity_STATUS) error {
...
func (identity *ApiManagementServiceIdentity_STATUS) AssignProperties_To_ApiManagementServiceIdentity_STATUS(destination *v20230301ps.ApiManagementServiceIdentity_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20230301ps.UserIdentityProperties_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20230301ps.UserIdentityProperties_STATUS
...
func (properties *ApiManagementServiceSkuProperties) AssignProperties_From_ApiManagementServiceSkuProperties(source *v20230301ps.ApiManagementServiceSkuProperties) error {
...
func (properties *ApiManagementServiceSkuProperties) AssignProperties_To_ApiManagementServiceSkuProperties(destination *v20230301ps.ApiManagementServiceSkuProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *ApiManagementServiceSkuProperties_STATUS) AssignProperties_From_ApiManagementServiceSkuProperties_STATUS(source *v20230301ps.ApiManagementServiceSkuProperties_STATUS) error {
...
func (properties *ApiManagementServiceSkuProperties_STATUS) AssignProperties_To_ApiManagementServiceSkuProperties_STATUS(destination *v20230301ps.ApiManagementServiceSkuProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (constraint *ApiVersionConstraint) AssignProperties_From_ApiVersionConstraint(source *v20230301ps.ApiVersionConstraint) error {
...
func (constraint *ApiVersionConstraint) AssignProperties_To_ApiVersionConstraint(destination *v20230301ps.ApiVersionConstraint) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (constraint *ApiVersionConstraint_STATUS) AssignProperties_From_ApiVersionConstraint_STATUS(source *v20230301ps.ApiVersionConstraint_STATUS) error {
...
func (constraint *ApiVersionConstraint_STATUS) AssignProperties_To_ApiVersionConstraint_STATUS(destination *v20230301ps.ApiVersionConstraint_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *CertificateConfiguration) AssignProperties_From_CertificateConfiguration(source *v20230301ps.CertificateConfiguration) error {
...
func (configuration *CertificateConfiguration) AssignProperties_To_CertificateConfiguration(destination *v20230301ps.CertificateConfiguration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Certificate
	if configuration.Certificate != nil {
		var certificate v20230301ps.CertificateInformation
...
func (configuration *CertificateConfiguration_STATUS) AssignProperties_From_CertificateConfiguration_STATUS(source *v20230301ps.CertificateConfiguration_STATUS) error {
...
func (configuration *CertificateConfiguration_STATUS) AssignProperties_To_CertificateConfiguration_STATUS(destination *v20230301ps.CertificateConfiguration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Certificate
	if configuration.Certificate != nil {
		var certificate v20230301ps.CertificateInformation_STATUS
...
func (configurationApi *ConfigurationApi) AssignProperties_From_ConfigurationApi(source *v20230301ps.ConfigurationApi) error {

	// LegacyApi
	if source.LegacyApi != nil {
		legacyApi := ConfigurationApi_LegacyApi(*source.LegacyApi)
		configurationApi.LegacyApi = &legacyApi
	} else {
...
func (configurationApi *ConfigurationApi) AssignProperties_To_ConfigurationApi(destination *v20230301ps.ConfigurationApi) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configurationApi *ConfigurationApi_STATUS) AssignProperties_From_ConfigurationApi_STATUS(source *v20230301ps.ConfigurationApi_STATUS) error {

	// LegacyApi
	if source.LegacyApi != nil {
		legacyApi := ConfigurationApi_LegacyApi_STATUS(*source.LegacyApi)
		configurationApi.LegacyApi = &legacyApi
	} else {
		configurationApi.LegacyApi = nil
	}
...
func (configurationApi *ConfigurationApi_STATUS) AssignProperties_To_ConfigurationApi_STATUS(destination *v20230301ps.ConfigurationApi_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *HostnameConfiguration) AssignProperties_From_HostnameConfiguration(source *v20230301ps.HostnameConfiguration) error {
...
func (configuration *HostnameConfiguration) AssignProperties_To_HostnameConfiguration(destination *v20230301ps.HostnameConfiguration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *HostnameConfiguration_STATUS) AssignProperties_From_HostnameConfiguration_STATUS(source *v20230301ps.HostnameConfiguration_STATUS) error {
...
func (configuration *HostnameConfiguration_STATUS) AssignProperties_To_HostnameConfiguration_STATUS(destination *v20230301ps.HostnameConfiguration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (wrapper *RemotePrivateEndpointConnectionWrapper_STATUS) AssignProperties_From_RemotePrivateEndpointConnectionWrapper_STATUS(source *v20230301ps.RemotePrivateEndpointConnectionWrapper_STATUS) error {
...
func (wrapper *RemotePrivateEndpointConnectionWrapper_STATUS) AssignProperties_To_RemotePrivateEndpointConnectionWrapper_STATUS(destination *v20230301ps.RemotePrivateEndpointConnectionWrapper_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if wrapper.PrivateEndpoint != nil {
		var privateEndpoint v20230301ps.ArmIdWrapper_STATUS
	...
	if wrapper.PrivateLinkServiceConnectionState != nil {
		var privateLinkServiceConnectionState v20230301ps.PrivateLinkServiceConnectionState_STATUS
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20230301ps.SystemData_STATUS) error {
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20230301ps.SystemData_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *VirtualNetworkConfiguration) AssignProperties_From_VirtualNetworkConfiguration(source *v20230301ps.VirtualNetworkConfiguration) error {
...
func (configuration *VirtualNetworkConfiguration) AssignProperties_To_VirtualNetworkConfiguration(destination *v20230301ps.VirtualNetworkConfiguration) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (configuration *VirtualNetworkConfiguration_STATUS) AssignProperties_From_VirtualNetworkConfiguration_STATUS(source *v20230301ps.VirtualNetworkConfiguration_STATUS) error {
...
func (configuration *VirtualNetworkConfiguration_STATUS) AssignProperties_To_VirtualNetworkConfiguration_STATUS(destination *v20230301ps.VirtualNetworkConfiguration_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (wrapper *ArmIdWrapper_STATUS) AssignProperties_From_ArmIdWrapper_STATUS(source *v20230301ps.ArmIdWrapper_STATUS) error {
...
func (wrapper *ArmIdWrapper_STATUS) AssignProperties_To_ArmIdWrapper_STATUS(destination *v20230301ps.ArmIdWrapper_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (information *CertificateInformation) AssignProperties_From_CertificateInformation(source *v20230301ps.CertificateInformation) error {
...
func (information *CertificateInformation) AssignProperties_To_CertificateInformation(destination *v20230301ps.CertificateInformation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (information *CertificateInformation_STATUS) AssignProperties_From_CertificateInformation_STATUS(source *v20230301ps.CertificateInformation_STATUS) error {
...
func (information *CertificateInformation_STATUS) AssignProperties_To_CertificateInformation_STATUS(destination *v20230301ps.CertificateInformation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (state *PrivateLinkServiceConnectionState_STATUS) AssignProperties_From_PrivateLinkServiceConnectionState_STATUS(source *v20230301ps.PrivateLinkServiceConnectionState_STATUS) error {
...
func (state *PrivateLinkServiceConnectionState_STATUS) AssignProperties_To_PrivateLinkServiceConnectionState_STATUS(destination *v20230301ps.PrivateLinkServiceConnectionState_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20230301ps.UserAssignedIdentityDetails) error {
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20230301ps.UserAssignedIdentityDetails) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_From_UserIdentityProperties_STATUS(source *v20230301ps.UserIdentityProperties_STATUS) error {
...
func (properties *UserIdentityProperties_STATUS) AssignProperties_To_UserIdentityProperties_STATUS(destination *v20230301ps.UserIdentityProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
