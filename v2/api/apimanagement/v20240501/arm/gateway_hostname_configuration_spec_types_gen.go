...
var _ genruntime.ARMResourceSpec = &GatewayHostnameConfiguration_Spec{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2024-05-01"
func (configuration GatewayHostnameConfiguration_Spec) GetAPIVersion() string {
	return "2024-05-01"
}

// GetName returns the Name of the resource
func (configuration *GatewayHostnameConfiguration_Spec) GetName() string {
...
func (configuration *GatewayHostnameConfiguration_Spec) GetType() string {
