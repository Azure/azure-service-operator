...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_policies,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_policies/status,service_policies/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_Policy
...
// Hub marks that this Service_Policy is the hub type for conversion
func (policy *Service_Policy) Hub() {}
