...
func Test_Service_ApiVersionSet_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of Service_ApiVersionSet via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForService_ApiVersionSet, Service_ApiVersionSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForService_ApiVersionSet runs a test to see if a specific instance of Service_ApiVersionSet round trips to JSON and back losslessly
func RunJSONSerializationTestForService_ApiVersionSet(subject Service_ApiVersionSet) string {
	// Serialize to JSON
	...
	var actual Service_ApiVersionSet
...
// Generator of Service_ApiVersionSet instances for property testing - lazily instantiated by
// Service_ApiVersionSetGenerator()
var service_ApiVersionSetGenerator gopter.Gen

// Service_ApiVersionSetGenerator returns a generator of Service_ApiVersionSet instances for property testing.
func Service_ApiVersionSetGenerator() gopter.Gen {
	if service_ApiVersionSetGenerator != nil {
		return service_ApiVersionSetGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForService_ApiVersionSet(generators)
	service_ApiVersionSetGenerator = gen.Struct(reflect.TypeOf(Service_ApiVersionSet{}), generators)

	return service_ApiVersionSetGenerator
}

// AddRelatedPropertyGeneratorsForService_ApiVersionSet is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_ApiVersionSet(gens map[string]gopter.Gen) {
