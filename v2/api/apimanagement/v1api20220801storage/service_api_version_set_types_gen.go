...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_apiversionsets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_apiversionsets/status,service_apiversionsets/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_ApiVersionSet
...
// Hub marks that this Service_ApiVersionSet is the hub type for conversion
func (versionSet *Service_ApiVersionSet) Hub() {}
