...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_namedvalues,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_namedvalues/status,service_namedvalues/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_NamedValue
...
// Hub marks that this Service_NamedValue is the hub type for conversion
func (value *Service_NamedValue) Hub() {}
