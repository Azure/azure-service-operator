...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_subscriptions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_subscriptions/status,service_subscriptions/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_Subscription
...
type Service_Subscription struct {
...
var _ conditions.Conditioner = &Service_Subscription{}

// GetConditions returns the conditions of the resource
func (subscription *Service_Subscription) GetConditions() conditions.Conditions {
	return subscription.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (subscription *Service_Subscription) SetConditions(conditions conditions.Conditions) {
	subscription.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &Service_Subscription{}

// AzureName returns the Azure name of the resource
func (subscription *Service_Subscription) AzureName() string {
	return subscription.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (subscription Service_Subscription) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (subscription *Service_Subscription) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (subscription *Service_Subscription) GetSpec() genruntime.ConvertibleSpec {
	return &subscription.Spec
}

// GetStatus returns the status of this resource
func (subscription *Service_Subscription) GetStatus() genruntime.ConvertibleStatus {
	return &subscription.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/subscriptions"
func (subscription *Service_Subscription) GetType() string {
	return "Microsoft.ApiManagement/service/subscriptions"
}

// NewEmptyStatus returns a new empty (blank) status
func (subscription *Service_Subscription) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_Subscription_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (subscription *Service_Subscription) Owner() *genruntime.ResourceReference {
...
func (subscription *Service_Subscription) SetStatus(status genruntime.ConvertibleStatus) error {
...
// Hub marks that this Service_Subscription is the hub type for conversion
func (subscription *Service_Subscription) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (subscription *Service_Subscription) OriginalGVK() *schema.GroupVersionKind {
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimsubscriptions.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/subscriptions/{sid}
type Service_SubscriptionList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_Subscription `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_Subscription{}, &Service_SubscriptionList{})
}
