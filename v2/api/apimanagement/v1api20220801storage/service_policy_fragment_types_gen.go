...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_policyfragments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_policyfragments/status,service_policyfragments/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_PolicyFragment
...
type Service_PolicyFragment struct {
...
var _ conditions.Conditioner = &Service_PolicyFragment{}

// GetConditions returns the conditions of the resource
func (fragment *Service_PolicyFragment) GetConditions() conditions.Conditions {
	return fragment.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (fragment *Service_PolicyFragment) SetConditions(conditions conditions.Conditions) {
	fragment.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &Service_PolicyFragment{}

// AzureName returns the Azure name of the resource
func (fragment *Service_PolicyFragment) AzureName() string {
	return fragment.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (fragment Service_PolicyFragment) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (fragment *Service_PolicyFragment) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (fragment *Service_PolicyFragment) GetSpec() genruntime.ConvertibleSpec {
	return &fragment.Spec
}

// GetStatus returns the status of this resource
func (fragment *Service_PolicyFragment) GetStatus() genruntime.ConvertibleStatus {
	return &fragment.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/policyFragments"
func (fragment *Service_PolicyFragment) GetType() string {
	return "Microsoft.ApiManagement/service/policyFragments"
}

// NewEmptyStatus returns a new empty (blank) status
func (fragment *Service_PolicyFragment) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_PolicyFragment_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (fragment *Service_PolicyFragment) Owner() *genruntime.ResourceReference {
...
func (fragment *Service_PolicyFragment) SetStatus(status genruntime.ConvertibleStatus) error {
...
// Hub marks that this Service_PolicyFragment is the hub type for conversion
func (fragment *Service_PolicyFragment) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (fragment *Service_PolicyFragment) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: fragment.Spec.OriginalVersion,
		Kind:    "Service_PolicyFragment",
	}
}
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimpolicyfragments.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policyFragments/{id}
type Service_PolicyFragmentList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_PolicyFragment `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_PolicyFragment{}, &Service_PolicyFragmentList{})
}
