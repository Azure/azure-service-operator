...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_apis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_apis/status,service_apis/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_Api
...
var _ conditions.Conditioner = &Service_Api{}

// GetConditions returns the conditions of the resource
func (serviceApi *Service_Api) GetConditions() conditions.Conditions {
	return serviceApi.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (serviceApi *Service_Api) SetConditions(conditions conditions.Conditions) {
	serviceApi.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &Service_Api{}

// AzureName returns the Azure name of the resource
func (serviceApi *Service_Api) AzureName() string {
	return serviceApi.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (serviceApi Service_Api) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (serviceApi *Service_Api) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (serviceApi *Service_Api) GetSpec() genruntime.ConvertibleSpec {
	return &serviceApi.Spec
}

// GetStatus returns the status of this resource
func (serviceApi *Service_Api) GetStatus() genruntime.ConvertibleStatus {
	return &serviceApi.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/apis"
func (serviceApi *Service_Api) GetType() string {
	return "Microsoft.ApiManagement/service/apis"
}

// NewEmptyStatus returns a new empty (blank) status
func (serviceApi *Service_Api) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_Api_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (serviceApi *Service_Api) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(serviceApi.Spec)
	return serviceApi.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (serviceApi *Service_Api) SetStatus(status genruntime.ConvertibleStatus) error {
	// If we have exactly the right type of status, assign it
	if st, ok := status.(*Service_Api_STATUS); ok {
		serviceApi.Status = *st
		return nil
	}
...
// Hub marks that this Service_Api is the hub type for conversion
func (serviceApi *Service_Api) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (serviceApi *Service_Api) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: serviceApi.Spec.OriginalVersion,
		Kind:    "Service_Api",
	}
}
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimapis.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apis/{apiId}
type Service_ApiList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_Api `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_Api{}, &Service_ApiList{})
}
