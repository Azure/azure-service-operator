...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_products,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_products/status,service_products/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_Product
...
var _ conditions.Conditioner = &Service_Product{}

// GetConditions returns the conditions of the resource
func (product *Service_Product) GetConditions() conditions.Conditions {
	return product.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (product *Service_Product) SetConditions(conditions conditions.Conditions) {
	product.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &Service_Product{}

// AzureName returns the Azure name of the resource
func (product *Service_Product) AzureName() string {
	return product.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (product Service_Product) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (product *Service_Product) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (product *Service_Product) GetSpec() genruntime.ConvertibleSpec {
	return &product.Spec
}

// GetStatus returns the status of this resource
func (product *Service_Product) GetStatus() genruntime.ConvertibleStatus {
	return &product.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/products"
func (product *Service_Product) GetType() string {
	return "Microsoft.ApiManagement/service/products"
}

// NewEmptyStatus returns a new empty (blank) status
func (product *Service_Product) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_Product_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (product *Service_Product) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(product.Spec)
	return product.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (product *Service_Product) SetStatus(status genruntime.ConvertibleStatus) error {
...
// Hub marks that this Service_Product is the hub type for conversion
func (product *Service_Product) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (product *Service_Product) OriginalGVK() *schema.GroupVersionKind {
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimproducts.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/products/{productId}
type Service_ProductList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_Product `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_Product{}, &Service_ProductList{})
}
