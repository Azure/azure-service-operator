...
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources=service_backends,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apimanagement.azure.com,resources={service_backends/status,service_backends/finalizers},verbs=get;update;patch
...
// Storage version of v1api20220801.Service_Backend
...
var _ conditions.Conditioner = &Service_Backend{}

// GetConditions returns the conditions of the resource
func (backend *Service_Backend) GetConditions() conditions.Conditions {
	return backend.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (backend *Service_Backend) SetConditions(conditions conditions.Conditions) {
	backend.Status.Conditions = conditions
}

var _ genruntime.KubernetesResource = &Service_Backend{}

// AzureName returns the Azure name of the resource
func (backend *Service_Backend) AzureName() string {
	return backend.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (backend Service_Backend) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (backend *Service_Backend) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (backend *Service_Backend) GetSpec() genruntime.ConvertibleSpec {
	return &backend.Spec
}

// GetStatus returns the status of this resource
func (backend *Service_Backend) GetStatus() genruntime.ConvertibleStatus {
	return &backend.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/backends"
func (backend *Service_Backend) GetType() string {
	return "Microsoft.ApiManagement/service/backends"
}

// NewEmptyStatus returns a new empty (blank) status
func (backend *Service_Backend) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_Backend_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (backend *Service_Backend) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(backend.Spec)
	return backend.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (backend *Service_Backend) SetStatus(status genruntime.ConvertibleStatus) error {
...
// Hub marks that this Service_Backend is the hub type for conversion
func (backend *Service_Backend) Hub() {}

// OriginalGVK returns a GroupValueKind for the original API version used to create the resource
func (backend *Service_Backend) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: backend.Spec.OriginalVersion,
		Kind:    "Service_Backend",
	}
}
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimbackends.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/backends/{backendId}
type Service_BackendList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_Backend `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_Backend{}, &Service_BackendList{})
}
