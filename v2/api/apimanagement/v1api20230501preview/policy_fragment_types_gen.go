...
func (fragment *PolicyFragment) ConvertFrom(hub conversion.Hub) error {
	...
	var source v20230501ps.PolicyFragment
...
func (fragment *PolicyFragment) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20230501ps.PolicyFragment
...
func (fragment *PolicyFragment) AssignProperties_From_PolicyFragment(source *v20230501ps.PolicyFragment) error {
...
func (fragment *PolicyFragment) AssignProperties_To_PolicyFragment(destination *v20230501ps.PolicyFragment) error {

	// ObjectMeta
	destination.ObjectMeta = *fragment.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230501ps.Service_PolicyFragment_Spec
	...
	// Status
	var status v20230501ps.Service_PolicyFragment_STATUS
...
func (fragment *Service_PolicyFragment_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230501ps.Service_PolicyFragment_Spec)
	if ok {
	...
	src = &v20230501ps.Service_PolicyFragment_Spec{}
...
func (fragment *Service_PolicyFragment_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230501ps.Service_PolicyFragment_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_PolicyFragment_Spec{}
...
func (fragment *Service_PolicyFragment_Spec) AssignProperties_From_Service_PolicyFragment_Spec(source *v20230501ps.Service_PolicyFragment_Spec) error {
...
func (fragment *Service_PolicyFragment_Spec) AssignProperties_To_Service_PolicyFragment_Spec(destination *v20230501ps.Service_PolicyFragment_Spec) error {
...
func (fragment *Service_PolicyFragment_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230501ps.Service_PolicyFragment_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230501ps.Service_PolicyFragment_STATUS{}
...
func (fragment *Service_PolicyFragment_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230501ps.Service_PolicyFragment_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_PolicyFragment_STATUS{}
...
func (fragment *Service_PolicyFragment_STATUS) AssignProperties_From_Service_PolicyFragment_STATUS(source *v20230501ps.Service_PolicyFragment_STATUS) error {
...
func (fragment *Service_PolicyFragment_STATUS) AssignProperties_To_Service_PolicyFragment_STATUS(destination *v20230501ps.Service_PolicyFragment_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
