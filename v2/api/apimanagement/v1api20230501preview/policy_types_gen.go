...
func (policy *Policy) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v20230501ps.Policy
...
func (policy *Policy) AssignProperties_From_Policy(source *v20230501ps.Policy) error {
...
func (policy *Policy) AssignProperties_To_Policy(destination *v20230501ps.Policy) error {

	// ObjectMeta
	destination.ObjectMeta = *policy.ObjectMeta.DeepCopy()

	// Spec
	var spec v20230501ps.Service_Policy_Spec
	...
	// Status
	var status v20230501ps.Service_Policy_STATUS
...
func (policy *Service_Policy_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20230501ps.Service_Policy_Spec)
	if ok {
	...
	src = &v20230501ps.Service_Policy_Spec{}
...
func (policy *Service_Policy_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20230501ps.Service_Policy_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_Policy_Spec{}
...
func (policy *Service_Policy_Spec) AssignProperties_From_Service_Policy_Spec(source *v20230501ps.Service_Policy_Spec) error {
...
func (policy *Service_Policy_Spec) AssignProperties_To_Service_Policy_Spec(destination *v20230501ps.Service_Policy_Spec) error {
...
func (policy *Service_Policy_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20230501ps.Service_Policy_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20230501ps.Service_Policy_STATUS{}
...
func (policy *Service_Policy_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20230501ps.Service_Policy_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20230501ps.Service_Policy_STATUS{}
...
func (policy *Service_Policy_STATUS) AssignProperties_From_Service_Policy_STATUS(source *v20230501ps.Service_Policy_STATUS) error {
...
func (policy *Service_Policy_STATUS) AssignProperties_To_Service_Policy_STATUS(destination *v20230501ps.Service_Policy_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
