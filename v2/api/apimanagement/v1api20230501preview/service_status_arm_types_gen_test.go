...
func AddIndependentPropertyGeneratorsForAdditionalLocation_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["PlatformVersion"] = gen.PtrOf(gen.OneConstOf(
		...
		AdditionalLocation_PlatformVersion_STATUS_ARM_Stv21,
...
func AddIndependentPropertyGeneratorsForApiManagementServiceProperties_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["CustomProperties"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
	gens["DeveloperPortalStatus"] = gen.PtrOf(gen.OneConstOf(ApiManagementServiceProperties_DeveloperPortalStatus_STATUS_ARM_Disabled, ApiManagementServiceProperties_DeveloperPortalStatus_STATUS_ARM_Enabled))
	...
	gens["LegacyPortalStatus"] = gen.PtrOf(gen.OneConstOf(ApiManagementServiceProperties_LegacyPortalStatus_STATUS_ARM_Disabled, ApiManagementServiceProperties_LegacyPortalStatus_STATUS_ARM_Enabled))
	...
	gens["PlatformVersion"] = gen.PtrOf(gen.OneConstOf(
		...
		ApiManagementServiceProperties_PlatformVersion_STATUS_ARM_Stv21,
...
func AddIndependentPropertyGeneratorsForApiManagementServiceSkuProperties_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.OneConstOf(
		...
		ApiManagementServiceSkuProperties_Name_STATUS_ARM_BasicV2,
		...
		ApiManagementServiceSkuProperties_Name_STATUS_ARM_StandardV2))
}
...
func AddIndependentPropertyGeneratorsForConfigurationApi_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["LegacyApi"] = gen.PtrOf(gen.OneConstOf(ConfigurationApi_LegacyApi_STATUS_ARM_Disabled, ConfigurationApi_LegacyApi_STATUS_ARM_Enabled))
}
...
func AddIndependentPropertyGeneratorsForHostnameConfiguration_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(
		HostnameConfiguration_Type_STATUS_ARM_ConfigurationApi,
