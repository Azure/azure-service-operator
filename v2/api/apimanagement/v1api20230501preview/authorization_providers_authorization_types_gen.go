...
func (authorization *Service_AuthorizationProviders_Authorization_Spec) AssignProperties_To_Service_AuthorizationProviders_Authorization_Spec(destination *v20230501ps.Service_AuthorizationProviders_Authorization_Spec) error {
	...
	// Error
	if authorization.Error != nil {
		var error v20230501ps.AuthorizationError
...
func (error *AuthorizationError) AssignProperties_From_AuthorizationError(source *v20230501ps.AuthorizationError) error {
...
func (error *AuthorizationError) AssignProperties_To_AuthorizationError(destination *v20230501ps.AuthorizationError) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
