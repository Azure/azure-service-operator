...
var _ conditions.Conditioner = &Service_Policy{}

// GetConditions returns the conditions of the resource
func (policy *Service_Policy) GetConditions() conditions.Conditions {
	return policy.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (policy *Service_Policy) SetConditions(conditions conditions.Conditions) {
	policy.Status.Conditions = conditions
}

var _ conversion.Convertible = &Service_Policy{}

// ConvertFrom populates our Service_Policy from the provided hub Service_Policy
func (policy *Service_Policy) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_Policy)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Policy but received %T instead", hub)
	}

	return policy.AssignProperties_From_Service_Policy(source)
}

// ConvertTo populates the provided hub Service_Policy from our Service_Policy
func (policy *Service_Policy) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_Policy)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Policy but received %T instead", hub)
	}

	return policy.AssignProperties_To_Service_Policy(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_policy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_policies,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_policies.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_Policy{}

// Default applies defaults to the Service_Policy resource
func (policy *Service_Policy) Default() {
	policy.defaultImpl()
	var temp any = policy
...
// defaultImpl applies the code generated defaults to the Service_Policy resource
func (policy *Service_Policy) defaultImpl() {}

var _ genruntime.ImportableResource = &Service_Policy{}

// InitializeSpec initializes the spec for this resource from the given status
func (policy *Service_Policy) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
var _ genruntime.KubernetesResource = &Service_Policy{}

// AzureName returns the Azure name of the resource (always "policy")
func (policy *Service_Policy) AzureName() string {
	return "policy"
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (policy Service_Policy) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (policy *Service_Policy) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (policy *Service_Policy) GetSpec() genruntime.ConvertibleSpec {
	return &policy.Spec
}

// GetStatus returns the status of this resource
func (policy *Service_Policy) GetStatus() genruntime.ConvertibleStatus {
	return &policy.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/policies"
func (policy *Service_Policy) GetType() string {
	return "Microsoft.ApiManagement/service/policies"
}

// NewEmptyStatus returns a new empty (blank) status
func (policy *Service_Policy) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_Policy_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (policy *Service_Policy) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(policy.Spec)
	return policy.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (policy *Service_Policy) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_policy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_policies,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_policies.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_Policy{}

// ValidateCreate validates the creation of the resource
func (policy *Service_Policy) ValidateCreate() (admission.Warnings, error) {
...
func (policy *Service_Policy) ValidateDelete() (admission.Warnings, error) {
...
func (policy *Service_Policy) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (policy *Service_Policy) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){policy.validateResourceReferences, policy.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (policy *Service_Policy) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (policy *Service_Policy) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (policy *Service_Policy) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(policy)
}

// validateResourceReferences validates all resource references
func (policy *Service_Policy) validateResourceReferences() (admission.Warnings, error) {
...
func (policy *Service_Policy) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_Policy)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_Policy populates our Service_Policy from the provided source Service_Policy
func (policy *Service_Policy) AssignProperties_From_Service_Policy(source *v20220801s.Service_Policy) error {
...
// AssignProperties_To_Service_Policy populates the provided destination Service_Policy from our Service_Policy
func (policy *Service_Policy) AssignProperties_To_Service_Policy(destination *v20220801s.Service_Policy) error {
...
func (policy *Service_Policy) OriginalGVK() *schema.GroupVersionKind {
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimpolicies.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/policies/{policyId}
type Service_PolicyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_Policy `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_Policy{}, &Service_PolicyList{})
}
