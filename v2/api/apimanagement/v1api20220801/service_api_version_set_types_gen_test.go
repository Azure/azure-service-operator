...
func Test_Service_ApiVersionSet_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from Service_ApiVersionSet to hub returns original",
		prop.ForAll(RunResourceConversionTestForService_ApiVersionSet, Service_ApiVersionSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForService_ApiVersionSet tests if a specific instance of Service_ApiVersionSet round trips to the hub storage version and back losslessly
func RunResourceConversionTestForService_ApiVersionSet(subject Service_ApiVersionSet) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20220801s.Service_ApiVersionSet
...
func Test_Service_ApiVersionSet_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Service_ApiVersionSet to Service_ApiVersionSet via AssignProperties_To_Service_ApiVersionSet & AssignProperties_From_Service_ApiVersionSet returns original",
		prop.ForAll(RunPropertyAssignmentTestForService_ApiVersionSet, Service_ApiVersionSetGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForService_ApiVersionSet tests if a specific instance of Service_ApiVersionSet can be assigned to v1api20220801storage and back losslessly
func RunPropertyAssignmentTestForService_ApiVersionSet(subject Service_ApiVersionSet) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801s.Service_ApiVersionSet
	err := copied.AssignProperties_To_Service_ApiVersionSet(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual Service_ApiVersionSet
	err = actual.AssignProperties_From_Service_ApiVersionSet(&other)
	if err != nil {
		return err.Error()
	}
