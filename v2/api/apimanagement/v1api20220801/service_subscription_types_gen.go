...
var _ conversion.Convertible = &Service_Subscription{}

// ConvertFrom populates our Service_Subscription from the provided hub Service_Subscription
func (subscription *Service_Subscription) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_Subscription)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Subscription but received %T instead", hub)
	}

	return subscription.AssignProperties_From_Service_Subscription(source)
}

// ConvertTo populates the provided hub Service_Subscription from our Service_Subscription
func (subscription *Service_Subscription) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_Subscription)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Subscription but received %T instead", hub)
	}

	return subscription.AssignProperties_To_Service_Subscription(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_subscription,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_subscriptions,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_subscriptions.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_Subscription{}

// Default applies defaults to the Service_Subscription resource
func (subscription *Service_Subscription) Default() {
...
func (subscription *Service_Subscription) defaultAzureName() {
	if subscription.Spec.AzureName == "" {
		subscription.Spec.AzureName = subscription.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_Subscription resource
func (subscription *Service_Subscription) defaultImpl() { subscription.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_Subscription{}

// InitializeSpec initializes the spec for this resource from the given status
func (subscription *Service_Subscription) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_subscription,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_subscriptions,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_subscriptions.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_Subscription{}

// ValidateCreate validates the creation of the resource
func (subscription *Service_Subscription) ValidateCreate() (admission.Warnings, error) {
...
func (subscription *Service_Subscription) ValidateDelete() (admission.Warnings, error) {
...
func (subscription *Service_Subscription) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (subscription *Service_Subscription) createValidations() []func() (admission.Warnings, error) {
...
func (subscription *Service_Subscription) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (subscription *Service_Subscription) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (subscription *Service_Subscription) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(subscription)
}

// validateResourceReferences validates all resource references
func (subscription *Service_Subscription) validateResourceReferences() (admission.Warnings, error) {
...
func (subscription *Service_Subscription) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_Subscription)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_Subscription populates our Service_Subscription from the provided source Service_Subscription
func (subscription *Service_Subscription) AssignProperties_From_Service_Subscription(source *v20220801s.Service_Subscription) error {
...
// AssignProperties_To_Service_Subscription populates the provided destination Service_Subscription from our Service_Subscription
func (subscription *Service_Subscription) AssignProperties_To_Service_Subscription(destination *v20220801s.Service_Subscription) error {
