...
var _ conversion.Convertible = &Service_Api{}

// ConvertFrom populates our Service_Api from the provided hub Service_Api
func (serviceApi *Service_Api) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_Api)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Api but received %T instead", hub)
	}

	return serviceApi.AssignProperties_From_Service_Api(source)
}

// ConvertTo populates the provided hub Service_Api from our Service_Api
func (serviceApi *Service_Api) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_Api)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Api but received %T instead", hub)
	}

	return serviceApi.AssignProperties_To_Service_Api(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_api,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_apis,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_apis.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_Api{}

// Default applies defaults to the Service_Api resource
func (serviceApi *Service_Api) Default() {
	serviceApi.defaultImpl()
	var temp any = serviceApi
...
func (serviceApi *Service_Api) defaultAzureName() {
	if serviceApi.Spec.AzureName == "" {
		serviceApi.Spec.AzureName = serviceApi.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_Api resource
func (serviceApi *Service_Api) defaultImpl() { serviceApi.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_Api{}

// InitializeSpec initializes the spec for this resource from the given status
func (serviceApi *Service_Api) InitializeSpec(status genruntime.ConvertibleStatus) error {
	if s, ok := status.(*Service_Api_STATUS); ok {
		return serviceApi.Spec.Initialize_From_Service_Api_STATUS(s)
	}
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_api,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_apis,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_apis.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_Api{}

// ValidateCreate validates the creation of the resource
func (serviceApi *Service_Api) ValidateCreate() (admission.Warnings, error) {
	validations := serviceApi.createValidations()
	var temp any = serviceApi
...
func (serviceApi *Service_Api) ValidateDelete() (admission.Warnings, error) {
	validations := serviceApi.deleteValidations()
	var temp any = serviceApi
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (serviceApi *Service_Api) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
	validations := serviceApi.updateValidations()
	var temp any = serviceApi
	if runtimeValidator, ok := temp.(genruntime.Validator); ok {
...
func (serviceApi *Service_Api) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){serviceApi.validateResourceReferences, serviceApi.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (serviceApi *Service_Api) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (serviceApi *Service_Api) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
	return []func(old runtime.Object) (admission.Warnings, error){
		func(old runtime.Object) (admission.Warnings, error) {
			return serviceApi.validateResourceReferences()
		},
		serviceApi.validateWriteOnceProperties,
		func(old runtime.Object) (admission.Warnings, error) {
			return serviceApi.validateOwnerReference()
		},
	}
}

// validateOwnerReference validates the owner field
func (serviceApi *Service_Api) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(serviceApi)
}

// validateResourceReferences validates all resource references
func (serviceApi *Service_Api) validateResourceReferences() (admission.Warnings, error) {
	refs, err := reflecthelpers.FindResourceReferences(&serviceApi.Spec)
	if err != nil {
		return nil, err
	}
...
func (serviceApi *Service_Api) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_Api)
	if !ok {
		return nil, nil
	}

	return genruntime.ValidateWriteOnceProperties(oldObj, serviceApi)
}

// AssignProperties_From_Service_Api populates our Service_Api from the provided source Service_Api
func (serviceApi *Service_Api) AssignProperties_From_Service_Api(source *v20220801s.Service_Api) error {

	// ObjectMeta
	serviceApi.ObjectMeta = *source.ObjectMeta.DeepCopy()
	...
	serviceApi.Status = status

	// No error
	return nil
}

// AssignProperties_To_Service_Api populates the provided destination Service_Api from our Service_Api
func (serviceApi *Service_Api) AssignProperties_To_Service_Api(destination *v20220801s.Service_Api) error {

	// ObjectMeta
	destination.ObjectMeta = *serviceApi.ObjectMeta.DeepCopy()

	// Spec
	var spec v20220801s.Service_Api_Spec
	err := serviceApi.Spec.AssignProperties_To_Service_Api_Spec(&spec)
	if err != nil {
	...
	err = serviceApi.Status.AssignProperties_To_Service_Api_STATUS(&status)
	if err != nil {
