...
type Service_ApiVersionSet struct {
...
var _ conditions.Conditioner = &Service_ApiVersionSet{}

// GetConditions returns the conditions of the resource
func (versionSet *Service_ApiVersionSet) GetConditions() conditions.Conditions {
	return versionSet.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (versionSet *Service_ApiVersionSet) SetConditions(conditions conditions.Conditions) {
	versionSet.Status.Conditions = conditions
}

var _ conversion.Convertible = &Service_ApiVersionSet{}

// ConvertFrom populates our Service_ApiVersionSet from the provided hub Service_ApiVersionSet
func (versionSet *Service_ApiVersionSet) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_ApiVersionSet)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_ApiVersionSet but received %T instead", hub)
	}

	return versionSet.AssignProperties_From_Service_ApiVersionSet(source)
}

// ConvertTo populates the provided hub Service_ApiVersionSet from our Service_ApiVersionSet
func (versionSet *Service_ApiVersionSet) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_ApiVersionSet)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_ApiVersionSet but received %T instead", hub)
	}

	return versionSet.AssignProperties_To_Service_ApiVersionSet(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_apiversionset,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_apiversionsets,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_apiversionsets.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_ApiVersionSet{}

// Default applies defaults to the Service_ApiVersionSet resource
func (versionSet *Service_ApiVersionSet) Default() {
...
func (versionSet *Service_ApiVersionSet) defaultAzureName() {
	if versionSet.Spec.AzureName == "" {
		versionSet.Spec.AzureName = versionSet.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_ApiVersionSet resource
func (versionSet *Service_ApiVersionSet) defaultImpl() { versionSet.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_ApiVersionSet{}

// InitializeSpec initializes the spec for this resource from the given status
func (versionSet *Service_ApiVersionSet) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
var _ genruntime.KubernetesResource = &Service_ApiVersionSet{}

// AzureName returns the Azure name of the resource
func (versionSet *Service_ApiVersionSet) AzureName() string {
	return versionSet.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (versionSet Service_ApiVersionSet) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (versionSet *Service_ApiVersionSet) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (versionSet *Service_ApiVersionSet) GetSpec() genruntime.ConvertibleSpec {
	return &versionSet.Spec
}

// GetStatus returns the status of this resource
func (versionSet *Service_ApiVersionSet) GetStatus() genruntime.ConvertibleStatus {
...
func (versionSet *Service_ApiVersionSet) GetType() string {
	return "Microsoft.ApiManagement/service/apiVersionSets"
}

// NewEmptyStatus returns a new empty (blank) status
func (versionSet *Service_ApiVersionSet) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_ApiVersionSet_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (versionSet *Service_ApiVersionSet) Owner() *genruntime.ResourceReference {
...
func (versionSet *Service_ApiVersionSet) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_apiversionset,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_apiversionsets,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_apiversionsets.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_ApiVersionSet{}

// ValidateCreate validates the creation of the resource
func (versionSet *Service_ApiVersionSet) ValidateCreate() (admission.Warnings, error) {
...
func (versionSet *Service_ApiVersionSet) ValidateDelete() (admission.Warnings, error) {
...
func (versionSet *Service_ApiVersionSet) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (versionSet *Service_ApiVersionSet) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){versionSet.validateResourceReferences, versionSet.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (versionSet *Service_ApiVersionSet) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (versionSet *Service_ApiVersionSet) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (versionSet *Service_ApiVersionSet) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(versionSet)
}

// validateResourceReferences validates all resource references
func (versionSet *Service_ApiVersionSet) validateResourceReferences() (admission.Warnings, error) {
...
func (versionSet *Service_ApiVersionSet) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_ApiVersionSet)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_ApiVersionSet populates our Service_ApiVersionSet from the provided source Service_ApiVersionSet
func (versionSet *Service_ApiVersionSet) AssignProperties_From_Service_ApiVersionSet(source *v20220801s.Service_ApiVersionSet) error {
...
// AssignProperties_To_Service_ApiVersionSet populates the provided destination Service_ApiVersionSet from our Service_ApiVersionSet
func (versionSet *Service_ApiVersionSet) AssignProperties_To_Service_ApiVersionSet(destination *v20220801s.Service_ApiVersionSet) error {
...
func (versionSet *Service_ApiVersionSet) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: versionSet.Spec.OriginalVersion(),
		Kind:    "Service_ApiVersionSet",
	}
}
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimapiversionsets.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/apiVersionSets/{versionSetId}
type Service_ApiVersionSetList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_ApiVersionSet `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_ApiVersionSet{}, &Service_ApiVersionSetList{})
}
