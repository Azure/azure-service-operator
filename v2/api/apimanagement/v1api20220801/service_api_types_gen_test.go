...
func Test_Service_Api_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from Service_Api to hub returns original",
		prop.ForAll(RunResourceConversionTestForService_Api, Service_ApiGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForService_Api tests if a specific instance of Service_Api round trips to the hub storage version and back losslessly
func RunResourceConversionTestForService_Api(subject Service_Api) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20220801s.Service_Api
...
func Test_Service_Api_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Service_Api to Service_Api via AssignProperties_To_Service_Api & AssignProperties_From_Service_Api returns original",
		prop.ForAll(RunPropertyAssignmentTestForService_Api, Service_ApiGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForService_Api tests if a specific instance of Service_Api can be assigned to v1api20220801storage and back losslessly
func RunPropertyAssignmentTestForService_Api(subject Service_Api) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801s.Service_Api
	err := copied.AssignProperties_To_Service_Api(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual Service_Api
	err = actual.AssignProperties_From_Service_Api(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Service_Api_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Service_Api via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForService_Api, Service_ApiGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForService_Api runs a test to see if a specific instance of Service_Api round trips to JSON and back losslessly
func RunJSONSerializationTestForService_Api(subject Service_Api) string {
	// Serialize to JSON
...
// Generator of Service_Api instances for property testing - lazily instantiated by Service_ApiGenerator()
var service_ApiGenerator gopter.Gen

// Service_ApiGenerator returns a generator of Service_Api instances for property testing.
func Service_ApiGenerator() gopter.Gen {
	if service_ApiGenerator != nil {
		return service_ApiGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForService_Api(generators)
	service_ApiGenerator = gen.Struct(reflect.TypeOf(Service_Api{}), generators)

	return service_ApiGenerator
}

// AddRelatedPropertyGeneratorsForService_Api is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_Api(gens map[string]gopter.Gen) {
