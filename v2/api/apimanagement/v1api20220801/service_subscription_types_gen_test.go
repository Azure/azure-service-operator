...
func Test_Service_Subscription_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from Service_Subscription to hub returns original",
		prop.ForAll(RunResourceConversionTestForService_Subscription, Service_SubscriptionGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForService_Subscription tests if a specific instance of Service_Subscription round trips to the hub storage version and back losslessly
func RunResourceConversionTestForService_Subscription(subject Service_Subscription) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20220801s.Service_Subscription
	...
	var actual Service_Subscription
...
func Test_Service_Subscription_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Service_Subscription to Service_Subscription via AssignProperties_To_Service_Subscription & AssignProperties_From_Service_Subscription returns original",
		prop.ForAll(RunPropertyAssignmentTestForService_Subscription, Service_SubscriptionGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForService_Subscription tests if a specific instance of Service_Subscription can be assigned to v1api20220801storage and back losslessly
func RunPropertyAssignmentTestForService_Subscription(subject Service_Subscription) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801s.Service_Subscription
	err := copied.AssignProperties_To_Service_Subscription(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual Service_Subscription
	err = actual.AssignProperties_From_Service_Subscription(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Service_Subscription_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Service_Subscription via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForService_Subscription, Service_SubscriptionGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForService_Subscription runs a test to see if a specific instance of Service_Subscription round trips to JSON and back losslessly
func RunJSONSerializationTestForService_Subscription(subject Service_Subscription) string {
	// Serialize to JSON
...
// Generator of Service_Subscription instances for property testing - lazily instantiated by
// Service_SubscriptionGenerator()
var service_SubscriptionGenerator gopter.Gen

// Service_SubscriptionGenerator returns a generator of Service_Subscription instances for property testing.
func Service_SubscriptionGenerator() gopter.Gen {
	if service_SubscriptionGenerator != nil {
		return service_SubscriptionGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForService_Subscription(generators)
	service_SubscriptionGenerator = gen.Struct(reflect.TypeOf(Service_Subscription{}), generators)

	return service_SubscriptionGenerator
}

// AddRelatedPropertyGeneratorsForService_Subscription is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_Subscription(gens map[string]gopter.Gen) {
