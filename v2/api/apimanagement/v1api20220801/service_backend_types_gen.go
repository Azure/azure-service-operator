...
var _ conversion.Convertible = &Service_Backend{}

// ConvertFrom populates our Service_Backend from the provided hub Service_Backend
func (backend *Service_Backend) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_Backend)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Backend but received %T instead", hub)
	}

	return backend.AssignProperties_From_Service_Backend(source)
}

// ConvertTo populates the provided hub Service_Backend from our Service_Backend
func (backend *Service_Backend) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_Backend)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Backend but received %T instead", hub)
	}

	return backend.AssignProperties_To_Service_Backend(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_backend,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_backends,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_backends.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_Backend{}

// Default applies defaults to the Service_Backend resource
func (backend *Service_Backend) Default() {
	backend.defaultImpl()
...
func (backend *Service_Backend) defaultAzureName() {
	if backend.Spec.AzureName == "" {
		backend.Spec.AzureName = backend.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_Backend resource
func (backend *Service_Backend) defaultImpl() { backend.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_Backend{}

// InitializeSpec initializes the spec for this resource from the given status
func (backend *Service_Backend) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_backend,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_backends,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_backends.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_Backend{}

// ValidateCreate validates the creation of the resource
func (backend *Service_Backend) ValidateCreate() (admission.Warnings, error) {
...
func (backend *Service_Backend) ValidateDelete() (admission.Warnings, error) {
...
func (backend *Service_Backend) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (backend *Service_Backend) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){backend.validateResourceReferences, backend.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (backend *Service_Backend) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (backend *Service_Backend) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (backend *Service_Backend) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(backend)
}

// validateResourceReferences validates all resource references
func (backend *Service_Backend) validateResourceReferences() (admission.Warnings, error) {
...
func (backend *Service_Backend) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_Backend)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_Backend populates our Service_Backend from the provided source Service_Backend
func (backend *Service_Backend) AssignProperties_From_Service_Backend(source *v20220801s.Service_Backend) error {
...
// AssignProperties_To_Service_Backend populates the provided destination Service_Backend from our Service_Backend
func (backend *Service_Backend) AssignProperties_To_Service_Backend(destination *v20220801s.Service_Backend) error {
