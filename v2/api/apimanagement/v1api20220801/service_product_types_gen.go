...
var _ conversion.Convertible = &Service_Product{}

// ConvertFrom populates our Service_Product from the provided hub Service_Product
func (product *Service_Product) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_Product)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Product but received %T instead", hub)
	}

	return product.AssignProperties_From_Service_Product(source)
}

// ConvertTo populates the provided hub Service_Product from our Service_Product
func (product *Service_Product) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_Product)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_Product but received %T instead", hub)
	}

	return product.AssignProperties_To_Service_Product(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_product,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_products,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_products.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_Product{}

// Default applies defaults to the Service_Product resource
func (product *Service_Product) Default() {
	product.defaultImpl()
...
func (product *Service_Product) defaultAzureName() {
	if product.Spec.AzureName == "" {
		product.Spec.AzureName = product.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_Product resource
func (product *Service_Product) defaultImpl() { product.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_Product{}

// InitializeSpec initializes the spec for this resource from the given status
func (product *Service_Product) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_product,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_products,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_products.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_Product{}

// ValidateCreate validates the creation of the resource
func (product *Service_Product) ValidateCreate() (admission.Warnings, error) {
...
func (product *Service_Product) ValidateDelete() (admission.Warnings, error) {
...
func (product *Service_Product) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (product *Service_Product) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){product.validateResourceReferences, product.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (product *Service_Product) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (product *Service_Product) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (product *Service_Product) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(product)
}

// validateResourceReferences validates all resource references
func (product *Service_Product) validateResourceReferences() (admission.Warnings, error) {
...
func (product *Service_Product) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_Product)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_Product populates our Service_Product from the provided source Service_Product
func (product *Service_Product) AssignProperties_From_Service_Product(source *v20220801s.Service_Product) error {
...
// AssignProperties_To_Service_Product populates the provided destination Service_Product from our Service_Product
func (product *Service_Product) AssignProperties_To_Service_Product(destination *v20220801s.Service_Product) error {
