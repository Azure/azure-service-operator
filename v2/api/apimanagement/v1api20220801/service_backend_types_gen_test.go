...
func Test_Service_Backend_WhenConvertedToHub_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from Service_Backend to hub returns original",
		prop.ForAll(RunResourceConversionTestForService_Backend, Service_BackendGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunResourceConversionTestForService_Backend tests if a specific instance of Service_Backend round trips to the hub storage version and back losslessly
func RunResourceConversionTestForService_Backend(subject Service_Backend) string {
	// Copy subject to make sure conversion doesn't modify it
	copied := subject.DeepCopy()

	// Convert to our hub version
	var hub v20220801s.Service_Backend
...
func Test_Service_Backend_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Service_Backend to Service_Backend via AssignProperties_To_Service_Backend & AssignProperties_From_Service_Backend returns original",
		prop.ForAll(RunPropertyAssignmentTestForService_Backend, Service_BackendGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForService_Backend tests if a specific instance of Service_Backend can be assigned to v1api20220801storage and back losslessly
func RunPropertyAssignmentTestForService_Backend(subject Service_Backend) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801s.Service_Backend
	err := copied.AssignProperties_To_Service_Backend(&other)
	if err != nil {
		return err.Error()
	}
	...
	var actual Service_Backend
	err = actual.AssignProperties_From_Service_Backend(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Service_Backend_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Service_Backend via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForService_Backend, Service_BackendGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForService_Backend runs a test to see if a specific instance of Service_Backend round trips to JSON and back losslessly
func RunJSONSerializationTestForService_Backend(subject Service_Backend) string {
	// Serialize to JSON
...
// Generator of Service_Backend instances for property testing - lazily instantiated by Service_BackendGenerator()
var service_BackendGenerator gopter.Gen

// Service_BackendGenerator returns a generator of Service_Backend instances for property testing.
func Service_BackendGenerator() gopter.Gen {
	if service_BackendGenerator != nil {
		return service_BackendGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForService_Backend(generators)
	service_BackendGenerator = gen.Struct(reflect.TypeOf(Service_Backend{}), generators)

	return service_BackendGenerator
}

// AddRelatedPropertyGeneratorsForService_Backend is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForService_Backend(gens map[string]gopter.Gen) {
