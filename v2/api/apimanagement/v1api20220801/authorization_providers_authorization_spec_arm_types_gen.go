...
type AuthorizationProvidersAuthorization_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &AuthorizationProvidersAuthorization_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (authorization AuthorizationProvidersAuthorization_Spec_ARM) GetAPIVersion() string {
	return "2022-08-01"
}

// GetName returns the Name of the resource
func (authorization *AuthorizationProvidersAuthorization_Spec_ARM) GetName() string {
...
func (authorization *AuthorizationProvidersAuthorization_Spec_ARM) GetType() string {
