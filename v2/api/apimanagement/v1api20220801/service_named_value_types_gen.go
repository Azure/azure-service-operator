...
type Service_NamedValue struct {
...
var _ conditions.Conditioner = &Service_NamedValue{}

// GetConditions returns the conditions of the resource
func (value *Service_NamedValue) GetConditions() conditions.Conditions {
	return value.Status.Conditions
}

// SetConditions sets the conditions on the resource status
func (value *Service_NamedValue) SetConditions(conditions conditions.Conditions) {
	value.Status.Conditions = conditions
}

var _ conversion.Convertible = &Service_NamedValue{}

// ConvertFrom populates our Service_NamedValue from the provided hub Service_NamedValue
func (value *Service_NamedValue) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_NamedValue)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_NamedValue but received %T instead", hub)
	}

	return value.AssignProperties_From_Service_NamedValue(source)
}

// ConvertTo populates the provided hub Service_NamedValue from our Service_NamedValue
func (value *Service_NamedValue) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_NamedValue)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_NamedValue but received %T instead", hub)
	}

	return value.AssignProperties_To_Service_NamedValue(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_namedvalue,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_namedvalues,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_namedvalues.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_NamedValue{}

// Default applies defaults to the Service_NamedValue resource
func (value *Service_NamedValue) Default() {
	value.defaultImpl()
	var temp any = value
...
func (value *Service_NamedValue) defaultAzureName() {
	if value.Spec.AzureName == "" {
		value.Spec.AzureName = value.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_NamedValue resource
func (value *Service_NamedValue) defaultImpl() { value.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_NamedValue{}

// InitializeSpec initializes the spec for this resource from the given status
func (value *Service_NamedValue) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
var _ genruntime.KubernetesResource = &Service_NamedValue{}

// AzureName returns the Azure name of the resource
func (value *Service_NamedValue) AzureName() string {
	return value.Spec.AzureName
}

// GetAPIVersion returns the ARM API version of the resource. This is always "2022-08-01"
func (value Service_NamedValue) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetResourceScope returns the scope of the resource
func (value *Service_NamedValue) GetResourceScope() genruntime.ResourceScope {
	return genruntime.ResourceScopeResourceGroup
}

// GetSpec returns the specification of this resource
func (value *Service_NamedValue) GetSpec() genruntime.ConvertibleSpec {
	return &value.Spec
}

// GetStatus returns the status of this resource
func (value *Service_NamedValue) GetStatus() genruntime.ConvertibleStatus {
	return &value.Status
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.ApiManagement/service/namedValues"
func (value *Service_NamedValue) GetType() string {
	return "Microsoft.ApiManagement/service/namedValues"
}

// NewEmptyStatus returns a new empty (blank) status
func (value *Service_NamedValue) NewEmptyStatus() genruntime.ConvertibleStatus {
	return &Service_NamedValue_STATUS{}
}

// Owner returns the ResourceReference of the owner
func (value *Service_NamedValue) Owner() *genruntime.ResourceReference {
	group, kind := genruntime.LookupOwnerGroupKind(value.Spec)
	return value.Spec.Owner.AsResourceReference(group, kind)
}

// SetStatus sets the status of this resource
func (value *Service_NamedValue) SetStatus(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_namedvalue,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_namedvalues,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_namedvalues.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_NamedValue{}

// ValidateCreate validates the creation of the resource
func (value *Service_NamedValue) ValidateCreate() (admission.Warnings, error) {
...
func (value *Service_NamedValue) ValidateDelete() (admission.Warnings, error) {
...
func (value *Service_NamedValue) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (value *Service_NamedValue) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){value.validateResourceReferences, value.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (value *Service_NamedValue) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (value *Service_NamedValue) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (value *Service_NamedValue) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(value)
}

// validateResourceReferences validates all resource references
func (value *Service_NamedValue) validateResourceReferences() (admission.Warnings, error) {
...
func (value *Service_NamedValue) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_NamedValue)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_NamedValue populates our Service_NamedValue from the provided source Service_NamedValue
func (value *Service_NamedValue) AssignProperties_From_Service_NamedValue(source *v20220801s.Service_NamedValue) error {
...
// AssignProperties_To_Service_NamedValue populates the provided destination Service_NamedValue from our Service_NamedValue
func (value *Service_NamedValue) AssignProperties_To_Service_NamedValue(destination *v20220801s.Service_NamedValue) error {
...
func (value *Service_NamedValue) OriginalGVK() *schema.GroupVersionKind {
	return &schema.GroupVersionKind{
		Group:   GroupVersion.Group,
		Version: value.Spec.OriginalVersion(),
		Kind:    "Service_NamedValue",
	}
}
...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2022-08-01/apimnamedvalues.json
// - ARM URI: /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/namedValues/{namedValueId}
type Service_NamedValueList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []Service_NamedValue `json:"items"`
}
...
func init() {
	SchemeBuilder.Register(&Service_NamedValue{}, &Service_NamedValueList{})
}
