...
type ApiManagementServiceProperties_ARM struct {
	...
	PrivateEndpointConnections []RemotePrivateEndpointConnectionWrapper_ARM `json:"privateEndpointConnections,omitempty"`
...
type RemotePrivateEndpointConnectionWrapper_ARM struct {
	...
	Properties *PrivateEndpointConnectionWrapperProperties_ARM `json:"properties,omitempty"`
...
type PrivateEndpointConnectionWrapperProperties_ARM struct {
