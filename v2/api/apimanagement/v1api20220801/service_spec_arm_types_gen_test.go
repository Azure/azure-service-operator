...
func AddRelatedPropertyGeneratorsForApiManagementServiceProperties_ARM(gens map[string]gopter.Gen) {
	...
	gens["PrivateEndpointConnections"] = gen.SliceOf(RemotePrivateEndpointConnectionWrapper_ARMGenerator())
...
func Test_RemotePrivateEndpointConnectionWrapper_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of RemotePrivateEndpointConnectionWrapper_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRemotePrivateEndpointConnectionWrapper_ARM, RemotePrivateEndpointConnectionWrapper_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRemotePrivateEndpointConnectionWrapper_ARM runs a test to see if a specific instance of RemotePrivateEndpointConnectionWrapper_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRemotePrivateEndpointConnectionWrapper_ARM(subject RemotePrivateEndpointConnectionWrapper_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual RemotePrivateEndpointConnectionWrapper_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of RemotePrivateEndpointConnectionWrapper_ARM instances for property testing - lazily instantiated by
// RemotePrivateEndpointConnectionWrapper_ARMGenerator()
var remotePrivateEndpointConnectionWrapper_ARMGenerator gopter.Gen

// RemotePrivateEndpointConnectionWrapper_ARMGenerator returns a generator of RemotePrivateEndpointConnectionWrapper_ARM instances for property testing.
// We first initialize remotePrivateEndpointConnectionWrapper_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func RemotePrivateEndpointConnectionWrapper_ARMGenerator() gopter.Gen {
	if remotePrivateEndpointConnectionWrapper_ARMGenerator != nil {
		return remotePrivateEndpointConnectionWrapper_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM(generators)
	remotePrivateEndpointConnectionWrapper_ARMGenerator = gen.Struct(reflect.TypeOf(RemotePrivateEndpointConnectionWrapper_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM(generators)
	AddRelatedPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM(generators)
	remotePrivateEndpointConnectionWrapper_ARMGenerator = gen.Struct(reflect.TypeOf(RemotePrivateEndpointConnectionWrapper_ARM{}), generators)

	return remotePrivateEndpointConnectionWrapper_ARMGenerator
}

// AddIndependentPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRemotePrivateEndpointConnectionWrapper_ARM(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(PrivateEndpointConnectionWrapperProperties_ARMGenerator())
}
...
func Test_PrivateEndpointConnectionWrapperProperties_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of PrivateEndpointConnectionWrapperProperties_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPrivateEndpointConnectionWrapperProperties_ARM, PrivateEndpointConnectionWrapperProperties_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPrivateEndpointConnectionWrapperProperties_ARM runs a test to see if a specific instance of PrivateEndpointConnectionWrapperProperties_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForPrivateEndpointConnectionWrapperProperties_ARM(subject PrivateEndpointConnectionWrapperProperties_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual PrivateEndpointConnectionWrapperProperties_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of PrivateEndpointConnectionWrapperProperties_ARM instances for property testing - lazily instantiated by
// PrivateEndpointConnectionWrapperProperties_ARMGenerator()
var privateEndpointConnectionWrapperProperties_ARMGenerator gopter.Gen

// PrivateEndpointConnectionWrapperProperties_ARMGenerator returns a generator of PrivateEndpointConnectionWrapperProperties_ARM instances for property testing.
func PrivateEndpointConnectionWrapperProperties_ARMGenerator() gopter.Gen {
	if privateEndpointConnectionWrapperProperties_ARMGenerator != nil {
		return privateEndpointConnectionWrapperProperties_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForPrivateEndpointConnectionWrapperProperties_ARM(generators)
	privateEndpointConnectionWrapperProperties_ARMGenerator = gen.Struct(reflect.TypeOf(PrivateEndpointConnectionWrapperProperties_ARM{}), generators)

	return privateEndpointConnectionWrapperProperties_ARMGenerator
}

// AddRelatedPropertyGeneratorsForPrivateEndpointConnectionWrapperProperties_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForPrivateEndpointConnectionWrapperProperties_ARM(gens map[string]gopter.Gen) {
...
func AddIndependentPropertyGeneratorsForPrivateLinkServiceConnectionState_ARM(gens map[string]gopter.Gen) {
	...
	gens["Status"] = gen.PtrOf(gen.OneConstOf(PrivateEndpointServiceConnectionStatus_Approved, PrivateEndpointServiceConnectionStatus_Pending, PrivateEndpointServiceConnectionStatus_Rejected))
}
