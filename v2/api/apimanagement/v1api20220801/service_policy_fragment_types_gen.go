...
var _ conversion.Convertible = &Service_PolicyFragment{}

// ConvertFrom populates our Service_PolicyFragment from the provided hub Service_PolicyFragment
func (fragment *Service_PolicyFragment) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20220801s.Service_PolicyFragment)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_PolicyFragment but received %T instead", hub)
	}

	return fragment.AssignProperties_From_Service_PolicyFragment(source)
}

// ConvertTo populates the provided hub Service_PolicyFragment from our Service_PolicyFragment
func (fragment *Service_PolicyFragment) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20220801s.Service_PolicyFragment)
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service_PolicyFragment but received %T instead", hub)
	}

	return fragment.AssignProperties_To_Service_PolicyFragment(destination)
}

// +kubebuilder:webhook:path=/mutate-apimanagement-azure-com-v1api20220801-service_policyfragment,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_policyfragments,verbs=create;update,versions=v1api20220801,name=default.v1api20220801.service_policyfragments.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Defaulter = &Service_PolicyFragment{}

// Default applies defaults to the Service_PolicyFragment resource
func (fragment *Service_PolicyFragment) Default() {
...
func (fragment *Service_PolicyFragment) defaultAzureName() {
	if fragment.Spec.AzureName == "" {
		fragment.Spec.AzureName = fragment.Name
	}
}

// defaultImpl applies the code generated defaults to the Service_PolicyFragment resource
func (fragment *Service_PolicyFragment) defaultImpl() { fragment.defaultAzureName() }

var _ genruntime.ImportableResource = &Service_PolicyFragment{}

// InitializeSpec initializes the spec for this resource from the given status
func (fragment *Service_PolicyFragment) InitializeSpec(status genruntime.ConvertibleStatus) error {
...
// +kubebuilder:webhook:path=/validate-apimanagement-azure-com-v1api20220801-service_policyfragment,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=apimanagement.azure.com,resources=service_policyfragments,verbs=create;update,versions=v1api20220801,name=validate.v1api20220801.service_policyfragments.apimanagement.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &Service_PolicyFragment{}

// ValidateCreate validates the creation of the resource
func (fragment *Service_PolicyFragment) ValidateCreate() (admission.Warnings, error) {
...
func (fragment *Service_PolicyFragment) ValidateDelete() (admission.Warnings, error) {
...
func (fragment *Service_PolicyFragment) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (fragment *Service_PolicyFragment) createValidations() []func() (admission.Warnings, error) {
	return []func() (admission.Warnings, error){fragment.validateResourceReferences, fragment.validateOwnerReference}
}

// deleteValidations validates the deletion of the resource
func (fragment *Service_PolicyFragment) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (fragment *Service_PolicyFragment) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (fragment *Service_PolicyFragment) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(fragment)
}

// validateResourceReferences validates all resource references
func (fragment *Service_PolicyFragment) validateResourceReferences() (admission.Warnings, error) {
...
func (fragment *Service_PolicyFragment) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*Service_PolicyFragment)
	if !ok {
		return nil, nil
	}
...
// AssignProperties_From_Service_PolicyFragment populates our Service_PolicyFragment from the provided source Service_PolicyFragment
func (fragment *Service_PolicyFragment) AssignProperties_From_Service_PolicyFragment(source *v20220801s.Service_PolicyFragment) error {
...
// AssignProperties_To_Service_PolicyFragment populates the provided destination Service_PolicyFragment from our Service_PolicyFragment
func (fragment *Service_PolicyFragment) AssignProperties_To_Service_PolicyFragment(destination *v20220801s.Service_PolicyFragment) error {
