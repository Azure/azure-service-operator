...
// RunPropertyAssignmentTestForBackendContractProperties_Pool tests if a specific instance of BackendContractProperties_Pool can be assigned to compat and back losslessly
func RunPropertyAssignmentTestForBackendContractProperties_Pool(subject BackendContractProperties_Pool) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801sc.BackendContractProperties_Pool
...
// RunPropertyAssignmentTestForBackendContractProperties_Pool_STATUS tests if a specific instance of BackendContractProperties_Pool_STATUS can be assigned to compat and back losslessly
func RunPropertyAssignmentTestForBackendContractProperties_Pool_STATUS(subject BackendContractProperties_Pool_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20220801sc.BackendContractProperties_Pool_STATUS
