...
// Storage version of v1api20230301preview.Service
// Generator information:
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/preview/2023-03-01-preview/apimdeployment.json
...
func (service *Service) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20220801storage/Service but received %T instead", hub)
	}
...
// GetAPIVersion returns the ARM API version of the resource. This is always "2023-03-01-preview"
...
// Storage version of v1api20230301preview.APIVersion
// +kubebuilder:validation:Enum={"2023-03-01-preview"}
type APIVersion string

const APIVersion_Value = APIVersion("2023-03-01-preview")
...
// Storage version of v1api20230301preview.Service_Spec
...
func (service *Service_Spec) AssignProperties_From_Service_Spec(source *v20220801s.Service_Spec) error {
	...
	// PublicIpAddressId
	if propertyBag.Contains("PublicIpAddressId") {
		var publicIpAddressId string
		err := propertyBag.Pull("PublicIpAddressId", &publicIpAddressId)
		if err != nil {
			return errors.Wrap(err, "pulling 'PublicIpAddressId' from propertyBag")
		}
	...
	if source.PublicIpAddressReference != nil {
		propertyBag.Add("PublicIpAddressReference", *source.PublicIpAddressReference)
	} else {
		propertyBag.Remove("PublicIpAddressReference")
	}
...
func (service *Service_Spec) AssignProperties_To_Service_Spec(destination *v20220801s.Service_Spec) error {
	...
	if service.PublicIpAddressId != nil {
		propertyBag.Add("PublicIpAddressId", *service.PublicIpAddressId)
	} else {
		propertyBag.Remove("PublicIpAddressId")
	}

	// PublicIpAddressReference
	if propertyBag.Contains("PublicIpAddressReference") {
		var publicIpAddressReference genruntime.ResourceReference
		err := propertyBag.Pull("PublicIpAddressReference", &publicIpAddressReference)
		if err != nil {
			return errors.Wrap(err, "pulling 'PublicIpAddressReference' from propertyBag")
		}
...
// Storage version of v1api20230301preview.Service_STATUS
...
// Storage version of v1api20230301preview.AdditionalLocation
...
func (location *AdditionalLocation) AssignProperties_From_AdditionalLocation(source *v20220801s.AdditionalLocation) error {
	...
	if propertyBag.Contains("PublicIpAddressId") {
		...
		location.PublicIpAddressId = nil
	}
...
func (location *AdditionalLocation) AssignProperties_To_AdditionalLocation(destination *v20220801s.AdditionalLocation) error {
	...
	if location.PublicIpAddressId != nil {
		propertyBag.Add("PublicIpAddressId", *location.PublicIpAddressId)
	} else {
		propertyBag.Remove("PublicIpAddressId")
	}
...
// Storage version of v1api20230301preview.AdditionalLocation_STATUS
// Description of an additional API Management resource location.
...
// Storage version of v1api20230301preview.ApiManagementServiceIdentity
...
// Storage version of v1api20230301preview.ApiManagementServiceIdentity_STATUS
// Identity properties of the Api Management service resource.
...
// Storage version of v1api20230301preview.ApiManagementServiceSkuProperties
...
// Storage version of v1api20230301preview.ApiManagementServiceSkuProperties_STATUS
// API Management service resource SKU properties.
...
// Storage version of v1api20230301preview.ApiVersionConstraint
...
// Storage version of v1api20230301preview.ApiVersionConstraint_STATUS
// Control Plane Apis version constraint for the API Management service.
...
// Storage version of v1api20230301preview.CertificateConfiguration
...
// Storage version of v1api20230301preview.CertificateConfiguration_STATUS
// Certificate configuration which consist of non-trusted intermediates and root certificates.
...
// Storage version of v1api20230301preview.ConfigurationApi
...
// Storage version of v1api20230301preview.ConfigurationApi_STATUS
// Information regarding the Configuration API of the API Management service.
...
// Storage version of v1api20230301preview.HostnameConfiguration
...
// Storage version of v1api20230301preview.HostnameConfiguration_STATUS
// Custom hostname configuration.
...
// Storage version of v1api20230301preview.RemotePrivateEndpointConnectionWrapper_STATUS
...
// Storage version of v1api20230301preview.SystemData_STATUS
...
// Storage version of v1api20230301preview.VirtualNetworkConfiguration
...
func (configuration *VirtualNetworkConfiguration) AssignProperties_From_VirtualNetworkConfiguration(source *v20220801s.VirtualNetworkConfiguration) error {
	...
	// SubnetResourceId
	if propertyBag.Contains("SubnetResourceId") {
		var subnetResourceId string
		err := propertyBag.Pull("SubnetResourceId", &subnetResourceId)
		if err != nil {
			return errors.Wrap(err, "pulling 'SubnetResourceId' from propertyBag")
		}
	...
	if source.SubnetResourceReference != nil {
		propertyBag.Add("SubnetResourceReference", *source.SubnetResourceReference)
	} else {
		propertyBag.Remove("SubnetResourceReference")
	}
...
func (configuration *VirtualNetworkConfiguration) AssignProperties_To_VirtualNetworkConfiguration(destination *v20220801s.VirtualNetworkConfiguration) error {
	...
	if configuration.SubnetResourceId != nil {
		propertyBag.Add("SubnetResourceId", *configuration.SubnetResourceId)
	} else {
		propertyBag.Remove("SubnetResourceId")
	}

	// SubnetResourceReference
	if propertyBag.Contains("SubnetResourceReference") {
		var subnetResourceReference genruntime.ResourceReference
		err := propertyBag.Pull("SubnetResourceReference", &subnetResourceReference)
		if err != nil {
			return errors.Wrap(err, "pulling 'SubnetResourceReference' from propertyBag")
		}
...
// Storage version of v1api20230301preview.VirtualNetworkConfiguration_STATUS
// Configuration of a virtual network to which API Management service is deployed.
...
// Storage version of v1api20230301preview.ArmIdWrapper_STATUS
...
// Storage version of v1api20230301preview.CertificateInformation
...
func (information *CertificateInformation) AssignProperties_From_CertificateInformation(source *v20220801s.CertificateInformation) error {
	...
	if source.ExpiryFromConfig != nil {
		propertyBag.Add("ExpiryFromConfig", *source.ExpiryFromConfig)
	} else {
		propertyBag.Remove("ExpiryFromConfig")
	}
	...
	if source.SubjectFromConfig != nil {
		propertyBag.Add("SubjectFromConfig", *source.SubjectFromConfig)
	} else {
		propertyBag.Remove("SubjectFromConfig")
	}
	...
	if source.ThumbprintFromConfig != nil {
		propertyBag.Add("ThumbprintFromConfig", *source.ThumbprintFromConfig)
	} else {
		propertyBag.Remove("ThumbprintFromConfig")
	}
...
func (information *CertificateInformation) AssignProperties_To_CertificateInformation(destination *v20220801s.CertificateInformation) error {
	...
	// ExpiryFromConfig
	if propertyBag.Contains("ExpiryFromConfig") {
		var expiryFromConfig genruntime.ConfigMapReference
		err := propertyBag.Pull("ExpiryFromConfig", &expiryFromConfig)
		if err != nil {
			return errors.Wrap(err, "pulling 'ExpiryFromConfig' from propertyBag")
		}
	...
	// SubjectFromConfig
	if propertyBag.Contains("SubjectFromConfig") {
		var subjectFromConfig genruntime.ConfigMapReference
		err := propertyBag.Pull("SubjectFromConfig", &subjectFromConfig)
		if err != nil {
			return errors.Wrap(err, "pulling 'SubjectFromConfig' from propertyBag")
		}
	...
	// ThumbprintFromConfig
	if propertyBag.Contains("ThumbprintFromConfig") {
		var thumbprintFromConfig genruntime.ConfigMapReference
		err := propertyBag.Pull("ThumbprintFromConfig", &thumbprintFromConfig)
		if err != nil {
			return errors.Wrap(err, "pulling 'ThumbprintFromConfig' from propertyBag")
		}
...
// Storage version of v1api20230301preview.CertificateInformation_STATUS
// SSL certificate information.
...
// Storage version of v1api20230301preview.PrivateLinkServiceConnectionState_STATUS
...
// Storage version of v1api20230301preview.UserAssignedIdentityDetails
...
// Storage version of v1api20230301preview.UserIdentityProperties_STATUS
