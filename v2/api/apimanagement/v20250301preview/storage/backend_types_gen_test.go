...
func Test_BackendFailureResponse_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendFailureResponse via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendFailureResponse, BackendFailureResponseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendFailureResponse runs a test to see if a specific instance of BackendFailureResponse round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendFailureResponse(subject BackendFailureResponse) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BackendFailureResponse
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BackendFailureResponse instances for property testing - lazily instantiated by
// BackendFailureResponseGenerator()
var backendFailureResponseGenerator gopter.Gen

// BackendFailureResponseGenerator returns a generator of BackendFailureResponse instances for property testing.
func BackendFailureResponseGenerator() gopter.Gen {
	if backendFailureResponseGenerator != nil {
		return backendFailureResponseGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendFailureResponse(generators)
	backendFailureResponseGenerator = gen.Struct(reflect.TypeOf(BackendFailureResponse{}), generators)

	return backendFailureResponseGenerator
}

// AddIndependentPropertyGeneratorsForBackendFailureResponse is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBackendFailureResponse(gens map[string]gopter.Gen) {
	gens["StatusCode"] = gen.PtrOf(gen.Int())
}

func Test_BackendFailureResponse_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendFailureResponse_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendFailureResponse_STATUS, BackendFailureResponse_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendFailureResponse_STATUS runs a test to see if a specific instance of BackendFailureResponse_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendFailureResponse_STATUS(subject BackendFailureResponse_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BackendFailureResponse_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BackendFailureResponse_STATUS instances for property testing - lazily instantiated by
// BackendFailureResponse_STATUSGenerator()
var backendFailureResponse_STATUSGenerator gopter.Gen

// BackendFailureResponse_STATUSGenerator returns a generator of BackendFailureResponse_STATUS instances for property testing.
func BackendFailureResponse_STATUSGenerator() gopter.Gen {
	if backendFailureResponse_STATUSGenerator != nil {
		return backendFailureResponse_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendFailureResponse_STATUS(generators)
	backendFailureResponse_STATUSGenerator = gen.Struct(reflect.TypeOf(BackendFailureResponse_STATUS{}), generators)

	return backendFailureResponse_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForBackendFailureResponse_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBackendFailureResponse_STATUS(gens map[string]gopter.Gen) {
	gens["StatusCode"] = gen.PtrOf(gen.Int())
}
...
func AddRelatedPropertyGeneratorsForBackendPool(gens map[string]gopter.Gen) {
	gens["FailureResponse"] = gen.PtrOf(BackendFailureResponseGenerator())
	gens["Services"] = gen.SliceOf(BackendPoolItemGenerator())
	gens["SessionAffinity"] = gen.PtrOf(BackendSessionAffinityGenerator())
}
...
func AddIndependentPropertyGeneratorsForBackendPoolItem(gens map[string]gopter.Gen) {
	gens["PreferredCarbonEmission"] = gen.PtrOf(gen.AlphaString())
...
func AddRelatedPropertyGeneratorsForBackendPool_STATUS(gens map[string]gopter.Gen) {
	gens["FailureResponse"] = gen.PtrOf(BackendFailureResponse_STATUSGenerator())
	gens["Services"] = gen.SliceOf(BackendPoolItem_STATUSGenerator())
	gens["SessionAffinity"] = gen.PtrOf(BackendSessionAffinity_STATUSGenerator())
}
...
func Test_BackendSessionAffinity_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendSessionAffinity via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendSessionAffinity, BackendSessionAffinityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendSessionAffinity runs a test to see if a specific instance of BackendSessionAffinity round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendSessionAffinity(subject BackendSessionAffinity) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BackendSessionAffinity
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BackendSessionAffinity instances for property testing - lazily instantiated by
// BackendSessionAffinityGenerator()
var backendSessionAffinityGenerator gopter.Gen

// BackendSessionAffinityGenerator returns a generator of BackendSessionAffinity instances for property testing.
func BackendSessionAffinityGenerator() gopter.Gen {
	if backendSessionAffinityGenerator != nil {
		return backendSessionAffinityGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForBackendSessionAffinity(generators)
	backendSessionAffinityGenerator = gen.Struct(reflect.TypeOf(BackendSessionAffinity{}), generators)

	return backendSessionAffinityGenerator
}

// AddRelatedPropertyGeneratorsForBackendSessionAffinity is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBackendSessionAffinity(gens map[string]gopter.Gen) {
	gens["SessionId"] = gen.PtrOf(BackendSessionIdGenerator())
}

func Test_BackendSessionAffinity_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendSessionAffinity_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendSessionAffinity_STATUS, BackendSessionAffinity_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendSessionAffinity_STATUS runs a test to see if a specific instance of BackendSessionAffinity_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendSessionAffinity_STATUS(subject BackendSessionAffinity_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BackendSessionAffinity_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BackendSessionAffinity_STATUS instances for property testing - lazily instantiated by
// BackendSessionAffinity_STATUSGenerator()
var backendSessionAffinity_STATUSGenerator gopter.Gen

// BackendSessionAffinity_STATUSGenerator returns a generator of BackendSessionAffinity_STATUS instances for property testing.
func BackendSessionAffinity_STATUSGenerator() gopter.Gen {
	if backendSessionAffinity_STATUSGenerator != nil {
		return backendSessionAffinity_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForBackendSessionAffinity_STATUS(generators)
	backendSessionAffinity_STATUSGenerator = gen.Struct(reflect.TypeOf(BackendSessionAffinity_STATUS{}), generators)

	return backendSessionAffinity_STATUSGenerator
}

// AddRelatedPropertyGeneratorsForBackendSessionAffinity_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBackendSessionAffinity_STATUS(gens map[string]gopter.Gen) {
	gens["SessionId"] = gen.PtrOf(BackendSessionId_STATUSGenerator())
}

func Test_BackendSessionId_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendSessionId via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendSessionId, BackendSessionIdGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendSessionId runs a test to see if a specific instance of BackendSessionId round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendSessionId(subject BackendSessionId) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of BackendSessionId instances for property testing - lazily instantiated by BackendSessionIdGenerator()
var backendSessionIdGenerator gopter.Gen

// BackendSessionIdGenerator returns a generator of BackendSessionId instances for property testing.
func BackendSessionIdGenerator() gopter.Gen {
	if backendSessionIdGenerator != nil {
		return backendSessionIdGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendSessionId(generators)
	backendSessionIdGenerator = gen.Struct(reflect.TypeOf(BackendSessionId{}), generators)

	return backendSessionIdGenerator
}

// AddIndependentPropertyGeneratorsForBackendSessionId is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBackendSessionId(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Source"] = gen.PtrOf(gen.AlphaString())
}

func Test_BackendSessionId_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BackendSessionId_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBackendSessionId_STATUS, BackendSessionId_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBackendSessionId_STATUS runs a test to see if a specific instance of BackendSessionId_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForBackendSessionId_STATUS(subject BackendSessionId_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BackendSessionId_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BackendSessionId_STATUS instances for property testing - lazily instantiated by
// BackendSessionId_STATUSGenerator()
var backendSessionId_STATUSGenerator gopter.Gen

// BackendSessionId_STATUSGenerator returns a generator of BackendSessionId_STATUS instances for property testing.
func BackendSessionId_STATUSGenerator() gopter.Gen {
	if backendSessionId_STATUSGenerator != nil {
		return backendSessionId_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendSessionId_STATUS(generators)
	backendSessionId_STATUSGenerator = gen.Struct(reflect.TypeOf(BackendSessionId_STATUS{}), generators)

	return backendSessionId_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForBackendSessionId_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBackendSessionId_STATUS(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Source"] = gen.PtrOf(gen.AlphaString())
}
...
// We first initialize backendTlsPropertiesGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func BackendTlsPropertiesGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendTlsProperties(generators)
	AddRelatedPropertyGeneratorsForBackendTlsProperties(generators)
	backendTlsPropertiesGenerator = gen.Struct(reflect.TypeOf(BackendTlsProperties{}), generators)
...
// AddRelatedPropertyGeneratorsForBackendTlsProperties is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBackendTlsProperties(gens map[string]gopter.Gen) {
	gens["ServerX509Names"] = gen.SliceOf(X509CertificateNameGenerator())
}
...
// We first initialize backendTlsProperties_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func BackendTlsProperties_STATUSGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBackendTlsProperties_STATUS(generators)
	AddRelatedPropertyGeneratorsForBackendTlsProperties_STATUS(generators)
	backendTlsProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(BackendTlsProperties_STATUS{}), generators)
...
// AddRelatedPropertyGeneratorsForBackendTlsProperties_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBackendTlsProperties_STATUS(gens map[string]gopter.Gen) {
	gens["ServerX509Names"] = gen.SliceOf(X509CertificateName_STATUSGenerator())
}
...
func AddIndependentPropertyGeneratorsForBackend_STATUS(gens map[string]gopter.Gen) {
	gens["AzureRegion"] = gen.PtrOf(gen.AlphaString())
...
func AddIndependentPropertyGeneratorsForCircuitBreakerRule(gens map[string]gopter.Gen) {
	gens["AcceptRetryAfter"] = gen.PtrOf(gen.Bool())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
