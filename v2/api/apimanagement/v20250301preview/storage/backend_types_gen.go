...
// Storage version of v20250301preview.Backend
...
// Storage version of v20250301preview.APIVersion
...
// Storage version of v20250301preview.Backend_Spec
...
func (backend *Backend_Spec) AssignProperties_From_Backend_Spec(source *storage.Backend_Spec) error {
	...
	// AzureRegion
	if propertyBag.Contains("AzureRegion") {
		var azureRegion string
		err := propertyBag.Pull("AzureRegion", &azureRegion)
		if err != nil {
			return eris.Wrap(err, "pulling 'AzureRegion' from propertyBag")
		}

		backend.AzureRegion = &azureRegion
	} else {
		backend.AzureRegion = nil
	}
...
func (backend *Backend_Spec) AssignProperties_To_Backend_Spec(destination *storage.Backend_Spec) error {
	...
	if backend.AzureRegion != nil {
		propertyBag.Add("AzureRegion", *backend.AzureRegion)
	} else {
		propertyBag.Remove("AzureRegion")
	}
...
// Storage version of v20250301preview.Backend_STATUS
...
func (backend *Backend_STATUS) AssignProperties_To_Backend_STATUS(destination *storage.Backend_STATUS) error {
	...
	if backend.SystemData != nil {
		propertyBag.Add("SystemData", *backend.SystemData)
	} else {
...
// Storage version of v20250301preview.BackendCircuitBreaker
...
// Storage version of v20250301preview.BackendCircuitBreaker_STATUS
// The configuration of the backend circuit breaker
...
// Storage version of v20250301preview.BackendCredentialsContract
...
// Storage version of v20250301preview.BackendCredentialsContract_STATUS
// Details of the Credentials used to connect to Backend.
...
// Storage version of v20250301preview.BackendOperatorSpec
...
// Storage version of v20250301preview.BackendPool
...
func (pool *BackendPool) AssignProperties_From_BackendPool(source *storage.BackendPool) error {
	...
	// FailureResponse
	if propertyBag.Contains("FailureResponse") {
		var failureResponse BackendFailureResponse
		err := propertyBag.Pull("FailureResponse", &failureResponse)
		if err != nil {
			return eris.Wrap(err, "pulling 'FailureResponse' from propertyBag")
		}
	...
	// SessionAffinity
	if propertyBag.Contains("SessionAffinity") {
		var sessionAffinity BackendSessionAffinity
		err := propertyBag.Pull("SessionAffinity", &sessionAffinity)
		if err != nil {
			return eris.Wrap(err, "pulling 'SessionAffinity' from propertyBag")
		}
...
func (pool *BackendPool) AssignProperties_To_BackendPool(destination *storage.BackendPool) error {
	...
	if pool.FailureResponse != nil {
		propertyBag.Add("FailureResponse", *pool.FailureResponse)
	} else {
		propertyBag.Remove("FailureResponse")
	}
	...
	if pool.SessionAffinity != nil {
		propertyBag.Add("SessionAffinity", *pool.SessionAffinity)
	} else {
		propertyBag.Remove("SessionAffinity")
	}
...
// Storage version of v20250301preview.BackendPool_STATUS
// Backend pool information
...
// Storage version of v20250301preview.BackendProperties
...
// Storage version of v20250301preview.BackendProperties_STATUS
// Properties specific to the Backend Type.
...
// Storage version of v20250301preview.BackendProxyContract
...
// Storage version of v20250301preview.BackendProxyContract_STATUS
// Details of the Backend WebProxy Server to use in the Request to Backend.
...
// Storage version of v20250301preview.BackendTlsProperties
...
func (properties *BackendTlsProperties) AssignProperties_From_BackendTlsProperties(source *storage.BackendTlsProperties) error {
	...
	if propertyBag.Contains("ServerCertificateThumbprints") {
		var serverCertificateThumbprint []string
		err := propertyBag.Pull("ServerCertificateThumbprints", &serverCertificateThumbprint)
		if err != nil {
			return eris.Wrap(err, "pulling 'ServerCertificateThumbprints' from propertyBag")
		}

		properties.ServerCertificateThumbprints = serverCertificateThumbprint
	} else {
		properties.ServerCertificateThumbprints = nil
	}

	// ServerX509Names
	if propertyBag.Contains("ServerX509Names") {
		var serverX509Name []X509CertificateName
		err := propertyBag.Pull("ServerX509Names", &serverX509Name)
		if err != nil {
			return eris.Wrap(err, "pulling 'ServerX509Names' from propertyBag")
		}

		properties.ServerX509Names = serverX509Name
	} else {
...
func (properties *BackendTlsProperties) AssignProperties_To_BackendTlsProperties(destination *storage.BackendTlsProperties) error {
	...
	// ServerCertificateThumbprints
	if len(properties.ServerCertificateThumbprints) > 0 {
		propertyBag.Add("ServerCertificateThumbprints", properties.ServerCertificateThumbprints)
	} else {
		propertyBag.Remove("ServerCertificateThumbprints")
	}

	// ServerX509Names
	if len(properties.ServerX509Names) > 0 {
		propertyBag.Add("ServerX509Names", properties.ServerX509Names)
	} else {
		propertyBag.Remove("ServerX509Names")
	}
...
// Storage version of v20250301preview.BackendTlsProperties_STATUS
// Properties controlling TLS Certificate Validation.
...
// Storage version of v20250301preview.SystemData_STATUS
...
// Storage version of v20250301preview.BackendAuthorizationHeaderCredentials
...
// Storage version of v20250301preview.BackendAuthorizationHeaderCredentials_STATUS
// Authorization header information.
...
// Storage version of v20250301preview.BackendFailureResponse
...
// Storage version of v20250301preview.BackendFailureResponse_STATUS
// The response to be returned when a backend fails to respond
...
// Storage version of v20250301preview.BackendPoolItem
// Backend pool service information
type BackendPoolItem struct {
	PreferredCarbonEmission *string                `json:"preferredCarbonEmission,omitempty"`
...
func (item *BackendPoolItem) AssignProperties_From_BackendPoolItem(source *storage.BackendPoolItem) error {
	...
	if propertyBag.Contains("PreferredCarbonEmission") {
		var preferredCarbonEmission string
		err := propertyBag.Pull("PreferredCarbonEmission", &preferredCarbonEmission)
		if err != nil {
			return eris.Wrap(err, "pulling 'PreferredCarbonEmission' from propertyBag")
		}
...
func (item *BackendPoolItem) AssignProperties_To_BackendPoolItem(destination *storage.BackendPoolItem) error {
	...
	if item.PreferredCarbonEmission != nil {
		propertyBag.Add("PreferredCarbonEmission", *item.PreferredCarbonEmission)
	} else {
		propertyBag.Remove("PreferredCarbonEmission")
	}
...
// Storage version of v20250301preview.BackendPoolItem_STATUS
// Backend pool service information
...
// Storage version of v20250301preview.BackendServiceFabricClusterProperties
...
// Storage version of v20250301preview.BackendServiceFabricClusterProperties_STATUS
// Properties of the Service Fabric Type Backend.
...
// Storage version of v20250301preview.BackendSessionAffinity
...
// Storage version of v20250301preview.BackendSessionAffinity_STATUS
// The session stickiness properties of the backend pool.
...
// Storage version of v20250301preview.CircuitBreakerRule
...
func (rule *CircuitBreakerRule) AssignProperties_To_CircuitBreakerRule(destination *storage.CircuitBreakerRule) error {
	...
	if rule.FailureResponse != nil {
		propertyBag.Add("FailureResponse", *rule.FailureResponse)
	} else {
		propertyBag.Remove("FailureResponse")
	}
...
// Storage version of v20250301preview.CircuitBreakerRule_STATUS
// Rule configuration to trip the backend.
...
// Storage version of v20250301preview.X509CertificateName
...
// Storage version of v20250301preview.X509CertificateName_STATUS
// Properties of server X509Names.
...
// Storage version of v20250301preview.BackendSessionId
...
// Storage version of v20250301preview.BackendSessionId_STATUS
// The properties of the id that identifies the requests belonging to the same session.
...
// Storage version of v20250301preview.CircuitBreakerFailureCondition
...
// Storage version of v20250301preview.CircuitBreakerFailureCondition_STATUS
// The trip conditions of the circuit breaker
...
// Storage version of v20250301preview.FailureStatusCodeRange
...
// Storage version of v20250301preview.FailureStatusCodeRange_STATUS
// The failure http status code range
