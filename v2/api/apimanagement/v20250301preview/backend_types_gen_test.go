...
import (
	...
	v20250301ps "github.com/Azure/azure-service-operator/v2/api/apimanagement/v20250301preview/storage"
...
func RunPropertyAssignmentTestForBackendAuthorizationHeaderCredentials(subject BackendAuthorizationHeaderCredentials) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendAuthorizationHeaderCredentials
...
func RunPropertyAssignmentTestForBackendAuthorizationHeaderCredentials_STATUS(subject BackendAuthorizationHeaderCredentials_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendAuthorizationHeaderCredentials_STATUS
...
func RunPropertyAssignmentTestForBackendCircuitBreaker(subject BackendCircuitBreaker) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendCircuitBreaker
...
func RunPropertyAssignmentTestForBackendCircuitBreaker_STATUS(subject BackendCircuitBreaker_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendCircuitBreaker_STATUS
...
func RunPropertyAssignmentTestForBackendCredentialsContract(subject BackendCredentialsContract) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendCredentialsContract
...
func RunPropertyAssignmentTestForBackendCredentialsContract_STATUS(subject BackendCredentialsContract_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendCredentialsContract_STATUS
...
func Test_BackendFailureResponse_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendFailureResponse to BackendFailureResponse via AssignProperties_To_BackendFailureResponse & AssignProperties_From_BackendFailureResponse returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendFailureResponse, BackendFailureResponseGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendFailureResponse tests if a specific instance of BackendFailureResponse can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendFailureResponse(subject BackendFailureResponse) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendFailureResponse
	err := copied.AssignProperties_To_BackendFailureResponse(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendFailureResponse(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_BackendFailureResponse_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendFailureResponse_STATUS to BackendFailureResponse_STATUS via AssignProperties_To_BackendFailureResponse_STATUS & AssignProperties_From_BackendFailureResponse_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendFailureResponse_STATUS, BackendFailureResponse_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendFailureResponse_STATUS tests if a specific instance of BackendFailureResponse_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendFailureResponse_STATUS(subject BackendFailureResponse_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendFailureResponse_STATUS
	err := copied.AssignProperties_To_BackendFailureResponse_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendFailureResponse_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func RunPropertyAssignmentTestForBackendOperatorSpec(subject BackendOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendOperatorSpec
...
func RunPropertyAssignmentTestForBackendPool(subject BackendPool) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendPool
...
func RunPropertyAssignmentTestForBackendPoolItem(subject BackendPoolItem) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendPoolItem
...
func AddIndependentPropertyGeneratorsForBackendPoolItem(gens map[string]gopter.Gen) {
	gens["PreferredCarbonEmission"] = gen.PtrOf(gen.OneConstOf(
		CarbonEmissionCategory_High,
		CarbonEmissionCategory_Low,
		CarbonEmissionCategory_Medium,
		CarbonEmissionCategory_VeryHigh,
		CarbonEmissionCategory_VeryLow))
...
func RunPropertyAssignmentTestForBackendPoolItem_STATUS(subject BackendPoolItem_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendPoolItem_STATUS
...
func AddIndependentPropertyGeneratorsForBackendPoolItem_STATUS(gens map[string]gopter.Gen) {
	...
	gens["PreferredCarbonEmission"] = gen.PtrOf(gen.OneConstOf(
		CarbonEmissionCategory_STATUS_High,
		CarbonEmissionCategory_STATUS_Low,
		CarbonEmissionCategory_STATUS_Medium,
		CarbonEmissionCategory_STATUS_VeryHigh,
		CarbonEmissionCategory_STATUS_VeryLow))
	gens["Priority"] = gen.PtrOf(gen.Int())
	gens["Weight"] = gen.PtrOf(gen.Int())
}
...
func RunPropertyAssignmentTestForBackendPool_STATUS(subject BackendPool_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendPool_STATUS
...
func RunPropertyAssignmentTestForBackendProperties(subject BackendProperties) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendProperties
...
func RunPropertyAssignmentTestForBackendProperties_STATUS(subject BackendProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendProperties_STATUS
...
func RunPropertyAssignmentTestForBackendProxyContract(subject BackendProxyContract) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendProxyContract
...
func RunPropertyAssignmentTestForBackendProxyContract_STATUS(subject BackendProxyContract_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendProxyContract_STATUS
...
func RunPropertyAssignmentTestForBackendServiceFabricClusterProperties(subject BackendServiceFabricClusterProperties) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendServiceFabricClusterProperties
...
func RunPropertyAssignmentTestForBackendServiceFabricClusterProperties_STATUS(subject BackendServiceFabricClusterProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendServiceFabricClusterProperties_STATUS
...
func Test_BackendSessionAffinity_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendSessionAffinity to BackendSessionAffinity via AssignProperties_To_BackendSessionAffinity & AssignProperties_From_BackendSessionAffinity returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendSessionAffinity, BackendSessionAffinityGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendSessionAffinity tests if a specific instance of BackendSessionAffinity can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendSessionAffinity(subject BackendSessionAffinity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendSessionAffinity
	err := copied.AssignProperties_To_BackendSessionAffinity(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendSessionAffinity(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_BackendSessionAffinity_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendSessionAffinity_STATUS to BackendSessionAffinity_STATUS via AssignProperties_To_BackendSessionAffinity_STATUS & AssignProperties_From_BackendSessionAffinity_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendSessionAffinity_STATUS, BackendSessionAffinity_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendSessionAffinity_STATUS tests if a specific instance of BackendSessionAffinity_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendSessionAffinity_STATUS(subject BackendSessionAffinity_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendSessionAffinity_STATUS
	err := copied.AssignProperties_To_BackendSessionAffinity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendSessionAffinity_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_BackendSessionId_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendSessionId to BackendSessionId via AssignProperties_To_BackendSessionId & AssignProperties_From_BackendSessionId returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendSessionId, BackendSessionIdGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendSessionId tests if a specific instance of BackendSessionId can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendSessionId(subject BackendSessionId) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendSessionId
	err := copied.AssignProperties_To_BackendSessionId(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendSessionId(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForBackendSessionId(gens map[string]gopter.Gen) {
	...
	gens["Source"] = gen.PtrOf(gen.OneConstOf(BackendSessionIdSource_Cookie))
}

func Test_BackendSessionId_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BackendSessionId_STATUS to BackendSessionId_STATUS via AssignProperties_To_BackendSessionId_STATUS & AssignProperties_From_BackendSessionId_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForBackendSessionId_STATUS, BackendSessionId_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForBackendSessionId_STATUS tests if a specific instance of BackendSessionId_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForBackendSessionId_STATUS(subject BackendSessionId_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendSessionId_STATUS
	err := copied.AssignProperties_To_BackendSessionId_STATUS(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignProperties_From_BackendSessionId_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForBackendSessionId_STATUS(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Source"] = gen.PtrOf(gen.OneConstOf(BackendSessionIdSource_STATUS_Cookie))
}
...
func RunPropertyAssignmentTestForBackendTlsProperties(subject BackendTlsProperties) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendTlsProperties
...
func RunPropertyAssignmentTestForBackendTlsProperties_STATUS(subject BackendTlsProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.BackendTlsProperties_STATUS
...
func RunPropertyAssignmentTestForBackend_STATUS(subject Backend_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.Backend_STATUS
...
func AddIndependentPropertyGeneratorsForBackend_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["PropertiesType"] = gen.PtrOf(gen.OneConstOf(BackendType_STATUS_Pool, BackendType_STATUS_Single))
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(BackendProtocol_STATUS_Http, BackendProtocol_STATUS_Soap))
...
func RunPropertyAssignmentTestForBackend_Spec(subject Backend_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.Backend_Spec
...
func AddIndependentPropertyGeneratorsForBackend_Spec(gens map[string]gopter.Gen) {
	...
	gens["AzureRegion"] = gen.PtrOf(gen.AlphaString())
	gens["Description"] = gen.PtrOf(gen.AlphaString())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(BackendProtocol_Http, BackendProtocol_Soap))
	gens["Title"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(BackendType_Pool, BackendType_Single))
	gens["Url"] = gen.PtrOf(gen.AlphaString())
}
...
func RunPropertyAssignmentTestForCircuitBreakerFailureCondition(subject CircuitBreakerFailureCondition) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.CircuitBreakerFailureCondition
...
func RunPropertyAssignmentTestForCircuitBreakerFailureCondition_STATUS(subject CircuitBreakerFailureCondition_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.CircuitBreakerFailureCondition_STATUS
...
func RunPropertyAssignmentTestForCircuitBreakerRule(subject CircuitBreakerRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.CircuitBreakerRule
...
func RunPropertyAssignmentTestForCircuitBreakerRule_STATUS(subject CircuitBreakerRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.CircuitBreakerRule_STATUS
...
func RunPropertyAssignmentTestForFailureStatusCodeRange(subject FailureStatusCodeRange) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.FailureStatusCodeRange
...
func RunPropertyAssignmentTestForFailureStatusCodeRange_STATUS(subject FailureStatusCodeRange_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.FailureStatusCodeRange_STATUS
...
func RunPropertyAssignmentTestForSystemData_STATUS(subject SystemData_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.SystemData_STATUS
...
func RunPropertyAssignmentTestForX509CertificateName(subject X509CertificateName) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.X509CertificateName
...
func RunPropertyAssignmentTestForX509CertificateName_STATUS(subject X509CertificateName_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20250301ps.X509CertificateName_STATUS
