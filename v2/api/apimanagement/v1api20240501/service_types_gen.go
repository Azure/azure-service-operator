...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2024-05-01/apimdeployment.json
...
func (service *Service_Spec) Initialize_From_Service_STATUS(source *Service_STATUS) error {
	...
	if source.ConfigurationApi != nil {
		var configurationApi ConfigurationApi
		err := configurationApi.Initialize_From_ConfigurationApi_STATUS(source.ConfigurationApi)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ConfigurationApi_STATUS() to populate field ConfigurationApi")
		}
		service.ConfigurationApi = &configurationApi
	} else {
		service.ConfigurationApi = nil
	...
	// DeveloperPortalStatus
	if source.DeveloperPortalStatus != nil {
		developerPortalStatus := genruntime.ToEnum(string(*source.DeveloperPortalStatus), apiManagementServiceProperties_DeveloperPortalStatus_Values)
		service.DeveloperPortalStatus = &developerPortalStatus
	} else {
		service.DeveloperPortalStatus = nil
	}
	...
	// LegacyPortalStatus
	if source.LegacyPortalStatus != nil {
		legacyPortalStatus := genruntime.ToEnum(string(*source.LegacyPortalStatus), apiManagementServiceProperties_LegacyPortalStatus_Values)
		service.LegacyPortalStatus = &legacyPortalStatus
	} else {
		service.LegacyPortalStatus = nil
	}
...
// Initialize_From_ConfigurationApi_STATUS populates our ConfigurationApi from the provided source ConfigurationApi_STATUS
func (configurationApi *ConfigurationApi) Initialize_From_ConfigurationApi_STATUS(source *ConfigurationApi_STATUS) error {

	// LegacyApi
	if source.LegacyApi != nil {
		legacyApi := genruntime.ToEnum(string(*source.LegacyApi), configurationApi_LegacyApi_Values)
		configurationApi.LegacyApi = &legacyApi
	} else {
		configurationApi.LegacyApi = nil
	}
