...
func RunResourceConversionTestForPolicy(subject Policy) string {
	...
	var hub apimanagement_v20240501s.Policy
...
func RunPropertyAssignmentTestForPolicy(subject Policy) string {
	...
	var other apimanagement_v1api20240501s.Policy
...
func RunPropertyAssignmentTestForPolicyOperatorSpec(subject PolicyOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other apimanagement_v1api20240501s.PolicyOperatorSpec
...
func RunPropertyAssignmentTestForPolicy_STATUS(subject Policy_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other apimanagement_v1api20240501s.Policy_STATUS
...
func RunPropertyAssignmentTestForPolicy_Spec(subject Policy_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other apimanagement_v1api20240501s.Policy_Spec
