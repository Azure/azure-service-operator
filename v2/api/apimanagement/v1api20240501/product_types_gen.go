...
// - Generated from: /apimanagement/resource-manager/Microsoft.ApiManagement/stable/2024-05-01/apimproducts.json
...
func (product *Product) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected apimanagement/v1api20240501/storage/Product but received %T instead", hub)
	}
