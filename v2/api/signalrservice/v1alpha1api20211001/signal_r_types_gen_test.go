...
// RunPropertyAssignmentTestForSignalR_STATUS tests if a specific instance of SignalR_STATUS can be assigned to v1alpha1api20211001storage and back losslessly
func RunPropertyAssignmentTestForSignalR_STATUS(subject SignalR_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211001s.SignalR_STATUS
...
// RunPropertyAssignmentTestForPrivateEndpointConnection_SignalR_SubResourceEmbedded tests if a specific instance of PrivateEndpointConnection_SignalR_SubResourceEmbedded can be assigned to v1alpha1api20211001storage and back losslessly
func RunPropertyAssignmentTestForPrivateEndpointConnection_SignalR_SubResourceEmbedded(subject PrivateEndpointConnection_SignalR_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211001s.PrivateEndpointConnection_SignalR_SubResourceEmbedded
...
// RunPropertyAssignmentTestForSharedPrivateLinkResource_SignalR_SubResourceEmbedded tests if a specific instance of SharedPrivateLinkResource_SignalR_SubResourceEmbedded can be assigned to v1alpha1api20211001storage and back losslessly
func RunPropertyAssignmentTestForSharedPrivateLinkResource_SignalR_SubResourceEmbedded(subject SharedPrivateLinkResource_SignalR_SubResourceEmbedded) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211001s.SharedPrivateLinkResource_SignalR_SubResourceEmbedded
...
// RunPropertyAssignmentTestForSystemData tests if a specific instance of SystemData can be assigned to v1alpha1api20211001storage and back losslessly
func RunPropertyAssignmentTestForSystemData(subject SystemData) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211001s.SystemData
...
// RunPropertyAssignmentTestForUserAssignedIdentityProperty tests if a specific instance of UserAssignedIdentityProperty can be assigned to v1alpha1api20211001storage and back losslessly
func RunPropertyAssignmentTestForUserAssignedIdentityProperty(subject UserAssignedIdentityProperty) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211001s.UserAssignedIdentityProperty
