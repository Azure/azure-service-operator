...
var _ admission.Defaulter = &CustomDomain{}

// Default applies defaults to the CustomDomain resource
func (domain *CustomDomain) Default() {
	domain.defaultImpl()
	var temp any = domain
...
func (domain *CustomDomain) defaultAzureName() {
...
func (domain *CustomDomain) defaultImpl() { domain.defaultAzureName() }
...
var _ admission.Validator = &CustomDomain{}

// ValidateCreate validates the creation of the resource
func (domain *CustomDomain) ValidateCreate() (admission.Warnings, error) {
...
func (domain *CustomDomain) ValidateDelete() (admission.Warnings, error) {
...
func (domain *CustomDomain) ValidateUpdate(old runtime.Object) (admission.Warnings, error) {
...
func (domain *CustomDomain) createValidations() []func() (admission.Warnings, error) {
...
func (domain *CustomDomain) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (domain *CustomDomain) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (domain *CustomDomain) validateConfigMapDestinations() (admission.Warnings, error) {
	if domain.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (domain *CustomDomain) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(domain)
}

// validateResourceReferences validates all resource references
func (domain *CustomDomain) validateResourceReferences() (admission.Warnings, error) {
...
func (domain *CustomDomain) validateSecretDestinations() (admission.Warnings, error) {
	if domain.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (domain *CustomDomain) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
	oldObj, ok := old.(*CustomDomain)
	if !ok {
		return nil, nil
	}
