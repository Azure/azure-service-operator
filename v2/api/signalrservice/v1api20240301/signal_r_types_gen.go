...
// +kubebuilder:webhook:path=/mutate-signalrservice-azure-com-v1api20240301-signalr,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=signalrservice.azure.com,resources=signalrs,verbs=create;update,versions=v1api20240301,name=default.v1api20240301.signalrs.signalrservice.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-signalrservice-azure-com-v1api20240301-signalr,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=signalrservice.azure.com,resources=signalrs,verbs=create;update,versions=v1api20240301,name=validate.v1api20240301.signalrs.signalrservice.azure.com,admissionReviewVersions=v1
...
func (signalR *SignalR_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if signalR.Kind != nil {
		...
		kind := arm.SignalrServiceKind(temp)
		result.Kind = &kind
	}
	...
	if signalR.Cors != nil ||
		...
		signalR.LiveTraceConfiguration != nil ||
		signalR.NetworkACLs != nil ||
		signalR.PublicNetworkAccess != nil ||
		signalR.RegionEndpointEnabled != nil ||
		signalR.ResourceLogConfiguration != nil ||
		signalR.ResourceStopped != nil ||
		signalR.Serverless != nil ||
		signalR.Tls != nil ||
	...
	if signalR.LiveTraceConfiguration != nil {
		...
		liveTraceConfiguration := *liveTraceConfiguration_ARM.(*arm.LiveTraceConfiguration)
	...
	if signalR.RegionEndpointEnabled != nil {
		regionEndpointEnabled := *signalR.RegionEndpointEnabled
	...
	if signalR.ResourceStopped != nil {
		resourceStopped := *signalR.ResourceStopped
	...
	if signalR.Serverless != nil {
		...
		serverless := *serverless_ARM.(*arm.ServerlessSettings)
...
func (signalR *SignalR_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.LiveTraceConfiguration != nil {
			var liveTraceConfiguration1 LiveTraceConfiguration
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.Serverless != nil {
			var serverless1 ServerlessSettings
...
func (signalR *SignalR_Spec) AssignProperties_From_SignalR_Spec(source *storage.SignalR_Spec) error {
	...
	if source.Kind != nil {
		kind := *source.Kind
		kindTemp := genruntime.ToEnum(kind, signalrServiceKind_Values)
	...
	if source.LiveTraceConfiguration != nil {
		var liveTraceConfiguration LiveTraceConfiguration
		err := liveTraceConfiguration.AssignProperties_From_LiveTraceConfiguration(source.LiveTraceConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_LiveTraceConfiguration() to populate field LiveTraceConfiguration")
		}
		signalR.LiveTraceConfiguration = &liveTraceConfiguration
	} else {
		signalR.LiveTraceConfiguration = nil
	...
	signalR.RegionEndpointEnabled = genruntime.ClonePointerToString(source.RegionEndpointEnabled)
	...
	// ResourceStopped
	signalR.ResourceStopped = genruntime.ClonePointerToString(source.ResourceStopped)

	// Serverless
	if source.Serverless != nil {
		var serverless ServerlessSettings
		err := serverless.AssignProperties_From_ServerlessSettings(source.Serverless)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_ServerlessSettings() to populate field Serverless")
		}
		signalR.Serverless = &serverless
	} else {
		signalR.Serverless = nil
...
func (signalR *SignalR_Spec) AssignProperties_To_SignalR_Spec(destination *storage.SignalR_Spec) error {
	...
	if signalR.LiveTraceConfiguration != nil {
		...
		err := signalR.LiveTraceConfiguration.AssignProperties_To_LiveTraceConfiguration(&liveTraceConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_LiveTraceConfiguration() to populate field LiveTraceConfiguration")
		}
	...
	// RegionEndpointEnabled
	destination.RegionEndpointEnabled = genruntime.ClonePointerToString(signalR.RegionEndpointEnabled)
	...
	// ResourceStopped
	destination.ResourceStopped = genruntime.ClonePointerToString(signalR.ResourceStopped)

	// Serverless
	if signalR.Serverless != nil {
		var serverless storage.ServerlessSettings
		err := signalR.Serverless.AssignProperties_To_ServerlessSettings(&serverless)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_ServerlessSettings() to populate field Serverless")
		}
...
func (signalR *SignalR_Spec) Initialize_From_SignalR_STATUS(source *SignalR_STATUS) error {
	...
	// Kind
	if source.Kind != nil {
		kind := genruntime.ToEnum(string(*source.Kind), signalrServiceKind_Values)
		signalR.Kind = &kind
	} else {
		signalR.Kind = nil
	}
	...
	if source.LiveTraceConfiguration != nil {
		var liveTraceConfiguration LiveTraceConfiguration
		err := liveTraceConfiguration.Initialize_From_LiveTraceConfiguration_STATUS(source.LiveTraceConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_LiveTraceConfiguration_STATUS() to populate field LiveTraceConfiguration")
		}
		signalR.LiveTraceConfiguration = &liveTraceConfiguration
	} else {
		signalR.LiveTraceConfiguration = nil
	...
	if source.Serverless != nil {
		var serverless ServerlessSettings
		err := serverless.Initialize_From_ServerlessSettings_STATUS(source.Serverless)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ServerlessSettings_STATUS() to populate field Serverless")
		}
		signalR.Serverless = &serverless
	} else {
		signalR.Serverless = nil
...
func (signalR *SignalR_STATUS) AssignProperties_From_SignalR_STATUS(source *storage.SignalR_STATUS) error {
	...
	if source.Kind != nil {
		kind := *source.Kind
		kindTemp := genruntime.ToEnum(kind, signalrServiceKind_STATUS_Values)
		signalR.Kind = &kindTemp
	} else {
		signalR.Kind = nil
	}
	...
	// LiveTraceConfiguration
	if source.LiveTraceConfiguration != nil {
		var liveTraceConfiguration LiveTraceConfiguration_STATUS
		err := liveTraceConfiguration.AssignProperties_From_LiveTraceConfiguration_STATUS(source.LiveTraceConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_LiveTraceConfiguration_STATUS() to populate field LiveTraceConfiguration")
		}
		signalR.LiveTraceConfiguration = &liveTraceConfiguration
	} else {
		signalR.LiveTraceConfiguration = nil
	...
	// Serverless
	if source.Serverless != nil {
		var serverless ServerlessSettings_STATUS
		err := serverless.AssignProperties_From_ServerlessSettings_STATUS(source.Serverless)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_ServerlessSettings_STATUS() to populate field Serverless")
		}
		signalR.Serverless = &serverless
	} else {
		signalR.Serverless = nil
...
func (signalR *SignalR_STATUS) AssignProperties_To_SignalR_STATUS(destination *storage.SignalR_STATUS) error {
	...
	if signalR.LiveTraceConfiguration != nil {
		...
		err := signalR.LiveTraceConfiguration.AssignProperties_To_LiveTraceConfiguration_STATUS(&liveTraceConfiguration)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_LiveTraceConfiguration_STATUS() to populate field LiveTraceConfiguration")
		}
		destination.LiveTraceConfiguration = &liveTraceConfiguration
	} else {
		destination.LiveTraceConfiguration = nil
	...
	if signalR.Serverless != nil {
		...
		err := signalR.Serverless.AssignProperties_To_ServerlessSettings_STATUS(&serverless)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_ServerlessSettings_STATUS() to populate field Serverless")
		}
		destination.Serverless = &serverless
	} else {
		destination.Serverless = nil
...
var _ genruntime.ARMTransformer = &LiveTraceConfiguration{}
...
func (configuration *LiveTraceConfiguration) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &arm.LiveTraceConfiguration{}
	...
	for _, item := range configuration.Categories {
		...
		result.Categories = append(result.Categories, *item_ARM.(*arm.LiveTraceCategory))
	}
...
func (configuration *LiveTraceConfiguration) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LiveTraceConfiguration{}
}
...
func (configuration *LiveTraceConfiguration) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LiveTraceConfiguration)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LiveTraceConfiguration, got %T", armInput)
	}

	// Set property "Categories":
	for _, item := range typedInput.Categories {
		var item1 LiveTraceCategory
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
...
func (configuration *LiveTraceConfiguration) AssignProperties_From_LiveTraceConfiguration(source *storage.LiveTraceConfiguration) error {
	...
	if source.Categories != nil {
		categoryList := make([]LiveTraceCategory, len(source.Categories))
		for categoryIndex, categoryItem := range source.Categories {
			// Shadow the loop variable to avoid aliasing
			categoryItem := categoryItem
			var category LiveTraceCategory
			err := category.AssignProperties_From_LiveTraceCategory(&categoryItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LiveTraceCategory() to populate field Categories")
			}
	...
	// Enabled
	configuration.Enabled = genruntime.ClonePointerToString(source.Enabled)
...
func (configuration *LiveTraceConfiguration) AssignProperties_To_LiveTraceConfiguration(destination *storage.LiveTraceConfiguration) error {
	...
	if configuration.Categories != nil {
		categoryList := make([]storage.LiveTraceCategory, len(configuration.Categories))
		for categoryIndex, categoryItem := range configuration.Categories {
			// Shadow the loop variable to avoid aliasing
			categoryItem := categoryItem
			var category storage.LiveTraceCategory
			err := categoryItem.AssignProperties_To_LiveTraceCategory(&category)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_LiveTraceCategory() to populate field Categories")
			}
			categoryList[categoryIndex] = category
		}
	...
	// Enabled
	destination.Enabled = genruntime.ClonePointerToString(configuration.Enabled)
...
func (configuration *LiveTraceConfiguration) Initialize_From_LiveTraceConfiguration_STATUS(source *LiveTraceConfiguration_STATUS) error {
	...
	if source.Categories != nil {
		...
		for categoryIndex, categoryItem := range source.Categories {
			...
			categoryItem := categoryItem
			var category LiveTraceCategory
			err := category.Initialize_From_LiveTraceCategory_STATUS(&categoryItem)
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_LiveTraceCategory_STATUS() to populate field Categories")
			}
			categoryList[categoryIndex] = category
		}
		configuration.Categories = categoryList
...
var _ genruntime.FromARMConverter = &LiveTraceConfiguration_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (configuration *LiveTraceConfiguration_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LiveTraceConfiguration_STATUS{}
}
...
func (configuration *LiveTraceConfiguration_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LiveTraceConfiguration_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LiveTraceConfiguration_STATUS, got %T", armInput)
	}

	// Set property "Categories":
	for _, item := range typedInput.Categories {
		var item1 LiveTraceCategory_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
...
func (configuration *LiveTraceConfiguration_STATUS) AssignProperties_From_LiveTraceConfiguration_STATUS(source *storage.LiveTraceConfiguration_STATUS) error {
	...
	// Categories
	if source.Categories != nil {
		categoryList := make([]LiveTraceCategory_STATUS, len(source.Categories))
		for categoryIndex, categoryItem := range source.Categories {
			// Shadow the loop variable to avoid aliasing
			categoryItem := categoryItem
			var category LiveTraceCategory_STATUS
			err := category.AssignProperties_From_LiveTraceCategory_STATUS(&categoryItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_LiveTraceCategory_STATUS() to populate field Categories")
			}
			categoryList[categoryIndex] = category
		}
		configuration.Categories = categoryList
...
func (configuration *LiveTraceConfiguration_STATUS) AssignProperties_To_LiveTraceConfiguration_STATUS(destination *storage.LiveTraceConfiguration_STATUS) error {
	...
	// Categories
	if configuration.Categories != nil {
		categoryList := make([]storage.LiveTraceCategory_STATUS, len(configuration.Categories))
		for categoryIndex, categoryItem := range configuration.Categories {
			// Shadow the loop variable to avoid aliasing
			categoryItem := categoryItem
			var category storage.LiveTraceCategory_STATUS
			err := categoryItem.AssignProperties_To_LiveTraceCategory_STATUS(&category)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_LiveTraceCategory_STATUS() to populate field Categories")
			}
			categoryList[categoryIndex] = category
		}
		destination.Categories = categoryList
...
var _ genruntime.ARMTransformer = &ServerlessSettings{}
...
func (settings *ServerlessSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &arm.ServerlessSettings{}

	// Set property "ConnectionTimeoutInSeconds":
	if settings.ConnectionTimeoutInSeconds != nil {
		connectionTimeoutInSeconds := *settings.ConnectionTimeoutInSeconds
		result.ConnectionTimeoutInSeconds = &connectionTimeoutInSeconds
	}
	return result, nil
}
...
func (settings *ServerlessSettings) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ServerlessSettings{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *ServerlessSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ServerlessSettings)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ServerlessSettings, got %T", armInput)
	}

	// Set property "ConnectionTimeoutInSeconds":
	if typedInput.ConnectionTimeoutInSeconds != nil {
		connectionTimeoutInSeconds := *typedInput.ConnectionTimeoutInSeconds
		settings.ConnectionTimeoutInSeconds = &connectionTimeoutInSeconds
	}
...
var _ genruntime.FromARMConverter = &ServerlessSettings_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *ServerlessSettings_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ServerlessSettings_STATUS{}
}
...
func (settings *ServerlessSettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ServerlessSettings_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ServerlessSettings_STATUS, got %T", armInput)
	}
...
func (rule *IPRule) AssignProperties_From_IPRule(source *storage.IPRule) error {
	...
	if source.Action != nil {
		...
		actionTemp := genruntime.ToEnum(action, aCLAction_Values)
...
func (rule *IPRule) Initialize_From_IPRule_STATUS(source *IPRule_STATUS) error {
	...
	// Action
	if source.Action != nil {
		action := genruntime.ToEnum(string(*source.Action), aCLAction_Values)
		rule.Action = &action
	} else {
		rule.Action = nil
	}
...
func (rule *IPRule_STATUS) AssignProperties_From_IPRule_STATUS(source *storage.IPRule_STATUS) error {
	...
	if source.Action != nil {
		action := *source.Action
		actionTemp := genruntime.ToEnum(action, aCLAction_STATUS_Values)
		rule.Action = &actionTemp
	} else {
		rule.Action = nil
	}
...
var _ genruntime.ARMTransformer = &LiveTraceCategory{}
...
func (category *LiveTraceCategory) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LiveTraceCategory{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (category *LiveTraceCategory) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LiveTraceCategory)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LiveTraceCategory, got %T", armInput)
	}
...
var _ genruntime.FromARMConverter = &LiveTraceCategory_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (category *LiveTraceCategory_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.LiveTraceCategory_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (category *LiveTraceCategory_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.LiveTraceCategory_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.LiveTraceCategory_STATUS, got %T", armInput)
	}
