...
type ServersDatabasesTransparentDataEncryption_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ServersDatabasesTransparentDataEncryption_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (encryption ServersDatabasesTransparentDataEncryption_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (encryption *ServersDatabasesTransparentDataEncryption_Spec_ARM) GetName() string {
...
func (encryption *ServersDatabasesTransparentDataEncryption_Spec_ARM) GetType() string {
