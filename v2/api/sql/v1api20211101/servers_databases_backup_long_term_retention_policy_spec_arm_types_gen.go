...
type ServersDatabasesBackupLongTermRetentionPolicy_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ServersDatabasesBackupLongTermRetentionPolicy_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (policy ServersDatabasesBackupLongTermRetentionPolicy_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec_ARM) GetName() string {
	return policy.Name
}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec_ARM) GetType() string {
