...
type ServersFirewallRule_Spec_ARM struct {
	// Name: Resource name.
...
var _ genruntime.ARMResourceSpec = &ServersFirewallRule_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (rule ServersFirewallRule_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (rule *ServersFirewallRule_Spec_ARM) GetName() string {
	return rule.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Sql/servers/firewallRules"
func (rule *ServersFirewallRule_Spec_ARM) GetType() string {
