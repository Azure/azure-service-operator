...
func Test_ServersDatabasesSecurityAlertPolicy_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ServersDatabasesSecurityAlertPolicy_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_Spec_ARM, ServersDatabasesSecurityAlertPolicy_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_Spec_ARM runs a test to see if a specific instance of ServersDatabasesSecurityAlertPolicy_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_Spec_ARM(subject ServersDatabasesSecurityAlertPolicy_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ServersDatabasesSecurityAlertPolicy_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ServersDatabasesSecurityAlertPolicy_Spec_ARM instances for property testing - lazily instantiated by
// ServersDatabasesSecurityAlertPolicy_Spec_ARMGenerator()
var serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator gopter.Gen

// ServersDatabasesSecurityAlertPolicy_Spec_ARMGenerator returns a generator of ServersDatabasesSecurityAlertPolicy_Spec_ARM instances for property testing.
// We first initialize serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServersDatabasesSecurityAlertPolicy_Spec_ARMGenerator() gopter.Gen {
	if serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator != nil {
		return serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM(generators)
	serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(ServersDatabasesSecurityAlertPolicy_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM(generators)
	serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(ServersDatabasesSecurityAlertPolicy_Spec_ARM{}), generators)

	return serversDatabasesSecurityAlertPolicy_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_Spec_ARM(gens map[string]gopter.Gen) {
