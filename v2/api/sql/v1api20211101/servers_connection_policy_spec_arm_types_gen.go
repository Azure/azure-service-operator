...
type ServersConnectionPolicy_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ServersConnectionPolicy_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (policy ServersConnectionPolicy_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (policy *ServersConnectionPolicy_Spec_ARM) GetName() string {
	return policy.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Sql/servers/connectionPolicies"
func (policy *ServersConnectionPolicy_Spec_ARM) GetType() string {
