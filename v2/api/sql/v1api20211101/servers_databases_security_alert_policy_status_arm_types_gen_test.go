...
func AddIndependentPropertyGeneratorsForDatabaseSecurityAlertPoliciesSecurityAlertsPolicyProperties_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["State"] = gen.PtrOf(gen.OneConstOf(DatabaseSecurityAlertPoliciesSecurityAlertsPolicyProperties_State_STATUS_ARM_Disabled, DatabaseSecurityAlertPoliciesSecurityAlertsPolicyProperties_State_STATUS_ARM_Enabled))
	gens["StorageEndpoint"] = gen.PtrOf(gen.AlphaString())
}

func Test_ServersDatabasesSecurityAlertPolicy_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ServersDatabasesSecurityAlertPolicy_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_STATUS_ARM, ServersDatabasesSecurityAlertPolicy_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_STATUS_ARM runs a test to see if a specific instance of ServersDatabasesSecurityAlertPolicy_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForServersDatabasesSecurityAlertPolicy_STATUS_ARM(subject ServersDatabasesSecurityAlertPolicy_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ServersDatabasesSecurityAlertPolicy_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ServersDatabasesSecurityAlertPolicy_STATUS_ARM instances for property testing - lazily instantiated by
// ServersDatabasesSecurityAlertPolicy_STATUS_ARMGenerator()
var serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator gopter.Gen

// ServersDatabasesSecurityAlertPolicy_STATUS_ARMGenerator returns a generator of ServersDatabasesSecurityAlertPolicy_STATUS_ARM instances for property testing.
// We first initialize serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServersDatabasesSecurityAlertPolicy_STATUS_ARMGenerator() gopter.Gen {
	if serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator != nil {
		return serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM(generators)
	serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ServersDatabasesSecurityAlertPolicy_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM(generators)
	serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ServersDatabasesSecurityAlertPolicy_STATUS_ARM{}), generators)

	return serversDatabasesSecurityAlertPolicy_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServersDatabasesSecurityAlertPolicy_STATUS_ARM(gens map[string]gopter.Gen) {
