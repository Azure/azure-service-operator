...
// RunPropertyAssignmentTestForServersAuditingSetting tests if a specific instance of ServersAuditingSetting can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_AuditingSetting_Spec tests if a specific instance of Servers_AuditingSetting_Spec can be assigned to v1api20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_AuditingSetting_STATUS tests if a specific instance of Servers_AuditingSetting_STATUS can be assigned to v1api20211101storage and back losslessly
