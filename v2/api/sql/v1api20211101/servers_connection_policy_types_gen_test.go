...
// RunPropertyAssignmentTestForServers_ConnectionPolicy_STATUS tests if a specific instance of Servers_ConnectionPolicy_STATUS can be assigned to storage and back losslessly
