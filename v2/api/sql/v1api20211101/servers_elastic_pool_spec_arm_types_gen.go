...
type ServersElasticPool_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ServersElasticPool_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (pool ServersElasticPool_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (pool *ServersElasticPool_Spec_ARM) GetName() string {
	return pool.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Sql/servers/elasticPools"
func (pool *ServersElasticPool_Spec_ARM) GetType() string {
