...
func Test_ServersVirtualNetworkRule_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of ServersVirtualNetworkRule_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForServersVirtualNetworkRule_STATUS_ARM, ServersVirtualNetworkRule_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServersVirtualNetworkRule_STATUS_ARM runs a test to see if a specific instance of ServersVirtualNetworkRule_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForServersVirtualNetworkRule_STATUS_ARM(subject ServersVirtualNetworkRule_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual ServersVirtualNetworkRule_STATUS_ARM
...
// Generator of ServersVirtualNetworkRule_STATUS_ARM instances for property testing - lazily instantiated by
// ServersVirtualNetworkRule_STATUS_ARMGenerator()
var serversVirtualNetworkRule_STATUS_ARMGenerator gopter.Gen

// ServersVirtualNetworkRule_STATUS_ARMGenerator returns a generator of ServersVirtualNetworkRule_STATUS_ARM instances for property testing.
// We first initialize serversVirtualNetworkRule_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ServersVirtualNetworkRule_STATUS_ARMGenerator() gopter.Gen {
	if serversVirtualNetworkRule_STATUS_ARMGenerator != nil {
		return serversVirtualNetworkRule_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM(generators)
	serversVirtualNetworkRule_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ServersVirtualNetworkRule_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM(generators)
	serversVirtualNetworkRule_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ServersVirtualNetworkRule_STATUS_ARM{}), generators)

	return serversVirtualNetworkRule_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForServersVirtualNetworkRule_STATUS_ARM(gens map[string]gopter.Gen) {
