...
type ServersDatabasesBackupShortTermRetentionPolicy_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &ServersDatabasesBackupShortTermRetentionPolicy_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-11-01"
func (policy ServersDatabasesBackupShortTermRetentionPolicy_Spec_ARM) GetAPIVersion() string {
	return "2021-11-01"
}

// GetName returns the Name of the resource
func (policy *ServersDatabasesBackupShortTermRetentionPolicy_Spec_ARM) GetName() string {
	return policy.Name
}
...
func (policy *ServersDatabasesBackupShortTermRetentionPolicy_Spec_ARM) GetType() string {
