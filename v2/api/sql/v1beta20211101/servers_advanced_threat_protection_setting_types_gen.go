...
func (setting *ServersAdvancedThreatProtectionSetting) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v1beta20211101storage/ServersAdvancedThreatProtectionSetting but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v1beta20211101-serversadvancedthreatprotectionsetting,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversadvancedthreatprotectionsettings,verbs=create;update,versions=v1beta20211101,name=default.v1beta20211101.serversadvancedthreatprotectionsettings.sql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v1beta20211101-serversadvancedthreatprotectionsetting,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversadvancedthreatprotectionsettings,verbs=create;update,versions=v1beta20211101,name=validate.v1beta20211101.serversadvancedthreatprotectionsettings.sql.azure.com,admissionReviewVersions=v1

var _ admission.Validator = &ServersAdvancedThreatProtectionSetting{}

// ValidateCreate validates the creation of the resource
func (setting *ServersAdvancedThreatProtectionSetting) ValidateCreate() error {
...
func (setting *ServersAdvancedThreatProtectionSetting) ValidateDelete() error {
...
func (setting *ServersAdvancedThreatProtectionSetting) ValidateUpdate(old runtime.Object) error {
...
func (setting *ServersAdvancedThreatProtectionSetting) createValidations() []func() error {
	return []func() error{setting.validateResourceReferences}
}

// deleteValidations validates the deletion of the resource
func (setting *ServersAdvancedThreatProtectionSetting) deleteValidations() []func() error {
	return nil
}

// updateValidations validates the update of the resource
func (setting *ServersAdvancedThreatProtectionSetting) updateValidations() []func(old runtime.Object) error {
...
func (setting *ServersAdvancedThreatProtectionSetting) validateResourceReferences() error {
...
func (setting *ServersAdvancedThreatProtectionSetting) validateWriteOnceProperties(old runtime.Object) error {
