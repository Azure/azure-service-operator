...
// RunPropertyAssignmentTestForServersDatabasesAdvancedThreatProtectionSetting tests if a specific instance of ServersDatabasesAdvancedThreatProtectionSetting can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_Databases_AdvancedThreatProtectionSetting_Spec tests if a specific instance of Servers_Databases_AdvancedThreatProtectionSetting_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_Databases_AdvancedThreatProtectionSetting_STATUS tests if a specific instance of Servers_Databases_AdvancedThreatProtectionSetting_STATUS can be assigned to v1beta20211101storage and back losslessly
