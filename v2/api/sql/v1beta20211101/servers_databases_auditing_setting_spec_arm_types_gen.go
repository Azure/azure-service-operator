...
var _ genruntime.ARMResourceSpec = &Servers_Databases_AuditingSetting_Spec_ARM{}
...
func (setting *Servers_Databases_AuditingSetting_Spec_ARM) GetName() string {
	return setting.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Sql/servers/databases/auditingSettings"
func (setting *Servers_Databases_AuditingSetting_Spec_ARM) GetType() string {
