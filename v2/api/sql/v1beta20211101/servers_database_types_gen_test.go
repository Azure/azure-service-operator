...
// RunPropertyAssignmentTestForServersDatabase tests if a specific instance of ServersDatabase can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_Database_Spec tests if a specific instance of Servers_Database_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_Database_STATUS tests if a specific instance of Servers_Database_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForDatabaseIdentity tests if a specific instance of DatabaseIdentity can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForDatabaseIdentity_STATUS tests if a specific instance of DatabaseIdentity_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForDatabaseUserIdentity_STATUS tests if a specific instance of DatabaseUserIdentity_STATUS can be assigned to v1beta20211101storage and back losslessly
