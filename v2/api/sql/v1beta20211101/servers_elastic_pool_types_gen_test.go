...
// RunPropertyAssignmentTestForServersElasticPool tests if a specific instance of ServersElasticPool can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_ElasticPool_Spec tests if a specific instance of Servers_ElasticPool_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_ElasticPool_STATUS tests if a specific instance of Servers_ElasticPool_STATUS can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForElasticPoolPerDatabaseSettings tests if a specific instance of ElasticPoolPerDatabaseSettings can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForElasticPoolPerDatabaseSettings_STATUS tests if a specific instance of ElasticPoolPerDatabaseSettings_STATUS can be assigned to v1beta20211101storage and back losslessly
