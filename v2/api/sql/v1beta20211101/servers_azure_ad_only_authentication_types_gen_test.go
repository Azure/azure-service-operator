...
// RunPropertyAssignmentTestForServersAzureADOnlyAuthentication tests if a specific instance of ServersAzureADOnlyAuthentication can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_AzureADOnlyAuthentication_Spec tests if a specific instance of Servers_AzureADOnlyAuthentication_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_AzureADOnlyAuthentication_STATUS tests if a specific instance of Servers_AzureADOnlyAuthentication_STATUS can be assigned to v1beta20211101storage and back losslessly
