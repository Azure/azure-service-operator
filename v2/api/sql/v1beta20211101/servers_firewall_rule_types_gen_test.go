...
// RunPropertyAssignmentTestForServers_FirewallRule_Spec tests if a specific instance of Servers_FirewallRule_Spec can be assigned to v1beta20211101storage and back losslessly
...
// RunPropertyAssignmentTestForServers_FirewallRule_STATUS tests if a specific instance of Servers_FirewallRule_STATUS can be assigned to v1beta20211101storage and back losslessly
