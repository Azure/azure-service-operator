...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v20211101-serversoutboundfirewallrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversoutboundfirewallrules,verbs=create;update,versions=v20211101,name=default.v20211101.serversoutboundfirewallrules.sql.azure.com,admissionReviewVersions=v1
...
func (rule *ServersOutboundFirewallRule) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersOutboundFirewallRule, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v20211101-serversoutboundfirewallrule,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversoutboundfirewallrules,verbs=create;update,versions=v20211101,name=validate.v20211101.serversoutboundfirewallrules.sql.azure.com,admissionReviewVersions=v1
...
func (rule *ServersOutboundFirewallRule) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersOutboundFirewallRule, but got %T", resource)
	}
...
func (rule *ServersOutboundFirewallRule) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersOutboundFirewallRule, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.ServersOutboundFirewallRule)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersOutboundFirewallRule, but got %T", oldResource)
	}
