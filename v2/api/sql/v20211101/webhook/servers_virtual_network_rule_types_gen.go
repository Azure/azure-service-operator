...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v20211101-serversvirtualnetworkrule,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversvirtualnetworkrules,verbs=create;update,versions=v20211101,name=default.v20211101.serversvirtualnetworkrules.sql.azure.com,admissionReviewVersions=v1
...
func (rule *ServersVirtualNetworkRule) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersVirtualNetworkRule, but got %T", obj)
	}
...
func (rule *ServersVirtualNetworkRule) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersVirtualNetworkRule, but got %T", resource)
	}
...
func (rule *ServersVirtualNetworkRule) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersVirtualNetworkRule, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.ServersVirtualNetworkRule)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersVirtualNetworkRule, but got %T", oldResource)
	}
