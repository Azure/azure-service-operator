...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v20211101-serversdatabasessecurityalertpolicy,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabasessecurityalertpolicies,verbs=create;update,versions=v20211101,name=default.v20211101.serversdatabasessecurityalertpolicies.sql.azure.com,admissionReviewVersions=v1
...
func (policy *ServersDatabasesSecurityAlertPolicy) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabasesSecurityAlertPolicy, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v20211101-serversdatabasessecurityalertpolicy,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabasessecurityalertpolicies,verbs=create;update,versions=v20211101,name=validate.v20211101.serversdatabasessecurityalertpolicies.sql.azure.com,admissionReviewVersions=v1
...
func (policy *ServersDatabasesSecurityAlertPolicy) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabasesSecurityAlertPolicy, but got %T", resource)
	}
...
func (policy *ServersDatabasesSecurityAlertPolicy) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabasesSecurityAlertPolicy, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.ServersDatabasesSecurityAlertPolicy)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabasesSecurityAlertPolicy, but got %T", oldResource)
	}
...
func (policy *ServersDatabasesSecurityAlertPolicy) createValidations() []func(ctx context.Context, obj *v20211101.ServersDatabasesSecurityAlertPolicy) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20211101.ServersDatabasesSecurityAlertPolicy) (admission.Warnings, error){
