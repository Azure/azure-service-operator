...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v20211101-serversdatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabases,verbs=create;update,versions=v20211101,name=default.v20211101.serversdatabases.sql.azure.com,admissionReviewVersions=v1
...
func (database *ServersDatabase) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabase, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v20211101-serversdatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversdatabases,verbs=create;update,versions=v20211101,name=validate.v20211101.serversdatabases.sql.azure.com,admissionReviewVersions=v1
...
func (database *ServersDatabase) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabase, but got %T", resource)
	}
...
func (database *ServersDatabase) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabase, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.ServersDatabase)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersDatabase, but got %T", oldResource)
	}
...
func (database *ServersDatabase) createValidations() []func(ctx context.Context, obj *v20211101.ServersDatabase) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20211101.ServersDatabase) (admission.Warnings, error){
