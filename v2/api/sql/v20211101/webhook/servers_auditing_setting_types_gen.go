...
// +kubebuilder:webhook:path=/mutate-sql-azure-com-v20211101-serversauditingsetting,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversauditingsettings,verbs=create;update,versions=v20211101,name=default.v20211101.serversauditingsettings.sql.azure.com,admissionReviewVersions=v1
...
func (setting *ServersAuditingSetting) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersAuditingSetting, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-sql-azure-com-v20211101-serversauditingsetting,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=sql.azure.com,resources=serversauditingsettings,verbs=create;update,versions=v20211101,name=validate.v20211101.serversauditingsettings.sql.azure.com,admissionReviewVersions=v1
...
func (setting *ServersAuditingSetting) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersAuditingSetting, but got %T", resource)
	}
...
func (setting *ServersAuditingSetting) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersAuditingSetting, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20211101.ServersAuditingSetting)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/sql/v20211101/ServersAuditingSetting, but got %T", oldResource)
	}
...
func (setting *ServersAuditingSetting) createValidations() []func(ctx context.Context, obj *v20211101.ServersAuditingSetting) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20211101.ServersAuditingSetting) (admission.Warnings, error){
