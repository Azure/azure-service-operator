...
func (rule *ServersFirewallRule) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v20250101/storage/ServersFirewallRule but received %T instead", hub)
	}
...
// Storage version of v20211101.ServersFirewallRule_Spec
...
// Storage version of v20211101.ServersFirewallRule_STATUS
