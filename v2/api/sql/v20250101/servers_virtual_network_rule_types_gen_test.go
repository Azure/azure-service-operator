...
func AddIndependentPropertyGeneratorsForServersVirtualNetworkRule_STATUS(gens map[string]gopter.Gen) {
	...
	gens["State"] = gen.PtrOf(gen.OneConstOf(
		VirtualNetworkRuleState_STATUS_Deleting,
		VirtualNetworkRuleState_STATUS_Failed,
		VirtualNetworkRuleState_STATUS_InProgress,
		VirtualNetworkRuleState_STATUS_Initializing,
		VirtualNetworkRuleState_STATUS_Ready,
		VirtualNetworkRuleState_STATUS_Unknown))
