...
func AddIndependentPropertyGeneratorsForServersDatabasesTransparentDataEncryption_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ScanState"] = gen.PtrOf(gen.OneConstOf(
		TransparentDataEncryptionScanState_STATUS_Aborted,
		TransparentDataEncryptionScanState_STATUS_Completed,
		TransparentDataEncryptionScanState_STATUS_None,
		TransparentDataEncryptionScanState_STATUS_Resume,
		TransparentDataEncryptionScanState_STATUS_Running,
		TransparentDataEncryptionScanState_STATUS_Suspend))
	gens["State"] = gen.PtrOf(gen.OneConstOf(TransparentDataEncryptionState_STATUS_Disabled, TransparentDataEncryptionState_STATUS_Enabled))
...
func AddIndependentPropertyGeneratorsForServersDatabasesTransparentDataEncryption_Spec(gens map[string]gopter.Gen) {
	gens["ScanState"] = gen.PtrOf(gen.OneConstOf(
		TransparentDataEncryptionScanState_Aborted,
		TransparentDataEncryptionScanState_Completed,
		TransparentDataEncryptionScanState_None,
		TransparentDataEncryptionScanState_Resume,
		TransparentDataEncryptionScanState_Running,
		TransparentDataEncryptionScanState_Suspend))
	gens["State"] = gen.PtrOf(gen.OneConstOf(TransparentDataEncryptionState_Disabled, TransparentDataEncryptionState_Enabled))
}
