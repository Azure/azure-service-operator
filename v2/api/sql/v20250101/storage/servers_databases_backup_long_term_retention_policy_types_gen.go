...
// Storage version of v20250101.ServersDatabasesBackupLongTermRetentionPolicy_Spec
type ServersDatabasesBackupLongTermRetentionPolicy_Spec struct {
	...
	TimeBasedImmutability     *string                            `json:"timeBasedImmutability,omitempty"`
	TimeBasedImmutabilityMode *string                            `json:"timeBasedImmutabilityMode,omitempty"`
...
// Storage version of v20250101.ServersDatabasesBackupLongTermRetentionPolicy_STATUS
