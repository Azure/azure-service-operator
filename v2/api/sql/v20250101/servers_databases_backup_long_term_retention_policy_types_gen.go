...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if policy.MonthlyRetention != nil ||
		policy.TimeBasedImmutability != nil ||
		policy.TimeBasedImmutabilityMode != nil ||
		policy.WeekOfYear != nil ||
		policy.WeeklyRetention != nil ||
		policy.YearlyRetention != nil {
		result.Properties = &arm.LongTermRetentionPolicyProperties{}
	}
	if policy.MonthlyRetention != nil {
		monthlyRetention := *policy.MonthlyRetention
		result.Properties.MonthlyRetention = &monthlyRetention
	}
	if policy.TimeBasedImmutability != nil {
		var temp string
		temp = string(*policy.TimeBasedImmutability)
		timeBasedImmutability := arm.TimeBasedImmutability(temp)
		result.Properties.TimeBasedImmutability = &timeBasedImmutability
	}
	if policy.TimeBasedImmutabilityMode != nil {
		var temp string
		temp = string(*policy.TimeBasedImmutabilityMode)
		timeBasedImmutabilityMode := arm.TimeBasedImmutabilityMode(temp)
		result.Properties.TimeBasedImmutabilityMode = &timeBasedImmutabilityMode
	}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "TimeBasedImmutability":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.TimeBasedImmutability != nil {
			var temp string
			temp = string(*typedInput.Properties.TimeBasedImmutability)
			timeBasedImmutability := TimeBasedImmutability(temp)
			policy.TimeBasedImmutability = &timeBasedImmutability
		}
	}

	// Set property "TimeBasedImmutabilityMode":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.TimeBasedImmutabilityMode != nil {
			var temp string
			temp = string(*typedInput.Properties.TimeBasedImmutabilityMode)
			timeBasedImmutabilityMode := TimeBasedImmutabilityMode(temp)
			policy.TimeBasedImmutabilityMode = &timeBasedImmutabilityMode
		}
	}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec) AssignProperties_From_ServersDatabasesBackupLongTermRetentionPolicy_Spec(source *storage.ServersDatabasesBackupLongTermRetentionPolicy_Spec) error {
	...
	if source.TimeBasedImmutability != nil {
		timeBasedImmutability := *source.TimeBasedImmutability
		timeBasedImmutabilityTemp := genruntime.ToEnum(timeBasedImmutability, timeBasedImmutability_Values)
		policy.TimeBasedImmutability = &timeBasedImmutabilityTemp
	} else {
		policy.TimeBasedImmutability = nil
	}
	...
	if source.TimeBasedImmutabilityMode != nil {
		timeBasedImmutabilityMode := *source.TimeBasedImmutabilityMode
		timeBasedImmutabilityModeTemp := genruntime.ToEnum(timeBasedImmutabilityMode, timeBasedImmutabilityMode_Values)
		policy.TimeBasedImmutabilityMode = &timeBasedImmutabilityModeTemp
	} else {
		policy.TimeBasedImmutabilityMode = nil
	}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec) AssignProperties_To_ServersDatabasesBackupLongTermRetentionPolicy_Spec(destination *storage.ServersDatabasesBackupLongTermRetentionPolicy_Spec) error {
	...
	// TimeBasedImmutability
	if policy.TimeBasedImmutability != nil {
		timeBasedImmutability := string(*policy.TimeBasedImmutability)
	...
	// TimeBasedImmutabilityMode
	if policy.TimeBasedImmutabilityMode != nil {
		timeBasedImmutabilityMode := string(*policy.TimeBasedImmutabilityMode)
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_Spec) Initialize_From_ServersDatabasesBackupLongTermRetentionPolicy_STATUS(source *ServersDatabasesBackupLongTermRetentionPolicy_STATUS) error {
	...
	// TimeBasedImmutability
	if source.TimeBasedImmutability != nil {
		timeBasedImmutability := genruntime.ToEnum(string(*source.TimeBasedImmutability), timeBasedImmutability_Values)
		policy.TimeBasedImmutability = &timeBasedImmutability
	} else {
		policy.TimeBasedImmutability = nil
	}
	...
	// TimeBasedImmutabilityMode
	if source.TimeBasedImmutabilityMode != nil {
		timeBasedImmutabilityMode := genruntime.ToEnum(string(*source.TimeBasedImmutabilityMode), timeBasedImmutabilityMode_Values)
		policy.TimeBasedImmutabilityMode = &timeBasedImmutabilityMode
	} else {
		policy.TimeBasedImmutabilityMode = nil
	}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.TimeBasedImmutability != nil {
			var temp string
			temp = string(*typedInput.Properties.TimeBasedImmutability)
			timeBasedImmutability := TimeBasedImmutability_STATUS(temp)
			policy.TimeBasedImmutability = &timeBasedImmutability
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.TimeBasedImmutabilityMode != nil {
			var temp string
			temp = string(*typedInput.Properties.TimeBasedImmutabilityMode)
			timeBasedImmutabilityMode := TimeBasedImmutabilityMode_STATUS(temp)
			policy.TimeBasedImmutabilityMode = &timeBasedImmutabilityMode
		}
	}
...
func (policy *ServersDatabasesBackupLongTermRetentionPolicy_STATUS) AssignProperties_From_ServersDatabasesBackupLongTermRetentionPolicy_STATUS(source *storage.ServersDatabasesBackupLongTermRetentionPolicy_STATUS) error {
	...
	if source.TimeBasedImmutability != nil {
		timeBasedImmutability := *source.TimeBasedImmutability
		timeBasedImmutabilityTemp := genruntime.ToEnum(timeBasedImmutability, timeBasedImmutability_STATUS_Values)
		policy.TimeBasedImmutability = &timeBasedImmutabilityTemp
	} else {
		policy.TimeBasedImmutability = nil
	}
	...
	if source.TimeBasedImmutabilityMode != nil {
		timeBasedImmutabilityMode := *source.TimeBasedImmutabilityMode
		timeBasedImmutabilityModeTemp := genruntime.ToEnum(timeBasedImmutabilityMode, timeBasedImmutabilityMode_STATUS_Values)
		policy.TimeBasedImmutabilityMode = &timeBasedImmutabilityModeTemp
	} else {
		policy.TimeBasedImmutabilityMode = nil
	}
