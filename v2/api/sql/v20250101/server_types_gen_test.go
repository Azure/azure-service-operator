...
func AddIndependentPropertyGeneratorsForPrivateEndpointConnectionProperties_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(
		PrivateEndpointProvisioningState_STATUS_Approving,
		PrivateEndpointProvisioningState_STATUS_Dropping,
		PrivateEndpointProvisioningState_STATUS_Failed,
		PrivateEndpointProvisioningState_STATUS_Ready,
		PrivateEndpointProvisioningState_STATUS_Rejecting))
}
...
// RunPropertyAssignmentTestForPrivateLinkServiceConnectionStateProperty_STATUS tests if a specific instance of PrivateLinkServiceConnectionStateProperty_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForPrivateLinkServiceConnectionStateProperty_STATUS(subject PrivateLinkServiceConnectionStateProperty_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.PrivateLinkServiceConnectionStateProperty_STATUS
...
func AddIndependentPropertyGeneratorsForPrivateLinkServiceConnectionStateProperty_STATUS(gens map[string]gopter.Gen) {
	gens["ActionsRequired"] = gen.PtrOf(gen.OneConstOf(PrivateLinkServiceConnectionStateActionsRequire_STATUS_None))
	gens["Description"] = gen.PtrOf(gen.AlphaString())
	gens["Status"] = gen.PtrOf(gen.OneConstOf(
		PrivateLinkServiceConnectionStateStatus_STATUS_Approved,
		PrivateLinkServiceConnectionStateStatus_STATUS_Disconnected,
		PrivateLinkServiceConnectionStateStatus_STATUS_Pending,
		PrivateLinkServiceConnectionStateStatus_STATUS_Rejected))
}
...
// RunPropertyAssignmentTestForResourceIdentity tests if a specific instance of ResourceIdentity can be assigned to storage and back losslessly
...
// RunPropertyAssignmentTestForResourceIdentity_STATUS tests if a specific instance of ResourceIdentity_STATUS can be assigned to storage and back losslessly
...
func AddIndependentPropertyGeneratorsForResourceIdentity_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(
		IdentityType_STATUS_None,
		IdentityType_STATUS_SystemAssigned,
		IdentityType_STATUS_SystemAssignedUserAssigned,
		IdentityType_STATUS_UserAssigned))
}
...
// RunPropertyAssignmentTestForServerExternalAdministrator tests if a specific instance of ServerExternalAdministrator can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForServerExternalAdministrator(subject ServerExternalAdministrator) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ServerExternalAdministrator
...
func AddIndependentPropertyGeneratorsForServerExternalAdministrator(gens map[string]gopter.Gen) {
	gens["AdministratorType"] = gen.PtrOf(gen.OneConstOf(AdministratorType_ActiveDirectory))
	gens["AzureADOnlyAuthentication"] = gen.PtrOf(gen.Bool())
	gens["Login"] = gen.PtrOf(gen.AlphaString())
	gens["PrincipalType"] = gen.PtrOf(gen.OneConstOf(PrincipalType_Application, PrincipalType_Group, PrincipalType_User))
	gens["Sid"] = gen.PtrOf(gen.AlphaString().Map(func(it string) AzureCoreUuid {
		return AzureCoreUuid(it)
	}))
	gens["TenantId"] = gen.PtrOf(gen.AlphaString().Map(func(it string) AzureCoreUuid {
		return AzureCoreUuid(it)
	}))
}
...
// RunPropertyAssignmentTestForServerExternalAdministrator_STATUS tests if a specific instance of ServerExternalAdministrator_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForServerExternalAdministrator_STATUS(subject ServerExternalAdministrator_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ServerExternalAdministrator_STATUS
...
func AddIndependentPropertyGeneratorsForServerExternalAdministrator_STATUS(gens map[string]gopter.Gen) {
	gens["AdministratorType"] = gen.PtrOf(gen.OneConstOf(AdministratorType_STATUS_ActiveDirectory))
	gens["AzureADOnlyAuthentication"] = gen.PtrOf(gen.Bool())
	gens["Login"] = gen.PtrOf(gen.AlphaString())
	gens["PrincipalType"] = gen.PtrOf(gen.OneConstOf(PrincipalType_STATUS_Application, PrincipalType_STATUS_Group, PrincipalType_STATUS_User))
...
// RunPropertyAssignmentTestForServerOperatorConfigMaps tests if a specific instance of ServerOperatorConfigMaps can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForServerOperatorConfigMaps(subject ServerOperatorConfigMaps) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.ServerOperatorConfigMaps
...
func AddIndependentPropertyGeneratorsForServer_STATUS(gens map[string]gopter.Gen) {
	...
	gens["CreateMode"] = gen.PtrOf(gen.OneConstOf(ServerCreateMode_STATUS_Normal, ServerCreateMode_STATUS_Restore))
	gens["ExternalGovernanceStatus"] = gen.PtrOf(gen.OneConstOf(ExternalGovernanceStatus_STATUS_Disabled, ExternalGovernanceStatus_STATUS_Enabled))
	...
	gens["MinimalTlsVersion"] = gen.PtrOf(gen.OneConstOf(
		MinimalTlsVersion_STATUS_10,
		MinimalTlsVersion_STATUS_11,
		MinimalTlsVersion_STATUS_12,
		MinimalTlsVersion_STATUS_13,
		MinimalTlsVersion_STATUS_None))
	...
	gens["WorkspaceFeature"] = gen.PtrOf(gen.OneConstOf(ServerWorkspaceFeature_STATUS_Connected, ServerWorkspaceFeature_STATUS_Disconnected))
}
...
func AddIndependentPropertyGeneratorsForServer_Spec(gens map[string]gopter.Gen) {
	...
	gens["MinimalTlsVersion"] = gen.PtrOf(gen.OneConstOf(
		...
		MinimalTlsVersion_11,
		MinimalTlsVersion_12,
