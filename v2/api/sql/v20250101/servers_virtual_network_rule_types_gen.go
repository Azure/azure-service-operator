...
// - Generated from: /sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/virtualNetworkRules.json
...
func (rule *ServersVirtualNetworkRule) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v20250101/storage/ServersVirtualNetworkRule but received %T instead", hub)
	}
...
func (rule *ServersVirtualNetworkRule_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.State != nil {
			...
			state := VirtualNetworkRuleState_STATUS(temp)
			rule.State = &state
		}
	}
...
func (rule *ServersVirtualNetworkRule_STATUS) AssignProperties_From_ServersVirtualNetworkRule_STATUS(source *storage.ServersVirtualNetworkRule_STATUS) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, virtualNetworkRuleState_STATUS_Values)
