...
// - Generated from: /sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/encryptionProtectors.json
...
func (protector *ServersEncryptionProtector_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.KeyVersion != nil {
			...
			protector.KeyVersion = &keyVersion
		}
	}
	...
	if typedInput.SystemData != nil {
		...
		protector.SystemData = &systemData
	}
...
func (protector *ServersEncryptionProtector_STATUS) AssignProperties_From_ServersEncryptionProtector_STATUS(source *storage.ServersEncryptionProtector_STATUS) error {
	...
	// KeyVersion
	protector.KeyVersion = genruntime.ClonePointerToString(source.KeyVersion)
	...
	if source.SystemData != nil {
		...
		protector.SystemData = &systemDatum
	} else {
		protector.SystemData = nil
	}
...
func (protector *ServersEncryptionProtector_STATUS) AssignProperties_To_ServersEncryptionProtector_STATUS(destination *storage.ServersEncryptionProtector_STATUS) error {
	...
	// KeyVersion
	destination.KeyVersion = genruntime.ClonePointerToString(protector.KeyVersion)
	...
	// SystemData
	if protector.SystemData != nil {
		var systemDatum storage.SystemData_STATUS
		err := protector.SystemData.AssignProperties_To_SystemData_STATUS(&systemDatum)
		if err != nil {
