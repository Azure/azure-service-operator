...
func AddIndependentPropertyGeneratorsForFailoverGroupReadOnlyEndpoint_STATUS(gens map[string]gopter.Gen) {
	gens["FailoverPolicy"] = gen.PtrOf(gen.OneConstOf(ReadOnlyEndpointFailoverPolicy_STATUS_Disabled, ReadOnlyEndpointFailoverPolicy_STATUS_Enabled))
...
func AddIndependentPropertyGeneratorsForFailoverGroupReadWriteEndpoint_STATUS(gens map[string]gopter.Gen) {
	gens["FailoverPolicy"] = gen.PtrOf(gen.OneConstOf(ReadWriteEndpointFailoverPolicy_STATUS_Automatic, ReadWriteEndpointFailoverPolicy_STATUS_Manual))
	gens["FailoverWithDataLossGracePeriodMinutes"] = gen.PtrOf(gen.Int())
}
...
func AddIndependentPropertyGeneratorsForPartnerInfo_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ReplicationRole"] = gen.PtrOf(gen.OneConstOf(FailoverGroupReplicationRole_STATUS_Primary, FailoverGroupReplicationRole_STATUS_Secondary))
}
...
func AddIndependentPropertyGeneratorsForServersFailoverGroup_STATUS(gens map[string]gopter.Gen) {
	...
	gens["SecondaryType"] = gen.PtrOf(gen.OneConstOf(FailoverGroupDatabasesSecondaryType_STATUS_Geo, FailoverGroupDatabasesSecondaryType_STATUS_Standby))
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
