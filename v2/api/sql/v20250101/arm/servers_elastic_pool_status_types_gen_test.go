...
func AddIndependentPropertyGeneratorsForElasticPoolProperties_STATUS(gens map[string]gopter.Gen) {
	...
	gens["LicenseType"] = gen.PtrOf(gen.OneConstOf(ElasticPoolLicenseType_STATUS_BasePrice, ElasticPoolLicenseType_STATUS_LicenseIncluded))
	...
	gens["State"] = gen.PtrOf(gen.OneConstOf(ElasticPoolState_STATUS_Creating, ElasticPoolState_STATUS_Disabled, ElasticPoolState_STATUS_Ready))
