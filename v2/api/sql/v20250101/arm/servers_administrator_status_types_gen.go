...
// Mapping from string to AdministratorType_STATUS
var administratorType_STATUS_Values = map[string]AdministratorType_STATUS{
	"activedirectory": AdministratorType_STATUS_ActiveDirectory,
}
