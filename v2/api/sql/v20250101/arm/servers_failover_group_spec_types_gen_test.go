...
func AddIndependentPropertyGeneratorsForFailoverGroupProperties(gens map[string]gopter.Gen) {
	...
	gens["SecondaryType"] = gen.PtrOf(gen.OneConstOf(FailoverGroupDatabasesSecondaryType_Geo, FailoverGroupDatabasesSecondaryType_Standby))
}
...
func AddIndependentPropertyGeneratorsForFailoverGroupReadOnlyEndpoint(gens map[string]gopter.Gen) {
	gens["FailoverPolicy"] = gen.PtrOf(gen.OneConstOf(ReadOnlyEndpointFailoverPolicy_Disabled, ReadOnlyEndpointFailoverPolicy_Enabled))
	gens["TargetServer"] = gen.PtrOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForFailoverGroupReadWriteEndpoint(gens map[string]gopter.Gen) {
	gens["FailoverPolicy"] = gen.PtrOf(gen.OneConstOf(ReadWriteEndpointFailoverPolicy_Automatic, ReadWriteEndpointFailoverPolicy_Manual))
