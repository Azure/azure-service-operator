...
func AddIndependentPropertyGeneratorsForServerConnectionPolicyProperties_STATUS(gens map[string]gopter.Gen) {
	gens["ConnectionType"] = gen.PtrOf(gen.OneConstOf(ServerConnectionType_STATUS_Default, ServerConnectionType_STATUS_Proxy, ServerConnectionType_STATUS_Redirect))
}
