...
// - Generated from: /sql/resource-manager/Microsoft.Sql/SQL/stable/2025-01-01/blobAuditing.json
...
func (setting *ServersAuditingSetting) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected sql/v20250101/storage/ServersAuditingSetting but received %T instead", hub)
	}
...
func (setting *ServersAuditingSetting_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if setting.State != nil {
		...
		state := arm.BlobAuditingPolicyState(temp)
	...
	if setting.StorageAccountSubscriptionId != nil {
		storageAccountSubscriptionId := string(*setting.StorageAccountSubscriptionId)
...
func (setting *ServersAuditingSetting_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.State != nil {
			...
			state := BlobAuditingPolicyState(temp)
			setting.State = &state
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.StorageAccountSubscriptionId != nil {
			storageAccountSubscriptionId := AzureCoreUuid(*typedInput.Properties.StorageAccountSubscriptionId)
...
func (setting *ServersAuditingSetting_Spec) AssignProperties_From_ServersAuditingSetting_Spec(source *storage.ServersAuditingSetting_Spec) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, blobAuditingPolicyState_Values)
	...
	if source.StorageAccountSubscriptionId != nil {
		storageAccountSubscriptionId := AzureCoreUuid(*source.StorageAccountSubscriptionId)
		setting.StorageAccountSubscriptionId = &storageAccountSubscriptionId
	} else {
		setting.StorageAccountSubscriptionId = nil
	}
...
func (setting *ServersAuditingSetting_Spec) Initialize_From_ServersAuditingSetting_STATUS(source *ServersAuditingSetting_STATUS) error {
	...
	// State
	if source.State != nil {
		state := genruntime.ToEnum(string(*source.State), blobAuditingPolicyState_Values)
		setting.State = &state
	} else {
		setting.State = nil
	}
...
func (setting *ServersAuditingSetting_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.State != nil {
			var temp string
			temp = string(*typedInput.Properties.State)
			state := BlobAuditingPolicyState_STATUS(temp)
			setting.State = &state
		}
	}
...
func (setting *ServersAuditingSetting_STATUS) AssignProperties_From_ServersAuditingSetting_STATUS(source *storage.ServersAuditingSetting_STATUS) error {
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, blobAuditingPolicyState_STATUS_Values)
		setting.State = &stateTemp
	} else {
		setting.State = nil
	}
...
// Mapping from string to BlobAuditingPolicyState
var blobAuditingPolicyState_Values = map[string]BlobAuditingPolicyState{
	"disabled": BlobAuditingPolicyState_Disabled,
	"enabled":  BlobAuditingPolicyState_Enabled,
}
...
// Mapping from string to BlobAuditingPolicyState_STATUS
var blobAuditingPolicyState_STATUS_Values = map[string]BlobAuditingPolicyState_STATUS{
	"disabled": BlobAuditingPolicyState_STATUS_Disabled,
	"enabled":  BlobAuditingPolicyState_STATUS_Enabled,
}
