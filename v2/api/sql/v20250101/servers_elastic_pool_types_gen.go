...
func (pool *ServersElasticPool_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if pool.AutoPauseDelay != nil ||
		pool.AvailabilityZone != nil ||
		pool.HighAvailabilityReplicaCount != nil ||
		...
		pool.PreferredEnclaveType != nil ||
		pool.ZoneRedundant != nil {
		result.Properties = &arm.ElasticPoolProperties{}
	}
	if pool.AutoPauseDelay != nil {
		autoPauseDelay := *pool.AutoPauseDelay
		result.Properties.AutoPauseDelay = &autoPauseDelay
	}
	if pool.AvailabilityZone != nil {
		var temp string
		temp = string(*pool.AvailabilityZone)
	...
	if pool.LicenseType != nil {
		...
		licenseType := arm.ElasticPoolLicenseType(temp)
	...
	if pool.PreferredEnclaveType != nil {
		var temp string
		temp = string(*pool.PreferredEnclaveType)
...
func (pool *ServersElasticPool_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AutoPauseDelay != nil {
			...
			pool.AutoPauseDelay = &autoPauseDelay
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AvailabilityZone != nil {
			...
			pool.AvailabilityZone = &availabilityZone
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.LicenseType != nil {
			...
			licenseType := ElasticPoolLicenseType(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PreferredEnclaveType != nil {
			...
			pool.PreferredEnclaveType = &preferredEnclaveType
		}
	}
...
func (pool *ServersElasticPool_Spec) AssignProperties_From_ServersElasticPool_Spec(source *storage.ServersElasticPool_Spec) error {
	...
	// AutoPauseDelay
	pool.AutoPauseDelay = genruntime.ClonePointerToInt(source.AutoPauseDelay)
	...
	if source.AvailabilityZone != nil {
		...
		pool.AvailabilityZone = &availabilityZoneTemp
	} else {
		pool.AvailabilityZone = nil
	}
	...
	if source.LicenseType != nil {
		...
		licenseTypeTemp := genruntime.ToEnum(licenseType, elasticPoolLicenseType_Values)
	...
	if source.PreferredEnclaveType != nil {
		...
		pool.PreferredEnclaveType = &preferredEnclaveTypeTemp
	} else {
		pool.PreferredEnclaveType = nil
	}
...
func (pool *ServersElasticPool_Spec) AssignProperties_To_ServersElasticPool_Spec(destination *storage.ServersElasticPool_Spec) error {
	...
	// AutoPauseDelay
	destination.AutoPauseDelay = genruntime.ClonePointerToInt(pool.AutoPauseDelay)

	// AvailabilityZone
	if pool.AvailabilityZone != nil {
		availabilityZone := string(*pool.AvailabilityZone)
	...
	// PreferredEnclaveType
	if pool.PreferredEnclaveType != nil {
		preferredEnclaveType := string(*pool.PreferredEnclaveType)
...
func (pool *ServersElasticPool_Spec) Initialize_From_ServersElasticPool_STATUS(source *ServersElasticPool_STATUS) error {
	...
	// LicenseType
	if source.LicenseType != nil {
		licenseType := genruntime.ToEnum(string(*source.LicenseType), elasticPoolLicenseType_Values)
		pool.LicenseType = &licenseType
	} else {
		pool.LicenseType = nil
	}
...
func (pool *ServersElasticPool_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.LicenseType != nil {
			var temp string
			temp = string(*typedInput.Properties.LicenseType)
			licenseType := ElasticPoolLicenseType_STATUS(temp)
			pool.LicenseType = &licenseType
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.State != nil {
			...
			state := ElasticPoolState_STATUS(temp)
			pool.State = &state
		}
	}
...
func (pool *ServersElasticPool_STATUS) AssignProperties_From_ServersElasticPool_STATUS(source *storage.ServersElasticPool_STATUS) error {
	...
	if source.LicenseType != nil {
		licenseType := *source.LicenseType
		licenseTypeTemp := genruntime.ToEnum(licenseType, elasticPoolLicenseType_STATUS_Values)
		pool.LicenseType = &licenseTypeTemp
	} else {
		pool.LicenseType = nil
	}
	...
	if source.State != nil {
		state := *source.State
		stateTemp := genruntime.ToEnum(state, elasticPoolState_STATUS_Values)
...
func (settings *ElasticPoolPerDatabaseSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "AutoPauseDelay":
	if settings.AutoPauseDelay != nil {
		autoPauseDelay := *settings.AutoPauseDelay
		result.AutoPauseDelay = &autoPauseDelay
	}
...
func (settings *ElasticPoolPerDatabaseSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "AutoPauseDelay":
	if typedInput.AutoPauseDelay != nil {
		autoPauseDelay := *typedInput.AutoPauseDelay
		settings.AutoPauseDelay = &autoPauseDelay
	}
...
func (settings *ElasticPoolPerDatabaseSettings) AssignProperties_From_ElasticPoolPerDatabaseSettings(source *storage.ElasticPoolPerDatabaseSettings) error {
	...
	// AutoPauseDelay
	settings.AutoPauseDelay = genruntime.ClonePointerToInt(source.AutoPauseDelay)
...
func (settings *ElasticPoolPerDatabaseSettings) AssignProperties_To_ElasticPoolPerDatabaseSettings(destination *storage.ElasticPoolPerDatabaseSettings) error {
	...
	// AutoPauseDelay
	destination.AutoPauseDelay = genruntime.ClonePointerToInt(settings.AutoPauseDelay)
