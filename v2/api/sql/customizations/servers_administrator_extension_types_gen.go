...
func (extension *ServersAdministratorExtension) GetExtendedResources() []genruntime.KubernetesResource {
	return []genruntime.KubernetesResource{
		&sql_v1api20211101.ServersAdministrator{},
		&sql_v1api20211101s.ServersAdministrator{},
		&sql_v20211101.ServersAdministrator{},
		&sql_v20211101s.ServersAdministrator{},
		&sql_v20250101.ServersAdministrator{},
		&sql_v20250101s.ServersAdministrator{}}
}
