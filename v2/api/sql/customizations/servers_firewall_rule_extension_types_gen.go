...
type ServersFirewallRuleExtension struct {
}

// GetExtendedResources Returns the KubernetesResource slice for Resource versions
func (extension *ServersFirewallRuleExtension) GetExtendedResources() []genruntime.KubernetesResource {
	return []genruntime.KubernetesResource{
		&sql_v1api20211101.ServersFirewallRule{},
		&sql_v1api20211101s.ServersFirewallRule{},
		&sql_v20211101.ServersFirewallRule{},
		&sql_v20211101s.ServersFirewallRule{},
		&sql_v20250101.ServersFirewallRule{},
		&sql_v20250101s.ServersFirewallRule{}}
}
