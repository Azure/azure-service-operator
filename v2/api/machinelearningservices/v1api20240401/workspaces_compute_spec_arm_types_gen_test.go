...
func Test_BindOptions_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BindOptions_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBindOptions_ARM, BindOptions_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBindOptions_ARM runs a test to see if a specific instance of BindOptions_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForBindOptions_ARM(subject BindOptions_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of BindOptions_ARM instances for property testing - lazily instantiated by BindOptions_ARMGenerator()
var bindOptions_ARMGenerator gopter.Gen

// BindOptions_ARMGenerator returns a generator of BindOptions_ARM instances for property testing.
func BindOptions_ARMGenerator() gopter.Gen {
	if bindOptions_ARMGenerator != nil {
		return bindOptions_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBindOptions_ARM(generators)
	bindOptions_ARMGenerator = gen.Struct(reflect.TypeOf(BindOptions_ARM{}), generators)

	return bindOptions_ARMGenerator
}

// AddIndependentPropertyGeneratorsForBindOptions_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBindOptions_ARM(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForComputeInstanceProperties_ARM(gens map[string]gopter.Gen) {
	gens["CustomServices"] = gen.SliceOf(CustomService_ARMGenerator())
	gens["PersonalComputeInstanceSettings"] = gen.PtrOf(PersonalComputeInstanceSettings_ARMGenerator())
	gens["Schedules"] = gen.PtrOf(ComputeSchedules_ARMGenerator())
...
func Test_ComputeRecurrenceSchedule_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ComputeRecurrenceSchedule_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForComputeRecurrenceSchedule_ARM, ComputeRecurrenceSchedule_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputeRecurrenceSchedule_ARM runs a test to see if a specific instance of ComputeRecurrenceSchedule_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForComputeRecurrenceSchedule_ARM(subject ComputeRecurrenceSchedule_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ComputeRecurrenceSchedule_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ComputeRecurrenceSchedule_ARM instances for property testing - lazily instantiated by
// ComputeRecurrenceSchedule_ARMGenerator()
var computeRecurrenceSchedule_ARMGenerator gopter.Gen

// ComputeRecurrenceSchedule_ARMGenerator returns a generator of ComputeRecurrenceSchedule_ARM instances for property testing.
func ComputeRecurrenceSchedule_ARMGenerator() gopter.Gen {
	if computeRecurrenceSchedule_ARMGenerator != nil {
		return computeRecurrenceSchedule_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputeRecurrenceSchedule_ARM(generators)
	computeRecurrenceSchedule_ARMGenerator = gen.Struct(reflect.TypeOf(ComputeRecurrenceSchedule_ARM{}), generators)

	return computeRecurrenceSchedule_ARMGenerator
}

// AddIndependentPropertyGeneratorsForComputeRecurrenceSchedule_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForComputeRecurrenceSchedule_ARM(gens map[string]gopter.Gen) {
	...
	gens["WeekDays"] = gen.SliceOf(gen.OneConstOf(
		ComputeWeekDay_ARM_Friday,
		ComputeWeekDay_ARM_Monday,
		ComputeWeekDay_ARM_Saturday,
		ComputeWeekDay_ARM_Sunday,
		ComputeWeekDay_ARM_Thursday,
		ComputeWeekDay_ARM_Tuesday,
		ComputeWeekDay_ARM_Wednesday))
}

func Test_ComputeSchedules_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ComputeSchedules_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForComputeSchedules_ARM, ComputeSchedules_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputeSchedules_ARM runs a test to see if a specific instance of ComputeSchedules_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForComputeSchedules_ARM(subject ComputeSchedules_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ComputeSchedules_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ComputeSchedules_ARM instances for property testing - lazily instantiated by
// ComputeSchedules_ARMGenerator()
var computeSchedules_ARMGenerator gopter.Gen

// ComputeSchedules_ARMGenerator returns a generator of ComputeSchedules_ARM instances for property testing.
func ComputeSchedules_ARMGenerator() gopter.Gen {
	if computeSchedules_ARMGenerator != nil {
		return computeSchedules_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForComputeSchedules_ARM(generators)
	computeSchedules_ARMGenerator = gen.Struct(reflect.TypeOf(ComputeSchedules_ARM{}), generators)

	return computeSchedules_ARMGenerator
}

// AddRelatedPropertyGeneratorsForComputeSchedules_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForComputeSchedules_ARM(gens map[string]gopter.Gen) {
	gens["ComputeStartStop"] = gen.SliceOf(ComputeStartStopSchedule_ARMGenerator())
}

func Test_ComputeStartStopSchedule_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ComputeStartStopSchedule_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForComputeStartStopSchedule_ARM, ComputeStartStopSchedule_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputeStartStopSchedule_ARM runs a test to see if a specific instance of ComputeStartStopSchedule_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForComputeStartStopSchedule_ARM(subject ComputeStartStopSchedule_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ComputeStartStopSchedule_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ComputeStartStopSchedule_ARM instances for property testing - lazily instantiated by
// ComputeStartStopSchedule_ARMGenerator()
var computeStartStopSchedule_ARMGenerator gopter.Gen

// ComputeStartStopSchedule_ARMGenerator returns a generator of ComputeStartStopSchedule_ARM instances for property testing.
// We first initialize computeStartStopSchedule_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ComputeStartStopSchedule_ARMGenerator() gopter.Gen {
	if computeStartStopSchedule_ARMGenerator != nil {
		return computeStartStopSchedule_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputeStartStopSchedule_ARM(generators)
	computeStartStopSchedule_ARMGenerator = gen.Struct(reflect.TypeOf(ComputeStartStopSchedule_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputeStartStopSchedule_ARM(generators)
	AddRelatedPropertyGeneratorsForComputeStartStopSchedule_ARM(generators)
	computeStartStopSchedule_ARMGenerator = gen.Struct(reflect.TypeOf(ComputeStartStopSchedule_ARM{}), generators)

	return computeStartStopSchedule_ARMGenerator
}

// AddIndependentPropertyGeneratorsForComputeStartStopSchedule_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForComputeStartStopSchedule_ARM(gens map[string]gopter.Gen) {
	gens["Action"] = gen.PtrOf(gen.OneConstOf(ComputePowerAction_ARM_Start, ComputePowerAction_ARM_Stop))
	gens["Status"] = gen.PtrOf(gen.OneConstOf(ScheduleStatus_ARM_Disabled, ScheduleStatus_ARM_Enabled))
	gens["TriggerType"] = gen.PtrOf(gen.OneConstOf(ComputeTriggerType_ARM_Cron, ComputeTriggerType_ARM_Recurrence))
}

// AddRelatedPropertyGeneratorsForComputeStartStopSchedule_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForComputeStartStopSchedule_ARM(gens map[string]gopter.Gen) {
	gens["Cron"] = gen.PtrOf(Cron_ARMGenerator())
	gens["Recurrence"] = gen.PtrOf(Recurrence_ARMGenerator())
	gens["Schedule"] = gen.PtrOf(ScheduleBase_ARMGenerator())
}
...
func Test_Cron_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Cron_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCron_ARM, Cron_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCron_ARM runs a test to see if a specific instance of Cron_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForCron_ARM(subject Cron_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Cron_ARM instances for property testing - lazily instantiated by Cron_ARMGenerator()
var cron_ARMGenerator gopter.Gen

// Cron_ARMGenerator returns a generator of Cron_ARM instances for property testing.
func Cron_ARMGenerator() gopter.Gen {
	if cron_ARMGenerator != nil {
		return cron_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCron_ARM(generators)
	cron_ARMGenerator = gen.Struct(reflect.TypeOf(Cron_ARM{}), generators)

	return cron_ARMGenerator
}

// AddIndependentPropertyGeneratorsForCron_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCron_ARM(gens map[string]gopter.Gen) {
	gens["Expression"] = gen.PtrOf(gen.AlphaString())
	gens["StartTime"] = gen.PtrOf(gen.AlphaString())
	gens["TimeZone"] = gen.PtrOf(gen.AlphaString())
}

func Test_CustomService_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of CustomService_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCustomService_ARM, CustomService_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCustomService_ARM runs a test to see if a specific instance of CustomService_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForCustomService_ARM(subject CustomService_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of CustomService_ARM instances for property testing - lazily instantiated by CustomService_ARMGenerator()
var customService_ARMGenerator gopter.Gen

// CustomService_ARMGenerator returns a generator of CustomService_ARM instances for property testing.
// We first initialize customService_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func CustomService_ARMGenerator() gopter.Gen {
	if customService_ARMGenerator != nil {
		return customService_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCustomService_ARM(generators)
	customService_ARMGenerator = gen.Struct(reflect.TypeOf(CustomService_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCustomService_ARM(generators)
	AddRelatedPropertyGeneratorsForCustomService_ARM(generators)
	customService_ARMGenerator = gen.Struct(reflect.TypeOf(CustomService_ARM{}), generators)

	return customService_ARMGenerator
}

// AddIndependentPropertyGeneratorsForCustomService_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCustomService_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForCustomService_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForCustomService_ARM(gens map[string]gopter.Gen) {
	gens["Docker"] = gen.PtrOf(Docker_ARMGenerator())
	gens["Endpoints"] = gen.SliceOf(Endpoint_ARMGenerator())
	gens["EnvironmentVariables"] = gen.MapOf(
		gen.AlphaString(),
		EnvironmentVariable_ARMGenerator())
	gens["Image"] = gen.PtrOf(Image_ARMGenerator())
	gens["Volumes"] = gen.SliceOf(VolumeDefinition_ARMGenerator())
}
...
func Test_Docker_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Docker_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDocker_ARM, Docker_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDocker_ARM runs a test to see if a specific instance of Docker_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDocker_ARM(subject Docker_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Docker_ARM instances for property testing - lazily instantiated by Docker_ARMGenerator()
var docker_ARMGenerator gopter.Gen

// Docker_ARMGenerator returns a generator of Docker_ARM instances for property testing.
func Docker_ARMGenerator() gopter.Gen {
	if docker_ARMGenerator != nil {
		return docker_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDocker_ARM(generators)
	docker_ARMGenerator = gen.Struct(reflect.TypeOf(Docker_ARM{}), generators)

	return docker_ARMGenerator
}

// AddIndependentPropertyGeneratorsForDocker_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDocker_ARM(gens map[string]gopter.Gen) {
	gens["Privileged"] = gen.PtrOf(gen.Bool())
}

func Test_Endpoint_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Endpoint_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForEndpoint_ARM, Endpoint_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForEndpoint_ARM runs a test to see if a specific instance of Endpoint_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForEndpoint_ARM(subject Endpoint_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Endpoint_ARM instances for property testing - lazily instantiated by Endpoint_ARMGenerator()
var endpoint_ARMGenerator gopter.Gen

// Endpoint_ARMGenerator returns a generator of Endpoint_ARM instances for property testing.
func Endpoint_ARMGenerator() gopter.Gen {
	if endpoint_ARMGenerator != nil {
		return endpoint_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForEndpoint_ARM(generators)
	endpoint_ARMGenerator = gen.Struct(reflect.TypeOf(Endpoint_ARM{}), generators)

	return endpoint_ARMGenerator
}

// AddIndependentPropertyGeneratorsForEndpoint_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForEndpoint_ARM(gens map[string]gopter.Gen) {
	gens["HostIp"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Protocol"] = gen.PtrOf(gen.OneConstOf(Endpoint_Protocol_ARM_Http, Endpoint_Protocol_ARM_Tcp, Endpoint_Protocol_ARM_Udp))
...
func AddIndependentPropertyGeneratorsForEnvironmentVariable_ARM(gens map[string]gopter.Gen) {
	gens["Type"] = gen.PtrOf(gen.OneConstOf(EnvironmentVariable_Type_ARM_Local))
...
func Test_Image_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Image_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForImage_ARM, Image_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForImage_ARM runs a test to see if a specific instance of Image_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForImage_ARM(subject Image_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Image_ARM instances for property testing - lazily instantiated by Image_ARMGenerator()
var image_ARMGenerator gopter.Gen

// Image_ARMGenerator returns a generator of Image_ARM instances for property testing.
func Image_ARMGenerator() gopter.Gen {
	if image_ARMGenerator != nil {
		return image_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImage_ARM(generators)
	image_ARMGenerator = gen.Struct(reflect.TypeOf(Image_ARM{}), generators)

	return image_ARMGenerator
}

// AddIndependentPropertyGeneratorsForImage_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForImage_ARM(gens map[string]gopter.Gen) {
	gens["Reference"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.OneConstOf(Image_Type_ARM_Azureml, Image_Type_ARM_Docker))
}
...
func AddIndependentPropertyGeneratorsForRecurrence_ARM(gens map[string]gopter.Gen) {
	gens["Frequency"] = gen.PtrOf(gen.OneConstOf(
		ComputeRecurrenceFrequency_ARM_Day,
		ComputeRecurrenceFrequency_ARM_Hour,
		ComputeRecurrenceFrequency_ARM_Minute,
		ComputeRecurrenceFrequency_ARM_Month,
		ComputeRecurrenceFrequency_ARM_Week))
...
func AddRelatedPropertyGeneratorsForRecurrence_ARM(gens map[string]gopter.Gen) {
	gens["Schedule"] = gen.PtrOf(ComputeRecurrenceSchedule_ARMGenerator())
}
...
func Test_ScheduleBase_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ScheduleBase_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForScheduleBase_ARM, ScheduleBase_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForScheduleBase_ARM runs a test to see if a specific instance of ScheduleBase_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForScheduleBase_ARM(subject ScheduleBase_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of ScheduleBase_ARM instances for property testing - lazily instantiated by ScheduleBase_ARMGenerator()
var scheduleBase_ARMGenerator gopter.Gen

// ScheduleBase_ARMGenerator returns a generator of ScheduleBase_ARM instances for property testing.
func ScheduleBase_ARMGenerator() gopter.Gen {
	if scheduleBase_ARMGenerator != nil {
		return scheduleBase_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForScheduleBase_ARM(generators)
	scheduleBase_ARMGenerator = gen.Struct(reflect.TypeOf(ScheduleBase_ARM{}), generators)

	return scheduleBase_ARMGenerator
}

// AddIndependentPropertyGeneratorsForScheduleBase_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForScheduleBase_ARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["ProvisioningStatus"] = gen.PtrOf(gen.OneConstOf(ScheduleProvisioningState_ARM_Completed, ScheduleProvisioningState_ARM_Failed, ScheduleProvisioningState_ARM_Provisioning))
	gens["Status"] = gen.PtrOf(gen.OneConstOf(ScheduleStatus_ARM_Disabled, ScheduleStatus_ARM_Enabled))
}
...
func Test_TmpfsOptions_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of TmpfsOptions_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForTmpfsOptions_ARM, TmpfsOptions_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForTmpfsOptions_ARM runs a test to see if a specific instance of TmpfsOptions_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForTmpfsOptions_ARM(subject TmpfsOptions_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of TmpfsOptions_ARM instances for property testing - lazily instantiated by TmpfsOptions_ARMGenerator()
var tmpfsOptions_ARMGenerator gopter.Gen

// TmpfsOptions_ARMGenerator returns a generator of TmpfsOptions_ARM instances for property testing.
func TmpfsOptions_ARMGenerator() gopter.Gen {
	if tmpfsOptions_ARMGenerator != nil {
		return tmpfsOptions_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForTmpfsOptions_ARM(generators)
	tmpfsOptions_ARMGenerator = gen.Struct(reflect.TypeOf(TmpfsOptions_ARM{}), generators)

	return tmpfsOptions_ARMGenerator
}

// AddIndependentPropertyGeneratorsForTmpfsOptions_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForTmpfsOptions_ARM(gens map[string]gopter.Gen) {
...
func Test_VolumeDefinition_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of VolumeDefinition_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForVolumeDefinition_ARM, VolumeDefinition_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVolumeDefinition_ARM runs a test to see if a specific instance of VolumeDefinition_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForVolumeDefinition_ARM(subject VolumeDefinition_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual VolumeDefinition_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of VolumeDefinition_ARM instances for property testing - lazily instantiated by
// VolumeDefinition_ARMGenerator()
var volumeDefinition_ARMGenerator gopter.Gen

// VolumeDefinition_ARMGenerator returns a generator of VolumeDefinition_ARM instances for property testing.
// We first initialize volumeDefinition_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func VolumeDefinition_ARMGenerator() gopter.Gen {
	if volumeDefinition_ARMGenerator != nil {
		return volumeDefinition_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVolumeDefinition_ARM(generators)
	volumeDefinition_ARMGenerator = gen.Struct(reflect.TypeOf(VolumeDefinition_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVolumeDefinition_ARM(generators)
	AddRelatedPropertyGeneratorsForVolumeDefinition_ARM(generators)
	volumeDefinition_ARMGenerator = gen.Struct(reflect.TypeOf(VolumeDefinition_ARM{}), generators)

	return volumeDefinition_ARMGenerator
}

// AddIndependentPropertyGeneratorsForVolumeDefinition_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVolumeDefinition_ARM(gens map[string]gopter.Gen) {
	...
	gens["Type"] = gen.PtrOf(gen.OneConstOf(
		VolumeDefinition_Type_ARM_Bind,
		VolumeDefinition_Type_ARM_Npipe,
		VolumeDefinition_Type_ARM_Tmpfs,
		VolumeDefinition_Type_ARM_Volume))
}

// AddRelatedPropertyGeneratorsForVolumeDefinition_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForVolumeDefinition_ARM(gens map[string]gopter.Gen) {
	gens["Bind"] = gen.PtrOf(BindOptions_ARMGenerator())
	gens["Tmpfs"] = gen.PtrOf(TmpfsOptions_ARMGenerator())
	gens["Volume"] = gen.PtrOf(VolumeOptions_ARMGenerator())
}

func Test_VolumeOptions_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of VolumeOptions_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForVolumeOptions_ARM, VolumeOptions_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForVolumeOptions_ARM runs a test to see if a specific instance of VolumeOptions_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForVolumeOptions_ARM(subject VolumeOptions_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of VolumeOptions_ARM instances for property testing - lazily instantiated by VolumeOptions_ARMGenerator()
var volumeOptions_ARMGenerator gopter.Gen

// VolumeOptions_ARMGenerator returns a generator of VolumeOptions_ARM instances for property testing.
func VolumeOptions_ARMGenerator() gopter.Gen {
	if volumeOptions_ARMGenerator != nil {
		return volumeOptions_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForVolumeOptions_ARM(generators)
	volumeOptions_ARMGenerator = gen.Struct(reflect.TypeOf(VolumeOptions_ARM{}), generators)

	return volumeOptions_ARMGenerator
}

// AddIndependentPropertyGeneratorsForVolumeOptions_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForVolumeOptions_ARM(gens map[string]gopter.Gen) {
	gens["Nocopy"] = gen.PtrOf(gen.Bool())
}

func Test_WorkspacesCompute_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of WorkspacesCompute_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForWorkspacesCompute_Spec_ARM, WorkspacesCompute_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForWorkspacesCompute_Spec_ARM runs a test to see if a specific instance of WorkspacesCompute_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForWorkspacesCompute_Spec_ARM(subject WorkspacesCompute_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual WorkspacesCompute_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of WorkspacesCompute_Spec_ARM instances for property testing - lazily instantiated by
// WorkspacesCompute_Spec_ARMGenerator()
var workspacesCompute_Spec_ARMGenerator gopter.Gen

// WorkspacesCompute_Spec_ARMGenerator returns a generator of WorkspacesCompute_Spec_ARM instances for property testing.
// We first initialize workspacesCompute_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func WorkspacesCompute_Spec_ARMGenerator() gopter.Gen {
	if workspacesCompute_Spec_ARMGenerator != nil {
		return workspacesCompute_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForWorkspacesCompute_Spec_ARM(generators)
	workspacesCompute_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(WorkspacesCompute_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForWorkspacesCompute_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForWorkspacesCompute_Spec_ARM(generators)
	workspacesCompute_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(WorkspacesCompute_Spec_ARM{}), generators)

	return workspacesCompute_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForWorkspacesCompute_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForWorkspacesCompute_Spec_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForWorkspacesCompute_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForWorkspacesCompute_Spec_ARM(gens map[string]gopter.Gen) {
