...
func Test_Workspaces_Computes_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of Workspaces_Computes_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForWorkspaces_Computes_SpecARM, Workspaces_Computes_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForWorkspaces_Computes_SpecARM runs a test to see if a specific instance of Workspaces_Computes_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForWorkspaces_Computes_SpecARM(subject Workspaces_Computes_SpecARM) string {
	// Serialize to JSON
	...
	var actual Workspaces_Computes_SpecARM
...
// Generator of Workspaces_Computes_SpecARM instances for property testing - lazily instantiated by
// Workspaces_Computes_SpecARMGenerator()
var workspaces_Computes_SpecARMGenerator gopter.Gen

// Workspaces_Computes_SpecARMGenerator returns a generator of Workspaces_Computes_SpecARM instances for property testing.
// We first initialize workspaces_Computes_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Workspaces_Computes_SpecARMGenerator() gopter.Gen {
	if workspaces_Computes_SpecARMGenerator != nil {
		return workspaces_Computes_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForWorkspaces_Computes_SpecARM(generators)
	workspaces_Computes_SpecARMGenerator = gen.Struct(reflect.TypeOf(Workspaces_Computes_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForWorkspaces_Computes_SpecARM(generators)
	AddRelatedPropertyGeneratorsForWorkspaces_Computes_SpecARM(generators)
	workspaces_Computes_SpecARMGenerator = gen.Struct(reflect.TypeOf(Workspaces_Computes_SpecARM{}), generators)

	return workspaces_Computes_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForWorkspaces_Computes_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForWorkspaces_Computes_SpecARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.AlphaString()
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForWorkspaces_Computes_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForWorkspaces_Computes_SpecARM(gens map[string]gopter.Gen) {
