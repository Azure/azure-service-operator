...
func (trigger *SqlDatabaseContainerTrigger) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected documentdb/v1api20240815/storage/SqlDatabaseContainerTrigger but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-documentdb-azure-com-v1api20240815-sqldatabasecontainertrigger,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=sqldatabasecontainertriggers,verbs=create;update,versions=v1api20240815,name=default.v1api20240815.sqldatabasecontainertriggers.documentdb.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-documentdb-azure-com-v1api20240815-sqldatabasecontainertrigger,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=sqldatabasecontainertriggers,verbs=create;update,versions=v1api20240815,name=validate.v1api20240815.sqldatabasecontainertriggers.documentdb.azure.com,admissionReviewVersions=v1
...
func (trigger *SqlDatabaseContainerTrigger_Spec) Initialize_From_SqlDatabaseContainerTrigger_STATUS(source *SqlDatabaseContainerTrigger_STATUS) error {
	...
	if source.Resource != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SqlTriggerGetProperties_Resource_STATUS() to populate field Resource")
		}
		trigger.Resource = &resource
	} else {
		trigger.Resource = nil
