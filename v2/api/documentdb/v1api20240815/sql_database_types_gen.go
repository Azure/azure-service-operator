...
// +kubebuilder:webhook:path=/mutate-documentdb-azure-com-v1api20240815-sqldatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=sqldatabases,verbs=create;update,versions=v1api20240815,name=default.v1api20240815.sqldatabases.documentdb.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-documentdb-azure-com-v1api20240815-sqldatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=sqldatabases,verbs=create;update,versions=v1api20240815,name=validate.v1api20240815.sqldatabases.documentdb.azure.com,admissionReviewVersions=v1
...
func (database *SqlDatabase_Spec) Initialize_From_SqlDatabase_STATUS(source *SqlDatabase_STATUS) error {
	...
	if source.Resource != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_SqlDatabaseGetProperties_Resource_STATUS() to populate field Resource")
		}
		database.Resource = &resource
	} else {
		database.Resource = nil
