...
func (database *MongodbDatabase) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected documentdb/v1api20240815/storage/MongodbDatabase but received %T instead", hub)
	}
...
// +kubebuilder:webhook:path=/mutate-documentdb-azure-com-v1api20240815-mongodbdatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=mongodbdatabases,verbs=create;update,versions=v1api20240815,name=default.v1api20240815.mongodbdatabases.documentdb.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-documentdb-azure-com-v1api20240815-mongodbdatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=documentdb.azure.com,resources=mongodbdatabases,verbs=create;update,versions=v1api20240815,name=validate.v1api20240815.mongodbdatabases.documentdb.azure.com,admissionReviewVersions=v1
...
func (database *MongodbDatabase_Spec) Initialize_From_MongodbDatabase_STATUS(source *MongodbDatabase_STATUS) error {
	...
	if source.Resource != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_MongoDBDatabaseGetProperties_Resource_STATUS() to populate field Resource")
		}
		database.Resource = &resource
	} else {
		database.Resource = nil
...
func (options *CreateUpdateOptions) Initialize_From_OptionsResource_STATUS(source *OptionsResource_STATUS) error {
	...
	if source.AutoscaleSettings != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_AutoscaleSettings_STATUS() to populate field AutoscaleSettings")
		}
		options.AutoscaleSettings = &autoscaleSetting
	} else {
		options.AutoscaleSettings = nil
...
func (base *RestoreParametersBase) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if base.RestoreWithTtlDisabled != nil {
		restoreWithTtlDisabled := *base.RestoreWithTtlDisabled
...
func (base *RestoreParametersBase) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.RestoreWithTtlDisabled != nil {
		...
		base.RestoreWithTtlDisabled = &restoreWithTtlDisabled
	}
...
func (base *RestoreParametersBase) AssignProperties_From_RestoreParametersBase(source *storage.RestoreParametersBase) error {
	...
	if source.RestoreWithTtlDisabled != nil {
		...
		base.RestoreWithTtlDisabled = nil
	}
