...
<<<<<<<< HEAD:v2/api/documentdb/v1beta20210515/database_accounts_sql_database_statusarm_types_gen.go
type DatabaseAccountsSqlDatabase_STATUSARM struct {
========
type SqlDatabaseGetResults_STATUSARM struct {
>>>>>>>> main:v2/api/documentdb/v1beta20210515/sql_database_get_results_status_arm_types_gen.go
