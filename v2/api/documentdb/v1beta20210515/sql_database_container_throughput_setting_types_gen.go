...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) SetAzureName(azureName string) {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUSARM{}
}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUSARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUSARM, got %T", armInput)
	}
