...
func (setting *SqlDatabaseContainerThroughputSetting) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20210515s.SqlDatabaseContainerThroughputSetting
...
func (setting *SqlDatabaseContainerThroughputSetting) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20210515s.SqlDatabaseContainerThroughputSetting
...
func (setting *SqlDatabaseContainerThroughputSetting) deleteValidations() []func() (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (setting *SqlDatabaseContainerThroughputSetting) updateValidations() []func(old runtime.Object) (admission.Warnings, error) {
...
func (setting *SqlDatabaseContainerThroughputSetting) validateOwnerReference() (admission.Warnings, error) {
	return genruntime.ValidateOwner(setting)
}

// validateResourceReferences validates all resource references
func (setting *SqlDatabaseContainerThroughputSetting) validateResourceReferences() (admission.Warnings, error) {
...
func (setting *SqlDatabaseContainerThroughputSetting) validateWriteOnceProperties(old runtime.Object) (admission.Warnings, error) {
...
func (setting *SqlDatabaseContainerThroughputSetting) AssignProperties_From_SqlDatabaseContainerThroughputSetting(source *v1beta20210515s.SqlDatabaseContainerThroughputSetting) error {
...
func (setting *SqlDatabaseContainerThroughputSetting) AssignProperties_To_SqlDatabaseContainerThroughputSetting(destination *v1beta20210515s.SqlDatabaseContainerThroughputSetting) error {

	// ObjectMeta
	destination.ObjectMeta = *setting.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec
	...
	// Status
	var status v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec)
	if ok {
	...
	src = &v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) AssignProperties_From_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec(source *v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) AssignProperties_To_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec(destination *v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error {
	...
	// Resource
	if setting.Resource != nil {
		var resource v1beta20210515s.ThroughputSettingsResource
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) AssignProperties_From_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS(source *v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) AssignProperties_To_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS(destination *v1beta20210515s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Resource
	if setting.Resource != nil {
		var resource v1beta20210515s.ThroughputSettingsGetProperties_Resource_STATUS
