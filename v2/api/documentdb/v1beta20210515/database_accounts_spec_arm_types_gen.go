...
<<<<<<<< HEAD:v2/api/documentdb/v1beta20210515/database_account__spec_arm_types_gen.go
	Kind *DatabaseAccount_Spec_Kind `json:"kind,omitempty"`
========
	Kind *DatabaseAccounts_Spec_Kind `json:"kind,omitempty"`
>>>>>>>> main:v2/api/documentdb/v1beta20210515/database_accounts_spec_arm_types_gen.go
...
========
// +kubebuilder:validation:Enum={"GlobalDocumentDB","MongoDB","Parse"}
type DatabaseAccounts_Spec_Kind string

const (
	DatabaseAccounts_Spec_Kind_GlobalDocumentDB = DatabaseAccounts_Spec_Kind("GlobalDocumentDB")
	DatabaseAccounts_Spec_Kind_MongoDB          = DatabaseAccounts_Spec_Kind("MongoDB")
	DatabaseAccounts_Spec_Kind_Parse            = DatabaseAccounts_Spec_Kind("Parse")
)
