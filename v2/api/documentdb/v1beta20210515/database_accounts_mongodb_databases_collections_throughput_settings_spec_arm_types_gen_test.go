...
<<<<<<<< HEAD:v2/api/documentdb/v1beta20210515/database_accounts_mongodb_databases_collections_throughput_setting__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/documentdb/v1beta20210515/database_accounts_mongodb_databases_collections_throughput_settings_spec_arm_types_gen_test.go
	t.Parallel()
