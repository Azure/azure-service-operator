...
// RunPropertyAssignmentTestForSqlDatabaseResource_STATUS tests if a specific instance of SqlDatabaseResource_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForSqlDatabaseResource_STATUS(subject SqlDatabaseResource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.SqlDatabaseResource_STATUS
