...
// RunPropertyAssignmentTestForSqlDatabaseCreateUpdateParameters_STATUS tests if a specific instance of SqlDatabaseCreateUpdateParameters_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForSqlDatabaseCreateUpdateParameters_STATUS(subject SqlDatabaseCreateUpdateParameters_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.SqlDatabaseCreateUpdateParameters_STATUS
