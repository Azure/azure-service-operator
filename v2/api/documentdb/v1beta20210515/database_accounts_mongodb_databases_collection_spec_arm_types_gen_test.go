...
func Test_DatabaseAccounts_MongodbDatabases_Collection_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of DatabaseAccounts_MongodbDatabases_Collection_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collection_SpecARM, DatabaseAccounts_MongodbDatabases_Collection_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collection_SpecARM runs a test to see if a specific instance of DatabaseAccounts_MongodbDatabases_Collection_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collection_SpecARM(subject DatabaseAccounts_MongodbDatabases_Collection_SpecARM) string {
	// Serialize to JSON
	...
	var actual DatabaseAccounts_MongodbDatabases_Collection_SpecARM
...
// Generator of DatabaseAccounts_MongodbDatabases_Collection_SpecARM instances for property testing - lazily
// instantiated by DatabaseAccounts_MongodbDatabases_Collection_SpecARMGenerator()
var databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator gopter.Gen

// DatabaseAccounts_MongodbDatabases_Collection_SpecARMGenerator returns a generator of DatabaseAccounts_MongodbDatabases_Collection_SpecARM instances for property testing.
// We first initialize databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DatabaseAccounts_MongodbDatabases_Collection_SpecARMGenerator() gopter.Gen {
	if databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator != nil {
		return databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collection_SpecARM(generators)
	databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_MongodbDatabases_Collection_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collection_SpecARM(generators)
	AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collection_SpecARM(generators)
	databaseAccounts_MongodbDatabases_Collection_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_MongodbDatabases_Collection_SpecARM{}), generators)
...
// AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collection_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collection_SpecARM(gens map[string]gopter.Gen) {
