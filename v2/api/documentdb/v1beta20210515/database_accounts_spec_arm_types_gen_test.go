...
func Test_DatabaseAccount_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/documentdb/v1beta20210515/database_account__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/documentdb/v1beta20210515/database_accounts_spec_arm_types_gen_test.go
	// Serialize to JSON
