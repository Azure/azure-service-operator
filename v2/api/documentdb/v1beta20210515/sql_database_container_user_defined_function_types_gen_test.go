...
// RunPropertyAssignmentTestForSqlUserDefinedFunctionCreateUpdateParameters_STATUS tests if a specific instance of SqlUserDefinedFunctionCreateUpdateParameters_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForSqlUserDefinedFunctionCreateUpdateParameters_STATUS(subject SqlUserDefinedFunctionCreateUpdateParameters_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.SqlUserDefinedFunctionCreateUpdateParameters_STATUS
...
// RunPropertyAssignmentTestForSqlUserDefinedFunctionResource_STATUS tests if a specific instance of SqlUserDefinedFunctionResource_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForSqlUserDefinedFunctionResource_STATUS(subject SqlUserDefinedFunctionResource_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.SqlUserDefinedFunctionResource_STATUS
