...
// RunPropertyAssignmentTestForMongoDBDatabaseCreateUpdateParameters_STATUS tests if a specific instance of MongoDBDatabaseCreateUpdateParameters_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForMongoDBDatabaseCreateUpdateParameters_STATUS(subject MongoDBDatabaseCreateUpdateParameters_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.MongoDBDatabaseCreateUpdateParameters_STATUS
...
// RunPropertyAssignmentTestForCreateUpdateOptions_STATUS tests if a specific instance of CreateUpdateOptions_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForCreateUpdateOptions_STATUS(subject CreateUpdateOptions_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.CreateUpdateOptions_STATUS
...
// RunPropertyAssignmentTestForMongoDBDatabaseResource_STATUS tests if a specific instance of MongoDBDatabaseResource_STATUS can be assigned to v1beta20210515storage and back losslessly
func RunPropertyAssignmentTestForMongoDBDatabaseResource_STATUS(subject MongoDBDatabaseResource_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210515s.MongoDBDatabaseResource_STATUS
