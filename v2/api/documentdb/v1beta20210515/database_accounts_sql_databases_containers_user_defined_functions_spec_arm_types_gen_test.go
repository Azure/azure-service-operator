...
<<<<<<<< HEAD:v2/api/documentdb/v1beta20210515/database_accounts_sql_databases_containers_user_defined_function__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/documentdb/v1beta20210515/database_accounts_sql_databases_containers_user_defined_functions_spec_arm_types_gen_test.go
	t.Parallel()
