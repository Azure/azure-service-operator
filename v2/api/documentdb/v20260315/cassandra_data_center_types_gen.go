...
func (center *CassandraDataCenter_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if center.Properties != nil {
		...
		properties := *properties_ARM.(*arm.DataCenterResourceProperties)
...
func (center *CassandraDataCenter_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		var properties1 DataCenterResourceProperties
...
func (center *CassandraDataCenter_Spec) AssignProperties_From_CassandraDataCenter_Spec(source *storage.CassandraDataCenter_Spec) error {
	...
	if source.Properties != nil {
		var property DataCenterResourceProperties
...
func (center *CassandraDataCenter_Spec) Initialize_From_CassandraDataCenter_STATUS(source *CassandraDataCenter_STATUS) error {
	...
	if source.Properties != nil {
		var property DataCenterResourceProperties
		err := property.Initialize_From_DataCenterResourceProperties_STATUS(source.Properties)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_DataCenterResourceProperties_STATUS() to populate field Properties")
		}
		center.Properties = &property
	} else {
		center.Properties = nil
...
func (center *CassandraDataCenter_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Properties":
	if typedInput.Properties != nil {
		var properties1 DataCenterResourceProperties_STATUS
		err := properties1.PopulateFromARM(owner, *typedInput.Properties)
		if err != nil {
			return err
		}
...
func (center *CassandraDataCenter_STATUS) AssignProperties_From_CassandraDataCenter_STATUS(source *storage.CassandraDataCenter_STATUS) error {
	...
	// Properties
	if source.Properties != nil {
		var property DataCenterResourceProperties_STATUS
	...
	if source.SystemData != nil {
		...
		center.SystemData = &systemDatum
	} else {
		center.SystemData = nil
	}
...
func (center *CassandraDataCenter_STATUS) AssignProperties_To_CassandraDataCenter_STATUS(destination *storage.CassandraDataCenter_STATUS) error {
	...
	// SystemData
	if center.SystemData != nil {
		var systemDatum storage.SystemData_STATUS
		err := center.SystemData.AssignProperties_To_SystemData_STATUS(&systemDatum)
		if err != nil {
...
var _ genruntime.ARMTransformer = &DataCenterResourceProperties{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (properties *DataCenterResourceProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if properties == nil {
		return nil, nil
	}
	result := &arm.DataCenterResourceProperties{}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *DataCenterResourceProperties) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DataCenterResourceProperties{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *DataCenterResourceProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DataCenterResourceProperties)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DataCenterResourceProperties, got %T", armInput)
	}
...
// AssignProperties_From_DataCenterResourceProperties populates our DataCenterResourceProperties from the provided source DataCenterResourceProperties
func (properties *DataCenterResourceProperties) AssignProperties_From_DataCenterResourceProperties(source *storage.DataCenterResourceProperties) error {
...
// AssignProperties_To_DataCenterResourceProperties populates the provided destination DataCenterResourceProperties from our DataCenterResourceProperties
func (properties *DataCenterResourceProperties) AssignProperties_To_DataCenterResourceProperties(destination *storage.DataCenterResourceProperties) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Initialize_From_DataCenterResourceProperties_STATUS populates our DataCenterResourceProperties from the provided source DataCenterResourceProperties_STATUS
func (properties *DataCenterResourceProperties) Initialize_From_DataCenterResourceProperties_STATUS(source *DataCenterResourceProperties_STATUS) error {
...
var _ genruntime.FromARMConverter = &DataCenterResourceProperties_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *DataCenterResourceProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DataCenterResourceProperties_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *DataCenterResourceProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DataCenterResourceProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DataCenterResourceProperties_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_DataCenterResourceProperties_STATUS populates our DataCenterResourceProperties_STATUS from the provided source DataCenterResourceProperties_STATUS
func (properties *DataCenterResourceProperties_STATUS) AssignProperties_From_DataCenterResourceProperties_STATUS(source *storage.DataCenterResourceProperties_STATUS) error {
...
// AssignProperties_To_DataCenterResourceProperties_STATUS populates the provided destination DataCenterResourceProperties_STATUS from our DataCenterResourceProperties_STATUS
func (properties *DataCenterResourceProperties_STATUS) AssignProperties_To_DataCenterResourceProperties_STATUS(destination *storage.DataCenterResourceProperties_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
