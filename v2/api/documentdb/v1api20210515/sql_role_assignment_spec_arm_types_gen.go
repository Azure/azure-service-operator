...
type SqlRoleAssignment_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &SqlRoleAssignment_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-15"
func (assignment SqlRoleAssignment_Spec_ARM) GetAPIVersion() string {
	return "2021-05-15"
}

// GetName returns the Name of the resource
func (assignment *SqlRoleAssignment_Spec_ARM) GetName() string {
	return assignment.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.DocumentDB/databaseAccounts/sqlRoleAssignments"
func (assignment *SqlRoleAssignment_Spec_ARM) GetType() string {
