...
type SqlDatabaseContainerStoredProcedure_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &SqlDatabaseContainerStoredProcedure_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-15"
func (procedure SqlDatabaseContainerStoredProcedure_Spec_ARM) GetAPIVersion() string {
	return "2021-05-15"
}

// GetName returns the Name of the resource
func (procedure *SqlDatabaseContainerStoredProcedure_Spec_ARM) GetName() string {
...
func (procedure *SqlDatabaseContainerStoredProcedure_Spec_ARM) GetType() string {
