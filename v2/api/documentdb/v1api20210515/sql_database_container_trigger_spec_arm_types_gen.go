...
type SqlDatabaseContainerTrigger_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &SqlDatabaseContainerTrigger_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-15"
func (trigger SqlDatabaseContainerTrigger_Spec_ARM) GetAPIVersion() string {
	return "2021-05-15"
}

// GetName returns the Name of the resource
func (trigger *SqlDatabaseContainerTrigger_Spec_ARM) GetName() string {
	return trigger.Name
}
...
func (trigger *SqlDatabaseContainerTrigger_Spec_ARM) GetType() string {
