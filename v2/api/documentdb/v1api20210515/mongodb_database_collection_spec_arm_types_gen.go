...
type MongodbDatabaseCollection_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &MongodbDatabaseCollection_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-15"
func (collection MongodbDatabaseCollection_Spec_ARM) GetAPIVersion() string {
	return "2021-05-15"
}

// GetName returns the Name of the resource
func (collection *MongodbDatabaseCollection_Spec_ARM) GetName() string {
...
func (collection *MongodbDatabaseCollection_Spec_ARM) GetType() string {
