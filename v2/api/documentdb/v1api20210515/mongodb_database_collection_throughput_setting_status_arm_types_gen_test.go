...
func Test_MongodbDatabaseCollectionThroughputSetting_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of MongodbDatabaseCollectionThroughputSetting_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM, MongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM runs a test to see if a specific instance of MongodbDatabaseCollectionThroughputSetting_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(subject MongodbDatabaseCollectionThroughputSetting_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual MongodbDatabaseCollectionThroughputSetting_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of MongodbDatabaseCollectionThroughputSetting_STATUS_ARM instances for property testing - lazily
// instantiated by MongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator()
var mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator gopter.Gen

// MongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator returns a generator of MongodbDatabaseCollectionThroughputSetting_STATUS_ARM instances for property testing.
// We first initialize mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func MongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator() gopter.Gen {
	if mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator != nil {
		return mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(generators)
	mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(MongodbDatabaseCollectionThroughputSetting_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(generators)
	mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(MongodbDatabaseCollectionThroughputSetting_STATUS_ARM{}), generators)

	return mongodbDatabaseCollectionThroughputSetting_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForMongodbDatabaseCollectionThroughputSetting_STATUS_ARM(gens map[string]gopter.Gen) {
