...
type augmentConversionForSqlDatabaseContainerThroughputSetting interface {
	AssignPropertiesFrom(src *v20231115s.SqlDatabaseContainerThroughputSetting) error
	AssignPropertiesTo(dst *v20231115s.SqlDatabaseContainerThroughputSetting) error
}
...
type augmentConversionForDatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error
}

type augmentConversionForDatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error
}
