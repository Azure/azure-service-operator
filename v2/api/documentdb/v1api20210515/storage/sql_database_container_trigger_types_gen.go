...
type augmentConversionForSqlDatabaseContainerTrigger interface {
	AssignPropertiesFrom(src *v20231115s.SqlDatabaseContainerTrigger) error
...
type augmentConversionForDatabaseAccounts_SqlDatabases_Containers_Trigger_Spec interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_Containers_Trigger_Spec) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_Containers_Trigger_Spec) error
}

type augmentConversionForDatabaseAccounts_SqlDatabases_Containers_Trigger_STATUS interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_Containers_Trigger_STATUS) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_Containers_Trigger_STATUS) error
}
...
type augmentConversionForSqlTriggerGetProperties_Resource_STATUS interface {
	AssignPropertiesFrom(src *v20231115s.SqlTriggerGetProperties_Resource_STATUS) error
	AssignPropertiesTo(dst *v20231115s.SqlTriggerGetProperties_Resource_STATUS) error
}

type augmentConversionForSqlTriggerResource interface {
	AssignPropertiesFrom(src *v20231115s.SqlTriggerResource) error
	AssignPropertiesTo(dst *v20231115s.SqlTriggerResource) error
}
