...
type augmentConversionForSqlDatabaseThroughputSetting interface {
	AssignPropertiesFrom(src *v20231115s.SqlDatabaseThroughputSetting) error
	AssignPropertiesTo(dst *v20231115s.SqlDatabaseThroughputSetting) error
}
...
type augmentConversionForDatabaseAccounts_SqlDatabases_ThroughputSetting_Spec interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_ThroughputSetting_Spec) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_ThroughputSetting_Spec) error
}

type augmentConversionForDatabaseAccounts_SqlDatabases_ThroughputSetting_STATUS interface {
	AssignPropertiesFrom(src *v20231115s.DatabaseAccounts_SqlDatabases_ThroughputSetting_STATUS) error
	AssignPropertiesTo(dst *v20231115s.DatabaseAccounts_SqlDatabases_ThroughputSetting_STATUS) error
}
