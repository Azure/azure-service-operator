...
import (
	...
	"github.com/Azure/azure-service-operator/v2/api/documentdb/v1api20231115"
...
func (webhook *SqlRoleAssignment) CustomDefault(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v1api20231115.SqlRoleAssignment)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/documentdb/v1api20231115/SqlRoleAssignment, but got %T", obj)
	}
...
func (webhook *SqlRoleAssignment) defaultAzureName(_ context.Context, assignment *v1api20231115.SqlRoleAssignment) {
