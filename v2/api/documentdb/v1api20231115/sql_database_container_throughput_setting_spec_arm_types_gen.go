...
type SqlDatabaseContainerThroughputSetting_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &SqlDatabaseContainerThroughputSetting_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2023-11-15"
func (setting SqlDatabaseContainerThroughputSetting_Spec_ARM) GetAPIVersion() string {
	return "2023-11-15"
}

// GetName returns the Name of the resource
func (setting *SqlDatabaseContainerThroughputSetting_Spec_ARM) GetName() string {
	return setting.Name
}
...
func (setting *SqlDatabaseContainerThroughputSetting_Spec_ARM) GetType() string {
