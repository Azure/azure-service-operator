...
func (setting *SqlDatabaseContainerThroughputSetting) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20231115s.SqlDatabaseContainerThroughputSetting)
	if !ok {
...
func (setting *SqlDatabaseContainerThroughputSetting) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20231115s.SqlDatabaseContainerThroughputSetting)
	if !ok {
		return fmt.Errorf("expected documentdb/v1api20231115/storage/SqlDatabaseContainerThroughputSetting but received %T instead", hub)
	}
...
func (setting *SqlDatabaseContainerThroughputSetting) AssignProperties_From_SqlDatabaseContainerThroughputSetting(source *v20231115s.SqlDatabaseContainerThroughputSetting) error {
...
func (setting *SqlDatabaseContainerThroughputSetting) AssignProperties_To_SqlDatabaseContainerThroughputSetting(destination *v20231115s.SqlDatabaseContainerThroughputSetting) error {

	// ObjectMeta
	destination.ObjectMeta = *setting.ObjectMeta.DeepCopy()

	// Spec
	var spec v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec
	...
	// Status
	var status v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec)
	if ok {
	...
	src = &v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) AssignProperties_From_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec(source *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) AssignProperties_To_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec(destination *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_Spec) error {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS{}
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) AssignProperties_From_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS(source *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error {
...
func (setting *DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) AssignProperties_To_DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS(destination *v20231115s.DatabaseAccounts_SqlDatabases_Containers_ThroughputSetting_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
