...
func Test_ClientEncryptionIncludedPath_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of ClientEncryptionIncludedPath_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForClientEncryptionIncludedPath_STATUS_ARM, ClientEncryptionIncludedPath_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForClientEncryptionIncludedPath_STATUS_ARM runs a test to see if a specific instance of ClientEncryptionIncludedPath_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForClientEncryptionIncludedPath_STATUS_ARM(subject ClientEncryptionIncludedPath_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual ClientEncryptionIncludedPath_STATUS_ARM
...
// Generator of ClientEncryptionIncludedPath_STATUS_ARM instances for property testing - lazily instantiated by
// ClientEncryptionIncludedPath_STATUS_ARMGenerator()
var clientEncryptionIncludedPath_STATUS_ARMGenerator gopter.Gen

// ClientEncryptionIncludedPath_STATUS_ARMGenerator returns a generator of ClientEncryptionIncludedPath_STATUS_ARM instances for property testing.
func ClientEncryptionIncludedPath_STATUS_ARMGenerator() gopter.Gen {
	if clientEncryptionIncludedPath_STATUS_ARMGenerator != nil {
		return clientEncryptionIncludedPath_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForClientEncryptionIncludedPath_STATUS_ARM(generators)
	clientEncryptionIncludedPath_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ClientEncryptionIncludedPath_STATUS_ARM{}), generators)

	return clientEncryptionIncludedPath_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForClientEncryptionIncludedPath_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForClientEncryptionIncludedPath_STATUS_ARM(gens map[string]gopter.Gen) {
...
func Test_ClientEncryptionPolicy_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ClientEncryptionPolicy_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForClientEncryptionPolicy_STATUS_ARM, ClientEncryptionPolicy_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForClientEncryptionPolicy_STATUS_ARM runs a test to see if a specific instance of ClientEncryptionPolicy_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForClientEncryptionPolicy_STATUS_ARM(subject ClientEncryptionPolicy_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ClientEncryptionPolicy_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ClientEncryptionPolicy_STATUS_ARM instances for property testing - lazily instantiated by
// ClientEncryptionPolicy_STATUS_ARMGenerator()
var clientEncryptionPolicy_STATUS_ARMGenerator gopter.Gen

// ClientEncryptionPolicy_STATUS_ARMGenerator returns a generator of ClientEncryptionPolicy_STATUS_ARM instances for property testing.
// We first initialize clientEncryptionPolicy_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ClientEncryptionPolicy_STATUS_ARMGenerator() gopter.Gen {
	if clientEncryptionPolicy_STATUS_ARMGenerator != nil {
		return clientEncryptionPolicy_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM(generators)
	clientEncryptionPolicy_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ClientEncryptionPolicy_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM(generators)
	clientEncryptionPolicy_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ClientEncryptionPolicy_STATUS_ARM{}), generators)

	return clientEncryptionPolicy_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["PolicyFormatVersion"] = gen.PtrOf(gen.Int())
}

// AddRelatedPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForClientEncryptionPolicy_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["IncludedPaths"] = gen.SliceOf(ClientEncryptionIncludedPath_STATUS_ARMGenerator())
}
...
func Test_ComputedProperty_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ComputedProperty_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForComputedProperty_STATUS_ARM, ComputedProperty_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputedProperty_STATUS_ARM runs a test to see if a specific instance of ComputedProperty_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForComputedProperty_STATUS_ARM(subject ComputedProperty_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ComputedProperty_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ComputedProperty_STATUS_ARM instances for property testing - lazily instantiated by
// ComputedProperty_STATUS_ARMGenerator()
var computedProperty_STATUS_ARMGenerator gopter.Gen

// ComputedProperty_STATUS_ARMGenerator returns a generator of ComputedProperty_STATUS_ARM instances for property testing.
func ComputedProperty_STATUS_ARMGenerator() gopter.Gen {
	if computedProperty_STATUS_ARMGenerator != nil {
		return computedProperty_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputedProperty_STATUS_ARM(generators)
	computedProperty_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(ComputedProperty_STATUS_ARM{}), generators)

	return computedProperty_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForComputedProperty_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForComputedProperty_STATUS_ARM(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForSqlContainerGetProperties_Resource_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["ClientEncryptionPolicy"] = gen.PtrOf(ClientEncryptionPolicy_STATUS_ARMGenerator())
	gens["ComputedProperties"] = gen.SliceOf(ComputedProperty_STATUS_ARMGenerator())
