...
// We first initialize mongoDBDatabaseResource_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func MongoDBDatabaseResource_ARMGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForMongoDBDatabaseResource_ARM(generators)
	AddRelatedPropertyGeneratorsForMongoDBDatabaseResource_ARM(generators)
	mongoDBDatabaseResource_ARMGenerator = gen.Struct(reflect.TypeOf(MongoDBDatabaseResource_ARM{}), generators)
...
// AddRelatedPropertyGeneratorsForMongoDBDatabaseResource_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForMongoDBDatabaseResource_ARM(gens map[string]gopter.Gen) {
