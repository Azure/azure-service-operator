...
func Test_SqlDatabaseContainerTrigger_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of SqlDatabaseContainerTrigger_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSqlDatabaseContainerTrigger_STATUS_ARM, SqlDatabaseContainerTrigger_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSqlDatabaseContainerTrigger_STATUS_ARM runs a test to see if a specific instance of SqlDatabaseContainerTrigger_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForSqlDatabaseContainerTrigger_STATUS_ARM(subject SqlDatabaseContainerTrigger_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual SqlDatabaseContainerTrigger_STATUS_ARM
...
// Generator of SqlDatabaseContainerTrigger_STATUS_ARM instances for property testing - lazily instantiated by
// SqlDatabaseContainerTrigger_STATUS_ARMGenerator()
var sqlDatabaseContainerTrigger_STATUS_ARMGenerator gopter.Gen

// SqlDatabaseContainerTrigger_STATUS_ARMGenerator returns a generator of SqlDatabaseContainerTrigger_STATUS_ARM instances for property testing.
// We first initialize sqlDatabaseContainerTrigger_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func SqlDatabaseContainerTrigger_STATUS_ARMGenerator() gopter.Gen {
	if sqlDatabaseContainerTrigger_STATUS_ARMGenerator != nil {
		return sqlDatabaseContainerTrigger_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM(generators)
	sqlDatabaseContainerTrigger_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(SqlDatabaseContainerTrigger_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM(generators)
	sqlDatabaseContainerTrigger_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(SqlDatabaseContainerTrigger_STATUS_ARM{}), generators)

	return sqlDatabaseContainerTrigger_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForSqlDatabaseContainerTrigger_STATUS_ARM(gens map[string]gopter.Gen) {
