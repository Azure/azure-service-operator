...
func Test_RestoreParametersBase_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of RestoreParametersBase_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRestoreParametersBase_ARM, RestoreParametersBase_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRestoreParametersBase_ARM runs a test to see if a specific instance of RestoreParametersBase_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRestoreParametersBase_ARM(subject RestoreParametersBase_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual RestoreParametersBase_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of RestoreParametersBase_ARM instances for property testing - lazily instantiated by
// RestoreParametersBase_ARMGenerator()
var restoreParametersBase_ARMGenerator gopter.Gen

// RestoreParametersBase_ARMGenerator returns a generator of RestoreParametersBase_ARM instances for property testing.
func RestoreParametersBase_ARMGenerator() gopter.Gen {
	if restoreParametersBase_ARMGenerator != nil {
		return restoreParametersBase_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRestoreParametersBase_ARM(generators)
	restoreParametersBase_ARMGenerator = gen.Struct(reflect.TypeOf(RestoreParametersBase_ARM{}), generators)

	return restoreParametersBase_ARMGenerator
}

// AddIndependentPropertyGeneratorsForRestoreParametersBase_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRestoreParametersBase_ARM(gens map[string]gopter.Gen) {
