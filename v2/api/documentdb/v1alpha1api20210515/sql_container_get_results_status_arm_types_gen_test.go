...
func Test_SqlContainerGetResults_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of SqlContainerGetResults_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSqlContainerGetResults_STATUS_ARM, SqlContainerGetResults_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSqlContainerGetResults_STATUS_ARM runs a test to see if a specific instance of SqlContainerGetResults_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForSqlContainerGetResults_STATUS_ARM(subject SqlContainerGetResults_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual SqlContainerGetResults_STATUS_ARM
...
// Generator of SqlContainerGetResults_STATUS_ARM instances for property testing - lazily instantiated by
// SqlContainerGetResults_STATUS_ARMGenerator()
var sqlContainerGetResults_STATUS_ARMGenerator gopter.Gen

// SqlContainerGetResults_STATUS_ARMGenerator returns a generator of SqlContainerGetResults_STATUS_ARM instances for property testing.
// We first initialize sqlContainerGetResults_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func SqlContainerGetResults_STATUS_ARMGenerator() gopter.Gen {
	if sqlContainerGetResults_STATUS_ARMGenerator != nil {
		return sqlContainerGetResults_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM(generators)
	sqlContainerGetResults_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(SqlContainerGetResults_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM(generators)
	sqlContainerGetResults_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(SqlContainerGetResults_STATUS_ARM{}), generators)

	return sqlContainerGetResults_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForSqlContainerGetResults_STATUS_ARM(gens map[string]gopter.Gen) {
