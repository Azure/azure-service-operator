...
<<<<<<<< HEAD:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collection__spec_arm_types_gen_test.go
func Test_DatabaseAccountsMongodbDatabasesCollection_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_DatabaseAccounts_MongodbDatabases_Collections_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collections_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of DatabaseAccounts_MongodbDatabases_Collections_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collections_SpecARM, DatabaseAccounts_MongodbDatabases_Collections_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collections_SpecARM runs a test to see if a specific instance of DatabaseAccounts_MongodbDatabases_Collections_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(subject DatabaseAccounts_MongodbDatabases_Collections_SpecARM) string {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collections_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual DatabaseAccounts_MongodbDatabases_Collections_SpecARM
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collections_spec_arm_types_gen_test.go
...
========
// Generator of DatabaseAccounts_MongodbDatabases_Collections_SpecARM instances for property testing - lazily
// instantiated by DatabaseAccounts_MongodbDatabases_Collections_SpecARMGenerator()
var databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator gopter.Gen

// DatabaseAccounts_MongodbDatabases_Collections_SpecARMGenerator returns a generator of DatabaseAccounts_MongodbDatabases_Collections_SpecARM instances for property testing.
// We first initialize databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DatabaseAccounts_MongodbDatabases_Collections_SpecARMGenerator() gopter.Gen {
	if databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator != nil {
		return databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(generators)
	databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_MongodbDatabases_Collections_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(generators)
	AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(generators)
	databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_MongodbDatabases_Collections_SpecARM{}), generators)

	return databaseAccounts_MongodbDatabases_Collections_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collections_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseAccounts_MongodbDatabases_Collections_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_collections_spec_arm_types_gen_test.go
