...
func AddRelatedPropertyGeneratorsForDatabaseAccountsSqlDatabasesContainer_SpecARM(gens map[string]gopter.Gen) {
	gens["Properties"] = SqlContainerPropertiesARMGenerator()
}

func Test_SqlContainerPropertiesARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SqlContainerPropertiesARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSqlContainerPropertiesARM, SqlContainerPropertiesARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSqlContainerPropertiesARM runs a test to see if a specific instance of SqlContainerPropertiesARM round trips to JSON and back losslessly
func RunJSONSerializationTestForSqlContainerPropertiesARM(subject SqlContainerPropertiesARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual SqlContainerPropertiesARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of SqlContainerPropertiesARM instances for property testing - lazily instantiated by
//SqlContainerPropertiesARMGenerator()
var sqlContainerPropertiesARMGenerator gopter.Gen

// SqlContainerPropertiesARMGenerator returns a generator of SqlContainerPropertiesARM instances for property testing.
func SqlContainerPropertiesARMGenerator() gopter.Gen {
	if sqlContainerPropertiesARMGenerator != nil {
		return sqlContainerPropertiesARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForSqlContainerPropertiesARM(generators)
	sqlContainerPropertiesARMGenerator = gen.Struct(reflect.TypeOf(SqlContainerPropertiesARM{}), generators)

	return sqlContainerPropertiesARMGenerator
}

// AddRelatedPropertyGeneratorsForSqlContainerPropertiesARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForSqlContainerPropertiesARM(gens map[string]gopter.Gen) {
