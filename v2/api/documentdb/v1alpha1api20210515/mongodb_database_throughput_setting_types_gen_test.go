...
// RunPropertyAssignmentTestForDatabaseAccounts_MongodbDatabases_ThroughputSetting_Spec tests if a specific instance of DatabaseAccounts_MongodbDatabases_ThroughputSetting_Spec can be assigned to v1alpha1api20210515storage and back losslessly
func RunPropertyAssignmentTestForDatabaseAccounts_MongodbDatabases_ThroughputSetting_Spec(subject DatabaseAccounts_MongodbDatabases_ThroughputSetting_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210515s.DatabaseAccounts_MongodbDatabases_ThroughputSetting_Spec
...
// RunPropertyAssignmentTestForDatabaseAccounts_MongodbDatabases_ThroughputSetting_STATUS tests if a specific instance of DatabaseAccounts_MongodbDatabases_ThroughputSetting_STATUS can be assigned to v1alpha1api20210515storage and back losslessly
func RunPropertyAssignmentTestForDatabaseAccounts_MongodbDatabases_ThroughputSetting_STATUS(subject DatabaseAccounts_MongodbDatabases_ThroughputSetting_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210515s.DatabaseAccounts_MongodbDatabases_ThroughputSetting_STATUS
