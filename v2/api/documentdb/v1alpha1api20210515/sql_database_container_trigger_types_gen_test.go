...
// RunPropertyAssignmentTestForDatabaseAccounts_SqlDatabases_Containers_Triggers_Spec tests if a specific instance of DatabaseAccounts_SqlDatabases_Containers_Triggers_Spec can be assigned to v1alpha1api20210515storage and back losslessly
...
>>>>>>> main
	...
	// Use AssignPropertiesTo() for the first stage of conversion
<<<<<<< HEAD
	var other alpha20210515s.DatabaseAccountsSqlDatabasesContainersTrigger_Spec
	err := copied.AssignPropertiesToDatabaseAccountsSqlDatabasesContainersTrigger_Spec(&other)
=======
	var other alpha20210515s.DatabaseAccounts_SqlDatabases_Containers_Triggers_Spec
...
// RunPropertyAssignmentTestForDatabaseAccountsSqlDatabasesContainersTrigger_STATUS tests if a specific instance of DatabaseAccountsSqlDatabasesContainersTrigger_STATUS can be assigned to v1alpha1api20210515storage and back losslessly
...
// RunPropertyAssignmentTestForSqlTriggerGetResults_STATUS tests if a specific instance of SqlTriggerGetResults_STATUS can be assigned to v1alpha1api20210515storage and back losslessly
...
>>>>>>> main
	...
	// Use AssignPropertiesTo() for the first stage of conversion
<<<<<<< HEAD
	var other alpha20210515s.DatabaseAccountsSqlDatabasesContainersTrigger_STATUS
...
// RunPropertyAssignmentTestForSqlTriggerGetProperties_Resource_STATUS tests if a specific instance of SqlTriggerGetProperties_Resource_STATUS can be assigned to v1alpha1api20210515storage and back losslessly
...
// RunPropertyAssignmentTestForSqlTriggerGetProperties_STATUS_Resource tests if a specific instance of SqlTriggerGetProperties_STATUS_Resource can be assigned to v1alpha1api20210515storage and back losslessly
...
>>>>>>> main
	...
	// Use AssignPropertiesTo() for the first stage of conversion
<<<<<<< HEAD
	var other alpha20210515s.SqlTriggerGetProperties_Resource_STATUS
