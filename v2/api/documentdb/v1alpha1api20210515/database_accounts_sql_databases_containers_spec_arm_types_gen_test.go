...
<<<<<<<< HEAD:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_container__spec_arm_types_gen_test.go
func Test_DatabaseAccountsSqlDatabasesContainer_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_DatabaseAccounts_SqlDatabases_Containers_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_containers_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of DatabaseAccounts_SqlDatabases_Containers_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseAccounts_SqlDatabases_Containers_SpecARM, DatabaseAccounts_SqlDatabases_Containers_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseAccounts_SqlDatabases_Containers_SpecARM runs a test to see if a specific instance of DatabaseAccounts_SqlDatabases_Containers_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseAccounts_SqlDatabases_Containers_SpecARM(subject DatabaseAccounts_SqlDatabases_Containers_SpecARM) string {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_containers_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual DatabaseAccounts_SqlDatabases_Containers_SpecARM
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_containers_spec_arm_types_gen_test.go
...
========
// Generator of DatabaseAccounts_SqlDatabases_Containers_SpecARM instances for property testing - lazily instantiated by
// DatabaseAccounts_SqlDatabases_Containers_SpecARMGenerator()
var databaseAccounts_SqlDatabases_Containers_SpecARMGenerator gopter.Gen

// DatabaseAccounts_SqlDatabases_Containers_SpecARMGenerator returns a generator of DatabaseAccounts_SqlDatabases_Containers_SpecARM instances for property testing.
// We first initialize databaseAccounts_SqlDatabases_Containers_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DatabaseAccounts_SqlDatabases_Containers_SpecARMGenerator() gopter.Gen {
	if databaseAccounts_SqlDatabases_Containers_SpecARMGenerator != nil {
		return databaseAccounts_SqlDatabases_Containers_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM(generators)
	databaseAccounts_SqlDatabases_Containers_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_SqlDatabases_Containers_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM(generators)
	AddRelatedPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM(generators)
	databaseAccounts_SqlDatabases_Containers_SpecARMGenerator = gen.Struct(reflect.TypeOf(DatabaseAccounts_SqlDatabases_Containers_SpecARM{}), generators)

	return databaseAccounts_SqlDatabases_Containers_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_containers_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseAccounts_SqlDatabases_Containers_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_sql_databases_containers_spec_arm_types_gen_test.go
