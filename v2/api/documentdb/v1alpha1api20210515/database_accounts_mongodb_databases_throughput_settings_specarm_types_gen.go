...
func (specarm DatabaseAccountsMongodbDatabasesThroughputSettings_SPECARM) GetAPIVersion() string {
	return string(APIVersionValue)
}

// GetName returns the Name of the resource
func (specarm DatabaseAccountsMongodbDatabasesThroughputSettings_SPECARM) GetName() string {
	return specarm.Name
}

// GetType returns the ARM Type of the resource. This is always ""
func (specarm DatabaseAccountsMongodbDatabasesThroughputSettings_SPECARM) GetType() string {
	return ""
}
