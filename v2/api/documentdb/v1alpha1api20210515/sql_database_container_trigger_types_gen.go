...
func (trigger *SqlDatabaseContainerTrigger) AssignPropertiesToSqlDatabaseContainerTrigger(destination *alpha20210515s.SqlDatabaseContainerTrigger) error {
	...
	// Status
	var status alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS
...
func (parameters *SqlTriggerCreateUpdateParameters_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS{}
...
func (parameters *SqlTriggerCreateUpdateParameters_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS{}
...
func (parameters *SqlTriggerCreateUpdateParameters_STATUS) AssignPropertiesFromSqlTriggerCreateUpdateParameters_STATUS(source *alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS) error {
...
func (parameters *SqlTriggerCreateUpdateParameters_STATUS) AssignPropertiesToSqlTriggerCreateUpdateParameters_STATUS(destination *alpha20210515s.SqlTriggerCreateUpdateParameters_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
