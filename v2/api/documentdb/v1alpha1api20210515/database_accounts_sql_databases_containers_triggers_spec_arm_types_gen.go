...
// Deprecated version of DatabaseAccounts_SqlDatabases_Containers_Triggers_Spec. Use v1beta20210515.DatabaseAccounts_SqlDatabases_Containers_Triggers_Spec instead
type DatabaseAccounts_SqlDatabases_Containers_Triggers_SpecARM struct {
...
var _ genruntime.ARMResourceSpec = &DatabaseAccounts_SqlDatabases_Containers_Triggers_SpecARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-05-15"
func (triggers DatabaseAccounts_SqlDatabases_Containers_Triggers_SpecARM) GetAPIVersion() string {
	return string(APIVersion_Value)
}

// GetName returns the Name of the resource
func (triggers *DatabaseAccounts_SqlDatabases_Containers_Triggers_SpecARM) GetName() string {
...
func (triggers *DatabaseAccounts_SqlDatabases_Containers_Triggers_SpecARM) GetType() string {
