...
// RunPropertyAssignmentTestForDatabaseAccounts_SqlDatabases_ThroughputSettings_Spec tests if a specific instance of DatabaseAccounts_SqlDatabases_ThroughputSettings_Spec can be assigned to v1alpha1api20210515storage and back losslessly
func RunPropertyAssignmentTestForDatabaseAccounts_SqlDatabases_ThroughputSettings_Spec(subject DatabaseAccounts_SqlDatabases_ThroughputSettings_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210515s.DatabaseAccounts_SqlDatabases_ThroughputSettings_Spec
