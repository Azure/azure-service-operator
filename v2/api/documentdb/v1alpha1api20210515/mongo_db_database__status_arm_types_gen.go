...
type MongoDBDatabase_StatusARM struct {
	...
	Properties *MongoDBDatabaseProperties_StatusARM `json:"properties,omitempty"`
...
type MongoDBDatabaseProperties_StatusARM struct {
