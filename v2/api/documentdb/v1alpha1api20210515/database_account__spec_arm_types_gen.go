...
type DatabaseAccount_SpecARM struct {
	...
	Properties DatabaseAccountPropertiesARM `json:"properties"`
...
type DatabaseAccountPropertiesARM struct {
...
type DatabaseAccount_SpecKind string

const (
	DatabaseAccount_SpecKindGlobalDocumentDB = DatabaseAccount_SpecKind("GlobalDocumentDB")
	DatabaseAccount_SpecKindMongoDB          = DatabaseAccount_SpecKind("MongoDB")
	DatabaseAccount_SpecKindParse            = DatabaseAccount_SpecKind("Parse")
)
