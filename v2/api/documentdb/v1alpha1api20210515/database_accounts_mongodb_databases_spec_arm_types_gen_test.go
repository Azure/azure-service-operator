...
<<<<<<<< HEAD:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_database__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/documentdb/v1alpha1api20210515/database_accounts_mongodb_databases_spec_arm_types_gen_test.go
	t.Parallel()
