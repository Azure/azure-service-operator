...
func (setting *MongodbDatabaseThroughputSetting) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1beta20210515storage.MongodbDatabaseThroughputSetting)
	if !ok {
...
func (setting *MongodbDatabaseThroughputSetting) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1beta20210515storage.MongodbDatabaseThroughputSetting)
	if !ok {
		return fmt.Errorf("expected documentdb/v1beta20210515storage/MongodbDatabaseThroughputSetting but received %T instead", hub)
	}
...
func (setting *MongodbDatabaseThroughputSetting) AssignPropertiesToMongodbDatabaseThroughputSetting(destination *v1beta20210515storage.MongodbDatabaseThroughputSetting) error {
	...
	// Spec
	var spec v1beta20210515storage.DatabaseAccountsMongodbDatabasesThroughputSettings_Spec
...
func (settings *DatabaseAccountsMongodbDatabasesThroughputSettings_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20210515storage.DatabaseAccountsMongodbDatabasesThroughputSettings_Spec)
	if ok {
	...
	src = &v1beta20210515storage.DatabaseAccountsMongodbDatabasesThroughputSettings_Spec{}
...
func (settings *DatabaseAccountsMongodbDatabasesThroughputSettings_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20210515storage.DatabaseAccountsMongodbDatabasesThroughputSettings_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20210515storage.DatabaseAccountsMongodbDatabasesThroughputSettings_Spec{}
