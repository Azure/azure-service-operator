...
const (
	IdentityProperties_TypeNone                       = IdentityProperties_Type("None")
	IdentityProperties_TypeSystemAssigned             = IdentityProperties_Type("SystemAssigned")
	IdentityProperties_TypeSystemAssignedUserAssigned = IdentityProperties_Type("SystemAssigned, UserAssigned")
	IdentityProperties_TypeUserAssigned               = IdentityProperties_Type("UserAssigned")
)
...
const (
	...
	Sku_NameClassic  = Sku_Name("Classic")
...
const (
	...
	Sku_TierClassic  = Sku_Tier("Classic")
