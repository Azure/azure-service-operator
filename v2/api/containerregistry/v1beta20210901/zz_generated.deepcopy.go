...
func (in *IdentityProperties_ARM) DeepCopyInto(out *IdentityProperties_ARM) {
	*out = *in
	...
	if in.UserAssignedIdentities != nil {
		in, out := &in.UserAssignedIdentities, &out.UserAssignedIdentities
		*out = make(map[string]UserIdentityProperties_ARM, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserIdentityProperties_ARM) DeepCopyInto(out *UserIdentityProperties_ARM) {
	*out = *in
	if in.ClientId != nil {
		in, out := &in.ClientId, &out.ClientId
		*out = new(string)
...
func (in *UserIdentityProperties_ARM) DeepCopy() *UserIdentityProperties_ARM {
	if in == nil {
		return nil
	}
	out := new(UserIdentityProperties_ARM)
	in.DeepCopyInto(out)
	return out
}
