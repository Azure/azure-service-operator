...
func Test_Registry_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/containerregistry/v1beta20210901/registry__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/containerregistry/v1beta20210901/registries_spec_arm_types_gen_test.go
	// Serialize to JSON
