...
func Test_Registry_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/containerregistry/v1alpha1api20210901/registry__spec_arm_types_gen_test.go
...
========
		...
		prop.ForAll(RunJSONSerializationTestForRegistries_SpecARM, Registries_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRegistries_SpecARM runs a test to see if a specific instance of Registries_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRegistries_SpecARM(subject Registries_SpecARM) string {
>>>>>>>> main:v2/api/containerregistry/v1alpha1api20210901/registries_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
// Generator of Registries_SpecARM instances for property testing - lazily instantiated by Registries_SpecARMGenerator()
var registries_SpecARMGenerator gopter.Gen

// Registries_SpecARMGenerator returns a generator of Registries_SpecARM instances for property testing.
// We first initialize registries_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func Registries_SpecARMGenerator() gopter.Gen {
	if registries_SpecARMGenerator != nil {
		return registries_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRegistries_SpecARM(generators)
	registries_SpecARMGenerator = gen.Struct(reflect.TypeOf(Registries_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRegistries_SpecARM(generators)
	AddRelatedPropertyGeneratorsForRegistries_SpecARM(generators)
	registries_SpecARMGenerator = gen.Struct(reflect.TypeOf(Registries_SpecARM{}), generators)

	return registries_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForRegistries_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRegistries_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/containerregistry/v1alpha1api20210901/registries_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForRegistries_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRegistries_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/containerregistry/v1alpha1api20210901/registries_spec_arm_types_gen_test.go
