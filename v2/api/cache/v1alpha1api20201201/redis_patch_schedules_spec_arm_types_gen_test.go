...
<<<<<<<< HEAD:v2/api/cache/v1alpha1api20201201/redis_patch_schedule__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/cache/v1alpha1api20201201/redis_patch_schedules_spec_arm_types_gen_test.go
	t.Parallel()
