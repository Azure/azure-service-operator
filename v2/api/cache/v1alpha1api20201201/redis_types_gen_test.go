...
// RunPropertyAssignmentTestForRedisResource_STATUS tests if a specific instance of RedisResource_STATUS can be assigned to v1alpha1api20201201storage and back losslessly
...
// RunPropertyAssignmentTestForPrivateEndpointConnection_STATUS_SubResourceEmbedded tests if a specific instance of PrivateEndpointConnection_STATUS_SubResourceEmbedded can be assigned to v1alpha1api20201201storage and back losslessly
