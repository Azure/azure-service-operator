...
// RunPropertyAssignmentTestForRedisCreateProperties_RedisConfiguration tests if a specific instance of RedisCreateProperties_RedisConfiguration can be assigned to v1alpha1api20201201storage and back losslessly
func RunPropertyAssignmentTestForRedisCreateProperties_RedisConfiguration(subject RedisCreateProperties_RedisConfiguration) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20201201s.RedisCreateProperties_RedisConfiguration
...
// RunPropertyAssignmentTestForRedisProperties_RedisConfiguration_STATUS tests if a specific instance of RedisProperties_RedisConfiguration_STATUS can be assigned to v1alpha1api20201201storage and back losslessly
func RunPropertyAssignmentTestForRedisProperties_RedisConfiguration_STATUS(subject RedisProperties_RedisConfiguration_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20201201s.RedisProperties_RedisConfiguration_STATUS
