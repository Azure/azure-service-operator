...
// RunPropertyAssignmentTestForRedisCreateParameters_STATUS tests if a specific instance of RedisCreateParameters_STATUS can be assigned to v1alpha1api20201201storage and back losslessly
func RunPropertyAssignmentTestForRedisCreateParameters_STATUS(subject RedisCreateParameters_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20201201s.RedisCreateParameters_STATUS
...
func RunPropertyAssignmentTestForRedisCreateProperties_RedisConfiguration_STATUS(subject RedisCreateProperties_RedisConfiguration_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20201201s.RedisCreateProperties_RedisConfiguration_STATUS
