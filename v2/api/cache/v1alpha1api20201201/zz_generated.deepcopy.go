...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RedisAccessKeys_STATUSARM) DeepCopyInto(out *RedisAccessKeys_STATUSARM) {
	*out = *in
	if in.PrimaryKey != nil {
		in, out := &in.PrimaryKey, &out.PrimaryKey
		*out = new(string)
...
func (in *RedisAccessKeys_STATUSARM) DeepCopy() *RedisAccessKeys_STATUSARM {
	if in == nil {
		return nil
	}
	out := new(RedisAccessKeys_STATUSARM)
	in.DeepCopyInto(out)
	return out
}
