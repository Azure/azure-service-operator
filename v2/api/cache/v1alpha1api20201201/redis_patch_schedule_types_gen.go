...
func (schedule *RedisPatchSchedule) AssignProperties_To_RedisPatchSchedule(destination *alpha20201201s.RedisPatchSchedule) error {
	...
	// Spec
	var spec alpha20201201s.Redis_PatchSchedule_Spec
	...
	// Status
	var status alpha20201201s.Redis_PatchSchedule_STATUS
...
=======
	...
	if schedule.Tags != nil {
		result.Tags = make(map[string]string, len(schedule.Tags))
		for key, value := range schedule.Tags {
...
=======
	...
	if typedInput.Tags != nil {
		schedule.Tags = make(map[string]string, len(typedInput.Tags))
...
func (schedule *Redis_PatchSchedule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20201201s.Redis_PatchSchedule_Spec)
	if ok {
	...
	src = &alpha20201201s.Redis_PatchSchedule_Spec{}
...
func (schedule *Redis_PatchSchedule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20201201s.Redis_PatchSchedule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &alpha20201201s.Redis_PatchSchedule_Spec{}
...
func (schedule *Redis_PatchSchedule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20201201s.Redis_PatchSchedule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20201201s.Redis_PatchSchedule_STATUS{}
...
func (schedule *Redis_PatchSchedule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20201201s.Redis_PatchSchedule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20201201s.Redis_PatchSchedule_STATUS{}
...
func (schedule *Redis_PatchSchedule_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &Redis_PatchSchedule_STATUSARM{}
}
...
func (schedule *Redis_PatchSchedule_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(Redis_PatchSchedule_STATUSARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected Redis_PatchSchedule_STATUSARM, got %T", armInput)
	}
