...
func Test_DatabaseCreateProperties_GeoReplication_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip from DatabaseCreateProperties_GeoReplication to DatabaseCreateProperties_GeoReplication via AssignProperties_To_DatabaseCreateProperties_GeoReplication & AssignProperties_From_DatabaseCreateProperties_GeoReplication returns original",
		prop.ForAll(RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication, DatabaseCreateProperties_GeoReplicationGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication tests if a specific instance of DatabaseCreateProperties_GeoReplication can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication(subject DatabaseCreateProperties_GeoReplication) string {
...
func Test_DatabaseCreateProperties_GeoReplication_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from DatabaseCreateProperties_GeoReplication_STATUS to DatabaseCreateProperties_GeoReplication_STATUS via AssignProperties_To_DatabaseCreateProperties_GeoReplication_STATUS & AssignProperties_From_DatabaseCreateProperties_GeoReplication_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication_STATUS, DatabaseCreateProperties_GeoReplication_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication_STATUS tests if a specific instance of DatabaseCreateProperties_GeoReplication_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForDatabaseCreateProperties_GeoReplication_STATUS(subject DatabaseCreateProperties_GeoReplication_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual DatabaseCreateProperties_GeoReplication_STATUS
...
func Test_DatabaseCreateProperties_GeoReplication_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DatabaseCreateProperties_GeoReplication_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDatabaseCreateProperties_GeoReplication_STATUS, DatabaseCreateProperties_GeoReplication_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDatabaseCreateProperties_GeoReplication_STATUS runs a test to see if a specific instance of DatabaseCreateProperties_GeoReplication_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForDatabaseCreateProperties_GeoReplication_STATUS(subject DatabaseCreateProperties_GeoReplication_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of DatabaseCreateProperties_GeoReplication_STATUS instances for property testing - lazily instantiated by
// DatabaseCreateProperties_GeoReplication_STATUSGenerator()
var databaseCreateProperties_GeoReplication_STATUSGenerator gopter.Gen

// DatabaseCreateProperties_GeoReplication_STATUSGenerator returns a generator of DatabaseCreateProperties_GeoReplication_STATUS instances for property testing.
// We first initialize databaseCreateProperties_GeoReplication_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func DatabaseCreateProperties_GeoReplication_STATUSGenerator() gopter.Gen {
	if databaseCreateProperties_GeoReplication_STATUSGenerator != nil {
		return databaseCreateProperties_GeoReplication_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS(generators)
	databaseCreateProperties_GeoReplication_STATUSGenerator = gen.Struct(reflect.TypeOf(DatabaseCreateProperties_GeoReplication_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS(generators)
	AddRelatedPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS(generators)
	databaseCreateProperties_GeoReplication_STATUSGenerator = gen.Struct(reflect.TypeOf(DatabaseCreateProperties_GeoReplication_STATUS{}), generators)

	return databaseCreateProperties_GeoReplication_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS(gens map[string]gopter.Gen) {
	gens["GroupNickname"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForDatabaseCreateProperties_GeoReplication_STATUS(gens map[string]gopter.Gen) {
...
func RunPropertyAssignmentTestForRedisEnterpriseDatabaseOperatorSecrets(subject RedisEnterpriseDatabaseOperatorSecrets) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.RedisEnterpriseDatabaseOperatorSecrets
...
func Test_RedisEnterpriseDatabase_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from RedisEnterpriseDatabase_STATUS to RedisEnterpriseDatabase_STATUS via AssignProperties_To_RedisEnterpriseDatabase_STATUS & AssignProperties_From_RedisEnterpriseDatabase_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForRedisEnterpriseDatabase_STATUS, RedisEnterpriseDatabase_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRedisEnterpriseDatabase_STATUS tests if a specific instance of RedisEnterpriseDatabase_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRedisEnterpriseDatabase_STATUS(subject RedisEnterpriseDatabase_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.RedisEnterpriseDatabase_STATUS
	...
	err = actual.AssignProperties_From_RedisEnterpriseDatabase_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForRedisEnterpriseDatabase_STATUS(gens map[string]gopter.Gen) {
	gens["AccessKeysAuthentication"] = gen.PtrOf(gen.OneConstOf(DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Disabled, DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Enabled))
	gens["ClientProtocol"] = gen.PtrOf(gen.OneConstOf(DatabaseCreateProperties_ClientProtocol_STATUS_Encrypted, DatabaseCreateProperties_ClientProtocol_STATUS_Plaintext))
	gens["ClusteringPolicy"] = gen.PtrOf(gen.OneConstOf(DatabaseCreateProperties_ClusteringPolicy_STATUS_EnterpriseCluster, DatabaseCreateProperties_ClusteringPolicy_STATUS_NoCluster, DatabaseCreateProperties_ClusteringPolicy_STATUS_OSSCluster))
	gens["DeferUpgrade"] = gen.PtrOf(gen.OneConstOf(DatabaseCreateProperties_DeferUpgrade_STATUS_Deferred, DatabaseCreateProperties_DeferUpgrade_STATUS_NotDeferred))
	gens["EvictionPolicy"] = gen.PtrOf(gen.OneConstOf(
		DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLFU,
		DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLRU,
		DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysRandom,
		DatabaseCreateProperties_EvictionPolicy_STATUS_NoEviction,
		DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLFU,
		DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLRU,
		DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileRandom,
		DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileTTL))
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
...
func AddRelatedPropertyGeneratorsForRedisEnterpriseDatabase_STATUS(gens map[string]gopter.Gen) {
	gens["GeoReplication"] = gen.PtrOf(DatabaseCreateProperties_GeoReplication_STATUSGenerator())
...
func Test_RedisEnterpriseDatabase_Spec_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from RedisEnterpriseDatabase_Spec to RedisEnterpriseDatabase_Spec via AssignProperties_To_RedisEnterpriseDatabase_Spec & AssignProperties_From_RedisEnterpriseDatabase_Spec returns original",
		prop.ForAll(RunPropertyAssignmentTestForRedisEnterpriseDatabase_Spec, RedisEnterpriseDatabase_SpecGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRedisEnterpriseDatabase_Spec tests if a specific instance of RedisEnterpriseDatabase_Spec can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRedisEnterpriseDatabase_Spec(subject RedisEnterpriseDatabase_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.RedisEnterpriseDatabase_Spec
	...
	err = actual.AssignProperties_From_RedisEnterpriseDatabase_Spec(&other)
	if err != nil {
		return err.Error()
	}
