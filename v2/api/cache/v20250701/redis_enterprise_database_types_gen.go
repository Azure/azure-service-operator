...
func (database *RedisEnterpriseDatabase_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if database.AccessKeysAuthentication != nil ||
		...
		database.Port != nil {
		result.Properties = &arm.DatabaseCreateProperties{}
	}
	if database.AccessKeysAuthentication != nil {
		var temp string
		temp = string(*database.AccessKeysAuthentication)
		accessKeysAuthentication := arm.DatabaseCreateProperties_AccessKeysAuthentication(temp)
	...
	if database.GeoReplication != nil {
		...
		geoReplication := *geoReplication_ARM.(*arm.DatabaseCreateProperties_GeoReplication)
...
func (database *RedisEnterpriseDatabase_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessKeysAuthentication != nil {
			...
			accessKeysAuthentication := DatabaseCreateProperties_AccessKeysAuthentication(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ClientProtocol != nil {
			...
			clientProtocol := DatabaseCreateProperties_ClientProtocol(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ClusteringPolicy != nil {
			...
			clusteringPolicy := DatabaseCreateProperties_ClusteringPolicy(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DeferUpgrade != nil {
			...
			deferUpgrade := DatabaseCreateProperties_DeferUpgrade(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.EvictionPolicy != nil {
			...
			evictionPolicy := DatabaseCreateProperties_EvictionPolicy(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.GeoReplication != nil {
			var geoReplication1 DatabaseCreateProperties_GeoReplication
...
func (database *RedisEnterpriseDatabase_Spec) AssignProperties_From_RedisEnterpriseDatabase_Spec(source *storage.RedisEnterpriseDatabase_Spec) error {
	...
	if source.AccessKeysAuthentication != nil {
		...
		accessKeysAuthenticationTemp := genruntime.ToEnum(accessKeysAuthentication, databaseCreateProperties_AccessKeysAuthentication_Values)
	...
	if source.ClientProtocol != nil {
		...
		clientProtocolTemp := genruntime.ToEnum(clientProtocol, databaseCreateProperties_ClientProtocol_Values)
	...
	if source.ClusteringPolicy != nil {
		...
		clusteringPolicyTemp := genruntime.ToEnum(clusteringPolicy, databaseCreateProperties_ClusteringPolicy_Values)
	...
	if source.DeferUpgrade != nil {
		...
		deferUpgradeTemp := genruntime.ToEnum(deferUpgrade, databaseCreateProperties_DeferUpgrade_Values)
	...
	if source.EvictionPolicy != nil {
		...
		evictionPolicyTemp := genruntime.ToEnum(evictionPolicy, databaseCreateProperties_EvictionPolicy_Values)
	...
	if source.GeoReplication != nil {
		var geoReplication DatabaseCreateProperties_GeoReplication
...
func (database *RedisEnterpriseDatabase_Spec) Initialize_From_RedisEnterpriseDatabase_STATUS(source *RedisEnterpriseDatabase_STATUS) error {
	...
	// AccessKeysAuthentication
	if source.AccessKeysAuthentication != nil {
		accessKeysAuthentication := genruntime.ToEnum(string(*source.AccessKeysAuthentication), databaseCreateProperties_AccessKeysAuthentication_Values)
		database.AccessKeysAuthentication = &accessKeysAuthentication
	} else {
		database.AccessKeysAuthentication = nil
	}
	...
	// ClientProtocol
	if source.ClientProtocol != nil {
		clientProtocol := genruntime.ToEnum(string(*source.ClientProtocol), databaseCreateProperties_ClientProtocol_Values)
		database.ClientProtocol = &clientProtocol
	} else {
		database.ClientProtocol = nil
	}
	...
	// ClusteringPolicy
	if source.ClusteringPolicy != nil {
		clusteringPolicy := genruntime.ToEnum(string(*source.ClusteringPolicy), databaseCreateProperties_ClusteringPolicy_Values)
		database.ClusteringPolicy = &clusteringPolicy
	} else {
		database.ClusteringPolicy = nil
	}
	...
	// DeferUpgrade
	if source.DeferUpgrade != nil {
		deferUpgrade := genruntime.ToEnum(string(*source.DeferUpgrade), databaseCreateProperties_DeferUpgrade_Values)
		database.DeferUpgrade = &deferUpgrade
	} else {
		database.DeferUpgrade = nil
	}
	...
	// EvictionPolicy
	if source.EvictionPolicy != nil {
		evictionPolicy := genruntime.ToEnum(string(*source.EvictionPolicy), databaseCreateProperties_EvictionPolicy_Values)
		database.EvictionPolicy = &evictionPolicy
	} else {
		database.EvictionPolicy = nil
	}
	...
	if source.GeoReplication != nil {
		var geoReplication DatabaseCreateProperties_GeoReplication
		err := geoReplication.Initialize_From_DatabaseCreateProperties_GeoReplication_STATUS(source.GeoReplication)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_DatabaseCreateProperties_GeoReplication_STATUS() to populate field GeoReplication")
		}
		database.GeoReplication = &geoReplication
	} else {
		database.GeoReplication = nil
...
type RedisEnterpriseDatabase_STATUS struct {
	// AccessKeysAuthentication: This property can be Enabled/Disabled to allow or deny access with the current access keys.
	// Can be updated even after database is created. Default is Disabled.
	AccessKeysAuthentication *DatabaseCreateProperties_AccessKeysAuthentication_STATUS `json:"accessKeysAuthentication,omitempty"`

	// ClientProtocol: Specifies whether redis clients can connect using TLS-encrypted or plaintext redis protocols. Default is
	// TLS-encrypted.
	ClientProtocol *DatabaseCreateProperties_ClientProtocol_STATUS `json:"clientProtocol,omitempty"`

	// ClusteringPolicy: Clustering policy - default is OSSCluster. This property can be updated only if the current value is
	// NoCluster. If the value is OSSCluster or EnterpriseCluster, it cannot be updated without deleting the database.
	ClusteringPolicy *DatabaseCreateProperties_ClusteringPolicy_STATUS `json:"clusteringPolicy,omitempty"`
	...
	// DeferUpgrade: Option to defer upgrade when newest version is released - default is NotDeferred. Learn more:
	// https://aka.ms/redisversionupgrade
	DeferUpgrade *DatabaseCreateProperties_DeferUpgrade_STATUS `json:"deferUpgrade,omitempty"`

	// EvictionPolicy: Redis eviction policy - default is VolatileLRU
	EvictionPolicy *DatabaseCreateProperties_EvictionPolicy_STATUS `json:"evictionPolicy,omitempty"`

	// GeoReplication: Optional set of properties to configure geo replication for this database.
	GeoReplication *DatabaseCreateProperties_GeoReplication_STATUS `json:"geoReplication,omitempty"`
...
func (database *RedisEnterpriseDatabase_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessKeysAuthentication != nil {
			var temp string
			temp = string(*typedInput.Properties.AccessKeysAuthentication)
			accessKeysAuthentication := DatabaseCreateProperties_AccessKeysAuthentication_STATUS(temp)
			database.AccessKeysAuthentication = &accessKeysAuthentication
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ClientProtocol != nil {
			var temp string
			temp = string(*typedInput.Properties.ClientProtocol)
			clientProtocol := DatabaseCreateProperties_ClientProtocol_STATUS(temp)
			database.ClientProtocol = &clientProtocol
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.ClusteringPolicy != nil {
			var temp string
			temp = string(*typedInput.Properties.ClusteringPolicy)
			clusteringPolicy := DatabaseCreateProperties_ClusteringPolicy_STATUS(temp)
			database.ClusteringPolicy = &clusteringPolicy
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DeferUpgrade != nil {
			var temp string
			temp = string(*typedInput.Properties.DeferUpgrade)
			deferUpgrade := DatabaseCreateProperties_DeferUpgrade_STATUS(temp)
			database.DeferUpgrade = &deferUpgrade
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.EvictionPolicy != nil {
			var temp string
			temp = string(*typedInput.Properties.EvictionPolicy)
			evictionPolicy := DatabaseCreateProperties_EvictionPolicy_STATUS(temp)
			database.EvictionPolicy = &evictionPolicy
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.GeoReplication != nil {
			var geoReplication1 DatabaseCreateProperties_GeoReplication_STATUS
			err := geoReplication1.PopulateFromARM(owner, *typedInput.Properties.GeoReplication)
			if err != nil {
				return err
			}
...
func (database *RedisEnterpriseDatabase_STATUS) AssignProperties_From_RedisEnterpriseDatabase_STATUS(source *storage.RedisEnterpriseDatabase_STATUS) error {
	...
	if source.AccessKeysAuthentication != nil {
		accessKeysAuthentication := *source.AccessKeysAuthentication
		accessKeysAuthenticationTemp := genruntime.ToEnum(accessKeysAuthentication, databaseCreateProperties_AccessKeysAuthentication_STATUS_Values)
		database.AccessKeysAuthentication = &accessKeysAuthenticationTemp
	} else {
		database.AccessKeysAuthentication = nil
	}
	...
	if source.ClientProtocol != nil {
		clientProtocol := *source.ClientProtocol
		clientProtocolTemp := genruntime.ToEnum(clientProtocol, databaseCreateProperties_ClientProtocol_STATUS_Values)
		database.ClientProtocol = &clientProtocolTemp
	} else {
		database.ClientProtocol = nil
	}
	...
	if source.ClusteringPolicy != nil {
		clusteringPolicy := *source.ClusteringPolicy
		clusteringPolicyTemp := genruntime.ToEnum(clusteringPolicy, databaseCreateProperties_ClusteringPolicy_STATUS_Values)
		database.ClusteringPolicy = &clusteringPolicyTemp
	} else {
		database.ClusteringPolicy = nil
	}
	...
	if source.DeferUpgrade != nil {
		deferUpgrade := *source.DeferUpgrade
		deferUpgradeTemp := genruntime.ToEnum(deferUpgrade, databaseCreateProperties_DeferUpgrade_STATUS_Values)
		database.DeferUpgrade = &deferUpgradeTemp
	} else {
		database.DeferUpgrade = nil
	}
	...
	if source.EvictionPolicy != nil {
		evictionPolicy := *source.EvictionPolicy
		evictionPolicyTemp := genruntime.ToEnum(evictionPolicy, databaseCreateProperties_EvictionPolicy_STATUS_Values)
		database.EvictionPolicy = &evictionPolicyTemp
	} else {
		database.EvictionPolicy = nil
	}
	...
	// GeoReplication
	if source.GeoReplication != nil {
		var geoReplication DatabaseCreateProperties_GeoReplication_STATUS
...
type DatabaseCreateProperties_AccessKeysAuthentication_STATUS string

const (
	DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Disabled = DatabaseCreateProperties_AccessKeysAuthentication_STATUS("Disabled")
	DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Enabled  = DatabaseCreateProperties_AccessKeysAuthentication_STATUS("Enabled")
)

// Mapping from string to DatabaseCreateProperties_AccessKeysAuthentication_STATUS
var databaseCreateProperties_AccessKeysAuthentication_STATUS_Values = map[string]DatabaseCreateProperties_AccessKeysAuthentication_STATUS{
	"disabled": DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Disabled,
	"enabled":  DatabaseCreateProperties_AccessKeysAuthentication_STATUS_Enabled,
}
...
type DatabaseCreateProperties_ClientProtocol_STATUS string

const (
	DatabaseCreateProperties_ClientProtocol_STATUS_Encrypted = DatabaseCreateProperties_ClientProtocol_STATUS("Encrypted")
	DatabaseCreateProperties_ClientProtocol_STATUS_Plaintext = DatabaseCreateProperties_ClientProtocol_STATUS("Plaintext")
)

// Mapping from string to DatabaseCreateProperties_ClientProtocol_STATUS
var databaseCreateProperties_ClientProtocol_STATUS_Values = map[string]DatabaseCreateProperties_ClientProtocol_STATUS{
	"encrypted": DatabaseCreateProperties_ClientProtocol_STATUS_Encrypted,
	"plaintext": DatabaseCreateProperties_ClientProtocol_STATUS_Plaintext,
}
...
type DatabaseCreateProperties_ClusteringPolicy_STATUS string

const (
	DatabaseCreateProperties_ClusteringPolicy_STATUS_EnterpriseCluster = DatabaseCreateProperties_ClusteringPolicy_STATUS("EnterpriseCluster")
	DatabaseCreateProperties_ClusteringPolicy_STATUS_NoCluster         = DatabaseCreateProperties_ClusteringPolicy_STATUS("NoCluster")
	DatabaseCreateProperties_ClusteringPolicy_STATUS_OSSCluster        = DatabaseCreateProperties_ClusteringPolicy_STATUS("OSSCluster")
)

// Mapping from string to DatabaseCreateProperties_ClusteringPolicy_STATUS
var databaseCreateProperties_ClusteringPolicy_STATUS_Values = map[string]DatabaseCreateProperties_ClusteringPolicy_STATUS{
	"enterprisecluster": DatabaseCreateProperties_ClusteringPolicy_STATUS_EnterpriseCluster,
	"nocluster":         DatabaseCreateProperties_ClusteringPolicy_STATUS_NoCluster,
	"osscluster":        DatabaseCreateProperties_ClusteringPolicy_STATUS_OSSCluster,
}
...
type DatabaseCreateProperties_DeferUpgrade_STATUS string

const (
	DatabaseCreateProperties_DeferUpgrade_STATUS_Deferred    = DatabaseCreateProperties_DeferUpgrade_STATUS("Deferred")
	DatabaseCreateProperties_DeferUpgrade_STATUS_NotDeferred = DatabaseCreateProperties_DeferUpgrade_STATUS("NotDeferred")
)

// Mapping from string to DatabaseCreateProperties_DeferUpgrade_STATUS
var databaseCreateProperties_DeferUpgrade_STATUS_Values = map[string]DatabaseCreateProperties_DeferUpgrade_STATUS{
	"deferred":    DatabaseCreateProperties_DeferUpgrade_STATUS_Deferred,
	"notdeferred": DatabaseCreateProperties_DeferUpgrade_STATUS_NotDeferred,
}
...
type DatabaseCreateProperties_EvictionPolicy_STATUS string

const (
	DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLFU     = DatabaseCreateProperties_EvictionPolicy_STATUS("AllKeysLFU")
	DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLRU     = DatabaseCreateProperties_EvictionPolicy_STATUS("AllKeysLRU")
	DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysRandom  = DatabaseCreateProperties_EvictionPolicy_STATUS("AllKeysRandom")
	DatabaseCreateProperties_EvictionPolicy_STATUS_NoEviction     = DatabaseCreateProperties_EvictionPolicy_STATUS("NoEviction")
	DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLFU    = DatabaseCreateProperties_EvictionPolicy_STATUS("VolatileLFU")
	DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLRU    = DatabaseCreateProperties_EvictionPolicy_STATUS("VolatileLRU")
	DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileRandom = DatabaseCreateProperties_EvictionPolicy_STATUS("VolatileRandom")
	DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileTTL    = DatabaseCreateProperties_EvictionPolicy_STATUS("VolatileTTL")
)

// Mapping from string to DatabaseCreateProperties_EvictionPolicy_STATUS
var databaseCreateProperties_EvictionPolicy_STATUS_Values = map[string]DatabaseCreateProperties_EvictionPolicy_STATUS{
	"allkeyslfu":     DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLFU,
	"allkeyslru":     DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysLRU,
	"allkeysrandom":  DatabaseCreateProperties_EvictionPolicy_STATUS_AllKeysRandom,
	"noeviction":     DatabaseCreateProperties_EvictionPolicy_STATUS_NoEviction,
	"volatilelfu":    DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLFU,
	"volatilelru":    DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileLRU,
	"volatilerandom": DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileRandom,
	"volatilettl":    DatabaseCreateProperties_EvictionPolicy_STATUS_VolatileTTL,
}
...
var _ genruntime.ARMTransformer = &DatabaseCreateProperties_GeoReplication{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (replication *DatabaseCreateProperties_GeoReplication) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if replication == nil {
		return nil, nil
	}
	result := &arm.DatabaseCreateProperties_GeoReplication{}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (replication *DatabaseCreateProperties_GeoReplication) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DatabaseCreateProperties_GeoReplication{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (replication *DatabaseCreateProperties_GeoReplication) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DatabaseCreateProperties_GeoReplication)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DatabaseCreateProperties_GeoReplication, got %T", armInput)
	}
...
// AssignProperties_From_DatabaseCreateProperties_GeoReplication populates our DatabaseCreateProperties_GeoReplication from the provided source DatabaseCreateProperties_GeoReplication
func (replication *DatabaseCreateProperties_GeoReplication) AssignProperties_From_DatabaseCreateProperties_GeoReplication(source *storage.DatabaseCreateProperties_GeoReplication) error {
...
// AssignProperties_To_DatabaseCreateProperties_GeoReplication populates the provided destination DatabaseCreateProperties_GeoReplication from our DatabaseCreateProperties_GeoReplication
func (replication *DatabaseCreateProperties_GeoReplication) AssignProperties_To_DatabaseCreateProperties_GeoReplication(destination *storage.DatabaseCreateProperties_GeoReplication) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Initialize_From_DatabaseCreateProperties_GeoReplication_STATUS populates our DatabaseCreateProperties_GeoReplication from the provided source DatabaseCreateProperties_GeoReplication_STATUS
func (replication *DatabaseCreateProperties_GeoReplication) Initialize_From_DatabaseCreateProperties_GeoReplication_STATUS(source *DatabaseCreateProperties_GeoReplication_STATUS) error {
...
type DatabaseCreateProperties_GeoReplication_STATUS struct {
	// GroupNickname: Name for the group of linked database resources
	GroupNickname *string `json:"groupNickname,omitempty"`
...
var _ genruntime.FromARMConverter = &DatabaseCreateProperties_GeoReplication_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (replication *DatabaseCreateProperties_GeoReplication_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.DatabaseCreateProperties_GeoReplication_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (replication *DatabaseCreateProperties_GeoReplication_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.DatabaseCreateProperties_GeoReplication_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.DatabaseCreateProperties_GeoReplication_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_DatabaseCreateProperties_GeoReplication_STATUS populates our DatabaseCreateProperties_GeoReplication_STATUS from the provided source DatabaseCreateProperties_GeoReplication_STATUS
func (replication *DatabaseCreateProperties_GeoReplication_STATUS) AssignProperties_From_DatabaseCreateProperties_GeoReplication_STATUS(source *storage.DatabaseCreateProperties_GeoReplication_STATUS) error {
...
// AssignProperties_To_DatabaseCreateProperties_GeoReplication_STATUS populates the provided destination DatabaseCreateProperties_GeoReplication_STATUS from our DatabaseCreateProperties_GeoReplication_STATUS
func (replication *DatabaseCreateProperties_GeoReplication_STATUS) AssignProperties_To_DatabaseCreateProperties_GeoReplication_STATUS(destination *storage.DatabaseCreateProperties_GeoReplication_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
