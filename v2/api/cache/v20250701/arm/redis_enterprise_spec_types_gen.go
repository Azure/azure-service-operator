...
type ClusterCreateProperties struct {
	...
	Encryption *ClusterCreateProperties_Encryption `json:"encryption,omitempty"`
	...
	HighAvailability *ClusterCreateProperties_HighAvailability `json:"highAvailability,omitempty"`
	...
	MinimumTlsVersion *ClusterCreateProperties_MinimumTlsVersion `json:"minimumTlsVersion,omitempty"`
	...
	// cannot be set.
	PublicNetworkAccess *ClusterCreateProperties_PublicNetworkAccess `json:"publicNetworkAccess,omitempty"`
}
...
type ClusterCreateProperties_Encryption struct {
	...
	CustomerManagedKeyEncryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption `json:"customerManagedKeyEncryption,omitempty"`
}

// +kubebuilder:validation:Enum={"Disabled","Enabled"}
type ClusterCreateProperties_HighAvailability string

const (
	ClusterCreateProperties_HighAvailability_Disabled = ClusterCreateProperties_HighAvailability("Disabled")
	ClusterCreateProperties_HighAvailability_Enabled  = ClusterCreateProperties_HighAvailability("Enabled")
)

// Mapping from string to ClusterCreateProperties_HighAvailability
var clusterCreateProperties_HighAvailability_Values = map[string]ClusterCreateProperties_HighAvailability{
	"disabled": ClusterCreateProperties_HighAvailability_Disabled,
	"enabled":  ClusterCreateProperties_HighAvailability_Enabled,
}

// +kubebuilder:validation:Enum={"1.0","1.1","1.2"}
type ClusterCreateProperties_MinimumTlsVersion string

const (
	ClusterCreateProperties_MinimumTlsVersion_10 = ClusterCreateProperties_MinimumTlsVersion("1.0")
	ClusterCreateProperties_MinimumTlsVersion_11 = ClusterCreateProperties_MinimumTlsVersion("1.1")
	ClusterCreateProperties_MinimumTlsVersion_12 = ClusterCreateProperties_MinimumTlsVersion("1.2")
)

// Mapping from string to ClusterCreateProperties_MinimumTlsVersion
var clusterCreateProperties_MinimumTlsVersion_Values = map[string]ClusterCreateProperties_MinimumTlsVersion{
	"1.0": ClusterCreateProperties_MinimumTlsVersion_10,
	"1.1": ClusterCreateProperties_MinimumTlsVersion_11,
	"1.2": ClusterCreateProperties_MinimumTlsVersion_12,
}

// +kubebuilder:validation:Enum={"Disabled","Enabled"}
type ClusterCreateProperties_PublicNetworkAccess string

const (
	ClusterCreateProperties_PublicNetworkAccess_Disabled = ClusterCreateProperties_PublicNetworkAccess("Disabled")
	ClusterCreateProperties_PublicNetworkAccess_Enabled  = ClusterCreateProperties_PublicNetworkAccess("Enabled")
)

// Mapping from string to ClusterCreateProperties_PublicNetworkAccess
var clusterCreateProperties_PublicNetworkAccess_Values = map[string]ClusterCreateProperties_PublicNetworkAccess{
	"disabled": ClusterCreateProperties_PublicNetworkAccess_Disabled,
	"enabled":  ClusterCreateProperties_PublicNetworkAccess_Enabled,
}
...
type ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption struct {
	...
	KeyEncryptionKeyIdentity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity `json:"keyEncryptionKeyIdentity,omitempty"`
...
type ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity struct {
	// IdentityType: Only userAssignedIdentity is supported in this API version; other types may be supported in the future
	IdentityType *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType `json:"identityType,omitempty"`
...
type ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType string

const (
	ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_SystemAssignedIdentity = ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType("systemAssignedIdentity")
	ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_UserAssignedIdentity   = ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType("userAssignedIdentity")
)

// Mapping from string to ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType
var clusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_Values = map[string]ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType{
	"systemassignedidentity": ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_SystemAssignedIdentity,
	"userassignedidentity":   ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_UserAssignedIdentity,
}
