...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/cache/v20250701/arm"
...
func (enterprise *RedisEnterprise_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if enterprise.Encryption != nil ||
		...
		enterprise.PublicNetworkAccess != nil {
		result.Properties = &arm.ClusterCreateProperties{}
	}
	if enterprise.Encryption != nil {
		...
		encryption := *encryption_ARM.(*arm.ClusterCreateProperties_Encryption)
		result.Properties.Encryption = &encryption
	}
	if enterprise.HighAvailability != nil {
		var temp string
		temp = string(*enterprise.HighAvailability)
		highAvailability := arm.ClusterCreateProperties_HighAvailability(temp)
	...
	if enterprise.MinimumTlsVersion != nil {
		...
		minimumTlsVersion := arm.ClusterCreateProperties_MinimumTlsVersion(temp)
		result.Properties.MinimumTlsVersion = &minimumTlsVersion
	}
	if enterprise.PublicNetworkAccess != nil {
		var temp string
		temp = string(*enterprise.PublicNetworkAccess)
		publicNetworkAccess := arm.ClusterCreateProperties_PublicNetworkAccess(temp)
...
func (enterprise *RedisEnterprise_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.Encryption != nil {
			var encryption1 ClusterCreateProperties_Encryption
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.HighAvailability != nil {
			...
			highAvailability := ClusterCreateProperties_HighAvailability(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersion != nil {
			...
			minimumTlsVersion := ClusterCreateProperties_MinimumTlsVersion(temp)
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccess != nil {
			...
			publicNetworkAccess := ClusterCreateProperties_PublicNetworkAccess(temp)
			enterprise.PublicNetworkAccess = &publicNetworkAccess
		}
	}
...
func (enterprise *RedisEnterprise_Spec) AssignProperties_From_RedisEnterprise_Spec(source *storage.RedisEnterprise_Spec) error {
	...
	if source.Encryption != nil {
		var encryption ClusterCreateProperties_Encryption
	...
	if source.HighAvailability != nil {
		...
		highAvailabilityTemp := genruntime.ToEnum(highAvailability, clusterCreateProperties_HighAvailability_Values)
	...
	if source.MinimumTlsVersion != nil {
		...
		minimumTlsVersionTemp := genruntime.ToEnum(minimumTlsVersion, clusterCreateProperties_MinimumTlsVersion_Values)
	...
	if source.PublicNetworkAccess != nil {
		...
		publicNetworkAccessTemp := genruntime.ToEnum(publicNetworkAccess, clusterCreateProperties_PublicNetworkAccess_Values)
		enterprise.PublicNetworkAccess = &publicNetworkAccessTemp
	} else {
		enterprise.PublicNetworkAccess = nil
	}
...
func (enterprise *RedisEnterprise_Spec) AssignProperties_To_RedisEnterprise_Spec(destination *storage.RedisEnterprise_Spec) error {
	...
	// PublicNetworkAccess
	if enterprise.PublicNetworkAccess != nil {
		publicNetworkAccess := string(*enterprise.PublicNetworkAccess)
...
func (enterprise *RedisEnterprise_Spec) Initialize_From_RedisEnterprise_STATUS(source *RedisEnterprise_STATUS) error {
	...
	if source.Encryption != nil {
		var encryption ClusterCreateProperties_Encryption
		err := encryption.Initialize_From_ClusterCreateProperties_Encryption_STATUS(source.Encryption)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ClusterCreateProperties_Encryption_STATUS() to populate field Encryption")
		}
		enterprise.Encryption = &encryption
	} else {
		enterprise.Encryption = nil
	...
	// HighAvailability
	if source.HighAvailability != nil {
		highAvailability := genruntime.ToEnum(string(*source.HighAvailability), clusterCreateProperties_HighAvailability_Values)
		enterprise.HighAvailability = &highAvailability
	} else {
		enterprise.HighAvailability = nil
	}
	...
	// MinimumTlsVersion
	if source.MinimumTlsVersion != nil {
		minimumTlsVersion := genruntime.ToEnum(string(*source.MinimumTlsVersion), clusterCreateProperties_MinimumTlsVersion_Values)
		enterprise.MinimumTlsVersion = &minimumTlsVersion
	} else {
		enterprise.MinimumTlsVersion = nil
	}
	...
	// PublicNetworkAccess
	if source.PublicNetworkAccess != nil {
		publicNetworkAccess := genruntime.ToEnum(string(*source.PublicNetworkAccess), clusterCreateProperties_PublicNetworkAccess_Values)
		enterprise.PublicNetworkAccess = &publicNetworkAccess
	} else {
		enterprise.PublicNetworkAccess = nil
	}
...
func (enterprise *RedisEnterprise_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.Encryption != nil {
			var encryption1 ClusterCreateProperties_Encryption_STATUS
			err := encryption1.PopulateFromARM(owner, *typedInput.Properties.Encryption)
			if err != nil {
				return err
			}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.HighAvailability != nil {
			var temp string
			temp = string(*typedInput.Properties.HighAvailability)
			highAvailability := ClusterCreateProperties_HighAvailability_STATUS(temp)
			enterprise.HighAvailability = &highAvailability
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.MinimumTlsVersion != nil {
			var temp string
			temp = string(*typedInput.Properties.MinimumTlsVersion)
			minimumTlsVersion := ClusterCreateProperties_MinimumTlsVersion_STATUS(temp)
			enterprise.MinimumTlsVersion = &minimumTlsVersion
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.PublicNetworkAccess != nil {
			var temp string
			temp = string(*typedInput.Properties.PublicNetworkAccess)
			publicNetworkAccess := ClusterCreateProperties_PublicNetworkAccess_STATUS(temp)
			enterprise.PublicNetworkAccess = &publicNetworkAccess
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.RedundancyMode != nil {
			...
			redundancyMode := ClusterCreateProperties_RedundancyMode_STATUS(temp)
...
func (enterprise *RedisEnterprise_STATUS) AssignProperties_From_RedisEnterprise_STATUS(source *storage.RedisEnterprise_STATUS) error {
	...
	// Encryption
	if source.Encryption != nil {
		var encryption ClusterCreateProperties_Encryption_STATUS
	...
	if source.HighAvailability != nil {
		highAvailability := *source.HighAvailability
		highAvailabilityTemp := genruntime.ToEnum(highAvailability, clusterCreateProperties_HighAvailability_STATUS_Values)
		enterprise.HighAvailability = &highAvailabilityTemp
	} else {
		enterprise.HighAvailability = nil
	}
	...
	if source.MinimumTlsVersion != nil {
		minimumTlsVersion := *source.MinimumTlsVersion
		minimumTlsVersionTemp := genruntime.ToEnum(minimumTlsVersion, clusterCreateProperties_MinimumTlsVersion_STATUS_Values)
		enterprise.MinimumTlsVersion = &minimumTlsVersionTemp
	} else {
		enterprise.MinimumTlsVersion = nil
	}
	...
	if source.PublicNetworkAccess != nil {
		publicNetworkAccess := *source.PublicNetworkAccess
		publicNetworkAccessTemp := genruntime.ToEnum(publicNetworkAccess, clusterCreateProperties_PublicNetworkAccess_STATUS_Values)
		enterprise.PublicNetworkAccess = &publicNetworkAccessTemp
	} else {
		enterprise.PublicNetworkAccess = nil
	}
	...
	if source.RedundancyMode != nil {
		...
		redundancyModeTemp := genruntime.ToEnum(redundancyMode, clusterCreateProperties_RedundancyMode_STATUS_Values)
...
var _ genruntime.ARMTransformer = &ClusterCreateProperties_Encryption{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (encryption *ClusterCreateProperties_Encryption) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if encryption == nil {
		return nil, nil
	}
	result := &arm.ClusterCreateProperties_Encryption{}
	...
	if encryption.CustomerManagedKeyEncryption != nil {
		...
		customerManagedKeyEncryption := *customerManagedKeyEncryption_ARM.(*arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (encryption *ClusterCreateProperties_Encryption) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (encryption *ClusterCreateProperties_Encryption) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption, got %T", armInput)
	}

	// Set property "CustomerManagedKeyEncryption":
	if typedInput.CustomerManagedKeyEncryption != nil {
		var customerManagedKeyEncryption1 ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption
...
// AssignProperties_From_ClusterCreateProperties_Encryption populates our ClusterCreateProperties_Encryption from the provided source ClusterCreateProperties_Encryption
func (encryption *ClusterCreateProperties_Encryption) AssignProperties_From_ClusterCreateProperties_Encryption(source *storage.ClusterCreateProperties_Encryption) error {

	// CustomerManagedKeyEncryption
	if source.CustomerManagedKeyEncryption != nil {
		var customerManagedKeyEncryption ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption
...
// AssignProperties_To_ClusterCreateProperties_Encryption populates the provided destination ClusterCreateProperties_Encryption from our ClusterCreateProperties_Encryption
func (encryption *ClusterCreateProperties_Encryption) AssignProperties_To_ClusterCreateProperties_Encryption(destination *storage.ClusterCreateProperties_Encryption) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Initialize_From_ClusterCreateProperties_Encryption_STATUS populates our ClusterCreateProperties_Encryption from the provided source ClusterCreateProperties_Encryption_STATUS
func (encryption *ClusterCreateProperties_Encryption) Initialize_From_ClusterCreateProperties_Encryption_STATUS(source *ClusterCreateProperties_Encryption_STATUS) error {

	// CustomerManagedKeyEncryption
	if source.CustomerManagedKeyEncryption != nil {
		var customerManagedKeyEncryption ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption
		err := customerManagedKeyEncryption.Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS(source.CustomerManagedKeyEncryption)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS() to populate field CustomerManagedKeyEncryption")
		}
		encryption.CustomerManagedKeyEncryption = &customerManagedKeyEncryption
	} else {
		encryption.CustomerManagedKeyEncryption = nil
...
var _ genruntime.FromARMConverter = &ClusterCreateProperties_Encryption_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (encryption *ClusterCreateProperties_Encryption_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (encryption *ClusterCreateProperties_Encryption_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption_STATUS, got %T", armInput)
	}

	// Set property "CustomerManagedKeyEncryption":
	if typedInput.CustomerManagedKeyEncryption != nil {
		var customerManagedKeyEncryption1 ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS
		err := customerManagedKeyEncryption1.PopulateFromARM(owner, *typedInput.CustomerManagedKeyEncryption)
		if err != nil {
			return err
		}
...
// AssignProperties_From_ClusterCreateProperties_Encryption_STATUS populates our ClusterCreateProperties_Encryption_STATUS from the provided source ClusterCreateProperties_Encryption_STATUS
func (encryption *ClusterCreateProperties_Encryption_STATUS) AssignProperties_From_ClusterCreateProperties_Encryption_STATUS(source *storage.ClusterCreateProperties_Encryption_STATUS) error {

	// CustomerManagedKeyEncryption
	if source.CustomerManagedKeyEncryption != nil {
		var customerManagedKeyEncryption ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS
...
// AssignProperties_To_ClusterCreateProperties_Encryption_STATUS populates the provided destination ClusterCreateProperties_Encryption_STATUS from our ClusterCreateProperties_Encryption_STATUS
func (encryption *ClusterCreateProperties_Encryption_STATUS) AssignProperties_To_ClusterCreateProperties_Encryption_STATUS(destination *storage.ClusterCreateProperties_Encryption_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
var _ genruntime.ARMTransformer = &ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if encryption == nil {
		return nil, nil
	}
	result := &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption{}
	...
	if encryption.KeyEncryptionKeyIdentity != nil {
		...
		keyEncryptionKeyIdentity := *keyEncryptionKeyIdentity_ARM.(*arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption, got %T", armInput)
	}

	// Set property "KeyEncryptionKeyIdentity":
	if typedInput.KeyEncryptionKeyIdentity != nil {
		var keyEncryptionKeyIdentity1 ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity
...
// AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption populates our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption from the provided source ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption(source *storage.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) error {

	// KeyEncryptionKeyIdentity
	if source.KeyEncryptionKeyIdentity != nil {
		var keyEncryptionKeyIdentity ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity
...
// AssignProperties_To_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption populates the provided destination ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption from our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) AssignProperties_To_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption(destination *storage.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS populates our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption from the provided source ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption) Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS(source *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) error {

	// KeyEncryptionKeyIdentity
	if source.KeyEncryptionKeyIdentity != nil {
		var keyEncryptionKeyIdentity ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity
		err := keyEncryptionKeyIdentity.Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS(source.KeyEncryptionKeyIdentity)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS() to populate field KeyEncryptionKeyIdentity")
		}
		encryption.KeyEncryptionKeyIdentity = &keyEncryptionKeyIdentity
	} else {
		encryption.KeyEncryptionKeyIdentity = nil
...
var _ genruntime.FromARMConverter = &ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS, got %T", armInput)
	}

	// Set property "KeyEncryptionKeyIdentity":
	if typedInput.KeyEncryptionKeyIdentity != nil {
		var keyEncryptionKeyIdentity1 ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS
		err := keyEncryptionKeyIdentity1.PopulateFromARM(owner, *typedInput.KeyEncryptionKeyIdentity)
		if err != nil {
			return err
		}
...
// AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS populates our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS from the provided source ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS(source *storage.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) error {

	// KeyEncryptionKeyIdentity
	if source.KeyEncryptionKeyIdentity != nil {
		var keyEncryptionKeyIdentity ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS
...
// AssignProperties_To_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS populates the provided destination ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS from our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS
func (encryption *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) AssignProperties_To_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS(destination *storage.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
var _ genruntime.ARMTransformer = &ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if identity == nil {
		return nil, nil
	}
	result := &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity{}

	// Set property "IdentityType":
	if identity.IdentityType != nil {
		var temp string
		temp = string(*identity.IdentityType)
		identityType := arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType(temp)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity, got %T", armInput)
	}
	...
	if typedInput.IdentityType != nil {
		...
		identityType := ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType(temp)
...
// Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS populates our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity from the provided source ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity) Initialize_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS(source *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS) error {

	// IdentityType
	if source.IdentityType != nil {
		identityType := genruntime.ToEnum(string(*source.IdentityType), clusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_Values)
		identity.IdentityType = &identityType
	} else {
		identity.IdentityType = nil
	}
...
var _ genruntime.FromARMConverter = &ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS, got %T", armInput)
	}
	...
	if typedInput.IdentityType != nil {
		var temp string
		temp = string(*typedInput.IdentityType)
		identityType := ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_STATUS(temp)
		identity.IdentityType = &identityType
	}
...
// AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS populates our ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS from the provided source ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS
func (identity *ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS) AssignProperties_From_ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS(source *storage.ClusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_STATUS) error {

	// IdentityType
	if source.IdentityType != nil {
		identityType := *source.IdentityType
		identityTypeTemp := genruntime.ToEnum(identityType, clusterCreateProperties_Encryption_CustomerManagedKeyEncryption_KeyEncryptionKeyIdentity_IdentityType_STATUS_Values)
		identity.IdentityType = &identityTypeTemp
	} else {
		identity.IdentityType = nil
	}
