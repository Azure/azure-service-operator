...
func (rule *RedisFirewallRule) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected cache/v20241101/storage/RedisFirewallRule but received %T instead", hub)
	}
...
// Storage version of v1api20241101.RedisFirewallRuleOperatorSpec
