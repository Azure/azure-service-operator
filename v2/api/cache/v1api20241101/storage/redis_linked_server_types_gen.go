...
// Storage version of v1api20241101.RedisLinkedServer
...
func (server *RedisLinkedServer) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected cache/v20241101/storage/RedisLinkedServer but received %T instead", hub)
	}
...
// Storage version of v1api20241101.RedisLinkedServerOperatorSpec
