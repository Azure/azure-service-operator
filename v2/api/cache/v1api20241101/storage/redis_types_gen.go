...
func (redis *Redis) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected cache/v20241101/storage/Redis but received %T instead", hub)
	}
...
func (redis *Redis_Spec) AssignProperties_From_Redis_Spec(source *storage.Redis_Spec) error {
	...
	redis.ZonalAllocationPolicy = genruntime.ClonePointerToString(source.ZonalAllocationPolicy)
...
func (redis *Redis_Spec) AssignProperties_To_Redis_Spec(destination *storage.Redis_Spec) error {
	...
	// ZonalAllocationPolicy
	destination.ZonalAllocationPolicy = genruntime.ClonePointerToString(redis.ZonalAllocationPolicy)
...
func (configuration *RedisCommonPropertiesRedisConfiguration) AssignProperties_From_RedisCommonPropertiesRedisConfiguration(source *storage.RedisCommonPropertiesRedisConfiguration) error {
	...
	// Invoke the augmentConversionForRedisCommonPropertiesRedisConfiguration interface (if implemented) to customize the conversion
	var configurationAsAny any = configuration
	if augmentedConfiguration, ok := configurationAsAny.(augmentConversionForRedisCommonPropertiesRedisConfiguration); ok {
...
func (configuration *RedisCommonPropertiesRedisConfiguration_STATUS) AssignProperties_From_RedisCommonPropertiesRedisConfiguration_STATUS(source *storage.RedisCommonPropertiesRedisConfiguration_STATUS) error {
	...
	// Invoke the augmentConversionForRedisCommonPropertiesRedisConfiguration_STATUS interface (if implemented) to customize the conversion
	var configurationAsAny any = configuration
	if augmentedConfiguration, ok := configurationAsAny.(augmentConversionForRedisCommonPropertiesRedisConfiguration_STATUS); ok {
		err := augmentedConfiguration.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForRedisCommonPropertiesRedisConfiguration interface {
...
type augmentConversionForRedisCommonPropertiesRedisConfiguration_STATUS interface {
