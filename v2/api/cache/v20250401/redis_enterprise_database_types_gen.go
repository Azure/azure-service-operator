...
func (database *RedisEnterpriseDatabase_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if database.AccessKeysAuthentication != nil ||
		database.ClientProtocol != nil ||
		database.ClusteringPolicy != nil ||
		database.DeferUpgrade != nil ||
	...
	if database.AccessKeysAuthentication != nil {
		var temp string
		temp = string(*database.AccessKeysAuthentication)
		accessKeysAuthentication := arm.DatabaseProperties_AccessKeysAuthentication(temp)
		result.Properties.AccessKeysAuthentication = &accessKeysAuthentication
	}
	...
	if database.DeferUpgrade != nil {
		var temp string
		temp = string(*database.DeferUpgrade)
		deferUpgrade := arm.DatabaseProperties_DeferUpgrade(temp)
		result.Properties.DeferUpgrade = &deferUpgrade
	}
...
func (database *RedisEnterpriseDatabase_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "AccessKeysAuthentication":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessKeysAuthentication != nil {
			var temp string
			temp = string(*typedInput.Properties.AccessKeysAuthentication)
			accessKeysAuthentication := DatabaseProperties_AccessKeysAuthentication(temp)
			database.AccessKeysAuthentication = &accessKeysAuthentication
		}
	}
	...
	// Set property "DeferUpgrade":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.DeferUpgrade != nil {
			var temp string
			temp = string(*typedInput.Properties.DeferUpgrade)
			deferUpgrade := DatabaseProperties_DeferUpgrade(temp)
			database.DeferUpgrade = &deferUpgrade
		}
	}
...
func (database *RedisEnterpriseDatabase_Spec) AssignProperties_From_RedisEnterpriseDatabase_Spec(source *storage.RedisEnterpriseDatabase_Spec) error {
	...
	if source.AccessKeysAuthentication != nil {
		accessKeysAuthentication := *source.AccessKeysAuthentication
		accessKeysAuthenticationTemp := genruntime.ToEnum(accessKeysAuthentication, databaseProperties_AccessKeysAuthentication_Values)
		database.AccessKeysAuthentication = &accessKeysAuthenticationTemp
	} else {
		database.AccessKeysAuthentication = nil
	}
	...
	if source.DeferUpgrade != nil {
		deferUpgrade := *source.DeferUpgrade
		deferUpgradeTemp := genruntime.ToEnum(deferUpgrade, databaseProperties_DeferUpgrade_Values)
		database.DeferUpgrade = &deferUpgradeTemp
	} else {
		database.DeferUpgrade = nil
	}
...
func (database *RedisEnterpriseDatabase_Spec) AssignProperties_To_RedisEnterpriseDatabase_Spec(destination *storage.RedisEnterpriseDatabase_Spec) error {
	...
	// AccessKeysAuthentication
	if database.AccessKeysAuthentication != nil {
		accessKeysAuthentication := string(*database.AccessKeysAuthentication)
	...
	// DeferUpgrade
	if database.DeferUpgrade != nil {
		deferUpgrade := string(*database.DeferUpgrade)
...
func (database *RedisEnterpriseDatabase_Spec) Initialize_From_RedisEnterpriseDatabase_STATUS(source *RedisEnterpriseDatabase_STATUS) error {
	...
	// AccessKeysAuthentication
	if source.AccessKeysAuthentication != nil {
		accessKeysAuthentication := genruntime.ToEnum(string(*source.AccessKeysAuthentication), databaseProperties_AccessKeysAuthentication_Values)
		database.AccessKeysAuthentication = &accessKeysAuthentication
	} else {
		database.AccessKeysAuthentication = nil
	}
	...
	// DeferUpgrade
	if source.DeferUpgrade != nil {
		deferUpgrade := genruntime.ToEnum(string(*source.DeferUpgrade), databaseProperties_DeferUpgrade_Values)
		database.DeferUpgrade = &deferUpgrade
	} else {
		database.DeferUpgrade = nil
	}
...
func (database *RedisEnterpriseDatabase_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.AccessKeysAuthentication != nil {
			var temp string
			temp = string(*typedInput.Properties.AccessKeysAuthentication)
			accessKeysAuthentication := DatabaseProperties_AccessKeysAuthentication_STATUS(temp)
			database.AccessKeysAuthentication = &accessKeysAuthentication
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.DeferUpgrade != nil {
			var temp string
			temp = string(*typedInput.Properties.DeferUpgrade)
			deferUpgrade := DatabaseProperties_DeferUpgrade_STATUS(temp)
			database.DeferUpgrade = &deferUpgrade
		}
	}
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.RedisVersion != nil {
			...
			database.RedisVersion = &redisVersion
		}
	}
...
func (database *RedisEnterpriseDatabase_STATUS) AssignProperties_From_RedisEnterpriseDatabase_STATUS(source *storage.RedisEnterpriseDatabase_STATUS) error {
	...
	if source.AccessKeysAuthentication != nil {
		accessKeysAuthentication := *source.AccessKeysAuthentication
		accessKeysAuthenticationTemp := genruntime.ToEnum(accessKeysAuthentication, databaseProperties_AccessKeysAuthentication_STATUS_Values)
		database.AccessKeysAuthentication = &accessKeysAuthenticationTemp
	} else {
		database.AccessKeysAuthentication = nil
	}
	...
	if source.DeferUpgrade != nil {
		deferUpgrade := *source.DeferUpgrade
		deferUpgradeTemp := genruntime.ToEnum(deferUpgrade, databaseProperties_DeferUpgrade_STATUS_Values)
		database.DeferUpgrade = &deferUpgradeTemp
	} else {
		database.DeferUpgrade = nil
	}
	...
	// RedisVersion
	database.RedisVersion = genruntime.ClonePointerToString(source.RedisVersion)
...
func (database *RedisEnterpriseDatabase_STATUS) AssignProperties_To_RedisEnterpriseDatabase_STATUS(destination *storage.RedisEnterpriseDatabase_STATUS) error {
	...
	// RedisVersion
	destination.RedisVersion = genruntime.ClonePointerToString(database.RedisVersion)
...
// Mapping from string to DatabaseProperties_AccessKeysAuthentication
var databaseProperties_AccessKeysAuthentication_Values = map[string]DatabaseProperties_AccessKeysAuthentication{
	"disabled": DatabaseProperties_AccessKeysAuthentication_Disabled,
	"enabled":  DatabaseProperties_AccessKeysAuthentication_Enabled,
}
...
// Mapping from string to DatabaseProperties_AccessKeysAuthentication_STATUS
var databaseProperties_AccessKeysAuthentication_STATUS_Values = map[string]DatabaseProperties_AccessKeysAuthentication_STATUS{
	"disabled": DatabaseProperties_AccessKeysAuthentication_STATUS_Disabled,
	"enabled":  DatabaseProperties_AccessKeysAuthentication_STATUS_Enabled,
}
...
// Mapping from string to DatabaseProperties_DeferUpgrade
var databaseProperties_DeferUpgrade_Values = map[string]DatabaseProperties_DeferUpgrade{
	"deferred":    DatabaseProperties_DeferUpgrade_Deferred,
	"notdeferred": DatabaseProperties_DeferUpgrade_NotDeferred,
}
...
// Mapping from string to DatabaseProperties_DeferUpgrade_STATUS
var databaseProperties_DeferUpgrade_STATUS_Values = map[string]DatabaseProperties_DeferUpgrade_STATUS{
	"deferred":    DatabaseProperties_DeferUpgrade_STATUS_Deferred,
	"notdeferred": DatabaseProperties_DeferUpgrade_STATUS_NotDeferred,
}
