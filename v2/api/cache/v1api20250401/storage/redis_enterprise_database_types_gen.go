...
// Storage version of v1api20250401.RedisEnterpriseDatabase_Spec
type RedisEnterpriseDatabase_Spec struct {
	...
	DeferUpgrade     *string                              `json:"deferUpgrade,omitempty"`
...
func (database *RedisEnterpriseDatabase_Spec) AssignProperties_From_RedisEnterpriseDatabase_Spec(source *storage.RedisEnterpriseDatabase_Spec) error {
	...
	database.AccessKeysAuthentication = genruntime.ClonePointerToString(source.AccessKeysAuthentication)
	...
	// DeferUpgrade
	database.DeferUpgrade = genruntime.ClonePointerToString(source.DeferUpgrade)
...
func (database *RedisEnterpriseDatabase_Spec) AssignProperties_To_RedisEnterpriseDatabase_Spec(destination *storage.RedisEnterpriseDatabase_Spec) error {
	...
	// AccessKeysAuthentication
	destination.AccessKeysAuthentication = genruntime.ClonePointerToString(database.AccessKeysAuthentication)
	...
	// DeferUpgrade
	destination.DeferUpgrade = genruntime.ClonePointerToString(database.DeferUpgrade)
...
// Storage version of v1api20250401.RedisEnterpriseDatabase_STATUS
...
// Storage version of v1api20250401.DatabaseProperties_GeoReplication
...
// Storage version of v1api20250401.DatabaseProperties_GeoReplication_STATUS
