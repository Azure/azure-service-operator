...
// +kubebuilder:webhook:path=/mutate-cache-azure-com-v1api20230801-redis,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cache.azure.com,resources=redis,verbs=create;update,versions=v1api20230801,name=default.v1api20230801.redis.cache.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-cache-azure-com-v1api20230801-redis,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cache.azure.com,resources=redis,verbs=create;update,versions=v1api20230801,name=validate.v1api20230801.redis.cache.azure.com,admissionReviewVersions=v1
...
func (redis *Redis_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if redis.UpdateChannel != nil {
		...
		updateChannel := arm.RedisCreateProperties_UpdateChannel(temp)
...
func (redis *Redis_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.UpdateChannel != nil {
			...
			updateChannel := RedisCreateProperties_UpdateChannel(temp)
...
func (redis *Redis_Spec) AssignProperties_From_Redis_Spec(source *storage.Redis_Spec) error {
	...
	if source.UpdateChannel != nil {
		...
		updateChannelTemp := genruntime.ToEnum(updateChannel, redisCreateProperties_UpdateChannel_Values)
...
func (redis *Redis_Spec) Initialize_From_Redis_STATUS(source *Redis_STATUS) error {
	...
	if source.RedisConfiguration != nil {
		...
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_RedisProperties_RedisConfiguration_STATUS() to populate field RedisConfiguration")
		}
		redis.RedisConfiguration = &redisConfiguration
	} else {
		redis.RedisConfiguration = nil
	...
	// UpdateChannel
	if source.UpdateChannel != nil {
		updateChannel := genruntime.ToEnum(string(*source.UpdateChannel), redisCreateProperties_UpdateChannel_Values)
		redis.UpdateChannel = &updateChannel
	} else {
		redis.UpdateChannel = nil
	}
...
func (redis *Redis_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		if typedInput.Properties.UpdateChannel != nil {
			var temp string
			temp = string(*typedInput.Properties.UpdateChannel)
			updateChannel := RedisProperties_UpdateChannel_STATUS(temp)
			redis.UpdateChannel = &updateChannel
		}
	}
...
func (redis *Redis_STATUS) AssignProperties_From_Redis_STATUS(source *storage.Redis_STATUS) error {
	...
	if source.UpdateChannel != nil {
		updateChannel := *source.UpdateChannel
		updateChannelTemp := genruntime.ToEnum(updateChannel, redisProperties_UpdateChannel_STATUS_Values)
		redis.UpdateChannel = &updateChannelTemp
	} else {
		redis.UpdateChannel = nil
	}
