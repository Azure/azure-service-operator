...
// +kubebuilder:webhook:path=/mutate-cache-azure-com-v20210301-redisenterprise,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cache.azure.com,resources=redisenterprises,verbs=create;update,versions=v20210301,name=default.v20210301.redisenterprises.cache.azure.com,admissionReviewVersions=v1
...
func (enterprise *RedisEnterprise) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cache/v20210301/RedisEnterprise, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-cache-azure-com-v20210301-redisenterprise,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=cache.azure.com,resources=redisenterprises,verbs=create;update,versions=v20210301,name=validate.v20210301.redisenterprises.cache.azure.com,admissionReviewVersions=v1
...
func (enterprise *RedisEnterprise) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cache/v20210301/RedisEnterprise, but got %T", resource)
	}
...
func (enterprise *RedisEnterprise) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cache/v20210301/RedisEnterprise, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210301.RedisEnterprise)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/cache/v20210301/RedisEnterprise, but got %T", oldResource)
	}
