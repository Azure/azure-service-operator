...
<<<<<<<< HEAD:v2/api/cache/v1beta20201201/redis_linked_server_with_properties_statusarm_types_gen_test.go
...
>>>>>>>> main:v2/api/cache/v1beta20201201/redis_linked_server_with_properties_status_arm_types_gen_test.go
	// Serialize to JSON
