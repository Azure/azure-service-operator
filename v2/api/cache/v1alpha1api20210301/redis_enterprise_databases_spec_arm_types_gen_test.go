...
<<<<<<<< HEAD:v2/api/cache/v1alpha1api20210301/redis_enterprise_database__spec_arm_types_gen_test.go
func Test_RedisEnterpriseDatabase_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_RedisEnterprise_Databases_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/cache/v1alpha1api20210301/redis_enterprise_databases_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of RedisEnterprise_Databases_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRedisEnterprise_Databases_SpecARM, RedisEnterprise_Databases_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRedisEnterprise_Databases_SpecARM runs a test to see if a specific instance of RedisEnterprise_Databases_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRedisEnterprise_Databases_SpecARM(subject RedisEnterprise_Databases_SpecARM) string {
>>>>>>>> main:v2/api/cache/v1alpha1api20210301/redis_enterprise_databases_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual RedisEnterprise_Databases_SpecARM
>>>>>>>> main:v2/api/cache/v1alpha1api20210301/redis_enterprise_databases_spec_arm_types_gen_test.go
...
========
// Generator of RedisEnterprise_Databases_SpecARM instances for property testing - lazily instantiated by
// RedisEnterprise_Databases_SpecARMGenerator()
var redisEnterprise_Databases_SpecARMGenerator gopter.Gen

// RedisEnterprise_Databases_SpecARMGenerator returns a generator of RedisEnterprise_Databases_SpecARM instances for property testing.
// We first initialize redisEnterprise_Databases_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func RedisEnterprise_Databases_SpecARMGenerator() gopter.Gen {
	if redisEnterprise_Databases_SpecARMGenerator != nil {
		return redisEnterprise_Databases_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRedisEnterprise_Databases_SpecARM(generators)
	redisEnterprise_Databases_SpecARMGenerator = gen.Struct(reflect.TypeOf(RedisEnterprise_Databases_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRedisEnterprise_Databases_SpecARM(generators)
	AddRelatedPropertyGeneratorsForRedisEnterprise_Databases_SpecARM(generators)
	redisEnterprise_Databases_SpecARMGenerator = gen.Struct(reflect.TypeOf(RedisEnterprise_Databases_SpecARM{}), generators)

	return redisEnterprise_Databases_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForRedisEnterprise_Databases_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRedisEnterprise_Databases_SpecARM(gens map[string]gopter.Gen) {
...
========
// AddRelatedPropertyGeneratorsForRedisEnterprise_Databases_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRedisEnterprise_Databases_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/cache/v1alpha1api20210301/redis_enterprise_databases_spec_arm_types_gen_test.go
