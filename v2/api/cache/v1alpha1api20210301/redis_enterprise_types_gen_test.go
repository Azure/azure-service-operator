...
func RunPropertyAssignmentTestForRedisEnterprise(subject RedisEnterprise) string {
	...
	var other alpha20210301s.RedisEnterprise
...
func RunPropertyAssignmentTestForRedisEnterprise_Spec(subject RedisEnterprise_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210301s.RedisEnterprise_Spec
...
// RunPropertyAssignmentTestForRedisEnterprise_STATUS tests if a specific instance of RedisEnterprise_STATUS can be assigned to v1alpha1api20210301storage and back losslessly
func RunPropertyAssignmentTestForRedisEnterprise_STATUS(subject RedisEnterprise_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210301s.RedisEnterprise_STATUS
