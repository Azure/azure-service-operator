...
// RunPropertyAssignmentTestForPrivateEndpointConnection tests if a specific instance of PrivateEndpointConnection can be assigned to v1alpha1api20210301storage and back losslessly
func RunPropertyAssignmentTestForPrivateEndpointConnection(subject PrivateEndpointConnection) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210301s.PrivateEndpointConnection
