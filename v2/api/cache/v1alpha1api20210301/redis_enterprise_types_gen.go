...
func (enterprise *RedisEnterprise_STATUS) AssignProperties_From_RedisEnterprise_STATUS(source *alpha20210301s.RedisEnterprise_STATUS) error {
...
func (enterprise *RedisEnterprise_STATUS) AssignProperties_To_RedisEnterprise_STATUS(destination *alpha20210301s.RedisEnterprise_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
