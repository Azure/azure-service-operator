...
func Test_RedisEnterpriseDatabase_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of RedisEnterpriseDatabase_STATUSARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRedisEnterpriseDatabase_STATUSARM, RedisEnterpriseDatabase_STATUSARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRedisEnterpriseDatabase_STATUSARM runs a test to see if a specific instance of RedisEnterpriseDatabase_STATUSARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRedisEnterpriseDatabase_STATUSARM(subject RedisEnterpriseDatabase_STATUSARM) string {
	// Serialize to JSON
	...
	var actual RedisEnterpriseDatabase_STATUSARM
...
// Generator of RedisEnterpriseDatabase_STATUSARM instances for property testing - lazily instantiated by
// RedisEnterpriseDatabase_STATUSARMGenerator()
var redisEnterpriseDatabase_STATUSARMGenerator gopter.Gen

// RedisEnterpriseDatabase_STATUSARMGenerator returns a generator of RedisEnterpriseDatabase_STATUSARM instances for property testing.
// We first initialize redisEnterpriseDatabase_STATUSARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func RedisEnterpriseDatabase_STATUSARMGenerator() gopter.Gen {
	if redisEnterpriseDatabase_STATUSARMGenerator != nil {
		return redisEnterpriseDatabase_STATUSARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM(generators)
	redisEnterpriseDatabase_STATUSARMGenerator = gen.Struct(reflect.TypeOf(RedisEnterpriseDatabase_STATUSARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM(generators)
	AddRelatedPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM(generators)
	redisEnterpriseDatabase_STATUSARMGenerator = gen.Struct(reflect.TypeOf(RedisEnterpriseDatabase_STATUSARM{}), generators)

	return redisEnterpriseDatabase_STATUSARMGenerator
}

// AddIndependentPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRedisEnterpriseDatabase_STATUSARM(gens map[string]gopter.Gen) {
