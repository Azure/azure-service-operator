...
type ManagementPolicyBaseBlob_STATUS_ARM struct {
	...
	TierToCold *DateAfterModification_STATUS_ARM `json:"tierToCold"`
	...
	// Accounts
	TierToHot *DateAfterModification_STATUS_ARM `json:"tierToHot"`
}
...
type ManagementPolicySnapShot_STATUS_ARM struct {
	...
	// TierToCold: The function to tier blobs to cold storage.
	TierToCold *DateAfterCreation_STATUS_ARM `json:"tierToCold"`
	...
	// TierToHot: The function to tier blobs to hot storage. This action can only be used with Premium Block Blob Storage
	// Accounts
	TierToHot *DateAfterCreation_STATUS_ARM `json:"tierToHot"`
}
...
type DateAfterCreation_STATUS_ARM struct {
	...
	DaysAfterLastTierChangeGreaterThan *float64 `json:"daysAfterLastTierChangeGreaterThan"`
}
