...
type ContainerProperties_STATUS_ARM struct {
	...
	EnableNfsV3AllSquash *bool `json:"enableNfsV3AllSquash"`

	// EnableNfsV3RootSquash: Enable NFSv3 root squash on blob container.
	EnableNfsV3RootSquash *bool `json:"enableNfsV3RootSquash"`
...
type LegalHoldProperties_STATUS_ARM struct {
	...
	ProtectedAppendWritesHistory *ProtectedAppendWritesHistory_STATUS_ARM `json:"protectedAppendWritesHistory"`
