...
func AddRelatedPropertyGeneratorsForStorageAccountPropertiesCreateParameters_ARM(gens map[string]gopter.Gen) {
	...
	gens["ImmutableStorageWithVersioning"] = gen.PtrOf(ImmutableStorageAccount_ARMGenerator())
...
func Test_ImmutableStorageAccount_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ImmutableStorageAccount_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForImmutableStorageAccount_ARM, ImmutableStorageAccount_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForImmutableStorageAccount_ARM runs a test to see if a specific instance of ImmutableStorageAccount_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForImmutableStorageAccount_ARM(subject ImmutableStorageAccount_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ImmutableStorageAccount_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ImmutableStorageAccount_ARM instances for property testing - lazily instantiated by
// ImmutableStorageAccount_ARMGenerator()
var immutableStorageAccount_ARMGenerator gopter.Gen

// ImmutableStorageAccount_ARMGenerator returns a generator of ImmutableStorageAccount_ARM instances for property testing.
// We first initialize immutableStorageAccount_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func ImmutableStorageAccount_ARMGenerator() gopter.Gen {
	if immutableStorageAccount_ARMGenerator != nil {
		return immutableStorageAccount_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImmutableStorageAccount_ARM(generators)
	immutableStorageAccount_ARMGenerator = gen.Struct(reflect.TypeOf(ImmutableStorageAccount_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImmutableStorageAccount_ARM(generators)
	AddRelatedPropertyGeneratorsForImmutableStorageAccount_ARM(generators)
	immutableStorageAccount_ARMGenerator = gen.Struct(reflect.TypeOf(ImmutableStorageAccount_ARM{}), generators)

	return immutableStorageAccount_ARMGenerator
}

// AddIndependentPropertyGeneratorsForImmutableStorageAccount_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForImmutableStorageAccount_ARM(gens map[string]gopter.Gen) {
	gens["Enabled"] = gen.PtrOf(gen.Bool())
}

// AddRelatedPropertyGeneratorsForImmutableStorageAccount_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForImmutableStorageAccount_ARM(gens map[string]gopter.Gen) {
	gens["ImmutabilityPolicy"] = gen.PtrOf(AccountImmutabilityPolicyProperties_ARMGenerator())
}
...
func Test_AccountImmutabilityPolicyProperties_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of AccountImmutabilityPolicyProperties_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForAccountImmutabilityPolicyProperties_ARM, AccountImmutabilityPolicyProperties_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForAccountImmutabilityPolicyProperties_ARM runs a test to see if a specific instance of AccountImmutabilityPolicyProperties_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForAccountImmutabilityPolicyProperties_ARM(subject AccountImmutabilityPolicyProperties_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual AccountImmutabilityPolicyProperties_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of AccountImmutabilityPolicyProperties_ARM instances for property testing - lazily instantiated by
// AccountImmutabilityPolicyProperties_ARMGenerator()
var accountImmutabilityPolicyProperties_ARMGenerator gopter.Gen

// AccountImmutabilityPolicyProperties_ARMGenerator returns a generator of AccountImmutabilityPolicyProperties_ARM instances for property testing.
func AccountImmutabilityPolicyProperties_ARMGenerator() gopter.Gen {
	if accountImmutabilityPolicyProperties_ARMGenerator != nil {
		return accountImmutabilityPolicyProperties_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAccountImmutabilityPolicyProperties_ARM(generators)
	accountImmutabilityPolicyProperties_ARMGenerator = gen.Struct(reflect.TypeOf(AccountImmutabilityPolicyProperties_ARM{}), generators)

	return accountImmutabilityPolicyProperties_ARMGenerator
}

// AddIndependentPropertyGeneratorsForAccountImmutabilityPolicyProperties_ARM is a factory method for creating gopter generators
