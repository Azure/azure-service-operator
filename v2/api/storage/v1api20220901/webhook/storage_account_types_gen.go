...
func (account *StorageAccount) Default(ctx context.Context, obj runtime.Object) error {
	resource, ok := obj.(*v20220901.StorageAccount)
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v1api20220901/StorageAccount, but got %T", obj)
	}
...
func (account *StorageAccount) defaultAzureName(ctx context.Context, obj *v20220901.StorageAccount) error {
...
func (account *StorageAccount) defaultImpl(ctx context.Context, obj *v20220901.StorageAccount) error {
...
func (account *StorageAccount) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	obj, ok := resource.(*v20220901.StorageAccount)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v1api20220901/StorageAccount, but got %T", resource)
	}
	validations := account.createValidations()
	var temp any = account
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20220901.StorageAccount]); ok {
...
func (account *StorageAccount) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	newObj, ok := newResource.(*v20220901.StorageAccount)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v1api20220901/StorageAccount, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20220901.StorageAccount)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/storage/v1api20220901/StorageAccount, but got %T", oldResource)
	}
...
func (account *StorageAccount) deleteValidations() []func(ctx context.Context, obj *v20220901.StorageAccount) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (account *StorageAccount) updateValidations() []func(ctx context.Context, oldObj *v20220901.StorageAccount, newObj *v20220901.StorageAccount) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20220901.StorageAccount, newObj *v20220901.StorageAccount) (admission.Warnings, error){
...
func (account *StorageAccount) validateConfigMapDestinations(ctx context.Context, obj *v20220901.StorageAccount) (admission.Warnings, error) {
...
func (account *StorageAccount) validateOwnerReference(ctx context.Context, obj *v20220901.StorageAccount) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (account *StorageAccount) validateResourceReferences(ctx context.Context, obj *v20220901.StorageAccount) (admission.Warnings, error) {
...
func (account *StorageAccount) validateSecretDestinations(ctx context.Context, obj *v20220901.StorageAccount) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (account *StorageAccount) validateWriteOnceProperties(ctx context.Context, oldObj *v20220901.StorageAccount, newObj *v20220901.StorageAccount) (admission.Warnings, error) {
