...
<<<<<<<< HEAD:v2/api/storage/v1beta20210401/storage_accounts_queue_services_queue_statusarm_types_gen.go
type StorageAccountsQueueServicesQueue_STATUSARM struct {
========
type StorageQueue_STATUSARM struct {
>>>>>>>> main:v2/api/storage/v1beta20210401/storage_queue_status_arm_types_gen.go
