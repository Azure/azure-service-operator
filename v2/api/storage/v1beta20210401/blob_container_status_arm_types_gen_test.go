...
func Test_BlobContainer_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of BlobContainer_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBlobContainer_STATUS_ARM, BlobContainer_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBlobContainer_STATUS_ARM runs a test to see if a specific instance of BlobContainer_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForBlobContainer_STATUS_ARM(subject BlobContainer_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual BlobContainer_STATUS_ARM
...
// Generator of BlobContainer_STATUS_ARM instances for property testing - lazily instantiated by
// BlobContainer_STATUS_ARMGenerator()
var blobContainer_STATUS_ARMGenerator gopter.Gen

// BlobContainer_STATUS_ARMGenerator returns a generator of BlobContainer_STATUS_ARM instances for property testing.
// We first initialize blobContainer_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func BlobContainer_STATUS_ARMGenerator() gopter.Gen {
	if blobContainer_STATUS_ARMGenerator != nil {
		return blobContainer_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBlobContainer_STATUS_ARM(generators)
	blobContainer_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(BlobContainer_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBlobContainer_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForBlobContainer_STATUS_ARM(generators)
	blobContainer_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(BlobContainer_STATUS_ARM{}), generators)

	return blobContainer_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForBlobContainer_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBlobContainer_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForBlobContainer_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBlobContainer_STATUS_ARM(gens map[string]gopter.Gen) {
