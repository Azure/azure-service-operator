...
<<<<<<<< HEAD:v2/api/storage/v1beta20210401/storage_accounts_management_policy__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/storage/v1beta20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
	t.Parallel()
