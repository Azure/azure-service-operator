...
func Test_StorageAccounts_BlobService_Spec_PropertiesARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StorageAccounts_BlobService_Spec_PropertiesARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccounts_BlobService_Spec_PropertiesARM, StorageAccounts_BlobService_Spec_PropertiesARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccounts_BlobService_Spec_PropertiesARM runs a test to see if a specific instance of StorageAccounts_BlobService_Spec_PropertiesARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccounts_BlobService_Spec_PropertiesARM(subject StorageAccounts_BlobService_Spec_PropertiesARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StorageAccounts_BlobService_Spec_PropertiesARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StorageAccounts_BlobService_Spec_PropertiesARM instances for property testing - lazily instantiated by
// StorageAccounts_BlobService_Spec_PropertiesARMGenerator()
var storageAccounts_BlobService_Spec_PropertiesARMGenerator gopter.Gen

// StorageAccounts_BlobService_Spec_PropertiesARMGenerator returns a generator of StorageAccounts_BlobService_Spec_PropertiesARM instances for property testing.
// We first initialize storageAccounts_BlobService_Spec_PropertiesARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccounts_BlobService_Spec_PropertiesARMGenerator() gopter.Gen {
	if storageAccounts_BlobService_Spec_PropertiesARMGenerator != nil {
		return storageAccounts_BlobService_Spec_PropertiesARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM(generators)
	storageAccounts_BlobService_Spec_PropertiesARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_BlobService_Spec_PropertiesARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM(generators)
	storageAccounts_BlobService_Spec_PropertiesARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_BlobService_Spec_PropertiesARM{}), generators)

	return storageAccounts_BlobService_Spec_PropertiesARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccounts_BlobService_Spec_PropertiesARM(gens map[string]gopter.Gen) {
