...
<<<<<<<< HEAD:v2/api/storage/v1beta20210401/storage_accounts_management_policy__spec_arm_types_gen.go
...
type StorageAccounts_ManagementPolicies_SpecARM struct {
	...
	Name string `json:"name,omitempty"`
>>>>>>>> main:v2/api/storage/v1beta20210401/storage_accounts_management_policies_spec_arm_types_gen.go
