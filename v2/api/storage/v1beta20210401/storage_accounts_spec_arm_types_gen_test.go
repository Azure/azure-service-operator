...
func Test_StorageAccount_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/storage/v1beta20210401/storage_account__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/storage/v1beta20210401/storage_accounts_spec_arm_types_gen_test.go
	// Serialize to JSON
