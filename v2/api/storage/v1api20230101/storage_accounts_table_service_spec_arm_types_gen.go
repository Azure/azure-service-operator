...
type StorageAccounts_TableService_Spec_ARM struct {
...
func (service StorageAccounts_TableService_Spec_ARM) GetAPIVersion() string {
	return "2023-01-01"
}

// GetName returns the Name of the resource
func (service *StorageAccounts_TableService_Spec_ARM) GetName() string {
	return service.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Storage/storageAccounts/tableServices"
func (service *StorageAccounts_TableService_Spec_ARM) GetType() string {
