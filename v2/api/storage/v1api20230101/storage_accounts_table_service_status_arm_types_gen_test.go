...
func Test_StorageAccounts_TableService_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties.Property(
		"Round trip of StorageAccounts_TableService_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccounts_TableService_STATUS_ARM, StorageAccounts_TableService_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccounts_TableService_STATUS_ARM runs a test to see if a specific instance of StorageAccounts_TableService_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccounts_TableService_STATUS_ARM(subject StorageAccounts_TableService_STATUS_ARM) string {
	// Serialize to JSON
	...
	var actual StorageAccounts_TableService_STATUS_ARM
...
// Generator of StorageAccounts_TableService_STATUS_ARM instances for property testing - lazily instantiated by
// StorageAccounts_TableService_STATUS_ARMGenerator()
var storageAccounts_TableService_STATUS_ARMGenerator gopter.Gen

// StorageAccounts_TableService_STATUS_ARMGenerator returns a generator of StorageAccounts_TableService_STATUS_ARM instances for property testing.
// We first initialize storageAccounts_TableService_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccounts_TableService_STATUS_ARMGenerator() gopter.Gen {
	if storageAccounts_TableService_STATUS_ARMGenerator != nil {
		return storageAccounts_TableService_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM(generators)
	storageAccounts_TableService_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_TableService_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM(generators)
	storageAccounts_TableService_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_TableService_STATUS_ARM{}), generators)

	return storageAccounts_TableService_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM(gens map[string]gopter.Gen) {
	gens["Id"] = gen.PtrOf(gen.AlphaString())
	gens["Name"] = gen.PtrOf(gen.AlphaString())
	gens["Type"] = gen.PtrOf(gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccounts_TableService_STATUS_ARM(gens map[string]gopter.Gen) {
