...
func Test_StorageAccountsFileService_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StorageAccountsFileService_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccountsFileService_Spec_ARM, StorageAccountsFileService_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccountsFileService_Spec_ARM runs a test to see if a specific instance of StorageAccountsFileService_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccountsFileService_Spec_ARM(subject StorageAccountsFileService_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StorageAccountsFileService_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StorageAccountsFileService_Spec_ARM instances for property testing - lazily instantiated by
// StorageAccountsFileService_Spec_ARMGenerator()
var storageAccountsFileService_Spec_ARMGenerator gopter.Gen

// StorageAccountsFileService_Spec_ARMGenerator returns a generator of StorageAccountsFileService_Spec_ARM instances for property testing.
// We first initialize storageAccountsFileService_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccountsFileService_Spec_ARMGenerator() gopter.Gen {
	if storageAccountsFileService_Spec_ARMGenerator != nil {
		return storageAccountsFileService_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsFileService_Spec_ARM(generators)
	storageAccountsFileService_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsFileService_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsFileService_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccountsFileService_Spec_ARM(generators)
	storageAccountsFileService_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsFileService_Spec_ARM{}), generators)

	return storageAccountsFileService_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccountsFileService_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccountsFileService_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForStorageAccountsFileService_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccountsFileService_Spec_ARM(gens map[string]gopter.Gen) {
