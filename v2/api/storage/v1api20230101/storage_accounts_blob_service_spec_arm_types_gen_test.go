...
func AddIndependentPropertyGeneratorsForCorsRule_ARM(gens map[string]gopter.Gen) {
	...
	gens["AllowedMethods"] = gen.SliceOf(gen.OneConstOf(
		CorsRule_AllowedMethods_ARM_CONNECT,
		CorsRule_AllowedMethods_ARM_DELETE,
		CorsRule_AllowedMethods_ARM_GET,
		CorsRule_AllowedMethods_ARM_HEAD,
		CorsRule_AllowedMethods_ARM_MERGE,
		CorsRule_AllowedMethods_ARM_OPTIONS,
		CorsRule_AllowedMethods_ARM_PATCH,
		CorsRule_AllowedMethods_ARM_POST,
		CorsRule_AllowedMethods_ARM_PUT,
		CorsRule_AllowedMethods_ARM_TRACE))
...
func AddIndependentPropertyGeneratorsForLastAccessTimeTrackingPolicy_ARM(gens map[string]gopter.Gen) {
	...
	gens["Name"] = gen.PtrOf(gen.OneConstOf(LastAccessTimeTrackingPolicy_Name_ARM_AccessTimeTracking))
...
func Test_StorageAccountsBlobService_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StorageAccountsBlobService_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccountsBlobService_Spec_ARM, StorageAccountsBlobService_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccountsBlobService_Spec_ARM runs a test to see if a specific instance of StorageAccountsBlobService_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccountsBlobService_Spec_ARM(subject StorageAccountsBlobService_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual StorageAccountsBlobService_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of StorageAccountsBlobService_Spec_ARM instances for property testing - lazily instantiated by
// StorageAccountsBlobService_Spec_ARMGenerator()
var storageAccountsBlobService_Spec_ARMGenerator gopter.Gen

// StorageAccountsBlobService_Spec_ARMGenerator returns a generator of StorageAccountsBlobService_Spec_ARM instances for property testing.
// We first initialize storageAccountsBlobService_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccountsBlobService_Spec_ARMGenerator() gopter.Gen {
	if storageAccountsBlobService_Spec_ARMGenerator != nil {
		return storageAccountsBlobService_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM(generators)
	storageAccountsBlobService_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsBlobService_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM(generators)
	storageAccountsBlobService_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsBlobService_Spec_ARM{}), generators)

	return storageAccountsBlobService_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccountsBlobService_Spec_ARM(gens map[string]gopter.Gen) {
