...
func AddIndependentPropertyGeneratorsForGeoReplicationStats_STATUS_ARM(gens map[string]gopter.Gen) {
	...
	gens["PostFailoverRedundancy"] = gen.PtrOf(gen.OneConstOf(GeoReplicationStats_PostFailoverRedundancy_STATUS_ARM_Standard_LRS, GeoReplicationStats_PostFailoverRedundancy_STATUS_ARM_Standard_ZRS))
	gens["PostPlannedFailoverRedundancy"] = gen.PtrOf(gen.OneConstOf(
		GeoReplicationStats_PostPlannedFailoverRedundancy_STATUS_ARM_Standard_GRS,
		GeoReplicationStats_PostPlannedFailoverRedundancy_STATUS_ARM_Standard_GZRS,
		GeoReplicationStats_PostPlannedFailoverRedundancy_STATUS_ARM_Standard_RAGRS,
		GeoReplicationStats_PostPlannedFailoverRedundancy_STATUS_ARM_Standard_RAGZRS))
