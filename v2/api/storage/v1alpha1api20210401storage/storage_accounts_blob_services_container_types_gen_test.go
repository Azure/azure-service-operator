...
// RunPropertyAssignmentTestForImmutabilityPolicyProperties tests if a specific instance of ImmutabilityPolicyProperties can be assigned to v1beta20210401storage and back losslessly
func RunPropertyAssignmentTestForImmutabilityPolicyProperties(subject ImmutabilityPolicyProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210401s.ImmutabilityPolicyProperties
...
// RunPropertyAssignmentTestForLegalHoldProperties tests if a specific instance of LegalHoldProperties can be assigned to v1beta20210401storage and back losslessly
func RunPropertyAssignmentTestForLegalHoldProperties(subject LegalHoldProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210401s.LegalHoldProperties
...
// RunPropertyAssignmentTestForTagProperty tests if a specific instance of TagProperty can be assigned to v1beta20210401storage and back losslessly
func RunPropertyAssignmentTestForTagProperty(subject TagProperty) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210401s.TagProperty
...
// RunPropertyAssignmentTestForUpdateHistoryProperty tests if a specific instance of UpdateHistoryProperty can be assigned to v1beta20210401storage and back losslessly
func RunPropertyAssignmentTestForUpdateHistoryProperty(subject UpdateHistoryProperty) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210401s.UpdateHistoryProperty
