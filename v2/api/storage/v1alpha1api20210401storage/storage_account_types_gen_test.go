...
// RunPropertyAssignmentTestForStorageAccountCreateParameters_STATUS tests if a specific instance of StorageAccountCreateParameters_STATUS can be assigned to v1beta20210401storage and back losslessly
func RunPropertyAssignmentTestForStorageAccountCreateParameters_STATUS(subject StorageAccountCreateParameters_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20210401s.StorageAccountCreateParameters_STATUS
