...
<<<<<<<< HEAD:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policy__spec_arm_types_gen_test.go
func Test_StorageAccountsManagementPolicy_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_StorageAccounts_ManagementPolicies_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of StorageAccounts_ManagementPolicies_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccounts_ManagementPolicies_SpecARM, StorageAccounts_ManagementPolicies_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccounts_ManagementPolicies_SpecARM runs a test to see if a specific instance of StorageAccounts_ManagementPolicies_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccounts_ManagementPolicies_SpecARM(subject StorageAccounts_ManagementPolicies_SpecARM) string {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual StorageAccounts_ManagementPolicies_SpecARM
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
...
========
// Generator of StorageAccounts_ManagementPolicies_SpecARM instances for property testing - lazily instantiated by
// StorageAccounts_ManagementPolicies_SpecARMGenerator()
var storageAccounts_ManagementPolicies_SpecARMGenerator gopter.Gen

// StorageAccounts_ManagementPolicies_SpecARMGenerator returns a generator of StorageAccounts_ManagementPolicies_SpecARM instances for property testing.
// We first initialize storageAccounts_ManagementPolicies_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccounts_ManagementPolicies_SpecARMGenerator() gopter.Gen {
	if storageAccounts_ManagementPolicies_SpecARMGenerator != nil {
		return storageAccounts_ManagementPolicies_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM(generators)
	storageAccounts_ManagementPolicies_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_ManagementPolicies_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM(generators)
	storageAccounts_ManagementPolicies_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_ManagementPolicies_SpecARM{}), generators)

	return storageAccounts_ManagementPolicies_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
...
========
// AddRelatedPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccounts_ManagementPolicies_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_management_policies_spec_arm_types_gen_test.go
