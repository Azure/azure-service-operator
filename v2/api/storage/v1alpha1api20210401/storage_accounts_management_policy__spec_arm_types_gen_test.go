...
func Test_StorageAccountsManagementPolicy_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForStorageAccountsManagementPolicy_SpecARM, StorageAccountsManagementPolicy_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccountsManagementPolicy_SpecARM runs a test to see if a specific instance of StorageAccountsManagementPolicy_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccountsManagementPolicy_SpecARM(subject StorageAccountsManagementPolicy_SpecARM) string {
	// Serialize to JSON
	...
	var actual StorageAccountsManagementPolicy_SpecARM
...
// Generator of StorageAccountsManagementPolicy_SpecARM instances for property testing - lazily instantiated by
// StorageAccountsManagementPolicy_SpecARMGenerator()
var storageAccountsManagementPolicy_SpecARMGenerator gopter.Gen

// StorageAccountsManagementPolicy_SpecARMGenerator returns a generator of StorageAccountsManagementPolicy_SpecARM instances for property testing.
// We first initialize storageAccountsManagementPolicy_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccountsManagementPolicy_SpecARMGenerator() gopter.Gen {
	if storageAccountsManagementPolicy_SpecARMGenerator != nil {
		return storageAccountsManagementPolicy_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsManagementPolicy_SpecARM(generators)
	storageAccountsManagementPolicy_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsManagementPolicy_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountsManagementPolicy_SpecARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccountsManagementPolicy_SpecARM(generators)
	storageAccountsManagementPolicy_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccountsManagementPolicy_SpecARM{}), generators)
...
func AddRelatedPropertyGeneratorsForStorageAccountsManagementPolicy_SpecARM(gens map[string]gopter.Gen) {
