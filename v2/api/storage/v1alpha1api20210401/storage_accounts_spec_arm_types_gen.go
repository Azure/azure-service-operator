...
<<<<<<<< HEAD:v2/api/storage/v1alpha1api20210401/storage_account__spec_arm_types_gen.go
	Kind             *StorageAccount_Spec_Kind                    `json:"kind,omitempty"`
========
	Kind             *StorageAccounts_Spec_Kind                   `json:"kind,omitempty"`
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_spec_arm_types_gen.go
...
<<<<<<<< HEAD:v2/api/storage/v1alpha1api20210401/storage_account__spec_arm_types_gen.go
========
// Deprecated version of StorageAccounts_Spec_Kind. Use v1beta20210401.StorageAccounts_Spec_Kind instead
// +kubebuilder:validation:Enum={"BlobStorage","BlockBlobStorage","FileStorage","Storage","StorageV2"}
