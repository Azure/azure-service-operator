...
func (policy *StorageAccountsManagementPolicy) AssignProperties_To_StorageAccountsManagementPolicy(destination *alpha20210401s.StorageAccountsManagementPolicy) error {
	...
	// Spec
	var spec alpha20210401s.StorageAccounts_ManagementPolicy_Spec
...
func (policy *StorageAccounts_ManagementPolicy_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20210401s.StorageAccounts_ManagementPolicy_Spec)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210401s.StorageAccounts_ManagementPolicy_Spec{}
...
func (policy *StorageAccounts_ManagementPolicy_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20210401s.StorageAccounts_ManagementPolicy_Spec)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210401s.StorageAccounts_ManagementPolicy_Spec{}
