...
func (specarm StorageAccountsBlobServices_SPECARM) GetAPIVersion() string {
	return string(APIVersionValue)
}

// GetName returns the Name of the resource
func (specarm StorageAccountsBlobServices_SPECARM) GetName() string {
	return specarm.Name
}

// GetType returns the ARM Type of the resource. This is always ""
func (specarm StorageAccountsBlobServices_SPECARM) GetType() string {
	return ""
}
...
type StorageAccountsBlobServices_SPEC_PropertiesARM struct {
	...
	ChangeFeed *ChangeFeed_SpecARM `json:"changeFeed,omitempty"`

	//ContainerDeleteRetentionPolicy: The blob service properties for container soft
	//delete.
	ContainerDeleteRetentionPolicy *DeleteRetentionPolicy_SpecARM `json:"containerDeleteRetentionPolicy,omitempty"`
	...
	DeleteRetentionPolicy *DeleteRetentionPolicy_SpecARM `json:"deleteRetentionPolicy,omitempty"`
	...
	LastAccessTimeTrackingPolicy *LastAccessTimeTrackingPolicy_SpecARM `json:"lastAccessTimeTrackingPolicy,omitempty"`

	//RestorePolicy: The blob service properties for blob restore policy.
	RestorePolicy *RestorePolicyProperties_SpecARM `json:"restorePolicy,omitempty"`
}

type ChangeFeed_SpecARM struct {
...
type CorsRules_SpecARM struct {
	//CorsRules: The List of CORS rules. You can include up to five CorsRule elements
	//in the request.
	CorsRules []CorsRule_SpecARM `json:"corsRules,omitempty"`
}

type DeleteRetentionPolicy_SpecARM struct {
...
type LastAccessTimeTrackingPolicy_SpecARM struct {
...
type RestorePolicyProperties_SpecARM struct {
