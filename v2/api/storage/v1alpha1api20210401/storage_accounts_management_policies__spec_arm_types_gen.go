...
type ManagementPolicyPropertiesARM struct {
	...
	Policy ManagementPolicySchemaARM `json:"policy"`
}
...
type ManagementPolicySchemaARM struct {
	...
	//https://docs.microsoft.com/en-us/azure/storage/common/storage-lifecycle-managment-concepts.
	Rules []ManagementPolicyRuleARM `json:"rules"`
}
...
type ManagementPolicyRuleARM struct {
	...
	Definition ManagementPolicyDefinitionARM `json:"definition"`
...
type ManagementPolicyDefinitionARM struct {
	...
	Actions ManagementPolicyActionARM `json:"actions"`
