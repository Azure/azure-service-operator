...
<<<<<<<< HEAD:v2/api/storage/v1alpha1api20210401/storage_accounts_blob_services_container__spec_arm_types_gen_test.go
func Test_StorageAccountsBlobServicesContainer_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
========
func Test_StorageAccounts_BlobServices_Containers_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_blob_services_containers_spec_arm_types_gen_test.go
	t.Parallel()
...
========
		"Round trip of StorageAccounts_BlobServices_Containers_SpecARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccounts_BlobServices_Containers_SpecARM, StorageAccounts_BlobServices_Containers_SpecARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccounts_BlobServices_Containers_SpecARM runs a test to see if a specific instance of StorageAccounts_BlobServices_Containers_SpecARM round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccounts_BlobServices_Containers_SpecARM(subject StorageAccounts_BlobServices_Containers_SpecARM) string {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_blob_services_containers_spec_arm_types_gen_test.go
	// Serialize to JSON
...
========
	var actual StorageAccounts_BlobServices_Containers_SpecARM
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_blob_services_containers_spec_arm_types_gen_test.go
...
========
// Generator of StorageAccounts_BlobServices_Containers_SpecARM instances for property testing - lazily instantiated by
// StorageAccounts_BlobServices_Containers_SpecARMGenerator()
var storageAccounts_BlobServices_Containers_SpecARMGenerator gopter.Gen

// StorageAccounts_BlobServices_Containers_SpecARMGenerator returns a generator of StorageAccounts_BlobServices_Containers_SpecARM instances for property testing.
// We first initialize storageAccounts_BlobServices_Containers_SpecARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccounts_BlobServices_Containers_SpecARMGenerator() gopter.Gen {
	if storageAccounts_BlobServices_Containers_SpecARMGenerator != nil {
		return storageAccounts_BlobServices_Containers_SpecARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM(generators)
	storageAccounts_BlobServices_Containers_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_BlobServices_Containers_SpecARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM(generators)
	AddRelatedPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM(generators)
	storageAccounts_BlobServices_Containers_SpecARMGenerator = gen.Struct(reflect.TypeOf(StorageAccounts_BlobServices_Containers_SpecARM{}), generators)

	return storageAccounts_BlobServices_Containers_SpecARMGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM(gens map[string]gopter.Gen) {
...
========
// AddRelatedPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccounts_BlobServices_Containers_SpecARM(gens map[string]gopter.Gen) {
>>>>>>>> main:v2/api/storage/v1alpha1api20210401/storage_accounts_blob_services_containers_spec_arm_types_gen_test.go
