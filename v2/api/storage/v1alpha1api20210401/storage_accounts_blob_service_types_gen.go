...
func (service *StorageAccountsBlobService) AssignProperties_To_StorageAccountsBlobService(destination *alpha20210401s.StorageAccountsBlobService) error {
	...
	// Spec
	var spec alpha20210401s.StorageAccounts_BlobService_Spec
	...
	// Status
	var status alpha20210401s.StorageAccounts_BlobService_STATUS
...
func (service *StorageAccounts_BlobService_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	result := &StorageAccounts_BlobService_SpecARM{}
	...
	if service.AutomaticSnapshotPolicyEnabled != nil ||
		...
		result.Properties = &StorageAccounts_BlobService_Spec_PropertiesARM{}
	}
	if service.AutomaticSnapshotPolicyEnabled != nil {
...
func (service *StorageAccounts_BlobService_Spec) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &StorageAccounts_BlobService_SpecARM{}
}
...
func (service *StorageAccounts_BlobService_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(StorageAccounts_BlobService_SpecARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected StorageAccounts_BlobService_SpecARM, got %T", armInput)
	}
...
func (service *StorageAccounts_BlobService_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20210401s.StorageAccounts_BlobService_Spec)
	if ok {
	...
	src = &alpha20210401s.StorageAccounts_BlobService_Spec{}
...
func (service *StorageAccounts_BlobService_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20210401s.StorageAccounts_BlobService_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &alpha20210401s.StorageAccounts_BlobService_Spec{}
...
func (service *StorageAccounts_BlobService_Spec) SetAzureName(azureName string) {
...
func (service *StorageAccounts_BlobService_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20210401s.StorageAccounts_BlobService_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210401s.StorageAccounts_BlobService_STATUS{}
...
func (service *StorageAccounts_BlobService_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20210401s.StorageAccounts_BlobService_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210401s.StorageAccounts_BlobService_STATUS{}
...
func (service *StorageAccounts_BlobService_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &StorageAccounts_BlobService_STATUSARM{}
}
...
func (service *StorageAccounts_BlobService_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(StorageAccounts_BlobService_STATUSARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected StorageAccounts_BlobService_STATUSARM, got %T", armInput)
	}
