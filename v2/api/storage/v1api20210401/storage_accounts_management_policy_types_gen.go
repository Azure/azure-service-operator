...
func (policy *StorageAccountsManagementPolicy) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20210401s.StorageAccountsManagementPolicy)
	if !ok {
		return fmt.Errorf("expected storage/v1api20210401storage/StorageAccountsManagementPolicy but received %T instead", hub)
	}
...
func (policy *StorageAccountsManagementPolicy) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20210401s.StorageAccountsManagementPolicy)
	if !ok {
		return fmt.Errorf("expected storage/v1api20210401storage/StorageAccountsManagementPolicy but received %T instead", hub)
	}
...
func (policy *StorageAccountsManagementPolicy) AssignProperties_From_StorageAccountsManagementPolicy(source *v1api20210401s.StorageAccountsManagementPolicy) error {
...
func (policy *StorageAccountsManagementPolicy) AssignProperties_To_StorageAccountsManagementPolicy(destination *v1api20210401s.StorageAccountsManagementPolicy) error {

	// ObjectMeta
	destination.ObjectMeta = *policy.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20210401s.StorageAccounts_ManagementPolicy_Spec
	...
	// Status
	var status v1api20210401s.StorageAccounts_ManagementPolicy_STATUS
...
func (policy *StorageAccounts_ManagementPolicy_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20210401s.StorageAccounts_ManagementPolicy_Spec)
	if ok {
	...
	src = &v1api20210401s.StorageAccounts_ManagementPolicy_Spec{}
...
func (policy *StorageAccounts_ManagementPolicy_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20210401s.StorageAccounts_ManagementPolicy_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20210401s.StorageAccounts_ManagementPolicy_Spec{}
...
func (policy *StorageAccounts_ManagementPolicy_Spec) AssignProperties_From_StorageAccounts_ManagementPolicy_Spec(source *v1api20210401s.StorageAccounts_ManagementPolicy_Spec) error {
...
func (policy *StorageAccounts_ManagementPolicy_Spec) AssignProperties_To_StorageAccounts_ManagementPolicy_Spec(destination *v1api20210401s.StorageAccounts_ManagementPolicy_Spec) error {
	...
	// Policy
	if policy.Policy != nil {
		var policyLocal v1api20210401s.ManagementPolicySchema
...
func (policy *StorageAccounts_ManagementPolicy_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20210401s.StorageAccounts_ManagementPolicy_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20210401s.StorageAccounts_ManagementPolicy_STATUS{}
...
func (policy *StorageAccounts_ManagementPolicy_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20210401s.StorageAccounts_ManagementPolicy_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20210401s.StorageAccounts_ManagementPolicy_STATUS{}
...
func (policy *StorageAccounts_ManagementPolicy_STATUS) AssignProperties_From_StorageAccounts_ManagementPolicy_STATUS(source *v1api20210401s.StorageAccounts_ManagementPolicy_STATUS) error {
...
func (policy *StorageAccounts_ManagementPolicy_STATUS) AssignProperties_To_StorageAccounts_ManagementPolicy_STATUS(destination *v1api20210401s.StorageAccounts_ManagementPolicy_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Policy
	if policy.Policy != nil {
		var policyLocal v1api20210401s.ManagementPolicySchema_STATUS
...
func (schema *ManagementPolicySchema) AssignProperties_From_ManagementPolicySchema(source *v1api20210401s.ManagementPolicySchema) error {
...
func (schema *ManagementPolicySchema) AssignProperties_To_ManagementPolicySchema(destination *v1api20210401s.ManagementPolicySchema) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Rules
	if schema.Rules != nil {
		ruleList := make([]v1api20210401s.ManagementPolicyRule, len(schema.Rules))
		for ruleIndex, ruleItem := range schema.Rules {
			// Shadow the loop variable to avoid aliasing
			ruleItem := ruleItem
			var rule v1api20210401s.ManagementPolicyRule
...
func (schema *ManagementPolicySchema_STATUS) AssignProperties_From_ManagementPolicySchema_STATUS(source *v1api20210401s.ManagementPolicySchema_STATUS) error {
...
func (schema *ManagementPolicySchema_STATUS) AssignProperties_To_ManagementPolicySchema_STATUS(destination *v1api20210401s.ManagementPolicySchema_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Rules
	if schema.Rules != nil {
		ruleList := make([]v1api20210401s.ManagementPolicyRule_STATUS, len(schema.Rules))
		for ruleIndex, ruleItem := range schema.Rules {
			// Shadow the loop variable to avoid aliasing
			ruleItem := ruleItem
			var rule v1api20210401s.ManagementPolicyRule_STATUS
...
func (rule *ManagementPolicyRule) AssignProperties_From_ManagementPolicyRule(source *v1api20210401s.ManagementPolicyRule) error {
...
func (rule *ManagementPolicyRule) AssignProperties_To_ManagementPolicyRule(destination *v1api20210401s.ManagementPolicyRule) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Definition
	if rule.Definition != nil {
		var definition v1api20210401s.ManagementPolicyDefinition
...
func (rule *ManagementPolicyRule_STATUS) AssignProperties_From_ManagementPolicyRule_STATUS(source *v1api20210401s.ManagementPolicyRule_STATUS) error {
...
func (rule *ManagementPolicyRule_STATUS) AssignProperties_To_ManagementPolicyRule_STATUS(destination *v1api20210401s.ManagementPolicyRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Definition
	if rule.Definition != nil {
		var definition v1api20210401s.ManagementPolicyDefinition_STATUS
...
func (definition *ManagementPolicyDefinition) AssignProperties_From_ManagementPolicyDefinition(source *v1api20210401s.ManagementPolicyDefinition) error {
...
func (definition *ManagementPolicyDefinition) AssignProperties_To_ManagementPolicyDefinition(destination *v1api20210401s.ManagementPolicyDefinition) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Actions
	if definition.Actions != nil {
		var action v1api20210401s.ManagementPolicyAction
	...
	// Filters
	if definition.Filters != nil {
		var filter v1api20210401s.ManagementPolicyFilter
...
func (definition *ManagementPolicyDefinition_STATUS) AssignProperties_From_ManagementPolicyDefinition_STATUS(source *v1api20210401s.ManagementPolicyDefinition_STATUS) error {
...
func (definition *ManagementPolicyDefinition_STATUS) AssignProperties_To_ManagementPolicyDefinition_STATUS(destination *v1api20210401s.ManagementPolicyDefinition_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Actions
	if definition.Actions != nil {
		var action v1api20210401s.ManagementPolicyAction_STATUS
	...
	// Filters
	if definition.Filters != nil {
		var filter v1api20210401s.ManagementPolicyFilter_STATUS
...
func (action *ManagementPolicyAction) AssignProperties_From_ManagementPolicyAction(source *v1api20210401s.ManagementPolicyAction) error {
...
func (action *ManagementPolicyAction) AssignProperties_To_ManagementPolicyAction(destination *v1api20210401s.ManagementPolicyAction) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BaseBlob
	if action.BaseBlob != nil {
		var baseBlob v1api20210401s.ManagementPolicyBaseBlob
	...
	// Snapshot
	if action.Snapshot != nil {
		var snapshot v1api20210401s.ManagementPolicySnapShot
	...
	// Version
	if action.Version != nil {
		var version v1api20210401s.ManagementPolicyVersion
...
func (action *ManagementPolicyAction_STATUS) AssignProperties_From_ManagementPolicyAction_STATUS(source *v1api20210401s.ManagementPolicyAction_STATUS) error {
...
func (action *ManagementPolicyAction_STATUS) AssignProperties_To_ManagementPolicyAction_STATUS(destination *v1api20210401s.ManagementPolicyAction_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BaseBlob
	if action.BaseBlob != nil {
		var baseBlob v1api20210401s.ManagementPolicyBaseBlob_STATUS
	...
	// Snapshot
	if action.Snapshot != nil {
		var snapshot v1api20210401s.ManagementPolicySnapShot_STATUS
	...
	// Version
	if action.Version != nil {
		var version v1api20210401s.ManagementPolicyVersion_STATUS
...
func (filter *ManagementPolicyFilter) AssignProperties_From_ManagementPolicyFilter(source *v1api20210401s.ManagementPolicyFilter) error {
...
func (filter *ManagementPolicyFilter) AssignProperties_To_ManagementPolicyFilter(destination *v1api20210401s.ManagementPolicyFilter) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BlobIndexMatch
	if filter.BlobIndexMatch != nil {
		blobIndexMatchList := make([]v1api20210401s.TagFilter, len(filter.BlobIndexMatch))
		for blobIndexMatchIndex, blobIndexMatchItem := range filter.BlobIndexMatch {
			// Shadow the loop variable to avoid aliasing
			blobIndexMatchItem := blobIndexMatchItem
			var blobIndexMatch v1api20210401s.TagFilter
...
func (filter *ManagementPolicyFilter_STATUS) AssignProperties_From_ManagementPolicyFilter_STATUS(source *v1api20210401s.ManagementPolicyFilter_STATUS) error {
...
func (filter *ManagementPolicyFilter_STATUS) AssignProperties_To_ManagementPolicyFilter_STATUS(destination *v1api20210401s.ManagementPolicyFilter_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// BlobIndexMatch
	if filter.BlobIndexMatch != nil {
		blobIndexMatchList := make([]v1api20210401s.TagFilter_STATUS, len(filter.BlobIndexMatch))
		for blobIndexMatchIndex, blobIndexMatchItem := range filter.BlobIndexMatch {
			// Shadow the loop variable to avoid aliasing
			blobIndexMatchItem := blobIndexMatchItem
			var blobIndexMatch v1api20210401s.TagFilter_STATUS
...
func (blob *ManagementPolicyBaseBlob) AssignProperties_From_ManagementPolicyBaseBlob(source *v1api20210401s.ManagementPolicyBaseBlob) error {
...
func (blob *ManagementPolicyBaseBlob) AssignProperties_To_ManagementPolicyBaseBlob(destination *v1api20210401s.ManagementPolicyBaseBlob) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Delete
	if blob.Delete != nil {
		var delete v1api20210401s.DateAfterModification
	...
	// TierToArchive
	if blob.TierToArchive != nil {
		var tierToArchive v1api20210401s.DateAfterModification
	...
	// TierToCool
	if blob.TierToCool != nil {
		var tierToCool v1api20210401s.DateAfterModification
...
func (blob *ManagementPolicyBaseBlob_STATUS) AssignProperties_From_ManagementPolicyBaseBlob_STATUS(source *v1api20210401s.ManagementPolicyBaseBlob_STATUS) error {
...
func (blob *ManagementPolicyBaseBlob_STATUS) AssignProperties_To_ManagementPolicyBaseBlob_STATUS(destination *v1api20210401s.ManagementPolicyBaseBlob_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Delete
	if blob.Delete != nil {
		var delete v1api20210401s.DateAfterModification_STATUS
	...
	// TierToArchive
	if blob.TierToArchive != nil {
		var tierToArchive v1api20210401s.DateAfterModification_STATUS
	...
	// TierToCool
	if blob.TierToCool != nil {
		var tierToCool v1api20210401s.DateAfterModification_STATUS
...
func (shot *ManagementPolicySnapShot) AssignProperties_From_ManagementPolicySnapShot(source *v1api20210401s.ManagementPolicySnapShot) error {
...
func (shot *ManagementPolicySnapShot) AssignProperties_To_ManagementPolicySnapShot(destination *v1api20210401s.ManagementPolicySnapShot) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Delete
	if shot.Delete != nil {
		var delete v1api20210401s.DateAfterCreation
	...
	// TierToArchive
	if shot.TierToArchive != nil {
		var tierToArchive v1api20210401s.DateAfterCreation
	...
	// TierToCool
	if shot.TierToCool != nil {
		var tierToCool v1api20210401s.DateAfterCreation
...
func (shot *ManagementPolicySnapShot_STATUS) AssignProperties_From_ManagementPolicySnapShot_STATUS(source *v1api20210401s.ManagementPolicySnapShot_STATUS) error {
...
func (shot *ManagementPolicySnapShot_STATUS) AssignProperties_To_ManagementPolicySnapShot_STATUS(destination *v1api20210401s.ManagementPolicySnapShot_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Delete
	if shot.Delete != nil {
		var delete v1api20210401s.DateAfterCreation_STATUS
	...
	// TierToArchive
	if shot.TierToArchive != nil {
		var tierToArchive v1api20210401s.DateAfterCreation_STATUS
	...
	// TierToCool
	if shot.TierToCool != nil {
		var tierToCool v1api20210401s.DateAfterCreation_STATUS
...
func (version *ManagementPolicyVersion) AssignProperties_From_ManagementPolicyVersion(source *v1api20210401s.ManagementPolicyVersion) error {
...
func (version *ManagementPolicyVersion) AssignProperties_To_ManagementPolicyVersion(destination *v1api20210401s.ManagementPolicyVersion) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (version *ManagementPolicyVersion_STATUS) AssignProperties_From_ManagementPolicyVersion_STATUS(source *v1api20210401s.ManagementPolicyVersion_STATUS) error {
...
func (version *ManagementPolicyVersion_STATUS) AssignProperties_To_ManagementPolicyVersion_STATUS(destination *v1api20210401s.ManagementPolicyVersion_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *TagFilter) AssignProperties_From_TagFilter(source *v1api20210401s.TagFilter) error {
...
func (filter *TagFilter) AssignProperties_To_TagFilter(destination *v1api20210401s.TagFilter) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (filter *TagFilter_STATUS) AssignProperties_From_TagFilter_STATUS(source *v1api20210401s.TagFilter_STATUS) error {
...
func (filter *TagFilter_STATUS) AssignProperties_To_TagFilter_STATUS(destination *v1api20210401s.TagFilter_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (creation *DateAfterCreation) AssignProperties_From_DateAfterCreation(source *v1api20210401s.DateAfterCreation) error {
...
func (creation *DateAfterCreation) AssignProperties_To_DateAfterCreation(destination *v1api20210401s.DateAfterCreation) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (creation *DateAfterCreation_STATUS) AssignProperties_From_DateAfterCreation_STATUS(source *v1api20210401s.DateAfterCreation_STATUS) error {
...
func (creation *DateAfterCreation_STATUS) AssignProperties_To_DateAfterCreation_STATUS(destination *v1api20210401s.DateAfterCreation_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (modification *DateAfterModification) AssignProperties_From_DateAfterModification(source *v1api20210401s.DateAfterModification) error {
...
func (modification *DateAfterModification) AssignProperties_To_DateAfterModification(destination *v1api20210401s.DateAfterModification) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (modification *DateAfterModification_STATUS) AssignProperties_From_DateAfterModification_STATUS(source *v1api20210401s.DateAfterModification_STATUS) error {
...
func (modification *DateAfterModification_STATUS) AssignProperties_To_DateAfterModification_STATUS(destination *v1api20210401s.DateAfterModification_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
