...
type StorageAccountsQueueServicesQueue_Spec_ARM struct {
...
var _ genruntime.ARMResourceSpec = &StorageAccountsQueueServicesQueue_Spec_ARM{}

// GetAPIVersion returns the ARM API version of the resource. This is always "2021-04-01"
func (queue StorageAccountsQueueServicesQueue_Spec_ARM) GetAPIVersion() string {
	return "2021-04-01"
}

// GetName returns the Name of the resource
func (queue *StorageAccountsQueueServicesQueue_Spec_ARM) GetName() string {
	return queue.Name
}

// GetType returns the ARM Type of the resource. This is always "Microsoft.Storage/storageAccounts/queueServices/queues"
func (queue *StorageAccountsQueueServicesQueue_Spec_ARM) GetType() string {
