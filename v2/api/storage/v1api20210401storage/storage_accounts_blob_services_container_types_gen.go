...
type augmentConversionForStorageAccountsBlobServicesContainer interface {
	AssignPropertiesFrom(src *v1api20220901s.StorageAccountsBlobServicesContainer) error
	AssignPropertiesTo(dst *v1api20220901s.StorageAccountsBlobServicesContainer) error
}
...
type augmentConversionForStorageAccounts_BlobServices_Container_Spec interface {
	AssignPropertiesFrom(src *v1api20220901s.StorageAccounts_BlobServices_Container_Spec) error
	AssignPropertiesTo(dst *v1api20220901s.StorageAccounts_BlobServices_Container_Spec) error
}

type augmentConversionForStorageAccounts_BlobServices_Container_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.StorageAccounts_BlobServices_Container_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.StorageAccounts_BlobServices_Container_STATUS) error
}
...
type augmentConversionForImmutabilityPolicyProperties_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.ImmutabilityPolicyProperties_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.ImmutabilityPolicyProperties_STATUS) error
}

type augmentConversionForImmutableStorageWithVersioning interface {
	AssignPropertiesFrom(src *v1api20220901s.ImmutableStorageWithVersioning) error
	AssignPropertiesTo(dst *v1api20220901s.ImmutableStorageWithVersioning) error
}

type augmentConversionForImmutableStorageWithVersioning_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.ImmutableStorageWithVersioning_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.ImmutableStorageWithVersioning_STATUS) error
}

type augmentConversionForLegalHoldProperties_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.LegalHoldProperties_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.LegalHoldProperties_STATUS) error
}
...
type augmentConversionForTagProperty_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.TagProperty_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.TagProperty_STATUS) error
}

type augmentConversionForUpdateHistoryProperty_STATUS interface {
	AssignPropertiesFrom(src *v1api20220901s.UpdateHistoryProperty_STATUS) error
	AssignPropertiesTo(dst *v1api20220901s.UpdateHistoryProperty_STATUS) error
}
