...
func Test_DualStackEndpointPreference_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DualStackEndpointPreference via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDualStackEndpointPreference, DualStackEndpointPreferenceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDualStackEndpointPreference runs a test to see if a specific instance of DualStackEndpointPreference round trips to JSON and back losslessly
func RunJSONSerializationTestForDualStackEndpointPreference(subject DualStackEndpointPreference) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of DualStackEndpointPreference instances for property testing - lazily instantiated by
// DualStackEndpointPreferenceGenerator()
var dualStackEndpointPreferenceGenerator gopter.Gen

// DualStackEndpointPreferenceGenerator returns a generator of DualStackEndpointPreference instances for property testing.
func DualStackEndpointPreferenceGenerator() gopter.Gen {
	if dualStackEndpointPreferenceGenerator != nil {
		return dualStackEndpointPreferenceGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDualStackEndpointPreference(generators)
	dualStackEndpointPreferenceGenerator = gen.Struct(reflect.TypeOf(DualStackEndpointPreference{}), generators)

	return dualStackEndpointPreferenceGenerator
}

// AddIndependentPropertyGeneratorsForDualStackEndpointPreference is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForDualStackEndpointPreference(gens map[string]gopter.Gen) {
...
func Test_GeoPriorityReplicationStatus_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of GeoPriorityReplicationStatus via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForGeoPriorityReplicationStatus, GeoPriorityReplicationStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForGeoPriorityReplicationStatus runs a test to see if a specific instance of GeoPriorityReplicationStatus round trips to JSON and back losslessly
func RunJSONSerializationTestForGeoPriorityReplicationStatus(subject GeoPriorityReplicationStatus) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of GeoPriorityReplicationStatus instances for property testing - lazily instantiated by
// GeoPriorityReplicationStatusGenerator()
var geoPriorityReplicationStatusGenerator gopter.Gen

// GeoPriorityReplicationStatusGenerator returns a generator of GeoPriorityReplicationStatus instances for property testing.
func GeoPriorityReplicationStatusGenerator() gopter.Gen {
	if geoPriorityReplicationStatusGenerator != nil {
		return geoPriorityReplicationStatusGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForGeoPriorityReplicationStatus(generators)
	geoPriorityReplicationStatusGenerator = gen.Struct(reflect.TypeOf(GeoPriorityReplicationStatus{}), generators)

	return geoPriorityReplicationStatusGenerator
}

// AddIndependentPropertyGeneratorsForGeoPriorityReplicationStatus is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForGeoPriorityReplicationStatus(gens map[string]gopter.Gen) {
...
func Test_Placement_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Placement via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPlacement, PlacementGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPlacement runs a test to see if a specific instance of Placement round trips to JSON and back losslessly
func RunJSONSerializationTestForPlacement(subject Placement) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Placement instances for property testing - lazily instantiated by PlacementGenerator()
var placementGenerator gopter.Gen

// PlacementGenerator returns a generator of Placement instances for property testing.
func PlacementGenerator() gopter.Gen {
	if placementGenerator != nil {
		return placementGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForPlacement(generators)
	placementGenerator = gen.Struct(reflect.TypeOf(Placement{}), generators)
...
func AddIndependentPropertyGeneratorsForSasPolicy(gens map[string]gopter.Gen) {
	gens["ExpirationAction"] = gen.PtrOf(gen.OneConstOf(SasPolicy_ExpirationAction_Block, SasPolicy_ExpirationAction_Log))
...
func Test_SmbOAuthSettings_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SmbOAuthSettings via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSmbOAuthSettings, SmbOAuthSettingsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSmbOAuthSettings runs a test to see if a specific instance of SmbOAuthSettings round trips to JSON and back losslessly
func RunJSONSerializationTestForSmbOAuthSettings(subject SmbOAuthSettings) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of SmbOAuthSettings instances for property testing - lazily instantiated by SmbOAuthSettingsGenerator()
var smbOAuthSettingsGenerator gopter.Gen

// SmbOAuthSettingsGenerator returns a generator of SmbOAuthSettings instances for property testing.
func SmbOAuthSettingsGenerator() gopter.Gen {
	if smbOAuthSettingsGenerator != nil {
		return smbOAuthSettingsGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSmbOAuthSettings(generators)
	smbOAuthSettingsGenerator = gen.Struct(reflect.TypeOf(SmbOAuthSettings{}), generators)
...
func AddRelatedPropertyGeneratorsForStorageAccountPropertiesCreateParameters(gens map[string]gopter.Gen) {
	...
	gens["DualStackEndpointPreference"] = gen.PtrOf(DualStackEndpointPreferenceGenerator())
	gens["Encryption"] = gen.PtrOf(EncryptionGenerator())
	gens["GeoPriorityReplicationStatus"] = gen.PtrOf(GeoPriorityReplicationStatusGenerator())
...
func AddRelatedPropertyGeneratorsForStorageAccount_Spec(gens map[string]gopter.Gen) {
	...
	gens["Placement"] = gen.PtrOf(PlacementGenerator())
