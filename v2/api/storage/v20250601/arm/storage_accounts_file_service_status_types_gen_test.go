...
func Test_EncryptionInTransit_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		"Round trip of EncryptionInTransit_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForEncryptionInTransit_STATUS, EncryptionInTransit_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForEncryptionInTransit_STATUS runs a test to see if a specific instance of EncryptionInTransit_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForEncryptionInTransit_STATUS(subject EncryptionInTransit_STATUS) string {
	// Serialize to JSON
...
// Generator of EncryptionInTransit_STATUS instances for property testing - lazily instantiated by
// EncryptionInTransit_STATUSGenerator()
var encryptionInTransit_STATUSGenerator gopter.Gen

// EncryptionInTransit_STATUSGenerator returns a generator of EncryptionInTransit_STATUS instances for property testing.
func EncryptionInTransit_STATUSGenerator() gopter.Gen {
	if encryptionInTransit_STATUSGenerator != nil {
		return encryptionInTransit_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForEncryptionInTransit_STATUS(generators)
	encryptionInTransit_STATUSGenerator = gen.Struct(reflect.TypeOf(EncryptionInTransit_STATUS{}), generators)

	return encryptionInTransit_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForEncryptionInTransit_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForEncryptionInTransit_STATUS(gens map[string]gopter.Gen) {
...
func Test_NfsSetting_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NfsSetting_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNfsSetting_STATUS, NfsSetting_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNfsSetting_STATUS runs a test to see if a specific instance of NfsSetting_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForNfsSetting_STATUS(subject NfsSetting_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of NfsSetting_STATUS instances for property testing - lazily instantiated by NfsSetting_STATUSGenerator()
var nfsSetting_STATUSGenerator gopter.Gen

// NfsSetting_STATUSGenerator returns a generator of NfsSetting_STATUS instances for property testing.
func NfsSetting_STATUSGenerator() gopter.Gen {
	if nfsSetting_STATUSGenerator != nil {
		return nfsSetting_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForNfsSetting_STATUS(generators)
	nfsSetting_STATUSGenerator = gen.Struct(reflect.TypeOf(NfsSetting_STATUS{}), generators)
