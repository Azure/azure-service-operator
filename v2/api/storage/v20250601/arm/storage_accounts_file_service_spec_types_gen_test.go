...
func Test_EncryptionInTransit_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		"Round trip of EncryptionInTransit via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForEncryptionInTransit, EncryptionInTransitGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForEncryptionInTransit runs a test to see if a specific instance of EncryptionInTransit round trips to JSON and back losslessly
func RunJSONSerializationTestForEncryptionInTransit(subject EncryptionInTransit) string {
	// Serialize to JSON
...
// Generator of EncryptionInTransit instances for property testing - lazily instantiated by
// EncryptionInTransitGenerator()
var encryptionInTransitGenerator gopter.Gen

// EncryptionInTransitGenerator returns a generator of EncryptionInTransit instances for property testing.
func EncryptionInTransitGenerator() gopter.Gen {
	if encryptionInTransitGenerator != nil {
		return encryptionInTransitGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForEncryptionInTransit(generators)
	encryptionInTransitGenerator = gen.Struct(reflect.TypeOf(EncryptionInTransit{}), generators)
...
func Test_NfsSetting_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NfsSetting via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNfsSetting, NfsSettingGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNfsSetting runs a test to see if a specific instance of NfsSetting round trips to JSON and back losslessly
func RunJSONSerializationTestForNfsSetting(subject NfsSetting) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of NfsSetting instances for property testing - lazily instantiated by NfsSettingGenerator()
var nfsSettingGenerator gopter.Gen

// NfsSettingGenerator returns a generator of NfsSetting instances for property testing.
func NfsSettingGenerator() gopter.Gen {
	if nfsSettingGenerator != nil {
		return nfsSettingGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForNfsSetting(generators)
	nfsSettingGenerator = gen.Struct(reflect.TypeOf(NfsSetting{}), generators)

	return nfsSettingGenerator
}

// AddRelatedPropertyGeneratorsForNfsSetting is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForNfsSetting(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForProtocolSettings(gens map[string]gopter.Gen) {
	gens["Nfs"] = gen.PtrOf(NfsSettingGenerator())
