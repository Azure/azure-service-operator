...
func AddIndependentPropertyGeneratorsForAccountImmutabilityPolicyProperties_STATUS(gens map[string]gopter.Gen) {
	...
	gens["State"] = gen.PtrOf(gen.OneConstOf(AccountImmutabilityPolicyState_STATUS_Disabled, AccountImmutabilityPolicyState_STATUS_Locked, AccountImmutabilityPolicyState_STATUS_Unlocked))
}
...
func AddIndependentPropertyGeneratorsForActiveDirectoryProperties_STATUS(gens map[string]gopter.Gen) {
	gens["AccountType"] = gen.PtrOf(gen.OneConstOf(AccountType_STATUS_Computer, AccountType_STATUS_User))
...
func AddIndependentPropertyGeneratorsForAzureFilesIdentityBasedAuthentication_STATUS(gens map[string]gopter.Gen) {
	gens["DefaultSharePermission"] = gen.PtrOf(gen.OneConstOf(
		DefaultSharePermission_STATUS_None,
		DefaultSharePermission_STATUS_StorageFileDataSmbShareContributor,
		DefaultSharePermission_STATUS_StorageFileDataSmbShareElevatedContributor,
		DefaultSharePermission_STATUS_StorageFileDataSmbShareReader))
	gens["DirectoryServiceOptions"] = gen.PtrOf(gen.OneConstOf(
		DirectoryServiceOptions_STATUS_AADDS,
		DirectoryServiceOptions_STATUS_AADKERB,
		DirectoryServiceOptions_STATUS_AD,
		DirectoryServiceOptions_STATUS_None))
}
...
func AddIndependentPropertyGeneratorsForBlobRestoreStatus_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Status"] = gen.PtrOf(gen.OneConstOf(BlobRestoreProgressStatus_STATUS_Complete, BlobRestoreProgressStatus_STATUS_Failed, BlobRestoreProgressStatus_STATUS_InProgress))
}
...
func Test_DualStackEndpointPreference_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of DualStackEndpointPreference_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForDualStackEndpointPreference_STATUS, DualStackEndpointPreference_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForDualStackEndpointPreference_STATUS runs a test to see if a specific instance of DualStackEndpointPreference_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForDualStackEndpointPreference_STATUS(subject DualStackEndpointPreference_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of DualStackEndpointPreference_STATUS instances for property testing - lazily instantiated by
// DualStackEndpointPreference_STATUSGenerator()
var dualStackEndpointPreference_STATUSGenerator gopter.Gen

// DualStackEndpointPreference_STATUSGenerator returns a generator of DualStackEndpointPreference_STATUS instances for property testing.
func DualStackEndpointPreference_STATUSGenerator() gopter.Gen {
	if dualStackEndpointPreference_STATUSGenerator != nil {
		return dualStackEndpointPreference_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForDualStackEndpointPreference_STATUS(generators)
	dualStackEndpointPreference_STATUSGenerator = gen.Struct(reflect.TypeOf(DualStackEndpointPreference_STATUS{}), generators)
...
func AddIndependentPropertyGeneratorsForEncryptionService_STATUS(gens map[string]gopter.Gen) {
	...
	gens["KeyType"] = gen.PtrOf(gen.OneConstOf(KeyType_STATUS_Account, KeyType_STATUS_Service))
...
func AddRelatedPropertyGeneratorsForEndpoints_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Ipv6Endpoints"] = gen.PtrOf(StorageAccountIpv6Endpoints_STATUSGenerator())
...
func Test_GeoPriorityReplicationStatus_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of GeoPriorityReplicationStatus_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForGeoPriorityReplicationStatus_STATUS, GeoPriorityReplicationStatus_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForGeoPriorityReplicationStatus_STATUS runs a test to see if a specific instance of GeoPriorityReplicationStatus_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForGeoPriorityReplicationStatus_STATUS(subject GeoPriorityReplicationStatus_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of GeoPriorityReplicationStatus_STATUS instances for property testing - lazily instantiated by
// GeoPriorityReplicationStatus_STATUSGenerator()
var geoPriorityReplicationStatus_STATUSGenerator gopter.Gen

// GeoPriorityReplicationStatus_STATUSGenerator returns a generator of GeoPriorityReplicationStatus_STATUS instances for property testing.
func GeoPriorityReplicationStatus_STATUSGenerator() gopter.Gen {
	if geoPriorityReplicationStatus_STATUSGenerator != nil {
		return geoPriorityReplicationStatus_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForGeoPriorityReplicationStatus_STATUS(generators)
	geoPriorityReplicationStatus_STATUSGenerator = gen.Struct(reflect.TypeOf(GeoPriorityReplicationStatus_STATUS{}), generators)
...
func AddIndependentPropertyGeneratorsForGeoReplicationStats_STATUS(gens map[string]gopter.Gen) {
	...
	gens["PostFailoverRedundancy"] = gen.PtrOf(gen.OneConstOf(PostFailoverRedundancy_STATUS_Standard_LRS, PostFailoverRedundancy_STATUS_Standard_ZRS))
	gens["PostPlannedFailoverRedundancy"] = gen.PtrOf(gen.OneConstOf(
		PostPlannedFailoverRedundancy_STATUS_Standard_GRS,
		PostPlannedFailoverRedundancy_STATUS_Standard_GZRS,
		PostPlannedFailoverRedundancy_STATUS_Standard_RAGRS,
		PostPlannedFailoverRedundancy_STATUS_Standard_RAGZRS))
	gens["Status"] = gen.PtrOf(gen.OneConstOf(GeoReplicationStatus_STATUS_Bootstrap, GeoReplicationStatus_STATUS_Live, GeoReplicationStatus_STATUS_Unavailable))
}
...
func AddRelatedPropertyGeneratorsForNetworkRuleSet_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Ipv6Rules"] = gen.SliceOf(IPRule_STATUSGenerator())
...
func Test_Placement_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Placement_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForPlacement_STATUS, Placement_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForPlacement_STATUS runs a test to see if a specific instance of Placement_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForPlacement_STATUS(subject Placement_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Placement_STATUS instances for property testing - lazily instantiated by Placement_STATUSGenerator()
var placement_STATUSGenerator gopter.Gen

// Placement_STATUSGenerator returns a generator of Placement_STATUS instances for property testing.
func Placement_STATUSGenerator() gopter.Gen {
	if placement_STATUSGenerator != nil {
		return placement_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForPlacement_STATUS(generators)
	placement_STATUSGenerator = gen.Struct(reflect.TypeOf(Placement_STATUS{}), generators)
...
func AddIndependentPropertyGeneratorsForPlacement_STATUS(gens map[string]gopter.Gen) {
	gens["ZonePlacementPolicy"] = gen.PtrOf(gen.OneConstOf(ZonePlacementPolicy_STATUS_Any, ZonePlacementPolicy_STATUS_None))
}
...
func AddIndependentPropertyGeneratorsForRoutingPreference_STATUS(gens map[string]gopter.Gen) {
	...
	gens["RoutingChoice"] = gen.PtrOf(gen.OneConstOf(RoutingChoice_STATUS_InternetRouting, RoutingChoice_STATUS_MicrosoftRouting))
}
...
func AddIndependentPropertyGeneratorsForSasPolicy_STATUS(gens map[string]gopter.Gen) {
	gens["ExpirationAction"] = gen.PtrOf(gen.OneConstOf(SasPolicy_ExpirationAction_STATUS_Block, SasPolicy_ExpirationAction_STATUS_Log))
...
func AddIndependentPropertyGeneratorsForSku_STATUS(gens map[string]gopter.Gen) {
	gens["Name"] = gen.PtrOf(gen.OneConstOf(
		SkuName_STATUS_PremiumV2_LRS,
		SkuName_STATUS_PremiumV2_ZRS,
		SkuName_STATUS_Premium_LRS,
		SkuName_STATUS_Premium_ZRS,
		SkuName_STATUS_StandardV2_GRS,
		SkuName_STATUS_StandardV2_GZRS,
		SkuName_STATUS_StandardV2_LRS,
		SkuName_STATUS_StandardV2_ZRS,
	...
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(SkuTier_STATUS_Premium, SkuTier_STATUS_Standard))
}
...
func Test_SmbOAuthSettings_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of SmbOAuthSettings_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForSmbOAuthSettings_STATUS, SmbOAuthSettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForSmbOAuthSettings_STATUS runs a test to see if a specific instance of SmbOAuthSettings_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForSmbOAuthSettings_STATUS(subject SmbOAuthSettings_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of SmbOAuthSettings_STATUS instances for property testing - lazily instantiated by
// SmbOAuthSettings_STATUSGenerator()
var smbOAuthSettings_STATUSGenerator gopter.Gen

// SmbOAuthSettings_STATUSGenerator returns a generator of SmbOAuthSettings_STATUS instances for property testing.
func SmbOAuthSettings_STATUSGenerator() gopter.Gen {
	if smbOAuthSettings_STATUSGenerator != nil {
		return smbOAuthSettings_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForSmbOAuthSettings_STATUS(generators)
	smbOAuthSettings_STATUSGenerator = gen.Struct(reflect.TypeOf(SmbOAuthSettings_STATUS{}), generators)

	return smbOAuthSettings_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForSmbOAuthSettings_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForSmbOAuthSettings_STATUS(gens map[string]gopter.Gen) {
...
func Test_StorageAccountIpv6Endpoints_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of StorageAccountIpv6Endpoints_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForStorageAccountIpv6Endpoints_STATUS, StorageAccountIpv6Endpoints_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForStorageAccountIpv6Endpoints_STATUS runs a test to see if a specific instance of StorageAccountIpv6Endpoints_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForStorageAccountIpv6Endpoints_STATUS(subject StorageAccountIpv6Endpoints_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of StorageAccountIpv6Endpoints_STATUS instances for property testing - lazily instantiated by
// StorageAccountIpv6Endpoints_STATUSGenerator()
var storageAccountIpv6Endpoints_STATUSGenerator gopter.Gen

// StorageAccountIpv6Endpoints_STATUSGenerator returns a generator of StorageAccountIpv6Endpoints_STATUS instances for property testing.
// We first initialize storageAccountIpv6Endpoints_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func StorageAccountIpv6Endpoints_STATUSGenerator() gopter.Gen {
	if storageAccountIpv6Endpoints_STATUSGenerator != nil {
		return storageAccountIpv6Endpoints_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS(generators)
	storageAccountIpv6Endpoints_STATUSGenerator = gen.Struct(reflect.TypeOf(StorageAccountIpv6Endpoints_STATUS{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS(generators)
	AddRelatedPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS(generators)
	storageAccountIpv6Endpoints_STATUSGenerator = gen.Struct(reflect.TypeOf(StorageAccountIpv6Endpoints_STATUS{}), generators)

	return storageAccountIpv6Endpoints_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS(gens map[string]gopter.Gen) {
	gens["Blob"] = gen.PtrOf(gen.AlphaString())
	gens["Dfs"] = gen.PtrOf(gen.AlphaString())
	gens["File"] = gen.PtrOf(gen.AlphaString())
	gens["Queue"] = gen.PtrOf(gen.AlphaString())
...
// AddRelatedPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForStorageAccountIpv6Endpoints_STATUS(gens map[string]gopter.Gen) {
	gens["InternetEndpoints"] = gen.PtrOf(StorageAccountInternetEndpoints_STATUSGenerator())
	gens["MicrosoftEndpoints"] = gen.PtrOf(StorageAccountMicrosoftEndpoints_STATUSGenerator())
}
...
func AddIndependentPropertyGeneratorsForStorageAccountProperties_STATUS(gens map[string]gopter.Gen) {
	gens["AccessTier"] = gen.PtrOf(gen.OneConstOf(
		AccessTier_STATUS_Cold,
		AccessTier_STATUS_Cool,
		AccessTier_STATUS_Hot,
		AccessTier_STATUS_Premium))
	gens["AccountMigrationInProgress"] = gen.PtrOf(gen.Bool())
	...
	gens["AllowedCopyScope"] = gen.PtrOf(gen.OneConstOf(AllowedCopyScope_STATUS_AAD, AllowedCopyScope_STATUS_PrivateLink))
	gens["CreationTime"] = gen.PtrOf(gen.AlphaString())
	gens["DefaultToOAuthAuthentication"] = gen.PtrOf(gen.Bool())
	gens["DnsEndpointType"] = gen.PtrOf(gen.OneConstOf(DnsEndpointType_STATUS_AzureDnsZone, DnsEndpointType_STATUS_Standard))
	...
	gens["IsSkuConversionBlocked"] = gen.PtrOf(gen.Bool())
	gens["LargeFileSharesState"] = gen.PtrOf(gen.OneConstOf(LargeFileSharesState_STATUS_Disabled, LargeFileSharesState_STATUS_Enabled))
	gens["LastGeoFailoverTime"] = gen.PtrOf(gen.AlphaString())
	gens["MinimumTlsVersion"] = gen.PtrOf(gen.OneConstOf(
		MinimumTlsVersion_STATUS_TLS1_0,
		MinimumTlsVersion_STATUS_TLS1_1,
		MinimumTlsVersion_STATUS_TLS1_2,
		MinimumTlsVersion_STATUS_TLS1_3))
	gens["PrimaryLocation"] = gen.PtrOf(gen.AlphaString())
	gens["ProvisioningState"] = gen.PtrOf(gen.OneConstOf(ProvisioningState_STATUS_Creating, ProvisioningState_STATUS_ResolvingDNS, ProvisioningState_STATUS_Succeeded))
	...
	gens["StatusOfPrimary"] = gen.PtrOf(gen.OneConstOf(AccountStatus_STATUS_Available, AccountStatus_STATUS_Unavailable))
	gens["StatusOfSecondary"] = gen.PtrOf(gen.OneConstOf(AccountStatus_STATUS_Available, AccountStatus_STATUS_Unavailable))
...
func AddRelatedPropertyGeneratorsForStorageAccountProperties_STATUS(gens map[string]gopter.Gen) {
	...
	gens["DualStackEndpointPreference"] = gen.PtrOf(DualStackEndpointPreference_STATUSGenerator())
	gens["Encryption"] = gen.PtrOf(Encryption_STATUSGenerator())
	gens["GeoPriorityReplicationStatus"] = gen.PtrOf(GeoPriorityReplicationStatus_STATUSGenerator())
...
func AddIndependentPropertyGeneratorsForStorageAccountSkuConversionStatus_STATUS(gens map[string]gopter.Gen) {
	...
	gens["SkuConversionStatus"] = gen.PtrOf(gen.OneConstOf(SkuConversionStatus_STATUS_Failed, SkuConversionStatus_STATUS_InProgress, SkuConversionStatus_STATUS_Succeeded))
...
func AddIndependentPropertyGeneratorsForStorageAccount_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Kind"] = gen.PtrOf(gen.OneConstOf(
		Kind_STATUS_BlobStorage,
		Kind_STATUS_BlockBlobStorage,
		Kind_STATUS_FileStorage,
		Kind_STATUS_Storage,
		Kind_STATUS_StorageV2))
...
func AddRelatedPropertyGeneratorsForStorageAccount_STATUS(gens map[string]gopter.Gen) {
	...
	gens["Placement"] = gen.PtrOf(Placement_STATUSGenerator())
...
func AddIndependentPropertyGeneratorsForVirtualNetworkRule_STATUS(gens map[string]gopter.Gen) {
	...
	gens["State"] = gen.PtrOf(gen.OneConstOf(
		State_STATUS_Deprovisioning,
		State_STATUS_Failed,
		State_STATUS_NetworkSourceDeleted,
		State_STATUS_Provisioning,
		State_STATUS_Succeeded))
}
