...
func AddIndependentPropertyGeneratorsForStorageAccountsFileServicesShare_STATUS(gens map[string]gopter.Gen) {
	...
	gens["NextAllowedProvisionedBandwidthDowngradeTime"] = gen.PtrOf(gen.AlphaString())
	gens["NextAllowedProvisionedIopsDowngradeTime"] = gen.PtrOf(gen.AlphaString())
	gens["NextAllowedQuotaDowngradeTime"] = gen.PtrOf(gen.AlphaString())
