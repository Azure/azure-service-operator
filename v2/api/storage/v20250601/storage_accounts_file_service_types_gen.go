...
func (settings *ProtocolSettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "Nfs":
	if settings.Nfs != nil {
		nfs_ARM, err := settings.Nfs.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		nfs := *nfs_ARM.(*arm.NfsSetting)
		result.Nfs = &nfs
	}
...
func (settings *ProtocolSettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Nfs":
	if typedInput.Nfs != nil {
		var nfs1 NfsSetting
		err := nfs1.PopulateFromARM(owner, *typedInput.Nfs)
		if err != nil {
			return err
		}
		nfs := nfs1
...
func (settings *ProtocolSettings) AssignProperties_From_ProtocolSettings(source *storage.ProtocolSettings) error {
	...
	if source.Nfs != nil {
		var nf NfsSetting
		err := nf.AssignProperties_From_NfsSetting(source.Nfs)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_NfsSetting() to populate field Nfs")
		}
		settings.Nfs = &nf
	} else {
		settings.Nfs = nil
...
func (settings *ProtocolSettings) AssignProperties_To_ProtocolSettings(destination *storage.ProtocolSettings) error {
	...
	if settings.Nfs != nil {
		...
		err := settings.Nfs.AssignProperties_To_NfsSetting(&nf)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_NfsSetting() to populate field Nfs")
		}
		destination.Nfs = &nf
	} else {
		destination.Nfs = nil
...
func (settings *ProtocolSettings) Initialize_From_ProtocolSettings_STATUS(source *ProtocolSettings_STATUS) error {
	...
	if source.Nfs != nil {
		var nf NfsSetting
		err := nf.Initialize_From_NfsSetting_STATUS(source.Nfs)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_NfsSetting_STATUS() to populate field Nfs")
		}
		settings.Nfs = &nf
	} else {
		settings.Nfs = nil
...
func (settings *ProtocolSettings_STATUS) AssignProperties_From_ProtocolSettings_STATUS(source *storage.ProtocolSettings_STATUS) error {
	...
	// Nfs
	if source.Nfs != nil {
		var nf NfsSetting_STATUS
		err := nf.AssignProperties_From_NfsSetting_STATUS(source.Nfs)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_NfsSetting_STATUS() to populate field Nfs")
		}
		settings.Nfs = &nf
	} else {
		settings.Nfs = nil
...
func (settings *ProtocolSettings_STATUS) AssignProperties_To_ProtocolSettings_STATUS(destination *storage.ProtocolSettings_STATUS) error {
	...
	if settings.Nfs != nil {
		...
		err := settings.Nfs.AssignProperties_To_NfsSetting_STATUS(&nf)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_NfsSetting_STATUS() to populate field Nfs")
		}
		destination.Nfs = &nf
	} else {
		destination.Nfs = nil
...
var _ genruntime.ARMTransformer = &NfsSetting{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (setting *NfsSetting) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if setting == nil {
		return nil, nil
	}
	result := &arm.NfsSetting{}

	// Set property "EncryptionInTransit":
	if setting.EncryptionInTransit != nil {
		encryptionInTransit_ARM, err := setting.EncryptionInTransit.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		encryptionInTransit := *encryptionInTransit_ARM.(*arm.EncryptionInTransit)
		result.EncryptionInTransit = &encryptionInTransit
	}
	return result, nil
}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (setting *NfsSetting) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NfsSetting{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (setting *NfsSetting) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NfsSetting)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NfsSetting, got %T", armInput)
	}

	// Set property "EncryptionInTransit":
	if typedInput.EncryptionInTransit != nil {
		var encryptionInTransit1 EncryptionInTransit
		err := encryptionInTransit1.PopulateFromARM(owner, *typedInput.EncryptionInTransit)
		if err != nil {
			return err
		}
		encryptionInTransit := encryptionInTransit1
		setting.EncryptionInTransit = &encryptionInTransit
	}
...
// AssignProperties_From_NfsSetting populates our NfsSetting from the provided source NfsSetting
func (setting *NfsSetting) AssignProperties_From_NfsSetting(source *storage.NfsSetting) error {

	// EncryptionInTransit
	if source.EncryptionInTransit != nil {
		var encryptionInTransit EncryptionInTransit
		err := encryptionInTransit.AssignProperties_From_EncryptionInTransit(source.EncryptionInTransit)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_EncryptionInTransit() to populate field EncryptionInTransit")
		}
		setting.EncryptionInTransit = &encryptionInTransit
	} else {
		setting.EncryptionInTransit = nil
	}
...
// AssignProperties_To_NfsSetting populates the provided destination NfsSetting from our NfsSetting
func (setting *NfsSetting) AssignProperties_To_NfsSetting(destination *storage.NfsSetting) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if setting.EncryptionInTransit != nil {
		...
		err := setting.EncryptionInTransit.AssignProperties_To_EncryptionInTransit(&encryptionInTransit)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_EncryptionInTransit() to populate field EncryptionInTransit")
		}
...
// Initialize_From_NfsSetting_STATUS populates our NfsSetting from the provided source NfsSetting_STATUS
func (setting *NfsSetting) Initialize_From_NfsSetting_STATUS(source *NfsSetting_STATUS) error {

	// EncryptionInTransit
	if source.EncryptionInTransit != nil {
		var encryptionInTransit EncryptionInTransit
		err := encryptionInTransit.Initialize_From_EncryptionInTransit_STATUS(source.EncryptionInTransit)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_EncryptionInTransit_STATUS() to populate field EncryptionInTransit")
		}
		setting.EncryptionInTransit = &encryptionInTransit
	} else {
		setting.EncryptionInTransit = nil
...
var _ genruntime.FromARMConverter = &NfsSetting_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (setting *NfsSetting_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.NfsSetting_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (setting *NfsSetting_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.NfsSetting_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.NfsSetting_STATUS, got %T", armInput)
	}

	// Set property "EncryptionInTransit":
	if typedInput.EncryptionInTransit != nil {
		var encryptionInTransit1 EncryptionInTransit_STATUS
		err := encryptionInTransit1.PopulateFromARM(owner, *typedInput.EncryptionInTransit)
		if err != nil {
			return err
		}
...
// AssignProperties_From_NfsSetting_STATUS populates our NfsSetting_STATUS from the provided source NfsSetting_STATUS
func (setting *NfsSetting_STATUS) AssignProperties_From_NfsSetting_STATUS(source *storage.NfsSetting_STATUS) error {

	// EncryptionInTransit
	if source.EncryptionInTransit != nil {
		var encryptionInTransit EncryptionInTransit_STATUS
		err := encryptionInTransit.AssignProperties_From_EncryptionInTransit_STATUS(source.EncryptionInTransit)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_EncryptionInTransit_STATUS() to populate field EncryptionInTransit")
		}
		setting.EncryptionInTransit = &encryptionInTransit
	} else {
		setting.EncryptionInTransit = nil
...
// AssignProperties_To_NfsSetting_STATUS populates the provided destination NfsSetting_STATUS from our NfsSetting_STATUS
func (setting *NfsSetting_STATUS) AssignProperties_To_NfsSetting_STATUS(destination *storage.NfsSetting_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	if setting.EncryptionInTransit != nil {
		...
		err := setting.EncryptionInTransit.AssignProperties_To_EncryptionInTransit_STATUS(&encryptionInTransit)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_EncryptionInTransit_STATUS() to populate field EncryptionInTransit")
		}
		destination.EncryptionInTransit = &encryptionInTransit
	} else {
		destination.EncryptionInTransit = nil
...
var _ genruntime.ARMTransformer = &EncryptionInTransit{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (transit *EncryptionInTransit) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if transit == nil {
		return nil, nil
	}
	result := &arm.EncryptionInTransit{}

	// Set property "Required":
	if transit.Required != nil {
		required := *transit.Required
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (transit *EncryptionInTransit) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.EncryptionInTransit{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (transit *EncryptionInTransit) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.EncryptionInTransit)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.EncryptionInTransit, got %T", armInput)
	}

	// Set property "Required":
	if typedInput.Required != nil {
		required := *typedInput.Required
		transit.Required = &required
	}
...
// AssignProperties_From_EncryptionInTransit populates our EncryptionInTransit from the provided source EncryptionInTransit
func (transit *EncryptionInTransit) AssignProperties_From_EncryptionInTransit(source *storage.EncryptionInTransit) error {
...
// AssignProperties_To_EncryptionInTransit populates the provided destination EncryptionInTransit from our EncryptionInTransit
func (transit *EncryptionInTransit) AssignProperties_To_EncryptionInTransit(destination *storage.EncryptionInTransit) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// Initialize_From_EncryptionInTransit_STATUS populates our EncryptionInTransit from the provided source EncryptionInTransit_STATUS
func (transit *EncryptionInTransit) Initialize_From_EncryptionInTransit_STATUS(source *EncryptionInTransit_STATUS) error {
...
var _ genruntime.FromARMConverter = &EncryptionInTransit_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (transit *EncryptionInTransit_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.EncryptionInTransit_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (transit *EncryptionInTransit_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.EncryptionInTransit_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.EncryptionInTransit_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_EncryptionInTransit_STATUS populates our EncryptionInTransit_STATUS from the provided source EncryptionInTransit_STATUS
func (transit *EncryptionInTransit_STATUS) AssignProperties_From_EncryptionInTransit_STATUS(source *storage.EncryptionInTransit_STATUS) error {
...
// AssignProperties_To_EncryptionInTransit_STATUS populates the provided destination EncryptionInTransit_STATUS from our EncryptionInTransit_STATUS
func (transit *EncryptionInTransit_STATUS) AssignProperties_To_EncryptionInTransit_STATUS(destination *storage.EncryptionInTransit_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
