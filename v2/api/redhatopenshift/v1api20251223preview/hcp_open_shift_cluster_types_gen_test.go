...
func RunPropertyAssignmentTestForApiProfile(subject ApiProfile) string {
	...
	var other v20251223ps.ApiProfile
...
func RunPropertyAssignmentTestForApiProfile_STATUS(subject ApiProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ApiProfile_STATUS
...
func RunPropertyAssignmentTestForClusterAutoscalingProfile(subject ClusterAutoscalingProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ClusterAutoscalingProfile
...
func RunPropertyAssignmentTestForClusterAutoscalingProfile_STATUS(subject ClusterAutoscalingProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ClusterAutoscalingProfile_STATUS
...
func RunPropertyAssignmentTestForClusterImageRegistryProfile(subject ClusterImageRegistryProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ClusterImageRegistryProfile
...
func RunPropertyAssignmentTestForClusterImageRegistryProfile_STATUS(subject ClusterImageRegistryProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ClusterImageRegistryProfile_STATUS
...
func RunPropertyAssignmentTestForCustomerManagedEncryptionProfile(subject CustomerManagedEncryptionProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.CustomerManagedEncryptionProfile
...
func RunPropertyAssignmentTestForCustomerManagedEncryptionProfile_STATUS(subject CustomerManagedEncryptionProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.CustomerManagedEncryptionProfile_STATUS
...
func RunPropertyAssignmentTestForDnsProfile(subject DnsProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.DnsProfile
...
func RunPropertyAssignmentTestForDnsProfile_STATUS(subject DnsProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.DnsProfile_STATUS
...
func RunPropertyAssignmentTestForEtcdDataEncryptionProfile(subject EtcdDataEncryptionProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.EtcdDataEncryptionProfile
...
func RunPropertyAssignmentTestForEtcdDataEncryptionProfile_STATUS(subject EtcdDataEncryptionProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.EtcdDataEncryptionProfile_STATUS
...
func RunPropertyAssignmentTestForEtcdProfile(subject EtcdProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.EtcdProfile
...
func RunPropertyAssignmentTestForEtcdProfile_STATUS(subject EtcdProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.EtcdProfile_STATUS
...
func RunResourceConversionTestForHcpOpenShiftCluster(subject HcpOpenShiftCluster) string {
	...
	var hub v20240610ps.HcpOpenShiftCluster
...
func RunPropertyAssignmentTestForHcpOpenShiftCluster(subject HcpOpenShiftCluster) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftCluster
...
func RunPropertyAssignmentTestForHcpOpenShiftClusterOperatorSecrets(subject HcpOpenShiftClusterOperatorSecrets) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftClusterOperatorSecrets
...
func RunPropertyAssignmentTestForHcpOpenShiftClusterOperatorSpec(subject HcpOpenShiftClusterOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftClusterOperatorSpec
...
func RunPropertyAssignmentTestForHcpOpenShiftClusterProperties(subject HcpOpenShiftClusterProperties) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftClusterProperties
...
func RunPropertyAssignmentTestForHcpOpenShiftClusterProperties_STATUS(subject HcpOpenShiftClusterProperties_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftClusterProperties_STATUS
...
func RunPropertyAssignmentTestForHcpOpenShiftCluster_STATUS(subject HcpOpenShiftCluster_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftCluster_STATUS
...
func RunPropertyAssignmentTestForHcpOpenShiftCluster_Spec(subject HcpOpenShiftCluster_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.HcpOpenShiftCluster_Spec
...
func Test_ImageDigestMirror_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ImageDigestMirror to ImageDigestMirror via AssignProperties_To_ImageDigestMirror & AssignProperties_From_ImageDigestMirror returns original",
		prop.ForAll(RunPropertyAssignmentTestForImageDigestMirror, ImageDigestMirrorGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForImageDigestMirror tests if a specific instance of ImageDigestMirror can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForImageDigestMirror(subject ImageDigestMirror) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ImageDigestMirror
...
func AddIndependentPropertyGeneratorsForImageDigestMirror(gens map[string]gopter.Gen) {
	gens["Mirrors"] = gen.SliceOf(gen.AlphaString().Map(func(it string) ImageRepository {
		return ImageRepository(it)
	}))
	gens["Source"] = gen.PtrOf(gen.AlphaString().Map(func(it string) ImageRepository {
		return ImageRepository(it)
	}))
}
...
func Test_ImageDigestMirror_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ImageDigestMirror_STATUS to ImageDigestMirror_STATUS via AssignProperties_To_ImageDigestMirror_STATUS & AssignProperties_From_ImageDigestMirror_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForImageDigestMirror_STATUS, ImageDigestMirror_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForImageDigestMirror_STATUS tests if a specific instance of ImageDigestMirror_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForImageDigestMirror_STATUS(subject ImageDigestMirror_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ImageDigestMirror_STATUS
...
func AddIndependentPropertyGeneratorsForImageDigestMirror_STATUS(gens map[string]gopter.Gen) {
	gens["Mirrors"] = gen.SliceOf(gen.AlphaString().Map(func(it string) ImageRepository_STATUS {
		return ImageRepository_STATUS(it)
	}))
	gens["Source"] = gen.PtrOf(gen.AlphaString().Map(func(it string) ImageRepository_STATUS {
		return ImageRepository_STATUS(it)
	}))
}
...
func RunPropertyAssignmentTestForKmsEncryptionProfile(subject KmsEncryptionProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.KmsEncryptionProfile
...
func RunPropertyAssignmentTestForKmsEncryptionProfile_STATUS(subject KmsEncryptionProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.KmsEncryptionProfile_STATUS
...
func AddIndependentPropertyGeneratorsForKmsEncryptionProfile_STATUS(gens map[string]gopter.Gen) {
	gens["VaultName"] = gen.PtrOf(gen.AlphaString())
	gens["Visibility"] = gen.PtrOf(gen.OneConstOf(KeyVaultVisibility_STATUS_Private, KeyVaultVisibility_STATUS_Public))
}
...
func RunPropertyAssignmentTestForKmsKey_STATUS(subject KmsKey_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.KmsKey_STATUS
...
func RunPropertyAssignmentTestForManagedServiceIdentity(subject ManagedServiceIdentity) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ManagedServiceIdentity
...
func RunPropertyAssignmentTestForManagedServiceIdentity_STATUS(subject ManagedServiceIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.ManagedServiceIdentity_STATUS
...
func RunPropertyAssignmentTestForOperatorsAuthenticationProfile(subject OperatorsAuthenticationProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.OperatorsAuthenticationProfile
...
func RunPropertyAssignmentTestForOperatorsAuthenticationProfile_STATUS(subject OperatorsAuthenticationProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.OperatorsAuthenticationProfile_STATUS
...
func RunPropertyAssignmentTestForPlatformProfile(subject PlatformProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.PlatformProfile
...
func RunPropertyAssignmentTestForPlatformProfile_STATUS(subject PlatformProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.PlatformProfile_STATUS
...
func RunPropertyAssignmentTestForUserAssignedIdentitiesProfile(subject UserAssignedIdentitiesProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.UserAssignedIdentitiesProfile
...
func RunPropertyAssignmentTestForUserAssignedIdentitiesProfile_STATUS(subject UserAssignedIdentitiesProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.UserAssignedIdentitiesProfile_STATUS
...
func RunPropertyAssignmentTestForUserAssignedIdentityDetails(subject UserAssignedIdentityDetails) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.UserAssignedIdentityDetails
...
func RunPropertyAssignmentTestForUserAssignedIdentity_STATUS(subject UserAssignedIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.UserAssignedIdentity_STATUS
...
func RunPropertyAssignmentTestForVersionProfile(subject VersionProfile) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.VersionProfile
...
func RunPropertyAssignmentTestForVersionProfile_STATUS(subject VersionProfile_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v20251223ps.VersionProfile_STATUS
