...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/redhatopenshift/v1api20251223preview/arm"
...
type HcpOpenShiftClusterProperties struct {
	...
	// +kubebuilder:validation:MaxItems=240
...
func (properties *HcpOpenShiftClusterProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "ImageDigestMirrors":
	for _, item := range properties.ImageDigestMirrors {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.ImageDigestMirrors = append(result.ImageDigestMirrors, *item_ARM.(*arm.ImageDigestMirror))
	}
...
func (properties *HcpOpenShiftClusterProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "ImageDigestMirrors":
	for _, item := range typedInput.ImageDigestMirrors {
		var item1 ImageDigestMirror
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		properties.ImageDigestMirrors = append(properties.ImageDigestMirrors, item1)
	}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_From_HcpOpenShiftClusterProperties(source *storage.HcpOpenShiftClusterProperties) error {
	...
	if source.ImageDigestMirrors != nil {
		...
		for imageDigestMirrorIndex, imageDigestMirrorItem := range source.ImageDigestMirrors {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_ImageDigestMirror() to populate field ImageDigestMirrors")
			}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_To_HcpOpenShiftClusterProperties(destination *storage.HcpOpenShiftClusterProperties) error {
	...
	if properties.ImageDigestMirrors != nil {
		...
		for imageDigestMirrorIndex, imageDigestMirrorItem := range properties.ImageDigestMirrors {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_ImageDigestMirror() to populate field ImageDigestMirrors")
			}
			imageDigestMirrorList[imageDigestMirrorIndex] = imageDigestMirror
		}
		destination.ImageDigestMirrors = imageDigestMirrorList
	} else {
		destination.ImageDigestMirrors = nil
	}
...
func (properties *HcpOpenShiftClusterProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "ImageDigestMirrors":
	for _, item := range typedInput.ImageDigestMirrors {
		var item1 ImageDigestMirror_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
...
func (properties *HcpOpenShiftClusterProperties_STATUS) AssignProperties_From_HcpOpenShiftClusterProperties_STATUS(source *storage.HcpOpenShiftClusterProperties_STATUS) error {
	...
	if source.ImageDigestMirrors != nil {
		...
		for imageDigestMirrorIndex, imageDigestMirrorItem := range source.ImageDigestMirrors {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_ImageDigestMirror_STATUS() to populate field ImageDigestMirrors")
			}
			imageDigestMirrorList[imageDigestMirrorIndex] = imageDigestMirror
		}
		properties.ImageDigestMirrors = imageDigestMirrorList
...
func (properties *HcpOpenShiftClusterProperties_STATUS) AssignProperties_To_HcpOpenShiftClusterProperties_STATUS(destination *storage.HcpOpenShiftClusterProperties_STATUS) error {
	...
	if properties.ImageDigestMirrors != nil {
		...
		for imageDigestMirrorIndex, imageDigestMirrorItem := range properties.ImageDigestMirrors {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_ImageDigestMirror_STATUS() to populate field ImageDigestMirrors")
			}
			imageDigestMirrorList[imageDigestMirrorIndex] = imageDigestMirror
		}
		destination.ImageDigestMirrors = imageDigestMirrorList
...
type ImageDigestMirror struct {
	...
	// Mirrors: Mirrors are one or more image repositories that may also contain the same images.
	Mirrors []ImageRepository `json:"mirrors,omitempty"`

	// +kubebuilder:validation:Required
	// Source: Source is the image repository that users refer to, e.g. in image pull specifications.
	Source *ImageRepository `json:"source,omitempty"`
}

var _ genruntime.ARMTransformer = &ImageDigestMirror{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (mirror *ImageDigestMirror) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if mirror == nil {
		return nil, nil
	}
	result := &arm.ImageDigestMirror{}

	// Set property "Mirrors":
	for _, item := range mirror.Mirrors {
		result.Mirrors = append(result.Mirrors, string(item))
	}

	// Set property "Source":
	if mirror.Source != nil {
		source := string(*mirror.Source)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (mirror *ImageDigestMirror) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ImageDigestMirror{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (mirror *ImageDigestMirror) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ImageDigestMirror)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ImageDigestMirror, got %T", armInput)
	}

	// Set property "Mirrors":
	for _, item := range typedInput.Mirrors {
		mirror.Mirrors = append(mirror.Mirrors, ImageRepository(item))
	}

	// Set property "Source":
	if typedInput.Source != nil {
		source := ImageRepository(*typedInput.Source)
...
// AssignProperties_From_ImageDigestMirror populates our ImageDigestMirror from the provided source ImageDigestMirror
func (mirror *ImageDigestMirror) AssignProperties_From_ImageDigestMirror(source *storage.ImageDigestMirror) error {
...
// AssignProperties_To_ImageDigestMirror populates the provided destination ImageDigestMirror from our ImageDigestMirror
func (mirror *ImageDigestMirror) AssignProperties_To_ImageDigestMirror(destination *storage.ImageDigestMirror) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Mirrors
	if mirror.Mirrors != nil {
		mirrorList := make([]string, len(mirror.Mirrors))
		for mirrorIndex, mirrorItem := range mirror.Mirrors {
			// Shadow the loop variable to avoid aliasing
			mirrorItem := mirrorItem
			mirrorList[mirrorIndex] = string(mirrorItem)
		}
		destination.Mirrors = mirrorList
	} else {
		destination.Mirrors = nil
	}
...
type ImageDigestMirror_STATUS struct {
	...
	// +kubebuilder:validation:MinItems=1
	// Mirrors: Mirrors are one or more image repositories that may also contain the same images.
	Mirrors []ImageRepository_STATUS `json:"mirrors,omitempty"`

	// +kubebuilder:validation:Required
	// Source: Source is the image repository that users refer to, e.g. in image pull specifications.
	Source *ImageRepository_STATUS `json:"source,omitempty"`
}

var _ genruntime.FromARMConverter = &ImageDigestMirror_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (mirror *ImageDigestMirror_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ImageDigestMirror_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (mirror *ImageDigestMirror_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.ImageDigestMirror_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.ImageDigestMirror_STATUS, got %T", armInput)
	}

	// Set property "Mirrors":
	for _, item := range typedInput.Mirrors {
		mirror.Mirrors = append(mirror.Mirrors, ImageRepository_STATUS(item))
	}

	// Set property "Source":
	if typedInput.Source != nil {
		source := ImageRepository_STATUS(*typedInput.Source)
		mirror.Source = &source
	}
...
// AssignProperties_From_ImageDigestMirror_STATUS populates our ImageDigestMirror_STATUS from the provided source ImageDigestMirror_STATUS
func (mirror *ImageDigestMirror_STATUS) AssignProperties_From_ImageDigestMirror_STATUS(source *storage.ImageDigestMirror_STATUS) error {

	// Mirrors
	if source.Mirrors != nil {
		mirrorList := make([]ImageRepository_STATUS, len(source.Mirrors))
		for mirrorIndex, mirrorItem := range source.Mirrors {
			// Shadow the loop variable to avoid aliasing
			mirrorItem := mirrorItem
			mirrorList[mirrorIndex] = ImageRepository_STATUS(mirrorItem)
		}
		mirror.Mirrors = mirrorList
	} else {
		mirror.Mirrors = nil
	...
	// Source
	if source.Source != nil {
		sourceTemp := ImageRepository_STATUS(*source.Source)
		mirror.Source = &sourceTemp
	} else {
		mirror.Source = nil
	}
...
// AssignProperties_To_ImageDigestMirror_STATUS populates the provided destination ImageDigestMirror_STATUS from our ImageDigestMirror_STATUS
func (mirror *ImageDigestMirror_STATUS) AssignProperties_To_ImageDigestMirror_STATUS(destination *storage.ImageDigestMirror_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (profile *PlatformProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "VnetIntegrationSubnetId":
	if profile.VnetIntegrationSubnetReference != nil {
		vnetIntegrationSubnetReferenceARMID, err := resolved.ResolvedReferences.Lookup(*profile.VnetIntegrationSubnetReference)
		if err != nil {
			return nil, err
		}
		vnetIntegrationSubnetReference := vnetIntegrationSubnetReferenceARMID
		result.VnetIntegrationSubnetId = &vnetIntegrationSubnetReference
	}
	return result, nil
}
...
func (profile *PlatformProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// no assignment for property "VnetIntegrationSubnetReference"
...
func (profile *PlatformProfile) AssignProperties_From_PlatformProfile(source *storage.PlatformProfile) error {
	...
	if source.VnetIntegrationSubnetReference != nil {
		vnetIntegrationSubnetReference := source.VnetIntegrationSubnetReference.Copy()
...
func (profile *PlatformProfile) AssignProperties_To_PlatformProfile(destination *storage.PlatformProfile) error {
	...
	// VnetIntegrationSubnetReference
	if profile.VnetIntegrationSubnetReference != nil {
		vnetIntegrationSubnetReference := profile.VnetIntegrationSubnetReference.Copy()
		destination.VnetIntegrationSubnetReference = &vnetIntegrationSubnetReference
	} else {
		destination.VnetIntegrationSubnetReference = nil
	}
...
func (profile *PlatformProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "VnetIntegrationSubnetId":
	if typedInput.VnetIntegrationSubnetId != nil {
		vnetIntegrationSubnetId := *typedInput.VnetIntegrationSubnetId
...
func (profile *PlatformProfile_STATUS) AssignProperties_From_PlatformProfile_STATUS(source *storage.PlatformProfile_STATUS) error {
	...
	profile.VnetIntegrationSubnetId = genruntime.ClonePointerToString(source.VnetIntegrationSubnetId)
...
func (profile *PlatformProfile_STATUS) AssignProperties_To_PlatformProfile_STATUS(destination *storage.PlatformProfile_STATUS) error {
	...
	// VnetIntegrationSubnetId
	destination.VnetIntegrationSubnetId = genruntime.ClonePointerToString(profile.VnetIntegrationSubnetId)
...
// +kubebuilder:validation:MaxLength=255
type ImageRepository_STATUS string
...
func (profile *KmsEncryptionProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if profile.Visibility != nil {
		var temp string
		temp = string(*profile.Visibility)
		visibility := arm.KeyVaultVisibility(temp)
		result.Visibility = &visibility
	}
	return result, nil
}
...
func (profile *KmsEncryptionProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Visibility != nil {
		var temp string
		temp = string(*typedInput.Visibility)
		visibility := KeyVaultVisibility(temp)
		profile.Visibility = &visibility
	}
...
func (profile *KmsEncryptionProfile) AssignProperties_From_KmsEncryptionProfile(source *storage.KmsEncryptionProfile) error {
	...
	if source.Visibility != nil {
		visibility := *source.Visibility
		visibilityTemp := genruntime.ToEnum(visibility, keyVaultVisibility_Values)
		profile.Visibility = &visibilityTemp
	} else {
		profile.Visibility = nil
	}
...
func (profile *KmsEncryptionProfile) AssignProperties_To_KmsEncryptionProfile(destination *storage.KmsEncryptionProfile) error {
	...
	// VaultName
	destination.VaultName = genruntime.ClonePointerToString(profile.VaultName)
...
type KmsEncryptionProfile_STATUS struct {
	...
	// Visibility: visibility of the keyvault that contains the secret.
	Visibility *KeyVaultVisibility_STATUS `json:"visibility,omitempty"`
}
...
func (profile *KmsEncryptionProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Visibility != nil {
		var temp string
		temp = string(*typedInput.Visibility)
		visibility := KeyVaultVisibility_STATUS(temp)
		profile.Visibility = &visibility
	}
...
func (profile *KmsEncryptionProfile_STATUS) AssignProperties_From_KmsEncryptionProfile_STATUS(source *storage.KmsEncryptionProfile_STATUS) error {
	...
	if source.Visibility != nil {
		visibility := *source.Visibility
		visibilityTemp := genruntime.ToEnum(visibility, keyVaultVisibility_STATUS_Values)
		profile.Visibility = &visibilityTemp
	} else {
		profile.Visibility = nil
	}
...
const (
	KeyVaultVisibility_Private = KeyVaultVisibility("Private")
	KeyVaultVisibility_Public  = KeyVaultVisibility("Public")
)

// Mapping from string to KeyVaultVisibility
var keyVaultVisibility_Values = map[string]KeyVaultVisibility{
	"private": KeyVaultVisibility_Private,
	"public":  KeyVaultVisibility_Public,
}

// The internet visibility of a keyvault resource
type KeyVaultVisibility_STATUS string

const (
	KeyVaultVisibility_STATUS_Private = KeyVaultVisibility_STATUS("Private")
	KeyVaultVisibility_STATUS_Public  = KeyVaultVisibility_STATUS("Public")
)

// Mapping from string to KeyVaultVisibility_STATUS
var keyVaultVisibility_STATUS_Values = map[string]KeyVaultVisibility_STATUS{
	"private": KeyVaultVisibility_STATUS_Private,
	"public":  KeyVaultVisibility_STATUS_Public,
}
