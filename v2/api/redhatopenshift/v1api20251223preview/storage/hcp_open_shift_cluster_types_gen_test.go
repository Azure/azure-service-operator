...
func AddRelatedPropertyGeneratorsForHcpOpenShiftClusterProperties(gens map[string]gopter.Gen) {
	...
	gens["ImageDigestMirrors"] = gen.SliceOf(ImageDigestMirrorGenerator())
...
func AddRelatedPropertyGeneratorsForHcpOpenShiftClusterProperties_STATUS(gens map[string]gopter.Gen) {
	...
	gens["ImageDigestMirrors"] = gen.SliceOf(ImageDigestMirror_STATUSGenerator())
...
func Test_ImageDigestMirror_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ImageDigestMirror via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForImageDigestMirror, ImageDigestMirrorGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}
...
func RunJSONSerializationTestForImageDigestMirror(subject ImageDigestMirror) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
var imageDigestMirrorGenerator gopter.Gen

// ImageDigestMirrorGenerator returns a generator of ImageDigestMirror instances for property testing.
func ImageDigestMirrorGenerator() gopter.Gen {
	if imageDigestMirrorGenerator != nil {
		return imageDigestMirrorGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImageDigestMirror(generators)
	imageDigestMirrorGenerator = gen.Struct(reflect.TypeOf(ImageDigestMirror{}), generators)

	return imageDigestMirrorGenerator
}

// AddIndependentPropertyGeneratorsForImageDigestMirror is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForImageDigestMirror(gens map[string]gopter.Gen) {
	gens["Mirrors"] = gen.SliceOf(gen.AlphaString())
...
func Test_ImageDigestMirror_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ImageDigestMirror_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForImageDigestMirror_STATUS, ImageDigestMirror_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}
...
func RunJSONSerializationTestForImageDigestMirror_STATUS(subject ImageDigestMirror_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
var imageDigestMirror_STATUSGenerator gopter.Gen

// ImageDigestMirror_STATUSGenerator returns a generator of ImageDigestMirror_STATUS instances for property testing.
func ImageDigestMirror_STATUSGenerator() gopter.Gen {
	if imageDigestMirror_STATUSGenerator != nil {
		return imageDigestMirror_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForImageDigestMirror_STATUS(generators)
	imageDigestMirror_STATUSGenerator = gen.Struct(reflect.TypeOf(ImageDigestMirror_STATUS{}), generators)

	return imageDigestMirror_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForImageDigestMirror_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForImageDigestMirror_STATUS(gens map[string]gopter.Gen) {
	gens["Mirrors"] = gen.SliceOf(gen.AlphaString())
	gens["Source"] = gen.PtrOf(gen.AlphaString())
}
...
// We first initialize kmsEncryptionProfileGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func KmsEncryptionProfileGenerator() gopter.Gen {
	...
	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForKmsEncryptionProfile(generators)
...
// AddIndependentPropertyGeneratorsForKmsEncryptionProfile is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForKmsEncryptionProfile(gens map[string]gopter.Gen) {
...
// We first initialize kmsEncryptionProfile_STATUSGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func KmsEncryptionProfile_STATUSGenerator() gopter.Gen {
	...
	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForKmsEncryptionProfile_STATUS(generators)
...
// AddIndependentPropertyGeneratorsForKmsEncryptionProfile_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForKmsEncryptionProfile_STATUS(gens map[string]gopter.Gen) {
	gens["VaultName"] = gen.PtrOf(gen.AlphaString())
	gens["Visibility"] = gen.PtrOf(gen.AlphaString())
}
...
func AddIndependentPropertyGeneratorsForPlatformProfile_STATUS(gens map[string]gopter.Gen) {
	...
	gens["VnetIntegrationSubnetId"] = gen.PtrOf(gen.AlphaString())
}
