...
func (pool *HcpOpenShiftClustersNodePool) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected redhatopenshift/v20260901preview/storage/HcpOpenShiftClustersNodePool but received %T instead", hub)
	}
...
type HcpOpenShiftClustersNodePool_Spec struct {
	// +kubebuilder:validation:Pattern="^[a-zA-Z]([-a-zA-Z0-9]{0,13}[a-zA-Z0-9])?$"
...
type NodePoolProperties_STATUS struct {
	...
	Status *ResourceStatus_STATUS `json:"status,omitempty"`
...
func (properties *NodePoolProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Status != nil {
		var status1 ResourceStatus_STATUS
...
func (properties *NodePoolProperties_STATUS) AssignProperties_From_NodePoolProperties_STATUS(source *storage.NodePoolProperties_STATUS) error {
	...
	if source.Status != nil {
		var status ResourceStatus_STATUS
		err := status.AssignProperties_From_ResourceStatus_STATUS(source.Status)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_ResourceStatus_STATUS() to populate field Status")
		}
		properties.Status = &status
	} else {
...
func (properties *NodePoolProperties_STATUS) AssignProperties_To_NodePoolProperties_STATUS(destination *storage.NodePoolProperties_STATUS) error {
	...
	if properties.Status != nil {
		var status storage.ResourceStatus_STATUS
		err := properties.Status.AssignProperties_To_ResourceStatus_STATUS(&status)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_ResourceStatus_STATUS() to populate field Status")
		}
		destination.Status = &status
	} else {
...
func (profile *OsDiskProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "DiskType":
	if profile.DiskType != nil {
		var temp string
		temp = string(*profile.DiskType)
		diskType := arm.OsDiskProfile_DiskType(temp)
...
func (profile *OsDiskProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "DiskType":
	if typedInput.DiskType != nil {
		var temp string
		temp = string(*typedInput.DiskType)
		diskType := OsDiskProfile_DiskType(temp)
		profile.DiskType = &diskType
	}
...
func (profile *OsDiskProfile) AssignProperties_From_OsDiskProfile(source *storage.OsDiskProfile) error {
	...
	if source.DiskType != nil {
		...
		diskTypeTemp := genruntime.ToEnum(diskType, osDiskProfile_DiskType_Values)
		profile.DiskType = &diskTypeTemp
	} else {
		profile.DiskType = nil
	}
...
func (profile *OsDiskProfile) AssignProperties_To_OsDiskProfile(destination *storage.OsDiskProfile) error {
	...
	// DiskType
	if profile.DiskType != nil {
		diskType := string(*profile.DiskType)
...
func (profile *OsDiskProfile) Initialize_From_OsDiskProfile_STATUS(source *OsDiskProfile_STATUS) error {
	...
	// DiskType
	if source.DiskType != nil {
		diskType := genruntime.ToEnum(string(*source.DiskType), osDiskProfile_DiskType_Values)
		profile.DiskType = &diskType
	} else {
		profile.DiskType = nil
	}
...
type OsDiskProfile_STATUS struct {
	...
	// DiskType: The type of the OS disk.
	// - https://learn.microsoft.com/en-us/azure/virtual-machines/ephemeral-os-disks
	DiskType *OsDiskProfile_DiskType_STATUS `json:"diskType,omitempty"`
...
func (profile *OsDiskProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.DiskType != nil {
		var temp string
		temp = string(*typedInput.DiskType)
		diskType := OsDiskProfile_DiskType_STATUS(temp)
		profile.DiskType = &diskType
	}
...
func (profile *OsDiskProfile_STATUS) AssignProperties_From_OsDiskProfile_STATUS(source *storage.OsDiskProfile_STATUS) error {
	...
	if source.DiskType != nil {
		diskType := *source.DiskType
		diskTypeTemp := genruntime.ToEnum(diskType, osDiskProfile_DiskType_STATUS_Values)
		profile.DiskType = &diskTypeTemp
	} else {
		profile.DiskType = nil
	}
...
type OsDiskProfile_DiskType string

const (
	OsDiskProfile_DiskType_Ephemeral = OsDiskProfile_DiskType("Ephemeral")
	OsDiskProfile_DiskType_Managed   = OsDiskProfile_DiskType("Managed")
)

// Mapping from string to OsDiskProfile_DiskType
var osDiskProfile_DiskType_Values = map[string]OsDiskProfile_DiskType{
	"ephemeral": OsDiskProfile_DiskType_Ephemeral,
	"managed":   OsDiskProfile_DiskType_Managed,
}

type OsDiskProfile_DiskType_STATUS string

const (
	OsDiskProfile_DiskType_STATUS_Ephemeral = OsDiskProfile_DiskType_STATUS("Ephemeral")
	OsDiskProfile_DiskType_STATUS_Managed   = OsDiskProfile_DiskType_STATUS("Managed")
)

// Mapping from string to OsDiskProfile_DiskType_STATUS
var osDiskProfile_DiskType_STATUS_Values = map[string]OsDiskProfile_DiskType_STATUS{
	"ephemeral": OsDiskProfile_DiskType_STATUS_Ephemeral,
	"managed":   OsDiskProfile_DiskType_STATUS_Managed,
}
