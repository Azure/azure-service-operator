...
func (auth *HcpOpenShiftClustersExternalAuth) defaultAzureName(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) error {
...
func (auth *HcpOpenShiftClustersExternalAuth) defaultImpl(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) error {
...
func (auth *HcpOpenShiftClustersExternalAuth) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = auth
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20260901p.HcpOpenShiftClustersExternalAuth]); ok {
...
func (auth *HcpOpenShiftClustersExternalAuth) createValidations() []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error){
...
func (auth *HcpOpenShiftClustersExternalAuth) deleteValidations() []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (auth *HcpOpenShiftClustersExternalAuth) updateValidations() []func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersExternalAuth, newObj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersExternalAuth, newObj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersExternalAuth, newObj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
...
func (auth *HcpOpenShiftClustersExternalAuth) validateConfigMapDestinations(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
...
func (auth *HcpOpenShiftClustersExternalAuth) validateOwnerReference(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (auth *HcpOpenShiftClustersExternalAuth) validateResourceReferences(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
...
func (auth *HcpOpenShiftClustersExternalAuth) validateSecretDestinations(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (auth *HcpOpenShiftClustersExternalAuth) validateWriteOnceProperties(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersExternalAuth, newObj *v20260901p.HcpOpenShiftClustersExternalAuth) (admission.Warnings, error) {
