...
func (pool *HcpOpenShiftClustersNodePool) defaultAzureName(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) error {
...
func (pool *HcpOpenShiftClustersNodePool) defaultImpl(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) error {
...
func (pool *HcpOpenShiftClustersNodePool) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	var temp any = pool
	if runtimeValidator, ok := temp.(genruntime.Validator[*v20260901p.HcpOpenShiftClustersNodePool]); ok {
...
func (pool *HcpOpenShiftClustersNodePool) createValidations() []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error){
...
func (pool *HcpOpenShiftClustersNodePool) deleteValidations() []func(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
	return nil
}

// updateValidations validates the update of the resource
func (pool *HcpOpenShiftClustersNodePool) updateValidations() []func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersNodePool, newObj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
	return []func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersNodePool, newObj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error){
		func(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersNodePool, newObj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
...
func (pool *HcpOpenShiftClustersNodePool) validateConfigMapDestinations(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
...
func (pool *HcpOpenShiftClustersNodePool) validateOwnerReference(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
	return genruntime.ValidateOwner(obj)
}

// validateResourceReferences validates all resource references
func (pool *HcpOpenShiftClustersNodePool) validateResourceReferences(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
...
func (pool *HcpOpenShiftClustersNodePool) validateSecretDestinations(ctx context.Context, obj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
	if obj.Spec.OperatorSpec == nil {
		return nil, nil
	}
...
func (pool *HcpOpenShiftClustersNodePool) validateWriteOnceProperties(ctx context.Context, oldObj *v20260901p.HcpOpenShiftClustersNodePool, newObj *v20260901p.HcpOpenShiftClustersNodePool) (admission.Warnings, error) {
