...
func (cluster *HcpOpenShiftCluster) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected redhatopenshift/v20260901preview/storage/HcpOpenShiftCluster but received %T instead", hub)
	}
...
type HcpOpenShiftCluster_Spec struct {
	// +kubebuilder:validation:Pattern="^[a-zA-Z]([-a-zA-Z0-9]{0,52}[a-zA-Z0-9])?$"
...
type HcpOpenShiftClusterProperties struct {
	...
	Ingress *IngressProfile `json:"ingress,omitempty"`
...
func (properties *HcpOpenShiftClusterProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if properties.Ingress != nil {
		ingress_ARM, err := properties.Ingress.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		ingress := *ingress_ARM.(*arm.IngressProfile)
...
func (properties *HcpOpenShiftClusterProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Ingress != nil {
		var ingress1 IngressProfile
		err := ingress1.PopulateFromARM(owner, *typedInput.Ingress)
		if err != nil {
			return err
		}
		ingress := ingress1
		properties.Ingress = &ingress
	}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_From_HcpOpenShiftClusterProperties(source *storage.HcpOpenShiftClusterProperties) error {
	...
	if source.Ingress != nil {
		var ingress IngressProfile
		err := ingress.AssignProperties_From_IngressProfile(source.Ingress)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_IngressProfile() to populate field Ingress")
		}
		properties.Ingress = &ingress
	} else {
		properties.Ingress = nil
	}
...
func (properties *HcpOpenShiftClusterProperties) AssignProperties_To_HcpOpenShiftClusterProperties(destination *storage.HcpOpenShiftClusterProperties) error {
	...
	// Ingress
	if properties.Ingress != nil {
		var ingress storage.IngressProfile
		err := properties.Ingress.AssignProperties_To_IngressProfile(&ingress)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_IngressProfile() to populate field Ingress")
		}
...
func (properties *HcpOpenShiftClusterProperties) Initialize_From_HcpOpenShiftClusterProperties_STATUS(source *HcpOpenShiftClusterProperties_STATUS) error {
	...
	if source.Ingress != nil {
		var ingress IngressProfile
		err := ingress.Initialize_From_IngressProfile_STATUS(source.Ingress)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_IngressProfile_STATUS() to populate field Ingress")
		}
		properties.Ingress = &ingress
	} else {
		properties.Ingress = nil
...
func (properties *HcpOpenShiftClusterProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "Ingress":
	if typedInput.Ingress != nil {
		var ingress1 IngressProfile_STATUS
		err := ingress1.PopulateFromARM(owner, *typedInput.Ingress)
		if err != nil {
			return err
		}
...
func (properties *HcpOpenShiftClusterProperties_STATUS) AssignProperties_From_HcpOpenShiftClusterProperties_STATUS(source *storage.HcpOpenShiftClusterProperties_STATUS) error {
	...
	// Ingress
	if source.Ingress != nil {
		var ingress IngressProfile_STATUS
		err := ingress.AssignProperties_From_IngressProfile_STATUS(source.Ingress)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_IngressProfile_STATUS() to populate field Ingress")
		}
		properties.Ingress = &ingress
	} else {
		properties.Ingress = nil
...
func (properties *HcpOpenShiftClusterProperties_STATUS) AssignProperties_To_HcpOpenShiftClusterProperties_STATUS(destination *storage.HcpOpenShiftClusterProperties_STATUS) error {
	...
	// Ingress
	if properties.Ingress != nil {
		var ingress storage.IngressProfile_STATUS
		err := properties.Ingress.AssignProperties_To_IngressProfile_STATUS(&ingress)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_IngressProfile_STATUS() to populate field Ingress")
		}
		destination.Ingress = &ingress
	} else {
		destination.Ingress = nil
...
type IngressProfile struct {
	...
	Type *IngressProfile_Type `json:"type,omitempty"`
}
...
func (profile *IngressProfile) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if profile.Type != nil {
		...
		typeVar := arm.IngressProfile_Type(temp)
		result.Type = &typeVar
	}
	return result, nil
}
...
func (profile *IngressProfile) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := IngressProfile_Type(temp)
...
func (profile *IngressProfile) AssignProperties_From_IngressProfile(source *storage.IngressProfile) error {
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, ingressProfile_Type_Values)
...
func (profile *IngressProfile) Initialize_From_IngressProfile_STATUS(source *IngressProfile_STATUS) error {
	...
	// Type
	if source.Type != nil {
		typeVar := genruntime.ToEnum(string(*source.Type), ingressProfile_Type_Values)
		profile.Type = &typeVar
	} else {
		profile.Type = nil
	}
...
func (profile *IngressProfile_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := IngressProfile_Type_STATUS(temp)
		profile.Type = &typeVar
	}
...
func (profile *IngressProfile_STATUS) AssignProperties_From_IngressProfile_STATUS(source *storage.IngressProfile_STATUS) error {
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, ingressProfile_Type_STATUS_Values)
		profile.Type = &typeTemp
	} else {
		profile.Type = nil
	}
...
var _ genruntime.FromARMConverter = &ResourceStatus_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (status *ResourceStatus_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.ResourceStatus_STATUS{}
}
...
// AssignProperties_From_ResourceStatus_STATUS populates our ResourceStatus_STATUS from the provided source ResourceStatus_STATUS
func (status *ResourceStatus_STATUS) AssignProperties_From_ResourceStatus_STATUS(source *storage.ResourceStatus_STATUS) error {

	// Conditions
	if source.Conditions != nil {
		conditionList := make([]Condition_STATUS, len(source.Conditions))
		for conditionIndex, conditionItem := range source.Conditions {
			var condition Condition_STATUS
			err := condition.AssignProperties_From_Condition_STATUS(&conditionItem)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_Condition_STATUS() to populate field Conditions")
			}
			conditionList[conditionIndex] = condition
		}
		status.Conditions = conditionList
	} else {
...
// AssignProperties_To_ResourceStatus_STATUS populates the provided destination ResourceStatus_STATUS from our ResourceStatus_STATUS
func (status *ResourceStatus_STATUS) AssignProperties_To_ResourceStatus_STATUS(destination *storage.ResourceStatus_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Conditions
	if status.Conditions != nil {
		conditionList := make([]storage.Condition_STATUS, len(status.Conditions))
		for conditionIndex, conditionItem := range status.Conditions {
			var condition storage.Condition_STATUS
			err := conditionItem.AssignProperties_To_Condition_STATUS(&condition)
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_Condition_STATUS() to populate field Conditions")
			}
			conditionList[conditionIndex] = condition
		}
...
func (condition *Condition_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Type != nil {
		var temp string
		temp = string(*typedInput.Type)
		typeVar := ConditionType_STATUS(temp)
...
func (condition *Condition_STATUS) AssignProperties_From_Condition_STATUS(source *storage.Condition_STATUS) error {
	...
	if source.Type != nil {
		typeVar := *source.Type
		typeTemp := genruntime.ToEnum(typeVar, conditionType_STATUS_Values)
...
type IngressProfile_Type string

const (
	IngressProfile_Type_Disabled = IngressProfile_Type("Disabled")
	IngressProfile_Type_Private  = IngressProfile_Type("Private")
	IngressProfile_Type_Public   = IngressProfile_Type("Public")
)

// Mapping from string to IngressProfile_Type
var ingressProfile_Type_Values = map[string]IngressProfile_Type{
	"disabled": IngressProfile_Type_Disabled,
	"private":  IngressProfile_Type_Private,
	"public":   IngressProfile_Type_Public,
}
