...
type HcpOpenShiftClusterProperties_STATUS struct {
	...
	Ingress *IngressProfile_STATUS `json:"ingress,omitempty"`
...
type IngressProfile_STATUS struct {
	// Type: The type of the default cluster ingress.
	Type *IngressProfile_Type_STATUS `json:"type,omitempty"`
}
...
type ResourceStatus_STATUS struct {
	// Conditions: The conditions on the resource
...
type Condition_STATUS struct {
	...
	Type *ConditionType_STATUS `json:"type,omitempty"`
}
...
const (
	IngressProfile_Type_STATUS_Disabled = IngressProfile_Type_STATUS("Disabled")
	IngressProfile_Type_STATUS_Private  = IngressProfile_Type_STATUS("Private")
	IngressProfile_Type_STATUS_Public   = IngressProfile_Type_STATUS("Public")
)

// Mapping from string to IngressProfile_Type_STATUS
var ingressProfile_Type_STATUS_Values = map[string]IngressProfile_Type_STATUS{
	"disabled": IngressProfile_Type_STATUS_Disabled,
	"private":  IngressProfile_Type_STATUS_Private,
	"public":   IngressProfile_Type_STATUS_Public,
}
...
// +kubebuilder:validation:Enum={"Available","Degraded","Progressing"}
type ConditionType_STATUS string

const (
	ConditionType_STATUS_Available   = ConditionType_STATUS("Available")
	ConditionType_STATUS_Degraded    = ConditionType_STATUS("Degraded")
	ConditionType_STATUS_Progressing = ConditionType_STATUS("Progressing")
)

// Mapping from string to ConditionType_STATUS
var conditionType_STATUS_Values = map[string]ConditionType_STATUS{
	"available":   ConditionType_STATUS_Available,
	"degraded":    ConditionType_STATUS_Degraded,
	"progressing": ConditionType_STATUS_Progressing,
}
...
// +kubebuilder:validation:Enum={"False","True","Unknown"}
