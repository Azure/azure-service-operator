...
import (
	"context"
	"fmt"
	v20240301 "github.com/Azure/azure-service-operator/v2/api/app/v20240301"
...
// +kubebuilder:webhook:path=/mutate-app-azure-com-v20240301-managedenvironment,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=app.azure.com,resources=managedenvironments,verbs=create;update,versions=v20240301,name=default.v20240301.managedenvironments.app.azure.com,admissionReviewVersions=v1
...
func (environment *ManagedEnvironment) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/app/v20240301/ManagedEnvironment, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-app-azure-com-v20240301-managedenvironment,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=app.azure.com,resources=managedenvironments,verbs=create;update,versions=v20240301,name=validate.v20240301.managedenvironments.app.azure.com,admissionReviewVersions=v1
...
func (environment *ManagedEnvironment) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/app/v20240301/ManagedEnvironment, but got %T", resource)
	}
...
func (environment *ManagedEnvironment) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/app/v20240301/ManagedEnvironment, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20240301.ManagedEnvironment)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/app/v20240301/ManagedEnvironment, but got %T", oldResource)
	}
