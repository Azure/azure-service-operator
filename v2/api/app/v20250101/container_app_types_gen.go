...
import (
	"context"
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/app/v20250101/arm"
...
func (containerApp *ContainerApp) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected app/v20250101/storage/ContainerApp but received %T instead", hub)
	}
...
type ContainerApp_STATUS struct {
	...
	RunningStatus *ContainerApp_Properties_RunningStatus_STATUS `json:"runningStatus,omitempty"`
...
func (containerApp *ContainerApp_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "RunningStatus":
	// copying flattened property:
	if typedInput.Properties != nil {
		if typedInput.Properties.RunningStatus != nil {
			var temp string
			temp = string(*typedInput.Properties.RunningStatus)
			runningStatus := ContainerApp_Properties_RunningStatus_STATUS(temp)
			containerApp.RunningStatus = &runningStatus
		}
	}
...
func (containerApp *ContainerApp_STATUS) AssignProperties_From_ContainerApp_STATUS(source *storage.ContainerApp_STATUS) error {
	...
	if source.RunningStatus != nil {
		runningStatus := *source.RunningStatus
		runningStatusTemp := genruntime.ToEnum(runningStatus, containerApp_Properties_RunningStatus_STATUS_Values)
		containerApp.RunningStatus = &runningStatusTemp
	} else {
		containerApp.RunningStatus = nil
	}
...
func (containerApp *ContainerApp_STATUS) AssignProperties_To_ContainerApp_STATUS(destination *storage.ContainerApp_STATUS) error {
	...
	// RunningStatus
	if containerApp.RunningStatus != nil {
		runningStatus := string(*containerApp.RunningStatus)
...
func (configuration *Configuration) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "IdentitySettings":
	for _, item := range configuration.IdentitySettings {
		item_ARM, err := item.ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		result.IdentitySettings = append(result.IdentitySettings, *item_ARM.(*arm.IdentitySettings))
	}
	...
	if configuration.Runtime != nil {
		...
		runtime := *runtime_ARM.(*arm.Runtime)
...
func (configuration *Configuration) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "IdentitySettings":
	for _, item := range typedInput.IdentitySettings {
		var item1 IdentitySettings
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
		configuration.IdentitySettings = append(configuration.IdentitySettings, item1)
	}
...
func (configuration *Configuration) AssignProperties_From_Configuration(source *storage.Configuration) error {
	...
	if source.IdentitySettings != nil {
		...
		for identitySettingIndex, identitySettingItem := range source.IdentitySettings {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IdentitySettings() to populate field IdentitySettings")
			}
			identitySettingList[identitySettingIndex] = identitySetting
		}
		configuration.IdentitySettings = identitySettingList
	} else {
		configuration.IdentitySettings = nil
	}
	...
	if source.Runtime != nil {
		var runtime Runtime
		err := runtime.AssignProperties_From_Runtime(source.Runtime)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Runtime() to populate field Runtime")
		}
		configuration.Runtime = &runtime
	} else {
...
func (configuration *Configuration) AssignProperties_To_Configuration(destination *storage.Configuration) error {
	...
	if configuration.IdentitySettings != nil {
		...
		for identitySettingIndex, identitySettingItem := range configuration.IdentitySettings {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IdentitySettings() to populate field IdentitySettings")
			}
			identitySettingList[identitySettingIndex] = identitySetting
		}
		destination.IdentitySettings = identitySettingList
	} else {
	...
	if configuration.Runtime != nil {
		...
		err := configuration.Runtime.AssignProperties_To_Runtime(&runtime)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Runtime() to populate field Runtime")
		}
...
func (configuration *Configuration) Initialize_From_Configuration_STATUS(source *Configuration_STATUS) error {
	...
	if source.IdentitySettings != nil {
		...
		for identitySettingIndex, identitySettingItem := range source.IdentitySettings {
			...
			if err != nil {
				return eris.Wrap(err, "calling Initialize_From_IdentitySettings_STATUS() to populate field IdentitySettings")
			}
			identitySettingList[identitySettingIndex] = identitySetting
		}
		configuration.IdentitySettings = identitySettingList
	...
	if source.Runtime != nil {
		var runtime Runtime
		err := runtime.Initialize_From_Runtime_STATUS(source.Runtime)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Runtime_STATUS() to populate field Runtime")
		}
		configuration.Runtime = &runtime
	} else {
		configuration.Runtime = nil
...
func (configuration *Configuration_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "IdentitySettings":
	for _, item := range typedInput.IdentitySettings {
		var item1 IdentitySettings_STATUS
		err := item1.PopulateFromARM(owner, item)
		if err != nil {
			return err
		}
...
func (configuration *Configuration_STATUS) AssignProperties_From_Configuration_STATUS(source *storage.Configuration_STATUS) error {
	...
	if source.IdentitySettings != nil {
		...
		for identitySettingIndex, identitySettingItem := range source.IdentitySettings {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_From_IdentitySettings_STATUS() to populate field IdentitySettings")
			}
			identitySettingList[identitySettingIndex] = identitySetting
		}
		configuration.IdentitySettings = identitySettingList
	...
	// Runtime
	if source.Runtime != nil {
		var runtime Runtime_STATUS
		err := runtime.AssignProperties_From_Runtime_STATUS(source.Runtime)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Runtime_STATUS() to populate field Runtime")
		}
		configuration.Runtime = &runtime
	} else {
		configuration.Runtime = nil
...
func (configuration *Configuration_STATUS) AssignProperties_To_Configuration_STATUS(destination *storage.Configuration_STATUS) error {
	...
	if configuration.IdentitySettings != nil {
		...
		for identitySettingIndex, identitySettingItem := range configuration.IdentitySettings {
			...
			if err != nil {
				return eris.Wrap(err, "calling AssignProperties_To_IdentitySettings_STATUS() to populate field IdentitySettings")
			}
			identitySettingList[identitySettingIndex] = identitySetting
		}
		destination.IdentitySettings = identitySettingList
	...
	if configuration.Runtime != nil {
		...
		err := configuration.Runtime.AssignProperties_To_Runtime_STATUS(&runtime)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Runtime_STATUS() to populate field Runtime")
		}
		destination.Runtime = &runtime
	} else {
		destination.Runtime = nil
...
type ContainerApp_Properties_RunningStatus_STATUS string

const (
	ContainerApp_Properties_RunningStatus_STATUS_Progressing = ContainerApp_Properties_RunningStatus_STATUS("Progressing")
	ContainerApp_Properties_RunningStatus_STATUS_Ready       = ContainerApp_Properties_RunningStatus_STATUS("Ready")
	ContainerApp_Properties_RunningStatus_STATUS_Running     = ContainerApp_Properties_RunningStatus_STATUS("Running")
	ContainerApp_Properties_RunningStatus_STATUS_Stopped     = ContainerApp_Properties_RunningStatus_STATUS("Stopped")
	ContainerApp_Properties_RunningStatus_STATUS_Suspended   = ContainerApp_Properties_RunningStatus_STATUS("Suspended")
)

// Mapping from string to ContainerApp_Properties_RunningStatus_STATUS
var containerApp_Properties_RunningStatus_STATUS_Values = map[string]ContainerApp_Properties_RunningStatus_STATUS{
	"progressing": ContainerApp_Properties_RunningStatus_STATUS_Progressing,
	"ready":       ContainerApp_Properties_RunningStatus_STATUS_Ready,
	"running":     ContainerApp_Properties_RunningStatus_STATUS_Running,
	"stopped":     ContainerApp_Properties_RunningStatus_STATUS_Stopped,
	"suspended":   ContainerApp_Properties_RunningStatus_STATUS_Suspended,
}
...
var _ genruntime.ARMTransformer = &IdentitySettings{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (settings *IdentitySettings) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if settings == nil {
		return nil, nil
	}
	result := &arm.IdentitySettings{}
	...
	// Set property "Lifecycle":
	if settings.Lifecycle != nil {
		var temp string
		temp = string(*settings.Lifecycle)
		lifecycle := arm.IdentitySettings_Lifecycle(temp)
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *IdentitySettings) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IdentitySettings{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *IdentitySettings) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IdentitySettings)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IdentitySettings, got %T", armInput)
	}

	// no assignment for property "IdentityReference"

	// Set property "Lifecycle":
	if typedInput.Lifecycle != nil {
		var temp string
		temp = string(*typedInput.Lifecycle)
		lifecycle := IdentitySettings_Lifecycle(temp)
...
// AssignProperties_From_IdentitySettings populates our IdentitySettings from the provided source IdentitySettings
func (settings *IdentitySettings) AssignProperties_From_IdentitySettings(source *storage.IdentitySettings) error {

	// IdentityReference
	if source.IdentityReference != nil {
		identityReference := source.IdentityReference.Copy()
		settings.IdentityReference = &identityReference
	} else {
		settings.IdentityReference = nil
	}

	// Lifecycle
	if source.Lifecycle != nil {
		lifecycle := *source.Lifecycle
		lifecycleTemp := genruntime.ToEnum(lifecycle, identitySettings_Lifecycle_Values)
		settings.Lifecycle = &lifecycleTemp
	} else {
		settings.Lifecycle = nil
	}
...
// AssignProperties_To_IdentitySettings populates the provided destination IdentitySettings from our IdentitySettings
func (settings *IdentitySettings) AssignProperties_To_IdentitySettings(destination *storage.IdentitySettings) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// IdentityReference
	if settings.IdentityReference != nil {
		identityReference := settings.IdentityReference.Copy()
	...
	// Lifecycle
	if settings.Lifecycle != nil {
		lifecycle := string(*settings.Lifecycle)
		destination.Lifecycle = &lifecycle
	} else {
		destination.Lifecycle = nil
	}
...
// Initialize_From_IdentitySettings_STATUS populates our IdentitySettings from the provided source IdentitySettings_STATUS
func (settings *IdentitySettings) Initialize_From_IdentitySettings_STATUS(source *IdentitySettings_STATUS) error {

	// Lifecycle
	if source.Lifecycle != nil {
		lifecycle := genruntime.ToEnum(string(*source.Lifecycle), identitySettings_Lifecycle_Values)
		settings.Lifecycle = &lifecycle
	} else {
		settings.Lifecycle = nil
	}
...
type IdentitySettings_STATUS struct {
	...
	// Lifecycle: Use to select the lifecycle stages of a Container App during which the Managed Identity should be available.
	Lifecycle *IdentitySettings_Lifecycle_STATUS `json:"lifecycle,omitempty"`
}

var _ genruntime.FromARMConverter = &IdentitySettings_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (settings *IdentitySettings_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.IdentitySettings_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (settings *IdentitySettings_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.IdentitySettings_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.IdentitySettings_STATUS, got %T", armInput)
	}
	...
	if typedInput.Lifecycle != nil {
		var temp string
		temp = string(*typedInput.Lifecycle)
		lifecycle := IdentitySettings_Lifecycle_STATUS(temp)
		settings.Lifecycle = &lifecycle
	}
...
// AssignProperties_From_IdentitySettings_STATUS populates our IdentitySettings_STATUS from the provided source IdentitySettings_STATUS
func (settings *IdentitySettings_STATUS) AssignProperties_From_IdentitySettings_STATUS(source *storage.IdentitySettings_STATUS) error {

	// Identity
	settings.Identity = genruntime.ClonePointerToString(source.Identity)

	// Lifecycle
	if source.Lifecycle != nil {
		lifecycle := *source.Lifecycle
		lifecycleTemp := genruntime.ToEnum(lifecycle, identitySettings_Lifecycle_STATUS_Values)
		settings.Lifecycle = &lifecycleTemp
	} else {
		settings.Lifecycle = nil
	}
...
// AssignProperties_To_IdentitySettings_STATUS populates the provided destination IdentitySettings_STATUS from our IdentitySettings_STATUS
func (settings *IdentitySettings_STATUS) AssignProperties_To_IdentitySettings_STATUS(destination *storage.IdentitySettings_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Identity
	destination.Identity = genruntime.ClonePointerToString(settings.Identity)
...
var _ genruntime.ARMTransformer = &Runtime{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (runtime *Runtime) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if runtime == nil {
		return nil, nil
	}
	result := &arm.Runtime{}
	...
	if runtime.Java != nil {
		...
		java := *java_ARM.(*arm.Runtime_Java)
		result.Java = &java
	}
	return result, nil
}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (runtime *Runtime) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Runtime{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (runtime *Runtime) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Runtime)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Runtime, got %T", armInput)
	}

	// Set property "Java":
	if typedInput.Java != nil {
		var java1 Runtime_Java
		err := java1.PopulateFromARM(owner, *typedInput.Java)
		if err != nil {
			return err
		}
		java := java1
...
// AssignProperties_From_Runtime populates our Runtime from the provided source Runtime
func (runtime *Runtime) AssignProperties_From_Runtime(source *storage.Runtime) error {

	// Java
	if source.Java != nil {
		var java Runtime_Java
		err := java.AssignProperties_From_Runtime_Java(source.Java)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Runtime_Java() to populate field Java")
		}
		runtime.Java = &java
	} else {
		runtime.Java = nil
...
// AssignProperties_To_Runtime populates the provided destination Runtime from our Runtime
func (runtime *Runtime) AssignProperties_To_Runtime(destination *storage.Runtime) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Java
	if runtime.Java != nil {
		var java storage.Runtime_Java
		err := runtime.Java.AssignProperties_To_Runtime_Java(&java)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Runtime_Java() to populate field Java")
		}
		destination.Java = &java
	} else {
		destination.Java = nil
	}
...
// Initialize_From_Runtime_STATUS populates our Runtime from the provided source Runtime_STATUS
func (runtime *Runtime) Initialize_From_Runtime_STATUS(source *Runtime_STATUS) error {

	// Java
	if source.Java != nil {
		var java Runtime_Java
		err := java.Initialize_From_Runtime_Java_STATUS(source.Java)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_Runtime_Java_STATUS() to populate field Java")
		}
		runtime.Java = &java
	} else {
		runtime.Java = nil
...
var _ genruntime.FromARMConverter = &Runtime_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (runtime *Runtime_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Runtime_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (runtime *Runtime_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Runtime_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Runtime_STATUS, got %T", armInput)
	}

	// Set property "Java":
	if typedInput.Java != nil {
		var java1 Runtime_Java_STATUS
		err := java1.PopulateFromARM(owner, *typedInput.Java)
		if err != nil {
			return err
		}
...
// AssignProperties_From_Runtime_STATUS populates our Runtime_STATUS from the provided source Runtime_STATUS
func (runtime *Runtime_STATUS) AssignProperties_From_Runtime_STATUS(source *storage.Runtime_STATUS) error {

	// Java
	if source.Java != nil {
		var java Runtime_Java_STATUS
		err := java.AssignProperties_From_Runtime_Java_STATUS(source.Java)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_Runtime_Java_STATUS() to populate field Java")
		}
		runtime.Java = &java
	} else {
		runtime.Java = nil
...
// AssignProperties_To_Runtime_STATUS populates the provided destination Runtime_STATUS from our Runtime_STATUS
func (runtime *Runtime_STATUS) AssignProperties_To_Runtime_STATUS(destination *storage.Runtime_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// Java
	if runtime.Java != nil {
		var java storage.Runtime_Java_STATUS
		err := runtime.Java.AssignProperties_To_Runtime_Java_STATUS(&java)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_Runtime_Java_STATUS() to populate field Java")
		}
		destination.Java = &java
	} else {
		destination.Java = nil
...
func (scale *Scale) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	// Set property "CooldownPeriod":
	if scale.CooldownPeriod != nil {
		cooldownPeriod := *scale.CooldownPeriod
...
func (scale *Scale) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CooldownPeriod":
	if typedInput.CooldownPeriod != nil {
		cooldownPeriod := *typedInput.CooldownPeriod
		scale.CooldownPeriod = &cooldownPeriod
	}
...
func (scale *Scale) AssignProperties_From_Scale(source *storage.Scale) error {
	...
	// CooldownPeriod
	scale.CooldownPeriod = genruntime.ClonePointerToInt(source.CooldownPeriod)
...
func (scale *Scale) AssignProperties_To_Scale(destination *storage.Scale) error {
	...
	// CooldownPeriod
	destination.CooldownPeriod = genruntime.ClonePointerToInt(scale.CooldownPeriod)
...
// +kubebuilder:validation:Enum={"All","Init","Main","None"}
type IdentitySettings_Lifecycle string

const (
	IdentitySettings_Lifecycle_All  = IdentitySettings_Lifecycle("All")
	IdentitySettings_Lifecycle_Init = IdentitySettings_Lifecycle("Init")
	IdentitySettings_Lifecycle_Main = IdentitySettings_Lifecycle("Main")
	IdentitySettings_Lifecycle_None = IdentitySettings_Lifecycle("None")
)

// Mapping from string to IdentitySettings_Lifecycle
var identitySettings_Lifecycle_Values = map[string]IdentitySettings_Lifecycle{
	"all":  IdentitySettings_Lifecycle_All,
	"init": IdentitySettings_Lifecycle_Init,
	"main": IdentitySettings_Lifecycle_Main,
	"none": IdentitySettings_Lifecycle_None,
}

type IdentitySettings_Lifecycle_STATUS string

const (
	IdentitySettings_Lifecycle_STATUS_All  = IdentitySettings_Lifecycle_STATUS("All")
	IdentitySettings_Lifecycle_STATUS_Init = IdentitySettings_Lifecycle_STATUS("Init")
	IdentitySettings_Lifecycle_STATUS_Main = IdentitySettings_Lifecycle_STATUS("Main")
	IdentitySettings_Lifecycle_STATUS_None = IdentitySettings_Lifecycle_STATUS("None")
)

// Mapping from string to IdentitySettings_Lifecycle_STATUS
var identitySettings_Lifecycle_STATUS_Values = map[string]IdentitySettings_Lifecycle_STATUS{
	"all":  IdentitySettings_Lifecycle_STATUS_All,
	"init": IdentitySettings_Lifecycle_STATUS_Init,
	"main": IdentitySettings_Lifecycle_STATUS_Main,
	"none": IdentitySettings_Lifecycle_STATUS_None,
}
...
var _ genruntime.ARMTransformer = &Runtime_Java{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (java *Runtime_Java) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if java == nil {
		return nil, nil
	}
	result := &arm.Runtime_Java{}

	// Set property "EnableMetrics":
	if java.EnableMetrics != nil {
		enableMetrics := *java.EnableMetrics
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (java *Runtime_Java) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Runtime_Java{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (java *Runtime_Java) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Runtime_Java)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Runtime_Java, got %T", armInput)
	}

	// Set property "EnableMetrics":
	if typedInput.EnableMetrics != nil {
		enableMetrics := *typedInput.EnableMetrics
		java.EnableMetrics = &enableMetrics
	}
...
// AssignProperties_From_Runtime_Java populates our Runtime_Java from the provided source Runtime_Java
func (java *Runtime_Java) AssignProperties_From_Runtime_Java(source *storage.Runtime_Java) error {

	// EnableMetrics
	if source.EnableMetrics != nil {
		enableMetric := *source.EnableMetrics
		java.EnableMetrics = &enableMetric
	} else {
		java.EnableMetrics = nil
	}
...
// AssignProperties_To_Runtime_Java populates the provided destination Runtime_Java from our Runtime_Java
func (java *Runtime_Java) AssignProperties_To_Runtime_Java(destination *storage.Runtime_Java) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// EnableMetrics
	if java.EnableMetrics != nil {
		enableMetric := *java.EnableMetrics
		destination.EnableMetrics = &enableMetric
	} else {
		destination.EnableMetrics = nil
	}
...
// Initialize_From_Runtime_Java_STATUS populates our Runtime_Java from the provided source Runtime_Java_STATUS
func (java *Runtime_Java) Initialize_From_Runtime_Java_STATUS(source *Runtime_Java_STATUS) error {
...
var _ genruntime.FromARMConverter = &Runtime_Java_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (java *Runtime_Java_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.Runtime_Java_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (java *Runtime_Java_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.Runtime_Java_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.Runtime_Java_STATUS, got %T", armInput)
	}
...
// AssignProperties_From_Runtime_Java_STATUS populates our Runtime_Java_STATUS from the provided source Runtime_Java_STATUS
func (java *Runtime_Java_STATUS) AssignProperties_From_Runtime_Java_STATUS(source *storage.Runtime_Java_STATUS) error {
...
// AssignProperties_To_Runtime_Java_STATUS populates the provided destination Runtime_Java_STATUS from our Runtime_Java_STATUS
func (java *Runtime_Java_STATUS) AssignProperties_To_Runtime_Java_STATUS(destination *storage.Runtime_Java_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
// +kubebuilder:validation:Enum={"AzureFile","EmptyDir","NfsAzureFile","Secret"}
...
const (
	...
	Volume_StorageType_NfsAzureFile = Volume_StorageType("NfsAzureFile")
...
var volume_StorageType_Values = map[string]Volume_StorageType{
	...
	"nfsazurefile": Volume_StorageType_NfsAzureFile,
...
const (
	...
	Volume_StorageType_STATUS_NfsAzureFile = Volume_StorageType_STATUS("NfsAzureFile")
...
var volume_StorageType_STATUS_Values = map[string]Volume_StorageType_STATUS{
	...
	"nfsazurefile": Volume_StorageType_STATUS_NfsAzureFile,
...
func (rule *CustomScaleRule) AssignProperties_To_CustomScaleRule(destination *storage.CustomScaleRule) error {
	...
	// IdentityReference
	if rule.IdentityReference != nil {
		identityReference := rule.IdentityReference.Copy()
		destination.IdentityReference = &identityReference
	} else {
		destination.IdentityReference = nil
	}
...
func (rule *CustomScaleRule_STATUS) AssignProperties_From_CustomScaleRule_STATUS(source *storage.CustomScaleRule_STATUS) error {
	...
	// Identity
	rule.Identity = genruntime.ClonePointerToString(source.Identity)
...
func (rule *CustomScaleRule_STATUS) AssignProperties_To_CustomScaleRule_STATUS(destination *storage.CustomScaleRule_STATUS) error {
	...
	// Identity
	destination.Identity = genruntime.ClonePointerToString(rule.Identity)
...
func (rule *QueueScaleRule) AssignProperties_From_QueueScaleRule(source *storage.QueueScaleRule) error {
	...
	// AccountName
	rule.AccountName = genruntime.ClonePointerToString(source.AccountName)
...
func (rule *QueueScaleRule) AssignProperties_To_QueueScaleRule(destination *storage.QueueScaleRule) error {
	...
	// AccountName
	destination.AccountName = genruntime.ClonePointerToString(rule.AccountName)
