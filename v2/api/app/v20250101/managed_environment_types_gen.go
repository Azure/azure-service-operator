...
func (configuration *CustomDomainConfiguration) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if configuration.CertificateKeyVaultProperties != nil {
		...
		certificateKeyVaultProperties := *certificateKeyVaultProperties_ARM.(*arm.CertificateKeyVaultProperties)
		result.CertificateKeyVaultProperties = &certificateKeyVaultProperties
	}
...
func (configuration *CustomDomainConfiguration) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CertificateKeyVaultProperties":
	if typedInput.CertificateKeyVaultProperties != nil {
		var certificateKeyVaultProperties1 CertificateKeyVaultProperties
		err := certificateKeyVaultProperties1.PopulateFromARM(owner, *typedInput.CertificateKeyVaultProperties)
		if err != nil {
			return err
		}
		certificateKeyVaultProperties := certificateKeyVaultProperties1
		configuration.CertificateKeyVaultProperties = &certificateKeyVaultProperties
	}
...
func (configuration *CustomDomainConfiguration) Initialize_From_CustomDomainConfiguration_STATUS(source *CustomDomainConfiguration_STATUS) error {
	...
	if source.CertificateKeyVaultProperties != nil {
		var certificateKeyVaultProperty CertificateKeyVaultProperties
		err := certificateKeyVaultProperty.Initialize_From_CertificateKeyVaultProperties_STATUS(source.CertificateKeyVaultProperties)
		if err != nil {
			return eris.Wrap(err, "calling Initialize_From_CertificateKeyVaultProperties_STATUS() to populate field CertificateKeyVaultProperties")
		}
		configuration.CertificateKeyVaultProperties = &certificateKeyVaultProperty
	} else {
		configuration.CertificateKeyVaultProperties = nil
...
func (configuration *CustomDomainConfiguration_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// Set property "CertificateKeyVaultProperties":
	if typedInput.CertificateKeyVaultProperties != nil {
		var certificateKeyVaultProperties1 CertificateKeyVaultProperties_STATUS
		err := certificateKeyVaultProperties1.PopulateFromARM(owner, *typedInput.CertificateKeyVaultProperties)
		if err != nil {
			return err
		}
...
var _ genruntime.ARMTransformer = &CertificateKeyVaultProperties{}

// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (properties *CertificateKeyVaultProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if properties == nil {
		return nil, nil
	}
	result := &arm.CertificateKeyVaultProperties{}
	...
	if properties.KeyVaultUrl != nil {
		keyVaultUrl := *properties.KeyVaultUrl
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *CertificateKeyVaultProperties) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.CertificateKeyVaultProperties{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *CertificateKeyVaultProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.CertificateKeyVaultProperties)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.CertificateKeyVaultProperties, got %T", armInput)
	}
	...
	if typedInput.KeyVaultUrl != nil {
		...
		properties.KeyVaultUrl = &keyVaultUrl
	}
...
// Initialize_From_CertificateKeyVaultProperties_STATUS populates our CertificateKeyVaultProperties from the provided source CertificateKeyVaultProperties_STATUS
func (properties *CertificateKeyVaultProperties) Initialize_From_CertificateKeyVaultProperties_STATUS(source *CertificateKeyVaultProperties_STATUS) error {
...
var _ genruntime.FromARMConverter = &CertificateKeyVaultProperties_STATUS{}

// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (properties *CertificateKeyVaultProperties_STATUS) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &arm.CertificateKeyVaultProperties_STATUS{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (properties *CertificateKeyVaultProperties_STATUS) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(arm.CertificateKeyVaultProperties_STATUS)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected arm.CertificateKeyVaultProperties_STATUS, got %T", armInput)
	}
