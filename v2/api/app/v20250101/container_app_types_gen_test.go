...
import (
	"encoding/json"
	storage "github.com/Azure/azure-service-operator/v2/api/app/v20250101/storage"
...
func RunPropertyAssignmentTestForIdentitySettings(subject IdentitySettings) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IdentitySettings
...
func RunPropertyAssignmentTestForIdentitySettings_STATUS(subject IdentitySettings_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.IdentitySettings_STATUS
...
func RunPropertyAssignmentTestForRuntime_Java(subject Runtime_Java) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.Runtime_Java
...
func RunPropertyAssignmentTestForRuntime_Java_STATUS(subject Runtime_Java_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.Runtime_Java_STATUS
...
func RunPropertyAssignmentTestForRuntime_STATUS(subject Runtime_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other storage.Runtime_STATUS
