...
func RunPropertyAssignmentTestForBaseContainer(subject BaseContainer) string {
	...
	var other app_v1api20250101s.BaseContainer
...
func RunPropertyAssignmentTestForBaseContainer_STATUS(subject BaseContainer_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.BaseContainer_STATUS
...
func RunPropertyAssignmentTestForConfiguration(subject Configuration) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Configuration
...
func AddRelatedPropertyGeneratorsForConfiguration(gens map[string]gopter.Gen) {
	...
	gens["IdentitySettings"] = gen.SliceOf(IdentitySettingsGenerator())
	gens["Ingress"] = gen.PtrOf(IngressGenerator())
	gens["Registries"] = gen.SliceOf(RegistryCredentialsGenerator())
	gens["Runtime"] = gen.PtrOf(RuntimeGenerator())
...
func RunPropertyAssignmentTestForConfiguration_STATUS(subject Configuration_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Configuration_STATUS
...
func AddRelatedPropertyGeneratorsForConfiguration_STATUS(gens map[string]gopter.Gen) {
	...
	gens["IdentitySettings"] = gen.SliceOf(IdentitySettings_STATUSGenerator())
	gens["Ingress"] = gen.PtrOf(Ingress_STATUSGenerator())
	gens["Registries"] = gen.SliceOf(RegistryCredentials_STATUSGenerator())
	gens["Runtime"] = gen.PtrOf(Runtime_STATUSGenerator())
...
func RunPropertyAssignmentTestForContainer(subject Container) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Container
...
func RunResourceConversionTestForContainerApp(subject ContainerApp) string {
	...
	var hub app_v20250101s.ContainerApp
...
func RunPropertyAssignmentTestForContainerApp(subject ContainerApp) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerApp
...
func RunPropertyAssignmentTestForContainerAppOperatorConfigMaps(subject ContainerAppOperatorConfigMaps) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppOperatorConfigMaps
...
func RunPropertyAssignmentTestForContainerAppOperatorSpec(subject ContainerAppOperatorSpec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppOperatorSpec
...
func RunPropertyAssignmentTestForContainerAppProbe(subject ContainerAppProbe) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe
...
func RunPropertyAssignmentTestForContainerAppProbe_HttpGet(subject ContainerAppProbe_HttpGet) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_HttpGet
...
func RunPropertyAssignmentTestForContainerAppProbe_HttpGet_HttpHeaders(subject ContainerAppProbe_HttpGet_HttpHeaders) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_HttpGet_HttpHeaders
...
func RunPropertyAssignmentTestForContainerAppProbe_HttpGet_HttpHeaders_STATUS(subject ContainerAppProbe_HttpGet_HttpHeaders_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_HttpGet_HttpHeaders_STATUS
...
func RunPropertyAssignmentTestForContainerAppProbe_HttpGet_STATUS(subject ContainerAppProbe_HttpGet_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_HttpGet_STATUS
...
func RunPropertyAssignmentTestForContainerAppProbe_STATUS(subject ContainerAppProbe_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_STATUS
...
func RunPropertyAssignmentTestForContainerAppProbe_TcpSocket(subject ContainerAppProbe_TcpSocket) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_TcpSocket
...
func RunPropertyAssignmentTestForContainerAppProbe_TcpSocket_STATUS(subject ContainerAppProbe_TcpSocket_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerAppProbe_TcpSocket_STATUS
...
func RunPropertyAssignmentTestForContainerApp_STATUS(subject ContainerApp_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerApp_STATUS
...
func AddIndependentPropertyGeneratorsForContainerApp_STATUS(gens map[string]gopter.Gen) {
	...
	gens["RunningStatus"] = gen.PtrOf(gen.OneConstOf(
		ContainerApp_Properties_RunningStatus_STATUS_Progressing,
		ContainerApp_Properties_RunningStatus_STATUS_Ready,
		ContainerApp_Properties_RunningStatus_STATUS_Running,
		ContainerApp_Properties_RunningStatus_STATUS_Stopped,
		ContainerApp_Properties_RunningStatus_STATUS_Suspended))
	gens["Tags"] = gen.MapOf(
		gen.AlphaString(),
		gen.AlphaString())
...
func RunPropertyAssignmentTestForContainerApp_Spec(subject ContainerApp_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerApp_Spec
...
func RunPropertyAssignmentTestForContainerResources(subject ContainerResources) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerResources
...
func RunPropertyAssignmentTestForContainerResources_STATUS(subject ContainerResources_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ContainerResources_STATUS
...
func RunPropertyAssignmentTestForContainer_STATUS(subject Container_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Container_STATUS
...
func RunPropertyAssignmentTestForCorsPolicy(subject CorsPolicy) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CorsPolicy
...
func RunPropertyAssignmentTestForCorsPolicy_STATUS(subject CorsPolicy_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CorsPolicy_STATUS
...
func RunPropertyAssignmentTestForCustomDomain(subject CustomDomain) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CustomDomain
...
func RunPropertyAssignmentTestForCustomDomain_STATUS(subject CustomDomain_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CustomDomain_STATUS
...
func RunPropertyAssignmentTestForCustomScaleRule(subject CustomScaleRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CustomScaleRule
...
func RunPropertyAssignmentTestForCustomScaleRule_STATUS(subject CustomScaleRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.CustomScaleRule_STATUS
...
func RunPropertyAssignmentTestForDapr(subject Dapr) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Dapr
...
func RunPropertyAssignmentTestForDapr_STATUS(subject Dapr_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Dapr_STATUS
...
func RunPropertyAssignmentTestForEnvironmentVar(subject EnvironmentVar) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.EnvironmentVar
...
func RunPropertyAssignmentTestForEnvironmentVar_STATUS(subject EnvironmentVar_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.EnvironmentVar_STATUS
...
func RunPropertyAssignmentTestForExtendedLocation(subject ExtendedLocation) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ExtendedLocation
...
func RunPropertyAssignmentTestForExtendedLocation_STATUS(subject ExtendedLocation_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ExtendedLocation_STATUS
...
func RunPropertyAssignmentTestForHttpScaleRule(subject HttpScaleRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.HttpScaleRule
...
func RunPropertyAssignmentTestForHttpScaleRule_STATUS(subject HttpScaleRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.HttpScaleRule_STATUS
...
func Test_IdentitySettings_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IdentitySettings to IdentitySettings via AssignProperties_To_IdentitySettings & AssignProperties_From_IdentitySettings returns original",
		prop.ForAll(RunPropertyAssignmentTestForIdentitySettings, IdentitySettingsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIdentitySettings tests if a specific instance of IdentitySettings can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIdentitySettings(subject IdentitySettings) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IdentitySettings
	err := copied.AssignProperties_To_IdentitySettings(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual IdentitySettings
	err = actual.AssignProperties_From_IdentitySettings(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IdentitySettings_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IdentitySettings via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIdentitySettings, IdentitySettingsGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIdentitySettings runs a test to see if a specific instance of IdentitySettings round trips to JSON and back losslessly
func RunJSONSerializationTestForIdentitySettings(subject IdentitySettings) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of IdentitySettings instances for property testing - lazily instantiated by IdentitySettingsGenerator()
var identitySettingsGenerator gopter.Gen

// IdentitySettingsGenerator returns a generator of IdentitySettings instances for property testing.
func IdentitySettingsGenerator() gopter.Gen {
	if identitySettingsGenerator != nil {
		return identitySettingsGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIdentitySettings(generators)
	identitySettingsGenerator = gen.Struct(reflect.TypeOf(IdentitySettings{}), generators)

	return identitySettingsGenerator
}

// AddIndependentPropertyGeneratorsForIdentitySettings is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIdentitySettings(gens map[string]gopter.Gen) {
	gens["Lifecycle"] = gen.PtrOf(gen.OneConstOf(
		IdentitySettings_Lifecycle_All,
		IdentitySettings_Lifecycle_Init,
		IdentitySettings_Lifecycle_Main,
		IdentitySettings_Lifecycle_None))
}

func Test_IdentitySettings_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from IdentitySettings_STATUS to IdentitySettings_STATUS via AssignProperties_To_IdentitySettings_STATUS & AssignProperties_From_IdentitySettings_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForIdentitySettings_STATUS, IdentitySettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForIdentitySettings_STATUS tests if a specific instance of IdentitySettings_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForIdentitySettings_STATUS(subject IdentitySettings_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IdentitySettings_STATUS
	err := copied.AssignProperties_To_IdentitySettings_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual IdentitySettings_STATUS
	err = actual.AssignProperties_From_IdentitySettings_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_IdentitySettings_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of IdentitySettings_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForIdentitySettings_STATUS, IdentitySettings_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForIdentitySettings_STATUS runs a test to see if a specific instance of IdentitySettings_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForIdentitySettings_STATUS(subject IdentitySettings_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of IdentitySettings_STATUS instances for property testing - lazily instantiated by
// IdentitySettings_STATUSGenerator()
var identitySettings_STATUSGenerator gopter.Gen

// IdentitySettings_STATUSGenerator returns a generator of IdentitySettings_STATUS instances for property testing.
func IdentitySettings_STATUSGenerator() gopter.Gen {
	if identitySettings_STATUSGenerator != nil {
		return identitySettings_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForIdentitySettings_STATUS(generators)
	identitySettings_STATUSGenerator = gen.Struct(reflect.TypeOf(IdentitySettings_STATUS{}), generators)

	return identitySettings_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForIdentitySettings_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForIdentitySettings_STATUS(gens map[string]gopter.Gen) {
	gens["Identity"] = gen.PtrOf(gen.AlphaString())
	gens["Lifecycle"] = gen.PtrOf(gen.OneConstOf(
		IdentitySettings_Lifecycle_STATUS_All,
		IdentitySettings_Lifecycle_STATUS_Init,
		IdentitySettings_Lifecycle_STATUS_Main,
		IdentitySettings_Lifecycle_STATUS_None))
}
...
func RunPropertyAssignmentTestForIngress(subject Ingress) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Ingress
...
func RunPropertyAssignmentTestForIngressPortMapping(subject IngressPortMapping) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IngressPortMapping
...
func RunPropertyAssignmentTestForIngressPortMapping_STATUS(subject IngressPortMapping_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IngressPortMapping_STATUS
...
func RunPropertyAssignmentTestForIngress_STATUS(subject Ingress_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Ingress_STATUS
...
func RunPropertyAssignmentTestForIngress_StickySessions(subject Ingress_StickySessions) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Ingress_StickySessions
...
func RunPropertyAssignmentTestForIngress_StickySessions_STATUS(subject Ingress_StickySessions_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Ingress_StickySessions_STATUS
...
func RunPropertyAssignmentTestForIpSecurityRestrictionRule(subject IpSecurityRestrictionRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IpSecurityRestrictionRule
...
func RunPropertyAssignmentTestForIpSecurityRestrictionRule_STATUS(subject IpSecurityRestrictionRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.IpSecurityRestrictionRule_STATUS
...
func RunPropertyAssignmentTestForManagedServiceIdentity(subject ManagedServiceIdentity) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ManagedServiceIdentity
...
func RunPropertyAssignmentTestForManagedServiceIdentity_STATUS(subject ManagedServiceIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ManagedServiceIdentity_STATUS
...
func RunPropertyAssignmentTestForQueueScaleRule(subject QueueScaleRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.QueueScaleRule
...
func RunPropertyAssignmentTestForQueueScaleRule_STATUS(subject QueueScaleRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.QueueScaleRule_STATUS
...
func RunPropertyAssignmentTestForRegistryCredentials(subject RegistryCredentials) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.RegistryCredentials
...
func RunPropertyAssignmentTestForRegistryCredentials_STATUS(subject RegistryCredentials_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.RegistryCredentials_STATUS
...
func Test_Runtime_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Runtime to Runtime via AssignProperties_To_Runtime & AssignProperties_From_Runtime returns original",
		prop.ForAll(RunPropertyAssignmentTestForRuntime, RuntimeGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRuntime tests if a specific instance of Runtime can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRuntime(subject Runtime) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Runtime
	err := copied.AssignProperties_To_Runtime(&other)
	if err != nil {
		return err.Error()
	}
	...
	// Use AssignPropertiesFrom() to convert back to our original type
	var actual Runtime
	err = actual.AssignProperties_From_Runtime(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Runtime_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Runtime via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRuntime, RuntimeGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRuntime runs a test to see if a specific instance of Runtime round trips to JSON and back losslessly
func RunJSONSerializationTestForRuntime(subject Runtime) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Runtime instances for property testing - lazily instantiated by RuntimeGenerator()
var runtimeGenerator gopter.Gen

// RuntimeGenerator returns a generator of Runtime instances for property testing.
func RuntimeGenerator() gopter.Gen {
	if runtimeGenerator != nil {
		return runtimeGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForRuntime(generators)
	runtimeGenerator = gen.Struct(reflect.TypeOf(Runtime{}), generators)

	return runtimeGenerator
}

// AddRelatedPropertyGeneratorsForRuntime is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRuntime(gens map[string]gopter.Gen) {
	gens["Java"] = gen.PtrOf(Runtime_JavaGenerator())
}

func Test_Runtime_Java_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Runtime_Java to Runtime_Java via AssignProperties_To_Runtime_Java & AssignProperties_From_Runtime_Java returns original",
		prop.ForAll(RunPropertyAssignmentTestForRuntime_Java, Runtime_JavaGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRuntime_Java tests if a specific instance of Runtime_Java can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRuntime_Java(subject Runtime_Java) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Runtime_Java
	err := copied.AssignProperties_To_Runtime_Java(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual Runtime_Java
	err = actual.AssignProperties_From_Runtime_Java(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Runtime_Java_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Runtime_Java via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRuntime_Java, Runtime_JavaGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRuntime_Java runs a test to see if a specific instance of Runtime_Java round trips to JSON and back losslessly
func RunJSONSerializationTestForRuntime_Java(subject Runtime_Java) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Runtime_Java instances for property testing - lazily instantiated by Runtime_JavaGenerator()
var runtime_JavaGenerator gopter.Gen

// Runtime_JavaGenerator returns a generator of Runtime_Java instances for property testing.
func Runtime_JavaGenerator() gopter.Gen {
	if runtime_JavaGenerator != nil {
		return runtime_JavaGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRuntime_Java(generators)
	runtime_JavaGenerator = gen.Struct(reflect.TypeOf(Runtime_Java{}), generators)

	return runtime_JavaGenerator
}

// AddIndependentPropertyGeneratorsForRuntime_Java is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRuntime_Java(gens map[string]gopter.Gen) {
	gens["EnableMetrics"] = gen.PtrOf(gen.Bool())
}

func Test_Runtime_Java_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Runtime_Java_STATUS to Runtime_Java_STATUS via AssignProperties_To_Runtime_Java_STATUS & AssignProperties_From_Runtime_Java_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForRuntime_Java_STATUS, Runtime_Java_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRuntime_Java_STATUS tests if a specific instance of Runtime_Java_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRuntime_Java_STATUS(subject Runtime_Java_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Runtime_Java_STATUS
	err := copied.AssignProperties_To_Runtime_Java_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual Runtime_Java_STATUS
	err = actual.AssignProperties_From_Runtime_Java_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Runtime_Java_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Runtime_Java_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRuntime_Java_STATUS, Runtime_Java_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRuntime_Java_STATUS runs a test to see if a specific instance of Runtime_Java_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForRuntime_Java_STATUS(subject Runtime_Java_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Runtime_Java_STATUS instances for property testing - lazily instantiated by
// Runtime_Java_STATUSGenerator()
var runtime_Java_STATUSGenerator gopter.Gen

// Runtime_Java_STATUSGenerator returns a generator of Runtime_Java_STATUS instances for property testing.
func Runtime_Java_STATUSGenerator() gopter.Gen {
	if runtime_Java_STATUSGenerator != nil {
		return runtime_Java_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRuntime_Java_STATUS(generators)
	runtime_Java_STATUSGenerator = gen.Struct(reflect.TypeOf(Runtime_Java_STATUS{}), generators)

	return runtime_Java_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForRuntime_Java_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRuntime_Java_STATUS(gens map[string]gopter.Gen) {
	gens["EnableMetrics"] = gen.PtrOf(gen.Bool())
}

func Test_Runtime_STATUS_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from Runtime_STATUS to Runtime_STATUS via AssignProperties_To_Runtime_STATUS & AssignProperties_From_Runtime_STATUS returns original",
		prop.ForAll(RunPropertyAssignmentTestForRuntime_STATUS, Runtime_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForRuntime_STATUS tests if a specific instance of Runtime_STATUS can be assigned to storage and back losslessly
func RunPropertyAssignmentTestForRuntime_STATUS(subject Runtime_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Runtime_STATUS
	err := copied.AssignProperties_To_Runtime_STATUS(&other)
	if err != nil {
		return err.Error()
	}

	// Use AssignPropertiesFrom() to convert back to our original type
	var actual Runtime_STATUS
	err = actual.AssignProperties_From_Runtime_STATUS(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_Runtime_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of Runtime_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRuntime_STATUS, Runtime_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRuntime_STATUS runs a test to see if a specific instance of Runtime_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForRuntime_STATUS(subject Runtime_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
// Generator of Runtime_STATUS instances for property testing - lazily instantiated by Runtime_STATUSGenerator()
var runtime_STATUSGenerator gopter.Gen

// Runtime_STATUSGenerator returns a generator of Runtime_STATUS instances for property testing.
func Runtime_STATUSGenerator() gopter.Gen {
	if runtime_STATUSGenerator != nil {
		return runtime_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddRelatedPropertyGeneratorsForRuntime_STATUS(generators)
	runtime_STATUSGenerator = gen.Struct(reflect.TypeOf(Runtime_STATUS{}), generators)

	return runtime_STATUSGenerator
}

// AddRelatedPropertyGeneratorsForRuntime_STATUS is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForRuntime_STATUS(gens map[string]gopter.Gen) {
	gens["Java"] = gen.PtrOf(Runtime_Java_STATUSGenerator())
}
...
func RunPropertyAssignmentTestForScale(subject Scale) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Scale
...
func AddIndependentPropertyGeneratorsForScale(gens map[string]gopter.Gen) {
	gens["CooldownPeriod"] = gen.PtrOf(gen.Int())
...
func RunPropertyAssignmentTestForScaleRule(subject ScaleRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ScaleRule
...
func RunPropertyAssignmentTestForScaleRuleAuth(subject ScaleRuleAuth) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ScaleRuleAuth
...
func RunPropertyAssignmentTestForScaleRuleAuth_STATUS(subject ScaleRuleAuth_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ScaleRuleAuth_STATUS
...
func RunPropertyAssignmentTestForScaleRule_STATUS(subject ScaleRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ScaleRule_STATUS
...
func RunPropertyAssignmentTestForScale_STATUS(subject Scale_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Scale_STATUS
...
func RunPropertyAssignmentTestForSecret(subject Secret) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Secret
...
func RunPropertyAssignmentTestForSecretVolumeItem(subject SecretVolumeItem) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.SecretVolumeItem
...
func RunPropertyAssignmentTestForSecretVolumeItem_STATUS(subject SecretVolumeItem_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.SecretVolumeItem_STATUS
...
func RunPropertyAssignmentTestForSecret_STATUS(subject Secret_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Secret_STATUS
...
func RunPropertyAssignmentTestForService(subject Service) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Service
...
func RunPropertyAssignmentTestForServiceBind(subject ServiceBind) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ServiceBind
...
func RunPropertyAssignmentTestForServiceBind_STATUS(subject ServiceBind_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.ServiceBind_STATUS
...
func RunPropertyAssignmentTestForService_STATUS(subject Service_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Service_STATUS
...
func RunPropertyAssignmentTestForTcpScaleRule(subject TcpScaleRule) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.TcpScaleRule
...
func RunPropertyAssignmentTestForTcpScaleRule_STATUS(subject TcpScaleRule_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.TcpScaleRule_STATUS
...
func RunPropertyAssignmentTestForTemplate(subject Template) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Template
...
func RunPropertyAssignmentTestForTemplate_STATUS(subject Template_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Template_STATUS
...
func RunPropertyAssignmentTestForTrafficWeight(subject TrafficWeight) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.TrafficWeight
...
func RunPropertyAssignmentTestForTrafficWeight_STATUS(subject TrafficWeight_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.TrafficWeight_STATUS
...
func RunPropertyAssignmentTestForUserAssignedIdentityDetails(subject UserAssignedIdentityDetails) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.UserAssignedIdentityDetails
...
func RunPropertyAssignmentTestForUserAssignedIdentity_STATUS(subject UserAssignedIdentity_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.UserAssignedIdentity_STATUS
...
func RunPropertyAssignmentTestForVolume(subject Volume) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Volume
...
func AddIndependentPropertyGeneratorsForVolume(gens map[string]gopter.Gen) {
	...
	gens["StorageType"] = gen.PtrOf(gen.OneConstOf(
		Volume_StorageType_AzureFile,
		Volume_StorageType_EmptyDir,
		Volume_StorageType_NfsAzureFile,
		Volume_StorageType_Secret))
}
...
func RunPropertyAssignmentTestForVolumeMount(subject VolumeMount) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.VolumeMount
...
func RunPropertyAssignmentTestForVolumeMount_STATUS(subject VolumeMount_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.VolumeMount_STATUS
...
func RunPropertyAssignmentTestForVolume_STATUS(subject Volume_STATUS) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other app_v1api20250101s.Volume_STATUS
...
func AddIndependentPropertyGeneratorsForVolume_STATUS(gens map[string]gopter.Gen) {
	...
	gens["StorageName"] = gen.PtrOf(gen.AlphaString())
	gens["StorageType"] = gen.PtrOf(gen.OneConstOf(
		Volume_StorageType_STATUS_AzureFile,
		Volume_StorageType_STATUS_EmptyDir,
		Volume_StorageType_STATUS_NfsAzureFile,
		Volume_StorageType_STATUS_Secret))
}
