...
func (environment *ManagedEnvironment) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected app/v20250101/storage/ManagedEnvironment but received %T instead", hub)
	}
...
// Storage version of v1api20250101.ManagedEnvironment_Spec
...
func (environment *ManagedEnvironment_Spec) AssignProperties_To_ManagedEnvironment_Spec(destination *storage.ManagedEnvironment_Spec) error {
	...
	if environment.Identity != nil {
		...
		err := environment.Identity.AssignProperties_To_ManagedServiceIdentity(&identity)
		if err != nil {
...
func (environment *ManagedEnvironment_STATUS) AssignProperties_To_ManagedEnvironment_STATUS(destination *storage.ManagedEnvironment_STATUS) error {
	...
	if environment.Identity != nil {
		...
		err := environment.Identity.AssignProperties_To_ManagedServiceIdentity_STATUS(&identity)
		if err != nil {
...
func (configuration *CustomDomainConfiguration) AssignProperties_From_CustomDomainConfiguration(source *storage.CustomDomainConfiguration) error {
	...
	if source.CertificateKeyVaultProperties != nil {
		var certificateKeyVaultProperty CertificateKeyVaultProperties
		err := certificateKeyVaultProperty.AssignProperties_From_CertificateKeyVaultProperties(source.CertificateKeyVaultProperties)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_CertificateKeyVaultProperties() to populate field CertificateKeyVaultProperties")
		}
		configuration.CertificateKeyVaultProperties = &certificateKeyVaultProperty
	} else {
		configuration.CertificateKeyVaultProperties = nil
	}
...
func (configuration *CustomDomainConfiguration) AssignProperties_To_CustomDomainConfiguration(destination *storage.CustomDomainConfiguration) error {
	...
	if configuration.CertificateKeyVaultProperties != nil {
		...
		err := configuration.CertificateKeyVaultProperties.AssignProperties_To_CertificateKeyVaultProperties(&certificateKeyVaultProperty)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_CertificateKeyVaultProperties() to populate field CertificateKeyVaultProperties")
		}
...
type CustomDomainConfiguration_STATUS struct {
	CertificateKeyVaultProperties *CertificateKeyVaultProperties_STATUS `json:"certificateKeyVaultProperties,omitempty"`
...
func (configuration *CustomDomainConfiguration_STATUS) AssignProperties_From_CustomDomainConfiguration_STATUS(source *storage.CustomDomainConfiguration_STATUS) error {
	...
	// CertificateKeyVaultProperties
	if source.CertificateKeyVaultProperties != nil {
		var certificateKeyVaultProperty CertificateKeyVaultProperties_STATUS
		err := certificateKeyVaultProperty.AssignProperties_From_CertificateKeyVaultProperties_STATUS(source.CertificateKeyVaultProperties)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_From_CertificateKeyVaultProperties_STATUS() to populate field CertificateKeyVaultProperties")
		}
		configuration.CertificateKeyVaultProperties = &certificateKeyVaultProperty
	} else {
		configuration.CertificateKeyVaultProperties = nil
...
func (configuration *CustomDomainConfiguration_STATUS) AssignProperties_To_CustomDomainConfiguration_STATUS(destination *storage.CustomDomainConfiguration_STATUS) error {
	...
	if configuration.CertificateKeyVaultProperties != nil {
		...
		err := configuration.CertificateKeyVaultProperties.AssignProperties_To_CertificateKeyVaultProperties_STATUS(&certificateKeyVaultProperty)
		if err != nil {
			return eris.Wrap(err, "calling AssignProperties_To_CertificateKeyVaultProperties_STATUS() to populate field CertificateKeyVaultProperties")
		}
		destination.CertificateKeyVaultProperties = &certificateKeyVaultProperty
	} else {
		destination.CertificateKeyVaultProperties = nil
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerAuthentication_Spec
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerAuthentication_STATUS
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerTrafficConfiguration_Spec
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerTrafficConfiguration_STATUS
...
// AssignProperties_From_CertificateKeyVaultProperties populates our CertificateKeyVaultProperties from the provided source CertificateKeyVaultProperties
func (properties *CertificateKeyVaultProperties) AssignProperties_From_CertificateKeyVaultProperties(source *storage.CertificateKeyVaultProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	if source.IdentityReference != nil {
		...
		properties.IdentityReference = &identityReference
	} else {
		properties.IdentityReference = nil
	}

	// KeyVaultUrl
	properties.KeyVaultUrl = genruntime.ClonePointerToString(source.KeyVaultUrl)
	...
	// Invoke the augmentConversionForCertificateKeyVaultProperties interface (if implemented) to customize the conversion
	var propertiesAsAny any = properties
	if augmentedProperties, ok := propertiesAsAny.(augmentConversionForCertificateKeyVaultProperties); ok {
...
// AssignProperties_To_CertificateKeyVaultProperties populates the provided destination CertificateKeyVaultProperties from our CertificateKeyVaultProperties
func (properties *CertificateKeyVaultProperties) AssignProperties_To_CertificateKeyVaultProperties(destination *storage.CertificateKeyVaultProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)

	// IdentityReference
	if properties.IdentityReference != nil {
		identityReference := properties.IdentityReference.Copy()
	...
	// KeyVaultUrl
	destination.KeyVaultUrl = genruntime.ClonePointerToString(properties.KeyVaultUrl)
...
// Properties for a certificate stored in a Key Vault.
type CertificateKeyVaultProperties_STATUS struct {
	Identity    *string                `json:"identity,omitempty"`
	KeyVaultUrl *string                `json:"keyVaultUrl,omitempty"`
	PropertyBag genruntime.PropertyBag `json:"$propertyBag,omitempty"`
}

// AssignProperties_From_CertificateKeyVaultProperties_STATUS populates our CertificateKeyVaultProperties_STATUS from the provided source CertificateKeyVaultProperties_STATUS
func (properties *CertificateKeyVaultProperties_STATUS) AssignProperties_From_CertificateKeyVaultProperties_STATUS(source *storage.CertificateKeyVaultProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
	...
	// Invoke the augmentConversionForCertificateKeyVaultProperties_STATUS interface (if implemented) to customize the conversion
	var propertiesAsAny any = properties
	if augmentedProperties, ok := propertiesAsAny.(augmentConversionForCertificateKeyVaultProperties_STATUS); ok {
		err := augmentedProperties.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
// AssignProperties_To_CertificateKeyVaultProperties_STATUS populates the provided destination CertificateKeyVaultProperties_STATUS from our CertificateKeyVaultProperties_STATUS
func (properties *CertificateKeyVaultProperties_STATUS) AssignProperties_To_CertificateKeyVaultProperties_STATUS(destination *storage.CertificateKeyVaultProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerTrafficConfiguration_Encryption_Spec
...
// Storage version of v1api20250101.ManagedEnvironment_Properties_PeerTrafficConfiguration_Encryption_STATUS
...
type augmentConversionForCertificateKeyVaultProperties interface {
	AssignPropertiesFrom(src *storage.CertificateKeyVaultProperties) error
	AssignPropertiesTo(dst *storage.CertificateKeyVaultProperties) error
}

type augmentConversionForCertificateKeyVaultProperties_STATUS interface {
	AssignPropertiesFrom(src *storage.CertificateKeyVaultProperties_STATUS) error
	AssignPropertiesTo(dst *storage.CertificateKeyVaultProperties_STATUS) error
}
