...
// Storage version of v1api20250101.ContainerApp_Spec
...
func (containerApp *ContainerApp_STATUS) AssignProperties_From_ContainerApp_STATUS(source *storage.ContainerApp_STATUS) error {
	...
	// RunningStatus
	containerApp.RunningStatus = genruntime.ClonePointerToString(source.RunningStatus)
...
func (containerApp *ContainerApp_STATUS) AssignProperties_To_ContainerApp_STATUS(destination *storage.ContainerApp_STATUS) error {
	...
	// RunningStatus
	destination.RunningStatus = genruntime.ClonePointerToString(containerApp.RunningStatus)
...
// Storage version of v1api20250101.ContainerAppOperatorConfigMaps
...
func (settings *IdentitySettings) AssignProperties_From_IdentitySettings(source *storage.IdentitySettings) error {
	...
	// Lifecycle
	settings.Lifecycle = genruntime.ClonePointerToString(source.Lifecycle)
	...
	// Invoke the augmentConversionForIdentitySettings interface (if implemented) to customize the conversion
	var settingsAsAny any = settings
	if augmentedSettings, ok := settingsAsAny.(augmentConversionForIdentitySettings); ok {
...
func (settings *IdentitySettings) AssignProperties_To_IdentitySettings(destination *storage.IdentitySettings) error {
	...
	// Lifecycle
	destination.Lifecycle = genruntime.ClonePointerToString(settings.Lifecycle)
...
func (settings *IdentitySettings_STATUS) AssignProperties_From_IdentitySettings_STATUS(source *storage.IdentitySettings_STATUS) error {
	...
	// Invoke the augmentConversionForIdentitySettings_STATUS interface (if implemented) to customize the conversion
	var settingsAsAny any = settings
	if augmentedSettings, ok := settingsAsAny.(augmentConversionForIdentitySettings_STATUS); ok {
		err := augmentedSettings.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
func (runtime *Runtime) AssignProperties_From_Runtime(source *storage.Runtime) error {
	...
	// Invoke the augmentConversionForRuntime interface (if implemented) to customize the conversion
	var runtimeAsAny any = runtime
	if augmentedRuntime, ok := runtimeAsAny.(augmentConversionForRuntime); ok {
...
func (runtime *Runtime_STATUS) AssignProperties_From_Runtime_STATUS(source *storage.Runtime_STATUS) error {
	...
	// Invoke the augmentConversionForRuntime_STATUS interface (if implemented) to customize the conversion
	var runtimeAsAny any = runtime
	if augmentedRuntime, ok := runtimeAsAny.(augmentConversionForRuntime_STATUS); ok {
		err := augmentedRuntime.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForIdentitySettings interface {
	AssignPropertiesFrom(src *storage.IdentitySettings) error
	AssignPropertiesTo(dst *storage.IdentitySettings) error
}

type augmentConversionForIdentitySettings_STATUS interface {
	AssignPropertiesFrom(src *storage.IdentitySettings_STATUS) error
	AssignPropertiesTo(dst *storage.IdentitySettings_STATUS) error
}
...
type augmentConversionForRuntime interface {
	AssignPropertiesFrom(src *storage.Runtime) error
	AssignPropertiesTo(dst *storage.Runtime) error
}

type augmentConversionForRuntime_STATUS interface {
	AssignPropertiesFrom(src *storage.Runtime_STATUS) error
	AssignPropertiesTo(dst *storage.Runtime_STATUS) error
}
...
// Storage version of v1api20250101.Ingress_StickySessions
...
// Storage version of v1api20250101.Ingress_StickySessions_STATUS
...
// Storage version of v1api20250101.Runtime_Java
...
func (java *Runtime_Java) AssignProperties_From_Runtime_Java(source *storage.Runtime_Java) error {
	...
	// Update the property bag
	if len(propertyBag) > 0 {
		java.PropertyBag = propertyBag
	} else {
		java.PropertyBag = nil
	}

	// Invoke the augmentConversionForRuntime_Java interface (if implemented) to customize the conversion
	var javaAsAny any = java
	if augmentedJava, ok := javaAsAny.(augmentConversionForRuntime_Java); ok {
		err := augmentedJava.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
	}
...
func (java *Runtime_Java) AssignProperties_To_Runtime_Java(destination *storage.Runtime_Java) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(java.PropertyBag)
	...
	var javaAsAny any = java
	if augmentedJava, ok := javaAsAny.(augmentConversionForRuntime_Java); ok {
		err := augmentedJava.AssignPropertiesTo(destination)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesTo() for conversion")
		}
	}
...
// Storage version of v1api20250101.Runtime_Java_STATUS
...
func (java *Runtime_Java_STATUS) AssignProperties_From_Runtime_Java_STATUS(source *storage.Runtime_Java_STATUS) error {
	...
	// Invoke the augmentConversionForRuntime_Java_STATUS interface (if implemented) to customize the conversion
	var javaAsAny any = java
	if augmentedJava, ok := javaAsAny.(augmentConversionForRuntime_Java_STATUS); ok {
		err := augmentedJava.AssignPropertiesFrom(source)
		if err != nil {
			return eris.Wrap(err, "calling augmented AssignPropertiesFrom() for conversion")
		}
...
type augmentConversionForRuntime_Java interface {
	AssignPropertiesFrom(src *storage.Runtime_Java) error
	AssignPropertiesTo(dst *storage.Runtime_Java) error
}

type augmentConversionForRuntime_Java_STATUS interface {
	AssignPropertiesFrom(src *storage.Runtime_Java_STATUS) error
	AssignPropertiesTo(dst *storage.Runtime_Java_STATUS) error
}
...
// Storage version of v1api20250101.ContainerAppProbe_HttpGet
...
// Storage version of v1api20250101.ContainerAppProbe_HttpGet_STATUS
...
// Storage version of v1api20250101.ContainerAppProbe_TcpSocket
...
// Storage version of v1api20250101.ContainerAppProbe_TcpSocket_STATUS
...
// Storage version of v1api20250101.ContainerAppProbe_HttpGet_HttpHeaders
...
// Storage version of v1api20250101.ContainerAppProbe_HttpGet_HttpHeaders_STATUS
