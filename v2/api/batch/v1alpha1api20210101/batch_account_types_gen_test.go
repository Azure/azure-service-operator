...
// RunPropertyAssignmentTestForBatchAccountCreateParameters_STATUS tests if a specific instance of BatchAccountCreateParameters_STATUS can be assigned to v1alpha1api20210101storage and back losslessly
func RunPropertyAssignmentTestForBatchAccountCreateParameters_STATUS(subject BatchAccountCreateParameters_STATUS) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20210101s.BatchAccountCreateParameters_STATUS
