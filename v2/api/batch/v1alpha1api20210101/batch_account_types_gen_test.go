...
// RunPropertyAssignmentTestForBatchAccountIdentity_STATUS_UserAssignedIdentities tests if a specific instance of BatchAccountIdentity_STATUS_UserAssignedIdentities can be assigned to v1alpha1api20210101storage and back losslessly
