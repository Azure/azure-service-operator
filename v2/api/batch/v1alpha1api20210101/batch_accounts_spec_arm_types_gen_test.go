...
func Test_BatchAccount_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/batch/v1alpha1api20210101/batch_account__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/batch/v1alpha1api20210101/batch_accounts_spec_arm_types_gen_test.go
	// Serialize to JSON
