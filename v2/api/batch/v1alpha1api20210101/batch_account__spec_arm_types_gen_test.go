...
func AddRelatedPropertyGeneratorsForBatchAccount_SpecARM(gens map[string]gopter.Gen) {
	...
	gens["Properties"] = gen.PtrOf(BatchAccountPropertiesARMGenerator())
}
...
func Test_BatchAccountPropertiesARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of BatchAccountPropertiesARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForBatchAccountPropertiesARM, BatchAccountPropertiesARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBatchAccountPropertiesARM runs a test to see if a specific instance of BatchAccountPropertiesARM round trips to JSON and back losslessly
func RunJSONSerializationTestForBatchAccountPropertiesARM(subject BatchAccountPropertiesARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual BatchAccountPropertiesARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of BatchAccountPropertiesARM instances for property testing - lazily instantiated by
//BatchAccountPropertiesARMGenerator()
var batchAccountPropertiesARMGenerator gopter.Gen

// BatchAccountPropertiesARMGenerator returns a generator of BatchAccountPropertiesARM instances for property testing.
// We first initialize batchAccountPropertiesARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func BatchAccountPropertiesARMGenerator() gopter.Gen {
	if batchAccountPropertiesARMGenerator != nil {
		return batchAccountPropertiesARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBatchAccountPropertiesARM(generators)
	batchAccountPropertiesARMGenerator = gen.Struct(reflect.TypeOf(BatchAccountPropertiesARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBatchAccountPropertiesARM(generators)
	AddRelatedPropertyGeneratorsForBatchAccountPropertiesARM(generators)
	batchAccountPropertiesARMGenerator = gen.Struct(reflect.TypeOf(BatchAccountPropertiesARM{}), generators)

	return batchAccountPropertiesARMGenerator
}

// AddIndependentPropertyGeneratorsForBatchAccountPropertiesARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBatchAccountPropertiesARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForBatchAccountPropertiesARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBatchAccountPropertiesARM(gens map[string]gopter.Gen) {
