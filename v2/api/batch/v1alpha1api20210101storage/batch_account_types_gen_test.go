...
func Test_BatchAccountIdentity_Status_UserAssignedIdentities_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from BatchAccountIdentity_Status_UserAssignedIdentities to UserAssignedIdentities_Status via AssignPropertiesToUserAssignedIdentitiesStatus & AssignPropertiesFromUserAssignedIdentitiesStatus returns original",
...
// RunPropertyAssignmentTestForBatchAccountIdentityStatusUserAssignedIdentities tests if a specific instance of BatchAccountIdentity_Status_UserAssignedIdentities can be assigned to v1alpha1api20210601storage and back losslessly
