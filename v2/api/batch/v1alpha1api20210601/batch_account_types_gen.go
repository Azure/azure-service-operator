...
//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/resourceDefinitions/batchAccounts
...
// +kubebuilder:webhook:path=/mutate-batch-azure-com-v1alpha1api20210601-batchaccount,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v1alpha1api20210601,name=default.v1alpha1api20210601.batchaccounts.batch.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-batch-azure-com-v1alpha1api20210601-batchaccount,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=batch.azure.com,resources=batchaccounts,verbs=create;update,versions=v1alpha1api20210601,name=validate.v1alpha1api20210601.batchaccounts.batch.azure.com,admissionReviewVersions=v1beta1
...
type BatchAccount_Status struct {
	...
	//AllowedAuthenticationModes: List of allowed authentication modes for the Batch
...
func (batchAccountStatus *BatchAccount_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.Properties != nil {
		for _, item := range typedInput.Properties.AllowedAuthenticationModes {
			batchAccountStatus.AllowedAuthenticationModes = append(batchAccountStatus.AllowedAuthenticationModes, item)
		}
	}
...
func (batchAccountStatus *BatchAccount_Status) AssignPropertiesFromBatchAccountStatus(source *v1alpha1api20210601storage.BatchAccount_Status) error {
	...
	if source.AllowedAuthenticationModes != nil {
		...
		for allowedAuthenticationModeIndex, allowedAuthenticationModeItem := range source.AllowedAuthenticationModes {
			...
			allowedAuthenticationModeItem := allowedAuthenticationModeItem
			allowedAuthenticationModeList[allowedAuthenticationModeIndex] = AuthenticationMode_Status(allowedAuthenticationModeItem)
		}
		batchAccountStatus.AllowedAuthenticationModes = allowedAuthenticationModeList
	} else {
		batchAccountStatus.AllowedAuthenticationModes = nil
	}
...
func (batchAccountStatus *BatchAccount_Status) AssignPropertiesToBatchAccountStatus(destination *v1alpha1api20210601storage.BatchAccount_Status) error {
	...
	// AllowedAuthenticationModes
	if batchAccountStatus.AllowedAuthenticationModes != nil {
		allowedAuthenticationModeList := make([]string, len(batchAccountStatus.AllowedAuthenticationModes))
		for allowedAuthenticationModeIndex, allowedAuthenticationModeItem := range batchAccountStatus.AllowedAuthenticationModes {
			// Shadow the loop variable to avoid aliasing
			allowedAuthenticationModeItem := allowedAuthenticationModeItem
...
const BatchAccountsSpecAPIVersion20210601 = BatchAccountsSpecAPIVersion("2021-06-01")

type BatchAccounts_Spec struct {
	//AllowedAuthenticationModes: List of allowed authentication modes for the Batch
	//account that can be used to authenticate with the data plane. This does not
	//affect authentication with the control plane.
	AllowedAuthenticationModes []BatchAccountCreatePropertiesAllowedAuthenticationModes `json:"allowedAuthenticationModes,omitempty"`
	...
	//Identity: The identity of the Batch account, if configured. This is used when
...
func (batchAccountsSpec *BatchAccounts_Spec) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	for _, item := range batchAccountsSpec.AllowedAuthenticationModes {
		result.Properties.AllowedAuthenticationModes = append(result.Properties.AllowedAuthenticationModes, item)
	}
...
func (batchAccountsSpec *BatchAccounts_Spec) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	// copying flattened property:
	for _, item := range typedInput.Properties.AllowedAuthenticationModes {
		batchAccountsSpec.AllowedAuthenticationModes = append(batchAccountsSpec.AllowedAuthenticationModes, item)
	}
...
func (batchAccountsSpec *BatchAccounts_Spec) AssignPropertiesFromBatchAccountsSpec(source *v1alpha1api20210601storage.BatchAccounts_Spec) error {
	...
	// AllowedAuthenticationModes
	if source.AllowedAuthenticationModes != nil {
		allowedAuthenticationModeList := make([]BatchAccountCreatePropertiesAllowedAuthenticationModes, len(source.AllowedAuthenticationModes))
		for allowedAuthenticationModeIndex, allowedAuthenticationModeItem := range source.AllowedAuthenticationModes {
			// Shadow the loop variable to avoid aliasing
			allowedAuthenticationModeItem := allowedAuthenticationModeItem
			allowedAuthenticationModeList[allowedAuthenticationModeIndex] = BatchAccountCreatePropertiesAllowedAuthenticationModes(allowedAuthenticationModeItem)
		}
		batchAccountsSpec.AllowedAuthenticationModes = allowedAuthenticationModeList
	} else {
		batchAccountsSpec.AllowedAuthenticationModes = nil
	}
...
func (batchAccountsSpec *BatchAccounts_Spec) AssignPropertiesToBatchAccountsSpec(destination *v1alpha1api20210601storage.BatchAccounts_Spec) error {
	...
	// AllowedAuthenticationModes
	if batchAccountsSpec.AllowedAuthenticationModes != nil {
		allowedAuthenticationModeList := make([]string, len(batchAccountsSpec.AllowedAuthenticationModes))
		for allowedAuthenticationModeIndex, allowedAuthenticationModeItem := range batchAccountsSpec.AllowedAuthenticationModes {
			// Shadow the loop variable to avoid aliasing
			allowedAuthenticationModeItem := allowedAuthenticationModeItem
			allowedAuthenticationModeList[allowedAuthenticationModeIndex] = string(allowedAuthenticationModeItem)
		}
...
const (
	AuthenticationMode_StatusAAD                     = AuthenticationMode_Status("AAD")
	AuthenticationMode_StatusSharedKey               = AuthenticationMode_Status("SharedKey")
	AuthenticationMode_StatusTaskAuthenticationToken = AuthenticationMode_Status("TaskAuthenticationToken")
)

//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/AutoStorageBaseProperties
type AutoStorageBaseProperties struct {
	//AuthenticationMode: The authentication mode which the Batch service will use to
	//manage the auto-storage account.
	AuthenticationMode *AutoStorageBasePropertiesAuthenticationMode `json:"authenticationMode,omitempty"`

	//NodeIdentityReference: The reference to a user assigned identity associated with
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	...
	if autoStorageBaseProperties.AuthenticationMode != nil {
		authenticationMode := *autoStorageBaseProperties.AuthenticationMode
		result.AuthenticationMode = &authenticationMode
	}

	// Set property ‘NodeIdentityReference’:
	if autoStorageBaseProperties.NodeIdentityReference != nil {
		nodeIdentityReferenceARM, err := (*autoStorageBaseProperties.NodeIdentityReference).ConvertToARM(resolved)
		if err != nil {
			return nil, err
		}
		nodeIdentityReference := nodeIdentityReferenceARM.(ComputeNodeIdentityReferenceARM)
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.AuthenticationMode != nil {
		authenticationMode := *typedInput.AuthenticationMode
		autoStorageBaseProperties.AuthenticationMode = &authenticationMode
	}
	...
	if typedInput.NodeIdentityReference != nil {
		...
		autoStorageBaseProperties.NodeIdentityReference = &nodeIdentityReference
	}
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) AssignPropertiesFromAutoStorageBaseProperties(source *v1alpha1api20210601storage.AutoStorageBaseProperties) error {
	...
	if source.AuthenticationMode != nil {
		authenticationMode := AutoStorageBasePropertiesAuthenticationMode(*source.AuthenticationMode)
		autoStorageBaseProperties.AuthenticationMode = &authenticationMode
	} else {
		autoStorageBaseProperties.AuthenticationMode = nil
	}

	// NodeIdentityReference
	if source.NodeIdentityReference != nil {
		var nodeIdentityReference ComputeNodeIdentityReference
		err := nodeIdentityReference.AssignPropertiesFromComputeNodeIdentityReference(source.NodeIdentityReference)
		if err != nil {
			return errors.Wrap(err, "calling AssignPropertiesFromComputeNodeIdentityReference() to populate field NodeIdentityReference")
		}
		autoStorageBaseProperties.NodeIdentityReference = &nodeIdentityReference
	} else {
		autoStorageBaseProperties.NodeIdentityReference = nil
	}
...
func (autoStorageBaseProperties *AutoStorageBaseProperties) AssignPropertiesToAutoStorageBaseProperties(destination *v1alpha1api20210601storage.AutoStorageBaseProperties) error {
	...
	// AuthenticationMode
	if autoStorageBaseProperties.AuthenticationMode != nil {
		authenticationMode := string(*autoStorageBaseProperties.AuthenticationMode)
	...
	if autoStorageBaseProperties.NodeIdentityReference != nil {
		...
		err := autoStorageBaseProperties.NodeIdentityReference.AssignPropertiesToComputeNodeIdentityReference(&nodeIdentityReference)
		if err != nil {
			return errors.Wrap(err, "calling AssignPropertiesToComputeNodeIdentityReference() to populate field NodeIdentityReference")
		}
...
type AutoStorageProperties_Status struct {
	//AuthenticationMode: The authentication mode which the Batch service will use to
	//manage the auto-storage account.
	AuthenticationMode *AutoStoragePropertiesStatusAuthenticationMode `json:"authenticationMode,omitempty"`
	...
	//NodeIdentityReference: The identity referenced here must be assigned to pools
	//which have compute nodes that need access to auto-storage.
...
func (autoStoragePropertiesStatus *AutoStorageProperties_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.AuthenticationMode != nil {
		authenticationMode := *typedInput.AuthenticationMode
		autoStoragePropertiesStatus.AuthenticationMode = &authenticationMode
	}
	...
	if typedInput.NodeIdentityReference != nil {
		...
		nodeIdentityReference := nodeIdentityReference1
		autoStoragePropertiesStatus.NodeIdentityReference = &nodeIdentityReference
	}
...
func (autoStoragePropertiesStatus *AutoStorageProperties_Status) AssignPropertiesFromAutoStoragePropertiesStatus(source *v1alpha1api20210601storage.AutoStorageProperties_Status) error {
	...
	// AuthenticationMode
	if source.AuthenticationMode != nil {
		authenticationMode := AutoStoragePropertiesStatusAuthenticationMode(*source.AuthenticationMode)
		autoStoragePropertiesStatus.AuthenticationMode = &authenticationMode
	} else {
		autoStoragePropertiesStatus.AuthenticationMode = nil
	}
	...
	if source.NodeIdentityReference != nil {
		...
		err := nodeIdentityReference.AssignPropertiesFromComputeNodeIdentityReferenceStatus(source.NodeIdentityReference)
		if err != nil {
			return errors.Wrap(err, "calling AssignPropertiesFromComputeNodeIdentityReferenceStatus() to populate field NodeIdentityReference")
		}
		autoStoragePropertiesStatus.NodeIdentityReference = &nodeIdentityReference
	} else {
		autoStoragePropertiesStatus.NodeIdentityReference = nil
	}
...
func (autoStoragePropertiesStatus *AutoStorageProperties_Status) AssignPropertiesToAutoStoragePropertiesStatus(destination *v1alpha1api20210601storage.AutoStorageProperties_Status) error {
	...
	// AuthenticationMode
	if autoStoragePropertiesStatus.AuthenticationMode != nil {
		authenticationMode := string(*autoStoragePropertiesStatus.AuthenticationMode)
		destination.AuthenticationMode = &authenticationMode
	} else {
		destination.AuthenticationMode = nil
	}
	...
	// NodeIdentityReference
	if autoStoragePropertiesStatus.NodeIdentityReference != nil {
		var nodeIdentityReference v1alpha1api20210601storage.ComputeNodeIdentityReference_Status
		err := autoStoragePropertiesStatus.NodeIdentityReference.AssignPropertiesToComputeNodeIdentityReferenceStatus(&nodeIdentityReference)
		if err != nil {
			return errors.Wrap(err, "calling AssignPropertiesToComputeNodeIdentityReferenceStatus() to populate field NodeIdentityReference")
		}
		destination.NodeIdentityReference = &nodeIdentityReference
	} else {
		destination.NodeIdentityReference = nil
...
type BatchAccountCreatePropertiesAllowedAuthenticationModes string

const (
	BatchAccountCreatePropertiesAllowedAuthenticationModesAAD                     = BatchAccountCreatePropertiesAllowedAuthenticationModes("AAD")
	BatchAccountCreatePropertiesAllowedAuthenticationModesSharedKey               = BatchAccountCreatePropertiesAllowedAuthenticationModes("SharedKey")
	BatchAccountCreatePropertiesAllowedAuthenticationModesTaskAuthenticationToken = BatchAccountCreatePropertiesAllowedAuthenticationModes("TaskAuthenticationToken")
)
...
//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/BatchAccountIdentity
...
func (batchAccountIdentityStatus *BatchAccountIdentity_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	...
	if typedInput.UserAssignedIdentities != nil {
		batchAccountIdentityStatus.UserAssignedIdentities = make(map[string]UserAssignedIdentities_Status)
...
//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/EncryptionProperties
...
//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/KeyVaultReference
...
type AutoStorageBasePropertiesAuthenticationMode string

const (
	AutoStorageBasePropertiesAuthenticationModeBatchAccountManagedIdentity = AutoStorageBasePropertiesAuthenticationMode("BatchAccountManagedIdentity")
	AutoStorageBasePropertiesAuthenticationModeStorageKeys                 = AutoStorageBasePropertiesAuthenticationMode("StorageKeys")
)

type AutoStoragePropertiesStatusAuthenticationMode string

const (
	AutoStoragePropertiesStatusAuthenticationModeBatchAccountManagedIdentity = AutoStoragePropertiesStatusAuthenticationMode("BatchAccountManagedIdentity")
	AutoStoragePropertiesStatusAuthenticationModeStorageKeys                 = AutoStoragePropertiesStatusAuthenticationMode("StorageKeys")
)

//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/ComputeNodeIdentityReference
...
// ConvertToARM converts from a Kubernetes CRD object to an ARM object
func (computeNodeIdentityReference *ComputeNodeIdentityReference) ConvertToARM(resolved genruntime.ConvertToARMResolvedDetails) (interface{}, error) {
	if computeNodeIdentityReference == nil {
		return nil, nil
	}
	var result ComputeNodeIdentityReferenceARM

	// Set property ‘ResourceId’:
	if computeNodeIdentityReference.ResourceReference != nil {
		resourceReferenceARMID, err := resolved.ResolvedReferences.ARMIDOrErr(*computeNodeIdentityReference.ResourceReference)
		if err != nil {
			return nil, err
		}
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (computeNodeIdentityReference *ComputeNodeIdentityReference) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &ComputeNodeIdentityReferenceARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (computeNodeIdentityReference *ComputeNodeIdentityReference) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	_, ok := armInput.(ComputeNodeIdentityReferenceARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected ComputeNodeIdentityReferenceARM, got %T", armInput)
	}
...
// AssignPropertiesFromComputeNodeIdentityReference populates our ComputeNodeIdentityReference from the provided source ComputeNodeIdentityReference
func (computeNodeIdentityReference *ComputeNodeIdentityReference) AssignPropertiesFromComputeNodeIdentityReference(source *v1alpha1api20210601storage.ComputeNodeIdentityReference) error {

	// ResourceReference
	if source.ResourceReference != nil {
		resourceReference := source.ResourceReference.Copy()
		computeNodeIdentityReference.ResourceReference = &resourceReference
	} else {
		computeNodeIdentityReference.ResourceReference = nil
	}
...
// AssignPropertiesToComputeNodeIdentityReference populates the provided destination ComputeNodeIdentityReference from our ComputeNodeIdentityReference
func (computeNodeIdentityReference *ComputeNodeIdentityReference) AssignPropertiesToComputeNodeIdentityReference(destination *v1alpha1api20210601storage.ComputeNodeIdentityReference) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ResourceReference
	if computeNodeIdentityReference.ResourceReference != nil {
		resourceReference := computeNodeIdentityReference.ResourceReference.Copy()
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (computeNodeIdentityReferenceStatus *ComputeNodeIdentityReference_Status) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &ComputeNodeIdentityReference_StatusARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (computeNodeIdentityReferenceStatus *ComputeNodeIdentityReference_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(ComputeNodeIdentityReference_StatusARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected ComputeNodeIdentityReference_StatusARM, got %T", armInput)
	}

	// Set property ‘ResourceId’:
	if typedInput.ResourceId != nil {
		resourceId := *typedInput.ResourceId
		computeNodeIdentityReferenceStatus.ResourceId = &resourceId
	}
...
// AssignPropertiesFromComputeNodeIdentityReferenceStatus populates our ComputeNodeIdentityReference_Status from the provided source ComputeNodeIdentityReference_Status
func (computeNodeIdentityReferenceStatus *ComputeNodeIdentityReference_Status) AssignPropertiesFromComputeNodeIdentityReferenceStatus(source *v1alpha1api20210601storage.ComputeNodeIdentityReference_Status) error {

	// ResourceId
	computeNodeIdentityReferenceStatus.ResourceId = genruntime.ClonePointerToString(source.ResourceId)

	// No error
	return nil
}

// AssignPropertiesToComputeNodeIdentityReferenceStatus populates the provided destination ComputeNodeIdentityReference_Status from our ComputeNodeIdentityReference_Status
func (computeNodeIdentityReferenceStatus *ComputeNodeIdentityReference_Status) AssignPropertiesToComputeNodeIdentityReferenceStatus(destination *v1alpha1api20210601storage.ComputeNodeIdentityReference_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ResourceId
	destination.ResourceId = genruntime.ClonePointerToString(computeNodeIdentityReferenceStatus.ResourceId)
...
//Generated from: https://schema.management.azure.com/schemas/2021-06-01/Microsoft.Batch.json#/definitions/KeyVaultProperties
...
// NewEmptyARMValue returns an empty ARM value suitable for deserializing into
func (userAssignedIdentitiesStatus *UserAssignedIdentities_Status) NewEmptyARMValue() genruntime.ARMResourceStatus {
	return &UserAssignedIdentities_StatusARM{}
}

// PopulateFromARM populates a Kubernetes CRD object from an Azure ARM object
func (userAssignedIdentitiesStatus *UserAssignedIdentities_Status) PopulateFromARM(owner genruntime.ArbitraryOwnerReference, armInput interface{}) error {
	typedInput, ok := armInput.(UserAssignedIdentities_StatusARM)
	if !ok {
		return fmt.Errorf("unexpected type supplied for PopulateFromARM() function. Expected UserAssignedIdentities_StatusARM, got %T", armInput)
	}

	// Set property ‘ClientId’:
	if typedInput.ClientId != nil {
		clientId := *typedInput.ClientId
		userAssignedIdentitiesStatus.ClientId = &clientId
	}

	// Set property ‘PrincipalId’:
	if typedInput.PrincipalId != nil {
		principalId := *typedInput.PrincipalId
		userAssignedIdentitiesStatus.PrincipalId = &principalId
	}
...
// AssignPropertiesFromUserAssignedIdentitiesStatus populates our UserAssignedIdentities_Status from the provided source UserAssignedIdentities_Status
func (userAssignedIdentitiesStatus *UserAssignedIdentities_Status) AssignPropertiesFromUserAssignedIdentitiesStatus(source *v1alpha1api20210601storage.UserAssignedIdentities_Status) error {

	// ClientId
	userAssignedIdentitiesStatus.ClientId = genruntime.ClonePointerToString(source.ClientId)

	// PrincipalId
	userAssignedIdentitiesStatus.PrincipalId = genruntime.ClonePointerToString(source.PrincipalId)

	// No error
	return nil
}

// AssignPropertiesToUserAssignedIdentitiesStatus populates the provided destination UserAssignedIdentities_Status from our UserAssignedIdentities_Status
func (userAssignedIdentitiesStatus *UserAssignedIdentities_Status) AssignPropertiesToUserAssignedIdentitiesStatus(destination *v1alpha1api20210601storage.UserAssignedIdentities_Status) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ClientId
	destination.ClientId = genruntime.ClonePointerToString(userAssignedIdentitiesStatus.ClientId)

	// PrincipalId
	destination.PrincipalId = genruntime.ClonePointerToString(userAssignedIdentitiesStatus.PrincipalId)
