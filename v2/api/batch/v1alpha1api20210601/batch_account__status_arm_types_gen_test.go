...
func AddRelatedPropertyGeneratorsForBatchAccountIdentityStatusARM(gens map[string]gopter.Gen) {
	gens["UserAssignedIdentities"] = gen.MapOf(gen.AlphaString(), UserAssignedIdentitiesStatusARMGenerator())
}
...
// We first initialize autoStoragePropertiesStatusARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AutoStoragePropertiesStatusARMGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAutoStoragePropertiesStatusARM(generators)
	AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatusARM(generators)
	autoStoragePropertiesStatusARMGenerator = gen.Struct(reflect.TypeOf(AutoStorageProperties_StatusARM{}), generators)
...
// AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatusARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatusARM(gens map[string]gopter.Gen) {
	gens["NodeIdentityReference"] = gen.PtrOf(ComputeNodeIdentityReferenceStatusARMGenerator())
}
...
func Test_UserAssignedIdentities_StatusARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of UserAssignedIdentities_StatusARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForUserAssignedIdentitiesStatusARM, UserAssignedIdentitiesStatusARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForUserAssignedIdentitiesStatusARM runs a test to see if a specific instance of UserAssignedIdentities_StatusARM round trips to JSON and back losslessly
func RunJSONSerializationTestForUserAssignedIdentitiesStatusARM(subject UserAssignedIdentities_StatusARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual UserAssignedIdentities_StatusARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of UserAssignedIdentities_StatusARM instances for property testing - lazily instantiated by
//UserAssignedIdentitiesStatusARMGenerator()
var userAssignedIdentitiesStatusARMGenerator gopter.Gen

// UserAssignedIdentitiesStatusARMGenerator returns a generator of UserAssignedIdentities_StatusARM instances for property testing.
func UserAssignedIdentitiesStatusARMGenerator() gopter.Gen {
	if userAssignedIdentitiesStatusARMGenerator != nil {
		return userAssignedIdentitiesStatusARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatusARM(generators)
	userAssignedIdentitiesStatusARMGenerator = gen.Struct(reflect.TypeOf(UserAssignedIdentities_StatusARM{}), generators)

	return userAssignedIdentitiesStatusARMGenerator
}

// AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatusARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatusARM(gens map[string]gopter.Gen) {
...
func Test_ComputeNodeIdentityReference_StatusARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MaxSize = 10
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ComputeNodeIdentityReference_StatusARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForComputeNodeIdentityReferenceStatusARM, ComputeNodeIdentityReferenceStatusARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputeNodeIdentityReferenceStatusARM runs a test to see if a specific instance of ComputeNodeIdentityReference_StatusARM round trips to JSON and back losslessly
func RunJSONSerializationTestForComputeNodeIdentityReferenceStatusARM(subject ComputeNodeIdentityReference_StatusARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ComputeNodeIdentityReference_StatusARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ComputeNodeIdentityReference_StatusARM instances for property testing - lazily instantiated by
//ComputeNodeIdentityReferenceStatusARMGenerator()
var computeNodeIdentityReferenceStatusARMGenerator gopter.Gen

// ComputeNodeIdentityReferenceStatusARMGenerator returns a generator of ComputeNodeIdentityReference_StatusARM instances for property testing.
func ComputeNodeIdentityReferenceStatusARMGenerator() gopter.Gen {
	if computeNodeIdentityReferenceStatusARMGenerator != nil {
		return computeNodeIdentityReferenceStatusARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatusARM(generators)
	computeNodeIdentityReferenceStatusARMGenerator = gen.Struct(reflect.TypeOf(ComputeNodeIdentityReference_StatusARM{}), generators)

	return computeNodeIdentityReferenceStatusARMGenerator
}

// AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatusARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatusARM(gens map[string]gopter.Gen) {
