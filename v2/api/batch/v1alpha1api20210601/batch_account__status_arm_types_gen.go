...
type BatchAccountIdentity_StatusARM struct {
	...
	//account.
	UserAssignedIdentities map[string]UserAssignedIdentities_StatusARM `json:"userAssignedIdentities,omitempty"`
}
...
type AutoStorageProperties_StatusARM struct {
	...
	NodeIdentityReference *ComputeNodeIdentityReference_StatusARM `json:"nodeIdentityReference,omitempty"`
...
type UserAssignedIdentities_StatusARM struct {
...
type ComputeNodeIdentityReference_StatusARM struct {
