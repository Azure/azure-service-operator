...
// RunPropertyAssignmentTestForBatchAccount tests if a specific instance of BatchAccount can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForBatchAccount(subject BatchAccount) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.BatchAccount
...
// RunPropertyAssignmentTestForBatchAccountStatus tests if a specific instance of BatchAccount_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForBatchAccountStatus(subject BatchAccount_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.BatchAccount_Status
...
func AddIndependentPropertyGeneratorsForBatchAccountStatus(gens map[string]gopter.Gen) {
	...
	gens["AllowedAuthenticationModes"] = gen.SliceOf(gen.OneConstOf(AuthenticationMode_StatusAAD, AuthenticationMode_StatusSharedKey, AuthenticationMode_StatusTaskAuthenticationToken))
...
// RunPropertyAssignmentTestForBatchAccountsSpec tests if a specific instance of BatchAccounts_Spec can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForBatchAccountsSpec(subject BatchAccounts_Spec) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.BatchAccounts_Spec
...
func AddIndependentPropertyGeneratorsForBatchAccountsSpec(gens map[string]gopter.Gen) {
	gens["AllowedAuthenticationModes"] = gen.SliceOf(gen.OneConstOf(BatchAccountCreatePropertiesAllowedAuthenticationModesAAD, BatchAccountCreatePropertiesAllowedAuthenticationModesSharedKey, BatchAccountCreatePropertiesAllowedAuthenticationModesTaskAuthenticationToken))
...
// RunPropertyAssignmentTestForAutoStorageBaseProperties tests if a specific instance of AutoStorageBaseProperties can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForAutoStorageBaseProperties(subject AutoStorageBaseProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.AutoStorageBaseProperties
...
func AddIndependentPropertyGeneratorsForAutoStorageBaseProperties(gens map[string]gopter.Gen) {
	gens["AuthenticationMode"] = gen.PtrOf(gen.OneConstOf(AutoStorageBasePropertiesAuthenticationModeBatchAccountManagedIdentity, AutoStorageBasePropertiesAuthenticationModeStorageKeys))
}
...
// RunPropertyAssignmentTestForAutoStoragePropertiesStatus tests if a specific instance of AutoStorageProperties_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForAutoStoragePropertiesStatus(subject AutoStorageProperties_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.AutoStorageProperties_Status
...
// We first initialize autoStoragePropertiesStatusGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func AutoStoragePropertiesStatusGenerator() gopter.Gen {
	...
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForAutoStoragePropertiesStatus(generators)
	AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatus(generators)
	autoStoragePropertiesStatusGenerator = gen.Struct(reflect.TypeOf(AutoStorageProperties_Status{}), generators)
...
func AddIndependentPropertyGeneratorsForAutoStoragePropertiesStatus(gens map[string]gopter.Gen) {
	gens["AuthenticationMode"] = gen.PtrOf(gen.OneConstOf(AutoStoragePropertiesStatusAuthenticationModeBatchAccountManagedIdentity, AutoStoragePropertiesStatusAuthenticationModeStorageKeys))
	gens["LastKeySync"] = gen.AlphaString()
	gens["StorageAccountId"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatus is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForAutoStoragePropertiesStatus(gens map[string]gopter.Gen) {
	gens["NodeIdentityReference"] = gen.PtrOf(ComputeNodeIdentityReferenceStatusGenerator())
}
...
// RunPropertyAssignmentTestForBatchAccountIdentity tests if a specific instance of BatchAccountIdentity can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForBatchAccountIdentity(subject BatchAccountIdentity) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.BatchAccountIdentity
...
// RunPropertyAssignmentTestForBatchAccountIdentityStatus tests if a specific instance of BatchAccountIdentity_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForBatchAccountIdentityStatus(subject BatchAccountIdentity_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.BatchAccountIdentity_Status
...
func AddRelatedPropertyGeneratorsForBatchAccountIdentityStatus(gens map[string]gopter.Gen) {
	gens["UserAssignedIdentities"] = gen.MapOf(gen.AlphaString(), UserAssignedIdentitiesStatusGenerator())
}
...
// RunPropertyAssignmentTestForEncryptionProperties tests if a specific instance of EncryptionProperties can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForEncryptionProperties(subject EncryptionProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.EncryptionProperties
...
// RunPropertyAssignmentTestForEncryptionPropertiesStatus tests if a specific instance of EncryptionProperties_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForEncryptionPropertiesStatus(subject EncryptionProperties_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.EncryptionProperties_Status
...
// RunPropertyAssignmentTestForKeyVaultReference tests if a specific instance of KeyVaultReference can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForKeyVaultReference(subject KeyVaultReference) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.KeyVaultReference
...
// RunPropertyAssignmentTestForKeyVaultReferenceStatus tests if a specific instance of KeyVaultReference_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForKeyVaultReferenceStatus(subject KeyVaultReference_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.KeyVaultReference_Status
...
// RunPropertyAssignmentTestForPrivateEndpointConnectionStatus tests if a specific instance of PrivateEndpointConnection_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForPrivateEndpointConnectionStatus(subject PrivateEndpointConnection_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.PrivateEndpointConnection_Status
...
// RunPropertyAssignmentTestForVirtualMachineFamilyCoreQuotaStatus tests if a specific instance of VirtualMachineFamilyCoreQuota_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForVirtualMachineFamilyCoreQuotaStatus(subject VirtualMachineFamilyCoreQuota_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.VirtualMachineFamilyCoreQuota_Status
...
func Test_ComputeNodeIdentityReference_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ComputeNodeIdentityReference to ComputeNodeIdentityReference via AssignPropertiesToComputeNodeIdentityReference & AssignPropertiesFromComputeNodeIdentityReference returns original",
		prop.ForAll(RunPropertyAssignmentTestForComputeNodeIdentityReference, ComputeNodeIdentityReferenceGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForComputeNodeIdentityReference tests if a specific instance of ComputeNodeIdentityReference can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForComputeNodeIdentityReference(subject ComputeNodeIdentityReference) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.ComputeNodeIdentityReference
	err := copied.AssignPropertiesToComputeNodeIdentityReference(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignPropertiesFromComputeNodeIdentityReference(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_ComputeNodeIdentityReference_Status_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from ComputeNodeIdentityReference_Status to ComputeNodeIdentityReference_Status via AssignPropertiesToComputeNodeIdentityReferenceStatus & AssignPropertiesFromComputeNodeIdentityReferenceStatus returns original",
		prop.ForAll(RunPropertyAssignmentTestForComputeNodeIdentityReferenceStatus, ComputeNodeIdentityReferenceStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForComputeNodeIdentityReferenceStatus tests if a specific instance of ComputeNodeIdentityReference_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForComputeNodeIdentityReferenceStatus(subject ComputeNodeIdentityReference_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.ComputeNodeIdentityReference_Status
	err := copied.AssignPropertiesToComputeNodeIdentityReferenceStatus(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignPropertiesFromComputeNodeIdentityReferenceStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_ComputeNodeIdentityReference_Status_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForComputeNodeIdentityReferenceStatus, ComputeNodeIdentityReferenceStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForComputeNodeIdentityReferenceStatus runs a test to see if a specific instance of ComputeNodeIdentityReference_Status round trips to JSON and back losslessly
func RunJSONSerializationTestForComputeNodeIdentityReferenceStatus(subject ComputeNodeIdentityReference_Status) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
//ComputeNodeIdentityReferenceStatusGenerator()
var computeNodeIdentityReferenceStatusGenerator gopter.Gen

// ComputeNodeIdentityReferenceStatusGenerator returns a generator of ComputeNodeIdentityReference_Status instances for property testing.
func ComputeNodeIdentityReferenceStatusGenerator() gopter.Gen {
	if computeNodeIdentityReferenceStatusGenerator != nil {
		return computeNodeIdentityReferenceStatusGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatus(generators)
	computeNodeIdentityReferenceStatusGenerator = gen.Struct(reflect.TypeOf(ComputeNodeIdentityReference_Status{}), generators)

	return computeNodeIdentityReferenceStatusGenerator
}

// AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatus is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForComputeNodeIdentityReferenceStatus(gens map[string]gopter.Gen) {
...
// RunPropertyAssignmentTestForKeyVaultProperties tests if a specific instance of KeyVaultProperties can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForKeyVaultProperties(subject KeyVaultProperties) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.KeyVaultProperties
...
// RunPropertyAssignmentTestForKeyVaultPropertiesStatus tests if a specific instance of KeyVaultProperties_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForKeyVaultPropertiesStatus(subject KeyVaultProperties_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.KeyVaultProperties_Status
...
// RunPropertyAssignmentTestForPrivateEndpointStatus tests if a specific instance of PrivateEndpoint_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForPrivateEndpointStatus(subject PrivateEndpoint_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.PrivateEndpoint_Status
...
// RunPropertyAssignmentTestForPrivateLinkServiceConnectionStateStatus tests if a specific instance of PrivateLinkServiceConnectionState_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForPrivateLinkServiceConnectionStateStatus(subject PrivateLinkServiceConnectionState_Status) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.PrivateLinkServiceConnectionState_Status
...
func Test_UserAssignedIdentities_Status_WhenPropertiesConverted_RoundTripsWithoutLoss(t *testing.T) {
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip from UserAssignedIdentities_Status to UserAssignedIdentities_Status via AssignPropertiesToUserAssignedIdentitiesStatus & AssignPropertiesFromUserAssignedIdentitiesStatus returns original",
		prop.ForAll(RunPropertyAssignmentTestForUserAssignedIdentitiesStatus, UserAssignedIdentitiesStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(false, 240, os.Stdout))
}

// RunPropertyAssignmentTestForUserAssignedIdentitiesStatus tests if a specific instance of UserAssignedIdentities_Status can be assigned to v1alpha1api20210601storage and back losslessly
func RunPropertyAssignmentTestForUserAssignedIdentitiesStatus(subject UserAssignedIdentities_Status) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20210601storage.UserAssignedIdentities_Status
	err := copied.AssignPropertiesToUserAssignedIdentitiesStatus(&other)
	if err != nil {
		return err.Error()
	}
	...
	err = actual.AssignPropertiesFromUserAssignedIdentitiesStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func Test_UserAssignedIdentities_Status_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForUserAssignedIdentitiesStatus, UserAssignedIdentitiesStatusGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForUserAssignedIdentitiesStatus runs a test to see if a specific instance of UserAssignedIdentities_Status round trips to JSON and back losslessly
func RunJSONSerializationTestForUserAssignedIdentitiesStatus(subject UserAssignedIdentities_Status) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
...
//UserAssignedIdentitiesStatusGenerator()
var userAssignedIdentitiesStatusGenerator gopter.Gen

// UserAssignedIdentitiesStatusGenerator returns a generator of UserAssignedIdentities_Status instances for property testing.
func UserAssignedIdentitiesStatusGenerator() gopter.Gen {
	if userAssignedIdentitiesStatusGenerator != nil {
		return userAssignedIdentitiesStatusGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatus(generators)
	userAssignedIdentitiesStatusGenerator = gen.Struct(reflect.TypeOf(UserAssignedIdentities_Status{}), generators)

	return userAssignedIdentitiesStatusGenerator
}

// AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatus is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForUserAssignedIdentitiesStatus(gens map[string]gopter.Gen) {
