...
func Test_BatchAccountCreateParameters_STATUSARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
		...
		prop.ForAll(RunJSONSerializationTestForBatchAccountCreateParameters_STATUSARM, BatchAccountCreateParameters_STATUSARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForBatchAccountCreateParameters_STATUSARM runs a test to see if a specific instance of BatchAccountCreateParameters_STATUSARM round trips to JSON and back losslessly
func RunJSONSerializationTestForBatchAccountCreateParameters_STATUSARM(subject BatchAccountCreateParameters_STATUSARM) string {
	// Serialize to JSON
...
// BatchAccountCreateParameters_STATUSARMGenerator()
var batchAccountCreateParameters_STATUSARMGenerator gopter.Gen

// BatchAccountCreateParameters_STATUSARMGenerator returns a generator of BatchAccountCreateParameters_STATUSARM instances for property testing.
// We first initialize batchAccountCreateParameters_STATUSARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func BatchAccountCreateParameters_STATUSARMGenerator() gopter.Gen {
	if batchAccountCreateParameters_STATUSARMGenerator != nil {
		return batchAccountCreateParameters_STATUSARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM(generators)
	batchAccountCreateParameters_STATUSARMGenerator = gen.Struct(reflect.TypeOf(BatchAccountCreateParameters_STATUSARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM(generators)
	AddRelatedPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM(generators)
	batchAccountCreateParameters_STATUSARMGenerator = gen.Struct(reflect.TypeOf(BatchAccountCreateParameters_STATUSARM{}), generators)

	return batchAccountCreateParameters_STATUSARMGenerator
}

// AddIndependentPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM(gens map[string]gopter.Gen) {
	gens["Location"] = gen.PtrOf(gen.AlphaString())
	gens["Tags"] = gen.MapOf(gen.AlphaString(), gen.AlphaString())
}

// AddRelatedPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForBatchAccountCreateParameters_STATUSARM(gens map[string]gopter.Gen) {
