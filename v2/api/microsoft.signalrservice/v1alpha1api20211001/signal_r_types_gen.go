...
import (
	"fmt"
	"github.com/Azure/azure-service-operator/v2/api/microsoft.signalrservice/v1alpha1api20211001storage"
...
// +kubebuilder:rbac:groups=microsoft.signalrservice.azure.com,resources=signalrs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=microsoft.signalrservice.azure.com,resources={signalrs/status,signalrs/finalizers},verbs=get;update;patch
...
// +kubebuilder:webhook:path=/mutate-microsoft-signalrservice-azure-com-v1alpha1api20211001-signalr,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.signalrservice.azure.com,resources=signalrs,verbs=create;update,versions=v1alpha1api20211001,name=default.v1alpha1api20211001.signalrs.microsoft.signalrservice.azure.com,admissionReviewVersions=v1beta1
...
// +kubebuilder:webhook:path=/validate-microsoft-signalrservice-azure-com-v1alpha1api20211001-signalr,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=microsoft.signalrservice.azure.com,resources=signalrs,verbs=create;update,versions=v1alpha1api20211001,name=validate.v1alpha1api20211001.signalrs.microsoft.signalrservice.azure.com,admissionReviewVersions=v1beta1
