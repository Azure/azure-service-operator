...
func AddIndependentPropertyGeneratorsForRoutePropertiesFormatStatusARM(gens map[string]gopter.Gen) {
	...
	gens["NextHopType"] = gen.OneConstOf(RouteNextHopType_StatusInternet, RouteNextHopType_StatusNone, RouteNextHopType_StatusVirtualAppliance, RouteNextHopType_StatusVirtualNetworkGateway, RouteNextHopType_StatusVnetLocal)
