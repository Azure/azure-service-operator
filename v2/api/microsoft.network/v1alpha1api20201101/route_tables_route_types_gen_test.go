...
// RunPropertyAssignmentTestForRouteTablesRoute tests if a specific instance of RouteTablesRoute can be assigned to v1alpha1api20201101storage and back losslessly
func RunPropertyAssignmentTestForRouteTablesRoute(subject RouteTablesRoute) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20201101storage.RouteTablesRoute
	err := subject.AssignPropertiesToRouteTablesRoute(&other)
	if err != nil {
		return err.Error()
	}
...
// RunPropertyAssignmentTestForRouteTablesRoutesSpec tests if a specific instance of RouteTablesRoutes_Spec can be assigned to v1alpha1api20201101storage and back losslessly
func RunPropertyAssignmentTestForRouteTablesRoutesSpec(subject RouteTablesRoutes_Spec) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20201101storage.RouteTablesRoutes_Spec
	err := subject.AssignPropertiesToRouteTablesRoutesSpec(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForRouteTablesRoutesSpec(gens map[string]gopter.Gen) {
	...
	gens["NextHopType"] = gen.OneConstOf(RoutePropertiesFormatNextHopTypeInternet, RoutePropertiesFormatNextHopTypeNone, RoutePropertiesFormatNextHopTypeVirtualAppliance, RoutePropertiesFormatNextHopTypeVirtualNetworkGateway, RoutePropertiesFormatNextHopTypeVnetLocal)
...
// RunPropertyAssignmentTestForRouteStatus tests if a specific instance of Route_Status can be assigned to v1alpha1api20201101storage and back losslessly
func RunPropertyAssignmentTestForRouteStatus(subject Route_Status) string {
	// Use AssignPropertiesTo() for the first stage of conversion
	var other v1alpha1api20201101storage.Route_Status
	err := subject.AssignPropertiesToRouteStatus(&other)
	if err != nil {
		return err.Error()
	}
...
func AddIndependentPropertyGeneratorsForRouteStatus(gens map[string]gopter.Gen) {
	...
	gens["NextHopIpAddress"] = gen.PtrOf(gen.AlphaString())
	gens["NextHopType"] = gen.PtrOf(gen.OneConstOf(RouteNextHopType_StatusInternet, RouteNextHopType_StatusNone, RouteNextHopType_StatusVirtualAppliance, RouteNextHopType_StatusVirtualNetworkGateway, RouteNextHopType_StatusVnetLocal))
