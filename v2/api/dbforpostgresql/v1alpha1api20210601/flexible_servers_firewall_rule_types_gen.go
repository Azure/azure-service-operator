...
func (rule *FlexibleServersFirewallRule) AssignProperties_To_FlexibleServersFirewallRule(destination *alpha20210601s.FlexibleServersFirewallRule) error {
	...
	// Spec
<<<<<<< HEAD
	var spec alpha20210601s.FlexibleServersFirewallRule_Spec
...
=======
	var spec alpha20210601s.FlexibleServers_FirewallRules_Spec
...
>>>>>>> main
	...
	// Status
<<<<<<< HEAD
	var status alpha20210601s.FlexibleServersFirewallRule_STATUS
...
func (rule *FlexibleServersFirewallRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20210601s.FlexibleServersFirewallRule_Spec)
	if ok {
	...
	src = &alpha20210601s.FlexibleServersFirewallRule_Spec{}
...
func (rule *FlexibleServersFirewallRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20210601s.FlexibleServersFirewallRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &alpha20210601s.FlexibleServersFirewallRule_Spec{}
...
func (rule *FlexibleServersFirewallRule_Spec) AssignPropertiesFromFlexibleServersFirewallRule_Spec(source *alpha20210601s.FlexibleServersFirewallRule_Spec) error {
...
func (rule *FlexibleServersFirewallRule_Spec) AssignPropertiesToFlexibleServersFirewallRule_Spec(destination *alpha20210601s.FlexibleServersFirewallRule_Spec) error {
...
func (rule *FlexibleServersFirewallRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20210601s.FlexibleServersFirewallRule_STATUS)
	if ok {
		// Populate our instance from source
<<<<<<< HEAD
...
>>>>>>> main
	...
	// Convert to an intermediate form
	src = &alpha20210601s.FlexibleServersFirewallRule_STATUS{}
...
func (rule *FlexibleServersFirewallRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20210601s.FlexibleServersFirewallRule_STATUS)
	if ok {
		// Populate destination from our instance
<<<<<<< HEAD
	...
	// Convert to an intermediate form
	dst = &alpha20210601s.FlexibleServersFirewallRule_STATUS{}
...
func (rule *FlexibleServersFirewallRule_STATUS) AssignPropertiesFromFlexibleServersFirewallRule_STATUS(source *alpha20210601s.FlexibleServersFirewallRule_STATUS) error {
=======
...
func (rule *FlexibleServersFirewallRule_STATUS) AssignPropertiesToFlexibleServersFirewallRule_STATUS(destination *alpha20210601s.FlexibleServersFirewallRule_STATUS) error {
=======
...
func (rules *FlexibleServers_FirewallRules_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*alpha20210601s.FlexibleServers_FirewallRules_Spec)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210601s.FlexibleServers_FirewallRules_Spec{}
	err := src.ConvertSpecFrom(source)
	if err != nil {
		return errors.Wrap(err, "initial step of conversion in ConvertSpecFrom()")
	}
...
func (rules *FlexibleServers_FirewallRules_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*alpha20210601s.FlexibleServers_FirewallRules_Spec)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210601s.FlexibleServers_FirewallRules_Spec{}
...
func (rules *FlexibleServers_FirewallRules_Spec) AssignProperties_From_FlexibleServers_FirewallRules_Spec(source *alpha20210601s.FlexibleServers_FirewallRules_Spec) error {
...
func (rules *FlexibleServers_FirewallRules_Spec) AssignProperties_To_FlexibleServers_FirewallRules_Spec(destination *alpha20210601s.FlexibleServers_FirewallRules_Spec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
