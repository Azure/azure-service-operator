...
func (rule *FlexibleServersFirewallRule) AssignProperties_To_FlexibleServersFirewallRule(destination *alpha20210601s.FlexibleServersFirewallRule) error {
	...
	// Status
	var status alpha20210601s.FlexibleServers_FirewallRule_STATUS
...
// Deprecated version of FlexibleServers_FirewallRule_STATUS. Use v1beta20210601.FlexibleServers_FirewallRule_STATUS instead
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20210601s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20210601s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20210601s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20210601s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_From_FlexibleServers_FirewallRule_STATUS(source *alpha20210601s.FlexibleServers_FirewallRule_STATUS) error {
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_To_FlexibleServers_FirewallRule_STATUS(destination *alpha20210601s.FlexibleServers_FirewallRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
