...
<<<<<<<< HEAD:v2/api/dbforpostgresql/v1alpha1api20210601/flexible_servers_database__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/dbforpostgresql/v1alpha1api20210601/flexible_servers_databases_spec_arm_types_gen_test.go
	t.Parallel()
