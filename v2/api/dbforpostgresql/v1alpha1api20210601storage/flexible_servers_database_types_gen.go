...
func (database *FlexibleServersDatabase) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1beta20210601storage.FlexibleServersDatabase)
	if !ok {
...
func (database *FlexibleServersDatabase) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1beta20210601storage.FlexibleServersDatabase)
	if !ok {
		return fmt.Errorf("expected dbforpostgresql/v1beta20210601storage/FlexibleServersDatabase but received %T instead", hub)
	}
...
func (database *FlexibleServersDatabase) AssignPropertiesFromFlexibleServersDatabase(source *v1beta20210601storage.FlexibleServersDatabase) error {
...
func (database *FlexibleServersDatabase) AssignPropertiesToFlexibleServersDatabase(destination *v1beta20210601storage.FlexibleServersDatabase) error {

	// ObjectMeta
	destination.ObjectMeta = *database.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20210601storage.FlexibleServersDatabases_Spec
	...
	// Status
	var status v1beta20210601storage.Database_Status
...
func (database *Database_Status) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20210601storage.Database_Status)
	if ok {
	...
	src = &v1beta20210601storage.Database_Status{}
...
func (database *Database_Status) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20210601storage.Database_Status)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20210601storage.Database_Status{}
...
func (database *Database_Status) AssignPropertiesFromDatabaseStatus(source *v1beta20210601storage.Database_Status) error {
...
func (database *Database_Status) AssignPropertiesToDatabaseStatus(destination *v1beta20210601storage.Database_Status) error {
	// Clone the existing property bag
...
func (databases *FlexibleServersDatabases_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20210601storage.FlexibleServersDatabases_Spec)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20210601storage.FlexibleServersDatabases_Spec{}
...
func (databases *FlexibleServersDatabases_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20210601storage.FlexibleServersDatabases_Spec)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20210601storage.FlexibleServersDatabases_Spec{}
...
func (databases *FlexibleServersDatabases_Spec) AssignPropertiesFromFlexibleServersDatabasesSpec(source *v1beta20210601storage.FlexibleServersDatabases_Spec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (databases *FlexibleServersDatabases_Spec) AssignPropertiesToFlexibleServersDatabasesSpec(destination *v1beta20210601storage.FlexibleServersDatabases_Spec) error {
	// Clone the existing property bag
