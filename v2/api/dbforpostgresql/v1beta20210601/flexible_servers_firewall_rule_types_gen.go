...
// Deprecated version of FlexibleServersFirewallRule. Use v1api20210601.FlexibleServersFirewallRule instead
...
func (rule *FlexibleServersFirewallRule) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20210601s.FlexibleServersFirewallRule
...
func (rule *FlexibleServersFirewallRule) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20210601s.FlexibleServersFirewallRule
...
func (rule *FlexibleServersFirewallRule) AssignProperties_From_FlexibleServersFirewallRule(source *v1beta20210601s.FlexibleServersFirewallRule) error {
...
func (rule *FlexibleServersFirewallRule) AssignProperties_To_FlexibleServersFirewallRule(destination *v1beta20210601s.FlexibleServersFirewallRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v1beta20210601s.FlexibleServers_FirewallRule_Spec
	...
	// Status
	var status v1beta20210601s.FlexibleServers_FirewallRule_STATUS
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20210601s.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	src = &v1beta20210601s.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20210601s.FlexibleServers_FirewallRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20210601s.FlexibleServers_FirewallRule_Spec{}
...
func (rule *FlexibleServers_FirewallRule_Spec) AssignProperties_From_FlexibleServers_FirewallRule_Spec(source *v1beta20210601s.FlexibleServers_FirewallRule_Spec) error {
...
func (rule *FlexibleServers_FirewallRule_Spec) AssignProperties_To_FlexibleServers_FirewallRule_Spec(destination *v1beta20210601s.FlexibleServers_FirewallRule_Spec) error {
...
// Deprecated version of FlexibleServers_FirewallRule_STATUS. Use v1api20210601.FlexibleServers_FirewallRule_STATUS instead
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20210601s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20210601s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20210601s.FlexibleServers_FirewallRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20210601s.FlexibleServers_FirewallRule_STATUS{}
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_From_FlexibleServers_FirewallRule_STATUS(source *v1beta20210601s.FlexibleServers_FirewallRule_STATUS) error {
...
func (rule *FlexibleServers_FirewallRule_STATUS) AssignProperties_To_FlexibleServers_FirewallRule_STATUS(destination *v1beta20210601s.FlexibleServers_FirewallRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
