...
<<<<<<<< HEAD:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_database__spec_arm_types_gen.go
...
type FlexibleServers_Databases_SpecARM struct {
	...
	Name string `json:"name,omitempty"`
>>>>>>>> main:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_databases_spec_arm_types_gen.go
