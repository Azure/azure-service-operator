...
<<<<<<<< HEAD:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_firewall_rule__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_firewall_rules_spec_arm_types_gen_test.go
	t.Parallel()
