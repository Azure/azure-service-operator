...
func Test_FlexibleServer_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/dbforpostgresql/v1beta20210601/flexible_server__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_spec_arm_types_gen_test.go
	// Serialize to JSON
