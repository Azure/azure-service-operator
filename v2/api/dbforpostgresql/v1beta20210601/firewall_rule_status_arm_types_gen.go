...
<<<<<<<< HEAD:v2/api/dbforpostgresql/v1beta20210601/flexible_servers_firewall_rule_statusarm_types_gen.go
type FlexibleServersFirewallRule_STATUSARM struct {
========
type FirewallRule_STATUSARM struct {
>>>>>>>> main:v2/api/dbforpostgresql/v1beta20210601/firewall_rule_status_arm_types_gen.go
