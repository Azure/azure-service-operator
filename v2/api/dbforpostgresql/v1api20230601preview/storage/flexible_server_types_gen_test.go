...
func AddIndependentPropertyGeneratorsForAuthConfig(gens map[string]gopter.Gen) {
	gens["ActiveDirectoryAuth"] = gen.PtrOf(gen.AlphaString())
	gens["PasswordAuth"] = gen.PtrOf(gen.AlphaString())
...
func AddIndependentPropertyGeneratorsForDataEncryption(gens map[string]gopter.Gen) {
	gens["GeoBackupEncryptionKeyStatus"] = gen.PtrOf(gen.AlphaString())
	gens["GeoBackupKeyURI"] = gen.PtrOf(gen.AlphaString())
	gens["PrimaryEncryptionKeyStatus"] = gen.PtrOf(gen.AlphaString())
...
func AddIndependentPropertyGeneratorsForReplica(gens map[string]gopter.Gen) {
	gens["PromoteMode"] = gen.PtrOf(gen.AlphaString())
	gens["PromoteOption"] = gen.PtrOf(gen.AlphaString())
