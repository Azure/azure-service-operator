...
func AddRelatedPropertyGeneratorsForFlexibleServersAdvancedThreatProtectionSettings_STATUS(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(ServerThreatProtectionProperties_STATUSGenerator())
	gens["SystemData"] = gen.PtrOf(SystemData_STATUSGenerator())
}

func Test_ServerThreatProtectionProperties_STATUS_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ServerThreatProtectionProperties_STATUS via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForServerThreatProtectionProperties_STATUS, ServerThreatProtectionProperties_STATUSGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForServerThreatProtectionProperties_STATUS runs a test to see if a specific instance of ServerThreatProtectionProperties_STATUS round trips to JSON and back losslessly
func RunJSONSerializationTestForServerThreatProtectionProperties_STATUS(subject ServerThreatProtectionProperties_STATUS) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ServerThreatProtectionProperties_STATUS
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ServerThreatProtectionProperties_STATUS instances for property testing - lazily instantiated by
// ServerThreatProtectionProperties_STATUSGenerator()
var serverThreatProtectionProperties_STATUSGenerator gopter.Gen

// ServerThreatProtectionProperties_STATUSGenerator returns a generator of ServerThreatProtectionProperties_STATUS instances for property testing.
func ServerThreatProtectionProperties_STATUSGenerator() gopter.Gen {
	if serverThreatProtectionProperties_STATUSGenerator != nil {
		return serverThreatProtectionProperties_STATUSGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForServerThreatProtectionProperties_STATUS(generators)
	serverThreatProtectionProperties_STATUSGenerator = gen.Struct(reflect.TypeOf(ServerThreatProtectionProperties_STATUS{}), generators)

	return serverThreatProtectionProperties_STATUSGenerator
}

// AddIndependentPropertyGeneratorsForServerThreatProtectionProperties_STATUS is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForServerThreatProtectionProperties_STATUS(gens map[string]gopter.Gen) {
