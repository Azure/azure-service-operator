...
func (server *FlexibleServer) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1api20220120ps.FlexibleServer
...
func (server *FlexibleServer) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1api20220120ps.FlexibleServer
...
func (server *FlexibleServer) validateConfigMapDestinations() error {
...
func (server *FlexibleServer) AssignProperties_From_FlexibleServer(source *v1api20220120ps.FlexibleServer) error {
...
func (server *FlexibleServer) AssignProperties_To_FlexibleServer(destination *v1api20220120ps.FlexibleServer) error {

	// ObjectMeta
	destination.ObjectMeta = *server.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20220120ps.FlexibleServer_Spec
	...
	// Status
	var status v1api20220120ps.FlexibleServer_STATUS
...
func (server *FlexibleServer_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20220120ps.FlexibleServer_Spec)
	if ok {
	...
	src = &v1api20220120ps.FlexibleServer_Spec{}
...
func (server *FlexibleServer_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20220120ps.FlexibleServer_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20220120ps.FlexibleServer_Spec{}
...
func (server *FlexibleServer_Spec) AssignProperties_From_FlexibleServer_Spec(source *v1api20220120ps.FlexibleServer_Spec) error {
...
func (server *FlexibleServer_Spec) AssignProperties_To_FlexibleServer_Spec(destination *v1api20220120ps.FlexibleServer_Spec) error {
	...
	// Backup
	if server.Backup != nil {
		var backup v1api20220120ps.Backup
	...
	// HighAvailability
	if server.HighAvailability != nil {
		var highAvailability v1api20220120ps.HighAvailability
	...
	// MaintenanceWindow
	if server.MaintenanceWindow != nil {
		var maintenanceWindow v1api20220120ps.MaintenanceWindow
	...
	// Network
	if server.Network != nil {
		var network v1api20220120ps.Network
	...
	if server.OperatorSpec != nil {
		var operatorSpec v1api20220120ps.FlexibleServerOperatorSpec
	...
	// Storage
	if server.Storage != nil {
		var storage v1api20220120ps.Storage
...
func (server *FlexibleServer_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20220120ps.FlexibleServer_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20220120ps.FlexibleServer_STATUS{}
...
func (server *FlexibleServer_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20220120ps.FlexibleServer_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20220120ps.FlexibleServer_STATUS{}
...
func (server *FlexibleServer_STATUS) AssignProperties_From_FlexibleServer_STATUS(source *v1api20220120ps.FlexibleServer_STATUS) error {
...
func (server *FlexibleServer_STATUS) AssignProperties_To_FlexibleServer_STATUS(destination *v1api20220120ps.FlexibleServer_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
	...
	// Backup
	if server.Backup != nil {
		var backup v1api20220120ps.Backup_STATUS
	...
	// HighAvailability
	if server.HighAvailability != nil {
		var highAvailability v1api20220120ps.HighAvailability_STATUS
	...
	// MaintenanceWindow
	if server.MaintenanceWindow != nil {
		var maintenanceWindow v1api20220120ps.MaintenanceWindow_STATUS
	...
	// Network
	if server.Network != nil {
		var network v1api20220120ps.Network_STATUS
	...
	// Sku
	if server.Sku != nil {
		var sku v1api20220120ps.Sku_STATUS
	...
	// Storage
	if server.Storage != nil {
		var storage v1api20220120ps.Storage_STATUS
...
func (backup *Backup) AssignProperties_From_Backup(source *v1api20220120ps.Backup) error {
...
func (backup *Backup) AssignProperties_To_Backup(destination *v1api20220120ps.Backup) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (backup *Backup_STATUS) AssignProperties_From_Backup_STATUS(source *v1api20220120ps.Backup_STATUS) error {
...
func (backup *Backup_STATUS) AssignProperties_To_Backup_STATUS(destination *v1api20220120ps.Backup_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (operator *FlexibleServerOperatorSpec) AssignProperties_From_FlexibleServerOperatorSpec(source *v1api20220120ps.FlexibleServerOperatorSpec) error {
...
func (operator *FlexibleServerOperatorSpec) AssignProperties_To_FlexibleServerOperatorSpec(destination *v1api20220120ps.FlexibleServerOperatorSpec) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()

	// ConfigMaps
	if operator.ConfigMaps != nil {
		var configMap v1api20220120ps.FlexibleServerOperatorConfigMaps
...
func (availability *HighAvailability) AssignProperties_From_HighAvailability(source *v1api20220120ps.HighAvailability) error {
...
func (availability *HighAvailability) AssignProperties_To_HighAvailability(destination *v1api20220120ps.HighAvailability) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (availability *HighAvailability_STATUS) AssignProperties_From_HighAvailability_STATUS(source *v1api20220120ps.HighAvailability_STATUS) error {
...
func (availability *HighAvailability_STATUS) AssignProperties_To_HighAvailability_STATUS(destination *v1api20220120ps.HighAvailability_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (window *MaintenanceWindow) AssignProperties_From_MaintenanceWindow(source *v1api20220120ps.MaintenanceWindow) error {
...
func (window *MaintenanceWindow) AssignProperties_To_MaintenanceWindow(destination *v1api20220120ps.MaintenanceWindow) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (window *MaintenanceWindow_STATUS) AssignProperties_From_MaintenanceWindow_STATUS(source *v1api20220120ps.MaintenanceWindow_STATUS) error {
...
func (window *MaintenanceWindow_STATUS) AssignProperties_To_MaintenanceWindow_STATUS(destination *v1api20220120ps.MaintenanceWindow_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (network *Network) AssignProperties_From_Network(source *v1api20220120ps.Network) error {
...
func (network *Network) AssignProperties_To_Network(destination *v1api20220120ps.Network) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (network *Network_STATUS) AssignProperties_From_Network_STATUS(source *v1api20220120ps.Network_STATUS) error {
...
func (network *Network_STATUS) AssignProperties_To_Network_STATUS(destination *v1api20220120ps.Network_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sku *Sku) AssignProperties_From_Sku(source *v1api20220120ps.Sku) error {
...
func (sku *Sku) AssignProperties_To_Sku(destination *v1api20220120ps.Sku) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (sku *Sku_STATUS) AssignProperties_From_Sku_STATUS(source *v1api20220120ps.Sku_STATUS) error {
...
func (sku *Sku_STATUS) AssignProperties_To_Sku_STATUS(destination *v1api20220120ps.Sku_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (storage *Storage) AssignProperties_From_Storage(source *v1api20220120ps.Storage) error {
...
func (storage *Storage) AssignProperties_To_Storage(destination *v1api20220120ps.Storage) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (storage *Storage_STATUS) AssignProperties_From_Storage_STATUS(source *v1api20220120ps.Storage_STATUS) error {
...
func (storage *Storage_STATUS) AssignProperties_To_Storage_STATUS(destination *v1api20220120ps.Storage_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v1api20220120ps.SystemData_STATUS) error {
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v1api20220120ps.SystemData_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
...
func (maps *FlexibleServerOperatorConfigMaps) AssignProperties_From_FlexibleServerOperatorConfigMaps(source *v1api20220120ps.FlexibleServerOperatorConfigMaps) error {
...
func (maps *FlexibleServerOperatorConfigMaps) AssignProperties_To_FlexibleServerOperatorConfigMaps(destination *v1api20220120ps.FlexibleServerOperatorConfigMaps) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
