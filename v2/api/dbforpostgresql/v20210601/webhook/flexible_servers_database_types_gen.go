...
// +kubebuilder:webhook:path=/mutate-dbforpostgresql-azure-com-v20210601-flexibleserversdatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v20210601,name=default.v20210601.flexibleserversdatabases.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (database *FlexibleServersDatabase) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20210601/FlexibleServersDatabase, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-dbforpostgresql-azure-com-v20210601-flexibleserversdatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v20210601,name=validate.v20210601.flexibleserversdatabases.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (database *FlexibleServersDatabase) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20210601/FlexibleServersDatabase, but got %T", resource)
	}
...
func (database *FlexibleServersDatabase) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20210601/FlexibleServersDatabase, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20210601.FlexibleServersDatabase)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20210601/FlexibleServersDatabase, but got %T", oldResource)
	}
...
func (database *FlexibleServersDatabase) createValidations() []func(ctx context.Context, obj *v20210601.FlexibleServersDatabase) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20210601.FlexibleServersDatabase) (admission.Warnings, error){
