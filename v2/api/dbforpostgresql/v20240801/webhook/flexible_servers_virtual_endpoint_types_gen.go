...
// +kubebuilder:webhook:path=/mutate-dbforpostgresql-azure-com-v20240801-flexibleserversvirtualendpoint,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversvirtualendpoints,verbs=create;update,versions=v20240801,name=default.v20240801.flexibleserversvirtualendpoints.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (endpoint *FlexibleServersVirtualEndpoint) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20240801/FlexibleServersVirtualEndpoint, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-dbforpostgresql-azure-com-v20240801-flexibleserversvirtualendpoint,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversvirtualendpoints,verbs=create;update,versions=v20240801,name=validate.v20240801.flexibleserversvirtualendpoints.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (endpoint *FlexibleServersVirtualEndpoint) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20240801/FlexibleServersVirtualEndpoint, but got %T", resource)
	}
...
func (endpoint *FlexibleServersVirtualEndpoint) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20240801/FlexibleServersVirtualEndpoint, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20240801.FlexibleServersVirtualEndpoint)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20240801/FlexibleServersVirtualEndpoint, but got %T", oldResource)
	}
