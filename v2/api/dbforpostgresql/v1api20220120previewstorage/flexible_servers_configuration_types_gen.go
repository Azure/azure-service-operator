...
func (configuration *FlexibleServersConfiguration) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v1api20210601s.FlexibleServersConfiguration)
	if !ok {
...
func (configuration *FlexibleServersConfiguration) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v1api20210601s.FlexibleServersConfiguration)
	if !ok {
		return fmt.Errorf("expected dbforpostgresql/v1api20210601storage/FlexibleServersConfiguration but received %T instead", hub)
	}
...
func (configuration *FlexibleServersConfiguration) AssignProperties_From_FlexibleServersConfiguration(source *v1api20210601s.FlexibleServersConfiguration) error {
...
func (configuration *FlexibleServersConfiguration) AssignProperties_To_FlexibleServersConfiguration(destination *v1api20210601s.FlexibleServersConfiguration) error {

	// ObjectMeta
	destination.ObjectMeta = *configuration.ObjectMeta.DeepCopy()

	// Spec
	var spec v1api20210601s.FlexibleServers_Configuration_Spec
	...
	// Status
	var status v1api20210601s.FlexibleServers_Configuration_STATUS
...
type augmentConversionForFlexibleServersConfiguration interface {
	AssignPropertiesFrom(src *v1api20210601s.FlexibleServersConfiguration) error
	AssignPropertiesTo(dst *v1api20210601s.FlexibleServersConfiguration) error
}
...
func (configuration *FlexibleServers_Configuration_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1api20210601s.FlexibleServers_Configuration_Spec)
	if ok {
	...
	src = &v1api20210601s.FlexibleServers_Configuration_Spec{}
...
func (configuration *FlexibleServers_Configuration_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1api20210601s.FlexibleServers_Configuration_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1api20210601s.FlexibleServers_Configuration_Spec{}
...
func (configuration *FlexibleServers_Configuration_Spec) AssignProperties_From_FlexibleServers_Configuration_Spec(source *v1api20210601s.FlexibleServers_Configuration_Spec) error {
...
func (configuration *FlexibleServers_Configuration_Spec) AssignProperties_To_FlexibleServers_Configuration_Spec(destination *v1api20210601s.FlexibleServers_Configuration_Spec) error {
	// Clone the existing property bag
...
func (configuration *FlexibleServers_Configuration_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1api20210601s.FlexibleServers_Configuration_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1api20210601s.FlexibleServers_Configuration_STATUS{}
...
func (configuration *FlexibleServers_Configuration_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1api20210601s.FlexibleServers_Configuration_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1api20210601s.FlexibleServers_Configuration_STATUS{}
...
func (configuration *FlexibleServers_Configuration_STATUS) AssignProperties_From_FlexibleServers_Configuration_STATUS(source *v1api20210601s.FlexibleServers_Configuration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (configuration *FlexibleServers_Configuration_STATUS) AssignProperties_To_FlexibleServers_Configuration_STATUS(destination *v1api20210601s.FlexibleServers_Configuration_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(configuration.PropertyBag)
...
type augmentConversionForFlexibleServers_Configuration_Spec interface {
	AssignPropertiesFrom(src *v1api20210601s.FlexibleServers_Configuration_Spec) error
	AssignPropertiesTo(dst *v1api20210601s.FlexibleServers_Configuration_Spec) error
}

type augmentConversionForFlexibleServers_Configuration_STATUS interface {
	AssignPropertiesFrom(src *v1api20210601s.FlexibleServers_Configuration_STATUS) error
	AssignPropertiesTo(dst *v1api20210601s.FlexibleServers_Configuration_STATUS) error
}
