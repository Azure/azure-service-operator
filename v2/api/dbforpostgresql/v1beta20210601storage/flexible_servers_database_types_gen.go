...
type augmentConversionForFlexibleServersDatabase interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServersDatabase) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServersDatabase) error
}
...
type augmentConversionForFlexibleServers_Database_Spec interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServers_Database_Spec) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServers_Database_Spec) error
}

type augmentConversionForFlexibleServers_Database_STATUS interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServers_Database_STATUS) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServers_Database_STATUS) error
}
