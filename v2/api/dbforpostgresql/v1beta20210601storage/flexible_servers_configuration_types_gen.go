...
type augmentConversionForFlexibleServersConfiguration interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServersConfiguration) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServersConfiguration) error
}
...
type augmentConversionForFlexibleServers_Configuration_Spec interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServers_Configuration_Spec) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServers_Configuration_Spec) error
}

type augmentConversionForFlexibleServers_Configuration_STATUS interface {
	AssignPropertiesFrom(src *v20220120ps.FlexibleServers_Configuration_STATUS) error
	AssignPropertiesTo(dst *v20220120ps.FlexibleServers_Configuration_STATUS) error
}
