...
// +kubebuilder:webhook:path=/mutate-dbforpostgresql-azure-com-v1beta20220120preview-flexibleserversdatabase,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v1beta20220120preview,name=default.v1beta20220120preview.flexibleserversdatabases.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-dbforpostgresql-azure-com-v1beta20220120preview-flexibleserversdatabase,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversdatabases,verbs=create;update,versions=v1beta20220120preview,name=validate.v1beta20220120preview.flexibleserversdatabases.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (database *FlexibleServersDatabase) AssignProperties_To_FlexibleServersDatabase(destination *v20220120ps.FlexibleServersDatabase) error {
	...
	// Status
	var status v20220120ps.Database_STATUS
...
func (database *Database_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20220120ps.Database_STATUS)
	if ok {
	...
	src = &v20220120ps.Database_STATUS{}
...
func (database *Database_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20220120ps.Database_STATUS)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20220120ps.Database_STATUS{}
...
func (database *Database_STATUS) AssignProperties_From_Database_STATUS(source *v20220120ps.Database_STATUS) error {
...
func (database *Database_STATUS) AssignProperties_To_Database_STATUS(destination *v20220120ps.Database_STATUS) error {
