...
import (
	"fmt"
	arm "github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v1api20250801/arm"
...
func (administrator *FlexibleServersAdministrator) ConvertFrom(hub conversion.Hub) error {
	...
	if !ok {
		return fmt.Errorf("expected dbforpostgresql/v1api20250801/storage/FlexibleServersAdministrator but received %T instead", hub)
	}
