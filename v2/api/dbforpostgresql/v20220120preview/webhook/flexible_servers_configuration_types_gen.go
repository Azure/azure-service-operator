...
import (
	"context"
	"fmt"
	v20220120p "github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20220120preview"
...
// +kubebuilder:webhook:path=/mutate-dbforpostgresql-azure-com-v20220120preview-flexibleserversconfiguration,mutating=true,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversconfigurations,verbs=create;update,versions=v20220120preview,name=default.v20220120preview.flexibleserversconfigurations.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (configuration *FlexibleServersConfiguration) Default(ctx context.Context, obj runtime.Object) error {
	...
	if !ok {
		return fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20220120preview/FlexibleServersConfiguration, but got %T", obj)
	}
...
// +kubebuilder:webhook:path=/validate-dbforpostgresql-azure-com-v20220120preview-flexibleserversconfiguration,mutating=false,sideEffects=None,matchPolicy=Exact,failurePolicy=fail,groups=dbforpostgresql.azure.com,resources=flexibleserversconfigurations,verbs=create;update,versions=v20220120preview,name=validate.v20220120preview.flexibleserversconfigurations.dbforpostgresql.azure.com,admissionReviewVersions=v1
...
func (configuration *FlexibleServersConfiguration) ValidateCreate(ctx context.Context, resource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20220120preview/FlexibleServersConfiguration, but got %T", resource)
	}
...
func (configuration *FlexibleServersConfiguration) ValidateUpdate(ctx context.Context, oldResource runtime.Object, newResource runtime.Object) (admission.Warnings, error) {
	...
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20220120preview/FlexibleServersConfiguration, but got %T", newResource)
	}
	oldObj, ok := oldResource.(*v20220120p.FlexibleServersConfiguration)
	if !ok {
		return nil, fmt.Errorf("expected github.com/Azure/azure-service-operator/v2/api/dbforpostgresql/v20220120preview/FlexibleServersConfiguration, but got %T", oldResource)
	}
...
func (configuration *FlexibleServersConfiguration) createValidations() []func(ctx context.Context, obj *v20220120p.FlexibleServersConfiguration) (admission.Warnings, error) {
	return []func(ctx context.Context, obj *v20220120p.FlexibleServersConfiguration) (admission.Warnings, error){
