...
type augmentConversionForNamespacesEventhub interface {
	AssignPropertiesFrom(src *v1api20211101s.NamespacesEventhub) error
	AssignPropertiesTo(dst *v1api20211101s.NamespacesEventhub) error
}
...
type augmentConversionForNamespaces_Eventhub_Spec interface {
	AssignPropertiesFrom(src *v1api20211101s.Namespaces_Eventhub_Spec) error
	AssignPropertiesTo(dst *v1api20211101s.Namespaces_Eventhub_Spec) error
}

type augmentConversionForNamespaces_Eventhub_STATUS interface {
	AssignPropertiesFrom(src *v1api20211101s.Namespaces_Eventhub_STATUS) error
	AssignPropertiesTo(dst *v1api20211101s.Namespaces_Eventhub_STATUS) error
}
...
type augmentConversionForCaptureDescription interface {
	AssignPropertiesFrom(src *v1api20211101s.CaptureDescription) error
	AssignPropertiesTo(dst *v1api20211101s.CaptureDescription) error
}

type augmentConversionForCaptureDescription_STATUS interface {
	AssignPropertiesFrom(src *v1api20211101s.CaptureDescription_STATUS) error
	AssignPropertiesTo(dst *v1api20211101s.CaptureDescription_STATUS) error
}
...
type augmentConversionForDestination interface {
	AssignPropertiesFrom(src *v1api20211101s.Destination) error
	AssignPropertiesTo(dst *v1api20211101s.Destination) error
}

type augmentConversionForDestination_STATUS interface {
	AssignPropertiesFrom(src *v1api20211101s.Destination_STATUS) error
	AssignPropertiesTo(dst *v1api20211101s.Destination_STATUS) error
}
