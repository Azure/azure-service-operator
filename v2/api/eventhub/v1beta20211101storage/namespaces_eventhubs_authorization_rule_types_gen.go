...
type augmentConversionForNamespacesEventhubsAuthorizationRule interface {
	AssignPropertiesFrom(src *v1api20211101s.NamespacesEventhubsAuthorizationRule) error
	AssignPropertiesTo(dst *v1api20211101s.NamespacesEventhubsAuthorizationRule) error
}
...
type augmentConversionForNamespaces_Eventhubs_AuthorizationRule_Spec interface {
	AssignPropertiesFrom(src *v1api20211101s.Namespaces_Eventhubs_AuthorizationRule_Spec) error
	AssignPropertiesTo(dst *v1api20211101s.Namespaces_Eventhubs_AuthorizationRule_Spec) error
}

type augmentConversionForNamespaces_Eventhubs_AuthorizationRule_STATUS interface {
	AssignPropertiesFrom(src *v1api20211101s.Namespaces_Eventhubs_AuthorizationRule_STATUS) error
	AssignPropertiesTo(dst *v1api20211101s.Namespaces_Eventhubs_AuthorizationRule_STATUS) error
}
