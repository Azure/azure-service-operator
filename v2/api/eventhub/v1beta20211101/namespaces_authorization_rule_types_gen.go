...
func (rule *NamespacesAuthorizationRule) ConvertFrom(hub conversion.Hub) error {
	...
	var source v1beta20211101s.NamespacesAuthorizationRule
...
func (rule *NamespacesAuthorizationRule) ConvertTo(hub conversion.Hub) error {
	// intermediate variable for conversion
	var destination v1beta20211101s.NamespacesAuthorizationRule
...
func (rule *NamespacesAuthorizationRule) AssignProperties_To_NamespacesAuthorizationRule(destination *v1beta20211101s.NamespacesAuthorizationRule) error {
	...
	// Spec
	var spec v1beta20211101s.Namespaces_AuthorizationRule_Spec
	...
	// Status
	var status v1beta20211101s.Namespaces_AuthorizationRule_STATUS
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v1beta20211101s.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	src = &v1beta20211101s.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v1beta20211101s.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v1beta20211101s.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v1beta20211101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v1beta20211101s.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v1beta20211101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v1beta20211101s.Namespaces_AuthorizationRule_STATUS{}
...
// v1api20211101.Namespaces_AuthorizationRule_Properties_Rights_Spec instead
...
// v1api20211101.Namespaces_AuthorizationRule_Properties_Rights_STATUS instead
