...
func (ext *NamespacesAuthorizationRuleExtension) ExportKubernetesSecrets(
	...
	primarySecrets := namespacesAuthorizationRuleSecretsSpecified(typedObj)
	...
	resolvedSecrets := makeNamespacesAuthorizationRuleResolvedSecretsMap(res.AccessKeys)
...
func namespacesAuthorizationRuleSecretsSpecified(obj *storage.NamespacesAuthorizationRule) set.Set[string] {
...
func makeNamespacesAuthorizationRuleResolvedSecretsMap(accessKeys armeventhub.AccessKeys) map[string]string {
