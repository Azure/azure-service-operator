...
func RunPropertyAssignmentTestForNamespaces_Spec(subject Namespaces_Spec) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211101s.Namespaces_Spec
...
// RunPropertyAssignmentTestForNamespaces_Spec_Properties_PrivateEndpointConnections tests if a specific instance of Namespaces_Spec_Properties_PrivateEndpointConnections can be assigned to v1alpha1api20211101storage and back losslessly
...
=======
	var other alpha20211101s.Namespaces_Spec_Properties_PrivateEndpointConnections
