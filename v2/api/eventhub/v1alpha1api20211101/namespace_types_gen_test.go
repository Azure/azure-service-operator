...
func AddIndependentPropertyGeneratorsForSku(gens map[string]gopter.Gen) {
	...
	gens["Tier"] = gen.PtrOf(gen.OneConstOf(Sku_TierBasic, Sku_TierPremium, Sku_TierStandard))
}
...
// RunPropertyAssignmentTestForSystemData tests if a specific instance of SystemData can be assigned to v1alpha1api20211101storage and back losslessly
func RunPropertyAssignmentTestForSystemData(subject SystemData) string {
	// Copy subject to make sure assignment doesn't modify it
	copied := subject.DeepCopy()

	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20211101s.SystemData
