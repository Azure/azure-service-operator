...
type Eventhub_StatusARM struct {
	...
	Properties *Eventhub_StatusPropertiesARM `json:"properties,omitempty"`
...
type Eventhub_StatusPropertiesARM struct {
...
type Destination_StatusARM struct {
	...
	Properties *Destination_StatusPropertiesARM `json:"properties,omitempty"`
}

type Destination_StatusPropertiesARM struct {
