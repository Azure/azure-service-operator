...
func (rule *NamespacesAuthorizationRule) AssignProperties_To_NamespacesAuthorizationRule(destination *alpha20211101s.NamespacesAuthorizationRule) error {
	...
	// Status
	var status alpha20211101s.Namespaces_AuthorizationRule_STATUS
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*alpha20211101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &alpha20211101s.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*alpha20211101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &alpha20211101s.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_From_Namespaces_AuthorizationRule_STATUS(source *alpha20211101s.Namespaces_AuthorizationRule_STATUS) error {
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_To_Namespaces_AuthorizationRule_STATUS(destination *alpha20211101s.Namespaces_AuthorizationRule_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
