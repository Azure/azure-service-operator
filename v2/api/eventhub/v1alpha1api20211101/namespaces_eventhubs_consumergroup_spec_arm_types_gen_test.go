...
func AddRelatedPropertyGeneratorsForNamespaces_Eventhubs_Consumergroup_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Properties"] = gen.PtrOf(ConsumerGroupProperties_ARMGenerator())
}

func Test_ConsumerGroupProperties_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of ConsumerGroupProperties_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForConsumerGroupProperties_ARM, ConsumerGroupProperties_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForConsumerGroupProperties_ARM runs a test to see if a specific instance of ConsumerGroupProperties_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForConsumerGroupProperties_ARM(subject ConsumerGroupProperties_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual ConsumerGroupProperties_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of ConsumerGroupProperties_ARM instances for property testing - lazily instantiated by
// ConsumerGroupProperties_ARMGenerator()
var consumerGroupProperties_ARMGenerator gopter.Gen

// ConsumerGroupProperties_ARMGenerator returns a generator of ConsumerGroupProperties_ARM instances for property testing.
func ConsumerGroupProperties_ARMGenerator() gopter.Gen {
	if consumerGroupProperties_ARMGenerator != nil {
		return consumerGroupProperties_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForConsumerGroupProperties_ARM(generators)
	consumerGroupProperties_ARMGenerator = gen.Struct(reflect.TypeOf(ConsumerGroupProperties_ARM{}), generators)

	return consumerGroupProperties_ARMGenerator
}

// AddIndependentPropertyGeneratorsForConsumerGroupProperties_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForConsumerGroupProperties_ARM(gens map[string]gopter.Gen) {
