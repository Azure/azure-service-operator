...
func Test_Namespace_SpecARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	...
	properties.Property(
<<<<<<<< HEAD:v2/api/eventhub/v1alpha1api20211101/namespace__spec_arm_types_gen_test.go
...
>>>>>>>> main:v2/api/eventhub/v1alpha1api20211101/namespaces_spec_arm_types_gen_test.go
	// Serialize to JSON
