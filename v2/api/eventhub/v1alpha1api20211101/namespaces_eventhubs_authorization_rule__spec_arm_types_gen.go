...
type NamespacesEventhubsAuthorizationRule_SpecARM struct {
	...
	Properties *NamespacesEventhubsAuthorizationRule_SpecPropertiesARM `json:"properties,omitempty"`
}
...
type NamespacesEventhubsAuthorizationRule_SpecPropertiesARM struct {
	//Rights: The rights associated with the rule.
	Rights []NamespacesEventhubsAuthorizationRule_SpecPropertiesRights `json:"rights"`
}
