...
func AddRelatedPropertyGeneratorsForNamespaces_Eventhub_Properties_Spec_ARM(gens map[string]gopter.Gen) {
	...
	gens["RetentionDescription"] = gen.PtrOf(RetentionDescription_ARMGenerator())
}
...
func Test_RetentionDescription_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of RetentionDescription_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForRetentionDescription_ARM, RetentionDescription_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForRetentionDescription_ARM runs a test to see if a specific instance of RetentionDescription_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForRetentionDescription_ARM(subject RetentionDescription_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual RetentionDescription_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of RetentionDescription_ARM instances for property testing - lazily instantiated by
// RetentionDescription_ARMGenerator()
var retentionDescription_ARMGenerator gopter.Gen

// RetentionDescription_ARMGenerator returns a generator of RetentionDescription_ARM instances for property testing.
func RetentionDescription_ARMGenerator() gopter.Gen {
	if retentionDescription_ARMGenerator != nil {
		return retentionDescription_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForRetentionDescription_ARM(generators)
	retentionDescription_ARMGenerator = gen.Struct(reflect.TypeOf(RetentionDescription_ARM{}), generators)

	return retentionDescription_ARMGenerator
}

// AddIndependentPropertyGeneratorsForRetentionDescription_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForRetentionDescription_ARM(gens map[string]gopter.Gen) {
...
func AddRelatedPropertyGeneratorsForDestination_ARM(gens map[string]gopter.Gen) {
	gens["Identity"] = gen.PtrOf(CaptureIdentity_ARMGenerator())
	gens["Properties"] = gen.PtrOf(Destination_Properties_ARMGenerator())
}

func Test_CaptureIdentity_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 100
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of CaptureIdentity_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForCaptureIdentity_ARM, CaptureIdentity_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForCaptureIdentity_ARM runs a test to see if a specific instance of CaptureIdentity_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForCaptureIdentity_ARM(subject CaptureIdentity_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual CaptureIdentity_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of CaptureIdentity_ARM instances for property testing - lazily instantiated by
// CaptureIdentity_ARMGenerator()
var captureIdentity_ARMGenerator gopter.Gen

// CaptureIdentity_ARMGenerator returns a generator of CaptureIdentity_ARM instances for property testing.
func CaptureIdentity_ARMGenerator() gopter.Gen {
	if captureIdentity_ARMGenerator != nil {
		return captureIdentity_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForCaptureIdentity_ARM(generators)
	captureIdentity_ARMGenerator = gen.Struct(reflect.TypeOf(CaptureIdentity_ARM{}), generators)

	return captureIdentity_ARMGenerator
}

// AddIndependentPropertyGeneratorsForCaptureIdentity_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForCaptureIdentity_ARM(gens map[string]gopter.Gen) {
