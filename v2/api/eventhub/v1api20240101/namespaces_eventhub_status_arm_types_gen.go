...
type Namespaces_Eventhub_Properties_STATUS_ARM struct {
	...
	RetentionDescription *RetentionDescription_STATUS_ARM `json:"retentionDescription,omitempty"`
...
type RetentionDescription_STATUS_ARM struct {
...
type Destination_STATUS_ARM struct {
	...
	Identity *CaptureIdentity_STATUS_ARM `json:"identity,omitempty"`
...
type CaptureIdentity_STATUS_ARM struct {
