...
type Namespace_Properties_Spec_ARM struct {
	...
	MinimumTlsVersion *Namespace_Properties_MinimumTlsVersion_Spec `json:"minimumTlsVersion,omitempty"`

	// PublicNetworkAccess: This determines if traffic is allowed over public network. By default it is enabled.
	PublicNetworkAccess *Namespace_Properties_PublicNetworkAccess_Spec `json:"publicNetworkAccess,omitempty"`
