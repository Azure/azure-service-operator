...
type Namespaces_Eventhub_Properties_Spec_ARM struct {
	...
	RetentionDescription *RetentionDescription_ARM `json:"retentionDescription,omitempty"`
}
...
type RetentionDescription_ARM struct {
...
type Destination_ARM struct {
	...
	Identity *CaptureIdentity_ARM `json:"identity,omitempty"`
...
type CaptureIdentity_ARM struct {
