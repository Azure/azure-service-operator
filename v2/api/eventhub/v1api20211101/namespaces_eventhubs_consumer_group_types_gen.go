...
func (group *NamespacesEventhubsConsumerGroup) AssignProperties_To_NamespacesEventhubsConsumerGroup(destination *storage.NamespacesEventhubsConsumerGroup) error {
	...
	// Spec
	var spec storage.Namespaces_Eventhubs_Consumergroup_Spec
	...
	// Status
	var status storage.Namespaces_Eventhubs_Consumergroup_STATUS
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*storage.Namespaces_Eventhubs_Consumergroup_Spec)
	if ok {
	...
	src = &storage.Namespaces_Eventhubs_Consumergroup_Spec{}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*storage.Namespaces_Eventhubs_Consumergroup_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &storage.Namespaces_Eventhubs_Consumergroup_Spec{}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) AssignProperties_From_Namespaces_Eventhubs_Consumergroup_Spec(source *storage.Namespaces_Eventhubs_Consumergroup_Spec) error {
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_Spec) AssignProperties_To_Namespaces_Eventhubs_Consumergroup_Spec(destination *storage.Namespaces_Eventhubs_Consumergroup_Spec) error {
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*storage.Namespaces_Eventhubs_Consumergroup_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &storage.Namespaces_Eventhubs_Consumergroup_STATUS{}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*storage.Namespaces_Eventhubs_Consumergroup_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &storage.Namespaces_Eventhubs_Consumergroup_STATUS{}
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_STATUS) AssignProperties_From_Namespaces_Eventhubs_Consumergroup_STATUS(source *storage.Namespaces_Eventhubs_Consumergroup_STATUS) error {
...
func (consumergroup *Namespaces_Eventhubs_Consumergroup_STATUS) AssignProperties_To_Namespaces_Eventhubs_Consumergroup_STATUS(destination *storage.Namespaces_Eventhubs_Consumergroup_STATUS) error {
	// Create a new property bag
	propertyBag := genruntime.NewPropertyBag()
