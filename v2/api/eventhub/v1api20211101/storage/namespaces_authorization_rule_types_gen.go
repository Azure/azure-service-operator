...
func (rule *NamespacesAuthorizationRule) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20240101s.NamespacesAuthorizationRule)
	if !ok {
...
func (rule *NamespacesAuthorizationRule) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20240101s.NamespacesAuthorizationRule)
	if !ok {
		return fmt.Errorf("expected eventhub/v1api20240101/storage/NamespacesAuthorizationRule but received %T instead", hub)
	}
...
func (rule *NamespacesAuthorizationRule) AssignProperties_From_NamespacesAuthorizationRule(source *v20240101s.NamespacesAuthorizationRule) error {
...
func (rule *NamespacesAuthorizationRule) AssignProperties_To_NamespacesAuthorizationRule(destination *v20240101s.NamespacesAuthorizationRule) error {

	// ObjectMeta
	destination.ObjectMeta = *rule.ObjectMeta.DeepCopy()

	// Spec
	var spec v20240101s.Namespaces_AuthorizationRule_Spec
	...
	// Status
	var status v20240101s.Namespaces_AuthorizationRule_STATUS
...
type augmentConversionForNamespacesAuthorizationRule interface {
	AssignPropertiesFrom(src *v20240101s.NamespacesAuthorizationRule) error
	AssignPropertiesTo(dst *v20240101s.NamespacesAuthorizationRule) error
}
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20240101s.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	src = &v20240101s.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20240101s.Namespaces_AuthorizationRule_Spec)
	if ok {
	...
	// Convert to an intermediate form
	dst = &v20240101s.Namespaces_AuthorizationRule_Spec{}
...
func (rule *Namespaces_AuthorizationRule_Spec) AssignProperties_From_Namespaces_AuthorizationRule_Spec(source *v20240101s.Namespaces_AuthorizationRule_Spec) error {
...
func (rule *Namespaces_AuthorizationRule_Spec) AssignProperties_To_Namespaces_AuthorizationRule_Spec(destination *v20240101s.Namespaces_AuthorizationRule_Spec) error {
	// Clone the existing property bag
	...
	if rule.OperatorSpec != nil {
		var operatorSpec v20240101s.NamespacesAuthorizationRuleOperatorSpec
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20240101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20240101s.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20240101s.Namespaces_AuthorizationRule_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20240101s.Namespaces_AuthorizationRule_STATUS{}
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_From_Namespaces_AuthorizationRule_STATUS(source *v20240101s.Namespaces_AuthorizationRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (rule *Namespaces_AuthorizationRule_STATUS) AssignProperties_To_Namespaces_AuthorizationRule_STATUS(destination *v20240101s.Namespaces_AuthorizationRule_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(rule.PropertyBag)
...
type augmentConversionForNamespaces_AuthorizationRule_Spec interface {
	AssignPropertiesFrom(src *v20240101s.Namespaces_AuthorizationRule_Spec) error
	AssignPropertiesTo(dst *v20240101s.Namespaces_AuthorizationRule_Spec) error
}

type augmentConversionForNamespaces_AuthorizationRule_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.Namespaces_AuthorizationRule_STATUS) error
	AssignPropertiesTo(dst *v20240101s.Namespaces_AuthorizationRule_STATUS) error
}
...
func (operator *NamespacesAuthorizationRuleOperatorSpec) AssignProperties_From_NamespacesAuthorizationRuleOperatorSpec(source *v20240101s.NamespacesAuthorizationRuleOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *NamespacesAuthorizationRuleOperatorSpec) AssignProperties_To_NamespacesAuthorizationRuleOperatorSpec(destination *v20240101s.NamespacesAuthorizationRuleOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(operator.PropertyBag)

	// Secrets
	if operator.Secrets != nil {
		var secret v20240101s.NamespacesAuthorizationRuleOperatorSecrets
...
type augmentConversionForNamespacesAuthorizationRuleOperatorSpec interface {
	AssignPropertiesFrom(src *v20240101s.NamespacesAuthorizationRuleOperatorSpec) error
	AssignPropertiesTo(dst *v20240101s.NamespacesAuthorizationRuleOperatorSpec) error
}
...
func (secrets *NamespacesAuthorizationRuleOperatorSecrets) AssignProperties_From_NamespacesAuthorizationRuleOperatorSecrets(source *v20240101s.NamespacesAuthorizationRuleOperatorSecrets) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (secrets *NamespacesAuthorizationRuleOperatorSecrets) AssignProperties_To_NamespacesAuthorizationRuleOperatorSecrets(destination *v20240101s.NamespacesAuthorizationRuleOperatorSecrets) error {
	// Clone the existing property bag
...
type augmentConversionForNamespacesAuthorizationRuleOperatorSecrets interface {
	AssignPropertiesFrom(src *v20240101s.NamespacesAuthorizationRuleOperatorSecrets) error
	AssignPropertiesTo(dst *v20240101s.NamespacesAuthorizationRuleOperatorSecrets) error
}
