...
func (namespace *Namespace) ConvertFrom(hub conversion.Hub) error {
	source, ok := hub.(*v20240101s.Namespace)
	if !ok {
...
func (namespace *Namespace) ConvertTo(hub conversion.Hub) error {
	destination, ok := hub.(*v20240101s.Namespace)
	if !ok {
		return fmt.Errorf("expected eventhub/v1api20240101/storage/Namespace but received %T instead", hub)
	}
...
func (namespace *Namespace) AssignProperties_From_Namespace(source *v20240101s.Namespace) error {
...
func (namespace *Namespace) AssignProperties_To_Namespace(destination *v20240101s.Namespace) error {

	// ObjectMeta
	destination.ObjectMeta = *namespace.ObjectMeta.DeepCopy()

	// Spec
	var spec v20240101s.Namespace_Spec
	...
	// Status
	var status v20240101s.Namespace_STATUS
...
type augmentConversionForNamespace interface {
	AssignPropertiesFrom(src *v20240101s.Namespace) error
	AssignPropertiesTo(dst *v20240101s.Namespace) error
}
...
func (namespace *Namespace_Spec) ConvertSpecFrom(source genruntime.ConvertibleSpec) error {
	src, ok := source.(*v20240101s.Namespace_Spec)
	if ok {
...
func (namespace *Namespace_Spec) ConvertSpecTo(destination genruntime.ConvertibleSpec) error {
	dst, ok := destination.(*v20240101s.Namespace_Spec)
	if ok {
...
func (namespace *Namespace_Spec) AssignProperties_From_Namespace_Spec(source *v20240101s.Namespace_Spec) error {
...
func (namespace *Namespace_Spec) AssignProperties_To_Namespace_Spec(destination *v20240101s.Namespace_Spec) error {
	// Clone the existing property bag
	...
	if namespace.Encryption != nil {
		var encryption v20240101s.Encryption
	...
	if namespace.Identity != nil {
		var identity v20240101s.Identity
	...
	if namespace.OperatorSpec != nil {
		var operatorSpec v20240101s.NamespaceOperatorSpec
...
func (namespace *Namespace_STATUS) ConvertStatusFrom(source genruntime.ConvertibleStatus) error {
	src, ok := source.(*v20240101s.Namespace_STATUS)
	if ok {
		// Populate our instance from source
	...
	// Convert to an intermediate form
	src = &v20240101s.Namespace_STATUS{}
...
func (namespace *Namespace_STATUS) ConvertStatusTo(destination genruntime.ConvertibleStatus) error {
	dst, ok := destination.(*v20240101s.Namespace_STATUS)
	if ok {
		// Populate destination from our instance
	...
	// Convert to an intermediate form
	dst = &v20240101s.Namespace_STATUS{}
...
func (namespace *Namespace_STATUS) AssignProperties_From_Namespace_STATUS(source *v20240101s.Namespace_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (namespace *Namespace_STATUS) AssignProperties_To_Namespace_STATUS(destination *v20240101s.Namespace_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(namespace.PropertyBag)
	...
	// Encryption
	if namespace.Encryption != nil {
		var encryption v20240101s.Encryption_STATUS
	...
	// Identity
	if namespace.Identity != nil {
		var identity v20240101s.Identity_STATUS
	...
	if namespace.PrivateEndpointConnections != nil {
		privateEndpointConnectionList := make([]v20240101s.PrivateEndpointConnection_STATUS, len(namespace.PrivateEndpointConnections))
		for privateEndpointConnectionIndex, privateEndpointConnectionItem := range namespace.PrivateEndpointConnections {
			// Shadow the loop variable to avoid aliasing
			privateEndpointConnectionItem := privateEndpointConnectionItem
			var privateEndpointConnection v20240101s.PrivateEndpointConnection_STATUS
...
type augmentConversionForNamespace_Spec interface {
	AssignPropertiesFrom(src *v20240101s.Namespace_Spec) error
	AssignPropertiesTo(dst *v20240101s.Namespace_Spec) error
}

type augmentConversionForNamespace_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.Namespace_STATUS) error
	AssignPropertiesTo(dst *v20240101s.Namespace_STATUS) error
}
...
func (encryption *Encryption) AssignProperties_From_Encryption(source *v20240101s.Encryption) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (encryption *Encryption) AssignProperties_To_Encryption(destination *v20240101s.Encryption) error {
	// Clone the existing property bag
	...
	if encryption.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v20240101s.KeyVaultProperties, len(encryption.KeyVaultProperties))
		for keyVaultPropertyIndex, keyVaultPropertyItem := range encryption.KeyVaultProperties {
			// Shadow the loop variable to avoid aliasing
			keyVaultPropertyItem := keyVaultPropertyItem
			var keyVaultProperty v20240101s.KeyVaultProperties
...
func (encryption *Encryption_STATUS) AssignProperties_From_Encryption_STATUS(source *v20240101s.Encryption_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (encryption *Encryption_STATUS) AssignProperties_To_Encryption_STATUS(destination *v20240101s.Encryption_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(encryption.PropertyBag)
	...
	// KeyVaultProperties
	if encryption.KeyVaultProperties != nil {
		keyVaultPropertyList := make([]v20240101s.KeyVaultProperties_STATUS, len(encryption.KeyVaultProperties))
		for keyVaultPropertyIndex, keyVaultPropertyItem := range encryption.KeyVaultProperties {
			// Shadow the loop variable to avoid aliasing
			keyVaultPropertyItem := keyVaultPropertyItem
			var keyVaultProperty v20240101s.KeyVaultProperties_STATUS
...
func (identity *Identity) AssignProperties_From_Identity(source *v20240101s.Identity) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *Identity) AssignProperties_To_Identity(destination *v20240101s.Identity) error {
	// Clone the existing property bag
	...
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityList := make([]v20240101s.UserAssignedIdentityDetails, len(identity.UserAssignedIdentities))
		for userAssignedIdentityIndex, userAssignedIdentityItem := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityItem := userAssignedIdentityItem
			var userAssignedIdentity v20240101s.UserAssignedIdentityDetails
...
func (identity *Identity_STATUS) AssignProperties_From_Identity_STATUS(source *v20240101s.Identity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *Identity_STATUS) AssignProperties_To_Identity_STATUS(destination *v20240101s.Identity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
	...
	// UserAssignedIdentities
	if identity.UserAssignedIdentities != nil {
		userAssignedIdentityMap := make(map[string]v20240101s.UserAssignedIdentity_STATUS, len(identity.UserAssignedIdentities))
		for userAssignedIdentityKey, userAssignedIdentityValue := range identity.UserAssignedIdentities {
			// Shadow the loop variable to avoid aliasing
			userAssignedIdentityValue := userAssignedIdentityValue
			var userAssignedIdentity v20240101s.UserAssignedIdentity_STATUS
...
func (operator *NamespaceOperatorSpec) AssignProperties_From_NamespaceOperatorSpec(source *v20240101s.NamespaceOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (operator *NamespaceOperatorSpec) AssignProperties_To_NamespaceOperatorSpec(destination *v20240101s.NamespaceOperatorSpec) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(operator.PropertyBag)

	// Secrets
	if operator.Secrets != nil {
		var secret v20240101s.NamespaceOperatorSecrets
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_From_PrivateEndpointConnection_STATUS(source *v20240101s.PrivateEndpointConnection_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (connection *PrivateEndpointConnection_STATUS) AssignProperties_To_PrivateEndpointConnection_STATUS(destination *v20240101s.PrivateEndpointConnection_STATUS) error {
	// Clone the existing property bag
...
func (sku *Sku) AssignProperties_From_Sku(source *v20240101s.Sku) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (sku *Sku) AssignProperties_To_Sku(destination *v20240101s.Sku) error {
	// Clone the existing property bag
...
func (sku *Sku_STATUS) AssignProperties_From_Sku_STATUS(source *v20240101s.Sku_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (sku *Sku_STATUS) AssignProperties_To_Sku_STATUS(destination *v20240101s.Sku_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(sku.PropertyBag)
...
func (data *SystemData_STATUS) AssignProperties_From_SystemData_STATUS(source *v20240101s.SystemData_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (data *SystemData_STATUS) AssignProperties_To_SystemData_STATUS(destination *v20240101s.SystemData_STATUS) error {
	// Clone the existing property bag
...
type augmentConversionForEncryption interface {
	AssignPropertiesFrom(src *v20240101s.Encryption) error
	AssignPropertiesTo(dst *v20240101s.Encryption) error
}

type augmentConversionForEncryption_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.Encryption_STATUS) error
	AssignPropertiesTo(dst *v20240101s.Encryption_STATUS) error
}

type augmentConversionForIdentity interface {
	AssignPropertiesFrom(src *v20240101s.Identity) error
	AssignPropertiesTo(dst *v20240101s.Identity) error
}

type augmentConversionForIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.Identity_STATUS) error
	AssignPropertiesTo(dst *v20240101s.Identity_STATUS) error
}

type augmentConversionForNamespaceOperatorSpec interface {
	AssignPropertiesFrom(src *v20240101s.NamespaceOperatorSpec) error
	AssignPropertiesTo(dst *v20240101s.NamespaceOperatorSpec) error
}

type augmentConversionForPrivateEndpointConnection_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.PrivateEndpointConnection_STATUS) error
	AssignPropertiesTo(dst *v20240101s.PrivateEndpointConnection_STATUS) error
}

type augmentConversionForSku interface {
	AssignPropertiesFrom(src *v20240101s.Sku) error
	AssignPropertiesTo(dst *v20240101s.Sku) error
}

type augmentConversionForSku_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.Sku_STATUS) error
	AssignPropertiesTo(dst *v20240101s.Sku_STATUS) error
}

type augmentConversionForSystemData_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.SystemData_STATUS) error
	AssignPropertiesTo(dst *v20240101s.SystemData_STATUS) error
}
...
func (properties *KeyVaultProperties) AssignProperties_From_KeyVaultProperties(source *v20240101s.KeyVaultProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (properties *KeyVaultProperties) AssignProperties_To_KeyVaultProperties(destination *v20240101s.KeyVaultProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)

	// Identity
	if properties.Identity != nil {
		var identity v20240101s.UserAssignedIdentityProperties
...
func (properties *KeyVaultProperties_STATUS) AssignProperties_From_KeyVaultProperties_STATUS(source *v20240101s.KeyVaultProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (properties *KeyVaultProperties_STATUS) AssignProperties_To_KeyVaultProperties_STATUS(destination *v20240101s.KeyVaultProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)

	// Identity
	if properties.Identity != nil {
		var identity v20240101s.UserAssignedIdentityProperties_STATUS
...
func (secrets *NamespaceOperatorSecrets) AssignProperties_From_NamespaceOperatorSecrets(source *v20240101s.NamespaceOperatorSecrets) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (secrets *NamespaceOperatorSecrets) AssignProperties_To_NamespaceOperatorSecrets(destination *v20240101s.NamespaceOperatorSecrets) error {
	// Clone the existing property bag
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_From_UserAssignedIdentity_STATUS(source *v20240101s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (identity *UserAssignedIdentity_STATUS) AssignProperties_To_UserAssignedIdentity_STATUS(destination *v20240101s.UserAssignedIdentity_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(identity.PropertyBag)
...
func (details *UserAssignedIdentityDetails) AssignProperties_From_UserAssignedIdentityDetails(source *v20240101s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (details *UserAssignedIdentityDetails) AssignProperties_To_UserAssignedIdentityDetails(destination *v20240101s.UserAssignedIdentityDetails) error {
	// Clone the existing property bag
...
type augmentConversionForKeyVaultProperties interface {
	AssignPropertiesFrom(src *v20240101s.KeyVaultProperties) error
	AssignPropertiesTo(dst *v20240101s.KeyVaultProperties) error
}

type augmentConversionForKeyVaultProperties_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.KeyVaultProperties_STATUS) error
	AssignPropertiesTo(dst *v20240101s.KeyVaultProperties_STATUS) error
}

type augmentConversionForNamespaceOperatorSecrets interface {
	AssignPropertiesFrom(src *v20240101s.NamespaceOperatorSecrets) error
	AssignPropertiesTo(dst *v20240101s.NamespaceOperatorSecrets) error
}

type augmentConversionForUserAssignedIdentity_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.UserAssignedIdentity_STATUS) error
	AssignPropertiesTo(dst *v20240101s.UserAssignedIdentity_STATUS) error
}

type augmentConversionForUserAssignedIdentityDetails interface {
	AssignPropertiesFrom(src *v20240101s.UserAssignedIdentityDetails) error
	AssignPropertiesTo(dst *v20240101s.UserAssignedIdentityDetails) error
}
...
func (properties *UserAssignedIdentityProperties) AssignProperties_From_UserAssignedIdentityProperties(source *v20240101s.UserAssignedIdentityProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (properties *UserAssignedIdentityProperties) AssignProperties_To_UserAssignedIdentityProperties(destination *v20240101s.UserAssignedIdentityProperties) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)
...
func (properties *UserAssignedIdentityProperties_STATUS) AssignProperties_From_UserAssignedIdentityProperties_STATUS(source *v20240101s.UserAssignedIdentityProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(source.PropertyBag)
...
func (properties *UserAssignedIdentityProperties_STATUS) AssignProperties_To_UserAssignedIdentityProperties_STATUS(destination *v20240101s.UserAssignedIdentityProperties_STATUS) error {
	// Clone the existing property bag
	propertyBag := genruntime.NewPropertyBag(properties.PropertyBag)
...
type augmentConversionForUserAssignedIdentityProperties interface {
	AssignPropertiesFrom(src *v20240101s.UserAssignedIdentityProperties) error
	AssignPropertiesTo(dst *v20240101s.UserAssignedIdentityProperties) error
}

type augmentConversionForUserAssignedIdentityProperties_STATUS interface {
	AssignPropertiesFrom(src *v20240101s.UserAssignedIdentityProperties_STATUS) error
	AssignPropertiesTo(dst *v20240101s.UserAssignedIdentityProperties_STATUS) error
}
