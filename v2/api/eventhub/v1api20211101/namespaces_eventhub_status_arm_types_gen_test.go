...
func Test_NamespacesEventhub_STATUS_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	parameters.MinSuccessfulTests = 80
	parameters.MaxSize = 3
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NamespacesEventhub_STATUS_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNamespacesEventhub_STATUS_ARM, NamespacesEventhub_STATUS_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNamespacesEventhub_STATUS_ARM runs a test to see if a specific instance of NamespacesEventhub_STATUS_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForNamespacesEventhub_STATUS_ARM(subject NamespacesEventhub_STATUS_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NamespacesEventhub_STATUS_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NamespacesEventhub_STATUS_ARM instances for property testing - lazily instantiated by
// NamespacesEventhub_STATUS_ARMGenerator()
var namespacesEventhub_STATUS_ARMGenerator gopter.Gen

// NamespacesEventhub_STATUS_ARMGenerator returns a generator of NamespacesEventhub_STATUS_ARM instances for property testing.
// We first initialize namespacesEventhub_STATUS_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func NamespacesEventhub_STATUS_ARMGenerator() gopter.Gen {
	if namespacesEventhub_STATUS_ARMGenerator != nil {
		return namespacesEventhub_STATUS_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespacesEventhub_STATUS_ARM(generators)
	namespacesEventhub_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(NamespacesEventhub_STATUS_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespacesEventhub_STATUS_ARM(generators)
	AddRelatedPropertyGeneratorsForNamespacesEventhub_STATUS_ARM(generators)
	namespacesEventhub_STATUS_ARMGenerator = gen.Struct(reflect.TypeOf(NamespacesEventhub_STATUS_ARM{}), generators)

	return namespacesEventhub_STATUS_ARMGenerator
}

// AddIndependentPropertyGeneratorsForNamespacesEventhub_STATUS_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNamespacesEventhub_STATUS_ARM(gens map[string]gopter.Gen) {
...
// AddRelatedPropertyGeneratorsForNamespacesEventhub_STATUS_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForNamespacesEventhub_STATUS_ARM(gens map[string]gopter.Gen) {
