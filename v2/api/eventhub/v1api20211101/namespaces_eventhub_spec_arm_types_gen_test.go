...
func Test_NamespacesEventhub_Spec_ARM_WhenSerializedToJson_DeserializesAsEqual(t *testing.T) {
	t.Parallel()
	parameters := gopter.DefaultTestParameters()
	...
	properties := gopter.NewProperties(parameters)
	properties.Property(
		"Round trip of NamespacesEventhub_Spec_ARM via JSON returns original",
		prop.ForAll(RunJSONSerializationTestForNamespacesEventhub_Spec_ARM, NamespacesEventhub_Spec_ARMGenerator()))
	properties.TestingRun(t, gopter.NewFormatedReporter(true, 240, os.Stdout))
}

// RunJSONSerializationTestForNamespacesEventhub_Spec_ARM runs a test to see if a specific instance of NamespacesEventhub_Spec_ARM round trips to JSON and back losslessly
func RunJSONSerializationTestForNamespacesEventhub_Spec_ARM(subject NamespacesEventhub_Spec_ARM) string {
	// Serialize to JSON
	bin, err := json.Marshal(subject)
	if err != nil {
		return err.Error()
	...
	// Deserialize back into memory
	var actual NamespacesEventhub_Spec_ARM
	err = json.Unmarshal(bin, &actual)
	if err != nil {
		return err.Error()
	}
...
// Generator of NamespacesEventhub_Spec_ARM instances for property testing - lazily instantiated by
// NamespacesEventhub_Spec_ARMGenerator()
var namespacesEventhub_Spec_ARMGenerator gopter.Gen

// NamespacesEventhub_Spec_ARMGenerator returns a generator of NamespacesEventhub_Spec_ARM instances for property testing.
// We first initialize namespacesEventhub_Spec_ARMGenerator with a simplified generator based on the
// fields with primitive types then replacing it with a more complex one that also handles complex fields
// to ensure any cycles in the object graph properly terminate.
func NamespacesEventhub_Spec_ARMGenerator() gopter.Gen {
	if namespacesEventhub_Spec_ARMGenerator != nil {
		return namespacesEventhub_Spec_ARMGenerator
	}

	generators := make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespacesEventhub_Spec_ARM(generators)
	namespacesEventhub_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(NamespacesEventhub_Spec_ARM{}), generators)

	// The above call to gen.Struct() captures the map, so create a new one
	generators = make(map[string]gopter.Gen)
	AddIndependentPropertyGeneratorsForNamespacesEventhub_Spec_ARM(generators)
	AddRelatedPropertyGeneratorsForNamespacesEventhub_Spec_ARM(generators)
	namespacesEventhub_Spec_ARMGenerator = gen.Struct(reflect.TypeOf(NamespacesEventhub_Spec_ARM{}), generators)

	return namespacesEventhub_Spec_ARMGenerator
}

// AddIndependentPropertyGeneratorsForNamespacesEventhub_Spec_ARM is a factory method for creating gopter generators
func AddIndependentPropertyGeneratorsForNamespacesEventhub_Spec_ARM(gens map[string]gopter.Gen) {
	gens["Name"] = gen.AlphaString()
}

// AddRelatedPropertyGeneratorsForNamespacesEventhub_Spec_ARM is a factory method for creating gopter generators
func AddRelatedPropertyGeneratorsForNamespacesEventhub_Spec_ARM(gens map[string]gopter.Gen) {
