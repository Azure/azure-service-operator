...
// RunPropertyAssignmentTestForUserAssignedIdentityOperatorConfigMaps tests if a specific instance of UserAssignedIdentityOperatorConfigMaps can be assigned to v1alpha1api20181130storage and back losslessly
func RunPropertyAssignmentTestForUserAssignedIdentityOperatorConfigMaps(subject UserAssignedIdentityOperatorConfigMaps) string {
	...
	// Use AssignPropertiesTo() for the first stage of conversion
	var other alpha20181130s.UserAssignedIdentityOperatorConfigMaps
