...
func (identity *Identity_STATUS) AssignPropertiesFromIdentity_STATUS(source *alpha20181130s.Identity_STATUS) error {
...
func (identity *Identity_STATUS) AssignPropertiesToIdentity_STATUS(destination *alpha20181130s.Identity_STATUS) error {
