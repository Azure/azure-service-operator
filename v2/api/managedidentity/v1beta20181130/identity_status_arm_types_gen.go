...
<<<<<<<< HEAD:v2/api/managedidentity/v1beta20181130/user_assigned_identity_statusarm_types_gen.go
type UserAssignedIdentity_STATUSARM struct {
========
type Identity_STATUSARM struct {
>>>>>>>> main:v2/api/managedidentity/v1beta20181130/identity_status_arm_types_gen.go
