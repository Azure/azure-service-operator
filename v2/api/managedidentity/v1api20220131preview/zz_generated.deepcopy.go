...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *FederatedIdentityCredential_Spec_ARM) DeepCopyInto(out *FederatedIdentityCredential_Spec_ARM) {
	*out = *in
	if in.Properties != nil {
		in, out := &in.Properties, &out.Properties
		*out = new(FederatedIdentityCredentialProperties_ARM)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new FederatedIdentityCredential_Spec_ARM.
func (in *FederatedIdentityCredential_Spec_ARM) DeepCopy() *FederatedIdentityCredential_Spec_ARM {
	if in == nil {
		return nil
	}
	out := new(FederatedIdentityCredential_Spec_ARM)
	in.DeepCopyInto(out)
	return out
}
